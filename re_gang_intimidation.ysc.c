	...
	while (iVar0 != 7)
	{
		...
		switch (iVar0)
		{
			...
			case 4:
				...
				{
					TASK::TASK_SYNCHRONIZED_SCENE(iVar18[0], iLocal_52, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_b", 4f, -4f, 17, 0, 1148846080, 0);
				}
				if (!PED::IS_PED_INJURED(iVar18[1]))
				{
					TASK::TASK_SYNCHRONIZED_SCENE(iVar18[1], iLocal_52, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_c", 4f, -4f, 17, 0, 1148846080, 0);
				}
				if (!PED::IS_PED_INJURED(iVar18[2]))
				{
					TASK::TASK_SYNCHRONIZED_SCENE(iVar18[2], iLocal_52, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_d", 4f, -4f, 17, 0, 1148846080, 0);
				}
	...
	switch (*iParam0)
	{
		...
		case 2:
			...
			if (!PED::IS_PED_INJURED((*iParam8)[1]))
			{
				...
				{
					TASK::TASK_SYNCHRONIZED_SCENE((*iParam8)[0], iLocal_53, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_b", 4f, -4f, 17, 0, 1148846080, 0);
				}
				if (!PED::IS_PED_INJURED((*iParam8)[1]))
				{
					TASK::TASK_SYNCHRONIZED_SCENE((*iParam8)[1], iLocal_53, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_c", 4f, -4f, 16, 0, 1148846080, 0);
				}
				if (!PED::IS_PED_INJURED((*iParam8)[2]))
				{
					TASK::TASK_SYNCHRONIZED_SCENE((*iParam8)[2], iLocal_53, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_d", 4f, -4f, 17, 0, 1148846080, 0);
				}
				*iParam0 = 3;
			}
			break;
...
int func_12()//Position - 0x1E84
{
	return Global_1312745;
}

int func_13(int iParam0, int iParam1)//Position - 0x1E90
{
	switch (iParam0)
	{
		case 0:
...
int func_14(int iParam0)//Position - 0x2204
{
	switch (iParam0)
	{
		case 29:
...
void func_15(int iParam0)//Position - 0x2233
{
	int iVar0;
	int iVar1;
...
void func_16(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x2275
{
	func_17(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_17(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2297
{
	int iVar0;
...
bool func_21(int iParam0)//Position - 0x26CE
{
	return Global_41396 == iParam0;
}

bool func_22(int iParam0)//Position - 0x26DC
{
	return iParam0 < 3;
}

int func_23(int iParam0)//Position - 0x26E8
{
	int iVar0;
	int iVar1;
...
int func_24(int iParam0)//Position - 0x2725
{
	if (func_22(iParam0))
	{
...
var func_25(int iParam0)//Position - 0x274A
{
	return Global_1798[iParam0 /*29*/];
}

int func_26(int iParam0)//Position - 0x2759
{
	int iVar0;
	int iVar1;
...
void func_27(int iParam0, int iParam1)//Position - 0x279C
{
	MISC::SET_BIT(&(Global_111560.f_24990.f_8[iParam0]), iParam1);
}

int func_28(int iParam0)//Position - 0x27B7
{
	int iVar0;
...
int func_30(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x2885
{
...
int func_31()//Position - 0x2A5F
{
	return 1;
}

int func_32(var uParam0)//Position - 0x2A68
{
	int iVar0;
...
void func_33(var uParam0)//Position - 0x2AA6
{
	int iVar0;
...
void func_34(var uParam0)//Position - 0x2ADB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_35(struct<6> Param0, int iParam6, var uParam7)//Position - 0x2B47
{
	switch (iLocal_252)
	{
		case 0:
		...
		case 2:
			if (!PED::IS_PED_INJURED((*uParam7)[2]))
			{
				if (!PED::IS_PED_INJURED((*uParam7)[0]))
				{
					...
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_229[0 /*3*/], 1f, -1, 1048576000, 0, 1193033728);
					TASK::TASK_ACHIEVE_HEADING(0, fLocal_239[0], 0);
					TASK::TASK_PLAY_ANIM_ADVANCED(0, Param0.f_5, "sit_down_idle_01", vLocal_229[0 /*3*/], 0f, 0f, fLocal_239[0], 1000f, -4f, -1, 1, 0, 2, 0);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_50);
				...
				if (!PED::IS_PED_INJURED((*uParam7)[1]))
				{
					...
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_229[1 /*3*/], 1f, -1, 1048576000, 0, 1193033728);
...
int func_36(int iParam0, int iParam1)//Position - 0x2E07
{
	int iVar0;
	int iVar1;
...
void func_37(var uParam0)//Position - 0x2E28
{
	int iVar0;
...
int func_38(int iParam0, bool bParam1, int iParam2)//Position - 0x2E81
{
	int iVar0;
...
int func_39(int iParam0, bool bParam1, bool bParam2)//Position - 0x2ECB
{
	int iVar0;
...
float func_40(bool bParam0, float fParam1, float fParam2)//Position - 0x2F6F
{
	if (bParam0)
	{
		return fParam1;
...
void func_41(int iParam0)//Position - 0x2F86
{
...
void func_42(var uParam0, int iParam1)//Position - 0x2F9D
{
	int iVar0;
...
void func_43()//Position - 0x3010
{
	Global_19671 = 0;
	func_44();
}

void func_44()//Position - 0x3020
{
...
bool func_45(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x3077
{
...
int func_46(char* sParam0, int iParam1, bool bParam2)//Position - 0x30C5
{
	Global_20806 = 0;
...
bool func_49(int iParam0)//Position - 0x3432
{
	return func_50(iParam0, 20);
}

bool func_50(int iParam0, int iParam1)//Position - 0x3442
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_51()//Position - 0x345D
{
	return -1;
}

void func_52()//Position - 0x3466
{
	int iVar0;
...
bool func_58(int iParam0, int iParam1)//Position - 0x36E7
{
	switch (iParam0)
	{
		case 5:
...
void func_59(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x3722
{
...
int func_60(int iParam0, var uParam1)//Position - 0x3778
{
	switch (iLocal_255)
	{
		case 0:
		...
		case 1:
			...
			if (!PED::IS_PED_INJURED(iParam0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_50);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_243, 2f, 20000, 0.25f, 0, 32.2195f);
		...
		case 4:
			if (!PED::IS_PED_INJURED(iParam0))
			{
				...
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_243, 2f, 20000, 1048576000, 0, 1193033728);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_50);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_50);
				iLocal_50 = 0;
			}
...
void func_61(int iParam0)//Position - 0x3E5B
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
		TASK::CLEAR_PED_TASKS(iParam0);
...
void func_62(int iParam0, var uParam1)//Position - 0x3EC4
{
	int iVar0;
...
int func_64(int iParam0)//Position - 0x4100
{
	if (func_68())
	{
		Global_111550 = 1;
...
void func_65(int iParam0)//Position - 0x4153
{
	switch (iParam0)
	{
		case 0:
...
void func_66(char[4] cParam0, int iParam1)//Position - 0x4234
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

char* func_67(int iParam0)//Position - 0x424B
{
	char* sVar0;
...
int func_69(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x42C5
{
	int iVar0;
...
void func_70(var uParam0, int iParam1)//Position - 0x43FC
{
	int iVar0;
...
bool func_71(int iParam0)//Position - 0x444B
{
	return func_72(iParam0, Global_41396);
}

int func_72(int iParam0, int iParam1)//Position - 0x445C
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_73(int iParam0)//Position - 0x463D
{
	if (Global_41396 == 15)
	{
		return 0;
...
int func_74(vector3 vParam0, int iParam3)//Position - 0x465F
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
void func_76()//Position - 0x46B2
{
	Global_19671 = 0;
	func_77();
}

void func_77()//Position - 0x46C2
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_78(int iParam0, int iParam1)//Position - 0x46E3
{
...
int func_79(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4, bool bParam5, float fParam6, int iParam7)//Position - 0x4730
{
	int iVar0;
...
int func_80(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5, int iParam6)//Position - 0x4779
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
void func_81(char* sParam0, int iParam1)//Position - 0x49D7
{
	func_83(sParam0);
	func_82(iParam1);
}

void func_82(int iParam0)//Position - 0x49EB
{
	if (iParam0 > 0)
	{
	}
...
void func_83(char* sParam0)//Position - 0x49F9
{
...
void func_84(int iParam0)//Position - 0x4A0C
{
	AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(iParam0);
}

void func_85(char* sParam0)//Position - 0x4A1A
{
	func_83(sParam0);
}

int func_86()//Position - 0x4A28
{
	int iVar0;
...
void func_87(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x4A89
{
...
int func_88()//Position - 0x4B24
{
	func_20();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_89(bool bParam0)//Position - 0x4B3D
{
	if (bParam0)
	{
	}
...
int func_90(int iParam0)//Position - 0x4B4A
{
	if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
		if (func_91(iParam0))
...
int func_91(int iParam0)//Position - 0x4B67
{
	switch (iParam0)
	{
		case 0:
...
int func_92(int iParam0)//Position - 0x4BD9
{
	int iVar0;
...
var func_93()//Position - 0x52F6
{
	return Global_98708.f_1;
}

int func_94()//Position - 0x5304
{
	if (Global_95621 != -1)
	{
...
bool func_97()//Position - 0x536E
{
	return Global_98721.f_346 > 0;
}

bool func_98()//Position - 0x537F
{
	return Global_98721.f_345 > 0;
}

var func_99()//Position - 0x5390
{
	return Global_1312873;
}

int func_100()//Position - 0x539C
{
...
int func_102(float fParam0, bool bParam1)//Position - 0x543E
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_103(int iParam0, var uParam1)//Position - 0x54F5
{
	switch (iParam0)
	{
		case 0:
...
int func_105(int iParam0)//Position - 0x67CD
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_106(int iParam0)//Position - 0x6B13
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_107(int iParam0)//Position - 0x6B4B
{
	struct<2> Var0;
...
bool func_109()//Position - 0x6FCA
{
	return Global_111278 > 0;
}

int func_110()//Position - 0x6FD8
{
	if (Global_95621 != -1)
	{
		return 1;
...
int func_115(int iParam0, struct<5> Param1, var uParam6)//Position - 0x70BD
{
	int iVar0;
...
void func_116(int iParam0)//Position - 0x7172
{
	if (iParam0 == -1)
	{
		iParam0 = func_29();
...
void func_118(int iParam0)//Position - 0x71E5
{
	Global_111549 = iParam0;
}

int func_119(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x71F3
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
...
bool func_120(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x758D
{
	if (bParam6)
	{
...
bool func_121(int iParam0)//Position - 0x75D4
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0x75F5
{
	return func_123(iParam0, 1);
}

int func_123(int iParam0, int iParam1)//Position - 0x7604
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_124(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x7657
{
	func_125(func_136(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_125(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x7675
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_126(float fParam0, float fParam1, float fParam2)//Position - 0x7876
{
	float fVar0;
...
int func_127(int iParam0, int iParam1)//Position - 0x78B8
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_128(int iParam0)//Position - 0x795A
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_129(int iParam0)//Position - 0x796D
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_130(int iParam0)//Position - 0x7980
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_131(int iParam0)//Position - 0x7993
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_132(int iParam0)//Position - 0x79A5
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_133(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_133(bool bParam0, int iParam1, int iParam2)//Position - 0x79CA
{
	if (bParam0)
	{
		return iParam1;
...
int func_134(int iParam0)//Position - 0x79E1
{
	return iParam0 & 15;
}

int func_135(int iParam0, int iParam1)//Position - 0x79EE
{
	int iVar0;
	int iVar1;
...
void func_137(var uParam0, int iParam1)//Position - 0x7B40
{
	if (iParam1 <= 0)
	{
		return;
...
void func_138(var uParam0, int iParam1)//Position - 0x7BC6
{
...
void func_139(var uParam0, int iParam1)//Position - 0x7BF9
{
	int iVar0;
	int iVar1;
...
void func_140(var uParam0, int iParam1)//Position - 0x7C4A
{
...
void func_141(var uParam0, int iParam1)//Position - 0x7C84
{
...
void func_142(var uParam0, int iParam1)//Position - 0x7CBF
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_143(int iParam0)//Position - 0x7CFB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_144(int iParam0, int iParam1)//Position - 0x7DD7
{
...
bool func_146(int iParam0)//Position - 0x7E22
{
	return func_135(func_136(), iParam0);
}

int func_147(int iParam0, int iParam1, int iParam2)//Position - 0x7E34
{
	int iVar0;
	int iVar1;
...
int func_148(int iParam0)//Position - 0x7F18
{
	if (!func_22(iParam0))
	{
		return 7;
...
bool func_149(int iParam0)//Position - 0x7F3C
{
	int iVar0;
	bool bVar1;
...
void func_152(struct<6> Param0, int iParam6, int iParam7, int iParam8)//Position - 0x809A
{
	int iVar0;
...
void func_153(int iParam0)//Position - 0x814B
{
	char cVar0[64];
...
void func_154(var uParam0)//Position - 0x8200
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_155(int iParam0, bool bParam1)//Position - 0x823D
{
	switch (iParam0)
	{
		case 0:
...
void func_156(int iParam0)//Position - 0x8486
{
	Global_41947 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_157(int iParam0)//Position - 0x8498
{
	func_158(iParam0, 0, func_163(iParam0));
}

void func_158(int iParam0, int iParam1, int iParam2)//Position - 0x84AD
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_159(var uParam0)//Position - 0x84DC
{
	struct<16> Var0;
	int iVar16;
...
void func_160(int iParam0, var uParam1)//Position - 0x85AD
{
	Global_111560.f_24990.f_43[iParam0] = *uParam1;
}

void func_161(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x85C5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_162(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8747
{
...
int func_163(int iParam0)//Position - 0x877F
{
	int iVar0;
