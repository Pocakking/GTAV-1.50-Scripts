...
void __EntryFunction__()//Position - 0x0
{
	...
	StringCopy(&vLocal_677, "MAUDE_MCS_3", 24);
	...
	while (true)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			vLocal_692 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
			func_421();
			func_420();
			switch (iLocal_98)
			{
...
bool func_6(vector3 vParam0, var uParam3, float fParam4, int iParam5)//Position - 0x71E
{
	var uVar0;
	vector3 vVar1;
...
void func_10(vector3 vParam0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x7F6
{
	var uVar0;
	int iVar1;
...
int func_17(int iParam0)//Position - 0x9DD
{
	if (iParam0 == 1)
	{
...
bool func_18()//Position - 0xA37
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

void func_19(int iParam0, struct<2> Param1, float fParam3)//Position - 0xA49
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
int func_20(int iParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6)//Position - 0xAA8
{
	bool bVar0;
	float fVar1;
...
void func_21()//Position - 0xB04
{
	Global_19671 = 0;
	func_22();
}

void func_22()//Position - 0xB14
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
...
int func_23(int iParam0)//Position - 0xB6B
{
	if (func_433(iParam0))
	{
...
void func_24(int iParam0, bool bParam1)//Position - 0xB8B
{
...
void func_25(int iParam0, int iParam1, int iParam2)//Position - 0xBC7
{
...
void func_26(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0xBFB
{
	int iVar0;
...
void func_27(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0xCA4
{
	if (bParam0)
	{
...
bool func_28()//Position - 0xDDD
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_29(int iParam0, int iParam1)//Position - 0xDFA
{
	bool bVar0;
...
int func_30(int iParam0, bool bParam1)//Position - 0xE45
{
	int iVar0;
	int iVar1;
...
int func_31()//Position - 0xE86
{
	return Global_1312745;
}

int func_32(int iParam0)//Position - 0xE92
{
...
bool func_33()//Position - 0xED4
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_34(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xEE5
{
	int iVar0;
...
void func_35(int iParam0)//Position - 0xF18
{
	if (iParam0 == 1)
	{
...
void func_36(int iParam0)//Position - 0xF3B
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		switch (iParam0)
...
void func_38(int iParam0, bool bParam1)//Position - 0x114C
{
	if (bParam1)
	{
		func_40(iParam0);
...
void func_39(int iParam0, bool bParam1)//Position - 0x1169
{
...
void func_40(int iParam0)//Position - 0x11A4
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
char* func_41()//Position - 0x11CF
{
	return "special_ped@maude@base";
}

void func_42(int iParam0, bool bParam1)//Position - 0x11DA
{
	if (bParam1)
	{
		func_44(iParam0);
...
void func_43(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11F9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_44(int iParam0)//Position - 0x1249
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_45()//Position - 0x128A
{
	return 2057223314;
}

float func_46()//Position - 0x1297
{
	return -92.17f;
}

Vector3 func_47()//Position - 0x12A4
{
	return 2727.4f, 4145.56f, 43.68f;
}

int func_48()//Position - 0x12BB
{
	return -380698483;
}

void func_49()//Position - 0x12C8
{
	int iVar0;
	int iVar1;
...
char* func_50()//Position - 0x13B4
{
	return "base_chair";
}

char* func_51()//Position - 0x13BF
{
	return "base";
}

Vector3 func_52()//Position - 0x13CA
{
	return 0f, 0f, -92.17f;
}

Vector3 func_53()//Position - 0x13D9
{
	return 2727.4f, 4145.56f, 43.68f;
}

int func_54(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, bool bParam7, bool bParam8)//Position - 0x13F0
{
...
void func_55(int iParam0, bool bParam1)//Position - 0x1472
{
	if (iParam0 != 0)
	{
		if (bParam1)
...
int func_56(int iParam0)//Position - 0x149D
{
	if (iParam0 == 0)
	{
		return 1;
...
int func_57(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0x14C3
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_56(iParam1))
...
int func_58(int iParam0)//Position - 0x152E
{
	switch (iParam0)
	{
		case 0:
...
bool func_59(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x1599
{
	return SYSTEM::VDIST2(vParam0, vParam3) <= (fParam6 * fParam6);
}

int func_60(int iParam0, float fParam1, int iParam2)//Position - 0x15B3
{
	int iVar0;
...
int func_64(int iParam0, int iParam1)//Position - 0x171D
{
	if (func_23(iParam0))
	{
...
int func_65(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x1750
{
...
void func_66(int iParam0)//Position - 0x18DF
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_68(char* sParam0)//Position - 0x194D
{
	func_27(1, 1, 0, 0, 0, 0);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_69(int iParam0, int iParam1, int iParam2)//Position - 0x1967
{
	if (func_520() && func_71())
	{
...
void func_70(int iParam0)//Position - 0x1A2B
{
	if (iParam0 == 1)
	{
...
void func_73(int iParam0)//Position - 0x1D1E
{
	if (func_23(*iParam0))
	{
...
char* func_74()//Position - 0x1D87
{
	return "female_Flee_Table_Left_Maude";
}

int func_75(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1D92
{
	if (iParam4 == 0)
	{
...
bool func_76(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1DCF
{
...
int func_77(char* sParam0, int iParam1, bool bParam2)//Position - 0x1E1D
{
	Global_20806 = 0;
...
bool func_80(int iParam0)//Position - 0x218A
{
	return func_81(iParam0, 20);
}

bool func_81(int iParam0, int iParam1)//Position - 0x219A
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_82()//Position - 0x21B5
{
	return -1;
}

void func_83()//Position - 0x21BE
{
	int iVar0;
...
int func_87()//Position - 0x23BF
{
	func_88();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_88()//Position - 0x23D8
{
	int iVar0;
...
bool func_89(int iParam0)//Position - 0x24D5
{
	return iParam0 < 3;
}

int func_90(int iParam0)//Position - 0x24E1
{
	int iVar0;
	int iVar1;
...
int func_91(int iParam0)//Position - 0x251E
{
	if (func_89(iParam0))
	{
...
var func_92(int iParam0)//Position - 0x2543
{
	return Global_1798[iParam0 /*29*/];
}

bool func_93(int iParam0)//Position - 0x2552
{
	return Global_41396 == iParam0;
}

void func_94()//Position - 0x2560
{
	int iVar0;
...
bool func_95(int iParam0, int iParam1)//Position - 0x25B7
{
	switch (iParam0)
	{
		case 5:
...
void func_96(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x25F2
{
...
void func_97(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2648
{
...
void func_98(bool bParam0)//Position - 0x26E3
{
	int iVar0;
...
void func_99(int iParam0, bool bParam1)//Position - 0x28B7
{
	if (bParam1)
	{
		func_101(iParam0);
...
void func_100(int iParam0)//Position - 0x28D3
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_101(int iParam0)//Position - 0x290B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_102(int iParam0)//Position - 0x29A7
{
	if (func_433(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_103(var uParam0)//Position - 0x29D1
{
...
void func_105(char* sParam0)//Position - 0x2A17
{
...
void func_106(int iParam0, bool bParam1)//Position - 0x2A56
{
	if (func_23(iParam0))
	{
		PED::SET_PED_COMBAT_ATTRIBUTES(iParam0, 5, 0);
...
int func_107(int iParam0, int iParam1, int iParam2)//Position - 0x2AD1
{
	int iVar0;
...
char* func_108()//Position - 0x2C1D
{
	return "Female_Flee_Table_Left_Maude_Chair";
}

char* func_109()//Position - 0x2C29
{
	return "special_ped@maude@exit_flee";
}

void func_110(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x2C35
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_111(iParam3), 0);
}

int func_111(int iParam0)//Position - 0x2C4E
{
	int iVar0;
...
bool func_112(int iParam0, vector3 vParam1, float fParam4)//Position - 0x2E43
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, 1), vParam1) <= (fParam4 * fParam4);
}

void func_113(int iParam0, bool bParam1)//Position - 0x2E60
{
	char* sVar0;
	int iVar1;
	int iVar2;
...
void func_114(var uParam0, int iParam1)//Position - 0x2ED1
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
void func_116(int iParam0)//Position - 0x2F12
{
	bool bVar0;
	struct<8> Var1;
...
void func_117(int iParam0)//Position - 0x2F84
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
void func_118(int iParam0)//Position - 0x2FA4
{
	int iVar0;
...
bool func_120(int iParam0, int iParam1)//Position - 0x3172
{
	return (MISC::GET_GAME_TIMER() - iParam0) > iParam1;
}

void func_121(int iParam0)//Position - 0x3184
{
...
void func_122(int iParam0)//Position - 0x32DB
{
	func_24(500, 1);
...
void func_123(int iParam0, int iParam1, int iParam2)//Position - 0x3310
{
	bool bVar0;
...
int func_126()//Position - 0x3904
{
	return Global_30736;
}

int func_127(int iParam0, int iParam1)//Position - 0x390F
{
	int iVar0;
...
int func_128(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x3960
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_129(int iParam0)//Position - 0x3FB2
{
	int iVar0;
...
void func_131(int iParam0)//Position - 0x42FE
{
	iLocal_98 = iParam0;
	iLocal_100 = 0;
}

void func_132(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x430D
{
	vector3 vVar0;
	var uVar3;
...
void func_133(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)//Position - 0x4388
{
	struct<60> Var0;
...
void func_134(int iParam0, int iParam1, int iParam2)//Position - 0x44B1
{
	int iVar0;
...
void func_135(int iParam0, int iParam1)//Position - 0x45CE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_136(int iParam0)//Position - 0x47D0
{
...
int func_137(int iParam0)//Position - 0x48AD
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_138(int iParam0, bool bParam1)//Position - 0x4A5E
{
	int iVar0;
	struct<2> Var1;
...
int func_139(int iParam0)//Position - 0x4BDE
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_141(int iParam0)//Position - 0x4CC1
{
	int iVar0;
	int iVar1;
...
int func_142()//Position - 0x718C
{
	return 0;
}

int func_143()//Position - 0x7195
{
	return 1;
}

int func_144()//Position - 0x719E
{
	return 1;
}

int func_145()//Position - 0x71A7
{
...
int func_147(int iParam0)//Position - 0x727B
{
	int iVar0;
	char* sVar1;
...
int func_148(int iParam0)//Position - 0x72C1
{
	int iVar0;
...
int func_149(int iParam0)//Position - 0x72FC
{
	int iVar0;
...
int func_150(int iParam0)//Position - 0x7378
{
	int iVar0;
...
int func_151(int iParam0, int iParam1, bool bParam2)//Position - 0x7460
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_152(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x74D1
{
...
void func_154(var uParam0, int iParam1)//Position - 0x75EF
{
	if (iParam1 <= 0)
	{
		return;
...
void func_155(var uParam0, int iParam1)//Position - 0x7675
{
...
void func_156(var uParam0, int iParam1)//Position - 0x76A8
{
	int iVar0;
	int iVar1;
...
int func_157(int iParam0, int iParam1)//Position - 0x76F9
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_158(int iParam0)//Position - 0x779B
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_159(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_159(bool bParam0, int iParam1, int iParam2)//Position - 0x77C0
{
	if (bParam0)
	{
		return iParam1;
...
int func_160(var uParam0)//Position - 0x77D7
{
	return uParam0 & 15;
}

void func_161(var uParam0, int iParam1)//Position - 0x77E4
{
...
void func_162(var uParam0, int iParam1)//Position - 0x781E
{
...
void func_163(var uParam0, int iParam1)//Position - 0x7859
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_164(var uParam0, int iParam1)//Position - 0x7895
{
	int iVar0;
	int iVar1;
...
int func_165(int iParam0, int iParam1)//Position - 0x8F8D
{
	struct<82> Var0;
...
void func_166(int iParam0, var uParam1, int iParam2)//Position - 0x8FCF
{
	int iVar0;
...
void func_167(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0x922B
{
	if (func_164(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
...
void func_168(int iParam0, bool bParam1)//Position - 0x932A
{
	if (iParam0 == -1)
	{
		return;
...
void func_169(int iParam0, int iParam1, bool bParam2)//Position - 0x9387
{
	if (iParam0 == -1)
	{
		return;
...
bool func_170(int iParam0, int iParam1)//Position - 0x93C2
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_171(var uParam0, var uParam1)//Position - 0x93E5
{
...
void func_172(int iParam0)//Position - 0x94B1
{
	if (iParam0 == -1)
	{
		return;
...
int func_173(int iParam0)//Position - 0x952B
{
	int iVar0;
...
bool func_174(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x958E
{
	if (bParam6)
	{
...
void func_175(int iParam0, var uParam1)//Position - 0x95D5
{
	int iVar0;
...
int func_176(int iParam0)//Position - 0x9880
{
	switch (iParam0)
	{
		case 1:
...
int func_177(int iParam0, var uParam1, var uParam2)//Position - 0x9930
{
	int iVar0;
	int iVar1;
...
int func_178(int iParam0)//Position - 0x9B23
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_179(var uParam0)//Position - 0x9B43
{
	int iVar0;
...
void func_180(int iParam0)//Position - 0x9BF3
{
...
int func_181(vector3 vParam0, int iParam3, var uParam4, var uParam5)//Position - 0x9C1A
{
	int iVar0;
...
int func_182(vector3 vParam0, int iParam3, int iParam4)//Position - 0x9D30
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_183(int iParam0)//Position - 0x9DBF
{
	return MISC::IS_BIT_SET(Global_111560.f_7224[iParam0], 0);
}

int func_184(int iParam0)//Position - 0x9DD7
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_185(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x9DF3
{
	func_186(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_186(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x9E1C
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_187(vector3 vParam0)//Position - 0xA210
{
...
int func_188(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0xA23A
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_189(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0xA530
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_190(vector3 vParam0)//Position - 0xA5E4
{
	float fVar0;
	float fVar1;
...
void func_191(int iParam0)//Position - 0xA623
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
bool func_192(vector3 vParam0, int iParam3)//Position - 0xA688
{
	return func_193(Global_102125.f_2890.f_12.f_66, vParam0, iParam3);
}

int func_193(int iParam0, vector3 vParam1, int iParam4)//Position - 0xA6A5
{
	vector3 vVar0;
	vector3 vVar3;
...
Vector3 func_194()//Position - 0xA70F
{
	return 2.55f, 5.665f, 2.55f;
}

Vector3 func_195()//Position - 0xA726
{
	return 3.01f, 11.01f, 6.01f;
}

int func_196(var uParam0, var uParam1, var uParam2)//Position - 0xA73D
{
...
void func_197(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0xA774
{
	int iVar0;
...
Vector3 func_198(int iParam0)//Position - 0xA932
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), 0);
}

int func_199(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xA945
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_200(int iParam0, int iParam1, int iParam2)//Position - 0xB15B
{
	int iVar0;
...
int func_201(int iParam0)//Position - 0xB1E7
{
	switch (iParam0)
	{
...
void func_202(int iParam0, int iParam1, int iParam2)//Position - 0xB222
{
	int iVar0;
	int iVar1;
...
int func_203(int iParam0, int iParam1, int iParam2)//Position - 0xB2AC
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_204(int iParam0, int iParam1, int iParam2)//Position - 0xB38A
{
	Global_76389[1 /*14*/] = { func_249(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 2);
}

int func_205(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0xB3B5
{
	var uVar0;
	int iVar10;
...
int func_206(int iParam0, int iParam1, int iParam2)//Position - 0xB9B9
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_207(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBA52
{
	int iVar0;
...
int func_208(int iParam0, int iParam1, int iParam2)//Position - 0xBAE8
{
	int iVar0;
	int iVar1;
...
int func_209(int iParam0)//Position - 0xBB89
{
	switch (iParam0)
	{
		case 0:
...
int func_210(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBC39
{
	int iVar0;
...
int func_211(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xBF40
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_212(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0xCAFA
{
	int iVar0;
...
int func_213(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCDDE
{
	int iVar0;
...
int func_214(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD0A5
{
	int iVar0;
	int iVar1;
...
int func_215(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD0DC
{
	int iVar0;
...
int func_216(int iParam0, int iParam1, int iParam2)//Position - 0xD105
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_217(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD3CF
{
	int iVar0;
...
int func_218(int iParam0, int iParam1, int iParam2)//Position - 0xD659
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_219(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD7B0
{
	int iVar0;
...
int func_220(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD848
{
	switch (iParam0)
	{
...
int func_221(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD916
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_222(int iParam0, int iParam1)//Position - 0xDA72
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_223(int iParam0)//Position - 0xDE19
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_224(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDE7A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_225(int iParam0, int iParam1)//Position - 0xDF76
{
	int iVar0;
...
int func_226(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE0B4
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_227(int iParam0)//Position - 0xE194
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_228(int iParam0, int iParam1)//Position - 0xE21A
{
	int iVar0;
	struct<10> Var1;
...
void func_229(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xEB49
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_230(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xEC73
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_231(int iParam0, int iParam1)//Position - 0xECBB
{
	int iVar0;
	struct<17> Var1;
...
void func_232(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10B04
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_233(int iParam0)//Position - 0x10CEE
{
	switch (iParam0)
	{
		case 0:
...
void func_234(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x10D9E
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_235(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10E0F
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_236(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1108C
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_237(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x114B1
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_238(int iParam0, int iParam1)//Position - 0x117A4
{
	int iVar0;
	int iVar1;
...
int func_239(int iParam0, int iParam1)//Position - 0x117EA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_240(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1184A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_241(int iParam0)//Position - 0x118CE
{
...
void func_242(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x11986
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_243(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x119D0
{
	int iVar0;
...
int func_244(var uParam0)//Position - 0x11A00
{
	int iVar0;
	int iVar1;
...
int func_245(int iParam0, int iParam1, int iParam2)//Position - 0x11A34
{
	int iVar0;
	var uVar1;
...
bool func_246(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x11A66
{
	int iVar0;
...
int func_247(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x138CD
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_248(int iParam0)//Position - 0x147EC
{
	if (!MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_249(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1483D
{
	func_312();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_250(int iParam0, int iParam1)//Position - 0x1488F
{
	switch (iParam0)
	{
		case 0:
...
void func_251(int iParam0)//Position - 0x1497F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_252(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x15BF6
{
	int iVar0;
	int iVar1;
...
bool func_253(int iParam0, int iParam1, var uParam2)//Position - 0x15F87
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_254(int iParam0, int iParam1)//Position - 0x1638C
{
	switch (iParam1)
	{
		case 0:
...
int func_255(int iParam0, int iParam1)//Position - 0x16787
{
	switch (iParam1)
	{
		case 0:
...
int func_256(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x16B82
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_257(int iParam0)//Position - 0x16BC4
{
	switch (iParam0)
	{
		case -1:
...
void func_258(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x16C98
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
...
void func_259(int iParam0)//Position - 0x16F71
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_260(int iParam0)//Position - 0x170C8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_261(int iParam0)//Position - 0x175D6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_262(int iParam0)//Position - 0x1764B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_263(int iParam0)//Position - 0x176BF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_264(int iParam0)//Position - 0x177A6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_265(int iParam0)//Position - 0x17B09
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_266(int iParam0)//Position - 0x17D1A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_267(int iParam0)//Position - 0x17F4A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_268(int iParam0)//Position - 0x1805C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_269(int iParam0)//Position - 0x189FB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_270(int iParam0)//Position - 0x1956E
{
	if (iParam0 < 136)
	{
		func_272(iParam0);
...
void func_271(int iParam0)//Position - 0x195A3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_272(int iParam0)//Position - 0x1A1A7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_273(int iParam0)//Position - 0x1B0B5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_274(int iParam0)//Position - 0x1B1E2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_275(int iParam0, int iParam1)//Position - 0x1B2E0
{
	switch (iParam0)
	{
		case 0:
...
void func_276(int iParam0)//Position - 0x1B3D0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_277(int iParam0)//Position - 0x1C8C3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_278(int iParam0)//Position - 0x1CA14
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_279(int iParam0)//Position - 0x1CF1F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_280(int iParam0)//Position - 0x1D58D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_281(int iParam0)//Position - 0x1D601
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_282(int iParam0)//Position - 0x1D6D1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_283(int iParam0)//Position - 0x1DC01
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_284(int iParam0)//Position - 0x1DD98
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_285(int iParam0)//Position - 0x1E596
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_286(int iParam0)//Position - 0x1E6A6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_287(int iParam0)//Position - 0x1F5D1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_288(int iParam0)//Position - 0x20290
{
	if (iParam0 < 107)
	{
		func_291(iParam0);
...
void func_289(int iParam0)//Position - 0x202D6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_290(int iParam0)//Position - 0x20D7B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_291(int iParam0)//Position - 0x21B6A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_292(int iParam0)//Position - 0x227B3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_293(int iParam0)//Position - 0x22A2C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_294(int iParam0, int iParam1)//Position - 0x22B72
{
	switch (iParam0)
	{
		case 0:
...
void func_295(int iParam0)//Position - 0x22C62
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_296(int iParam0)//Position - 0x239EC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_297(int iParam0)//Position - 0x23B66
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_298(int iParam0)//Position - 0x240DF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_299(int iParam0)//Position - 0x24609
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_300(int iParam0)//Position - 0x2467D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_301(int iParam0)//Position - 0x2474D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_302(int iParam0)//Position - 0x24C25
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_303(int iParam0)//Position - 0x24E8E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_304(int iParam0)//Position - 0x25164
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_305(int iParam0)//Position - 0x2532D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_306(int iParam0)//Position - 0x25E81
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_307(int iParam0)//Position - 0x26ACB
{
	if (iParam0 < 60)
	{
		func_309(iParam0);
...
void func_308(int iParam0)//Position - 0x26B00
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_309(int iParam0)//Position - 0x278A0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_310(int iParam0)//Position - 0x27F2C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_311(int iParam0)//Position - 0x28014
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_312()//Position - 0x28112
{
...
int func_313(int iParam0, int iParam1, int iParam2)//Position - 0x2818B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_314(bool bParam0)//Position - 0x283E6
{
	int iVar0;
...
void func_315()//Position - 0x28424
{
	bool bVar0;
	vector3 vVar1;
	...
	if (func_23(Local_112.f_9))
	{
		...
		switch (iLocal_100)
		{
			case 0:
				...
				vLocal_707 = { ENTITY::GET_ENTITY_COORDS(Local_112.f_9, 0) };
			...
			case 1:
				if (!iLocal_448)
				{
					...
					if (Local_112.f_10 == 13 || Local_112.f_10 == 14)
					{
						...
						if (func_327(Local_112.f_9, vLocal_692, bVar0, 0, 1, iLocal_478))
						{
...
int func_316(var uParam0)//Position - 0x288FF
{
	vector3 vVar0;
...
int func_317(var uParam0)//Position - 0x28944
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
bool func_318(char* sParam0, int iParam1, char* sParam2)//Position - 0x2897C
{
...
void func_319(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x2899A
{
...
void func_320(char* sParam0, int iParam1, int iParam2)//Position - 0x28A46
{
	iParam2 = iParam2;
...
int func_321(char* sParam0, bool bParam1)//Position - 0x28A5F
{
	struct<6> Var0;
...
struct<6> func_322()//Position - 0x28A9A
{
	struct<6> Var0;
...
void func_323(int iParam0, vector3 vParam1, int iParam4, float fParam5)//Position - 0x28ABE
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_324(var uParam0, int iParam1, int iParam2)//Position - 0x28BA3
{
	char* sVar0;
...
int func_325(char* sParam0)//Position - 0x28C80
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_326()//Position - 0x28C93
{
	if (func_23(Local_112.f_9))
	{
...
int func_327(int iParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6, int iParam7)//Position - 0x28D8E
{
	int iVar0;
...
int func_328(int iParam0, vector3 vParam1, float fParam4, float fParam5)//Position - 0x28F04
{
...
int func_329(int iParam0, vector3 vParam1)//Position - 0x28F3C
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
void func_330(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x28F9A
{
	func_331(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_331(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x28FB4
{
	func_332(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_332(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x28FD1
{
...
void func_333(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x29009
{
	int iVar0;
	int iVar1;
...
void func_334(var uParam0)//Position - 0x29376
{
...
int func_335(var uParam0)//Position - 0x293DF
{
	int iVar0;
...
int func_336(bool bParam0)//Position - 0x2940A
{
	switch (Global_41396)
	{
		case 0:
...
void func_337(char[4] cParam0, int iParam1)//Position - 0x294B4
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_338(char* sParam0)//Position - 0x294CB
{
	if (!func_339(1, 1, 0))
	{
...
int func_339(bool bParam0, bool bParam1, bool bParam2)//Position - 0x29564
{
	int iVar0;
	int iVar1;
...
int func_340(int iParam0)//Position - 0x297BD
{
	if (iParam0 != func_82())
	{
...
int func_341(int iParam0, bool bParam1, bool bParam2)//Position - 0x29823
{
	int iVar0;
...
int func_342(int iParam0, int iParam1)//Position - 0x2986D
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		if (VEHICLE::GET_NUM_MOD_KITS(iParam0) > 0)
...
int func_343(int iParam0, int iParam1)//Position - 0x298CF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_344()//Position - 0x29954
{
	return Global_2448961.f_17;
}

bool func_345(int iParam0)//Position - 0x29962
{
	return iParam0 == 51;
}

var func_346()//Position - 0x2996F
{
	return Global_2448961.f_16;
}

bool func_347()//Position - 0x2997D
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

void func_348(var uParam0, int iParam1, vector3 vParam2, int iParam5)//Position - 0x29992
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_349()//Position - 0x29AA2
{
	return func_350(PLAYER::PLAYER_ID());
}

int func_350(int iParam0)//Position - 0x29AB2
{
...
int func_351(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x29AD1
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_352(bool bParam0, bool bParam1, bool bParam2)//Position - 0x29E3D
{
...
int func_353(bool bParam0, bool bParam1, bool bParam2)//Position - 0x29E8F
{
	if (!func_339(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_354(bool bParam0, bool bParam1, bool bParam2)//Position - 0x29ED8
{
	if (!func_339(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_355(bool bParam0, bool bParam1, bool bParam2)//Position - 0x29F37
{
	if (!func_339(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_356(int iParam0)//Position - 0x29F8D
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_357()//Position - 0x29FE8
{
	MISC::SET_BIT(&Global_7357, 4);
}

void func_358(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x29FF8
{
	if (HUD::DOES_BLIP_EXIST(*uParam0))
	{
...
int func_359(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x2A0F3
{
	int iVar0;
	bool bVar1;
...
void func_360(int iParam0)//Position - 0x2A145
{
...
void func_361(var uParam0, vector3 vParam1)//Position - 0x2A194
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_362()//Position - 0x2A271
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			switch (Local_112.f_10)
			{
				...
				case 15:
					...
					{
						if ((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_254[0 /*6*/], 0) && func_112(Local_254[0 /*6*/], Local_254[0 /*6*/].f_1, 3f)) && func_369(ENTITY::GET_ENTITY_HEADING(Local_254[0 /*6*/]), Local_254[0 /*6*/].f_4, 20f))
						{
				...
				case 16:
					...
					else if (((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_254[0 /*6*/], 0) || PED::IS_PED_BEING_JACKED(Local_112.f_9)) || !func_112(Local_254[0 /*6*/], Local_254[0 /*6*/].f_1, 3f)) || !func_369(ENTITY::GET_ENTITY_HEADING(Local_254[0 /*6*/]), Local_254[0 /*6*/].f_4, 20f))
					{
						Local_112.f_10 = 13;
					}
...
bool func_363(int iParam0, int iParam1)//Position - 0x2B3DC
{
	return (MISC::GET_FRAME_COUNT() - iParam0) > iParam1;
}

int func_364()//Position - 0x2B3EE
{
	int iVar0;
	int iVar1;
...
var func_365()//Position - 0x2B474
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

int func_366()//Position - 0x2B484
{
	if (!iLocal_418)
	{
		return 1;
...
int func_367(int iParam0, int iParam1, float fParam2, bool bParam3, float fParam4, float fParam5, bool bParam6)//Position - 0x2B4F1
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_368(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2B6A7
{
	int iVar0;
...
int func_369(float fParam0, float fParam1, float fParam2)//Position - 0x2B79E
{
...
char* func_370()//Position - 0x2B7BA
{
	return "move_m@bail_bond_not_tazered";
}

char* func_371()//Position - 0x2B7C6
{
	return "move_m@bail_bond_tazered";
}

int func_372()//Position - 0x2B7D2
{
...
void func_373(var uParam0, bool bParam1)//Position - 0x2B807
{
...
void func_374(int iParam0, var uParam1, float fParam2, int iParam3)//Position - 0x2B81E
{
	if (func_433(iParam0))
	{
...
bool func_375(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2B84A
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
...
int func_376(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x2B90B
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_377(int iParam0, int iParam1)//Position - 0x2BA37
{
	int iVar0;
...
int func_379(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2BB46
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_380(vector3 vParam0, vector3 vParam3)//Position - 0x2BBD7
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

int func_381(int iParam0, int iParam1)//Position - 0x2BBF8
{
	int iVar0;
...
void func_382(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2BC37
{
	if (func_433(iParam0))
	{
...
void func_383()//Position - 0x2BC63
{
	if (func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_689, 100f))
	{
		if (!func_384())
		{
			CUTSCENE::REQUEST_CUTSCENE(&vLocal_677, 8);
			func_67();
			iLocal_453 = 1;
		}
	}
	...
	{
		if (!func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_689, 120f))
		{
			if (CUTSCENE::HAS_CUTSCENE_LOADED())
			{
				CUTSCENE::REMOVE_CUTSCENE();
...
bool func_384()//Position - 0x2BCED
{
	return Global_96008;
}

void func_385()//Position - 0x2BCF9
{
	func_37();
	func_383();
	if (func_23(Local_112.f_9))
...
void func_386()//Position - 0x2BFF5
{
	int iVar0;
	int iVar1;
...
int func_387(int iParam0)//Position - 0x2C474
{
	int iVar0;
...
void func_388(char* sParam0, int iParam1)//Position - 0x2C4AD
{
	if (func_325(sParam0))
	{
...
void func_389(int iParam0)//Position - 0x2C4C4
{
...
void func_390()//Position - 0x2C4FF
{
	func_37();
	func_383();
	if (func_23(Local_112.f_9))
		...
		switch (iLocal_100)
		{
			...
			case 1:
				if (!iLocal_449)
				{
					...
					else
					{
						...
						{
							func_386();
							func_393(&Local_385, vLocal_692, &iLocal_465, 5000, 1101004800);
						}
						if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_689, 4f, 4f, 2f, 1, 1, 0))
						{
						}
				...
				if (!bLocal_446)
				{
					bLocal_446 = func_391(vLocal_692, Local_103, 180f);
				}
				if (func_316(&(Local_112.f_9)))
				{
					iLocal_454 = 1;
			...
			case 2:
				...
				else
				{
					...
					if (!bLocal_446)
					{
						bLocal_446 = func_391(vLocal_692, Local_103, 0f);
					}
					func_131(4);
				}
				break;
...
int func_391(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x2C8EC
{
	int iVar0;
...
bool func_392(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x2C9DE
{
	vector3 vVar0;
...
int func_393(int iParam0, vector3 vParam1, int iParam4, int iParam5, float fParam6)//Position - 0x2CA08
{
	vector3 vVar0;
	var uVar3;
	char[] cVar168[8];
...
void func_394(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2CA94
{
...
int func_395(vector3 vParam0, int iParam3, int iParam4)//Position - 0x2CACF
{
	int iVar0;
...
void func_396()//Position - 0x2CAFD
{
	bool bVar0;
			...
			case 1:
				...
				if (!iLocal_448)
				{
					...
					if (Local_112.f_10 == 13 || Local_112.f_10 == 14)
					{
						...
						if (func_327(Local_112.f_9, vLocal_692, bVar0, 0, 1, 170))
						{
							func_326();
							func_398(iLocal_473);
							Local_112.f_17 = MISC::GET_GAME_TIMER();
...
void func_397(bool bParam0, var uParam1)//Position - 0x2CFDE
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_398(int iParam0)//Position - 0x2D0CB
{
	int iVar0;
...
void func_399(int iParam0)//Position - 0x2D114
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_400(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x2D29E
{
	if (iParam3 == 0)
	{
...
void func_401(int iParam0)//Position - 0x2D475
{
	int iVar0;
...
void func_402()//Position - 0x2D4B4
{
	if (func_23(Local_112.f_9))
	{
...
void func_403(bool bParam0)//Position - 0x2D993
{
...
void func_404()//Position - 0x2D9B7
{
	Global_19671 = 0;
	func_405();
}

void func_405()//Position - 0x2D9C7
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
void func_406()//Position - 0x2D9EB
{
	if (!iLocal_431)
	{
		if (!func_62())
...
struct<6> func_407()//Position - 0x2DB10
{
	struct<6> Var0;
	int iVar6;
	int iVar7;
...
int func_408(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2DBBC
{
	if (iParam5 == 0)
	{
		if (HUD::IS_MESSAGE_BEING_DISPLAYED())
...
bool func_409(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2DBF9
{
...
int func_410(int iParam0, int iParam1, bool bParam2, float fParam3, float fParam4)//Position - 0x2DC4D
{
	if (func_433(iParam0))
	{
		if (!func_363(iParam1, 10))
...
int func_411(var uParam0)//Position - 0x2DCB3
{
...
int func_412(int iParam0, vector3 vParam1, float fParam4)//Position - 0x2DCCD
{
	vector3 vVar0;
	float fVar3;
...
void func_413()//Position - 0x2DCFC
{
	switch (iLocal_100)
	{
		case 0:
...
void func_414(var uParam0, var uParam1)//Position - 0x2DF29
{
	if (!uParam0->f_7)
	{
...
char* func_415(int iParam0)//Position - 0x2DFBA
{
	switch (iParam0)
	{
		case 0:
...
char* func_416(int iParam0)//Position - 0x2DFFF
{
	switch (iParam0)
	{
		case 0:
...
int func_417(int iParam0, int iParam1, int iParam2)//Position - 0x2E042
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_418(int iParam0)//Position - 0x2E12C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_419(int iParam0)//Position - 0x2E190
{
	switch (iParam0)
	{
		case 0:
...
void func_420()//Position - 0x2E1CD
{
	if (bLocal_442)
	{
...
void func_421()//Position - 0x2E22A
{
	if (bLocal_442)
	{
...
void func_422()//Position - 0x2E274
{
	...
	if (iLocal_98 == 0)
	{
		if (!SYSTEM::VDIST2(vLocal_692, Local_103) <= ((Local_103.f_3 + 25f) * (Local_103.f_3 + 25f)))
		{
...
int func_423(bool bParam0)//Position - 0x2E3B3
{
	if (func_23(Local_385))
	{
...
int func_424(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x2E50B
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_425(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x2E606
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_426(int iParam0, float fParam1)//Position - 0x2E712
{
	var uVar0;
	vector3 vVar1;
...
int func_427(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0x2E7A7
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_428(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x2E835
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_429(int iParam0, float fParam1)//Position - 0x2E87D
{
	float fVar0;
...
bool func_430(int iParam0, float fParam1)//Position - 0x2E8F3
{
	return func_375(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

int func_431(int iParam0)//Position - 0x2E90B
{
...
void func_432(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)//Position - 0x2E933
{
...
int func_433(int iParam0)//Position - 0x2E961
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
bool func_434(bool bParam0)//Position - 0x2E982
{
...
void func_435(int iParam0, bool bParam1)//Position - 0x2E9AD
{
	func_445(bParam1, 1);
	if (bParam1)
	{
...
void func_436()//Position - 0x2EA3C
{
	func_437(1, 0);
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
void func_437(bool bParam0, bool bParam1)//Position - 0x2EAAE
{
	HUD::CLEAR_PRINTS();
	if (HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
	{
...
void func_438(bool bParam0)//Position - 0x2EBCC
{
	if (bParam0)
	{
...
void func_439()//Position - 0x2EBF2
{
	STREAMING::REMOVE_ANIM_SET(func_370());
	STREAMING::REMOVE_ANIM_SET(func_371());
}

void func_440(bool bParam0, int iParam1, int iParam2)//Position - 0x2EC0A
{
	bool bVar0;
...
void func_441(int iParam0)//Position - 0x2EC69
{
	Global_96005 = iParam0;
}

void func_442(bool bParam0)//Position - 0x2EC77
{
	if (bParam0)
	{
...
void func_443(bool bParam0)//Position - 0x2ED53
{
	if (bParam0)
	{
		func_444();
...
void func_444()//Position - 0x2EDB6
{
...
void func_445(bool bParam0, bool bParam1)//Position - 0x2EDDF
{
	if (bParam0)
	{
		func_440(0, 1, 1);
...
void func_446(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x2EE12
{
	if (func_520())
	{
...
void func_447(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2EEA7
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_493(vParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_174(vParam1, 0f, 0f, 0f, 0))
...
int func_448(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)//Position - 0x2F03B
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
void func_449(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2FE7F
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_450(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x30A96
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_451(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x30B09
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_452(int iParam0)//Position - 0x31FFB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_453(int iParam0, bool bParam1, var uParam2)//Position - 0x320AB
{
	int iVar0;
	bool bVar1;
...
int func_454(int iParam0)//Position - 0x32219
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
...
int func_455(int iParam0)//Position - 0x32260
{
	switch (iParam0)
	{
		case 0:
...
int func_456(int iParam0)//Position - 0x32628
{
...
int func_457(int iParam0)//Position - 0x3266A
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case -32236122:
...
int func_458(int iParam0)//Position - 0x3270D
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
...
int func_459(int iParam0)//Position - 0x32754
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
...
int func_460(int iParam0)//Position - 0x3279A
{
	switch (iParam0)
	{
		case -2118308144:
...
int func_461(int iParam0)//Position - 0x327CF
{
...
int func_462(int iParam0)//Position - 0x327FE
{
...
int func_463(int iParam0)//Position - 0x328BB
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		return 0;
...
int func_464(int iParam0)//Position - 0x328F1
{
	switch (iParam0)
	{
		case 562680400:
...
int func_465(int iParam0, bool bParam1)//Position - 0x3294A
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_466(int iParam0)//Position - 0x329A5
{
	int iVar0;
...
int func_467(int iParam0, int iParam1)//Position - 0x329DF
{
	if (iParam1 == 0)
	{
...
bool func_468()//Position - 0x32D53
{
	return DLC::IS_DLC_PRESENT(1927191088);
}

bool func_469()//Position - 0x32D64
{
	return DLC::IS_DLC_PRESENT(2067165443);
}

bool func_470()//Position - 0x32D75
{
	return DLC::IS_DLC_PRESENT(-957277403);
}

bool func_471()//Position - 0x32D86
{
	return DLC::IS_DLC_PRESENT(210122941);
}

bool func_472()//Position - 0x32D97
{
	return DLC::IS_DLC_PRESENT(-1894522408);
}

bool func_473()//Position - 0x32DA8
{
	return DLC::IS_DLC_PRESENT(1630677557);
}

int func_474(int iParam0, int iParam1)//Position - 0x32DB9
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_475(int iParam0)//Position - 0x3312F
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
...
int func_476(int iParam0)//Position - 0x3318E
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
...
int func_477(int iParam0)//Position - 0x331EE
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
...
int func_478(int iParam0, bool bParam1, var uParam2)//Position - 0x33235
{
	bool bVar0;
...
int func_479(int iParam0)//Position - 0x33674
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_480(int iParam0, int iParam1)//Position - 0x3369D
{
	int iVar0;
...
void func_481(int iParam0)//Position - 0x3371F
{
	if (!func_482(*iParam0))
	{
...
bool func_482(int iParam0)//Position - 0x3374A
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_483(int iParam0, var uParam1, var uParam2)//Position - 0x33759
{
	int iVar0;
	int iVar1;
...
int func_484(int iParam0)//Position - 0x3391C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_485(var uParam0)//Position - 0x339F8
{
...
int func_486(int iParam0, int iParam1)//Position - 0x33A38
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_487(var uParam0, int iParam1)//Position - 0x33B1D
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_488(int iParam0, int iParam1)//Position - 0x33B5E
{
	int iVar0;
...
void func_489(vector3 vParam0, float fParam3, bool bParam4)//Position - 0x33BFC
{
	int iVar0;
...
void func_490(int iParam0)//Position - 0x33C4C
{
	bool bVar0;
...
int func_491(int iParam0, int iParam1)//Position - 0x33DBE
{
	int iVar0;
...
int func_492(var uParam0)//Position - 0x33E30
{
	return *uParam0;
}

int func_493(vector3 vParam0, float fParam3)//Position - 0x33E3B
{
	return func_494(&(Global_105109.f_2890), vParam0, fParam3, 0);
}

int func_494(var uParam0, vector3 vParam1, float fParam4, bool bParam5)//Position - 0x33E55
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
int func_495(int iParam0)//Position - 0x34108
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_496(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x341CB
{
	int iVar0;
	var uVar1[3];
	int iVar5;
...
int func_497(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x343D3
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_498(int iParam0, int iParam1, bool bParam2)//Position - 0x3444E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_499(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x344AF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_500(int iParam0, int iParam1)//Position - 0x34A71
{
	int iVar0;
	int iVar1;
...
bool func_501()//Position - 0x34AE9
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_502(int iParam0)//Position - 0x34AFA
{
	int iVar0;
...
int func_503(int iParam0)//Position - 0x34B45
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
int func_504(int iParam0)//Position - 0x34BCC
{
...
int func_505(int iParam0)//Position - 0x34BFB
{
...
int func_506(int iParam0)//Position - 0x34C18
{
...
int func_507(int iParam0, int iParam1)//Position - 0x34C3B
{
...
int func_508(int iParam0)//Position - 0x34C76
{
	if (func_507(iParam0, 0))
	{
...
int func_509(int iParam0, int iParam1)//Position - 0x34C99
{
	int iVar0;
...
int func_510(var uParam0)//Position - 0x34CE6
{
	if (func_511(uParam0))
	{
...
int func_511(var uParam0)//Position - 0x34D1B
{
...
bool func_512()//Position - 0x34D7A
{
	return func_510(&(Global_105109.f_2890));
}

void func_513()//Position - 0x34D8D
{
	func_514(&(Global_105109.f_2890));
}

void func_514(var uParam0)//Position - 0x34DA0
{
	if (func_511(uParam0))
	{
...
int func_515(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x34DBE
{
...
int func_517(int iParam0)//Position - 0x34EC1
{
	switch (iParam0)
	{
		case joaat("police"):
...
bool func_518()//Position - 0x34F1A
{
	return func_511(&(Global_105109.f_2890));
}

int func_519()//Position - 0x34F2D
{
...
void func_521()//Position - 0x34F7B
{
	vector3 vVar0;
	vector3 vVar3;
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, iLocal_664);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_664, 1862763509);
	vVar0 = { func_528(Local_103) };
	vVar3 = { func_527(Local_103) };
	PED::SET_PED_NON_CREATION_AREA(vVar0, vVar3);
	iLocal_482 = PED::ADD_SCENARIO_BLOCKING_AREA(vVar0, vVar3, 0, 1, 1, 1);
	MISC::CLEAR_AREA(Local_103, 15f, 0, 0, 0, false);
...
void func_522()//Position - 0x350C0
{
	int iVar0;
...
void func_523(var uParam0, char* sParam1, int iParam2)//Position - 0x35572
{
	char cVar0[16];
...
int func_525(var uParam0, int iParam1, vector3 vParam2, int iParam5, int iParam6, bool bParam7)//Position - 0x357D5
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_56(iParam6))
...
int func_526(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0x35846
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_56(iParam1))
...
Vector3 func_527(struct<5> Param0, var uParam5, var uParam6, var uParam7)//Position - 0x358E5
{
	switch (Param0.f_4)
	{
		case 0:
...
Vector3 func_528(struct<5> Param0, var uParam5, var uParam6, var uParam7)//Position - 0x35959
{
	switch (Param0.f_4)
	{
		case 0:
...
void func_529()//Position - 0x359CD
{
	int iVar0;
...
float func_530()//Position - 0x35E18
{
	return 75.15f;
}

Vector3 func_531()//Position - 0x35E25
{
	return 2727.29f, 4145.9f, 44.16f;
}

float func_532()//Position - 0x35E3C
{
	return 71f;
}

Vector3 func_533()//Position - 0x35E49
{
	return 2727.686f, 4145.715f, 44.08f;
}

int func_534()//Position - 0x35E60
{
	return 1385417869;
}

float func_535()//Position - 0x35E6D
{
	return -91.28f;
}

Vector3 func_536()//Position - 0x35E7A
{
	return 2728.35f, 4145.59f, 43.3f;
}

int func_537()//Position - 0x35E91
{
	return -741944541;
}

float func_538()//Position - 0x35E9E
{
	return 89.19f;
}

Vector3 func_539()//Position - 0x35EAB
{
	return 2728.33f, 4145.6f, 43.89f;
}

int func_540(int iParam0)//Position - 0x35EC2
{
	if (!func_89(iParam0))
	{
		return func_92(iParam0);
...
int func_541(bool bParam0)//Position - 0x35EE8
{
...
int func_545(int iParam0)//Position - 0x36020
{
	int iVar0;
...
var func_546()//Position - 0x3673D
{
	return Global_98708.f_1;
}

int func_547()//Position - 0x3674B
{
	if (Global_95621 != -1)
	{
...
bool func_548()//Position - 0x36771
{
	return Global_98721.f_346 > 0;
}

bool func_549()//Position - 0x36782
{
	return Global_98721.f_345 > 0;
}

var func_550()//Position - 0x36793
{
	return Global_1312873;
}

bool func_551(int iParam0)//Position - 0x3679F
{
	return func_552(iParam0, Global_41396);
}

int func_552(int iParam0, int iParam1)//Position - 0x367B0
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_553(int iParam0)//Position - 0x36991
{
	func_578();
	if (!func_577())
	{
...
void func_554(char* sParam0)//Position - 0x369DC
{
	if (Global_98669 != 12)
	{
...
int func_555(char* sParam0, int iParam1, int iParam2)//Position - 0x369F9
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_566())
	{
		...
		{
			iVar33 = func_556(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_556(char* sParam0)//Position - 0x36B8B
{
...
void func_557(int iParam0, var uParam1)//Position - 0x36BE1
{
	switch (iParam0)
	{
		case 0:
...
void func_558(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, var uParam22, int iParam23, int iParam24)//Position - 0x37D96
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_559(int iParam0)//Position - 0x37E27
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_560(int iParam0)//Position - 0x3816F
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_561(int iParam0)//Position - 0x381A6
{
	struct<2> Var0;
...
int func_563(char* sParam0, bool bParam1)//Position - 0x38616
{
	int iVar0;
	int iVar1;
...
int func_564(int iParam0, bool bParam1)//Position - 0x38640
{
	int iVar0;
...
void func_567(int iParam0)//Position - 0x38732
{
	if (iParam0 == 1)
	{
		Global_41945 = 1;
...
void func_568(bool bParam0)//Position - 0x3874B
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_569(int iParam0)//Position - 0x3875F
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_570(int iParam0)//Position - 0x3879C
{
	if (iParam0 == 1)
	{
...
void func_571()//Position - 0x387D9
{
	Global_22211.f_5 = 1;
}

void func_572()//Position - 0x387E7
{
	Global_22211.f_5 = 0;
}

void func_573()//Position - 0x387F5
{
	Global_92875 = 0;
	Global_92876 = 0;
}

void func_574()//Position - 0x38807
{
	Global_98669 = 13;
	Global_98669.f_1 = -1;
	Global_98669.f_2 = 0;
...
void func_578()//Position - 0x388F2
{
	Global_98704 = 1;
...
void func_579()//Position - 0x389DF
{
	if (iLocal_451)
	{
		func_437(0, 1);
