...
bool func_13(int iParam0)//Position - 0x9FE
{
	return func_14(iParam0, 20);
}

bool func_14(int iParam0, int iParam1)//Position - 0xA0E
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_15()//Position - 0xA29
{
	return -1;
}

void func_16()//Position - 0xA32
{
	int iVar0;
...
bool func_22(int iParam0, int iParam1)//Position - 0xCB3
{
	switch (iParam0)
	{
		case 5:
...
void func_24(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD45
{
	...
	switch (iLocal_55)
	{
		case 0:
			...
			if (iVar0 == 1)
			{
				...
				MISC::CLEAR_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_76, true), 20f, 1, 0, 0, false);
			...
			if (!PED::IS_PED_INJURED(iLocal_75) && !PED::IS_PED_INJURED(iLocal_76))
			{
				if (func_76(&uLocal_88, "RECRAAU", "RECRA_ARRIV", "RECRA_ARRIV_1", 3, 0, 0))
				{
					...
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						...
						{
							ENTITY::SET_ENTITY_COORDS(iVar1, vLocal_60, 1, false, 0, 1);
							ENTITY::SET_ENTITY_HEADING(iVar1, 119f);
						}
					...
					ENTITY::SET_ENTITY_COORDS(iLocal_75, 1738.047f, 3842.438f, 33.7707f, 1, false, 0, 1);
					ENTITY::SET_ENTITY_HEADING(iLocal_75, 36.8203f);
					PED::_0x2208438012482A1A(iLocal_75, 0, 0);
					MISC::CLEAR_AREA(vLocal_60, 4f, 1, 0, 0, false);
					func_66(&iVar1);
					iLocal_271 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_80, vLocal_83, 2);
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_75, iLocal_271, sLocal_269, "helping_friend_inside_victim", 1000f, -1000f, 0, 0, 1148846080, 0);
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_76, iLocal_271, sLocal_269, "helping_friend_inside_friend", 1000f, -1000f, 0, 0, 1148846080, 0);
...
void func_28()//Position - 0x11D7
{
	func_29();
}

int func_29()//Position - 0x11E4
{
	if (func_30(0))
	{
		return 0;
...
bool func_30(bool bParam0)//Position - 0x122F
{
...
void func_31(int iParam0, int iParam1)//Position - 0x125A
{
	if (iParam0 == -1)
	{
		iParam0 = func_49();
...
void func_32(int iParam0)//Position - 0x135E
{
	Global_111546 = iParam0;
}

void func_33(int iParam0, var uParam1, var uParam2)//Position - 0x136C
{
	bool bVar0;
...
int func_35()//Position - 0x1915
{
	return Global_30736;
}

int func_36(int iParam0, int iParam1)//Position - 0x1920
{
	int iVar0;
...
int func_37(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1971
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_38()//Position - 0x1FC3
{
	return Global_1312745;
}

int func_39(int iParam0, int iParam1)//Position - 0x1FCF
{
	switch (iParam0)
	{
		case 0:
...
int func_40(int iParam0)//Position - 0x2343
{
	switch (iParam0)
	{
		case 29:
...
void func_41(int iParam0)//Position - 0x2372
{
	int iVar0;
	int iVar1;
...
void func_42(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x23B4
{
	func_43(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_43(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x23D6
{
	int iVar0;
...
int func_46(int iParam0)//Position - 0x2710
{
	int iVar0;
	int iVar1;
...
void func_47(int iParam0, int iParam1)//Position - 0x2753
{
	MISC::SET_BIT(&(Global_111560.f_24990.f_8[iParam0]), iParam1);
}

int func_48(int iParam0)//Position - 0x276E
{
	int iVar0;
...
int func_50(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x283C
{
...
int func_51()//Position - 0x2A16
{
	return 1;
}

void func_52(int iParam0, bool bParam1)//Position - 0x2A1F
{
	int iVar0;
...
int func_55(int iParam0)//Position - 0x2B70
{
...
int func_56(int iParam0)//Position - 0x2B9F
{
...
void func_57(int iParam0, bool bParam1)//Position - 0x2BCB
{
	int iVar0;
	char* sVar1;
...
var func_58(int iParam0)//Position - 0x2CC9
{
	return func_59(iParam0);
}

char* func_59(int iParam0)//Position - 0x2CD7
{
	switch (iParam0)
	{
		case 1:
...
int func_60(int iParam0)//Position - 0x2DBA
{
	return Global_94574[iParam0 /*5*/];
}

void func_61(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2DCA
{
	int iVar0;
...
int func_62(int iParam0)//Position - 0x2E73
{
	if (func_25(iParam0))
	{
...
int func_64(int iParam0)//Position - 0x2ED4
{
...
void func_66(int iParam0)//Position - 0x2F50
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_67(int iParam0)//Position - 0x2F88
{
	vector3 vVar0[2];
	vector3 vVar7;
...
Vector3 func_68()//Position - 0x3006
{
	return 2.55f, 5.665f, 2.55f;
}

void func_69(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x301D
{
	if (bParam0)
	{
...
bool func_70()//Position - 0x3156
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_71(int iParam0, int iParam1)//Position - 0x3173
{
	bool bVar0;
...
int func_72(int iParam0, bool bParam1)//Position - 0x31BE
{
	int iVar0;
	int iVar1;
...
int func_73(int iParam0)//Position - 0x31FF
{
...
bool func_74()//Position - 0x3241
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

void func_75(int iParam0)//Position - 0x3252
{
	if (iParam0 == 1)
	{
...
bool func_76(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x3275
{
...
void func_77(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x32C9
{
	int iVar0;
...
void func_78(int iParam0, bool bParam1)//Position - 0x3487
{
...
Vector3 func_79(int iParam0)//Position - 0x34C3
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_80(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x34D6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_81(int iParam0, int iParam1, int iParam2)//Position - 0x3CEC
{
	int iVar0;
...
int func_82(int iParam0)//Position - 0x3D78
{
	switch (iParam0)
	{
...
void func_83(int iParam0, int iParam1, int iParam2)//Position - 0x3DB3
{
	int iVar0;
	int iVar1;
...
int func_84(int iParam0, int iParam1, int iParam2)//Position - 0x3E3D
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_85(int iParam0, int iParam1, int iParam2)//Position - 0x3F1B
{
	Global_76389[1 /*14*/] = { func_130(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 2);
}

int func_86(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x3F46
{
	var uVar0;
	int iVar10;
...
int func_87(int iParam0, int iParam1, int iParam2)//Position - 0x454C
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x45E5
{
	int iVar0;
...
int func_89(int iParam0, int iParam1, int iParam2)//Position - 0x467B
{
	int iVar0;
	int iVar1;
...
int func_90(int iParam0)//Position - 0x471C
{
	switch (iParam0)
	{
		case 0:
...
int func_91(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x47CC
{
	int iVar0;
...
int func_92(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x4AD3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_93(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x5686
{
	int iVar0;
...
int func_94(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x596A
{
	int iVar0;
...
int func_95(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5C31
{
	int iVar0;
	int iVar1;
...
int func_96(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5C68
{
	int iVar0;
...
int func_97(int iParam0, int iParam1, int iParam2)//Position - 0x5C91
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_98(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5F5B
{
	int iVar0;
...
int func_99(int iParam0, int iParam1, int iParam2)//Position - 0x61E5
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x633C
{
	int iVar0;
...
int func_101(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x63D4
{
	switch (iParam0)
	{
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x64A2
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_103(int iParam0, int iParam1)//Position - 0x65FE
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_104(int iParam0)//Position - 0x69A5
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_105(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6A06
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_106(int iParam0, int iParam1)//Position - 0x6B02
{
	int iVar0;
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6C40
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_108(int iParam0)//Position - 0x6D20
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_109(int iParam0, int iParam1)//Position - 0x6DA6
{
	int iVar0;
	struct<10> Var1;
...
void func_110(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x76D5
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_111(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x77FF
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_112(int iParam0, int iParam1)//Position - 0x7847
{
	int iVar0;
	struct<17> Var1;
...
void func_113(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9691
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_114(int iParam0)//Position - 0x987B
{
	switch (iParam0)
	{
		case 0:
...
void func_115(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x992B
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_116(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x999C
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_117(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9C19
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_118(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA03E
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_119(int iParam0, int iParam1)//Position - 0xA331
{
	int iVar0;
	int iVar1;
...
int func_120(int iParam0, int iParam1)//Position - 0xA377
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_121(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA3D7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_122(int iParam0)//Position - 0xA45B
{
...
void func_123(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xA513
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_124(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xA55D
{
	int iVar0;
...
int func_125(var uParam0)//Position - 0xA58D
{
	int iVar0;
	int iVar1;
...
int func_126(int iParam0, int iParam1, int iParam2)//Position - 0xA5C1
{
	int iVar0;
	var uVar1;
...
bool func_127(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xA5F3
{
	int iVar0;
...
int func_128(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xC653
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_129(int iParam0)//Position - 0xD571
{
	if (!MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_130(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD5C2
{
	func_193();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_131(int iParam0, int iParam1)//Position - 0xD614
{
	switch (iParam0)
	{
		case 0:
...
void func_132(int iParam0)//Position - 0xD704
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xE97B
{
	int iVar0;
	int iVar1;
...
bool func_134(int iParam0, int iParam1, var uParam2)//Position - 0xED0C
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_135(int iParam0, int iParam1)//Position - 0xF111
{
	switch (iParam1)
	{
		case 0:
...
int func_136(int iParam0, int iParam1)//Position - 0xF50C
{
	switch (iParam1)
	{
		case 0:
...
int func_137(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xF907
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_138(int iParam0)//Position - 0xF949
{
	switch (iParam0)
	{
		case -1:
...
void func_139(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xFA1D
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
...
void func_140(int iParam0)//Position - 0xFCF6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0xFE4D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x1035D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x103D2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x10446
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x1052D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x10890
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x10AA1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x10CD1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x10DE1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x11780
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x122F3
{
	if (iParam0 < 136)
	{
		func_153(iParam0);
...
void func_152(int iParam0)//Position - 0x12328
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x12F2C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x13E3A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x13F67
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0, int iParam1)//Position - 0x14067
{
	switch (iParam0)
	{
		case 0:
...
void func_157(int iParam0)//Position - 0x14157
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x15648
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x15799
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x15CA4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x16312
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0x16386
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x16456
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x16986
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x16B1D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x1731B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x1742B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x18357
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x19014
{
	if (iParam0 < 107)
	{
		func_172(iParam0);
...
void func_170(int iParam0)//Position - 0x1905A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x19AFF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x1A8EE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x1B537
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x1B7B0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0, int iParam1)//Position - 0x1B8F6
{
	switch (iParam0)
	{
		case 0:
...
void func_176(int iParam0)//Position - 0x1B9E6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_177(int iParam0)//Position - 0x1C772
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x1C8EC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_179(int iParam0)//Position - 0x1CE63
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180(int iParam0)//Position - 0x1D38D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_181(int iParam0)//Position - 0x1D401
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_182(int iParam0)//Position - 0x1D4D1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_183(int iParam0)//Position - 0x1D9A9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_184(int iParam0)//Position - 0x1DC12
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_185(int iParam0)//Position - 0x1DEE8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_186(int iParam0)//Position - 0x1E0B1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_187(int iParam0)//Position - 0x1EC05
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_188(int iParam0)//Position - 0x1F84F
{
	if (iParam0 < 60)
	{
		func_190(iParam0);
...
void func_189(int iParam0)//Position - 0x1F884
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_190(int iParam0)//Position - 0x20626
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_191(int iParam0)//Position - 0x20CB2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_192(int iParam0)//Position - 0x20D99
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_193()//Position - 0x20E97
{
...
int func_194(int iParam0, int iParam1, int iParam2)//Position - 0x20F10
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_195(bool bParam0)//Position - 0x2116B
{
	int iVar0;
...
void func_197(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x211C2
{
	func_198(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_198(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x211EB
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_199(vector3 vParam0)//Position - 0x215DF
{
...
int func_200(int iParam0, int iParam1, bool bParam2)//Position - 0x21609
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_201(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2167A
{
...
int func_202(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x21753
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_203(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x21A49
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_204(vector3 vParam0)//Position - 0x21AFD
{
	float fVar0;
	float fVar1;
...
void func_205(int iParam0)//Position - 0x21B3C
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
int func_206(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x21BA1
{
...
void func_207(int iParam0)//Position - 0x21D30
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
int func_208(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x21D5C
{
	int iVar0;
...
void func_209()//Position - 0x21D8F
{
	if (!PED::IS_PED_INJURED(iLocal_75))
	{
		...
		else if (MISC::GET_GAME_TIMER() < iLocal_284)
		{
			...
			if (func_221())
			{
				...
				if (bLocal_256)
				{
					...
					else if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_60, Global_19, true, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1722.09f, 3843f, 33.6f, 1740.11f, 3854.94f, 39.22f, 12f, 0, true, 0))
					{
						iLocal_54 = 1;
						iLocal_55 = 0;
					}
...
void func_212()//Position - 0x22186
{
	if (!bLocal_256 && func_220(PLAYER::PLAYER_PED_ID(), vLocal_60, 150f))
	{
		...
		{
			iLocal_257 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(1728.778f, 3851.287f, 33.7826f, 5f, joaat("prop_skid_chair_01"), 1, 0, 1);
			...
			iLocal_271 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_80, vLocal_83, 2);
			TASK::TASK_SYNCHRONIZED_SCENE(iLocal_76, iLocal_271, sLocal_269, "helping_friend_idle_friend", 1000f, -1000f, 0, 0, 1148846080, 0);
			bLocal_256 = true;
		}
	}
}

void func_213(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x222A0
{
...
bool func_214(int iParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x2233B
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam3), ENTITY::GET_ENTITY_COORDS(iParam1, bParam3)) <= (fParam2 * fParam2);
}

int func_215(vector3 vParam0, bool bParam3)//Position - 0x2235D
{
	return func_216(vParam0, bParam3);
}

int func_216(vector3 vParam0, bool bParam3)//Position - 0x2236F
{
	int iVar0;
...
float func_217(bool bParam0, float fParam1, float fParam2)//Position - 0x2239B
{
	if (bParam0)
	{
		return fParam1;
...
void func_218()//Position - 0x223B2
{
...
void func_219(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x22400
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
bool func_220(int iParam0, vector3 vParam1, float fParam4)//Position - 0x22450
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, true), vParam1) <= (fParam4 * fParam4);
}

int func_221()//Position - 0x2246D
{
...
int func_222(int iParam0, bool bParam1, int iParam2)//Position - 0x2254F
{
	var uVar0;
...
int func_223(int iParam0)//Position - 0x225B4
{
	return func_224(iParam0);
}

int func_224(int iParam0)//Position - 0x225C2
{
	return func_225(iParam0, 1, 0);
}

int func_225(int iParam0, bool bParam1, bool bParam2)//Position - 0x225D2
{
	int iVar0;
...
int func_226(int iParam0, bool bParam1, int iParam2)//Position - 0x22676
{
	iParam2 = iParam2;
	return func_227(iParam0, bParam1, 0);
}

int func_227(int iParam0, bool bParam1, bool bParam2)//Position - 0x2268B
{
	return func_225(iParam0, !bParam1, bParam2);
}

int func_228(int iParam0, bool bParam1, int iParam2)//Position - 0x2269E
{
	iParam2 = iParam2;
	return func_229(iParam0, bParam1, 145);
}

int func_229(int iParam0, bool bParam1, int iParam2)//Position - 0x226B4
{
	int iVar0;
...
void func_233()//Position - 0x2285A
{
	switch (iLocal_56)
	{
		case 0:
...
void func_234(int iParam0, bool bParam1)//Position - 0x231AA
{
	if (!func_339())
	{
		if (iLocal_278)
...
void func_236()//Position - 0x2320A
{
	vector3 vVar0;
	char* sVar3;
	...
	switch (iLocal_71)
	{
		...
		case 1:
			if (!PED::IS_PED_INJURED(iLocal_75))
			{
				...
				MISC::GET_GROUND_Z_FOR_3D_COORD(vLocal_80, &(vLocal_80.f_2), 0, 0);
				vLocal_83 = { func_241() };
				vLocal_83.z = func_240((fLocal_275 + 180f), 0f, 360f);
				...
				MISC::CLEAR_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_75, true), 5f, 1, 0, 0, false);
				...
				iLocal_280 = GRAPHICS::ADD_DECAL(1110, vLocal_272, 0f, 0f, -1f, func_204(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
				...
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_75, iLocal_270, sLocal_263, "HELPING_VICTIM_TO_FEET_VICTIM", 1000f, -4f, 0, 0, 1148846080, 0);
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_270, false);
		...
		case 4:
			...
			if (iLocal_254)
			{
				...
				PED::FORCE_PED_MOTION_STATE(iLocal_75, -1871534317, false, 0, 0);
				PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
				PED::_0x2208438012482A1A(iLocal_75, 0, 0);
				...
				MISC::GET_GROUND_Z_FOR_3D_COORD(vVar0, &(vVar0.f_2), 0, 0);
				ENTITY::SET_ENTITY_COORDS(iLocal_75, vVar0, 1, false, 0, 1);
			...
			PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_253, 0);
			iLocal_253 = PED::ADD_SCENARIO_BLOCKING_AREA(Vector(33.813f, 3847.646f, 1731.052f) + Vector(-5f, -20f, -20f), Vector(33.813f, 3847.646f, 1731.052f) + Vector(5f, 25f, 35f), 0, 1, 1, 1);
...
int func_237(int iParam0, float fParam1)//Position - 0x237EE
{
	int iVar0;
	int iVar1;
	var uVar2;
...
void func_238(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)//Position - 0x2384A
{
...
float func_240(float fParam0, float fParam1, float fParam2)//Position - 0x239A3
{
	float fVar0;
...
Vector3 func_241()//Position - 0x239E5
{
	return 0f, 0f, 0f;
}

void func_242()//Position - 0x239F0
{
...
int func_243(int iParam0)//Position - 0x23BDC
{
	if (func_247())
	{
		Global_111550 = 1;
...
void func_244(int iParam0)//Position - 0x23C2F
{
	switch (iParam0)
	{
		case 0:
...
void func_245(char[4] cParam0, int iParam1)//Position - 0x23D10
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

char* func_246(int iParam0)//Position - 0x23D27
{
	char* sVar0;
...
int func_248(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x23DA1
{
	int iVar0;
...
void func_249(var uParam0, int iParam1)//Position - 0x23ED8
{
	int iVar0;
...
bool func_250(int iParam0)//Position - 0x23F27
{
	return func_251(iParam0, Global_41396);
}

int func_251(int iParam0, int iParam1)//Position - 0x23F38
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_252(int iParam0)//Position - 0x24124
{
	if (Global_41396 == 15)
	{
		return 0;
...
int func_254(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x24171
{
	int iVar0;
	bool bVar1;
...
void func_255()//Position - 0x241C3
{
	Global_19671 = 0;
	func_256();
}

void func_256()//Position - 0x241D3
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
int func_257(bool bParam0, bool bParam1, bool bParam2)//Position - 0x241F7
{
	int iVar0;
...
void func_258(bool bParam0)//Position - 0x242DC
{
	if (bParam0)
	{
		func_259(1);
...
void func_259(bool bParam0)//Position - 0x242F6
{
	if (bParam0)
	{
...
void func_261()//Position - 0x243C8
{
	var uVar0;
	vector3 vVar3;
	...
	if (((((((((STREAMING::HAS_MODEL_LOADED(iLocal_258) && STREAMING::HAS_MODEL_LOADED(iLocal_260)) && STREAMING::HAS_MODEL_LOADED(iLocal_259)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_261)) && STREAMING::HAS_CLIP_SET_LOADED(sLocal_262)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_265)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_266)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_267)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_264)) && STREAMING::HAS_PTFX_ASSET_LOADED())
	{
		...
		VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_79, false, false, 0);
		...
		VEHICLE::SET_VEHICLE_DAMAGE(iLocal_79, 0f, vVar3.y, 0f, 500f, 10000f, 1);
		VEHICLE::SET_VEHICLE_DAMAGE(iLocal_79, vVar3.x, (vVar3.y * 0.75f), 0f, 500f, 10000f, 1);
		VEHICLE::SET_VEHICLE_DAMAGE(iLocal_79, vVar3.x, 0f, 0f, 500f, 10000f, 1);
		VEHICLE::SET_VEHICLE_DAMAGE(iLocal_79, 0f, 0f, vVar3.z, 500f, 10000f, 1);
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_79, 5, 1, true);
		...
		iLocal_279 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_recrash_rescue_fire", iLocal_79, -0.45f, -1.25f, -0.5f, 0f, 0f, 0f, 1f, 0, 0, 1);
		if (bLocal_276)
		{
		...
		MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(vLocal_63.x, (vLocal_63.y + 0.1f), (vLocal_63.z + 0.1f), vLocal_63.x, (vLocal_63.y - 0.1f), (vLocal_63.z - 0.1f), 1, 1, joaat("weapon_assaultrifle"), 0, 1, 1, -1082130432);
		...
		iLocal_253 = PED::ADD_SCENARIO_BLOCKING_AREA(Vector(33.7286f, 3850.767f, 1729.311f) - Vector(3f, 25f, 25f), Vector(33.7286f, 3850.767f, 1729.311f) + Vector(3f, 25f, 25f), 0, 1, 1, 1);
		iLocal_53 = 1;
	}
}

int func_262()//Position - 0x24860
{
	if (!func_250(5))
	{
		return 1;
...
int func_263(float fParam0, bool bParam1)//Position - 0x248C2
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_264(int iParam0, var uParam1)//Position - 0x24979
{
	switch (iParam0)
	{
		case 0:
...
int func_266(int iParam0)//Position - 0x25C51
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_267(int iParam0)//Position - 0x25F97
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_268(int iParam0)//Position - 0x25FCF
{
	struct<2> Var0;
...
bool func_271()//Position - 0x2646B
{
	return Global_111278 > 0;
}

int func_272()//Position - 0x26479
{
	if (Global_95621 != -1)
	{
		return 1;
...
void func_275()//Position - 0x2653A
{
}

void func_276(int iParam0)//Position - 0x26542
{
	if (iParam0 == -1)
	{
		iParam0 = func_49();
...
void func_277()//Position - 0x26578
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
...
void func_278(int iParam0)//Position - 0x265B5
{
	Global_111549 = iParam0;
}

int func_279(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x265C3
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
...
bool func_280(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x2695D
{
	if (bParam6)
	{
...
bool func_281(int iParam0)//Position - 0x269A4
{
	int iVar0;
...
int func_282(int iParam0)//Position - 0x269C5
{
	return func_283(iParam0, 1);
}

int func_283(int iParam0, int iParam1)//Position - 0x269D4
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_284(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x26A27
{
	func_285(func_295(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_285(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x26A45
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_286(int iParam0, int iParam1)//Position - 0x26C46
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_287(int iParam0)//Position - 0x26CE8
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_288(int iParam0)//Position - 0x26CFB
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_289(int iParam0)//Position - 0x26D0E
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_290(int iParam0)//Position - 0x26D21
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_291(int iParam0)//Position - 0x26D33
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_292(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_292(bool bParam0, int iParam1, int iParam2)//Position - 0x26D58
{
	if (bParam0)
	{
		return iParam1;
...
int func_293(int iParam0)//Position - 0x26D6F
{
	return iParam0 & 15;
}

int func_294(int iParam0, int iParam1)//Position - 0x26D7C
{
	int iVar0;
	int iVar1;
...
void func_296(var uParam0, int iParam1)//Position - 0x26ECE
{
	if (iParam1 <= 0)
	{
		return;
...
void func_297(var uParam0, int iParam1)//Position - 0x26F54
{
...
void func_298(var uParam0, int iParam1)//Position - 0x26F87
{
	int iVar0;
	int iVar1;
...
void func_299(var uParam0, int iParam1)//Position - 0x26FD8
{
...
void func_300(var uParam0, int iParam1)//Position - 0x27012
{
...
void func_301(var uParam0, int iParam1)//Position - 0x2704D
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_302(int iParam0)//Position - 0x27089
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_303(int iParam0, int iParam1)//Position - 0x27165
{
...
int func_304(int iParam0)//Position - 0x27188
{
	int iVar0;
...
var func_305()//Position - 0x278A5
{
	return Global_98708.f_1;
}

int func_306()//Position - 0x278B3
{
	if (Global_95621 != -1)
	{
...
bool func_309()//Position - 0x2791D
{
	return Global_98721.f_346 > 0;
}

bool func_310()//Position - 0x2792E
{
	return Global_98721.f_345 > 0;
}

var func_311()//Position - 0x2793F
{
	return Global_1312873;
}

int func_312()//Position - 0x2794B
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_314(int iParam0)//Position - 0x2798F
{
	return func_294(func_295(), iParam0);
}

int func_315(int iParam0, int iParam1, int iParam2)//Position - 0x279A1
{
	int iVar0;
	int iVar1;
...
int func_316(int iParam0)//Position - 0x27A85
{
	if (!func_5(iParam0))
	{
		return 7;
...
bool func_317(int iParam0)//Position - 0x27AA9
{
	int iVar0;
	bool bVar1;
...
void func_322()//Position - 0x27C6E
{
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_253, 0);
	if (func_253())
	{
	...
	PATHFIND::SET_ROADS_BACK_TO_ORIGINAL(vLocal_57 - Vector(3f, 3f, 3f), vLocal_57 + Vector(3f, 3f, 3f), true);
...
void func_323(int iParam0)//Position - 0x27D16
{
	char cVar0[64];
...
void func_324(var uParam0)//Position - 0x27DCB
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_325(int iParam0, bool bParam1)//Position - 0x27E08
{
	switch (iParam0)
	{
		case 0:
...
void func_326(int iParam0)//Position - 0x28053
{
	Global_41947 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_327(int iParam0)//Position - 0x28065
{
	func_328(iParam0, 0, func_333(iParam0));
}

void func_328(int iParam0, int iParam1, int iParam2)//Position - 0x2807A
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_329(var uParam0)//Position - 0x280A9
{
	struct<16> Var0;
	int iVar16;
...
void func_330(int iParam0, var uParam1)//Position - 0x2817A
{
	Global_111560.f_24990.f_43[iParam0] = *uParam1;
}

void func_331(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x28192
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_332(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x28314
{
...
int func_333(int iParam0)//Position - 0x2834C
{
	int iVar0;
...
void func_334(int iParam0, bool bParam1)//Position - 0x284EF
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_335()//Position - 0x2852A
{
	Global_19671 = 0;
	func_336();
}

void func_336()//Position - 0x2853A
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_338(char* sParam0)//Position - 0x285D2
{
