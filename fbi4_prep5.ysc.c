...
void func_6(var uParam0, int iParam1)//Position - 0x3E2
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_8(Global_111560.f_18528[iVar0], &vVar2, &fVar5))
			{
...
var func_17(int iParam0)//Position - 0x11DF
{
	return Global_1798[iParam0 /*29*/];
}

int func_18()//Position - 0x11EE
{
	int iVar0;
...
void func_19(char* sParam0)//Position - 0x1223
{
	func_20(sParam0);
	func_4(0);
}

void func_20(char* sParam0)//Position - 0x1236
{
...
void func_21()//Position - 0x1275
{
	func_22(&iLocal_200);
}

void func_22(int iParam0)//Position - 0x1283
{
...
void func_24(int iParam0, int iParam1, int iParam2)//Position - 0x1368
{
...
void func_25(int iParam0, bool bParam1)//Position - 0x139C
{
...
void func_26(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x13D8
{
	int iVar0;
...
int func_27(int iParam0)//Position - 0x1481
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_28(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x14A2
{
	if (bParam0)
	{
...
bool func_29()//Position - 0x15DB
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_30(int iParam0, int iParam1)//Position - 0x15F8
{
	bool bVar0;
...
int func_31(int iParam0, bool bParam1)//Position - 0x1643
{
	int iVar0;
	int iVar1;
...
int func_32()//Position - 0x1684
{
	return Global_1312745;
}

int func_33(int iParam0)//Position - 0x1690
{
...
bool func_34()//Position - 0x16D2
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_35(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x16E3
{
	int iVar0;
...
void func_37(int iParam0)//Position - 0x173D
{
	if (iParam0 == 1)
	{
...
void func_38(int iParam0, vector3 vParam1, float fParam4)//Position - 0x1760
{
	if (func_236(iParam0))
	{
...
int func_39(int iParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6)//Position - 0x1786
{
	bool bVar0;
	float fVar1;
...
void func_41(bool bParam0, int iParam1)//Position - 0x1801
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_42(int iParam0)//Position - 0x18D7
{
	switch (iParam0)
	{
		case 71:
...
void func_43()//Position - 0x1915
{
	Global_19671 = 0;
	func_44();
}

void func_44()//Position - 0x1925
{
...
int func_45(var uParam0, char* sParam1, var uParam2)//Position - 0x197C
{
	switch (*uParam0)
	{
		case 0:
...
void func_46(int iParam0, int iParam1)//Position - 0x1AF1
{
...
int func_47(int iParam0)//Position - 0x1B2E
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
void func_49(bool bParam0)//Position - 0x1BAB
{
...
void func_50(char* sParam0, char* sParam1)//Position - 0x1BBF
{
	if (AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())
	{
		Global_20862 = 1;
...
int func_53(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x1C5C
{
	struct<15> Var0;
	int iVar15;
...
void func_54(int iParam0)//Position - 0x1DAD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_55(int iParam0)//Position - 0x1E71
{
	switch (iParam0)
	{
		case 0:
...
int func_57()//Position - 0x2001
{
	return Global_76839;
}

int func_58(int iParam0, int iParam1)//Position - 0x200D
{
	int iVar0;
...
int func_59(int iParam0)//Position - 0x2069
{
	if (iParam0 > 3)
	{
		return 0;
...
int func_60(int iParam0)//Position - 0x209A
{
	if (iParam0 == 0)
	{
		return 0;
...
struct<4> func_61(bool bParam0)//Position - 0x20D5
{
	struct<4> Var0;
...
bool func_62(var uParam0, var uParam1, int iParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)//Position - 0x213B
{
...
int func_63(char* sParam0, int iParam1, bool bParam2)//Position - 0x21A3
{
	Global_20806 = 0;
...
bool func_66(int iParam0)//Position - 0x2510
{
	return func_67(iParam0, 20);
}

bool func_67(int iParam0, int iParam1)//Position - 0x2520
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_68()//Position - 0x253B
{
	return -1;
}

void func_69()//Position - 0x2544
{
	int iVar0;
...
bool func_74(int iParam0, int iParam1)//Position - 0x279C
{
	switch (iParam0)
	{
		case 5:
...
void func_75(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x27D7
{
...
void func_78(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x296B
{
...
void func_79(int iParam0, int iParam1)//Position - 0x2A06
{
...
void func_80(bool bParam0)//Position - 0x2A4B
{
	if (bParam0)
	{
...
int func_82(int iParam0)//Position - 0x2AE7
{
...
int func_84(int iParam0)//Position - 0x2B5B
{
	if (iParam0 == 146 || iParam0 == -1)
	{
		return 0;
...
bool func_85(char* sParam0, int iParam1, char* sParam2)//Position - 0x2B88
{
...
void func_86(bool bParam0, int iParam1)//Position - 0x2BA6
{
	int iVar0;
...
bool func_87(int iParam0)//Position - 0x2C40
{
	return func_88(iParam0, 5, 1);
}

int func_88(int iParam0, int iParam1, bool bParam2)//Position - 0x2C50
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_89(int iParam0, int iParam1, int iParam2)//Position - 0x2CBA
{
	int iVar0;
	var uVar1;
...
int func_90(var uParam0)//Position - 0x2CEC
{
	int iVar0;
	int iVar1;
...
int func_91(int iParam0)//Position - 0x2D20
{
	switch (iParam0)
	{
		case 0:
...
int func_92()//Position - 0x3050
{
	return Global_30736;
}

void func_93(char* sParam0, int iParam1)//Position - 0x305B
{
	if (!*iParam1)
	{
...
void func_94(char* sParam0, int iParam1, int iParam2)//Position - 0x3078
{
	iParam2 = iParam2;
...
int func_95(int iParam0, bool bParam1)//Position - 0x3091
{
	func_98();
	switch (iParam0)
	{
...
int func_96(int iParam0, vector3 vParam1, float fParam4)//Position - 0x313C
{
	switch (iParam0)
	{
		case 0:
			if (func_97(vParam1, vLocal_202, 1056964608, 0) && fParam4 == 0f)
			{
				return 1;
			}
			break;
...
int func_97(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x31A4
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_98()//Position - 0x321F
{
	func_99(&uLocal_210);
}

void func_99(var uParam0)//Position - 0x322D
{
	int iVar0;
	char* sVar1;
...
void func_101(bool bParam0)//Position - 0x36E4
{
	func_102(iLocal_84);
...
void func_102(int iParam0)//Position - 0x3717
{
	switch (iParam0)
	{
		case 0:
...
void func_103(int iParam0)//Position - 0x372F
{
	bool bVar0;
	int iVar1;
...
int func_104(int iParam0)//Position - 0x37A0
{
	return func_88(iParam0, 6, 1);
}

bool func_105(int iParam0, vector3 vParam1, float fParam4)//Position - 0x37B0
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, true), vParam1) <= (fParam4 * fParam4);
}

void func_106()//Position - 0x37CD
{
	if (!iLocal_197)
	{
		if (func_87(28))
...
void func_107(int iParam0, bool bParam1)//Position - 0x37EF
{
	int iVar0;
...
void func_108(int iParam0, vector3 vParam1, bool bParam4, bool bParam5, char* sParam6)//Position - 0x3839
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
		*iParam0 = func_109(vParam1, 5, bParam4);
		if (bParam5)
		{
...
int func_109(vector3 vParam0, int iParam3, bool bParam4)//Position - 0x3868
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0x39C8
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
bool func_112(int iParam0)//Position - 0x3A00
{
	return func_88(iParam0, 0, 1);
}

void func_113(int iParam0, int iParam1, int iParam2)//Position - 0x3A10
{
...
void func_114(int iParam0)//Position - 0x3AD4
{
	if (iParam0 == 1)
	{
...
bool func_115()//Position - 0x3AFD
{
	return MISC::IS_BIT_SET(Global_98669.f_20, 13);
}

void func_116(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x3B11
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_195(vParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
...
int func_117(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)//Position - 0x3CA5
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var5))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var5, vParam2, fParam5, 1, 1, 0);
				...
				func_177(iParam0, &(Var5.f_31), &(Var5.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 1)
				{
...
void func_118(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x4AEA
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_119(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x56FE
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_120(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x5771
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_121(int iParam0)//Position - 0x6C63
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_122(int iParam0, var uParam1, var uParam2)//Position - 0x6D13
{
	int iVar0;
	int iVar1;
...
int func_123(int iParam0, bool bParam1, var uParam2)//Position - 0x6F06
{
	int iVar0;
	bool bVar1;
...
int func_124(int iParam0)//Position - 0x7074
{
	int iVar0;
...
int func_125(int iParam0)//Position - 0x70AF
{
	if (iParam0 != func_68())
	{
...
int func_126(int iParam0)//Position - 0x70F6
{
	switch (iParam0)
	{
		case 0:
...
int func_127(int iParam0, bool bParam1, bool bParam2)//Position - 0x74BE
{
	int iVar0;
...
int func_128(int iParam0)//Position - 0x7508
{
...
int func_129(int iParam0)//Position - 0x754A
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case -32236122:
...
int func_130(int iParam0)//Position - 0x75ED
{
	if (iParam0 != func_68())
	{
		if (func_127(iParam0, 1, 1))
...
int func_131(int iParam0)//Position - 0x7634
{
	if (iParam0 != func_68())
	{
		if (func_127(iParam0, 1, 1))
...
int func_132(int iParam0)//Position - 0x767A
{
	switch (iParam0)
	{
		case -2118308144:
...
int func_133(int iParam0)//Position - 0x76AF
{
...
int func_134(int iParam0)//Position - 0x76DE
{
...
int func_135(int iParam0)//Position - 0x779B
{
...
int func_136(int iParam0)//Position - 0x77D1
{
	switch (iParam0)
	{
		case 562680400:
...
int func_137(int iParam0, bool bParam1)//Position - 0x782A
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_138(int iParam0)//Position - 0x7885
{
	int iVar0;
...
int func_139(int iParam0, int iParam1)//Position - 0x78BF
{
	if (iParam1 == 0)
	{
...
bool func_140()//Position - 0x7C33
{
	return DLC::IS_DLC_PRESENT(1927191088);
}

bool func_141()//Position - 0x7C44
{
	return DLC::IS_DLC_PRESENT(2067165443);
}

bool func_142()//Position - 0x7C55
{
	return DLC::IS_DLC_PRESENT(-957277403);
}

bool func_143()//Position - 0x7C66
{
	return DLC::IS_DLC_PRESENT(210122941);
}

bool func_144()//Position - 0x7C77
{
	return DLC::IS_DLC_PRESENT(-1894522408);
}

bool func_145()//Position - 0x7C88
{
	return DLC::IS_DLC_PRESENT(1630677557);
}

int func_146(int iParam0, int iParam1)//Position - 0x7C99
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_147(int iParam0)//Position - 0x8012
{
	if (iParam0 != func_68())
	{
		if (func_127(iParam0, 1, 1))
...
int func_148(int iParam0)//Position - 0x8071
{
	if (iParam0 != func_68())
	{
		if (func_127(iParam0, 1, 1))
...
int func_149(int iParam0)//Position - 0x80D1
{
	if (iParam0 != func_68())
	{
		if (func_127(iParam0, 1, 1))
...
int func_150(int iParam0, bool bParam1, var uParam2)//Position - 0x8118
{
	bool bVar0;
...
int func_151(int iParam0)//Position - 0x8557
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_152(int iParam0, int iParam1)//Position - 0x8580
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_153(int iParam0, var uParam1)//Position - 0x8782
{
	int iVar0;
...
int func_154(int iParam0)//Position - 0x8A2D
{
	switch (iParam0)
	{
		case 1:
...
int func_155(int iParam0)//Position - 0x8ADD
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_156(var uParam0)//Position - 0x8AFD
{
	int iVar0;
...
int func_157(int iParam0)//Position - 0x8BAD
{
...
int func_158(int iParam0)//Position - 0x8C8A
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_159(int iParam0, bool bParam1)//Position - 0x8E3B
{
	int iVar0;
	struct<2> Var1;
...
int func_160(int iParam0)//Position - 0x8FBB
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_162(int iParam0)//Position - 0x909E
{
	int iVar0;
	int iVar1;
...
int func_163()//Position - 0xB569
{
	return 0;
}

int func_164()//Position - 0xB572
{
	return 1;
}

int func_165()//Position - 0xB57B
{
	return 1;
}

int func_166()//Position - 0xB584
{
...
int func_168(int iParam0)//Position - 0xB658
{
	int iVar0;
	char* sVar1;
...
int func_169(int iParam0)//Position - 0xB69E
{
	int iVar0;
...
int func_170(int iParam0)//Position - 0xB71A
{
	int iVar0;
...
int func_171(int iParam0)//Position - 0xB802
{
	int iVar0;
...
int func_172(int iParam0, int iParam1, bool bParam2)//Position - 0xB865
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_173(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0xB8D6
{
...
void func_175(int iParam0)//Position - 0xBA30
{
	if (!func_176(*iParam0))
	{
...
bool func_176(int iParam0)//Position - 0xBA5B
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_177(int iParam0, var uParam1, var uParam2)//Position - 0xBA6A
{
	int iVar0;
	int iVar1;
...
int func_178(int iParam0)//Position - 0xBC2D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_179(var uParam0)//Position - 0xBD09
{
...
int func_180(int iParam0, int iParam1)//Position - 0xBD49
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_181(var uParam0, int iParam1)//Position - 0xBE2E
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_182(int iParam0, var uParam1, int iParam2)//Position - 0xBE6F
{
	int iVar0;
...
void func_183(int iParam0, int iParam1)//Position - 0xC0CD
{
	int iVar0;
...
int func_184(int iParam0, int iParam1)//Position - 0xC16B
{
	struct<82> Var0;
...
void func_185(vector3 vParam0, float fParam3, bool bParam4)//Position - 0xC1AD
{
	int iVar0;
...
void func_186(int iParam0)//Position - 0xC1FD
{
	bool bVar0;
...
void func_187(int iParam0, bool bParam1)//Position - 0xC36F
{
	if (iParam0 == -1)
	{
		return;
...
void func_188(int iParam0, int iParam1, bool bParam2)//Position - 0xC3CC
{
	if (iParam0 == -1)
	{
		return;
...
void func_189(var uParam0, var uParam1)//Position - 0xC407
{
...
int func_190(int iParam0, int iParam1)//Position - 0xC4D3
{
	int iVar0;
...
int func_191(var uParam0)//Position - 0xC545
{
	return *uParam0;
}

bool func_192(int iParam0, int iParam1)//Position - 0xC550
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_193(var uParam0, int iParam1)//Position - 0xC573
{
	int iVar0;
	int iVar1;
...
bool func_194(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0xDC6A
{
	if (bParam6)
	{
...
int func_195(vector3 vParam0, float fParam3)//Position - 0xDCB1
{
	return func_196(&(Global_105109.f_2890), vParam0, fParam3, 0);
}

int func_196(var uParam0, vector3 vParam1, float fParam4, bool bParam5)//Position - 0xDCCB
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
int func_197(int iParam0)//Position - 0xDF7D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_198(int iParam0, vector3 vParam1, bool bParam4)//Position - 0xE040
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_199(iParam0, uVar1[iVar6], 1) && func_97(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_194(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
...
int func_199(int iParam0, int iParam1, bool bParam2)//Position - 0xE248
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_200(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0xE2A9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_201(int iParam0, int iParam1)//Position - 0xE86B
{
	int iVar0;
	int iVar1;
...
bool func_202()//Position - 0xE8E3
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_203(int iParam0)//Position - 0xE8F4
{
	int iVar0;
...
int func_204(int iParam0)//Position - 0xE93F
{
...
int func_205(int iParam0)//Position - 0xE9C6
{
...
int func_206(int iParam0)//Position - 0xE9F5
{
...
int func_207(int iParam0)//Position - 0xEA12
{
...
int func_208(int iParam0, int iParam1)//Position - 0xEA35
{
...
int func_209(int iParam0)//Position - 0xEA70
{
	if (func_208(iParam0, 0))
	{
...
int func_210(int iParam0, int iParam1)//Position - 0xEA93
{
	int iVar0;
...
int func_211(var uParam0)//Position - 0xEAE0
{
	if (func_212(uParam0))
	{
...
int func_212(var uParam0)//Position - 0xEB15
{
...
bool func_213()//Position - 0xEB74
{
	return func_211(&(Global_105109.f_2890));
}

void func_214()//Position - 0xEB87
{
	func_215(&(Global_105109.f_2890));
}

void func_215(var uParam0)//Position - 0xEB9A
{
	if (func_212(uParam0))
	{
...
int func_216(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xEBB8
{
...
int func_218(int iParam0)//Position - 0xECBB
{
	switch (iParam0)
	{
		case joaat("police"):
...
bool func_219()//Position - 0xED14
{
	return func_212(&(Global_105109.f_2890));
}

bool func_220(vector3 vParam0, int iParam3)//Position - 0xED27
{
	return func_221(Global_105109.f_2890.f_12.f_66, vParam0, iParam3);
}

int func_221(int iParam0, vector3 vParam1, int iParam4)//Position - 0xED44
{
	vector3 vVar0;
	vector3 vVar3;
...
Vector3 func_222()//Position - 0xEDAE
{
	return 2.55f, 5.665f, 2.55f;
}

void func_223()//Position - 0xEDC5
{
		...
		if (iLocal_84 > 0)
		{
			...
			if (!bLocal_196)
			{
				...
				else if (!func_105(PLAYER::PLAYER_PED_ID(), vLocal_205, 75f))
				{
					...
					{
						HUD::CLEAR_PRINTS();
						func_224("PRE_RETSHOP", &bLocal_208);
					}
				}
			}
		}
...
void func_224(char* sParam0, bool bParam1)//Position - 0xEE7C
{
	if (!*bParam1)
	{
		func_94(sParam0, 7500, 0);
...
int func_225()//Position - 0xEE99
{
	...
	if (!func_226(bLocal_196, iVar0) && !bLocal_196)
	{
		return 0;
	}
	return 1;
...
int func_226(bool bParam0, int iParam1)//Position - 0xEED6
{
	int iVar0;
...
int func_227(int iParam0, int iParam1)//Position - 0xEF22
{
	int iVar0;
...
int func_228(int iParam0)//Position - 0xEF37
{
	return Global_58645[iParam0];
}

bool func_229(int iParam0)//Position - 0xEF46
{
	return func_88(iParam0, 1, 1);
}

void func_230(int iParam0)//Position - 0xEF56
{
	HUD::CLEAR_PRINTS();
	func_43();
	switch (iParam0)
...
void func_233(char* sParam0, char* sParam1, char* sParam2)//Position - 0xF1B5
{
...
bool func_234()//Position - 0xF1F1
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

int func_235()//Position - 0xF206
{
	int iVar0;
	int iVar1;
...
int func_236(int iParam0)//Position - 0xF242
{
	if (func_27(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_238(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0xF2B2
{
	int iVar0;
	int iVar1;
...
int func_239(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xF384
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_240(bool bParam0)//Position - 0xF983
{
	int iVar0;
	int iVar1;
...
void func_241(int iParam0)//Position - 0xFC05
{
	int iVar0;
...
void func_242(int iParam0)//Position - 0xFC5F
{
	bool bVar0;
	char cVar1[64];
...
char* func_243(int iParam0)//Position - 0xFDEF
{
	switch (iParam0)
	{
		case 0:
...
void func_245(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xFEF8
{
	int iVar0;
...
int func_246(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xFF28
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_247(int iParam0)//Position - 0x1057B
{
	func_268(93, iParam0);
	func_268(29, iParam0);
	func_268(30, iParam0);
...
bool func_248(int iParam0)//Position - 0x1059B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_249(int iParam0, int iParam1, int iParam2)//Position - 0x1074B
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_250(int iParam0)//Position - 0x10788
{
	int iVar0;
...
int func_251(int iParam0, int iParam1)//Position - 0x10B24
{
	int iVar0;
...
int func_252(bool bParam0)//Position - 0x10E9D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_253(int iParam0, int iParam1)//Position - 0x10F54
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_254(int iParam0, int iParam1)//Position - 0x10F6F
{
...
int func_255(var uParam0, int iParam1)//Position - 0x1100C
{
	int iVar0;
	var uVar1[78];
...
int func_256(var uParam0, int iParam1)//Position - 0x110BD
{
	int iVar0;
...
bool func_257(var uParam0, int iParam1)//Position - 0x11138
{
	return (*uParam0)[iParam1] == 78;
}

void func_258(var uParam0)//Position - 0x11149
{
	int iVar0;
...
void func_259(var uParam0, int iParam1)//Position - 0x1117D
{
	(*uParam0)[iParam1] = 78;
}

void func_260(var uParam0, float fParam1)//Position - 0x1118D
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_261(var uParam0)//Position - 0x111AA
{
	return uParam0->f_80;
}

bool func_262(var uParam0, int iParam1)//Position - 0x111B6
{
	return func_263(uParam0, iParam1) != -1;
}

int func_263(var uParam0, int iParam1)//Position - 0x111C8
{
	int iVar0;
...
bool func_264(var uParam0)//Position - 0x111F5
{
	return uParam0->f_79 == 1;
}

int func_265(int iParam0)//Position - 0x11203
{
	switch (iParam0)
	{
		case 60:
...
int func_266(int iParam0, int iParam1)//Position - 0x11253
{
	int iVar0;
...
void func_267(int iParam0, int iParam1)//Position - 0x112A4
{
	int iVar0;
...
void func_268(int iParam0, int iParam1)//Position - 0x112C7
{
	int iVar0;
...
void func_269()//Position - 0x11324
{
	int iVar0;
...
int func_270(int iParam0)//Position - 0x11399
{
	return Global_1798[iParam0 /*29*/].f_17;
}

void func_271(int iParam0)//Position - 0x113AA
{
...
void func_272(int iParam0, int iParam1, bool bParam2)//Position - 0x113D1
{
	int iVar0;
...
bool func_273(bool bParam0)//Position - 0x11443
{
...
void func_274()//Position - 0x1146E
{
	if (!func_82(36))
	{
		func_275(21, 0, 0);
...
void func_275(int iParam0, bool bParam1, int iParam2)//Position - 0x11488
{
	if (bParam1)
	{
...
void func_276(int iParam0)//Position - 0x11547
{
	Global_98721.f_181[iParam0] = 1;
	Global_98721.f_180 = 1;
}

void func_277(int iParam0, int iParam1, bool bParam2)//Position - 0x11561
{
	int iVar0;
...
int func_278(int iParam0)//Position - 0x115D3
{
	switch (iParam0)
	{
		case -1:
...
void func_279(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x118A1
{
	if (func_280())
	{
...
void func_281(bool bParam0)//Position - 0x1195A
{
...
int func_282(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x119E9
{
...
int func_283(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x11A85
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
struct<14> func_284(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x129A3
{
	func_349();
...
void func_285(int iParam0, int iParam1)//Position - 0x129F5
{
	switch (iParam0)
	{
		case 0:
...
void func_286(int iParam0)//Position - 0x12AE5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_294(iVar10, iParam0, 155, -1);
			return;
			break;
	}
	func_287(&(Global_76389[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_287(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x13D5C
{
	int iVar0;
	int iVar1;
...
bool func_288(int iParam0, int iParam1, var uParam2)//Position - 0x140EE
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_289(int iParam0, int iParam1)//Position - 0x144F3
{
	switch (iParam1)
	{
		case 0:
...
int func_290(int iParam0, int iParam1)//Position - 0x148EE
{
	switch (iParam1)
	{
		case 0:
...
int func_291(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x14CE9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_292(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x14D2B
{
	int iVar0;
...
int func_293(int iParam0)//Position - 0x16B92
{
	switch (iParam0)
	{
		case -1:
...
void func_294(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x16C66
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_287(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_287(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_295(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_295(int iParam0)//Position - 0x16F3F
{
	switch (iParam0)
	{
		case 0:
...
void func_296(int iParam0)//Position - 0x16FEF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_297(int iParam0)//Position - 0x17146
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_298(int iParam0)//Position - 0x17654
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_299(int iParam0)//Position - 0x176C9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_300(int iParam0)//Position - 0x1773D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_301(int iParam0)//Position - 0x17824
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_302(int iParam0)//Position - 0x17B87
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_303(int iParam0)//Position - 0x17D98
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_304(int iParam0)//Position - 0x17FC8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_305(int iParam0)//Position - 0x180E9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_306(int iParam0)//Position - 0x18A88
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_307(int iParam0)//Position - 0x195FB
{
	if (iParam0 < 136)
	{
		func_309(iParam0);
...
void func_308(int iParam0)//Position - 0x19630
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_309(int iParam0)//Position - 0x1A234
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_310(int iParam0)//Position - 0x1B142
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_311(int iParam0)//Position - 0x1B26F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_312(int iParam0, int iParam1)//Position - 0x1B36D
{
	switch (iParam0)
	{
		case 0:
...
void func_313(int iParam0)//Position - 0x1B45D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_314(int iParam0)//Position - 0x1C950
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_315(int iParam0)//Position - 0x1CAA1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_316(int iParam0)//Position - 0x1CFAC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_317(int iParam0)//Position - 0x1D61A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_318(int iParam0)//Position - 0x1D68E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_319(int iParam0)//Position - 0x1D75E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_320(int iParam0)//Position - 0x1DC8E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_321(int iParam0)//Position - 0x1DE25
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_322(int iParam0)//Position - 0x1E623
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_323(int iParam0)//Position - 0x1E733
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_324(int iParam0)//Position - 0x1F65E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_325(int iParam0)//Position - 0x2031C
{
	if (iParam0 < 107)
	{
		func_328(iParam0);
...
void func_326(int iParam0)//Position - 0x20362
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_327(int iParam0)//Position - 0x20E07
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_328(int iParam0)//Position - 0x21BF6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_329(int iParam0)//Position - 0x2283F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_330(int iParam0)//Position - 0x22AB8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_331(int iParam0, int iParam1)//Position - 0x22BFE
{
	switch (iParam0)
	{
		case 0:
...
void func_332(int iParam0)//Position - 0x22CEE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_333(int iParam0)//Position - 0x23A78
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_334(int iParam0)//Position - 0x23BF2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_335(int iParam0)//Position - 0x2416B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_336(int iParam0)//Position - 0x24695
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_337(int iParam0)//Position - 0x24709
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_338(int iParam0)//Position - 0x247D9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_339(int iParam0)//Position - 0x24CB1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_340(int iParam0)//Position - 0x24F1A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_341(int iParam0)//Position - 0x251F0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_342(int iParam0)//Position - 0x253B9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_343(int iParam0)//Position - 0x25F0D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_344(int iParam0)//Position - 0x26B57
{
	if (iParam0 < 60)
	{
		func_346(iParam0);
...
void func_345(int iParam0)//Position - 0x26B8C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_346(int iParam0)//Position - 0x2792C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_347(int iParam0)//Position - 0x27FB8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_348(int iParam0)//Position - 0x280C0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_349()//Position - 0x281BE
{
...
void func_350()//Position - 0x28237
{
	func_359();
	func_358();
	func_351();
...
void func_351()//Position - 0x2824B
{
	vector3 vVar0[8];
...
void func_352(var uParam0, int iParam1)//Position - 0x282B8
{
	int iVar0;
	...
	{
		func_356(&uLocal_87, *(uParam0[iVar0 /*3*/]));
		iVar0++;
	}
	func_355(&uLocal_87);
	func_353(&uLocal_139, &uLocal_87, 50f);
}

void func_353(var uParam0, var uParam1, float fParam2)//Position - 0x282FC
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		if (func_354(uParam1, *(uParam1[iVar1 /*3*/]) + vVar9))
		{
			vVar9 = { -vVar9 };
		}
...
bool func_354(var uParam0, struct<2> Param1, Vector3 vParam3)//Position - 0x28409
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_355(var uParam0)//Position - 0x284C5
{
	int iVar0;
	float fVar1;
...
void func_356(var uParam0, vector3 vParam1)//Position - 0x28565
{
	if (uParam0->f_51 == 0)
	{
	}
...
void func_357(var uParam0)//Position - 0x28596
{
	if (uParam0->f_51)
	{
	}
...
void func_358()//Position - 0x285BD
{
...
void func_359()//Position - 0x285E0
{
}

void func_360()//Position - 0x285E8
{
	func_372(1);
	func_371();
	func_370();
...
void func_361(bool bParam0)//Position - 0x28606
{
	if (bParam0)
	{
	}
	...
	if (CAM::DOES_CAM_EXIST(iLocal_201))
	{
		...
		CAM::DESTROY_CAM(iLocal_201, 0);
	}
}

void func_362()//Position - 0x28671
{
}

void func_363()//Position - 0x28679
{
	Global_19671 = 0;
	func_364();
}

void func_364()//Position - 0x28689
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_365()//Position - 0x286AA
{
}

void func_366()//Position - 0x286B2
{
}

void func_367()//Position - 0x286BA
{
}

void func_368()//Position - 0x286C2
{
}

void func_369(bool bParam0, int iParam1, int iParam2)//Position - 0x286CA
{
	bool bVar0;
...
void func_370()//Position - 0x28729
{
	func_275(21, 1, 0);
}

void func_371()//Position - 0x28739
{
	Global_94554 = 0;
}

void func_372(bool bParam0)//Position - 0x28746
{
...
void func_373()//Position - 0x2878D
{
	Global_111560.f_2358.f_539.f_2403[0] = -99;
	Global_111560.f_2358.f_539.f_2403[1] = -99;
	Global_111560.f_2358.f_539.f_2403[2] = -99;
...
void func_374()//Position - 0x287D3
{
	int iVar0;
