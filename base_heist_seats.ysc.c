...
void func_11()//Position - 0x216
{
	...
	if (Global_1590291 == PLAYER::PLAYER_ID() && !MISC::IS_BIT_SET(Global_1692918[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*39*/].f_27, 5))
	{
		...
		if (func_18(&Local_47, 0, 0))
		{
			...
			if ((((((iLocal_484 == 0 && !MISC::IS_BIT_SET(Global_1692918[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*39*/].f_27, 3)) && !func_16()) && !HUD::IS_PAUSE_MENU_ACTIVE()) && !func_15(0)) && !func_14()) && PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 225))
			{
				func_12(&Local_47);
			}
		}
...
void func_19(int iParam0)//Position - 0x431
{
	...
	switch (iParam0->f_421.f_4)
	{
		...
		case 4:
			...
			if (Var20 != 3)
			{
				vVar34 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar16, func_45(iParam0), func_44(iParam0), 0, 2) };
				vVar37 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar16, func_45(iParam0), func_44(iParam0), 0, 2) };
				iVar40 = vVar37.z;
		...
		case 5:
			...
			{
				iParam0->f_421.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_45(iParam0), func_44(iParam0), 2, 1, false, 1065353216, 0, 1065353216);
...
void func_31(var uParam0)//Position - 0xD53
{
	...
	if (((func_21(uParam0) != uParam0->f_421.f_8.f_1 && uParam0->f_421.f_8.f_2 < 6) && uParam0->f_421.f_8.f_2 != 3) && uParam0->f_421.f_8.f_2 != 4)
	{
		...
		uParam0->f_421.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_45(uParam0), func_44(uParam0), 2, 1, false, 1065353216, 0, 1065353216);
...
void func_41(bool bParam0, bool bParam1)//Position - 0x1056
{
	if (bParam0)
	{
		if (func_15(0))
...
bool func_42()//Position - 0x10CA
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

bool func_43()//Position - 0x10DB
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

Vector3 func_44(var uParam0)//Position - 0x10ED
{
	vector3 vVar0;
...
Vector3 func_45(var uParam0)//Position - 0x112D
{
	return (uParam0[uParam0->f_421.f_2 /*14*/])->f_8;
}

void func_46(var uParam0, char* sParam1)//Position - 0x1144
{
...
void func_47(var uParam0, char* sParam1)//Position - 0x1241
{
...
void func_48(var uParam0)//Position - 0x1385
{
...
int func_49(var uParam0)//Position - 0x13C6
{
	int iVar0;
...
int func_50(int iParam0)//Position - 0x140B
{
	if (iParam0 >= 11)
	{
		return 0;
...
void func_51(var uParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x1454
{
	int iVar0;
...
bool func_52(var uParam0)//Position - 0x157F
{
...
int func_53(var uParam0)//Position - 0x15B2
{
	int iVar0;
	int iVar1;
...
int func_54(int iParam0, bool bParam1, bool bParam2)//Position - 0x161E
{
	int iVar0;
...
bool func_55(var uParam0)//Position - 0x1668
{
	return uParam0->f_421 & 31 > 0;
}

bool func_56(int iParam0, var uParam1)//Position - 0x167A
{
	return ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam0, uParam1->f_1, uParam1->f_1.f_3, uParam1->f_1.f_6, 0, 1, 0);
}

int func_57(var uParam0)//Position - 0x169F
{
	int iVar0;
...
void func_58(var uParam0, int iParam1)//Position - 0x16EA
{
	uParam0->f_421.f_4 = iParam1;
}

void func_59(int iParam0, int iParam1)//Position - 0x16FB
{
	MISC::CLEAR_BIT(iParam0, iParam1);
}

void func_60(var uParam0)//Position - 0x170B
{
	if (uParam0->f_421.f_4 == 6)
	{
	}
...
float func_61(var uParam0)//Position - 0x1795
{
...
void func_62(var uParam0)//Position - 0x17E8
{
...
void func_63(int iParam0, int iParam1, bool bParam2)//Position - 0x1845
{
	int iVar0;
...
int func_65()//Position - 0x189C
{
	return -1;
}

int func_66()//Position - 0x18A5
{
	var uVar0;
...
int func_69()//Position - 0x1986
{
	return Global_30736;
}

bool func_70()//Position - 0x1991
{
	return Global_2448961.f_598;
}

int func_71(int iParam0)//Position - 0x19A0
{
...
bool func_72()//Position - 0x19B7
{
	return Global_2458999;
}

bool func_73()//Position - 0x19C3
{
	return Global_2448961.f_593;
}

void func_74(var uParam0)//Position - 0x19D2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_75(int iParam0)//Position - 0x1A45
{
	vector3 vVar0;
	int iVar3;
	int iVar4;
...
int func_76(int iParam0, var uParam1)//Position - 0x1AC6
{
...
void func_80(int iParam0, int iParam1)//Position - 0x20B9
{
	iParam0->f_421.f_13 = iParam1;
	func_13(&(iParam0->f_421), 5);
}

bool func_81(var uParam0, int iParam1)//Position - 0x20D4
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
float func_82(vector3 vParam0, vector3 vParam3)//Position - 0x217A
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_83(vector3 vParam0)//Position - 0x219B
{
	float fVar0;
	float fVar1;
...
int func_84(int iParam0)//Position - 0x21DA
{
	if (iParam0 != func_65())
	{
...
void func_85(int iParam0, vector3 vParam1, float fParam4, vector3 vParam5, vector3 vParam8)//Position - 0x220D
{
...
Vector3 func_86(vector3 vParam0, float fParam3)//Position - 0x2285
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
Vector3 func_87(vector3 vParam0, float fParam3)//Position - 0x22C9
{
	return vParam0 + func_86(0f, 0.01f, 0.015f, fParam3);
}

Vector3 func_88()//Position - 0x22E7
{
	return 0f, -0.7f, -1f;
}

Vector3 func_89()//Position - 0x22F6
{
	return 0f, 0.1f, 1f;
}

int func_90(int iParam0, int iParam1, bool bParam2)//Position - 0x2305
{
	int iVar0;
