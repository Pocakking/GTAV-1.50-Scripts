...
bool func_7(int iParam0)//Position - 0x5D2
{
	return func_8(iParam0, 20);
}

bool func_8(int iParam0, int iParam1)//Position - 0x5E2
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_9()//Position - 0x5FD
{
	return -1;
}

void func_10()//Position - 0x606
{
	int iVar0;
...
bool func_15(int iParam0)//Position - 0x82D
{
	return Global_41396 == iParam0;
}

void func_16()//Position - 0x83B
{
	int iVar0;
...
bool func_17(int iParam0, int iParam1)//Position - 0x891
{
	switch (iParam0)
	{
		case 5:
...
void func_19(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x923
{
...
void func_20(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x979
{
...
int func_21()//Position - 0xA14
{
	func_22();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_22()//Position - 0xA2D
{
	int iVar0;
...
int func_23(int iParam0)//Position - 0xB2A
{
	int iVar0;
	int iVar1;
...
int func_24(int iParam0)//Position - 0xB67
{
	if (func_26(iParam0))
	{
...
var func_25(int iParam0)//Position - 0xB8C
{
	return Global_1798[iParam0 /*29*/];
}

bool func_26(int iParam0)//Position - 0xB9B
{
	return iParam0 < 3;
}

var func_27()//Position - 0xBA7
{
	func_22();
	return Global_111560.f_2358.f_539.f_4321;
}

int func_28(int iParam0, int iParam1)//Position - 0xBC0
{
	int iVar0;
	char* sVar1;
	float fVar2;
		...
		if (!PED::IS_PED_INJURED((*iParam0)[iVar0]))
		{
			switch ((*iParam1)[iVar0])
			{
				case 100:
					...
					{
						TASK::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_96028, &cLocal_371, &(Local_387[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
						(*iParam1)[iVar0] = 101;
					}
				...
				case 101:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96029))
					{
						TASK::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_96029, &cLocal_371, &(Local_420[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
					...
					if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_371) && ENTITY::IS_ENTITY_PLAYING_ANIM((*iParam0)[iVar0], &cLocal_371, &(Local_420[iVar0 /*16*/]), 1))
					{
						...
						if (iLocal_113 == 108 || iLocal_113 == 109)
						{
							if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME((*iParam0)[iVar0], &cLocal_371, &(Local_420[iVar0 /*16*/])) > 0.954f)
							{
								...
								TASK::TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], vLocal_299 + vLocal_303[iVar0 /*3*/], 1f, -1, 1048576000, 0, 1193033728);
				...
				case 1:
					...
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], vVar21, 0.5f, -1, 1048576000, 0, 1193033728);
						break;
					}
					break;
				...
				case 10:
					if (TASK::GET_SCRIPT_TASK_STATUS((*iParam0)[iVar0], -71340211) == 7 || TASK::GET_SCRIPT_TASK_STATUS((*iParam0)[iVar0], -71340211) == 1)
					{
						...
						PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_289, 1862763509);
						PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, iLocal_289);
				...
				case 11:
					...
					{
						PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, iLocal_289, 1862763509);
						PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, 1862763509, iLocal_289);
						TASK::CLEAR_PED_TASKS((*iParam0)[iVar0]);
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], vLocal_299 + vLocal_303[iVar0 /*3*/], 0.5f, -1, 1048576000, 0, 1193033728);
						(*iParam1)[iVar0] = 1;
					}
				...
				case 5:
					...
					if (!TASK::PED_HAS_USE_SCENARIO_TASK((*iParam0)[iVar0]))
					{
						...
						{
							if (TASK::DOES_SCENARIO_EXIST_IN_AREA(vLocal_299 + vLocal_303[iVar0 /*3*/], 20f, 1))
							{
...
int func_29(int iParam0, float fParam1)//Position - 0x1642
{
	int iVar0;
	vector3 vVar1;
	int iVar4;
...
int func_30(vector3 vParam0)//Position - 0x1704
{
...
Vector3 func_31(int iParam0, int iParam1)//Position - 0x172E
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x176C
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_33(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7, int iParam8, bool bParam9, int iParam10)//Position - 0x1892
{
	vector3 vVar0;
	vector3 vVar3;
	
	vVar0.x = (vParam1.x - (SYSTEM::COS(fParam7) * vParam4.x));
	vVar0.y = (vParam1.y - (SYSTEM::SIN(fParam7) * vParam4.x));
	vVar0.z = (vParam1.z - vParam4.z);
	vVar3.x = (vParam1.x + (SYSTEM::COS(fParam7) * vParam4.x));
	vVar3.y = (vParam1.y + (SYSTEM::SIN(fParam7) * vParam4.x));
	vVar3.z = (vParam1.z + vParam4.z);
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam0, vVar0, vVar3, (vParam4.y * 2f), iParam8, bParam9, iParam10))
	{
		return 1;
	}
	return 0;
...
bool func_34(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x1916
{
	if (bParam6)
	{
...
int func_35(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x195D
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_36(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x1A58
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_37(int iParam0, float fParam1)//Position - 0x1B64
{
	var uVar0;
	vector3 vVar1;
...
int func_38(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0x1BF9
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_39(vector3 vParam0, vector3 vParam3)//Position - 0x1C87
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_40(vector3 vParam0)//Position - 0x1CA8
{
	float fVar0;
	float fVar1;
...
int func_41(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x1CE7
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_42(int iParam0)//Position - 0x1D2F
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_45(int iParam0)//Position - 0x1DC5
{
	return Global_111560.f_24899[iParam0 /*4*/];
}

int func_46()//Position - 0x1DD8
{
	int iVar0;
...
int func_48(int iParam0, int iParam1)//Position - 0x1EC9
{
	vector3 vVar0;
	float fVar3;
...
int func_49(var uParam0)//Position - 0x1FAD
{
	return uParam0;
}

bool func_50(var uParam0, var uParam1)//Position - 0x1FB7
{
	return (uParam0 && uParam1) != 0;
}

int func_51()//Position - 0x1FC6
{
	func_22();
...
void func_53()//Position - 0x204C
{
	func_54((Global_98392 - 1));
}

void func_54(int iParam0)//Position - 0x205E
{
	Global_98392 = iParam0;
}

void func_55()//Position - 0x206C
{
	func_54(0);
}

void func_56()//Position - 0x2079
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	while (iVar0 < iLocal_280)
	{
		if (iLocal_286[iVar0] != 0)
		{
			iLocal_280[iVar0] = PED::CREATE_PED(26, iLocal_286[iVar0], vLocal_299 + vLocal_303[iVar0 /*3*/], 0f, 1, true);
		...
		if (iLocal_293[iVar0] != 0)
		{
			...
			ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_290[iVar0], iLocal_280[iVar0], PED::GET_PED_BONE_INDEX(iLocal_280[iVar0], iLocal_296[iVar0]), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
		}
		iVar0++;
	}
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, iLocal_289, 1862763509);
...
void func_57()//Position - 0x22DC
{
	char[] cVar0[8];
	var uVar8;
	var uVar9;
	
	iLocal_113 = Global_98072;
...
struct<4> func_58(char* sParam0, int iParam1)//Position - 0x2C85
{
	struct<4> Var0;
...
int func_59(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5)//Position - 0x2CE1
{
	*uParam4 = 9;
	*uParam5 = 0;
	switch (iParam0)
...
void func_60(int iParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0x441E
{
...
int func_61(int iParam0, var uParam1, var uParam2, char* sParam3)//Position - 0x443E
{
	int iVar0;
...
bool func_62(var uParam0)//Position - 0x4629
{
	int iVar0;
	vector3 vVar1;
	float fVar4;
...
int func_63(int iParam0, var uParam1, char* sParam2)//Position - 0x46E4
{
	vector3 vVar0;
	int iVar3;
	var uVar4;
...
int func_64(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0x6AF0
{
	switch (iParam1)
	{
		case 0:
...
int func_66(int iParam0, var uParam1, var uParam2)//Position - 0x8A5E
{
	switch (iParam0)
	{
		case 11:
...
char* func_67(int iParam0)//Position - 0x93CD
{
	switch (iParam0)
	{
		case 2014101067:
