...
void __EntryFunction__()//Position - 0x0
{
	...
	while (iVar0 == 1)
	{
		...
		switch (iLocal_250)
		{
			...
			case 8:
				...
				else if (iLocal_440 == 1)
				{
					...
					{
						func_56(Global_111505[iLocal_251], iLocal_297, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_240, &Local_372, &Local_356));
					}
				}
				break;
			...
			case 9:
				...
				if (!bVar37 && (!bVar36 || bLocal_437))
				{
					if (bLocal_504)
					{
						Global_111505[iLocal_251] = uLocal_503;
					}
					else
					{
		...
		if (((((((((((((iLocal_250 == 0 || iLocal_250 == 1) || iLocal_250 == 3) || iLocal_250 == 8) || iLocal_250 == 9) || iLocal_250 == 7) && func_87(iLocal_240, PLAYER::PLAYER_PED_ID(), 1) < 5f) && bLocal_436 == 1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) && iVar30 == 0) && bLocal_439 == 1) && !Global_3) && func_7()) && bVar81)
		{
			if (iLocal_298 == -1)
			{
...
int func_7()//Position - 0x14D3
{
	return 1;
}

void func_8()//Position - 0x14DC
{
	func_9();
...
void func_12(int iParam0)//Position - 0x15A6
{
	int iVar0;
	int iVar1;
...
void func_13(char[4] cParam0, int iParam1)//Position - 0x15E8
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_14(int iParam0)//Position - 0x15FF
{
	int iVar0;
	int iVar1;
...
int func_15(int iParam0)//Position - 0x1642
{
...
void func_16(var uParam0, int iParam1)//Position - 0x166F
{
...
void func_17()//Position - 0x168C
{
	Global_19671 = 0;
	func_18();
}

void func_18()//Position - 0x169C
{
...
int func_20()//Position - 0x1728
{
	func_21();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_21()//Position - 0x1741
{
	int iVar0;
...
bool func_22(int iParam0)//Position - 0x183E
{
	return Global_41396 == iParam0;
}

bool func_23(int iParam0)//Position - 0x184C
{
	return iParam0 < 3;
}

int func_24(int iParam0)//Position - 0x1858
{
	int iVar0;
	int iVar1;
...
int func_25(int iParam0)//Position - 0x1895
{
	if (func_23(iParam0))
	{
...
var func_26(int iParam0)//Position - 0x18BA
{
	return Global_1798[iParam0 /*29*/];
}

void func_27(char* sParam0)//Position - 0x18C9
{
	struct<16> Var0;
...
void func_28(char* sParam0)//Position - 0x18EF
{
	int iVar0;
...
void func_29(char* sParam0)//Position - 0x1942
{
	int iVar0;
...
void func_30(int iParam0, char* sParam1)//Position - 0x1986
{
	switch (iParam0)
	{
		case 0:
...
void func_31(char* sParam0)//Position - 0x1B4F
{
	char cVar0[64];
...
void func_32(char* sParam0)//Position - 0x1B83
{
	struct<4> Var0;
...
void func_33(char* sParam0)//Position - 0x1BAE
{
...
void func_34()//Position - 0x1BCF
{
	iLocal_254 = MISC::GET_RANDOM_INT_IN_RANGE(0, iLocal_253);
}

void func_35(char* sParam0)//Position - 0x1BE0
{
	int iVar0;
...
bool func_37(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1C4C
{
...
int func_38(char* sParam0, int iParam1, bool bParam2)//Position - 0x1C9A
{
	Global_20806 = 0;
...
bool func_41(int iParam0)//Position - 0x2007
{
	return func_42(iParam0, 20);
}

bool func_42(int iParam0, int iParam1)//Position - 0x2017
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_43()//Position - 0x2032
{
	return -1;
}

void func_44()//Position - 0x203B
{
	int iVar0;
...
bool func_50(int iParam0, int iParam1)//Position - 0x22B8
{
	switch (iParam0)
	{
		case 5:
...
void func_51(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x22F3
{
...
void func_52(char[4] cParam0)//Position - 0x2349
{
	int iVar0;
...
void func_53(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2384
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_54(char* sParam0)//Position - 0x241F
{
	int iVar0;
...
void func_55(var uParam0)//Position - 0x2457
{
}

void func_56(var uParam0, int iParam1, float fParam2)//Position - 0x245F
{
}

void func_57()//Position - 0x2467
{
	STREAMING::REMOVE_ANIM_DICT(&Local_388);
}

void func_58()//Position - 0x2476
{
	char* sVar0;
	struct<16> Var8;
	
	func_61(Global_111505[iLocal_251] + 1, &sVar0, &Var8);
	...
	PED::_0x2208438012482A1A(iLocal_240, 0, 0);
	func_59(Global_111505[iLocal_251]);
}

void func_59(var uParam0)//Position - 0x24EC
{
}

void func_60(char* sParam0)//Position - 0x24F4
{
...
void func_61(int iParam0, char* sParam1, char* sParam2)//Position - 0x2507
{
...
bool func_63()//Position - 0x25FA
{
	return Global_98721.f_345 > 0;
}

bool func_64()//Position - 0x260B
{
	bool bVar0;
...
void func_68(char* sParam0)//Position - 0x268E
{
	struct<8> Var0;
...
void func_69(char* sParam0)//Position - 0x26CE
{
	func_30(iLocal_297, sParam0);
}

void func_70(char* sParam0)//Position - 0x26DF
{
	StringCopy(sParam0, "MONOLOGUE_", 16);
	StringIntConCat(sParam0, Global_111505[iLocal_251] + 1, 16);
}

void func_71(int iParam0, bool bParam1)//Position - 0x26FD
{
	int iVar0;
...
void func_72(int iParam0, bool bParam1)//Position - 0x271E
{
	int iVar0;
...
void func_73(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x278F
{
	func_74(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_74(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x27AF
{
	int iVar0;
...
int func_78(int iParam0)//Position - 0x2BA7
{
	if (func_80(iParam0))
	{
...
int func_79(int iParam0)//Position - 0x2BCE
{
	int iVar0;
...
int func_80(int iParam0)//Position - 0x2C01
{
...
int func_81(int iParam0)//Position - 0x2C2B
{
	switch (iParam0)
	{
...
void func_82(int iParam0)//Position - 0x2CE9
{
	if (iLocal_447 == 1)
	{
...
void func_83(int iParam0, int iParam1, bool bParam2)//Position - 0x2D08
{
	if (iLocal_447 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
...
int func_84(int iParam0, bool bParam1, int iParam2)//Position - 0x2D5B
{
	int iVar0;
...
int func_85(int iParam0, bool bParam1, bool bParam2)//Position - 0x2DA5
{
	int iVar0;
...
float func_86(bool bParam0, float fParam1, float fParam2)//Position - 0x2E49
{
	if (bParam0)
	{
		return fParam1;
...
float func_87(int iParam0, int iParam1, bool bParam2)//Position - 0x2E60
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_88(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2EBE
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_89(vector3 vParam0, vector3 vParam3)//Position - 0x2F4F
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_90(vector3 vParam0)//Position - 0x2F70
{
	float fVar0;
	float fVar1;
...
int func_91(int iParam0)//Position - 0x2FAF
{
	var uVar0;
...
void func_94()//Position - 0x3003
{
	Global_19671 = 0;
	func_95();
}

void func_95()//Position - 0x3013
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_96()//Position - 0x3034
{
	return 1;
}

void func_97()//Position - 0x303D
{
}

int func_98()//Position - 0x3045
{
	return 1;
}

float func_99(int iParam0, int iParam1)//Position - 0x304E
{
	return func_87(iParam0, iParam1, 1);
}

void func_100(int iParam0)//Position - 0x305F
{
	int iVar0;
...
int func_101(int iParam0)//Position - 0x3090
{
	int iVar0;
	int iVar1;
...
int func_102(int iParam0, bool bParam1)//Position - 0x30C1
{
	if (!func_80(iParam0))
	{
		if (!bParam1)
...
void func_103(var uParam0, var uParam1)//Position - 0x3174
{
	*uParam0 = (*uParam0 || uParam1);
}

void func_104(int iParam0, bool bParam1)//Position - 0x3185
{
	if (iParam0 == 1)
	{
		TASK::TASK_PLAY_ANIM(iLocal_240, &cLocal_324, &Local_218, 2f, -2f, -1, 0, 0, 0, 0, 0);
...
int func_105(int iParam0)//Position - 0x31F7
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_106()//Position - 0x3218
{
	func_107();
}

void func_107()//Position - 0x3224
{
...
int func_112()//Position - 0x337A
{
	return 1;
}

bool func_113(var uParam0)//Position - 0x3383
{
	return func_114(Global_111560.f_20112, uParam0);
}

bool func_114(var uParam0, var uParam1)//Position - 0x3398
{
	return (uParam0 && uParam1) != 0;
}

int func_115(int iParam0)//Position - 0x33A7
{
...
void func_116(int iParam0)//Position - 0x34CE
{
	var uVar0;
...
void func_117(int iParam0)//Position - 0x359D
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
struct<6> func_118()//Position - 0x35BD
{
	struct<6> Var0;
...
void func_119()//Position - 0x35E1
{
	func_120();
}

void func_120()//Position - 0x35ED
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_448))
	{
