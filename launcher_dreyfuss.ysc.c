...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		if (Var0 == 8)
		{
			func_187(&Var0, vVar61, "DREY1AU", "DREY1_IDLE", 3, "DREYFUSS", 5000, 1101004800);
		}
...
int func_26(var uParam0)//Position - 0x2840
{
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2862
{
	int iVar0;
...
bool func_36(int iParam0)//Position - 0x2E05
{
	return iParam0 < 3;
}
...
int func_43(int iParam0, int iParam1, bool bParam2)//Position - 0x355F
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x35D0
{
...
int func_45(int iParam0)//Position - 0x36A9
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x36E6
{
	if (func_36(iParam0))
	{
...
var func_47(int iParam0)//Position - 0x370B
{
	return Global_1798[iParam0 /*29*/];
}

void func_48(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x371A
{
	int iVar0;
	int iVar1;
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x38BA
{
	int iVar0;
	var uVar1;
...
int func_50(var uParam0)//Position - 0x38EC
{
	int iVar0;
	int iVar1;
...
int func_51()//Position - 0x3920
{
	return Global_1312745;
}

int func_52(int iParam0, int iParam1)//Position - 0x392C
{
	var uVar0;
	var uVar1;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3958
{
	int iVar0;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3EA0
{
	int iVar0;
...
int func_55()//Position - 0x40E3
{
	func_56();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_56()//Position - 0x40FC
{
	int iVar0;
...
bool func_57(int iParam0)//Position - 0x41F9
{
	return Global_41396 == iParam0;
}

void func_58(int iParam0, bool bParam1)//Position - 0x4207
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_59(int iParam0, var uParam1)//Position - 0x42FA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_61(int iParam0)//Position - 0x461D
{
...
int func_62(int iParam0, int iParam1)//Position - 0x47AF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var uParam1)//Position - 0x5320
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x535B
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x55CF
{
	int iVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x560B
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_67(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x5B66
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5BAA
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x62C5
{
	if (bParam6)
	{
...
int func_70(var uParam0)//Position - 0x630C
{
...
bool func_71(int iParam0)//Position - 0x6367
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x6377
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x63E1
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x6711
{
	return Global_30736;
}

int func_75(int iParam0)//Position - 0x671C
{
	return func_72(iParam0, 5, 1);
}

int func_76(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x672C
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x67CE
{
	switch (iParam0)
	{
		case -1:
...
int func_78(int iParam0)//Position - 0x6DEB
{
	if (iParam0 != func_87())
	{
...
Vector3 func_79(int iParam0, int iParam1)//Position - 0x6E49
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_80(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6EF7
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_81(vector3 vParam0, float fParam3)//Position - 0x6F8C
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_82(int iParam0)//Position - 0x6FD0
{
	struct<6> Var0;
...
struct<6> func_83(int iParam0)//Position - 0x7154
{
	return func_84(iParam0);
}

struct<6> func_84(int iParam0)//Position - 0x7162
{
	struct<6> Var0;
...
int func_85(int iParam0, var uParam1)//Position - 0x7C29
{
	switch (iParam0)
	{
		case 0:
...
int func_86(int iParam0)//Position - 0x7CAB
{
	if (iParam0 != func_87())
	{
...
int func_87()//Position - 0x7D09
{
	return -1;
}

Vector3 func_88(int iParam0)//Position - 0x7D12
{
	switch (iParam0)
	{
		case 1:
...
int func_89()//Position - 0x7F1D
{
	return func_90(PLAYER::PLAYER_ID());
}

int func_90(int iParam0)//Position - 0x7F2D
{
	return MISC::GET_BITS_IN_RANGE(Global_2424073[iParam0 /*421*/].f_309.f_3, 28, 31);
}

int func_91(int iParam0)//Position - 0x7F4A
{
	return func_72(iParam0, 0, 0);
}

int func_92(int iParam0)//Position - 0x7F5A
{
	switch (iParam0)
	{
		case -1:
...
int func_170(int iParam0, int iParam1)//Position - 0xB542
{
	if (func_126(iParam0))
	{
...
float func_171(int iParam0, vector3 vParam1, bool bParam4)//Position - 0xB575
{
	vector3 vVar0;
...
int func_172(int iParam0)//Position - 0xB5AF
{
	int iVar0;
...
var func_173()//Position - 0xBCCC
{
	return Global_98708.f_1;
}

int func_174()//Position - 0xBCDA
{
	if (Global_95621 != -1)
	{
...
bool func_177()//Position - 0xBD44
{
	return Global_98721.f_346 > 0;
}

bool func_178(int iParam0, int iParam1)//Position - 0xBD55
{
	switch (iParam0)
	{
		case 5:
...
var func_179()//Position - 0xBD90
{
	return Global_1312873;
}

int func_180()//Position - 0xBD9C
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_181(int iParam0, int iParam1)//Position - 0xBDB8
{
	switch (iParam0->f_16)
	{
		case 0:
...
void func_182()//Position - 0xC59D
{
	func_27(&(Global_102125.f_2890), &Global_102125, 0, 1, 1, 0);
}

int func_183(var uParam0)//Position - 0xC5B8
{
	float fVar0;
...
void func_184(int iParam0, int iParam1)//Position - 0xC646
{
	if (iParam0 == 1)
	{
		if (!func_130(iParam1))
...
int func_185(bool bParam0)//Position - 0xC6AA
{
	int iVar0;
...
int func_186(int iParam0)//Position - 0xC741
{
	if (func_127(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
int func_187(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xC76B
{
	var uVar0;
...
void func_188(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC7F3
{
...
void func_189(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC82E
{
...
void func_190(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xC884
{
...
void func_191(int iParam0, int iParam1, vector3 vParam2)//Position - 0xC91F
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_192(int iParam0, bool bParam1)//Position - 0xCA10
{
	if (iParam0 == -1)
	{
		return;
...
int func_193(int iParam0)//Position - 0xCA4C
{
	if (Global_76573 == iParam0)
	{
		if (Global_76574 == -1)
...
void func_194(int iParam0, int iParam1)//Position - 0xCA85
{
	bool bVar0;
	int iVar1;
...
bool func_195()//Position - 0xCB23
{
	return Global_96008;
}

void func_196(int iParam0)//Position - 0xCB2F
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_197(iParam0);
...
void func_197(int iParam0)//Position - 0xCB46
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_198(int iParam0)//Position - 0xCC2E
{
	if (iParam0 == -1)
	{
		iParam0 = func_166();
...
int func_199(var uParam0, bool bParam1)//Position - 0xCC56
{
	struct<27> Var0;
...
void func_200(int iParam0, var uParam1, int iParam2)//Position - 0xCEC9
{
	int iVar0;
	int iVar1;
...
int func_201(int iParam0)//Position - 0xD221
{
...
int func_202(var uParam0)//Position - 0xD241
{
...
int func_203(var uParam0)//Position - 0xD259
{
...
void func_204(var uParam0)//Position - 0xD27E
{
	int iVar0;
	int iVar1;
...
void func_205(int iParam0)//Position - 0xD582
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_206(var uParam0)//Position - 0xD5AD
{
	int iVar0;
...
int func_207(var uParam0, bool bParam1, bool bParam2)//Position - 0xD62D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_208(int iParam0, int iParam1)//Position - 0xD7EB
{
	int iVar0;
...
int func_209(var uParam0, bool bParam1, int iParam2)//Position - 0xD81B
{
	int iVar0;
	int iVar1;
...
int func_210(int iParam0)//Position - 0xDAD7
{
...
int func_211(int iParam0, float fParam1)//Position - 0xDB0B
{
	float fVar0;
...
bool func_212(int iParam0, float fParam1)//Position - 0xDB81
{
	return func_213(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_213(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDB99
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
...
int func_214(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xDC5A
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_215(int iParam0, int iParam1)//Position - 0xDD86
{
	int iVar0;
...
int func_217(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xDE95
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_218(vector3 vParam0, vector3 vParam3)//Position - 0xDF26
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_219(vector3 vParam0)//Position - 0xDF47
{
	float fVar0;
	float fVar1;
...
void func_220(var uParam0)//Position - 0xDF86
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_221(int iParam0, int iParam1)//Position - 0xDFA1
{
	int iVar0;
...
int func_222(int iParam0)//Position - 0xDFE0
{
...
int func_223(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE008
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_224(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE103
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_225(int iParam0, float fParam1)//Position - 0xE20F
{
	var uVar0;
	vector3 vVar1;
...
int func_226(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0xE2A4
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_227(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE332
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_228(int iParam0)//Position - 0xE37A
{
...
void func_229(int iParam0)//Position - 0xE3C4
{
	int iVar0;
...
int func_230(int iParam0)//Position - 0xE461
{
	if (iParam0 == -1)
	{
		iParam0 = func_166();
...
int func_231(int iParam0)//Position - 0xE4F9
{
...
int func_234(int iParam0)//Position - 0xE57B
{
...
int func_236(int iParam0)//Position - 0xE5ED
{
	if (func_108(0))
	{
...
int func_239(var uParam0)//Position - 0xE662
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			{
				func_248(&(uParam0->f_35[0]), iVar0[1], vLocal_94, fLocal_97);
				if (func_127(uParam0->f_35[0]))
				{
...
void func_240(bool bParam0)//Position - 0xE87C
{
...
void func_241(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xE8CE
{
	if (iParam0 != 198)
	{
		if (Global_76577)
...
void func_242(int iParam0, int iParam1)//Position - 0xE929
{
	switch (iParam0)
	{
		case 12:
...
void func_243(int iParam0, bool bParam1)//Position - 0xEA12
{
	if (bParam1)
	{
...
bool func_244(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0xEA3B
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_246()//Position - 0xF3D3
{
	return Global_30737;
}

int func_247(var uParam0, int iParam1)//Position - 0xF3DE
{
	int iVar0;
...
void func_248(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0x12C1E
{
	func_249(iParam0);
...
void func_249(int iParam0)//Position - 0x12C60
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_250(int iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)//Position - 0x12CFC
{
...
int func_251(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0x12D58
{
	int iVar0;
...
int func_252(var uParam0, int iParam1)//Position - 0x12DE6
{
	int iVar0;
...
int func_253(var uParam0)//Position - 0x12E2C
{
	if (func_203(uParam0))
	{
...
int func_254(int iParam0)//Position - 0x12E56
{
	int iVar0;
...
void func_255(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x12E87
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_256(int iParam0)//Position - 0x12EC3
{
	struct<27> Var0;
	int iVar32;
...
int func_257(int iParam0)//Position - 0x12F17
{
	char* sVar0;
...
int func_258(int iParam0)//Position - 0x12FD0
{
	var uVar0;
...
int func_259(int iParam0)//Position - 0x13091
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_260(int iParam0, char* sParam1)//Position - 0x13116
{
...
bool func_261(int iParam0)//Position - 0x131F8
{
...
bool func_262(int iParam0)//Position - 0x13226
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_263(int iParam0)//Position - 0x13254
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_264(int iParam0)//Position - 0x13282
{
	if (func_231(iParam0))
	{
		return 0;
...
void func_265()//Position - 0x132B7
{
	func_288("Running end routines.");
	Global_111278 = (Global_111278 - 1);
}

int func_266(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0x132D1
{
	int iVar0;
...
int func_267(int iParam0, vector3 vParam1, float fParam4, var uParam5)//Position - 0x13336
{
	int iVar0;
	struct<7> Var1;
...
int func_268(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x133B4
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_269(int iParam0, bool bParam1)//Position - 0x1342F
{
	char* sVar0;
	...
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_99, 0);
	func_240(1);
	if (bParam1)
	{
		func_198(*iParam0);
...
void func_270(char* sParam0)//Position - 0x134B4
{
...
void func_271()//Position - 0x134D3
{
	Global_19671 = 0;
	func_272();
}

void func_272()//Position - 0x134E3
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_273(char* sParam0)//Position - 0x13504
{
	struct<6> Var0;
...
struct<6> func_274()//Position - 0x13524
{
	struct<6> Var0;
...
int func_275(var uParam0)//Position - 0x13548
{
	if (func_203(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_276(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x1357E
{
...
void func_277(var uParam0, bool bParam1)//Position - 0x1359E
{
	func_278(&(uParam0->f_41), bParam1);
}

void func_278(var uParam0, bool bParam1)//Position - 0x135B0
{
	int iVar0;
...
void func_279(int iParam0, bool bParam1)//Position - 0x135EE
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_280(var uParam0, bool bParam1)//Position - 0x13629
{
	func_281(&(uParam0->f_35), bParam1);
}

void func_281(var uParam0, bool bParam1)//Position - 0x1363B
{
	int iVar0;
...
void func_282(int iParam0)//Position - 0x13678
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_283(var uParam0, int iParam1)//Position - 0x136B0
{
	func_284(&(uParam0->f_28), iParam1);
}

void func_284(var uParam0, int iParam1)//Position - 0x136C2
{
	int iVar0;
...
void func_285(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x13703
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_286(int iParam0)//Position - 0x13753
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_287(var uParam0)//Position - 0x13794
{
	if (*uParam0 == -1)
	{
		return;
...
void func_288(int iParam0)//Position - 0x137D1
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(iParam0))
	{
	}
...
void func_289(var uParam0)//Position - 0x137E3
{
	*uParam0 = -1;
...
void func_290()//Position - 0x13816
{
	func_288("Running start routines.");
	Global_111278++;
}

int func_291(int iParam0)//Position - 0x13830
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
