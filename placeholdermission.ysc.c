...
void func_13(var uParam0, int iParam1)//Position - 0x50A
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
void func_14(var uParam0)//Position - 0x6D3
{
	*uParam0 = -15;
}

int func_15(int iParam0, var uParam1, float fParam2)//Position - 0x6E1
{
	switch (iParam0)
	{
		case 11:
...
void func_16(int iParam0, bool bParam1)//Position - 0x1050
{
	if (bParam1)
	{
...
bool func_19(bool bParam0)//Position - 0x1101
{
