...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_44 = 49;
	iLocal_45 = 64;
	uLocal_49 = HUD::_GET_LEVEL_BLIP_SPRITE();
					...
					switch (Local_2515[iVar0 /*6*/].f_2)
					{
						...
						case 1:
							if (MISC::GET_GAME_TIMER() > Local_2515[iVar0 /*6*/].f_5)
							{
								...
								TASK::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), 2475.075f, 4945.965f, 44.0228f, 1f, 20000, 1193033728, 0.5f);
...
bool func_40(int iParam0)//Position - 0x78E1
{
	return func_41(iParam0, 20);
}

bool func_41(int iParam0, int iParam1)//Position - 0x78F1
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_42()//Position - 0x790C
{
	return -1;
}

void func_43()//Position - 0x7915
{
	int iVar0;
...
int func_48()//Position - 0x7B3E
{
	func_49();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_49()//Position - 0x7B57
{
	int iVar0;
...
bool func_50(int iParam0)//Position - 0x7C54
{
	return iParam0 < 3;
}

int func_51(int iParam0)//Position - 0x7C60
{
	int iVar0;
	int iVar1;
...
int func_52(int iParam0)//Position - 0x7C9D
{
	if (func_50(iParam0))
	{
...
var func_53(int iParam0)//Position - 0x7CC2
{
	return Global_1798[iParam0 /*29*/];
}

bool func_54(int iParam0)//Position - 0x7CD1
{
	return Global_41396 == iParam0;
}

void func_55()//Position - 0x7CDF
{
	int iVar0;
...
bool func_56(int iParam0, int iParam1)//Position - 0x7D37
{
	switch (iParam0)
	{
		case 5:
...
void func_58(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x7DC9
{
...
void func_61(int iParam0, int iParam1, char* sParam2)//Position - 0x7EA7
{
	int iVar0;
...
void func_62(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x7F0C
{
...
void func_63(var uParam0, int iParam1)//Position - 0x7FA7
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
void func_64(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x7FC4
{
	int iVar0;
...
int func_66(char* sParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, char* sParam6, int iParam7, int iParam8, char* sParam9)//Position - 0x8057
{
	if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
	{
...
bool func_67(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7)//Position - 0x80F7
{
...
int func_68(int iParam0)//Position - 0x8145
{
	return iLocal_3511[iParam0];
}

int func_69(int iParam0)//Position - 0x8154
{
...
void func_70()//Position - 0x81B8
{
	Global_19671 = 0;
	func_71();
}

void func_71()//Position - 0x81C8
{
...
void func_72()//Position - 0x81FF
{
	Global_19671 = 0;
	func_57();
}

float func_73(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x820F
{
	vector3 vVar0;
...
int func_74(int iParam0)//Position - 0x8249
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_75(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x8269
{
	func_76(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_76(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x8293
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_77(vector3 vParam0)//Position - 0x8687
{
...
int func_78(int iParam0, int iParam1, bool bParam2)//Position - 0x86B1
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_79(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x8722
{
...
int func_80(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x87FB
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_81(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x8AF1
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_82(vector3 vParam0)//Position - 0x8BA5
{
	float fVar0;
	float fVar1;
...
void func_83(int iParam0)//Position - 0x8BE4
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
					...
					if (Local_1619[iVar0 /*24*/].f_3 <= 3)
					{
						switch (Local_755[iVar0 /*33*/].f_3)
						{
							...
							case 2:
								...
								{
									func_103(Local_755[iVar0 /*33*/], &(Local_755[iVar0 /*33*/].f_25), -1, 0, 1, 0, -1082130432, 0, -1, -1, 1);
								}
									...
									switch (Local_755[iVar0 /*33*/].f_5)
									{
										...
										case 12:
											if (PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), Local_755[iVar0 /*33*/]) && func_73(Local_755[iVar0 /*33*/], 2448.003f, 4982.305f, 45.8519f, 1) < 10f)
											{
												...
												{
													TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_755[iVar0 /*33*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 1f, 20000, 1048576000, 0, 1193033728);
							...
							case 28:
								...
								{
									case 0:
										if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_755[iVar0 /*33*/]) || (func_96(ENTITY::GET_ENTITY_COORDS(Local_755[iVar0 /*33*/], true), 1f, 1120403456) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2448.583f, 4969.292f, 45.1856f, 2439.538f, 4978.061f, 46.82762f, 5.75f, 0, true, 0)))
										{
							...
							case 30:
								...
								switch (Local_755[iVar0 /*33*/].f_5)
								{
									...
									case 3:
										...
										TASK::TASK_SYNCHRONIZED_SCENE(Local_755[iVar0 /*33*/], iLocal_2874, "misschinese2_crystalmaze", "_cower_to_stand", 4f, -8f, 0, 0, 1148846080, 0);
										TASK::TASK_LOOK_AT_ENTITY(Local_755[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
										Local_755[iVar0 /*33*/].f_5++;
										break;
...
int func_86(int iParam0)//Position - 0xC4EF
{
	int iVar0;
	bool bVar1;
...
void func_87(bool bParam0)//Position - 0xC588
{
	iLocal_3491 = 0;
	if (bParam0)
	{
...
int func_88(char* sParam0)//Position - 0xC5A4
{
	struct<6> Var0;
...
struct<6> func_89()//Position - 0xC5C4
{
	struct<6> Var0;
...
bool func_90(char* sParam0, int iParam1, char* sParam2)//Position - 0xC5E8
{
...
void func_91()//Position - 0xC606
{
	Global_19671 = 0;
	func_92();
}

void func_92()//Position - 0xC616
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
int func_93(int iParam0)//Position - 0xC63A
{
	int iVar0;
...
void func_94()//Position - 0xC68A
{
	Global_19671 = 0;
	func_95();
}

void func_95()//Position - 0xC69A
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_96(vector3 vParam0, float fParam3, float fParam4)//Position - 0xC6BB
{
...
int func_97(int iParam0, int iParam1)//Position - 0xC703
{
	int iVar0;
...
void func_98(int iParam0, bool bParam1)//Position - 0xC74D
{
	if (bParam1)
	{
...
void func_99()//Position - 0xC786
{
	TASK::OPEN_SEQUENCE_TASK(&uLocal_257);
}

void func_100(int iParam0)//Position - 0xC795
{
...
float func_101(float fParam0, float fParam1, float fParam2)//Position - 0xCA83
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
float func_102(struct<2> Param0, float fParam2, struct<2> Param3, float fParam5, int iParam6)//Position - 0xCAAA
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_103(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xCB0F
{
	if (iParam3 == 0)
	{
...
void func_104(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5)//Position - 0xCCE6
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
void func_105(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCD22
{
...
void func_106(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCDB6
{
...
int func_107(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, bool bParam7, int iParam8)//Position - 0xCDF1
{
	int iVar0;
...
void func_108(int iParam0, bool bParam1)//Position - 0xD623
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_109(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, vector3 vParam8, vector3 vParam11, vector3 vParam14, vector3 vParam17, vector3 vParam20, vector3 vParam23, vector3 vParam26, vector3 vParam29)//Position - 0xD6BE
{
	if (iLocal_52 > 0)
	{
...
void func_110(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10, vector3 vParam13, vector3 vParam16, vector3 vParam19)//Position - 0xD718
{
						...
						if (!PED::IS_PED_DEAD_OR_DYING((*uParam0)[iLocal_61 /*24*/], 1))
						{
							switch (iLocal_60)
							{
									...
									if (!bLocal_53)
									{
										if (!bLocal_56)
										{
											if (!iLocal_76)
											{
												...
												{
													func_94();
													if (func_111(vParam13.y, vParam13.z, (*uParam0)[iLocal_61 /*24*/], vParam13.x, -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
													{
														iLocal_67 = 2;
													}
												}
										...
										{
											func_94();
											if (func_111(vParam10.y, vParam10.z, (*uParam0)[iLocal_61 /*24*/], vParam10.x, -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
											{
												iLocal_67 = 2;
											}
										}
								...
								case 5:
									iLocal_76 = 0;
									func_94();
									if (func_111(vParam16.y, vParam16.z, (*uParam0)[iLocal_61 /*24*/], vParam16.x, -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
									{
										iLocal_67 = 2;
									}
									break;
								...
								case 3:
									...
									{
										func_94();
										if (func_111(vParam19.y, vParam19.z, (*uParam0)[iLocal_61 /*24*/], vParam19.x, -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
										{
											iLocal_67 = 2;
										}
									}
...
int func_111(char* sParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, char* sParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, char* sParam12, int iParam13)//Position - 0xDA25
{
	func_64(sParam0, iParam1, iParam4, iParam7, iParam10);
...
void func_112(int iParam0, int iParam1, char* sParam2)//Position - 0xDAD8
{
	int iVar0;
...
void func_113(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, vector3 vParam8)//Position - 0xDB35
{
	int iVar0;
	float fVar1;
	int iVar2;
...
float func_114(float fParam0, float fParam1, float fParam2)//Position - 0xEC17
{
	if (fParam0 < fParam1)
	{
		return fParam1;
...
int func_115(int iParam0, var uParam1, char* sParam2, vector3 vParam3, vector3 vParam6, vector3 vParam9, bool bParam12)//Position - 0xEC3B
{
	switch ((uParam1[iParam0 /*24*/])->f_5)
	{
		...
		case 2:
			if (!MISC::ARE_STRINGS_EQUAL("chi2_hear", vParam3.y))
			{
				...
				{
					if (func_111(vParam9.y, vParam9.z, (*uParam1)[iParam0 /*24*/], vParam9.x, -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
					{
						if (bParam12)
						{
						}
		...
		case 5:
			if (func_111(vParam3.y, vParam6.z, (*uParam1)[iParam0 /*24*/], vParam3.x, -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
			{
				(uParam1[iParam0 /*24*/])->f_5++;
			}
			break;
...
int func_116(int iParam0, var uParam1, bool bParam2)//Position - 0xF09F
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float func_117(int iParam0, int iParam1, int iParam2)//Position - 0xF191
{
	vector3 vVar0;
	vector3 vVar3;
...
float func_119(int iParam0, int iParam1)//Position - 0xF3AC
{
...
float func_120(int iParam0, vector3 vParam1)//Position - 0xF3D9
{
	float fVar0;
...
void func_121(var uParam0, struct<2> Param1, var uParam3, struct<2> Param4, var uParam6, struct<2> Param7, var uParam9, struct<2> Param10, var uParam12)//Position - 0xF417
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_122(int iParam0)//Position - 0xFC5B
{
...
struct<6> func_124()//Position - 0xFDF4
{
	struct<6> Var0;
	int iVar6;
	int iVar7;
...
void func_127(int iParam0, int iParam1)//Position - 0x1012B
{
	int iVar0;
...
void func_128(vector3 vParam0, int iParam3)//Position - 0x10199
{
	if (iLocal_438 == 0)
	{
		iParam3 = 0;
...
void func_129()//Position - 0x10222
{
	int iVar0;
	int iVar1;
	float fVar2;
...
Vector3 func_130()//Position - 0x10535
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
void func_131()//Position - 0x105A5
{
	int iVar0;
...
void func_132()//Position - 0x10633
{
	if (!iLocal_264)
	{
		iLocal_264 = 1;
...
void func_133()//Position - 0x10646
{
	int iVar0;
	...
	if (iLocal_2511 >= 4)
	{
		...
		while (iVar0 < Local_755)
		{
			if (ENTITY::DOES_ENTITY_EXIST(Local_755[iVar0 /*33*/]))
			{
				...
				{
					func_103(Local_755[iVar0 /*33*/], &(Local_755[iVar0 /*33*/].f_25), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1);
				}
			}
...
void func_134(int iParam0)//Position - 0x106FA
{
	bool bVar0;
	struct<8> Var1;
...
void func_135()//Position - 0x1076C
{
	int iVar0;
...
void func_136(int iParam0)//Position - 0x1081E
{
...
void func_138(char* sParam0)//Position - 0x108A6
{
	func_148(sParam0);
	func_139(0);
}

void func_139(int iParam0)//Position - 0x108B9
{
	int iVar0;
...
int func_140(int iParam0)//Position - 0x108FE
{
	int iVar0;
	int iVar1;
...
void func_141(var uParam0, int iParam1)//Position - 0x10A15
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_143(Global_111560.f_18528[iVar0], &vVar2, &fVar5))
			{
...
void func_142(var uParam0)//Position - 0x10BDE
{
	*uParam0 = -15;
}

int func_143(int iParam0, var uParam1, float fParam2)//Position - 0x10BEC
{
	switch (iParam0)
	{
		case 11:
...
void func_144(int iParam0, bool bParam1)//Position - 0x1155B
{
	if (bParam1)
	{
...
void func_145()//Position - 0x11599
{
	Global_98704 = 1;
...
bool func_147(bool bParam0)//Position - 0x116BD
{
...
void func_148(char* sParam0)//Position - 0x116E8
{
...
void func_149()//Position - 0x11728
{
	func_176(46, 52);
...
void func_150()//Position - 0x117B6
{
	HUD::CLEAR_PRINTS();
	func_151(0, 0);
	func_443(0);
...
void func_151(bool bParam0, int iParam1)//Position - 0x117CD
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_152(int iParam0)//Position - 0x118A3
{
	switch (iParam0)
	{
		case 71:
...
int func_153(int iParam0, int iParam1)//Position - 0x118E1
{
...
void func_154()//Position - 0x11907
{
	vector3 vVar0;
...
void func_155(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x11D91
{
	int iVar0;
	int iVar1;
...
void func_156(char* sParam0, int iParam1, int iParam2)//Position - 0x122A8
{
	iParam2 = iParam2;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
void func_157(char[4] cParam0, int iParam1)//Position - 0x122C1
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_158(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x122D8
{
	bLocal_3118 = false;
	iLocal_3119 = 0;
...
int func_159(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x12337
{
	switch (iParam2)
	{
		case 0:
...
void func_160(int iParam0)//Position - 0x12490
{
	int iVar0;
...
int func_161(int iParam0)//Position - 0x124BC
{
	int iVar0;
...
int func_162(int iParam0)//Position - 0x124EF
{
	int iVar0;
...
void func_163(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x12547
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_165(int iParam0, int iParam1, int iParam2)//Position - 0x139CC
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_166(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x13A52
{
	bool bVar0;
	float fVar1;
	float fVar2;
					...
					switch (Local_2917[iParam0 /*10*/].f_6)
					{
						case 1:
							if (MISC::GET_GAME_TIMER() > Local_2917[iParam0 /*10*/].f_7)
							{
								...
								{
									FIRE::ADD_EXPLOSION(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) + Vector(0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 4f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 4f)), 16, 1.5f, 1, 0, 1065353216, 0);
						...
						default:
							...
							if (MISC::GET_GAME_TIMER() > Local_2917[iParam0 /*10*/].f_8)
							{
								...
								while (iVar5 < vLocal_2889.x)
								{
									...
									{
										FIRE::ADD_EXPLOSION(vLocal_2889[iVar5 /*3*/], 16, 1.5f, 1, 0, 1065353216, 0);
				...
				case 41:
					switch (Local_2917[iParam0 /*10*/].f_6)
					{
						...
						case 900:
							...
							if (!PED::IS_PED_INJURED(Local_755[10 /*33*/]))
							{
								if (((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_755[10 /*33*/], PLAYER::PLAYER_PED_ID(), 1) || PED::IS_PED_RAGDOLL(Local_755[10 /*33*/])) || PED::IS_PED_INJURED(Local_755[11 /*33*/])) || (!PED::IS_PED_INJURED(Local_755[10 /*33*/]) && TASK::GET_SCRIPT_TASK_STATUS(Local_755[10 /*33*/], 1785177548) == 2))
								{
									if (!MISC::IS_BIT_SET(Local_2917[iParam0 /*10*/].f_8, 0))
									{
							...
							if (!PED::IS_PED_INJURED(Local_755[11 /*33*/]))
							{
								if (((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_755[11 /*33*/], PLAYER::PLAYER_PED_ID(), 1) || PED::IS_PED_RAGDOLL(Local_755[11 /*33*/])) || MISC::IS_BIT_SET(Local_2917[iParam0 /*10*/].f_8, 1)) || (!PED::IS_PED_INJURED(Local_755[11 /*33*/]) && TASK::GET_SCRIPT_TASK_STATUS(Local_755[11 /*33*/], 1785177548) == 2))
								{
...
void func_167()//Position - 0x16529
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
bool func_168(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x165DC
{
	if (bParam6)
	{
...
void func_169(bool bParam0)//Position - 0x16623
{
	int iVar0;
...
int func_170(var uParam0)//Position - 0x16781
{
	int iVar0;
...
void func_171(int iParam0)//Position - 0x167B9
{
	bool bVar0;
	int iVar1;
...
void func_172(bool bParam0)//Position - 0x1682A
{
	if (bParam0)
	{
...
int func_175(int iParam0, int iParam1)//Position - 0x168C2
{
	if (Local_2917[iParam0 /*10*/] == iParam1)
	{
...
void func_176(int iParam0, int iParam1)//Position - 0x168E3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_178(int iParam0)//Position - 0x17890
{
...
int func_179()//Position - 0x178B3
{
	return iLocal_280;
}

int func_180()//Position - 0x178BE
{
	int iVar0;
...
void func_181()//Position - 0x1791D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_182(int iParam0)//Position - 0x186B3
{
	func_186();
	func_185();
	func_184();
...
void func_183()//Position - 0x186E2
{
	int iVar0;
...
void func_184()//Position - 0x18742
{
	int iVar0;
...
void func_185()//Position - 0x187F6
{
	int iVar0;
...
void func_186()//Position - 0x1884C
{
	int iVar0;
...
int func_187(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1888E
{
	int iVar0;
...
void func_189(int iParam0, bool bParam1, int iParam2)//Position - 0x188DA
{
	int iVar0;
...
void func_190()//Position - 0x18980
{
	int iVar0;
...
void func_191(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x189F5
{
	func_76(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_192(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x18A1E
{
	if (bParam0)
	{
...
bool func_193()//Position - 0x18B57
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_194(int iParam0, int iParam1)//Position - 0x18B74
{
	bool bVar0;
...
int func_195(int iParam0, bool bParam1)//Position - 0x18BBF
{
	int iVar0;
	int iVar1;
...
int func_196()//Position - 0x18C00
{
	return Global_1312745;
}

int func_197(int iParam0)//Position - 0x18C0C
{
...
bool func_198()//Position - 0x18C4E
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

void func_199(int iParam0)//Position - 0x18C5F
{
	if (iParam0 == 1)
	{
...
void func_202()//Position - 0x18E51
{
	GRAPHICS::_0x27CFB1B1E078CB2D();
	func_176(28, 45);
...
void func_203(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x190AB
{
...
void func_204(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x19173
{
	if (!Local_3358[iParam0 /*7*/].f_1)
	{
...
int func_205(int iParam0, int iParam1)//Position - 0x191A9
{
	if (Local_3358[iParam0 /*7*/] == iParam1)
	{
		if (Local_3358[iParam0 /*7*/].f_1)
...
void func_206()//Position - 0x191DC
{
	func_176(5, 31);
...
void func_207()//Position - 0x194B1
{
	vector3 vVar0;
	float fVar3;
	int iVar4;
		...
		case 0:
			if (STREAMING::IS_SRL_LOADED())
			{
				...
				if (iLocal_2512 == 1)
				{
					...
					TASK::TASK_GO_STRAIGHT_TO_COORD(0, 2570.543f, 4982.002f, 50.6795f, 1f, 20000, 1193033728, 0.5f);
...
void func_208()//Position - 0x1A53D
{
	int iVar0;
...
void func_209(var uParam0, var uParam1, char* sParam2, float fParam3, vector3 vParam4, float fParam7, int iParam8)//Position - 0x1A6D1
{
	int iVar0;
...
bool func_210()//Position - 0x1A7C8
{
	bool bVar0;
...
void func_211(bool bParam0)//Position - 0x1A7EB
{
	if (bParam0)
	{
		func_217();
...
void func_212(int iParam0)//Position - 0x1A84E
{
	if (func_215())
	{
		return;
...
void func_213(bool bParam0, bool bParam1)//Position - 0x1A8D8
{
	if (bParam0)
	{
		if (func_216(0))
...
bool func_214()//Position - 0x1A94C
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

bool func_215()//Position - 0x1A95D
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

int func_216(int iParam0)//Position - 0x1A96F
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
void func_217()//Position - 0x1A9C9
{
...
void func_218(int iParam0, bool bParam1, bool bParam2)//Position - 0x1A9F2
{
	int iVar0;
...
var func_219()//Position - 0x1ABA3
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

void func_220(int iParam0, var uParam1)//Position - 0x1ABB3
{
	switch (iParam0)
	{
		case 0:
...
void func_221(int iParam0, var uParam1)//Position - 0x1ABFB
{
	switch (iParam0)
	{
		case 0:
...
void func_222(var uParam0)//Position - 0x1AC43
{
...
float func_223(float fParam0)//Position - 0x1AC5E
{
	return (fParam0 * 57.29578f);
}

void func_224()//Position - 0x1AC6E
{
	int iVar0;
...
int func_225(int iParam0)//Position - 0x1AF67
{
	int iVar0;
...
int func_226(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x1AFA9
{
...
void func_227(int iParam0)//Position - 0x1B138
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
bool func_228(int iParam0, vector3 vParam1, vector3 vParam4, int iParam7, char* sParam8, bool bParam9, bool bParam10, int iParam11)//Position - 0x1B164
{
...
int func_229(int iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, char* sParam19, char* sParam20, char* sParam21, char* sParam22, char* sParam23, char* sParam24, bool bParam25, bool bParam26, char* sParam27, bool bParam28, int iParam29, bool bParam30, int iParam31, int iParam32, int iParam33, int iParam34, bool bParam35, float fParam36)//Position - 0x1B1B5
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
int func_230(int iParam0, bool bParam1, bool bParam2)//Position - 0x1BB1D
{
	return func_14(iParam0, !bParam1, bParam2);
}

int func_231(int iParam0)//Position - 0x1BB30
{
...
int func_232(bool bParam0, bool bParam1, bool bParam2)//Position - 0x1BB8E
{
	int iVar0;
...
int func_233(int iParam0)//Position - 0x1BC73
{
	float fVar0;
...
int func_234(int iParam0, int iParam1)//Position - 0x1BCAA
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
int func_235(int iParam0, int iParam1)//Position - 0x1BD15
{
	int iVar0;
...
int func_236(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x1BD5D
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_237(int iParam0, int iParam1)//Position - 0x1BDD8
{
	if (HUD::DOES_BLIP_EXIST(iParam0))
	{
...
void func_238(int iParam0, char* sParam1, int iParam2)//Position - 0x1BE13
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_239(iParam2), 1);
}

int func_239(int iParam0)//Position - 0x1BE2A
{
	int iVar0;
...
void func_240(int iParam0, char* sParam1, bool bParam2)//Position - 0x1C020
{
	if (!bParam2)
	{
...
int func_241(int iParam0)//Position - 0x1C058
{
...
int func_242(int iParam0, int iParam1)//Position - 0x1C07C
{
...
int func_244(var uParam0)//Position - 0x1C0EB
{
	int iVar0;
	int iVar1;
...
int func_245(var uParam0, int iParam1)//Position - 0x1C10E
{
	int iVar0;
...
int func_246(int iParam0, var uParam1, int iParam2)//Position - 0x1C13F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_247(char* sParam0)//Position - 0x1C1D3
{
...
int func_248(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, char* sParam7, float fParam8, bool bParam9, int iParam10, bool bParam11, int iParam12, var uParam13, var uParam14, var uParam15, int iParam16, bool bParam17)//Position - 0x1C1EB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_249(int iParam0, var uParam1)//Position - 0x1D260
{
	switch (iParam0)
	{
		case 0:
...
void func_250(var uParam0, char* sParam1, char* sParam2, bool bParam3)//Position - 0x1D2A8
{
	if (!bParam3)
	{
		if (!MISC::IS_STRING_NULL(sParam1))
...
void func_251(char* sParam0, char* sParam1, int iParam2, int iParam3)//Position - 0x1D2E2
{
	iParam3 = iParam3;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
int func_252(int iParam0, var uParam1)//Position - 0x1D301
{
	switch (iParam0)
	{
		case 0:
...
int func_253(int iParam0, float fParam1)//Position - 0x1D34A
{
	int iVar0;
...
int func_254(int iParam0, int iParam1)//Position - 0x1D381
{
	int iVar0;
...
int func_255(int iParam0, int iParam1)//Position - 0x1D3E8
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
void func_256(int iParam0, var uParam1)//Position - 0x1D41D
{
	switch (iParam0)
	{
		case 0:
...
int func_257(int iParam0, var uParam1)//Position - 0x1D465
{
	switch (iParam0)
	{
		case 0:
...
int func_258(int iParam0)//Position - 0x1D4AE
{
	int iVar0;
	int iVar1;
...
int func_259(int iParam0, var uParam1)//Position - 0x1D53B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_260(var uParam0)//Position - 0x1D69B
{
	int iVar0;
...
int func_261(var uParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x1D6CA
{
	int iVar0;
...
int func_262(int iParam0)//Position - 0x1D7A8
{
	float fVar0;
...
int func_263(int iParam0, int iParam1)//Position - 0x1D7E0
{
	int iVar0;
...
void func_264()//Position - 0x1D810
{
	int iVar0;
	int iVar1;
...
void func_265(var uParam0)//Position - 0x1D87D
{
	int iVar0;
...
void func_266(var uParam0)//Position - 0x1D920
{
	int iVar0;
...
Vector3 func_267()//Position - 0x1D9B6
{
	vector3 vVar0;
...
int func_268(int iParam0, int iParam1)//Position - 0x1D9C2
{
	int iVar0;
...
void func_269()//Position - 0x1DA06
{
	int iVar0;
	int iVar1;
	...
	switch (iLocal_2512)
	{
		case 0:
			...
			if (func_210())
			{
				...
				{
					Local_755[14 /*33*/] = Global_95196.f_9[2];
					Local_755[13 /*33*/] = Global_95196.f_9[1];
					Local_755[11 /*33*/] = Global_95196.f_9[4];
					Local_755[10 /*33*/] = Global_95196.f_9[3];
					Local_755[12 /*33*/] = Global_95196.f_9[0];
		...
		case 2:
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("tao", 0))
			{
				if (!PED::IS_PED_INJURED(Local_755[11 /*33*/]))
				{
					...
					TASK::TASK_SYNCHRONIZED_SCENE(Local_755[11 /*33*/], iVar0, "misschinese2_crystalmaze", "2int_Loop_A_TaoCheng", 1000f, -4f, 1, 16, 1148846080, 0);
				}
			}
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Taos_Translator", 0))
			{
				if (!PED::IS_PED_INJURED(Local_755[10 /*33*/]))
				{
					...
					TASK::TASK_SYNCHRONIZED_SCENE(Local_755[10 /*33*/], iVar1, "misschinese2_crystalmaze", "2int_Loop_A_taotranslator", 1000f, -4f, 1, 16, 1148846080, 0);
				}
			}
...
void func_270(int iParam0)//Position - 0x1E17F
{
	if (Global_95621 != -1)
	{
...
void func_271()//Position - 0x1E1A3
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_96068[iVar0]))
		{
			...
			{
				ENTITY::SET_ENTITY_PROOFS(Global_96068[iVar0], false, false, false, false, false, 0, 0, 0);
...
void func_272()//Position - 0x1E256
{
	int iVar0;
...
void func_273(int iParam0, bool bParam1, bool bParam2)//Position - 0x1F232
{
	int iVar0;
...
void func_274(int iParam0, int iParam1, int iParam2)//Position - 0x20145
{
	Local_3337[iParam0 /*4*/].f_1 = iParam2;
	Local_3337[iParam0 /*4*/] = iParam1;
}

void func_275(int iParam0, int iParam1, int iParam2)//Position - 0x20161
{
	Local_3358[iParam0 /*7*/].f_1 = iParam2;
	Local_3358[iParam0 /*7*/] = iParam1;
}

Vector3 func_276(int iParam0, vector3 vParam1)//Position - 0x2017D
{
	var uVar0;
...
bool func_277(int iParam0)//Position - 0x201C3
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
bool func_278()//Position - 0x201E1
{
	return Global_105109.f_2890.f_8;
}

var func_279(int iParam0)//Position - 0x201F2
{
	if (Global_98706 > 0)
	{
...
float func_280()//Position - 0x2021C
{
	return Global_105109.f_2884.f_3;
}

Vector3 func_281()//Position - 0x2022D
{
	return Global_105109.f_2884;
}

void func_282(int iParam0, int iParam1, int iParam2)//Position - 0x2023E
{
...
void func_283(int iParam0)//Position - 0x20302
{
	if (iParam0 == 1)
	{
...
bool func_284()//Position - 0x2032B
{
	return MISC::IS_BIT_SET(Global_98669.f_20, 13);
}

void func_285(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2033F
{
	if (bParam0)
	{
		if (func_355())
...
int func_286(vector3 vParam0, float fParam3)//Position - 0x20403
{
	return func_287(&(Global_105109.f_2890), vParam0, fParam3, 0);
}

int func_287(var uParam0, vector3 vParam1, float fParam4, bool bParam5)//Position - 0x2041D
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
void func_288(int iParam0, int iParam1)//Position - 0x206CF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_289(int iParam0, var uParam1)//Position - 0x208D1
{
	int iVar0;
...
int func_290(int iParam0)//Position - 0x20B7C
{
	switch (iParam0)
	{
		case 1:
...
int func_291(int iParam0, var uParam1, var uParam2)//Position - 0x20C2C
{
	int iVar0;
	int iVar1;
...
int func_292(int iParam0)//Position - 0x20E1F
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_293(var uParam0)//Position - 0x20E3F
{
	int iVar0;
...
int func_294(int iParam0)//Position - 0x20EF0
{
...
int func_295(int iParam0)//Position - 0x20FCD
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_296(int iParam0, bool bParam1)//Position - 0x2117E
{
	int iVar0;
	struct<2> Var1;
...
int func_297(int iParam0)//Position - 0x212FE
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_299(int iParam0)//Position - 0x213E1
{
	int iVar0;
	int iVar1;
...
int func_300()//Position - 0x238AC
{
	return 0;
}

int func_301()//Position - 0x238B5
{
	return 1;
}

int func_302()//Position - 0x238BE
{
	return 1;
}

int func_303()//Position - 0x238C7
{
...
int func_305(int iParam0)//Position - 0x2399B
{
	int iVar0;
	char* sVar1;
...
int func_306(int iParam0)//Position - 0x239E1
{
	int iVar0;
...
int func_307(int iParam0)//Position - 0x23A1C
{
	int iVar0;
...
int func_308(int iParam0)//Position - 0x23A98
{
	int iVar0;
...
int func_309(int iParam0)//Position - 0x23B80
{
	int iVar0;
...
void func_310(int iParam0, bool bParam1)//Position - 0x23BE3
{
	if (iParam0 == -1)
	{
		return;
...
void func_311(int iParam0, int iParam1, bool bParam2)//Position - 0x23C40
{
	if (iParam0 == -1)
	{
		return;
...
bool func_312(int iParam0, int iParam1)//Position - 0x23C7B
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_313(int iParam0)//Position - 0x23C9E
{
	bool bVar0;
...
void func_314(var uParam0, var uParam1)//Position - 0x23E10
{
...
int func_315(int iParam0, int iParam1)//Position - 0x23EDC
{
	int iVar0;
...
int func_316(var uParam0)//Position - 0x23F4E
{
	return *uParam0;
}

int func_317(var uParam0, int iParam1)//Position - 0x23F59
{
	int iVar0;
	int iVar1;
...
int func_318(int iParam0, int iParam1)//Position - 0x256A5
{
	struct<82> Var0;
...
void func_319(int iParam0, var uParam1, int iParam2)//Position - 0x256E7
{
	int iVar0;
...
int func_320(int iParam0)//Position - 0x25943
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_321(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x25A06
{
	int iVar0;
	var uVar1[3];
	int iVar5;
...
int func_322(int iParam0, int iParam1, bool bParam2)//Position - 0x25C0E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_323(int iParam0, int iParam1)//Position - 0x25C6F
{
	int iVar0;
...
void func_324(int iParam0, int iParam1)//Position - 0x25CF1
{
	int iVar0;
...
void func_325(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x25D8F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_326(int iParam0, var uParam1, var uParam2)//Position - 0x26351
{
	int iVar0;
	int iVar1;
...
int func_327(int iParam0)//Position - 0x26514
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_328(var uParam0)//Position - 0x265F0
{
...
int func_329(int iParam0, int iParam1)//Position - 0x26630
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_330(int iParam0, int iParam1)//Position - 0x26715
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
void func_331(int iParam0, int iParam1)//Position - 0x26A8B
{
	int iVar0;
	int iVar1;
...
bool func_332()//Position - 0x26B03
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_333(int iParam0)//Position - 0x26B14
{
	int iVar0;
...
int func_334(int iParam0)//Position - 0x26B5F
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
int func_335(int iParam0)//Position - 0x26BE6
{
...
int func_336(int iParam0)//Position - 0x26C15
{
...
int func_337(int iParam0)//Position - 0x26C32
{
...
int func_338(int iParam0, int iParam1)//Position - 0x26C55
{
...
int func_339(int iParam0)//Position - 0x26C90
{
	if (func_338(iParam0, 0))
	{
...
int func_340(int iParam0, int iParam1)//Position - 0x26CB3
{
	int iVar0;
...
int func_341(int iParam0, bool bParam1, bool bParam2)//Position - 0x26D00
{
	int iVar0;
...
void func_342(vector3 vParam0, float fParam3, bool bParam4)//Position - 0x26D4A
{
	int iVar0;
...
int func_343(var uParam0)//Position - 0x26D9A
{
	if (func_344(uParam0))
	{
...
int func_344(var uParam0)//Position - 0x26DCF
{
...
bool func_345()//Position - 0x26E2E
{
	return func_343(&(Global_105109.f_2890));
}

void func_346()//Position - 0x26E41
{
	func_347(&(Global_105109.f_2890));
}

void func_347(var uParam0)//Position - 0x26E54
{
	if (func_344(uParam0))
	{
...
bool func_348()//Position - 0x26E72
{
	return func_344(&(Global_105109.f_2890));
}

int func_349(vector3 vParam0, float fParam3)//Position - 0x26E85
{
	return func_287(&(Global_102125.f_2890), vParam0, fParam3, 0);
}

bool func_350()//Position - 0x26E9F
{
	return func_343(&(Global_102125.f_2890));
}

void func_351()//Position - 0x26EB2
{
	func_347(&(Global_102125.f_2890));
}

int func_352(int iParam0, vector3 vParam1, int iParam4)//Position - 0x26EC5
{
	vector3 vVar0;
	vector3 vVar3;
...
Vector3 func_353()//Position - 0x26F2F
{
	return 2.55f, 5.665f, 2.55f;
}

int func_354()//Position - 0x26F46
{
	return Global_102125.f_2890.f_12.f_66;
}

bool func_355()//Position - 0x26F59
{
	return func_344(&(Global_102125.f_2890));
}

void func_356(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x26F6C
{
	if (func_366())
	{
...
int func_357(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0x27001
{
	int iVar0;
...
int func_358(var uParam0, int iParam1)//Position - 0x2708F
{
	int iVar0;
...
int func_359(int iParam0)//Position - 0x270D5
{
	if (!func_50(iParam0))
	{
		return func_53(iParam0);
...
void func_360(int iParam0)//Position - 0x270FB
{
	int iVar0;
	int iVar1;
...
void func_361()//Position - 0x2793F
{
	EVENT::UNBLOCK_DECISION_MAKER_EVENT(-455129387, 31);
}

void func_362(int iParam0, int iParam1)//Position - 0x27952
{
	int iVar0;
...
int func_363(int iParam0, int iParam1)//Position - 0x279B8
{
	int iVar0;
...
void func_364()//Position - 0x27AEB
{
	int iVar0;
...
void func_367(var uParam0, char* sParam1, int iParam2, char* sParam3)//Position - 0x27B63
{
	*uParam0 = sParam3;
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam2;
...
void func_368()//Position - 0x27B7C
{
...
void func_369()//Position - 0x27C12
{
	switch (iLocal_3688)
	{
		case 0:
...
void func_370(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x27D25
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar10 = func_431(&(Global_98669.f_3));
				if (iVar10 > -1)
				{
...
void func_371(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x27E9B
{
	func_372(&Global_105109, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_372(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x27EB7
{
	int iVar0;
	int iVar1;
...
int func_373(var uParam0)//Position - 0x28D43
{
...
void func_374(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x28D65
{
	int iVar0;
...
int func_375(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x28DED
{
...
int func_376(int iParam0)//Position - 0x28E2D
{
	int iVar0;
...
void func_377(var uParam0, int iParam1, int iParam2)//Position - 0x28E5B
{
...
int func_378(int iParam0)//Position - 0x28F37
{
	int iVar0;
...
int func_379(int iParam0, int iParam1, int iParam2)//Position - 0x28F79
{
	int iVar0;
...
int func_380(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x29007
{
	char* sVar0;
...
void func_381(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x29136
{
	int iVar0;
	int iVar1;
...
int func_382(int iParam0, int iParam1, int iParam2)//Position - 0x292D6
{
	int iVar0;
	var uVar1;
...
int func_383(var uParam0)//Position - 0x29308
{
	int iVar0;
	int iVar1;
...
int func_384(int iParam0, int iParam1)//Position - 0x2933C
{
	var uVar0;
	var uVar1;
	
	uVar0 = Global_2576213[iParam0 /*3*/][func_383(iParam1)];
...
void func_385(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x29368
{
	int iVar0;
...
void func_386(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x298B0
{
	int iVar0;
...
int func_387()//Position - 0x29AF1
{
	func_49();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_388(int iParam0, bool bParam1)//Position - 0x29B0A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_389(int iParam0, var uParam1)//Position - 0x29BFD
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_391(Var11.f_1)) && iVar72 < 51)
			{
...
int func_390(int iParam0)//Position - 0x29E85
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_391(int iParam0)//Position - 0x29F20
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
int func_392(int iParam0, int iParam1)//Position - 0x2A0B2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_393(int iParam0, var uParam1)//Position - 0x2AC23
{
	int iVar0;
	int iVar1;
...
int func_394(int iParam0)//Position - 0x2AC5E
{
	int iVar0;
...
void func_395(int iParam0)//Position - 0x2AED2
{
	int iVar0;
...
void func_396(var uParam0, int iParam1)//Position - 0x2AF0E
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_397(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x2B469
{
	int iVar0;
	int iVar1;
...
bool func_398(int iParam0, var uParam1, var uParam2)//Position - 0x2B4AD
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
int func_399(var uParam0)//Position - 0x2BBC8
{
...
bool func_400(int iParam0)//Position - 0x2BC23
{
	return func_401(iParam0, 0, 1);
}

int func_401(int iParam0, int iParam1, bool bParam2)//Position - 0x2BC33
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_402(int iParam0)//Position - 0x2BC9D
{
	switch (iParam0)
	{
		case 0:
...
int func_403(int iParam0)//Position - 0x2BFCD
{
	return func_401(iParam0, 5, 1);
}

int func_404(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x2BFDD
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_405(int iParam0, bool bParam1)//Position - 0x2C080
{
	switch (iParam0)
	{
		case -1:
...
int func_406(int iParam0)//Position - 0x2C69D
{
	if (iParam0 != func_42())
	{
...
Vector3 func_407(int iParam0, int iParam1)//Position - 0x2C6FB
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_408(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x2C7A9
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_409(vector3 vParam0, float fParam3)//Position - 0x2C83E
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_410(int iParam0)//Position - 0x2C882
{
	struct<6> Var0;
...
struct<6> func_411(int iParam0)//Position - 0x2CA06
{
	return func_412(iParam0);
}

struct<6> func_412(int iParam0)//Position - 0x2CA14
{
	struct<6> Var0;
...
int func_413(int iParam0, var uParam1)//Position - 0x2D4DB
{
	switch (iParam0)
	{
		case 0:
...
int func_414(int iParam0)//Position - 0x2D55D
{
	if (iParam0 != func_42())
	{
...
Vector3 func_415(int iParam0)//Position - 0x2D5BB
{
	switch (iParam0)
	{
		case 1:
...
int func_416()//Position - 0x2D7C6
{
	return func_417(PLAYER::PLAYER_ID());
}

var func_417(int iParam0)//Position - 0x2D7D6
{
	return MISC::GET_BITS_IN_RANGE(Global_2424073[iParam0 /*421*/].f_309.f_3, 28, 31);
}

int func_418(int iParam0)//Position - 0x2D7F3
{
	return func_401(iParam0, 0, 0);
}

int func_419(int iParam0)//Position - 0x2D803
{
	switch (iParam0)
	{
		case -1:
...
void func_421(var uParam0, int iParam1)//Position - 0x2DB17
{
	if (iParam1 <= 0)
	{
		return;
...
void func_422(var uParam0, int iParam1)//Position - 0x2DB9D
{
...
void func_423(var uParam0, int iParam1)//Position - 0x2DBD0
{
	int iVar0;
	int iVar1;
...
int func_424(int iParam0, int iParam1)//Position - 0x2DC21
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_425(int iParam0)//Position - 0x2DCC3
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_426(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_426(bool bParam0, int iParam1, int iParam2)//Position - 0x2DCE8
{
	if (bParam0)
	{
		return iParam1;
...
int func_427(var uParam0)//Position - 0x2DCFF
{
	return uParam0 & 15;
}

void func_428(var uParam0, int iParam1)//Position - 0x2DD0C
{
...
void func_429(var uParam0, int iParam1)//Position - 0x2DD46
{
...
void func_430(var uParam0, int iParam1)//Position - 0x2DD81
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_431(char* sParam0)//Position - 0x2DDBD
{
...
struct<2> func_432(int iParam0)//Position - 0x2DE13
{
	struct<2> Var0;
...
int func_433(char* sParam0, int iParam1)//Position - 0x2E260
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_434(int iParam0, var uParam1)//Position - 0x2E2A9
{
	switch (iParam0)
	{
		case 0:
...
int func_436(int iParam0)//Position - 0x2F581
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_437(int iParam0)//Position - 0x2F8C7
{
	struct<2> Var0;
	char[] cVar2[8];
...
int func_438(int iParam0)//Position - 0x2F8FF
{
	switch (iParam0)
	{
		case 69:
...
int func_439(int iParam0)//Position - 0x2F9BB
{
	switch (iParam0)
	{
		case 1:
...
int func_440(char* sParam0, bool bParam1)//Position - 0x2FA0F
{
	int iVar0;
	int iVar1;
...
int func_441(int iParam0, bool bParam1)//Position - 0x2FA39
{
	int iVar0;
...
void func_442(bool bParam0)//Position - 0x2FA6F
{
	int iVar0;
	int iVar1;
...
void func_443(int iParam0)//Position - 0x2FCF1
{
	func_360(iParam0);
	GRAPHICS::_SET_FAR_SHADOWS_SUPPRESSED(1);
...
void func_444()//Position - 0x2FE09
{
	int iVar0;
