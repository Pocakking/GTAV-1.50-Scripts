...
Vector3 func_1(int iParam0)//Position - 0x1F1
{
	int iVar0;
...
int func_2(int iParam0)//Position - 0x209
{
	if (iParam0 != func_3())
	{
...
int func_3()//Position - 0x235
{
	return -1;
}

int func_4(int iParam0)//Position - 0x23E
{
	if (iParam0 != func_3())
	{
...
int func_8(int iParam0, bool bParam1, bool bParam2)//Position - 0x2D2
{
	if (bParam1)
	{
		if (func_9(iParam0))
...
bool func_9(int iParam0)//Position - 0x304
{
	return func_10(iParam0);
}

bool func_10(int iParam0)//Position - 0x312
{
	return MISC::IS_BIT_SET(Global_1590446[iParam0 /*871*/].f_13.f_1, 0);
}

bool func_11(int iParam0)//Position - 0x32C
{
