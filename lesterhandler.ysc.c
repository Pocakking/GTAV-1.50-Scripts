		...
		if (!MISC::IS_BIT_SET(iLocal_216, 0))
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_46))
			{
				if (!PED::IS_PED_INJURED(iLocal_46))
				{
					...
					TASK::TASK_PLAY_ANIM_ADVANCED(0, "MISSHEIST_JEWEL@HACKING", "HACK_INTRO", vVar0, vVar3, 8f, -8f, -1, 262152, 0, 2, 0);
					TASK::TASK_PLAY_ANIM_ADVANCED(0, "MISSHEIST_JEWEL@HACKING", "HACK_LOOP", vVar0, vVar3, 8f, -8f, -1, 262153, 0, 2, 0);
...
void func_3(int iParam0, bool bParam1)//Position - 0x4B8
{
	int iVar0;
...
bool func_4(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x51D
{
...
int func_5(char* sParam0, int iParam1, bool bParam2)//Position - 0x56B
{
	Global_20806 = 0;
...
bool func_8(int iParam0)//Position - 0x8D8
{
	return func_9(iParam0, 20);
}

bool func_9(int iParam0, int iParam1)//Position - 0x8E8
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_10()//Position - 0x903
{
	return -1;
}

void func_11()//Position - 0x90C
{
	int iVar0;
...
bool func_16(int iParam0)//Position - 0xB34
{
	return Global_41396 == iParam0;
}

void func_17()//Position - 0xB42
{
	int iVar0;
...
bool func_18(int iParam0, int iParam1)//Position - 0xB99
{
	switch (iParam0)
	{
		case 5:
...
void func_20(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0xC2B
{
...
int func_22()//Position - 0xCA3
{
	func_23();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_23()//Position - 0xCBC
{
	int iVar0;
...
bool func_24(int iParam0)//Position - 0xDB9
{
	return iParam0 < 3;
}

int func_25(int iParam0)//Position - 0xDC5
{
	int iVar0;
	int iVar1;
...
int func_26(int iParam0)//Position - 0xE02
{
	if (func_24(iParam0))
	{
...
var func_27(int iParam0)//Position - 0xE27
{
	return Global_1798[iParam0 /*29*/];
}

void func_28(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xE36
{
...
bool func_29(bool bParam0)//Position - 0xED1
{
