			...
			if (func_168(iLocal_77) && !func_110())
			{
						...
						switch (iLocal_49)
						{
							case 0:
								if (!PED::IS_PED_INJURED(iLocal_76))
								{
									if (PED::IS_PED_IN_VEHICLE(iLocal_76, iLocal_77, 0))
									{
										...
										GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_wheel_burnout", iLocal_77, vLocal_320 + Vector(-0.5f, -1f, 0f), 0f, 180f, 0f, 0.25f, 0, 0, 0);
										...
										GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_wheel_burnout", iLocal_77, vLocal_326 + Vector(-0.5f, -1f, 0f), 0f, 180f, 0f, 0.25f, 0, 0, 0);
										SYSTEM::SETTIMERA(0);
							...
							case 2:
								...
								if (!ENTITY::IS_ENTITY_DEAD(iLocal_76, 0))
								{
									if (!PED::IS_PED_IN_VEHICLE(iLocal_76, iLocal_77, 0))
									{
										func_70(iLocal_76, &iLocal_67, -1, 0, 0, 0, -1082130432, 0, -1, -1, 1);
									}
								}
								else
								{
								...
								if (HUD::DOES_BLIP_EXIST(iLocal_65))
								{
									if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_77, 0))
									{
										...
										if (!iLocal_60)
										{
											...
											{
												ENTITY::SET_ENTITY_COORDS(iLocal_75, vLocal_93, 1, false, 0, 1);
									...
									else if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_77, iLocal_75, 20f, 20f, 7f, 0, 1, 0))
									{
										...
										if (func_62())
										{
											if (VEHICLE::_0x639431E895B9AA57(iLocal_75, iLocal_77, -1, 0, false))
											{
												if (!bLocal_296)
												{
				...
				else
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_75))
					{
						...
						TASK::OPEN_SEQUENCE_TASK(&iLocal_78);
						TASK::TASK_GO_STRAIGHT_TO_COORD(0, vLocal_102, 1f, 20000, 1193033728, 0.5f);
		...
		switch (iLocal_51)
		{
			...
			case 1:
				...
				if (iLocal_301 == 1)
				{
					...
					fVar7 = 53.23f;
					fLocal_112 = 50f;
					ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), vLocal_87, 1, false, 0, 1);
					WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_unarmed"), true);
					ENTITY::SET_ENTITY_COORDS(iLocal_75, vLocal_93, 1, false, 0, 1);
					ENTITY::SET_ENTITY_HEADING(iLocal_77, fLocal_105);
					ENTITY::SET_ENTITY_COORDS(iLocal_77, vLocal_90, 1, false, 0, 1);
				}
				else
				{
				...
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_75, iLocal_302, sLocal_306, sLocal_308, 1000f, -2f, 0, 0, 1148846080, 0);
				TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_302, sLocal_306, sLocal_309, 1000f, -2f, 1024, 0, 1148846080, 0);
				iLocal_79 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_ANIMATED_CAMERA", vLocal_113, vLocal_116, fLocal_112, 0, 2);
				CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_79, iLocal_302, "car_returned_cam", sLocal_306);
				ENTITY::PLAY_ENTITY_ANIM(iLocal_77, sLocal_307, sLocal_306, 1000f, false, 0, 0, 0f, 262144);
				...
				if (func_168(iLocal_80))
				{
					...
					{
						ENTITY::SET_ENTITY_COORDS(iLocal_80, vVar4, 1, false, 0, 1);
						ENTITY::SET_ENTITY_HEADING(iLocal_80, fVar7);
						VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_80, 1084227584);
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_80, true, 0);
					}
				}
				MISC::CLEAR_AREA(vLocal_90, 10f, 1, 0, 0, false);
				SYSTEM::SETTIMERA(0);
				if (iLocal_301 == 2)
				{
					...
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_302))
					{
						if (iLocal_316 == 0)
						{
							if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_302) >= 0.83f)
							{
								...
								TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_306, sLocal_309, 1000f, -2f, -1, 1048576, PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_302), 0, 0, 0);
...
void func_6(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x18B5
{
	int iVar0;
...
bool func_12(int iParam0)//Position - 0x1A6D
{
	return Global_41396 == iParam0;
}

bool func_13(int iParam0)//Position - 0x1A7B
{
	return iParam0 < 3;
}

int func_14(int iParam0)//Position - 0x1A87
{
	int iVar0;
	int iVar1;
...
int func_15(int iParam0)//Position - 0x1AC4
{
	if (func_13(iParam0))
	{
...
var func_16(int iParam0)//Position - 0x1AE9
{
	return Global_1798[iParam0 /*29*/];
}

void func_17(int iParam0)//Position - 0x1AF8
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_18(int iParam0, bool bParam1)//Position - 0x1B30
{
...
int func_21(int iParam0)//Position - 0x1C00
{
...
float func_23(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x1C7C
{
	vector3 vVar0;
...
void func_24(int iParam0)//Position - 0x1CB6
{
	if (func_30())
	{
		return;
...
void func_25(int iParam0)//Position - 0x1CE9
{
	if (func_30())
	{
		return;
...
void func_27(bool bParam0, bool bParam1)//Position - 0x1D9A
{
	if (bParam0)
	{
		if (func_29(0))
...
bool func_28()//Position - 0x1E0E
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

int func_29(int iParam0)//Position - 0x1E1F
{
	if (iParam0 == 1)
	{
...
bool func_30()//Position - 0x1E79
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

void func_31()//Position - 0x1E8B
{
	Global_19671 = 0;
	func_32();
}

void func_32()//Position - 0x1E9B
{
...
int func_33(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x1EBC
{
...
void func_34(int iParam0)//Position - 0x204B
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_35(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x2077
{
	if (bParam0)
	{
...
bool func_36()//Position - 0x21B0
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_37(int iParam0, int iParam1)//Position - 0x21CD
{
	bool bVar0;
...
int func_38(int iParam0, bool bParam1)//Position - 0x2218
{
	int iVar0;
	int iVar1;
...
int func_39(int iParam0)//Position - 0x2259
{
...
bool func_40()//Position - 0x229B
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_41(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x22AC
{
	int iVar0;
...
void func_42(int iParam0)//Position - 0x22DF
{
	if (iParam0 == 1)
	{
...
void func_43(vector3 vParam0, float fParam3, float fParam4)//Position - 0x2302
{
	bool bVar0;
	vector3 vVar1;
	float fVar4;
...
int func_44(int iParam0, float fParam1, float fParam2)//Position - 0x2403
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_45(float fParam0, float fParam1, float fParam2)//Position - 0x248A
{
	float fVar0;
	float fVar1;
...
int func_46(bool bParam0, bool bParam1, bool bParam2)//Position - 0x24FF
{
	int iVar0;
...
bool func_47(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x25E4
{
...
int func_48(char* sParam0, int iParam1, bool bParam2)//Position - 0x2632
{
	Global_20806 = 0;
...
bool func_51(int iParam0)//Position - 0x299F
{
	return func_52(iParam0, 20);
}

bool func_52(int iParam0, int iParam1)//Position - 0x29AF
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_53()//Position - 0x29CA
{
	return -1;
}

void func_54()//Position - 0x29D3
{
	int iVar0;
...
bool func_59(int iParam0, int iParam1)//Position - 0x2C2D
{
	switch (iParam0)
	{
		case 5:
...
void func_61(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x2CBF
{
...
void func_64(var uParam0)//Position - 0x2DD4
{
	*uParam0 = -99;
}

int func_65(int iParam0, bool bParam1, int iParam2)//Position - 0x2DE2
{
	iParam2 = iParam2;
	return func_66(iParam0, bParam1, 145);
}

int func_66(int iParam0, bool bParam1, int iParam2)//Position - 0x2DF8
{
	int iVar0;
...
int func_67(int iParam0, bool bParam1, bool bParam2)//Position - 0x2E42
{
	int iVar0;
...
float func_68(bool bParam0, float fParam1, float fParam2)//Position - 0x2EE6
{
	if (bParam0)
	{
		return fParam1;
...
void func_69(int iParam0)//Position - 0x2EFD
{
	bool bVar0;
	struct<8> Var1;
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x2F6F
{
	if (iParam3 == 0)
	{
...
void func_71(var uParam0, int iParam1, int iParam2)//Position - 0x3146
{
	char* sVar0;
...
int func_72(char* sParam0)//Position - 0x3223
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_73()//Position - 0x3236
{
	if (!PED::IS_PED_INJURED(iLocal_76))
	{
...
void func_77(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x3424
{
	func_78(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_78(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x3441
{
	func_79(uParam0, iParam1, vParam2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

void func_79(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x345F
{
	...
	uParam0->f_6 = 2;
	func_80(uParam0, iParam1, vParam2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

void func_80(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x3497
{
	int iVar0;
	int iVar1;
...
void func_81(var uParam0)//Position - 0x3804
{
...
int func_82(var uParam0)//Position - 0x386D
{
	int iVar0;
...
int func_83(bool bParam0)//Position - 0x3898
{
	switch (Global_41396)
	{
		case 0:
...
void func_84(char[4] cParam0, int iParam1)//Position - 0x3942
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_85(char* sParam0)//Position - 0x3959
{
	if (!func_86(1, 1, 0))
	{
...
int func_86(bool bParam0, bool bParam1, bool bParam2)//Position - 0x39F2
{
	int iVar0;
	int iVar1;
...
int func_87(int iParam0)//Position - 0x3C4B
{
	if (iParam0 != func_53())
	{
...
int func_88(int iParam0, bool bParam1, bool bParam2)//Position - 0x3CB1
{
	int iVar0;
...
int func_89(int iParam0, int iParam1)//Position - 0x3CFB
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
...
int func_90(int iParam0, int iParam1)//Position - 0x3D5D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_91()//Position - 0x3DE2
{
	return Global_2448961.f_17;
}

bool func_92(int iParam0)//Position - 0x3DF0
{
	return iParam0 == 51;
}

var func_93()//Position - 0x3DFD
{
	return Global_2448961.f_16;
}

bool func_94()//Position - 0x3E0B
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

void func_95(var uParam0, int iParam1, vector3 vParam2, int iParam5)//Position - 0x3E20
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_96()//Position - 0x3F30
{
	return func_97(PLAYER::PLAYER_ID());
}

int func_97(int iParam0)//Position - 0x3F40
{
...
bool func_98(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x3F5F
{
	if (bParam6)
	{
...
int func_99(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x3FA6
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_100(bool bParam0, bool bParam1, bool bParam2)//Position - 0x4313
{
...
int func_101(bool bParam0, bool bParam1, bool bParam2)//Position - 0x4365
{
	if (!func_86(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_102(bool bParam0, bool bParam1, bool bParam2)//Position - 0x43AE
{
	if (!func_86(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_103(bool bParam0, bool bParam1, bool bParam2)//Position - 0x440D
{
	if (!func_86(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_104(int iParam0)//Position - 0x4463
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (ENTITY::IS_ENTITY_A_VEHICLE(iParam0))
...
void func_105()//Position - 0x44BE
{
	MISC::SET_BIT(&Global_7357, 4);
}

int func_106(int iParam0, bool bParam1, int iParam2)//Position - 0x44CE
{
	iParam2 = iParam2;
	return func_107(iParam0, bParam1, 0);
}

int func_107(int iParam0, bool bParam1, bool bParam2)//Position - 0x44E3
{
	return func_67(iParam0, !bParam1, bParam2);
}

int func_108()//Position - 0x44F6
{
	float fVar0;
...
void func_109(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)//Position - 0x455B
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float func_114(int iParam0, int iParam1, bool bParam2)//Position - 0x4D98
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_115(int iParam0, int iParam1)//Position - 0x4DF6
{
	if (func_116(iParam0))
	{
...
int func_116(int iParam0)//Position - 0x4E29
{
	if (func_3(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_119(var uParam0, int iParam1)//Position - 0x4EBA
{
...
void func_120(bool bParam0)//Position - 0x4ED7
{
	int iVar0;
...
void func_121()//Position - 0x4FD2
{
	func_122();
}

int func_122()//Position - 0x4FDF
{
	if (func_123(0))
	{
		return 0;
...
bool func_123(bool bParam0)//Position - 0x502A
{
...
void func_124(int iParam0, int iParam1)//Position - 0x5055
{
	if (iParam0 == -1)
	{
		iParam0 = func_140();
...
void func_125(int iParam0, var uParam1, var uParam2)//Position - 0x5159
{
	bool bVar0;
...
int func_127()//Position - 0x5702
{
	return Global_30736;
}

int func_128(int iParam0, int iParam1)//Position - 0x570D
{
	int iVar0;
...
int func_129(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x575E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_130(int iParam0, int iParam1)//Position - 0x5DB0
{
	switch (iParam0)
	{
		case 0:
...
int func_131(int iParam0)//Position - 0x6124
{
	switch (iParam0)
	{
		case 29:
...
void func_132(int iParam0)//Position - 0x6153
{
	int iVar0;
	int iVar1;
...
void func_133(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x6195
{
	func_134(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_134(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x61B7
{
	int iVar0;
...
int func_137(int iParam0)//Position - 0x64F1
{
	int iVar0;
	int iVar1;
...
void func_138(int iParam0, int iParam1)//Position - 0x6534
{
	MISC::SET_BIT(&(Global_111560.f_24990.f_8[iParam0]), iParam1);
}

int func_139(int iParam0)//Position - 0x654F
{
	int iVar0;
...
int func_141(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x661D
{
...
void func_142(int iParam0)//Position - 0x67F7
{
	Global_111546 = iParam0;
}

int func_143(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x6805
{
	struct<10> Var0;
	struct<10> Var10;
	int iVar20;
	...
	else
	{
		...
		iVar20 = 0;
		func_149(&iVar20);
		iVar21 = func_148(Var10, Global_111560.f_7683.f_765[iVar20 /*10*/]);
		if (iVar21 == 2)
		{
			func_146(Global_111560.f_7683.f_765[iVar20 /*10*/]);
		...
		else if (iVar21 == 1)
		{
			...
			{
				if (!func_144(Global_111560.f_7683.f_765[iVar20 /*10*/]))
				{
					Global_111560.f_7683.f_765[iVar20 /*10*/] = { Var10 };
					func_145(&Var10);
					return 1;
...
int func_144(struct<9> Param0, var uParam9)//Position - 0x6A27
{
	if (Param0.f_8 == 0)
	{
		return 0;
...
void func_145(var uParam0)//Position - 0x6A3F
{
	struct<10> Var0;
...
void func_146(struct<10> Param0)//Position - 0x6A51
{
	if (func_144(Param0))
	{
...
void func_147(int iParam0, int iParam1)//Position - 0x6A6E
{
...
int func_148(struct<4> Param0, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, struct<4> Param10, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19)//Position - 0x6AAB
{
	int iVar0;
	int iVar1;
...
void func_149(int iParam0)//Position - 0x6ADC
{
	int iVar0;
...
struct<10> func_150(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, var uParam8, var uParam9)//Position - 0x6B33
{
	struct<10> Var0;
...
int func_151(int iParam0)//Position - 0x6B8C
{
	switch (iParam0)
	{
		case 0:
...
void func_152(int iParam0, bool bParam1)//Position - 0x6BF6
{
	if (bParam1)
	{
...
void func_153(int iParam0, int iParam1, bool bParam2)//Position - 0x6C2D
{
	int iVar0;
...
int func_154(int iParam0)//Position - 0x6C9F
{
	switch (iParam0)
	{
		case 0:
...
void func_155(int iParam0, int iParam1, bool bParam2)//Position - 0x6FCF
{
	int iVar0;
...
int func_156(int iParam0, int iParam1, bool bParam2)//Position - 0x7041
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_157(int iParam0)//Position - 0x70AB
{
	if (func_160())
	{
		Global_111550 = 1;
...
void func_158(int iParam0)//Position - 0x70FE
{
	switch (iParam0)
	{
		case 0:
...
char* func_159(int iParam0)//Position - 0x71DF
{
	char* sVar0;
...
int func_161(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x7259
{
	int iVar0;
...
void func_162(var uParam0, int iParam1)//Position - 0x7390
{
	int iVar0;
...
bool func_163(int iParam0)//Position - 0x73DF
{
	return func_164(iParam0, Global_41396);
}

int func_164(int iParam0, int iParam1)//Position - 0x73F0
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_165(int iParam0)//Position - 0x75D1
{
	if (Global_41396 == 15)
	{
		return 0;
...
bool func_167(int iParam0)//Position - 0x76A9
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
...
int func_168(int iParam0)//Position - 0x77D0
{
	if (func_3(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
int func_169()//Position - 0x77FA
{
	...
	if (((((((STREAMING::HAS_MODEL_LOADED(iVar7) && STREAMING::HAS_MODEL_LOADED(iVar8)) && STREAMING::HAS_MODEL_LOADED(iVar9)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_83)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_84)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_85)) && STREAMING::HAS_ANIM_DICT_LOADED("RANDOM@CAR_THIEF@WAITING_IG_4")) && STREAMING::HAS_PTFX_ASSET_LOADED())
	{
		if (iLocal_301 == 1)
		{
			...
			iLocal_76 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_77, 22, iVar8, -1, 1, true);
			...
			iLocal_75 = PED::CREATE_PED(5, iVar7, vLocal_52, fLocal_55, 1, true);
		...
		else
		{
			...
			if (bLocal_61)
			{
				iLocal_75 = PED::CREATE_PED(5, iVar7, -490.4008f, -2160.755f, 8.2498f, 314.0037f, 1, true);
			}
			...
			{
				iLocal_75 = PED::CREATE_PED(5, iVar7, -486.81f, -2156.99f, 8.27f, -172.34f, 1, true);
			}
			else
			{
				iLocal_75 = PED::CREATE_PED(5, iVar7, -486.2511f, -2161.808f, 8.3041f, 353.4264f, 1, true);
			}
		...
		VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_77, true, true, 0);
...
int func_171(float fParam0, bool bParam1)//Position - 0x80B1
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_172(int iParam0, var uParam1)//Position - 0x8168
{
	switch (iParam0)
	{
		case 0:
...
int func_174(int iParam0)//Position - 0x9440
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_175(int iParam0)//Position - 0x9786
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_176(int iParam0)//Position - 0x97BE
{
	struct<2> Var0;
...
bool func_178()//Position - 0x9C3D
{
	return Global_111278 > 0;
}

int func_179()//Position - 0x9C4B
{
	if (Global_95621 != -1)
	{
		return 1;
...
void func_182(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x9CA3
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_183(char* sParam0, float fParam1)//Position - 0x9D3E
{
	func_185(sParam0);
	func_184(fParam1);
}

void func_184(float fParam0)//Position - 0x9D52
{
	if (fParam0 != 0f)
	{
	}
...
void func_185(char* sParam0)//Position - 0x9D61
{
...
void func_189(int iParam0, var uParam1)//Position - 0x9E4B
{
	int iVar0;
	int iVar1;
...
void func_190()//Position - 0x9EEA
{
}

void func_191(int iParam0)//Position - 0x9EF2
{
	if (iParam0 == -1)
	{
		iParam0 = func_140();
...
void func_193(int iParam0)//Position - 0x9F65
{
	Global_111549 = iParam0;
}

int func_194(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x9F73
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
	...
	if (!bVar0)
	{
		...
		if (!func_229(Global_111560.f_24990.f_43[iParam3]))
		{
			return 0;
		}
...
bool func_195(int iParam0)//Position - 0xA30D
{
	int iVar0;
...
int func_196(int iParam0)//Position - 0xA32E
{
	return func_197(iParam0, 1);
}

int func_197(int iParam0, int iParam1)//Position - 0xA33D
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_198(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0xA390
{
	func_199(func_210(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_199(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0xA3AE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_200(float fParam0, float fParam1, float fParam2)//Position - 0xA5AF
{
	float fVar0;
...
int func_201(int iParam0, int iParam1)//Position - 0xA5F1
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_202(int iParam0)//Position - 0xA693
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_203(int iParam0)//Position - 0xA6A6
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_204(int iParam0)//Position - 0xA6B9
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_205(int iParam0)//Position - 0xA6CC
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_206(int iParam0)//Position - 0xA6DE
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_207(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_207(bool bParam0, int iParam1, int iParam2)//Position - 0xA703
{
	if (bParam0)
	{
		return iParam1;
...
int func_208(int iParam0)//Position - 0xA71A
{
	return iParam0 & 15;
}

int func_209(int iParam0, int iParam1)//Position - 0xA727
{
	int iVar0;
	int iVar1;
...
void func_211(var uParam0, int iParam1)//Position - 0xA879
{
	if (iParam1 <= 0)
	{
		return;
...
void func_212(var uParam0, int iParam1)//Position - 0xA8FF
{
...
void func_213(var uParam0, int iParam1)//Position - 0xA932
{
	int iVar0;
	int iVar1;
...
void func_214(var uParam0, int iParam1)//Position - 0xA983
{
...
void func_215(var uParam0, int iParam1)//Position - 0xA9BD
{
...
void func_216(var uParam0, int iParam1)//Position - 0xA9F8
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_217(int iParam0)//Position - 0xAA34
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_218(int iParam0, int iParam1)//Position - 0xAB10
{
...
int func_219(int iParam0)//Position - 0xAB33
{
	int iVar0;
...
var func_220()//Position - 0xB250
{
	return Global_98708.f_1;
}

int func_221()//Position - 0xB25E
{
	if (Global_95621 != -1)
	{
...
bool func_224()//Position - 0xB2C8
{
	return Global_98721.f_346 > 0;
}

bool func_225()//Position - 0xB2D9
{
	return Global_98721.f_345 > 0;
}

var func_226()//Position - 0xB2EA
{
	return Global_1312873;
}

int func_227()//Position - 0xB2F6
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_229(int iParam0)//Position - 0xB33A
{
	return func_209(func_210(), iParam0);
}

int func_230(int iParam0, int iParam1, int iParam2)//Position - 0xB34C
{
	int iVar0;
	int iVar1;
...
int func_231(int iParam0)//Position - 0xB430
{
	if (!func_13(iParam0))
	{
		return 7;
...
bool func_232(int iParam0)//Position - 0xB454
{
	int iVar0;
	bool bVar1;
...
int func_235(int iParam0)//Position - 0xB5B1
{
	int iVar0;
...
void func_238(int iParam0)//Position - 0xB780
{
	char cVar0[64];
...
void func_239(var uParam0)//Position - 0xB835
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_240(int iParam0, bool bParam1)//Position - 0xB872
{
	switch (iParam0)
	{
		case 0:
...
void func_241(int iParam0)//Position - 0xBABB
{
	Global_41947 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_242(int iParam0)//Position - 0xBACD
{
	func_243(iParam0, 0, func_248(iParam0));
}

void func_243(int iParam0, int iParam1, int iParam2)//Position - 0xBAE2
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_244(var uParam0)//Position - 0xBB11
{
	struct<16> Var0;
	int iVar16;
...
void func_245(int iParam0, var uParam1)//Position - 0xBBE2
{
	Global_111560.f_24990.f_43[iParam0] = *uParam1;
}

void func_246(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xBBFA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_247(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xBD7C
{
...
int func_248(int iParam0)//Position - 0xBDB4
{
	int iVar0;
...
void func_249(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xBF57
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
