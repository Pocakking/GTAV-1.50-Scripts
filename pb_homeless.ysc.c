...
int func_3(int iParam0, vector3 vParam1, float fParam4, float fParam5, bool bParam6)//Position - 0x314
{
	float fVar0;
	vector3 vVar1;
...
var func_24(int iParam0)//Position - 0x1253
{
	return Global_1798[iParam0 /*29*/];
}

bool func_25(int iParam0)//Position - 0x1262
{
	return func_26(iParam0, Global_41396);
}

int func_26(int iParam0, int iParam1)//Position - 0x1273
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_27(int iParam0)//Position - 0x1454
{
	return Global_41396 == iParam0;
}

void func_28()//Position - 0x1462
{
