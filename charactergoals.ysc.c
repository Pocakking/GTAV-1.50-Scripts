...
char* func_6(int iParam0)//Position - 0xD10
{
	switch (iParam0)
	{
		case 0:
...
void func_8(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xE0B
{
	int iVar0;
...
int func_9(var uParam0)//Position - 0xE3B
{
	int iVar0;
	int iVar1;
...
int func_10()//Position - 0xE6F
{
	return Global_1312745;
}

int func_11(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xE7B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_12(int iParam0)//Position - 0x14CD
{
	func_35(93, iParam0);
	func_35(29, iParam0);
	func_35(30, iParam0);
...
bool func_13(int iParam0)//Position - 0x14ED
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_14(int iParam0, int iParam1, int iParam2)//Position - 0x169D
{
	int iVar0;
	var uVar1;
...
int func_15(int iParam0, int iParam1, int iParam2)//Position - 0x16CF
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_16(int iParam0)//Position - 0x170C
{
	int iVar0;
...
int func_17(int iParam0, int iParam1)//Position - 0x1AA8
{
	int iVar0;
...
int func_18(bool bParam0)//Position - 0x1E21
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_19(int iParam0, int iParam1)//Position - 0x1ED8
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_20(int iParam0, int iParam1)//Position - 0x1EF3
{
...
int func_21(var uParam0, int iParam1)//Position - 0x1F90
{
	int iVar0;
	var uVar1[78];
...
int func_22(var uParam0, int iParam1)//Position - 0x2041
{
	int iVar0;
...
bool func_23(var uParam0, int iParam1)//Position - 0x20BC
{
	return (*uParam0)[iParam1] == 78;
}

void func_24(var uParam0)//Position - 0x20CD
{
	int iVar0;
...
void func_25(var uParam0, int iParam1)//Position - 0x2101
{
	(*uParam0)[iParam1] = 78;
}

void func_26(var uParam0, float fParam1)//Position - 0x2111
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_27(var uParam0)//Position - 0x212E
{
	return uParam0->f_80;
}

bool func_28(var uParam0, int iParam1)//Position - 0x213A
{
	return func_29(uParam0, iParam1) != -1;
}

int func_29(var uParam0, int iParam1)//Position - 0x214C
{
	int iVar0;
...
bool func_30(var uParam0)//Position - 0x2179
{
	return uParam0->f_79 == 1;
}

int func_31(int iParam0)//Position - 0x2187
{
	switch (iParam0)
	{
		case 60:
...
bool func_32(int iParam0)//Position - 0x21D7
{
	return Global_41396 == iParam0;
}

int func_33(int iParam0, int iParam1)//Position - 0x21E5
{
	int iVar0;
...
void func_34(int iParam0, int iParam1)//Position - 0x2236
{
	int iVar0;
...
void func_35(int iParam0, int iParam1)//Position - 0x2259
{
	int iVar0;
...
int func_37(int iParam0)//Position - 0x232B
{
	return Global_1798[iParam0 /*29*/].f_17;
}

void func_38(char* sParam0, int iParam1, int iParam2)//Position - 0x233C
{
	iParam2 = iParam2;
...
void func_39(char* sParam0, char* sParam1, int iParam2, int iParam3)//Position - 0x2355
{
	iParam3 = iParam3;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
int func_40(int iParam0, int iParam1)//Position - 0x2374
{
...
void func_41(char* sParam0, int iParam1)//Position - 0x238F
{
...
void func_42(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4)//Position - 0x23D2
{
...
void func_43(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x23F0
{
...
int func_44(int iParam0, int iParam1, bool bParam2, int iParam3)//Position - 0x242F
{
	if (func_50())
	{
		return 0;
...
int func_45(var uParam0, var uParam1, bool bParam2, int iParam3)//Position - 0x245A
{
...
void func_46(int iParam0)//Position - 0x24BE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_49(struct<6> Param0, struct<6> Param6)//Position - 0x261A
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
...
int func_51(int iParam0, int iParam1, int iParam2)//Position - 0x272C
{
	if (func_37(iParam0) == 3)
	{
		return 0;
...
int func_52(int iParam0)//Position - 0x2760
{
	var uVar0;
