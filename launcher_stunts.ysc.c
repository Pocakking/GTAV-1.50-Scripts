				...
				case 3:
					...
					else
					{
						...
						if (!func_86(3) && !Global_98703)
						{
							...
							{
								if ((!func_109(uLocal_94, 1) || !ENTITY::DOES_ENTITY_EXIST(func_85())) && !Global_98703)
								{
									func_102(10);
									break;
								}
...
var func_37(int iParam0)//Position - 0x1ABD
{
	return Global_1798[iParam0 /*29*/];
}

int func_38(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x1ACC
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_39(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x1DC2
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_40(vector3 vParam0)//Position - 0x1E76
{
	float fVar0;
	float fVar1;
...
void func_41(int iParam0)//Position - 0x1EB5
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_42(int iParam0)//Position - 0x1F1A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_43(int iParam0)//Position - 0x1F73
{
...
int func_44(int iParam0)//Position - 0x1FF6
{
	int iVar0;
...
void func_45(int iParam0, int iParam1, int iParam2)//Position - 0x2027
{
	func_46(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_46(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x203C
{
	int iVar0;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x20EF
{
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x210A
{
	int iVar0;
...
int func_50(int iParam0)//Position - 0x2156
{
	int iVar0;
...
int func_52(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x221C
{
	int iVar0;
...
void func_53(var uParam0, int iParam1)//Position - 0x2353
{
	int iVar0;
...
int func_54(int iParam0)//Position - 0x23A2
{
	if (Global_41396 == 15)
	{
		return 0;
...
void func_56(int iParam0)//Position - 0x2460
{
	if (func_61())
	{
		return;
...
void func_57(int iParam0)//Position - 0x2493
{
	if (func_61())
	{
		return;
...
void func_59(bool bParam0, bool bParam1)//Position - 0x2544
{
	if (bParam0)
	{
		if (func_69(0))
...
int func_64(int iParam0)//Position - 0x26A9
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x26E4
{
	int iVar0;
...
void func_66(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x273B
{
	int iVar0;
...
int func_67(int iParam0)//Position - 0x2866
{
	return 0;
	return 1;
}

var func_68()//Position - 0x2873
{
	return Global_73784;
}

int func_69(int iParam0)//Position - 0x287F
{
	if (iParam0 == 1)
	{
...
bool func_70(int iParam0, int iParam1)//Position - 0x28D9
{
	switch (iParam0)
	{
		case 5:
...
bool func_71()//Position - 0x2914
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

int func_72()//Position - 0x2929
{
...
bool func_73(bool bParam0)//Position - 0x2943
{
	if (bParam0)
	{
...
int func_74()//Position - 0x296C
{
	return 1;
}

bool func_75()//Position - 0x2975
{
	int iVar0;
	bool bVar1;
...
int func_76(int iParam0)//Position - 0x2A7F
{
	int iVar0;
...
var func_77()//Position - 0x319C
{
	return Global_98708.f_1;
}

int func_78()//Position - 0x31AA
{
	if (Global_95621 != -1)
	{
...
bool func_80()//Position - 0x31FA
{
	return Global_98721.f_346 > 0;
}

bool func_81()//Position - 0x320B
{
	return Global_98721.f_345 > 0;
}

var func_82()//Position - 0x321C
{
	return Global_1312873;
}

int func_83()//Position - 0x3228
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
var func_85()//Position - 0x325E
{
	return Global_94531;
}

int func_86(int iParam0)//Position - 0x326A
{
	switch (iParam0)
	{
		case 0:
...
bool func_87(int iParam0)//Position - 0x32DC
{
	int iVar0;
...
bool func_88(int iParam0)//Position - 0x3318
{
	return Global_41396 == iParam0;
}

void func_89(var uParam0, int iParam1)//Position - 0x3326
{
	*uParam0 = (*uParam0 || iParam1);
}

void func_90()//Position - 0x3337
{
}

void func_91(var uParam0, int iParam1)//Position - 0x333F
{
	func_92(uParam0, iParam1);
}

void func_92(var uParam0, var uParam1)//Position - 0x334F
{
	*uParam0 = (*uParam0 || uParam1);
}

int func_93()//Position - 0x3360
{
	if (Global_41396 == 15)
	{
		return 0;
...
void func_94()//Position - 0x3375
{
	iLocal_48++;
}

int func_95()//Position - 0x3383
{
	return 1;
}
...
int func_97()//Position - 0x3394
{
	return 0;
}

int func_98()//Position - 0x339D
{
	return 1;
}

int func_99()//Position - 0x33A6
{
	return 1;
}

void func_100(int iParam0)//Position - 0x33AF
{
	if (iParam0 == 2)
	{
	}
...
void func_102(int iParam0)//Position - 0x3443
{
	iLocal_95 = iParam0;
}

void func_103(int iParam0, bool bParam1, bool bParam2)//Position - 0x344F
{
	int iVar0;
	bool bVar1;
...
bool func_106(int iParam0, int iParam1)//Position - 0x359B
{
	bool bVar0;
...
bool func_107(int iParam0)//Position - 0x35E8
{
	return func_108(iParam0, Global_41396);
}

int func_108(int iParam0, int iParam1)//Position - 0x35F9
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_109(var uParam0, int iParam1)//Position - 0x37DA
{
	return (uParam0 && iParam1) != 0;
}

void func_110()//Position - 0x37E9
{
...
void func_111(var uParam0, int iParam1)//Position - 0x3837
{
	func_112(uParam0, iParam1);
}

void func_112(var uParam0, var uParam1)//Position - 0x3847
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

void func_113(bool bParam0)//Position - 0x385C
{
	if (bParam0)
	{
		if (iLocal_105 != 263)
