	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		switch (iLocal_243[iParam1])
		{
						...
						if (!ENTITY::IS_ENTITY_DEAD(iLocal_253[iParam1], 0))
						{
							if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_253[iParam1], &sLocal_349, &(Local_302[iParam1 /*16*/]), 2))
							{
								if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_96029) > 0.817f)
								{
									...
									vVar38.x = -824.333f;
									fVar41 = 140.49f;
									ENTITY::SET_ENTITY_COORDS(iLocal_253[iParam1], vVar38, 1, false, 0, 1);
									ENTITY::SET_ENTITY_HEADING(iLocal_253[iParam1], fVar41);
									VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_253[iParam1], 1084227584);
								}
							}
						}
						if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_96029) > fLocal_481)
						{
			...
			case 10:
				...
				if (func_6(iLocal_246[iParam1], iLocal_249[iParam1], &sVar42, &cVar58, &iVar74, &iVar75) && func_4(iLocal_246[iParam1], iLocal_249[iParam1], &vVar76, &fVar79))
				{
					if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_480))
					{
						...
						PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_480, false);
					}
					TASK::TASK_SYNCHRONIZED_SCENE(iParam0, iLocal_480, &sVar42, &cVar58, 1000f, -8f, 0, 0, 1000f, 0);
					PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_480, true);
					iLocal_243[iParam1] = 1;
				}
				break;
...
bool func_15(int iParam0)//Position - 0x43D7
{
	return func_16(iParam0, 20);
}

bool func_16(int iParam0, int iParam1)//Position - 0x43E7
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_17()//Position - 0x4402
{
	return -1;
}

void func_18()//Position - 0x440B
{
	int iVar0;
...
var func_23()//Position - 0x4632
{
	func_24();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_24()//Position - 0x464B
{
	int iVar0;
...
bool func_25(int iParam0)//Position - 0x4748
{
	return iParam0 < 3;
}

int func_26(int iParam0)//Position - 0x4754
{
	int iVar0;
	int iVar1;
...
int func_27(int iParam0)//Position - 0x4791
{
	if (func_25(iParam0))
	{
...
var func_28(int iParam0)//Position - 0x47B6
{
	return Global_1798[iParam0 /*29*/];
}

bool func_29(int iParam0)//Position - 0x47C5
{
	return Global_41396 == iParam0;
}

void func_30()//Position - 0x47D3
{
	int iVar0;
...
bool func_31(int iParam0, int iParam1)//Position - 0x4829
{
	switch (iParam0)
	{
		case 5:
...
void func_33(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x48BB
{
			...
			while (iVar0 < iLocal_237)
			{
				if (!PED::IS_PED_INJURED(iLocal_237[iVar0]))
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_253[iVar0], 0))
					{
						...
						{
							ENTITY::SET_ENTITY_COORDS(iLocal_237[iVar0], ENTITY::GET_ENTITY_COORDS(iLocal_237[iVar0], true), 1, false, 0, 1);
						}
					}
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iVar0], Global_96029, &sLocal_349, &(Local_430[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
					iLocal_243[iVar0] = 0;
				}
				else
				{
				...
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_253[iVar0], 0))
				{
					...
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar0], Global_96029, &(Local_302[iVar0 /*16*/]), &sLocal_349, 8f, 8f, 0, 1148846080);
				}
				iVar0++;
			}
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&Local_463) && iLocal_468)
...
int func_36()//Position - 0x4AE4
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96028))
	{
		...
		while (iVar0 < iLocal_237)
		{
			if (!PED::IS_PED_INJURED(iLocal_237[iVar0]))
			{
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iVar0], Global_96028, &sLocal_349, &(Local_397[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
			}
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_253[iVar0], 0))
			{
				if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_269[iVar0 /*16*/])))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar0], Global_96028, &(Local_269[iVar0 /*16*/]), &sLocal_349, 8f, 8f, 0, 1148846080);
				}
				else
				{
					if (!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_253[iVar0]))
...
void func_37(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x4D00
{
...
int func_38(int iParam0, int iParam1)//Position - 0x4D9B
{
	vector3 vVar0;
	float fVar3;
...
int func_39(var uParam0)//Position - 0x4E7F
{
	return uParam0;
}

bool func_40(var uParam0, var uParam1)//Position - 0x4E89
{
	return (uParam0 && uParam1) != 0;
}

int func_41()//Position - 0x4E98
{
	func_24();
...
void func_43()//Position - 0x4F1E
{
	func_44((Global_98392 - 1));
}

void func_44(int iParam0)//Position - 0x4F30
{
	Global_98392 = iParam0;
}

void func_45()//Position - 0x4F3E
{
	func_44(0);
}

void func_46()//Position - 0x4F4B
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	while (iVar0 < iLocal_253)
	{
		if (iLocal_256[iVar0] != 0)
		{
			...
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_269[iVar0 /*16*/])))
			{
				ENTITY::PLAY_ENTITY_ANIM(iLocal_253[iVar0], &(Local_269[iVar0 /*16*/]), &sLocal_349, 8f, true, 0, 0, 0f, 0);
			}
			else
			{
				VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(iLocal_253[iVar0], iLocal_474[iVar0], &Local_470, 1);
	...
	while (iVar0 < iLocal_237)
	{
		if (iLocal_240[iVar0] != 145)
		{
			if (func_171(&(iLocal_237[iVar0]), iLocal_240[iVar0], vLocal_335 + vLocal_339[iVar0 /*3*/], (fLocal_338 + fLocal_346[iVar0]), 1))
			{
				...
				else if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_253[iVar0], 0))
				{
...
int func_47(var uParam0, int iParam1, int iParam2)//Position - 0x5233
{
	switch (iParam2)
	{
		case 77:
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x563F
{
	int iVar0;
	int iVar1;
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x5D4A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_50(int iParam0)//Position - 0x5FA5
{
	switch (iParam0)
	{
		case 0:
...
int func_51(int iParam0, int iParam1)//Position - 0x6055
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_52(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x60B5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_53(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x6139
{
	var uVar0;
	int iVar10;
...
int func_54(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x673D
{
	switch (iParam0)
	{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_55(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_55(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_55(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_55(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_55(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x69BA
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar41 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_50(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_56(int iParam0, int iParam1)//Position - 0x6B16
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_57(int iParam0)//Position - 0x6EBD
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_58(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6F1E
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_59(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7343
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_60(int iParam0, int iParam1, int iParam2)//Position - 0x7636
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
struct<10> func_61(int iParam0, int iParam1)//Position - 0x76CF
{
	int iVar0;
	struct<10> Var1;
...
void func_62(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7FFE
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
int func_63(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x812A
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_50(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
void func_64(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x820A
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_65(int iParam0, int iParam1)//Position - 0x8252
{
	int iVar0;
	struct<17> Var1;
...
void func_66(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA09A
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_67(int iParam0)//Position - 0xA284
{
	switch (iParam0)
	{
		case 0:
...
void func_68(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xA334
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_69(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA3A5
{
	func_137();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_70(int iParam0, int iParam1)//Position - 0xA3F7
{
	switch (iParam0)
	{
		case 0:
...
void func_71(int iParam0)//Position - 0xA4E7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_72(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xB75E
{
	int iVar0;
	int iVar1;
...
bool func_73(int iParam0, int iParam1, var uParam2)//Position - 0xBAEF
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_74(int iParam0, int iParam1)//Position - 0xBEF4
{
	switch (iParam1)
	{
		case 0:
...
int func_75(int iParam0, int iParam1, int iParam2)//Position - 0xC2EF
{
	int iVar0;
	var uVar1;
...
int func_76(var uParam0)//Position - 0xC321
{
	int iVar0;
	int iVar1;
...
var func_77()//Position - 0xC355
{
	return Global_1312745;
}

int func_78(int iParam0, int iParam1)//Position - 0xC361
{
	switch (iParam1)
	{
		case 0:
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xC75C
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_80(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xD67A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_81(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xD6BC
{
	int iVar0;
...
int func_82(int iParam0)//Position - 0xF523
{
	switch (iParam0)
	{
		case -1:
...
void func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xF5F7
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_72(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_72(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_50(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_84(int iParam0)//Position - 0xF8D0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_85(int iParam0)//Position - 0xFA27
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_86(int iParam0)//Position - 0xFF35
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_87(int iParam0)//Position - 0xFFAA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_88(int iParam0)//Position - 0x10020
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_89(int iParam0)//Position - 0x10107
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_90(int iParam0)//Position - 0x1046A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_91(int iParam0)//Position - 0x1067B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_92(int iParam0)//Position - 0x108AB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_93(int iParam0)//Position - 0x109BB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_94(int iParam0)//Position - 0x1135A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_95(int iParam0)//Position - 0x11ECD
{
	if (iParam0 < 136)
	{
		func_97(iParam0);
...
void func_96(int iParam0)//Position - 0x11F02
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_97(int iParam0)//Position - 0x12B06
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_98(int iParam0)//Position - 0x13A14
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_99(int iParam0)//Position - 0x13B41
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_100(int iParam0, int iParam1)//Position - 0x13C3F
{
	switch (iParam0)
	{
		case 0:
...
void func_101(int iParam0)//Position - 0x13D2F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_102(int iParam0)//Position - 0x154C9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_103(int iParam0)//Position - 0x1561A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_104(int iParam0)//Position - 0x15B25
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_105(int iParam0)//Position - 0x16193
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_106(int iParam0)//Position - 0x16207
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_107(int iParam0)//Position - 0x162D7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_108(int iParam0)//Position - 0x16807
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_109(int iParam0)//Position - 0x1699E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_110(int iParam0)//Position - 0x1719C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_111(int iParam0)//Position - 0x172AC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_112(int iParam0)//Position - 0x181D8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_113(int iParam0)//Position - 0x18E95
{
	if (iParam0 < 107)
	{
		func_116(iParam0);
...
void func_114(int iParam0)//Position - 0x18EDB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_115(int iParam0)//Position - 0x19980
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_116(int iParam0)//Position - 0x1A76F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_117(int iParam0)//Position - 0x1B3B8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_118(int iParam0)//Position - 0x1B631
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_119(int iParam0, int iParam1)//Position - 0x1B777
{
	switch (iParam0)
	{
		case 0:
...
void func_120(int iParam0)//Position - 0x1B867
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_121(int iParam0)//Position - 0x1C5F3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_122(int iParam0)//Position - 0x1C76D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_123(int iParam0)//Position - 0x1CCE4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_124(int iParam0)//Position - 0x1D20E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_125(int iParam0)//Position - 0x1D282
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_126(int iParam0)//Position - 0x1D352
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_127(int iParam0)//Position - 0x1D82A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0x1DA93
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0x1DD69
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0x1DF32
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x1EA86
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x1F6D0
{
	if (iParam0 < 60)
	{
		func_134(iParam0);
...
void func_133(int iParam0)//Position - 0x1F705
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x204A6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x20B32
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x20C19
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137()//Position - 0x20D17
{
...
int func_138(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x20D90
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_139(int iParam0, int iParam1, int iParam2)//Position - 0x215A6
{
	int iVar0;
...
int func_140(int iParam0)//Position - 0x21632
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_141(int iParam0, int iParam1, int iParam2)//Position - 0x2166D
{
	int iVar0;
	int iVar1;
...
int func_142(int iParam0, int iParam1, int iParam2)//Position - 0x216F7
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_143(int iParam0, int iParam1, int iParam2)//Position - 0x217D5
{
	Global_76389[1 /*14*/] = { func_69(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 2);
}

int func_144(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x21800
{
	int iVar0;
...
int func_145(int iParam0, int iParam1, int iParam2)//Position - 0x21896
{
	int iVar0;
	int iVar1;
...
int func_146(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x21937
{
	int iVar0;
...
int func_147(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x21C3E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_148(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x227F1
{
	int iVar0;
...
int func_149(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x22AD5
{
	int iVar0;
...
int func_150(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x22D9C
{
	int iVar0;
	int iVar1;
...
int func_151(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x22DD3
{
	int iVar0;
...
int func_152(int iParam0, int iParam1, int iParam2)//Position - 0x22DFC
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_153(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x230C6
{
	int iVar0;
...
int func_154(int iParam0, int iParam1, int iParam2)//Position - 0x23350
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_155(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x234A7
{
	int iVar0;
...
int func_156(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2353F
{
	switch (iParam0)
	{
		case joaat("mp_m_freemode_01"):
...
int func_157(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2360D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_158(int iParam0, int iParam1)//Position - 0x23709
{
	int iVar0;
...
int func_159(int iParam0)//Position - 0x23847
{
	switch (iParam0)
	{
		case 0:
...
int func_160(int iParam0, int iParam1)//Position - 0x238CD
{
	int iVar0;
	int iVar1;
...
void func_161(int iParam0)//Position - 0x23913
{
...
void func_162(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x239CB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_163(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x23A15
{
	int iVar0;
...
int func_164(int iParam0)//Position - 0x23A45
{
	if (!MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
	{
		return 0;
...
void func_165(int iParam0, int iParam1)//Position - 0x23A96
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_166(var uParam0, int iParam1)//Position - 0x23B65
{
	return (uParam0 && iParam1) != 0;
}

void func_167(int iParam0, int iParam1)//Position - 0x23B74
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_168(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4)//Position - 0x23BA7
{
	switch (iParam0)
	{
		case 0:
...
int func_169(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13)//Position - 0x24BF8
{
	switch (iParam0)
	{
		case 34:
...
void func_170(var uParam0, int iParam1)//Position - 0x25502
{
	*uParam0 = (*uParam0 || iParam1);
}

int func_171(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0x25513
{
	int iVar0;
...
int func_172(var uParam0, int iParam1)//Position - 0x255A1
{
	int iVar0;
...
int func_173(int iParam0)//Position - 0x255E7
{
	if (!func_25(iParam0))
	{
		return func_28(iParam0);
...
int func_174(int iParam0)//Position - 0x2560D
{
	if (!func_25(iParam0))
	{
...
void func_175(int iParam0)//Position - 0x25637
{
	if (!func_25(iParam0))
	{
...
void func_176()//Position - 0x2565D
{
	char[] cVar0[8];
	var uVar8;
	var uVar9;
...
struct<4> func_177(char* sParam0, int iParam1)//Position - 0x25A56
{
	struct<4> Var0;
...
int func_178(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x25AB2
{
	switch (iParam0)
	{
		case 231:
...
int func_179(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5)//Position - 0x25D88
{
	*uParam4 = 9;
	*uParam5 = 0;
	switch (iParam0)
...
void func_180(int iParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0x2758F
{
...
int func_181(int iParam0, var uParam1, var uParam2, char* sParam3)//Position - 0x275B2
{
	int iVar0;
...
bool func_182(var uParam0)//Position - 0x2779D
{
	int iVar0;
	vector3 vVar1;
	float fVar4;
...
bool func_183(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x27858
{
	if (bParam6)
	{
...
int func_184(int iParam0, var uParam1, char* sParam2)//Position - 0x2789F
{
	vector3 vVar0;
	int iVar3;
	var uVar4;
...
int func_185(int iParam0, var uParam1, var uParam2)//Position - 0x29CE3
{
	switch (iParam0)
	{
		case 11:
...
char* func_186(int iParam0)//Position - 0x2A652
{
	switch (iParam0)
	{
		case 2014101067:
...
void func_187()//Position - 0x2A6EB
{
	int iVar0;
...
void func_188(int iParam0)//Position - 0x2A751
{
	if (!func_25(iParam0))
	{
