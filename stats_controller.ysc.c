...
void func_8(char[4] cParam0, int iParam1)//Position - 0x81F
{
...
int func_10(int iParam0)//Position - 0xB3A
{
	if (iParam0 != func_11())
	{
...
int func_11()//Position - 0xB64
{
	return -1;
}

int func_12(char* sParam0)//Position - 0xB6D
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

bool func_13()//Position - 0xB80
{
	return Global_2437549.f_1893.f_688 != 0;
}

bool func_14()//Position - 0xB94
{
	return Global_2437549.f_3032.f_578;
}

bool func_15()//Position - 0xBA6
{
	return func_16();
}

bool func_16()//Position - 0xBB2
{
	return Global_1366857.f_40 == 3;
}

bool func_17(bool bParam0)//Position - 0xBC2
{
	if (bParam0)
	{
...
bool func_18(int iParam0)//Position - 0xBEB
{
	return MISC::IS_BIT_SET(Global_1627738[iParam0 /*38*/].f_14, 0);
}

int func_19(int iParam0, bool bParam1, bool bParam2)//Position - 0xC02
{
	int iVar0;
...
int func_21(int iParam0)//Position - 0xC69
{
	if (iParam0 == 1)
	{
...
bool func_22()//Position - 0xCC3
{
	return Global_1373500.f_112;
}

bool func_23()//Position - 0xCD1
{
	return Global_2437549.f_2708[0 /*80*/].f_1 != 0;
}

int func_24(int iParam0, int iParam1)//Position - 0xCE7
{
	switch (iParam0)
	{
		case 5:
...
bool func_25(int iParam0, int iParam1)//Position - 0xD53
{
	switch (iParam0)
	{
		case 5:
...
int func_26(int iParam0)//Position - 0xD8E
{
	var uVar0;
...
bool func_27()//Position - 0xDA2
{
	return Global_2448961.f_592;
}

bool func_28()//Position - 0xDB1
{
	return MISC::IS_BIT_SET(Global_959568.f_8, 13);
}

bool func_29()//Position - 0xDC5
{
	return Global_2448961.f_591;
}

int func_30()//Position - 0xDD4
{
...
int func_31()//Position - 0xDF6
{
	return Global_1312467.f_18;
}

int func_32()//Position - 0xE04
{
...
void func_34(int iParam0, int iParam1)//Position - 0xE40
{
	int iVar0;
	int iVar1;
...
int func_35(int iParam0)//Position - 0xF2B
{
	int iVar0;
...
void func_36(var uParam0)//Position - 0xF8E
{
	uParam0->f_1 = 0;
}

int func_37(var uParam0, int iParam1, bool bParam2)//Position - 0xF9B
{
	if (iParam1 == -1)
	{
		return 1;
...
void func_38(var uParam0, bool bParam1, bool bParam2)//Position - 0x1005
{
	if (uParam0->f_1 == 0)
	{
...
bool func_39(int iParam0, int iParam1)//Position - 0x104A
{
	int iVar0;
	int iVar1;
...
bool func_41()//Position - 0x1131
{
	return Global_1312873;
}

bool func_42()//Position - 0x113D
{
	return Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_196 != 0;
}

int func_43(int iParam0)//Position - 0x1154
{
	int iVar0;
	int iVar1;
...
bool func_44(int iParam0)//Position - 0x11C0
{
	return MISC::IS_BIT_SET(Global_2424073[iParam0 /*421*/].f_309.f_3, 13);
}

int func_45(int iParam0, int iParam1)//Position - 0x11DC
{
	int iVar0;
	var uVar1;
...
bool func_47()//Position - 0x122C
{
	return func_48(PLAYER::PLAYER_ID());
}

int func_48(int iParam0)//Position - 0x123C
{
	if (iParam0 != func_11())
	{
...
bool func_49(bool bParam0)//Position - 0x1271
{
	return func_50(PLAYER::PLAYER_ID(), bParam0);
}

bool func_50(int iParam0, bool bParam1)//Position - 0x1283
{
	if (!bParam1)
	{
		if (func_48(iParam0))
...
int func_51(int iParam0, int iParam1)//Position - 0x12AE
{
	switch (iParam0)
	{
		case 0:
...
bool func_52(bool bParam0)//Position - 0x14BE
{
...
int func_53(int iParam0, int iParam1, int iParam2)//Position - 0x14E9
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_54(14))
...
bool func_54(int iParam0)//Position - 0x1736
{
	return Global_41396 == iParam0;
}

void func_55(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x1744
{
	int iVar0;
...
int func_56(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x1774
{
...
int func_57(int iParam0, int iParam1, bool bParam2, int iParam3)//Position - 0x1796
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_58(int iParam0, int iParam1, int iParam2)//Position - 0x24A9
{
	switch (iParam0)
	{
		case 0:
...
int func_59(int iParam0)//Position - 0x25BD
{
	int iVar0;
	var uVar1;
...
int func_60(int iParam0, int iParam1)//Position - 0x25DB
{
	return Global_111560.f_19142[iParam1 /*271*/].f_3[iParam0 /*12*/].f_3;
}

int func_61(int iParam0, int iParam1)//Position - 0x25F7
{
...
int func_62(int iParam0)//Position - 0x2625
{
	int iVar0;
...
int func_63(int iParam0, int iParam1)//Position - 0x2668
{
	return Global_2542527[iParam0 /*3*/][func_5(iParam1)];
}

int func_64(int iParam0)//Position - 0x2680
{
	int iVar0;
...
var func_65(float fParam0)//Position - 0x26B3
{
	if (func_46())
	{
...
int func_67()//Position - 0x2733
{
	return Global_1628955[PLAYER::PLAYER_ID() /*614*/].f_11;
}

float func_68(int iParam0, int iParam1)//Position - 0x2748
{
	int iVar0;
	var uVar1;
...
int func_69(int iParam0, int iParam1, int iParam2)//Position - 0x2774
{
	if (iParam0 > iParam2)
	{
		return iParam2;
...
int func_70(int iParam0, int iParam1, int iParam2)//Position - 0x2799
{
	int iVar0;
	var uVar1;
...
void func_71(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0x27CB
{
	switch (iParam0)
	{
		case 0:
...
bool func_73(int iParam0)//Position - 0x2A3E
{
	return iParam0 < 3;
}

void func_74(int iParam0, int iParam1)//Position - 0x2A4A
{
	int iVar0;
	float fVar1;
	int iVar2;
...
int func_75(int iParam0)//Position - 0x2B37
{
	if (Global_41396 == 15)
	{
		return 0;
...
bool func_76(int iParam0)//Position - 0x2B59
{
	return func_77(iParam0, Global_41396);
}

int func_77(int iParam0, int iParam1)//Position - 0x2B6A
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_80(int iParam0, int iParam1, int iParam2)//Position - 0x3021
{
	int iVar0;
	int iVar1;
...
bool func_84(int iParam0)//Position - 0x34B4
{
	return (Global_110645 && iParam0) != 0;
}

int func_85()//Position - 0x34C5
{
	func_86();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_86()//Position - 0x34DE
{
	int iVar0;
...
int func_87(int iParam0)//Position - 0x35DB
{
	int iVar0;
	int iVar1;
...
int func_88(int iParam0)//Position - 0x3618
{
	if (func_73(iParam0))
	{
...
var func_89(int iParam0)//Position - 0x363D
{
	return Global_1798[iParam0 /*29*/];
}

void func_90()//Position - 0x364C
{
	char* sVar0;
	int iVar1;
...
int func_91(int iParam0)//Position - 0x3710
{
	switch (iParam0)
	{
		case 0:
...
char* func_92(int iParam0)//Position - 0x378F
{
	switch (iParam0)
	{
		case 0:
...
int func_93(int iParam0)//Position - 0x3819
{
	int iVar0;
...
void func_94(int iParam0, bool bParam1)//Position - 0x384F
{
...
int func_95(int iParam0)//Position - 0x38BB
{
	int iVar0;
...
int func_96(int iParam0)//Position - 0x38ED
{
	int iVar0;
...
void func_97(int iParam0)//Position - 0x396C
{
	char cVar0[64];
	char cVar16[64];
	int iVar32;
	...
	func_98(&(Global_1385294[iVar32 /*5*/]));
	Global_1385455 = (Global_1385455 - 1);
}

void func_98(var uParam0)//Position - 0x3A21
{
	*uParam0 = 0;
	uParam0->f_1 = func_11();
	uParam0->f_2 = 0;
...
int func_102()//Position - 0x3C4F
{
	return Global_30736;
}

int func_103(int iParam0)//Position - 0x3C5A
{
	if (iParam0 == -1)
	{
		return 0;
