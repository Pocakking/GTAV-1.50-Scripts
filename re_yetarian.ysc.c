...
int func_15()//Position - 0x13E3
{
	return Global_1312745;
}

int func_16(int iParam0, int iParam1)//Position - 0x13EF
{
	switch (iParam0)
	{
		case 0:
...
int func_17(int iParam0)//Position - 0x1763
{
	switch (iParam0)
	{
		case 29:
...
void func_18(int iParam0)//Position - 0x1792
{
	int iVar0;
	int iVar1;
...
void func_19(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x17D4
{
	func_20(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_20(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x17F6
{
	int iVar0;
...
bool func_24(int iParam0)//Position - 0x1C2D
{
	return Global_41396 == iParam0;
}

bool func_25(int iParam0)//Position - 0x1C3B
{
	return iParam0 < 3;
}

int func_26(int iParam0)//Position - 0x1C47
{
	int iVar0;
	int iVar1;
...
int func_27(int iParam0)//Position - 0x1C84
{
	if (func_25(iParam0))
	{
...
var func_28(int iParam0)//Position - 0x1CA9
{
	return Global_1798[iParam0 /*29*/];
}

int func_29(int iParam0)//Position - 0x1CB8
{
	int iVar0;
	int iVar1;
...
void func_30(int iParam0, int iParam1)//Position - 0x1CFB
{
	MISC::SET_BIT(&(Global_111560.f_24990.f_8[iParam0]), iParam1);
}

int func_31(int iParam0)//Position - 0x1D16
{
	int iVar0;
...
int func_33(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x1DE4
{
...
int func_34()//Position - 0x1FBE
{
	return 1;
}

void func_35(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1FC7
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_37(int iParam0, char* sParam1, int iParam2)//Position - 0x2118
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_38(iParam2), 1);
}

int func_38(int iParam0)//Position - 0x212F
{
	int iVar0;
...
bool func_39(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2324
{
...
int func_40(char* sParam0, int iParam1, bool bParam2)//Position - 0x2372
{
	Global_20806 = 0;
...
bool func_43(int iParam0)//Position - 0x26DF
{
	return func_44(iParam0, 20);
}

bool func_44(int iParam0, int iParam1)//Position - 0x26EF
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_45()//Position - 0x270A
{
	return -1;
}

void func_46()//Position - 0x2713
{
	int iVar0;
...
bool func_52(int iParam0, int iParam1)//Position - 0x2994
{
	switch (iParam0)
	{
		case 5:
...
void func_54(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x2A26
{
...
int func_55()//Position - 0x2A7C
{
	func_23();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_56(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2A95
{
...
int func_64(int iParam0)//Position - 0x30A9
{
	var uVar0;
...
int func_65()//Position - 0x30BD
{
	if (!PED::IS_COP_PED_IN_AREA_3D(vLocal_126, vLocal_129) && !(MISC::IS_POSITION_OCCUPIED(-61.01321f, -1093.393f, 25.75297f, 2f, 0, 1, 0, 0, 0, 0, 0) && MISC::IS_POSITION_OCCUPIED(-38.59683f, -1109.284f, 25.68742f, 2f, 0, 1, 0, 0, 0, 0, 0)))
	{
	...
	else if (PED::IS_COP_PED_IN_AREA_3D(vLocal_126, vLocal_129) || (MISC::IS_POSITION_OCCUPIED(-61.01321f, -1093.393f, 25.75297f, 2f, 0, 1, 0, 0, 0, 0, 0) && MISC::IS_POSITION_OCCUPIED(-38.59683f, -1109.284f, 25.68742f, 2f, 0, 1, 0, 0, 0, 0, 0)))
	{
		if (INTERIOR::GET_ROOM_KEY_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == MISC::GET_HASH_KEY("rm_showroom"))
		{
...
void func_66(int iParam0)//Position - 0x3212
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_67(int iParam0)//Position - 0x3253
{
	if (func_71())
	{
		Global_111550 = 1;
...
void func_68(int iParam0)//Position - 0x32A6
{
	switch (iParam0)
	{
		case 0:
...
void func_69(char[4] cParam0, int iParam1)//Position - 0x3387
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

char* func_70(int iParam0)//Position - 0x339E
{
	char* sVar0;
...
int func_72(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x3418
{
	int iVar0;
...
void func_73(var uParam0, int iParam1)//Position - 0x354F
{
	int iVar0;
...
bool func_74(int iParam0)//Position - 0x359E
{
	return func_75(iParam0, Global_41396);
}

int func_75(int iParam0, int iParam1)//Position - 0x35AF
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_76(int iParam0)//Position - 0x3790
{
	if (Global_41396 == 15)
	{
		return 0;
...
void func_77(bool bParam0)//Position - 0x37B2
{
	if (bParam0)
	{
		if (func_2(iLocal_92))
		{
			ENTITY::SET_ENTITY_VISIBLE(iLocal_92, true, 0);
	...
	{
		ENTITY::SET_ENTITY_VISIBLE(iLocal_91, true, 0);
...
void func_78(int iParam0)//Position - 0x3828
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_2(iLocal_91) || !func_2(iLocal_92))
			{
				...
				if (func_2(iLocal_91))
				{
					ENTITY::SET_ENTITY_VISIBLE(iLocal_91, false, 0);
					...
					ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_95, iLocal_91, PED::GET_PED_BONE_INDEX(iLocal_91, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_147);
					...
					TASK::SET_SEQUENCE_TO_REPEAT(iLocal_147, 1);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_147);
				...
				if (func_2(iLocal_92))
				{
					ENTITY::SET_ENTITY_VISIBLE(iLocal_92, false, 0);
					...
					ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_96, iLocal_92, PED::GET_PED_BONE_INDEX(iLocal_92, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_147);
					TASK::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_b", 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_f", 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_no_a", 8f, -8f, -1, 0, 0, 0, 0, 0);
			...
			else
			{
				...
				VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(iLocal_123, 0);
				...
				VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(iLocal_124, 0);
				...
				VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(iLocal_125, 0);
				iLocal_89 = 2;
			}
			break;
...
int func_81(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0x3C73
{
	int iVar0;
...
int func_82(var uParam0, int iParam1)//Position - 0x3D01
{
	int iVar0;
...
int func_83(int iParam0)//Position - 0x3D47
{
	if (!func_25(iParam0))
	{
		return func_28(iParam0);
...
int func_85(float fParam0, bool bParam1)//Position - 0x3DF3
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_86(int iParam0, var uParam1)//Position - 0x3EAA
{
	switch (iParam0)
	{
		case 0:
...
int func_88(int iParam0)//Position - 0x52D1
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_89(int iParam0)//Position - 0x5617
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_90(int iParam0)//Position - 0x564F
{
	struct<2> Var0;
...
bool func_92()//Position - 0x5ACE
{
	return Global_111278 > 0;
}

int func_93()//Position - 0x5ADC
{
	if (Global_95621 != -1)
	{
		return 1;
...
void func_97(int iParam0)//Position - 0x5BE0
{
			...
			if (!Local_47[iParam0 /*20*/].f_19)
			{
				if (!func_2(Local_47[iParam0 /*20*/].f_1))
				{
					...
					if (func_2(Local_47[iParam0 /*20*/].f_1))
					{
						if (iParam0 == 0)
						{
							TASK::TASK_START_SCENARIO_AT_POSITION(Local_47[iParam0 /*20*/].f_1, "PROP_HUMAN_SEAT_CHAIR", vLocal_132[iParam0 /*3*/], fLocal_139[iParam0], 0, 0, 1);
							PED::_0xA3A9299C4F2ADB98(Local_47[iParam0 /*20*/].f_1);
							PED::_0x425AECF167663F48(Local_47[iParam0 /*20*/].f_1, 1);
...
void func_98(int iParam0)//Position - 0x6072
{
	bool bVar0;
	struct<8> Var1;
...
int func_99(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x60E4
{
	if (iParam3 == 0)
	{
...
void func_101(int iParam0)//Position - 0x63BD
{
	char cVar0[64];
...
void func_102(int iParam0)//Position - 0x6472
{
	Global_111549 = iParam0;
}

char* func_103(int iParam0, bool bParam1)//Position - 0x6480
{
	switch (iParam0)
	{
		case 0:
...
void func_104(int iParam0)//Position - 0x66C9
{
	Global_41947 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_105(int iParam0)//Position - 0x66DB
{
	func_106(iParam0, 0, func_126(iParam0));
}

void func_106(int iParam0, int iParam1, int iParam2)//Position - 0x66F0
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_107(var uParam0)//Position - 0x671F
{
	struct<16> Var0;
	int iVar16;
...
int func_108(int iParam0)//Position - 0x67F0
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_109(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_109(bool bParam0, int iParam1, int iParam2)//Position - 0x6815
{
	if (bParam0)
	{
		return iParam1;
...
int func_110(int iParam0)//Position - 0x682C
{
	return iParam0 & 15;
}

int func_111(int iParam0)//Position - 0x6839
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_112(int iParam0)//Position - 0x684B
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_113(int iParam0)//Position - 0x685E
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_114(int iParam0)//Position - 0x6871
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

void func_115(int iParam0, var uParam1)//Position - 0x6884
{
	Global_111560.f_24990.f_43[iParam0] = *uParam1;
}

void func_116(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x689C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_117(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x6A1E
{
...
void func_118(var uParam0, int iParam1)//Position - 0x6A56
{
	if (iParam1 <= 0)
	{
		return;
...
void func_119(var uParam0, int iParam1)//Position - 0x6ADC
{
	int iVar0;
	int iVar1;
...
void func_120(var uParam0, int iParam1)//Position - 0x6B2D
{
...
void func_121(var uParam0, int iParam1)//Position - 0x6B60
{
...
void func_122(var uParam0, int iParam1)//Position - 0x6B9A
{
...
void func_123(var uParam0, int iParam1)//Position - 0x6BD5
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_124(int iParam0, int iParam1)//Position - 0x6C11
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_126(int iParam0)//Position - 0x6CF9
{
	int iVar0;
...
void func_127(var uParam0)//Position - 0x6E9C
{
	if (*uParam0 == -1)
	{
		return;
...
void func_130()//Position - 0x6F66
{
	...
	iLocal_142 = PED::ADD_SCENARIO_BLOCKING_AREA(-79.95f, -1126.33f, 20.65f, -3.5f, -1081.6f, 30.67f, 0, 1, 1, 1);
...
void func_131(int iParam0, int iParam1)//Position - 0x71FE
{
	int iVar0;
...
void func_132(int iParam0)//Position - 0x72F7
{
...
void func_133(int iParam0)//Position - 0x7345
{
	struct<7> Var0;
	bool bVar7;
	bool bVar8;
...
int func_135(int iParam0)//Position - 0x78A7
{
	int iVar0;
...
int func_136(int iParam0)//Position - 0x7AFC
{
	int iVar0;
...
int func_137(int iParam0)//Position - 0x7B68
{
	return iParam0;
}

void func_138(int iParam0, var uParam1)//Position - 0x7B72
{
	int iVar0;
	int iVar1;
...
bool func_139(int iParam0)//Position - 0x8511
{
	struct<7> Var0;
	int iVar7;
...
struct<7> func_140(int iParam0)//Position - 0x8545
{
	struct<7> Var0;
...
int func_142()//Position - 0xB17E
{
	return Global_30737;
}

void func_143(int iParam0)//Position - 0xB189
{
	if (iParam0 == -1)
	{
		iParam0 = func_32();
...
int func_145(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xB1FC
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
	...
	if (!bVar0)
	{
		...
		if (!func_166(Global_111560.f_24990.f_43[iParam3]))
		{
			return 0;
		}
...
bool func_146(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0xB596
{
	if (bParam6)
	{
...
bool func_147(int iParam0)//Position - 0xB5DD
{
	int iVar0;
...
int func_148(int iParam0)//Position - 0xB5FE
{
	return func_149(iParam0, 1);
}

int func_149(int iParam0, int iParam1)//Position - 0xB60D
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_150(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0xB660
{
	func_151(func_125(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_151(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0xB67E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_152(float fParam0, float fParam1, float fParam2)//Position - 0xB87F
{
	float fVar0;
...
int func_153(int iParam0, int iParam1)//Position - 0xB8C1
{
	int iVar0;
	int iVar1;
...
int func_154(int iParam0)//Position - 0xB9CD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_155(int iParam0, int iParam1)//Position - 0xBAA9
{
...
int func_156(int iParam0)//Position - 0xBACC
{
	int iVar0;
...
var func_157()//Position - 0xC1EA
{
	return Global_98708.f_1;
}

int func_158()//Position - 0xC1F8
{
	if (Global_95621 != -1)
	{
...
bool func_161()//Position - 0xC262
{
	return Global_98721.f_346 > 0;
}

bool func_162()//Position - 0xC273
{
	return Global_98721.f_345 > 0;
}

var func_163()//Position - 0xC284
{
	return Global_1312873;
}

int func_164()//Position - 0xC290
{
...
bool func_166(int iParam0)//Position - 0xC2D4
{
	return func_153(func_125(), iParam0);
}

int func_167(int iParam0, int iParam1, int iParam2)//Position - 0xC2E6
{
	int iVar0;
	int iVar1;
...
int func_168(int iParam0)//Position - 0xC3CA
{
	if (!func_25(iParam0))
	{
		return 7;
...
bool func_169(int iParam0)//Position - 0xC3EE
{
	int iVar0;
	bool bVar1;
...
void func_172()//Position - 0xC54B
{
	func_100();
}

void func_173(vector3 vParam0)//Position - 0xC557
{
