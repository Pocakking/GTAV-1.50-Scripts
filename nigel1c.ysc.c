...
bool func_6(int iParam0)//Position - 0xAE2
{
	return func_7(iParam0, 20);
}

bool func_7(int iParam0, int iParam1)//Position - 0xAF2
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_8()//Position - 0xB0D
{
	return -1;
}

void func_9()//Position - 0xB16
{
	int iVar0;
...
int func_14()//Position - 0xD3E
{
	func_15();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_15()//Position - 0xD57
{
	int iVar0;
...
bool func_16(int iParam0)//Position - 0xE54
{
	return iParam0 < 3;
}

int func_17(int iParam0)//Position - 0xE60
{
	int iVar0;
	int iVar1;
...
int func_18(int iParam0)//Position - 0xE9D
{
	if (func_16(iParam0))
	{
...
var func_19(int iParam0)//Position - 0xEC2
{
	return Global_1798[iParam0 /*29*/];
}

bool func_20(int iParam0)//Position - 0xED1
{
	return Global_41396 == iParam0;
}

void func_21()//Position - 0xEDF
{
	int iVar0;
...
bool func_22(int iParam0, int iParam1)//Position - 0xF36
{
	switch (iParam0)
	{
		case 5:
...
void func_24(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xFC8
{
...
bool func_27(int iParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x1057
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam3), ENTITY::GET_ENTITY_COORDS(iParam1, bParam3)) <= (fParam2 * fParam2);
}

int func_28(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x1079
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_29(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x1174
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_30(int iParam0, float fParam1)//Position - 0x1280
{
	var uVar0;
	vector3 vVar1;
...
int func_31(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0x1315
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	...
	{
		vVar3 = { func_33(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_32(vector3 vParam0, vector3 vParam3)//Position - 0x13A3
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_33(vector3 vParam0)//Position - 0x13C4
{
	float fVar0;
	float fVar1;
...
int func_34(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x1403
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_35(int iParam0)//Position - 0x144B
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_36(int iParam0, float fParam1)//Position - 0x146C
{
	float fVar0;
...
bool func_37(int iParam0, float fParam1)//Position - 0x14E2
{
	return func_38(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_38(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x14FA
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_39(&(Local_40[iVar4 /*4*/]), vVar1, iParam1, &(Local_40[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_40[iVar4 /*4*/].f_3) < iParam4);
}

int func_39(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x15BB
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_40(int iParam0, int iParam1)//Position - 0x16E7
{
	int iVar0;
...
int func_42(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x17F6
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
void func_43(var uParam0)//Position - 0x1887
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_44(int iParam0, int iParam1)//Position - 0x18A2
{
	int iVar0;
...
int func_45(int iParam0)//Position - 0x18E1
{
...
void func_46()//Position - 0x1909
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_605))
	{
		...
		else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_605, PLAYER::PLAYER_PED_ID(), 1) || func_47())
		{
...
void func_49(int iParam0)//Position - 0x1C43
{
	if (func_52())
	{
		return;
...
void func_50(bool bParam0, bool bParam1)//Position - 0x1CCD
{
	if (bParam0)
	{
		if (func_53(0))
...
bool func_51()//Position - 0x1D41
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

bool func_52()//Position - 0x1D52
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

int func_53(int iParam0)//Position - 0x1D64
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
void func_55(int iParam0)//Position - 0x1E76
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_56(int iParam0)//Position - 0x1F12
{
	if (func_35(iParam0))
	{
...
void func_57(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x1F3C
{
	func_58(&(Param0.f_1));
	func_55(&Param0);
}

void func_58(int iParam0)//Position - 0x1F52
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_60(char* sParam0, bool bParam1)//Position - 0x1FC0
{
	func_61(sParam0);
	func_506(bParam1);
}

void func_61(char* sParam0)//Position - 0x1FD4
{
...
void func_62()//Position - 0x2013
{
	Global_19671 = 0;
	func_23();
}

void func_63()//Position - 0x2023
{
	Global_19671 = 0;
	func_64();
}

void func_64()//Position - 0x2033
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
	...
	switch (iLocal_522)
	{
		case 0:
			...
			if (func_283(iLocal_605))
			{
				...
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_605, 0.5f, 1f, 0f), 2.5f, 20000, 1048576000, 0, 1193033728);
...
bool func_67(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x223D
{
...
void func_68(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x229C
{
...
void func_69(var uParam0, int iParam1)//Position - 0x2337
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
float func_70(int iParam0, int iParam1)//Position - 0x2354
{
	return func_71(iParam0, iParam1, 1);
}

float func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x2365
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_72()//Position - 0x23C3
{
	...
	switch (iLocal_522)
	{
		case 0:
			...
			func_219();
			func_68(&uLocal_701, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_934, vLocal_937, fLocal_940, 0, true, 0))
			{
				func_218(500, 1);
			...
			if (func_283(iLocal_605))
			{
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_616, false);
				TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_616, sLocal_910, "take_collar_trevor", 8f, -4f, 1, 16, 1148846080, 0);
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_605, iLocal_616, sLocal_910, "take_collar_dog", 8f, -4f, 1, 16, 1148846080, 0);
...
void func_73(bool bParam0, bool bParam1)//Position - 0x2796
{
...
int func_74(int iParam0)//Position - 0x27ED
{
...
void func_76(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2869
{
	int iVar0;
...
void func_77(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x2912
{
	if (bParam0)
	{
...
int func_80(int iParam0, bool bParam1)//Position - 0x2AB3
{
	int iVar0;
	int iVar1;
...
int func_81()//Position - 0x2AF4
{
	return Global_1312745;
}

int func_82(int iParam0)//Position - 0x2B00
{
...
bool func_83()//Position - 0x2B42
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_84(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x2B53
{
	int iVar0;
...
void func_85(int iParam0)//Position - 0x2B86
{
	if (iParam0 == 1)
	{
...
bool func_86(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2BA9
{
...
void func_87(bool bParam0)//Position - 0x2BFD
{
	...
	{
		MISC::CLEAR_AREA_OF_VEHICLES(vLocal_911, 50f, 0, 0, 0, 0, false, 0);
...
bool func_88(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2D6E
{
	func_24(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
Vector3 func_89(int iParam0, vector3 vParam1)//Position - 0x2DC2
{
	var uVar0;
...
bool func_90(int iParam0)//Position - 0x2E08
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
void func_91(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x2E26
{
	int iVar0;
...
Vector3 func_92(int iParam0)//Position - 0x2FE4
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_93(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2FF7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_94(int iParam0, int iParam1, int iParam2)//Position - 0x380D
{
	int iVar0;
...
int func_95(int iParam0)//Position - 0x3899
{
	switch (iParam0)
	{
...
void func_96(int iParam0, int iParam1, int iParam2)//Position - 0x38D4
{
	int iVar0;
	int iVar1;
...
int func_97(int iParam0, int iParam1, int iParam2)//Position - 0x395E
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_98(int iParam0, int iParam1, int iParam2)//Position - 0x3A3C
{
	Global_76389[1 /*14*/] = { func_143(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 2);
}

int func_99(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x3A67
{
	var uVar0;
	int iVar10;
...
int func_100(int iParam0, int iParam1, int iParam2)//Position - 0x406E
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_101(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4107
{
	int iVar0;
...
int func_102(int iParam0, int iParam1, int iParam2)//Position - 0x419D
{
	int iVar0;
	int iVar1;
...
int func_103(int iParam0)//Position - 0x423E
{
	switch (iParam0)
	{
		case 0:
...
int func_104(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x42EE
{
	int iVar0;
...
int func_105(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x45F5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_106(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x51A8
{
	int iVar0;
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x548C
{
	int iVar0;
...
int func_108(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5753
{
	int iVar0;
	int iVar1;
...
int func_109(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x578A
{
	int iVar0;
...
int func_110(int iParam0, int iParam1, int iParam2)//Position - 0x57B3
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_111(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5A7D
{
	int iVar0;
...
int func_112(int iParam0, int iParam1, int iParam2)//Position - 0x5D07
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_113(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5E5E
{
	int iVar0;
...
int func_114(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5EF6
{
	switch (iParam0)
	{
...
int func_115(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5FC4
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar41 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_103(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_116(int iParam0, int iParam1)//Position - 0x6120
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_117(int iParam0)//Position - 0x64C7
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_118(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6528
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_119(int iParam0, int iParam1)//Position - 0x6624
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6762
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_103(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
int func_121(int iParam0)//Position - 0x6842
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_122(int iParam0, int iParam1)//Position - 0x68C8
{
	int iVar0;
	struct<10> Var1;
...
void func_123(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x71F7
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_124(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x7321
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_125(int iParam0, int iParam1)//Position - 0x7369
{
	int iVar0;
	struct<17> Var1;
...
void func_126(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x91B4
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_127(int iParam0)//Position - 0x939E
{
	switch (iParam0)
	{
		case 0:
...
void func_128(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x944E
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_129(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x94BF
{
	switch (iParam0)
	{
		case joaat("player_zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_115(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_115(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_115(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_115(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_130(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x973C
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_131(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9B61
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_132(int iParam0, int iParam1)//Position - 0x9E54
{
	int iVar0;
	int iVar1;
...
int func_133(int iParam0, int iParam1)//Position - 0x9E9A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_134(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9EFA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_135(int iParam0)//Position - 0x9F7E
{
...
void func_136(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xA036
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_137(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xA080
{
	int iVar0;
...
int func_138(var uParam0)//Position - 0xA0B0
{
	int iVar0;
	int iVar1;
...
int func_139(int iParam0, int iParam1, int iParam2)//Position - 0xA0E4
{
	int iVar0;
	var uVar1;
...
bool func_140(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xA116
{
	int iVar0;
...
int func_141(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xBF7D
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_142(int iParam0)//Position - 0xCE9C
{
	if (!MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_143(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCEED
{
	func_206();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_144(int iParam0, int iParam1)//Position - 0xCF3F
{
	switch (iParam0)
	{
		case 0:
...
void func_145(int iParam0)//Position - 0xD02F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xE2A6
{
	int iVar0;
	int iVar1;
...
bool func_147(int iParam0, int iParam1, var uParam2)//Position - 0xE637
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_148(int iParam0, int iParam1)//Position - 0xEA3C
{
	switch (iParam1)
	{
		case 0:
...
int func_149(int iParam0, int iParam1)//Position - 0xEE37
{
	switch (iParam1)
	{
		case 0:
...
int func_150(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xF232
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_151(int iParam0)//Position - 0xF274
{
	switch (iParam0)
	{
		case -1:
...
void func_152(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xF348
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_146(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_146(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_103(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_153(int iParam0)//Position - 0xF621
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0xF778
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0xFC86
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0xFCFB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0xFD6F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0xFE56
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x101BA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x103CB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x105FB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0x1070B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x110AA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x11C1D
{
	if (iParam0 < 136)
	{
		func_166(iParam0);
...
void func_165(int iParam0)//Position - 0x11C52
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x12856
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x13764
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x13891
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0, int iParam1)//Position - 0x1398F
{
	switch (iParam0)
	{
		case 0:
...
void func_170(int iParam0)//Position - 0x13A7F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x14F72
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x150C3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x155CE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x15C3C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x15CB0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0)//Position - 0x15D80
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_177(int iParam0)//Position - 0x162B0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x16447
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_179(int iParam0)//Position - 0x16C45
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180(int iParam0)//Position - 0x16D55
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_181(int iParam0)//Position - 0x17C80
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_182(int iParam0)//Position - 0x1893E
{
	if (iParam0 < 107)
	{
		func_185(iParam0);
...
void func_183(int iParam0)//Position - 0x18984
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_184(int iParam0)//Position - 0x19429
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_185(int iParam0)//Position - 0x1A218
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_186(int iParam0)//Position - 0x1AE61
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_187(int iParam0)//Position - 0x1B0DA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_188(int iParam0, int iParam1)//Position - 0x1B220
{
	switch (iParam0)
	{
		case 0:
...
void func_189(int iParam0)//Position - 0x1B310
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_190(int iParam0)//Position - 0x1C09C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_191(int iParam0)//Position - 0x1C216
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_192(int iParam0)//Position - 0x1C78D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_193(int iParam0)//Position - 0x1CCB7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_194(int iParam0)//Position - 0x1CD2B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_195(int iParam0)//Position - 0x1CDFB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_196(int iParam0)//Position - 0x1D2D3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_197(int iParam0)//Position - 0x1D53C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_198(int iParam0)//Position - 0x1D812
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_199(int iParam0)//Position - 0x1D9DB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_200(int iParam0)//Position - 0x1E52F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_201(int iParam0)//Position - 0x1F179
{
	if (iParam0 < 60)
	{
		func_203(iParam0);
...
void func_202(int iParam0)//Position - 0x1F1AE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_203(int iParam0)//Position - 0x1FF4E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_204(int iParam0)//Position - 0x20665
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_205(int iParam0)//Position - 0x2074C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_206()//Position - 0x2084A
{
...
int func_207(int iParam0, int iParam1, int iParam2)//Position - 0x208C3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_208(bool bParam0)//Position - 0x20B1E
{
	int iVar0;
...
void func_209(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x20B5C
{
	func_210(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_210(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x20B86
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_211(vector3 vParam0)//Position - 0x20F7A
{
...
int func_212(int iParam0, int iParam1, bool bParam2)//Position - 0x20FA4
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_213(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x21015
{
...
int func_214(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x210ED
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_215(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x213E3
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_216(int iParam0)//Position - 0x21497
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
Vector3 func_217()//Position - 0x214FC
{
	return 2.55f, 5.665f, 2.55f;
}

void func_218(int iParam0, bool bParam1)//Position - 0x21513
{
	if (CAM::IS_SCREEN_FADED_IN())
	{
...
void func_219()//Position - 0x21545
{
	func_222(Local_627);
	func_222(Local_635);
	func_222(Local_643);
...
void func_220(struct<8> Param0)//Position - 0x215A7
{
	if (func_221(Param0))
	{
...
int func_221(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x215E4
{
...
void func_222(struct<8> Param0)//Position - 0x21607
{
	if (func_221(Param0))
	{
...
void func_223()//Position - 0x2163D
{
	float fVar0;
	...
	switch (iLocal_522)
	{
		case 0:
			if (func_283(iLocal_605))
			{
				...
				TASK::TASK_PERFORM_SEQUENCE(iLocal_605, iLocal_866);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_866);
				PED::_0x2208438012482A1A(iLocal_605, 1, 0);
			}
			func_87(1);
...
int func_224(float fParam0)//Position - 0x21785
{
	vector3 vVar0;
	...
	if (func_283(PLAYER::PLAYER_PED_ID()) && func_283(iLocal_605))
	{
		...
		if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_605, vLocal_927, vLocal_930, fLocal_933, 0, true, 0) && func_225(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_605, 0f, 1f, 0f), 1.5f)) && !ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iLocal_605))
		{
		...
		{
			vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_605, true)) };
...
bool func_225(int iParam0, vector3 vParam1, float fParam4)//Position - 0x218BA
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_226()//Position - 0x218EF
{
				...
				if (func_228() || func_27(Local_523[0 /*16*/], PLAYER::PLAYER_PED_ID(), 5f, 1))
				{
					if (func_27(Local_523[0 /*16*/], PLAYER::PLAYER_PED_ID(), 12f, 1))
					{
						...
						if (func_88(&uLocal_701, "NIG1CAU", "NIG1C_DOG", "NIG1C_DOG_1", 7, func_25(), 0))
						{
							...
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_523[0 /*16*/].f_9, 1f, 20000, 1048576000, 0, 1193033728);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_866);
			...
			if ((func_283(Local_523[1 /*16*/]) && func_283(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_FLEEING(Local_523[1 /*16*/]))
			{
				if (func_27(Local_523[1 /*16*/], PLAYER::PLAYER_PED_ID(), 8f, 1))
				{
					if (func_88(&uLocal_701, "NIG1CAU", "NIG1C_DOG", "NIG1C_DOG_4", 7, func_25(), 0))
					{
						...
						TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 4000);
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_523[1 /*16*/].f_9, 1f, 20000, 1048576000, 0, 1193033728);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_866);
...
bool func_230(char* sParam0, int iParam1, char* sParam2)//Position - 0x21CD5
{
...
void func_231()//Position - 0x21CF3
{
	if (iLocal_879 == 0)
	{
		if (func_221(Local_659) && func_283(iLocal_605))
		{
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_659))
			{
				...
				if (iLocal_877 == 0)
				{
					if (func_27(Local_659, iLocal_605, 6f, 1))
					{
...
void func_233()//Position - 0x21E10
{
	if (iLocal_878 == 0)
	{
		if (func_221(Local_643) && func_283(iLocal_605))
		{
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_643))
			{
				...
				if (iLocal_876 == 0)
				{
					if (func_27(Local_643, iLocal_605, 6f, 1))
					{
...
void func_234()//Position - 0x21F0A
{
	if (iLocal_514 != 6)
	{
		if ((func_221(Local_635) && func_221(Local_627)) && func_221(Local_667))
		{
			if (iLocal_875 == 0)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_605, -662.7688f, -208.3171f, 35.49321f, -674.6289f, -214.6519f, 38.80591f, 6.5f, 0, true, 0))
				{
			...
			switch (iLocal_514)
			{
				...
				case 3:
					...
					TASK::TASK_VEHICLE_MISSION(Local_667.f_1, Local_667, Local_635, 2, 20f, 262144, 0.5f, 2f, 1);
					TASK::TASK_VEHICLE_MISSION(Local_635.f_1, Local_635, Local_667, 2, 20f, 262144, 0.5f, 2f, 1);
				...
				case 5:
					if (ENTITY::GET_ENTITY_SPEED(Local_635) < 0.5f && ENTITY::GET_ENTITY_SPEED(Local_667) < 0.5f)
					{
						...
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_635.f_1, -1f, 1f, 0f), 1.3f, 20000, 1048576000, 0, 1193033728);
						...
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_635.f_1, -1f, 1f, 0f), 1.2f, 20000, 1f, 0, 1193033728);
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_635.f_1, 0);
						TASK::TASK_PLAY_ANIM(0, sLocal_907, "react_big_variations_a", 8f, -8f, -1, 8192, 0, 0, 0, 0);
						TASK::TASK_PLAY_ANIM(0, sLocal_907, "exit_to_generic", 8f, -8f, -1, 8192, 0, 0, 0, 0);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_866);
...
void func_235()//Position - 0x22487
{
...
int func_236(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x227A4
{
	vector3 vVar0;
...
bool func_237(int iParam0, int iParam1, float fParam2)//Position - 0x2285F
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_239()//Position - 0x228BC
{
	if (func_221(Local_651) && func_283(iLocal_605))
	{
		switch (iLocal_515)
		{
			...
			case 1:
				ENTITY::SET_ENTITY_COORDS(Local_651, -616.56f, -176.6f, 37.26f, 1, false, 0, 1);
				...
				{
					TASK::TASK_VEHICLE_MISSION(Local_651.f_1, Local_651, Local_635, 12, 15f, 262144, 20f, 5f, 1);
				}
			...
			case 4:
				if ((TASK::GET_SCRIPT_TASK_STATUS(Local_651.f_1, 242628503) != 1 && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_651, -1, 0)) && !PED::IS_PED_FLEEING(Local_651.f_1))
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_866);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_651, -2f, 2f, 0f), 2f, 20000, 1048576000, 0, 1193033728);
					if (func_283(Local_627.f_1))
					{
			...
			case 6:
				...
				TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, Local_651, PLAYER::PLAYER_PED_ID(), 8, 20f, 20, 100f, 5f, 1);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_866);
				TASK::TASK_PERFORM_SEQUENCE(Local_651.f_1, iLocal_866);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_866);
				iLocal_515 = 7;
...
void func_240(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)//Position - 0x22BA1
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_241()//Position - 0x22CFA
{
	...
	switch (iLocal_522)
	{
		...
		case 1:
			...
			else if (iLocal_891 == 0)
			{
				if (func_221(Local_683))
				{
					if (func_227() > 25)
					{
						...
						ENTITY::SET_ENTITY_COORDS(Local_683, -678.85f, -95.08f, 36.86f, 1, false, 0, 1);
			...
			func_233();
			func_231();
			if (ENTITY::IS_ENTITY_AT_COORD(iLocal_605, vLocal_869, 3f, 3f, 2f, false, true, 0))
			{
				iLocal_522 = 0;
				iLocal_521 = 6;
			}
...
void func_242()//Position - 0x23260
{
	if (func_283(iLocal_604))
	{
...
void func_243()//Position - 0x23286
{
...
void func_244(int iParam0)//Position - 0x23374
{
	vector3 vVar0;
	...
	if (!Local_523[iParam0 /*16*/].f_14)
	{
		if (func_283(Local_523[iParam0 /*16*/]) && func_283(iLocal_605))
		{
			if (!Local_523[iParam0 /*16*/].f_13)
			{
				if (TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_605))
				{
					if (func_232() > Local_523[iParam0 /*16*/].f_12)
					{
						...
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_523[iParam0 /*16*/].f_6, 1f, 20000, 1048576000, 0, 1193033728);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_866);
			...
			{
				vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(Local_523[iParam0 /*16*/], ENTITY::GET_ENTITY_COORDS(iLocal_605, true)) };
				...
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_605, 0);
				TASK::TASK_PAUSE(0, 1000);
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_523[iParam0 /*16*/].f_9, 1f, 20000, 1048576000, 0, 1193033728);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_866);
				TASK::TASK_PERFORM_SEQUENCE(Local_523[iParam0 /*16*/], iLocal_866);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_866);
...
void func_245()//Position - 0x23512
{
	if ((func_283(iLocal_604) && func_246(iLocal_604, vLocal_609, 1) < 5f) && func_246(PLAYER::PLAYER_PED_ID(), vLocal_609, 1) < 25f)
	{
		if (iLocal_613)
		{
...
float func_246(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x235D0
{
	vector3 vVar0;
...
void func_247(int iParam0)//Position - 0x2360A
{
	vector3 vVar0;
	float fVar3;
	...
	{
		Local_523[iParam0 /*16*/] = PED::CREATE_PED(5, Local_523[iParam0 /*16*/].f_1, Local_523[iParam0 /*16*/].f_2, Local_523[iParam0 /*16*/].f_5, 1, true);
		vVar0 = { Local_523[iParam0 /*16*/].f_2 };
		MISC::GET_GROUND_Z_FOR_3D_COORD(vVar0, &fVar3, 0, 0);
		ENTITY::SET_ENTITY_COORDS(Local_523[iParam0 /*16*/], vVar0.x, vVar0.y, fVar3, 1, false, 0, 1);
...
int func_248()//Position - 0x236B5
{
	if (PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()))
	{
		if (!ENTITY::DOES_ENTITY_EXIST(Local_627))
		{
			if (STREAMING::HAS_MODEL_LOADED(Local_627.f_2) && STREAMING::HAS_MODEL_LOADED(Local_627.f_3))
			{
				...
				Local_627.f_1 = PED::CREATE_PED_INSIDE_VEHICLE(Local_627, 4, Local_627.f_3, -1, 1, true);
				VEHICLE::_0xBE5C1255A1830FF5(Local_627, 1);
		...
		if (!ENTITY::DOES_ENTITY_EXIST(Local_635))
		{
			if (STREAMING::HAS_MODEL_LOADED(iLocal_623) && STREAMING::HAS_MODEL_LOADED(iLocal_618))
			{
				...
				Local_635.f_1 = PED::CREATE_PED_INSIDE_VEHICLE(Local_635, 5, iLocal_618, -1, 1, true);
		...
		if (!ENTITY::DOES_ENTITY_EXIST(Local_643))
		{
			if (STREAMING::HAS_MODEL_LOADED(iLocal_621) && STREAMING::HAS_MODEL_LOADED(iLocal_620))
			{
				...
				Local_643.f_1 = PED::CREATE_PED_INSIDE_VEHICLE(Local_643, 4, iLocal_620, -1, 1, true);
				iLocal_615 = PED::CREATE_PED_INSIDE_VEHICLE(Local_643, 4, iLocal_618, 2, 1, true);
				VEHICLE::_0xBE5C1255A1830FF5(Local_643, 1);
		...
		if (!ENTITY::DOES_ENTITY_EXIST(Local_659))
		{
			if (STREAMING::HAS_MODEL_LOADED(iLocal_622) && STREAMING::HAS_MODEL_LOADED(iLocal_618))
			{
				...
				{
					Local_659.f_1 = PED::CREATE_PED_INSIDE_VEHICLE(Local_659, 4, iLocal_618, -1, 1, true);
		...
		if (!ENTITY::DOES_ENTITY_EXIST(Local_667))
		{
			if (STREAMING::HAS_MODEL_LOADED(iLocal_621) && STREAMING::HAS_MODEL_LOADED(iLocal_620))
			{
				...
				{
					Local_667.f_1 = PED::CREATE_PED_INSIDE_VEHICLE(Local_667, 4, iLocal_620, -1, 1, true);
					PED::SET_PED_COMBAT_ATTRIBUTES(Local_667.f_1, 17, true);
		...
		if (!ENTITY::DOES_ENTITY_EXIST(Local_651))
		{
			if (STREAMING::HAS_MODEL_LOADED(iLocal_624) && STREAMING::HAS_MODEL_LOADED(iLocal_618))
			{
				...
				Local_651.f_1 = PED::CREATE_PED_INSIDE_VEHICLE(Local_651, 4, iLocal_618, -1, 1, true);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_675))
	{
		if (STREAMING::HAS_MODEL_LOADED(Local_675.f_2) && STREAMING::HAS_MODEL_LOADED(iLocal_620))
		{
			...
			{
				Local_675.f_1 = PED::CREATE_PED_INSIDE_VEHICLE(Local_675, 4, iLocal_620, -1, 1, true);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_683))
	{
		if (STREAMING::HAS_MODEL_LOADED(Local_683.f_2) && STREAMING::HAS_MODEL_LOADED(Local_683.f_3))
		{
			...
			{
				Local_683.f_1 = PED::CREATE_PED_INSIDE_VEHICLE(Local_683, 4, Local_683.f_3, -1, 1, true);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_691))
	{
		if (STREAMING::HAS_MODEL_LOADED(iLocal_623) && STREAMING::HAS_MODEL_LOADED(iLocal_620))
		{
			...
			{
				Local_691.f_1 = PED::CREATE_PED_INSIDE_VEHICLE(Local_691, 4, iLocal_620, -1, 1, true);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_699))
	{
		...
		{
			iLocal_699 = VEHICLE::CREATE_VEHICLE(1938952078, -637.88f, -112.82f, 38.1f, 83.08f, true, true, false);
...
void func_249()//Position - 0x23C35
{
...
void func_250()//Position - 0x23CF5
{
	bool bVar0;
	...
	switch (iLocal_522)
	{
		case 0:
			...
			if ((iLocal_951 != 1 && func_283(iLocal_604)) && func_283(iLocal_605))
			{
				...
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_609, 2.2f, 20000, 1048576000, 0, 1193033728);
...
void func_251(char* sParam0, int iParam1, int iParam2)//Position - 0x23F6D
{
	iParam2 = iParam2;
...
int func_252(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x23F86
{
	int iVar0;
	bool bVar1;
...
void func_253()//Position - 0x23FD8
{
	switch (iLocal_522)
	{
		case 0:
...
void func_255()//Position - 0x240F4
{
	struct<20> Var0;
	struct<22> Var22;
...
bool func_256(int iParam0, vector3 vParam1, float fParam4)//Position - 0x243D7
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, true), vParam1) <= (fParam4 * fParam4);
}

void func_257()//Position - 0x243F4
{
	if (iLocal_892)
	{
		if (!func_26())
...
void func_258()//Position - 0x24426
{
	func_259();
	switch (iLocal_522)
	{
		...
		case 1:
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_927, vLocal_930, fLocal_933, 0, true, 0))
			{
				iLocal_522 = 0;
				iLocal_521 = 3;
			}
...
void func_259()//Position - 0x244DC
{
	bool bVar0;
	
	if (func_283(iLocal_604))
	{
		if (MISC::GET_GAME_TIMER() > iLocal_898 && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_899, vLocal_902, fLocal_905, 0, true, 0))
		{
			bVar0 = false;
			if (HUD::IS_MESSAGE_BEING_DISPLAYED())
			{
...
void func_260()//Position - 0x2455C
{
	func_259();
	switch (iLocal_522)
	{
		case 0:
			...
			func_251("N1C_INIT", 7500, 1);
			AUDIO::TRIGGER_MUSIC_EVENT("NIGEL1C_FORA");
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_920, vLocal_923, fLocal_926, 0, true, 0))
			{
				iLocal_522 = 0;
				iLocal_521 = 2;
			}
...
void func_261(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2462D
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_262()//Position - 0x24912
{
	if (Global_76831 != 6)
	{
	}
...
float func_263(char* sParam0)//Position - 0x2494A
{
	HUD::_BEGIN_TEXT_COMMAND_GET_WIDTH(sParam0);
	return HUD::_END_TEXT_COMMAND_GET_WIDTH(1);
}

struct<2> func_264(int iParam0, int iParam1, int iParam2)//Position - 0x2495D
{
	struct<2> Var0;
	int iVar2;
...
char* func_265(int iParam0)//Position - 0x24A33
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_266(int iParam0)//Position - 0x24B86
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_267(int iParam0)//Position - 0x24BB9
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_268(int iParam0)//Position - 0x24BEC
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_269(int iParam0)//Position - 0x24C1F
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_270(int iParam0)//Position - 0x24C52
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_271(int iParam0)//Position - 0x24C8F
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_272(int iParam0)//Position - 0x24CC2
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_273(int iParam0)//Position - 0x24CF9
{
	struct<2> Var0;
...
struct<2> func_274(int iParam0)//Position - 0x25145
{
	struct<2> Var0;
...
int func_275(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x251AE
{
...
bool func_276(bool bParam0)//Position - 0x252C6
{
	if (bParam0)
	{
...
int func_277(int iParam0)//Position - 0x252EF
{
	if (Global_41396 == 15)
	{
		return 0;
...
bool func_278(int iParam0)//Position - 0x25311
{
	return func_279(iParam0, Global_41396);
}

int func_279(int iParam0, int iParam1)//Position - 0x25322
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_280(vector3 vParam0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x25503
{
	int iVar0;
	int iVar1;
...
void func_281()//Position - 0x25573
{
	Global_22211.f_6 = 1;
}

void func_282(int iParam0)//Position - 0x25581
{
	if (func_52())
	{
		return;
...
int func_283(int iParam0)//Position - 0x255B4
{
	if (func_35(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
bool func_284(bool bParam0)//Position - 0x255D4
{
...
void func_285()//Position - 0x255FF
{
	func_286(98, 1);
	func_490();
}

void func_286(int iParam0, bool bParam1)//Position - 0x25612
{
	int iVar0;
	char* sVar1;
...
void func_288(int iParam0, int iParam1, int iParam2)//Position - 0x25794
{
	bool bVar0;
...
void func_289()//Position - 0x2587C
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_290()//Position - 0x25D3D
{
	return Global_30736;
}

int func_291(int iParam0, int iParam1)//Position - 0x25D48
{
	int iVar0;
...
int func_292(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x25D99
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_293()//Position - 0x263EB
{
	func_310();
	func_302();
	func_298();
...
void func_294(int iParam0)//Position - 0x26444
{
	if (iParam0 == 1)
	{
...
void func_295()//Position - 0x2646D
{
...
void func_296()//Position - 0x2648B
{
	StringCopy(&Global_76809, "", 16);
	StringCopy(&Global_76813, "", 16);
}

void func_297()//Position - 0x264A5
{
	int iVar0;
...
void func_298()//Position - 0x264CA
{
	Global_98669 = 13;
	Global_98669.f_1 = -1;
	Global_98669.f_2 = 0;
...
void func_301(int iParam0)//Position - 0x26577
{
	if (iParam0 == 1)
	{
		Global_41945 = 1;
...
void func_302()//Position - 0x26590
{
	func_303(&Global_105109);
}

void func_303(var uParam0)//Position - 0x265A0
{
	int iVar0;
	int iVar1;
...
void func_304(var uParam0)//Position - 0x26B30
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_305(var uParam0)//Position - 0x26B4B
{
...
void func_306(var uParam0)//Position - 0x26B7A
{
	int iVar0;
...
void func_307(var uParam0)//Position - 0x26C2A
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_308(var uParam0)//Position - 0x26C48
{
	int iVar0;
...
void func_309(var uParam0)//Position - 0x26D28
{
	*uParam0 = -15;
}

void func_310()//Position - 0x26D36
{
	StringCopy(&Global_102117, "", 32);
	func_303(&Global_102125);
}

void func_311()//Position - 0x26D4F
{
...
void func_312()//Position - 0x26DCC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_313(int iParam0, int iParam1, int iParam2)//Position - 0x26E8D
{
	int iVar0;
	int iVar1;
	var uVar2;
...
void func_314(char* sParam0, int iParam1)//Position - 0x2704C
{
...
void func_316(int iParam0, int iParam1)//Position - 0x270EC
{
...
void func_317(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x27136
{
...
void func_318(int iParam0, int iParam1, int iParam2)//Position - 0x271D3
{
	struct<4> Var0;
	char* sVar32;
	...
	if (iParam0 != -1)
	{
		...
		func_319(&sVar32, Var0.f_3, Global_98706, iParam1, iParam2);
	}
}

void func_319(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x27212
{
...
void func_320(int iParam0, var uParam1)//Position - 0x27256
{
	switch (iParam0)
	{
		case 0:
...
void func_321(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, var uParam22, int iParam23, int iParam24)//Position - 0x2840D
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_322(int iParam0)//Position - 0x2849E
{
	switch (iParam0)
	{
		case 0:
...
void func_323(int iParam0)//Position - 0x287E4
{
	Global_41947 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_324()//Position - 0x287F6
{
	if (Global_96011)
	{
		func_15();
...
char* func_325(var uParam0)//Position - 0x28828
{
	uParam0 = uParam0;
	return "";
}

void func_326()//Position - 0x28837
{
	vector3 vVar0[24];
...
void func_327(int iParam0, int iParam1)//Position - 0x2887A
{
	Global_96006 = iParam0;
	Global_96007 = iParam1;
}

void func_328(var uParam0)//Position - 0x2888E
{
	if (*uParam0 == -1)
	{
		return;
...
void func_329(int iParam0, bool bParam1)//Position - 0x288CB
{
	struct<26> Var0;
	int iVar32;
	bool bVar33;
...
int func_330(int iParam0)//Position - 0x28A51
{
	switch (iParam0)
	{
		case 0:
...
void func_331(int iParam0)//Position - 0x28DD8
{
	func_333(iParam0, 1);
...
int func_332()//Position - 0x28E0E
{
	return (Global_111560.f_10011.f_21 + Global_111560.f_18569.f_380);
}

void func_333(var uParam0, bool bParam1)//Position - 0x28E2A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_334(int iParam0)//Position - 0x2914E
{
...
void func_335(int iParam0)//Position - 0x29181
{
	switch (iParam0)
	{
		case 30:
...
void func_336(int iParam0, bool bParam1)//Position - 0x291B6
{
	if (iParam0 == -1)
	{
		return;
...
void func_337(int iParam0, int iParam1, bool bParam2)//Position - 0x29213
{
	if (iParam0 == -1)
	{
		return;
...
bool func_338(int iParam0, int iParam1)//Position - 0x2924E
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_339(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x29271
{
	if (iParam0 != 198)
	{
		if (Global_76577)
...
void func_340(int iParam0, int iParam1)//Position - 0x292CC
{
	switch (iParam0)
	{
		case 12:
...
void func_341(int iParam0, bool bParam1)//Position - 0x293B5
{
	if (bParam1)
	{
...
bool func_342(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x293DE
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_344()//Position - 0x29D60
{
	return Global_30737;
}

int func_345(var uParam0, int iParam1)//Position - 0x29D6B
{
	int iVar0;
...
int func_346(int iParam0)//Position - 0x2D506
{
	switch (iParam0)
	{
		case 46:
...
void func_347(int iParam0, bool bParam1)//Position - 0x2D5F8
{
	switch (iParam0)
	{
		case 46:
...
void func_348(int iParam0, bool bParam1)//Position - 0x2D649
{
	int iVar0;
...
void func_349(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x2D6AF
{
	func_350(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_350(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2D6D0
{
	int iVar0;
...
void func_351()//Position - 0x2D8A3
{
	int iVar0;
...
int func_352(int iParam0)//Position - 0x2D9C3
{
	int iVar0;
	int iVar1;
...
int func_355(int iParam0)//Position - 0x2DBFD
{
...
void func_356(int iParam0, int iParam1)//Position - 0x2DC2A
{
...
int func_357(char* sParam0)//Position - 0x2DC67
{
	int iVar0;
...
int func_358()//Position - 0x2DCC7
{
	return func_359(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_359(char* sParam0, int iParam1)//Position - 0x2DCD8
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_360(int iParam0)//Position - 0x2DD21
{
	bool bVar0;
	int iVar1;
...
void func_361(int iParam0, int iParam1, int iParam2)//Position - 0x2DD92
{
...
void func_362(int iParam0, bool bParam1)//Position - 0x2DDC6
{
...
void func_363(int iParam0, int iParam1, int iParam2)//Position - 0x2DE02
{
...
bool func_364()//Position - 0x2DEC6
{
	return MISC::IS_BIT_SET(Global_98669.f_20, 13);
}

void func_365(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2DEDA
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_438(vParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
...
int func_366(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)//Position - 0x2E06E
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
void func_367(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2EEB2
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_368(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x2FAC6
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_369(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x2FB39
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_370(int iParam0)//Position - 0x31073
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_371(int iParam0, var uParam1, var uParam2)//Position - 0x31123
{
	int iVar0;
	int iVar1;
...
int func_372(int iParam0, bool bParam1, var uParam2)//Position - 0x31316
{
	int iVar0;
	bool bVar1;
...
int func_373(int iParam0)//Position - 0x31484
{
	int iVar0;
...
int func_374(int iParam0)//Position - 0x314BF
{
	if (iParam0 != func_8())
	{
...
int func_375(int iParam0)//Position - 0x31506
{
	switch (iParam0)
	{
		case 0:
...
int func_376(int iParam0, bool bParam1, bool bParam2)//Position - 0x318CE
{
	int iVar0;
...
int func_377(int iParam0)//Position - 0x31918
{
...
int func_378(int iParam0)//Position - 0x3195A
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case -32236122:
...
int func_379(int iParam0)//Position - 0x319FD
{
	if (iParam0 != func_8())
	{
		if (func_376(iParam0, 1, 1))
...
int func_380(int iParam0)//Position - 0x31A44
{
	if (iParam0 != func_8())
	{
		if (func_376(iParam0, 1, 1))
...
int func_381(int iParam0)//Position - 0x31A8A
{
	switch (iParam0)
	{
		case -2118308144:
...
int func_382(int iParam0)//Position - 0x31ABF
{
...
int func_383(int iParam0)//Position - 0x31AEE
{
...
int func_384(int iParam0)//Position - 0x31BAD
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		return 0;
...
int func_385(int iParam0)//Position - 0x31BE3
{
	switch (iParam0)
	{
		case 562680400:
...
int func_386(int iParam0, bool bParam1)//Position - 0x31C3C
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_387(int iParam0)//Position - 0x31C97
{
	int iVar0;
...
int func_388(int iParam0, int iParam1)//Position - 0x31CD1
{
	if (iParam1 == 0)
	{
...
bool func_389()//Position - 0x32045
{
	return DLC::IS_DLC_PRESENT(1927191088);
}

bool func_390()//Position - 0x32056
{
	return DLC::IS_DLC_PRESENT(2067165443);
}

bool func_391()//Position - 0x32067
{
	return DLC::IS_DLC_PRESENT(-957277403);
}

bool func_392()//Position - 0x32078
{
	return DLC::IS_DLC_PRESENT(210122941);
}

bool func_393()//Position - 0x32089
{
	return DLC::IS_DLC_PRESENT(-1894522408);
}

bool func_394()//Position - 0x3209A
{
	return DLC::IS_DLC_PRESENT(1630677557);
}

int func_395(int iParam0, int iParam1)//Position - 0x320AB
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_396(int iParam0)//Position - 0x32421
{
	if (iParam0 != func_8())
	{
		if (func_376(iParam0, 1, 1))
...
int func_397(int iParam0)//Position - 0x32480
{
	if (iParam0 != func_8())
	{
		if (func_376(iParam0, 1, 1))
...
int func_398(int iParam0)//Position - 0x324E0
{
	if (iParam0 != func_8())
	{
		if (func_376(iParam0, 1, 1))
...
int func_399(int iParam0, bool bParam1, var uParam2)//Position - 0x32527
{
	bool bVar0;
...
int func_400(int iParam0)//Position - 0x32966
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_401(int iParam0, int iParam1)//Position - 0x3298F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_402(int iParam0, var uParam1)//Position - 0x32B91
{
	int iVar0;
...
int func_403(int iParam0)//Position - 0x32E3E
{
	switch (iParam0)
	{
		case 1:
...
int func_404(int iParam0)//Position - 0x32EEE
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_405(int iParam0)//Position - 0x32F0E
{
...
int func_406(int iParam0)//Position - 0x32FEB
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_407(int iParam0, bool bParam1)//Position - 0x3319C
{
	int iVar0;
	struct<2> Var1;
...
int func_408(int iParam0)//Position - 0x3331C
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_410(int iParam0)//Position - 0x33407
{
	int iVar0;
	int iVar1;
...
int func_411()//Position - 0x358D5
{
	return 0;
}

int func_412()//Position - 0x358DE
{
	return 1;
}

int func_413()//Position - 0x358E7
{
	return 1;
}

int func_414()//Position - 0x358F0
{
...
int func_416(int iParam0)//Position - 0x359C4
{
	int iVar0;
	char* sVar1;
...
int func_417(int iParam0)//Position - 0x35A0B
{
	int iVar0;
...
int func_418(int iParam0)//Position - 0x35A87
{
	int iVar0;
...
int func_419(int iParam0)//Position - 0x35B6F
{
	int iVar0;
...
void func_420(int iParam0, int iParam1)//Position - 0x35BD2
{
	int iVar0;
...
void func_421(int iParam0)//Position - 0x35C54
{
	if (!func_422(*iParam0))
	{
...
bool func_422(int iParam0)//Position - 0x35C7F
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_423(int iParam0, var uParam1, var uParam2)//Position - 0x35C8E
{
	int iVar0;
	int iVar1;
...
int func_424(int iParam0)//Position - 0x35E51
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_425(var uParam0)//Position - 0x35F2F
{
...
int func_426(int iParam0, int iParam1)//Position - 0x35F6F
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_427(var uParam0, int iParam1)//Position - 0x36054
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_428(int iParam0, var uParam1, int iParam2)//Position - 0x36095
{
	int iVar0;
...
void func_429(int iParam0, int iParam1)//Position - 0x362F6
{
	int iVar0;
...
int func_430(int iParam0, int iParam1)//Position - 0x36394
{
	struct<82> Var0;
...
void func_431(vector3 vParam0, float fParam3, bool bParam4)//Position - 0x363D6
{
	int iVar0;
...
void func_432(int iParam0)//Position - 0x36426
{
	bool bVar0;
...
void func_433(var uParam0, var uParam1)//Position - 0x36598
{
...
int func_434(int iParam0, int iParam1)//Position - 0x36664
{
	int iVar0;
...
int func_435(var uParam0)//Position - 0x366D6
{
	return *uParam0;
}

int func_436(var uParam0, int iParam1)//Position - 0x366E1
{
	int iVar0;
	int iVar1;
...
bool func_437(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x37DD8
{
	if (bParam6)
	{
...
int func_438(vector3 vParam0, float fParam3)//Position - 0x37E1F
{
	return func_439(&(Global_105109.f_2890), vParam0, fParam3, 0);
}

int func_439(var uParam0, vector3 vParam1, float fParam4, bool bParam5)//Position - 0x37E39
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
int func_440(int iParam0)//Position - 0x380EE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_441(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x381B1
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_437(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
int func_442(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x383B9
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_443(int iParam0, int iParam1, bool bParam2)//Position - 0x38434
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_444(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x38495
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_445(int iParam0, int iParam1)//Position - 0x38A59
{
	int iVar0;
	int iVar1;
...
bool func_446()//Position - 0x38AD1
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_447(int iParam0)//Position - 0x38AE2
{
	int iVar0;
...
int func_448(int iParam0)//Position - 0x38B30
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
int func_449(int iParam0)//Position - 0x38BB7
{
...
int func_450(int iParam0)//Position - 0x38BE9
{
...
int func_451(int iParam0)//Position - 0x38C06
{
...
int func_452(int iParam0, int iParam1)//Position - 0x38C29
{
...
int func_453(int iParam0)//Position - 0x38C64
{
	if (func_452(iParam0, 0))
	{
...
int func_454(int iParam0, int iParam1)//Position - 0x38C87
{
	int iVar0;
...
int func_455(var uParam0)//Position - 0x38CD4
{
	if (func_456(uParam0))
	{
...
int func_456(var uParam0)//Position - 0x38D09
{
...
bool func_457()//Position - 0x38D68
{
	return func_455(&(Global_105109.f_2890));
}

void func_458()//Position - 0x38D7B
{
	func_459(&(Global_105109.f_2890));
}

void func_459(var uParam0)//Position - 0x38D8E
{
	if (func_456(uParam0))
	{
...
int func_460(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x38DAC
{
...
int func_462(int iParam0)//Position - 0x38EAF
{
	switch (iParam0)
	{
		case joaat("police"):
...
bool func_463()//Position - 0x38F08
{
	return func_456(&(Global_105109.f_2890));
}

void func_464(int iParam0)//Position - 0x38F1B
{
	int iVar0;
	...
	switch (iParam0)
	{
		...
		case 3:
			...
			iLocal_604 = PED::CREATE_PED(5, iLocal_617, vLocal_606, 27.58f, 1, true);
			func_89(iLocal_604, vLocal_606);
			...
			iLocal_605 = PED::CREATE_PED(26, iLocal_619, -633.89f, -250.1f, 37.38f, 50f, 1, true);
		...
		case 4:
			...
			iLocal_605 = PED::CREATE_PED(26, iLocal_619, -636.42f, -95.84f, 37.48f, -95.46f, 1, true);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_605, 3, 0, 3, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_605, 4, 0, 1, 0);
...
void func_465()//Position - 0x3936D
{
	while (!func_466())
	{
		SYSTEM::WAIT(0);
...
void func_467()//Position - 0x3946B
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_605))
	{
...
void func_468(bool bParam0)//Position - 0x394D0
{
	if (bParam0)
	{
		func_469();
...
void func_469()//Position - 0x39533
{
...
void func_470()//Position - 0x3955C
{
	func_482(0);
	if (func_481())
	{
...
void func_471()//Position - 0x3965B
{
	Global_92877 = 1;
}

void func_472(int iParam0, int iParam1, bool bParam2)//Position - 0x39668
{
	int iVar0;
...
void func_473()//Position - 0x39798
{
	char cVar0[64];
	char cVar16[64];
	char* sVar32;
...
struct<4> func_474(int iParam0)//Position - 0x39815
{
	return Global_1798[iParam0 /*29*/].f_3;
}

int func_475(int iParam0, int iParam1)//Position - 0x39828
{
...
int func_476(int iParam0, int iParam1)//Position - 0x39852
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_477(int iParam0, int iParam1, int iParam2)//Position - 0x3987C
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_478(int iParam0, int iParam1, int iParam2)//Position - 0x398C1
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_479()//Position - 0x39906
{
...
void func_480()//Position - 0x39A8E
{
...
void func_482(bool bParam0)//Position - 0x39C4E
{
...
void func_483(bool bParam0, bool bParam1)//Position - 0x39C8B
{
	if (bParam0)
	{
		func_484(0, 1, 1);
...
void func_484(bool bParam0, int iParam1, int iParam2)//Position - 0x39CBE
{
	bool bVar0;
...
void func_485(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x39D1D
{
	if (func_489())
	{
...
int func_487(var uParam0)//Position - 0x39DDC
{
	int iVar0[2];
	int iVar3;
	char* sVar4;
	...
	switch (iLocal_82)
	{
		...
		case 1:
			if (!func_488(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar4))
			{
				return 0;
			}
			iLocal_82 = 2;
		...
		case 2:
			...
			TASK::SET_SEQUENCE_TO_REPEAT(iVar5, 1);
...
int func_488(int iParam0)//Position - 0x3A115
{
	int iVar0;
...
void func_490()//Position - 0x3A16A
{
	if (func_505())
	{
		if (func_283(PLAYER::PLAYER_PED_ID()))
...
void func_491(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x3A1E6
{
...
void func_492(var uParam0, bool bParam1)//Position - 0x3A206
{
	func_493(&(uParam0->f_41), bParam1);
}

void func_493(var uParam0, bool bParam1)//Position - 0x3A218
{
	int iVar0;
...
void func_494(int iParam0, bool bParam1)//Position - 0x3A256
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_495(int iParam0)//Position - 0x3A291
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_496(var uParam0, bool bParam1)//Position - 0x3A2BC
{
	func_497(&(uParam0->f_35), bParam1);
}

void func_497(var uParam0, bool bParam1)//Position - 0x3A2CE
{
	int iVar0;
...
void func_498(int iParam0)//Position - 0x3A30B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_499(var uParam0, int iParam1)//Position - 0x3A343
{
	func_500(&(uParam0->f_28), iParam1);
}

void func_500(var uParam0, int iParam1)//Position - 0x3A355
{
	int iVar0;
...
void func_501(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x3A396
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_502()//Position - 0x3A3E6
{
...
void func_503(int iParam0)//Position - 0x3A569
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_523[iParam0 /*16*/]))
	{
...
void func_504(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x3A59A
{
	func_501(&(Param0.f_1), 1, 0, 1);
	func_498(&Param0);
}

int func_505()//Position - 0x3A5B3
{
	int iVar0;
...
void func_506(bool bParam0)//Position - 0x3A654
{
	int iVar0;
...
void func_507(char* sParam0, int iParam1)//Position - 0x3A724
{
	if (Global_98669 != 12)
	{
...
int func_508(char* sParam0, int iParam1, int iParam2)//Position - 0x3A74C
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_509(char* sParam0)//Position - 0x3A8DE
{
...
int func_511(char* sParam0, bool bParam1)//Position - 0x3A95C
{
	int iVar0;
	int iVar1;
...
int func_512(int iParam0, bool bParam1)//Position - 0x3A986
{
	int iVar0;
...
void func_515(bool bParam0)//Position - 0x3AA78
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_516(int iParam0)//Position - 0x3AA8C
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_517(int iParam0)//Position - 0x3AAC9
{
	if (iParam0 == 1)
	{
...
void func_518()//Position - 0x3AB06
{
	Global_22211.f_5 = 1;
}

void func_519()//Position - 0x3AB14
{
	Global_22211.f_5 = 0;
}

void func_520()//Position - 0x3AB22
{
	Global_92875 = 0;
	Global_92876 = 0;
}

int func_521()//Position - 0x3AB34
{
	if (((Global_98669 == 13 || Global_98669 == 10) || Global_98669 == 11) || Global_98669 == 12)
	{
		return 0;
...
void func_522()//Position - 0x3AB72
{
	Global_98704 = 1;
...
void func_523(int iParam0)//Position - 0x3AC65
{
...
void func_524(int iParam0, bool bParam1)//Position - 0x3AC77
{
	if (bParam1)
	{
...
void func_525()//Position - 0x3AC99
{
	int iVar0;
...
void func_526(var uParam0)//Position - 0x3ACB9
{
...
void func_527(var uParam0)//Position - 0x3ACD9
{
	int iVar0;
...
int func_528(int iParam0)//Position - 0x3AD13
{
	if (!func_16(iParam0))
	{
		return func_19(iParam0);
