...
bool func_5()//Position - 0x3C2
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

int func_6(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3D4
{
	int iVar0;
...
void func_7(int iParam0)//Position - 0x407
{
	if (func_5())
	{
		return;
...
void func_9(bool bParam0, bool bParam1)//Position - 0x4B8
{
	if (bParam0)
	{
		if (func_4(0))
...
bool func_10()//Position - 0x52C
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

void func_11(char* sParam0)//Position - 0x53D
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}

bool func_12()//Position - 0x54F
{
	return Global_1315657;
}

int func_13()//Position - 0x55B
{
	int iVar0;
	int iVar1;
...
int func_15(int iParam0)//Position - 0x5C2
{
	int iVar0;
...
int func_16(int iParam0, char* sParam1)//Position - 0x69F
{
...
int func_17(int iParam0, char* sParam1, int iParam2)//Position - 0x6B5
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam1);
...
int func_18(int iParam0, char* sParam1, char* sParam2)//Position - 0x6D1
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam1);
...
int func_19(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x6ED
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam1);
	HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(sParam2);
...
void func_22(int iParam0)//Position - 0x7DD
{
	iLocal_42 = iParam0;
	iLocal_43 = 0;
}

int func_23(var uParam0, int iParam1)//Position - 0x7EC
{
	int iVar0;
	bool bVar1;
	vector3 vVar2;
...
void func_24(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, char* sParam6, char* sParam7)//Position - 0x9D4
{
	int iVar0;
...
int func_26(int iParam0)//Position - 0xB82
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_27(int iParam0, int iParam1, int iParam2)//Position - 0xC4A
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_28(int iParam0)//Position - 0xC87
{
	int iVar0;
...
int func_29(int iParam0, int iParam1)//Position - 0x1023
{
	int iVar0;
...
int func_30()//Position - 0x139C
{
	return Global_1312745;
}

int func_31(int iParam0)//Position - 0x13A8
{
	if (iParam0 == 3)
	{
		return 815;
...
int func_32(int iParam0, int iParam1)//Position - 0x13EF
{
	if (iParam1 < 32)
	{
		return iParam1;
...
void func_34(int iParam0)//Position - 0x145B
{
...
void func_35(int iParam0)//Position - 0x1475
{
	int iVar0;
	int iVar1;
...
void func_36(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x14B7
{
	func_37(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_37(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x14D8
{
	int iVar0;
...
int func_40(var uParam0, var uParam1, vector3 vParam2)//Position - 0x180E
{
	int iVar0;
...
void func_41(var uParam0)//Position - 0x18CB
{
...
void func_42(var uParam0, var uParam1, int iParam2)//Position - 0x18E4
{
	int iVar0;
...
bool func_44(bool bParam0)//Position - 0x19DA
{
...
void func_45(int iParam0, int iParam1)//Position - 0x1A05
{
	Global_98708.f_7 = iParam0;
	Global_98708.f_8 = iParam1;
}

void func_46()//Position - 0x1A1D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_47(int iParam0, int iParam1)//Position - 0x1AC0
{
	int iVar0;
...
int func_48(int iParam0)//Position - 0x1B11
{
	if (iParam0 == 3)
	{
...
void func_49(var uParam0)//Position - 0x1B62
{
	int iVar0;
	int iVar1;
...
int func_50(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1BE5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_51(var uParam0, int iParam1)//Position - 0x2237
{
	if (uParam0->f_3 <= 0)
	{
	}
...
void func_52(int iParam0, int iParam1, bool bParam2)//Position - 0x22AB
{
...
void func_53(int iParam0, int iParam1, bool bParam2)//Position - 0x2397
{
	if (iParam1 < 0 || iParam1 >= 64)
	{
		return;
...
void func_54(int iParam0)//Position - 0x23F8
{
...
int func_55(int iParam0)//Position - 0x2418
{
	int iVar0;
	int iVar1;
...
int func_56(int iParam0)//Position - 0x24A4
{
...
void func_57(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5)//Position - 0x24C5
{
	int iVar0;
...
void func_58(vector3 vParam0)//Position - 0x25DE
{
	int iVar0;
...
bool func_60(int iParam0)//Position - 0x265A
{
	return Global_41396 == iParam0;
}

void func_61(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2668
{
	uParam0->f_6 = iParam1;
	func_62(&(uParam0->f_1), iParam2, iParam3);
}

void func_62(int iParam0, var uParam1, var uParam2)//Position - 0x2682
{
	int iVar0;
	int iVar1;
...
void func_63(var uParam0, int iParam1, int iParam2, char* sParam3)//Position - 0x26EB
{
	*uParam0 = iParam1;
	uParam0->f_7 = iParam2;
	uParam0->f_8 = sParam3;
...
Vector3 func_65(int iParam0, int iParam1)//Position - 0x2AFF
{
	switch (iParam0)
	{
		case 0:
...
bool func_66(int iParam0)//Position - 0x32DF
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
void func_67(int iParam0, int iParam1)//Position - 0x32FD
{
...
void func_68(int iParam0, int iParam1)//Position - 0x333A
{
...
void func_69(int iParam0, int iParam1, int iParam2)//Position - 0x337F
{
	bool bVar0;
...
int func_71()//Position - 0x3928
{
	return Global_30736;
}

int func_72(int iParam0)//Position - 0x3933
{
	int iVar0;
	int iVar1;
...
int func_73(int iParam0)//Position - 0x398D
{
	if (iParam0 == 146 || iParam0 == -1)
	{
		return 0;
...
int func_74(int iParam0)//Position - 0x39BA
{
	int iVar0;
	int iVar1;
...
bool func_76(var uParam0)//Position - 0x3AC5
{
	if (uParam0->f_3 <= 0)
	{
	}
...
int func_78(int iParam0)//Position - 0x3B0A
{
	int iVar0;
	int iVar1;
