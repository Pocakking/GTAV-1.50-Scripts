				...
				case 3:
					...
					else
					{
						...
						if (!func_112(3) && !Global_98703)
						{
							...
							{
								if ((!func_132(uLocal_94, 1) || !ENTITY::DOES_ENTITY_EXIST(func_111())) && !Global_98703)
								{
									func_125(10);
									break;
								}
				...
				case 6:
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_52))
					{
						...
						if (iLocal_99 != -1)
						{
							if (func_132(Global_110211, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_18(iLocal_99), 0, Global_98706, 0);
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_297))
		{
			...
			if (fVar15 > 0.8f)
			{
				...
				if (iLocal_122 == 12)
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar9, 1f, 20000, 1048576000, 0, func_65(vVar9, ENTITY::GET_ENTITY_COORDS(iLocal_297, false)));
				}
				else
				{
...
var func_40(int iParam0)//Position - 0x1748
{
	return Global_1798[iParam0 /*29*/];
}

void func_41()//Position - 0x1757
{
	vector3 vVar0;
	var uVar3;
	vector3 vVar4;
	...
	{
		TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
		TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iVar7, "oddjobs@basejump@ig_15", "puton_parachute", 1000f, -1000f, 0, 0, 1148846080, 0);
	}
...
void func_42(var uParam0, var uParam1)//Position - 0x1885
{
...
float func_43(float fParam0, float fParam1)//Position - 0x19AD
{
	if (fParam0 > fParam1)
	{
		return fParam1;
...
float func_44(float fParam0, float fParam1)//Position - 0x19C4
{
	if (fParam0 > fParam1)
	{
		return fParam0;
...
float func_45(float fParam0, float fParam1, float fParam2)//Position - 0x19DB
{
	float fVar0;
...
Vector3 func_46(int iParam0)//Position - 0x1A1D
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_47(int iParam0)//Position - 0x1B67
{
	switch (iParam0)
	{
		case 4:
...
Vector3 func_48(int iParam0)//Position - 0x1BDD
{
	switch (iParam0)
	{
		case 4:
...
void func_49(int iParam0, int iParam1, int iParam2)//Position - 0x1C67
{
...
void func_50(int iParam0, bool bParam1)//Position - 0x1CBF
{
	if (bParam1)
	{
...
void func_51(bool bParam0, bool bParam1, var uParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x1CE1
{
	if (bParam0)
	{
...
bool func_52()//Position - 0x1E1A
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_53(int iParam0, int iParam1)//Position - 0x1E37
{
	bool bVar0;
...
int func_54(int iParam0, bool bParam1)//Position - 0x1E82
{
	int iVar0;
	int iVar1;
...
int func_55()//Position - 0x1EC3
{
	return Global_1312745;
}

int func_56(int iParam0)//Position - 0x1ECF
{
...
bool func_57()//Position - 0x1F11
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_58(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x1F22
{
	int iVar0;
...
void func_60(int iParam0)//Position - 0x1F7C
{
	if (iParam0 == 1)
	{
...
void func_61(int iParam0)//Position - 0x1F9F
{
	if (func_64())
	{
		return;
...
void func_62(bool bParam0, bool bParam1)//Position - 0x2029
{
	if (bParam0)
	{
		if (func_93(0))
...
bool func_63()//Position - 0x209D
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

bool func_64()//Position - 0x20AE
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

float func_65(struct<2> Param0, float fParam2, struct<2> Param3, float fParam5)//Position - 0x20C0
{
	return MISC::GET_HEADING_FROM_VECTOR_2D((Param3 - Param0), (Param3.f_1 - Param0.f_1));
}

void func_66(bool bParam0)//Position - 0x20DA
{
	if (bParam0)
	{
		func_67();
...
Vector3 func_68(int iParam0)//Position - 0x2166
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_69(vector3 vParam0)//Position - 0x22B0
{
	float fVar0;
	float fVar1;
...
Vector3 func_70(int iParam0)//Position - 0x22EF
{
	switch (iParam0)
	{
		case 0:
...
void func_71(int iParam0)//Position - 0x2419
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_72(int iParam0)//Position - 0x2472
{
...
int func_73(int iParam0)//Position - 0x24F5
{
	int iVar0;
...
void func_74(int iParam0, int iParam1, int iParam2)//Position - 0x2526
{
	func_75(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_75(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x253B
{
	int iVar0;
...
int func_77(int iParam0, int iParam1, int iParam2)//Position - 0x25EE
{
...
int func_78(int iParam0, int iParam1, int iParam2)//Position - 0x2609
{
	int iVar0;
...
int func_79(int iParam0)//Position - 0x2655
{
	int iVar0;
...
int func_81(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x271B
{
	int iVar0;
...
void func_82(var uParam0, int iParam1)//Position - 0x2852
{
	int iVar0;
...
int func_83(int iParam0)//Position - 0x28A1
{
	if (Global_41396 == 15)
	{
		return 0;
...
void func_86(int iParam0)//Position - 0x2947
{
	if (iParam0 == 2)
	{
	}
...
int func_87(int iParam0, bool bParam1)//Position - 0x2968
{
	int iVar0;
...
int func_88(int iParam0)//Position - 0x2A20
{
	int iVar0;
...
void func_89(int iParam0)//Position - 0x2A5B
{
	int iVar0;
...
void func_90(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x2AB2
{
	int iVar0;
...
int func_91(var uParam0)//Position - 0x2BDD
{
	return 1;
}

var func_92()//Position - 0x2BE6
{
	return Global_73784;
}

int func_93(int iParam0)//Position - 0x2BF2
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
bool func_94(int iParam0, int iParam1)//Position - 0x2C4C
{
	switch (iParam0)
	{
		case 5:
...
bool func_95()//Position - 0x2C87
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

int func_96()//Position - 0x2C9C
{
...
bool func_97(bool bParam0)//Position - 0x2CB6
{
	if (bParam0)
	{
...
void func_98(var uParam0, int iParam1)//Position - 0x2CDF
{
	func_99(uParam0, iParam1);
}

void func_99(var uParam0, var uParam1)//Position - 0x2CEF
{
	*uParam0 = (*uParam0 || uParam1);
}

int func_100()//Position - 0x2D00
{
	return 1;
}

bool func_101()//Position - 0x2D09
{
	int iVar0;
	bool bVar1;
...
int func_102(int iParam0)//Position - 0x2E13
{
	int iVar0;
...
var func_103()//Position - 0x3530
{
	return Global_98708.f_1;
}

int func_104()//Position - 0x353E
{
	if (Global_95621 != -1)
	{
...
bool func_106()//Position - 0x358E
{
	return Global_98721.f_346 > 0;
}

bool func_107()//Position - 0x359F
{
	return Global_98721.f_345 > 0;
}

var func_108()//Position - 0x35B0
{
	return Global_1312873;
}

int func_109()//Position - 0x35BC
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
var func_111()//Position - 0x35F2
{
	return Global_94531;
}

int func_112(int iParam0)//Position - 0x35FE
{
	switch (iParam0)
	{
		case 0:
...
bool func_113(int iParam0)//Position - 0x3670
{
	int iVar0;
...
bool func_114(int iParam0)//Position - 0x36AC
{
	return Global_41396 == iParam0;
}

void func_115(var uParam0, int iParam1)//Position - 0x36BA
{
	*uParam0 = (*uParam0 || iParam1);
}

void func_116()//Position - 0x36CB
{
	vector3 vVar0;
...
float func_117(int iParam0)//Position - 0x3794
{
	switch (iParam0)
	{
		case 6:
...
Vector3 func_118(int iParam0)//Position - 0x37B2
{
	switch (iParam0)
	{
		case 6:
...
int func_120(var uParam0)//Position - 0x3870
{
	int iVar0;
...
void func_122(var uParam0)//Position - 0x3956
{
	int iVar0;
...
int func_123(var uParam0, int iParam1)//Position - 0x3986
{
	int iVar0;
	int iVar1;
...
int func_124(var uParam0)//Position - 0x39E3
{
	int iVar0;
...
void func_125(int iParam0)//Position - 0x3A0F
{
	iLocal_95 = iParam0;
}

void func_126(int iParam0, bool bParam1, bool bParam2)//Position - 0x3A1B
{
	int iVar0;
	bool bVar1;
...
bool func_129(int iParam0, int iParam1)//Position - 0x3B67
{
	bool bVar0;
...
bool func_130(int iParam0)//Position - 0x3BB4
{
	return func_131(iParam0, Global_41396);
}

int func_131(int iParam0, int iParam1)//Position - 0x3BC5
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_132(var uParam0, int iParam1)//Position - 0x3DA6
{
	return (uParam0 && iParam1) != 0;
}

void func_133()//Position - 0x3DB5
{
	if (ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
...
int func_134(int iParam0)//Position - 0x3ED3
{
	switch (iParam0)
	{
		case 91:
...
void func_135(int iParam0)//Position - 0x3FEB
{
	if (iLocal_95 < 5)
	{
		if (iParam0 != 263)
...
bool func_136(int iParam0)//Position - 0x4030
{
	return Global_110647[iParam0 /*10*/].f_1;
}

int func_137(vector3 vParam0, int iParam3)//Position - 0x4042
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_138(int iParam0)//Position - 0x4091
{
	switch (iParam0)
	{
		case 0:
...
void func_139(var uParam0, int iParam1)//Position - 0x40D8
{
	func_140(uParam0, iParam1);
}

void func_140(var uParam0, var uParam1)//Position - 0x40E8
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

void func_141(bool bParam0)//Position - 0x40FD
{
	if (bParam0)
	{
		if (iLocal_105 != 263)
