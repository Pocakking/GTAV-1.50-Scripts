...
void __EntryFunction__()//Position - 0x0
{
	...
	{
		iLocal_930 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -1652.227f, -1120.93f, 22.4479f, 9.2388f, 0f, -131.6249f, 50.1098f, 1, 2);
	...
	if (func_56(PLAYER::PLAYER_PED_ID()) && func_56(Local_868.f_9))
	{
		...
		ENTITY::ATTACH_ENTITY_TO_ENTITY(PLAYER::PLAYER_PED_ID(), Local_868.f_9, 0, 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
		ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), false, 0);
	}
	...
	if (func_56(PLAYER::PLAYER_PED_ID()))
	{
		...
		func_14(&Local_893, vVar1, ENTITY::GET_ENTITY_ROTATION(Local_868.f_9, 2), 50f, Local_893.f_20, Local_893.f_21, 3, 1101004800, 0, 0, -1082130432, 0);
		CAM::ATTACH_CAM_TO_ENTITY(Local_893, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0.5f, 1);
	}
	SYSTEM::WAIT(0);
...
float func_3(vector3 vParam0, vector3 vParam3)//Position - 0x7BA
{
...
void func_8(char[4] cParam0, int iParam1)//Position - 0x995
{
...
void func_12(vector3 vParam0, vector3 vParam3, var uParam6, var uParam7, int iParam8)//Position - 0x1029
{
	vector3 vVar0;
	
	vVar0 = { vParam3 - vParam0 };
	func_13(vVar0, uParam6, uParam7, iParam8);
}

void func_13(vector3 vParam0, var uParam3, var uParam4, int iParam5)//Position - 0x104C
{
	float fVar0;
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7, var uParam8, var uParam9, int iParam10, int iParam11, int iParam12, int iParam13, float fParam14, bool bParam15)//Position - 0x10F1
{
	uParam0->f_1 = { vParam1 };
	uParam0->f_4 = { vParam4 };
	uParam0->f_7 = fParam7;
...
Vector3 func_18(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4)//Position - 0x1367
{
	...
	vVar0.y = (0.5f * ((((2f * uParam1->f_1) + ((-uParam0->f_1 + uParam2->f_1) * fParam4)) + (((((2f * uParam0->f_1) - (5f * uParam1->f_1)) + (4f * uParam2->f_1)) - uParam3->f_1) * fVar3)) + ((((-uParam0->f_1 + (3f * uParam1->f_1)) - (3f * uParam2->f_1)) + uParam3->f_1) * fVar4)));
	vVar0.z = (0.5f * ((((2f * uParam1->f_2) + ((-uParam0->f_2 + uParam2->f_2) * fParam4)) + (((((2f * uParam0->f_2) - (5f * uParam1->f_2)) + (4f * uParam2->f_2)) - uParam3->f_2) * fVar3)) + ((((-uParam0->f_2 + (3f * uParam1->f_2)) - (3f * uParam2->f_2)) + uParam3->f_2) * fVar4)));
	return vVar0;
}
...
void func_23(bool bParam0, bool bParam1)//Position - 0x163B
{
	if (bParam0)
	{
		if (func_26(0))
...
bool func_24()//Position - 0x16AF
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

bool func_25()//Position - 0x16C0
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

int func_26(int iParam0)//Position - 0x16D2
{
	if (iParam0 == 1)
	{
...
void func_28(var uParam0, int iParam1, int iParam2)//Position - 0x1755
{
	int iVar0;
...
void func_29()//Position - 0x1863
{
	...
	while (iVar0 < iLocal_925)
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_925[iVar0], true, 0);
			ENTITY::SET_ENTITY_VISIBLE(iLocal_925[iVar0], false, 0);
			ENTITY::SET_ENTITY_COLLISION(iLocal_925[iVar0], false, 0);
...
void func_31(float fParam0, float fParam1, float fParam2)//Position - 0x2AB2
{
...
void func_32(int iParam0)//Position - 0x2AEA
{
	if (iParam0 > 0)
	{
	}
...
void func_33(int iParam0, float fParam1, int iParam2)//Position - 0x2AF8
{
...
void func_34(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x2B7B
{
	func_35(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_35(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2BA4
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_36(vector3 vParam0)//Position - 0x2F98
{
...
int func_37(int iParam0, int iParam1, bool bParam2)//Position - 0x2FC2
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_38(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x3033
{
...
int func_39()//Position - 0x3107
{
	func_40();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_40()//Position - 0x3120
{
	int iVar0;
...
bool func_41(int iParam0)//Position - 0x321D
{
	return Global_41396 == iParam0;
}

bool func_42(int iParam0)//Position - 0x322B
{
	return iParam0 < 3;
}

int func_43(int iParam0)//Position - 0x3237
{
	int iVar0;
	int iVar1;
...
int func_44(int iParam0)//Position - 0x3274
{
	if (func_42(iParam0))
	{
...
var func_45(int iParam0)//Position - 0x3299
{
	return Global_1798[iParam0 /*29*/];
}

int func_46(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x32A8
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_47(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x359E
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_48(int iParam0)//Position - 0x3652
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
int func_49(int iParam0, int iParam1)//Position - 0x36B7
{
	struct<2> Var0;
	struct<2> Var3;
	struct<2> Var6;
...
bool func_50(var uParam0)//Position - 0x3714
{
	int iVar0;
	int iVar1;
...
int func_51(var uParam0, int iParam1)//Position - 0x3788
{
...
int func_52(var uParam0, int iParam1)//Position - 0x398E
{
...
int func_54(var uParam0, int iParam1, int iParam2)//Position - 0x3B7C
{
	if (MISC::IS_BIT_SET(uParam0->f_113, iParam1) || MISC::IS_BIT_SET(uParam0->f_114, iParam1))
	{
		return 1;
...
void func_55(var uParam0)//Position - 0x3BCB
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
bool func_56(int iParam0)//Position - 0x3BF0
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
void func_57(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x3C0E
{
	int iVar0;
...
void func_58(int iParam0, bool bParam1)//Position - 0x3DCC
{
...
int func_59(int iParam0)//Position - 0x3E08
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
Vector3 func_60(int iParam0)//Position - 0x3E29
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_61(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x3E3C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, int iParam1, int iParam2)//Position - 0x4654
{
	int iVar0;
...
int func_63(int iParam0)//Position - 0x46E0
{
	switch (iParam0)
	{
...
void func_64(int iParam0, int iParam1, int iParam2)//Position - 0x471B
{
	int iVar0;
	int iVar1;
...
int func_65(int iParam0, int iParam1, int iParam2)//Position - 0x47A5
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_66(int iParam0, int iParam1, int iParam2)//Position - 0x4883
{
	Global_76389[1 /*14*/] = { func_112(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 2);
}

int func_67(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x48AE
{
	var uVar0;
	int iVar10;
...
int func_68(int iParam0, int iParam1, int iParam2)//Position - 0x4EB2
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_69(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4F4B
{
	int iVar0;
...
int func_70(int iParam0, int iParam1, int iParam2)//Position - 0x4FE1
{
	int iVar0;
	int iVar1;
...
int func_71(int iParam0)//Position - 0x5082
{
	switch (iParam0)
	{
		case 0:
...
int func_72(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5132
{
	int iVar0;
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x5439
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_74(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x5FEC
{
	int iVar0;
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x62D0
{
	int iVar0;
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6597
{
	int iVar0;
	int iVar1;
...
int func_77(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x65CE
{
	int iVar0;
...
int func_78(int iParam0, int iParam1, int iParam2)//Position - 0x65F7
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x68C1
{
	int iVar0;
...
int func_80(int iParam0, int iParam1, int iParam2)//Position - 0x6B4B
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_81(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6CA2
{
	int iVar0;
...
int func_82(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6D3A
{
	switch (iParam0)
	{
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6E08
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_84(int iParam0, int iParam1)//Position - 0x6F64
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_85(int iParam0)//Position - 0x730B
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_86(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x736C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_87(int iParam0, int iParam1)//Position - 0x7468
{
	int iVar0;
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x75A6
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_89(int iParam0)//Position - 0x7686
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_90(int iParam0, int iParam1)//Position - 0x770C
{
	int iVar0;
	struct<10> Var1;
...
void func_91(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x803C
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_92(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x8166
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_93(int iParam0, int iParam1)//Position - 0x81AE
{
	int iVar0;
	struct<17> Var1;
...
void func_94(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9FF6
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_95(int iParam0)//Position - 0xA1E0
{
	switch (iParam0)
	{
		case 0:
...
void func_96(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xA290
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_97(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA301
{
	switch (iParam0)
	{
		case joaat("player_zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_98(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA57E
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_99(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA9A3
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_100(int iParam0, int iParam1)//Position - 0xAC96
{
	int iVar0;
	int iVar1;
...
int func_101(int iParam0, int iParam1)//Position - 0xACDC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAD3C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_103(int iParam0)//Position - 0xADC0
{
...
void func_104(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xAE78
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_105(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xAEC2
{
	int iVar0;
...
int func_106(var uParam0)//Position - 0xAEF2
{
	int iVar0;
	int iVar1;
...
int func_107()//Position - 0xAF26
{
	return Global_1312745;
}

int func_108(int iParam0, int iParam1, int iParam2)//Position - 0xAF32
{
	int iVar0;
	var uVar1;
...
bool func_109(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xAF64
{
	int iVar0;
...
int func_110(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xCDCB
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_111(int iParam0)//Position - 0xDCE9
{
	if (!MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_112(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDD3A
{
	func_175();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_113(int iParam0, int iParam1)//Position - 0xDD8C
{
	switch (iParam0)
	{
		case 0:
...
void func_114(int iParam0)//Position - 0xDE7C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_115(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xF0F3
{
	int iVar0;
	int iVar1;
...
bool func_116(int iParam0, int iParam1, var uParam2)//Position - 0xF484
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_117(int iParam0, int iParam1)//Position - 0xF889
{
	switch (iParam1)
	{
		case 0:
...
int func_118(int iParam0, int iParam1)//Position - 0xFC84
{
	switch (iParam1)
	{
		case 0:
...
int func_119(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x10081
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_120(int iParam0)//Position - 0x100C3
{
	switch (iParam0)
	{
		case -1:
...
void func_121(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10197
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_71(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_122(int iParam0)//Position - 0x10470
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_123(int iParam0)//Position - 0x105C7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_124(int iParam0)//Position - 0x10AD5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_125(int iParam0)//Position - 0x10B4A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_126(int iParam0)//Position - 0x10BBE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_127(int iParam0)//Position - 0x10CA5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0x11008
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0x11219
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0x11449
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x11559
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x11EF8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x12A6B
{
	if (iParam0 < 136)
	{
		func_135(iParam0);
...
void func_134(int iParam0)//Position - 0x12AA0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x136A4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x145B2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x146DF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0, int iParam1)//Position - 0x147DD
{
	switch (iParam0)
	{
		case 0:
...
void func_139(int iParam0)//Position - 0x148CD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x15DBE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x15F0F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x1641A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x16A88
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x16AFC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x16BCC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x170FC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x17293
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x17A91
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x17BA1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x18ACE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x1978B
{
	if (iParam0 < 107)
	{
		func_154(iParam0);
...
void func_152(int iParam0)//Position - 0x197D1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x1A276
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x1B065
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x1BCAE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x1BF27
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0, int iParam1)//Position - 0x1C06F
{
	switch (iParam0)
	{
		case 0:
...
void func_158(int iParam0)//Position - 0x1C15F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x1CEE9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x1D063
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x1D5DA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0x1DB04
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x1DB78
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x1DC48
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x1E120
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x1E389
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x1E65F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x1E828
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x1F37C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x1FFC6
{
	if (iParam0 < 60)
	{
		func_172(iParam0);
...
void func_171(int iParam0)//Position - 0x1FFFB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x20DA0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x2142C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x21513
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175()//Position - 0x21611
{
...
int func_176(int iParam0, int iParam1, int iParam2)//Position - 0x2168A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_177(bool bParam0)//Position - 0x218E5
{
	int iVar0;
...
void func_178(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x21923
{
	if (bParam0)
	{
...
bool func_179()//Position - 0x21A5C
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_180(int iParam0, int iParam1)//Position - 0x21A79
{
	bool bVar0;
...
int func_181(int iParam0, bool bParam1)//Position - 0x21AC4
{
	int iVar0;
	int iVar1;
...
int func_182(int iParam0)//Position - 0x21B05
{
...
bool func_183()//Position - 0x21B47
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_184(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x21B58
{
	int iVar0;
...
void func_185(int iParam0)//Position - 0x21B8B
{
	if (iParam0 == 1)
	{
...
void func_186(bool bParam0)//Position - 0x21BAE
{
	AUDIO::STOP_STREAM();
...
void func_187(var uParam0)//Position - 0x21CE3
{
	int iVar0;
...
int func_188(var uParam0, int iParam1)//Position - 0x21D08
{
...
int func_189(int iParam0, int iParam1, int iParam2)//Position - 0x21EFB
{
...
int func_190(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x21F2F
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_191(bool bParam0)//Position - 0x2252E
{
	int iVar0;
	int iVar1;
...
void func_192(int iParam0)//Position - 0x227B0
{
	int iVar0;
...
void func_193(int iParam0)//Position - 0x2280A
{
	bool bVar0;
	char cVar1[64];
...
char* func_194(int iParam0)//Position - 0x2299A
{
	switch (iParam0)
	{
		case 0:
...
int func_196(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x22AA3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_197(int iParam0)//Position - 0x230F5
{
	func_218(93, iParam0);
	func_218(29, iParam0);
	func_218(30, iParam0);
...
bool func_198(int iParam0)//Position - 0x23115
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_199(int iParam0, int iParam1, int iParam2)//Position - 0x232C5
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_200(int iParam0)//Position - 0x23302
{
	int iVar0;
...
int func_201(int iParam0, int iParam1)//Position - 0x2369E
{
	int iVar0;
...
int func_202(bool bParam0)//Position - 0x23A17
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_203(int iParam0, int iParam1)//Position - 0x23ACE
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_204(int iParam0, int iParam1)//Position - 0x23AE9
{
...
int func_205(var uParam0, int iParam1)//Position - 0x23B86
{
	int iVar0;
	var uVar1[78];
...
int func_206(var uParam0, int iParam1)//Position - 0x23C37
{
	int iVar0;
...
bool func_207(var uParam0, int iParam1)//Position - 0x23CB2
{
	return (*uParam0)[iParam1] == 78;
}

void func_208(var uParam0)//Position - 0x23CC3
{
	int iVar0;
...
void func_209(var uParam0, int iParam1)//Position - 0x23CF7
{
	(*uParam0)[iParam1] = 78;
}

void func_210(var uParam0, float fParam1)//Position - 0x23D07
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_211(var uParam0)//Position - 0x23D24
{
	return uParam0->f_80;
}

bool func_212(var uParam0, int iParam1)//Position - 0x23D30
{
	return func_213(uParam0, iParam1) != -1;
}

int func_213(var uParam0, int iParam1)//Position - 0x23D42
{
	int iVar0;
...
bool func_214(var uParam0)//Position - 0x23D6F
{
	return uParam0->f_79 == 1;
}

int func_215(int iParam0)//Position - 0x23D7D
{
	switch (iParam0)
	{
		case 60:
...
int func_216(int iParam0, int iParam1)//Position - 0x23DCD
{
	int iVar0;
...
void func_217(int iParam0, int iParam1)//Position - 0x23E1E
{
	int iVar0;
...
void func_218(int iParam0, int iParam1)//Position - 0x23E41
{
	int iVar0;
...
void func_219()//Position - 0x23E9E
{
	int iVar0;
...
int func_220(int iParam0)//Position - 0x23F13
{
	return Global_1798[iParam0 /*29*/].f_17;
}

void func_221(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x23F24
{
	int iVar0;
...
int func_222(int iParam0)//Position - 0x23FCD
{
	if (func_59(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
Vector3 func_223(int iParam0, vector3 vParam1)//Position - 0x23FED
{
	var uVar0;
...
void func_224()//Position - 0x24035
{
	int iVar0;
	...
	while (iVar0 < iLocal_925)
	{
		if (func_56(iLocal_925[iVar0]))
		{
			...
			ENTITY::SET_ENTITY_VISIBLE(iLocal_925[iVar0], true, 0);
			ENTITY::SET_ENTITY_COLLISION(iLocal_925[iVar0], true, 0);
...
void func_225(int iParam0, bool bParam1)//Position - 0x24169
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_226(int iParam0)//Position - 0x241A4
{
	if (*iParam0 != -1)
	{
...
void func_227(var uParam0, int iParam1, bool bParam2)//Position - 0x241C5
{
...
void func_228(int iParam0, int iParam1, int iParam2)//Position - 0x2425F
{
	bool bVar0;
...
void func_229()//Position - 0x24347
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_231(bool bParam0)//Position - 0x24853
{
