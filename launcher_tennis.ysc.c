			...
			switch (iLocal_96)
			{
				...
				case 3:
					...
					if (!func_178(iLocal_101))
					{
						...
						{
							bVar1 = true;
							if (MISC::ARE_STRINGS_EQUAL(&(Global_98669.f_3), &cLocal_70))
							{
								cLocal_70 = { Local_54 };
								bVar1 = false;
							}
					...
					if (fLocal_111 > (fLocal_103 * fLocal_103) && !Global_98703)
					{
						if (iLocal_106 != 263)
						{
					...
					else
					{
						...
						if (!func_165(3) && !Global_98703)
						{
							...
							{
								if ((!func_180(uLocal_95, 1) || !ENTITY::DOES_ENTITY_EXIST(func_164())) && !Global_98703)
								{
									func_173(10);
									break;
								}
						...
						if (bVar2)
						{
							if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_118, vLocal_121, fLocal_124, 1, false, iLocal_104) || (fLocal_126 > 0f && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), func_139(vLocal_118, vLocal_121, 0.5f), false) > fLocal_126))
							{
								bVar2 = false;
							}
				...
				case 6:
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_53))
					{
						...
						if (iLocal_100 != -1)
						{
							if (func_180(Global_110211, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_19(iLocal_100), 0, Global_98706, 0);
								func_7(func_19(iLocal_100), 0, Global_98706, 1, 0);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_19(iLocal_100), 0, Global_98706, 0);
								func_7(func_19(iLocal_100), 0, Global_98706, 0, 0);
							}
						}
						func_6();
						func_186(&Global_110211, 0);
...
int func_1(char* sParam0)//Position - 0xA60
{
...
void func_10(int iParam0)//Position - 0xB94
{
	iParam0->f_1 = 0f;
	iParam0->f_2 = 0f;
	*iParam0 = 0;
...
float func_11(int iParam0)//Position - 0xBAA
{
	if (func_14(iParam0))
	{
		if (func_13(iParam0))
...
float func_12(bool bParam0)//Position - 0xBE9
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_13(var uParam0)//Position - 0xC41
{
...
int func_15()//Position - 0xC61
{
	return 1;
}

void func_16()//Position - 0xC6A
{
}

void func_17(char* sParam0, int iParam1, int iParam2)//Position - 0xC72
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_95769))
	{
...
bool func_18(bool bParam0)//Position - 0xCB3
{
...
char* func_19(int iParam0)//Position - 0xCDE
{
	switch (iParam0)
	{
		case 0:
...
void func_20(int iParam0)//Position - 0xE1C
{
	var uVar0;
	vector3 vVar1[24];
...
void func_21(int iParam0)//Position - 0xE73
{
	if (!func_14(iParam0))
	{
		func_24(iParam0);
...
void func_22(int iParam0)//Position - 0xE94
{
	func_23(iParam0, 0f);
}

void func_23(int iParam0, float fParam1)//Position - 0xEA3
{
...
void func_24(int iParam0)//Position - 0xED1
{
	if (!func_14(iParam0))
	{
		func_22(iParam0);
...
void func_25(int iParam0)//Position - 0xEE9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_26(int iParam0)//Position - 0xF42
{
...
int func_27(int iParam0)//Position - 0xFC5
{
	int iVar0;
...
void func_28(int iParam0, int iParam1, int iParam2)//Position - 0xFF6
{
	func_29(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_29(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x100B
{
	int iVar0;
...
int func_31(int iParam0, int iParam1, int iParam2)//Position - 0x10BE
{
...
int func_32(int iParam0, int iParam1, int iParam2)//Position - 0x10D9
{
	int iVar0;
...
int func_33(int iParam0)//Position - 0x1125
{
	int iVar0;
...
int func_35(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x11EB
{
	int iVar0;
...
void func_36(var uParam0, int iParam1)//Position - 0x1322
{
	int iVar0;
...
int func_37(int iParam0)//Position - 0x1371
{
	if (Global_41396 == 15)
	{
		return 0;
...
int func_42(int iParam0)//Position - 0x14E5
{
	return Global_93705[iParam0];
}

void func_43(int iParam0, int iParam1)//Position - 0x14F5
{
	int iVar0;
	struct<17> Var1;
...
void func_44(int iParam0, int iParam1, var uParam2)//Position - 0x151C
{
	int iVar0;
	struct<14> Var1;
	int iVar15;
...
int func_46(int iParam0)//Position - 0x167E
{
	switch (iParam0)
	{
		case -1:
...
struct<10> func_47(int iParam0, int iParam1)//Position - 0x1752
{
	int iVar0;
	struct<10> Var1;
...
void func_48(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2081
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
int func_49(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x21AB
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_51(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
int func_50(int iParam0, int iParam1)//Position - 0x228B
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_51(int iParam0)//Position - 0x2632
{
	switch (iParam0)
	{
		case 0:
...
int func_52(int iParam0)//Position - 0x26E2
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_53(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x2743
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<14> func_54(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x278B
{
	func_121();
...
void func_55(int iParam0, int iParam1)//Position - 0x27DD
{
	switch (iParam0)
	{
		case 0:
...
void func_56(int iParam0)//Position - 0x28CD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_57(&(Global_76389[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_57(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x3B02
{
	int iVar0;
	int iVar1;
...
bool func_58(int iParam0, int iParam1, var uParam2)//Position - 0x3E92
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_59(int iParam0, int iParam1)//Position - 0x4298
{
	switch (iParam1)
	{
		case 0:
...
int func_60(int iParam0, int iParam1, int iParam2)//Position - 0x4693
{
	int iVar0;
	var uVar1;
...
int func_61(var uParam0)//Position - 0x46C5
{
	int iVar0;
	int iVar1;
...
var func_62()//Position - 0x46F9
{
	return Global_1312745;
}

int func_63(int iParam0, int iParam1)//Position - 0x4705
{
	switch (iParam1)
	{
		case 0:
...
int func_64(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x4B00
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_65(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x5A1E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_66(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x5A60
{
	int iVar0;
...
void func_67(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x78C7
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_57(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_57(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_51(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_68(int iParam0)//Position - 0x7B9F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_69(int iParam0)//Position - 0x7CEC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_70(int iParam0)//Position - 0x81FA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_71(int iParam0)//Position - 0x826E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_72(int iParam0)//Position - 0x82E1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_73(int iParam0)//Position - 0x83C8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_74(int iParam0)//Position - 0x870A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_75(int iParam0)//Position - 0x8912
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_76(int iParam0)//Position - 0x8B32
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_77(int iParam0)//Position - 0x8C3B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_78(int iParam0)//Position - 0x95CD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_79(int iParam0)//Position - 0xA125
{
	if (iParam0 < 136)
	{
		func_81(iParam0);
...
void func_80(int iParam0)//Position - 0xA15A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_81(int iParam0)//Position - 0xAD5E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_82(int iParam0)//Position - 0xBC5E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_83(int iParam0)//Position - 0xBD8B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_84(int iParam0, int iParam1)//Position - 0xBE82
{
	switch (iParam0)
	{
		case 0:
...
void func_85(int iParam0)//Position - 0xBF72
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_86(int iParam0)//Position - 0xD4A5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_87(int iParam0)//Position - 0xD5EC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_88(int iParam0)//Position - 0xDAF6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_89(int iParam0)//Position - 0xE15F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_90(int iParam0)//Position - 0xE1D2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_91(int iParam0)//Position - 0xE2A2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_92(int iParam0)//Position - 0xE79D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_93(int iParam0)//Position - 0xE92E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_94(int iParam0)//Position - 0xF11D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_95(int iParam0)//Position - 0xF226
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_96(int iParam0)//Position - 0x1014B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_97(int iParam0)//Position - 0x10DF8
{
	if (iParam0 < 107)
	{
		func_100(iParam0);
...
void func_98(int iParam0)//Position - 0x10E3E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_99(int iParam0)//Position - 0x118E2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_100(int iParam0)//Position - 0x126D0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_101(int iParam0)//Position - 0x1330F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_102(int iParam0)//Position - 0x13587
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_103(int iParam0, int iParam1)//Position - 0x136C3
{
	switch (iParam0)
	{
		case 0:
...
void func_104(int iParam0)//Position - 0x137B3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_105(int iParam0)//Position - 0x14512
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_106(int iParam0)//Position - 0x14681
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_107(int iParam0)//Position - 0x14BF2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_108(int iParam0)//Position - 0x1511A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_109(int iParam0)//Position - 0x1518D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_110(int iParam0)//Position - 0x1525D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_111(int iParam0)//Position - 0x1570D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_112(int iParam0)//Position - 0x15968
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_113(int iParam0)//Position - 0x15C28
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_114(int iParam0)//Position - 0x15DE3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_115(int iParam0)//Position - 0x16929
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_116(int iParam0)//Position - 0x1755B
{
	if (iParam0 < 60)
	{
		func_118(iParam0);
...
void func_117(int iParam0)//Position - 0x17590
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_118(int iParam0)//Position - 0x18326
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_119(int iParam0)//Position - 0x189A8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_120(int iParam0)//Position - 0x18A8E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_121()//Position - 0x18B85
{
...
int func_122(int iParam0)//Position - 0x18BFD
{
	switch (iParam0)
	{
		case 0:
...
struct<17> func_123(int iParam0, int iParam1)//Position - 0x18CAD
{
	int iVar0;
	struct<17> Var1;
...
void func_124(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1AAF5
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
void func_125(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x1ACDF
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
void func_126(int iParam0)//Position - 0x1AD50
{
	Global_110646 = (Global_110646 || iParam0);
}

bool func_127(int iParam0)//Position - 0x1AD63
{
	return (Global_110646 && iParam0) != 0;
}

void func_128(int iParam0)//Position - 0x1AD74
{
	if (iLocal_96 < 5)
	{
		if (iParam0 != 263)
...
int func_130(int iParam0)//Position - 0x1ADD7
{
	int iVar0;
	int iVar1;
...
int func_131(int iParam0)//Position - 0x1AE14
{
	if (func_133(iParam0))
	{
...
var func_132(int iParam0)//Position - 0x1AE39
{
	return Global_1798[iParam0 /*29*/];
}

bool func_133(int iParam0)//Position - 0x1AE48
{
	return iParam0 < 3;
}

int func_134(int iParam0, bool bParam1)//Position - 0x1AE54
{
	int iVar0;
...
int func_135(int iParam0)//Position - 0x1AF0C
{
	int iVar0;
...
void func_136(int iParam0)//Position - 0x1AF47
{
	int iVar0;
...
void func_137(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x1AF9E
{
	int iVar0;
...
int func_138(var uParam0)//Position - 0x1B0C9
{
	return 1;
}

Vector3 func_139(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x1B0D2
{
	return FtoV((1f - fParam6)) * vParam0 + Vector(fParam6, fParam6, fParam6) * vParam3;
}

var func_140()//Position - 0x1B0ED
{
	return Global_73784;
}

int func_141(int iParam0)//Position - 0x1B0F9
{
	if (iParam0 == 1)
	{
...
bool func_142(int iParam0, int iParam1)//Position - 0x1B153
{
	switch (iParam0)
	{
		case 5:
...
bool func_143()//Position - 0x1B18E
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

int func_144()//Position - 0x1B1A3
{
...
bool func_145(bool bParam0)//Position - 0x1B1BD
{
	if (bParam0)
	{
...
int func_147(vector3 vParam0)//Position - 0x1B2B5
{
	float fVar0;
	float fVar1;
	int iVar2;
...
Vector3 func_148(int iParam0)//Position - 0x1B2F9
{
	int iVar0;
...
Vector3 func_149(int iParam0, int iParam1)//Position - 0x1B3D7
{
	int iVar0;
...
void func_150(var uParam0, int iParam1)//Position - 0x1B415
{
	func_151(uParam0, iParam1);
}

void func_151(var uParam0, var uParam1)//Position - 0x1B425
{
	*uParam0 = (*uParam0 || uParam1);
}

bool func_152()//Position - 0x1B436
{
	int iVar0;
	bool bVar1;
...
int func_153(int iParam0)//Position - 0x1B540
{
	int iVar0;
...
var func_154()//Position - 0x1BC5D
{
	return Global_98708.f_1;
}

int func_155()//Position - 0x1BC6B
{
	if (Global_95621 != -1)
	{
...
bool func_157()//Position - 0x1BCBB
{
	return Global_98721.f_346 > 0;
}

bool func_158()//Position - 0x1BCCC
{
	return Global_98721.f_345 > 0;
}

var func_159()//Position - 0x1BCDD
{
	return Global_1312873;
}

int func_160()//Position - 0x1BCE9
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
var func_161()//Position - 0x1BD05
{
	func_162();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_162()//Position - 0x1BD1E
{
	int iVar0;
...
var func_164()//Position - 0x1BE35
{
	return Global_94531;
}

int func_165(int iParam0)//Position - 0x1BE41
{
	switch (iParam0)
	{
		case 0:
...
bool func_166(int iParam0)//Position - 0x1BEB3
{
	int iVar0;
...
bool func_167(int iParam0)//Position - 0x1BEEF
{
	return Global_41396 == iParam0;
}

void func_168(var uParam0, int iParam1)//Position - 0x1BEFD
{
	*uParam0 = (*uParam0 || iParam1);
}

void func_169()//Position - 0x1BF0E
{
	var uVar0;
	int iVar4;
	int iVar5[3];
...
int func_170(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1BFB4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_172()//Position - 0x1C047
{
	if (bLocal_129)
	{
		if (iLocal_128 == 1)
...
void func_173(int iParam0)//Position - 0x1C062
{
	iLocal_96 = iParam0;
}

void func_174(int iParam0, bool bParam1, bool bParam2)//Position - 0x1C06E
{
	int iVar0;
	bool bVar1;
...
bool func_177(int iParam0, int iParam1)//Position - 0x1C1BA
{
	bool bVar0;
...
bool func_178(int iParam0)//Position - 0x1C207
{
	return func_179(iParam0, Global_41396);
}

int func_179(int iParam0, int iParam1)//Position - 0x1C218
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_180(var uParam0, int iParam1)//Position - 0x1C3F9
{
	return (uParam0 && iParam1) != 0;
}

void func_181()//Position - 0x1C408
{
	int iVar0;
	int iVar1;
...
int func_183(int iParam0)//Position - 0x1C857
{
	if (func_133(iParam0))
	{
...
int func_184(vector3 vParam0)//Position - 0x1C8A5
{
	return func_185(func_147(vParam0));
}

int func_185(var uParam0)//Position - 0x1C8B9
{
	int iVar0;
...
void func_186(var uParam0, int iParam1)//Position - 0x1C931
{
	func_187(uParam0, iParam1);
}

void func_187(var uParam0, var uParam1)//Position - 0x1C941
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

void func_188(bool bParam0)//Position - 0x1C956
{
	if (bParam0)
	{
		if (iLocal_106 != 263)
...
void func_189()//Position - 0x1C99F
{
...
void func_190()//Position - 0x1C9DC
{
	func_4(128);
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
