...
void func_16(bool bParam0, bool bParam1)//Position - 0x6F7
{
	if (bParam0)
	{
		if (func_19(0))
...
bool func_17()//Position - 0x76B
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

bool func_18()//Position - 0x77C
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

int func_19(int iParam0)//Position - 0x78E
{
	if (iParam0 == 1)
	{
...
void func_22(int iParam0)//Position - 0x82A
{
	if (iParam0 == 2)
	{
	}
...
int func_23()//Position - 0x845
{
	...
	if (iLocal_95)
	{
		...
		{
			case 1:
				if ((((((iLocal_1303 == 0 && ENTITY::DOES_ENTITY_EXIST(Local_1318)) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1318, 0)) && ENTITY::DOES_ENTITY_EXIST(vLocal_1306.x)) && !PED::IS_PED_INJURED(vLocal_1306.x)) && PED::IS_PED_IN_VEHICLE(vLocal_1306.x, Local_1318, 0)) && func_134(&(Local_1084[0 /*8*/])))
				{
				...
				else if ((ENTITY::DOES_ENTITY_EXIST(iLocal_1320) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1320, 0)) && VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_1320, Local_1318))
				{
					...
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_1318, 692.9143f, -1003.556f, 21.50839f, 692.6511f, -1021.604f, 26.20675f, 9.75f, 0, true, 0))
					{
						VEHICLE::BRING_VEHICLE_TO_HALT(iLocal_1320, 5f, -1, 0);
						iLocal_94 = 101;
					}
				}
				...
				else if (iLocal_1303 == 0)
				{
					...
					if (func_98(&iLocal_1101, vVar0, 692.9143f, -1003.556f, 21.50839f, 692.6511f, -1021.604f, 26.20675f, 9.75f, 1, Local_1318, "JHP2A_RTNVAN", "", "", PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_1318, 0), 0, 1, -1))
					{
						iLocal_94 = 101;
					}
			...
			case 101:
				if (ENTITY::DOES_ENTITY_EXIST(Local_1318) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_1318, 0))
				{
					iVar8 = Local_1318;
				}
			...
			case 102:
				if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
				{
					HUD::CLEAR_PRINTS();
					VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(Local_1318, 0);
					VEHICLE::SET_VEHICLE_DISABLE_TOWING(Local_1318, 1);
			...
			case 2:
					...
					while (iVar6 < Local_1322)
					{
						if (ENTITY::DOES_ENTITY_EXIST(Local_1322[iVar6 /*2*/]) && !ENTITY::IS_ENTITY_ATTACHED(Local_1322[iVar6 /*2*/]))
						{
							if (!WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_briefcase"), 0))
							{
								...
								if ((bVar9 && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, 0f, -3f, -0.5f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, 0f, -4.5f, 1f), 1.68f, 0, true, 1)) || (!bVar9 && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(Local_1322[iVar6 /*2*/], true), 0.75f, 0.75f, 4f, false, false, 1)))
								{
				...
				else
				{
					...
					if (bVar11 || ((iVar12 && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) && bLocal_1352))
					{
					...
					bLocal_1352 = PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1);
				}
				break;
...
bool func_26(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x12A0
{
...
int func_27(char* sParam0, int iParam1, bool bParam2)//Position - 0x12FF
{
	Global_20806 = 0;
...
bool func_30(int iParam0)//Position - 0x166C
{
	return func_31(iParam0, 20);
}

bool func_31(int iParam0, int iParam1)//Position - 0x167C
{
...
bool func_37(int iParam0)//Position - 0x18A1
{
	return Global_41396 == iParam0;
}

void func_38()//Position - 0x18AF
{
	int iVar0;
...
bool func_39(int iParam0, int iParam1)//Position - 0x1906
{
	switch (iParam0)
	{
		case 5:
...
void func_41(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x1998
{
...
void func_44(bool bParam0, bool bParam1)//Position - 0x1A36
{
	if (!bParam1)
	{
...
void func_45(bool bParam0)//Position - 0x1AF0
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
...
void func_46(int iParam0)//Position - 0x1B6C
{
	bool bVar0;
	int iVar1;
...
void func_47(char[4] cParam0)//Position - 0x1BDD
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 1, true, -1);
}

int func_48(int iParam0, vector3 vParam1, vector3 vParam4, bool bParam7, char* sParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x1BF3
{
...
int func_49(int iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10, bool bParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, char* sParam19, char* sParam20, char* sParam21, char* sParam22, char* sParam23, char* sParam24, bool bParam25, bool bParam26, char* sParam27, bool bParam28, int iParam29, bool bParam30, int iParam31, int iParam32, int iParam33, int iParam34, bool bParam35, float fParam36)//Position - 0x1C4E
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
int func_50(int iParam0, bool bParam1, bool bParam2)//Position - 0x25B6
{
	return func_51(iParam0, !bParam1, bParam2);
}

int func_51(int iParam0, bool bParam1, bool bParam2)//Position - 0x25C9
{
	int iVar0;
...
float func_52(bool bParam0, float fParam1, float fParam2)//Position - 0x266D
{
	if (bParam0)
	{
		return fParam1;
...
int func_53(int iParam0)//Position - 0x2684
{
...
int func_54(bool bParam0, bool bParam1, bool bParam2)//Position - 0x26E2
{
	int iVar0;
...
int func_56(int iParam0, int iParam1)//Position - 0x27FE
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
int func_58()//Position - 0x28B1
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

int func_59(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x28C1
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_60(int iParam0, int iParam1)//Position - 0x293C
{
	if (HUD::DOES_BLIP_EXIST(iParam0))
	{
...
int func_61(vector3 vParam0, bool bParam3)//Position - 0x2977
{
	int iVar0;
...
void func_62(int iParam0, char* sParam1, int iParam2)//Position - 0x29A3
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_63(iParam2), 1);
}

int func_63(int iParam0)//Position - 0x29BA
{
	int iVar0;
...
void func_64(int iParam0, char* sParam1, bool bParam2)//Position - 0x2BAF
{
	if (!bParam2)
	{
...
int func_65(int iParam0)//Position - 0x2BE6
{
...
int func_66(int iParam0, int iParam1)//Position - 0x2C0A
{
...
int func_68(var uParam0)//Position - 0x2C79
{
	int iVar0;
	int iVar1;
...
int func_69(var uParam0, int iParam1)//Position - 0x2C9C
{
	int iVar0;
...
int func_70(int iParam0, var uParam1, int iParam2)//Position - 0x2CCD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_71(char* sParam0)//Position - 0x2D61
{
...
int func_72(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, char* sParam7, float fParam8, bool bParam9, int iParam10, bool bParam11, int iParam12, var uParam13, var uParam14, var uParam15, int iParam16, bool bParam17)//Position - 0x2D79
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_73(int iParam0, var uParam1)//Position - 0x3DED
{
	switch (iParam0)
	{
		case 0:
...
void func_74(var uParam0, char* sParam1, char* sParam2, bool bParam3)//Position - 0x3E35
{
	if (!bParam3)
	{
		if (!MISC::IS_STRING_NULL(sParam1))
...
void func_75(char* sParam0, char* sParam1, int iParam2, int iParam3)//Position - 0x3E6E
{
	iParam3 = iParam3;
...
int func_76(int iParam0, var uParam1)//Position - 0x3E8D
{
	switch (iParam0)
	{
		case 0:
...
int func_77(int iParam0, float fParam1)//Position - 0x3ED6
{
	int iVar0;
...
int func_78(int iParam0, int iParam1)//Position - 0x3F0D
{
	int iVar0;
...
int func_79(int iParam0, int iParam1)//Position - 0x3F74
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
void func_80(int iParam0, var uParam1)//Position - 0x3FA9
{
	switch (iParam0)
	{
		case 0:
...
void func_81(int iParam0, var uParam1)//Position - 0x3FF1
{
	switch (iParam0)
	{
		case 0:
...
int func_82(int iParam0, var uParam1)//Position - 0x4041
{
	switch (iParam0)
	{
		case 0:
...
int func_83(int iParam0)//Position - 0x408A
{
	int iVar0;
	int iVar1;
...
int func_84(int iParam0, var uParam1)//Position - 0x4117
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_85(var uParam0)//Position - 0x4277
{
	int iVar0;
...
int func_86(var uParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x42A6
{
	int iVar0;
...
int func_87(int iParam0)//Position - 0x4384
{
	float fVar0;
...
int func_88(int iParam0, int iParam1)//Position - 0x43BC
{
	int iVar0;
...
void func_90(var uParam0)//Position - 0x4459
{
	int iVar0;
...
void func_91(var uParam0)//Position - 0x44FC
{
	int iVar0;
...
Vector3 func_93()//Position - 0x459C
{
	vector3 vVar0;
...
int func_94(int iParam0)//Position - 0x45A8
{
	vector3 vVar0;
	...
	vVar0 = { MISC::_0x21C235BC64831E5A(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, vLocal_87), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, vLocal_90), 0) };
...
void func_95(bool bParam0, int iParam1)//Position - 0x461E
{
	int iVar0;
...
int func_96(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x46B8
{
...
void func_97(int iParam0)//Position - 0x4847
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
bool func_98(int iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, float fParam10, bool bParam11, int iParam12, char* sParam13, char* sParam14, char* sParam15, bool bParam16, int iParam17, bool bParam18, int iParam19)//Position - 0x4873
{
...
Vector3 func_99()//Position - 0x48C8
{
	return 0f, 0f, 2f;
}

int func_100(int iParam0)//Position - 0x48D3
{
	return func_51(iParam0, 1, 0);
}

int func_101(int iParam0, vector3 vParam1, vector3 vParam4, bool bParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11, bool bParam12, int iParam13, bool bParam14, int iParam15)//Position - 0x48E3
{
...
void func_102(int iParam0, bool bParam1)//Position - 0x4932
{
	int iVar0;
...
void func_103(int iParam0, bool bParam1, bool bParam2)//Position - 0x497C
{
	int iVar0;
...
void func_104(int iParam0, var uParam1)//Position - 0x4B2D
{
	switch (iParam0)
	{
		case 0:
...
void func_105(var uParam0)//Position - 0x4B75
{
...
void func_106(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x4B90
{
	func_107(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_107(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x4BAD
{
	func_108(uParam0, iParam1, vParam2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

void func_108(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x4BCB
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
	{
		func_11(uParam0, 0, 0);
...
void func_109(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x4C03
{
	int iVar0;
	int iVar1;
...
void func_110(var uParam0)//Position - 0x4F6C
{
...
int func_111(var uParam0)//Position - 0x4FD0
{
	int iVar0;
...
int func_112(bool bParam0)//Position - 0x4FFB
{
	switch (Global_41396)
	{
		case 0:
...
int func_113(char* sParam0)//Position - 0x50A5
{
	if (!func_114(1, 1, 0))
	{
...
int func_114(bool bParam0, bool bParam1, bool bParam2)//Position - 0x513D
{
	int iVar0;
	int iVar1;
	...
	if ((func_121() || func_120(Global_4456448.f_190930)) || func_119())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::IS_TURRET_SEAT(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_117(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_115(int iParam0)//Position - 0x5396
{
	if (iParam0 != func_32())
	{
...
int func_116(int iParam0, bool bParam1, bool bParam2)//Position - 0x53FC
{
	int iVar0;
...
int func_117(int iParam0, int iParam1)//Position - 0x5446
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
...
int func_118(int iParam0, int iParam1)//Position - 0x54A8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_119()//Position - 0x552D
{
	return Global_2448961.f_17;
}

bool func_120(int iParam0)//Position - 0x553B
{
	return iParam0 == 51;
}

var func_121()//Position - 0x5548
{
	return Global_2448961.f_16;
}

bool func_122()//Position - 0x5556
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

void func_123(var uParam0, int iParam1, vector3 vParam2, int iParam5)//Position - 0x556B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_124()//Position - 0x5677
{
	return func_125(PLAYER::PLAYER_ID());
}

int func_125(int iParam0)//Position - 0x5687
{
...
bool func_126(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x56A6
{
	if (bParam6)
	{
...
int func_127(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x56ED
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_128(bool bParam0, bool bParam1, bool bParam2)//Position - 0x5A59
{
...
int func_129(bool bParam0, bool bParam1, bool bParam2)//Position - 0x5AAB
{
	if (!func_114(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_130(bool bParam0, bool bParam1, bool bParam2)//Position - 0x5AF4
{
	if (!func_114(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_131(bool bParam0, bool bParam1, bool bParam2)//Position - 0x5B53
{
	if (!func_114(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_132(int iParam0)//Position - 0x5BA9
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (ENTITY::IS_ENTITY_A_VEHICLE(iParam0))
...
void func_133()//Position - 0x5C04
{
	MISC::SET_BIT(&Global_7357, 4);
}

int func_134(var uParam0)//Position - 0x5C14
{
...
int func_135(var uParam0)//Position - 0x5C39
{
	if (*uParam0 == 4)
	{
		return 1;
...
int func_136(var uParam0)//Position - 0x5C50
{
...
void func_137()//Position - 0x5C7E
{
	int iVar0;
	
	if (iLocal_1303 == 0 || iLocal_1303 == 1)
	{
		if (((ENTITY::IS_ENTITY_DEAD(Local_1318, 0) || (ENTITY::DOES_ENTITY_EXIST(Local_1322[0 /*2*/]) && !ENTITY::IS_ENTITY_ATTACHED(Local_1322[0 /*2*/]))) || (ENTITY::DOES_ENTITY_EXIST(Local_1322[1 /*2*/]) && !ENTITY::IS_ENTITY_ATTACHED(Local_1322[1 /*2*/]))) || (ENTITY::DOES_ENTITY_EXIST(Local_1322[2 /*2*/]) && !ENTITY::IS_ENTITY_ATTACHED(Local_1322[2 /*2*/])))
		{
			iLocal_1303 = 2;
		}
	}
	if (iLocal_1303 == 2)
	{
		if ((((!ENTITY::DOES_ENTITY_EXIST(Local_1318) || !VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1318, 0)) || (ENTITY::DOES_ENTITY_EXIST(Local_1322[0 /*2*/]) && !func_94(Local_1322[0 /*2*/]))) || (ENTITY::DOES_ENTITY_EXIST(Local_1322[1 /*2*/]) && !func_94(Local_1322[1 /*2*/]))) || (ENTITY::DOES_ENTITY_EXIST(Local_1322[2 /*2*/]) && !func_94(Local_1322[2 /*2*/])))
		{
			iLocal_1303 = 3;
		}
	}
...
void func_138(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x5E26
{
	vector3 vVar0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102125.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102125.f_4, 0))
		{
			if (func_190(24) != Global_102125.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_187(ENTITY::GET_ENTITY_COORDS(Global_102125.f_4, true), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
				}
				func_139(Global_102125.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_139(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)//Position - 0x5EA1
{
	struct<60> Var0;
...
void func_140(int iParam0, int iParam1, int iParam2)//Position - 0x5FCA
{
	int iVar0;
...
void func_141(int iParam0, int iParam1)//Position - 0x60E7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_142(int iParam0)//Position - 0x62E9
{
...
int func_143(int iParam0)//Position - 0x63C6
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_144(int iParam0, bool bParam1)//Position - 0x6577
{
	int iVar0;
	struct<2> Var1;
...
int func_145(int iParam0)//Position - 0x66F7
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_147(int iParam0)//Position - 0x67DA
{
	int iVar0;
	int iVar1;
...
int func_148()//Position - 0x8CA7
{
	return 0;
}

int func_149()//Position - 0x8CB0
{
	return 1;
}

int func_150()//Position - 0x8CB9
{
	return 1;
}

int func_151()//Position - 0x8CC2
{
...
int func_153(int iParam0)//Position - 0x8D96
{
	int iVar0;
	char* sVar1;
...
int func_154(int iParam0)//Position - 0x8DDC
{
	int iVar0;
...
int func_155(int iParam0)//Position - 0x8E17
{
	int iVar0;
...
int func_156(int iParam0)//Position - 0x8E93
{
	int iVar0;
...
int func_157(int iParam0, int iParam1, bool bParam2)//Position - 0x8F7B
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_158(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x8FEC
{
...
void func_160(var uParam0, int iParam1)//Position - 0x910A
{
	if (iParam1 <= 0)
	{
		return;
...
void func_161(var uParam0, int iParam1)//Position - 0x9190
{
...
void func_162(var uParam0, int iParam1)//Position - 0x91C3
{
	int iVar0;
	int iVar1;
...
int func_163(int iParam0, int iParam1)//Position - 0x9214
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_164(int iParam0)//Position - 0x92B6
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_165(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_165(bool bParam0, int iParam1, int iParam2)//Position - 0x92DB
{
	if (bParam0)
	{
		return iParam1;
...
int func_166(var uParam0)//Position - 0x92F2
{
	return uParam0 & 15;
}

void func_167(var uParam0, int iParam1)//Position - 0x92FF
{
...
void func_168(var uParam0, int iParam1)//Position - 0x9339
{
...
void func_169(var uParam0, int iParam1)//Position - 0x9374
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_170(var uParam0, int iParam1)//Position - 0x93B0
{
	int iVar0;
	int iVar1;
...
int func_171(int iParam0, int iParam1)//Position - 0xAAA7
{
	struct<82> Var0;
...
void func_172(int iParam0, var uParam1, int iParam2)//Position - 0xAAE9
{
	int iVar0;
...
bool func_173(int iParam0)//Position - 0xAD45
{
	return iParam0 < 3;
}

void func_174(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0xAD51
{
	if (func_170(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
...
void func_175(int iParam0, bool bParam1)//Position - 0xAE50
{
	if (iParam0 == -1)
	{
		return;
...
void func_176(int iParam0, int iParam1, bool bParam2)//Position - 0xAEAD
{
	if (iParam0 == -1)
	{
		return;
...
bool func_177(int iParam0, int iParam1)//Position - 0xAEE8
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_178(var uParam0, var uParam1)//Position - 0xAF0B
{
...
void func_179(int iParam0)//Position - 0xAFD7
{
	if (iParam0 == -1)
	{
		return;
...
int func_180(int iParam0)//Position - 0xB051
{
	int iVar0;
...
void func_181(int iParam0, var uParam1)//Position - 0xB0B4
{
	int iVar0;
...
int func_182(int iParam0)//Position - 0xB35F
{
	switch (iParam0)
	{
		case 1:
...
int func_183(int iParam0, var uParam1, var uParam2)//Position - 0xB40F
{
	int iVar0;
	int iVar1;
...
int func_184(int iParam0)//Position - 0xB602
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_185(var uParam0)//Position - 0xB622
{
	int iVar0;
...
void func_186(int iParam0)//Position - 0xB6D2
{
...
int func_187(vector3 vParam0, int iParam3, var uParam4, var uParam5)//Position - 0xB6F9
{
	int iVar0;
...
int func_188(vector3 vParam0, int iParam3, int iParam4)//Position - 0xB80F
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_189(int iParam0)//Position - 0xB89E
{
	return MISC::IS_BIT_SET(Global_111560.f_7224[iParam0], 0);
}

int func_190(int iParam0)//Position - 0xB8B6
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_191()//Position - 0xB8D2
{
	func_192();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_192()//Position - 0xB8EB
{
	int iVar0;
...
int func_193(int iParam0)//Position - 0xB9E8
{
	int iVar0;
	int iVar1;
...
int func_194(int iParam0)//Position - 0xBA25
{
	if (func_173(iParam0))
	{
...
var func_195(int iParam0)//Position - 0xBA4A
{
	return Global_1798[iParam0 /*29*/];
}

void func_196(char[4] cParam0, int iParam1)//Position - 0xBA59
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

void func_197(char* sParam0, int iParam1, int iParam2)//Position - 0xBA70
{
	iParam2 = iParam2;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
int func_198(int iParam0, bool bParam1, bool bParam2)//Position - 0xBA89
{
	return func_51(iParam0, !bParam1, bParam2);
}

int func_199(int iParam0)//Position - 0xBA9C
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_200(var uParam0)//Position - 0xBB01
{
	int iVar0;
...
void func_201()//Position - 0xBB71
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_1318))
	{
		if ((ENTITY::IS_ENTITY_IN_WATER(Local_1318) && !VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1318, 0)) && !WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_briefcase"), 0))
		{
			func_307(4);
		}
	}
...
float func_202(int iParam0, int iParam1, bool bParam2)//Position - 0xBDDA
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_203(int iParam0, int iParam1)//Position - 0xBE38
{
	Global_61482 = iParam0;
	Global_61483 = iParam1;
}

void func_204(int iParam0, int iParam1)//Position - 0xBE4A
{
	int iVar0;
...
void func_205()//Position - 0xBEB5
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_1318))
	{
		if (((!func_199(Local_1318) && ENTITY::IS_ENTITY_DEAD(Local_1318, 0)) && iLocal_1346) && func_202(Local_1318, PLAYER::PLAYER_PED_ID(), 1) > 200f)
		{
			ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&Local_1318);
		}
	}
...
int func_206(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xBF35
{
	if (iParam3 == 0)
	{
...
void func_207()//Position - 0xC10D
{
	...
	if (bLocal_96 == 1)
	{
		...
		else
		{
			...
			if (!func_281())
			{
				func_280(iLocal_93, &vVar0, &fVar3);
				...
				func_278(&uLocal_99, vVar0, 50f, 0);
			}
			func_277(&uLocal_99);
			switch (iLocal_93)
			{
			...
			switch (iLocal_93)
			{
				case 0:
					...
					VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_1316, true, true, 0);
					if (func_281())
					{
...
void func_208(int iParam0, int iParam1, int iParam2)//Position - 0xC3FA
{
...
void func_209(int iParam0)//Position - 0xC4BE
{
	if (iParam0 == 1)
	{
...
int func_211(int iParam0, vector3 vParam1, float fParam4, bool bParam5)//Position - 0xC50B
{
	struct<67> Var0;
...
int func_212(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)//Position - 0xC616
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
void func_213(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0xD45A
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_214(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0xE06E
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_215(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0xE0E1
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_216(int iParam0)//Position - 0xF5D3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_217(int iParam0, bool bParam1, var uParam2)//Position - 0xF683
{
	int iVar0;
	bool bVar1;
...
int func_218(int iParam0)//Position - 0xF7F1
{
	if (iParam0 != func_32())
	{
		if (func_116(iParam0, 1, 1))
...
int func_219(int iParam0)//Position - 0xF838
{
	switch (iParam0)
	{
		case 0:
...
int func_220(int iParam0)//Position - 0xFC00
{
...
int func_221(int iParam0)//Position - 0xFC42
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case -32236122:
...
int func_222(int iParam0)//Position - 0xFCE5
{
	if (iParam0 != func_32())
	{
		if (func_116(iParam0, 1, 1))
...
int func_223(int iParam0)//Position - 0xFD2C
{
	if (iParam0 != func_32())
	{
		if (func_116(iParam0, 1, 1))
...
int func_224(int iParam0)//Position - 0xFD72
{
	switch (iParam0)
	{
		case -2118308144:
...
int func_225(int iParam0)//Position - 0xFDA7
{
...
int func_226(int iParam0)//Position - 0xFDD6
{
...
int func_227(int iParam0)//Position - 0xFE93
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		return 0;
...
int func_228(int iParam0)//Position - 0xFEC9
{
	switch (iParam0)
	{
		case 562680400:
...
int func_229(int iParam0, bool bParam1)//Position - 0xFF22
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_230(int iParam0)//Position - 0xFF7D
{
	int iVar0;
...
int func_231(int iParam0, int iParam1)//Position - 0xFFB7
{
	if (iParam1 == 0)
	{
...
bool func_232()//Position - 0x10359
{
	return DLC::IS_DLC_PRESENT(1927191088);
}

bool func_233()//Position - 0x1036A
{
	return DLC::IS_DLC_PRESENT(2067165443);
}

bool func_234()//Position - 0x1037B
{
	return DLC::IS_DLC_PRESENT(-957277403);
}

bool func_235()//Position - 0x1038C
{
	return DLC::IS_DLC_PRESENT(210122941);
}

bool func_236()//Position - 0x1039D
{
	return DLC::IS_DLC_PRESENT(-1894522408);
}

bool func_237()//Position - 0x103AE
{
	return DLC::IS_DLC_PRESENT(1630677557);
}

int func_238(int iParam0, int iParam1)//Position - 0x103BF
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_239(int iParam0)//Position - 0x10735
{
	if (iParam0 != func_32())
	{
		if (func_116(iParam0, 1, 1))
...
int func_240(int iParam0)//Position - 0x10794
{
	if (iParam0 != func_32())
	{
		if (func_116(iParam0, 1, 1))
...
int func_241(int iParam0)//Position - 0x107F4
{
	if (iParam0 != func_32())
	{
		if (func_116(iParam0, 1, 1))
...
int func_242(int iParam0, bool bParam1, var uParam2)//Position - 0x1083B
{
	bool bVar0;
...
int func_243(int iParam0)//Position - 0x10C7A
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_244(int iParam0, int iParam1)//Position - 0x10CA3
{
	int iVar0;
...
void func_245(int iParam0)//Position - 0x10D25
{
	if (!func_246(*iParam0))
	{
...
bool func_246(int iParam0)//Position - 0x10D50
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_247(int iParam0, var uParam1, var uParam2)//Position - 0x10D5F
{
	int iVar0;
	int iVar1;
...
int func_248(int iParam0)//Position - 0x10F22
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_249(var uParam0)//Position - 0x10FFE
{
...
int func_250(int iParam0, int iParam1)//Position - 0x1103E
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_251(var uParam0, int iParam1)//Position - 0x11123
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_252(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x11164
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_253(int iParam0, int iParam1)//Position - 0x11726
{
	int iVar0;
	int iVar1;
...
bool func_254()//Position - 0x1179E
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_255(int iParam0)//Position - 0x117AF
{
	int iVar0;
...
int func_256(int iParam0)//Position - 0x117FA
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
int func_257(int iParam0)//Position - 0x11881
{
...
int func_258(int iParam0)//Position - 0x118B0
{
...
int func_259(int iParam0)//Position - 0x118CD
{
...
int func_260(int iParam0, int iParam1)//Position - 0x118F0
{
...
int func_261(int iParam0)//Position - 0x1192B
{
	if (func_260(iParam0, 0))
	{
...
int func_262(int iParam0, int iParam1)//Position - 0x1194E
{
	int iVar0;
...
int func_263(int iParam0, var uParam1)//Position - 0x1199B
{
	struct<82> Var0;
...
bool func_264()//Position - 0x11AF5
{
	return func_265(&(Global_102125.f_2890));
}

int func_265(var uParam0)//Position - 0x11B08
{
...
bool func_266()//Position - 0x11B67
{
	return func_265(&(Global_105109.f_2890));
}

int func_267(bool bParam0)//Position - 0x11B7A
{
	bool bVar0;
	vector3 vVar1;
	...
	if ((STREAMING::HAS_MODEL_LOADED(joaat("s_m_m_armoured_01")) && STREAMING::HAS_MODEL_LOADED(iLocal_85)) && STREAMING::HAS_MODEL_LOADED(iLocal_86))
	{
		if (bParam0)
		{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(vLocal_1306.x))
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_95196.f_9[0]))
				{
					...
					vLocal_1306.x = Global_95196.f_9[0];
				}
				else
				{
					bVar0 = false;
		...
		{
			func_276(&uLocal_99, iLocal_84);
			if (STREAMING::HAS_MODEL_LOADED(iLocal_84) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(&Global_95561))
			{
				if (MISC::ARE_STRINGS_EQUAL(&Global_95561, "jhp2a_main"))
				{
					...
					vLocal_1306.x = PED::CREATE_PED_INSIDE_VEHICLE(Local_1318, 26, iLocal_83, -1, 1, true);
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_1318, 1084227584);
					TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1306.x, Local_1318, &Global_95561, 786475, 23, 16, -1, 12f, 0, 1073741824);
				}
				else
				{
					...
					vLocal_1306.x = PED::CREATE_PED_INSIDE_VEHICLE(Local_1318, 26, iLocal_83, -1, 1, true);
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_1318, 1084227584);
					TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1306.x, Local_1318, &Global_95561, 786475, 29, 16, -1, 12f, 0, 1073741824);
				}
			}
		}
		if (ENTITY::DOES_ENTITY_EXIST(Local_1318))
		{
			func_273(Local_1318, 0);
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1318, 0))
			{
		...
		if (ENTITY::DOES_ENTITY_EXIST(vLocal_1306.x))
		{
			if (!PED::IS_PED_INJURED(vLocal_1306.x))
			{
				...
				func_272(&uLocal_1126, 3, vLocal_1306.x, "JHP2A_Driver", 0, 1);
...
void func_268(var uParam0, int iParam1)//Position - 0x11E71
{
	int iVar0;
...
void func_269(var uParam0)//Position - 0x11ED6
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_270()//Position - 0x11EF1
{
	vector3 vVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_1318))
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_1318, 0) && !ENTITY::DOES_ENTITY_EXIST(iLocal_1329))
		{
			...
			ENTITY::ATTACH_ENTITY_TO_ENTITY_PHYSICALLY(iLocal_1329, Local_1318, -1, -1, ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(Local_1318, ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(Local_1318, 5)) + Vector(0f, 0f, 0.02f), 0f, 0f, 0f, 0f, 0f, 0f, -1f, 1, 1, 0, 1, 2);
			ENTITY::SET_ENTITY_VISIBLE(iLocal_1329, false, 0);
		}
		if (!ENTITY::DOES_ENTITY_EXIST(Local_1322[0 /*2*/]))
		{
			if (ENTITY::IS_ENTITY_DEAD(Local_1318, 0))
			...
			else
			{
				...
				ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_1322[0 /*2*/], Local_1318, -1, -0.2f, -2.675f, 0.05f, -90f, 0f, -90f, 0, 0, 0, 0, 2, 1);
		...
		if (!ENTITY::DOES_ENTITY_EXIST(Local_1322[1 /*2*/]))
		{
			...
			else
			{
				...
				ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_1322[1 /*2*/], Local_1318, -1, 0f, -2.675f, 0.05f, -90f, 0f, -90f, 0, 0, 0, 0, 2, 1);
		...
		if (!ENTITY::DOES_ENTITY_EXIST(Local_1322[2 /*2*/]))
		{
			...
			else
			{
				...
				ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_1322[2 /*2*/], Local_1318, -1, 0.2f, -2.675f, 0.05f, -90f, 0f, -90f, 0, 0, 0, 0, 2, 1);
...
int func_271(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x121CC
{
	if (*uParam0 == -1)
	{
		return 0;
...
void func_272(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1224C
{
...
void func_273(int iParam0, int iParam1)//Position - 0x122E7
{
	Global_98669.f_22[iParam1] = iParam0;
}

int func_274(var uParam0)//Position - 0x122FB
{
	if (func_282(uParam0))
	{
		return 1;
...
int func_275(var uParam0, int iParam1)//Position - 0x12314
{
	int iVar0;
	int iVar1;
...
int func_276(var uParam0, int iParam1)//Position - 0x123DB
{
	int iVar0;
	int iVar1;
...
void func_277(var uParam0)//Position - 0x12484
{
	int iVar0;
...
int func_278(var uParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0x126DC
{
	if (func_279(vParam1) || fParam4 <= 0f)
	{
		return 0;
	}
	if (uParam0->f_868)
...
int func_279(vector3 vParam0)//Position - 0x12794
{
...
void func_280(int iParam0, var uParam1, var uParam2)//Position - 0x127BE
{
	switch (iParam0)
	{
		case 0:
...
bool func_281()//Position - 0x12815
{
	return MISC::IS_BIT_SET(Global_98669.f_20, 13);
}

int func_282(var uParam0)//Position - 0x12829
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_283(var uParam0)//Position - 0x131F9
{
...
void func_284()//Position - 0x13215
{
	if (bLocal_98 && (func_285() || CAM::IS_SCREEN_FADED_OUT()))
	{
		func_8(1);
		SCRIPT::TERMINATE_THIS_THREAD();
	}
...
void func_286()//Position - 0x1326B
{
	vector3 vVar0;
	var uVar3;
	...
	if (func_6(0) || func_210())
	{
		...
		if (func_210())
		{
			func_280(iLocal_97, &vVar0, &uVar3);
			func_292(vVar0, uVar3, 1, 0);
		}
		bLocal_96 = true;
	}
	else
	...
	func_288(88);
	func_272(&uLocal_1126, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
...
void func_287()//Position - 0x133DF
{
	Global_92877 = 1;
}

void func_288(int iParam0)//Position - 0x133EC
{
	Global_94554 = 0;
	switch (iParam0)
	{
...
void func_289(int iParam0)//Position - 0x1347A
{
	MISC::SET_BIT(&Global_94554, iParam0);
}

int func_290(var uParam0, char* sParam1, int iParam2)//Position - 0x1348C
{
...
void func_291(var uParam0)//Position - 0x13530
{
	func_282(uParam0);
}

void func_292(vector3 vParam0, var uParam3, int iParam4, int iParam5)//Position - 0x1353F
{
	if (func_210())
	{
		...
		else
		{
			switch (uParam0->f_1)
			{
				case 1:
					...
					if (((((iLocal_1335 >= 3 || ENTITY::IS_ENTITY_DEAD(iLocal_1329, 0)) || VEHICLE::IS_VEHICLE_DOOR_DAMAGED(Local_1318, 2)) || VEHICLE::IS_VEHICLE_DOOR_DAMAGED(Local_1318, 3)) || VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(Local_1318, 2) > 0f) || VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(Local_1318, 3) > 0f)
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_1329))
						{
							OBJECT::DELETE_OBJECT(&iLocal_1329);
						...
						{
							VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_1318, 2, 0, false);
						}
						if (!VEHICLE::IS_VEHICLE_DOOR_DAMAGED(Local_1318, 3))
						{
							VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_1318, 3, 0, false);
						}
						iLocal_1347 = 0;
						iLocal_1348 = 0;
				...
				case 3:
					if (func_295(Local_1318))
					{
						if (!VEHICLE::IS_VEHICLE_DOOR_DAMAGED(Local_1318, 2))
						{
							...
							{
								VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_1318, 2, 1, false);
						...
						if (!VEHICLE::IS_VEHICLE_DOOR_DAMAGED(Local_1318, 3))
						{
							...
							{
								VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_1318, 3, 1, false);
...
int func_295(int iParam0)//Position - 0x138F2
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_296(var uParam0, int iParam1, int iParam2)//Position - 0x13913
{
	if (iParam2 > 0)
	{
		*uParam0 = 2;
...
int func_297(var uParam0, int iParam1)//Position - 0x13939
{
	int iVar0;
	int iVar1;
...
void func_298(var uParam0)//Position - 0x13A03
{
	if (*uParam0 != 4)
	{
		*uParam0 = 4;
...
void func_299(int iParam0, bool bParam1)//Position - 0x13A28
{
	vector3 vVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		...
		if (bParam1)
		{
			vVar0 = { func_300(ENTITY::GET_ENTITY_COORDS(iParam0, true) - ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, MISC::GET_RANDOM_FLOAT_IN_RANGE(-0.15f, 0.15f), IntToFloat(-MISC::GET_RANDOM_INT_IN_RANGE(3, 6)), MISC::GET_RANDOM_FLOAT_IN_RANGE(-0.1f, 0.1f))) };
...
Vector3 func_300(vector3 vParam0)//Position - 0x13AE5
{
	float fVar0;
	float fVar1;
...
int func_301(var uParam0, int iParam1, char* sParam2)//Position - 0x13B24
{
	if (*uParam0 != -1)
	{
		return 0;
...
void func_302(var uParam0)//Position - 0x13B4B
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
	...
	if (!func_135(uParam0))
	{
		if (((!ENTITY::DOES_ENTITY_EXIST(vLocal_1306.x) || PED::IS_PED_INJURED(vLocal_1306.x)) || (ENTITY::DOES_ENTITY_EXIST(Local_1318) && func_202(Local_1318, vLocal_1306.x, 1) > 200f)) || (!PED::IS_PED_IN_ANY_VEHICLE(vLocal_1306.x, 0) && func_202(Local_1318, vLocal_1306.x, 1) > 200f))
		{
			if (ENTITY::DOES_ENTITY_EXIST(Local_1318) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1318, 0))
			{
				VEHICLE::SET_VEHICLE_DISABLE_TOWING(Local_1318, 0);
			}
			ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&vLocal_1306);
			func_298(uParam0);
		}
		...
		{
			if ((uParam0->f_1 != 5 && uParam0->f_1 != 3) && ((!ENTITY::DOES_ENTITY_EXIST(Local_1318) || !VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1318, 0)) || !PED::IS_PED_IN_VEHICLE(vLocal_1306.x, Local_1318, 0)))
			{
				iLocal_1337 = 0;
				iLocal_1338 = 0;
			...
			else if ((uParam0->f_1 == 1 || uParam0->f_1 == 2) || uParam0->f_1 == 4)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					...
					vVar1 = { func_300(ENTITY::GET_ENTITY_COORDS(iVar0, true) - ENTITY::GET_ENTITY_COORDS(Local_1318, true)) };
					vVar4 = { ENTITY::GET_ENTITY_VELOCITY(Local_1318) - ENTITY::GET_ENTITY_VELOCITY(iVar0) };
					fLocal_1333 = func_306(vVar4, vVar1);
				}
			}
			switch (uParam0->f_1)
			{
				case 1:
					if ((((((((((((((((((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_1318, PLAYER::PLAYER_PED_ID(), 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(vLocal_1306.x, PLAYER::PLAYER_PED_ID(), 1)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 124)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 125)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 126)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 29)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 118)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 123)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 22)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 24)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 47)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 62)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 62)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 138)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 88)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 89)) || PED::IS_PED_BEING_JACKED(vLocal_1306.x)) || FIRE::IS_ENTITY_ON_FIRE(Local_1318)) || iLocal_1331 > 0)
					{
						iLocal_1337 = 0;
						iLocal_1338 = 0;
						StringCopy(&cLocal_1339, "", 24);
					...
					else
					{
						if (ENTITY::DOES_ENTITY_EXIST(Local_1318) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1318, 0))
						{
							if ((ENTITY::IS_ENTITY_STATIC(PLAYER::PLAYER_PED_ID()) || fLocal_1333 > 0.5f) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, 0f, 2f, -0.5f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, 0f, 10f, 2f), 4.5f, 0, true, 0))
							{
						...
						if (func_305(Local_1318, -993.7236f, -2418.757f, 12.9447f, 1) < 20f)
						{
							func_275(&uLocal_99, "jhp2a_airport");
						}
						if (!func_304(vLocal_1306.x, -235832601, 1))
						{
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_1318, -990.6312f, -2413.214f, 12.69471f, -996.0194f, -2422.608f, 16.05846f, 8.75f, 0, true, 0))
							{
							...
							{
								TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1306.x, Local_1318, &Global_95561, 786475, -1, 24, -1, 12f, 0, 1073741824);
							}
						}
					}
					break;
				...
				case 2:
					...
					else if (!func_304(vLocal_1306.x, -235832601, 1))
					{
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_1318, -1096.139f, -2467.117f, 12.69561f, -1101.641f, -2476.775f, 15.6304f, 7.8125f, 0, true, 0))
						{
							iLocal_1337 = 0;
							iLocal_1338 = 0;
							StringCopy(&cLocal_1339, "", 24);
						...
						{
							TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1306.x, Local_1318, "jhp2a_airport", 786475, -1, 24, -1, 12f, 0, 1073741824);
						}
					}
					break;
				
				case 3:
					if (((((((((((((((((((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_1318, PLAYER::PLAYER_PED_ID(), 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(vLocal_1306.x, PLAYER::PLAYER_PED_ID(), 1)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 124)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 125)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 126)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 29)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 118)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 123)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 22)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 24)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 47)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 62)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 62)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 138)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 88)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 89)) || PED::IS_PED_BEING_JACKED(vLocal_1306.x)) || FIRE::IS_ENTITY_ON_FIRE(Local_1318)) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_1318, 1)) || iLocal_1331 > 0)
					{
						iLocal_1337 = 0;
						iLocal_1338 = 0;
						StringCopy(&cLocal_1339, "", 24);
					...
					{
						if (!func_304(vLocal_1306.x, 451360105, 1))
						{
					...
					else
					{
						...
						if (!func_304(vLocal_1306.x, 242628503, 1))
						{
				...
				case 4:
					...
					else if (!func_304(vLocal_1306.x, -1273030092, 1))
					{
						TASK::TASK_VEHICLE_MISSION_PED_TARGET(vLocal_1306.x, Local_1318, PLAYER::PLAYER_PED_ID(), 8, 90f, 786468, 400f, 10f, 0);
					}
					break;
						...
						case 2:
							if (func_42() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(vLocal_1306.x))
							{
								if (MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_1339))
								{
									...
									if ((((((iLocal_1332 || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 124)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 125)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 126)) || fVar8 < 49f) && (MISC::GET_GAME_TIMER() - iLocal_1338) > 5000) && fVar8 < 225f)
									{
...
bool func_303(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1487B
{
...
int func_304(int iParam0, int iParam1, bool bParam2)//Position - 0x148C9
{
	int iVar0;
...
float func_305(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x1490F
{
	vector3 vVar0;
...
float func_306(vector3 vParam0, vector3 vParam3)//Position - 0x14949
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

void func_307(int iParam0)//Position - 0x1496A
{
	struct<2> Var0;
	char[] cVar4[8];
...
void func_308(char* sParam0, char* sParam1)//Position - 0x14A10
{
	func_316(sParam0, sParam1);
	func_309(0);
}

void func_309(int iParam0)//Position - 0x14A25
{
	int iVar0;
...
int func_310(int iParam0)//Position - 0x14A6A
{
	int iVar0;
	int iVar1;
...
void func_311(var uParam0, int iParam1)//Position - 0x14B81
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_313(Global_111560.f_18528[iVar0], &vVar2, &fVar5))
			{
...
void func_312(var uParam0)//Position - 0x14D4A
{
	*uParam0 = -15;
}

int func_313(int iParam0, var uParam1, float fParam2)//Position - 0x14D58
{
	switch (iParam0)
	{
		case 11:
...
void func_314(int iParam0, bool bParam1)//Position - 0x156C7
{
	if (bParam1)
	{
...
void func_315()//Position - 0x15705
{
	Global_98704 = 1;
...
void func_316(char* sParam0, char* sParam1)//Position - 0x157F2
{
...
void func_317(char* sParam0)//Position - 0x15830
{
	func_318(sParam0);
	func_309(0);
}

void func_318(char* sParam0)//Position - 0x15843
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (HUD::GET_LENGTH_OF_LITERAL_STRING(sParam0) <= 16)
...
void func_319()//Position - 0x15882
{
	int iVar0;
