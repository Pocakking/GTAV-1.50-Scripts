				...
				if ((((((((!Global_1573977 && !func_23(3)) && !func_20(PLAYER::PLAYER_ID(), 0)) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) && !func_18(PLAYER::PLAYER_ID())) && !func_16(func_17(PLAYER::PLAYER_ID()))) && !func_14(PLAYER::PLAYER_ID(), 146)) && !func_10(PLAYER::PLAYER_ID()))
				{
					if (func_9(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 4, 100, 0))
					{
						if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
						{
							...
							{
								if (!func_8(&(Local_149.f_1)))
								{
									func_5(&(Local_149.f_1));
								}
								else if (func_2(&(Local_149.f_1)) > 20f)
								{
						...
						else if (func_8(&(Local_149.f_1)))
						{
							func_1(&(Local_149.f_1));
						}
					}
				}
			}
...
void func_1(var uParam0)//Position - 0x249
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
float func_2(var uParam0)//Position - 0x25F
{
	if (func_8(uParam0))
	{
		if (func_4(uParam0))
...
float func_3(bool bParam0)//Position - 0x29E
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_4(var uParam0)//Position - 0x2F6
{
	return MISC::IS_BIT_SET(*uParam0, 2);
}

void func_5(int iParam0)//Position - 0x306
{
	if (!func_8(iParam0))
	{
		func_6(iParam0);
...
void func_6(int iParam0)//Position - 0x31E
{
	func_7(iParam0, 0f);
}

void func_7(int iParam0, float fParam1)//Position - 0x32D
{
...
bool func_8(var uParam0)//Position - 0x35B
{
	return MISC::IS_BIT_SET(*uParam0, 1);
}

int func_9(vector3 vParam0, int iParam3, int iParam4, bool bParam5)//Position - 0x36B
{
	vector3 vVar0[15];
	vector3 vVar46[15];
	float fVar92[15];
...
bool func_10(int iParam0)//Position - 0x10BF
{
	return func_11(func_12(iParam0));
}

int func_11(int iParam0)//Position - 0x10D1
{
	switch (iParam0)
	{
		case 167:
...
int func_12(int iParam0)//Position - 0x10F7
{
...
int func_13(int iParam0, int iParam1)//Position - 0x111A
{
...
int func_14(int iParam0, int iParam1)//Position - 0x1155
{
...
int func_15(int iParam0)//Position - 0x1175
{
	int iVar0;
...
int func_16(int iParam0)//Position - 0x119B
{
	switch (iParam0)
	{
		case 136:
...
int func_17(int iParam0)//Position - 0x11D9
{
	int iVar0;
...
bool func_19()//Position - 0x123A
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

bool func_20(int iParam0, int iParam1)//Position - 0x124B
{
	bool bVar0;
...
int func_21(int iParam0, bool bParam1)//Position - 0x1296
{
	int iVar0;
	int iVar1;
...
int func_22()//Position - 0x12D7
{
	return Global_1312745;
}

bool func_23(int iParam0)//Position - 0x12E3
{
	return MISC::IS_BIT_SET(Global_1573976, iParam0);
}

int func_24(int iParam0, int iParam1)//Position - 0x12F5
{
	int iVar0;
...
int func_25(int iParam0)//Position - 0x132E
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_28()//Position - 0x13B3
{
	switch (Local_149)
	{
		case 0:
			...
			{
				Local_149.f_4 = PED::ADD_SCENARIO_BLOCKING_AREA(1413.703f, 2341.517f, -232.3945f, 2016.209f, 2998.893f, 161.0299f, 0, 1, 1, 1);
			}
		...
		case 2:
			if (Global_1573977 || func_23(3))
			{
				PED::REMOVE_SCENARIO_BLOCKING_AREA(Local_149.f_4, 0);
			}
			return 1;
			break;
	}
...
void func_29(var uParam0, int iParam1)//Position - 0x1471
{
	func_30(uParam0, iParam1);
}

void func_30(var uParam0, var uParam1)//Position - 0x1481
{
	*uParam0 = (*uParam0 || uParam1);
}

int func_31()//Position - 0x1492
{
	switch (iLocal_114)
	{
		case 0:
...
int func_36()//Position - 0x15F0
{
	return Global_30736;
}

bool func_37()//Position - 0x15FB
{
	return Global_2448961.f_598;
}

int func_38(int iParam0)//Position - 0x160A
{
...
bool func_39()//Position - 0x1621
{
	return Global_2458999;
}

bool func_40()//Position - 0x162D
{
	return Global_2448961.f_593;
}

void func_41(var uParam0)//Position - 0x163C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_42(int iParam0)//Position - 0x16AF
{
	vector3 vVar0;
	int iVar3;
	int iVar4;
...
int func_43(int iParam0, var uParam1)//Position - 0x1730
{
...
int func_44(int iParam0, bool bParam1, bool bParam2)//Position - 0x178F
{
	int iVar0;
...
void func_45()//Position - 0x17D9
{
	SYSTEM::WAIT(0);
}

void func_46()//Position - 0x17E6
{
	func_47();
}
...
void func_48(struct<21> Param0)//Position - 0x17FE
{
...
int func_50(int iParam0, int iParam1, bool bParam2)//Position - 0x18A2
{
	int iVar0;
...
bool func_51()//Position - 0x19B7
{
	return Global_1312850;
}

void func_52(int iParam0, struct<17> Param1, var uParam18, var uParam19, var uParam20, var uParam21)//Position - 0x19C3
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_47();
...
int func_53(int iParam0)//Position - 0x19E2
{
	switch (iParam0)
	{
		case 3:
