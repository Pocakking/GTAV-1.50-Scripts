...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_295[0] = PLAYER::PLAYER_PED_ID();
	bLocal_310 = true;
	...
	func_467(1);
	iLocal_325 = func_464(func_500(iLocal_295[0]), 1);
	fVar1776 = (SYSTEM::TO_FLOAT(iLocal_325) / 100f);
	...
	while (true)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_295[0]))
		{
			PED::SET_PED_RESET_FLAG(iLocal_295[0], 239, 1);
			PED::SET_PED_RESET_FLAG(iLocal_295[0], 124, 1);
			func_462();
			...
			{
				if (uVar1803[iVar1775] != iLocal_295[1])
				{
			...
			switch (Var0)
			{
				case 0:
					...
					if (ENTITY::DOES_ENTITY_EXIST(Var0.f_243))
					{
						...
						iLocal_129 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, vLocal_366, vLocal_369, 65f, 0, 2);
				...
				case 1:
					...
					{
						MISC::CLEAR_AREA(ScriptParam_0, 0.5f, 1, 0, 0, false);
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
						{
							TASK::CLEAR_SEQUENCE_TASK(&uLocal_332);
							TASK::OPEN_SEQUENCE_TASK(&uLocal_332);
							TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
							TASK::CLOSE_SEQUENCE_TASK(uLocal_332);
							TASK::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uLocal_332);
						}
						vLocal_85 = { vLocal_85 };
						Var0 = 2;
					}
				...
				case 3:
					if (func_449(&Var477, &Var508))
					{
						...
						iLocal_388 = func_500(iLocal_295[0]);
						switch (iLocal_388)
						{
							case 0:
						...
						iLocal_59 = OBJECT::CREATE_OBJECT(iLocal_60, vVar471, 1, true, 0);
						Var0.f_446[0] = 0;
						Var0.f_446[1] = 0;
						Var0 = 4;
					}
				...
				case 4:
					...
					{
						iVar1824 = OBJECT::CREATE_OBJECT(joaat("prop_dart_1"), vVar471, 1, true, 0);
						func_439(Var0.f_243.f_4, Var465, &uVar1803, &ScriptParam_0);
						func_438(&Var477, sLocal_390, sLocal_391);
						TASK::CLEAR_PED_TASKS(iLocal_295[1]);
						iLocal_333 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, 0f, 0f, 0f, 0f, 0f, 0f, 65f, 0, 2);
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
						{
							PED::FORCE_PED_MOTION_STATE(PLAYER::PLAYER_PED_ID(), -1871534317, 0, 0, 0);
						}
						func_437(&(Var0.f_257), 0, PLAYER::PLAYER_PED_ID(), sLocal_390, 0, 1);
						if (ENTITY::IS_ENTITY_DEAD(func_498(), 0))
						{
							if (iLocal_334 == 2)
							{
								func_437(&(Var0.f_257), 3, iLocal_295[1], "DartsBillLost1", 0, 1);
							}
							else
							{
								func_437(&(Var0.f_257), 3, iLocal_295[1], "DartsMelHick1", 0, 1);
							}
							iVar1774 = -1;
						}
						else
				...
				case 5:
					if ((((!PED::IS_PED_INJURED(iLocal_295[1]) && PED::IS_PED_ON_FOOT(iLocal_295[0])) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_295[0], 1)) && PED::IS_PED_ON_FOOT(iLocal_295[1])) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_295[1], 1))
					{
						bLocal_305 = func_432(&uLocal_321);
						if ((func_431() && MISC::GET_GAME_TIMER() >= iLocal_323 + 1000) && iVar1774 != 9)
						{
						...
						{
							case -1:
								if (!PED::IS_PED_INJURED(iLocal_295[1]))
								{
									iLocal_327 = PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(ScriptParam_0.f_4, 0.337842f, -0.243051f, -0.329731f), 0f, 0f, (ENTITY::GET_ENTITY_HEADING(ScriptParam_0.f_4) - 3.783146f), 2);
									iLocal_333 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 0);
									CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_333, iLocal_327, "darts_ig_intro_cam", "mini@dartsintro");
									CAM::SET_CAM_ACTIVE(iLocal_333, true);
									CAM::RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
									TASK::TASK_CLEAR_LOOK_AT(iLocal_295[0]);
									TASK::TASK_CLEAR_LOOK_AT(iLocal_295[1]);
									TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_295[0]);
									TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_295[1]);
									TASK::TASK_SYNCHRONIZED_SCENE(iLocal_295[1], iLocal_327, "mini@dartsintro", "darts_ig_intro_guy1", 1000f, -1000f, 0, 0, 1148846080, 0);
									TASK::TASK_SYNCHRONIZED_SCENE(iLocal_295[0], iLocal_327, "mini@dartsintro", "darts_ig_intro_guy2", 1000f, -1000f, 0, 0, 1148846080, 0);
									TASK::TASK_PLAY_ANIM(iLocal_295[1], "mini@dartsintro", "darts_ig_intro_guy1_face", 8f, -8f, -1, 32, 0, 0, 0, 0);
									TASK::TASK_PLAY_ANIM(iLocal_295[0], "mini@dartsintro", sVar1793, 8f, -8f, -1, 32, 0, 0, 0, 0);
									ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iVar1824, iLocal_327, "darts_ig_intro_dart", "mini@dartsintro", 1000f, 8f, 0, 1148846080);
									func_424(&iVar1800);
									iVar1774++;
								}
								break;
							...
							case 0:
								if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_327))
								{
									if (!bVar1770)
									{
										...
										{
											func_422(iLocal_295[0], "DARTS_REQUEST_GAME", 6);
											bVar1770 = true;
											func_421(&iVar1800);
										}
									}
									else if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(iLocal_295[0]))
									{
										if (!bVar1771)
										{
									...
									switch (iLocal_31)
									{
										...
										case 1:
											if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_327) > 0.25f)
											{
												func_424(&iVar1800);
										...
										case 2:
											if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_327) > 0.55f)
											{
										...
										case 3:
											if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_327) > 0.85f)
											{
												func_418("DARTS_HOW_3A", -1);
												iLocal_31++;
											}
									...
									if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_327) > 0.95f)
									{
										iLocal_317 = 1;
										iVar1774++;
									}
							...
							case 1:
								if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_327) > 0.99f)
								{
									if (!PED::IS_PED_INJURED(iLocal_295[1]))
									{
										...
										TASK::CLEAR_PED_TASKS(iLocal_295[0]);
										TASK::CLEAR_PED_TASKS(iLocal_295[1]);
										ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iVar1824, -1000f, 0);
							...
							case 3:
								if (!PED::IS_PED_INJURED(iLocal_295[1]))
								{
									iLocal_327 = PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(ScriptParam_0.f_4, 0.337842f, -0.243051f, -0.329731f), 0f, 0f, (ENTITY::GET_ENTITY_HEADING(ScriptParam_0.f_4) - 3.783146f), 2);
									iLocal_333 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 0);
									CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_333, iLocal_327, "darts_ig_intro_alt1_cam", "mini@dartsintro_alt1");
									CAM::SET_CAM_ACTIVE(iLocal_333, true);
									CAM::RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
									TASK::TASK_CLEAR_LOOK_AT(iLocal_295[0]);
									TASK::TASK_CLEAR_LOOK_AT(iLocal_295[1]);
									TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_295[0]);
									TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_295[1]);
									TASK::TASK_SYNCHRONIZED_SCENE(iLocal_295[1], iLocal_327, "mini@dartsintro_alt1", "darts_ig_intro_alt1_guy1", 1000f, -1000f, 0, 0, 1148846080, 0);
									TASK::TASK_SYNCHRONIZED_SCENE(iLocal_295[0], iLocal_327, "mini@dartsintro_alt1", "darts_ig_intro_alt1_guy2", 1000f, -1000f, 0, 0, 1148846080, 0);
									TASK::TASK_PLAY_ANIM(iLocal_295[1], "mini@dartsintro_alt1", "darts_ig_intro_alt1_guy1_face", 8f, -8f, -1, 32, 0, 0, 0, 0);
									TASK::TASK_PLAY_ANIM(iLocal_295[0], "mini@dartsintro_alt1", sVar1793, 8f, -8f, -1, 32, 0, 0, 0, 0);
									ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iVar1824, iLocal_327, "darts_ig_intro_alt1_dart", "mini@dartsintro_alt1", 1000f, 8f, 0, 1148846080);
									func_424(&iVar1800);
									iVar1774++;
								}
								break;
							...
							case 9:
								if (CAM::IS_SCREEN_FADED_OUT())
								{
									...
									if (!PED::IS_PED_INJURED(iLocal_295[1]))
									{
										ENTITY::SET_ENTITY_COORDS(iLocal_295[0], Var465, 1, 0, 0, 1);
										ENTITY::SET_ENTITY_HEADING(iLocal_295[0], Var0.f_243.f_4);
										ENTITY::SET_ENTITY_COORDS(iLocal_295[1], Var465.f_3, 1, 0, 0, 1);
										ENTITY::SET_ENTITY_HEADING(iLocal_295[1], Var0.f_243.f_4);
										TASK::CLEAR_PED_TASKS(iLocal_295[0]);
										TASK::CLEAR_PED_TASKS(iLocal_295[1]);
									}
									CAM::DESTROY_CAM(iLocal_333, 0);
				...
				case 6:
					switch (iVar1774)
					{
						...
						case 1:
							if ((MISC::GET_GAME_TIMER() - iLocal_323) > 1500)
							{
				...
				case 10:
					...
					func_246(&Var0, &vVar471, &Var477, &Var508, &iVar1794);
					break;
					...
					switch (iVar1774)
					{
						case 0:
							if (func_423(&(Var0.f_254)) > 0.5f)
							{
								...
								iVar1830 = func_240();
								iLocal_327 = PED::CREATE_SYNCHRONIZED_SCENE(vVar1787, vVar1790, 2);
								iLocal_333 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 0);
								CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_333, iLocal_327, sLocal_407[iVar1830], "mini@dartsoutro");
								CAM::SET_CAM_ACTIVE(iLocal_333, true);
								CAM::RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
								if (!PED::IS_PED_INJURED(iLocal_295[0]) && !PED::IS_PED_INJURED(iLocal_295[1]))
								{
									if (Var0.f_454)
									{
										...
										func_239(&iLocal_295, iVar1832);
										TASK::TASK_SYNCHRONIZED_SCENE(iLocal_295[0], iLocal_327, "mini@dartsoutro", sLocal_399[iVar1830], 1000f, -1.5f, 0, 0, 1148846080, 0);
										TASK::TASK_SYNCHRONIZED_SCENE(iLocal_295[1], iLocal_327, "mini@dartsoutro", sLocal_403[iVar1830], 1000f, -1.5f, 0, 0, 1148846080, 0);
										TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_394, sLocal_395[MISC::GET_RANDOM_INT_IN_RANGE(0, 3)], 4f, -4f, -1, 32, 0, 0, 0, 0);
									}
									else
									{
										AUDIO::PLAY_SOUND_FRONTEND(-1, "OTHER_TEXT", "HUD_AWARDS", 1);
										func_238(&iLocal_295);
										TASK::TASK_SYNCHRONIZED_SCENE(iLocal_295[1], iLocal_327, "mini@dartsoutro", sLocal_399[iVar1830], 1000f, -1.5f, 0, 0, 1148846080, 0);
										TASK::TASK_SYNCHRONIZED_SCENE(iLocal_295[0], iLocal_327, "mini@dartsoutro", sLocal_403[iVar1830], 1000f, -1.5f, 0, 0, 1148846080, 0);
										TASK::TASK_PLAY_ANIM(iLocal_295[1], sLocal_393, sLocal_395[MISC::GET_RANDOM_INT_IN_RANGE(0, 3)], 4f, -4f, -1, 32, 0, 0, 0, 0);
									}
								}
								iVar1774++;
							}
				...
				case 13:
					...
					switch (iVar1774)
					{
						case 0:
							...
							if (!bLocal_313)
							{
								CAM::RENDER_SCRIPT_CAMS(false, bLocal_313, 3000, 1, 0, 0);
							}
							else
							{
							...
							HUD::CLEAR_PRINTS();
							TASK::TASK_LOOK_AT_ENTITY(iLocal_295[0], iLocal_295[1], 5000, 2049, 3);
							func_435(&iVar1800);
							iVar1774++;
							break;
						...
						case 2:
							if (func_7(&iVar1800) > 0.3f)
							{
								if (!PED::IS_PED_INJURED(iLocal_295[1]))
								{
									if (!bVar1768)
									{
										func_4(iLocal_295[0], "GENERIC_THANKS", 1, 4);
									}
								}
								func_435(&iVar1800);
								iVar1774++;
...
float func_16(float fParam0)//Position - 0x3582
{
	return (fParam0 * 0.00078125f);
}

void func_17(char* sParam0, float fParam1, float fParam2, int iParam3, bool bParam4, int iParam5)//Position - 0x3592
{
...
int func_18(int iParam0, bool bParam1, bool bParam2, float fParam3, float fParam4, bool bParam5)//Position - 0x35CF
{
	char cVar0[64];
	char cVar16[64];
	int iVar32;
...
float func_19(int iParam0)//Position - 0x3780
{
	switch (iParam0)
	{
		case 33:
...
var func_21(int iParam0, bool bParam1)//Position - 0x3886
{
	char* sVar0[2];
	var uVar3;
	struct<13> Var19;
...
var func_22(var uParam0)//Position - 0x3DB0
{
	return uParam0;
}

struct<13> func_23(int iParam0)//Position - 0x3DBA
{
	struct<13> Var0;
...
char* func_24(int iParam0)//Position - 0x3DD1
{
	var uVar0;
	struct<13> Var16;
...
void func_25(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5)//Position - 0x3E46
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_26(int iParam0, int iParam1, float fParam2, float fParam3, char* sParam4, int iParam5)//Position - 0x40D2
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float func_27(float fParam0)//Position - 0x445A
{
	return (fParam0 * 0.025f);
}

float func_28(float fParam0)//Position - 0x446A
{
	return (fParam0 * 0.0009259259f);
}

void func_29(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17)//Position - 0x447A
{
	int iVar0;
	int iVar1;
...
void func_30(int iParam0, int iParam1)//Position - 0x45D7
{
	MISC::SET_BIT(&(Global_1375006.f_6184[iParam0]), iParam1);
}

bool func_31(int iParam0, int iParam1)//Position - 0x45F0
{
	return MISC::IS_BIT_SET(Global_1375006.f_6184[iParam0], iParam1);
}

float func_32(char* sParam0)//Position - 0x4609
{
	HUD::_BEGIN_TEXT_COMMAND_GET_WIDTH(sParam0);
	return (HUD::_END_TEXT_COMMAND_GET_WIDTH(1) / 2f);
}

void func_33()//Position - 0x461E
{
...
void func_34(char* sParam0)//Position - 0x4646
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
}

float func_35()//Position - 0x4654
{
	float fVar0;
...
void func_36(int iParam0)//Position - 0x4668
{
	Global_76837 = iParam0;
	Global_76838 = iParam0;
}

float func_37(float fParam0)//Position - 0x467C
{
	return (fParam0 * 0.001388889f);
}

void func_38(int iParam0)//Position - 0x468C
{
	if (func_40())
	{
		return;
...
int func_39(int iParam0)//Position - 0x46BF
{
	if (iParam0 == 1)
	{
...
bool func_40()//Position - 0x4719
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

void func_41(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)//Position - 0x472B
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	if (iLocal_300)
	{
		...
		if ((PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_327) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_327) >= 0.995f) || !PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_327))
		{
			bLocal_313 = true;
			if (CAM::DOES_CAM_EXIST(iLocal_333))
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_295[0]) && !PED::IS_PED_INJURED(iLocal_295[1]))
				{
					TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_295[0]);
					TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_295[1]);
					PED::_0x2208438012482A1A(iLocal_295[0], 0, 0);
					PED::_0x2208438012482A1A(iLocal_295[1], 0, 0);
				}
			}
			func_108();
		}
		...
		else if (((PAD::IS_CONTROL_JUST_PRESSED(0, 234) || PAD::IS_CONTROL_JUST_PRESSED(0, 235)) && uParam0->f_248 == 1) && bVar1)
		{
			...
			if (iLocal_299)
			{
				vVar3 = { ENTITY::GET_ENTITY_COORDS(uParam0->f_5[iLocal_30 /*79*/][iLocal_322 /*26*/], true) };
		...
		else if (((PAD::IS_CONTROL_JUST_PRESSED(0, 211) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 211)) && bVar1) && (iLocal_318 || !PLAYER::IS_PLAYER_ONLINE()))
		{
			uParam1->f_680 = 1;
			func_120(&(uParam1->f_509), 0, 0, 1, 1);
			func_119(&(uParam1->f_509), "DARTS_CONT", 2, 215, 1, 1, 0);
	...
	else if (!uParam0->f_457)
	{
		...
		iVar13 = func_240();
		iLocal_327 = PED::CREATE_SYNCHRONIZED_SCENE(vVar7, vVar10, 2);
		iLocal_333 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 0);
		CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_333, iLocal_327, sLocal_407[iVar13], "mini@dartsoutro");
		CAM::SET_CAM_ACTIVE(iLocal_333, true);
		CAM::RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
		if (!PED::IS_PED_INJURED(iLocal_295[0]) && !PED::IS_PED_INJURED(iLocal_295[1]))
		{
			if (uParam0->f_454)
			{
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_295[0], iLocal_327, "mini@dartsoutro", sLocal_399[iVar13], 1000f, -1.5f, 0, 0, 1148846080, 0);
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_295[1], iLocal_327, "mini@dartsoutro", sLocal_403[iVar13], 1000f, -1.5f, 0, 0, 1148846080, 0);
				TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_394, sLocal_395[MISC::GET_RANDOM_INT_IN_RANGE(0, 3)], 4f, -4f, -1, 32, 0, 0, 0, 0);
			}
			else
			{
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_295[1], iLocal_327, "mini@dartsoutro", sLocal_399[iVar13], 1000f, -1.5f, 0, 0, 1148846080, 0);
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_295[0], iLocal_327, "mini@dartsoutro", sLocal_403[iVar13], 1000f, -1.5f, 0, 0, 1148846080, 0);
				TASK::TASK_PLAY_ANIM(iLocal_295[1], sLocal_393, sLocal_395[MISC::GET_RANDOM_INT_IN_RANGE(0, 3)], 4f, -4f, -1, 32, 0, 0, 0, 0);
			}
		}
		bLocal_313 = false;
...
int func_42(var uParam0, bool bParam1, int iParam2)//Position - 0x4EEF
{
...
void func_43(var uParam0)//Position - 0x508F
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "CLEAR_ALL");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	if (MISC::IS_PC_VERSION())
...
void func_44(var uParam0)//Position - 0x5154
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_45(var uParam0)//Position - 0x525C
{
	uParam0->f_547 = 1f;
	uParam0->f_546 = 0;
	uParam0->f_568 = 0f;
...
void func_46(var uParam0, bool bParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11)//Position - 0x52DB
{
	uParam0->f_561 = 1;
	if (bParam1)
	{
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x53AD
{
...
void func_48(var uParam0, int iParam1, char* sParam2, char* sParam3, var uParam4, int iParam5, int iParam6, int iParam7)//Position - 0x53E8
{
	int iVar0;
...
void func_49(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x545B
{
...
void func_50(vector3 vParam0)//Position - 0x547E
{
	vector3 vVar0;
...
Vector3 func_51(vector3 vParam0)//Position - 0x54CE
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_52(vector3 vParam0, bool bParam3, bool bParam4)//Position - 0x54FA
{
	vector3 vVar0;
...
void func_53(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x558C
{
	int iVar0;
	int iVar1;
...
int func_54(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x565E
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_55(bool bParam0)//Position - 0x5C5D
{
	int iVar0;
	int iVar1;
...
void func_56(int iParam0)//Position - 0x5EDF
{
	int iVar0;
...
void func_57(int iParam0)//Position - 0x5F39
{
	bool bVar0;
	char cVar1[64];
...
char* func_58(int iParam0)//Position - 0x60CA
{
	switch (iParam0)
	{
		case 0:
...
void func_60(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x61D4
{
	int iVar0;
...
int func_61(var uParam0)//Position - 0x6204
{
	int iVar0;
	int iVar1;
...
int func_62()//Position - 0x6238
{
	return Global_1312745;
}

int func_63(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x6244
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_64(int iParam0)//Position - 0x6896
{
	func_87(93, iParam0);
	func_87(29, iParam0);
	func_87(30, iParam0);
...
bool func_65(int iParam0)//Position - 0x68B6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_66(int iParam0, int iParam1, int iParam2)//Position - 0x6A66
{
	int iVar0;
	var uVar1;
...
int func_67(int iParam0, int iParam1, int iParam2)//Position - 0x6A98
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_68(int iParam0)//Position - 0x6AD5
{
	int iVar0;
...
int func_69(int iParam0, int iParam1)//Position - 0x6E71
{
	int iVar0;
...
int func_70(bool bParam0)//Position - 0x71EA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_71(int iParam0, int iParam1)//Position - 0x72A1
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_72(int iParam0, int iParam1)//Position - 0x72BC
{
...
int func_73(var uParam0, int iParam1)//Position - 0x7359
{
	int iVar0;
	var uVar1[78];
...
int func_74(var uParam0, int iParam1)//Position - 0x740A
{
	int iVar0;
...
bool func_75(var uParam0, int iParam1)//Position - 0x7485
{
	return (*uParam0)[iParam1] == 78;
}

void func_76(var uParam0)//Position - 0x7496
{
	int iVar0;
...
void func_77(var uParam0, int iParam1)//Position - 0x74CA
{
	(*uParam0)[iParam1] = 78;
}

void func_78(var uParam0, float fParam1)//Position - 0x74DA
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_79(var uParam0)//Position - 0x74F7
{
	return uParam0->f_80;
}

bool func_80(var uParam0, int iParam1)//Position - 0x7503
{
	return func_81(uParam0, iParam1) != -1;
}

int func_81(var uParam0, int iParam1)//Position - 0x7515
{
	int iVar0;
...
bool func_82(var uParam0)//Position - 0x7542
{
	return uParam0->f_79 == 1;
}

int func_83(int iParam0)//Position - 0x7550
{
	switch (iParam0)
	{
		case 60:
...
bool func_84(int iParam0)//Position - 0x75A0
{
	return Global_41396 == iParam0;
}

int func_85(int iParam0, int iParam1)//Position - 0x75AE
{
	int iVar0;
...
void func_86(int iParam0, int iParam1)//Position - 0x75FF
{
	int iVar0;
...
void func_87(int iParam0, int iParam1)//Position - 0x7622
{
	int iVar0;
...
int func_89(int iParam0)//Position - 0x76F4
{
	return Global_1798[iParam0 /*29*/].f_17;
}

int func_90()//Position - 0x7705
{
	func_91();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_91()//Position - 0x771E
{
	int iVar0;
...
bool func_92(int iParam0)//Position - 0x781B
{
	return iParam0 < 3;
}

int func_93(int iParam0)//Position - 0x7827
{
	if (func_92(iParam0))
	{
...
var func_94(int iParam0)//Position - 0x784C
{
	return Global_1798[iParam0 /*29*/];
}

void func_95(var uParam0)//Position - 0x785B
{
...
void func_96(var uParam0, int iParam1)//Position - 0x788E
{
	if (uParam0->f_4 != 0)
	{
...
void func_97(var uParam0)//Position - 0x7939
{
	uParam0->f_1 = 0;
}

void func_98()//Position - 0x7946
{
	int iVar0;
	int iVar1;
	struct<75> Var2;
...
void func_99(var uParam0)//Position - 0x7AB2
{
	int iVar0;
...
void func_100(var uParam0)//Position - 0x7B0A
{
	struct<13> Var0;
	int iVar13;
	int iVar14;
...
void func_101(var uParam0)//Position - 0x7BEC
{
	int iVar0;
	struct<13> Var1;
...
void func_102(var uParam0)//Position - 0x7C74
{
	int iVar0;
	struct<35> Var1;
...
void func_103(var uParam0, var uParam1, var uParam2)//Position - 0x7D42
{
	*uParam0 = 0;
	*uParam1 = 0;
	Global_1835008 = 0;
...
void func_105(var uParam0)//Position - 0x7E12
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_106(var uParam0)//Position - 0x7E5A
{
	int iVar0;
...
void func_107(var uParam0)//Position - 0x7E95
{
	func_45(uParam0);
	uParam0->f_570 = 0;
	uParam0->f_31 = 0;
...
void func_108()//Position - 0x7EBF
{
	CAM::SET_CAM_ACTIVE(iLocal_126, true);
}

int func_109(var uParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x7ECE
{
...
void func_111()//Position - 0x8138
{
	Global_30880 = 1;
}

void func_112(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14)//Position - 0x8144
{
	int iVar0;
	int iVar1;
...
int func_113(char* sParam0)//Position - 0x8286
{
...
char* func_114(bool bParam0, char* sParam1, char* sParam2)//Position - 0x82C0
{
	if (bParam0)
	{
		return sParam1;
...
int func_115(bool bParam0, int iParam1, int iParam2)//Position - 0x82D7
{
	if (bParam0)
	{
		return iParam1;
...
void func_116(var uParam0, bool bParam1)//Position - 0x82EE
{
	if (bParam1)
	{
...
void func_117(var uParam0, int iParam1)//Position - 0x8314
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
}

void func_118(var uParam0, int iParam1)//Position - 0x8329
{
	*uParam0 = (*uParam0 || iParam1);
}

int func_119(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x833A
{
	int iVar0;
	int iVar1;
...
void func_120(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x8403
{
	if (*uParam0 == 0)
	{
...
int func_121(var uParam0)//Position - 0x847D
{
...
void func_122(var uParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)//Position - 0x84B4
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
float func_123(bool bParam0, float fParam1, float fParam2)//Position - 0x8774
{
	if (bParam0)
	{
		return fParam1;
...
bool func_124(var uParam0, int iParam1)//Position - 0x878B
{
	return (uParam0 && iParam1) != 0;
}

int func_125(var uParam0)//Position - 0x879A
{
	if (*uParam0 != 0)
	{
		if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*uParam0))
...
void func_126(var uParam0, var uParam1)//Position - 0x87C1
{
	func_127(uParam1, uParam0);
}

void func_127(var uParam0, var uParam1)//Position - 0x87D1
{
	int iVar0;
	int iVar1;
	var uVar2[3];
				...
				if (HUD::DOES_TEXT_LABEL_EXIST(&(Global_1835392.f_2780.f_1)))
				{
					if (!func_192(uParam1->f_44))
					{
						if (Global_1835392.f_2780.f_26 > 0)
						{
							...
							func_191(*uParam0, &(Global_1835392.f_2780.f_1), &iVar25, &Var9, Global_1835392.f_2780.f_25, Global_1835392.f_2780.f_26);
						}
						else
						{
							func_191(*uParam0, &(Global_1835392.f_2780.f_1), &iVar25, &(Global_1835392.f_2780.f_9), Global_1835392.f_2780.f_25, -1);
						}
					}
			...
			if (!func_153(uParam1))
			{
				...
				if (!MISC::IS_BIT_SET(uParam1->f_42, 0))
				{
					...
					if (HUD::DOES_TEXT_LABEL_EXIST(&(Global_1835392.f_2780.f_1)))
					{
						if (!func_192(uParam1->f_44))
						{
							...
							{
								Var9 = { Global_1835392.f_2780.f_9 };
								func_191(*uParam0, &(Global_1835392.f_2780.f_1), &iVar25, &Var9, 1, Global_1835392.f_2780.f_26);
							}
							else
							{
								func_191(*uParam0, &(Global_1835392.f_2780.f_1), &iVar25, &(Global_1835392.f_2780.f_9), Global_1835392.f_2780.f_25, -1);
				...
				if (Global_1835392.f_2825 == -1)
				{
					...
					while (iVar0 < 3)
					{
						...
						func_152(*uParam0, iVar6, iVar31, &vVar51);
						iVar6++;
						iVar0++;
					}
					Global_1835392.f_2825 = 1;
				...
				else if (func_150(&(Global_1835392.f_2823), 300, 0))
				{
					...
					while (iVar0 < 3)
					{
						...
						iVar31 = 0;
						MISC::SET_BIT(&iVar31, 7);
						func_152(*uParam0, iVar6, iVar31, &vVar57);
						iVar6++;
						iVar0++;
					}
...
void func_128(var uParam0, var uParam1)//Position - 0x97AF
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_129(var uParam0, int iParam1)//Position - 0x9B51
{
	var uVar0;
	int iVar1;
	var uVar2;
...
void func_130(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)//Position - 0x9BF0
{
...
void func_131(int iParam0, int iParam1, int iParam2)//Position - 0x9CC5
{
...
void func_132()//Position - 0x9CE8
{
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}

void func_133(struct<30> Param0, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, int iParam43, float fParam44, bool bParam45)//Position - 0x9CF4
{
...
float func_134(float fParam0)//Position - 0x9E16
{
	return (fParam0 / 0.3048f);
}

float func_135(float fParam0)//Position - 0x9E26
{
	return (fParam0 / 1609.344f);
}

void func_136(struct<30> Param0, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, int iParam43, int iParam44, bool bParam45, bool bParam46)//Position - 0x9E36
{
	struct<4> Var0;
...
struct<4> func_137(int iParam0)//Position - 0xA20B
{
	struct<4> Var0;
...
char* func_138(int iParam0, bool bParam1)//Position - 0xA244
{
	struct<32> Var0;
...
var func_139(var uParam0)//Position - 0xAEFE
{
	return uParam0;
}

int func_140(int iParam0, var uParam1)//Position - 0xAF08
{
	int iVar0;
	int iVar1;
...
int func_141(int iParam0)//Position - 0xAF43
{
	if (iParam0 == 600)
	{
...
void func_142(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, char* sParam5)//Position - 0xB0B6
{
...
int func_143(var uParam0, var uParam1)//Position - 0xB108
{
	if (!func_144(*uParam0))
	{
		return 0;
...
bool func_144(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12)//Position - 0xB142
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

void func_145(var uParam0, var uParam1)//Position - 0xB152
{
	int iVar0;
	int iVar1;
	struct<75> Var2;
...
void func_146(var uParam0, var uParam1)//Position - 0xB2C3
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void func_147(var uParam0)//Position - 0xB378
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_148(var uParam0)//Position - 0xB598
{
	struct<13> Var0;
	int iVar13;
...
int func_149(var uParam0, int iParam1, var uParam2, int iParam3)//Position - 0xB60E
{
	int iVar0;
...
int func_150(var uParam0, int iParam1, bool bParam2)//Position - 0xB8B7
{
	if (iParam1 == -1)
	{
		return 1;
...
void func_151(var uParam0, bool bParam1, bool bParam2)//Position - 0xB915
{
	if (uParam0->f_1 == 0)
	{
...
void func_152(int iParam0, int iParam1, int iParam2, char* sParam3)//Position - 0xB95A
{
...
int func_153(var uParam0)//Position - 0xB98E
{
	if (!Global_1835388)
	{
...
void func_154(var uParam0)//Position - 0xBB53
{
	int iVar0;
	int iVar1;
	int iVar2;
...
Vector3 func_155(int iParam0)//Position - 0xBD3D
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_156(int iParam0, int iParam1)//Position - 0xBD50
{
	int iVar0;
...
int func_157(int iParam0)//Position - 0xBDCC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_158(var uParam0)//Position - 0xBE5F
{
	int iVar0;
	int iVar1;
...
int func_159(var uParam0, var uParam1, var uParam2, var uParam3)//Position - 0xC003
{
	var uVar0;
	int iVar35;
...
void func_160(var uParam0, char* sParam1)//Position - 0xC0BC
{
	NETWORK::NETWORK_CLAN_GET_UI_FORMATTED_TAG(uParam0, 35, sParam1);
}

int func_161(var uParam0, var uParam1)//Position - 0xC0CE
{
	int iVar0;
...
void func_162(var uParam0)//Position - 0xC10D
{
	int iVar0;
...
int func_163(var uParam0)//Position - 0xC17E
{
	int iVar0;
...
int func_164(var uParam0, var uParam1, char* sParam2)//Position - 0xC1EC
{
	if (*uParam0 == 2)
	{
		return 1;
...
int func_165(var uParam0)//Position - 0xC2FD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_166(var uParam0)//Position - 0xC493
{
	int iVar0;
...
int func_167(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, char* sParam17)//Position - 0xC530
{
	struct<13> Var0;
...
int func_168(var uParam0, int iParam1, char* sParam2, var uParam3, var uParam4)//Position - 0xC652
{
	int iVar0;
	struct<13> Var1[1];
...
int func_169(var uParam0)//Position - 0xC758
{
	struct<97> Var0;
	struct<6> Var98;
	int iVar106;
...
void func_170(int iParam0, int iParam1)//Position - 0xD58B
{
	int iVar0;
...
int func_171(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4)//Position - 0xD6B0
{
	switch (*uParam0)
	{
		case 0:
...
int func_176(int iParam0)//Position - 0xD80C
{
...
void func_177(var uParam0, char* sParam1, int iParam2)//Position - 0xD86A
{
	int iVar0;
	int iVar1;
...
void func_178(var uParam0)//Position - 0xD977
{
	int iVar0;
...
void func_179(var uParam0, var uParam1)//Position - 0xDA25
{
	*uParam0 = *uParam1;
...
int func_180(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, bool bParam5, bool bParam6, int iParam7, int iParam8)//Position - 0xDA40
{
	var uVar0;
	var uVar1;
...
int func_182(var uParam0)//Position - 0xDB95
{
	struct<20> Var0;
	struct<6> Var98;
	int iVar106;
	...
	switch ((*uParam0)[1])
	{
		case 0:
			...
			if (iVar107 > 0)
			{
				...
				if (func_183(&(uParam0->f_4), &(uParam0->f_5), &(uParam0->f_44), &(uParam0->f_113), uParam0->f_113[0 /*66*/], iVar112, 0, 100))
				{
					func_179(&Var98, &(uParam0->f_44));
					if (uParam0->f_5 && STATS::_0xA0F93D5465B3094D(&Var98))
					{
...
int func_183(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, int iParam7)//Position - 0xE598
{
	switch (*uParam0)
	{
		case 0:
...
int func_184(var uParam0)//Position - 0xE654
{
	struct<13> Var0;
	struct<97> Var13;
	struct<6> Var111;
...
void func_186(var uParam0)//Position - 0xF527
{
	int iVar0;
...
bool func_187(var uParam0)//Position - 0xF577
{
	return uParam0->f_1;
}

void func_188(int iParam0)//Position - 0xF583
{
...
void func_189(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0xF5A3
{
	char* sVar0;
	struct<2> Var1;
	struct<16> Var36;
...
void func_190(int iParam0, char* sParam1, var uParam2, int iParam3)//Position - 0xF879
{
	int iVar0;
...
void func_191(int iParam0, char* sParam1, int iParam2, int iParam3, bool bParam4, int iParam5)//Position - 0xF8BB
{
...
int func_192(int iParam0)//Position - 0xF94B
{
...
void func_193(int iParam0, int iParam1)//Position - 0xF96D
{
...
int func_194()//Position - 0xF98A
{
	return unk_0x67D02A194A2FC2BD("SC_LEADERBOARD");
}

bool func_195()//Position - 0xF99A
{
	return func_196(PLAYER::PLAYER_ID());
}

int func_196(int iParam0)//Position - 0xF9AA
{
...
int func_197(int iParam0)//Position - 0xFA0A
{
	return Global_1590446[iParam0 /*871*/].f_196;
}

void func_198(int iParam0)//Position - 0xFA1D
{
	Global_1315712 = iParam0;
}

void func_199(int iParam0)//Position - 0xFA2B
{
	Global_1375006.f_1100 = iParam0;
}

void func_200(bool bParam0)//Position - 0xFA3C
{
	if (bParam0)
	{
		func_202();
...
void func_201(int iParam0, int iParam1)//Position - 0xFA8D
{
...
void func_202()//Position - 0xFAC3
{
	Global_2531497.f_4532 = 0;
}

void func_203(var uParam0, bool bParam1, bool bParam2)//Position - 0xFAD3
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1)
	{
		if (!bParam2)
...
int func_204(int iParam0, bool bParam1)//Position - 0xFB10
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void func_205(var uParam0, bool bParam1)//Position - 0xFF87
{
	func_206(uParam0);
	if (bParam1)
	{
...
void func_206(var uParam0)//Position - 0xFFA4
{
	struct<46> Var0;
...
void func_207(var uParam0, int iParam1)//Position - 0xFFBF
{
	if (iParam1 == 1)
	{
		*uParam0 = 0;
...
void func_208(var uParam0)//Position - 0x100BF
{
	uParam0->f_35 = 0;
}

int func_209(var uParam0)//Position - 0x100CC
{
	return uParam0->f_35;
}

int func_210()//Position - 0x100D8
{
	if (func_211())
	{
		return 0;
...
bool func_211()//Position - 0x100F8
{
	return Global_2459500;
}

void func_212(bool bParam0)//Position - 0x10104
{
	HUD::BUSYSPINNER_OFF();
	if (bParam0)
	{
...
int func_213(var uParam0, bool bParam1, bool bParam2)//Position - 0x10119
{
	if (!iLocal_289)
	{
...
int func_214(var uParam0)//Position - 0x10182
{
	struct<98> Var0;
	struct<4> Var98;
	struct<37> Var106;
...
bool func_215()//Position - 0x105A6
{
	return MISC::IS_BIT_SET(Global_959568.f_8, 1);
}

var func_216()//Position - 0x105B9
{
	return Global_2457255.f_3;
}

int func_217(int iParam0)//Position - 0x105C7
{
	switch (iParam0)
	{
		case 817:
...
void func_218()//Position - 0x10698
{
...
int func_219(int iParam0, int iParam1, int iParam2)//Position - 0x106F8
{
	int iVar0;
...
int func_220(int iParam0, int iParam1)//Position - 0x107FA
{
...
int func_221(var uParam0, var uParam1, var uParam2, var uParam3)//Position - 0x10855
{
	switch (*uParam0)
	{
		case 0:
...
void func_222(int iParam0, bool bParam1)//Position - 0x10909
{
	struct<6> Var0[1];
	struct<8> Var7[1];
...
void func_223(int iParam0, int iParam1, int iParam2, float fParam3, bool bParam4)//Position - 0x109F9
{
	int iVar0;
	int iVar1;
...
int func_224(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x10B14
{
	struct<68> Var0;
	int iVar68;
	struct<13> Var69;
...
void func_225(var uParam0, bool bParam1)//Position - 0x10C48
{
	int iVar0;
...
void func_226(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x10C70
{
	struct<8> Var0;
	struct<8> Var8;
	int iVar16;
...
int func_227(struct<8> Param0, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12)//Position - 0x157FB
{
	char cVar0[64];
...
struct<6> func_228(int iParam0)//Position - 0x1586D
{
	struct<6> Var0;
...
bool func_229(int iParam0)//Position - 0x1591C
{
	return iParam0 == 74;
}

var func_230(int iParam0)//Position - 0x15929
{
	return (func_232(iParam0) || func_231(iParam0));
}

bool func_231(int iParam0)//Position - 0x15943
{
	return iParam0 == 44;
}

bool func_232(int iParam0)//Position - 0x15950
{
	return iParam0 == 45;
}

bool func_233(int iParam0)//Position - 0x1595D
{
	return iParam0 == 12;
}

struct<6> func_234(int iParam0)//Position - 0x1596A
{
	struct<6> Var0;
...
int func_236(var uParam0, int iParam1)//Position - 0x15BCA
{
...
void func_237(var uParam0, float fParam1)//Position - 0x15CCD
{
...
void func_238(int iParam0)//Position - 0x15CF3
{
	int iVar0;
...
void func_239(int iParam0, int iParam1)//Position - 0x15D6C
{
	int iVar0;
...
void func_241(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x15E69
{
	char* sVar0;
...
char* func_242(int iParam0)//Position - 0x15EC9
{
	switch (iParam0)
	{
		case 0:
...
void func_243(var uParam0, int iParam1)//Position - 0x15F38
{
...
int func_244(int iParam0)//Position - 0x15F56
{
...
void func_245(int iParam0)//Position - 0x15FA6
{
...
void func_246(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4)//Position - 0x1600A
{
	bool bVar0;
			...
			if (iLocal_30 == 0)
			{
				...
				if (((((!func_303("DARTS_SHT_USE") && !func_303("DARTS_INSTR_W")) && !func_303("DARTS_INSTR_B")) && !func_303("DARTS_AIM_HLP")) && !func_303("DARTS_STD_HLP")) && !func_303("DARTS_FST_HLP"))
				{
					if (func_3(&(uParam3->f_666), 24))
					{
						...
						MISC::SET_BIT(&(Global_111560.f_18965.f_6), iLocal_326);
				...
				else if (!iLocal_301)
				{
					...
					{
						func_290(iLocal_295[(1 - iLocal_30)]);
						func_421(iParam4);
						iLocal_301 = 1;
					}
				}
...
void func_247(var uParam0, var uParam1)//Position - 0x1646A
{
	vector3 vVar0;
	float fVar3;
	int iVar4;
	...
	while (iLocal_31 < 3 && uParam0->f_1 == 6)
	{
		...
		else if (uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_24)
		{
			...
			if (bLocal_307)
			{
				if (iLocal_309)
				{
					uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/] = OBJECT::CREATE_OBJECT(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_1, vLocal_79, 1, true, 0);
					vVar0 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam0->f_243.f_1, uParam0->f_243.f_4, uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_11, (uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_11.f_1 + fLocal_55), uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_11.f_2) };
					ENTITY::SET_ENTITY_COORDS(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/], vVar0, 1, 0, 0, 1);
			...
			if (bLocal_307)
			{
				if (iLocal_309)
				{
					...
					while (iVar4 < iLocal_31 + 1)
					{
						...
						{
							uParam0->f_5[iLocal_30 /*79*/][iVar4 /*26*/] = OBJECT::CREATE_OBJECT(uParam0->f_5[iLocal_30 /*79*/][iVar4 /*26*/].f_1, vLocal_79, 1, true, 0);
...
void func_248(var uParam0, var uParam1, var uParam2)//Position - 0x168F3
{
	vector3 vVar0;
	int iVar3;
	...
	switch (uParam0->f_2)
	{
		...
		case 1:
			if (PAD::IS_CONTROL_JUST_PRESSED(2, 190))
			{
				...
				vVar0 = { ENTITY::GET_ENTITY_COORDS(uParam0->f_5[iLocal_30 /*79*/][iLocal_322 /*26*/], true) };
				func_50(vVar0);
			}
		...
		case 2:
			if (PAD::IS_CONTROL_JUST_PRESSED(2, 201) || (iLocal_308 && bLocal_307))
			{
				iLocal_298 = 1;
			}
			...
			if (!func_3(&(uParam2->f_666), 6))
			{
				if (!iLocal_303)
				{
					if (func_251(iLocal_30 == 0, &(iLocal_295[1]), (uParam0->f_425[iLocal_30] - uParam0->f_422[iLocal_30]), uParam0->f_422[0], uParam0->f_422[1]))
					{
						iLocal_303 = 1;
					}
				}
			...
			{
				if (func_250(iLocal_30 == 0, &(iLocal_295[1]), (uParam0->f_425[iLocal_30] - uParam0->f_422[iLocal_30]), uParam0->f_422[0], uParam0->f_422[1]))
				{
					iLocal_303 = 1;
				}
			}
...
void func_249(var uParam0, int iParam1, int iParam2)//Position - 0x16D0C
{
...
int func_250(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4)//Position - 0x16D30
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_251(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4)//Position - 0x16F2D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_252(char* sParam0, int iParam1, int iParam2)//Position - 0x17186
{
	iParam2 = iParam2;
...
void func_253(char* sParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1719F
{
	iParam3 = iParam3;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam1);
...
void func_254()//Position - 0x171BE
{
	CAM::SET_CAM_ACTIVE(iLocal_129, true);
	CAM::SET_CAM_ACTIVE(iLocal_120, false);
}

void func_255(var uParam0, var uParam1)//Position - 0x171D4
{
	uParam0->f_455 = 0;
	...
	else
	{
		...
		else if ((uParam0->f_422[iLocal_30] == 1 || uParam0->f_422[iLocal_30] < 0) || (uParam0->f_422[iLocal_30] == 0 && uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_21 != 2))
		{
			...
			if (!iLocal_303)
			{
				if (func_264(iLocal_295[(1 - iLocal_30)]))
				{
					iLocal_303 = 1;
				}
			}
		...
		else
		{
			if (uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_20 == 50)
			{
				...
				{
					if (func_262(iLocal_295[iLocal_30]))
					{
						iLocal_303 = 1;
					}
				}
			...
			if (uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_20 == 0)
			{
				if (!iLocal_303 && !iLocal_308)
				{
					func_261(iLocal_295[(1 - iLocal_30)]);
					iLocal_303 = 1;
				}
			}
			if (uParam0->f_428 == 180)
			{
				if (!iLocal_303 && !iLocal_308)
				{
					if (func_260(iLocal_295[1], iLocal_30 == 0))
					{
						iLocal_303 = 1;
					}
				}
			...
			if (uParam0->f_428 == 140)
			{
				if (!iLocal_303 && !iLocal_308)
				{
					if (func_258(iLocal_295[iLocal_30], iLocal_30 == 0))
					{
						iLocal_303 = 1;
					}
				}
...
void func_256(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x17771
{
	iParam4 = iParam4;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam1);
...
void func_257(int iParam0)//Position - 0x17796
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
int func_258(int iParam0, bool bParam1)//Position - 0x177B4
{
	int iVar0;
...
int func_260(int iParam0, bool bParam1)//Position - 0x17854
{
	int iVar0;
...
int func_261(int iParam0)//Position - 0x178D3
{
	int iVar0;
	int iVar1;
...
int func_262(int iParam0)//Position - 0x17916
{
	int iVar0;
...
void func_263(var uParam0, int iParam1)//Position - 0x17942
{
	uParam0->f_679 = 1;
	uParam0->f_682 = iParam1;
}

int func_264(int iParam0)//Position - 0x17957
{
	int iVar0;
...
void func_265(int iParam0)//Position - 0x17983
{
	switch (iParam0)
	{
		case 0:
...
void func_266(char* sParam0, var uParam1)//Position - 0x17AFA
{
}

void func_267(var uParam0)//Position - 0x17B02
{
	if (!uParam0->f_460)
	{
		uParam0->f_460 = 1;
...
void func_268(bool bParam0)//Position - 0x17CAB
{
	char* sVar0;
...
int func_269(var uParam0)//Position - 0x17D1E
{
	int iVar0;
	int iVar1;
...
void func_270(var uParam0, var uParam1, bool bParam2)//Position - 0x17DE0
{
	float fVar0;
	float fVar1;
	float fVar2;
...
float func_271(vector3 vParam0)//Position - 0x18016
{
	return SYSTEM::SQRT(((vParam0.x * vParam0.x) + (vParam0.z * vParam0.z)));
}

int func_272(var uParam0)//Position - 0x18031
{
	int iVar0;
...
int func_273(var uParam0, var uParam1, int iParam2, bool bParam3)//Position - 0x180F7
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
void func_274(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x18217
{
	struct<9> Var0;
...
float func_275(float fParam0)//Position - 0x1831C
{
	return (fParam0 + fLocal_13);
}

float func_276(float fParam0)//Position - 0x18329
{
	return (fParam0 + fLocal_12);
}

int func_277()//Position - 0x18336
{
	if (func_278())
	{
		return 1;
...
bool func_278()//Position - 0x18375
{
	return Global_1312439;
}

void func_279(var uParam0)//Position - 0x18381
{
	uParam0->f_4 = 128;
	uParam0->f_5 = 128;
	uParam0->f_6 = 128;
...
void func_280(var uParam0)//Position - 0x1839B
{
	uParam0->f_7 = 2;
}

void func_281(var uParam0)//Position - 0x183A8
{
	uParam0->f_7 = 5;
}

void func_282(var uParam0)//Position - 0x183B5
{
	uParam0->f_4 = 0;
	uParam0->f_5 = 0;
	uParam0->f_6 = 0;
...
void func_283(var uParam0)//Position - 0x183D2
{
	uParam0->f_4 = 0;
	uParam0->f_5 = 0;
	uParam0->f_6 = 0;
...
void func_284(var uParam0)//Position - 0x183EF
{
...
void func_285(var uParam0)//Position - 0x18418
{
...
void func_286(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)//Position - 0x18440
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	else
	{
		...
		uParam0->f_24 = 1;
		func_287(uParam0);
		*uParam0 = OBJECT::CREATE_OBJECT(uParam0->f_1, vLocal_79, 0, false, 0);
...
void func_287(var uParam0)//Position - 0x18799
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
int func_288(var uParam0)//Position - 0x18845
{
	switch (uParam0->f_4)
	{
		case 0:
...
void func_289(var uParam0, var uParam1)//Position - 0x18879
{
	int iVar0;
...
int func_290(int iParam0)//Position - 0x189CB
{
	int iVar0;
...
void func_291(int iParam0)//Position - 0x189F7
{
	func_292(iParam0, 0f);
}

void func_292(int iParam0, float fParam1)//Position - 0x18A06
{
...
int func_293(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6)//Position - 0x18A34
{
	float fVar0;
	int iVar1;
...
int func_294(var uParam0)//Position - 0x18CA9
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_295()//Position - 0x18E67
{
	Local_70.f_4 = 210;
	Local_70.f_5 = 23;
	Local_70.f_6 = 19;
...
void func_296()//Position - 0x18E81
{
	Local_70.f_4 = 183;
	Local_70.f_5 = 137;
	Local_70.f_6 = 0;
...
void func_297()//Position - 0x18E9A
{
	Local_70.f_4 = 16;
	Local_70.f_5 = 184;
	Local_70.f_6 = 10;
...
void func_298(var uParam0, var uParam1, bool bParam2, int iParam3)//Position - 0x18EB4
{
	vector3 vVar0;
...
void func_299(var uParam0, int iParam1)//Position - 0x18F63
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_300()//Position - 0x19355
{
	if (PAD::IS_CONTROL_PRESSED(2, 227))
	{
		fLocal_92 = 0.3f;
...
void func_301(var uParam0, struct<4> Param1, var uParam5, var uParam6)//Position - 0x19467
{
	vector3 vVar0;
...
int func_302(var uParam0, var uParam1, bool bParam2)//Position - 0x194BB
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_303(char* sParam0)//Position - 0x195F2
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_304(int iParam0, int iParam1)//Position - 0x19605
{
	if (iParam0 == 0)
	{
...
int func_305(int iParam0, var uParam1, var uParam2, var uParam3)//Position - 0x1975A
{
	vector3 vVar0;
...
Vector3 func_308(int iParam0)//Position - 0x19829
{
	float fVar0;
	vector3 vVar1;
...
float func_309(float fParam0)//Position - 0x1986D
{
	float fVar0;
	float fVar1;
...
float func_310(float fParam0)//Position - 0x19889
{
	float fVar0;
	float fVar1;
...
var func_311(int iParam0)//Position - 0x198A5
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_312(var uParam0)//Position - 0x198E1
{
	switch (*uParam0)
	{
		case 0:
		...
		case 1:
			if (PAD::IS_CONTROL_PRESSED(2, 228))
			{
				...
				{
					func_317();
					func_316(&iLocal_335, vLocal_366, vLocal_369, 30f, 10, 10, 3, 15f, 0, 0, -1f, 1);
					*uParam0 = 2;
				}
			}
			else
		...
		case 2:
			...
			{
				func_313(&iLocal_335, 1, 1, 0, 0, 1045220557, 0, 1065353216, 0);
			}
			break;
		...
		case 3:
			...
			{
				if (CAM::IS_CAM_ACTIVE(iLocal_335))
				{
					CAM::SET_CAM_ACTIVE(iLocal_335, false);
				}
				CAM::DESTROY_CAM(iLocal_335, 0);
			}
			*uParam0 = 0;
			return 0;
			break;
...
void func_313(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, float fParam7, bool bParam8)//Position - 0x199D4
{
	int iVar0[4];
	float fVar5;
	float fVar6;
...
int func_314(int iParam0, int iParam1, int iParam2)//Position - 0x19F28
{
	if (iParam0 > iParam2)
	{
		return iParam2;
...
void func_315(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x19F4D
{
...
void func_316(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7, int iParam8, int iParam9, int iParam10, float fParam11, int iParam12, int iParam13, float fParam14, bool bParam15)//Position - 0x1A051
{
	uParam0->f_1 = { vParam1 };
	uParam0->f_4 = { vParam4 };
	uParam0->f_7 = fParam7;
...
void func_317()//Position - 0x1A149
{
	if (iLocal_291)
	{
		return;
...
void func_318()//Position - 0x1A16B
{
...
void func_319(bool bParam0)//Position - 0x1A18E
{
	if (bParam0)
	{
...
void func_320(var uParam0)//Position - 0x1A1B8
{
	if (uParam0->f_679)
	{
		if (uParam0->f_681 == 2)
...
void func_321(var uParam0)//Position - 0x1A23D
{
	uParam0->f_8 = 0;
	func_421(&(uParam0->f_2));
	func_421(&(uParam0->f_5));
...
char* func_322(int iParam0)//Position - 0x1A25A
{
	switch (iParam0)
	{
		case 0:
...
void func_323(var uParam0)//Position - 0x1A287
{
	if (!iLocal_99)
	{
		if (!PAD::IS_CONTROL_PRESSED(2, 201))
...
void func_324(var uParam0, int iParam1)//Position - 0x1A2DF
{
	if (!HUD::IS_PAUSE_MENU_ACTIVE())
	{
		if (iParam1 == 0)
...
int func_325(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x1A59B
{
	int iVar0;
...
void func_326(var uParam0)//Position - 0x1A666
{
	if (!HUD::IS_PAUSE_MENU_ACTIVE())
	{
...
void func_327(var uParam0)//Position - 0x1A778
{
	bool bVar0;
...
void func_328(int iParam0)//Position - 0x1A81B
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
float func_329(int iParam0)//Position - 0x1A839
{
	if (iParam0 < 10)
	{
		return 0.107f;
...
float func_330(int iParam0)//Position - 0x1A88E
{
	if (iParam0 < 10)
	{
		return 0.08f;
...
void func_331(int iParam0, int iParam1, bool bParam2)//Position - 0x1A8E3
{
	if (bParam2)
	{
...
int func_332(int iParam0, var uParam1)//Position - 0x1A903
{
	if (iParam0 >= 10)
	{
...
int func_333(int iParam0, var uParam1, var uParam2)//Position - 0x1A92F
{
	int iVar0;
	int iVar1;
...
void func_334(bool bParam0)//Position - 0x1AA1B
{
...
void func_335(bool bParam0)//Position - 0x1AA6C
{
	if (bParam0)
	{
		CAM::SET_CAM_ACTIVE(iLocal_120, true);
...
void func_336()//Position - 0x1AA80
{
	CAM::SET_CAM_ACTIVE(iLocal_122, true);
}

void func_337(var uParam0)//Position - 0x1AA8F
{
	func_338();
	uParam0->f_670 = 3;
	func_331(&(uParam0->f_666), 15, 0);
...
void func_338()//Position - 0x1AAC5
{
	int iVar0;
...
void func_339()//Position - 0x1AB35
{
	SYSTEM::SETTIMERA(0);
	iLocal_99 = 0;
	HUD::CLEAR_SMALL_PRINTS();
...
void func_340(bool bParam0, int iParam1)//Position - 0x1AB49
{
	int iVar0;
...
void func_341(int iParam0)//Position - 0x1AC07
{
	if (iParam0->f_9 != 0)
	{
		if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*iParam0))
...
int func_342(var uParam0, bool bParam1, int iParam2)//Position - 0x1AC30
{
	char cVar0[64];
	int iVar16;
	int iVar17;
...
void func_343(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x1ACCD
{
...
int func_344(var uParam0, var uParam1, var uParam2)//Position - 0x1ACFD
{
	char* sVar0;
	int iVar1;
	int iVar2;
...
void func_345(bool bParam0, bool bParam1)//Position - 0x1B10D
{
	int iVar0;
	int iVar1;
	float fVar2;
...
void func_347(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7, int iParam8)//Position - 0x1B62B
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		if (iVar5 == 1 && Global_22350.f_5728)
		{
			...
			if (MISC::GET_HASH_KEY(&(Global_4268271.f_21)) != 0 && Global_4268271.f_65 != -1)
			{
				...
				if (Global_4268271.f_67 != 0)
				{
					...
					GRAPHICS::DRAW_SPRITE(func_24(Global_4268271.f_67), func_21(Global_4268271.f_67, 1), ((Global_22347 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
				}
				fVar51 = (fVar51 + (((HUD::_GET_TEXT_SCALE_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
...
float func_348(int iParam0)//Position - 0x1E3CF
{
	switch (iParam0)
	{
		case 35:
...
void func_349(float fParam0, float fParam1, char* sParam2, float fParam3, int iParam4)//Position - 0x1E43E
{
...
void func_350(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4)//Position - 0x1E45D
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam3);
...
bool func_351()//Position - 0x1E47B
{
	return DLC::IS_DLC_PRESENT(-1762644250);
}

void func_352(bool bParam0)//Position - 0x1E48C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_353(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x1E4D2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_354(int iParam0, var uParam1, var uParam2, var uParam3)//Position - 0x1E680
{
	switch (iParam0)
	{
		case 0:
...
void func_355(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)//Position - 0x1E90A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_356(int iParam0, int iParam1)//Position - 0x1EE12
{
	bool bVar0;
...
int func_357(int iParam0, bool bParam1)//Position - 0x1EE5D
{
	int iVar0;
	int iVar1;
...
void func_360(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x1EF26
{
...
void func_361(float fParam0)//Position - 0x1F03B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_362(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4)//Position - 0x1F09A
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam3);
...
float func_363(char* sParam0, int iParam1, int iParam2)//Position - 0x1F0BD
{
	if (!MISC::IS_STRING_NULL(sParam0))
	{
...
void func_364()//Position - 0x1F0FF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_365(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x1F189
{
	GRAPHICS::DRAW_RECT((fParam0 + (fParam2 * 0.5f)), (fParam1 + (fParam3 * 0.5f)), fParam2, fParam3, iParam4, iParam5, iParam6, iParam7, 0);
}

void func_366(int iParam0, char* sParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)//Position - 0x1F1B8
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float func_367(char* sParam0)//Position - 0x1F3C4
{
...
float func_368(char* sParam0)//Position - 0x1F3E0
{
	if (!MISC::IS_STRING_NULL(sParam0))
	{
		if (MISC::GET_HASH_KEY(sParam0) == 0)
...
void func_369(int iParam0, bool bParam1)//Position - 0x1F41D
{
	int iVar0;
...
int func_370(bool bParam0, bool bParam1)//Position - 0x1F469
{
...
int func_371()//Position - 0x1F506
{
	return Global_1312808;
}

bool func_372(int iParam0, int iParam1)//Position - 0x1F512
{
	switch (iParam0)
	{
		case 5:
...
int func_373(int iParam0, bool bParam1)//Position - 0x1F54D
{
	if (bParam1)
	{
		switch (iParam0)
...
int func_374(int iParam0, int iParam1, int iParam2)//Position - 0x1F5D4
{
	if (!PAD::_IS_INPUT_DISABLED(2))
	{
		return 0;
...
void func_375(int iParam0)//Position - 0x1F64C
{
	if (!func_420(iParam0))
	{
		func_435(iParam0);
...
int func_376(int iParam0)//Position - 0x1F664
{
	float fVar0;
...
void func_377(var uParam0)//Position - 0x1F6E9
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void func_378(int iParam0, char* sParam1, int iParam2, bool bParam3)//Position - 0x1F7E0
{
	char* sVar0;
...
void func_379(int iParam0)//Position - 0x1F895
{
	Global_22350.f_5738 = iParam0;
}

void func_380(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1F8A5
{
...
void func_381(int iParam0, int iParam1, bool bParam2)//Position - 0x1F8D3
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float func_382(char* sParam0, int iParam1)//Position - 0x1FA52
{
	if (!HUD::DOES_TEXT_LABEL_EXIST(sParam0))
	{
	}
...
float func_383(char* sParam0, int iParam1)//Position - 0x1FA74
{
	if (!HUD::DOES_TEXT_LABEL_EXIST(sParam0))
	{
		return 0f;
...
void func_384(int iParam0, char* sParam1, char* sParam2)//Position - 0x1FAA6
{
	Global_22350 = iParam0;
	func_385(29, sParam1, sParam2);
}

void func_385(int iParam0, char* sParam1, char* sParam2)//Position - 0x1FABD
{
	StringCopy(&(Global_22350.f_6020[iParam0 /*16*/]), sParam1, 64);
	StringCopy(&(Global_22350.f_7013[iParam0 /*16*/]), sParam2, 64);
}

void func_386(char* sParam0)//Position - 0x1FAE1
{
	int iVar0;
...
void func_387(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x1FB2C
{
...
void func_388(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x1FB6B
{
...
void func_389(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x1FBAA
{
...
void func_390(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4)//Position - 0x1FC54
{
...
int func_391(int iParam0, int iParam1, int iParam2)//Position - 0x1FC84
{
	if (!PAD::_IS_INPUT_DISABLED(2))
	{
		return 0;
...
int func_392(int iParam0)//Position - 0x1FCFC
{
	float fVar0;
...
int func_393(int iParam0)//Position - 0x1FD74
{
	float fVar0;
...
int func_394(int iParam0)//Position - 0x1FDEC
{
	float fVar0;
...
int func_395(float fParam0)//Position - 0x1FE64
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_397(char* sParam0, int iParam1, int iParam2)//Position - 0x1FF4C
{
	int iVar0;
...
void func_398(int iParam0, bool bParam1, int iParam2)//Position - 0x1FFB1
{
	int iVar0;
	int iVar1;
...
int func_400(int iParam0, int iParam1, bool bParam2)//Position - 0x2012C
{
	if (!PAD::_IS_INPUT_DISABLED(2))
	{
		return 0;
...
void func_401(bool bParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x2020C
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_402(bool bParam0)//Position - 0x204B8
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_403()//Position - 0x20541
{
...
float func_404(float fParam0)//Position - 0x20589
{
	if (fParam0 < 1.3f)
	{
		return 35f;
...
void func_405(var uParam0)//Position - 0x205BF
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void func_406()//Position - 0x206AC
{
	if (MISC::IS_PC_VERSION())
	{
...
int func_407(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5)//Position - 0x206CA
{
	int iVar0;
	int iVar1;
	
	if ((func_431() && MISC::GET_GAME_TIMER() >= iLocal_323 + 1000) && *iParam0 != 8)
	{
		if (!CAM::IS_SCREEN_FADED_OUT() && !CAM::IS_SCREEN_FADING_OUT())
		{
			CAM::DO_SCREEN_FADE_OUT(500);
...
void func_408(int iParam0)//Position - 0x20AE6
{
	vector3 vVar0;
...
void func_409(vector3 vParam0, float fParam3, vector3 vParam4, vector3 vParam7, int iParam10)//Position - 0x20B26
{
...
int func_410(var uParam0, bool bParam1, bool bParam2)//Position - 0x20B6F
{
	if (!func_420(&(uParam0->f_2)))
	{
		func_435(&(uParam0->f_2));
...
void func_411(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, bool bParam6, float fParam7)//Position - 0x20C01
{
	char* sVar0;
...
char* func_412(int iParam0)//Position - 0x20C90
{
	switch (iParam0)
	{
		case 0:
...
void func_413()//Position - 0x20D0B
{
	CAM::SET_CAM_ACTIVE(iLocal_120, true);
	CAM::RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
...
char* func_414(int iParam0)//Position - 0x20D86
{
	if (iLocal_334 == 1)
	{
		switch (iParam0)
...
void func_415(vector3 vParam0, float fParam3, vector3 vParam4, vector3 vParam7, int iParam10, bool bParam11)//Position - 0x20E19
{
...
Vector3 func_416(bool bParam0)//Position - 0x20E71
{
	if (bParam0)
	{
...
Vector3 func_417(int iParam0)//Position - 0x20E9A
{
	switch (iParam0)
	{
		case 0:
...
void func_418(char[4] cParam0, int iParam1)//Position - 0x20F24
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_419(int iParam0)//Position - 0x20F3B
{
	if (!ENTITY::IS_ENTITY_DEAD(func_498(), 0))
	{
...
bool func_420(int iParam0)//Position - 0x20F6E
{
	return MISC::IS_BIT_SET(*iParam0, 1);
}

void func_421(int iParam0)//Position - 0x20F7E
{
	iParam0->f_1 = 0f;
	iParam0->f_2 = 0f;
	*iParam0 = 0;
...
void func_422(int iParam0, char* sParam1, int iParam2)//Position - 0x20F94
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_6(iParam2), 1);
}

float func_423(int iParam0)//Position - 0x20FAB
{
	if (func_420(iParam0))
	{
		if (func_9(iParam0))
...
void func_424(int iParam0)//Position - 0x20FE7
{
	if (!func_420(iParam0))
	{
		func_375(iParam0);
...
void func_425()//Position - 0x21008
{
	Global_19671 = 0;
	func_426();
}

void func_426()//Position - 0x21018
{
...
void func_427(int iParam0)//Position - 0x2106F
{
	if (func_40())
	{
		return;
...
void func_429(bool bParam0, bool bParam1)//Position - 0x21120
{
	if (bParam0)
	{
		if (func_39(0))
...
bool func_430()//Position - 0x21194
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

int func_431()//Position - 0x211A5
{
	if (HUD::IS_PAUSE_MENU_ACTIVE())
	{
		return 0;
...
int func_432(var uParam0)//Position - 0x211D7
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (!func_433(iVar0))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && ENTITY::IS_ENTITY_AT_ENTITY(iVar0, PLAYER::PLAYER_PED_ID(), vLocal_292, 0, 1, 0))
			{
...
int func_433(int iParam0)//Position - 0x2124A
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_434(var uParam0, int iParam1)//Position - 0x2128D
{
	iParam1++;
...
void func_435(int iParam0)//Position - 0x212B1
{
	func_436(iParam0, 0f);
}

void func_436(int iParam0, float fParam1)//Position - 0x212C0
{
	iParam0->f_1 = (func_8(MISC::IS_BIT_SET(*iParam0, 4)) - fParam1);
	MISC::SET_BIT(iParam0, 1);
	MISC::CLEAR_BIT(iParam0, 2);
...
void func_437(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x212EE
{
...
void func_438(var uParam0, char* sParam1, char* sParam2)//Position - 0x21389
{
...
void func_439(float fParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8)//Position - 0x213AD
{
	int iVar0;
	int iVar1;
	...
	else
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(uParam8->f_5, true, 1);
			iLocal_295[1] = uParam8->f_5;
			TASK::CLEAR_PED_TASKS(iLocal_295[1]);
		}
		...
		{
			iLocal_295[1] = PED::CREATE_PED(26, iLocal_331, Param1.f_3, fParam0, 1, true);
		}
		if (DECORATOR::DECOR_EXIST_ON(iLocal_295[1], "Darts_name"))
		{
			iVar0 = DECORATOR::DECOR_GET_INT(iLocal_295[1], "Darts_name");
			if (954610991 == iVar0)
			{
				sLocal_391 = func_445("RAYMOND");
				iLocal_392 = 954610991;
		...
		DECORATOR::DECOR_SET_INT(iLocal_295[1], "Darts_name", iLocal_392);
	}
	iVar1 = ENTITY::GET_ENTITY_MODEL(iLocal_295[1]);
	func_440(iVar1);
	TASK::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_295[1], iLocal_295[0], 0);
	TASK::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_295[0], iLocal_295[1], 0);
}

void func_440(int iParam0)//Position - 0x215A6
{
	int iVar0;
...
int func_441(var uParam0)//Position - 0x21645
{
	int iVar0;
...
int func_442(int iParam0)//Position - 0x2172E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_443(int iParam0)//Position - 0x21774
{
	if (!func_92(iParam0))
	{
		return func_94(iParam0);
...
char* func_445(char* sParam0)//Position - 0x217BC
{
...
void func_446(var uParam0, var uParam1, var uParam2, bool bParam3)//Position - 0x218F6
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_447(var uParam0, var uParam1)//Position - 0x2195E
{
...
void func_448(var uParam0, var uParam1)//Position - 0x21999
{
...
int func_449(var uParam0, var uParam1)//Position - 0x219EB
{
...
bool func_450(char* sParam0, int iParam1, bool bParam2)//Position - 0x21ACF
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool func_451(var uParam0)//Position - 0x21BC5
{
	switch (uParam0->f_9)
	{
		case 0:
...
void func_452(var uParam0, var uParam1)//Position - 0x21C67
{
...
int func_453()//Position - 0x21CD5
{
	return unk_0x67D02A194A2FC2BD("MIDSIZED_MESSAGE");
}

int func_454()//Position - 0x21CE5
{
	return unk_0x67D02A194A2FC2BD("MP_BIG_MESSAGE_FREEMODE");
}

void func_455(var uParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0x21CF5
{
	int iVar0;
	int iVar1;
...
int func_456(vector3 vParam0)//Position - 0x21E11
{
...
void func_457(int iParam0)//Position - 0x21E3B
{
	int iVar0;
...
void func_458(var uParam0, int iParam1)//Position - 0x21F0E
{
	if (iParam1 == 0)
	{
...
void func_459()//Position - 0x21F35
{
	int iVar0;
...
void func_460(vector3 vParam0, float fParam3)//Position - 0x21F5E
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	iLocal_126 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, 1996.235f, 3048.456f, 48.0237f, -3.4831f, 0.0223f, 60.6925f, 38.1f, 0, 2);
...
void func_461(var uParam0, var uParam1)//Position - 0x221C1
{
	uParam0->f_1 = { *uParam1 };
...
void func_462()//Position - 0x2227D
{
	Global_22211.f_6 = 1;
}

void func_463(int iParam0, bool bParam1)//Position - 0x2228B
{
	if (bParam1)
	{
...
var func_464(int iParam0, int iParam1)//Position - 0x222AD
{
	var uVar0;
	int iVar1;
...
var func_465(int iParam0, int iParam1)//Position - 0x222CB
{
	var uVar0;
	var uVar1;
...
void func_466(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0x222E1
{
	switch (iParam0)
	{
		case 0:
...
void func_467(bool bParam0)//Position - 0x22538
{
	if (bParam0)
	{
		func_468();
...
void func_468()//Position - 0x2259B
{
...
void func_469(int iParam0, var uParam1, var uParam2)//Position - 0x225C4
{
	int iVar0;
	int iVar1;
...
void func_470()//Position - 0x22712
{
	func_471();
}

int func_471()//Position - 0x2271F
{
	if (func_472(0))
	{
		return 0;
...
bool func_472(bool bParam0)//Position - 0x2276A
{
...
void func_473(int iParam0, int iParam1, int iParam2)//Position - 0x22795
{
	bool bVar0;
...
void func_474()//Position - 0x2287D
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_475()//Position - 0x22D3E
{
	return Global_30736;
}

void func_476(int iParam0, bool bParam1)//Position - 0x22D49
{
	struct<6> Var0[1];
	struct<8> Var7[1];
...
void func_477(var uParam0)//Position - 0x22DF4
{
	if (uParam0->f_1 != 0)
	{
...
void func_478(var uParam0)//Position - 0x22E9B
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0) && !PED::IS_PED_INJURED(*uParam0))
	{
		TASK::CLEAR_SEQUENCE_TASK(&uLocal_332);
		TASK::OPEN_SEQUENCE_TASK(&uLocal_332);
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_295[0]))
		{
			TASK::TASK_LOOK_AT_ENTITY(0, iLocal_295[0], 8000, 2049, 3);
		}
		...
		if (bLocal_310)
		{
			if (!MISC::IS_BIT_SET(Global_111521, 10))
			{
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_479(iLocal_334 == 2, vLocal_375, vLocal_381), 1f, 20000, 0.25f, 0, func_123(iLocal_334 == 2, fLocal_385, fLocal_387));
			}
			else
			{
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_479(iLocal_334 == 2, vLocal_372, vLocal_378), 1f, 20000, 0.25f, 0, func_123(iLocal_334 == 2, fLocal_384, fLocal_386));
			}
			TASK::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
		}
		else
		{
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_479(iLocal_334 == 2, vLocal_372, vLocal_378), 1f, 20000, 0.25f, 0, func_123(iLocal_334 == 2, 172.6813f, 142.6717f));
			TASK::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_STAND_IMPATIENT", 0, 1);
		}
		TASK::CLOSE_SEQUENCE_TASK(uLocal_332);
		TASK::TASK_PERFORM_SEQUENCE(*uParam0, uLocal_332);
		PED::SET_PED_KEEP_TASK(*uParam0, true);
	}
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_331);
}

Vector3 func_479(bool bParam0, vector3 vParam1, vector3 vParam4)//Position - 0x22FD6
{
	if (bParam0)
	{
		return vParam1;
...
void func_480(int iParam0, var uParam1)//Position - 0x22FF1
{
...
var func_481()//Position - 0x23019
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

void func_482(int iParam0)//Position - 0x23029
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*iParam0))
	{
		GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(iParam0);
...
void func_483(var uParam0)//Position - 0x23045
{
	GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uParam0);
}

void func_484()//Position - 0x23053
{
	HUD::CLEAR_HELP(1);
...
void func_485()//Position - 0x23074
{
...
void func_486(var uParam0)//Position - 0x2308B
{
	int iVar0;
...
void func_487()//Position - 0x230C2
{
	int iVar0;
...
void func_488()//Position - 0x23133
{
	Global_98704 = 1;
...
int func_489(int iParam0)//Position - 0x23222
{
	int iVar0;
	int iVar1;
...
void func_490(var uParam0, int iParam1)//Position - 0x23339
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_492(Global_111560.f_18528[iVar0], &vVar2, &fVar5))
			{
...
void func_491(var uParam0)//Position - 0x23502
{
	*uParam0 = -15;
}

int func_492(int iParam0, var uParam1, float fParam2)//Position - 0x23510
{
	switch (iParam0)
	{
		case 11:
...
void func_493(int iParam0, bool bParam1)//Position - 0x23E7F
{
	if (bParam1)
	{
...
void func_496(int iParam0, bool bParam1)//Position - 0x23F30
{
...
var func_497()//Position - 0x23F95
{
	return Global_94532;
}

int func_498()//Position - 0x23FA1
{
	return Global_94531;
}

void func_499()//Position - 0x23FAD
{
	if (iLocal_290 == 1)
	{
		return;
...
int func_500(int iParam0)//Position - 0x23FD0
{
	int iVar0;
	int iVar1;
