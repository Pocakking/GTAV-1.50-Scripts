...
var func_18(int iParam0)//Position - 0x7CA
{
	return Global_1798[iParam0 /*29*/];
}

void func_19()//Position - 0x7D9
{
	int iVar0;
	int iVar1;
	float fVar2;
...
void func_20(int iParam0, int iParam1)//Position - 0x954
{
...
int func_22(int iParam0)//Position - 0x9AF
{
	switch (iParam0)
	{
		case 0:
...
int func_27(int iParam0)//Position - 0xAF7
{
	if (Global_41396 == 15)
	{
		return 0;
...
bool func_28(int iParam0)//Position - 0xB19
{
	return func_29(iParam0, Global_41396);
}

int func_29(int iParam0, int iParam1)//Position - 0xB2A
{
	if (iParam1 == 15)
	{
		return 1;
