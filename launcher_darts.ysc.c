				...
				case 3:
					...
					else
					{
						...
						if (!func_99(3) && !Global_98703)
						{
							...
							{
								if ((!func_115(uLocal_94, 1) || !ENTITY::DOES_ENTITY_EXIST(func_98())) && !Global_98703)
								{
									func_108(10);
									break;
								}
...
void func_28(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x10CD
{
	int iVar0;
...
int func_30(int iParam0, int iParam1, int iParam2)//Position - 0x1180
{
...
int func_31(int iParam0, int iParam1, int iParam2)//Position - 0x119B
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x11E7
{
	int iVar0;
...
int func_34(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x12AD
{
	int iVar0;
...
void func_35(var uParam0, int iParam1)//Position - 0x13E4
{
	int iVar0;
...
int func_36(int iParam0)//Position - 0x1433
{
	if (Global_41396 == 15)
	{
		return 0;
		...
		else if (iLocal_147 == 1)
		{
			if (fVar32 >= (10f * 10f))
			{
				...
				else
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_143, 0))
					{
						ENTITY::SET_ENTITY_COORDS(iLocal_143, 1991.677f, 3044.957f, 46.21505f, 1, false, 0, 1);
						TASK::TASK_STAND_STILL(iLocal_143, -1);
						if (!ENTITY::IS_ENTITY_ATTACHED(iLocal_143))
						{
							ENTITY::FREEZE_ENTITY_POSITION(iLocal_143, true);
					...
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_144, 0))
					{
						ENTITY::SET_ENTITY_COORDS(iLocal_144, 1990.37f, 3045.121f, 46.21502f, 1, false, 0, 1);
						TASK::TASK_STAND_STILL(iLocal_144, -1);
						if (!ENTITY::IS_ENTITY_ATTACHED(iLocal_144))
						{
							ENTITY::FREEZE_ENTITY_POSITION(iLocal_144, true);
...
void func_38(int iParam0, int iParam1)//Position - 0x1A46
{
	int iVar0;
...
void func_39(int iParam0)//Position - 0x1B3F
{
...
void func_40(int iParam0)//Position - 0x1B8D
{
	struct<7> Var0;
	bool bVar7;
	bool bVar8;
...
int func_42()//Position - 0x20EF
{
	func_43();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_43()//Position - 0x2108
{
	int iVar0;
...
bool func_44(int iParam0)//Position - 0x2205
{
	return iParam0 < 3;
}

int func_45(int iParam0)//Position - 0x2211
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x224E
{
	if (func_44(iParam0))
	{
...
var func_47(int iParam0)//Position - 0x2273
{
	return Global_1798[iParam0 /*29*/];
}

int func_48(int iParam0)//Position - 0x2282
{
	int iVar0;
...
int func_49(int iParam0)//Position - 0x24D7
{
	int iVar0;
...
int func_50(int iParam0)//Position - 0x2543
{
	return iParam0;
}

void func_51(int iParam0, var uParam1)//Position - 0x254D
{
	int iVar0;
	int iVar1;
...
bool func_52(int iParam0)//Position - 0x2EE8
{
	struct<7> Var0;
	int iVar7;
...
int func_53(int iParam0)//Position - 0x2F1C
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

var func_54()//Position - 0x2F2F
{
	var uVar0;
...
void func_55(var uParam0, int iParam1)//Position - 0x2F75
{
	if (iParam1 <= 0)
	{
		return;
...
void func_56(var uParam0, int iParam1)//Position - 0x2FFB
{
...
void func_57(var uParam0, int iParam1)//Position - 0x302E
{
	int iVar0;
	int iVar1;
...
int func_58(int iParam0, int iParam1)//Position - 0x307F
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_59(int iParam0)//Position - 0x3121
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_60(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_60(bool bParam0, int iParam1, int iParam2)//Position - 0x3146
{
	if (bParam0)
	{
		return iParam1;
...
int func_61(var uParam0)//Position - 0x315D
{
	return uParam0 & 15;
}

void func_62(var uParam0, int iParam1)//Position - 0x316A
{
...
void func_63(var uParam0, int iParam1)//Position - 0x31A4
{
...
void func_64(var uParam0, int iParam1)//Position - 0x31DF
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
struct<7> func_65(int iParam0)//Position - 0x321B
{
	struct<7> Var0;
...
int func_67()//Position - 0x5E57
{
	return Global_30737;
}

int func_68()//Position - 0x5E62
{
	return Global_30736;
}

void func_69(int iParam0)//Position - 0x5E6D
{
	if (iParam0 == 2)
	{
	}
...
Vector3 func_71(int iParam0)//Position - 0x5EEF
{
	switch (iParam0)
	{
		case 1:
...
int func_72()//Position - 0x5F31
{
	return 1;
}

int func_73(int iParam0, bool bParam1)//Position - 0x5F3A
{
	int iVar0;
...
int func_74(int iParam0)//Position - 0x5FF2
{
	int iVar0;
...
void func_75(int iParam0)//Position - 0x602D
{
	int iVar0;
...
void func_76(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x6084
{
	int iVar0;
...
int func_77(var uParam0)//Position - 0x61AF
{
	return 1;
}

int func_78(var uParam0, vector3 vParam1, vector3 vParam4, int iParam7)//Position - 0x61B8
{
	int iVar0;
	var uVar1;
	var uVar4;
...
var func_79()//Position - 0x625C
{
	return Global_73784;
}

int func_80(int iParam0)//Position - 0x6268
{
	if (iParam0 == 1)
	{
...
bool func_81(int iParam0, int iParam1)//Position - 0x62C2
{
	switch (iParam0)
	{
		case 5:
...
bool func_82()//Position - 0x62FD
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

int func_83()//Position - 0x6312
{
...
bool func_84(bool bParam0)//Position - 0x632C
{
	if (bParam0)
	{
...
void func_85(var uParam0, int iParam1)//Position - 0x6355
{
	func_86(uParam0, iParam1);
}

void func_86(var uParam0, var uParam1)//Position - 0x6365
{
	*uParam0 = (*uParam0 || uParam1);
}

int func_87()//Position - 0x6376
{
	if (func_101(6) || func_101(7))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
...
int func_89(int iParam0)//Position - 0x64B2
{
	int iVar0;
...
var func_90()//Position - 0x6BCF
{
	return Global_98708.f_1;
}

int func_91()//Position - 0x6BDD
{
	if (Global_95621 != -1)
	{
...
bool func_93()//Position - 0x6C2D
{
	return Global_98721.f_346 > 0;
}

bool func_94()//Position - 0x6C3E
{
	return Global_98721.f_345 > 0;
}

var func_95()//Position - 0x6C4F
{
	return Global_1312873;
}

int func_96()//Position - 0x6C5B
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
var func_98()//Position - 0x6C91
{
	return Global_94531;
}

int func_99(int iParam0)//Position - 0x6C9D
{
	switch (iParam0)
	{
		case 0:
...
bool func_100(int iParam0)//Position - 0x6D0F
{
	int iVar0;
...
bool func_101(int iParam0)//Position - 0x6D4B
{
	return Global_41396 == iParam0;
}

void func_102()//Position - 0x6D59
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	...
	if (bLocal_146)
	{
		...
		if ((fVar6 > 45f || Global_111522) && !ENTITY::DOES_ENTITY_EXIST(iLocal_143))
		{
			if (Global_111522)
			{
				Global_111522 = 0;
			...
			iLocal_143 = PED::CREATE_PED(26, iLocal_141, func_104(iLocal_148 == 1, vVar7, vVar13), func_103(iLocal_148 == 1, fVar19, fVar21), 1, true);
			iLocal_144 = PED::CREATE_PED(26, iLocal_142, func_104(iLocal_148 == 1, vVar10, vVar16), func_103(iLocal_148 == 1, fVar20, fVar22), 1, true);
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_143, true, 0);
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_144, true, 0);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_143, true);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_144, true);
			iLocal_160 = 1;
...
float func_103(bool bParam0, float fParam1, float fParam2)//Position - 0x6F43
{
	if (bParam0)
	{
		return fParam1;
...
Vector3 func_104(bool bParam0, vector3 vParam1, vector3 vParam4)//Position - 0x6F5A
{
	if (bParam0)
	{
		return vParam1;
...
void func_107(var uParam0, int iParam1)//Position - 0x70AD
{
	*uParam0 = (*uParam0 || iParam1);
}

void func_108(int iParam0)//Position - 0x70BE
{
	iLocal_95 = iParam0;
}

void func_109(int iParam0, bool bParam1, bool bParam2)//Position - 0x70CA
{
	int iVar0;
	bool bVar1;
...
bool func_112(int iParam0, int iParam1)//Position - 0x7216
{
	bool bVar0;
...
bool func_113(int iParam0)//Position - 0x7263
{
	return func_114(iParam0, Global_41396);
}

int func_114(int iParam0, int iParam1)//Position - 0x7274
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_115(var uParam0, int iParam1)//Position - 0x7455
{
	return (uParam0 && iParam1) != 0;
}

void func_116()//Position - 0x7464
{
	bool bVar0;
...
void func_117(var uParam0, int iParam1)//Position - 0x74FA
{
	func_118(uParam0, iParam1);
}

void func_118(var uParam0, var uParam1)//Position - 0x750A
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

void func_119(bool bParam0)//Position - 0x751F
{
	if (bParam0)
	{
		if (iLocal_105 != 263)
...
void func_122(int iParam0)//Position - 0x75BA
{
	if (iParam0 != 263)
	{
