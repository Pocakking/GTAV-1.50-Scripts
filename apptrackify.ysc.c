...
{
	fLocal_25 = (Global_4269804[iParam0 /*3*/] - vLocal_20.x);
	fLocal_26 = (SYSTEM::COS(((3.14159f / 180f) * vLocal_20.x)) * (Global_4269804[iParam0 /*3*/].f_1 - vLocal_20.y));
...
{
	fLocal_29 = SYSTEM::SQRT(SYSTEM::VDIST2(Global_4269804[iParam0 /*3*/], vLocal_20));
	fLocal_30 = (Global_4269804[iParam0 /*3*/].f_2 - vLocal_20.z);
	return fLocal_29;
}

float func_13(int iParam0)//Position - 0x735
{
	fLocal_28 = SYSTEM::SQRT((((Global_4269804[iParam0 /*3*/] - vLocal_20.x) * (Global_4269804[iParam0 /*3*/] - vLocal_20.x)) + ((Global_4269804[iParam0 /*3*/].f_1 - vLocal_20.y) * (Global_4269804[iParam0 /*3*/].f_1 - vLocal_20.y))));
	return fLocal_28;
}
