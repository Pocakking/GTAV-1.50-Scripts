				...
				switch (iLocal_94)
				{
					...
					case 1:
						...
						if (!PED::IS_PED_INJURED(iLocal_99))
						{
							...
							{
								TASK::TASK_SMART_FLEE_COORD(iLocal_99, vLocal_95, 200f, -1, 0, 0);
						...
						else
						{
							...
							if (!PED::IS_PED_INJURED(iLocal_100))
							{
								TASK::TASK_SMART_FLEE_COORD(iLocal_100, vLocal_95, 200f, -1, 0, 0);
								...
								if (!MISC::IS_BIT_SET(Global_7356, 11) || func_95())
								{
									if (!PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
									{
										...
										if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
										{
											...
											{
												while ((!func_83(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fLocal_136, 1, 1056964608, 0, 1, 0) || func_94()) || !ENTITY::DOES_ENTITY_HAVE_DRAWABLE(iLocal_101))
												{
													if (!func_83(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fLocal_136, 1, 1056964608, 0, 1, 0))
													{
													}
													if (func_94())
													{
				...
				else
				{
					...
					if (!func_100())
					{
						if (!func_182(iLocal_100, 1227113341) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
						{
							...
							TASK::TASK_GO_TO_ENTITY(iLocal_100, PLAYER::PLAYER_PED_ID(), 20000, 0.5f, 1f, 1073741824, 0);
						}
					}
			...
			switch (iLocal_150)
			{
				case 0:
					if (((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_PRONE(PLAYER::PLAYER_PED_ID())) && !TASK::IS_PED_GETTING_UP(PLAYER::PLAYER_PED_ID()))
					{
							...
							if (!VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
							{
								...
								if (ENTITY::IS_ENTITY_AT_COORD(iVar0, vLocal_126, (vLocal_351.y + 1f), (vLocal_351.y + 1f), 3f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(iVar0, PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_362, sLocal_364, vLocal_126, vLocal_129, 0, 2), (vLocal_351.y + 1f), (vLocal_351.y + 1f), 3f, false, true, 0))
								{
									...
									else
									{
										...
										vLocal_121 = { func_66(vLocal_126, PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_362, sLocal_364, vLocal_126, vLocal_129, 0, 2)) };
						...
						TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_112, cLocal_362, sLocal_363, 1000f, -1000f, 1024, 0, 1148846080, 0);
						PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
						if (!PED::IS_PED_INJURED(iLocal_100))
						{
							TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_100);
							TASK::TASK_SYNCHRONIZED_SCENE(iLocal_100, iLocal_112, cLocal_362, sLocal_364, 1000f, -4f, 0, 0, 1148846080, 0);
						}
				...
				case 1:
					if ((PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_112) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_112) == 1f) || func_49())
					{
						...
						if (func_69(vLocal_95, -526.58f, -1222.79f, 17.46f, 10f, 0))
						{
							...
							{
								TASK::OPEN_SEQUENCE_TASK(&iLocal_105);
								TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_100, 0f, 3.5f, 0f), 1f, 20000, 1048576000, 5, 1193033728);
						...
						{
							TASK::OPEN_SEQUENCE_TASK(&iLocal_105);
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_100, 0f, 2.5f, 0f), 1f, 20000, 1048576000, 5, 1193033728);
							TASK::TASK_WANDER_STANDARD(0, ENTITY::GET_ENTITY_HEADING(iLocal_100), 1);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_105);
							TASK::TASK_PERFORM_SEQUENCE(iLocal_100, iLocal_105);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_105);
...
int func_4(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x2A25
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_5(bool bParam0)//Position - 0x3024
{
	int iVar0;
	int iVar1;
...
void func_6(int iParam0)//Position - 0x32A6
{
	int iVar0;
...
void func_7(int iParam0)//Position - 0x3300
{
	bool bVar0;
	char cVar1[64];
...
char* func_8(int iParam0)//Position - 0x348E
{
	switch (iParam0)
	{
		case 0:
...
void func_10(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x3593
{
	int iVar0;
...
int func_11(var uParam0)//Position - 0x35C3
{
	int iVar0;
	int iVar1;
...
int func_12()//Position - 0x35F7
{
	return Global_1312745;
}

int func_13(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x3603
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_14(int iParam0)//Position - 0x3C55
{
	func_36(93, iParam0);
	func_36(29, iParam0);
	func_36(30, iParam0);
...
bool func_15(int iParam0)//Position - 0x3C75
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_16(int iParam0, int iParam1, int iParam2)//Position - 0x3E25
{
	int iVar0;
	var uVar1;
...
int func_17(int iParam0, int iParam1, int iParam2)//Position - 0x3E57
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_18(int iParam0)//Position - 0x3E94
{
	int iVar0;
...
int func_19(int iParam0, int iParam1)//Position - 0x4232
{
	int iVar0;
...
int func_20(bool bParam0)//Position - 0x45AB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_21(int iParam0, int iParam1)//Position - 0x4662
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_22(int iParam0, int iParam1)//Position - 0x467D
{
...
int func_23(var uParam0, int iParam1)//Position - 0x471A
{
	int iVar0;
	var uVar1[78];
...
int func_24(var uParam0, int iParam1)//Position - 0x47CB
{
	int iVar0;
...
bool func_25(var uParam0, int iParam1)//Position - 0x4846
{
	return (*uParam0)[iParam1] == 78;
}

void func_26(var uParam0)//Position - 0x4857
{
	int iVar0;
...
void func_27(var uParam0, int iParam1)//Position - 0x488B
{
	(*uParam0)[iParam1] = 78;
}

void func_28(var uParam0, float fParam1)//Position - 0x489B
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_29(var uParam0)//Position - 0x48B8
{
	return uParam0->f_80;
}

bool func_30(var uParam0, int iParam1)//Position - 0x48C4
{
	return func_31(uParam0, iParam1) != -1;
}

int func_31(var uParam0, int iParam1)//Position - 0x48D6
{
	int iVar0;
...
bool func_32(var uParam0)//Position - 0x4903
{
	return uParam0->f_79 == 1;
}

int func_33(int iParam0)//Position - 0x4911
{
	switch (iParam0)
	{
		case 60:
...
bool func_34(int iParam0)//Position - 0x4961
{
	return Global_41396 == iParam0;
}

int func_35(int iParam0, int iParam1)//Position - 0x496F
{
	int iVar0;
...
void func_36(int iParam0, int iParam1)//Position - 0x49C0
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x4A92
{
	return Global_1798[iParam0 /*29*/].f_17;
}

int func_39()//Position - 0x4AA3
{
	func_40();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_40()//Position - 0x4ABC
{
	int iVar0;
...
bool func_41(int iParam0)//Position - 0x4BB9
{
	return iParam0 < 3;
}

int func_42(int iParam0)//Position - 0x4BC5
{
	int iVar0;
	int iVar1;
...
int func_43(int iParam0)//Position - 0x4C02
{
	if (func_41(iParam0))
	{
...
var func_44(int iParam0)//Position - 0x4C27
{
	return Global_1798[iParam0 /*29*/];
}

void func_45()//Position - 0x4C36
{
	int iVar0;
...
void func_47(int iParam0)//Position - 0x4C8D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_48(int iParam0, float fParam1, float fParam2)//Position - 0x4CC5
{
	float fVar0;
	float fVar1;
...
int func_50(int iParam0)//Position - 0x4D97
{
...
void func_52(int iParam0, int iParam1)//Position - 0x4E13
{
	int iVar0;
...
int func_53(var uParam0, char* sParam1, char* sParam2, char[4] cParam3, char* sParam4, char[4] cParam5, int iParam6, int iParam7, int iParam8)//Position - 0x4E36
{
	var uVar0;
	var uVar11;
...
int func_54(var uParam0, var uParam1, int iParam2, bool bParam3)//Position - 0x4E8F
{
	int iVar0;
...
bool func_61(int iParam0, int iParam1)//Position - 0x5478
{
	switch (iParam0)
	{
		case 5:
...
void func_63(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16)//Position - 0x550A
{
...
void func_64(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x5592
{
...
bool func_65(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x55E8
{
	if (bParam6)
	{
...
Vector3 func_66(vector3 vParam0, vector3 vParam3)//Position - 0x562F
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
...
Vector3 func_67(vector3 vParam0, float fParam3, struct<2> Param4, var uParam6)//Position - 0x5C30
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
int func_68(int iParam0)//Position - 0x5C7D
{
	if (func_112(iParam0))
	{
...
int func_69(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x5CA7
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_70(int iParam0, var uParam1, var uParam2, char* sParam3, char* sParam4)//Position - 0x5D22
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			case 1:
				if (SHAPETEST::GET_SHAPE_TEST_RESULT(iVar5, &iVar6, &vVar10, &uVar7, &uVar19) == 2)
				{
					...
					else
					{
						if (iVar1 > 0)
						{
							uParam2->f_2 = func_71(vVar13 + Vector(-0.75f, 0f, 0f), *uParam1, 1);
						}
						iVar0++;
					}
				}
...
float func_71(struct<2> Param0, float fParam2, struct<2> Param3, var uParam5, int iParam6)//Position - 0x5EDA
{
	float fVar0;
	float fVar1;
	float fVar2;
...
float func_72(int iParam0, int iParam1, int iParam2)//Position - 0x5F3F
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_73(vector3 vParam0, float fParam3, float fParam4)//Position - 0x5F6B
{
	bool bVar0;
	vector3 vVar1;
	float fVar4;
...
int func_74(int iParam0, float fParam1, float fParam2)//Position - 0x606C
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_75(int iParam0)//Position - 0x60F3
{
	if (func_80())
	{
		return;
...
void func_76(int iParam0)//Position - 0x6126
{
	if (func_80())
	{
		return;
...
void func_77(bool bParam0, bool bParam1)//Position - 0x61B0
{
	if (bParam0)
	{
		if (func_79(0))
...
bool func_78()//Position - 0x6224
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

int func_79(int iParam0)//Position - 0x6235
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
bool func_80()//Position - 0x628F
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

void func_81()//Position - 0x62A1
{
	Global_19671 = 0;
	func_82();
}

void func_82()//Position - 0x62B1
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_83(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x62D2
{
...
void func_84(int iParam0)//Position - 0x6461
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_85(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x648D
{
	if (bParam0)
	{
...
bool func_86()//Position - 0x65C6
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_87(int iParam0, int iParam1)//Position - 0x65E3
{
	bool bVar0;
...
int func_88(int iParam0, bool bParam1)//Position - 0x662E
{
	int iVar0;
	int iVar1;
...
int func_89(int iParam0)//Position - 0x666F
{
...
bool func_90()//Position - 0x66B1
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_91(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x66C2
{
	int iVar0;
...
void func_92(int iParam0)//Position - 0x66F5
{
	if (iParam0 == 1)
	{
...
void func_93()//Position - 0x6718
{
	Global_19671 = 0;
	func_62();
}

int func_94()//Position - 0x6728
{
...
int func_96(bool bParam0, bool bParam1, bool bParam2)//Position - 0x676B
{
	int iVar0;
...
bool func_97(int iParam0)//Position - 0x6850
{
	return func_98(func_99(iParam0));
}

int func_98(char* sParam0)//Position - 0x6862
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

char* func_99(int iParam0)//Position - 0x6875
{
	char* sVar0;
...
void func_102(int iParam0)//Position - 0x6E9C
{
	switch (iParam0)
	{
		case 0:
...
void func_103(char[4] cParam0, int iParam1)//Position - 0x6F7D
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

void func_104(var uParam0)//Position - 0x6F94
{
	*uParam0 = -99;
}

int func_105(int iParam0, bool bParam1, int iParam2)//Position - 0x6FA2
{
	iParam2 = iParam2;
	return func_106(iParam0, bParam1, 145);
}

int func_106(int iParam0, bool bParam1, int iParam2)//Position - 0x6FB8
{
	int iVar0;
...
int func_107(int iParam0, bool bParam1, bool bParam2)//Position - 0x7002
{
	int iVar0;
...
float func_108(bool bParam0, float fParam1, float fParam2)//Position - 0x70A6
{
	if (bParam0)
	{
		return fParam1;
	...
	else
	{
		if (!iLocal_143)
		{
			if (!func_182(iLocal_100, 242628503) && !PED::IS_PED_INJURED(iLocal_100))
			{
				...
				{
					TASK::TASK_GO_STRAIGHT_TO_COORD(0, vLocal_354, 1f, 20000, 1193033728, 0.5f);
				}
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
		...
		else if (!PED::IS_PED_INJURED(iLocal_100))
		{
			if (OBJECT::DOES_PICKUP_EXIST(iLocal_141))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(iLocal_100, OBJECT::GET_PICKUP_COORDS(iLocal_141), 10f, 10f, 7f, false, true, 0))
				{
					TASK::CLEAR_PED_TASKS(iLocal_100);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_105);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, OBJECT::GET_PICKUP_COORDS(iLocal_141), 1f, 20000, 1f, 512, 1193033728);
...
int func_110(int iParam0)//Position - 0x73C6
{
	return func_111(iParam0);
}

int func_111(int iParam0)//Position - 0x73D4
{
	int iVar0;
...
int func_112(int iParam0)//Position - 0x740C
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_115(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)//Position - 0x7668
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_116(int iParam0, char* sParam1, int iParam2)//Position - 0x77C1
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_117(iParam2), 1);
}

int func_117(int iParam0)//Position - 0x77D8
{
	int iVar0;
...
float func_118(int iParam0, int iParam1, bool bParam2)//Position - 0x79CD
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_119(int iParam0, var uParam1)//Position - 0x7A2B
{
	if (HUD::DOES_BLIP_EXIST(iParam0))
	{
...
bool func_120(int iParam0)//Position - 0x7A89
{
	return MISC::IS_BIT_SET(Global_111556, iParam0);
}

void func_121()//Position - 0x7A9B
{
	switch (iLocal_109)
	{
		case 1:
		case 2:
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_117, 0))
			{
				if (iLocal_338)
				{
					...
					{
						TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iLocal_99, iLocal_117, vLocal_95, 8, 35f, 786469, 10f, 10f, 1);
					}
					else
					{
						TASK::TASK_SMART_FLEE_PED(iLocal_99, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
				...
				else
				{
					...
					TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iLocal_99, iLocal_117, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 8, 35f, 786469, 10f, 10f, 1);
				}
			}
			else
			{
		...
		default:
			...
			{
				TASK::TASK_SMART_FLEE_COORD(iLocal_99, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 300f, -1, 0, 0);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_105);
			}
			else if (iLocal_338)
			{
...
bool func_122(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x7C92
{
...
int func_123(char* sParam0, int iParam1, bool bParam2)//Position - 0x7CE0
{
	Global_20806 = 0;
	if (Global_20805 == 0 || Global_20807 == 2)
	{
...
bool func_126(int iParam0)//Position - 0x804E
{
	return func_127(iParam0, 20);
}

bool func_127(int iParam0, int iParam1)//Position - 0x805E
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_128()//Position - 0x8079
{
	return -1;
}

bool func_129()//Position - 0x8082
{
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
...
int func_130(int iParam0)//Position - 0x81D3
{
	if (func_112(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_133(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x8300
{
	vector3 vVar0;
...
int func_134(int iParam0, float fParam1)//Position - 0x83BB
{
	float fVar0;
...
bool func_135(int iParam0, float fParam1)//Position - 0x8431
{
	return func_136(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_136(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x8449
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_137(&(Local_49[iVar4 /*4*/]), vVar1, iParam1, &(Local_49[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_49[iVar4 /*4*/].f_3) < iParam4);
}

int func_137(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x850A
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_138(int iParam0, int iParam1)//Position - 0x8636
{
	int iVar0;
...
int func_140(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x8745
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_141(vector3 vParam0, vector3 vParam3)//Position - 0x87D6
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_142(vector3 vParam0)//Position - 0x87F7
{
	float fVar0;
	float fVar1;
...
void func_143(var uParam0)//Position - 0x8836
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_144(int iParam0, int iParam1)//Position - 0x8851
{
	int iVar0;
...
int func_145(int iParam0)//Position - 0x8890
{
...
bool func_146(int iParam0, int iParam1, float fParam2)//Position - 0x88B8
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_147(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x88FF
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_148(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x89FA
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_149(int iParam0, float fParam1)//Position - 0x8B06
{
	var uVar0;
	vector3 vVar1;
...
int func_150(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0x8B9B
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_151(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x8C29
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_153(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x8CA8
{
	func_154(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_154(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x8CC2
{
	func_155(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_155(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x8CDF
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
	{
	...
	uParam0->f_6 = 2;
	func_156(uParam0, iParam1, vParam2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

void func_156(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x8D17
{
	int iVar0;
	int iVar1;
...
void func_157(var uParam0)//Position - 0x9084
{
...
int func_158(var uParam0)//Position - 0x90ED
{
	int iVar0;
...
int func_159(bool bParam0)//Position - 0x9118
{
	switch (Global_41396)
	{
		case 0:
...
int func_160(char* sParam0)//Position - 0x91C2
{
	if (!func_161(1, 1, 0))
	{
...
int func_161(bool bParam0, bool bParam1, bool bParam2)//Position - 0x925B
{
	int iVar0;
	int iVar1;
...
int func_162(int iParam0)//Position - 0x94B4
{
	if (iParam0 != func_128())
	{
...
int func_163(int iParam0, bool bParam1, bool bParam2)//Position - 0x951A
{
	int iVar0;
...
int func_164(int iParam0, int iParam1)//Position - 0x9564
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
...
int func_165(int iParam0, int iParam1)//Position - 0x95C6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_166()//Position - 0x964B
{
	return Global_2448961.f_17;
}

bool func_167(int iParam0)//Position - 0x9659
{
	return iParam0 == 51;
}

var func_168()//Position - 0x9666
{
	return Global_2448961.f_16;
}

bool func_169()//Position - 0x9674
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

void func_170(var uParam0, int iParam1, vector3 vParam2, int iParam5)//Position - 0x9689
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_171()//Position - 0x9799
{
	return func_172(PLAYER::PLAYER_ID());
}

int func_172(int iParam0)//Position - 0x97A9
{
...
int func_173(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x97C8
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_174(bool bParam0, bool bParam1, bool bParam2)//Position - 0x9B34
{
...
int func_175(bool bParam0, bool bParam1, bool bParam2)//Position - 0x9B86
{
	if (!func_161(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_176(bool bParam0, bool bParam1, bool bParam2)//Position - 0x9BCF
{
	if (!func_161(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_177(bool bParam0, bool bParam1, bool bParam2)//Position - 0x9C2E
{
	if (!func_161(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_178(int iParam0)//Position - 0x9C84
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (ENTITY::IS_ENTITY_A_VEHICLE(iParam0))
...
void func_179()//Position - 0x9CDF
{
	MISC::SET_BIT(&Global_7357, 4);
}

void func_180(var uParam0, int iParam1, int iParam2)//Position - 0x9CEF
{
	char* sVar0;
...
float func_181(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x9DCC
{
	vector3 vVar0;
...
int func_182(int iParam0, int iParam1)//Position - 0x9E06
{
	if (func_130(iParam0))
	{
...
void func_183(char* sParam0)//Position - 0x9E39
{
	func_184(sParam0);
}

void func_184(char* sParam0)//Position - 0x9E47
{
...
void func_185(var uParam0, int iParam1)//Position - 0x9E5A
{
...
int func_187(int iParam0)//Position - 0xA02E
{
	if (func_189())
	{
		Global_111550 = 1;
...
int func_188(int iParam0)//Position - 0xA081
{
	switch (iParam0)
	{
		case 29:
...
int func_190(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xA0E6
{
	int iVar0;
...
void func_191(var uParam0, int iParam1)//Position - 0xA21D
{
	int iVar0;
...
bool func_192(int iParam0)//Position - 0xA26C
{
	return func_193(iParam0, Global_41396);
}

int func_193(int iParam0, int iParam1)//Position - 0xA27D
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_194(int iParam0)//Position - 0xA45E
{
	if (Global_41396 == 15)
	{
		return 0;
...
int func_197()//Position - 0xA659
{
	...
	if (func_199())
	{
		...
		ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_99, 1, 0f);
		switch (func_39())
		{
			case 0:
				sLocal_324 = "MICHAEL";
		...
		if (iLocal_109 == 1 || iLocal_109 == 2)
		{
			...
			if (iLocal_109 == 2)
			{
				VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_117, 0, 0, false);
			}
			else if (iLocal_109 == 1)
			{
...
void func_198(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xAD15
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
int func_200(var uParam0)//Position - 0xAE55
{
	int iVar0;
...
bool func_201(var uParam0)//Position - 0xAEB7
{
	return func_202(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

int func_202(int iParam0, char* sParam1, int iParam2)//Position - 0xAECE
{
...
int func_203(int iParam0)//Position - 0xAFC2
{
	int iVar0;
...
void func_204(var uParam0, char* sParam1)//Position - 0xAFEE
{
	func_205(uParam0, 1, -1, sParam1, 0);
}

void func_205(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4)//Position - 0xB001
{
	int iVar0;
...
void func_206(var uParam0, int iParam1)//Position - 0xB0E9
{
	func_205(uParam0, 0, iParam1, "NULL", 0);
}

void func_207(var uParam0, int iParam1)//Position - 0xB0FD
{
	if (iParam1 > 0)
	{
...
int func_209(float fParam0, bool bParam1)//Position - 0xB19A
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_210(int iParam0, var uParam1)//Position - 0xB251
{
	switch (iParam0)
	{
		case 0:
...
int func_212(int iParam0)//Position - 0xC499
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_213(int iParam0)//Position - 0xC7DF
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_214(int iParam0)//Position - 0xC816
{
	struct<2> Var0;
...
bool func_217()//Position - 0xCCDA
{
	return Global_111278 > 0;
}

int func_218()//Position - 0xCCE8
{
	if (Global_95621 != -1)
	{
		return 1;
...
int func_226(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0xD964
{
...
void func_227(var uParam0)//Position - 0xDB3E
{
	int iVar0;
...
void func_228(int iParam0)//Position - 0xDBC8
{
	func_229(iParam0, &(iParam0->f_2), iParam0->f_1);
}

void func_229(int iParam0, char* sParam1, int iParam2)//Position - 0xDBDE
{
	if (MISC::IS_BIT_SET(*iParam0, 30))
	{
		switch (func_203(*iParam0))
...
void func_230(int iParam0, var uParam1)//Position - 0xDCB8
{
	int iVar0;
	int iVar1;
...
void func_231()//Position - 0xDD57
{
}

void func_232()//Position - 0xDD5F
{
}

void func_233(int iParam0)//Position - 0xDD67
{
	if (iParam0 == -1)
	{
		iParam0 = func_225();
...
void func_235(int iParam0)//Position - 0xDDDA
{
	Global_111549 = iParam0;
}

int func_236(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xDDE8
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
...
bool func_237(int iParam0)//Position - 0xE182
{
	int iVar0;
...
int func_238(int iParam0)//Position - 0xE1A3
{
	return func_239(iParam0, 1);
}

int func_239(int iParam0, int iParam1)//Position - 0xE1B2
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_240(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0xE205
{
	func_241(func_252(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_241(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0xE223
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_242(float fParam0, float fParam1, float fParam2)//Position - 0xE424
{
	float fVar0;
...
int func_243(int iParam0, int iParam1)//Position - 0xE466
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_244(int iParam0)//Position - 0xE508
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_245(int iParam0)//Position - 0xE51B
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_246(int iParam0)//Position - 0xE52E
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_247(int iParam0)//Position - 0xE541
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_248(int iParam0)//Position - 0xE553
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_249(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_249(bool bParam0, int iParam1, int iParam2)//Position - 0xE578
{
	if (bParam0)
	{
		return iParam1;
...
int func_250(int iParam0)//Position - 0xE58F
{
	return iParam0 & 15;
}

int func_251(int iParam0, int iParam1)//Position - 0xE59C
{
	int iVar0;
	int iVar1;
...
void func_253(var uParam0, int iParam1)//Position - 0xE6EE
{
	if (iParam1 <= 0)
	{
		return;
...
void func_254(var uParam0, int iParam1)//Position - 0xE774
{
...
void func_255(var uParam0, int iParam1)//Position - 0xE7A7
{
	int iVar0;
	int iVar1;
...
void func_256(var uParam0, int iParam1)//Position - 0xE7F8
{
...
void func_257(var uParam0, int iParam1)//Position - 0xE832
{
...
void func_258(var uParam0, int iParam1)//Position - 0xE86D
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_259(int iParam0)//Position - 0xE8A9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_260(int iParam0, int iParam1)//Position - 0xE985
{
...
int func_261(int iParam0)//Position - 0xE9A8
{
	int iVar0;
...
var func_262()//Position - 0xF0C5
{
	return Global_98708.f_1;
}

int func_263()//Position - 0xF0D3
{
	if (Global_95621 != -1)
	{
...
bool func_266()//Position - 0xF13D
{
	return Global_98721.f_346 > 0;
}

bool func_267()//Position - 0xF14E
{
	return Global_98721.f_345 > 0;
}

var func_268()//Position - 0xF15F
{
	return Global_1312873;
}

int func_269()//Position - 0xF16B
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_271(int iParam0)//Position - 0xF1AF
{
	return func_251(func_252(), iParam0);
}

int func_272(int iParam0, int iParam1, int iParam2)//Position - 0xF1C1
{
	int iVar0;
	int iVar1;
...
int func_273(int iParam0)//Position - 0xF2A5
{
	if (!func_41(iParam0))
	{
		return 7;
...
bool func_274(int iParam0)//Position - 0xF2C9
{
	int iVar0;
	bool bVar1;
...
bool func_276(bool bParam0)//Position - 0xF36B
{
...
void func_279(int iParam0)//Position - 0xF52D
{
	char cVar0[64];
...
void func_280(var uParam0)//Position - 0xF5E2
{
	if (*uParam0 == -1)
	{
		return;
...
int func_281(int iParam0)//Position - 0xF61F
{
	int iVar0;
...
char* func_282(int iParam0, bool bParam1)//Position - 0xF6D0
{
	switch (iParam0)
	{
		case 0:
...
void func_283(int iParam0)//Position - 0xF919
{
	Global_41947 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_284(int iParam0)//Position - 0xF92B
{
	func_285(iParam0, 0, func_290(iParam0));
}

void func_285(int iParam0, int iParam1, int iParam2)//Position - 0xF940
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_286(var uParam0)//Position - 0xF96F
{
	struct<16> Var0;
	int iVar16;
...
void func_287(int iParam0, var uParam1)//Position - 0xFA3F
{
	Global_111560.f_24990.f_43[iParam0] = *uParam1;
}

void func_288(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xFA57
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_289(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xFBD9
{
...
int func_290(int iParam0)//Position - 0xFC11
{
	int iVar0;
...
void func_291(var uParam0, bool bParam1)//Position - 0xFDB4
{
	int iVar0;
...
void func_292(var uParam0)//Position - 0xFDEF
{
	*uParam0 = 0;
	uParam0->f_1 = -1;
...
void func_293(var uParam0)//Position - 0xFE08
{
	int iVar0;
...
void func_294(var uParam0)//Position - 0xFE41
{
	func_295(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

void func_295(int iParam0, char* sParam1, int iParam2)//Position - 0xFE58
{
	if (MISC::IS_BIT_SET(iParam0, 30))
	{
		switch (func_203(iParam0))
...
void func_296(bool bParam0)//Position - 0xFF18
{
	Global_111552 = { vLocal_95 };
	if (bParam0)
	{
		func_311(3);
	}
...
void func_297()//Position - 0xFF4D
{
	func_298();
}

int func_298()//Position - 0xFF5A
{
	if (func_276(0))
	{
		return 0;
...
int func_299()//Position - 0xFFA5
{
	return 1;
}

void func_300(int iParam0, int iParam1)//Position - 0xFFAE
{
	if (iParam0 == -1)
	{
		iParam0 = func_225();
...
void func_301(int iParam0, var uParam1, var uParam2)//Position - 0x100B3
{
	bool bVar0;
...
void func_302()//Position - 0x1019B
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_303()//Position - 0x1065C
{
	return Global_30736;
}

int func_304(int iParam0, int iParam1)//Position - 0x10667
{
	switch (iParam0)
	{
		case 0:
...
void func_305(int iParam0)//Position - 0x109DB
{
	int iVar0;
	int iVar1;
...
void func_306(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x10A1D
{
	func_307(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_307(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x10A3E
{
	int iVar0;
...
void func_308()//Position - 0x10C11
{
	int iVar0;
...
int func_309(int iParam0)//Position - 0x10D31
{
	int iVar0;
	int iVar1;
...
void func_310(int iParam0, int iParam1)//Position - 0x10D74
{
	MISC::SET_BIT(&(Global_111560.f_24990.f_8[iParam0]), iParam1);
}

void func_311(int iParam0)//Position - 0x10D8F
{
