	...
	switch (iLocal_36)
	{
		case 0:
			...
			if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
			{
				...
				while (iVar4 <= 5)
				{
					if (ENTITY::DOES_ENTITY_EXIST(Global_110270.f_225[iVar4]))
					{
						uLocal_284[iVar4] = Global_110270.f_225[iVar4];
						Global_110270.f_225[iVar4] = 0;
				...
				while (iVar4 <= 1)
				{
					if (ENTITY::DOES_ENTITY_EXIST(Global_110270.f_222[iVar4]))
					{
						uLocal_281[iVar4] = Global_110270.f_222[iVar4];
						Global_110270.f_222[iVar4] = 0;
...
bool func_14(int iParam0)//Position - 0xDE8
{
	return func_15(iParam0, 20);
}

bool func_15(int iParam0, int iParam1)//Position - 0xDF8
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_16()//Position - 0xE13
{
	return -1;
}

void func_17()//Position - 0xE1C
{
	int iVar0;
...
int func_22()//Position - 0x1044
{
	func_23();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_23()//Position - 0x105D
{
	int iVar0;
...
bool func_24(int iParam0)//Position - 0x115A
{
	return iParam0 < 3;
}

int func_25(int iParam0)//Position - 0x1166
{
	int iVar0;
	int iVar1;
...
int func_26(int iParam0)//Position - 0x11A3
{
	if (func_24(iParam0))
	{
...
var func_27(int iParam0)//Position - 0x11C8
{
	return Global_1798[iParam0 /*29*/];
}

bool func_28(int iParam0)//Position - 0x11D7
{
	return Global_41396 == iParam0;
}

void func_29()//Position - 0x11E5
{
	int iVar0;
...
bool func_30(int iParam0, int iParam1)//Position - 0x123C
{
	switch (iParam0)
	{
		case 5:
...
void func_32(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x12CE
{
...
struct<4> func_33(char* sParam0)//Position - 0x1324
{
	struct<4> Var0;
...
void func_34(int iParam0, char* sParam1, int iParam2)//Position - 0x136F
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_35(iParam2), 1);
}

int func_35(int iParam0)//Position - 0x1386
{
	int iVar0;
...
int func_38(int iParam0, int iParam1, bool bParam2)//Position - 0x160F
{
	int iVar0;
...
void func_39(int iParam0, vector3 vParam1)//Position - 0x1655
{
	int iVar0;
	int iVar1;
	int iVar2;
...
Vector3 func_40(vector3 vParam0, float fParam3)//Position - 0x1839
{
	vector3 vVar0;
...
Vector3 func_41(vector3 vParam0, float fParam3)//Position - 0x186B
{
	float fVar0;
...
int func_42(vector3 vParam0)//Position - 0x18A2
{
...
int func_43(int iParam0)//Position - 0x18CC
{
	int iVar0;
...
bool func_44(var uParam0, int iParam1)//Position - 0x1A39
{
	return (uParam0 && iParam1) != 0;
}

void func_45()//Position - 0x1A48
{
	int iVar0;
	var uVar1[2];
	int iVar4;
				...
				case 2:
					if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_284[iVar0], 0))
					{
						...
						else if (func_46(uLocal_284[iVar0], 0) == -1)
						{
							...
							{
								TASK::TASK_VEHICLE_ESCORT(uLocal_284[iVar0], PED::GET_VEHICLE_PED_IS_IN(uLocal_284[iVar0], 0), PED::GET_VEHICLE_PED_IS_IN(uLocal_284[iLocal_276], 0), -1, 40f, 786468, -1f, 20, 20f);
							}
							else if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_284[iVar0], -1273030092) == 1)
							{
								if (!TASK::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(uLocal_284[iVar0]))
...
int func_46(int iParam0, int iParam1)//Position - 0x236B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_47()//Position - 0x23F0
{
	func_62(1);
	func_61();
}

void func_48(char* sParam0, int iParam1, int iParam2)//Position - 0x2401
{
	iParam2 = iParam2;
...
int func_49(int iParam0, bool bParam1, int iParam2)//Position - 0x241A
{
	int iVar0;
...
int func_50(int iParam0, bool bParam1, bool bParam2)//Position - 0x2464
{
	int iVar0;
...
float func_51(bool bParam0, float fParam1, float fParam2)//Position - 0x2508
{
	if (bParam0)
	{
		return fParam1;
...
void func_52(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5)//Position - 0x251F
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
char* func_55(int iParam0)//Position - 0x276B
{
	switch (iParam0)
	{
		case 1:
...
char* func_56(int iParam0)//Position - 0x27B6
{
	switch (iParam0)
	{
		case 1:
...
void func_57(var uParam0, int iParam1, int iParam2)//Position - 0x2801
{
	switch (iParam1)
	{
		case 11:
...
int func_58()//Position - 0x2F68
{
	return func_59(Global_110270.f_20, Global_110270.f_29);
}

int func_59(var uParam0, int iParam1)//Position - 0x2F80
{
	uParam0 = uParam0;
	switch (iParam1)
	{
...
void func_60(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2FAE
{
...
void func_62(int iParam0)//Position - 0x3118
{
