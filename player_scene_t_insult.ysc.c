...
bool func_7(int iParam0)//Position - 0x5CA
{
	return func_8(iParam0, 20);
}

bool func_8(int iParam0, int iParam1)//Position - 0x5DA
{
...
var func_15()//Position - 0x825
{
	func_16();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_16()//Position - 0x83E
{
	int iVar0;
...
bool func_17(int iParam0)//Position - 0x93B
{
	return iParam0 < 3;
}

int func_18(int iParam0)//Position - 0x947
{
	int iVar0;
	int iVar1;
...
int func_19(int iParam0)//Position - 0x984
{
	if (func_17(iParam0))
	{
...
var func_20(int iParam0)//Position - 0x9A9
{
	return Global_1798[iParam0 /*29*/];
}

bool func_21(int iParam0)//Position - 0x9B8
{
	return Global_41396 == iParam0;
}

void func_22()//Position - 0x9C6
{
	int iVar0;
...
bool func_23(int iParam0, int iParam1)//Position - 0xA1C
{
	switch (iParam0)
	{
		case 5:
...
void func_25(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0xAAE
{
...
void func_26(int iParam0, int iParam1)//Position - 0xB04
{
	float fVar0;
	float fVar1;
	float fVar2;
		...
		switch (iLocal_240[iParam1])
		{
			case 0:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, &Local_345, &(Local_394[iParam1 /*16*/]), 2))
				{
					...
					if (ENTITY::FIND_ANIM_EVENT_PHASE(&Local_345, &(Local_394[iParam1 /*16*/]), "WalkInterruptible", &fVar0, &fVar1) || func_35(&Local_345, &(Local_394[iParam1 /*16*/]), "WalkInterruptible", &fVar0, &fVar1))
					{
						...
						if (fVar2 > fVar0)
						{
							...
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, vLocal_273 + vLocal_284[iParam1 /*3*/], fVar3, -1, (fLocal_294[iParam1] * 0.1f), 0, 1193033728);
				...
				else
				{
					...
					if (MISC::IS_STRING_NULL_OR_EMPTY(&(Local_427[iParam1 /*16*/])))
					{
						...
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, vLocal_273 + vLocal_284[iParam1 /*3*/], 1f, -1, 1048576000, 0, 1193033728);
						iLocal_240[iParam1] = 1;
					}
					else
					{
						...
						while (iVar11 < iLocal_253)
						{
							if (iLocal_256[iVar11] != 0)
							{
								...
								{
									ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar11], iLocal_724, &(Local_592[iVar11 /*16*/]), &Local_345, 8f, 8f, 0, 1148846080);
								}
							}
							iVar11++;
						}
			...
			case 1:
				...
				if (TASK::GET_SCRIPT_TASK_STATUS(iParam0, 713668775) != 1)
				{
					...
					TASK::TASK_WANDER_IN_AREA(iParam0, vLocal_273 + vLocal_284[iParam1 /*3*/], fLocal_294[iParam1], 1077936128, 1086324736);
			...
			case 10:
				...
				else
				{
					...
					while (iVar16 < iLocal_253)
					{
						if (iLocal_256[iVar16] != 0)
						{
							...
							{
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar16], iLocal_724, &(Local_592[iVar16 /*16*/]), &Local_345, 8f, 8f, 0, 1148846080);
							}
						}
						iVar16++;
					}
				...
				if (bVar18)
				{
					...
					PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_724, true);
					...
					while (iVar22 < iLocal_253)
					{
						if (iLocal_256[iVar22] != 0)
						{
							...
							{
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar22], iLocal_724, &(Local_625[iVar22 /*16*/]), &Local_345, 8f, 8f, 0, 1148846080);
			...
			case 11:
				...
				if (!bVar23)
				{
					...
					PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_724, false);
					PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_724, true);
					iVar24 = 0;
					iVar25 = 180;
					iVar26 = 0;
					...
					while (iVar27 < iLocal_253)
					{
						if (iLocal_256[iVar27] != 0)
						{
							...
							{
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar27], iLocal_724, &(Local_658[iVar27 /*16*/]), &Local_345, 8f, 8f, 0, 1148846080);
							}
						}
						iVar27++;
					}
			...
			case 12:
				...
				if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_237[iParam1], &Local_345, &(Local_493[iParam1 /*16*/]), 2))
				{
					...
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iParam1], iLocal_724, &Local_345, &(Local_493[iParam1 /*16*/]), 1000f, -1000f, 0, 0, 1148846080, 0);
					iVar28 = 0;
					while (iVar28 < iLocal_253)
					{
						if (iLocal_256[iVar28] != 0)
						{
							...
							{
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar28], iLocal_724, &(Local_658[iVar28 /*16*/]), &Local_345, 8f, 8f, 0, 1148846080);
							}
						}
						iVar28++;
					}
...
void func_27(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x15F6
{
...
int func_28(int iParam0)//Position - 0x1691
{
	int iVar0;
...
int func_29(int iParam0)//Position - 0x172F
{
	int iVar0;
	float fVar1;
...
void func_30(int iParam0, int iParam1)//Position - 0x17DA
{
	*iParam0 = (*iParam0 || iParam1);
}

bool func_31(int iParam0, int iParam1)//Position - 0x17EB
{
	return (iParam0 && iParam1) != 0;
}

bool func_32(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x17FA
{
	if (bParam6)
	{
...
void func_33(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x1841
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_34(iParam3), 0);
}

int func_34(int iParam0)//Position - 0x185A
{
	int iVar0;
...
int func_35(char* sParam0, char* sParam1, char* sParam2, float fParam3, float fParam4)//Position - 0x1A49
{
		...
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96029))
		{
			...
			while (iVar0 < iLocal_237)
			{
				if (!PED::IS_PED_INJURED(iLocal_237[iVar0]))
				{
					...
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iVar0], Global_96029, &Local_345, &(Local_394[iVar0 /*16*/]), 1000f, fVar1, iVar2, iVar3, fVar4, iVar5);
					iLocal_240[iVar0] = 0;
				}
				iVar0++;
			}
			...
			while (iVar0 < iLocal_253)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_253[iVar0]))
				{
					...
					{
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar0], Global_96029, &(Local_559[iVar0 /*16*/]), &Local_345, 8f, -1000f, 0, 1148846080);
					}
				}
				iVar0++;
			}
...
int func_38()//Position - 0x1C77
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96028))
	{
		...
		while (iVar0 < iLocal_237)
		{
			if (!PED::IS_PED_INJURED(iLocal_237[iVar0]))
			{
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iVar0], Global_96028, &Local_345, &(Local_361[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
			}
			iVar0++;
		}
		iVar0 = 0;
		while (iVar0 < iLocal_253)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_253[iVar0]))
			{
				...
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar0], Global_96028, &(Local_526[iVar0 /*16*/]), &Local_345, 8f, -1000f, 0, 1148846080);
				}
			}
			iVar0++;
		}
...
int func_39(int iParam0, int iParam1)//Position - 0x1D73
{
	vector3 vVar0;
	float fVar3;
...
int func_40(var uParam0)//Position - 0x1E57
{
	return uParam0;
}

bool func_41(var uParam0, var uParam1)//Position - 0x1E61
{
	return (uParam0 && uParam1) != 0;
}

int func_42()//Position - 0x1E70
{
	func_16();
...
void func_44()//Position - 0x1EF6
{
	func_45((Global_98392 - 1));
}

void func_45(int iParam0)//Position - 0x1F08
{
	Global_98392 = iParam0;
}

void func_46()//Position - 0x1F16
{
	func_45(0);
}

void func_47()//Position - 0x1F23
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	while (iVar0 < iLocal_237)
	{
		if (iLocal_243[iVar0] != 0)
		{
			iLocal_237[iVar0] = PED::CREATE_PED(26, iLocal_243[iVar0], vLocal_273 + vLocal_277[iVar0 /*3*/], 0f, 1, true);
			...
			TASK::TASK_PLAY_ANIM(iLocal_237[iVar0], &Local_345, &(Local_361[iVar0 /*16*/]), 8f, -8f, -1, 1, 0f, 0, 0, 0);
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_253)
	{
		if (iLocal_256[iVar0] != 0)
		{
			...
			ENTITY::SET_ENTITY_ROTATION(iLocal_253[iVar0], Vector((fLocal_276 + fLocal_291[iVar0]), 0f, 0f) + vLocal_266[iVar0 /*3*/], 2, 1);
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_526[iVar0 /*16*/])))
			{
				ENTITY::PLAY_ENTITY_ANIM(iLocal_253[iVar0], &(Local_526[iVar0 /*16*/]), &Local_345, 8f, true, 0, 0, 0f, 0);
			}
		}
		iVar0++;
	}
...
int func_49(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5)//Position - 0x2A42
{
	*uParam4 = 9;
	*uParam5 = 0;
	switch (iParam0)
...
void func_50(int iParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0x4180
{
...
int func_51(int iParam0, var uParam1, var uParam2, char* sParam3)//Position - 0x41A0
{
	int iVar0;
...
bool func_52(var uParam0)//Position - 0x438B
{
	int iVar0;
	vector3 vVar1;
	float fVar4;
...
int func_53(int iParam0, var uParam1, char* sParam2)//Position - 0x4446
{
	vector3 vVar0;
	int iVar3;
	var uVar4;
...
int func_54(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0x6852
{
	switch (iParam1)
	{
		case 0:
...
int func_56(int iParam0, var uParam1, var uParam2)//Position - 0x87C5
{
	switch (iParam0)
	{
		case 11:
...
char* func_57(int iParam0)//Position - 0x9134
{
	switch (iParam0)
	{
		case 2014101067:
