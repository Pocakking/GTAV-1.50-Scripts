...
void func_1(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0xE8
{
	func_2(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_2(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x111
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
var func_12(int iParam0)//Position - 0x803
{
	return Global_1798[iParam0 /*29*/];
}

int func_13(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x812
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_14(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0xB08
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_15(vector3 vParam0)//Position - 0xBBC
{
	float fVar0;
	float fVar1;
...
void func_16(int iParam0)//Position - 0xBFB
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_17()//Position - 0xC60
{
	Global_110584 = 1;
}

void func_18()//Position - 0xC6D
{
	int iVar0;
...
void func_19(int iParam0)//Position - 0xCCD
{
...
void func_21(bool bParam0, int iParam1)//Position - 0xCF6
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_23(int iParam0)//Position - 0xE01
{
	switch (iParam0)
	{
		case 71:
...
bool func_24(bool bParam0)//Position - 0xE3F
{
...
void func_25(int iParam0, int iParam1)//Position - 0xE6A
{
