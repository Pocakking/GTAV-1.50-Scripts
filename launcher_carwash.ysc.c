...
int func_13(var uParam0, char[4] cParam1, int iParam2)//Position - 0xCB0
{
...
void func_14(char[4] cParam0, int iParam1)//Position - 0xCFC
{
...
int func_22(var uParam0, char[4] cParam1)//Position - 0xEFF
{
	if (MISC::IS_STRING_NULL_OR_EMPTY(cParam1))
	{
		return 0;
...
void func_23(char[4] cParam0)//Position - 0xF48
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 1, true, -1);
}
...
var func_37(int iParam0)//Position - 0x12EA
{
	return Global_1798[iParam0 /*29*/];
}

var func_38(int iParam0)//Position - 0x12F9
{
	var uVar0;
...
int func_39(int iParam0)//Position - 0x130B
{
	if (iParam0 > -1)
	{
...
int func_40(int iParam0)//Position - 0x134E
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_41(var uParam0, int iParam1)//Position - 0x1373
{
	uParam0->f_13 = iParam1;
	func_24(uParam0);
}

bool func_42(var uParam0)//Position - 0x1387
{
	func_70(PLAYER::PLAYER_PED_ID());
	if (*uParam0 == 0)
	{
...
bool func_43()//Position - 0x143F
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

bool func_44(bool bParam0)//Position - 0x1454
{
	if (bParam0)
	{
...
int func_45(int iParam0)//Position - 0x147D
{
	if (iParam0 == 0)
	{
		if (func_51())
...
int func_46(int iParam0)//Position - 0x14E9
{
	if (func_49(iParam0))
	{
		return 1;
...
int func_47(int iParam0)//Position - 0x150C
{
	int iVar0;
...
bool func_48(int iParam0, int iParam1)//Position - 0x152A
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_49(var uParam0)//Position - 0x1545
{
	int iVar0;
...
int func_50(int iParam0)//Position - 0x156B
{
	if (iParam0 == 1)
	{
...
void func_53(vector3 vParam0, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x160F
{
	int iVar0;
	float fVar1;
	vector3 vVar2;
...
void func_55(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x16EA
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
Vector3 func_56(vector3 vParam0, vector3 vParam3)//Position - 0x18FA
{
...
void func_57(int iParam0)//Position - 0x1933
{
	...
	if (iLocal_117[iParam0] == 0)
	{
		...
		{
			iLocal_117[iParam0] = SHAPETEST::START_SHAPE_TEST_SWEPT_SPHERE(vLocal_107[iParam0 /*3*/], vLocal_107[iParam0 /*3*/] + Vector(1f, 0f, 0f), 2f, 2, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 4);
		}
	}
	else
	{
...
int func_61(int iParam0)//Position - 0x1C11
{
	int iVar0;
...
int func_62(int iParam0)//Position - 0x1D49
{
...
float func_63(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x1F26
{
	vector3 vVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x1FEE
{
...
void func_66(var uParam0, vector3 vParam1, float fParam4)//Position - 0x2082
{
	uParam0->f_12 = { func_20(vParam1 * Vector(5f, 5f, 5f)) };
	uParam0->f_15 = func_67(fParam4, 0f, 360f);
}

float func_67(float fParam0, float fParam1, float fParam2)//Position - 0x20AB
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
void func_68(var uParam0, int iParam1, char* sParam2, vector3 vParam3, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0x20D2
{
	uParam0->f_5 = sParam2;
	uParam0->f_1 = { vParam3 };
	uParam0->f_4 = sParam7;
...
Vector3 func_69(int iParam0)//Position - 0x2147
{
	int iVar0;
...
bool func_70(int iParam0)//Position - 0x215F
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
void func_72(var uParam0)//Position - 0x2195
{
	int iVar0;
...
void func_73(var uParam0)//Position - 0x21BE
{
	*uParam0 = 0;
}
