							...
							if (!PED::IS_PED_INJURED(iLocal_58))
							{
								if (ENTITY::IS_ENTITY_AT_COORD(iLocal_58, vLocal_118, 5f, 5f, 5f, false, true, 0))
								{
									if (!ENTITY::DOES_ENTITY_EXIST(iLocal_121[8]))
									{
										...
										ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_121[8], iLocal_58, PED::GET_PED_BONE_INDEX(iLocal_58, 57005), 0f, -0.15f, -0.05f, 70f, 110f, 200f, 1, 0, 0, 0, 2, 1);
									}
									func_46(0);
									SYSTEM::WAIT(0);
									func_55();
...
void func_1()//Position - 0x4AA
{
	...
	if (iLocal_150 && !iLocal_149)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_121[8]))
		{
			iLocal_133 = OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_weapon_golfclub"), ENTITY::GET_ENTITY_COORDS(iLocal_121[8], true), ENTITY::GET_ENTITY_ROTATION(iLocal_121[8], 2) + Vector(2.8157f, -159.5768f, -14.1956f), 0, -1, 2, 1, 0);
			OBJECT::DELETE_OBJECT(&(iLocal_121[8]));
		}
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_63 - Vector(10f, 10f, 10f), vLocal_63 + Vector(10f, 10f, 10f), true, 1);
		...
		while (iVar0 < iLocal_121)
		{
			...
			{
				ENTITY::DETACH_ENTITY(iLocal_121[iVar0], 1, true);
			}
			iVar0++;
		}
...
void func_6(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x77D
{
	int iVar0;
...
int func_7(var uParam0)//Position - 0x7AD
{
	int iVar0;
	int iVar1;
...
int func_8()//Position - 0x7E1
{
	return Global_1312745;
}

int func_9(int iParam0, int iParam1, int iParam2)//Position - 0x7ED
{
	int iVar0;
	var uVar1;
...
int func_11()//Position - 0xB4F
{
	return Global_30736;
}

void func_12(int iParam0, int iParam1, bool bParam2)//Position - 0xB5A
{
	int iVar0;
...
int func_13(int iParam0, int iParam1, bool bParam2)//Position - 0xBCC
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_15()//Position - 0xC7A
{
	func_16();
}

int func_16()//Position - 0xC87
{
	if (func_17(0))
	{
		return 0;
...
bool func_17(bool bParam0)//Position - 0xCD2
{
...
void func_18(int iParam0, int iParam1)//Position - 0xCFD
{
	if (iParam0 == -1)
	{
		iParam0 = func_40();
...
void func_19(int iParam0)//Position - 0xE00
{
	Global_111546 = iParam0;
}

void func_20(int iParam0, var uParam1, var uParam2)//Position - 0xE0E
{
	bool bVar0;
...
int func_22(int iParam0, int iParam1)//Position - 0x13B7
{
	int iVar0;
...
int func_23(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1408
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_24(int iParam0, int iParam1)//Position - 0x1A51
{
	switch (iParam0)
	{
		case 0:
...
int func_25(int iParam0)//Position - 0x1DC5
{
	switch (iParam0)
	{
		case 29:
...
void func_26(int iParam0)//Position - 0x1DF4
{
	int iVar0;
	int iVar1;
...
void func_27(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x1E36
{
	func_28(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_28(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x1E56
{
	int iVar0;
...
bool func_32(int iParam0)//Position - 0x228B
{
	return Global_41396 == iParam0;
}

bool func_33(int iParam0)//Position - 0x2299
{
	return iParam0 < 3;
}

int func_34(int iParam0)//Position - 0x22A5
{
	int iVar0;
	int iVar1;
...
int func_35(int iParam0)//Position - 0x22E2
{
	if (func_33(iParam0))
	{
...
var func_36(int iParam0)//Position - 0x2307
{
	return Global_1798[iParam0 /*29*/];
}

int func_37(int iParam0)//Position - 0x2316
{
	int iVar0;
	int iVar1;
...
void func_38(int iParam0, int iParam1)//Position - 0x2359
{
	MISC::SET_BIT(&(Global_111560.f_24990.f_8[iParam0]), iParam1);
}

int func_39(int iParam0)//Position - 0x2374
{
	int iVar0;
...
int func_41(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x2442
{
...
int func_42()//Position - 0x261C
{
	return (Global_111560.f_10011.f_21 + Global_111560.f_18569.f_380);
}

int func_43()//Position - 0x2638
{
	return 1;
}

int func_44()//Position - 0x2641
{
	if (Global_30972)
	{
		func_19(4);
...
void func_46(int iParam0)//Position - 0x267A
{
	Global_21816 = iParam0;
}

int func_47()//Position - 0x2687
{
...
bool func_48()//Position - 0x26A3
{
	return Global_30971;
}

void func_49(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x26AE
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_50(iParam3), 0);
}

int func_50(int iParam0)//Position - 0x26C7
{
	int iVar0;
...
void func_51()//Position - 0x28BC
{
	iLocal_48 = 3;
}

int func_52()//Position - 0x28C7
{
...
int func_54()//Position - 0x2985
{
	func_31();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_55()//Position - 0x299E
{
	Global_19671 = 0;
	func_56();
}

void func_56()//Position - 0x29AE
{
...
void func_57(bool bParam0)//Position - 0x29CF
{
	if (bParam0)
	{
		if (iLocal_71)
...
void func_58()//Position - 0x2A2B
{
	Global_19671 = 0;
	func_59();
}

void func_59()//Position - 0x2A3B
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
struct<6> func_60()//Position - 0x2A5F
{
	struct<6> Var0;
	int iVar6;
...
struct<6> func_61()//Position - 0x2AA5
{
	struct<6> Var0;
...
int func_63(char* sParam0)//Position - 0x2B40
{
	var uVar0;
...
bool func_64(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2B68
{
...
int func_65(char* sParam0, int iParam1, bool bParam2)//Position - 0x2BBC
{
	Global_20806 = 0;
...
bool func_68(int iParam0)//Position - 0x2F29
{
	return func_69(iParam0, 20);
}

bool func_69(int iParam0, int iParam1)//Position - 0x2F39
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_70()//Position - 0x2F54
{
	return -1;
}

void func_71()//Position - 0x2F5D
{
	int iVar0;
...
bool func_77(int iParam0, int iParam1)//Position - 0x31DA
{
	switch (iParam0)
	{
		case 5:
...
void func_79(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x326C
{
...
int func_80(vector3 vParam0)//Position - 0x32C2
{
	if (func_54() == 2)
	{
	...
	switch (iLocal_143)
	{
		...
		case 2:
			...
			if (!PED::IS_PED_INJURED(iLocal_58))
			{
				...
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_115, 1f, -1, 0.25f, 0, 311.3569f);
...
void func_83(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x36E0
{
	int iVar0;
	int iVar1;
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x37B2
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_85(bool bParam0)//Position - 0x3DB1
{
	int iVar0;
	int iVar1;
...
void func_86(int iParam0)//Position - 0x4035
{
	int iVar0;
...
void func_87(int iParam0)//Position - 0x408F
{
	bool bVar0;
	char cVar1[64];
...
char* func_88(int iParam0)//Position - 0x421E
{
	switch (iParam0)
	{
		case 0:
...
void func_90(int iParam0)//Position - 0x4326
{
	func_110(93, iParam0);
	func_110(29, iParam0);
	func_110(30, iParam0);
...
bool func_91(int iParam0)//Position - 0x4346
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_92(int iParam0, int iParam1, int iParam2)//Position - 0x44F6
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_93(int iParam0)//Position - 0x4533
{
	int iVar0;
...
int func_94(int iParam0, int iParam1)//Position - 0x48CF
{
	int iVar0;
...
int func_95(bool bParam0)//Position - 0x4C3F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_96(int iParam0, int iParam1)//Position - 0x4CF6
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_97(int iParam0, int iParam1)//Position - 0x4D11
{
...
int func_98(var uParam0, int iParam1)//Position - 0x4DAE
{
	int iVar0;
	var uVar1[78];
...
int func_99(var uParam0, int iParam1)//Position - 0x4E5F
{
	int iVar0;
...
bool func_100(var uParam0, int iParam1)//Position - 0x4EDA
{
	return (*uParam0)[iParam1] == 78;
}

void func_101(var uParam0)//Position - 0x4EEB
{
	int iVar0;
...
void func_102(var uParam0, int iParam1)//Position - 0x4F1F
{
	(*uParam0)[iParam1] = 78;
}

void func_103(var uParam0, float fParam1)//Position - 0x4F2F
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_104(var uParam0)//Position - 0x4F4C
{
	return uParam0->f_80;
}

bool func_105(var uParam0, int iParam1)//Position - 0x4F58
{
	return func_106(uParam0, iParam1) != -1;
}

int func_106(var uParam0, int iParam1)//Position - 0x4F6A
{
	int iVar0;
...
bool func_107(var uParam0)//Position - 0x4F97
{
	return uParam0->f_79 == 1;
}

int func_108(int iParam0)//Position - 0x4FA5
{
	switch (iParam0)
	{
		case 60:
...
void func_109(int iParam0, int iParam1)//Position - 0x4FF5
{
	int iVar0;
...
void func_110(int iParam0, int iParam1)//Position - 0x5018
{
	int iVar0;
...
int func_112(int iParam0)//Position - 0x50EA
{
	return Global_1798[iParam0 /*29*/].f_17;
}

void func_113(var uParam0, int iParam1)//Position - 0x50FB
{
	*uParam0 = (*uParam0 || iParam1);
}

void func_114(var uParam0, int iParam1)//Position - 0x510C
{
	uParam0->f_23 = (uParam0->f_23 || iParam1);
}

void func_115(char[4] cParam0, int iParam1)//Position - 0x511F
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

void func_116()//Position - 0x5136
{
	switch (iLocal_143)
	{
		case 0:
...
int func_117(bool bParam0, bool bParam1, bool bParam2)//Position - 0x537F
{
	int iVar0;
...
void func_120()//Position - 0x5AB6
{
	...
	if ((iLocal_137 - iLocal_136) > 60000)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_58))
		{
			...
			{
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_58, vLocal_115, 1f, -1, 1048576000, 0, 1193033728);
			}
			else
			{
...
int func_123(vector3 vParam0, bool bParam3)//Position - 0x5CB1
{
	int iVar0;
...
float func_124(bool bParam0, float fParam1, float fParam2)//Position - 0x5CDD
{
	if (bParam0)
	{
		return fParam1;
...
int func_125(int iParam0, bool bParam1, int iParam2)//Position - 0x5CF4
{
	int iVar0;
...
int func_126(int iParam0, bool bParam1, bool bParam2)//Position - 0x5D3E
{
	int iVar0;
...
void func_128(var uParam0, int iParam1)//Position - 0x5E1B
{
	...
	if (!PED::IS_PED_INJURED(iLocal_58))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
		{
			if (!func_132())
			{
				...
				{
					TASK::TASK_GO_TO_ENTITY(iLocal_58, PLAYER::PLAYER_PED_ID(), -1, 6f, 2f, 1073741824, 0);
				}
				if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_58, 0))
				{
...
int func_130()//Position - 0x5F59
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

int func_131()//Position - 0x5F69
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
	{
...
float func_135(struct<2> Param0, float fParam2, struct<2> Param3, float fParam5)//Position - 0x667E
{
	return MISC::GET_HEADING_FROM_VECTOR_2D((Param3 - Param0), (Param3.f_1 - Param0.f_1));
}

int func_136(char* sParam0)//Position - 0x6698
{
	var uVar0;
...
void func_140()//Position - 0x68D3
{
	switch (iLocal_68)
	{
		...
		case 1:
			...
			{
				ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_121[8], iLocal_57, PED::GET_PED_BONE_INDEX(iLocal_57, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
				iLocal_68++;
			}
			break;
		...
		case 2:
			if (!PED::IS_PED_INJURED(iLocal_57) && ENTITY::DOES_ENTITY_EXIST(iLocal_121[8]))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_57, "random@domestic", "balcony_fight_female", 3))
				{
					...
					{
						ENTITY::DETACH_ENTITY(iLocal_121[8], 0, true);
		...
		case 4:
			if (!PED::IS_PED_INJURED(iLocal_57) && ENTITY::DOES_ENTITY_EXIST(iLocal_121[9]))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_57, "random@domestic", "balcony_fight_female", 3))
				{
					...
					{
						ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_121[9], iLocal_57, PED::GET_PED_BONE_INDEX(iLocal_57, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
						iLocal_68++;
					}
				}
			}
		...
		case 6:
			if (!PED::IS_PED_INJURED(iLocal_57) && ENTITY::DOES_ENTITY_EXIST(iLocal_121[9]))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_57, "random@domestic", "balcony_fight_female", 3))
				{
					...
					{
						ENTITY::DETACH_ENTITY(iLocal_121[9], 0, true);
		...
		case 8:
			if (!PED::IS_PED_INJURED(iLocal_57) && ENTITY::DOES_ENTITY_EXIST(iLocal_121[10]))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_57, "random@domestic", "balcony_fight_female", 3))
				{
					...
					{
						ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_121[10], iLocal_57, PED::GET_PED_BONE_INDEX(iLocal_57, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
						iLocal_68++;
					}
				}
			}
		...
		case 9:
			if (!PED::IS_PED_INJURED(iLocal_57) && ENTITY::DOES_ENTITY_EXIST(iLocal_121[10]))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_57, "random@domestic", "balcony_fight_female", 3))
				{
					...
					{
						ENTITY::DETACH_ENTITY(iLocal_121[10], 0, true);
...
void func_141()//Position - 0x708C
{
	...
	{
		TASK::OPEN_SEQUENCE_TASK(&iLocal_95);
		TASK::TASK_GO_STRAIGHT_TO_COORD(0, vLocal_109, 1f, -1, 1193033728, 0.5f);
...
int func_142(int iParam0)//Position - 0x7117
{
	if (func_145())
	{
		Global_111550 = 1;
...
void func_143(int iParam0)//Position - 0x716A
{
	switch (iParam0)
	{
		case 0:
...
char* func_144(int iParam0)//Position - 0x724B
{
	char* sVar0;
...
int func_146(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x72C3
{
	int iVar0;
...
void func_147(var uParam0, int iParam1)//Position - 0x73FA
{
	int iVar0;
...
bool func_148(int iParam0)//Position - 0x7449
{
	return func_149(iParam0, Global_41396);
}

int func_149(int iParam0, int iParam1)//Position - 0x745A
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_150(int iParam0)//Position - 0x763B
{
	if (Global_41396 == 15)
	{
		return 0;
...
void func_152()//Position - 0x7699
{
	...
	func_4(43, 1);
	func_4(44, 1);
	MISC::CLEAR_AREA(vLocal_63, 2f, 1, 0, 0, false);
	MISC::CLEAR_AREA(vLocal_60, 2f, 1, 0, 0, false);
	VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_63 - Vector(10f, 10f, 10f), vLocal_63 + Vector(10f, 10f, 10f), false, 1);
...
void func_153(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x79F4
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_155(int iParam0, char* sParam1, int iParam2)//Position - 0x7D74
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_50(iParam2), 1);
}

bool func_156(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x7D8B
{
...
void func_158()//Position - 0x7DFB
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_58))
	{
		if (func_161(iLocal_58) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_58, PLAYER::PLAYER_PED_ID(), 1))
		{
			func_159();
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_57))
	{
		if (func_161(iLocal_57) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_57, PLAYER::PLAYER_PED_ID(), 1))
		{
			func_159();
		}
	}
...
int func_161(int iParam0)//Position - 0x80A9
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_163()//Position - 0x814F
{
	if (!PED::IS_PED_INJURED(iLocal_58))
	{
		TASK::CLEAR_PED_TASKS(iLocal_58);
		TASK::TASK_SMART_FLEE_COORD(iLocal_58, ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), true), 150f, -1, 0, 0);
		PED::SET_PED_KEEP_TASK(iLocal_58, true);
	}
	iLocal_49 = 11;
}

int func_164(int iParam0)//Position - 0x818E
{
...
int func_169(float fParam0, bool bParam1)//Position - 0x8556
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_170(int iParam0, var uParam1)//Position - 0x860D
{
	switch (iParam0)
	{
		case 0:
...
int func_172(int iParam0)//Position - 0x9813
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_173(int iParam0)//Position - 0x9B59
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_174(int iParam0)//Position - 0x9B8F
{
	struct<2> Var0;
...
bool func_176()//Position - 0xA00C
{
	return Global_111278 > 0;
}

int func_177()//Position - 0xA01A
{
	if (Global_95621 != -1)
	{
		return 1;
...
void func_182(int iParam0)//Position - 0xA0FF
{
	if (iParam0 == -1)
	{
		iParam0 = func_40();
...
void func_184(int iParam0)//Position - 0xA172
{
	Global_111549 = iParam0;
}

int func_185(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA180
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
	...
	if (!bVar0)
	{
		...
		if (!func_221(Global_111560.f_24990.f_43[iParam3]))
		{
			return 0;
		}
...
bool func_186(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0xA51A
{
	if (bParam6)
	{
...
bool func_187(int iParam0)//Position - 0xA561
{
	int iVar0;
...
int func_188(int iParam0)//Position - 0xA582
{
	return func_189(iParam0, 1);
}

int func_189(int iParam0, int iParam1)//Position - 0xA591
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_190(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0xA5E4
{
	func_191(func_202(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_191(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0xA602
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_192(float fParam0, float fParam1, float fParam2)//Position - 0xA803
{
	float fVar0;
...
int func_193(int iParam0, int iParam1)//Position - 0xA845
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_194(int iParam0)//Position - 0xA8E7
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_195(int iParam0)//Position - 0xA8FA
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_196(int iParam0)//Position - 0xA90D
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_197(int iParam0)//Position - 0xA920
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_198(int iParam0)//Position - 0xA932
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_199(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_199(bool bParam0, int iParam1, int iParam2)//Position - 0xA957
{
	if (bParam0)
	{
		return iParam1;
...
int func_200(int iParam0)//Position - 0xA96E
{
	return iParam0 & 15;
}

int func_201(int iParam0, int iParam1)//Position - 0xA97B
{
	int iVar0;
	int iVar1;
...
void func_203(var uParam0, int iParam1)//Position - 0xAACD
{
	if (iParam1 <= 0)
	{
		return;
...
void func_204(var uParam0, int iParam1)//Position - 0xAB53
{
...
void func_205(var uParam0, int iParam1)//Position - 0xAB86
{
	int iVar0;
	int iVar1;
...
void func_206(var uParam0, int iParam1)//Position - 0xABD7
{
...
void func_207(var uParam0, int iParam1)//Position - 0xAC11
{
...
void func_208(var uParam0, int iParam1)//Position - 0xAC4C
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_209(int iParam0)//Position - 0xAC88
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_210(int iParam0, int iParam1)//Position - 0xAD64
{
...
int func_211(int iParam0)//Position - 0xAD87
{
	int iVar0;
...
var func_212()//Position - 0xB4A4
{
	return Global_98708.f_1;
}

int func_213()//Position - 0xB4B2
{
	if (Global_95621 != -1)
	{
...
bool func_216()//Position - 0xB51C
{
	return Global_98721.f_346 > 0;
}

bool func_217()//Position - 0xB52D
{
	return Global_98721.f_345 > 0;
}

var func_218()//Position - 0xB53E
{
	return Global_1312873;
}

int func_219()//Position - 0xB54A
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_221(int iParam0)//Position - 0xB58E
{
	return func_201(func_202(), iParam0);
}

int func_222(int iParam0, int iParam1, int iParam2)//Position - 0xB5A0
{
	int iVar0;
	int iVar1;
...
int func_223(int iParam0)//Position - 0xB684
{
	if (!func_33(iParam0))
	{
		return 7;
...
bool func_224(int iParam0)//Position - 0xB6A8
{
	int iVar0;
	bool bVar1;
...
int func_227(int iParam0, int iParam1)//Position - 0xB805
{
	if (Global_111560.f_10189[iParam0 /*12*/].f_5 == 1)
	{
		if (iParam1 == 1)
...
void func_229(int iParam0)//Position - 0xB995
{
	char cVar0[64];
...
void func_230(var uParam0)//Position - 0xBA4A
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_231(int iParam0, bool bParam1)//Position - 0xBA87
{
	switch (iParam0)
	{
		case 0:
...
void func_232(int iParam0)//Position - 0xBCD0
{
	Global_41947 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_233(int iParam0)//Position - 0xBCE2
{
	func_234(iParam0, 0, func_239(iParam0));
}

void func_234(int iParam0, int iParam1, int iParam2)//Position - 0xBCF7
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_235(var uParam0)//Position - 0xBD26
{
	struct<16> Var0;
	int iVar16;
...
void func_236(int iParam0, var uParam1)//Position - 0xBDF5
{
	Global_111560.f_24990.f_43[iParam0] = *uParam1;
}

void func_237(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xBE0D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_238(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xBF8F
{
...
int func_239(int iParam0)//Position - 0xBFC7
{
	int iVar0;
