...
void __EntryFunction__()//Position - 0x0
{
	...
	if (Var0 == 32)
	{
		...
		MISC::CLEAR_AREA(vVar61, 40f, 1, 0, 0, false);
	}
	else if (Var0 == 34)
	{
		iLocal_97 = func_245();
	...
	while (true)
	{
		...
		{
			func_187(&Var0, vVar61, "MIN3AUD", "MIN3_AMB", 3, "MANUEL", 5000, 1101004800);
		}
		if (func_173(&Var0, 0))
		{
			if (func_172(Var0))
...
int func_26(var uParam0)//Position - 0x2968
{
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x298A
{
	int iVar0;
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2A12
{
...
int func_29(int iParam0)//Position - 0x2A52
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x2A80
{
...
int func_31(int iParam0)//Position - 0x2B5C
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2B9E
{
	int iVar0;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x2C01
{
	int iVar0;
...
int func_34(int iParam0, int iParam1)//Position - 0x2C8F
{
	struct<82> Var0;
...
void func_35(int iParam0, var uParam1, int iParam2)//Position - 0x2CD1
{
	int iVar0;
...
bool func_36(int iParam0)//Position - 0x2F2D
{
	return iParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2F39
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x31E4
{
	switch (iParam0)
	{
		case 1:
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x3294
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x3487
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0)//Position - 0x34A7
{
	int iVar0;
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3558
{
	char* sVar0;
...
int func_43(int iParam0, int iParam1, bool bParam2)//Position - 0x3687
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x36F8
{
...
int func_45(int iParam0)//Position - 0x37D1
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x380E
{
	if (func_36(iParam0))
	{
...
var func_47(int iParam0)//Position - 0x3833
{
	return Global_1798[iParam0 /*29*/];
}

void func_48(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3842
{
	int iVar0;
	int iVar1;
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x39E2
{
	int iVar0;
	var uVar1;
...
int func_50(var uParam0)//Position - 0x3A14
{
	int iVar0;
	int iVar1;
...
int func_51()//Position - 0x3A48
{
	return Global_1312745;
}

int func_52(int iParam0, int iParam1)//Position - 0x3A54
{
	var uVar0;
	var uVar1;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3A80
{
	int iVar0;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3FC8
{
	int iVar0;
...
int func_55()//Position - 0x420A
{
	func_56();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_56()//Position - 0x4223
{
	int iVar0;
...
bool func_57(int iParam0)//Position - 0x4320
{
	return Global_41396 == iParam0;
}

void func_58(int iParam0, bool bParam1)//Position - 0x432E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_59(int iParam0, var uParam1)//Position - 0x4421
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_60(int iParam0)//Position - 0x46A9
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_61(int iParam0)//Position - 0x4744
{
...
int func_62(int iParam0, int iParam1)//Position - 0x48D6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var uParam1)//Position - 0x5447
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x5482
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x56F6
{
	int iVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x5732
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_67(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x5C8D
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5CD1
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x63EC
{
	if (bParam6)
	{
...
int func_70(var uParam0)//Position - 0x6433
{
...
bool func_71(int iParam0)//Position - 0x648E
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x649E
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x6508
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x6838
{
	return Global_30736;
}

int func_75(int iParam0)//Position - 0x6843
{
	return func_72(iParam0, 5, 1);
}

int func_76(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6853
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x68F5
{
	switch (iParam0)
	{
		case -1:
...
int func_78(int iParam0)//Position - 0x6F12
{
	if (iParam0 != func_87())
	{
...
Vector3 func_79(int iParam0, int iParam1)//Position - 0x6F70
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_80(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x701E
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_81(vector3 vParam0, float fParam3)//Position - 0x70B3
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_82(int iParam0)//Position - 0x70F7
{
	struct<6> Var0;
...
struct<6> func_83(int iParam0)//Position - 0x727B
{
	return func_84(iParam0);
}

struct<6> func_84(int iParam0)//Position - 0x7289
{
	struct<6> Var0;
...
int func_85(int iParam0, var uParam1)//Position - 0x7D50
{
	switch (iParam0)
	{
		case 0:
...
int func_86(int iParam0)//Position - 0x7DD2
{
	if (iParam0 != func_87())
	{
...
int func_87()//Position - 0x7E30
{
	return -1;
}

Vector3 func_88(int iParam0)//Position - 0x7E39
{
	switch (iParam0)
	{
		case 1:
...
int func_89()//Position - 0x8045
{
	return func_90(PLAYER::PLAYER_ID());
}

int func_90(int iParam0)//Position - 0x8055
{
	return MISC::GET_BITS_IN_RANGE(Global_2424073[iParam0 /*421*/].f_309.f_3, 28, 31);
}

int func_91(int iParam0)//Position - 0x8072
{
	return func_72(iParam0, 0, 0);
}

int func_92(int iParam0)//Position - 0x8082
{
	switch (iParam0)
	{
		case -1:
...
bool func_93()//Position - 0x8350
{
	return Global_98721.f_345 > 0;
}

var func_94()//Position - 0x8361
{
	var uVar0;
...
void func_95(var uParam0, int iParam1)//Position - 0x83A7
{
	if (iParam1 <= 0)
	{
		return;
...
void func_96(var uParam0, int iParam1)//Position - 0x842D
{
...
void func_97(var uParam0, int iParam1)//Position - 0x8460
{
	int iVar0;
	int iVar1;
...
int func_98(int iParam0, int iParam1)//Position - 0x84B1
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_99(int iParam0)//Position - 0x8553
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_100(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_100(bool bParam0, int iParam1, int iParam2)//Position - 0x8578
{
	if (bParam0)
	{
		return iParam1;
...
int func_101(var uParam0)//Position - 0x858F
{
	return uParam0 & 15;
}

void func_102(var uParam0, int iParam1)//Position - 0x859C
{
...
void func_103(var uParam0, int iParam1)//Position - 0x85D6
{
...
void func_104(var uParam0, int iParam1)//Position - 0x8611
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_105()//Position - 0x864D
{
	func_56();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_106(int iParam0)//Position - 0x8666
{
	var uVar0;
	vector3 vVar1[24];
...
void func_107(char* sParam0, int iParam1, int iParam2)//Position - 0x86BF
{
...
bool func_108(bool bParam0)//Position - 0x8701
{
...
struct<2> func_109(int iParam0)//Position - 0x872C
{
	struct<2> Var0;
...
void func_110(int iParam0, var uParam1)//Position - 0x8B79
{
	switch (iParam0)
	{
		case 0:
...
int func_112(int iParam0)//Position - 0x9E51
{
	switch (iParam0)
	{
		case 0:
...
int func_113(int iParam0)//Position - 0xA197
{
	int iVar0;
...
void func_114(int iParam0)//Position - 0xA23B
{
	struct<2> Var0;
...
void func_115(int iParam0)//Position - 0xA2D6
{
	if (iParam0 < 63)
	{
		func_116();
...
void func_117(int iParam0)//Position - 0xA334
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_118(int iParam0)//Position - 0xA38D
{
...
int func_119(int iParam0)//Position - 0xA410
{
	int iVar0;
...
void func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA441
{
	func_121(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_121(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA456
{
	int iVar0;
...
int func_123(int iParam0, int iParam1, int iParam2)//Position - 0xA509
{
...
int func_124(int iParam0, int iParam1, int iParam2)//Position - 0xA524
{
	int iVar0;
...
int func_125(int iParam0)//Position - 0xA570
{
	int iVar0;
...
int func_126(int iParam0)//Position - 0xA5B9
{
	if (func_127(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_127(int iParam0)//Position - 0xA5D9
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_128(int iParam0)//Position - 0xA5FA
{
	switch (iParam0)
	{
		case 5:
...
int func_130(int iParam0)//Position - 0xA6CA
{
	switch (iParam0)
	{
		case 5:
...
void func_131(var uParam0, bool bParam1, bool bParam2)//Position - 0xA71D
{
	int iVar0;
...
int func_132(int iParam0)//Position - 0xA812
{
	switch (iParam0)
	{
		case 5:
...
void func_133(bool bParam0)//Position - 0xA87D
{
	int iVar0;
...
void func_134(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0xA8BB
{
	if (bParam0)
	{
...
bool func_135()//Position - 0xA9F4
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_136(int iParam0, int iParam1)//Position - 0xAA11
{
	bool bVar0;
...
int func_137(int iParam0, bool bParam1)//Position - 0xAA5C
{
	int iVar0;
	int iVar1;
...
int func_138(int iParam0)//Position - 0xAA9D
{
...
bool func_139()//Position - 0xAADF
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_140(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xAAF0
{
	int iVar0;
...
void func_142(int iParam0)//Position - 0xAB4A
{
	if (iParam0 == 1)
	{
...
int func_143(int iParam0)//Position - 0xAB6D
{
...
void func_144()//Position - 0xABAA
{
	Global_19671 = 0;
	func_145();
}

void func_145()//Position - 0xABBA
{
...
int func_149(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xACA0
{
...
void func_150(int iParam0)//Position - 0xAE2F
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_152(int iParam0)//Position - 0xAEAC
{
	if (func_157())
	{
		return;
...
void func_153(int iParam0)//Position - 0xAEDF
{
	if (func_157())
	{
		return;
...
void func_154(bool bParam0, bool bParam1)//Position - 0xAF69
{
	if (bParam0)
	{
		if (func_156(0))
...
bool func_155()//Position - 0xAFDD
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

int func_156(int iParam0)//Position - 0xAFEE
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
bool func_157()//Position - 0xB048
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

int func_158(int iParam0)//Position - 0xB05A
{
...
void func_160(int iParam0)//Position - 0xB0E0
{
...
int func_161(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB112
{
	int iVar0;
...
void func_162(var uParam0, int iParam1)//Position - 0xB249
{
	int iVar0;
...
bool func_163(int iParam0)//Position - 0xB298
{
	return func_164(iParam0, Global_41396);
}

int func_164(int iParam0, int iParam1)//Position - 0xB2A9
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_165(int iParam0)//Position - 0xB48A
{
	if (Global_41396 == 15)
	{
		return 0;
...
int func_166()//Position - 0xB4AC
{
	return func_167(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_167(char* sParam0, int iParam1)//Position - 0xB4BD
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_169(int iParam0, int iParam1)//Position - 0xB52A
{
	switch (iParam0)
	{
		case 0:
...
int func_170(vector3 vParam0, bool bParam3)//Position - 0xB9B1
{
	int iVar0;
...
float func_171(bool bParam0, float fParam1, float fParam2)//Position - 0xB9DD
{
	if (bParam0)
	{
		return fParam1;
...
int func_172(int iParam0)//Position - 0xB9F4
{
	switch (iParam0)
	{
		case 0:
...
int func_173(int iParam0, int iParam1)//Position - 0xBA83
{
	switch (iParam0->f_16)
	{
		case 0:
...
void func_174()//Position - 0xC269
{
	func_27(&(Global_102125.f_2890), &Global_102125, 0, 1, 1, 0);
}

int func_175(var uParam0)//Position - 0xC284
{
	float fVar0;
...
void func_176(int iParam0, int iParam1)//Position - 0xC312
{
	if (iParam0 == 1)
	{
		if (!func_130(iParam1))
...
int func_177(bool bParam0)//Position - 0xC376
{
	int iVar0;
...
int func_178(int iParam0)//Position - 0xC40D
{
	int iVar0;
...
var func_179()//Position - 0xCB2A
{
	return Global_98708.f_1;
}

int func_180()//Position - 0xCB38
{
	if (Global_95621 != -1)
	{
...
bool func_183()//Position - 0xCBA2
{
	return Global_98721.f_346 > 0;
}

bool func_184(int iParam0, int iParam1)//Position - 0xCBB3
{
	switch (iParam0)
	{
		case 5:
...
var func_185()//Position - 0xCBEE
{
	return Global_1312873;
}

int func_186()//Position - 0xCBFA
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_187(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xCC16
{
	var uVar0;
...
void func_188(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCC9E
{
...
void func_189(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCCD9
{
...
void func_190(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCD2F
{
...
float func_191(int iParam0, vector3 vParam1, bool bParam4)//Position - 0xCDCA
{
	vector3 vVar0;
...
int func_192(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)//Position - 0xCE04
{
	var uVar0;
...
void func_193(int iParam0)//Position - 0xCF4F
{
	Global_21816 = iParam0;
}

int func_194(char* sParam0)//Position - 0xCF5C
{
	struct<6> Var0;
...
struct<6> func_195()//Position - 0xCF7C
{
	struct<6> Var0;
...
void func_196(int iParam0, int iParam1, vector3 vParam2)//Position - 0xCFA0
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_197(int iParam0, bool bParam1)//Position - 0xD091
{
	if (iParam0 == -1)
	{
		return;
...
int func_198(int iParam0)//Position - 0xD0CD
{
	if (Global_76573 == iParam0)
	{
		if (Global_76574 == -1)
...
void func_199(int iParam0, int iParam1)//Position - 0xD106
{
	bool bVar0;
	int iVar1;
...
bool func_200()//Position - 0xD1A4
{
	return Global_96008;
}

void func_201(int iParam0)//Position - 0xD1B0
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_202(iParam0);
...
void func_202(int iParam0)//Position - 0xD1C7
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_203(int iParam0)//Position - 0xD2AF
{
	if (iParam0 == -1)
	{
		iParam0 = func_166();
...
void func_204(var uParam0)//Position - 0xD2D7
{
	int iVar0;
	int iVar1;
...
void func_205(int iParam0)//Position - 0xD5DB
{
	int iVar0;
...
void func_206(int iParam0)//Position - 0xD678
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_207(struct<2> Param0, float fParam2, struct<2> Param3, float fParam5, float fParam6)//Position - 0xD6A3
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_208(int iParam0)//Position - 0xD6DC
{
	if (func_127(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
int func_210(var uParam0, bool bParam1)//Position - 0xD739
{
	struct<27> Var0;
...
void func_211(int iParam0, var uParam1, int iParam2)//Position - 0xD9AC
{
	int iVar0;
	int iVar1;
...
int func_212(int iParam0)//Position - 0xDD04
{
...
int func_213(var uParam0)//Position - 0xDD24
{
...
int func_214(var uParam0)//Position - 0xDD3C
{
...
void func_215(var uParam0)//Position - 0xDD61
{
	int iVar0;
...
int func_216(var uParam0, bool bParam1, bool bParam2)//Position - 0xDDE1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_217(int iParam0, int iParam1)//Position - 0xDF9F
{
	int iVar0;
...
int func_218(var uParam0, bool bParam1, int iParam2)//Position - 0xDFCF
{
	int iVar0;
	int iVar1;
...
int func_219(int iParam0)//Position - 0xE28B
{
...
int func_220(int iParam0, float fParam1)//Position - 0xE2BF
{
	float fVar0;
...
bool func_221(int iParam0, float fParam1)//Position - 0xE335
{
	return func_222(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_222(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE34D
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_223(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_223(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE40E
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_224(int iParam0, int iParam1)//Position - 0xE53A
{
	int iVar0;
...
int func_226(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE649
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_227(vector3 vParam0, vector3 vParam3)//Position - 0xE6DA
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_228(vector3 vParam0)//Position - 0xE6FB
{
	float fVar0;
	float fVar1;
...
void func_229(var uParam0)//Position - 0xE73A
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_230(int iParam0, int iParam1)//Position - 0xE755
{
	int iVar0;
...
int func_231(int iParam0)//Position - 0xE794
{
...
int func_232(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE7BC
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_233(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE8B7
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_234(int iParam0, float fParam1)//Position - 0xE9C3
{
	var uVar0;
	vector3 vVar1;
...
int func_235(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0xEA58
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_236(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xEAE6
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_237(int iParam0)//Position - 0xEB2E
{
...
int func_238(int iParam0)//Position - 0xEB78
{
	if (iParam0 == -1)
	{
		iParam0 = func_166();
...
int func_239(int iParam0)//Position - 0xEC10
{
...
int func_242(int iParam0)//Position - 0xEC92
{
...
int func_244(int iParam0)//Position - 0xED04
{
	if (func_108(0))
	{
...
int func_247(var uParam0)//Position - 0xEDB8
{
	int iVar0[5];
	int iVar6;
	bool bVar7;
...
void func_248(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xF0D9
{
	func_249(iParam0);
...
void func_249(int iParam0)//Position - 0xF11B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_250(int iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)//Position - 0xF1B7
{
...
int func_251(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0xF213
{
	int iVar0;
...
int func_252(var uParam0, int iParam1)//Position - 0xF2A1
{
	int iVar0;
...
void func_253(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xF2E7
{
	func_206(iParam0);
...
int func_254(var uParam0)//Position - 0xF30E
{
	if (func_214(uParam0))
	{
...
int func_255(int iParam0)//Position - 0xF338
{
	int iVar0;
...
void func_256(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0xF369
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_257(var uParam0)//Position - 0xF3A5
{
	int iVar0[1];
	int iVar2;
...
int func_258(var uParam0)//Position - 0xF4B8
{
	int iVar0[4];
	int iVar5;
	bool bVar6;
...
void func_259(int iParam0, int iParam1)//Position - 0xF7D9
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_260(int iParam0)//Position - 0xF80F
{
	struct<27> Var0;
	int iVar32;
...
int func_261(int iParam0)//Position - 0xF863
{
	char* sVar0;
...
int func_262(int iParam0)//Position - 0xF91C
{
	var uVar0;
...
int func_263(int iParam0)//Position - 0xF9DD
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_264(int iParam0, char* sParam1)//Position - 0xFA62
{
...
bool func_265(int iParam0)//Position - 0xFB44
{
...
bool func_266(int iParam0)//Position - 0xFB72
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_267(int iParam0)//Position - 0xFBA0
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_268(int iParam0)//Position - 0xFBCE
{
	if (func_239(iParam0))
	{
		return 0;
...
void func_269()//Position - 0xFC03
{
	func_290("Running end routines.");
	Global_111278 = (Global_111278 - 1);
}

int func_270(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xFC1D
{
	int iVar0;
...
int func_271(int iParam0, vector3 vParam1, float fParam4, var uParam5)//Position - 0xFC82
{
	int iVar0;
	struct<7> Var1;
...
int func_272(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0xFD00
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_273(int iParam0, bool bParam1)//Position - 0xFD7B
{
	char* sVar0;
...
void func_274(char* sParam0)//Position - 0xFE68
{
...
void func_275()//Position - 0xFE87
{
	Global_19671 = 0;
	func_276();
}

void func_276()//Position - 0xFE97
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_277(var uParam0)//Position - 0xFEB8
{
	if (func_214(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_278(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xFEEE
{
...
void func_279(var uParam0, bool bParam1)//Position - 0xFF0E
{
	func_280(&(uParam0->f_41), bParam1);
}

void func_280(var uParam0, bool bParam1)//Position - 0xFF20
{
	int iVar0;
...
void func_281(int iParam0, bool bParam1)//Position - 0xFF5E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_282(var uParam0, bool bParam1)//Position - 0xFF99
{
	func_283(&(uParam0->f_35), bParam1);
}

void func_283(var uParam0, bool bParam1)//Position - 0xFFAB
{
	int iVar0;
...
void func_284(int iParam0)//Position - 0xFFE8
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_285(var uParam0, int iParam1)//Position - 0x10021
{
	func_286(&(uParam0->f_28), iParam1);
}

void func_286(var uParam0, int iParam1)//Position - 0x10033
{
	int iVar0;
...
void func_287(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10074
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_288(int iParam0)//Position - 0x100C4
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_289(var uParam0)//Position - 0x10105
{
	if (*uParam0 == -1)
	{
		return;
...
void func_290(int iParam0)//Position - 0x10142
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(iParam0))
	{
	}
...
void func_291(var uParam0)//Position - 0x10154
{
	*uParam0 = -1;
...
void func_292()//Position - 0x10187
{
	func_290("Running start routines.");
	Global_111278++;
}

int func_293(int iParam0)//Position - 0x101A1
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
