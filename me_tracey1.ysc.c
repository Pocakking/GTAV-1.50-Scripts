...
bool func_7(int iParam0)//Position - 0x7E7
{
	return func_8(iParam0, 20);
}

bool func_8(int iParam0, int iParam1)//Position - 0x7F7
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_9()//Position - 0x812
{
	return -1;
}

void func_10()//Position - 0x81B
{
	int iVar0;
...
int func_15()//Position - 0xA43
{
	func_16();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_16()//Position - 0xA5C
{
	int iVar0;
...
bool func_17(int iParam0)//Position - 0xB59
{
	return iParam0 < 3;
}

int func_18(int iParam0)//Position - 0xB65
{
	int iVar0;
	int iVar1;
...
int func_19(int iParam0)//Position - 0xBA2
{
	if (func_17(iParam0))
	{
...
var func_20(int iParam0)//Position - 0xBC7
{
	return Global_1798[iParam0 /*29*/];
}

bool func_21(int iParam0)//Position - 0xBD6
{
	return Global_41396 == iParam0;
}

void func_22()//Position - 0xBE4
{
	int iVar0;
...
bool func_23(int iParam0, int iParam1)//Position - 0xC3B
{
	switch (iParam0)
	{
		case 5:
...
void func_25(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCCD
{
...
bool func_26(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7)//Position - 0xD23
{
...
void func_27(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD71
{
...
void func_28(var uParam0, int iParam1)//Position - 0xE0C
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
int func_30(int iParam0)//Position - 0xE4B
{
	int iVar0;
...
void func_31(int iParam0)//Position - 0xEA7
{
	HUD::CLEAR_THIS_PRINT(vLocal_341[iParam0 /*3*/].f_2);
}

int func_32(int iParam0)//Position - 0xEBC
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_33(int iParam0)//Position - 0xEDD
{
...
void func_34(int iParam0)//Position - 0xEFD
{
...
void func_35(char* sParam0, int iParam1, int iParam2)//Position - 0xF4D
{
	iParam2 = iParam2;
...
void func_37(int iParam0)//Position - 0xFEC
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_38(int iParam0)//Position - 0x1088
{
	if (func_32(iParam0))
	{
...
void func_39(int iParam0)//Position - 0x10B2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
		...
		case 0:
			...
			if (func_185(iLocal_273, 5f, 5, 1056964608, 0, 1, 0))
			{
				if (bLocal_533)
				{
					...
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_530, 1f, 20000, 1048576000, 0, 1193033728);
				...
				MISC::CLEAR_AREA_OF_VEHICLES(vLocal_527, 8f, 1, 0, 0, 0, false, 0);
				if (!bLocal_533)
				{
				...
				if (bLocal_533)
				{
					...
					iLocal_473 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -1315.612f, 402.8979f, 76.0077f, -26.827f, 0f, 175.0236f, 48.4f, 0, 2);
				}
				else
				{
					iLocal_474 = MISC::GET_GAME_TIMER() + 5000;
					iLocal_473 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -840.7f, 185.3f, 78.4f, -14f, 0f, -110.4f, 48.4f, 0, 2);
				}
		...
		case 2:
			...
			else
			{
				if (bLocal_475)
				{
					...
					ENTITY::SET_ENTITY_COORDS(iLocal_289, -813.7761f, 179.4943f, 71.1592f, 0, false, 0, 1);
					PED::_0x2208438012482A1A(iLocal_289, 0, 0);
				}
				if (func_29())
				{
					func_60();
			...
			CAM::DESTROY_CAM(iLocal_473, 0);
			func_41(0);
			break;
	}
}

void func_41(bool bParam0)//Position - 0x1482
{
	func_42(0, 0);
	if (bParam0)
	{
...
void func_42(bool bParam0, int iParam1)//Position - 0x14A4
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_44(int iParam0)//Position - 0x15AF
{
	switch (iParam0)
	{
		case 71:
...
bool func_45(bool bParam0)//Position - 0x15ED
{
...
void func_46(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x1618
{
	int iVar0;
...
int func_47(int iParam0)//Position - 0x16C1
{
	if (func_32(iParam0))
	{
...
void func_48(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x16E1
{
	if (bParam0)
	{
...
bool func_49()//Position - 0x181A
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_50(int iParam0, int iParam1)//Position - 0x1837
{
	bool bVar0;
...
int func_51(int iParam0, bool bParam1)//Position - 0x1882
{
	int iVar0;
	int iVar1;
...
int func_52()//Position - 0x18C3
{
	return Global_1312745;
}

int func_53(int iParam0)//Position - 0x18CF
{
...
bool func_54()//Position - 0x1911
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_55(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x1922
{
	int iVar0;
...
void func_56(int iParam0)//Position - 0x1955
{
	if (iParam0 == 1)
	{
...
int func_57(int iParam0)//Position - 0x1978
{
	int iVar0;
...
int func_58(int iParam0)//Position - 0x19DB
{
	int iVar0;
...
int func_59(int iParam0)//Position - 0x1AFC
{
	if (!func_17(iParam0))
	{
		return func_20(iParam0);
...
void func_60()//Position - 0x1B22
{
	Global_19671 = 0;
	func_61();
}

void func_61()//Position - 0x1B32
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
bool func_62(int iParam0, vector3 vParam1, float fParam4)//Position - 0x1B53
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, true), vParam1) <= (fParam4 * fParam4);
}

int func_63(int iParam0)//Position - 0x1B70
{
...
void func_65(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x1BEC
{
	int iVar0;
...
void func_66(int iParam0, bool bParam1)//Position - 0x1DAA
{
...
Vector3 func_67(int iParam0)//Position - 0x1DE6
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_68(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x1DF9
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76389[1 /*14*/] = { func_118(iVar10, 14, uVar28[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76389[1 /*14*/] = { func_118(iVar10, 14, uVar69[iVar1], -1) };
			func_88(iParam0, Global_76389[1 /*14*/].f_12, Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4);
			func_110(14);
			if (Global_76387 == 1)
			{
...
int func_69(int iParam0, int iParam1, int iParam2)//Position - 0x260F
{
	int iVar0;
...
int func_70(int iParam0)//Position - 0x269B
{
	switch (iParam0)
	{
...
void func_71(int iParam0, int iParam1, int iParam2)//Position - 0x26D6
{
	int iVar0;
	int iVar1;
...
int func_72(int iParam0, int iParam1, int iParam2)//Position - 0x2760
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_73(int iParam0, int iParam1, int iParam2)//Position - 0x283E
{
	Global_76389[1 /*14*/] = { func_118(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 2);
}

int func_74(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x2869
{
	var uVar0;
	int iVar10;
...
int func_75(int iParam0, int iParam1, int iParam2)//Position - 0x2E6D
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2F06
{
	int iVar0;
...
int func_77(int iParam0, int iParam1, int iParam2)//Position - 0x2F9C
{
	int iVar0;
	int iVar1;
...
int func_78(int iParam0)//Position - 0x303D
{
	switch (iParam0)
	{
		case 0:
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x30ED
{
	int iVar0;
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x33F4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x3FA7
{
	int iVar0;
...
int func_82(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x428C
{
	int iVar0;
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4553
{
	int iVar0;
	int iVar1;
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x458A
{
	int iVar0;
...
int func_85(int iParam0, int iParam1, int iParam2)//Position - 0x45B3
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_86(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x487D
{
	int iVar0;
...
int func_87(int iParam0, int iParam1, int iParam2)//Position - 0x4B07
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_88(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4C5E
{
	int iVar0;
...
int func_89(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4CF6
{
	switch (iParam0)
	{
...
int func_90(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4DC4
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar41 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_78(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_91(int iParam0, int iParam1)//Position - 0x4F20
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_92(int iParam0)//Position - 0x52C7
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_93(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5328
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_94(int iParam0, int iParam1)//Position - 0x5424
{
	int iVar0;
...
int func_95(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5562
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_78(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
int func_96(int iParam0)//Position - 0x5642
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_97(int iParam0, int iParam1)//Position - 0x56C8
{
	int iVar0;
	struct<10> Var1;
...
void func_98(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5FF7
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_99(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x6121
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_100(int iParam0, int iParam1)//Position - 0x6169
{
	int iVar0;
	struct<17> Var1;
...
void func_101(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7FB1
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_102(int iParam0)//Position - 0x819D
{
	switch (iParam0)
	{
		case 0:
...
void func_103(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x824D
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_104(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x82BE
{
	switch (iParam0)
	{
		case joaat("player_zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_90(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_90(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_90(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_90(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_105(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x853B
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_106(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8960
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_107(int iParam0, int iParam1)//Position - 0x8C53
{
	int iVar0;
	int iVar1;
...
int func_108(int iParam0, int iParam1)//Position - 0x8C99
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_109(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8CF9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_110(int iParam0)//Position - 0x8D7D
{
...
void func_111(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x8E35
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_112(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x8E7F
{
	int iVar0;
...
int func_113(var uParam0)//Position - 0x8EAF
{
	int iVar0;
	int iVar1;
...
int func_114(int iParam0, int iParam1, int iParam2)//Position - 0x8EE3
{
	int iVar0;
	var uVar1;
...
bool func_115(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x8F15
{
	int iVar0;
...
int func_116(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xAD7C
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_117(int iParam0)//Position - 0xBC9A
{
	if (!MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_118(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBCEB
{
	func_181();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_119(int iParam0, int iParam1)//Position - 0xBD3D
{
	switch (iParam0)
	{
		case 0:
...
void func_120(int iParam0)//Position - 0xBE2D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_121(&(Global_76389[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_121(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xD20F
{
	int iVar0;
	int iVar1;
...
bool func_122(int iParam0, int iParam1, var uParam2)//Position - 0xD59F
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_123(int iParam0, int iParam1)//Position - 0xD9A4
{
	switch (iParam1)
	{
		case 0:
...
int func_124(int iParam0, int iParam1)//Position - 0xDD9F
{
	switch (iParam1)
	{
		case 0:
...
int func_125(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xE19A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_126(int iParam0)//Position - 0xE1DC
{
	switch (iParam0)
	{
		case -1:
...
void func_127(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE2B0
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_121(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_121(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_78(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_128(int iParam0)//Position - 0xE588
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0xE6D5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0xEBE2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0xEC56
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0xECC9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0xEDB0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0xF0F2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0xF2FA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0xF51A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0xF623
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0xFFB5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0)//Position - 0x10B31
{
	if (iParam0 < 136)
	{
		func_141(iParam0);
...
void func_140(int iParam0)//Position - 0x10B66
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x1176A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x1266A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x12797
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0, int iParam1)//Position - 0x1288E
{
	switch (iParam0)
	{
		case 0:
...
void func_145(int iParam0)//Position - 0x1297E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x13E4B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x13F92
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x144E2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x14B4B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x14BBE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x14C8E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x15189
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x1531A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x15B09
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x15C12
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x16B35
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0x177E2
{
	if (iParam0 < 107)
	{
		func_160(iParam0);
...
void func_158(int iParam0)//Position - 0x17828
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x182CC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x190BA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x19CF9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0x19F71
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0, int iParam1)//Position - 0x1A0AD
{
	switch (iParam0)
	{
		case 0:
...
void func_164(int iParam0)//Position - 0x1A19D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x1AEFB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x1B06A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x1B5DB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x1BB03
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x1BB76
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x1BC46
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x1C0F7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x1C352
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x1C612
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x1C7CD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x1D313
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0)//Position - 0x1DF45
{
	if (iParam0 < 60)
	{
		func_178(iParam0);
...
void func_177(int iParam0)//Position - 0x1DF7A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x1ED0D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_179(int iParam0)//Position - 0x1F38F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180(int iParam0)//Position - 0x1F475
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_181()//Position - 0x1F56C
{
...
int func_182(int iParam0, int iParam1, int iParam2)//Position - 0x1F5E4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_183(bool bParam0)//Position - 0x1F83F
{
	int iVar0;
...
int func_185(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x1F896
{
...
void func_186(int iParam0)//Position - 0x1FA25
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_187()//Position - 0x1FA51
{
	switch (iLocal_93)
	{
		case 0:
		...
		case 1:
			...
			else if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, 0))
			{
				iLocal_305 = 1;
				HUD::CLEAR_PRINTS();
				func_33(&iLocal_297);
			...
			else if (!PED::IS_PED_IN_VEHICLE(iLocal_289, iLocal_273, 0))
			{
				iLocal_306 = 1;
				iLocal_307 = 0;
				HUD::CLEAR_PRINTS();
...
void func_188(int iParam0)//Position - 0x1FF2B
{
...
void func_191()//Position - 0x200A9
{
	int iVar0;
	int iVar1;
...
bool func_193(char* sParam0, int iParam1, char* sParam2)//Position - 0x20663
{
...
void func_195()//Position - 0x206A0
{
	Global_19671 = 0;
	func_196();
}

void func_196()//Position - 0x206B0
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
int func_199(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x20763
{
	int iVar0;
	bool bVar1;
...
int func_200(int iParam0)//Position - 0x207B5
{
	if (vLocal_341[iParam0 /*3*/].f_1 < vLocal_341[iParam0 /*3*/] || vLocal_341[iParam0 /*3*/] == -1)
	{
		return 1;
...
void func_201()//Position - 0x207E8
{
	if (bLocal_312 == 0)
	{
...
int func_202(int iParam0, bool bParam1, int iParam2)//Position - 0x20882
{
	int iVar0;
...
void func_203()//Position - 0x208B7
{
	bLocal_312 = false;
	iLocal_313 = 0;
	iLocal_314 = MISC::GET_GAME_TIMER() + 2000;
...
void func_204(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x208D5
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar10 = func_276(&(Global_98669.f_3));
				if (iVar10 > -1)
				{
...
void func_205(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x20A4A
{
	func_206(&Global_105109, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_206(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x20A66
{
	int iVar0;
	int iVar1;
...
int func_207(var uParam0)//Position - 0x218EF
{
...
void func_208(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x21911
{
	int iVar0;
...
int func_209(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x21999
{
...
int func_210(int iParam0)//Position - 0x219D9
{
	int iVar0;
...
void func_211(var uParam0, int iParam1, int iParam2)//Position - 0x21A07
{
...
int func_212(int iParam0)//Position - 0x21AE3
{
	int iVar0;
...
int func_213(int iParam0)//Position - 0x21B25
{
	int iVar0;
...
int func_214(int iParam0, int iParam1, int iParam2)//Position - 0x21B88
{
	int iVar0;
...
int func_215(int iParam0, int iParam1)//Position - 0x21C16
{
	struct<82> Var0;
...
void func_216(int iParam0, var uParam1, int iParam2)//Position - 0x21C58
{
	int iVar0;
...
void func_217(int iParam0, var uParam1)//Position - 0x21EB4
{
	int iVar0;
...
int func_218(int iParam0)//Position - 0x2215F
{
	switch (iParam0)
	{
		case 1:
...
int func_219(int iParam0, var uParam1, var uParam2)//Position - 0x2220F
{
	int iVar0;
	int iVar1;
...
int func_220(int iParam0)//Position - 0x22402
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_221(var uParam0)//Position - 0x22422
{
	int iVar0;
...
int func_222(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x224D2
{
	char* sVar0;
...
int func_223(int iParam0, int iParam1, bool bParam2)//Position - 0x22601
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_224(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x22672
{
...
void func_225(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2274A
{
	int iVar0;
	int iVar1;
...
int func_226(int iParam0, int iParam1)//Position - 0x228EA
{
	var uVar0;
	var uVar1;
	
	uVar0 = Global_2576213[iParam0 /*3*/][func_113(iParam1)];
...
void func_227(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x22916
{
	int iVar0;
...
void func_228(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x22E5E
{
	int iVar0;
...
int func_229()//Position - 0x2309F
{
	func_16();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_230(int iParam0, bool bParam1)//Position - 0x230B8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_231(int iParam0, var uParam1)//Position - 0x231AB
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_233(Var11.f_1)) && iVar72 < 51)
			{
...
int func_232(int iParam0)//Position - 0x23433
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_233(int iParam0)//Position - 0x234CE
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
int func_234(int iParam0, int iParam1)//Position - 0x23660
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_235(int iParam0, var uParam1)//Position - 0x241D2
{
	int iVar0;
	int iVar1;
...
int func_236(int iParam0)//Position - 0x2420D
{
	int iVar0;
...
void func_237(int iParam0)//Position - 0x24481
{
	int iVar0;
...
void func_238(var uParam0, int iParam1)//Position - 0x244BD
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_239(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x24A18
{
	int iVar0;
	int iVar1;
...
bool func_240(int iParam0, var uParam1, var uParam2)//Position - 0x24A5C
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_241(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x25177
{
	if (bParam6)
	{
...
int func_242(var uParam0)//Position - 0x251BE
{
...
bool func_243(int iParam0)//Position - 0x25219
{
	return func_244(iParam0, 0, 1);
}

int func_244(int iParam0, int iParam1, bool bParam2)//Position - 0x25229
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_245(int iParam0)//Position - 0x25293
{
	switch (iParam0)
	{
		case 0:
...
int func_246()//Position - 0x255C3
{
	return Global_30736;
}

int func_247(int iParam0)//Position - 0x255CE
{
	return func_244(iParam0, 5, 1);
}

int func_248(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x255DE
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_249(int iParam0, bool bParam1)//Position - 0x25680
{
	switch (iParam0)
	{
		case -1:
...
int func_250(int iParam0)//Position - 0x25C9D
{
	if (iParam0 != func_9())
	{
...
Vector3 func_251(int iParam0, int iParam1)//Position - 0x25CFB
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_252(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x25DA9
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_253(vector3 vParam0, float fParam3)//Position - 0x25E3E
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_254(int iParam0)//Position - 0x25E82
{
	struct<6> Var0;
...
struct<6> func_255(int iParam0)//Position - 0x26006
{
	return func_256(iParam0);
}

struct<6> func_256(int iParam0)//Position - 0x26014
{
	struct<6> Var0;
...
int func_257(int iParam0, var uParam1)//Position - 0x26ADB
{
	switch (iParam0)
	{
		case 0:
...
int func_258(int iParam0)//Position - 0x26B5D
{
	if (iParam0 != func_9())
	{
...
Vector3 func_259(int iParam0)//Position - 0x26BBB
{
	switch (iParam0)
	{
		case 1:
...
int func_260()//Position - 0x26DC6
{
	return func_261(PLAYER::PLAYER_ID());
}

int func_261(int iParam0)//Position - 0x26DD6
{
	return MISC::GET_BITS_IN_RANGE(Global_2424073[iParam0 /*421*/].f_309.f_3, 28, 31);
}

int func_262(int iParam0)//Position - 0x26DF3
{
	return func_244(iParam0, 0, 0);
}

int func_263(int iParam0)//Position - 0x26E03
{
	switch (iParam0)
	{
		case -1:
...
bool func_264()//Position - 0x270D1
{
	return Global_98721.f_345 > 0;
}

var func_265()//Position - 0x270E2
{
	var uVar0;
...
void func_266(var uParam0, int iParam1)//Position - 0x27128
{
	if (iParam1 <= 0)
	{
		return;
...
void func_267(var uParam0, int iParam1)//Position - 0x271AE
{
...
void func_268(var uParam0, int iParam1)//Position - 0x271E1
{
	int iVar0;
	int iVar1;
...
int func_269(int iParam0, int iParam1)//Position - 0x27232
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_270(int iParam0)//Position - 0x272D4
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_271(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_271(bool bParam0, int iParam1, int iParam2)//Position - 0x272F9
{
	if (bParam0)
	{
		return iParam1;
...
int func_272(var uParam0)//Position - 0x27310
{
	return uParam0 & 15;
}

void func_273(var uParam0, int iParam1)//Position - 0x2731D
{
...
void func_274(var uParam0, int iParam1)//Position - 0x27357
{
...
void func_275(var uParam0, int iParam1)//Position - 0x27392
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_276(char* sParam0)//Position - 0x273CE
{
...
struct<2> func_277(int iParam0)//Position - 0x27424
{
	struct<2> Var0;
...
int func_278(char* sParam0, int iParam1)//Position - 0x27870
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_279(int iParam0, var uParam1)//Position - 0x278B9
{
	switch (iParam0)
	{
		case 0:
...
void func_280(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, var uParam22, int iParam23, int iParam24)//Position - 0x28A73
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_281(int iParam0)//Position - 0x28B04
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_282(int iParam0)//Position - 0x28E4A
{
	struct<2> Var0;
	char[] cVar2[8];
...
int func_283(int iParam0)//Position - 0x28E81
{
	switch (iParam0)
	{
		case 69:
...
int func_284(int iParam0)//Position - 0x28F3D
{
	switch (iParam0)
	{
		case 1:
...
int func_285(char* sParam0, bool bParam1)//Position - 0x28F91
{
	int iVar0;
	int iVar1;
...
int func_286(int iParam0, bool bParam1)//Position - 0x28FBB
{
	int iVar0;
...
void func_287(bool bParam0)//Position - 0x28FF1
{
	int iVar0;
	int iVar1;
...
int func_288(vector3 vParam0, int iParam3, bool bParam4)//Position - 0x29273
{
	int iVar0;
...
void func_289()//Position - 0x292A1
{
	int iVar0;
	...
	switch (iLocal_93)
	{
		case 0:
			...
			if (func_32(iLocal_290))
			{
				...
				{
					TASK::TASK_SMART_FLEE_COORD(iLocal_290, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 2000f, -1, 0, 0);
				}
				iLocal_413 = 0;
				bLocal_414 = false;
				iLocal_415 = 0;
				...
				ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_290, 1, 0f);
...
void func_290(var uParam0, int iParam1, int iParam2)//Position - 0x29577
{
	char* sVar0;
...
int func_291(char* sParam0)//Position - 0x29654
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_292()//Position - 0x29667
{
	if (!bLocal_604)
	{
		...
		if (!bLocal_604)
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_290, 0))
			{
				...
				{
					if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_290, 0f, 1f, -2f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_290, 0f, 7f, 5f), 5f, 0, true, 0) && !PED::IS_PED_RAGDOLL(iLocal_290)) && !TASK::IS_PED_GETTING_UP(iLocal_290))
					{
						func_293(0, 1);
					}
					else
			...
			else if (!bLocal_605 && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_290, 0))
			{
				func_293(1, 1);
			}
		}
...
void func_293(int iParam0, bool bParam1)//Position - 0x297BE
{
	if (iParam0 == 0)
	{
		TASK::TASK_SMART_FLEE_COORD(iLocal_290, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 2000f, -1, 0, 0);
...
bool func_294(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x29860
{
	return SYSTEM::VDIST2(vParam0, vParam3) <= (fParam6 * fParam6);
}

void func_295(bool bParam0)//Position - 0x2987A
{
...
void func_296()//Position - 0x29901
{
	bool bVar0;
	...
	if (func_299() && MISC::GET_GAME_TIMER() > iLocal_412)
	{
		...
		{
			if (func_32(iLocal_273) && (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, 0) || func_197(PLAYER::PLAYER_PED_ID(), iLocal_273, 15f, 1)))
			{
				iLocal_380 = 4;
			}
		}
	...
	switch (iLocal_417)
	{
		...
		case 10:
			...
			{
				if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, 1) && !func_197(PLAYER::PLAYER_PED_ID(), iLocal_290, 25f, 1))
				{
					func_195();
				}
			}
...
int func_298(char* sParam0)//Position - 0x29F55
{
...
void func_300(int iParam0, char* sParam1, char* sParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2A234
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
bool func_302(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2A3F3
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_303(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_303(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x2A4B4
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_304(int iParam0, int iParam1)//Position - 0x2A5E0
{
	int iVar0;
...
int func_306(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2A6EF
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_307(vector3 vParam0, vector3 vParam3)//Position - 0x2A780
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_308(vector3 vParam0)//Position - 0x2A7A1
{
	float fVar0;
	float fVar1;
...
void func_309(var uParam0)//Position - 0x2A7E0
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_310(int iParam0, int iParam1)//Position - 0x2A7FB
{
	int iVar0;
...
void func_311()//Position - 0x2A83A
{
	iLocal_338 = 1;
	iLocal_340 = MISC::GET_GAME_TIMER();
}

void func_312()//Position - 0x2A84D
{
	func_302(iLocal_289, PLAYER::PLAYER_PED_ID(), 1126825984, 1, 250, 7);
	func_302(iLocal_289, iLocal_290, 1126825984, 1, 250, 7);
}

void func_313(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x2A87E
{
	func_314(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_314(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x2A898
{
	func_315(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_315(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2A8B5
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
	{
	...
	uParam0->f_6 = 2;
	func_316(uParam0, iParam1, vParam2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

void func_316(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2A8ED
{
	int iVar0;
	int iVar1;
...
void func_317(var uParam0)//Position - 0x2AC5A
{
...
int func_318(var uParam0)//Position - 0x2ACC3
{
	int iVar0;
...
int func_319(bool bParam0)//Position - 0x2ACEE
{
	switch (Global_41396)
	{
		case 0:
...
void func_320(char[4] cParam0, int iParam1)//Position - 0x2AD98
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_321(char* sParam0)//Position - 0x2ADAF
{
	if (!func_322(1, 1, 0))
	{
...
int func_322(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2AE48
{
	int iVar0;
	int iVar1;
	...
	if ((func_329() || func_328(Global_4456448.f_190930)) || func_327())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::IS_TURRET_SEAT(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_325(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_323(int iParam0)//Position - 0x2B0A1
{
	if (iParam0 != func_9())
	{
...
int func_324(int iParam0, bool bParam1, bool bParam2)//Position - 0x2B107
{
	int iVar0;
...
int func_325(int iParam0, int iParam1)//Position - 0x2B151
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		if (VEHICLE::GET_NUM_MOD_KITS(iParam0) > 0)
...
int func_326(int iParam0, int iParam1)//Position - 0x2B1B3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_327()//Position - 0x2B238
{
	return Global_2448961.f_17;
}

bool func_328(int iParam0)//Position - 0x2B246
{
	return iParam0 == 51;
}

var func_329()//Position - 0x2B253
{
	return Global_2448961.f_16;
}

bool func_330()//Position - 0x2B261
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

int func_331(int iParam0)//Position - 0x2B276
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
void func_332(var uParam0, int iParam1, vector3 vParam2, int iParam5)//Position - 0x2B2D0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_333()//Position - 0x2B3E0
{
	return func_334(PLAYER::PLAYER_ID());
}

int func_334(int iParam0)//Position - 0x2B3F0
{
...
int func_335(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x2B40F
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_336(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2B77B
{
...
int func_337(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2B7CD
{
	if (!func_322(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_338(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2B816
{
	if (!func_322(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_339(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2B875
{
	if (!func_322(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_340(int iParam0)//Position - 0x2B8CB
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_341()//Position - 0x2B926
{
	MISC::SET_BIT(&Global_7357, 4);
}

void func_342(int iParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, bool bParam5, int iParam6)//Position - 0x2B936
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
		if (bParam5)
...
void func_343()//Position - 0x2B9E2
{
	vector3 vVar0;
...
void func_344()//Position - 0x2BA72
{
	switch (iLocal_93)
	{
		case 0:
			if (func_32(iLocal_290))
			{
				...
				else
				{
					...
					if (!iLocal_333)
					{
						iLocal_333 = 1;
						TASK::CLEAR_PED_TASKS(iLocal_290);
						TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_290, Local_277, PLAYER::PLAYER_PED_ID(), 8, 25f, 786477, 100f, 1f, 1);
					}
					iLocal_603 = MISC::GET_GAME_TIMER();
		...
		case 1:
			if (func_32(iLocal_290))
			{
				...
				else if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_290, 0))
				{
					iLocal_93 = 0;
					iLocal_92 = 6;
				}
				...
				if ((HUD::DOES_BLIP_EXIST(iLocal_297) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, 0)) && PED::IS_PED_IN_VEHICLE(iLocal_289, iLocal_273, 0))
				{
					func_359(iLocal_297, iLocal_290, 220f, 0.75f, 0);
				}
				func_313(&uLocal_261, iLocal_290, 0, 0, 1, 1, 1);
...
void func_345()//Position - 0x2BF8E
{
...
void func_348()//Position - 0x2C569
{
...
void func_349(int iParam0)//Position - 0x2C5B6
{
...
float func_351(float fParam0, float fParam1, float fParam2)//Position - 0x2C63B
{
	float fVar0;
...
void func_352()//Position - 0x2C67D
{
	if (func_32(Local_277))
	{
		if ((MISC::GET_GAME_TIMER() - iLocal_603) > 3000)
...
void func_354()//Position - 0x2C734
{
	if (iLocal_617 == 0)
	{
		...
		else if ((MISC::GET_GAME_TIMER() - iLocal_613) > iLocal_616 && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_277, 0f, -0.5f, -1.5f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_277, 0f, 6f, 2f), 12f, 0, true, 0))
		{
			iLocal_613 = MISC::GET_GAME_TIMER();
			iLocal_617 = 1;
		}
...
int func_355(int iParam0)//Position - 0x2C849
{
...
int func_356()//Position - 0x2C867
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_277))
	{
		if (ENTITY::IS_ENTITY_DEAD(Local_277, 0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(Local_277, 0))
		{
			return 1;
		}
...
int func_357(int iParam0)//Position - 0x2C90D
{
...
int func_358(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, float fParam6)//Position - 0x2C94F
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
...
void func_359(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)//Position - 0x2CA00
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_360(var uParam0, var uParam1, var uParam2, var uParam3)//Position - 0x2CB59
{
	*uParam0 = 0;
	*uParam1 = 0;
	*uParam2 = 0;
...
void func_361()//Position - 0x2CB71
{
	int iVar0;
		...
		case 0:
			if (!func_366())
			{
				...
				if (func_362(Local_277.f_6, Local_277.f_9, 0))
				{
					...
					TASK::OPEN_SEQUENCE_TASK(&iVar0);
					TASK::TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_277, ENTITY::GET_ENTITY_COORDS(iLocal_273, true), 4, 35f, 2883621, 10f, 12f, 1);
			...
			if (func_32(iLocal_290))
			{
				if (func_32(Local_277))
				{
					...
					else
					{
						...
						if (!iLocal_332)
						{
							if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_277, PLAYER::PLAYER_PED_ID(), 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_290, PLAYER::PLAYER_PED_ID(), 1))
							{
								ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_290);
...
int func_362(vector3 vParam0, float fParam3, int iParam4)//Position - 0x2CF58
{
	...
	else if (iLocal_292)
	{
		...
		{
			MISC::CLEAR_AREA_OF_VEHICLES(Local_277.f_6, 5f, 0, 0, 0, 0, false, 0);
			...
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_277, 1084227584);
			VEHICLE::LOWER_CONVERTIBLE_ROOF(Local_277, 1);
			VEHICLE::SET_CONVERTIBLE_ROOF_LATCH_STATE(Local_277, 1);
			VEHICLE::SET_VEHICLE_ENGINE_ON(Local_277, true, true, 0);
			ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_277, true, 1);
			VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_277);
			func_363(Local_277, 0);
			AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(Local_277, "M_E_TRACEY_STALKERS_CAR_GROUP", 0);
			iLocal_317 = 1;
...
void func_363(int iParam0, int iParam1)//Position - 0x2D0F8
{
	Global_98669.f_22[iParam1] = iParam0;
}

void func_364()//Position - 0x2D10C
{
	int iVar0;
	
	if (func_62(PLAYER::PLAYER_PED_ID(), Local_487[3 /*8*/], Local_487[3 /*8*/].f_3))
	{
		if (ENTITY::WOULD_ENTITY_BE_OCCLUDED(Local_277.f_1, vLocal_546[0 /*3*/], 0))
		{
			iVar0 = 0;
		}
		else
	...
	else
	{
		if (func_365())
		{
			if (ENTITY::WOULD_ENTITY_BE_OCCLUDED(Local_277.f_1, vLocal_546[2 /*3*/], 0))
			{
				iVar0 = 2;
			}
			else
		...
		else if (ENTITY::WOULD_ENTITY_BE_OCCLUDED(Local_277.f_1, vLocal_546[4 /*3*/], 0))
		{
			iVar0 = 4;
		}
		else
...
void func_367()//Position - 0x2D236
{
...
void func_368()//Position - 0x2D8F8
{
	if (((!func_29() && !func_194()) && PED::IS_PED_IN_VEHICLE(iLocal_289, iLocal_273, 0)) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, 0))
	{
...
void func_369()//Position - 0x2D964
{
	var uVar0[2];
	vector3 vVar3[4];
	struct<5> Var16;
...
int func_370(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x2DC87
{
	vector3 vVar0;
...
int func_371(int iParam0, float fParam1)//Position - 0x2DD42
{
	float fVar0;
...
bool func_372(int iParam0, float fParam1)//Position - 0x2DDB8
{
	return func_302(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

int func_373(int iParam0)//Position - 0x2DDD0
{
...
bool func_374(int iParam0, int iParam1, float fParam2)//Position - 0x2DDF8
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_375(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x2DE3F
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_376(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x2DF3A
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_377(int iParam0, float fParam1)//Position - 0x2E046
{
	var uVar0;
	vector3 vVar1;
...
int func_378(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0x2E0DB
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_379(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x2E169
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_380()//Position - 0x2E1B1
{
	int iVar0;
			...
			if (!func_2())
			{
				if (!func_366())
				{
					switch (iLocal_304)
					{
						...
						case 2:
							if (((!iLocal_311 && !func_29()) && !func_193("MET1TCAR", 0, 0)) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
							{
...
void func_381()//Position - 0x2E68D
{
	switch (iLocal_371)
	{
		case 0:
...
void func_382()//Position - 0x2E745
{
	if (!iLocal_294)
	{
...
int func_383(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)//Position - 0x2E799
{
	struct<98> Var0;
	int iVar98;
	int iVar99;
	...
	if (!func_17(iParam1))
	{
		...
		if ((iParam1 == 17 && Global_111560.f_2358.f_539.f_3618[0 /*197*/][0 /*98*/] == Var0) || (iParam1 == 15 && Global_111560.f_2358.f_539.f_3618[0 /*197*/][1 /*98*/] == Var0))
		{
			...
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_111560.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/], vParam2, fParam5, false, false, false);
				...
				func_387(iParam0, &(Global_111560.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_31), &(Global_111560.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_81));
...
void func_384(int iParam0, struct<98> Param1)//Position - 0x2ED6F
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_385(var uParam0, int iParam1)//Position - 0x2EF71
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_386(var uParam0)//Position - 0x2EFB2
{
	int iVar0;
...
int func_387(int iParam0, var uParam1, var uParam2)//Position - 0x2EFEF
{
	int iVar0;
	int iVar1;
...
int func_388(int iParam0)//Position - 0x2F1B2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_389(var uParam0)//Position - 0x2F28E
{
...
int func_390(int iParam0, int iParam1)//Position - 0x2F2CE
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_391(int iParam0, int iParam1)//Position - 0x2F3B3
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
void func_392(int iParam0, var uParam1, int iParam2)//Position - 0x2F729
{
	int iVar0;
	struct<98> Var1;
...
int func_393(int iParam0, vector3 vParam1, float fParam4, bool bParam5)//Position - 0x2FB1D
{
	int iVar0;
...
void func_394()//Position - 0x2FB9C
{
	switch (iLocal_93)
	{
		case 0:
		...
		case 2:
			...
			{
				STREAMING::REQUEST_ANIM_DICT(sLocal_296);
				PATHFIND::SET_ROADS_IN_ANGLED_AREA(Local_534[0 /*3*/], Local_534[1 /*3*/], Local_534.f_7, 0, false, 1);
				iLocal_542 = PED::ADD_SCENARIO_BLOCKING_AREA(227.4f, -66.5f, 67.5f, 249f, -30.8f, 72.5f, 0, 1, 1, 1);
				MISC::CLEAR_AREA(vLocal_479, 30f, 0, 0, 0, false);
				MISC::CLEAR_AREA_OF_VEHICLES(vLocal_479, 30f, 0, 0, 0, 0, false, 0);
				iLocal_93 = 0;
				iLocal_92 = 2;
			}
			break;
...
void func_395(int iParam0, vector3 vParam1, float fParam4)//Position - 0x2FCF0
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
int func_396(vector3 vParam0, bool bParam3)//Position - 0x2FD19
{
	int iVar0;
...
void func_397()//Position - 0x2FD58
{
...
void func_398(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x2FD8D
{
	vector3 vVar0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102125.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102125.f_4, 0))
		{
			if (func_428(24) != Global_102125.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_425(ENTITY::GET_ENTITY_COORDS(Global_102125.f_4, true), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
				}
				func_399(Global_102125.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_399(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)//Position - 0x2FE08
{
	struct<60> Var0;
...
void func_400(int iParam0, int iParam1, int iParam2)//Position - 0x2FF31
{
	int iVar0;
...
void func_401(int iParam0, int iParam1)//Position - 0x3004F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_402(int iParam0)//Position - 0x30251
{
...
int func_403(int iParam0)//Position - 0x3032E
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_404(int iParam0, bool bParam1)//Position - 0x304DF
{
	int iVar0;
	struct<2> Var1;
...
int func_405(int iParam0)//Position - 0x3065F
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_407(int iParam0)//Position - 0x30742
{
	int iVar0;
	int iVar1;
...
int func_408()//Position - 0x32C0D
{
	return 0;
}

int func_409()//Position - 0x32C16
{
	return 1;
}

int func_410()//Position - 0x32C1F
{
	return 1;
}

int func_411()//Position - 0x32C28
{
...
int func_413(int iParam0)//Position - 0x32CFC
{
	int iVar0;
	char* sVar1;
...
int func_414(int iParam0)//Position - 0x32D42
{
	int iVar0;
...
int func_415(int iParam0)//Position - 0x32D7D
{
	int iVar0;
...
int func_416(int iParam0)//Position - 0x32DF9
{
	int iVar0;
...
int func_417(var uParam0, int iParam1)//Position - 0x32EE1
{
	int iVar0;
	int iVar1;
...
void func_418(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0x345DD
{
	if (func_417(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
...
void func_419(int iParam0, bool bParam1)//Position - 0x346DC
{
	if (iParam0 == -1)
	{
		return;
...
void func_420(int iParam0, int iParam1, bool bParam2)//Position - 0x34739
{
	if (iParam0 == -1)
	{
		return;
...
bool func_421(int iParam0, int iParam1)//Position - 0x34774
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_422(var uParam0, var uParam1)//Position - 0x34797
{
...
void func_423(int iParam0)//Position - 0x34863
{
	if (iParam0 == -1)
	{
		return;
...
void func_424(int iParam0)//Position - 0x348DD
{
...
int func_425(vector3 vParam0, int iParam3, var uParam4, var uParam5)//Position - 0x34904
{
	int iVar0;
...
int func_426(vector3 vParam0, int iParam3, int iParam4)//Position - 0x34A1A
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_427(int iParam0)//Position - 0x34AA9
{
	return MISC::IS_BIT_SET(Global_111560.f_7224[iParam0], 0);
}

int func_428(int iParam0)//Position - 0x34AC1
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_429()//Position - 0x34ADD
{
	if (!iLocal_338)
	{
		return;
...
void func_430()//Position - 0x34B55
{
}

int func_431()//Position - 0x34B5D
{
	if (!func_32(PLAYER::PLAYER_PED_ID()))
	{
		func_434("DEFAULT");
...
void func_434(char* sParam0)//Position - 0x34C43
{
	sLocal_573 = sParam0;
	iLocal_92 = 11;
	iLocal_93 = 0;
...
void func_435()//Position - 0x34C57
{
	switch (iLocal_93)
	{
		case 0:
...
void func_437(char* sParam0)//Position - 0x34CF1
{
	func_438(sParam0);
	func_439(0);
}

void func_438(char* sParam0)//Position - 0x34D04
{
...
void func_439(int iParam0)//Position - 0x34D43
{
	int iVar0;
...
int func_440(int iParam0)//Position - 0x34D88
{
	int iVar0;
	int iVar1;
...
void func_441(var uParam0, int iParam1)//Position - 0x34E9F
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_443(Global_111560.f_18528[iVar0], &vVar2, &fVar5))
			{
...
void func_442(var uParam0)//Position - 0x35068
{
	*uParam0 = -15;
}

int func_443(int iParam0, var uParam1, float fParam2)//Position - 0x35076
{
	switch (iParam0)
	{
		case 11:
...
void func_444(int iParam0, bool bParam1)//Position - 0x359E5
{
	if (bParam1)
	{
...
void func_445()//Position - 0x35A23
{
	Global_98704 = 1;
...
void func_446(bool bParam0, bool bParam1)//Position - 0x35B10
{
	vector3 vVar0[2];
	float fVar7;
	...
	{
		vVar0[0 /*3*/] = { func_464() };
		if (PATHFIND::GET_CLOSEST_VEHICLE_NODE_WITH_HEADING(vVar0[0 /*3*/], &(vVar0[1 /*3*/]), &fVar7, 1, 1077936128, 0))
		{
		}
		else
		{
		...
		fLocal_621 = fVar7;
		MISC::CLEAR_AREA_OF_VEHICLES(vLocal_618, 10f, 0, 0, 0, 0, false, 0);
	...
	else
	{
		...
		ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), vLocal_618, 1, false, 0, 1);
	...
	{
		func_447(vLocal_618, 1112014848, 12, 5000, 0, 0);
	}
}

void func_447(vector3 vParam0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x35D09
{
	int iVar0;
	int iVar1;
...
void func_448()//Position - 0x35D79
{
	Global_22211.f_6 = 1;
}

void func_449(int iParam0)//Position - 0x35D87
{
	if (func_453())
	{
		return;
...
void func_450(int iParam0)//Position - 0x35DBA
{
	if (func_453())
	{
		return;
...
void func_451(bool bParam0, bool bParam1)//Position - 0x35E44
{
	if (bParam0)
	{
		if (func_331(0))
...
bool func_452()//Position - 0x35EB8
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

bool func_453()//Position - 0x35EC9
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

void func_454(int iParam0, int iParam1, int iParam2)//Position - 0x35EDB
{
...
void func_455(int iParam0)//Position - 0x35F9F
{
	if (iParam0 == 1)
	{
...
bool func_456()//Position - 0x35FC8
{
	return MISC::IS_BIT_SET(Global_98669.f_20, 13);
}

void func_457(int iParam0, int iParam1)//Position - 0x35FDC
{
	vLocal_341[iParam0 /*3*/].f_1 = iParam1;
}

void func_458(int iParam0)//Position - 0x35FEF
{
...
void func_459(int iParam0, int iParam1, int iParam2)//Position - 0x36015
{
	if (func_47(iParam0))
	{
		if (func_32(iParam1))
...
void func_460(vector3 vParam0, float fParam3, bool bParam4)//Position - 0x36057
{
	func_461();
	...
	if (func_32(iLocal_273))
	{
		VEHICLE::LOWER_CONVERTIBLE_ROOF(iLocal_273, 1);
		VEHICLE::SET_VEHICLE_STRONG(iLocal_273, true);
		VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_273, true, true, 0);
		VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(iLocal_273);
		VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(iLocal_273, true);
		func_363(iLocal_273, 1);
		iLocal_274 = 1;
...
void func_461()//Position - 0x36191
{
	iLocal_293 = 0;
	if (func_32(iLocal_289))
	{
...
void func_462(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x361D7
{
	if (func_542())
	{
...
void func_463(vector3 vParam0, var uParam3, var uParam4)//Position - 0x3626C
{
	vector3 vVar0[4];
	float fVar13[4];
	int iVar18;
...
Vector3 func_464()//Position - 0x36356
{
	return Global_105109.f_2884;
}

void func_465()//Position - 0x36367
{
	func_39(&iLocal_290);
	if (ENTITY::DOES_ENTITY_EXIST(Local_277))
	{
		...
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(Local_277, 0);
		func_37(&Local_277);
	}
}

void func_466(bool bParam0)//Position - 0x363A0
{
	func_33(&iLocal_297);
	func_465();
	if (bParam0)
	...
	else
	{
		if (func_32(PLAYER::PLAYER_PED_ID()))
		{
			ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Local_487[3 /*8*/], Local_487[3 /*8*/].f_1, (Local_487[3 /*8*/].f_2 + 8f), 1, false, 0, 1);
			func_460(Local_487[3 /*8*/], 71.4f, 1);
			func_459(PLAYER::PLAYER_PED_ID(), iLocal_273, -1);
		}
		if (func_32(iLocal_273))
		{
			MISC::CLEAR_AREA_OF_VEHICLES(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_273, 0f, -8f, 0f), 6f, 0, 0, 0, 0, false, 0);
		}
	}
...
void func_467(bool bParam0)//Position - 0x36501
{
	func_33(&iLocal_297);
	bLocal_622 = false;
	if (func_32(PLAYER::PLAYER_PED_ID()))
	{
		...
		else if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			else
			{
				...
				ENTITY::SET_ENTITY_COORDS(iLocal_623, 99.6208f, -21.0027f, 67.0114f, 1, false, 0, 1);
	...
	if (bLocal_622)
	{
		...
		{
			VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_623, true, true, 0);
...
void func_468()//Position - 0x36822
{
...
int func_469(vector3 vParam0, float fParam3)//Position - 0x3683F
{
	return func_470(&(Global_105109.f_2890), vParam0, fParam3, 0);
}

int func_470(var uParam0, vector3 vParam1, float fParam4, bool bParam5)//Position - 0x36859
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
void func_471(int iParam0)//Position - 0x36B0B
{
	bool bVar0;
...
int func_472(int iParam0, int iParam1)//Position - 0x36C7D
{
	int iVar0;
...
int func_473(var uParam0)//Position - 0x36CEF
{
	return *uParam0;
}

int func_474(int iParam0)//Position - 0x36CFA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_475(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x36DBD
{
	int iVar0;
	var uVar1[3];
	int iVar5;
...
int func_476(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x36FC5
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_477(int iParam0, int iParam1, bool bParam2)//Position - 0x37040
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_478(int iParam0, int iParam1)//Position - 0x370A1
{
	int iVar0;
...
void func_479(int iParam0, int iParam1)//Position - 0x37123
{
	int iVar0;
...
void func_480(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x371C1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_481(int iParam0, int iParam1)//Position - 0x37783
{
	int iVar0;
	int iVar1;
...
bool func_482()//Position - 0x377FB
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_483(int iParam0)//Position - 0x3780C
{
	int iVar0;
...
int func_484(int iParam0)//Position - 0x37857
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
int func_485(int iParam0)//Position - 0x378DE
{
...
int func_486(int iParam0)//Position - 0x3790D
{
...
int func_487(int iParam0)//Position - 0x3792A
{
...
int func_488(int iParam0, int iParam1)//Position - 0x3794D
{
...
int func_489(int iParam0)//Position - 0x37988
{
	if (func_488(iParam0, 0))
	{
...
int func_490(int iParam0, int iParam1)//Position - 0x379AB
{
	int iVar0;
...
void func_491(vector3 vParam0, float fParam3, bool bParam4)//Position - 0x379F8
{
	int iVar0;
...
int func_492(var uParam0)//Position - 0x37A48
{
	if (func_493(uParam0))
	{
...
int func_493(var uParam0)//Position - 0x37A7D
{
...
bool func_494()//Position - 0x37ADC
{
	return func_492(&(Global_105109.f_2890));
}

void func_495()//Position - 0x37AEF
{
	func_496(&(Global_105109.f_2890));
}

void func_496(var uParam0)//Position - 0x37B02
{
	if (func_493(uParam0))
	{
...
bool func_497()//Position - 0x37B20
{
	return func_493(&(Global_105109.f_2890));
}

void func_498(bool bParam0, bool bParam1)//Position - 0x37B33
{
	if (bParam0)
	{
		func_499(0, 1, 1);
...
void func_499(bool bParam0, int iParam1, int iParam2)//Position - 0x37B66
{
	bool bVar0;
...
void func_500(int iParam0, int iParam1, int iParam2)//Position - 0x37BC5
{
...
void func_501(int iParam0)//Position - 0x37BF9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_502(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x37C31
{
	vector3 vVar0;
	float fVar3;
	...
	else if (PATHFIND::GET_CLOSEST_VEHICLE_NODE_WITH_HEADING(vVar0, &vVar0, &fVar3, 1, 1077936128, 0))
	{
		func_503(iParam0, vVar0, fVar3, 1, iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, 1);
	}
}

void func_503(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x37CC2
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		if (!func_537(iParam6, iParam7, iParam8, iParam13))
		{
			iVar0 = 0;
		}
	}
...
int func_504(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)//Position - 0x37E56
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
void func_505(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x38C9C
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_506(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x398B0
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_507(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x39923
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_508(int iParam0)//Position - 0x3AE15
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_509(int iParam0, bool bParam1, var uParam2)//Position - 0x3AEC5
{
	int iVar0;
	bool bVar1;
...
int func_510(int iParam0)//Position - 0x3B033
{
	if (iParam0 != func_9())
	{
		if (func_324(iParam0, 1, 1))
...
int func_511(int iParam0)//Position - 0x3B07A
{
	switch (iParam0)
	{
		case 0:
...
int func_512(int iParam0)//Position - 0x3B442
{
...
int func_513(int iParam0)//Position - 0x3B484
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case -32236122:
...
int func_514(int iParam0)//Position - 0x3B527
{
	if (iParam0 != func_9())
	{
		if (func_324(iParam0, 1, 1))
...
int func_515(int iParam0)//Position - 0x3B56E
{
	if (iParam0 != func_9())
	{
		if (func_324(iParam0, 1, 1))
...
int func_516(int iParam0)//Position - 0x3B5B4
{
	switch (iParam0)
	{
		case -2118308144:
...
int func_517(int iParam0)//Position - 0x3B5E9
{
...
int func_518(int iParam0)//Position - 0x3B618
{
...
int func_519(int iParam0)//Position - 0x3B6D5
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		return 0;
...
int func_520(int iParam0)//Position - 0x3B70B
{
	switch (iParam0)
	{
		case 562680400:
...
int func_521(int iParam0, bool bParam1)//Position - 0x3B764
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_522(int iParam0)//Position - 0x3B7BF
{
	int iVar0;
...
int func_523(int iParam0, int iParam1)//Position - 0x3B7F9
{
	if (iParam1 == 0)
	{
...
bool func_524()//Position - 0x3BB6D
{
	return DLC::IS_DLC_PRESENT(1927191088);
}

bool func_525()//Position - 0x3BB7E
{
	return DLC::IS_DLC_PRESENT(2067165443);
}

bool func_526()//Position - 0x3BB8F
{
	return DLC::IS_DLC_PRESENT(-957277403);
}

bool func_527()//Position - 0x3BBA0
{
	return DLC::IS_DLC_PRESENT(210122941);
}

bool func_528()//Position - 0x3BBB1
{
	return DLC::IS_DLC_PRESENT(-1894522408);
}

bool func_529()//Position - 0x3BBC2
{
	return DLC::IS_DLC_PRESENT(1630677557);
}

int func_530(int iParam0)//Position - 0x3BBD3
{
	if (iParam0 != func_9())
	{
		if (func_324(iParam0, 1, 1))
...
int func_531(int iParam0)//Position - 0x3BC32
{
	if (iParam0 != func_9())
	{
		if (func_324(iParam0, 1, 1))
...
int func_532(int iParam0)//Position - 0x3BC92
{
	if (iParam0 != func_9())
	{
		if (func_324(iParam0, 1, 1))
...
int func_533(int iParam0, bool bParam1, var uParam2)//Position - 0x3BCD9
{
	bool bVar0;
...
int func_534(int iParam0)//Position - 0x3C11C
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_535(int iParam0)//Position - 0x3C145
{
	if (!func_536(*iParam0))
	{
...
bool func_536(int iParam0)//Position - 0x3C170
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_537(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3C17F
{
...
int func_539(int iParam0)//Position - 0x3C282
{
	switch (iParam0)
	{
		case joaat("police"):
...
var func_540()//Position - 0x3C2DB
{
	return Global_102125.f_2890.f_8;
}

int func_541()//Position - 0x3C2EC
{
...
void func_543()//Position - 0x3C33A
{
	if (func_553() == 1)
	{
		bLocal_533 = true;
	...
	func_547();
	func_546();
	func_545(&Local_534, 200.34f, -30.73f, 60.91f, 244.07f, -45.73f, 77.22f, 30f);
...
void func_544(bool bParam0)//Position - 0x3C42A
{
...
void func_545(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x3C4CC
{
	*(uParam0[0 /*3*/]) = { vParam1 };
	*(uParam0[1 /*3*/]) = { vParam4 };
	uParam0->f_7 = fParam7;
...
void func_546()//Position - 0x3C4F0
{
...
void func_547()//Position - 0x3C5C4
{
	iLocal_572 = 0;
...
void func_548()//Position - 0x3C766
{
...
void func_549()//Position - 0x3C79E
{
	vLocal_381[0 /*3*/] = 0;
...
void func_550()//Position - 0x3CA83
{
	vLocal_341[0 /*3*/] = { func_551("MET1INITDRV", 1) };
	vLocal_341[1 /*3*/] = { func_551("MET1TCAR", 1) };
	vLocal_341[2 /*3*/] = { func_551("MET1WAIT", 1) };
	vLocal_341[3 /*3*/] = { func_551("MET1WANT", -1) };
	vLocal_341[4 /*3*/] = { func_551("MET1CHASE", 1) };
	vLocal_341[5 /*3*/] = { func_551("MET1GETBKT", 1) };
	vLocal_341[6 /*3*/] = { func_551("MET1DLT", 1) };
	vLocal_341[7 /*3*/] = { func_551("MET1HOME", 1) };
	vLocal_341[8 /*3*/] = { func_551("MET1HOTEL", 1) };
}

Vector3 func_551(char* sParam0, int iParam1)//Position - 0x3CB25
{
	vector3 vVar0;
...
void func_552()//Position - 0x3CB40
{
	sLocal_575[0] = "NONE";
...
int func_554(int iParam0)//Position - 0x3CC16
{
...
int func_555(int iParam0)//Position - 0x3CC43
{
...
void func_556(bool bParam0, bool bParam1)//Position - 0x3CC6F
{
	func_33(&iLocal_297);
	if (ENTITY::DOES_ENTITY_EXIST(Local_277))
	{
	...
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_542, 0);
...
void func_557(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x3CDC2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_558()//Position - 0x3CE12
{
	int iVar0;
