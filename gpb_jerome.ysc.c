...
void func_16(char* sParam0)//Position - 0x15FB
{
	struct<16> Var0;
...
void func_17(char* sParam0)//Position - 0x1621
{
	StringCopy(sParam0, "", 64);
}

void func_18(char* sParam0)//Position - 0x162F
{
	int iVar0;
...
void func_19(int iParam0, char* sParam1)//Position - 0x1673
{
	switch (iParam0)
	{
		case 0:
...
void func_20(char* sParam0)//Position - 0x183C
{
	char cVar0[64];
...
void func_21(char* sParam0)//Position - 0x1870
{
	struct<4> Var0;
...
int func_22()//Position - 0x189B
{
	func_23();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_23()//Position - 0x18B4
{
	int iVar0;
...
bool func_24(int iParam0)//Position - 0x19B1
{
	return Global_41396 == iParam0;
}

bool func_25(int iParam0)//Position - 0x19BF
{
	return iParam0 < 3;
}

int func_26(int iParam0)//Position - 0x19CB
{
	int iVar0;
	int iVar1;
...
int func_27(int iParam0)//Position - 0x1A08
{
	if (func_25(iParam0))
	{
...
var func_28(int iParam0)//Position - 0x1A2D
{
	return Global_1798[iParam0 /*29*/];
}

void func_29(char* sParam0)//Position - 0x1A3C
{
...
void func_30()//Position - 0x1A5D
{
	iLocal_254 = MISC::GET_RANDOM_INT_IN_RANGE(0, iLocal_253);
}

void func_31(char* sParam0)//Position - 0x1A6E
{
	int iVar0;
...
bool func_33(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1ADA
{
...
int func_34(char* sParam0, int iParam1, bool bParam2)//Position - 0x1B28
{
	Global_20806 = 0;
...
bool func_37(int iParam0)//Position - 0x1E95
{
	return func_38(iParam0, 20);
}

bool func_38(int iParam0, int iParam1)//Position - 0x1EA5
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_39()//Position - 0x1EC0
{
	return -1;
}

void func_40()//Position - 0x1EC9
{
	int iVar0;
...
bool func_46(int iParam0, int iParam1)//Position - 0x2146
{
	switch (iParam0)
	{
		case 5:
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x2181
{
...
void func_48(char[4] cParam0)//Position - 0x21D7
{
	int iVar0;
...
void func_49(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2212
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_50(char* sParam0)//Position - 0x22AD
{
	int iVar0;
...
void func_51(var uParam0)//Position - 0x22E5
{
}

void func_52(var uParam0, int iParam1, float fParam2)//Position - 0x22ED
{
}

void func_53()//Position - 0x22F5
{
	STREAMING::REMOVE_ANIM_DICT(&Local_388);
}

void func_54()//Position - 0x2304
{
	char* sVar0;
	struct<16> Var8;
...
void func_55(var uParam0)//Position - 0x237A
{
}

void func_56(char* sParam0)//Position - 0x2382
{
...
void func_57(int iParam0, char* sParam1, char* sParam2)//Position - 0x2395
{
...
bool func_59()//Position - 0x2488
{
	return Global_98721.f_345 > 0;
}

bool func_60()//Position - 0x2499
{
	bool bVar0;
...
void func_64(char* sParam0)//Position - 0x251C
{
	struct<8> Var0;
...
void func_65(char* sParam0)//Position - 0x255C
{
	func_19(iLocal_297, sParam0);
}

void func_66(char* sParam0)//Position - 0x256D
{
	StringCopy(sParam0, "MONOLOGUE_", 16);
	StringIntConCat(sParam0, Global_111505[iLocal_251] + 1, 16);
}

void func_67(int iParam0, bool bParam1)//Position - 0x258B
{
	int iVar0;
...
void func_68(int iParam0, bool bParam1)//Position - 0x25AC
{
	int iVar0;
...
void func_69(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x261D
{
	func_70(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_70(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x263D
{
	int iVar0;
...
int func_72(int iParam0)//Position - 0x292F
{
	int iVar0;
	int iVar1;
...
int func_75(int iParam0)//Position - 0x2A78
{
	if (func_77(iParam0))
	{
...
int func_76(int iParam0)//Position - 0x2A9F
{
	int iVar0;
...
int func_77(int iParam0)//Position - 0x2AD2
{
...
int func_78(int iParam0)//Position - 0x2AFC
{
	switch (iParam0)
	{
...
void func_79(int iParam0)//Position - 0x2BBA
{
	if (iLocal_447 == 1)
	{
...
void func_80(int iParam0, int iParam1, bool bParam2)//Position - 0x2BD9
{
	if (iLocal_447 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
...
int func_81(int iParam0, bool bParam1, int iParam2)//Position - 0x2C2C
{
	int iVar0;
...
int func_82(int iParam0, bool bParam1, bool bParam2)//Position - 0x2C76
{
	int iVar0;
...
float func_83(bool bParam0, float fParam1, float fParam2)//Position - 0x2D1A
{
	if (bParam0)
	{
		return fParam1;
...
float func_84(int iParam0, int iParam1, bool bParam2)//Position - 0x2D31
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_85(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2D8F
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_86(vector3 vParam0, vector3 vParam3)//Position - 0x2E20
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_87(vector3 vParam0)//Position - 0x2E41
{
	float fVar0;
	float fVar1;
...
int func_88(int iParam0)//Position - 0x2E80
{
	var uVar0;
...
void func_91()//Position - 0x2ED4
{
	Global_19671 = 0;
	func_92();
}

void func_92()//Position - 0x2EE4
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_93()//Position - 0x2F05
{
	return 0;
}

void func_94()//Position - 0x2F0E
{
}

int func_95()//Position - 0x2F16
{
	return 1;
}

float func_96(int iParam0, int iParam1)//Position - 0x2F1F
{
	return func_84(iParam0, iParam1, 1);
}

void func_97(int iParam0)//Position - 0x2F30
{
	int iVar0;
...
int func_98(int iParam0)//Position - 0x2F61
{
	int iVar0;
	int iVar1;
...
int func_99(int iParam0, bool bParam1)//Position - 0x2F92
{
	if (!func_77(iParam0))
	{
		if (!bParam1)
...
void func_100(var uParam0, var uParam1)//Position - 0x3045
{
	*uParam0 = (*uParam0 || uParam1);
}

void func_101(int iParam0, bool bParam1)//Position - 0x3056
{
	if (iParam0 == 1)
	{
		TASK::TASK_PLAY_ANIM(iLocal_240, &cLocal_324, &Local_218, 2f, -2f, -1, 0, 0, 0, 0, 0);
...
int func_102(int iParam0)//Position - 0x30C8
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_103()//Position - 0x30E9
{
	func_104();
}

void func_104()//Position - 0x30F5
{
	PED::SET_PED_PROP_INDEX(iLocal_240, 1, 0, 0, false);
}

void func_105()//Position - 0x3107
{
...
int func_109()//Position - 0x3204
{
	return 1;
}

bool func_110(var uParam0)//Position - 0x320D
{
	return func_111(Global_111560.f_20112, uParam0);
}

bool func_111(var uParam0, var uParam1)//Position - 0x3222
{
	return (uParam0 && uParam1) != 0;
}

int func_112(int iParam0)//Position - 0x3231
{
...
void func_113(int iParam0)//Position - 0x3358
{
	var uVar0;
...
void func_114(int iParam0)//Position - 0x3427
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
struct<6> func_115()//Position - 0x3447
{
	struct<6> Var0;
...
void func_116()//Position - 0x346B
{
	func_117();
}

void func_117()//Position - 0x3477
{
}

void func_118()//Position - 0x347F
{
	if (iLocal_245 == -1)
	{
