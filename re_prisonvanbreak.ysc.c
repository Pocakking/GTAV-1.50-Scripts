...
void func_2()//Position - 0x325
{
	...
	else if (!iLocal_266 && !bLocal_49)
	{
		...
		if (((ENTITY::IS_ENTITY_DEAD(iLocal_222, 0) && ENTITY::IS_ENTITY_DEAD(iLocal_223, 0)) && STREAMING::HAS_MODEL_LOADED(joaat("ambulance"))) && STREAMING::HAS_ANIM_DICT_LOADED("random@countrysiderobbery"))
		{
			...
			if (!PED::IS_PED_INJURED(iLocal_226[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_236))
			{
				...
				TASK::OPEN_SEQUENCE_TASK(&iLocal_269);
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_236, false) + Vector(0f, 5f, 0f), 1f, -1, 1048576000, 0, 1193033728);
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_226[1], 0) && ENTITY::DOES_ENTITY_EXIST(iLocal_230))
			{
				...
				TASK::OPEN_SEQUENCE_TASK(&iLocal_269);
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_230, false) + Vector(0f, 1f, 0f), 2f, -1, 1048576000, 0, 1193033728);
			...
			if (!PED::IS_PED_INJURED(iLocal_226[2]) && ENTITY::DOES_ENTITY_EXIST(iLocal_223))
			{
				...
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_269);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_223, false) + Vector(0f, 1f, 0f), 1f, -1, 1048576000, 0, 1193033728);
					TASK::TASK_SWAP_WEAPON(0, 0);
	...
	if (((((ENTITY::IS_ENTITY_DEAD(iLocal_222, 0) && ENTITY::IS_ENTITY_DEAD(iLocal_223, 0)) && ENTITY::IS_ENTITY_DEAD(iLocal_226[0], 0)) && ENTITY::IS_ENTITY_DEAD(iLocal_226[1], 0)) && ENTITY::IS_ENTITY_DEAD(iLocal_226[2], 0)) && (func_38() || !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 310.6203f, 2642.854f, 43.5173f, 200f, 200f, 180f, false, true, 0)))
	{
...
int func_17()//Position - 0x1D00
{
	return Global_1312745;
}

int func_18(int iParam0, int iParam1)//Position - 0x1D0C
{
	switch (iParam0)
	{
		case 0:
...
int func_19(int iParam0)//Position - 0x2080
{
	switch (iParam0)
	{
		case 29:
...
void func_20(int iParam0)//Position - 0x20AF
{
	int iVar0;
	int iVar1;
...
void func_21(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x20F1
{
	func_22(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_22(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2113
{
	int iVar0;
...
bool func_26(int iParam0)//Position - 0x254A
{
	return Global_41396 == iParam0;
}

bool func_27(int iParam0)//Position - 0x2558
{
	return iParam0 < 3;
}

int func_28(int iParam0)//Position - 0x2564
{
	int iVar0;
	int iVar1;
...
int func_29(int iParam0)//Position - 0x25A1
{
	if (func_27(iParam0))
	{
...
var func_30(int iParam0)//Position - 0x25C6
{
	return Global_1798[iParam0 /*29*/];
}

int func_31(int iParam0)//Position - 0x25D5
{
	int iVar0;
	int iVar1;
...
void func_32(int iParam0, int iParam1)//Position - 0x2618
{
	MISC::SET_BIT(&(Global_111560.f_24990.f_8[iParam0]), iParam1);
}

int func_33(int iParam0)//Position - 0x2633
{
	int iVar0;
...
int func_35(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x2701
{
...
int func_36()//Position - 0x28DB
{
	return 1;
}

int func_37()//Position - 0x28E4
{
...
int func_39(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2997
{
...
int func_40(char* sParam0, int iParam1, bool bParam2)//Position - 0x29E5
{
	Global_20806 = 0;
...
bool func_43(int iParam0)//Position - 0x2D52
{
	return func_44(iParam0, 20);
}

bool func_44(int iParam0, int iParam1)//Position - 0x2D62
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_45()//Position - 0x2D7D
{
	return -1;
}

void func_46()//Position - 0x2D86
{
	int iVar0;
...
bool func_53(int iParam0, int iParam1)//Position - 0x3020
{
	switch (iParam0)
	{
		case 5:
...
void func_55(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x30B2
{
...
void func_56(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x3108
{
...
int func_57(int iParam0)//Position - 0x31A3
{
	int iVar0;
...
float func_58(bool bParam0, float fParam1, float fParam2)//Position - 0x31DB
{
	if (bParam0)
	{
		return fParam1;
...
void func_59(var uParam0, int iParam1)//Position - 0x31F2
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
void func_61()//Position - 0x374D
{
	if (!PED::IS_PED_INJURED(iLocal_222) && !ENTITY::IS_ENTITY_DEAD(iLocal_236, 0))
	{
		...
		{
			TASK::TASK_SMART_FLEE_COORD(iLocal_222, vLocal_219, 1000f, -1, 0, 0);
			PED::SET_PED_KEEP_TASK(iLocal_222, true);
			iLocal_285 = 1;
		}
	}
	if (!PED::IS_PED_INJURED(iLocal_223) && !ENTITY::IS_ENTITY_DEAD(iLocal_236, 0))
	{
		...
		{
			TASK::TASK_SMART_FLEE_COORD(iLocal_223, vLocal_219, 1000f, -1, 0, 0);
			PED::SET_PED_KEEP_TASK(iLocal_223, true);
			iLocal_285 = 1;
		}
	}
...
int func_63(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x3923
{
...
int func_66(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x3E7D
{
	func_55(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
void func_67(int iParam0, var uParam1, int iParam2, float fParam3)//Position - 0x3ED1
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
...
void func_68(int iParam0)//Position - 0x4050
{
...
int func_70(char* sParam0)//Position - 0x4B07
{
	var uVar0;
...
struct<6> func_71()//Position - 0x4B2F
{
	struct<6> Var0;
...
int func_74(int iParam0)//Position - 0x589A
{
	if (func_78())
	{
		Global_111550 = 1;
...
void func_75(int iParam0)//Position - 0x58ED
{
	switch (iParam0)
	{
		case 0:
...
void func_76(char[4] cParam0, int iParam1)//Position - 0x59CE
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

char* func_77(int iParam0)//Position - 0x59E5
{
	char* sVar0;
...
int func_79(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x5A5F
{
	int iVar0;
...
void func_80(var uParam0, int iParam1)//Position - 0x5B96
{
	int iVar0;
...
bool func_81(int iParam0)//Position - 0x5BE5
{
	return func_82(iParam0, Global_41396);
}

int func_82(int iParam0, int iParam1)//Position - 0x5BF6
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_83(int iParam0)//Position - 0x5DD7
{
	if (Global_41396 == 15)
	{
		return 0;
...
int func_85(int iParam0, bool bParam1, int iParam2)//Position - 0x5F95
{
	int iVar0;
...
int func_86(int iParam0, bool bParam1, bool bParam2)//Position - 0x5FDF
{
	int iVar0;
...
void func_89(var uParam0, char* sParam1)//Position - 0x64C5
{
...
void func_91()//Position - 0x686E
{
	...
	if ((((STREAMING::HAS_MODEL_LOADED(joaat("s_m_y_ranger_01")) && STREAMING::HAS_MODEL_LOADED(joaat("a_m_y_genstreet_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("s_m_m_paramedic_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("sheriff"))) && STREAMING::HAS_MODEL_LOADED(joaat("phoenix")))
	{
		...
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_232[0], 0, 0, false);
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_232[0], 1, 0, false);
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_232[1], 1, 0, false);
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_232[1], 0, 0, false);
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_232[2], 1, 0, false);
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_232[2], 0, 0, false);
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_236, 1, 0, false);
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_236, 0, 0, false);
...
void func_92(int iParam0)//Position - 0x7063
{
	if (iParam0 == -1)
	{
		iParam0 = func_34();
...
void func_94(int iParam0)//Position - 0x70D6
{
	Global_111549 = iParam0;
}

int func_95(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x70E4
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
...
bool func_96(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x747E
{
	if (bParam6)
	{
...
bool func_97(int iParam0)//Position - 0x74C5
{
	int iVar0;
...
int func_98(int iParam0)//Position - 0x74E6
{
	return func_99(iParam0, 1);
}

int func_99(int iParam0, int iParam1)//Position - 0x74F5
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_100(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x7548
{
	func_101(func_112(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_101(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x7566
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_102(float fParam0, float fParam1, float fParam2)//Position - 0x7767
{
	float fVar0;
...
int func_103(int iParam0, int iParam1)//Position - 0x77A9
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_104(int iParam0)//Position - 0x784B
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_105(int iParam0)//Position - 0x785E
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_106(int iParam0)//Position - 0x7871
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_107(int iParam0)//Position - 0x7884
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_108(int iParam0)//Position - 0x7896
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_109(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_109(bool bParam0, int iParam1, int iParam2)//Position - 0x78BB
{
	if (bParam0)
	{
		return iParam1;
...
int func_110(int iParam0)//Position - 0x78D2
{
	return iParam0 & 15;
}

int func_111(int iParam0, int iParam1)//Position - 0x78DF
{
	int iVar0;
	int iVar1;
...
void func_113(var uParam0, int iParam1)//Position - 0x7A31
{
	if (iParam1 <= 0)
	{
		return;
...
void func_114(var uParam0, int iParam1)//Position - 0x7AB7
{
...
void func_115(var uParam0, int iParam1)//Position - 0x7AEA
{
	int iVar0;
	int iVar1;
...
void func_116(var uParam0, int iParam1)//Position - 0x7B3B
{
...
void func_117(var uParam0, int iParam1)//Position - 0x7B75
{
...
void func_118(var uParam0, int iParam1)//Position - 0x7BB0
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_119(int iParam0)//Position - 0x7BEC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_120(int iParam0, int iParam1)//Position - 0x7CC8
{
...
int func_121(int iParam0)//Position - 0x7CEB
{
	int iVar0;
...
var func_122()//Position - 0x8409
{
	return Global_98708.f_1;
}

int func_123()//Position - 0x8417
{
	if (Global_95621 != -1)
	{
...
bool func_126()//Position - 0x8481
{
	return Global_98721.f_346 > 0;
}

bool func_127()//Position - 0x8492
{
	return Global_98721.f_345 > 0;
}

var func_128()//Position - 0x84A3
{
	return Global_1312873;
}

int func_129()//Position - 0x84AF
{
...
bool func_131(int iParam0)//Position - 0x84F3
{
	return func_111(func_112(), iParam0);
}

int func_132(int iParam0, int iParam1, int iParam2)//Position - 0x8505
{
	int iVar0;
	int iVar1;
...
int func_133(int iParam0)//Position - 0x85E9
{
	if (!func_27(iParam0))
	{
		return 7;
...
bool func_134(int iParam0)//Position - 0x860D
{
	int iVar0;
	bool bVar1;
...
int func_135(float fParam0, bool bParam1)//Position - 0x866B
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_136(int iParam0, var uParam1)//Position - 0x8722
{
	switch (iParam0)
	{
		case 0:
...
int func_138(int iParam0)//Position - 0x99FA
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_139(int iParam0)//Position - 0x9D40
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_140(int iParam0)//Position - 0x9D78
{
	struct<2> Var0;
...
bool func_143()//Position - 0xA23B
{
	return Global_111278 > 0;
}

int func_144()//Position - 0xA249
{
	if (Global_95621 != -1)
	{
		return 1;
...
void func_149(int iParam0)//Position - 0xA4C8
{
	char cVar0[64];
...
void func_150(var uParam0)//Position - 0xA57D
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_151(int iParam0, bool bParam1)//Position - 0xA5BA
{
	switch (iParam0)
	{
		case 0:
...
void func_152(int iParam0)//Position - 0xA803
{
	Global_41947 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_153(int iParam0)//Position - 0xA815
{
	func_154(iParam0, 0, func_159(iParam0));
}

void func_154(int iParam0, int iParam1, int iParam2)//Position - 0xA82A
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_155(var uParam0)//Position - 0xA859
{
	struct<16> Var0;
	int iVar16;
...
void func_156(int iParam0, var uParam1)//Position - 0xA92A
{
	Global_111560.f_24990.f_43[iParam0] = *uParam1;
}

void func_157(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xA942
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_158(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xAAC4
{
...
int func_159(int iParam0)//Position - 0xAAFC
{
	int iVar0;
