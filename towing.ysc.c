	...
	switch (ScriptParam_0.f_2)
	{
		case 1:
			if (ScriptParam_0.f_4)
			{
				...
				{
					iLocal_2604 = func_262(100000f, iLocal_420, Global_111560.f_19968.f_9);
				}
			}
			else
			{
				...
				{
					iLocal_2604 = Global_111560.f_19968.f_9;
					iLocal_420 = Global_111560.f_19968.f_2;
				}
...
int func_74(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x4284
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_102()//Position - 0x5886
{
	...
	Global_111560.f_19968.f_2 = iLocal_420;
	switch (iLocal_420)
	{
		case 2:
...
void func_105(char[4] cParam0, int iParam1)//Position - 0x6145
{
...
void func_113()//Position - 0x6461
{
	...
	if (((!ENTITY::IS_ENTITY_DEAD(iLocal_3109, 0) && !ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0)) && VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_3109, Local_2996[0 /*20*/].f_6)) || (Global_111560.f_19968.f_3 == 0 || Global_111560.f_19968.f_3 > 2))
	{
		return;
	}
	switch (iLocal_3050)
...
int func_131(var uParam0, vector3 vParam1, float fParam4)//Position - 0x761A
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_133(bool bParam0, int iParam1)//Position - 0x776A
{
	...
	else if (Local_650[iLocal_2604 /*23*/] == 4)
	{
		...
		VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_2996[0 /*20*/].f_6, 0, 0, false);
	}
	if (bParam0)
	{
		bLocal_442 = true;
...
int func_134(vector3 vParam0, vector3 vParam3)//Position - 0x7A71
{
...
int func_135(vector3 vParam0, float fParam3, int iParam4, bool bParam5, var uParam6)//Position - 0x7AA2
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_138(vector3 vParam0, float fParam3, var uParam4, int iParam5)//Position - 0x7CD0
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_2996[*uParam4 /*20*/].f_6, 4, 0, false);
	...
	iLocal_3048 = VEHICLE::_ADD_SPEED_ZONE_FOR_COORD(OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vVar12, fVar15, -1.5f, -30f, 0f), 10f, 0f, 0);
	iLocal_3049 = VEHICLE::_ADD_SPEED_ZONE_FOR_COORD(OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vVar12, fVar15, -1.5f, 30f, 0f), 10f, 0f, 0);
...
bool func_140(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x7F2A
{
	if (bParam6)
	{
...
void func_147(var uParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, int iParam7, bool bParam8)//Position - 0x81A4
{
	int iVar0;
...
void func_163(var uParam0, vector3 vParam1, int iParam4)//Position - 0x8B38
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_184(int iParam0, vector3 vParam1, vector3 vParam4)//Position - 0x9C71
{
...
int func_185(var uParam0, var uParam1, vector3 vParam2, var uParam5, var uParam6, var uParam7, float fParam8, char[4] cParam9, char* sParam10, int iParam11)//Position - 0x9C91
{
	var uVar0;
	int iVar1;
	int iVar2;
...
float func_186(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)//Position - 0x9EE0
{
			...
			if (func_10(Local_2996[0 /*20*/].f_7, Local_650[iLocal_2604 /*23*/].f_1, 1) < IntToFloat(iLocal_3041))
			{
				if (!ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0))
				{
					...
					if (PED::IS_PED_IN_ANY_VEHICLE(Local_2996[0 /*20*/], 0))
					{
						TASK::OPEN_SEQUENCE_TASK(&iLocal_421);
						TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
						TASK::TASK_GO_TO_COORD_ANY_MEANS(0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_650[iLocal_2604 /*23*/].f_1, Local_650[iLocal_2604 /*23*/].f_4, 0f, 15f, 0f), 3f, 0, 0, 786603, -1082130432);
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_421);
...
void func_199(char* sParam0, int iParam1, bool bParam2, int iParam3, float fParam4, float fParam5, float fParam6, char* sParam7)//Position - 0xB0CA
{
	func_122(iParam1);
	if (bParam2)
	{
...
void func_203(struct<165> Param0, char* sParam165, char* sParam166, bool bParam167)//Position - 0xC227
{
	if (bParam167)
	{
		AUDIO::STOP_SCRIPTED_CONVERSATION(false);
...
int func_214(int iParam0, int iParam1, struct<7> Param2, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, int iParam22, var uParam23, char* sParam24, var uParam25, bool bParam26, var uParam27)//Position - 0xC68E
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
void func_217(char[4] cParam0)//Position - 0xCD72
{
	SYSTEM::SETTIMERA(0);
	func_105(cParam0, -1);
}

void func_218(struct<7> Param0, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, int iParam20, int iParam21)//Position - 0xCD86
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
void func_222(char[4] cParam0, int iParam1, int iParam2)//Position - 0xD1B5
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
...
{
	iLocal_420 = func_260(Global_111560.f_19968.f_2);
	...
	{
		iLocal_2604 = func_262(1300f, iLocal_420, Global_111560.f_19968.f_9);
		Global_111560.f_19968.f_9 = iLocal_2604;
	}
	if (iLocal_2604 == 0)
	{
		iLocal_420 = 3;
...
{
	iLocal_2604 = func_262(1300f, iParam0, Global_111560.f_19968.f_9);
	if (iLocal_2604 == -1)
	{
		return 0;
	}
