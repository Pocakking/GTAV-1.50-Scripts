...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_240 = PED::CREATE_PED(25, iLocal_36, vLocal_242, ScriptParam_0.f_17[0], 0, true);
	func_104();
	...
	while (iVar0 == 1)
	{
		...
		if (((ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iLocal_240) && !iLocal_250 == 25) && !iLocal_250 == 5) && !iLocal_250 == 6)
		{
			...
			{
				func_92();
				TASK::TASK_PLAY_ANIM(iLocal_240, &cLocal_324, &Local_218, 2f, -2f, -1, 0, 0, 0, 0, 0);
				iLocal_250 = 25;
			}
			else
			{
		...
		if (((((PED::IS_PED_INJURED(iLocal_240) || MISC::IS_BULLET_IN_AREA(vVar76, 50f, 1)) || MISC::IS_BULLET_IN_AREA(vVar76, 50f, 0)) || MISC::IS_PROJECTILE_IN_AREA(vVar76, 20f, 20f, 20f, 0)) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, vVar76, 50f)) || GRAPHICS::GET_IS_PETROL_DECAL_IN_RANGE(vVar76, 1f))
		{
			if (!func_90())
			{
				func_92();
		...
		switch (iLocal_250)
		{
			...
			case 6:
				...
				if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_240, 713668775) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_240, 713668775) != 0)
				{
					...
					TASK::TASK_PLAY_ANIM(iLocal_240, &cLocal_340, "idle_intro", 4f, -4f, -1, 0, 0, 0, 0, 0);
			...
			case 8:
				...
				else if (iLocal_440 == 1)
				{
					...
					{
						func_53(Global_111505[iLocal_251], iLocal_297, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_240, &Local_372, &Local_356));
					}
				}
				break;
			...
			case 9:
				...
				bVar36 = func_62();
				bVar37 = func_63();
				func_52(Global_111505[iLocal_251]);
				if (!bVar37 && (!bVar36 || bLocal_437))
				{
					if (bLocal_505)
					{
						Global_111505[iLocal_251] = uLocal_504;
					}
					else
					{
			...
			case 11:
				...
				{
					func_24(&sVar13);
					TASK::TASK_PLAY_ANIM(iLocal_240, &Local_404, &sVar13, 2f, -2f, -1, 0, 0, 0, 0, 0);
					iLocal_250 = 12;
				}
				else
				{
			...
			case 15:
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(&Local_404))
				{
					...
					if (!func_63())
					{
						...
						func_24(&sVar13);
						TASK::TASK_PLAY_ANIM(iLocal_240, &Local_404, &sVar13, 1000f, -1000f, -1, 0, 0, 0, 0, 0);
						PED::_0x2208438012482A1A(iLocal_240, 0, 0);
						iLocal_250 = 12;
					}
				}
		...
		if (((((((((((((iLocal_250 == 0 || iLocal_250 == 1) || iLocal_250 == 3) || iLocal_250 == 8) || iLocal_250 == 9) || iLocal_250 == 7) && func_85(iLocal_240, PLAYER::PLAYER_PED_ID(), 1) < 5f) && bLocal_436 == 1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) && iVar30 == 0) && bLocal_439 == 1) && !Global_3) && func_7()) && bVar81)
		{
			if (iLocal_298 == -1)
			{
	...
	while (true)
	{
		...
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_240, PLAYER::PLAYER_PED_ID(), 1) && !bVar83)
		{
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_240, false);
			TASK::CLEAR_PED_TASKS(iLocal_240);
			TASK::TASK_SMART_FLEE_PED(iLocal_240, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
...
void func_6(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x13A8
{
	int iVar0;
...
bool func_7()//Position - 0x14D3
{
	return !func_8();
}

int func_8()//Position - 0x14E0
{
	if (Global_111505[iLocal_251] == 3 && (iLocal_297 >= 4 && iLocal_297 <= 12))
	{
		return 1;
	}
	return 0;
...
void func_9()//Position - 0x150F
{
	func_10();
	if (func_103(iLocal_240) && func_103(PLAYER::PLAYER_PED_ID()))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_240, false);
		TASK::TASK_WANDER_STANDARD(iLocal_240, 1193033728, 0);
		PED::SET_PED_KEEP_TASK(iLocal_240, true);
	}
}

void func_10()//Position - 0x154B
{
	if (iLocal_449)
	{
		if (func_8())
		{
			ENTITY::DETACH_ENTITY(iLocal_448, 1, 1);
			iLocal_449 = 0;
		}
		else
		{
...
void func_12()//Position - 0x15C1
{
}

void func_13(var uParam0, int iParam1)//Position - 0x15C9
{
...
void func_14()//Position - 0x15E6
{
	Global_19671 = 0;
	func_15();
}

void func_15()//Position - 0x15F6
{
...
int func_17()//Position - 0x1675
{
	func_18();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_18()//Position - 0x168E
{
	int iVar0;
...
bool func_19(int iParam0)//Position - 0x178B
{
	return Global_41396 == iParam0;
}

bool func_20(int iParam0)//Position - 0x1799
{
	return iParam0 < 3;
}

int func_21(int iParam0)//Position - 0x17A5
{
	int iVar0;
	int iVar1;
...
int func_22(int iParam0)//Position - 0x17E2
{
	if (func_20(iParam0))
	{
...
var func_23(int iParam0)//Position - 0x1807
{
	return Global_1798[iParam0 /*29*/];
}

void func_24(char* sParam0)//Position - 0x1816
{
	struct<16> Var0;
...
void func_25(char* sParam0)//Position - 0x183C
{
	int iVar0;
...
void func_26(char* sParam0)//Position - 0x187A
{
	int iVar0;
...
void func_27(int iParam0, char* sParam1)//Position - 0x18BE
{
	switch (iParam0)
	{
		case 0:
...
void func_28(char* sParam0)//Position - 0x1A87
{
	char cVar0[64];
...
void func_29(char* sParam0)//Position - 0x1ABB
{
	struct<4> Var0;
...
void func_30(char* sParam0)//Position - 0x1AE6
{
...
void func_31()//Position - 0x1B07
{
	iLocal_254 = MISC::GET_RANDOM_INT_IN_RANGE(0, iLocal_253);
}

void func_32(char* sParam0)//Position - 0x1B18
{
	int iVar0;
...
bool func_34(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1B84
{
...
int func_35(char* sParam0, int iParam1, bool bParam2)//Position - 0x1BD2
{
	Global_20806 = 0;
...
bool func_38(int iParam0)//Position - 0x1F3F
{
	return func_39(iParam0, 20);
}

bool func_39(int iParam0, int iParam1)//Position - 0x1F4F
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_40()//Position - 0x1F6A
{
	return -1;
}

void func_41()//Position - 0x1F73
{
	int iVar0;
...
bool func_47(int iParam0, int iParam1)//Position - 0x21F0
{
	switch (iParam0)
	{
		case 5:
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x222B
{
...
void func_49(char[4] cParam0)//Position - 0x2281
{
	int iVar0;
...
void func_50(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x22BC
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_51(char* sParam0)//Position - 0x2357
{
	int iVar0;
...
void func_52(var uParam0)//Position - 0x238F
{
}

void func_53(int iParam0, int iParam1, float fParam2)//Position - 0x2397
{
	if (iParam0 == 3)
	{
		if ((iParam1 == 3 && !iLocal_449) && fParam2 >= 0.773f)
		{
			...
			ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_448, iLocal_240, PED::GET_PED_BONE_INDEX(iLocal_240, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			iLocal_449 = 1;
		}
...
void func_54()//Position - 0x242B
{
	STREAMING::REMOVE_ANIM_DICT(&Local_388);
}

void func_55()//Position - 0x243A
{
	char* sVar0;
	struct<16> Var8;
	
	func_58(Global_111505[iLocal_251] + 1, &sVar0, &Var8);
	StringConCat(&Var8, "_", 64);
	StringIntConCat(&Var8, iLocal_297, 64);
	Local_356 = { Var8 };
	Local_372 = { Local_388 };
	func_57(&Local_356);
	TASK::TASK_PLAY_ANIM(iLocal_240, &Local_388, &Var8, 1000f, -8f, -1, 0, 0, 0, 0, 0);
	PED::_0x2208438012482A1A(iLocal_240, 0, 0);
	func_56(Global_111505[iLocal_251]);
}

void func_56(var uParam0)//Position - 0x24B0
{
}

void func_57(char* sParam0)//Position - 0x24B8
{
...
void func_58(int iParam0, char* sParam1, char* sParam2)//Position - 0x24CB
{
...
bool func_60()//Position - 0x25BE
{
	return Global_98721.f_345 > 0;
}

bool func_61()//Position - 0x25CF
{
	bool bVar0;
...
void func_65(char* sParam0)//Position - 0x2652
{
	struct<8> Var0;
...
void func_66(char* sParam0)//Position - 0x2692
{
	func_27(iLocal_297, sParam0);
}

void func_67(char* sParam0)//Position - 0x26A3
{
	StringCopy(sParam0, "MONOLOGUE_", 16);
	StringIntConCat(sParam0, Global_111505[iLocal_251] + 1, 16);
}

void func_68(int iParam0, bool bParam1)//Position - 0x26C1
{
	int iVar0;
...
void func_69(int iParam0, bool bParam1)//Position - 0x26E2
{
	int iVar0;
...
void func_70(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x2753
{
	func_71(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_71(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2773
{
	int iVar0;
...
int func_73(int iParam0)//Position - 0x2A65
{
	int iVar0;
	int iVar1;
...
int func_76(int iParam0)//Position - 0x2BAE
{
	if (func_78(iParam0))
	{
...
int func_77(int iParam0)//Position - 0x2BD5
{
	int iVar0;
...
int func_78(int iParam0)//Position - 0x2C08
{
...
int func_79(int iParam0)//Position - 0x2C32
{
	switch (iParam0)
	{
...
void func_80(int iParam0)//Position - 0x2CF0
{
	if (iLocal_447 == 1)
	{
...
void func_81(int iParam0, int iParam1, bool bParam2)//Position - 0x2D0F
{
	if (iLocal_447 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
...
int func_82(int iParam0, bool bParam1, int iParam2)//Position - 0x2D62
{
	int iVar0;
...
int func_83(int iParam0, bool bParam1, bool bParam2)//Position - 0x2DAC
{
	int iVar0;
...
float func_84(bool bParam0, float fParam1, float fParam2)//Position - 0x2E50
{
	if (bParam0)
	{
		return fParam1;
...
float func_85(int iParam0, int iParam1, bool bParam2)//Position - 0x2E67
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_86(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2EC5
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_87(vector3 vParam0, vector3 vParam3)//Position - 0x2F56
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_88(vector3 vParam0)//Position - 0x2F77
{
	float fVar0;
	float fVar1;
...
int func_89(int iParam0)//Position - 0x2FB6
{
	var uVar0;
...
void func_92()//Position - 0x300A
{
	Global_19671 = 0;
	func_93();
}

void func_93()//Position - 0x301A
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
bool func_94()//Position - 0x303B
{
	return func_8();
}

void func_95()//Position - 0x3047
{
}

int func_96()//Position - 0x304F
{
	if (Global_111505[iLocal_251] == 3)
	{
		return 0;
	}
	return 1;
...
float func_97(int iParam0, int iParam1)//Position - 0x3068
{
	return func_85(iParam0, iParam1, 1);
}

void func_98(int iParam0)//Position - 0x3079
{
	int iVar0;
...
int func_99(int iParam0)//Position - 0x30AA
{
	int iVar0;
	int iVar1;
...
int func_100(int iParam0, bool bParam1)//Position - 0x30DB
{
	if (!func_78(iParam0))
	{
		if (!bParam1)
...
void func_101(var uParam0, var uParam1)//Position - 0x318E
{
	*uParam0 = (*uParam0 || uParam1);
}

void func_102(int iParam0, bool bParam1)//Position - 0x319F
{
	if (iParam0 == 1)
	{
		TASK::TASK_PLAY_ANIM(iLocal_240, &cLocal_324, &Local_218, 2f, -2f, -1, 0, 0, 0, 0, 0);
	...
	{
		TASK::TASK_PLAY_ANIM(iLocal_240, &cLocal_324, &Local_218, 1000f, 1000f, -1, 0, 0, 0, 0, 0);
	}
	Local_356 = { Local_218 };
	if (bParam1)
	{
...
int func_103(int iParam0)//Position - 0x3211
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_104()//Position - 0x3232
{
	func_105();
}

void func_105()//Position - 0x323E
{
	PED::SET_PED_CAN_EVASIVE_DIVE(iLocal_240, 0);
	PED::SET_PED_CONFIG_FLAG(iLocal_240, 185, true);
	PED::SET_PED_CONFIG_FLAG(iLocal_240, 318, true);
}

void func_106()//Position - 0x3260
{
...
int func_110()//Position - 0x335F
{
	return 1;
}

bool func_111(var uParam0)//Position - 0x3368
{
	return func_112(Global_111560.f_20112, uParam0);
}

bool func_112(var uParam0, var uParam1)//Position - 0x337D
{
	return (uParam0 && uParam1) != 0;
}

int func_113(int iParam0)//Position - 0x338C
{
	if (MISC::IS_STRING_NULL_OR_EMPTY(iParam0))
	{
		return 0;
	}
	if (MISC::ARE_STRINGS_EQUAL(iParam0, "gpb_AndyMoon"))
	{
		return 1;
	}
	else if (MISC::ARE_STRINGS_EQUAL(iParam0, "gpb_Baygor"))
	{
		return 2;
	}
	else if (MISC::ARE_STRINGS_EQUAL(iParam0, "gpb_BillBinder"))
	{
		return 4;
	}
	else if (MISC::ARE_STRINGS_EQUAL(iParam0, "gpb_Clinton"))
	{
		return 8;
	}
	else if (MISC::ARE_STRINGS_EQUAL(iParam0, "gpb_Griff"))
	{
		return 16;
	}
	else if (MISC::ARE_STRINGS_EQUAL(iParam0, "gpb_Jane"))
	{
		return 64;
	}
	else if (MISC::ARE_STRINGS_EQUAL(iParam0, "gpb_Jerome"))
	{
		return 128;
	}
	else if (MISC::ARE_STRINGS_EQUAL(iParam0, "gpb_Jesse"))
	{
		return 256;
	}
	else if (MISC::ARE_STRINGS_EQUAL(iParam0, "gpb_Mani"))
	{
		return 512;
	}
	else if (MISC::ARE_STRINGS_EQUAL(iParam0, "gpb_Mime"))
	{
		return 1024;
	}
	else if (MISC::ARE_STRINGS_EQUAL(iParam0, "gpb_PamelaDrake"))
	{
		return 2048;
	}
	else if (MISC::ARE_STRINGS_EQUAL(iParam0, "gpb_Superhero"))
	{
		return 4096;
	}
	else if (MISC::ARE_STRINGS_EQUAL(iParam0, "gpb_Zombie"))
	{
		return 8192;
	}
	return 0;
...
void func_114(int iParam0)//Position - 0x34B3
{
	var uVar0;
...
void func_115(int iParam0)//Position - 0x3582
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
struct<6> func_116()//Position - 0x35A2
{
	struct<6> Var0;
...
void func_117()//Position - 0x35C6
{
	func_118();
}

void func_118()//Position - 0x35D2
{
}

void func_119()//Position - 0x35DA
{
	if (iLocal_245 == -1)
	{
