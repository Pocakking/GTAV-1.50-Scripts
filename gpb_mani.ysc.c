...
int func_16()//Position - 0x1619
{
	func_17();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_17()//Position - 0x1632
{
	int iVar0;
...
bool func_19(int iParam0)//Position - 0x173D
{
	return iParam0 < 3;
}

int func_20(int iParam0)//Position - 0x1749
{
	int iVar0;
	int iVar1;
...
int func_21(int iParam0)//Position - 0x1786
{
	if (func_19(iParam0))
	{
...
var func_22(int iParam0)//Position - 0x17AB
{
	return Global_1798[iParam0 /*29*/];
}

void func_23(char* sParam0)//Position - 0x17BA
{
	struct<16> Var0;
...
void func_24(char* sParam0)//Position - 0x17E0
{
	int iVar0;
...
void func_25(char* sParam0)//Position - 0x181E
{
	int iVar0;
...
void func_26(int iParam0, char* sParam1)//Position - 0x1862
{
	switch (iParam0)
	{
		case 0:
...
void func_27(char* sParam0)//Position - 0x1A2B
{
	char cVar0[64];
...
void func_29(char* sParam0)//Position - 0x1A8A
{
...
void func_30()//Position - 0x1AAB
{
	iLocal_254 = MISC::GET_RANDOM_INT_IN_RANGE(0, iLocal_253);
}

void func_31(char* sParam0)//Position - 0x1ABC
{
	int iVar0;
...
bool func_33(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1B28
{
...
int func_34(char* sParam0, int iParam1, bool bParam2)//Position - 0x1B76
{
	Global_20806 = 0;
...
bool func_37(int iParam0)//Position - 0x1EE3
{
	return func_38(iParam0, 20);
}

bool func_38(int iParam0, int iParam1)//Position - 0x1EF3
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_39()//Position - 0x1F0E
{
	return -1;
}

void func_40()//Position - 0x1F17
{
	int iVar0;
...
bool func_46(int iParam0, int iParam1)//Position - 0x2194
{
	switch (iParam0)
	{
		case 5:
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x21CF
{
...
void func_48(char[4] cParam0)//Position - 0x2225
{
	int iVar0;
...
void func_49(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2260
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_50(char* sParam0)//Position - 0x22FB
{
	int iVar0;
...
void func_51(var uParam0)//Position - 0x2333
{
}

void func_52(var uParam0, int iParam1, float fParam2)//Position - 0x233B
{
}

void func_53()//Position - 0x2343
{
	STREAMING::REMOVE_ANIM_DICT(&Local_388);
}

void func_54()//Position - 0x2352
{
	char* sVar0;
	struct<16> Var8;
...
void func_55(var uParam0)//Position - 0x23C8
{
}

void func_56(char* sParam0)//Position - 0x23D0
{
...
void func_57(int iParam0, char* sParam1, char* sParam2)//Position - 0x23E3
{
...
bool func_59()//Position - 0x24D6
{
	return Global_98721.f_345 > 0;
}

bool func_60()//Position - 0x24E7
{
	bool bVar0;
...
void func_64(char* sParam0)//Position - 0x256A
{
	struct<8> Var0;
...
void func_65(char* sParam0)//Position - 0x25AA
{
	func_26(iLocal_297, sParam0);
}

void func_66(char* sParam0)//Position - 0x25BB
{
	StringCopy(sParam0, "MONOLOGUE_", 16);
	StringIntConCat(sParam0, Global_111505[iLocal_251] + 1, 16);
}

void func_67(int iParam0, bool bParam1)//Position - 0x25D9
{
	int iVar0;
...
void func_68(int iParam0, bool bParam1)//Position - 0x25FA
{
	int iVar0;
...
void func_69(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x266B
{
	func_70(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_70(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x268B
{
	int iVar0;
...
int func_72(int iParam0)//Position - 0x297D
{
	int iVar0;
	int iVar1;
...
void func_73(var uParam0)//Position - 0x29C0
{
...
int func_76(int iParam0)//Position - 0x2AED
{
	int iVar0;
...
int func_77(int iParam0)//Position - 0x2B20
{
...
int func_78(int iParam0)//Position - 0x2B4A
{
	switch (iParam0)
	{
...
void func_79(int iParam0)//Position - 0x2C08
{
	if (iLocal_447 == 1)
	{
...
void func_80(int iParam0, int iParam1, bool bParam2)//Position - 0x2C27
{
	if (iLocal_447 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
...
int func_81(int iParam0, bool bParam1, int iParam2)//Position - 0x2C7A
{
	int iVar0;
...
int func_82(int iParam0, bool bParam1, bool bParam2)//Position - 0x2CC4
{
	int iVar0;
...
float func_83(bool bParam0, float fParam1, float fParam2)//Position - 0x2D68
{
	if (bParam0)
	{
		return fParam1;
...
float func_84(int iParam0, int iParam1, bool bParam2)//Position - 0x2D7F
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_85(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2DDD
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_86(vector3 vParam0, vector3 vParam3)//Position - 0x2E6E
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_87(vector3 vParam0)//Position - 0x2E8F
{
	float fVar0;
	float fVar1;
...
int func_88(int iParam0)//Position - 0x2ECE
{
	var uVar0;
...
void func_91()//Position - 0x2F22
{
	Global_19671 = 0;
	func_92();
}

void func_92()//Position - 0x2F32
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_93()//Position - 0x2F53
{
	return 0;
}

void func_94()//Position - 0x2F5C
{
}

int func_95()//Position - 0x2F64
{
	return 1;
}

float func_96(int iParam0, int iParam1)//Position - 0x2F6D
{
	return func_84(iParam0, iParam1, 1);
}

void func_97(int iParam0)//Position - 0x2F7E
{
	int iVar0;
...
int func_98(int iParam0)//Position - 0x2FAF
{
	int iVar0;
	int iVar1;
...
int func_99(int iParam0, bool bParam1)//Position - 0x2FE0
{
	if (!func_77(iParam0))
	{
		if (!bParam1)
...
void func_100(var uParam0, var uParam1)//Position - 0x3093
{
	*uParam0 = (*uParam0 || uParam1);
}

void func_101(int iParam0, bool bParam1)//Position - 0x30A4
{
	if (iParam0 == 1)
	{
		TASK::TASK_PLAY_ANIM(iLocal_240, &cLocal_324, &Local_218, 2f, -2f, -1, 0, 0, 0, 0, 0);
...
int func_102(int iParam0)//Position - 0x3116
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_103()//Position - 0x3137
{
	func_104();
}

void func_104()//Position - 0x3143
{
}

void func_105()//Position - 0x314B
{
...
int func_109()//Position - 0x3245
{
	return 1;
}

bool func_110(var uParam0)//Position - 0x324E
{
	return func_111(Global_111560.f_20112, uParam0);
}

bool func_111(var uParam0, var uParam1)//Position - 0x3263
{
	return (uParam0 && uParam1) != 0;
}

int func_112(int iParam0)//Position - 0x3272
{
...
void func_113(int iParam0)//Position - 0x3399
{
	var uVar0;
...
void func_114(int iParam0)//Position - 0x3468
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
struct<6> func_115()//Position - 0x3488
{
	struct<6> Var0;
...
void func_116()//Position - 0x34AC
{
	func_117();
}

void func_117()//Position - 0x34B8
{
}

void func_118()//Position - 0x34C0
{
	if (iLocal_245 == -1)
	{
