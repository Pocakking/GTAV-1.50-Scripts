...
int func_95()//Position - 0x2F35
{
	return 1;
}

float func_96(int iParam0, int iParam1)//Position - 0x2F3E
{
	return func_84(iParam0, iParam1, 1);
}

void func_97(int iParam0)//Position - 0x2F4F
{
	int iVar0;
...
int func_98(int iParam0)//Position - 0x2F80
{
	int iVar0;
	int iVar1;
...
int func_99(int iParam0, bool bParam1)//Position - 0x2FB1
{
	if (!func_77(iParam0))
	{
		if (!bParam1)
...
void func_100(var uParam0, var uParam1)//Position - 0x3064
{
	*uParam0 = (*uParam0 || uParam1);
}

void func_101(int iParam0, bool bParam1)//Position - 0x3075
{
	if (iParam0 == 1)
	{
		TASK::TASK_PLAY_ANIM(iLocal_240, &cLocal_324, &Local_218, 2f, -2f, -1, 0, 0, 0, 0, 0);
...
int func_102(int iParam0)//Position - 0x30E7
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_103()//Position - 0x3108
{
	func_104();
}

void func_104()//Position - 0x3114
{
}

void func_105()//Position - 0x311C
{
...
int func_109()//Position - 0x3213
{
	return 1;
}

bool func_110(var uParam0)//Position - 0x321C
{
	return func_111(Global_111560.f_20112, uParam0);
}

bool func_111(var uParam0, var uParam1)//Position - 0x3231
{
	return (uParam0 && uParam1) != 0;
}

int func_112(int iParam0)//Position - 0x3240
{
...
void func_113(int iParam0)//Position - 0x3367
{
	var uVar0;
...
void func_114(int iParam0)//Position - 0x3436
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
struct<6> func_115()//Position - 0x3456
{
	struct<6> Var0;
...
void func_116()//Position - 0x347A
{
	func_117();
}

void func_117()//Position - 0x3486
{
}
