...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		switch (Var0)
		{
			...
			case 1:
				func_188(&Var0, vVar61, "SONARAU", "SONAR_CALL", 3, "ABIGAIL", 10000, 1101004800);
				break;
		}
		if (func_173(&Var0, 0))
		{
...
int func_26(var uParam0)//Position - 0x288A
{
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x28AC
{
	int iVar0;
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2934
{
...
int func_29(int iParam0)//Position - 0x2974
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x29A2
{
...
int func_31(int iParam0)//Position - 0x2A7E
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2AC0
{
	int iVar0;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x2B23
{
	int iVar0;
...
int func_34(int iParam0, int iParam1)//Position - 0x2BB1
{
	struct<82> Var0;
...
void func_35(int iParam0, var uParam1, int iParam2)//Position - 0x2BF3
{
	int iVar0;
...
bool func_36(int iParam0)//Position - 0x2E4F
{
	return iParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2E5B
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x3106
{
	switch (iParam0)
	{
		case 1:
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x31B6
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x33A9
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0)//Position - 0x33C9
{
	int iVar0;
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x347A
{
	char* sVar0;
...
int func_43(int iParam0, int iParam1, bool bParam2)//Position - 0x35A9
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x361A
{
...
int func_45(int iParam0)//Position - 0x36F3
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x3730
{
	if (func_36(iParam0))
	{
...
var func_47(int iParam0)//Position - 0x3755
{
	return Global_1798[iParam0 /*29*/];
}

void func_48(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3764
{
	int iVar0;
	int iVar1;
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x3904
{
	int iVar0;
	var uVar1;
...
int func_50(var uParam0)//Position - 0x3936
{
	int iVar0;
	int iVar1;
...
int func_51()//Position - 0x396A
{
	return Global_1312745;
}

int func_52(int iParam0, int iParam1)//Position - 0x3976
{
	var uVar0;
	var uVar1;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x39A2
{
	int iVar0;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3EEA
{
	int iVar0;
...
int func_55()//Position - 0x412C
{
	func_56();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_56()//Position - 0x4145
{
	int iVar0;
...
bool func_57(int iParam0)//Position - 0x4242
{
	return Global_41396 == iParam0;
}

void func_58(int iParam0, bool bParam1)//Position - 0x4250
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_59(int iParam0, var uParam1)//Position - 0x4343
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_60(int iParam0)//Position - 0x45CB
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_61(int iParam0)//Position - 0x4666
{
...
int func_62(int iParam0, int iParam1)//Position - 0x47F8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var uParam1)//Position - 0x5369
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x53A4
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x5618
{
	int iVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x5654
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_67(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x5BAF
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5BF3
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x630E
{
	if (bParam6)
	{
...
int func_70(var uParam0)//Position - 0x6355
{
...
bool func_71(int iParam0)//Position - 0x63B0
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x63C0
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x642A
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x675A
{
	return Global_30736;
}

int func_75(int iParam0)//Position - 0x6765
{
	return func_72(iParam0, 5, 1);
}

int func_76(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6775
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x6817
{
	switch (iParam0)
	{
		case -1:
...
int func_78(int iParam0)//Position - 0x6E34
{
	if (iParam0 != func_87())
	{
...
Vector3 func_79(int iParam0, int iParam1)//Position - 0x6E92
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_80(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6F40
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_81(vector3 vParam0, float fParam3)//Position - 0x6FD5
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_82(int iParam0)//Position - 0x7019
{
	struct<6> Var0;
...
struct<6> func_83(int iParam0)//Position - 0x719D
{
	return func_84(iParam0);
}

struct<6> func_84(int iParam0)//Position - 0x71AB
{
	struct<6> Var0;
...
int func_85(int iParam0, var uParam1)//Position - 0x7C72
{
	switch (iParam0)
	{
		case 0:
...
int func_86(int iParam0)//Position - 0x7CF4
{
	if (iParam0 != func_87())
	{
...
int func_87()//Position - 0x7D52
{
	return -1;
}

Vector3 func_88(int iParam0)//Position - 0x7D5B
{
	switch (iParam0)
	{
		case 1:
...
int func_89()//Position - 0x7F66
{
	return func_90(PLAYER::PLAYER_ID());
}

int func_90(int iParam0)//Position - 0x7F76
{
	return MISC::GET_BITS_IN_RANGE(Global_2424073[iParam0 /*421*/].f_309.f_3, 28, 31);
}

int func_91(int iParam0)//Position - 0x7F93
{
	return func_72(iParam0, 0, 0);
}

int func_92(int iParam0)//Position - 0x7FA3
{
	switch (iParam0)
	{
		case -1:
...
bool func_93()//Position - 0x82C7
{
	return Global_98721.f_345 > 0;
}

var func_94()//Position - 0x82D8
{
	var uVar0;
...
void func_95(var uParam0, int iParam1)//Position - 0x831E
{
	if (iParam1 <= 0)
	{
		return;
...
void func_96(var uParam0, int iParam1)//Position - 0x83A4
{
...
void func_97(var uParam0, int iParam1)//Position - 0x83D7
{
	int iVar0;
	int iVar1;
...
int func_98(int iParam0, int iParam1)//Position - 0x8428
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_99(int iParam0)//Position - 0x84CA
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_100(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_100(bool bParam0, int iParam1, int iParam2)//Position - 0x84EF
{
	if (bParam0)
	{
		return iParam1;
...
int func_101(var uParam0)//Position - 0x8506
{
	return uParam0 & 15;
}

void func_102(var uParam0, int iParam1)//Position - 0x8513
{
...
void func_103(var uParam0, int iParam1)//Position - 0x854D
{
...
void func_104(var uParam0, int iParam1)//Position - 0x8588
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_105()//Position - 0x85C4
{
	func_56();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_106(int iParam0)//Position - 0x85DD
{
	var uVar0;
	vector3 vVar1[24];
...
void func_107(char* sParam0, var uParam1, int iParam2)//Position - 0x8636
{
...
bool func_108(bool bParam0)//Position - 0x8678
{
...
struct<2> func_109(int iParam0)//Position - 0x86A3
{
	struct<2> Var0;
...
void func_110(int iParam0, var uParam1)//Position - 0x8AF0
{
	switch (iParam0)
	{
		case 0:
...
int func_112(int iParam0)//Position - 0x9DC8
{
	switch (iParam0)
	{
		case 0:
...
int func_113(int iParam0)//Position - 0xA10E
{
	int iVar0;
...
void func_114(int iParam0)//Position - 0xA1B2
{
	struct<2> Var0;
...
void func_115(int iParam0)//Position - 0xA24D
{
	if (iParam0 < 63)
	{
		func_116();
...
void func_117(int iParam0)//Position - 0xA2AB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_118(int iParam0)//Position - 0xA304
{
...
int func_119(int iParam0)//Position - 0xA387
{
	int iVar0;
...
void func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA3B8
{
	func_121(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_121(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA3CD
{
	int iVar0;
...
int func_123(int iParam0, int iParam1, int iParam2)//Position - 0xA480
{
...
int func_124(int iParam0, int iParam1, int iParam2)//Position - 0xA49B
{
	int iVar0;
...
int func_125(int iParam0)//Position - 0xA4E7
{
	int iVar0;
...
int func_126(int iParam0)//Position - 0xA530
{
	if (func_127(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_127(int iParam0)//Position - 0xA550
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_128(int iParam0)//Position - 0xA571
{
	switch (iParam0)
	{
		case 5:
...
int func_130(int iParam0)//Position - 0xA641
{
	switch (iParam0)
	{
		case 5:
...
void func_131(var uParam0, bool bParam1, bool bParam2)//Position - 0xA694
{
	int iVar0;
...
int func_132(int iParam0)//Position - 0xA789
{
	switch (iParam0)
	{
		case 5:
...
void func_133(bool bParam0)//Position - 0xA7F4
{
	int iVar0;
...
void func_134(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0xA832
{
	if (bParam0)
	{
...
bool func_135()//Position - 0xA96B
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_136(int iParam0, int iParam1)//Position - 0xA988
{
	bool bVar0;
...
int func_137(int iParam0, bool bParam1)//Position - 0xA9D3
{
	int iVar0;
	int iVar1;
...
int func_138(int iParam0)//Position - 0xAA14
{
...
bool func_139()//Position - 0xAA56
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_140(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xAA67
{
	int iVar0;
...
void func_142(int iParam0)//Position - 0xAAC1
{
	if (iParam0 == 1)
	{
...
int func_143(int iParam0)//Position - 0xAAE4
{
...
void func_144()//Position - 0xAB21
{
	Global_19671 = 0;
	func_145();
}

void func_145()//Position - 0xAB31
{
...
int func_149(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xAC17
{
...
void func_150(int iParam0)//Position - 0xADA6
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_152(int iParam0)//Position - 0xAE23
{
	if (func_157())
	{
		return;
...
void func_153(int iParam0)//Position - 0xAE56
{
	if (func_157())
	{
		return;
...
void func_154(bool bParam0, bool bParam1)//Position - 0xAEE0
{
	if (bParam0)
	{
		if (func_156(0))
...
bool func_155()//Position - 0xAF54
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

int func_156(int iParam0)//Position - 0xAF65
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
bool func_157()//Position - 0xAFBF
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

int func_158(int iParam0)//Position - 0xAFD1
{
...
int func_159(int iParam0)//Position - 0xB012
{
	int iVar0;
...
void func_160(int iParam0)//Position - 0xB057
{
...
int func_161(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB089
{
	int iVar0;
...
void func_162(var uParam0, int iParam1)//Position - 0xB1C0
{
	int iVar0;
...
bool func_163(int iParam0)//Position - 0xB20F
{
	return func_164(iParam0, Global_41396);
}

int func_164(int iParam0, int iParam1)//Position - 0xB220
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_165(int iParam0)//Position - 0xB401
{
	if (Global_41396 == 15)
	{
		return 0;
...
int func_166()//Position - 0xB423
{
	return func_167(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_167(char* sParam0, int iParam1)//Position - 0xB434
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_169(int iParam0, int iParam1)//Position - 0xB4A1
{
	switch (iParam0)
	{
		case 0:
...
int func_170(vector3 vParam0, bool bParam3)//Position - 0xB928
{
	int iVar0;
...
float func_171(bool bParam0, float fParam1, float fParam2)//Position - 0xB954
{
	if (bParam0)
	{
		return fParam1;
...
int func_172(int iParam0)//Position - 0xB96B
{
	switch (iParam0)
	{
		case 0:
...
int func_173(var uParam0, int iParam1)//Position - 0xB9FA
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_174()//Position - 0xC1E0
{
	func_27(&(Global_102125.f_2890), &Global_102125, 0, 1, 1, 0);
}

int func_175(var uParam0)//Position - 0xC1FB
{
	float fVar0;
...
void func_176(int iParam0, int iParam1)//Position - 0xC289
{
	if (iParam0 == 1)
	{
		if (!func_130(iParam1))
...
int func_177(bool bParam0)//Position - 0xC2ED
{
	int iVar0;
...
int func_178(int iParam0)//Position - 0xC384
{
	if (func_127(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
int func_179(int iParam0)//Position - 0xC3AE
{
	int iVar0;
...
var func_180()//Position - 0xCACB
{
	return Global_98708.f_1;
}

int func_181()//Position - 0xCAD9
{
	if (Global_95621 != -1)
	{
...
bool func_184()//Position - 0xCB43
{
	return Global_98721.f_346 > 0;
}

bool func_185(int iParam0, int iParam1)//Position - 0xCB54
{
	switch (iParam0)
	{
		case 5:
...
var func_186()//Position - 0xCB8F
{
	return Global_1312873;
}

int func_187()//Position - 0xCB9B
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_188(var uParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xCBB7
{
	var uVar0;
...
void func_189(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCC3F
{
...
void func_190(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCC7A
{
...
void func_191(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCCD0
{
...
float func_192(int iParam0, vector3 vParam1, bool bParam4)//Position - 0xCD6B
{
	vector3 vVar0;
...
void func_193(int iParam0, var uParam1, char* sParam2)//Position - 0xCDA5
{
	if (func_127(*uParam1) && func_127(PLAYER::PLAYER_PED_ID()))
	{
		switch (*iParam0)
		{
			...
			case 1:
				...
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_92, vLocal_95, 8f, 0, true, 0))
					{
...
bool func_194(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xD0A1
{
...
int func_195(char* sParam0, int iParam1, bool bParam2)//Position - 0xD0EF
{
	Global_20806 = 0;
...
bool func_198(int iParam0)//Position - 0xD45C
{
	return func_199(iParam0, 20);
}

bool func_199(int iParam0, int iParam1)//Position - 0xD46C
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

void func_200()//Position - 0xD487
{
	int iVar0;
...
float func_205(int iParam0, int iParam1, bool bParam2)//Position - 0xD6E1
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_206(int iParam0, int iParam1, vector3 vParam2)//Position - 0xD73F
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_207(int iParam0, bool bParam1)//Position - 0xD830
{
	if (iParam0 == -1)
	{
		return;
...
int func_208(int iParam0)//Position - 0xD86C
{
	if (Global_76573 == iParam0)
	{
		if (Global_76574 == -1)
...
void func_209(int iParam0, int iParam1)//Position - 0xD8A5
{
	bool bVar0;
	int iVar1;
...
bool func_210()//Position - 0xD943
{
	return Global_96008;
}

void func_211(int iParam0)//Position - 0xD94F
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_212(iParam0);
...
void func_212(int iParam0)//Position - 0xD966
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_213(int iParam0)//Position - 0xDA4E
{
	if (iParam0 == -1)
	{
		iParam0 = func_166();
...
int func_214(int iParam0, bool bParam1)//Position - 0xDA76
{
	struct<27> Var0;
...
void func_215(int iParam0, var uParam1, int iParam2)//Position - 0xDCE9
{
	int iVar0;
	int iVar1;
...
int func_216(int iParam0)//Position - 0xE041
{
...
int func_217(var uParam0)//Position - 0xE061
{
...
int func_218(var uParam0)//Position - 0xE079
{
...
void func_219(var uParam0)//Position - 0xE09E
{
	int iVar0;
	int iVar1;
...
void func_220(int iParam0)//Position - 0xE39C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_221(var uParam0)//Position - 0xE3C7
{
	int iVar0;
...
int func_222(var uParam0, bool bParam1, bool bParam2)//Position - 0xE447
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_223(int iParam0, int iParam1)//Position - 0xE605
{
	int iVar0;
...
int func_224(var uParam0, bool bParam1, int iParam2)//Position - 0xE635
{
	int iVar0;
	int iVar1;
...
int func_225(int iParam0)//Position - 0xE8F1
{
...
int func_226(int iParam0, float fParam1)//Position - 0xE925
{
	float fVar0;
...
bool func_227(int iParam0, float fParam1)//Position - 0xE99B
{
	return func_228(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_228(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE9B3
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
...
int func_229(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xEA74
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_230(int iParam0, int iParam1)//Position - 0xEBA0
{
	int iVar0;
...
int func_232(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xECAF
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_233(vector3 vParam0, vector3 vParam3)//Position - 0xED40
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_234(vector3 vParam0)//Position - 0xED61
{
	float fVar0;
	float fVar1;
...
void func_235(var uParam0)//Position - 0xEDA0
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_236(int iParam0, int iParam1)//Position - 0xEDBB
{
	int iVar0;
...
int func_237(int iParam0)//Position - 0xEDFA
{
...
int func_238(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xEE22
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_239(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xEF1D
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_240(int iParam0, float fParam1)//Position - 0xF029
{
	var uVar0;
	vector3 vVar1;
...
int func_241(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0xF0BE
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_242(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF14C
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_243(int iParam0)//Position - 0xF194
{
...
void func_244(int iParam0)//Position - 0xF1DE
{
	int iVar0;
...
int func_245(int iParam0)//Position - 0xF27B
{
	if (iParam0 == -1)
	{
		iParam0 = func_166();
...
int func_246(int iParam0)//Position - 0xF313
{
...
int func_249(int iParam0)//Position - 0xF395
{
...
int func_251(int iParam0)//Position - 0xF407
{
	if (func_108(0))
	{
...
int func_252(int iParam0)//Position - 0xF42F
{
	switch (*iParam0)
	{
		case 0:
...
int func_253(var uParam0)//Position - 0xF476
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
...
void func_254(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xF628
{
	func_255(iParam0);
...
void func_255(int iParam0)//Position - 0xF66A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_256(int iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)//Position - 0xF706
{
...
int func_257(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0xF762
{
	int iVar0;
...
int func_258(var uParam0, int iParam1)//Position - 0xF7F0
{
	int iVar0;
...
int func_259(int iParam0)//Position - 0xF836
{
	int iVar0;
...
void func_260(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xF867
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_261(var uParam0)//Position - 0xF8A3
{
	int iVar0;
	bool bVar1;
...
int func_262(int iParam0)//Position - 0xF9AE
{
	struct<27> Var0;
	int iVar32;
...
int func_263(int iParam0)//Position - 0xFA02
{
	char* sVar0;
...
int func_264(int iParam0)//Position - 0xFABB
{
	var uVar0;
...
int func_265(int iParam0)//Position - 0xFB7C
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_266(int iParam0, char* sParam1)//Position - 0xFC01
{
...
bool func_267(int iParam0)//Position - 0xFCE3
{
...
bool func_268(int iParam0)//Position - 0xFD11
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_269(int iParam0)//Position - 0xFD3F
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_270(int iParam0)//Position - 0xFD6D
{
	if (func_246(iParam0))
	{
		return 0;
...
void func_271()//Position - 0xFDA2
{
	func_293("Running end routines.");
	Global_111278 = (Global_111278 - 1);
}

int func_272(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xFDBC
{
	int iVar0;
...
int func_273(int iParam0, vector3 vParam1, float fParam4, var uParam5)//Position - 0xFE21
{
	int iVar0;
	struct<7> Var1;
...
int func_274(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0xFE9F
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_275(int iParam0, bool bParam1)//Position - 0xFF1A
{
	char* sVar0;
...
void func_276(char* sParam0)//Position - 0xFFA1
{
...
void func_277()//Position - 0xFFC0
{
	Global_19671 = 0;
	func_278();
}

void func_278()//Position - 0xFFD0
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_279(char* sParam0)//Position - 0xFFF1
{
	struct<6> Var0;
...
struct<6> func_280()//Position - 0x10013
{
	struct<6> Var0;
...
void func_281(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x10037
{
...
void func_282(var uParam0, bool bParam1)//Position - 0x10057
{
	func_283(&(uParam0->f_41), bParam1);
}

void func_283(var uParam0, bool bParam1)//Position - 0x10069
{
	int iVar0;
...
void func_284(int iParam0, bool bParam1)//Position - 0x100A7
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_285(var uParam0, bool bParam1)//Position - 0x100E2
{
	func_286(&(uParam0->f_35), bParam1);
}

void func_286(var uParam0, bool bParam1)//Position - 0x100F4
{
	int iVar0;
...
void func_287(int iParam0)//Position - 0x10131
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_288(var uParam0, int iParam1)//Position - 0x10169
{
	func_289(&(uParam0->f_28), iParam1);
}

void func_289(var uParam0, int iParam1)//Position - 0x1017B
{
	int iVar0;
...
void func_290(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x101BC
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_291(int iParam0)//Position - 0x1020C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_292(var uParam0)//Position - 0x1024D
{
	if (*uParam0 == -1)
	{
		return;
...
void func_293(int iParam0)//Position - 0x1028A
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(iParam0))
	{
	}
...
void func_294(var uParam0)//Position - 0x1029C
{
	*uParam0 = -1;
...
void func_295()//Position - 0x102CF
{
	func_293("Running start routines.");
	Global_111278++;
}

int func_296(int iParam0)//Position - 0x102E9
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
