...
void func_37(int iParam0, int iParam1, int iParam2)//Position - 0x1B63
{
	struct<2> Var0;
...
void func_38(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7)//Position - 0x1B99
{
	if (GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD_ON_FRONTEND("SET_DATA_SLOT"))
	{
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
...
int func_39(int iParam0)//Position - 0x1BF3
{
	int iVar0;
...
int func_40()//Position - 0x1D6F
{
	return 1;
}

int func_41()//Position - 0x1D78
{
	return 1;
}

int func_42(int iParam0)//Position - 0x1D81
{
	int iVar0;
...
void func_43(int iParam0)//Position - 0x1F33
{
...
void func_44(int iParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x1F50
{
	if (iParam1 == -1)
	{
		return;
...
void func_46(int iParam0)//Position - 0x2014
{
	func_3(iParam0, 0);
}

void func_47(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, char* sParam5, bool bParam6, int iParam7, bool bParam8)//Position - 0x2023
{
	if (GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD_ON_FRONTEND("SET_DATA_SLOT"))
	{
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
...
int func_49(int iParam0)//Position - 0x2147
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_50(int iParam0, var uParam1, int iParam2)//Position - 0x21E1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_51(int iParam0)//Position - 0x2344
{
	return (iParam0 % 32);
}

int func_52(int iParam0)//Position - 0x2351
{
	return (iParam0 / 32);
}

void func_53()//Position - 0x235E
{
	int iVar0;
...
void func_54(var uParam0)//Position - 0x241B
{
	uParam0->f_1 = 0;
}

int func_55(var uParam0, int iParam1, bool bParam2)//Position - 0x2428
{
	if (iParam1 == -1)
	{
		return 1;
...
void func_56(var uParam0, bool bParam1, bool bParam2)//Position - 0x2486
{
	if (uParam0->f_1 == 0)
	{
