...
void func_2(char* sParam0)//Position - 0x1EF
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}

void func_3()//Position - 0x201
{
	int iVar0;
	int iVar1;
...
void func_4()//Position - 0x264
{
}

void func_5()//Position - 0x26C
{
}

void func_6(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x274
{
	if (bParam0)
	{
...
bool func_7()//Position - 0x3AD
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_8(int iParam0, int iParam1)//Position - 0x3CA
{
	bool bVar0;
...
int func_9(int iParam0, bool bParam1)//Position - 0x415
{
	int iVar0;
	int iVar1;
...
int func_10()//Position - 0x456
{
	return Global_1312745;
}

int func_11(int iParam0)//Position - 0x462
{
	if (func_8(iParam0, 0))
	{
		return 1;
...
bool func_12()//Position - 0x4A4
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_13(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x4B5
{
	int iVar0;
...
void func_15(int iParam0)//Position - 0x50F
{
	if (iParam0 == 1)
	{
...
void func_16(bool bParam0)//Position - 0x532
{
	int iVar0;
...
void func_17(int iParam0)//Position - 0x866
{
	switch (iParam0)
	{
		case 0:
...
void func_18(int iParam0, int iParam1, int iParam2)//Position - 0x9D6
{
	Local_24[iParam0] = iParam1;
	Local_24.f_17[iParam0] = iParam2;
}

void func_19(var uParam0, int iParam1)//Position - 0x9F0
{
	uParam0->f_22 = 0;
...
void func_20(var uParam0, int iParam1)//Position - 0xA18
{
	uParam0->f_22 = 0;
...
void func_21(var uParam0, int iParam1)//Position - 0xA40
{
	vector3 vVar0;
...
void func_22(var uParam0, vector3 vParam1, vector3 vParam4, int iParam7, float fParam8, float fParam9)//Position - 0x23E5
{
	uParam0->f_1 = { vParam1 };
	uParam0->f_4 = { vParam4 };
	uParam0->f_7 = iParam7;
...
void func_23(var uParam0, int iParam1, vector3 vParam2, vector3 vParam5, int iParam8, int iParam9, int iParam10)//Position - 0x2417
{
...
void func_24(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, var uParam8, var uParam9, var uParam10)//Position - 0x2452
{
	*uParam0 = { vParam2 };
	uParam0->f_3 = { vParam5 };
	uParam0->f_6 = uParam8;
...
float func_25(float fParam0)//Position - 0x2484
{
	return (fParam0 * 57.29578f);
}

void func_26(var uParam0)//Position - 0x2494
{
	uParam0->f_154 = 0;
...
int func_27(char* sParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x24B1
{
	int iVar0;
...
int func_28(char* sParam0, var uParam1, int iParam2)//Position - 0x2516
{
	int iVar0;
...
int func_29(char* sParam0, int iParam1)//Position - 0x257E
{
	int iVar0;
...
char* func_30(int iParam0)//Position - 0x25D9
{
	char* sVar0;
...
void func_31(int iParam0, int iParam1)//Position - 0x26A9
{
...
void func_32(bool bParam0)//Position - 0x2778
{
...
bool func_33(int iParam0)//Position - 0x27D2
{
...
void func_34(bool bParam0)//Position - 0x27F0
{
	if (bParam0)
	{
		func_40();
...
void func_35(int iParam0)//Position - 0x2853
{
	if (func_38())
	{
		return;
...
void func_36(bool bParam0, bool bParam1)//Position - 0x28DD
{
	if (bParam0)
	{
		if (func_39(0))
...
bool func_37()//Position - 0x2951
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

bool func_38()//Position - 0x2962
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

int func_39(int iParam0)//Position - 0x2974
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
void func_43(int iParam0)//Position - 0x2B06
{
...
void func_44(char* sParam0)//Position - 0x2B69
{
	STREAMING::REMOVE_ANIM_DICT(sParam0);
}

void func_45(int iParam0)//Position - 0x2B77
{
	if (iParam0 != 0)
	{
...
void func_46(var uParam0)//Position - 0x2B8B
{
	int iVar0;
	char* sVar1;
	char* sVar2;
...
char* func_47(int iParam0)//Position - 0x2C00
{
	char* sVar0;
...
char* func_48(int iParam0)//Position - 0x2C16
{
	char* sVar0;
...
void func_49(var uParam0)//Position - 0x2C2B
{
	int iVar0;
...
void func_50(int iParam0)//Position - 0x2C77
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_51(var uParam0)//Position - 0x2CB8
{
	int iVar0;
...
void func_52(int iParam0)//Position - 0x2CE1
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
