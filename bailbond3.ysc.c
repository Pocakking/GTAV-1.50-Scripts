...
void __EntryFunction__()//Position - 0x0
{
	...
	StringCopy(&vLocal_671, "MAUDE_MCS_4", 24);
	...
	while (true)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			vLocal_680 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
			func_417();
			func_416();
			switch (iLocal_98)
			{
...
bool func_4(vector3 vParam0, var uParam3, float fParam4, int iParam5)//Position - 0x697
{
	var uVar0;
	vector3 vVar1;
...
void func_10(vector3 vParam0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x76F
{
	var uVar0;
	int iVar1;
...
int func_17(int iParam0)//Position - 0x956
{
	if (iParam0 == 1)
	{
...
bool func_18()//Position - 0x9B0
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

void func_19(int iParam0, struct<2> Param1, float fParam3)//Position - 0x9C2
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
int func_20(int iParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6)//Position - 0xA21
{
	bool bVar0;
	float fVar1;
...
void func_21()//Position - 0xA7D
{
	Global_19671 = 0;
	func_22();
}

void func_22()//Position - 0xA8D
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
...
int func_23(int iParam0)//Position - 0xAE4
{
	if (func_429(iParam0))
	{
...
void func_24(int iParam0, bool bParam1)//Position - 0xB04
{
...
void func_25(int iParam0, int iParam1, int iParam2)//Position - 0xB40
{
...
void func_26(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0xB74
{
	int iVar0;
...
void func_27(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0xC1D
{
	if (bParam0)
	{
...
bool func_28()//Position - 0xD56
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_29(int iParam0, int iParam1)//Position - 0xD73
{
	bool bVar0;
...
int func_30(int iParam0, bool bParam1)//Position - 0xDBE
{
	int iVar0;
	int iVar1;
...
int func_31()//Position - 0xDFF
{
	return Global_1312745;
}

int func_32(int iParam0)//Position - 0xE0B
{
...
bool func_33()//Position - 0xE4D
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_34(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xE5E
{
	int iVar0;
...
void func_35(int iParam0)//Position - 0xE91
{
	if (iParam0 == 1)
	{
...
void func_36(int iParam0)//Position - 0xEB4
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		switch (iParam0)
...
void func_38(int iParam0, bool bParam1)//Position - 0x10C5
{
	if (bParam1)
	{
		func_40(iParam0);
...
void func_39(int iParam0, bool bParam1)//Position - 0x10E2
{
...
void func_40(int iParam0)//Position - 0x111D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
char* func_41()//Position - 0x1148
{
	return "special_ped@maude@base";
}

void func_42(int iParam0, bool bParam1)//Position - 0x1153
{
	if (bParam1)
	{
		func_44(iParam0);
...
void func_43(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1172
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_44(int iParam0)//Position - 0x11C2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_45()//Position - 0x1203
{
	return 2057223314;
}

float func_46()//Position - 0x1210
{
	return -92.17f;
}

Vector3 func_47()//Position - 0x121D
{
	return 2727.4f, 4145.56f, 43.68f;
}

int func_48()//Position - 0x1234
{
	return -380698483;
}

void func_49()//Position - 0x1241
{
	int iVar0;
	int iVar1;
	...
	if (func_23(Local_385))
	{
		if (func_429(Local_393))
		{
			if (func_58(2))
			{
				...
				TASK::TASK_SYNCHRONIZED_SCENE(Local_385, iVar0, func_41(), func_51(), 1000f, -8f, 4688, 0, 1148846080, 0);
				iVar1 = 0;
				iVar1 += 16;
				iVar1 += 64;
				iVar1 += 512;
				iVar1 += 4096;
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(Local_393, iVar0, func_50(), func_41(), 1000f, -8f, iVar1, 1148846080);
...
char* func_50()//Position - 0x132D
{
	return "base_chair";
}

char* func_51()//Position - 0x1338
{
	return "base";
}

Vector3 func_52()//Position - 0x1343
{
	return 0f, 0f, -92.17f;
}

Vector3 func_53()//Position - 0x1352
{
	return 2727.4f, 4145.56f, 43.68f;
}

int func_54(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, bool bParam7, bool bParam8)//Position - 0x1369
{
...
void func_55(int iParam0, bool bParam1)//Position - 0x13EB
{
	if (iParam0 != 0)
	{
		if (bParam1)
...
int func_56(int iParam0)//Position - 0x1416
{
	if (iParam0 == 0)
	{
		return 1;
...
int func_57(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0x143C
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_56(iParam1))
...
int func_58(int iParam0)//Position - 0x14A7
{
	switch (iParam0)
	{
		case 0:
...
bool func_59(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x1512
{
	return SYSTEM::VDIST2(vParam0, vParam3) <= (fParam6 * fParam6);
}

int func_60(int iParam0, float fParam1, int iParam2)//Position - 0x152C
{
	int iVar0;
...
int func_64(int iParam0, int iParam1)//Position - 0x1696
{
	if (func_23(iParam0))
	{
...
int func_65(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x16C9
{
...
void func_66(int iParam0)//Position - 0x1858
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_68(char* sParam0)//Position - 0x18C6
{
	func_27(1, 1, 0, 0, 0, 0);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_69(int iParam0, int iParam1, int iParam2)//Position - 0x18E0
{
	if (func_516() && func_71())
	{
...
void func_70(int iParam0)//Position - 0x19A4
{
	if (iParam0 == 1)
	{
		...
		case 1:
			...
			else
			{
				if (!iLocal_434)
				{
					...
					if (iLocal_102 == 4)
					{
						if (func_23(Local_385))
						{
							if (func_116(Local_385, vLocal_680, 35f))
							{
								...
								if (func_75(&uLocal_499, cLocal_493, &vLocal_665, 4, 0, 0, 0))
								{
									iLocal_434 = 1;
								}
							}
					...
					else if (func_75(&uLocal_499, cLocal_493, &vLocal_665, 4, 0, 0, 0))
					{
						iLocal_434 = 1;
					}
				}
...
void func_73(int iParam0)//Position - 0x1CE1
{
	if (func_23(*iParam0))
	{
...
char* func_74()//Position - 0x1D4A
{
	return "female_Flee_Table_Left_Maude";
}

int func_75(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1D55
{
	if (iParam4 == 0)
	{
...
bool func_76(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1D92
{
...
int func_77(char* sParam0, int iParam1, bool bParam2)//Position - 0x1DE0
{
	Global_20806 = 0;
...
bool func_80(int iParam0)//Position - 0x214D
{
	return func_81(iParam0, 20);
}

bool func_81(int iParam0, int iParam1)//Position - 0x215D
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_82()//Position - 0x2178
{
	return -1;
}

void func_83()//Position - 0x2181
{
	int iVar0;
...
int func_87()//Position - 0x2382
{
	func_88();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_88()//Position - 0x239B
{
	int iVar0;
...
bool func_89(int iParam0)//Position - 0x2498
{
	return iParam0 < 3;
}

int func_90(int iParam0)//Position - 0x24A4
{
	int iVar0;
	int iVar1;
...
int func_91(int iParam0)//Position - 0x24E1
{
	if (func_89(iParam0))
	{
...
var func_92(int iParam0)//Position - 0x2506
{
	return Global_1798[iParam0 /*29*/];
}

bool func_93(int iParam0)//Position - 0x2515
{
	return Global_41396 == iParam0;
}

void func_94()//Position - 0x2523
{
	int iVar0;
...
bool func_95(int iParam0, int iParam1)//Position - 0x257A
{
	switch (iParam0)
	{
		case 5:
...
void func_96(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x25B5
{
...
void func_97(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x260B
{
...
void func_98(bool bParam0)//Position - 0x26A6
{
	int iVar0;
...
void func_99(int iParam0, bool bParam1)//Position - 0x287A
{
	if (bParam1)
	{
		func_101(iParam0);
...
void func_100(int iParam0)//Position - 0x2896
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_101(int iParam0)//Position - 0x28CE
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_102(int iParam0)//Position - 0x296A
{
	if (func_429(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_103(var uParam0)//Position - 0x2994
{
...
void func_104(vector3 vParam0, float fParam3)//Position - 0x29AD
{
	func_105(&(Global_105109.f_2890), vParam0, fParam3);
}

void func_105(var uParam0, vector3 vParam1, var uParam4)//Position - 0x29C6
{
	*uParam0 = { vParam1 };
	uParam0->f_6 = uParam4;
}

void func_106(vector3 vParam0, float fParam3)//Position - 0x29DC
{
...
bool func_107(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x2A08
{
	if (bParam6)
	{
...
void func_109(char* sParam0)//Position - 0x2A7C
{
...
void func_110(int iParam0, bool bParam1)//Position - 0x2ABB
{
	if (func_23(iParam0))
	{
		PED::SET_PED_COMBAT_ATTRIBUTES(iParam0, 5, 0);
...
int func_111(int iParam0, int iParam1, int iParam2)//Position - 0x2B36
{
	int iVar0;
...
char* func_112()//Position - 0x2C82
{
	return "Female_Flee_Table_Left_Maude_Chair";
}

char* func_113()//Position - 0x2C8D
{
	return "special_ped@maude@exit_flee";
}

void func_114(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x2C99
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_115(iParam3), 0);
}

int func_115(int iParam0)//Position - 0x2CB2
{
	int iVar0;
...
bool func_116(int iParam0, vector3 vParam1, float fParam4)//Position - 0x2EA7
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, 1), vParam1) <= (fParam4 * fParam4);
}

void func_117(int iParam0, bool bParam1)//Position - 0x2EC4
{
	char* sVar0;
	int iVar1;
	int iVar2;
...
void func_118(var uParam0, int iParam1)//Position - 0x2F35
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
void func_120(int iParam0)//Position - 0x2F76
{
	bool bVar0;
	struct<8> Var1;
...
void func_121(int iParam0)//Position - 0x2FE8
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
void func_122(int iParam0)//Position - 0x3008
{
	int iVar0;
...
bool func_124(int iParam0, int iParam1)//Position - 0x30E2
{
	return (MISC::GET_GAME_TIMER() - iParam0) > iParam1;
}

void func_125(int iParam0)//Position - 0x30F4
{
	func_24(500, 1);
...
void func_126(int iParam0, int iParam1, int iParam2)//Position - 0x3129
{
	bool bVar0;
...
int func_129()//Position - 0x371D
{
	return Global_30736;
}

int func_130(int iParam0, int iParam1)//Position - 0x3728
{
	int iVar0;
...
int func_131(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x3779
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_132(int iParam0)//Position - 0x3DCB
{
	int iVar0;
		...
		case 0:
			...
			if (func_37())
			{
				if (func_60(1, 10.5f, 1))
				{
					...
					func_198(&vVar0, &vVar3, &fVar9);
					vVar6 = { func_197() };
					if (func_194(vVar6, 0))
					{
						func_187(vVar0, vVar3, fVar9, 2721.02f, 4140.34f, 43.66f, 257.67f, 1, 1, 1, 0, 0);
						func_135(2721.02f, 4140.34f, 43.66f, 257.67f, 0, 145);
					}
					else
					{
						func_187(vVar0, vVar3, fVar9, 2710.665f, 4149.075f, 42.7026f, 180.9488f, 1, 1, 1, 0, 0);
...
void func_134(int iParam0)//Position - 0x40F0
{
	iLocal_98 = iParam0;
	iLocal_100 = 0;
}

void func_135(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x40FF
{
	vector3 vVar0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102125.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102125.f_4, 0))
		{
			if (func_186(24) != Global_102125.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_183(ENTITY::GET_ENTITY_COORDS(Global_102125.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
				}
				func_136(Global_102125.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_136(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)//Position - 0x417A
{
	struct<60> Var0;
...
void func_137(int iParam0, int iParam1, int iParam2)//Position - 0x42A3
{
	int iVar0;
...
void func_138(int iParam0, int iParam1)//Position - 0x43C0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_139(int iParam0)//Position - 0x45C2
{
...
int func_140(int iParam0)//Position - 0x469F
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_141(int iParam0, bool bParam1)//Position - 0x4850
{
	int iVar0;
	struct<2> Var1;
...
int func_142(int iParam0)//Position - 0x49D0
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_144(int iParam0)//Position - 0x4AB3
{
	int iVar0;
	int iVar1;
...
int func_145()//Position - 0x6F7E
{
	return 0;
}

int func_146()//Position - 0x6F87
{
	return 1;
}

int func_147()//Position - 0x6F90
{
	return 1;
}

int func_148()//Position - 0x6F99
{
...
int func_150(int iParam0)//Position - 0x706D
{
	int iVar0;
	char* sVar1;
...
int func_151(int iParam0)//Position - 0x70B3
{
	int iVar0;
...
int func_152(int iParam0)//Position - 0x70EE
{
	int iVar0;
...
int func_153(int iParam0)//Position - 0x716A
{
	int iVar0;
...
int func_154(int iParam0, int iParam1, bool bParam2)//Position - 0x7252
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_155(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x72C3
{
...
void func_157(var uParam0, int iParam1)//Position - 0x73E1
{
	if (iParam1 <= 0)
	{
		return;
...
void func_158(var uParam0, int iParam1)//Position - 0x7467
{
...
void func_159(var uParam0, int iParam1)//Position - 0x749A
{
	int iVar0;
	int iVar1;
...
int func_160(int iParam0, int iParam1)//Position - 0x74EB
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_161(int iParam0)//Position - 0x758D
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_162(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_162(bool bParam0, int iParam1, int iParam2)//Position - 0x75B2
{
	if (bParam0)
	{
		return iParam1;
...
int func_163(var uParam0)//Position - 0x75C9
{
	return uParam0 & 15;
}

void func_164(var uParam0, int iParam1)//Position - 0x75D6
{
...
void func_165(var uParam0, int iParam1)//Position - 0x7610
{
...
void func_166(var uParam0, int iParam1)//Position - 0x764B
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_167(var uParam0, int iParam1)//Position - 0x7687
{
	int iVar0;
	int iVar1;
...
int func_168(int iParam0, int iParam1)//Position - 0x8D81
{
	struct<82> Var0;
...
void func_169(int iParam0, var uParam1, int iParam2)//Position - 0x8DC3
{
	int iVar0;
...
void func_170(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0x901F
{
	if (func_167(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
...
void func_171(int iParam0, bool bParam1)//Position - 0x911E
{
	if (iParam0 == -1)
	{
		return;
...
void func_172(int iParam0, int iParam1, bool bParam2)//Position - 0x917B
{
	if (iParam0 == -1)
	{
		return;
...
bool func_173(int iParam0, int iParam1)//Position - 0x91B6
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_174(var uParam0, var uParam1)//Position - 0x91D9
{
...
void func_175(int iParam0)//Position - 0x92A5
{
	if (iParam0 == -1)
	{
		return;
...
int func_176(int iParam0)//Position - 0x931F
{
	int iVar0;
...
void func_177(int iParam0, var uParam1)//Position - 0x9382
{
	int iVar0;
...
int func_178(int iParam0)//Position - 0x962D
{
	switch (iParam0)
	{
		case 1:
...
int func_179(int iParam0, var uParam1, var uParam2)//Position - 0x96DD
{
	int iVar0;
	int iVar1;
...
int func_180(int iParam0)//Position - 0x98D0
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_181(var uParam0)//Position - 0x98F0
{
	int iVar0;
...
void func_182(int iParam0)//Position - 0x99A0
{
...
int func_183(vector3 vParam0, int iParam3, var uParam4, var uParam5)//Position - 0x99C7
{
	int iVar0;
...
int func_184(vector3 vParam0, int iParam3, int iParam4)//Position - 0x9ADD
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_185(int iParam0)//Position - 0x9B6C
{
	return MISC::IS_BIT_SET(Global_111560.f_7224[iParam0], 0);
}

int func_186(int iParam0)//Position - 0x9B84
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_187(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x9BA0
{
	func_188(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_188(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x9BC9
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_189(vector3 vParam0)//Position - 0x9FBD
{
...
int func_190(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x9FE7
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_191(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0xA2DD
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_192(vector3 vParam0)//Position - 0xA391
{
	float fVar0;
	float fVar1;
...
void func_193(int iParam0)//Position - 0xA3D0
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
bool func_194(vector3 vParam0, int iParam3)//Position - 0xA435
{
	return func_195(Global_102125.f_2890.f_12.f_66, vParam0, iParam3);
}

int func_195(int iParam0, vector3 vParam1, int iParam4)//Position - 0xA452
{
	vector3 vVar0;
	vector3 vVar3;
...
Vector3 func_196()//Position - 0xA4BC
{
	return 2.55f, 5.665f, 2.55f;
}

Vector3 func_197()//Position - 0xA4D3
{
	return 3.01f, 11.01f, 6.01f;
}

int func_198(var uParam0, var uParam1, var uParam2)//Position - 0xA4EA
{
...
void func_199(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0xA521
{
	int iVar0;
...
Vector3 func_200(int iParam0)//Position - 0xA6DF
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), 0);
}

int func_201(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xA6F2
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76389[1 /*14*/] = { func_251(iVar10, 14, uVar28[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76389[1 /*14*/] = { func_251(iVar10, 14, uVar69[iVar1], -1) };
			func_221(iParam0, Global_76389[1 /*14*/].f_12, Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4);
			func_243(14);
			if (Global_76387 == 1)
			{
...
int func_202(int iParam0, int iParam1, int iParam2)//Position - 0xAF08
{
	int iVar0;
...
int func_203(int iParam0)//Position - 0xAF94
{
	switch (iParam0)
	{
...
void func_204(int iParam0, int iParam1, int iParam2)//Position - 0xAFCF
{
	int iVar0;
	int iVar1;
...
int func_205(int iParam0, int iParam1, int iParam2)//Position - 0xB059
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_206(int iParam0, int iParam1, int iParam2)//Position - 0xB137
{
	Global_76389[1 /*14*/] = { func_251(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 2);
}

int func_207(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0xB162
{
	var uVar0;
	int iVar10;
...
int func_208(int iParam0, int iParam1, int iParam2)//Position - 0xB766
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_209(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB7FF
{
	int iVar0;
...
int func_210(int iParam0, int iParam1, int iParam2)//Position - 0xB895
{
	int iVar0;
	int iVar1;
...
int func_211(int iParam0)//Position - 0xB936
{
	switch (iParam0)
	{
		case 0:
...
int func_212(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB9E6
{
	int iVar0;
...
int func_213(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xBCED
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_214(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0xC8A1
{
	int iVar0;
...
int func_215(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCB85
{
	int iVar0;
...
int func_216(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCE4C
{
	int iVar0;
	int iVar1;
...
int func_217(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCE83
{
	int iVar0;
...
int func_218(int iParam0, int iParam1, int iParam2)//Position - 0xCEAC
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_219(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD176
{
	int iVar0;
...
int func_220(int iParam0, int iParam1, int iParam2)//Position - 0xD400
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_221(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD557
{
	int iVar0;
...
int func_222(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD5EF
{
	switch (iParam0)
	{
...
int func_223(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD6BD
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_224(int iParam0, int iParam1)//Position - 0xD819
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_225(int iParam0)//Position - 0xDBC0
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_226(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDC21
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_227(int iParam0, int iParam1)//Position - 0xDD1D
{
	int iVar0;
...
int func_228(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDE5B
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_229(int iParam0)//Position - 0xDF3B
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_230(int iParam0, int iParam1)//Position - 0xDFC1
{
	int iVar0;
	struct<10> Var1;
...
void func_231(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE8F0
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_232(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xEA1A
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_233(int iParam0, int iParam1)//Position - 0xEA62
{
	int iVar0;
	struct<17> Var1;
...
void func_234(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x108AD
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_235(int iParam0)//Position - 0x10A97
{
	switch (iParam0)
	{
		case 0:
...
void func_236(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x10B47
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_237(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10BB8
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_238(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10E35
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_239(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1125A
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_240(int iParam0, int iParam1)//Position - 0x1154D
{
	int iVar0;
	int iVar1;
...
int func_241(int iParam0, int iParam1)//Position - 0x11593
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_242(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x115F3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_243(int iParam0)//Position - 0x11677
{
...
void func_244(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x1172F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_245(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x11779
{
	int iVar0;
...
int func_246(var uParam0)//Position - 0x117A9
{
	int iVar0;
	int iVar1;
...
int func_247(int iParam0, int iParam1, int iParam2)//Position - 0x117DD
{
	int iVar0;
	var uVar1;
...
bool func_248(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x1180F
{
	int iVar0;
...
int func_249(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x13676
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_250(int iParam0)//Position - 0x14595
{
	if (!MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_251(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x145E6
{
	func_314();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_252(int iParam0, int iParam1)//Position - 0x14638
{
	switch (iParam0)
	{
		case 0:
...
void func_253(int iParam0)//Position - 0x14728
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_254(&(Global_76389[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_254(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x1599F
{
	int iVar0;
	int iVar1;
...
bool func_255(int iParam0, int iParam1, var uParam2)//Position - 0x15D30
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_256(int iParam0, int iParam1)//Position - 0x16135
{
	switch (iParam1)
	{
		case 0:
...
int func_257(int iParam0, int iParam1)//Position - 0x16530
{
	switch (iParam1)
	{
		case 0:
...
int func_258(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x1692B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_259(int iParam0)//Position - 0x1696D
{
	switch (iParam0)
	{
		case -1:
...
void func_260(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x16A41
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_254(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_254(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
void func_261(int iParam0)//Position - 0x16D1A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_262(int iParam0)//Position - 0x16E71
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_263(int iParam0)//Position - 0x1737F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_264(int iParam0)//Position - 0x173F4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_265(int iParam0)//Position - 0x17468
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_266(int iParam0)//Position - 0x1754F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_267(int iParam0)//Position - 0x178B2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_268(int iParam0)//Position - 0x17AC3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_269(int iParam0)//Position - 0x17CF3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_270(int iParam0)//Position - 0x17E03
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_271(int iParam0)//Position - 0x18978
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_272(int iParam0)//Position - 0x194EB
{
	if (iParam0 < 136)
	{
		func_274(iParam0);
...
void func_273(int iParam0)//Position - 0x19520
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_274(int iParam0)//Position - 0x1A124
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_275(int iParam0)//Position - 0x1B032
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_276(int iParam0)//Position - 0x1B15F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_277(int iParam0, int iParam1)//Position - 0x1B25D
{
	switch (iParam0)
	{
		case 0:
...
void func_278(int iParam0)//Position - 0x1B34D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_279(int iParam0)//Position - 0x1C83F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_280(int iParam0)//Position - 0x1C990
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_281(int iParam0)//Position - 0x1CE9B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_282(int iParam0)//Position - 0x1D509
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_283(int iParam0)//Position - 0x1D57D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_284(int iParam0)//Position - 0x1D64D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_285(int iParam0)//Position - 0x1DB7D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_286(int iParam0)//Position - 0x1DD14
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_287(int iParam0)//Position - 0x1E512
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_288(int iParam0)//Position - 0x1E622
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_289(int iParam0)//Position - 0x1F54D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_290(int iParam0)//Position - 0x2020C
{
	if (iParam0 < 107)
	{
		func_293(iParam0);
...
void func_291(int iParam0)//Position - 0x20252
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_292(int iParam0)//Position - 0x20CF7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_293(int iParam0)//Position - 0x21AE6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_294(int iParam0)//Position - 0x2272F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_295(int iParam0)//Position - 0x229A8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_296(int iParam0, int iParam1)//Position - 0x22AEE
{
	switch (iParam0)
	{
		case 0:
...
void func_297(int iParam0)//Position - 0x22BDE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_298(int iParam0)//Position - 0x23968
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_299(int iParam0)//Position - 0x23AE2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_300(int iParam0)//Position - 0x2405A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_301(int iParam0)//Position - 0x24584
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_302(int iParam0)//Position - 0x245F8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_303(int iParam0)//Position - 0x246C8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_304(int iParam0)//Position - 0x24BA0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_305(int iParam0)//Position - 0x24E09
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_306(int iParam0)//Position - 0x250DF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_307(int iParam0)//Position - 0x252A8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_308(int iParam0)//Position - 0x25DFC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_309(int iParam0)//Position - 0x26A46
{
	if (iParam0 < 60)
	{
		func_311(iParam0);
...
void func_310(int iParam0)//Position - 0x26A7B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_311(int iParam0)//Position - 0x2781B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_312(int iParam0)//Position - 0x27EA7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_313(int iParam0)//Position - 0x27F8E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_314()//Position - 0x2808E
{
...
int func_315(int iParam0, int iParam1, int iParam2)//Position - 0x28107
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_316(bool bParam0)//Position - 0x28362
{
	int iVar0;
...
void func_317()//Position - 0x283A0
{
	bool bVar0;
	vector3 vVar1;
	...
	if (func_23(Local_112.f_9))
	{
		...
		switch (iLocal_100)
		{
			case 0:
				...
				vLocal_701 = { ENTITY::GET_ENTITY_COORDS(Local_112.f_9, 0) };
			...
			case 1:
				if (!iLocal_448)
				{
					...
					if (Local_112.f_10 == 22 || Local_112.f_10 == 23)
					{
						...
						if (func_329(Local_112.f_9, vLocal_680, bVar0, 0, 1, iLocal_476))
						{
...
int func_318(var uParam0)//Position - 0x2887B
{
	vector3 vVar0;
...
int func_319(var uParam0)//Position - 0x288C0
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
bool func_320(char* sParam0, int iParam1, char* sParam2)//Position - 0x288F8
{
...
void func_321(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x28916
{
...
void func_322(char* sParam0, int iParam1, int iParam2)//Position - 0x289C2
{
	iParam2 = iParam2;
...
int func_323(char* sParam0, bool bParam1)//Position - 0x289DB
{
	struct<6> Var0;
...
struct<6> func_324()//Position - 0x28A16
{
	struct<6> Var0;
...
void func_325(int iParam0, vector3 vParam1, int iParam4, float fParam5)//Position - 0x28A3A
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_326(var uParam0, int iParam1, int iParam2)//Position - 0x28B1F
{
	char* sVar0;
...
int func_327(char* sParam0)//Position - 0x28BFC
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_328()//Position - 0x28C0F
{
	if (func_23(Local_112.f_9))
	{
...
int func_329(int iParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6, int iParam7)//Position - 0x28D0A
{
	int iVar0;
...
int func_330(int iParam0, vector3 vParam1, float fParam4, float fParam5)//Position - 0x28E80
{
...
int func_331(int iParam0, vector3 vParam1)//Position - 0x28EB8
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
void func_332(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x28F16
{
	func_333(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_333(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x28F30
{
	func_334(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_334(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x28F4D
{
...
void func_335(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x28F85
{
	int iVar0;
	int iVar1;
...
void func_336(var uParam0)//Position - 0x292F2
{
...
int func_337(var uParam0)//Position - 0x2935B
{
	int iVar0;
...
int func_338(bool bParam0)//Position - 0x29386
{
	switch (Global_41396)
	{
		case 0:
...
void func_339(char[4] cParam0, int iParam1)//Position - 0x29430
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_340(char* sParam0)//Position - 0x29447
{
	if (!func_341(1, 1, 0))
	{
...
int func_341(bool bParam0, bool bParam1, bool bParam2)//Position - 0x294E0
{
	int iVar0;
	int iVar1;
...
int func_342(int iParam0)//Position - 0x29739
{
	if (iParam0 != func_82())
	{
...
int func_343(int iParam0, bool bParam1, bool bParam2)//Position - 0x2979F
{
	int iVar0;
...
int func_344(int iParam0, int iParam1)//Position - 0x297E9
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		if (VEHICLE::GET_NUM_MOD_KITS(iParam0) > 0)
...
int func_345(int iParam0, int iParam1)//Position - 0x2984B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_346()//Position - 0x298D0
{
	return Global_2448961.f_17;
}

bool func_347(int iParam0)//Position - 0x298DE
{
	return iParam0 == 51;
}

var func_348()//Position - 0x298EB
{
	return Global_2448961.f_16;
}

bool func_349()//Position - 0x298F9
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

void func_350(var uParam0, int iParam1, vector3 vParam2, int iParam5)//Position - 0x2990E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_351()//Position - 0x29A1E
{
	return func_352(PLAYER::PLAYER_ID());
}

int func_352(int iParam0)//Position - 0x29A2E
{
...
int func_353(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x29A4D
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_354(bool bParam0, bool bParam1, bool bParam2)//Position - 0x29DB9
{
...
int func_355(bool bParam0, bool bParam1, bool bParam2)//Position - 0x29E0B
{
	if (!func_341(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_356(bool bParam0, bool bParam1, bool bParam2)//Position - 0x29E54
{
	if (!func_341(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_357(bool bParam0, bool bParam1, bool bParam2)//Position - 0x29EB3
{
	if (!func_341(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_358(int iParam0)//Position - 0x29F09
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_359()//Position - 0x29F64
{
	MISC::SET_BIT(&Global_7357, 4);
}

void func_360(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x29F74
{
	if (HUD::DOES_BLIP_EXIST(*uParam0))
	{
...
int func_361(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x2A06F
{
	int iVar0;
	bool bVar1;
...
void func_362(int iParam0)//Position - 0x2A0C1
{
...
void func_363(var uParam0, vector3 vParam1)//Position - 0x2A109
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_364()//Position - 0x2A1E6
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			switch (Local_112.f_10)
			{
					...
					if (!PED::IS_PED_BEING_STUNNED(Local_112.f_9, 0))
					{
						if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_112.f_9, "oddjobs@bailbond_mountain", "base_jump_spot", 3))
						{
							...
							if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_112.f_9, "oddjobs@bailbond_mountain", "base_jump_spot") > 0.413f)
							{
								...
								ENTITY::APPLY_FORCE_TO_ENTITY(Local_112.f_9, 1, Vector(fVar7, fVar7, fVar7) * vLocal_689, vVar4, 0, 0, 1, 1, 0, 1);
								Local_112.f_18 = MISC::GET_GAME_TIMER();
								Local_112.f_10 = 19;
							}
						}
				...
				case 24:
					...
					{
						if ((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_254[0 /*6*/], 0) && func_116(Local_254[0 /*6*/], Local_254[0 /*6*/].f_1, 3f)) && func_371(ENTITY::GET_ENTITY_HEADING(Local_254[0 /*6*/]), Local_254[0 /*6*/].f_4, 20f))
						{
				...
				case 25:
					...
					else if (((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_254[0 /*6*/], 0) || PED::IS_PED_BEING_JACKED(Local_112.f_9)) || !func_116(Local_254[0 /*6*/], Local_254[0 /*6*/].f_1, 3f)) || !func_371(ENTITY::GET_ENTITY_HEADING(Local_254[0 /*6*/]), Local_254[0 /*6*/].f_4, 20f))
					{
						Local_112.f_10 = 22;
					}
...
bool func_365(int iParam0, int iParam1)//Position - 0x2B7C6
{
	return (MISC::GET_FRAME_COUNT() - iParam0) > iParam1;
}

int func_366()//Position - 0x2B7D8
{
	int iVar0;
	int iVar1;
...
var func_367()//Position - 0x2B85E
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

int func_368()//Position - 0x2B86E
{
	if (!iLocal_418)
	{
		return 1;
...
int func_369(int iParam0, int iParam1, float fParam2, bool bParam3, float fParam4, float fParam5, bool bParam6)//Position - 0x2B8DB
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_370(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2BA91
{
	int iVar0;
...
int func_371(float fParam0, float fParam1, float fParam2)//Position - 0x2BB88
{
...
char* func_372()//Position - 0x2BBA4
{
	return "move_m@bail_bond_not_tazered";
}

char* func_373()//Position - 0x2BBB0
{
	return "move_m@bail_bond_tazered";
}

int func_374()//Position - 0x2BBBC
{
...
void func_375(var uParam0, bool bParam1)//Position - 0x2BBF1
{
...
void func_376(int iParam0, var uParam1, float fParam2, int iParam3)//Position - 0x2BC08
{
	if (func_429(iParam0))
	{
...
bool func_377(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2BC34
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_378(&(Local_56[iVar4 /*4*/]), vVar1, iParam1, &(Local_56[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_56[iVar4 /*4*/].f_3) < iParam4);
}

int func_378(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x2BCF5
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_379(int iParam0, int iParam1)//Position - 0x2BE21
{
	int iVar0;
...
int func_381(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2BF30
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	
	vVar0 = { func_192(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
float func_382(vector3 vParam0, vector3 vParam3)//Position - 0x2BFC1
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

int func_383(int iParam0, int iParam1)//Position - 0x2BFE2
{
	int iVar0;
...
void func_384(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2C021
{
	if (func_429(iParam0))
	{
...
void func_385()//Position - 0x2C04D
{
	if (func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_677, 100f))
	{
		if (!func_386())
		{
			CUTSCENE::REQUEST_CUTSCENE(&vLocal_671, 8);
			func_67();
			iLocal_452 = 1;
		}
	}
	...
	{
		if (!func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_677, 120f))
		{
			if (CUTSCENE::HAS_CUTSCENE_LOADED())
			{
				CUTSCENE::REMOVE_CUTSCENE();
...
bool func_386()//Position - 0x2C0D7
{
	return Global_96008;
}

void func_387()//Position - 0x2C0E3
{
	func_37();
	func_385();
	if (func_23(Local_112.f_9))
		...
		switch (iLocal_100)
		{
			...
			case 1:
				if (!iLocal_449)
				{
					...
					{
						func_390();
						func_388(&Local_385, vLocal_680, &iLocal_464, 5000, 1101004800);
					}
				}
...
int func_388(int iParam0, vector3 vParam1, int iParam4, int iParam5, float fParam6)//Position - 0x2C3F7
{
	vector3 vVar0;
	var uVar3;
	char[] cVar168[8];
...
void func_389(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2C483
{
...
void func_390()//Position - 0x2C4BE
{
	int iVar0;
	int iVar1;
...
int func_391(int iParam0)//Position - 0x2C93A
{
	int iVar0;
...
void func_392(char* sParam0, int iParam1)//Position - 0x2C973
{
	if (func_327(sParam0))
	{
...
void func_393(int iParam0)//Position - 0x2C98A
{
...
void func_394()//Position - 0x2C9C5
{
	func_37();
	func_385();
	if (func_23(Local_112.f_9))
		...
		switch (iLocal_100)
		{
			...
			case 1:
				if (!iLocal_449)
				{
					...
					else
					{
						...
						if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_677, 4f, 4f, 2f, 1, 1, 0))
						{
						}
				...
				if (!bLocal_446)
				{
					bLocal_446 = func_395(vLocal_680, Local_103, 180f);
				}
				if (func_318(&(Local_112.f_9)))
				{
					iLocal_453 = 1;
			...
			case 2:
				...
				else
				{
					...
					if (!bLocal_446)
					{
						bLocal_446 = func_395(vLocal_680, Local_103, 0f);
					}
					func_134(4);
				}
				break;
...
int func_395(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x2CD9A
{
	int iVar0;
...
bool func_396(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x2CE8C
{
	vector3 vVar0;
...
int func_397(vector3 vParam0, int iParam3, int iParam4)//Position - 0x2CEB6
{
	int iVar0;
...
void func_398()//Position - 0x2CEE4
{
	bool bVar0;
			...
			case 1:
				...
				if (!iLocal_448)
				{
					...
					else if (Local_112.f_10 == 22 || Local_112.f_10 == 23)
					{
						...
						if (func_329(Local_112.f_9, vLocal_680, bVar0, 0, 1, 170))
						{
							func_328();
							Local_112.f_17 = MISC::GET_GAME_TIMER();
							func_326(&uLocal_44, 0, 0);
...
void func_399(bool bParam0, var uParam1)//Position - 0x2D338
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_400()//Position - 0x2D425
{
	if (func_23(Local_132[0 /*20*/]))
	{
		if (Local_132[0 /*20*/].f_14 == 0)
		{
			...
			else if (ENTITY::DOES_ENTITY_EXIST(Local_340[0 /*9*/]))
			{
				if (!ENTITY::IS_ENTITY_ATTACHED(Local_340[0 /*9*/]))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_340[0 /*9*/], Local_132[0 /*20*/], PED::GET_PED_BONE_INDEX(Local_132[0 /*20*/], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
				}
				else
				{
...
void func_401()//Position - 0x2D5F2
{
	if (func_23(Local_112.f_9))
	{
...
void func_402(bool bParam0)//Position - 0x2DAF3
{
...
void func_403()//Position - 0x2DB17
{
	Global_19671 = 0;
	func_404();
}

void func_404()//Position - 0x2DB27
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
void func_405()//Position - 0x2DB4B
{
	if (iLocal_478 < 10)
	{
		if (!iLocal_431)
...
int func_406(int iParam0, int iParam1, bool bParam2, float fParam3, float fParam4)//Position - 0x2DBEC
{
	if (func_429(iParam0))
	{
		if (!func_365(iParam1, 10))
...
int func_407(var uParam0)//Position - 0x2DC52
{
...
int func_408(int iParam0, vector3 vParam1, float fParam4)//Position - 0x2DC6C
{
	vector3 vVar0;
	float fVar3;
...
void func_409()//Position - 0x2DC9B
{
	switch (iLocal_100)
	{
		case 0:
...
void func_410(var uParam0, var uParam1)//Position - 0x2DEDB
{
	if (!uParam0->f_7)
	{
...
char* func_411(int iParam0)//Position - 0x2DF6C
{
	switch (iParam0)
	{
		case 0:
...
char* func_412(int iParam0)//Position - 0x2DFB1
{
	switch (iParam0)
	{
		case 0:
...
int func_413(int iParam0, int iParam1, int iParam2)//Position - 0x2DFF4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_414(int iParam0)//Position - 0x2E0DE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_415(int iParam0)//Position - 0x2E142
{
	switch (iParam0)
	{
		case 0:
...
void func_416()//Position - 0x2E17F
{
	if (bLocal_443)
	{
...
void func_417()//Position - 0x2E1DC
{
	if (bLocal_443)
	{
...
void func_418()//Position - 0x2E226
{
	float fVar0;
	...
	if (iLocal_98 == 0)
	{
		if (!SYSTEM::VDIST2(vLocal_680, Local_103) <= ((Local_103.f_3 + 25f) * (Local_103.f_3 + 25f)))
		{
...
int func_419(bool bParam0)//Position - 0x2E3C2
{
	if (func_23(Local_385))
	{
...
int func_420(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x2E51A
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_421(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x2E615
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_422(int iParam0, float fParam1)//Position - 0x2E721
{
	var uVar0;
	vector3 vVar1;
...
int func_423(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0x2E7B6
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	
	vVar0 = { func_192(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
int func_424(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x2E844
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_425(int iParam0, float fParam1)//Position - 0x2E88C
{
	float fVar0;
...
bool func_426(int iParam0, float fParam1)//Position - 0x2E902
{
	return func_377(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

int func_427(int iParam0)//Position - 0x2E91A
{
...
void func_428(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)//Position - 0x2E942
{
...
int func_429(int iParam0)//Position - 0x2E970
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
bool func_430(bool bParam0)//Position - 0x2E991
{
...
void func_431(int iParam0, bool bParam1)//Position - 0x2E9BC
{
	func_441(bParam1, 1);
	if (bParam1)
	{
...
void func_432()//Position - 0x2EA4B
{
	func_433(1, 0);
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
void func_433(bool bParam0, bool bParam1)//Position - 0x2EABD
{
	HUD::CLEAR_PRINTS();
	if (HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
	{
	...
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_482, 0);
	PED::CLEAR_PED_NON_CREATION_AREA();
...
void func_434(bool bParam0)//Position - 0x2EBD4
{
	if (bParam0)
	{
...
void func_435()//Position - 0x2EBFA
{
	STREAMING::REMOVE_ANIM_SET(func_372());
	STREAMING::REMOVE_ANIM_SET(func_373());
}

void func_436(bool bParam0, int iParam1, int iParam2)//Position - 0x2EC12
{
	bool bVar0;
...
void func_437(int iParam0)//Position - 0x2EC71
{
	Global_96005 = iParam0;
}

void func_438(bool bParam0)//Position - 0x2EC7F
{
	if (bParam0)
	{
...
void func_439(bool bParam0)//Position - 0x2ED5B
{
	if (bParam0)
	{
		func_440();
...
void func_440()//Position - 0x2EDBE
{
...
void func_441(bool bParam0, bool bParam1)//Position - 0x2EDE7
{
	if (bParam0)
	{
		func_436(0, 1, 1);
...
void func_442(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x2EE1A
{
	if (func_516())
	{
...
void func_443(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2EEAF
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		if (!func_511(iParam6, iParam7, iParam8, iParam13))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_489(vParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_107(vParam1, 0f, 0f, 0f, 0))
...
int func_444(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)//Position - 0x2F043
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
void func_445(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2FE87
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_446(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x30A9D
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_447(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x30B10
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_448(int iParam0)//Position - 0x32002
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_449(int iParam0, bool bParam1, var uParam2)//Position - 0x320B2
{
	int iVar0;
	bool bVar1;
...
int func_450(int iParam0)//Position - 0x32220
{
	if (iParam0 != func_82())
	{
		if (func_343(iParam0, 1, 1))
...
int func_451(int iParam0)//Position - 0x32267
{
	switch (iParam0)
	{
		case 0:
...
int func_452(int iParam0)//Position - 0x3262F
{
...
int func_453(int iParam0)//Position - 0x32671
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case -32236122:
...
int func_454(int iParam0)//Position - 0x32714
{
	if (iParam0 != func_82())
	{
		if (func_343(iParam0, 1, 1))
...
int func_455(int iParam0)//Position - 0x3275B
{
	if (iParam0 != func_82())
	{
		if (func_343(iParam0, 1, 1))
...
int func_456(int iParam0)//Position - 0x327A1
{
	switch (iParam0)
	{
		case -2118308144:
...
int func_457(int iParam0)//Position - 0x327D6
{
...
int func_458(int iParam0)//Position - 0x32805
{
...
int func_459(int iParam0)//Position - 0x328C2
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		return 0;
...
int func_460(int iParam0)//Position - 0x328F8
{
	switch (iParam0)
	{
		case 562680400:
...
int func_461(int iParam0, bool bParam1)//Position - 0x32951
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_462(int iParam0)//Position - 0x329AC
{
	int iVar0;
...
int func_463(int iParam0, int iParam1)//Position - 0x329E6
{
	if (iParam1 == 0)
	{
...
bool func_464()//Position - 0x32D5A
{
	return DLC::IS_DLC_PRESENT(1927191088);
}

bool func_465()//Position - 0x32D6B
{
	return DLC::IS_DLC_PRESENT(2067165443);
}

bool func_466()//Position - 0x32D7C
{
	return DLC::IS_DLC_PRESENT(-957277403);
}

bool func_467()//Position - 0x32D8D
{
	return DLC::IS_DLC_PRESENT(210122941);
}

bool func_468()//Position - 0x32D9E
{
	return DLC::IS_DLC_PRESENT(-1894522408);
}

bool func_469()//Position - 0x32DAF
{
	return DLC::IS_DLC_PRESENT(1630677557);
}

int func_470(int iParam0, int iParam1)//Position - 0x32DC0
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_471(int iParam0)//Position - 0x33136
{
	if (iParam0 != func_82())
	{
		if (func_343(iParam0, 1, 1))
...
int func_472(int iParam0)//Position - 0x33195
{
	if (iParam0 != func_82())
	{
		if (func_343(iParam0, 1, 1))
...
int func_473(int iParam0)//Position - 0x331F5
{
	if (iParam0 != func_82())
	{
		if (func_343(iParam0, 1, 1))
...
int func_474(int iParam0, bool bParam1, var uParam2)//Position - 0x3323C
{
	bool bVar0;
...
int func_475(int iParam0)//Position - 0x3367B
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_476(int iParam0, int iParam1)//Position - 0x336A4
{
	int iVar0;
...
void func_477(int iParam0)//Position - 0x33726
{
	if (!func_478(*iParam0))
	{
...
bool func_478(int iParam0)//Position - 0x33751
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_479(int iParam0, var uParam1, var uParam2)//Position - 0x33760
{
	int iVar0;
	int iVar1;
...
int func_480(int iParam0)//Position - 0x33923
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_481(var uParam0)//Position - 0x339FF
{
...
int func_482(int iParam0, int iParam1)//Position - 0x33A3F
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_483(var uParam0, int iParam1)//Position - 0x33B24
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_484(int iParam0, int iParam1)//Position - 0x33B65
{
	int iVar0;
...
void func_485(vector3 vParam0, float fParam3, bool bParam4)//Position - 0x33C03
{
	int iVar0;
...
void func_486(int iParam0)//Position - 0x33C53
{
	bool bVar0;
...
int func_487(int iParam0, int iParam1)//Position - 0x33DC5
{
	int iVar0;
...
int func_488(var uParam0)//Position - 0x33E37
{
	return *uParam0;
}

int func_489(vector3 vParam0, float fParam3)//Position - 0x33E42
{
	return func_490(&(Global_105109.f_2890), vParam0, fParam3, 0);
}

int func_490(var uParam0, vector3 vParam1, float fParam4, bool bParam5)//Position - 0x33E5C
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
int func_491(int iParam0)//Position - 0x34110
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_492(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x341D3
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_494(iParam0, uVar1[iVar6], 1) && func_493(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_107(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
int func_493(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x343DB
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_494(int iParam0, int iParam1, bool bParam2)//Position - 0x34456
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_495(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x344B7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_496(int iParam0, int iParam1)//Position - 0x34A79
{
	int iVar0;
	int iVar1;
...
bool func_497()//Position - 0x34AF1
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_498(int iParam0)//Position - 0x34B02
{
	int iVar0;
...
int func_499(int iParam0)//Position - 0x34B4D
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
int func_500(int iParam0)//Position - 0x34BD4
{
...
int func_501(int iParam0)//Position - 0x34C03
{
...
int func_502(int iParam0)//Position - 0x34C20
{
...
int func_503(int iParam0, int iParam1)//Position - 0x34C43
{
...
int func_504(int iParam0)//Position - 0x34C7E
{
	if (func_503(iParam0, 0))
	{
...
int func_505(int iParam0, int iParam1)//Position - 0x34CA1
{
	int iVar0;
...
int func_506(var uParam0)//Position - 0x34CEE
{
	if (func_507(uParam0))
	{
...
int func_507(var uParam0)//Position - 0x34D23
{
...
bool func_508()//Position - 0x34D82
{
	return func_506(&(Global_105109.f_2890));
}

void func_509()//Position - 0x34D95
{
	func_510(&(Global_105109.f_2890));
}

void func_510(var uParam0)//Position - 0x34DA8
{
	if (func_507(uParam0))
	{
...
int func_511(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x34DC6
{
...
int func_513(int iParam0)//Position - 0x34EC9
{
	switch (iParam0)
	{
		case joaat("police"):
...
bool func_514()//Position - 0x34F22
{
	return func_507(&(Global_105109.f_2890));
}

int func_515()//Position - 0x34F35
{
...
void func_517()//Position - 0x34F83
{
	vector3 vVar0;
	vector3 vVar3;
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, iLocal_664);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_664, 1862763509);
	vVar0 = { func_524(Local_103) };
	vVar3 = { func_523(Local_103) };
	PED::SET_PED_NON_CREATION_AREA(vVar0, vVar3);
	iLocal_482 = PED::ADD_SCENARIO_BLOCKING_AREA(vVar0, vVar3, 0, 1, 1, 1);
...
void func_518()//Position - 0x350C8
{
	if (func_23(Local_112.f_9))
	{
		...
		func_362(Local_112.f_9);
		func_519(Local_112.f_9, "TARGET_", 0);
		Local_112.f_10 = 0;
		...
		if (func_23(Local_132[0 /*20*/]))
		{
			...
			func_519(Local_132[0 /*20*/], "BACKUP_", 0);
...
void func_519(var uParam0, char* sParam1, int iParam2)//Position - 0x353BF
{
	char cVar0[16];
...
int func_520()//Position - 0x353DB
{
	...
	if (iLocal_468 > 0)
	{
		...
		{
			if (func_522(&(Local_254[iVar2 /*6*/]), Local_254[iVar2 /*6*/].f_5, Local_254[iVar2 /*6*/].f_1, Local_254[iVar2 /*6*/].f_4, 1))
			{
				iVar0++;
			}
			iVar2++;
	...
	if (iLocal_470 > 0)
	{
		...
		{
			if (func_521(&(Local_377[iVar2 /*7*/]), Local_377[iVar2 /*7*/].f_5, Local_377[iVar2 /*7*/].f_2, Local_377[iVar2 /*7*/].f_6, Local_377[iVar2 /*7*/].f_1, 1))
			{
				iVar0++;
			}
			iVar2++;
...
int func_521(var uParam0, int iParam1, vector3 vParam2, int iParam5, int iParam6, bool bParam7)//Position - 0x35615
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_56(iParam6))
...
int func_522(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0x35686
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_56(iParam1))
...
Vector3 func_523(struct<5> Param0, var uParam5, var uParam6, var uParam7)//Position - 0x35725
{
	switch (Param0.f_4)
	{
		case 0:
...
Vector3 func_524(struct<5> Param0, var uParam5, var uParam6, var uParam7)//Position - 0x35799
{
	switch (Param0.f_4)
	{
		case 0:
...
void func_525()//Position - 0x3580D
{
	int iVar0;
	...
	StringCopy(&vLocal_665, "", 24);
	Local_385.f_6 = func_536(62);
	Local_385.f_1 = { func_535() };
	Local_385.f_4 = func_534();
	Local_393.f_5 = func_533();
	Local_393.f_1 = { func_532() };
	Local_393.f_4 = func_531();
	Local_399.f_5 = func_530();
	Local_399.f_1 = { func_529() };
	Local_399.f_4 = func_528();
	Local_405.f_5 = func_48();
	Local_405.f_1 = { func_47() };
	Local_405.f_4 = func_46();
	Local_411.f_5 = func_45();
	Local_411.f_1 = { func_527() };
	Local_411.f_4 = func_526();
...
float func_526()//Position - 0x35BCA
{
	return 75.15f;
}

Vector3 func_527()//Position - 0x35BD7
{
	return 2727.29f, 4145.9f, 44.16f;
}

float func_528()//Position - 0x35BEE
{
	return 71f;
}

Vector3 func_529()//Position - 0x35BFB
{
	return 2727.686f, 4145.715f, 44.08f;
}

int func_530()//Position - 0x35C12
{
	return 1385417869;
}

float func_531()//Position - 0x35C1F
{
	return -91.28f;
}

Vector3 func_532()//Position - 0x35C2C
{
	return 2728.35f, 4145.59f, 43.3f;
}

int func_533()//Position - 0x35C43
{
	return -741944541;
}

float func_534()//Position - 0x35C50
{
	return 89.19f;
}

Vector3 func_535()//Position - 0x35C5D
{
	return 2728.33f, 4145.6f, 43.89f;
}

int func_536(int iParam0)//Position - 0x35C74
{
	if (!func_89(iParam0))
	{
		return func_92(iParam0);
...
int func_537(bool bParam0)//Position - 0x35C9A
{
...
int func_541(int iParam0)//Position - 0x35DD2
{
	int iVar0;
...
var func_542()//Position - 0x364EF
{
	return Global_98708.f_1;
}

int func_543()//Position - 0x364FD
{
	if (Global_95621 != -1)
	{
...
bool func_544()//Position - 0x36523
{
	return Global_98721.f_346 > 0;
}

bool func_545()//Position - 0x36534
{
	return Global_98721.f_345 > 0;
}

var func_546()//Position - 0x36545
{
	return Global_1312873;
}

bool func_547(int iParam0)//Position - 0x36551
{
	return func_548(iParam0, Global_41396);
}

int func_548(int iParam0, int iParam1)//Position - 0x36562
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_549(int iParam0)//Position - 0x36743
{
	func_574();
	if (!func_573())
	{
...
void func_550(char* sParam0)//Position - 0x3678E
{
	if (Global_98669 != 12)
	{
...
int func_551(char* sParam0, int iParam1, int iParam2)//Position - 0x367AB
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_552(char* sParam0)//Position - 0x3693D
{
...
void func_553(int iParam0, var uParam1)//Position - 0x36993
{
	switch (iParam0)
	{
		case 0:
...
int func_555(int iParam0)//Position - 0x37BD9
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_556(int iParam0)//Position - 0x37F1F
{
	struct<2> Var0;
	char[] cVar2[8];
	
	StringCopy(&Var0, "", 8);
	cVar2 = { func_557(iParam0) };
...
struct<2> func_557(int iParam0)//Position - 0x37F56
{
	struct<2> Var0;
...
int func_559(char* sParam0, bool bParam1)//Position - 0x38462
{
	int iVar0;
	int iVar1;
...
int func_560(int iParam0, bool bParam1)//Position - 0x3848C
{
	int iVar0;
...
void func_563(int iParam0)//Position - 0x3857E
{
	if (iParam0 == 1)
	{
		Global_41945 = 1;
...
void func_564(bool bParam0)//Position - 0x38597
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_565(int iParam0)//Position - 0x385AB
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_566(int iParam0)//Position - 0x385E8
{
	if (iParam0 == 1)
	{
...
void func_567()//Position - 0x38625
{
	Global_22211.f_5 = 1;
}

void func_568()//Position - 0x38633
{
	Global_22211.f_5 = 0;
}

void func_569()//Position - 0x38641
{
	Global_92875 = 0;
	Global_92876 = 0;
}

void func_570()//Position - 0x38653
{
	Global_98669 = 13;
	Global_98669.f_1 = -1;
	Global_98669.f_2 = 0;
...
void func_574()//Position - 0x3873E
{
	Global_98704 = 1;
...
void func_575()//Position - 0x3882B
{
	if (iLocal_450)
	{
		func_433(0, 1);
