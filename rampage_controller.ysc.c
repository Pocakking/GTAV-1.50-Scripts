...
int func_16(char* sParam0)//Position - 0x87A
{
...
int func_17(char* sParam0)//Position - 0x8A1
{
	int iVar0;
...
int func_18(int iParam0)//Position - 0x8DC
{
	int iVar0;
	int iVar1;
...
void func_19(bool bParam0)//Position - 0x91F
{
	int iVar0;
	int iVar1;
...
void func_20(int iParam0, bool bParam1)//Position - 0x9AF
{
	int iVar0;
...
int func_21(int iParam0, int iParam1)//Position - 0xA38
{
...
void func_22(int iParam0, int iParam1)//Position - 0xA5F
{
	int iVar0;
...
void func_23(int iParam0, bool bParam1)//Position - 0xABD
{
	int iVar0;
...
void func_24(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0xB43
{
	int iVar0;
...
void func_25(int iParam0)//Position - 0xC11
{
	int iVar0;
...
void func_26(int iParam0, bool bParam1, bool bParam2)//Position - 0xCA2
{
	int iVar0;
	bool bVar1;
...
void func_27(int iParam0, int iParam1, int iParam2)//Position - 0xDAB
{
	bool bVar0;
...
bool func_30(bool bParam0)//Position - 0x139F
{
...
int func_31()//Position - 0x13CA
{
	return Global_30736;
}

int func_32(int iParam0, int iParam1)//Position - 0x13D5
{
	int iVar0;
...
int func_33(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1426
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_34()//Position - 0x1A69
{
	return Global_1312745;
}

int func_35(int iParam0)//Position - 0x1A75
{
	int iVar0;
	int iVar1;
...
int func_36(int iParam0)//Position - 0x1ACF
{
