...
int func_7(int iParam0, int iParam1)//Position - 0x8EE
{
	int iVar0;
...
int func_8()//Position - 0xC5D
{
	return Global_1312745;
}

int func_9(int iParam0)//Position - 0xC69
{
	if (iParam0 == 3)
	{
		return 815;
...
int func_10(int iParam0, int iParam1)//Position - 0xCB0
{
	if (iParam1 < 32)
	{
		return iParam1;
...
int func_11(int iParam0)//Position - 0xCCC
{
	if (iParam0 == 3)
	{
		return 30;
...
void func_12(int iParam0)//Position - 0xD1C
{
...
int func_14(int iParam0)//Position - 0xD58
{
	int iVar0;
	int iVar1;
...
int func_15(int iParam0, int iParam1, bool bParam2)//Position - 0xDB2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_16(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xFAE
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!bParam2)
	{
		...
		iVar2 = iVar20;
		Var3 = { func_27(Global_42574[iVar20 /*12*/].f_1) };
	...
	else
	{
		...
		{
			Var3 = { func_27(Global_42574[iVar26 /*12*/].f_1) };
		}
	}
	if (!bParam4)
	{
...
void func_17(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x1383
{
	int iVar0;
	bool bVar1;
	char cVar2[64];
...
void func_18(var uParam0)//Position - 0x156B
{
...
char* func_19(int iParam0)//Position - 0x1599
{
	switch (iParam0)
	{
		case 0:
...
char* func_20(int iParam0, int iParam1)//Position - 0x1904
{
	*iParam1 = 1;
	switch (iParam0)
	{
...
var func_21()//Position - 0x1CCF
{
	func_22();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_22()//Position - 0x1CE8
{
	int iVar0;
...
bool func_23(int iParam0)//Position - 0x1DE5
{
	return iParam0 < 3;
}

int func_24(int iParam0)//Position - 0x1DF1
{
	int iVar0;
	int iVar1;
...
int func_25(int iParam0)//Position - 0x1E2E
{
	if (func_23(iParam0))
	{
...
var func_26(int iParam0)//Position - 0x1E53
{
	return Global_1798[iParam0 /*29*/];
}

struct<16> func_27(int iParam0)//Position - 0x1E62
{
	struct<16> Var0;
	struct<16> Var16;
...
int func_28(int iParam0, bool bParam1)//Position - 0x1E93
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
int func_29(int iParam0)//Position - 0x20AB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_30(int iParam0, int iParam1)//Position - 0x210F
{
...
void func_31(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5)//Position - 0x2154
{
	int iVar0;
...
void func_32(vector3 vParam0)//Position - 0x226D
{
	int iVar0;
...
int func_33(int iParam0, int iParam1)//Position - 0x22AB
{
	int iVar0;
	int iVar1;
...
void func_34(var uParam0, var uParam1)//Position - 0x2305
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
void func_35(vector3 vParam0)//Position - 0x2345
{
...
bool func_36(int iParam0, vector3 vParam1, float fParam4)//Position - 0x236F
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, true), vParam1) <= (fParam4 * fParam4);
}

int func_37()//Position - 0x238C
{
	if (func_38(0))
	{
		return 0;
...
bool func_38(bool bParam0)//Position - 0x23D7
{
...
void func_39(int iParam0, int iParam1)//Position - 0x2402
{
	Global_98708.f_7 = iParam0;
	Global_98708.f_8 = iParam1;
}

int func_40(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x241A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_41(var uParam0)//Position - 0x2A62
{
...
int func_42(var uParam0)//Position - 0x2A7B
{
	int iVar0;
	int iVar1;
...
void func_43(int iParam0)//Position - 0x2B07
{
	int iVar0;
	int iVar1;
...
int func_44(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x2B49
{
	int iVar0;
...
int func_45(int iParam0)//Position - 0x2C1A
{
	int iVar0;
	int iVar1;
...
bool func_46(int iParam0)//Position - 0x2C5D
{
	return Global_41396 == iParam0;
}

int func_47(int iParam0)//Position - 0x2C6B
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_49(int iParam0)//Position - 0x2E3E
{
	int iVar0;
	int iVar1;
