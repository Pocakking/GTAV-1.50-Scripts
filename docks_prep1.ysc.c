...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_41 = 49;
	iLocal_42 = 64;
	uLocal_46 = HUD::_GET_LEVEL_BLIP_SPRITE();
	iLocal_47 = HUD::_GET_WAYPOINT_BLIP_SPRITE();
	iLocal_49 = "REACTION@MALE_STAND@BIG_VARIATIONS@IDLE_B";
	iLocal_50 = "cellphone@str";
	iLocal_51 = "missheistdocksprep1ig_1";
...
void func_8()//Position - 0x3E5
{
	switch (iLocal_2104)
	{
		case 0:
			...
			{
				ENTITY::SET_ENTITY_PROOFS(Local_55[0 /*2*/], false, false, false, true, false, 0, 0, 0);
			}
		...
		case 1:
			...
			if (!iLocal_453 && func_92(PLAYER::PLAYER_PED_ID(), vLocal_52, 1) < 200f)
			{
			...
			if (ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_55[1 /*2*/], PLAYER::GET_PLAYERS_LAST_VEHICLE()) || ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_55[2 /*2*/], -333.6057f, -2623.681f, 5.00103f, -350.1272f, -2640.339f, 12.65742f, 15f, 0, true, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_64[3 /*10*/], -333.6057f, -2623.681f, 5.00103f, -350.1272f, -2640.339f, 12.65742f, 15f, 0, true, 0)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_55[0 /*2*/], -333.6057f, -2623.681f, 5.00103f, -350.1272f, -2640.339f, 12.65742f, 15f, 0, true, 0)))
			{
				...
				{
					HUD::_SET_BLIP_DISPLAY_INDICATOR_ON_BLIP(Local_188.f_5, 1);
				}
		...
		case 3:
			if (!func_11())
			{
				...
				{
					TASK::CLEAR_PED_TASKS(Local_64[3 /*10*/]);
					TASK::TASK_SMART_FLEE_COORD(Local_64[3 /*10*/], vLocal_52, 300f, -1, 0, 0);
				}
				iLocal_452 = MISC::GET_GAME_TIMER();
				iLocal_2104++;
			}
...
bool func_16(int iParam0)//Position - 0xEEE
{
	return func_17(iParam0, 20);
}

bool func_17(int iParam0, int iParam1)//Position - 0xEFE
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_18()//Position - 0xF19
{
	return -1;
}

void func_19()//Position - 0xF22
{
	int iVar0;
...
int func_24()//Position - 0x114A
{
	func_25();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_25()//Position - 0x1163
{
	int iVar0;
...
bool func_26(int iParam0)//Position - 0x1260
{
	return iParam0 < 3;
}

int func_27(int iParam0)//Position - 0x126C
{
	int iVar0;
	int iVar1;
...
int func_28(int iParam0)//Position - 0x12A9
{
	if (func_26(iParam0))
	{
...
var func_29(int iParam0)//Position - 0x12CE
{
	return Global_1798[iParam0 /*29*/];
}

bool func_30(int iParam0)//Position - 0x12DD
{
	return Global_41396 == iParam0;
}

void func_31()//Position - 0x12EB
{
	int iVar0;
...
bool func_32(int iParam0, int iParam1)//Position - 0x1342
{
	switch (iParam0)
	{
		case 5:
...
void func_34(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x13D4
{
...
void func_35(char* sParam0, int iParam1, int iParam2)//Position - 0x142A
{
	iParam2 = iParam2;
...
int func_38(int iParam0, bool bParam1, bool bParam2)//Position - 0x148A
{
	return func_39(iParam0, !bParam1, bParam2);
}

int func_39(int iParam0, bool bParam1, bool bParam2)//Position - 0x149D
{
	int iVar0;
...
float func_40(bool bParam0, float fParam1, float fParam2)//Position - 0x1541
{
	if (bParam0)
	{
		return fParam1;
...
void func_41(int iParam0)//Position - 0x1558
{
...
void func_42(int iParam0, bool bParam1, bool bParam2)//Position - 0x1573
{
	int iVar0;
...
var func_43()//Position - 0x1724
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

void func_44(int iParam0, var uParam1)//Position - 0x1734
{
	switch (iParam0)
	{
		case 0:
...
void func_45(int iParam0, var uParam1)//Position - 0x177C
{
	switch (iParam0)
	{
		case 0:
...
int func_46(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x17C4
{
...
void func_47(int iParam0)//Position - 0x1953
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
int func_48(int iParam0, vector3 vParam1, vector3 vParam4, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, char* sParam12, char* sParam13, char* sParam14, char* sParam15, char* sParam16, char* sParam17, char* sParam18, bool bParam19, bool bParam20, bool bParam21, int iParam22)//Position - 0x197F
{
	return func_49(iParam0, vParam1, vParam4, func_87(), func_87(), iParam7, 5, iParam8, iParam9, iParam10, iParam11, sParam12, sParam13, sParam14, sParam15, sParam16, sParam17, bParam19, bParam20, sParam18, 0, 0, bParam21, iParam22, 0, 0, 0, 1, 1065353216);
}

int func_49(int iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, char* sParam19, char* sParam20, char* sParam21, char* sParam22, char* sParam23, char* sParam24, bool bParam25, bool bParam26, char* sParam27, bool bParam28, int iParam29, bool bParam30, int iParam31, int iParam32, int iParam33, int iParam34, bool bParam35, float fParam36)//Position - 0x19C9
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
int func_50(int iParam0, bool bParam1, bool bParam2)//Position - 0x2326
{
	return func_39(iParam0, !bParam1, bParam2);
}

int func_51(int iParam0)//Position - 0x2339
{
...
int func_52(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2397
{
	int iVar0;
...
int func_53(int iParam0)//Position - 0x247C
{
	float fVar0;
...
int func_54(int iParam0, int iParam1)//Position - 0x24B3
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
int func_55(int iParam0, int iParam1)//Position - 0x251E
{
	int iVar0;
...
int func_56(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x2566
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_57(int iParam0, int iParam1)//Position - 0x25E1
{
	if (HUD::DOES_BLIP_EXIST(iParam0))
	{
...
int func_58(vector3 vParam0, bool bParam3)//Position - 0x261C
{
	int iVar0;
...
void func_59(int iParam0, char* sParam1, int iParam2)//Position - 0x2648
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_60(iParam2), 1);
}

int func_60(int iParam0)//Position - 0x265F
{
	int iVar0;
...
void func_61(int iParam0, char* sParam1, bool bParam2)//Position - 0x2854
{
	if (!bParam2)
	{
...
int func_62(int iParam0)//Position - 0x288B
{
...
int func_63(int iParam0, int iParam1)//Position - 0x28AF
{
...
int func_64(var uParam0)//Position - 0x2907
{
	int iVar0;
	int iVar1;
...
int func_65(var uParam0, int iParam1)//Position - 0x292A
{
	int iVar0;
...
int func_66(int iParam0, var uParam1, int iParam2)//Position - 0x295B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_67(char* sParam0)//Position - 0x29EF
{
...
int func_68(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, char* sParam7, float fParam8, bool bParam9, int iParam10, bool bParam11, int iParam12, var uParam13, var uParam14, var uParam15, int iParam16, bool bParam17)//Position - 0x2A07
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_69(int iParam0, var uParam1)//Position - 0x3A78
{
	switch (iParam0)
	{
		case 0:
...
void func_70(var uParam0, char* sParam1, char* sParam2, bool bParam3)//Position - 0x3AC0
{
	if (!bParam3)
	{
		if (!MISC::IS_STRING_NULL(sParam1))
...
void func_71(char* sParam0, char* sParam1, int iParam2, int iParam3)//Position - 0x3AF9
{
	iParam3 = iParam3;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
int func_72(int iParam0, var uParam1)//Position - 0x3B18
{
	switch (iParam0)
	{
		case 0:
...
int func_73(int iParam0, float fParam1)//Position - 0x3B61
{
	int iVar0;
...
int func_74(int iParam0, int iParam1)//Position - 0x3B98
{
	int iVar0;
...
int func_75(int iParam0, int iParam1)//Position - 0x3BFF
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
void func_76(int iParam0, var uParam1)//Position - 0x3C34
{
	switch (iParam0)
	{
		case 0:
...
int func_77(int iParam0, var uParam1)//Position - 0x3C7C
{
	switch (iParam0)
	{
		case 0:
...
int func_78(int iParam0)//Position - 0x3CC5
{
	int iVar0;
	int iVar1;
...
int func_79(int iParam0, var uParam1)//Position - 0x3D52
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_80(var uParam0)//Position - 0x3EB2
{
	int iVar0;
...
int func_81(var uParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x3EE1
{
	int iVar0;
...
int func_82(int iParam0)//Position - 0x3FBF
{
	float fVar0;
...
int func_83(int iParam0, int iParam1)//Position - 0x3FF7
{
	int iVar0;
...
void func_85(var uParam0)//Position - 0x4096
{
	int iVar0;
...
void func_86(var uParam0)//Position - 0x4139
{
	int iVar0;
...
Vector3 func_87()//Position - 0x41CF
{
	vector3 vVar0;
...
int func_88(var uParam0, int iParam1)//Position - 0x41DB
{
	int iVar0;
	int iVar1;
...
void func_89(var uParam0, int iParam1)//Position - 0x4284
{
	int iVar0;
...
void func_90(var uParam0)//Position - 0x42E9
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_91(int iParam0, bool bParam1)//Position - 0x4304
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
float func_92(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x433F
{
	vector3 vVar0;
...
void func_93(int iParam0)//Position - 0x4379
{
	char* sVar0;
...
void func_94(vector3 vParam0, float fParam3)//Position - 0x44C5
{
...
bool func_95(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x44F1
{
	if (bParam6)
	{
...
void func_98(char* sParam0)//Position - 0x457A
{
	func_106(sParam0);
	func_99(0);
}

void func_99(int iParam0)//Position - 0x458D
{
	int iVar0;
...
int func_100(int iParam0)//Position - 0x45D2
{
	int iVar0;
	int iVar1;
...
void func_101(var uParam0, int iParam1)//Position - 0x46E9
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_103(Global_111560.f_18528[iVar0], &vVar2, &fVar5))
			{
...
void func_102(var uParam0)//Position - 0x48B2
{
	*uParam0 = -15;
}

int func_103(int iParam0, var uParam1, float fParam2)//Position - 0x48C0
{
	switch (iParam0)
	{
		case 11:
...
void func_104(int iParam0, bool bParam1)//Position - 0x522F
{
	if (bParam1)
	{
...
void func_106(char* sParam0)//Position - 0x535A
{
...
int func_107(int iParam0)//Position - 0x5399
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (ENTITY::IS_ENTITY_A_VEHICLE(iParam0))
...
void func_108(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x53E4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_109(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x5559
{
	func_110(&Global_105109, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_110(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x5575
{
	int iVar0;
	int iVar1;
...
int func_111(var uParam0)//Position - 0x63FE
{
...
void func_112(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x6420
{
	int iVar0;
...
int func_113(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x64A8
{
...
int func_114(int iParam0)//Position - 0x64E8
{
	int iVar0;
...
void func_115(var uParam0, int iParam1, int iParam2)//Position - 0x6516
{
...
int func_116(int iParam0)//Position - 0x65F2
{
	int iVar0;
...
int func_117(int iParam0)//Position - 0x6634
{
	int iVar0;
...
int func_118(int iParam0, int iParam1, int iParam2)//Position - 0x6697
{
	int iVar0;
...
int func_119(int iParam0, int iParam1)//Position - 0x6725
{
	struct<82> Var0;
...
void func_120(int iParam0, var uParam1, int iParam2)//Position - 0x6767
{
	int iVar0;
...
void func_121(int iParam0, var uParam1)//Position - 0x69C3
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0x6C6E
{
	switch (iParam0)
	{
		case 1:
...
int func_123(int iParam0, var uParam1, var uParam2)//Position - 0x6D1E
{
	int iVar0;
	int iVar1;
...
int func_124(int iParam0)//Position - 0x6F11
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_125(var uParam0)//Position - 0x6F31
{
	int iVar0;
...
int func_126(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x6FE1
{
	char* sVar0;
...
int func_127(int iParam0, int iParam1, bool bParam2)//Position - 0x7110
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_128(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x7181
{
...
void func_129(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x7259
{
	int iVar0;
	int iVar1;
...
int func_130(int iParam0, int iParam1, int iParam2)//Position - 0x73F9
{
	int iVar0;
	var uVar1;
...
var func_132()//Position - 0x745F
{
	return Global_1312745;
}

int func_133(int iParam0, int iParam1)//Position - 0x746B
{
	var uVar0;
	var uVar1;
...
void func_134(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x7497
{
	int iVar0;
...
void func_135(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x79DF
{
	int iVar0;
...
int func_136()//Position - 0x7C20
{
	func_25();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_137(int iParam0, bool bParam1)//Position - 0x7C39
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_138(int iParam0, var uParam1)//Position - 0x7D2C
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_140(Var11.f_1)) && iVar72 < 51)
			{
...
int func_139(int iParam0)//Position - 0x7FB4
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_140(int iParam0)//Position - 0x8094
{
...
int func_141(int iParam0, int iParam1)//Position - 0x8226
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_142(int iParam0, var uParam1)//Position - 0x8D97
{
	int iVar0;
	int iVar1;
...
int func_143(int iParam0)//Position - 0x8DD2
{
	int iVar0;
...
void func_144(int iParam0)//Position - 0x9046
{
	int iVar0;
...
void func_145(var uParam0, int iParam1)//Position - 0x9082
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_146(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x95DD
{
	int iVar0;
	int iVar1;
...
bool func_147(int iParam0, var uParam1, var uParam2)//Position - 0x9621
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
int func_148(var uParam0)//Position - 0x9D3C
{
...
bool func_149(int iParam0)//Position - 0x9D97
{
	return func_150(iParam0, 0, 1);
}

int func_150(int iParam0, int iParam1, bool bParam2)//Position - 0x9DA7
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_151(int iParam0)//Position - 0x9E11
{
	switch (iParam0)
	{
		case 0:
...
int func_152()//Position - 0xA141
{
	return Global_30736;
}

int func_153(int iParam0)//Position - 0xA14C
{
	return func_150(iParam0, 5, 1);
}

int func_154(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0xA15C
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_155(int iParam0, bool bParam1)//Position - 0xA1FE
{
	switch (iParam0)
	{
		case -1:
...
int func_156(int iParam0)//Position - 0xA81B
{
	if (iParam0 != func_18())
	{
...
Vector3 func_157(int iParam0, int iParam1)//Position - 0xA879
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_158(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0xA927
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_159(vector3 vParam0, float fParam3)//Position - 0xA9BC
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_160(int iParam0)//Position - 0xAA00
{
	struct<6> Var0;
...
struct<6> func_161(int iParam0)//Position - 0xAB84
{
	return func_162(iParam0);
}

struct<6> func_162(int iParam0)//Position - 0xAB92
{
	struct<6> Var0;
...
int func_163(int iParam0, var uParam1)//Position - 0xB659
{
	switch (iParam0)
	{
		case 0:
...
int func_164(int iParam0)//Position - 0xB6DB
{
	if (iParam0 != func_18())
	{
...
Vector3 func_165(int iParam0)//Position - 0xB739
{
	switch (iParam0)
	{
		case 1:
...
int func_166()//Position - 0xB944
{
	return func_167(PLAYER::PLAYER_ID());
}

var func_167(int iParam0)//Position - 0xB954
{
	return MISC::GET_BITS_IN_RANGE(Global_2424073[iParam0 /*421*/].f_309.f_3, 28, 31);
}

int func_168(int iParam0)//Position - 0xB971
{
	return func_150(iParam0, 0, 0);
}

int func_169(int iParam0)//Position - 0xB981
{
	switch (iParam0)
	{
		case -1:
...
bool func_170()//Position - 0xBC4F
{
	return Global_98721.f_345 > 0;
}

var func_171()//Position - 0xBC60
{
	var uVar0;
...
void func_172(var uParam0, int iParam1)//Position - 0xBCA6
{
	if (iParam1 <= 0)
	{
		return;
...
void func_173(var uParam0, int iParam1)//Position - 0xBD2C
{
...
void func_174(var uParam0, int iParam1)//Position - 0xBD5F
{
	int iVar0;
	int iVar1;
...
int func_175(int iParam0, int iParam1)//Position - 0xBDB0
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_176(int iParam0)//Position - 0xBE52
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_177(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_177(bool bParam0, int iParam1, int iParam2)//Position - 0xBE77
{
	if (bParam0)
	{
		return iParam1;
...
int func_178(var uParam0)//Position - 0xBE8E
{
	return uParam0 & 15;
}

void func_179(var uParam0, int iParam1)//Position - 0xBE9B
{
...
void func_180(var uParam0, int iParam1)//Position - 0xBED5
{
...
void func_181(var uParam0, int iParam1)//Position - 0xBF10
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_182(char* sParam0)//Position - 0xBF4C
{
...
struct<2> func_183(int iParam0)//Position - 0xBFA2
{
	struct<2> Var0;
...
int func_184(char* sParam0, int iParam1)//Position - 0xC43E
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_185(int iParam0, var uParam1)//Position - 0xC487
{
	switch (iParam0)
	{
		case 0:
...
int func_187(int iParam0)//Position - 0xD6CD
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_188(int iParam0)//Position - 0xDA13
{
	struct<2> Var0;
	char[] cVar2[8];
...
int func_189(int iParam0)//Position - 0xDA4A
{
	switch (iParam0)
	{
		case 69:
...
int func_190(int iParam0)//Position - 0xDB06
{
	switch (iParam0)
	{
		case 1:
...
int func_191(char* sParam0, bool bParam1)//Position - 0xDB5A
{
	int iVar0;
	int iVar1;
...
int func_192(int iParam0, bool bParam1)//Position - 0xDB84
{
	int iVar0;
...
void func_193(bool bParam0)//Position - 0xDBBA
{
	int iVar0;
	int iVar1;
...
void func_194()//Position - 0xDE3C
{
	...
	switch (iLocal_2104)
	{
		...
		case 1:
			if (func_222())
			{
				func_221(&uLocal_460, iLocal_49);
				func_221(&uLocal_460, iLocal_50);
				iLocal_396 = -1;
				iLocal_397 = 0;
				iLocal_2104++;
			}
		...
		case 2:
			...
			{
				if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, true, 0) || PED::IS_PED_FLEEING(Local_64[6 /*10*/])) || func_10(PLAYER::PLAYER_PED_ID(), Local_64[6 /*10*/], 1) > 100f)
				{
			...
			{
				if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, true, 0) || PED::IS_PED_FLEEING(Local_64[7 /*10*/])) || func_10(PLAYER::PLAYER_PED_ID(), Local_64[7 /*10*/], 1) > 100f)
				{
			...
			{
				if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, true, 0) || PED::IS_PED_FLEEING(Local_64[4 /*10*/])) || func_10(PLAYER::PLAYER_PED_ID(), Local_64[4 /*10*/], 1) > 100f)
				{
			...
			{
				if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, true, 0) || PED::IS_PED_FLEEING(Local_64[5 /*10*/])) || func_10(PLAYER::PLAYER_PED_ID(), Local_64[5 /*10*/], 1) > 100f)
				{
					TASK::CLEAR_PED_TASKS(Local_64[5 /*10*/]);
					func_9(&(Local_64[5 /*10*/]), 1, 0, 1);
				}
			}
			if (func_226(&Local_188, 324.7653f, -2974.495f, -1.5f, 0.1f, 0.1f, 2f, 0, Local_55[0 /*2*/], "dkp1_tk1", "", "DKP1_SUBBK", 1, 0, 1, -1) || ((HUD::DOES_BLIP_EXIST(Local_188.f_5) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_55[0 /*2*/], 312.8557f, -2974.003f, 1.19166f, 339.1654f, -2974.348f, -6.70078f, 15f, 0, true, 0)) && func_218(PLAYER::PLAYER_PED_ID(), Local_55[0 /*2*/])))
			{
		...
		case 3:
			...
			{
				iLocal_444 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, 341.6419f, -2965.525f, 4.037704f, 17.06695f, 0.473599f, 112.4448f, 34f, 0, 2);
		...
		case 6:
			...
			if (((((iLocal_446 && iLocal_447) && iLocal_448) && iLocal_449) && iLocal_450) && iLocal_451)
			{
				if (CAM::IS_SCREEN_FADED_IN() || PED::_HAS_STREAMED_PED_ASSETS_LOADED(Local_64[3 /*10*/]))
				{
					...
					VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_55[0 /*2*/], 10);
					VEHICLE::SET_VEHICLE_ENGINE_ON(Local_55[0 /*2*/], false, 1, 0);
					...
					Local_169[5 /*2*/] = OBJECT::CREATE_OBJECT(joaat("prop_tarp_strap"), -332.8449f, -2622.157f, 8.7838f, 1, true, 0);
...
int func_195(int iParam0)//Position - 0xE919
{
	if (iLocal_2102 == 0)
	{
		iLocal_2105 = iParam0;
...
void func_196(var uParam0)//Position - 0xE939
{
	if (uParam0->f_860)
	{
...
void func_197(bool bParam0, bool bParam1, bool bParam2, int iParam3, int iParam4)//Position - 0xE971
{
	HUD::DISPLAY_RADAR(true);
	HUD::DISPLAY_HUD(true);
...
void func_198(int iParam0)//Position - 0xE9C1
{
	iLocal_446 = iParam0;
	iLocal_447 = iParam0;
	iLocal_448 = iParam0;
...
int func_199()//Position - 0xE9E7
{
	...
	switch (iLocal_410)
	{
		case 0:
			...
			iLocal_380 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_pls_sub_water_drips", Local_55[0 /*2*/], 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
			GRAPHICS::SET_PARTICLE_FX_LOOPED_EVOLUTION(iLocal_380, "flow", 1f, 0);
		...
		case 4:
			if (fLocal_424 >= 108f)
			{
				...
				{
					GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_380, 0);
				}
				iLocal_410++;
			}
			else
			{
				...
				GRAPHICS::SET_PARTICLE_FX_LOOPED_EVOLUTION(iLocal_380, "flow", fVar0, 0);
				func_204(1, 5.5f);
			}
			break;
...
int func_200(int iParam0)//Position - 0xEF5A
{
	if (CAM::IS_SCREEN_FADED_IN())
	{
...
void func_202(var uParam0)//Position - 0xEFD6
{
...
float func_203(float fParam0, float fParam1, float fParam2)//Position - 0xEFF2
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
void func_204(bool bParam0, float fParam1)//Position - 0xF019
{
	if (bParam0)
	{
...
void func_205(bool bParam0, float fParam1)//Position - 0xF08A
{
	if (bParam0)
	{
...
int func_206(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7, int iParam8)//Position - 0xF0D9
{
...
int func_207(vector3 vParam0)//Position - 0xF1BF
{
...
void func_209(bool bParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, bool bParam9)//Position - 0xF21F
{
	...
	HUD::CLEAR_PRINTS();
	HUD::CLEAR_HELP(1);
	CAM::RENDER_SCRIPT_CAMS(bParam4, bParam5, iParam7, 1, 0, 0);
	if (bParam6)
	{
...
void func_210(int iParam0)//Position - 0xF297
{
	if (func_214())
	{
		return;
...
void func_211(bool bParam0, bool bParam1)//Position - 0xF321
{
	if (bParam0)
	{
		if (func_212(0))
...
int func_212(int iParam0)//Position - 0xF395
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
bool func_213()//Position - 0xF3EF
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

bool func_214()//Position - 0xF400
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

void func_215(bool bParam0, int iParam1)//Position - 0xF412
{
	int iVar0;
...
void func_216(int iParam0, bool bParam1)//Position - 0xF4AC
{
...
void func_217(int iParam0, bool bParam1)//Position - 0xF4E3
{
	func_42(iParam0, bParam1, 0);
}

int func_218(int iParam0, int iParam1)//Position - 0xF4F4
{
...
int func_219(char* sParam0)//Position - 0xF538
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_220(char[4] cParam0, int iParam1)//Position - 0xF54B
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

void func_221(var uParam0, int iParam1)//Position - 0xF562
{
	int iVar0;
		...
		while (iVar0 < uParam0->f_273)
		{
			if (uParam0->f_273[iVar0 /*5*/])
			{
				if (MISC::ARE_STRINGS_EQUAL(uParam0->f_273[iVar0 /*5*/].f_4, iParam1))
				{
					...
					{
						STREAMING::REMOVE_ANIM_DICT(iParam1);
...
int func_222()//Position - 0xF5E6
{
	if (!ENTITY::DOES_ENTITY_EXIST(Local_169[6 /*2*/]))
	{
		Local_169[6 /*2*/] = OBJECT::CREATE_OBJECT(iLocal_415, vLocal_416, 1, true, 0);
	...
	{
		Local_169[7 /*2*/] = OBJECT::CREATE_OBJECT(iLocal_420, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[6 /*2*/], vLocal_421), 1, true, 0);
	}
	...
	{
		Local_169[8 /*2*/] = OBJECT::CREATE_OBJECT(iLocal_425, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[7 /*2*/], vLocal_426), 1, true, 0);
	...
	if (!iLocal_384)
	{
		...
		{
			iLocal_439 = PHYSICS::ADD_ROPE(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[7 /*2*/], vLocal_433), 0f, 0f, 0f, 70f, 0, -1f, 4f, 1.4f, 0, 0, 1, 1f, 0, 0);
			PHYSICS::_0x36CCB9BE67B970FD(iLocal_439, 1);
			PHYSICS::ROPE_SET_UPDATE_ORDER(iLocal_439, 2);
			PHYSICS::ROPE_DRAW_SHADOW_ENABLED(&iLocal_439, 0);
			PHYSICS::ATTACH_ENTITIES_TO_ROPE(iLocal_439, Local_169[7 /*2*/], Local_169[8 /*2*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[7 /*2*/], vLocal_433), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[8 /*2*/], vLocal_436), 70f, 0, 0, 0, 0);
			iLocal_384 = 1;
			return 1;
		}
...
void func_223(int iParam0, int iParam1)//Position - 0xF7C5
{
...
void func_224(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xF7EC
{
...
void func_225(int iParam0, bool bParam1)//Position - 0xF887
{
	int iVar0;
...
int func_226(int iParam0, vector3 vParam1, vector3 vParam4, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11, bool bParam12, int iParam13, bool bParam14, int iParam15)//Position - 0xF8D1
{
	return func_49(iParam0, vParam1, vParam4, func_87(), func_87(), iParam7, 5, 0, 0, 0, iParam8, sParam9, func_227(), func_227(), func_227(), func_227(), sParam10, 0, bParam12, sParam11, 0, iParam13, bParam14, iParam15, 0, 0, 0, 1, 1065353216);
}

var func_227()//Position - 0xF920
{
	var uVar0;
...
void func_228(var uParam0, char* sParam1)//Position - 0xF92A
{
	int iVar0;
...
void func_229()//Position - 0xF9A4
{
	...
	switch (iLocal_2104)
	{
		...
		case 1:
			if (iLocal_383)
			{
				...
				if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1249.106f, -3007.908f, 10.84327f, 1249.962f, -3007.837f, 8.31909f, 1.68f, 0, true, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) && !func_212(0))
				{
					...
					{
						iLocal_444 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, 1249.929f, -3010.267f, 9.590105f, 5.351202f, -1.57369f, 8.12499f, 21.33357f, 1, 2);
						...
						{
							TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_381, iLocal_51, "ig_1_stealth_button", 1000f, -1.5f, 4, 0, 1000f, 2);
						}
						else
						{
							TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_381, iLocal_51, "ig_1_button", 1000f, -1.5f, 4, 0, 1000f, 2);
						}
		...
		case 5:
			...
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_55[0 /*2*/], 0))
			{
				...
				{
					Local_64[6 /*10*/] = PED::CREATE_PED(26, joaat("s_m_m_security_01"), 1229.557f, -3002.882f, 8.31909f, -30.33f, 1, true);
					...
					TASK::CLEAR_SEQUENCE_TASK(&uLocal_379);
					Local_64[7 /*10*/] = PED::CREATE_PED(26, joaat("s_m_m_security_01"), 1229.557f, -3002.882f, 8.31909f, -30.33f, 1, true);
				...
				{
					Local_64[5 /*10*/] = PED::CREATE_PED(26, joaat("s_m_m_dockwork_01"), 1228.929f, -3015.008f, 8.31909f, 0f, 1, true);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_64[5 /*10*/], 1);
					TASK::CLEAR_SEQUENCE_TASK(&uLocal_379);
					TASK::OPEN_SEQUENCE_TASK(&uLocal_379);
					TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2096, 2);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1252.876f, -3014.035f, 8.31909f, 2f, 20000, 1048576000, 0, 1193033728);
					TASK::TASK_PLAY_ANIM(0, iLocal_49, "react_big_variations_g", 1.5f, -1.5f, -1, 0, 0, 0, 0, 0);
					TASK::TASK_PLAY_ANIM(0, iLocal_49, "react_big_variations_i", 1.5f, -1.5f, -1, 0, 0, 0, 0, 0);
				...
				{
					Local_64[4 /*10*/] = PED::CREATE_PED(26, joaat("s_m_m_dockwork_01"), 1229.557f, -3002.882f, 8.31909f, -99f, 1, true);
				}
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_64[4 /*10*/], 1);
				...
				TASK::TASK_PLAY_ANIM(0, iLocal_49, "react_big_variations_f", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
				TASK::TASK_PLAY_ANIM(0, iLocal_49, "react_big_variations_g", 1.5f, -1.5f, -1, 0, 0, 0, 0, 0);
				TASK::TASK_PLAY_ANIM(0, iLocal_49, "react_big_variations_h", 1.5f, -1.5f, -1, 0, 0, 0, 0, 0);
				TASK::TASK_PLAY_ANIM(0, iLocal_49, "react_big_variations_i", 1.5f, -1.5f, -1, 0, 0, 0, 0, 0);
				TASK::TASK_PLAY_ANIM(0, iLocal_49, "react_big_variations_f", 1.5f, -1.5f, -1, 0, 0, 0, 0, 0);
	...
	if (((!iLocal_383 && ENTITY::DOES_ENTITY_EXIST(Local_169[0 /*2*/])) && ENTITY::DOES_ENTITY_EXIST(Local_169[1 /*2*/])) && func_107(Local_55[0 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_HAVE_PHYSICS(Local_169[0 /*2*/]) && ENTITY::DOES_ENTITY_HAVE_PHYSICS(Local_169[1 /*2*/]))
		{
			...
			Local_145[0 /*5*/] = PHYSICS::ADD_ROPE(1260.692f, -3008.286f, 23.73365f, 0f, 0f, 0f, fLocal_2109, 1, fLocal_2109, 0.5f, 0.5f, 0, 0, 0, 10f, 1, 0);
			PHYSICS::ATTACH_ENTITIES_TO_ROPE(Local_145[0 /*5*/], Local_169[0 /*2*/], Local_55[0 /*2*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[0 /*2*/], 0f, 0f, 0f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_55[0 /*2*/], 1.8f, 1.02f, 1.11f), fLocal_2109, 0, 0, 0, 0);
			Local_145[1 /*5*/] = PHYSICS::ADD_ROPE(1260.692f, -3008.286f, 23.73365f, 0f, 0f, 0f, fLocal_2109, 1, fLocal_2109, 0.5f, 0.5f, 0, 0, 0, 10f, 1, 0);
			PHYSICS::ATTACH_ENTITIES_TO_ROPE(Local_145[1 /*5*/], Local_169[0 /*2*/], Local_55[0 /*2*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[0 /*2*/], 0f, 0f, 0f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_55[0 /*2*/], -1.8f, 1.02f, 1.11f), fLocal_2109, 0, 0, 0, 0);
			Local_145[2 /*5*/] = PHYSICS::ADD_ROPE(1260.692f, -3008.286f, 23.73365f, 0f, 0f, 0f, fLocal_2109, 1, fLocal_2109, 0.5f, 0.5f, 0, 0, 0, 10f, 1, 0);
			PHYSICS::ATTACH_ENTITIES_TO_ROPE(Local_145[2 /*5*/], Local_169[1 /*2*/], Local_55[0 /*2*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[1 /*2*/], 0f, 0f, 0f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_55[0 /*2*/], 1.8f, -3.07f, 1.11f), fLocal_2109, 0, 0, 0, 0);
			Local_145[3 /*5*/] = PHYSICS::ADD_ROPE(1260.752f, -3004.994f, 22.68315f, 0f, 0f, 0f, fLocal_2109, 1, fLocal_2109, 0.5f, 0.5f, 0, 0, 0, 10f, 1, 0);
			PHYSICS::ATTACH_ENTITIES_TO_ROPE(Local_145[3 /*5*/], Local_169[1 /*2*/], Local_55[0 /*2*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[1 /*2*/], 0f, 0f, 0f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_55[0 /*2*/], -1.8f, -3.07f, 1.11f), fLocal_2109, 0, 0, 0, 0);
			iLocal_383 = 1;
			iLocal_385 = 0;
			PHYSICS::ACTIVATE_PHYSICS(Local_55[0 /*2*/]);
	...
	{
		if (func_107(Local_64[4 /*10*/]) && ENTITY::IS_ENTITY_PLAYING_ANIM(Local_64[4 /*10*/], iLocal_50, "cellphone_call_listen_c", 3))
		{
			TASK::STOP_ANIM_TASK(Local_64[4 /*10*/], iLocal_50, "cellphone_call_listen_c", -8f);
		}
...
void func_230(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x10AF6
{
	vector3 vVar0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102125.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102125.f_4, 0))
		{
			if (func_260(24) != Global_102125.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_257(ENTITY::GET_ENTITY_COORDS(Global_102125.f_4, true), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
				}
				func_231(Global_102125.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_231(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)//Position - 0x10B71
{
	struct<60> Var0;
...
void func_232(int iParam0, int iParam1, int iParam2)//Position - 0x10C9A
{
	int iVar0;
...
void func_233(int iParam0, int iParam1)//Position - 0x10DB7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_234(int iParam0)//Position - 0x10FB9
{
...
int func_235(int iParam0)//Position - 0x11096
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_236(int iParam0, bool bParam1)//Position - 0x11247
{
	int iVar0;
	struct<2> Var1;
...
int func_237(int iParam0)//Position - 0x113C7
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_239(int iParam0)//Position - 0x114AA
{
	int iVar0;
	int iVar1;
...
int func_240()//Position - 0x13975
{
	return 0;
}

int func_241()//Position - 0x1397E
{
	return 1;
}

int func_242()//Position - 0x13987
{
	return 1;
}

int func_243()//Position - 0x13990
{
...
int func_245(int iParam0)//Position - 0x13A64
{
	int iVar0;
	char* sVar1;
...
int func_246(int iParam0)//Position - 0x13AAA
{
	int iVar0;
...
int func_247(int iParam0)//Position - 0x13AE5
{
	int iVar0;
...
int func_248(int iParam0)//Position - 0x13B61
{
	int iVar0;
...
int func_249(var uParam0, int iParam1)//Position - 0x13C49
{
	int iVar0;
	int iVar1;
...
void func_250(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0x15341
{
	if (func_249(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
...
void func_251(int iParam0, bool bParam1)//Position - 0x15440
{
	if (iParam0 == -1)
	{
		return;
...
void func_252(int iParam0, int iParam1, bool bParam2)//Position - 0x1549D
{
	if (iParam0 == -1)
	{
		return;
...
bool func_253(int iParam0, int iParam1)//Position - 0x154D8
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_254(var uParam0, var uParam1)//Position - 0x154FB
{
...
void func_255(int iParam0)//Position - 0x155C7
{
	if (iParam0 == -1)
	{
		return;
...
void func_256(int iParam0)//Position - 0x15641
{
...
int func_257(vector3 vParam0, int iParam3, var uParam4, var uParam5)//Position - 0x15668
{
	int iVar0;
...
int func_258(vector3 vParam0, int iParam3, int iParam4)//Position - 0x1577E
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_259(int iParam0)//Position - 0x1580D
{
	return MISC::IS_BIT_SET(Global_111560.f_7224[iParam0], 0);
}

int func_260(int iParam0)//Position - 0x15825
{
	if (iParam0 == -1)
	{
		return 0;
...
bool func_261(var uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8)//Position - 0x15841
{
	var uVar0;
	var uVar11;
...
int func_262(var uParam0, var uParam1, int iParam2, bool bParam3)//Position - 0x1589A
{
	int iVar0;
...
void func_263(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16)//Position - 0x15C04
{
...
void func_264(int iParam0)//Position - 0x15C8C
{
	MISC::SET_BIT(&Global_94554, iParam0);
}

int func_265(int iParam0, int iParam1)//Position - 0x15C9E
{
	int iVar0;
...
int func_266(int iParam0)//Position - 0x15CFA
{
	if (iParam0 > 3)
	{
		return 0;
...
int func_267(int iParam0)//Position - 0x15D2B
{
	if (iParam0 == 0)
	{
		return 0;
...
void func_269(char[4] cParam0)//Position - 0x15D82
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 1, true, -1);
}

void func_270()//Position - 0x15D98
{
	int iVar0;
	bool bVar1;
	...
	if (bVar1)
	{
		if (((((!PHYSICS::_0x84DE3B5FB3E666F0(&(Local_145[0 /*5*/])) && !PHYSICS::_0x84DE3B5FB3E666F0(&(Local_145[1 /*5*/]))) && (!Local_145[0 /*5*/].f_4 || !Local_145[1 /*5*/].f_4)) || ((!PHYSICS::_0x84DE3B5FB3E666F0(&(Local_145[2 /*5*/])) && !PHYSICS::_0x84DE3B5FB3E666F0(&(Local_145[3 /*5*/]))) && (!Local_145[2 /*5*/].f_4 || !Local_145[3 /*5*/].f_4))) || iVar0 == 3) && iVar0 < 4)
		{
			...
			{
				AUDIO::PLAY_SOUND_FROM_COORD(iLocal_2113[iLocal_2116], "DOCKS_HEIST_PREP_1_SUB_SWING", 1260.896f, -3006.556f, 23.4213f, 0, 0, 0, 0);
				iLocal_2116++;
			}
		}
		else if (iVar0 <= 2)
...
void func_271(int iParam0)//Position - 0x15F6B
{
	switch (iParam0)
	{
		case 0:
...
void func_272(var uParam0)//Position - 0x160A6
{
	uParam0->f_860.f_2 = 0;
	if (!uParam0->f_860.f_1)
	{
...
void func_273(var uParam0)//Position - 0x160DA
{
	uParam0->f_864.f_2 = 0;
...
int func_274(var uParam0, int iParam1)//Position - 0x1610E
{
	int iVar0;
	int iVar1;
...
int func_275(var uParam0, int iParam1)//Position - 0x161D5
{
	int iVar0;
	int iVar1;
...
int func_276(var uParam0, int iParam1)//Position - 0x1629F
{
	int iVar0;
	int iVar1;
...
int func_277(int iParam0)//Position - 0x16366
{
	return func_39(iParam0, 1, 0);
}

void func_278()//Position - 0x16376
{
	int iVar0;
...
void func_279(int iParam0)//Position - 0x168BC
{
	bool bVar0;
	int iVar1;
...
void func_280(int iParam0, int iParam1)//Position - 0x1692D
{
	int iVar0;
...
void func_281()//Position - 0x16998
{
	switch (iLocal_399)
	{
		case 0:
			if (func_107(Local_64[4 /*10*/]))
			{
				if (iLocal_404)
				{
					TASK::TASK_PLAY_ANIM(Local_64[4 /*10*/], iLocal_50, "cellphone_call_listen_c", 8f, -8f, -1, 49, 0, 0, 0, 0);
		...
		case 1:
			...
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, true, 0))
			{
				if (func_107(Local_64[4 /*10*/]))
				{
					...
					else if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_64[4 /*10*/], true), true) < 12f && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						if (!func_283(Local_64[4 /*10*/], 1464580341, 1))
						{
							TASK::TASK_TURN_PED_TO_FACE_COORD(Local_64[4 /*10*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 4000);
			...
			if (func_107(Local_64[4 /*10*/]))
			{
				if (!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(Local_64[4 /*10*/]))
				{
					if (iLocal_404)
					{
						...
						{
							if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_64[4 /*10*/], iLocal_50, "cellphone_call_listen_c", 3))
							{
								TASK::TASK_PLAY_ANIM(Local_64[4 /*10*/], iLocal_50, "cellphone_call_listen_c", 8f, -8f, -1, 49, 0, 0, 0, 0);
							}
							if (ENTITY::IS_ENTITY_AT_COORD(Local_64[4 /*10*/], 1228.056f, -3000.427f, 8.4424f, 2f, 2f, 2f, 0, true, 0))
							{
								if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("docksprep1"))
								{
				...
				else
				{
					if ((MISC::GET_GAME_TIMER() - iLocal_407) > 10000)
					{
						...
						{
							if (ENTITY::IS_ENTITY_AT_COORD(Local_64[4 /*10*/], 1251.625f, -3003.338f, 8.31909f, 2f, 2f, 2f, 0, true, 0))
							{
								TASK::WAYPOINT_PLAYBACK_PAUSE(Local_64[4 /*10*/], 0, 0);
							}
							else if (ENTITY::IS_ENTITY_AT_COORD(Local_64[4 /*10*/], 1228.849f, -2986.284f, 8.31909f, 2f, 2f, 2f, 0, true, 0))
							{
								TASK::WAYPOINT_PLAYBACK_PAUSE(Local_64[4 /*10*/], 0, 0);
							}
						}
		...
		case 2:
			...
			if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, true, 0) || !func_107(Local_64[4 /*10*/]))
			{
				iLocal_399 = 0;
			}
		...
		case 3:
			switch (iLocal_401)
			{
				...
				case 3:
					if (func_107(Local_64[4 /*10*/]))
					{
						if (ENTITY::IS_ENTITY_AT_COORD(Local_64[4 /*10*/], 1252.558f, -3004.846f, 8.31909f, 2f, 2f, 2f, 0, true, 0))
						{
					...
					if (func_107(Local_64[4 /*10*/]))
					{
						if (!PED::IS_PED_RAGDOLL(Local_64[4 /*10*/]) && !TASK::IS_PED_GETTING_UP(Local_64[4 /*10*/]))
						{
							if (func_12(&uLocal_213, "SOL1AUD", "SOL1_COPSIN2", 7, 0, 0, 0))
							{
								TASK::CLEAR_PED_TASKS(Local_64[4 /*10*/]);
								TASK::OPEN_SEQUENCE_TASK(&uLocal_379);
								TASK::TASK_PLAY_ANIM(0, iLocal_50, "cellphone_call_listen_c", 8f, -8f, -1, 49, 0, 0, 0, 0);
								if (iLocal_405)
								{
...
void func_282(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x17A0A
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_60(iParam3), 0);
}

int func_283(int iParam0, int iParam1, bool bParam2)//Position - 0x17A23
{
	int iVar0;
...
void func_284()//Position - 0x17A69
{
	switch (iLocal_459)
	{
		case 0:
		...
		case 2:
			...
			{
				case 0:
					if ((!HUD::IS_MESSAGE_BEING_DISPLAYED() && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_55[0 /*2*/], 0)) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 324.7653f, -2974.495f, -1f, true) < 110f)
					{
						func_289();
						iLocal_458 = 1;
					}
		...
		case 6:
			...
			{
				case 0:
					if ((((PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && PED::IS_PED_IN_VEHICLE(Local_64[3 /*10*/], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0)) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_55[1 /*2*/], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))) && !HUD::IS_MESSAGE_BEING_DISPLAYED()) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_55[0 /*2*/], true), -323.73f, -2613.702f, 5f, true) < 40f)
					{
						func_289();
						iLocal_458 = 1;
					}
...
bool func_285(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x180A1
{
...
void func_287()//Position - 0x18116
{
	Global_19671 = 0;
	func_33();
}

void func_288(int iParam0)//Position - 0x18126
{
	Global_21816 = iParam0;
}

void func_289()//Position - 0x18133
{
	Global_19671 = 0;
	func_290();
}

void func_290()//Position - 0x18143
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
int func_291(var uParam0)//Position - 0x18167
{
...
void func_292(int iParam0)//Position - 0x181C1
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_293(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x181F9
{
	if (iParam3 == 0)
	{
...
void func_294()//Position - 0x183D0
{
	vector3 vVar0;
	float fVar3;
...
void func_295()//Position - 0x18507
{
	if (!func_107(Local_55[0 /*2*/]))
	{
	...
	{
		Local_169[4 /*2*/] = OBJECT::CREATE_OBJECT(joaat("prop_sub_cover_01"), 297.5948f, -2950.354f, 5.0008f, 1, true, 0);
		ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_169[4 /*2*/], Local_55[1 /*2*/], -1, vLocal_440, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	}
...
void func_296(int iParam0, int iParam1, int iParam2)//Position - 0x186F5
{
...
void func_297(int iParam0)//Position - 0x187B9
{
	if (iParam0 == 1)
	{
...
void func_299()//Position - 0x18806
{
	if (!func_107(Local_55[0 /*2*/]))
	{
...
int func_300(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x18A4E
{
	int iVar0;
...
int func_301(var uParam0, int iParam1)//Position - 0x18ACE
{
	int iVar0;
...
int func_302(int iParam0)//Position - 0x18B14
{
	if (!func_26(iParam0))
	{
		return func_29(iParam0);
...
void func_303()//Position - 0x18B3A
{
...
void func_304()//Position - 0x18BC8
{
	if (!ENTITY::DOES_ENTITY_EXIST(Local_55[0 /*2*/]))
	{
	...
	{
		Local_64[4 /*10*/] = PED::CREATE_PED(26, joaat("s_m_m_dockwork_01"), 1229.322f, -3002.879f, 8.31861f, 270f, 1, true);
		TASK::TASK_PLAY_ANIM(Local_64[4 /*10*/], iLocal_50, "cellphone_call_listen_c", 8f, -8f, -1, 49, 0, 0, 0, 0);
	...
	{
		Local_169[0 /*2*/] = OBJECT::CREATE_OBJECT(joaat("prop_ld_test_01"), 1260.692f, -3008.286f, 23.73365f, 1, true, 0);
		ENTITY::FREEZE_ENTITY_POSITION(Local_169[0 /*2*/], true);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_169[1 /*2*/]))
	{
		Local_169[1 /*2*/] = OBJECT::CREATE_OBJECT(joaat("prop_ld_test_01"), 1260.752f, -3004.994f, 22.68315f, 1, true, 0);
		ENTITY::FREEZE_ENTITY_POSITION(Local_169[1 /*2*/], true);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_169[2 /*2*/]))
	{
		Local_169[2 /*2*/] = OBJECT::CREATE_OBJECT(joaat("prop_sub_release"), 1249.105f, -3007.968f, 9.68718f, 1, true, 0);
		ENTITY::SET_ENTITY_ROTATION(Local_169[2 /*2*/], 0f, 0f, 90f, 2, 1);
		ENTITY::FREEZE_ENTITY_POSITION(Local_169[2 /*2*/], true);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_169[3 /*2*/]))
	{
		Local_169[3 /*2*/] = OBJECT::CREATE_OBJECT(joaat("p_amb_phone_01"), 1229.322f, -3002.879f, 8.31861f, 1, true, 0);
	}
	iLocal_383 = 0;
	TASK::REQUEST_WAYPOINT_RECORDING("docksprep1");
...
void func_305(var uParam0, int iParam1)//Position - 0x18E2E
{
	Global_98669.f_22[iParam1] = uParam0;
}

int func_306(var uParam0)//Position - 0x18E42
{
	if (func_307(uParam0))
	{
		return 1;
...
int func_307(var uParam0)//Position - 0x18E5B
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_308(var uParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0x1982B
{
...
void func_309(int iParam0, var uParam1, var uParam2)//Position - 0x198E3
{
	switch (iParam0)
	{
		case 0:
...
bool func_310()//Position - 0x19982
{
	return MISC::IS_BIT_SET(Global_98669.f_20, 13);
}

void func_311(var uParam0)//Position - 0x19996
{
	int iVar0;
...
void func_312()//Position - 0x19BEE
{
	if (CUTSCENE::IS_CUTSCENE_ACTIVE())
	{
	...
	while (iLocal_382 <= (8 - 1))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(Local_64[iLocal_382 /*10*/]) && !PED::IS_PED_INJURED(Local_64[iLocal_382 /*10*/]))
		{
			...
			{
				PED::SET_PED_COORDS_NO_GANG(Local_64[iLocal_382 /*10*/], ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(Local_64[iLocal_382 /*10*/], 0), true) + Vector(0f, -2f, 0f));
			}
...
void func_313(int iParam0)//Position - 0x19E0E
{
	if (Global_95621 != -1)
	{
...
void func_314(int iParam0)//Position - 0x19E32
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_315(int iParam0)//Position - 0x19E5D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_316(int iParam0)//Position - 0x19EF9
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
int func_317(int iParam0)//Position - 0x19F1A
{
	if (func_316(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_318(int iParam0)//Position - 0x19F44
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_319(int iParam0)//Position - 0x19FE0
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_320(int iParam0)//Position - 0x1A021
{
	bool bVar0;
	struct<8> Var1;
...
void func_321()//Position - 0x1A093
{
	switch (iLocal_2102)
	{
		case 1:
...
void func_322(var uParam0)//Position - 0x1A0FA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_323(var uParam0)//Position - 0x1A25B
{
	int iVar0;
	int iVar1;
...
void func_324(var uParam0)//Position - 0x1A2C8
{
	func_307(uParam0);
}

void func_325()//Position - 0x1A2D7
{
	vector3 vVar0;
	var uVar3;
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_395, 1862763509);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, 1862763509, iLocal_394);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_394, 1862763509);
...
void func_326(int iParam0)//Position - 0x1A6D6
{
	Global_94554 = 0;
	switch (iParam0)
	{
...
void func_327(bool bParam0)//Position - 0x1A764
{
	if (bParam0)
	{
		Global_20861 = 1;
...
void func_328(vector3 vParam0, var uParam3, int iParam4, int iParam5)//Position - 0x1A77C
{
	if (func_298())
	{
...
void func_330()//Position - 0x1A83B
{
	if (CUTSCENE::IS_CUTSCENE_ACTIVE())
	{
		CUTSCENE::STOP_CUTSCENE_IMMEDIATELY();
...
void func_331()//Position - 0x1AA7A
{
	Global_94554 = 0;
}

void func_332(bool bParam0)//Position - 0x1AA87
{
	if (bParam0)
	{
...
void func_333()//Position - 0x1AAB3
{
	int iVar0;
...
void func_335()//Position - 0x1AB62
{
	func_94(787.0854f, -2973.872f, 5.0585f, 256.91f);
}
