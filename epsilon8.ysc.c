...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_945 = PED::ADD_SCENARIO_BLOCKING_AREA(-711.6323f, 42.0868f, 14.5077f, -663.5175f, 118.0403f, 86.0362f, 0, 1, 1, 1);
	iLocal_946 = PED::ADD_SCENARIO_BLOCKING_AREA(-657.5416f, 38.5153f, 38.7892f, -665.8512f, 52.9232f, 42.3853f, 0, 1, 1, 1);
	iLocal_947 = PED::ADD_SCENARIO_BLOCKING_AREA(Vector(45.2982f, -36.1436f, -413.4749f) - Vector(5f, 7f, 7f), Vector(45.2982f, -36.1436f, -413.4749f) + Vector(5f, 7f, 7f), 0, 1, 1, 1);
...
void func_4()//Position - 0x3D9
{
	...
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_616[0], 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_616[1]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_616[1], 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_616[2]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_616[2], 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_616[3]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_616[3], 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_616[4]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_616[4], 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_616[5]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_616[5], 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_616[6]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_616[6], 0);
	}
	...
	if (iLocal_370 == 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			{
				PATHFIND::GET_SAFE_COORD_FOR_PED(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 0, &vLocal_230, 0);
				ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), vLocal_230, 1, 0, 0, 1);
			}
...
bool func_10()//Position - 0x9E4
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

int func_11(int iParam0)//Position - 0x9F6
{
	if (iParam0 == 1)
	{
...
void func_15(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xEAC
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_16(int iParam0)//Position - 0xEFC
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_17(int iParam0)//Position - 0xF27
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_19(int iParam0)//Position - 0xFE4
{
	if (func_18(iParam0))
	{
...
void func_20(int iParam0)//Position - 0x100E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_21(var uParam0, bool bParam1)//Position - 0x104F
{
	if (bParam1)
	{
...
void func_23(char* sParam0, bool bParam1)//Position - 0x1099
{
	func_24(sParam0);
	func_505(bParam1);
}

void func_24(char* sParam0)//Position - 0x10AD
{
...
void func_26(int iParam0)//Position - 0x11F7
{
...
void func_27(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x1217
{
	int iVar0;
	int iVar1;
...
int func_28(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x12E9
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_29(bool bParam0)//Position - 0x18E8
{
	int iVar0;
	int iVar1;
...
void func_30(int iParam0)//Position - 0x1B6A
{
	int iVar0;
...
void func_31(int iParam0)//Position - 0x1BC4
{
	bool bVar0;
	char cVar1[64];
...
char* func_32(int iParam0)//Position - 0x1D52
{
	switch (iParam0)
	{
		case 0:
...
void func_34(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x1E51
{
	int iVar0;
...
int func_35(var uParam0)//Position - 0x1E81
{
	int iVar0;
	int iVar1;
...
int func_36()//Position - 0x1EB5
{
	return Global_1312745;
}

int func_37(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1EC1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_38(int iParam0)//Position - 0x2513
{
	func_61(93, iParam0);
	func_61(29, iParam0);
	func_61(30, iParam0);
...
bool func_39(int iParam0)//Position - 0x2533
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_40(int iParam0, int iParam1, int iParam2)//Position - 0x26E3
{
	int iVar0;
	var uVar1;
...
int func_41(int iParam0, int iParam1, int iParam2)//Position - 0x2715
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_42(int iParam0)//Position - 0x2752
{
	int iVar0;
...
int func_43(int iParam0, int iParam1)//Position - 0x2AEE
{
	int iVar0;
...
int func_44(bool bParam0)//Position - 0x2E67
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_45(int iParam0, int iParam1)//Position - 0x2F1E
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_46(int iParam0, int iParam1)//Position - 0x2F39
{
...
int func_47(var uParam0, int iParam1)//Position - 0x2FD6
{
	int iVar0;
	var uVar1[78];
...
int func_48(var uParam0, int iParam1)//Position - 0x3087
{
	int iVar0;
...
bool func_49(var uParam0, int iParam1)//Position - 0x3102
{
	return (*uParam0)[iParam1] == 78;
}

void func_50(var uParam0)//Position - 0x3113
{
	int iVar0;
...
void func_51(var uParam0, int iParam1)//Position - 0x3147
{
	(*uParam0)[iParam1] = 78;
}

void func_52(var uParam0, float fParam1)//Position - 0x3157
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_53(var uParam0)//Position - 0x3174
{
	return uParam0->f_80;
}

bool func_54(var uParam0, int iParam1)//Position - 0x3180
{
	return func_55(uParam0, iParam1) != -1;
}

int func_55(var uParam0, int iParam1)//Position - 0x3192
{
	int iVar0;
...
bool func_56(var uParam0)//Position - 0x31BF
{
	return uParam0->f_79 == 1;
}

int func_57(int iParam0)//Position - 0x31CD
{
	switch (iParam0)
	{
		case 60:
...
bool func_58(int iParam0)//Position - 0x321D
{
	return Global_41396 == iParam0;
}

int func_59(int iParam0, int iParam1)//Position - 0x322B
{
	int iVar0;
...
void func_60(int iParam0, int iParam1)//Position - 0x327C
{
	int iVar0;
...
void func_61(int iParam0, int iParam1)//Position - 0x329F
{
	int iVar0;
...
int func_63(int iParam0)//Position - 0x3371
{
	return Global_1798[iParam0 /*29*/].f_17;
}

void func_64()//Position - 0x3382
{
	var uVar0;
	vector3 vVar1;
	...
	if (func_18(iLocal_615) && func_18(iLocal_579))
	{
		...
		if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_615, 0f, 0f, (vVar1.z - 200f)), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_615, 500f, 0f, (vVar1.z + 200f)), 1000f, 0, true, 0))
		{
...
bool func_66(int iParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x3C89
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam3), ENTITY::GET_ENTITY_COORDS(iParam1, bParam3)) <= (fParam2 * fParam2);
}

bool func_67(int iParam0)//Position - 0x3CAB
{
	return func_68(PED::GET_VEHICLE_PED_IS_IN(iParam0, 0), PLAYER::PLAYER_PED_ID(), 250, 7);
}

bool func_68(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3CC5
{
	int iVar0;
	var uVar1;
...
int func_69(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x3D65
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_70(int iParam0, int iParam1)//Position - 0x3E91
{
	int iVar0;
...
void func_72(var uParam0)//Position - 0x3FA0
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_73(int iParam0, int iParam1)//Position - 0x3FBB
{
	int iVar0;
...
bool func_74(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x3FFA
{
...
int func_75(char* sParam0, int iParam1, bool bParam2)//Position - 0x404F
{
	Global_20806 = 0;
...
bool func_78(int iParam0)//Position - 0x43BC
{
	return func_79(iParam0, 20);
}

bool func_79(int iParam0, int iParam1)//Position - 0x43CC
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_80()//Position - 0x43E7
{
	return -1;
}

void func_81()//Position - 0x43F0
{
	int iVar0;
...
int func_85()//Position - 0x45F1
{
	func_86();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_86()//Position - 0x460A
{
	int iVar0;
...
bool func_87(int iParam0)//Position - 0x4707
{
	return iParam0 < 3;
}

int func_88(int iParam0)//Position - 0x4713
{
	int iVar0;
	int iVar1;
...
int func_89(int iParam0)//Position - 0x4750
{
	if (func_87(iParam0))
	{
...
var func_90(int iParam0)//Position - 0x4775
{
	return Global_1798[iParam0 /*29*/];
}

void func_91()//Position - 0x4784
{
	int iVar0;
...
bool func_92(int iParam0, int iParam1)//Position - 0x47DB
{
	switch (iParam0)
	{
		case 5:
...
void func_94(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x486D
{
...
int func_95(int iParam0)//Position - 0x48C3
{
	if (func_18(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
bool func_96(char* sParam0, int iParam1, char* sParam2)//Position - 0x48E3
{
...
void func_98(int iParam0, bool bParam1)//Position - 0x498B
{
	int iVar0;
	var uVar1;
...
bool func_100(bool bParam0)//Position - 0x4B0D
{
...
void func_101(int iParam0, int iParam1, int iParam2)//Position - 0x4B38
{
	bool bVar0;
...
int func_103()//Position - 0x50E1
{
	return Global_30736;
}

void func_104()//Position - 0x50EC
{
	func_121();
	func_113();
	func_109();
...
void func_105(int iParam0)//Position - 0x5145
{
	if (iParam0 == 1)
	{
...
void func_107()//Position - 0x518C
{
	StringCopy(&Global_76809, "", 16);
	StringCopy(&Global_76813, "", 16);
}

void func_108()//Position - 0x51A6
{
	int iVar0;
...
void func_112(int iParam0)//Position - 0x5278
{
	if (iParam0 == 1)
	{
		Global_41945 = 1;
...
void func_113()//Position - 0x5291
{
	func_114(&Global_105109);
}

void func_114(var uParam0)//Position - 0x52A1
{
	int iVar0;
	int iVar1;
...
void func_115(var uParam0)//Position - 0x5831
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_116(var uParam0)//Position - 0x584C
{
...
void func_117(var uParam0)//Position - 0x587B
{
	int iVar0;
...
void func_118(var uParam0)//Position - 0x592B
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_119(var uParam0)//Position - 0x5949
{
	int iVar0;
...
void func_120(var uParam0)//Position - 0x5A29
{
	*uParam0 = -15;
}

void func_121()//Position - 0x5A37
{
	StringCopy(&Global_102117, "", 32);
	func_114(&Global_102125);
}

void func_122()//Position - 0x5A50
{
...
int func_124(int iParam0, int iParam1, int iParam2)//Position - 0x5B8E
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	else
	{
		...
		Global_76389[1 /*14*/] = { func_172(iVar0, iParam1, uVar31[iParam1], -1) };
...
int func_125(int iParam0, int iParam1, int iParam2)//Position - 0x5D4D
{
	int iVar0;
...
int func_126(int iParam0)//Position - 0x5DD9
{
	switch (iParam0)
	{
...
int func_127(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x5E14
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76389[1 /*14*/] = { func_172(iVar10, 14, uVar28[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76389[1 /*14*/] = { func_172(iVar10, 14, uVar69[iVar1], -1) };
			func_143(iParam0, Global_76389[1 /*14*/].f_12, Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4);
			func_158(14);
			if (Global_76387 == 1)
			{
...
void func_128(int iParam0, int iParam1, int iParam2)//Position - 0x662A
{
	int iVar0;
	int iVar1;
...
int func_129(int iParam0, int iParam1, int iParam2)//Position - 0x66B4
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_130(int iParam0, int iParam1, int iParam2)//Position - 0x6792
{
	Global_76389[1 /*14*/] = { func_172(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 2);
}

int func_131(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x67BD
{
	var uVar0;
	int iVar10;
...
int func_132(int iParam0, int iParam1, int iParam2)//Position - 0x6DC1
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_133(int iParam0, int iParam1, int iParam2)//Position - 0x6E5A
{
	int iVar0;
	int iVar1;
...
int func_134(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6EFB
{
	int iVar0;
...
int func_135(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x7202
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_136(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x7DB5
{
	int iVar0;
...
int func_137(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x809A
{
	int iVar0;
...
int func_138(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8361
{
	int iVar0;
	int iVar1;
...
int func_139(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8398
{
	int iVar0;
...
int func_140(int iParam0, int iParam1, int iParam2)//Position - 0x83C1
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_141(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x868B
{
	int iVar0;
...
int func_142(int iParam0, int iParam1, int iParam2)//Position - 0x8915
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_143(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8A6C
{
	int iVar0;
...
int func_144(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8B04
{
	switch (iParam0)
	{
...
int func_145(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8BD2
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_146(int iParam0, int iParam1)//Position - 0x8D2E
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_147(int iParam0)//Position - 0x90D5
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_148(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9136
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_149(int iParam0, int iParam1)//Position - 0x9232
{
	int iVar0;
...
int func_150(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9370
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_151(int iParam0)//Position - 0x9450
{
	switch (iParam0)
	{
		case 0:
...
int func_152(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x94D6
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_153(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9753
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_154(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9B78
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_155(int iParam0, int iParam1)//Position - 0x9E6B
{
	int iVar0;
	int iVar1;
...
int func_156(int iParam0, int iParam1)//Position - 0x9EB1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_157(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9F11
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_158(int iParam0)//Position - 0x9F95
{
...
void func_159(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xA04D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_160(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xA097
{
	int iVar0;
...
int func_161(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xBEFE
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_162(int iParam0)//Position - 0xCE1D
{
	if (!MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_163(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCE6E
{
	int iVar0;
...
int func_164(int iParam0)//Position - 0xCF04
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_165(int iParam0, int iParam1)//Position - 0xCFB4
{
	int iVar0;
	struct<10> Var1;
...
void func_166(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD8E3
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_167(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xDA0D
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_168(int iParam0, int iParam1)//Position - 0xDA55
{
	int iVar0;
	struct<17> Var1;
...
void func_169(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xF89D
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_170(int iParam0)//Position - 0xFA87
{
	switch (iParam0)
	{
		case 0:
...
void func_171(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xFB37
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_172(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xFBA8
{
	func_235();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_173(int iParam0, int iParam1)//Position - 0xFBFA
{
	switch (iParam0)
	{
		case 0:
...
void func_174(int iParam0)//Position - 0xFCEA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_175(&(Global_76389[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_175(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x1124F
{
	int iVar0;
	int iVar1;
...
bool func_176(int iParam0, int iParam1, var uParam2)//Position - 0x115E0
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_177(int iParam0, int iParam1)//Position - 0x119E5
{
	switch (iParam1)
	{
		case 0:
...
int func_178(int iParam0, int iParam1)//Position - 0x11DE0
{
	switch (iParam1)
	{
		case 0:
...
int func_179(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x121DB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_180(int iParam0)//Position - 0x1221D
{
	switch (iParam0)
	{
		case -1:
...
void func_181(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x122F1
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_175(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_175(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
void func_182(int iParam0)//Position - 0x125CA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_183(int iParam0)//Position - 0x12721
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_184(int iParam0)//Position - 0x12C2F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_185(int iParam0)//Position - 0x12CA4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_186(int iParam0)//Position - 0x12D18
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_187(int iParam0)//Position - 0x12DFF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_188(int iParam0)//Position - 0x13162
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_189(int iParam0)//Position - 0x13373
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_190(int iParam0)//Position - 0x135A3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_191(int iParam0)//Position - 0x136B3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_192(int iParam0)//Position - 0x14054
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_193(int iParam0)//Position - 0x14BC7
{
	if (iParam0 < 136)
	{
		func_195(iParam0);
...
void func_194(int iParam0)//Position - 0x14BFC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_195(int iParam0)//Position - 0x15800
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_196(int iParam0)//Position - 0x1670E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_197(int iParam0)//Position - 0x1683B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_198(int iParam0, int iParam1)//Position - 0x16939
{
	switch (iParam0)
	{
		case 0:
...
void func_199(int iParam0)//Position - 0x16A29
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_200(int iParam0)//Position - 0x17F1A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_201(int iParam0)//Position - 0x1806D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_202(int iParam0)//Position - 0x18578
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_203(int iParam0)//Position - 0x18BE6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_204(int iParam0)//Position - 0x18C5A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_205(int iParam0)//Position - 0x18D2A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_206(int iParam0)//Position - 0x1925A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_207(int iParam0)//Position - 0x193F1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_208(int iParam0)//Position - 0x19BEF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_209(int iParam0)//Position - 0x19CFF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_210(int iParam0)//Position - 0x1AC2A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_211(int iParam0)//Position - 0x1B8E7
{
	if (iParam0 < 107)
	{
		func_214(iParam0);
...
void func_212(int iParam0)//Position - 0x1B92D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_213(int iParam0)//Position - 0x1C3D3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_214(int iParam0)//Position - 0x1D1C2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_215(int iParam0)//Position - 0x1DE0B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_216(int iParam0)//Position - 0x1E084
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_217(int iParam0, int iParam1)//Position - 0x1E1CA
{
	switch (iParam0)
	{
		case 0:
...
void func_218(int iParam0)//Position - 0x1E2BA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_219(int iParam0)//Position - 0x1F044
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_220(int iParam0)//Position - 0x1F1BE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_221(int iParam0)//Position - 0x1F735
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_222(int iParam0)//Position - 0x1FC5F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_223(int iParam0)//Position - 0x1FCD3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_224(int iParam0)//Position - 0x1FDA3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_225(int iParam0)//Position - 0x2027D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_226(int iParam0)//Position - 0x204E6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_227(int iParam0)//Position - 0x207BC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_228(int iParam0)//Position - 0x20985
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_229(int iParam0)//Position - 0x214D9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_230(int iParam0)//Position - 0x22123
{
	if (iParam0 < 60)
	{
		func_232(iParam0);
...
void func_231(int iParam0)//Position - 0x22158
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_232(int iParam0)//Position - 0x22EF8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_233(int iParam0)//Position - 0x23584
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_234(int iParam0)//Position - 0x2366B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_235()//Position - 0x23769
{
...
int func_236(int iParam0, int iParam1, int iParam2)//Position - 0x237E2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_237(var uParam0, int iParam1)//Position - 0x23A3D
{
...
struct<2> func_239(int iParam0)//Position - 0x23ADD
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_240(int iParam0)//Position - 0x23B14
{
	struct<2> Var0;
...
void func_241(int iParam0, int iParam1)//Position - 0x23F60
{
...
void func_242(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x23FAA
{
...
void func_243(int iParam0, int iParam1, int iParam2)//Position - 0x2404B
{
	struct<4> Var0;
	char* sVar32;
	...
	if (iParam0 != -1)
	{
		...
		func_244(&sVar32, Var0.f_3, Global_98706, iParam1, iParam2);
	}
}

void func_244(char* sParam0, var uParam1, var uParam2, var uParam3, var uParam4)//Position - 0x2408A
{
	...
	STATS::PLAYSTATS_MISSION_OVER(sParam0, uParam1, uParam2, uParam3, uParam4, Global_92876);
	StringCopy(&Global_95769, "", 64);
}

void func_245(int iParam0, var uParam1)//Position - 0x240CE
{
	switch (iParam0)
	{
		case 0:
...
void func_246(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, var uParam22, int iParam23, int iParam24)//Position - 0x25283
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_247(int iParam0)//Position - 0x25314
{
	switch (iParam0)
	{
		case 0:
...
void func_248(int iParam0)//Position - 0x2565A
{
	Global_41947 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_249()//Position - 0x2566C
{
	if (Global_96011)
	{
		func_86();
...
char* func_250(var uParam0)//Position - 0x2569E
{
	uParam0 = uParam0;
	return "";
}

void func_251()//Position - 0x256AD
{
	vector3 vVar0[24];
...
void func_252(int iParam0, int iParam1)//Position - 0x256F0
{
	Global_96006 = iParam0;
	Global_96007 = iParam1;
}

void func_253()//Position - 0x25704
{
	if (Global_76831 != 6)
	{
	}
...
void func_254(var uParam0)//Position - 0x2573C
{
	if (*uParam0 == -1)
	{
		return;
...
void func_255(int iParam0, bool bParam1)//Position - 0x25779
{
	struct<26> Var0;
	int iVar32;
	bool bVar33;
...
int func_256(int iParam0)//Position - 0x258FF
{
	switch (iParam0)
	{
		case 0:
...
void func_257(int iParam0)//Position - 0x25C86
{
	func_259(iParam0, 1);
...
int func_258()//Position - 0x25CBC
{
	return (Global_111560.f_10011.f_21 + Global_111560.f_18569.f_380);
}

void func_259(var uParam0, bool bParam1)//Position - 0x25CD8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_260(int iParam0)//Position - 0x25FFC
{
...
void func_261(int iParam0)//Position - 0x2602F
{
	switch (iParam0)
	{
		case 30:
...
void func_262(int iParam0, bool bParam1)//Position - 0x26064
{
	if (iParam0 == -1)
	{
		return;
...
void func_263(int iParam0, int iParam1, bool bParam2)//Position - 0x260C1
{
	if (iParam0 == -1)
	{
		return;
...
bool func_264(int iParam0, int iParam1)//Position - 0x260FC
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_265(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x2611F
{
	if (iParam0 != 198)
	{
		if (Global_76577)
...
void func_266(int iParam0, int iParam1)//Position - 0x2617A
{
	switch (iParam0)
	{
		case 12:
...
void func_267(int iParam0, bool bParam1)//Position - 0x26263
{
	if (bParam1)
	{
...
bool func_268(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x2628C
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_270()//Position - 0x26C0E
{
	return Global_30737;
}

int func_271(var uParam0, int iParam1)//Position - 0x26C19
{
	int iVar0;
...
int func_272(int iParam0)//Position - 0x2A3B6
{
	switch (iParam0)
	{
		case 46:
...
void func_273(int iParam0, bool bParam1)//Position - 0x2A4A8
{
	switch (iParam0)
	{
		case 46:
...
void func_274(int iParam0, bool bParam1)//Position - 0x2A4F9
{
	int iVar0;
...
void func_275(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x2A55F
{
	func_276(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_276(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2A580
{
	int iVar0;
...
void func_277()//Position - 0x2A753
{
	int iVar0;
...
int func_278(int iParam0)//Position - 0x2A873
{
	int iVar0;
	int iVar1;
...
int func_281(int iParam0)//Position - 0x2AAAD
{
...
void func_282(int iParam0, int iParam1)//Position - 0x2AADA
{
...
int func_283(char* sParam0)//Position - 0x2AB17
{
	int iVar0;
...
int func_284()//Position - 0x2AB77
{
	return func_285(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_285(char* sParam0, int iParam1)//Position - 0x2AB88
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_286(int iParam0)//Position - 0x2ABD1
{
	bool bVar0;
	int iVar1;
...
void func_287()//Position - 0x2AC42
{
	if (func_95(iLocal_578))
	{
		if (func_19(iLocal_615))
		{
			if (PED::IS_PED_IN_VEHICLE(iLocal_578, iLocal_615, 0))
			{
				...
				if (iLocal_333 == 0)
				{
						...
						else if (iLocal_272 == 1)
						{
							if (MISC::GET_GAME_TIMER() > iLocal_290 + 10000)
							{
								if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && func_297(PLAYER::PLAYER_PED_ID(), iLocal_615, 0) < 85f)
								{
									if (iLocal_279 < 25)
									{
										PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(vLocal_209, iLocal_279, &vLocal_221, 1, 1077936128, 0);
							...
							if (iLocal_257 == iLocal_258 + 1 || iLocal_364 == 1)
							{
								...
								if (iLocal_281 > 3)
								{
									if (func_67(iLocal_578))
									{
										...
										if (iLocal_360 == 1)
										{
											TASK::TASK_HELI_MISSION(iLocal_578, iLocal_615, 0, PLAYER::PLAYER_PED_ID(), vLocal_209, 9, 200f, 2f, -1f, iLocal_260 + 10, 50, -1f, 0);
											if (iLocal_262 > 0)
											{
												if (!func_299())
												{
					...
					{
						TASK::TASK_HELI_MISSION(iLocal_578, iLocal_615, 0, 0, (vLocal_209.x + 600f), (vLocal_209.y + 600f), (vLocal_209.z + 100f), 4, 200f, -1f, -1f, -1, 100, -1f, 0);
						ENTITY::SET_ENTITY_COLLISION(iLocal_615, false, 0);
						iLocal_373 = 1;
					}
				}
			}
...
bool func_288(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2B1B1
{
...
bool func_289(int iParam0, vector3 vParam1, float fParam4)//Position - 0x2B1FF
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, true), vParam1) <= (fParam4 * fParam4);
}

void func_290()//Position - 0x2B21C
{
	if (iLocal_336 == 0)
	{
		if (iLocal_333 == 0)
...
int func_291(int iParam0, bool bParam1, int iParam2)//Position - 0x2B3CB
{
	int iVar0;
...
void func_292()//Position - 0x2B400
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_616[iLocal_256], 0))
	{
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_616[iLocal_256], 0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_580[iLocal_256], 0))
			{
				PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_580[iLocal_256], 1, false);
			}
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_588[iLocal_256], 0))
			{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_580[iLocal_256]))
	{
		...
		else if (HUD::DOES_BLIP_EXIST(iLocal_911[iLocal_256]))
		{
			if (iLocal_256 != 0)
			{
				...
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_580[iLocal_256], -361.7977f, -108.5845f, 67.12477f, -347.5992f, -65.6332f, 36.46431f, 174.75f, 0, true, 0))
					{
						PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_580[iLocal_256], 1, false);
				...
				else
				{
					...
					if (iLocal_341[iLocal_256] == 1)
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (!ENTITY::IS_ENTITY_DEAD(iLocal_616[iLocal_256], 0))
							{
								if (PED::IS_PED_IN_VEHICLE(iLocal_580[iLocal_256], iLocal_616[iLocal_256], 0))
								{
								...
								else if (func_95(iLocal_580[iLocal_256]))
								{
									...
									{
										TASK::TASK_ENTER_VEHICLE(iLocal_580[iLocal_256], iLocal_616[iLocal_256], 20000, -1, 1073741824, 1, 0);
									}
								}
							}
						}
	...
	if (iLocal_299 != -1)
	{
		...
		{
			TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_570[iLocal_299], iLocal_632, PLAYER::PLAYER_PED_ID(), 8, 40f, 786468, 100f, 30f, 1);
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_570[iLocal_256]))
	{
		...
		{
			if (!PED::IS_PED_IN_VEHICLE(iLocal_570[iLocal_256], iLocal_632, 0))
			{
				if (HUD::DOES_BLIP_EXIST(iLocal_927[iLocal_256]))
				{
					func_26(&(iLocal_927[iLocal_256]));
						...
						if (!func_66(PLAYER::PLAYER_PED_ID(), iLocal_632, 30f, 1))
						{
							if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_632, 0))
							{
								if (VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_632, -1, 0))
								{
									...
									PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_570[iLocal_299], 1);
...
void func_293(var uParam0, int iParam1)//Position - 0x2BD23
{
...
void func_294()//Position - 0x2BD40
{
	func_26(&iLocal_939);
	func_26(&iLocal_940);
	if (func_95(iLocal_596))
	...
	if (func_95(iLocal_580[iLocal_256]))
	{
		if (!HUD::DOES_BLIP_EXIST(iLocal_911[iLocal_256]))
		{
			if ((PED::IS_PED_IN_COMBAT(iLocal_580[iLocal_256], PLAYER::PLAYER_PED_ID()) || MISC::GET_GAME_TIMER() > iLocal_290 + 20000) || !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -335.8581f, -97.34045f, 62.20868f, -403.0932f, -76.60052f, 25.80415f, 34f, 0, true, 0))
			{
				iLocal_911[iLocal_256] = func_295(iLocal_580[iLocal_256], 1, 0, 5);
				HUD::SET_BLIP_SCALE(iLocal_911[iLocal_256], fLocal_148);
				if (iLocal_256 == 0)
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_616[0], 0))
					{
	...
	if (func_95(iLocal_588[iLocal_256]))
	{
		if (!HUD::DOES_BLIP_EXIST(iLocal_919[iLocal_256]))
		{
			if ((PED::IS_PED_IN_COMBAT(iLocal_588[iLocal_256], PLAYER::PLAYER_PED_ID()) || MISC::GET_GAME_TIMER() > iLocal_290 + 20100) || !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -335.8581f, -97.34045f, 62.20868f, -403.0932f, -76.60052f, 25.80415f, 34f, 0, true, 0))
			{
	...
	if (func_95(iLocal_570[iLocal_256]))
	{
		if (!HUD::DOES_BLIP_EXIST(iLocal_927[iLocal_256]))
		{
			...
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_570[iLocal_256], 0))
				{
	...
	if (iLocal_315 == 0)
	{
		if (MISC::GET_GAME_TIMER() > iLocal_290 + 300)
		{
			if (func_19(iLocal_615))
			{
				...
				VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_615, true, 1, 0);
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_578, 0))
				{
					if (!HUD::DOES_BLIP_EXIST(iLocal_937))
					{
						...
						else
						{
							...
							{
								if (PED::IS_PED_IN_VEHICLE(iLocal_570[5], iLocal_615, 0))
								{
...
int func_295(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x2C23A
{
	int iVar0;
	bool bVar1;
...
int func_296(int iParam0, int iParam1, int iParam2)//Position - 0x2C28C
{
...
float func_297(int iParam0, int iParam1, bool bParam2)//Position - 0x2C2CA
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_298(char* sParam0, int iParam1, int iParam2)//Position - 0x2C328
{
	iParam2 = iParam2;
...
void func_300()//Position - 0x2C363
{
	if (!AUDIO::IS_AUDIO_SCENE_ACTIVE("EPSILONISM_08_COMPLIANCE"))
	{
		if (!AUDIO::IS_AUDIO_SCENE_ACTIVE("EPSILONISM_08_NON_COMPLIANCE"))
		{
			...
			{
				AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_616[0], "EPSILONISM_08_NON_COMPLIANCE_ENEMY_CAR", 0);
			}
			if (func_18(iLocal_616[1]))
			{
				AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_616[1], "EPSILONISM_08_NON_COMPLIANCE_ENEMY_CAR", 0);
			}
			if (func_18(iLocal_616[2]))
			{
				AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_616[2], "EPSILONISM_08_NON_COMPLIANCE_ENEMY_CAR", 0);
			}
			if (func_18(iLocal_616[3]))
			{
				AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_616[3], "EPSILONISM_08_NON_COMPLIANCE_ENEMY_CAR", 0);
			}
			if (func_18(iLocal_616[4]))
			{
				AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_616[4], "EPSILONISM_08_NON_COMPLIANCE_ENEMY_CAR", 0);
			}
			if (func_18(iLocal_616[5]))
			{
				AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_616[5], "EPSILONISM_08_NON_COMPLIANCE_ENEMY_CAR", 0);
			}
			if (func_18(iLocal_616[6]))
			{
				AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_616[6], "EPSILONISM_08_NON_COMPLIANCE_ENEMY_CAR", 0);
			}
			if (func_18(iLocal_615))
			{
...
void func_301()//Position - 0x2C471
{
	if (AUDIO::IS_AUDIO_SCENE_ACTIVE("EPSILONISM_08_COMPLIANCE"))
	{
		AUDIO::STOP_AUDIO_SCENE("EPSILONISM_08_COMPLIANCE");
...
void func_302()//Position - 0x2C48C
{
	func_310();
	func_308();
	func_305();
	...
	if (iLocal_331 == 1)
	{
		if (MISC::GET_GAME_TIMER() > iLocal_292 + 10000 || PED::IS_PED_IN_VEHICLE(iLocal_570[5], iLocal_615, 0))
		{
			iLocal_312 = 1;
		}
	}
...
void func_303()//Position - 0x2C539
{
	var uVar0;
	...
	if ((func_95(iLocal_570[5]) && func_18(iLocal_632)) && func_18(iLocal_615))
	{
		switch (iLocal_387)
		{
			case 0:
				...
				TASK::CLOSE_SEQUENCE_TASK(uVar0);
				TASK::TASK_PERFORM_SEQUENCE(iLocal_570[5], uVar0);
				TASK::CLEAR_SEQUENCE_TASK(&uVar0);
				iLocal_387 = 5;
				break;
			
			case 1:
				if (((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -371.3996f, -88.47154f, 44.65829f, -378.7455f, -85.82195f, 48.21037f, 5.75f, 0, true, 0) && CAM::IS_SPHERE_VISIBLE(-378.46f, -88.44f, 45.66f, 2f)) && !ENTITY::IS_ENTITY_ON_SCREEN(iLocal_632)) && PED::IS_PED_FACING_PED(PLAYER::PLAYER_PED_ID(), iLocal_596, 120f))
				{
					iLocal_309 = PED::CREATE_SYNCHRONIZED_SCENE(-356.91f, -89.03f, 45.875f, 0f, 0f, -120f, 2);
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_570[5], iLocal_309, "rcmepsilonism8", "grab_all_4_bags_carrier", 4f, -2f, 0, 0, 1148846080, 0);
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_632, iLocal_309, "grab_all_4_bags_car", "rcmepsilonism8", 1000f, -1.5f, 0, 1148846080);
					iLocal_387 = 2;
					ENTITY::DETACH_ENTITY(iLocal_597[0], 1, 1);
					ENTITY::DETACH_ENTITY(iLocal_597[1], 1, 1);
					ENTITY::DETACH_ENTITY(iLocal_597[2], 1, 1);
					ENTITY::DETACH_ENTITY(iLocal_597[3], 1, 1);
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_597[0], iLocal_309, "base_bag_1", "rcmepsilonism8", 1000f, -1000f, 0, 1148846080);
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_597[1], iLocal_309, "base_bag_2", "rcmepsilonism8", 1000f, -1000f, 0, 1148846080);
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_597[2], iLocal_309, "base_bag_3", "rcmepsilonism8", 1000f, -1000f, 0, 1148846080);
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_597[3], iLocal_309, "base_bag_4", "rcmepsilonism8", 1000f, -1000f, 0, 1148846080);
			...
			case 2:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_309))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_309) >= 0.126f && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_309) < 0.237f)
					{
						...
						{
							ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_597[0], iLocal_570[5], PED::GET_PED_BONE_INDEX(iLocal_570[5], 28422), 0.25f, 0.075f, -0.3f, 50f, 50f, -135f, 0, 0, 0, 0, 2, 1);
					...
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_309) >= 0.347f && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_309) < 0.455f)
					{
						...
						{
							ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_597[1], iLocal_570[5], PED::GET_PED_BONE_INDEX(iLocal_570[5], 28422), 0.25f, 0.075f, -0.3f, 50f, 50f, -135f, 0, 0, 0, 0, 2, 1);
					...
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_309) >= 0.563f && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_309) < 0.678f)
					{
						...
						{
							ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_597[2], iLocal_570[5], PED::GET_PED_BONE_INDEX(iLocal_570[5], 28422), 0.25f, 0.075f, -0.3f, 50f, 50f, -135f, 0, 0, 0, 0, 2, 1);
					...
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_309) >= 0.789f && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_309) < 0.901f)
					{
						...
						{
							ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_597[3], iLocal_570[5], PED::GET_PED_BONE_INDEX(iLocal_570[5], 28422), 0.25f, 0.075f, -0.3f, 50f, 50f, -135f, 0, 0, 0, 0, 2, 1);
			...
			case 3:
				if ((func_289(iLocal_570[5], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_615, -1.5f, 0f, 0f), 0.5f) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_570[5], 713668775) != 1) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_570[5], 713668775) != 0)
				{
					...
					TASK::TASK_PLAY_ANIM(iLocal_570[5], "rcmepsilonism8", "bag_handler_load_walk_away_left", 8f, -8f, -1, 639044, 0, 0, 0, 0);
					iLocal_387 = 4;
				}
				else if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_570[5], 713668775) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_570[5], 713668775) != 0)
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_570[5], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_615, -1.5f, 0f, 0f), 1f, -1, 0.4f, 0, (ENTITY::GET_ENTITY_HEADING(iLocal_615) - 90f));
				}
				break;
			...
			case 4:
				...
				{
					ENTITY::DETACH_ENTITY(iLocal_597[iLocal_304], 1, 1);
				}
				if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_570[5], "rcmepsilonism8", "bag_handler_load_walk_away_left", 3) || ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_570[5], "rcmepsilonism8", "bag_handler_load_walk_away_left") > 0.8f)
				{
					...
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_570[5], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_632, 0f, -3.2f, 0f), 1f, -1, 0.3f, 0, ENTITY::GET_ENTITY_HEADING(iLocal_632));
						iLocal_387 = 1;
					}
				}
				break;
...
void func_304()//Position - 0x2CD05
{
	if (iLocal_362 == 1)
	{
		if (func_95(iLocal_596))
...
void func_305()//Position - 0x2CD51
{
	float fVar0;
	var uVar1;
	struct<6> Var2;
				...
				if (iLocal_383 == 0)
				{
					if ((ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_596, "rcmepsilonism8", "jump_off_heli", 3) && ENTITY::FIND_ANIM_EVENT_PHASE("rcmepsilonism8", "jump_off_heli", "WalkInterruptible", &fVar0, &uVar1)) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_596, "rcmepsilonism8", "jump_off_heli") >= fVar0)
					{
						if (!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_596))
						{
							...
							TASK::TASK_GO_STRAIGHT_TO_COORD(iLocal_596, -377.228f, -87.0252f, 44.6583f, 1f, 20000, 1193033728, 0.5f);
							iLocal_383 = 1;
...
void func_306()//Position - 0x2D450
{
	Global_19671 = 0;
	func_93();
}

struct<6> func_307()//Position - 0x2D460
{
	struct<6> Var0;
...
void func_308()//Position - 0x2D484
{
	bool bVar0;
		...
		if (func_19(iLocal_616[0]))
		{
			if (PED::IS_PED_SITTING_IN_VEHICLE(iLocal_580[0], iLocal_616[0]))
			{
				if (fLocal_252 != -1f)
				{
					if (bVar0)
					{
						VEHICLE::SET_VEHICLE_BRAKE_LIGHTS(iLocal_616[0], 1);
					}
					else
					{
						VEHICLE::SET_VEHICLE_BRAKE_LIGHTS(iLocal_616[0], 0);
					}
				}
				if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_632, 0))
				{
					...
					else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_580[0], -345.6437f, -85.66679f, 53.65821f, -378.4535f, -73.82299f, 43.15821f, 18.25f, 0, true, 0))
					{
						if (!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_616[0]) || !iLocal_385)
						{
							TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iLocal_580[0], iLocal_616[0], "Eps8LS01", 786599, 0, 8, -1, fLocal_252, 0, 1073741824);
							iLocal_385 = 1;
						}
						else
						{
					...
					{
						TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iLocal_580[0], iLocal_616[0], "Eps8LS01", 786468, 0, 8, -1, fLocal_252, 0, 1073741824);
					}
					else
					{
						func_309();
	...
	VEHICLE::SET_VEHICLE_INDICATOR_LIGHTS(iLocal_616[0], 0, 0);
	VEHICLE::SET_VEHICLE_INDICATOR_LIGHTS(iLocal_616[0], 1, 0);
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_580[0], -673.6242f, 46.50732f, 45.42094f, -657.8456f, 45.62354f, 35.89909f, 7f, 0, true, 0))
	{
		VEHICLE::SET_VEHICLE_INDICATOR_LIGHTS(iLocal_616[0], 0, 1);
	}
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_580[0], -659.3698f, 21.0666f, 45.16937f, -641.9688f, -12.16242f, 35.58978f, 14f, 0, true, 0))
	{
		VEHICLE::SET_VEHICLE_INDICATOR_LIGHTS(iLocal_616[0], 1, 1);
	}
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_580[0], -429.661f, -7.262719f, 52.31787f, -394.0083f, -12.02923f, 41.92323f, 14f, 0, true, 0))
	{
		VEHICLE::SET_VEHICLE_INDICATOR_LIGHTS(iLocal_616[0], 0, 1);
	}
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_580[0], -405.9864f, -54.69353f, 51.0304f, -397.1461f, -36.4476f, 41.66385f, 14f, 0, true, 0))
	{
		VEHICLE::SET_VEHICLE_INDICATOR_LIGHTS(iLocal_616[0], 1, 1);
	}
}

void func_309()//Position - 0x2D891
{
	if (fLocal_252 == -1f)
	{
...
void func_310()//Position - 0x2D8D6
{
	struct<6> Var0;
	struct<6> Var6;
	...
	if (func_19(iLocal_616[0]))
	{
		if (iLocal_339 == 0)
		{
			if (MISC::GET_GAME_TIMER() > iLocal_291 + 5000 || !ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_616[0], -664.4363f, 53.47593f, 31.86062f, -727.7729f, 24.45449f, 46.73167f, 22.5f, 0, true, 0))
			{
				iLocal_339 = 1;
			}
		}
		VEHICLE::_0xBE5C1255A1830FF5(iLocal_616[0], 1);
		if (iLocal_568 == 3 || iLocal_568 == 4)
		{
			if (MISC::GET_GAME_TIMER() > iLocal_294 + 4000)
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_616[0], PLAYER::PLAYER_PED_ID(), 1))
				{
					if (iLocal_275 < 2)
					{
						iLocal_275++;
	...
	{
		VEHICLE::_0xBE5C1255A1830FF5(iLocal_616[2], 1);
	}
	if (func_19(iLocal_616[3]))
	{
		VEHICLE::_0xBE5C1255A1830FF5(iLocal_616[3], 1);
	}
	if (func_95(iLocal_580[0]))
	{
	...
	{
		if ((func_19(iLocal_633) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -383.1558f, -102.7442f, 37.43079f, -371.1183f, -109.4619f, 40.42916f, 13f, 0, true, 0)) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
		{
			if (func_95(iLocal_596))
			{
				if (iLocal_338 == 1)
	...
	if (func_19(iLocal_615))
	{
		if (func_95(iLocal_570[5]))
		{
			if (PED::IS_PED_IN_VEHICLE(iLocal_570[5], iLocal_615, 0))
			{
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_570[5], 1);
				PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_570[5], 3, false);
			}
			else
			{
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_570[5], 0);
	...
	if (func_95(iLocal_580[3]))
	{
		if (func_19(iLocal_616[3]))
		{
			if (func_19(iLocal_632))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(iLocal_580[3], -403.493f, -39.7956f, 45.1741f, 8f, 8f, 8f, 0, true, 0))
				{
					iLocal_363 = 0;
				...
				else
				{
					if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -658.9627f, 46.1624f, 40.1914f, 4f, 4f, 5f, 0, true, 0))
					{
						if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_632, 0))
						{
							if (iLocal_363 == 0)
							{
								TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iLocal_580[3], iLocal_616[3], "Eps8LS01", 786468, 18, 0, -1, 40f, 0, 1073741824);
								iLocal_363 = 1;
							}
						}
					}
					if (iLocal_363 == 1)
					{
						if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_632, 0))
						{
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_580[3], -431.31f, -13.28864f, 44.0877f, -391.9005f, -16.8117f, 49.91203f, 33.75f, 0, true, 0))
							{
								if (!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_616[3]))
								{
									TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iLocal_580[3], iLocal_616[3], "Eps8LS01", 786469, 18, 8, -1, 40f, 0, 1073741824);
								}
							}
							else if (!func_66(PLAYER::PLAYER_PED_ID(), iLocal_580[3], 30f, 1))
							{
								if (!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_616[3]))
								{
									TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iLocal_580[3], iLocal_616[3], "Eps8LS01", 786468, 18, 8, -1, 40f, 0, 1073741824);
								}
							}
	...
	if (func_95(iLocal_570[iLocal_256]))
	{
		...
		else if (iLocal_568 == 7)
		{
			...
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_570[iLocal_256], -381.8959f, -98.08368f, 37.74649f, -378.5122f, -88.64344f, 46.51857f, 2.4f, 0, true, 0))
				{
					iLocal_311 = 1;
				}
			}
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (iLocal_256 == 5)
				{
					if (iLocal_324 == 0)
					{
						...
						{
							AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iLocal_570[5], "EPS8_ANAA", "EPSGUARD2", "SPEECH_PARAMS_FORCE", 0);
							iLocal_324 = 1;
						}
					}
				}
				if (iLocal_256 == 3)
				{
					if (iLocal_325 == 0)
					{
						...
						{
							AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iLocal_570[3], "EPS8_AOAA", "EPSGUARD7", "SPEECH_PARAMS_FORCE", 0);
							TASK::TASK_PLAY_ANIM(iLocal_570[3], "rcmepsilonism8", "security_greet", 2f, -2f, -1, 32, 0.2f, 1, 0, 0);
							iLocal_325 = 1;
						}
					}
				}
				if (iLocal_256 == 4)
				{
					if (iLocal_326 == 0)
					{
						...
						{
							AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iLocal_570[4], "EPS8_APAA", "EPSGUARD8", "SPEECH_PARAMS_FORCE", 0);
							TASK::TASK_PLAY_ANIM(iLocal_570[4], "rcmepsilonism8", "security_greet", 2f, -2f, -1, 32, 0.2f, 1, 0, 0);
							iLocal_326 = 1;
						}
					}
				}
	...
	if (func_95(iLocal_596))
	{
		...
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_596, -381.8959f, -98.08368f, 37.74649f, -378.5122f, -88.64344f, 46.51857f, 2.4f, 0, true, 0))
			{
				iLocal_311 = 1;
			}
		}
	...
	if ((((((((ENTITY::IS_ENTITY_DEAD(iLocal_570[0], 0) || ENTITY::IS_ENTITY_DEAD(iLocal_570[2], 0)) || ENTITY::IS_ENTITY_DEAD(iLocal_570[3], 0)) || ENTITY::IS_ENTITY_DEAD(iLocal_570[4], 0)) || ENTITY::IS_ENTITY_DEAD(iLocal_570[5], 0)) || ENTITY::IS_ENTITY_DEAD(iLocal_578, 0)) || ENTITY::IS_ENTITY_DEAD(iLocal_579, 0)) || PED::IS_PED_BEING_JACKED(iLocal_578)) || PED::IS_PED_BEING_JACKED(iLocal_579))
	{
		iLocal_311 = 1;
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_616[iLocal_256]))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_616[iLocal_256], 0))
		{
			if (((MISC::_IS_PROJECTILE_TYPE_IN_RADIUS(ENTITY::GET_ENTITY_COORDS(iLocal_616[iLocal_256], true), joaat("weapon_grenade"), 4f, 1) || MISC::_IS_PROJECTILE_TYPE_IN_RADIUS(ENTITY::GET_ENTITY_COORDS(iLocal_616[iLocal_256], true), joaat("weapon_molotov"), 4f, 1)) || MISC::_IS_PROJECTILE_TYPE_IN_RADIUS(ENTITY::GET_ENTITY_COORDS(iLocal_616[iLocal_256], true), joaat("weapon_smokegrenade"), 4f, 1)) || MISC::_IS_PROJECTILE_TYPE_IN_RADIUS(ENTITY::GET_ENTITY_COORDS(iLocal_616[iLocal_256], true), joaat("weapon_stickybomb"), 4f, 1))
			{
				iLocal_311 = 1;
			}
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_616[iLocal_256], 0))
...
int func_311(int iParam0, int iParam1)//Position - 0x2E75A
{
	int iVar0;
...
struct<6> func_312()//Position - 0x2E78A
{
	struct<6> Var0;
	int iVar6;
...
void func_313()//Position - 0x2E7D0
{
	struct<6> Var0;
...
void func_314()//Position - 0x2E87A
{
	func_13();
	func_310();
	func_308();
	...
	else if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -351.6279f, -76.40219f, 41.77763f, -361.8925f, -104.8718f, 48.97791f, fLocal_152, 0, true, 0))
	{
		iLocal_311 = 1;
	}
}

void func_315(var uParam0, int iParam1, int iParam2)//Position - 0x2EA1E
{
	char* sVar0;
...
int func_316(char* sParam0)//Position - 0x2EAFB
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_317(int iParam0, int iParam1)//Position - 0x2EB0E
{
	Global_98669.f_22[iParam1] = iParam0;
}

void func_318()//Position - 0x2EB22
{
	func_301();
	VEHICLE::SET_RANDOM_VEHICLE_DENSITY_MULTIPLIER_THIS_FRAME(0f);
	func_310();
	func_308();
	if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_632, vLocal_158, 2f, 2f, 2f, 0, true, 0))
	{
		func_290();
	}
	if (!PED::IS_PED_HEADTRACKING_PED(iLocal_596, PLAYER::PLAYER_PED_ID()))
	...
	if (ENTITY::IS_ENTITY_AT_COORD(iLocal_632, vLocal_158, 2f, 2f, 2f, 0, true, 0) && VEHICLE::IS_VEHICLE_STOPPED(iLocal_632))
	{
		func_26(&iLocal_935);
	...
	else if (ENTITY::IS_ENTITY_AT_COORD(iLocal_632, vLocal_158, 2f, 2f, 2f, 0, true, 0))
	{
		func_26(&iLocal_935);
	...
	{
		iLocal_382 = 0;
		if (ENTITY::IS_ENTITY_AT_COORD(iLocal_632, vLocal_158, 6f, 6f, 2f, 1, true, 0))
		{
		}
	}
}

int func_319(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x2ECE2
{
...
void func_320(int iParam0)//Position - 0x2EE71
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_321(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x2EE9D
{
	func_322(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_322(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x2EEB7
{
	uParam0->f_6 = 0;
	func_323(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_323(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2EED9
{
	int iVar0;
	int iVar1;
...
void func_324(var uParam0)//Position - 0x2F246
{
...
int func_325(var uParam0)//Position - 0x2F2AF
{
	int iVar0;
...
int func_326(bool bParam0)//Position - 0x2F2DA
{
	switch (Global_41396)
	{
		case 0:
...
void func_327(char[4] cParam0, int iParam1)//Position - 0x2F384
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_328(char* sParam0)//Position - 0x2F39B
{
	if (!func_329(1, 1, 0))
	{
...
int func_329(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2F434
{
	int iVar0;
	int iVar1;
...
int func_330(int iParam0)//Position - 0x2F68D
{
	if (iParam0 != func_80())
	{
...
int func_331(int iParam0, bool bParam1, bool bParam2)//Position - 0x2F6F3
{
	int iVar0;
...
int func_332(int iParam0, int iParam1)//Position - 0x2F73D
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
...
int func_333(int iParam0, int iParam1)//Position - 0x2F79F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_334()//Position - 0x2F824
{
	return Global_2448961.f_17;
}

bool func_335(int iParam0)//Position - 0x2F832
{
	return iParam0 == 51;
}

var func_336()//Position - 0x2F83F
{
	return Global_2448961.f_16;
}

bool func_337()//Position - 0x2F84D
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

void func_338(var uParam0, int iParam1, vector3 vParam2, int iParam5)//Position - 0x2F862
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_339()//Position - 0x2F972
{
	return func_340(PLAYER::PLAYER_ID());
}

int func_340(int iParam0)//Position - 0x2F982
{
...
bool func_341(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x2F9A1
{
	if (bParam6)
	{
...
int func_342(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x2F9E8
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_343(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2FD54
{
...
int func_344(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2FDA6
{
	if (!func_329(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_345(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2FDEF
{
	if (!func_329(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_346(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2FE4E
{
	if (!func_329(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_347(int iParam0)//Position - 0x2FEA4
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_348()//Position - 0x2FEFF
{
	MISC::SET_BIT(&Global_7357, 4);
}

void func_349()//Position - 0x2FF0F
{
	if (!iLocal_384)
	{
	...
	if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_632, 0))
	{
		...
		if (PED::IS_PED_IN_VEHICLE(iLocal_580[0], iLocal_616[0], 0))
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_616[0], -384.1292f, -72.76846f, 41.7355f, -381.6261f, -65.75608f, 52.89689f, 8.5f, 0, true, 0))
			{
				if (HUD::DOES_BLIP_EXIST(iLocal_939))
				{
		...
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_632, -384.1292f, -72.76846f, 41.7355f, -381.6261f, -65.75608f, 52.89689f, 8.5f, 0, true, 0))
		{
			func_26(&iLocal_939);
			if (!HUD::DOES_BLIP_EXIST(iLocal_935))
			{
...
void func_350()//Position - 0x300CC
{
	if (func_19(iLocal_632))
	{
		if (func_95(iLocal_580[0]))
...
bool func_351(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x307CF
{
	func_94(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
void func_352()//Position - 0x30823
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if ((((STREAMING::HAS_MODEL_LOADED(joaat("taxi")) && STREAMING::HAS_MODEL_LOADED(joaat("sadler"))) && STREAMING::HAS_MODEL_LOADED(joaat("habanero"))) && STREAMING::HAS_MODEL_LOADED(joaat("schafter2"))) && STREAMING::HAS_MODEL_LOADED(joaat("rumpo")))
	{
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC01"))
		{
			...
			{
				if (!func_289(PLAYER::PLAYER_PED_ID(), vLocal_650[iLocal_910 /*3*/], 50f) && !MISC::IS_POSITION_OCCUPIED(vLocal_650[iLocal_910 /*3*/], 15f, 0, 1, 0, 0, 0, 0, 0))
				{
					if (!CAM::IS_SPHERE_VISIBLE(vLocal_650[iLocal_910 /*3*/], 8f))
					{
						...
						if (!MISC::GET_GROUND_Z_FOR_3D_COORD(vLocal_650[iLocal_910 /*3*/], &fVar2, 0, 0))
						{
							fVar2 = vLocal_650[iLocal_910 /*3*/].f_2;
						}
						if (iLocal_910 > 4 || func_289(PLAYER::PLAYER_PED_ID(), vLocal_158, 150f))
						{
							iLocal_634[iLocal_910] = VEHICLE::CREATE_VEHICLE(iVar0, vLocal_650[iLocal_910 /*3*/], vLocal_650[iLocal_910 /*3*/].f_1, fVar2, fLocal_672[iLocal_910], 1, 1, 0);
							iLocal_642[iLocal_910] = PED::CREATE_RANDOM_PED_AS_DRIVER(iLocal_634[iLocal_910], 1);
							VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_634[iLocal_910], 1084227584);
							TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iLocal_642[iLocal_910], iLocal_634[iLocal_910], "Eps8TRAFFIC01", 262275, 0, 1032, -1, -1082130432, 0, 1073741824);
						}
					}
				}
			}
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC02"))
		{
			...
			{
				if (!func_289(PLAYER::PLAYER_PED_ID(), vLocal_696[iLocal_910 /*3*/], 50f) && !MISC::IS_POSITION_OCCUPIED(vLocal_696[iLocal_910 /*3*/], 15f, 0, 1, 0, 0, 0, 0, 0))
				{
					if (!CAM::IS_SPHERE_VISIBLE(vLocal_696[iLocal_910 /*3*/], 8f))
					{
						...
						if (!MISC::GET_GROUND_Z_FOR_3D_COORD(vLocal_696[iLocal_910 /*3*/], &fVar2, 0, 0))
						{
							fVar2 = vLocal_696[iLocal_910 /*3*/].f_2;
						}
						iLocal_680[iLocal_910] = VEHICLE::CREATE_VEHICLE(iVar0, vLocal_696[iLocal_910 /*3*/], vLocal_696[iLocal_910 /*3*/].f_1, fVar2, fLocal_718[iLocal_910], 1, 1, 0);
						iLocal_688[iLocal_910] = PED::CREATE_RANDOM_PED_AS_DRIVER(iLocal_680[iLocal_910], 1);
						VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_680[iLocal_910], 1084227584);
						TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iLocal_688[iLocal_910], iLocal_680[iLocal_910], "Eps8TRAFFIC02", 262275, 0, 1032, -1, -1082130432, 0, 1073741824);
					}
				}
			}
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC03"))
		{
			...
			{
				if ((!func_289(PLAYER::PLAYER_PED_ID(), vLocal_742[iLocal_910 /*3*/], 50f) && func_289(PLAYER::PLAYER_PED_ID(), vLocal_742[iLocal_910 /*3*/], 220f)) && !MISC::IS_POSITION_OCCUPIED(vLocal_742[iLocal_910 /*3*/], 15f, 0, 1, 0, 0, 0, 0, 0))
				{
					if (!CAM::IS_SPHERE_VISIBLE(vLocal_742[iLocal_910 /*3*/], 8f))
					{
						...
						if (!MISC::GET_GROUND_Z_FOR_3D_COORD(vLocal_742[iLocal_910 /*3*/], &fVar2, 0, 0))
						{
							fVar2 = vLocal_742[iLocal_910 /*3*/].f_2;
						}
						iLocal_726[iLocal_910] = VEHICLE::CREATE_VEHICLE(iVar0, vLocal_742[iLocal_910 /*3*/], vLocal_742[iLocal_910 /*3*/].f_1, fVar2, fLocal_764[iLocal_910], 1, 1, 0);
						iLocal_734[iLocal_910] = PED::CREATE_RANDOM_PED_AS_DRIVER(iLocal_726[iLocal_910], 1);
						VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_726[iLocal_910], 1084227584);
						TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iLocal_734[iLocal_910], iLocal_726[iLocal_910], "Eps8TRAFFIC03", 262275, 0, 1032, -1, -1082130432, 0, 1073741824);
					}
				}
			}
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC04"))
		{
			...
			{
				if (!func_289(PLAYER::PLAYER_PED_ID(), vLocal_788[iLocal_910 /*3*/], 50f) && !MISC::IS_POSITION_OCCUPIED(vLocal_788[iLocal_910 /*3*/], 15f, 0, 1, 0, 0, 0, 0, 0))
				{
					if (!CAM::IS_SPHERE_VISIBLE(vLocal_788[iLocal_910 /*3*/], 8f))
					{
						...
						if (!MISC::GET_GROUND_Z_FOR_3D_COORD(vLocal_788[iLocal_910 /*3*/], &fVar2, 0, 0))
						{
							fVar2 = vLocal_788[iLocal_910 /*3*/].f_2;
						}
						iLocal_772[iLocal_910] = VEHICLE::CREATE_VEHICLE(iVar0, vLocal_788[iLocal_910 /*3*/], vLocal_788[iLocal_910 /*3*/].f_1, fVar2, fLocal_810[iLocal_910], 1, 1, 0);
						iLocal_780[iLocal_910] = PED::CREATE_RANDOM_PED_AS_DRIVER(iLocal_772[iLocal_910], 1);
						VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_772[iLocal_910], 1084227584);
						TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iLocal_780[iLocal_910], iLocal_772[iLocal_910], "Eps8TRAFFIC04", 262275, 0, 1032, -1, -1082130432, 0, 1073741824);
					}
				}
			}
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC05"))
		{
			...
			{
				if ((!func_289(PLAYER::PLAYER_PED_ID(), vLocal_834[iLocal_910 /*3*/], 50f) && func_289(PLAYER::PLAYER_PED_ID(), vLocal_834[iLocal_910 /*3*/], 170f)) && !MISC::IS_POSITION_OCCUPIED(vLocal_834[iLocal_910 /*3*/], 15f, 0, 1, 0, 0, 0, 0, 0))
				{
					if (!CAM::IS_SPHERE_VISIBLE(vLocal_834[iLocal_910 /*3*/], 8f))
					{
						...
						if (!MISC::GET_GROUND_Z_FOR_3D_COORD(vLocal_834[iLocal_910 /*3*/], &fVar2, 0, 0))
						{
							fVar2 = vLocal_834[iLocal_910 /*3*/].f_2;
						}
						iLocal_818[iLocal_910] = VEHICLE::CREATE_VEHICLE(iVar0, vLocal_834[iLocal_910 /*3*/], vLocal_834[iLocal_910 /*3*/].f_1, fVar2, fLocal_856[iLocal_910], 1, 1, 0);
						iLocal_826[iLocal_910] = PED::CREATE_RANDOM_PED_AS_DRIVER(iLocal_818[iLocal_910], 1);
						VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_818[iLocal_910], 1084227584);
						TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iLocal_826[iLocal_910], iLocal_818[iLocal_910], "Eps8TRAFFIC05", 262275, 0, 1032, -1, -1082130432, 0, 1073741824);
					}
				}
			}
		...
		if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC06"))
		{
			...
			{
				if ((!func_289(PLAYER::PLAYER_PED_ID(), vLocal_880[iLocal_910 /*3*/], 50f) && func_289(PLAYER::PLAYER_PED_ID(), vLocal_880[iLocal_910 /*3*/], 170f)) && !MISC::IS_POSITION_OCCUPIED(vLocal_880[iLocal_910 /*3*/], 15f, 0, 1, 0, 0, 0, 0, 0))
				{
					if (!CAM::IS_SPHERE_VISIBLE(vLocal_880[iLocal_910 /*3*/], 8f))
					{
						...
						if (!MISC::GET_GROUND_Z_FOR_3D_COORD(vLocal_880[iLocal_910 /*3*/], &fVar2, 0, 0))
						{
							fVar2 = vLocal_880[iLocal_910 /*3*/].f_2;
						}
						iLocal_864[iLocal_910] = VEHICLE::CREATE_VEHICLE(iVar0, vLocal_880[iLocal_910 /*3*/], vLocal_880[iLocal_910 /*3*/].f_1, fVar2, fLocal_902[iLocal_910], 1, 1, 0);
						iLocal_872[iLocal_910] = PED::CREATE_RANDOM_PED_AS_DRIVER(iLocal_864[iLocal_910], 1);
						VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_864[iLocal_910], 1084227584);
						TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iLocal_872[iLocal_910], iLocal_864[iLocal_910], "Eps8TRAFFIC06", 262275, 0, 1032, -1, -1082130432, 0, 1073741824);
					}
				}
			}
...
void func_353()//Position - 0x31AE3
{
	if (!AUDIO::IS_AUDIO_SCENE_ACTIVE("EPSILONISM_08_COMPLIANCE"))
	{
		if (func_18(iLocal_616[0]))
		{
			AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_616[0], "EPSILONISM_08_COMPLIANCE_CAR_LEADER", 0);
		}
		if (func_18(iLocal_615))
		{
...
void func_354()//Position - 0x31B32
{
	VEHICLE::SET_RANDOM_VEHICLE_DENSITY_MULTIPLIER_THIS_FRAME(0f);
	func_366();
	func_365();
...
void func_355()//Position - 0x31B70
{
	HUD::CLEAR_PRINTS();
	...
	if (func_19(iLocal_616[0]))
	{
		if (func_95(iLocal_580[0]))
		{
			...
			TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(0, iLocal_616[0], "Eps8LS01", 786468, 0, 8, -1, -1f, 0, 1073741824);
			TASK::CLOSE_SEQUENCE_TASK(uLocal_942);
			TASK::CLEAR_PED_TASKS(iLocal_580[0]);
			TASK::TASK_PERFORM_SEQUENCE(iLocal_580[0], uLocal_942);
...
void func_356()//Position - 0x31C45
{
	iLocal_615 = VEHICLE::CREATE_VEHICLE(joaat("maverick"), vLocal_206, fLocal_250, 1, 1, 0);
	...
	ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_578, 1, 0f);
	...
	iLocal_596 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_615, 26, joaat("a_m_y_epsilon_01"), 1, 1, true);
	...
	ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_579, 1, 0f);
	iLocal_570[5] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_615, 26, joaat("s_m_m_highsec_01"), 0, 1, true);
	...
	ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_570[5], 1, 0f);
	PED::SET_PED_CONFIG_FLAG(iLocal_570[5], 324, true);
	iLocal_616[2] = VEHICLE::CREATE_VEHICLE(joaat("sentinel"), vLocal_162[2 /*3*/], fLocal_233[2], 1, 1, 0);
	VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_616[2], 1084227584);
	...
	ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_580[2], 1, 1);
	...
	ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_580[2], 1, 0f);
	PED::SET_PED_CONFIG_FLAG(iLocal_580[2], 324, true);
	iLocal_588[2] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_616[2], 26, joaat("s_m_m_highsec_01"), 0, 1, true);
	...
	ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_588[2], 1, 0f);
	PED::SET_PED_CONFIG_FLAG(iLocal_588[2], 324, true);
	iLocal_616[3] = VEHICLE::CREATE_VEHICLE(joaat("sentinel"), vLocal_162[3 /*3*/], fLocal_233[3], 1, 1, 0);
	VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_616[3], 1084227584);
	...
	ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_580[3], 1, 1);
	...
	ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_580[3], 1, 0f);
	PED::SET_PED_CONFIG_FLAG(iLocal_580[3], 324, true);
	iLocal_588[3] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_616[3], 26, joaat("s_m_m_highsec_01"), 0, 1, true);
	...
	ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_588[3], 1, 0f);
	...
	if (func_95(iLocal_570[0]))
	{
		...
		ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_570[0], 1, 0f);
		PED::SET_PED_CAN_EVASIVE_DIVE(iLocal_570[0], 0);
	...
	if (func_95(iLocal_570[2]))
	{
		...
		ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_570[2], 1, 0f);
		PED::SET_PED_CAN_EVASIVE_DIVE(iLocal_570[2], 0);
	...
	ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_570[3], 1, 0f);
	TASK::TASK_PLAY_ANIM(iLocal_570[3], "rcmepsilonism8", "security_idle", 4f, -4f, -1, 1, 0, 0, 0, 0);
	PED::SET_PED_CAN_EVASIVE_DIVE(iLocal_570[3], 0);
	...
	ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_570[4], 1, 0f);
	TASK::TASK_PLAY_ANIM(iLocal_570[4], "rcmepsilonism8", "security_idle", 4f, -4f, -1, 1, 0, 0, 0, 0);
	PED::SET_PED_CAN_EVASIVE_DIVE(iLocal_570[4], 0);
	...
	if (func_95(iLocal_580[0]))
	{
		...
		ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_580[0], 1, 0f);
	...
	if (func_95(iLocal_588[0]))
	{
		...
		ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_588[0], 1, 0f);
...
void func_357(int iParam0, int iParam1, bool bParam2)//Position - 0x32995
{
	int iVar0;
...
void func_358()//Position - 0x32AC5
{
	char cVar0[64];
	char cVar16[64];
	char* sVar32;
...
struct<4> func_359(int iParam0)//Position - 0x32B40
{
	return Global_1798[iParam0 /*29*/].f_3;
}

int func_360(int iParam0, int iParam1)//Position - 0x32B53
{
...
int func_361(int iParam0, int iParam1)//Position - 0x32B7D
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_362(int iParam0, int iParam1, int iParam2)//Position - 0x32BA7
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_363(int iParam0, int iParam1, int iParam2)//Position - 0x32BEC
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_364(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x32C31
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_365()//Position - 0x32CCC
{
...
void func_366()//Position - 0x32D76
{
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_632))
	{
		iLocal_632 = VEHICLE::CREATE_VEHICLE(joaat("tailgater"), vLocal_212, fLocal_251, 1, 1, 0);
	...
	if (func_19(iLocal_632))
	{
		...
		iLocal_597[0] = OBJECT::CREATE_OBJECT(joaat("p_ld_heist_bag_s_1"), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_632, 0f, 0f, 10f), 1, true, 0);
		iLocal_597[1] = OBJECT::CREATE_OBJECT(joaat("p_ld_heist_bag_s_1"), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_632, 0f, 0f, 11f), 1, true, 0);
		iLocal_597[2] = OBJECT::CREATE_OBJECT(joaat("p_ld_heist_bag_s_1"), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_632, 0f, 0f, 12f), 1, true, 0);
		iLocal_597[3] = OBJECT::CREATE_OBJECT(joaat("p_ld_heist_bag_s_1"), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_632, 0f, 0f, 13f), 1, true, 0);
		ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_597[0], iLocal_632, 0, -0.06f, -1.93f, -0.1f, 0f, 0f, 91f, 0, 0, 0, 0, 2, 1);
		ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_597[1], iLocal_632, 0, 0.2f, -1.92f, -0.1f, 0f, 0f, 93f, 0, 0, 0, 0, 2, 1);
		ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_597[2], iLocal_632, 0, 0.4f, -1.94f, -0.1f, 0f, 0f, 89f, 0, 0, 0, 0, 2, 1);
		ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_597[3], iLocal_632, 0, 0.66f, -1.95f, -0.1f, 0f, 0f, 89f, 0, 0, 0, 0, 2, 1);
...
bool func_367()//Position - 0x32FF0
{
	return MISC::IS_BIT_SET(Global_98669.f_20, 13);
}

void func_368()//Position - 0x33004
{
	var uVar0;
	...
	switch (iLocal_567)
	{
		case 0:
			if (iLocal_308 == 0)
			{
				...
				{
					iLocal_613 = CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 1);
				}
				if (!CAM::DOES_CAM_EXIST(iLocal_614))
				{
					iLocal_614 = CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 1);
				}
			...
			else if (iLocal_308 == 2)
			{
				...
				if (func_439(1, 1093140480, 0))
				{
					...
					SYSTEM::WAIT(0);
					CAM::RENDER_SCRIPT_CAMS(false, false, 3000, 1, 0, 0);
					CAM::DESTROY_CAM(iLocal_613, 0);
					CAM::DESTROY_CAM(iLocal_614, 0);
...
void func_369(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x335BA
{
	int iVar0;
...
void func_370(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x33663
{
	if (bParam0)
	{
...
bool func_371()//Position - 0x3379C
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_372(int iParam0, int iParam1)//Position - 0x337B9
{
	bool bVar0;
...
int func_373(int iParam0, bool bParam1)//Position - 0x33804
{
	int iVar0;
	int iVar1;
...
int func_374(int iParam0)//Position - 0x33845
{
...
bool func_375()//Position - 0x33887
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_376(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x33898
{
	int iVar0;
...
void func_377(int iParam0)//Position - 0x338CB
{
	if (iParam0 == 1)
	{
...
int func_378(int iParam0, int iParam1, int iParam2)//Position - 0x338EE
{
	if (func_63(iParam0) == 3)
	{
		return 0;
...
void func_379(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x33922
{
	int iVar0;
...
void func_380(int iParam0, bool bParam1)//Position - 0x33AE0
{
...
Vector3 func_381(int iParam0)//Position - 0x33B1C
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_382(bool bParam0)//Position - 0x33B2F
{
	int iVar0;
...
void func_383(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x33B6D
{
	vector3 vVar0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102125.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102125.f_4, 0))
		{
			if (func_430(24) != Global_102125.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_427(ENTITY::GET_ENTITY_COORDS(Global_102125.f_4, true), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
				}
				func_384(Global_102125.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_384(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)//Position - 0x33BE8
{
	struct<60> Var0;
...
void func_385(int iParam0, int iParam1, int iParam2)//Position - 0x33D11
{
	int iVar0;
...
void func_386(int iParam0, int iParam1)//Position - 0x33E2E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_387(int iParam0)//Position - 0x34030
{
...
int func_388(int iParam0)//Position - 0x3410D
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_389(int iParam0, bool bParam1)//Position - 0x342BE
{
	int iVar0;
	struct<2> Var1;
...
int func_390(int iParam0)//Position - 0x3443E
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_392(int iParam0)//Position - 0x34529
{
	int iVar0;
	int iVar1;
...
int func_393()//Position - 0x369F4
{
	return 0;
}

int func_394()//Position - 0x369FD
{
	return 1;
}

int func_395()//Position - 0x36A06
{
	return 1;
}

int func_396()//Position - 0x36A0F
{
...
int func_398(int iParam0)//Position - 0x36AE3
{
	int iVar0;
	char* sVar1;
...
int func_399(int iParam0)//Position - 0x36B2A
{
	int iVar0;
...
int func_400(int iParam0)//Position - 0x36B65
{
	int iVar0;
...
int func_401(int iParam0)//Position - 0x36BE1
{
	int iVar0;
...
int func_402(int iParam0, int iParam1, bool bParam2)//Position - 0x36CC9
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_403(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x36D3A
{
...
void func_405(var uParam0, int iParam1)//Position - 0x36E5F
{
	if (iParam1 <= 0)
	{
		return;
...
void func_406(var uParam0, int iParam1)//Position - 0x36EE5
{
...
void func_407(var uParam0, int iParam1)//Position - 0x36F18
{
	int iVar0;
	int iVar1;
...
int func_408(int iParam0, int iParam1)//Position - 0x36F69
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_409(int iParam0)//Position - 0x3700B
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_410(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_410(bool bParam0, int iParam1, int iParam2)//Position - 0x37030
{
	if (bParam0)
	{
		return iParam1;
...
int func_411(var uParam0)//Position - 0x37047
{
	return uParam0 & 15;
}

void func_412(var uParam0, int iParam1)//Position - 0x37054
{
...
void func_413(var uParam0, int iParam1)//Position - 0x3708E
{
...
void func_414(var uParam0, int iParam1)//Position - 0x370C9
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_415(var uParam0, int iParam1)//Position - 0x37105
{
	int iVar0;
	int iVar1;
...
int func_416(int iParam0, int iParam1)//Position - 0x38800
{
	struct<82> Var0;
...
void func_417(int iParam0, var uParam1, int iParam2)//Position - 0x38842
{
	int iVar0;
...
void func_418(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0x38AA3
{
	if (func_415(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
...
void func_419(var uParam0, var uParam1)//Position - 0x38BA2
{
...
void func_420(int iParam0)//Position - 0x38C6E
{
	if (iParam0 == -1)
	{
		return;
...
int func_421(int iParam0)//Position - 0x38CE8
{
	int iVar0;
...
void func_422(int iParam0, var uParam1)//Position - 0x38D4B
{
	int iVar0;
...
int func_423(int iParam0)//Position - 0x38FF8
{
	switch (iParam0)
	{
		case 1:
...
int func_424(int iParam0, var uParam1, var uParam2)//Position - 0x390A8
{
	int iVar0;
	int iVar1;
...
int func_425(int iParam0)//Position - 0x3929B
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_426(int iParam0)//Position - 0x392BB
{
...
int func_427(vector3 vParam0, int iParam3, var uParam4, var uParam5)//Position - 0x392E2
{
	int iVar0;
...
int func_428(vector3 vParam0, int iParam3, int iParam4)//Position - 0x393F8
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_429(int iParam0)//Position - 0x39487
{
	return MISC::IS_BIT_SET(Global_111560.f_7224[iParam0], 0);
}

int func_430(int iParam0)//Position - 0x3949F
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_431(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x394BB
{
	func_432(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_432(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x394E4
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_433(vector3 vParam0)//Position - 0x398D8
{
...
int func_434(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x39902
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_435(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x39BF8
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_436(vector3 vParam0)//Position - 0x39CAC
{
	float fVar0;
	float fVar1;
...
void func_437(int iParam0)//Position - 0x39CEB
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_438()//Position - 0x39D50
{
	int iVar0;
...
int func_439(int iParam0, float fParam1, int iParam2)//Position - 0x39D70
{
	int iVar0;
...
bool func_440()//Position - 0x39E44
{
	bool bVar0;
...
void func_441()//Position - 0x39E67
{
...
int func_442(int iParam0, int iParam1)//Position - 0x39EB8
{
	if (func_95(iParam0))
	{
...
void func_443(char* sParam0, int iParam1, int iParam2)//Position - 0x39EEB
{
	int iVar0;
	struct<14> Var1;
	var uVar15;
...
int func_444(int iParam0)//Position - 0x3A04A
{
...
int func_446(int iParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6)//Position - 0x3A0C6
{
	bool bVar0;
	float fVar1;
...
void func_447(char* sParam0, bool bParam1)//Position - 0x3A122
{
	func_382(bParam1);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_448()//Position - 0x3A138
{
...
void func_449()//Position - 0x3A166
{
	vector3 vVar0;
	vector3 vVar3;
	...
	if (func_19(Local_83.f_35[0]))
	{
		...
		if (((vVar3.x < (vLocal_162[0 /*3*/] - 0.01f) || vVar3.x > (vLocal_162[0 /*3*/] + 0.01f)) || vVar3.y < (vLocal_162[0 /*3*/].f_1 - 0.01f)) || vVar3.y > (vLocal_162[0 /*3*/].f_1 + 0.01f))
		{
			...
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_616[0], 1084227584);
		}
	}
	else
	{
		iLocal_616[0] = VEHICLE::CREATE_VEHICLE(joaat("landstalker"), vLocal_162[0 /*3*/], fLocal_233[0], 1, 1, 0);
	...
	{
		iLocal_588[0] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_616[0], 26, joaat("s_m_m_highsec_01"), 0, 1, true);
	}
...
void func_450()//Position - 0x3A44E
{
...
void func_451()//Position - 0x3A80F
{
...
void func_452(int iParam0, int iParam1, int iParam2)//Position - 0x3A8D8
{
...
void func_453(int iParam0, int iParam1, int iParam2)//Position - 0x3A90C
{
...
void func_454(int iParam0, bool bParam1)//Position - 0x3A9D0
{
	if (CAM::IS_SCREEN_FADED_IN())
	{
...
void func_455(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x3AA02
{
	if (func_490())
	{
...
void func_456()//Position - 0x3AA97
{
	float fVar0;
	var uVar1;
	struct<6> Var2;
		...
		if (!func_299() || !iLocal_353 == 1)
		{
			if (iLocal_311 == 1)
			{
				...
				if (func_95(iLocal_596))
				{
					...
					ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_596, 1, 0f);
				...
				TASK::TASK_CLEAR_LOOK_AT(PLAYER::PLAYER_PED_ID());
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_570[5], 0))
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_597[0], 0))
					{
						if (ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_597[0], iLocal_570[5]))
						{
							ENTITY::DETACH_ENTITY(iLocal_597[0], 1, 1);
					...
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_597[1], 0))
					{
						if (ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_597[1], iLocal_570[5]))
						{
							ENTITY::DETACH_ENTITY(iLocal_597[1], 1, 1);
					...
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_597[2], 0))
					{
						if (ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_597[2], iLocal_570[5]))
						{
							ENTITY::DETACH_ENTITY(iLocal_597[2], 1, 1);
					...
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_597[3], 0))
					{
						if (ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_597[3], iLocal_570[5]))
						{
							ENTITY::DETACH_ENTITY(iLocal_597[3], 1, 1);
...
void func_457()//Position - 0x3B039
{
	if (func_19(iLocal_616[0]))
	{
		AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_616[0], "EPSILONISM_08_CLOSE_CAR_MG", 0);
	}
	if (func_19(iLocal_616[1]))
	{
		AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_616[1], "EPSILONISM_08_CLOSE_CAR_MG", 0);
	}
	if (func_19(iLocal_616[2]))
	{
		AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_616[2], "EPSILONISM_08_CLOSE_CAR_MG", 0);
	}
	if (func_19(iLocal_616[3]))
	{
		AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_616[3], "EPSILONISM_08_CLOSE_CAR_MG", 0);
	}
	if (func_19(iLocal_616[4]))
	{
		AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_616[4], "EPSILONISM_08_CLOSE_CAR_MG", 0);
	}
	if (func_19(iLocal_616[5]))
	{
		AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_616[5], "EPSILONISM_08_CLOSE_CAR_MG", 0);
	}
	if (func_19(iLocal_616[6]))
	{
		AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_616[6], "EPSILONISM_08_CLOSE_CAR_MG", 0);
	}
}

void func_458()//Position - 0x3B10C
{
	Global_19671 = 0;
	func_459();
}

void func_459()//Position - 0x3B11C
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_460()//Position - 0x3B13D
{
	var uVar0;
...
void func_461()//Position - 0x3B230
{
	if (iLocal_336 == 0)
	{
		if (iLocal_333 == 0)
				...
				else
				{
					...
					if (iLocal_568 != 7)
					{
						if (iLocal_329 == 0)
						{
							...
							{
								if ((iLocal_299 != -1 && func_95(iLocal_570[iLocal_299])) && PED::IS_PED_IN_VEHICLE(iLocal_570[iLocal_299], iLocal_632, 0))
								{
...
void func_462(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x3B4E1
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_76831 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_464(Global_76832, Global_76834, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
float func_463(char* sParam0)//Position - 0x3B7C6
{
	HUD::_BEGIN_TEXT_COMMAND_GET_WIDTH(sParam0);
	return HUD::_END_TEXT_COMMAND_GET_WIDTH(1);
}

struct<2> func_464(int iParam0, int iParam1, int iParam2)//Position - 0x3B7D9
{
	struct<2> Var0;
	int iVar2;
...
char* func_465(int iParam0)//Position - 0x3B8AF
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_466(int iParam0)//Position - 0x3BA17
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_467(int iParam0)//Position - 0x3BA4B
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_468(int iParam0)//Position - 0x3BA7F
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_469(int iParam0)//Position - 0x3BAB3
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_470(int iParam0)//Position - 0x3BAE7
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_471(int iParam0)//Position - 0x3BB25
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_472(int iParam0)//Position - 0x3BB59
{
	struct<2> Var0;
...
int func_473(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x3BBC6
{
...
bool func_474(bool bParam0)//Position - 0x3BCDF
{
	if (bParam0)
	{
...
int func_475(int iParam0)//Position - 0x3BD08
{
	if (Global_41396 == 15)
	{
		return 0;
...
bool func_476(int iParam0)//Position - 0x3BD2A
{
	return func_477(iParam0, Global_41396);
}

int func_477(int iParam0, int iParam1)//Position - 0x3BD3B
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_478(bool bParam0)//Position - 0x3BF1C
{
	int iVar0;
...
void func_479(int iParam0, bool bParam1)//Position - 0x3BF3F
{
	if (bParam1)
	{
...
void func_480(int iParam0, int iParam1, bool bParam2)//Position - 0x3BF76
{
	int iVar0;
...
int func_481(int iParam0)//Position - 0x3BFE8
{
	switch (iParam0)
	{
		case 0:
...
void func_482(int iParam0, int iParam1, bool bParam2)//Position - 0x3C329
{
	int iVar0;
...
int func_483(int iParam0, int iParam1, bool bParam2)//Position - 0x3C39B
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_484(var uParam0, bool bParam1, bool bParam2)//Position - 0x3C405
{
	int iVar0;
...
void func_487(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0x3C9D9
{
	func_20(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, vParam2, fParam5, 0, false);
}

void func_488(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0x3C9FA
{
	func_17(iParam0);
...
int func_489(int iParam0)//Position - 0x3CA3C
{
	int iVar0;
...
void func_491()//Position - 0x3CA91
{
	func_438();
	if (func_504())
	{
	...
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_616[0], 0);
		VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(iLocal_616[0], 1);
	}
	if (func_19(iLocal_616[1]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_616[1], 0);
		VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(iLocal_616[1], 1);
	}
	if (func_19(iLocal_616[2]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_616[2], 0);
		VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(iLocal_616[2], 1);
	}
	if (func_19(iLocal_616[3]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_616[3], 0);
		VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(iLocal_616[3], 1);
	}
	if (func_19(iLocal_616[4]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_616[4], 0);
		VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(iLocal_616[4], 1);
	}
	if (func_19(iLocal_616[5]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_616[5], 0);
		VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(iLocal_616[5], 1);
	}
	if (func_19(iLocal_616[6]))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_616[6], 0);
		VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(iLocal_616[6], 1);
	}
	...
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_945, 0);
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_946, 0);
...
int func_492(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x3CF2B
{
	struct<15> Var0;
	int iVar15;
...
void func_493(int iParam0)//Position - 0x3D0AB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_494(int iParam0)//Position - 0x3D16F
{
	switch (iParam0)
	{
		case 0:
...
void func_495()//Position - 0x3D1D9
{
	if (AUDIO::IS_AUDIO_SCENE_ACTIVE("EPSILONISM_08_NON_COMPLIANCE"))
	{
...
void func_496(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x3D1F4
{
...
void func_497(var uParam0, bool bParam1)//Position - 0x3D214
{
	func_498(&(uParam0->f_41), bParam1);
}

void func_498(var uParam0, bool bParam1)//Position - 0x3D226
{
	int iVar0;
...
void func_499(int iParam0, bool bParam1)//Position - 0x3D264
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_500(var uParam0, bool bParam1)//Position - 0x3D29F
{
	func_501(&(uParam0->f_35), bParam1);
}

void func_501(var uParam0, bool bParam1)//Position - 0x3D2B1
{
	int iVar0;
...
void func_502(var uParam0, int iParam1)//Position - 0x3D2EE
{
	func_503(&(uParam0->f_28), iParam1);
}

void func_503(var uParam0, int iParam1)//Position - 0x3D300
{
	int iVar0;
...
void func_505(bool bParam0)//Position - 0x3D3E2
{
	int iVar0;
...
void func_506(char* sParam0, int iParam1)//Position - 0x3D4B2
{
	if (Global_98669 != 12)
	{
...
int func_507(char* sParam0, int iParam1, int iParam2)//Position - 0x3D4DA
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_508(char* sParam0)//Position - 0x3D66C
{
...
int func_510(char* sParam0, bool bParam1)//Position - 0x3D6EA
{
	int iVar0;
	int iVar1;
...
int func_511(int iParam0, bool bParam1)//Position - 0x3D714
{
	int iVar0;
...
void func_514(bool bParam0)//Position - 0x3D806
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_515(int iParam0)//Position - 0x3D81A
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_516(int iParam0)//Position - 0x3D857
{
	if (iParam0 == 1)
	{
...
void func_517()//Position - 0x3D894
{
	Global_22211.f_5 = 1;
}

void func_518()//Position - 0x3D8A2
{
	Global_22211.f_5 = 0;
}

void func_519()//Position - 0x3D8B0
{
	Global_92875 = 0;
	Global_92876 = 0;
}

int func_520()//Position - 0x3D8C2
{
...
void func_521()//Position - 0x3D900
{
	Global_98704 = 1;
...
void func_522(int iParam0)//Position - 0x3D9F3
{
...
void func_523(var uParam0)//Position - 0x3DA05
{
...
void func_524(var uParam0)//Position - 0x3DA25
{
	int iVar0;
...
int func_525(int iParam0)//Position - 0x3DA5F
{
	if (!func_87(iParam0))
	{
		return func_90(iParam0);
