...
int func_12(int iParam0, int iParam1, int iParam2)//Position - 0x4D3
{
...
int func_15(int iParam0)//Position - 0x580
{
	if (iParam0 == 1)
	{
...
void func_16(int iParam0)//Position - 0x5DA
{
	func_109();
	if (iLocal_40 == 0)
	{
...
void func_21(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)//Position - 0x9FC
{
	struct<60> Var0;
...
void func_22(int iParam0, int iParam1, int iParam2)//Position - 0xB25
{
	int iVar0;
...
void func_23(int iParam0, int iParam1)//Position - 0xC42
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_24(int iParam0)//Position - 0xE44
{
...
int func_25(int iParam0)//Position - 0xF21
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_26(int iParam0, bool bParam1)//Position - 0x10D2
{
	int iVar0;
	struct<2> Var1;
...
int func_27(int iParam0)//Position - 0x1252
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_29(int iParam0)//Position - 0x132F
{
	int iVar0;
	int iVar1;
...
int func_30()//Position - 0x37FA
{
	return 0;
}

int func_31()//Position - 0x3803
{
	return 1;
}

int func_32()//Position - 0x380C
{
	return 1;
}

int func_33()//Position - 0x3815
{
...
int func_35(int iParam0)//Position - 0x38E9
{
	int iVar0;
	char* sVar1;
...
int func_36(int iParam0)//Position - 0x392F
{
	int iVar0;
...
int func_37(int iParam0)//Position - 0x396A
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x39E6
{
	int iVar0;
...
int func_39(int iParam0, int iParam1, bool bParam2)//Position - 0x3ACE
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_40(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x3B3F
{
...
void func_42(var uParam0, int iParam1)//Position - 0x3C5C
{
	if (iParam1 <= 0)
	{
		return;
...
void func_43(var uParam0, int iParam1)//Position - 0x3CE2
{
...
void func_44(var uParam0, int iParam1)//Position - 0x3D15
{
	int iVar0;
	int iVar1;
...
int func_45(int iParam0, int iParam1)//Position - 0x3D66
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_46(int iParam0)//Position - 0x3E08
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_47(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_47(bool bParam0, int iParam1, int iParam2)//Position - 0x3E2D
{
	if (bParam0)
	{
		return iParam1;
...
int func_48(var uParam0)//Position - 0x3E44
{
	return uParam0 & 15;
}

void func_49(var uParam0, int iParam1)//Position - 0x3E51
{
...
void func_50(var uParam0, int iParam1)//Position - 0x3E8B
{
...
void func_51(var uParam0, int iParam1)//Position - 0x3EC6
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_52(var uParam0, int iParam1)//Position - 0x3F02
{
	int iVar0;
	int iVar1;
...
int func_133()//Position - 0x7F9C
{
	return Global_76839;
}

void func_134()//Position - 0x7FA8
{
...
void func_136()//Position - 0x8054
{
	func_17();
	func_109();
}

void func_137()//Position - 0x8064
{
	func_151();
	func_147();
	func_144();
	func_109();
	if (func_76(PLAYER::PLAYER_PED_ID(), vLocal_106, 150f) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -176.9431f, -651.257f, 31.2136f, -150.9563f, -579.7476f, 35.4245f, 50f, 0, true, 0))
	{
		MISC::CLEAR_AREA_OF_VEHICLES(vLocal_106, 6f, 0, 1, 0, 0, false, 0);
...
void func_138(var uParam0)//Position - 0x8232
{
	if (*uParam0 == -1)
	{
		return;
...
int func_140(int iParam0)//Position - 0x82D2
{
...
bool func_141(char* sParam0, int iParam1, char* sParam2)//Position - 0x8302
{
...
void func_142(int iParam0)//Position - 0x8320
{
...
void func_143(char* sParam0, int iParam1, int iParam2)//Position - 0x8340
{
	iParam2 = iParam2;
...
int func_145(vector3 vParam0, bool bParam3)//Position - 0x83D1
{
	int iVar0;
...
float func_146(bool bParam0, float fParam1, float fParam2)//Position - 0x83FD
{
	if (bParam0)
	{
		return fParam1;
		...
		if (iLocal_38 == 0)
		{
			if (!MISC::IS_BIT_SET(iLocal_105, 1))
			{
				if (func_85(iLocal_109))
				{
					...
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_109, -168.8162f, -619.9002f, 31.42446f, -162.6423f, -622.0781f, 33.42446f, 4.14f, 0, true, 0))
					{
						func_150(24, 46);
...
int func_148(float fParam0, int iParam1)//Position - 0x84D6
{
	int iVar0;
...
int func_149(int iParam0)//Position - 0x855A
{
	vector3 vVar0;
...
void func_150(int iParam0, int iParam1)//Position - 0x860F
{
	func_4(iParam0);
...
int func_152(int iParam0)//Position - 0x893A
{
...
void func_153(int iParam0)//Position - 0x896B
{
	if (func_157())
	{
		return;
...
void func_155(bool bParam0, bool bParam1)//Position - 0x8A1C
{
	if (bParam0)
	{
		if (func_15(0))
...
bool func_156()//Position - 0x8A90
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

bool func_157()//Position - 0x8AA1
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

void func_158()//Position - 0x8AB3
{
	MISC::CLEAR_BIT(&iLocal_105, 0);
	MISC::CLEAR_BIT(&iLocal_105, 8);
	MISC::CLEAR_BIT(&iLocal_105, 7);
...
int func_159(int iParam0)//Position - 0x8AD1
{
...
int func_161(int iParam0)//Position - 0x8B59
{
...
int func_162(int iParam0)//Position - 0x8B83
{
	int iVar0;
...
int func_163(int iParam0)//Position - 0x8BA4
{
...
int func_164(int iParam0)//Position - 0x8BD1
{
	int iVar0;
...
int func_165(int iParam0)//Position - 0x8C25
{
	int iVar0;
...
int func_166(int iParam0)//Position - 0x8C6A
{
	int iVar0;
...
int func_168(int iParam0)//Position - 0x8D2C
{
	if (DECORATOR::DECOR_EXIST_ON(iParam0, "GetawayVehicleValid"))
	{
		return 1;
...
int func_171(var uParam0)//Position - 0x8DB7
{
	char* sVar0;
...
void func_173(int iParam0, vector3 vParam1)//Position - 0x8E34
{
	int iVar0;
...
bool func_174(var uParam0, var uParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x8E83
{
...
int func_175(char* sParam0, int iParam1, bool bParam2)//Position - 0x8EE2
{
	Global_20806 = 0;
...
bool func_178(int iParam0)//Position - 0x924F
{
	return func_179(iParam0, 20);
}

bool func_179(int iParam0, int iParam1)//Position - 0x925F
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_180()//Position - 0x927A
{
	return -1;
}

void func_181()//Position - 0x9283
{
	int iVar0;
...
bool func_186(int iParam0, int iParam1)//Position - 0x94D9
{
	switch (iParam0)
	{
		case 5:
...
void func_188(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x956B
{
...
void func_190(int iParam0, var uParam1)//Position - 0x95DB
{
	int iVar0;
...
void func_191(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x9751
{
...
void func_192(int iParam0, int iParam1, bool bParam2)//Position - 0x97EC
{
	int iVar0;
...
struct<4> func_194(int iParam0)//Position - 0x9995
{
	return Global_1798[iParam0 /*29*/].f_3;
}

int func_195(int iParam0, int iParam1)//Position - 0x99A8
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
int func_196(int iParam0, int iParam1)//Position - 0x99D2
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
char* func_199(int iParam0)//Position - 0xB2AA
{
	char* sVar0;
...
int func_200(var uParam0)//Position - 0xB3B7
{
...
int func_201(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB409
{
	int iVar0;
...
void func_202(var uParam0, int iParam1)//Position - 0xB540
{
	int iVar0;
...
bool func_203(int iParam0)//Position - 0xB58F
{
	return func_204(iParam0, Global_41396);
}

int func_204(int iParam0, int iParam1)//Position - 0xB5A0
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_205(int iParam0)//Position - 0xB781
{
	if (Global_41396 == 15)
	{
		return 0;
...
int func_207(int iParam0)//Position - 0xB7CC
{
	if (Global_21920 == 0)
	{
		return 0;
...
void func_209()//Position - 0xB84B
{
	int iVar0;
	int iVar1;
	
	if (((((((Global_41396 == 15 && iLocal_37 != 3) && MISC::IS_BIT_SET(iLocal_105, 5)) && !func_169()) && Global_76574 == -1) && !func_219()) && !func_84(9)) || func_103(35))
	{
		func_218();
		func_217();
		switch (iLocal_39)
...
bool func_210()//Position - 0xB9DC
{
	return SCRIPT::IS_THREAD_ACTIVE(Global_111560.f_18098.f_395);
}

void func_211(int iParam0, bool bParam1)//Position - 0xB9F2
{
	switch (iLocal_39)
	{
		case 1:
...
void func_212(char[4] cParam0, int iParam1)//Position - 0xBB02
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_213()//Position - 0xBB19
{
...
int func_214(int iParam0)//Position - 0xBB33
{
	int iVar0;
...
int func_215(int iParam0)//Position - 0xBB7D
{
	int iVar0;
...
void func_216(int iParam0, int iParam1)//Position - 0xBC34
{
	int iVar0;
...
int func_228(float fParam0)//Position - 0xC1CD
{
	if (iLocal_42 == 1)
	{
...
int func_231(int iParam0)//Position - 0xC2D9
{
	return func_232(iParam0, 6, 1);
}

int func_232(int iParam0, int iParam1, bool bParam2)//Position - 0xC2E9
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_233(int iParam0, int iParam1, int iParam2)//Position - 0xC353
{
	int iVar0;
	var uVar1;
...
int func_234(var uParam0)//Position - 0xC385
{
	int iVar0;
	int iVar1;
...
int func_235(int iParam0)//Position - 0xC3B9
{
	switch (iParam0)
	{
		case 0:
...
int func_236(int iParam0)//Position - 0xC6E9
{
	if (func_86(iParam0))
	{
...
void func_237(char* sParam0, int iParam1)//Position - 0xC709
{
	int iVar0;
	int iVar1;
...
void func_239(int iParam0)//Position - 0xC8D6
{
...
void func_240(int iParam0, int iParam1)//Position - 0xC96E
{
...
int func_241(int iParam0)//Position - 0xCA7E
{
...
void func_242(int iParam0)//Position - 0xCAAA
{
	iLocal_42 = iParam0;
	if (iLocal_42 == 0)
	{
...
char* func_244(int iParam0)//Position - 0xCD4D
{
	char* sVar0;
...
struct<8> func_246(char* sParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0xE24D
{
	struct<8> Var0;
...
void func_247(int iParam0, bool bParam1)//Position - 0xE278
{
	if (func_85(iLocal_109))
	{
		func_20(&iLocal_109);
...
int func_248(int iParam0)//Position - 0xE2A0
{
	int iVar0;
	int iVar1;
...
void func_250(bool bParam0)//Position - 0xE320
{
	char* sVar0;
...
void func_251()//Position - 0xE3ED
{
	StringCopy(&(Global_7194[3 /*16*/].f_8), "CELL_SFUN_NULL", 32);
}

void func_252()//Position - 0xE403
{
	StringCopy(&(Global_7194[2 /*16*/].f_8), "CELL_SFUN_NULL", 32);
}

void func_253()//Position - 0xE419
{
	StringCopy(&(Global_7194[1 /*16*/].f_8), "CELL_SFUN_NULL", 32);
}

void func_254()//Position - 0xE42F
{
	StringCopy(&(Global_7194[0 /*16*/].f_8), "CELL_SFUN_NULL", 32);
}

void func_255(char* sParam0)//Position - 0xE445
{
	StringCopy(&(Global_7194[0 /*16*/].f_8), sParam0, 32);
}

void func_256(char* sParam0)//Position - 0xE459
{
	StringCopy(&(Global_7194[2 /*16*/].f_8), sParam0, 32);
}

void func_257(char* sParam0)//Position - 0xE46D
{
	StringCopy(&(Global_7194[1 /*16*/].f_8), sParam0, 32);
}

void func_258(char* sParam0)//Position - 0xE481
{
	StringCopy(&(Global_7194[3 /*16*/].f_8), sParam0, 32);
}

void func_259(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0xE495
{
	func_260(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_260(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0xE4B5
{
	int iVar0;
...
int func_261(var uParam0, int iParam1)//Position - 0xE687
{
	if (iParam1 == -1)
	{
		return 0;
...
float func_262(int iParam0)//Position - 0xE6D2
{
	if (iParam0 == -1)
	{
		return 0f;
...
Vector3 func_263(int iParam0)//Position - 0xE708
{
	if (iParam0 == -1)
	{
		return 0f, 0f, 0f;
...
int func_264(int iParam0)//Position - 0xE742
{
	int iVar0;
	int iVar1;
