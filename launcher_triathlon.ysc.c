				...
				case 3:
					...
					else
					{
						...
						if (!func_100(3) && !Global_98703)
						{
							...
							{
								if ((!func_118(uLocal_94, 1) || !ENTITY::DOES_ENTITY_EXIST(func_99())) && !Global_98703)
								{
									func_111(10);
									break;
								}
				...
				case 6:
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_52))
					{
						...
						if (iLocal_99 != -1)
						{
							if (func_118(Global_110211, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_39(iLocal_99), 0, Global_98706, 0);
								func_28(func_39(iLocal_99), 0, Global_98706, 1, 0);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_39(iLocal_99), 0, Global_98706, 0);
								func_28(func_39(iLocal_99), 0, Global_98706, 0, 0);
							}
						}
						func_4();
						func_122(&Global_110211, 0);
...
void func_4()//Position - 0xB0D
{
	...
	{
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_129, true, 1);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_127))
	{
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_127, true, 1);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_128))
	{
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_128, true, 1);
	}
	iLocal_130 = PED::ADD_SCENARIO_BLOCKING_AREA((vLocal_121.x - 3f), (vLocal_121.y - 3f), (vLocal_121.z - 3f), (vLocal_121.x + 3f), (vLocal_121.y + 3f), (vLocal_121.z + 3f), 0, 1, 1, 1);
	func_7();
	func_5();
}
...
void func_7()//Position - 0xBF1
{
	if (func_118(Global_111560.f_20006.f_9, 1))
	{
		...
		if (iLocal_135 == Global_111560.f_20006.f_8)
		{
			if (Global_111560.f_20006.f_8 != 2)
			{
				...
				if (iLocal_132 && Global_111560.f_20006.f_8 == 2)
				{
					func_19(62);
				}
				else
...
void func_51(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x5C21
{
	int iVar0;
...
int func_53(int iParam0, int iParam1, int iParam2)//Position - 0x5CD4
{
...
int func_54(int iParam0, int iParam1, int iParam2)//Position - 0x5CEF
{
	int iVar0;
...
int func_55(int iParam0)//Position - 0x5D3B
{
	int iVar0;
...
int func_57(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x5E01
{
	int iVar0;
...
void func_58(var uParam0, int iParam1)//Position - 0x5F38
{
	int iVar0;
...
int func_59(int iParam0)//Position - 0x5F87
{
	if (Global_41396 == 15)
	{
		return 0;
...
void func_62(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x61B1
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_63(iParam3), 0);
}

int func_63(int iParam0)//Position - 0x61CA
{
	int iVar0;
...
var func_64()//Position - 0x63BF
{
	func_65();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_65()//Position - 0x63D8
{
	int iVar0;
...
bool func_66(int iParam0)//Position - 0x64D5
{
	return iParam0 < 3;
}

int func_67(int iParam0)//Position - 0x64E1
{
	int iVar0;
	int iVar1;
...
int func_68(int iParam0)//Position - 0x651E
{
	if (func_66(iParam0))
	{
...
var func_69(int iParam0)//Position - 0x6543
{
	return Global_1798[iParam0 /*29*/];
}

int func_70()//Position - 0x6552
{
	if (func_71(131))
	{
		return 1;
...
int func_71(int iParam0)//Position - 0x6568
{
...
void func_73(int iParam0)//Position - 0x65AC
{
	if (iLocal_95 < 5)
	{
		if (iParam0 != 263)
...
int func_74(int iParam0, bool bParam1)//Position - 0x65EF
{
	int iVar0;
...
int func_75(int iParam0)//Position - 0x66A7
{
	int iVar0;
...
void func_76(int iParam0)//Position - 0x66E2
{
	int iVar0;
...
void func_77(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x6739
{
	int iVar0;
...
int func_78(var uParam0)//Position - 0x6864
{
	return 1;
}

void func_79(char[4] cParam0, int iParam1)//Position - 0x686D
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

var func_80()//Position - 0x6884
{
	return Global_73784;
}

int func_81(int iParam0)//Position - 0x6890
{
	if (iParam0 == 1)
	{
...
bool func_82(int iParam0, int iParam1)//Position - 0x68EA
{
	switch (iParam0)
	{
		case 5:
...
bool func_83()//Position - 0x6925
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

int func_84()//Position - 0x693A
{
...
bool func_85(bool bParam0)//Position - 0x6954
{
	if (bParam0)
	{
...
void func_86(var uParam0, int iParam1)//Position - 0x697D
{
	func_87(uParam0, iParam1);
}

void func_87(var uParam0, var uParam1)//Position - 0x698D
{
	*uParam0 = (*uParam0 || uParam1);
}

int func_88()//Position - 0x699E
{
	return 1;
}

bool func_89()//Position - 0x69A7
{
	int iVar0;
	bool bVar1;
...
int func_90(int iParam0)//Position - 0x6AB1
{
	int iVar0;
...
var func_91()//Position - 0x71CE
{
	return Global_98708.f_1;
}

int func_92()//Position - 0x71DC
{
	if (Global_95621 != -1)
	{
...
bool func_94()//Position - 0x722C
{
	return Global_98721.f_346 > 0;
}

bool func_95()//Position - 0x723D
{
	return Global_98721.f_345 > 0;
}

var func_96()//Position - 0x724E
{
	return Global_1312873;
}

int func_97()//Position - 0x725A
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
var func_99()//Position - 0x7290
{
	return Global_94531;
}

int func_100(int iParam0)//Position - 0x729C
{
	switch (iParam0)
	{
		case 0:
...
bool func_101(int iParam0)//Position - 0x730E
{
	int iVar0;
...
bool func_102(int iParam0)//Position - 0x734A
{
	return Global_41396 == iParam0;
}

void func_103()//Position - 0x7358
{
	float fVar0;
	vector3 vVar1;
	vector3 vVar4;
	...
	if (bLocal_131)
	{
		...
		{
			if (TASK::DOES_SCENARIO_EXIST_IN_AREA(vLocal_121, 3f, 1))
			{
			...
			else
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(iLocal_129, "PROP_HUMAN_SEAT_CHAIR", vVar7, fVar10, -1, 0, 1);
			}
		}
		iVar18 = 0;
...
int func_104(vector3 vParam0)//Position - 0x7747
{
...
void func_105(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4)//Position - 0x7771
{
	switch (iParam0)
	{
		case 0:
...
float func_106(bool bParam0, float fParam1, float fParam2)//Position - 0x7AA9
{
	if (bParam0)
	{
		return fParam1;
...
Vector3 func_107(bool bParam0, vector3 vParam1, vector3 vParam4)//Position - 0x7AC0
{
	if (bParam0)
	{
		return vParam1;
...
void func_110(var uParam0, int iParam1)//Position - 0x7BEE
{
	*uParam0 = (*uParam0 || iParam1);
}

void func_111(int iParam0)//Position - 0x7BFF
{
	iLocal_95 = iParam0;
}

void func_112(int iParam0, bool bParam1, bool bParam2)//Position - 0x7C0B
{
	int iVar0;
	bool bVar1;
...
bool func_115(int iParam0, int iParam1)//Position - 0x7D57
{
	bool bVar0;
...
bool func_116(int iParam0)//Position - 0x7DA4
{
	return func_117(iParam0, Global_41396);
}

int func_117(int iParam0, int iParam1)//Position - 0x7DB5
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_118(var uParam0, int iParam1)//Position - 0x7F96
{
	return (uParam0 && iParam1) != 0;
}

void func_119()//Position - 0x7FA5
{
	...
	if (Global_111560.f_20006.f_8 < iLocal_135)
	{
		func_86(&uLocal_94, 8388608);
	}
}

int func_120(vector3 vParam0, var uParam3)//Position - 0x8078
{
	int iVar0;
	vector3 vVar1[3];
	float fVar11;
...
Vector3 func_121(int iParam0)//Position - 0x8104
{
...
void func_122(var uParam0, int iParam1)//Position - 0x8178
{
	func_123(uParam0, iParam1);
}

void func_123(var uParam0, var uParam1)//Position - 0x8188
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

void func_124(bool bParam0)//Position - 0x819D
{
	if (bParam0)
	{
		if (iLocal_105 != 263)
...
void func_127(bool bParam0, int iParam1)//Position - 0x828A
{
	int iVar0;
...
void func_128(int iParam0)//Position - 0x8348
{
	if (iParam0->f_9 != 0)
	{
...
int func_129(var uParam0, bool bParam1, int iParam2)//Position - 0x8371
{
	char cVar0[64];
	int iVar16;
	int iVar17;
