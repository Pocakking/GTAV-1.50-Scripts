		...
		case 0:
			...
			if ((AUDIO::REQUEST_SCRIPT_AUDIO_BANK("CONSTRUCTION_ACCIDENT_1", false, -1) && STREAMING::HAS_ANIM_DICT_LOADED("re@construction")) && func_104(&Local_537))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_319, 0))
				{
					...
					iLocal_533 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_sparking_generator", iLocal_339, 0f, 0f, 0.2f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
...
bool func_28(int iParam0)//Position - 0x190B
{
	return func_29(iParam0, 20);
}

bool func_29(int iParam0, int iParam1)//Position - 0x191B
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_30()//Position - 0x1936
{
	return -1;
}

void func_31()//Position - 0x193F
{
	int iVar0;
...
int func_35()//Position - 0x1B40
{
	func_36();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_36()//Position - 0x1B59
{
	int iVar0;
...
bool func_37(int iParam0)//Position - 0x1C56
{
	return iParam0 < 3;
}

int func_38(int iParam0)//Position - 0x1C62
{
	int iVar0;
	int iVar1;
...
int func_39(int iParam0)//Position - 0x1C9F
{
	if (func_37(iParam0))
	{
...
var func_40(int iParam0)//Position - 0x1CC4
{
	return Global_1798[iParam0 /*29*/];
}

bool func_41(int iParam0)//Position - 0x1CD3
{
	return Global_41396 == iParam0;
}

void func_42()//Position - 0x1CE1
{
	int iVar0;
...
bool func_43(int iParam0, int iParam1)//Position - 0x1D38
{
	switch (iParam0)
	{
		case 5:
...
void func_45(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x1DCA
{
...
void func_46()//Position - 0x1E20
{
	Global_19671 = 0;
	func_47();
}

void func_47()//Position - 0x1E30
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_50()//Position - 0x220A
{
	iLocal_48 = 1;
}

int func_51()//Position - 0x2215
{
	if (iLocal_222 == 1)
	{
		return 1;
		...
		case 5:
			if ((MISC::GET_GAME_TIMER() - iLocal_351) > 3000)
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_317))
				{
					...
					TASK::SET_SEQUENCE_TO_REPEAT(iLocal_357, 1);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_357);
					TASK::TASK_PERFORM_SEQUENCE(iLocal_317, iLocal_357);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_357);
				}
...
bool func_56(bool bParam0)//Position - 0x28B8
{
...
int func_61()//Position - 0x2F9E
{
	return Global_30736;
}

int func_62(int iParam0, int iParam1)//Position - 0x2FA9
{
	int iVar0;
...
int func_63(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x2FFA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_64(int iParam0, int iParam1)//Position - 0x364C
{
	switch (iParam0)
	{
		case 0:
...
int func_65(int iParam0)//Position - 0x39C0
{
	switch (iParam0)
	{
		case 29:
...
void func_66(int iParam0)//Position - 0x39EF
{
	int iVar0;
	int iVar1;
...
void func_67(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x3A31
{
	func_68(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_68(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x3A52
{
	int iVar0;
...
int func_71(int iParam0)//Position - 0x3D8B
{
	int iVar0;
	int iVar1;
...
void func_72(int iParam0, int iParam1)//Position - 0x3DCE
{
	MISC::SET_BIT(&(Global_111560.f_24990.f_8[iParam0]), iParam1);
}

int func_73(int iParam0)//Position - 0x3DE9
{
	int iVar0;
...
int func_75(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x3EB7
{
...
void func_76(int iParam0, int iParam1, int iParam2)//Position - 0x4093
{
	int iVar0;
	int iVar1;
...
void func_77(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x4183
{
	int iVar0;
...
int func_78(var uParam0)//Position - 0x41B3
{
	int iVar0;
	int iVar1;
...
int func_79(int iParam0, int iParam1, int iParam2)//Position - 0x41E7
{
	int iVar0;
	var uVar1;
...
int func_80()//Position - 0x4219
{
	return 1;
}

int func_81(int iParam0, bool bParam1, int iParam2)//Position - 0x4222
{
	int iVar0;
...
int func_82(int iParam0, bool bParam1, bool bParam2)//Position - 0x426C
{
	int iVar0;
...
float func_83(bool bParam0, float fParam1, float fParam2)//Position - 0x4310
{
	if (bParam0)
	{
		return fParam1;
...
int func_84(int iParam0)//Position - 0x4327
{
	if (func_88())
	{
		Global_111550 = 1;
...
void func_85(int iParam0)//Position - 0x437A
{
	switch (iParam0)
	{
		case 0:
...
void func_86(char[4] cParam0, int iParam1)//Position - 0x445B
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

char* func_87(int iParam0)//Position - 0x4472
{
	char* sVar0;
...
int func_89(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x44EB
{
	int iVar0;
...
void func_90(var uParam0, int iParam1)//Position - 0x4622
{
	int iVar0;
...
bool func_91(int iParam0)//Position - 0x4671
{
	return func_92(iParam0, Global_41396);
}

int func_92(int iParam0, int iParam1)//Position - 0x4682
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_93(int iParam0)//Position - 0x4863
{
	if (Global_41396 == 15)
	{
		return 0;
...
int func_94(bool bParam0, bool bParam1, bool bParam2)//Position - 0x4885
{
	int iVar0;
...
void func_95()//Position - 0x496A
{
	AUDIO::TRIGGER_MUSIC_EVENT("RE14A_FAIL");
	iLocal_301 = 2;
}

int func_96(int iParam0, bool bParam1, bool bParam2)//Position - 0x497E
{
	return func_82(iParam0, !bParam1, bParam2);
}

void func_97()//Position - 0x4991
{
	if (func_100(1000))
	{
		func_46();
	...
	switch (iLocal_303)
	{
		...
		case 3:
			if ((MISC::GET_GAME_TIMER() - iLocal_354) > 500)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_327[0]))
				{
					...
					GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_reconstruct_pipefall_debris", iLocal_327[0], 0f, 0f, 0f, 0f, 0f, 0f, 1f, 0, 0, 0);
				}
				iLocal_354 = MISC::GET_GAME_TIMER();
				iLocal_303 = 4;
			}
		...
		case 5:
			if ((MISC::GET_GAME_TIMER() - iLocal_354) > 500)
			{
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_319, 0))
				{
					...
					TASK::TASK_PLAY_ANIM(iLocal_317, "re@construction", "idle_panic", 8f, -8f, -1, 16, 0, 0, 0, 0);
					GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_reconstruct_pipe_impact", iLocal_319, 0f, 0f, 0f, 0f, 0f, 0f, 1f, 0, 0, 0);
		...
		case 8:
			...
			if (!PED::IS_PED_INJURED(iLocal_317))
			{
				TASK::CLEAR_PED_TASKS(iLocal_317);
				TASK::TASK_CLEAR_LOOK_AT(iLocal_317);
				TASK::TASK_PLAY_ANIM(iLocal_317, "re@construction", "idle_panic", 8f, -8f, -1, 1, 0, 0, 0, 0);
			}
...
void func_98(int iParam0)//Position - 0x54DA
{
...
void func_99()//Position - 0x54F2
{
	AUDIO::START_PRELOADED_CONVERSATION();
	Global_21797 = 0;
}

int func_100(int iParam0)//Position - 0x5502
{
...
int func_102(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x557E
{
	func_45(uParam0, 145, sParam1, iParam4, iParam5, iParam6);
	if (iParam3 > 7)
	{
...
void func_103(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x55D1
{
...
int func_104(var uParam0)//Position - 0x566C
{
	int iVar0;
...
bool func_105(var uParam0)//Position - 0x56CE
{
	return func_106(*uParam0, "NULL", uParam0->f_1);
}

int func_106(int iParam0, char* sParam1, int iParam2)//Position - 0x56E3
{
...
int func_107(int iParam0)//Position - 0x57D7
{
	int iVar0;
...
void func_108(var uParam0)//Position - 0x5803
{
	func_109(uParam0, 9, -1, 0);
}

void func_109(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5815
{
	int iVar0;
...
int func_110(int iParam0)//Position - 0x58D8
{
	switch (iParam0)
	{
		case -1:
...
void func_111(var uParam0, int iParam1)//Position - 0x5977
{
	func_109(uParam0, 0, iParam1, 0);
}

void func_112(var uParam0)//Position - 0x5989
{
	int iVar0;
...
void func_113(int iParam0)//Position - 0x5A13
{
	func_114(iParam0, "NULL", iParam0->f_1);
}

void func_114(int iParam0, char* sParam1, int iParam2)//Position - 0x5A27
{
	if (MISC::IS_BIT_SET(*iParam0, 30))
	{
		switch (func_107(*iParam0))
...
void func_116(var uParam0, bool bParam1)//Position - 0x5DE7
{
	int iVar0;
...
void func_117(var uParam0)//Position - 0x5E27
{
	*uParam0 = 0;
	uParam0->f_1 = -1;
}

void func_118(var uParam0)//Position - 0x5E38
{
	int iVar0;
...
void func_119(var uParam0)//Position - 0x5E71
{
	func_120(*uParam0, "NULL", uParam0->f_1);
}

void func_120(int iParam0, char* sParam1, int iParam2)//Position - 0x5E86
{
	if (MISC::IS_BIT_SET(iParam0, 30))
	{
		switch (func_107(iParam0))
...
int func_122(float fParam0, bool bParam1)//Position - 0x5FCC
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_123(int iParam0, var uParam1)//Position - 0x6083
{
	switch (iParam0)
	{
		case 0:
...
int func_125(int iParam0)//Position - 0x72C9
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_126(int iParam0)//Position - 0x760F
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_127(int iParam0)//Position - 0x7646
{
	struct<2> Var0;
...
bool func_129()//Position - 0x7AC4
{
	return Global_111278 > 0;
}

int func_130()//Position - 0x7AD2
{
	if (Global_95621 != -1)
	{
		return 1;
...
void func_135(int iParam0)//Position - 0x7BB7
{
	if (iParam0 == -1)
	{
		iParam0 = func_74();
...
void func_137(int iParam0)//Position - 0x7C2A
{
	Global_111549 = iParam0;
}

int func_138(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x7C38
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
...
bool func_139(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x7FD2
{
	if (bParam6)
	{
...
bool func_140(int iParam0)//Position - 0x801B
{
	int iVar0;
...
int func_141(int iParam0)//Position - 0x803C
{
	return func_142(iParam0, 1);
}

int func_142(int iParam0, int iParam1)//Position - 0x804B
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_143(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x809E
{
	func_144(func_155(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_144(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x80BC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_145(float fParam0, float fParam1, float fParam2)//Position - 0x82BD
{
	float fVar0;
...
int func_146(int iParam0, int iParam1)//Position - 0x82FF
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_147(int iParam0)//Position - 0x83A1
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_148(int iParam0)//Position - 0x83B4
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_149(int iParam0)//Position - 0x83C7
{
...
int func_151(int iParam0)//Position - 0x83EC
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_152(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_152(bool bParam0, int iParam1, int iParam2)//Position - 0x8411
{
	if (bParam0)
	{
		return iParam1;
...
int func_153(int iParam0)//Position - 0x8428
{
	return iParam0 & 15;
}

int func_154(int iParam0, int iParam1)//Position - 0x8435
{
	int iVar0;
	int iVar1;
...
void func_156(var uParam0, int iParam1)//Position - 0x8587
{
	if (iParam1 <= 0)
	{
		return;
...
void func_157(var uParam0, int iParam1)//Position - 0x860D
{
...
void func_158(var uParam0, int iParam1)//Position - 0x8640
{
	int iVar0;
	int iVar1;
...
void func_159(var uParam0, int iParam1)//Position - 0x8691
{
...
void func_160(var uParam0, int iParam1)//Position - 0x86CB
{
...
void func_161(var uParam0, int iParam1)//Position - 0x8706
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_162(int iParam0)//Position - 0x8742
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_163(int iParam0, int iParam1)//Position - 0x881E
{
...
int func_164(int iParam0)//Position - 0x8841
{
	int iVar0;
...
var func_165()//Position - 0x8F5E
{
	return Global_98708.f_1;
}

int func_166()//Position - 0x8F6C
{
	if (Global_95621 != -1)
	{
...
bool func_169()//Position - 0x8FD6
{
	return Global_98721.f_346 > 0;
}

bool func_170()//Position - 0x8FE7
{
	return Global_98721.f_345 > 0;
}

var func_171()//Position - 0x8FF8
{
	return Global_1312873;
}

int func_172()//Position - 0x9004
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_174(int iParam0)//Position - 0x9048
{
	return func_154(func_155(), iParam0);
}

int func_175(int iParam0, int iParam1, int iParam2)//Position - 0x905A
{
	int iVar0;
	int iVar1;
...
int func_176(int iParam0)//Position - 0x913E
{
	if (!func_37(iParam0))
	{
		return 7;
...
bool func_177(int iParam0)//Position - 0x9162
{
	int iVar0;
	bool bVar1;
...
void func_181(int iParam0)//Position - 0x94AB
{
	char cVar0[64];
...
void func_182(var uParam0)//Position - 0x9560
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_183(int iParam0, bool bParam1)//Position - 0x959D
{
	switch (iParam0)
	{
		case 0:
...
void func_184(int iParam0)//Position - 0x97E6
{
	Global_41947 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_185(int iParam0)//Position - 0x97F8
{
	func_186(iParam0, 0, func_191(iParam0));
}

void func_186(int iParam0, int iParam1, int iParam2)//Position - 0x980D
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_187(var uParam0)//Position - 0x983C
{
	struct<16> Var0;
	int iVar16;
...
void func_188(int iParam0, var uParam1)//Position - 0x990C
{
	Global_111560.f_24990.f_43[iParam0] = *uParam1;
}

void func_189(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x9924
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_190(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x9AA6
{
...
int func_191(int iParam0)//Position - 0x9ADE
{
	int iVar0;
...
int func_192(int iParam0, int iParam1, int iParam2)//Position - 0x9C81
{
	var uVar0;
	int iVar1;
...
void func_193(int iParam0, int iParam1)//Position - 0x9CC1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_194(int iParam0, var uParam1)//Position - 0x9EC3
{
	int iVar0;
...
int func_195(int iParam0)//Position - 0xA16E
{
	switch (iParam0)
	{
		case 1:
...
int func_196(int iParam0, var uParam1, var uParam2)//Position - 0xA21E
{
	int iVar0;
	int iVar1;
...
int func_197(int iParam0)//Position - 0xA411
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_198(var uParam0)//Position - 0xA431
{
	int iVar0;
...
int func_199(int iParam0)//Position - 0xA4E1
{
...
int func_200(int iParam0)//Position - 0xA5BE
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_201(int iParam0, bool bParam1)//Position - 0xA76F
{
	int iVar0;
	struct<2> Var1;
...
int func_202(int iParam0)//Position - 0xA8EF
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_204(int iParam0)//Position - 0xA9D2
{
	int iVar0;
	int iVar1;
...
int func_205()//Position - 0xCE9F
{
	return 0;
}

int func_206()//Position - 0xCEA8
{
	return 1;
}

int func_207()//Position - 0xCEB1
{
	return 1;
}

int func_208()//Position - 0xCEBA
{
...
int func_209(int iParam0)//Position - 0xCED3
{
	int iVar0;
	char* sVar1;
...
int func_210(int iParam0)//Position - 0xCF19
{
	int iVar0;
...
int func_211(int iParam0)//Position - 0xCF54
{
	int iVar0;
...
int func_212(int iParam0)//Position - 0xCFD0
{
	int iVar0;
...
int func_213(int iParam0)//Position - 0xD0B8
{
	int iVar0;
...
int func_214(int iParam0, int iParam1, bool bParam2)//Position - 0xD11B
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_215(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0xD18C
{
...
void func_216()//Position - 0xD264
{
	Global_19671 = 0;
	func_217();
}

void func_217()//Position - 0xD274
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
