...
void __EntryFunction__()//Position - 0x0
{
	...
	{
		SYSTEM::WAIT(0);
		if ((BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || iLocal_100) || (func_111() && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_48, 500f, 500f, 500f, false, true, 0)))
		{
			if (!func_111())
			{
				if (func_110())
	...
	switch (iLocal_47)
	{
		case 0:
			if (OBJECT::DOES_PICKUP_EXIST(iLocal_113))
			{
				...
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_73, vLocal_76, fLocal_79, 0, true, 0))
					{
						func_67();
						if (!bLocal_101)
						{
...
int func_36()//Position - 0x17D8
{
	return Global_1312745;
}

int func_37(int iParam0, int iParam1)//Position - 0x17E4
{
	switch (iParam0)
	{
		case 0:
...
int func_38(int iParam0)//Position - 0x1B58
{
	switch (iParam0)
	{
		case 29:
...
void func_39(int iParam0)//Position - 0x1B87
{
	int iVar0;
	int iVar1;
...
void func_40(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x1BC9
{
	func_41(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_41(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x1BEA
{
	int iVar0;
...
bool func_45(int iParam0)//Position - 0x2020
{
	return Global_41396 == iParam0;
}

bool func_46(int iParam0)//Position - 0x202E
{
	return iParam0 < 3;
}

int func_47(int iParam0)//Position - 0x203A
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0)//Position - 0x2077
{
	if (func_46(iParam0))
	{
...
var func_49(int iParam0)//Position - 0x209C
{
	return Global_1798[iParam0 /*29*/];
}

int func_50(int iParam0)//Position - 0x20AB
{
	int iVar0;
	int iVar1;
...
void func_51(int iParam0, int iParam1)//Position - 0x20EE
{
	MISC::SET_BIT(&(Global_111560.f_24990.f_8[iParam0]), iParam1);
}

int func_52(int iParam0)//Position - 0x2109
{
	int iVar0;
...
int func_54(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x21D7
{
...
void func_57(char[4] cParam0, int iParam1)//Position - 0x23DC
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_58(int iParam0)//Position - 0x23F3
{
	if (func_61())
	{
		Global_111550 = 1;
...
void func_59(int iParam0)//Position - 0x2446
{
	switch (iParam0)
	{
		case 0:
...
char* func_60(int iParam0)//Position - 0x2527
{
	char* sVar0;
...
int func_62(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x25A0
{
	int iVar0;
...
void func_63(var uParam0, int iParam1)//Position - 0x26D7
{
	int iVar0;
...
bool func_64(int iParam0)//Position - 0x2726
{
	return func_65(iParam0, Global_41396);
}

int func_65(int iParam0, int iParam1)//Position - 0x2737
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_66(int iParam0)//Position - 0x2918
{
	if (Global_41396 == 15)
	{
		return 0;
...
int func_68(int iParam0)//Position - 0x296C
{
	int iVar0;
...
float func_69(bool bParam0, float fParam1, float fParam2)//Position - 0x29A4
{
	if (bParam0)
	{
		return fParam1;
			...
			switch (iLocal_127)
			{
				case 0:
					if (!iLocal_90[iLocal_125])
					{
						...
						{
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_73, vLocal_76, fLocal_79, 0, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 2205.918f, 5633.455f, 55.7472f, 15f, 15f, 40f, false, true, 0))
							{
								if (!func_56())
								{
				...
				case 1:
					...
					if (iLocal_90[iLocal_125])
					{
						...
						{
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_73, vLocal_76, fLocal_79, 0, true, 0) || ENTITY::IS_ENTITY_AT_ENTITY(iLocal_103[iLocal_125], PLAYER::PLAYER_PED_ID(), 15f, 15f, 5f, 0, 1, 0))
							{
								func_93();
								SYSTEM::WAIT(0);
								if (func_92())
							...
							else
							{
								if (!PED::IS_PED_IN_COMBAT(iLocal_103[iLocal_125], 0))
								{
									...
									if (!PED::IS_PED_INJURED(iLocal_103[0]))
									{
										...
										TASK::SET_SEQUENCE_TO_REPEAT(iLocal_124, 1);
										TASK::CLOSE_SEQUENCE_TASK(iLocal_124);
...
int func_72(int iParam0, bool bParam1, int iParam2)//Position - 0x3254
{
	int iVar0;
...
int func_73(int iParam0, bool bParam1, bool bParam2)//Position - 0x329E
{
	int iVar0;
...
int func_74(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x3342
{
...
int func_75(char* sParam0, int iParam1, bool bParam2)//Position - 0x3390
{
	Global_20806 = 0;
...
bool func_78(int iParam0)//Position - 0x36FD
{
	return func_79(iParam0, 20);
}

bool func_79(int iParam0, int iParam1)//Position - 0x370D
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_80()//Position - 0x3728
{
	return -1;
}

void func_81()//Position - 0x3731
{
	int iVar0;
...
int func_86()//Position - 0x3959
{
	func_44();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_87()//Position - 0x3972
{
	int iVar0;
...
bool func_88(int iParam0, int iParam1)//Position - 0x39C9
{
	switch (iParam0)
	{
		case 5:
...
void func_90(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x3A5B
{
...
void func_91(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x3AB1
{
...
bool func_92()//Position - 0x3B4C
{
	return Global_111560.f_24990.f_7;
}

void func_93()//Position - 0x3B5D
{
	Global_19671 = 0;
	func_94();
}

void func_94()//Position - 0x3B6D
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_95()//Position - 0x3B8E
{
	...
	while (iVar0 < iLocal_103)
	{
		if (!PED::IS_PED_INJURED(iLocal_103[iVar0]))
		{
			...
			if ((((((MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], true), 5f, 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_103[iVar0], PLAYER::PLAYER_PED_ID(), 1)) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_103[iVar0])) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], true) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], true) + Vector(15f, 15f, 15f), joaat("weapon_smokegrenade"), 1)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], true) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], true) + Vector(15f, 15f, 15f), joaat("weapon_grenade"), 1)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], true) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], true) + Vector(15f, 15f, 15f), joaat("weapon_grenadelauncher"), 1)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], true) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], true) + Vector(15f, 15f, 15f), joaat("weapon_stickybomb"), 1))
			{
				return 1;
			}
		}
...
void func_96()//Position - 0x3E01
{
	...
	if ((STREAMING::HAS_MODEL_LOADED(joaat("g_m_y_salvagoon_01")) && STREAMING::HAS_MODEL_LOADED(joaat("bobcatxl"))) && STREAMING::HAS_MODEL_LOADED(joaat("prop_cash_case_01")))
	{
		...
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_110[0], true, 0);
		...
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_110[1], true, 0);
		VEHICLE::SET_VEHICLE_EXTRA(iLocal_110[1], 1, false);
		iVar0 = 0;
		MISC::SET_BIT(&iVar0, 1);
		iLocal_113 = OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_money_case"), vLocal_51, -1.368082f, 0.230633f, 176.8749f, iVar0, MISC::GET_RANDOM_INT_IN_RANGE(40000, 100000), 2, 1, joaat("prop_cash_case_01"));
...
int func_97(vector3 vParam0, bool bParam3)//Position - 0x4442
{
	int iVar0;
...
int func_99(float fParam0, bool bParam1)//Position - 0x44F4
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_100(int iParam0, var uParam1)//Position - 0x45AB
{
	switch (iParam0)
	{
		case 0:
...
int func_102(int iParam0)//Position - 0x57F1
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_103(int iParam0)//Position - 0x5B37
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_104(int iParam0)//Position - 0x5B6E
{
	struct<2> Var0;
...
bool func_106()//Position - 0x5FEC
{
	return Global_111278 > 0;
}

int func_107()//Position - 0x5FFA
{
	if (Global_95621 != -1)
	{
		return 1;
...
void func_112(int iParam0)//Position - 0x60DF
{
	if (iParam0 == -1)
	{
		iParam0 = func_53();
...
void func_114(int iParam0)//Position - 0x6152
{
	Global_111549 = iParam0;
}

int func_115(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x6160
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
...
bool func_116(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x64FA
{
	if (bParam6)
	{
...
bool func_117(int iParam0)//Position - 0x6541
{
	int iVar0;
...
int func_118(int iParam0)//Position - 0x6562
{
	return func_119(iParam0, 1);
}

int func_119(int iParam0, int iParam1)//Position - 0x6571
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_120(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x65C4
{
	func_121(func_22(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_121(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x65E2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_122(float fParam0, float fParam1, float fParam2)//Position - 0x67E3
{
	float fVar0;
...
int func_123(int iParam0, int iParam1)//Position - 0x6825
{
	int iVar0;
	int iVar1;
...
int func_124(int iParam0)//Position - 0x6931
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_125(int iParam0, int iParam1)//Position - 0x6A0D
{
...
int func_126(int iParam0)//Position - 0x6A30
{
	int iVar0;
...
var func_127()//Position - 0x714D
{
	return Global_98708.f_1;
}

int func_128()//Position - 0x715B
{
	if (Global_95621 != -1)
	{
...
bool func_131()//Position - 0x71C5
{
	return Global_98721.f_346 > 0;
}

bool func_132()//Position - 0x71D6
{
	return Global_98721.f_345 > 0;
}

var func_133()//Position - 0x71E7
{
	return Global_1312873;
}

int func_134()//Position - 0x71F3
{
...
bool func_136(int iParam0)//Position - 0x7237
{
	return func_123(func_22(), iParam0);
}

int func_137(int iParam0, int iParam1, int iParam2)//Position - 0x7249
{
	int iVar0;
	int iVar1;
...
int func_138(int iParam0)//Position - 0x732D
{
	if (!func_46(iParam0))
	{
		return 7;
...
bool func_139(int iParam0)//Position - 0x7351
{
	int iVar0;
	bool bVar1;
...
void func_143(int iParam0)//Position - 0x754A
{
	char cVar0[64];
...
void func_144(var uParam0)//Position - 0x75FF
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_145(int iParam0, bool bParam1)//Position - 0x763C
{
	switch (iParam0)
	{
		case 0:
...
void func_146(int iParam0)//Position - 0x7885
{
	Global_41947 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_147(int iParam0)//Position - 0x7897
{
	func_3(iParam0, 0, func_148(iParam0));
}

int func_148(int iParam0)//Position - 0x78AC
{
	int iVar0;
