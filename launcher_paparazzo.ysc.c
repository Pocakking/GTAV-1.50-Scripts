...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		if (Var0 == 47)
		{
			func_197(&Var0, vVar61, "PAP2AUD", "PAP2_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		else if (Var0 == 51)
		{
			func_197(&Var0, vVar61, "PAP4AUD", "PAP4_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		func_196(Var0);
...
int func_40(int iParam0)//Position - 0x33A8
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0)//Position - 0x33C8
{
	int iVar0;
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3479
{
	char* sVar0;
...
int func_43(int iParam0, int iParam1, bool bParam2)//Position - 0x35A8
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x3619
{
...
int func_45(int iParam0)//Position - 0x36F2
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x372F
{
	if (func_36(iParam0))
	{
...
var func_47(int iParam0)//Position - 0x3754
{
	return Global_1798[iParam0 /*29*/];
}

void func_48(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3763
{
	int iVar0;
	int iVar1;
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x3903
{
	int iVar0;
	var uVar1;
...
int func_50(var uParam0)//Position - 0x3935
{
	int iVar0;
	int iVar1;
...
int func_51()//Position - 0x3969
{
	return Global_1312745;
}

int func_52(int iParam0, int iParam1)//Position - 0x3975
{
	var uVar0;
	var uVar1;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x39A1
{
	int iVar0;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3EE9
{
	int iVar0;
...
void func_107(char* sParam0, int iParam1, int iParam2)//Position - 0x8636
{
...
void func_188(int iParam0, int iParam1, vector3 vParam2)//Position - 0xCBB7
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_189(int iParam0, bool bParam1)//Position - 0xCCA8
{
	if (iParam0 == -1)
	{
		return;
...
int func_190(int iParam0)//Position - 0xCCE4
{
	if (Global_76573 == iParam0)
	{
		if (Global_76574 == -1)
...
void func_191(int iParam0, int iParam1)//Position - 0xCD1D
{
	bool bVar0;
	int iVar1;
...
float func_192(int iParam0, vector3 vParam1, bool bParam4)//Position - 0xCDBB
{
	vector3 vVar0;
...
bool func_193()//Position - 0xCDF5
{
	return Global_96008;
}

void func_194(int iParam0)//Position - 0xCE01
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_195(iParam0);
...
void func_195(int iParam0)//Position - 0xCE18
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_196(int iParam0)//Position - 0xCF00
{
	if (iParam0 == -1)
	{
		iParam0 = func_166();
...
int func_197(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xCF28
{
	var uVar0;
...
void func_198(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCFB0
{
...
void func_199(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCFEB
{
...
void func_200(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD041
{
...
int func_201(var uParam0, bool bParam1)//Position - 0xD0DC
{
	struct<27> Var0;
...
void func_202(int iParam0, var uParam1, int iParam2)//Position - 0xD34F
{
	int iVar0;
	int iVar1;
...
int func_203(int iParam0)//Position - 0xD6A7
{
...
int func_204(var uParam0)//Position - 0xD6C7
{
...
int func_205(var uParam0)//Position - 0xD6DF
{
...
void func_206(var uParam0)//Position - 0xD704
{
	int iVar0;
	int iVar1;
...
void func_207(int iParam0)//Position - 0xDA08
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_208(var uParam0)//Position - 0xDA33
{
	int iVar0;
...
int func_209(var uParam0, bool bParam1, bool bParam2)//Position - 0xDAB3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_210(int iParam0, int iParam1)//Position - 0xDC71
{
	int iVar0;
...
int func_211(var uParam0, bool bParam1, int iParam2)//Position - 0xDCA1
{
	int iVar0;
	int iVar1;
...
int func_212(int iParam0)//Position - 0xDF5D
{
...
int func_213(int iParam0, float fParam1)//Position - 0xDF91
{
	float fVar0;
...
bool func_214(int iParam0, float fParam1)//Position - 0xE007
{
	return func_215(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_215(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE01F
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_216(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_216(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE0E0
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_217(int iParam0, int iParam1)//Position - 0xE20C
{
	int iVar0;
...
int func_219(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE31B
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_220(vector3 vParam0, vector3 vParam3)//Position - 0xE3AC
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_221(vector3 vParam0)//Position - 0xE3CD
{
	float fVar0;
	float fVar1;
...
void func_222(var uParam0)//Position - 0xE40C
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_223(int iParam0, int iParam1)//Position - 0xE427
{
	int iVar0;
...
int func_224(int iParam0)//Position - 0xE466
{
...
int func_225(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE48E
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_226(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE589
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_227(int iParam0, float fParam1)//Position - 0xE695
{
	var uVar0;
	vector3 vVar1;
...
int func_228(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0xE72A
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_229(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE7B8
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_230(int iParam0)//Position - 0xE800
{
...
void func_231(int iParam0)//Position - 0xE84A
{
	int iVar0;
...
int func_232(int iParam0)//Position - 0xE8E7
{
	if (iParam0 == -1)
	{
		iParam0 = func_166();
...
int func_233(int iParam0)//Position - 0xE97F
{
...
int func_236(int iParam0)//Position - 0xEA01
{
...
int func_238(int iParam0)//Position - 0xEA73
{
	if (func_108(0))
	{
...
int func_241(var uParam0)//Position - 0xEB6C
{
	int iVar0[7];
	char* sVar8;
	int iVar9;
...
void func_242(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xF12F
{
	func_207(iParam0);
...
void func_243(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xF156
{
	func_244(iParam0);
...
void func_244(int iParam0)//Position - 0xF198
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_245(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0xF234
{
	func_246(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, vParam2, fParam5, 0, false);
}

void func_246(int iParam0)//Position - 0xF255
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_247(int iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)//Position - 0xF296
{
...
int func_248(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0xF2F2
{
	int iVar0;
...
int func_249(var uParam0, int iParam1)//Position - 0xF380
{
	int iVar0;
...
int func_250(int iParam0)//Position - 0xF3C6
{
	int iVar0;
...
int func_251(var uParam0)//Position - 0xF3F7
{
	uParam0->f_16 = 3;
...
int func_252(var uParam0)//Position - 0xF42B
{
	int iVar0[1];
	int iVar2;
...
int func_253(var uParam0)//Position - 0xF516
{
	int iVar0[5];
	int iVar6[3];
	vector3 vVar10[3];
	...
	switch (iLocal_91)
	{
		...
		case 3:
			if (func_127(uParam0->f_41[0]))
			{
				...
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[0], iLocal_94, "idle_closed_pap_3_rcm_dumpster", sVar30, 8f, -8f, 0, 1148846080);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_94, true);
				if (func_127(uParam0->f_28[0]))
				{
					TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iLocal_94, sVar30, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				}
				if (func_127(uParam0->f_41[1]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[1], iLocal_94, "idle_closed_pap_3_rcm_lid_l", sVar30, 8f, -8f, 0, 1148846080);
				}
				if (func_127(uParam0->f_41[2]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[2], iLocal_94, "idle_closed_pap_3_rcm_lid_r", sVar30, 8f, -8f, 0, 1148846080);
				}
			}
			iVar31 = 0;
			while (iVar31 <= (iVar0 - 1))
...
int func_254(var uParam0)//Position - 0xFA55
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
...
int func_255(var uParam0)//Position - 0xFD96
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
		...
		case 3:
			if (func_127(uParam0->f_28[0]))
			{
				if (STREAMING::HAS_ANIM_DICT_LOADED("rcmpaparazzo1beckon"))
				{
					...
					TASK::SET_SEQUENCE_TO_REPEAT(iVar6, 1);
...
void func_256(int iParam0, bool bParam1)//Position - 0x100BB
{
	switch (iParam0)
	{
		case 46:
...
int func_257(int iParam0)//Position - 0x10146
{
	struct<27> Var0;
	int iVar32;
...
int func_258(int iParam0)//Position - 0x1019A
{
	char* sVar0;
...
int func_259(int iParam0)//Position - 0x10253
{
	var uVar0;
...
int func_260(int iParam0)//Position - 0x10314
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_261(int iParam0, char* sParam1)//Position - 0x10399
{
...
bool func_262(int iParam0)//Position - 0x1047B
{
...
bool func_263(int iParam0)//Position - 0x104A9
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_264(int iParam0)//Position - 0x104D7
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_265(int iParam0)//Position - 0x10505
{
	if (func_233(iParam0))
	{
		return 0;
...
void func_266()//Position - 0x1053A
{
	func_283("Running end routines.");
	Global_111278 = (Global_111278 - 1);
}

int func_267(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0x10554
{
	int iVar0;
...
int func_268(int iParam0, vector3 vParam1, float fParam4, var uParam5)//Position - 0x105B9
{
	int iVar0;
	struct<7> Var1;
...
int func_269(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x10637
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_270(int iParam0, bool bParam1)//Position - 0x106B2
{
	if (bParam1)
	{
		...
		switch (*iParam0)
		{
			...
			case 47:
				...
				PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_96, 0);
				func_272(iParam0, 0, 0, 0);
				break;
...
int func_271(var uParam0)//Position - 0x10820
{
	if (func_205(uParam0))
	{
...
void func_272(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x10856
{
...
void func_273(var uParam0, bool bParam1)//Position - 0x10876
{
	func_274(&(uParam0->f_41), bParam1);
}

void func_274(var uParam0, bool bParam1)//Position - 0x10888
{
	int iVar0;
...
void func_275(int iParam0, bool bParam1)//Position - 0x108C6
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_276(var uParam0, bool bParam1)//Position - 0x10901
{
	func_277(&(uParam0->f_35), bParam1);
}

void func_277(var uParam0, bool bParam1)//Position - 0x10913
{
	int iVar0;
...
void func_278(int iParam0)//Position - 0x10950
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_279(var uParam0, int iParam1)//Position - 0x10988
{
	func_280(&(uParam0->f_28), iParam1);
}

void func_280(var uParam0, int iParam1)//Position - 0x1099A
{
	int iVar0;
...
void func_281(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x109DB
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_282(var uParam0)//Position - 0x10A2B
{
	if (*uParam0 == -1)
	{
		return;
...
void func_283(int iParam0)//Position - 0x10A68
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(iParam0))
	{
	}
...
void func_284(var uParam0)//Position - 0x10A7A
{
	*uParam0 = -1;
...
void func_285()//Position - 0x10AAD
{
	func_283("Running start routines.");
	Global_111278++;
}

int func_286(int iParam0)//Position - 0x10AC7
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
