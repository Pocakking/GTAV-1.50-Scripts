...
void func_1()//Position - 0x171
{
	...
	switch (iLocal_293)
	{
		...
		case 2:
			...
			ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_41, iLocal_294, func_33(iLocal_296), func_35(), 8f, -2f, 0, 1148846080);
			if (PED::_0x7F2F4F13AC5257EF(iLocal_294))
			{
...
int func_2(int iParam0)//Position - 0x4DB
{
...
bool func_3(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x4FC
{
...
int func_4(char* sParam0, int iParam1, bool bParam2)//Position - 0x54A
{
	Global_20806 = 0;
...
bool func_7(int iParam0)//Position - 0x8B7
{
	return func_8(iParam0, 20);
}

bool func_8(int iParam0, int iParam1)//Position - 0x8C7
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_9()//Position - 0x8E2
{
	return -1;
}

void func_10()//Position - 0x8EB
{
	int iVar0;
...
int func_15()//Position - 0xB13
{
	func_16();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_16()//Position - 0xB2C
{
	int iVar0;
...
bool func_17(int iParam0)//Position - 0xC29
{
	return iParam0 < 3;
}

int func_18(int iParam0)//Position - 0xC35
{
	int iVar0;
	int iVar1;
...
int func_19(int iParam0)//Position - 0xC72
{
	if (func_17(iParam0))
	{
...
var func_20(int iParam0)//Position - 0xC97
{
	return Global_1798[iParam0 /*29*/];
}

bool func_21(int iParam0)//Position - 0xCA6
{
	return Global_41396 == iParam0;
}

void func_22()//Position - 0xCB4
{
	int iVar0;
...
bool func_23(int iParam0, int iParam1)//Position - 0xD0B
{
	switch (iParam0)
	{
		case 5:
...
void func_25(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0xD9D
{
...
void func_28(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)//Position - 0xE88
{
...
char* func_30(int iParam0)//Position - 0xFAD
{
	char* sVar0;
...
char* func_33(int iParam0)//Position - 0x116C
{
	char* sVar0;
...
char* func_34(int iParam0)//Position - 0x1268
{
	char* sVar0;
...
Vector3 func_36()//Position - 0x145B
{
	vector3 vVar0;
...
Vector3 func_37()//Position - 0x1570
{
	vector3 vVar0;
...
void func_38()//Position - 0x16E5
{
	Global_22211.f_6 = 1;
}

int func_39(char* sParam0)//Position - 0x16F3
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_40(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x1706
{
	if (bParam0)
	{
...
bool func_41()//Position - 0x183F
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_42(int iParam0, int iParam1)//Position - 0x185C
{
	bool bVar0;
...
int func_43(int iParam0, bool bParam1)//Position - 0x18A7
{
	int iVar0;
	int iVar1;
...
int func_44()//Position - 0x18E8
{
	return Global_1312745;
}

int func_45(int iParam0)//Position - 0x18F4
{
...
bool func_46()//Position - 0x1936
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_47(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x1947
{
	int iVar0;
...
void func_48(int iParam0)//Position - 0x197A
{
	if (iParam0 == 1)
	{
...
int func_49(bool bParam0, bool bParam1, bool bParam2)//Position - 0x199D
{
	int iVar0;
...
int func_52(vector3 vParam0, float fParam3, var uParam4, var uParam5)//Position - 0x1B73
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
int func_53(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x1C26
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_56(int iParam0)//Position - 0x1D7A
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
int func_71(int iParam0)//Position - 0x25BC
{
	if (Global_41396 == 15)
	{
		return 0;
...
bool func_72(int iParam0)//Position - 0x25DE
{
	return func_73(iParam0, Global_41396);
}

int func_73(int iParam0, int iParam1)//Position - 0x25EF
{
	if (iParam1 == 15)
	{
		return 1;
