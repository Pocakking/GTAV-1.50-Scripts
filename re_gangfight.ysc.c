		...
		if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		{
				...
				switch (iLocal_46)
				{
					...
					case 1:
						...
						else
						{
							...
							{
								TASK::TASK_SMART_FLEE_PED(iLocal_68, PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
							}
							func_69();
						}
						break;
			...
			else
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_68))
				{
					...
					if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_68, 150f, 150f, 50f, 0, 1, 0))
					{
	...
	switch (iLocal_48)
	{
		...
		case 2:
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_76, 0))
			{
				...
				if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_68, 5f, 5f, 5f, 0, 1, 0))
				{
		...
		case 3:
			if (!PED::IS_PED_INJURED(iLocal_68))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_68, 6f, 6f, 6f, 0, 1, 0))
				{
			...
			if (!PED::IS_PED_INJURED(iLocal_68))
			{
				if (!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_68, PLAYER::PLAYER_PED_ID(), 120f, 120f, 120f, 0, 1, 0))
				{
					func_10();
				}
			}
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_76, 0))
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_76, PLAYER::PLAYER_PED_ID(), 0))
				{
					func_69();
				}
			}
		...
		case 5:
			if (!PED::IS_PED_INJURED(iLocal_68) && !ENTITY::IS_ENTITY_DEAD(iLocal_76, 0))
			{
				TASK::OPEN_SEQUENCE_TASK(&iLocal_84);
		...
		case 6:
			if (!PED::IS_PED_INJURED(iLocal_68))
			{
				...
				{
					if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_68, "veh@drivebystd_ds_grenades", "drop_grenade") > 0.436f && PED::IS_PED_IN_ANY_VEHICLE(iLocal_68, 0))
					{
						OBJECT::CREATE_MONEY_PICKUPS(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(PED::GET_VEHICLE_PED_IS_IN(iLocal_68, 0), -1f, 0f, 0f), 1000, 1, 0);
						iLocal_48++;
					}
				}
			}
...
int func_21()//Position - 0x19A3
{
	return Global_1312745;
}

int func_22(int iParam0, int iParam1)//Position - 0x19AF
{
	switch (iParam0)
	{
		case 0:
...
int func_23(int iParam0)//Position - 0x1D23
{
	switch (iParam0)
	{
		case 29:
...
void func_24(int iParam0)//Position - 0x1D52
{
	int iVar0;
	int iVar1;
...
void func_25(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x1D94
{
	func_26(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_26(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x1DB6
{
	int iVar0;
...
bool func_30(int iParam0)//Position - 0x21ED
{
	return Global_41396 == iParam0;
}

bool func_31(int iParam0)//Position - 0x21FB
{
	return iParam0 < 3;
}
...
int func_33(int iParam0)//Position - 0x2244
{
	if (func_31(iParam0))
	{
...
var func_34(int iParam0)//Position - 0x2269
{
	return Global_1798[iParam0 /*29*/];
}

int func_35(int iParam0)//Position - 0x2278
{
	int iVar0;
	int iVar1;
...
void func_36(int iParam0, int iParam1)//Position - 0x22BB
{
	MISC::SET_BIT(&(Global_111560.f_24990.f_8[iParam0]), iParam1);
}

int func_37(int iParam0)//Position - 0x22D6
{
	int iVar0;
...
int func_39(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x23A4
{
...
int func_40()//Position - 0x257E
{
	return 1;
}

void func_41(int iParam0)//Position - 0x2587
{
	int iVar0;
...
bool func_42(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x25B6
{
...
int func_43(char* sParam0, int iParam1, bool bParam2)//Position - 0x2604
{
	Global_20806 = 0;
...
bool func_46(int iParam0)//Position - 0x2971
{
	return func_47(iParam0, 20);
}

bool func_47(int iParam0, int iParam1)//Position - 0x2981
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_48()//Position - 0x299C
{
	return -1;
}
...
int func_54()//Position - 0x2BCE
{
	func_29();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_55()//Position - 0x2BE7
{
	int iVar0;
...
bool func_56(int iParam0, int iParam1)//Position - 0x2C3F
{
	switch (iParam0)
	{
		case 5:
...
void func_58(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x2CD1
{
...
void func_59()//Position - 0x2D27
{
	...
	switch (iLocal_48)
	{
		...
		case 1:
			if (!PED::IS_PED_INJURED(iLocal_68))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_68, 20f, 20f, 20f, 0, 1, 0))
				{
			...
			if (!PED::IS_PED_INJURED(iLocal_68))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_68, 8f, 8f, 8f, 0, 1, 0))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) || PED::IS_PED_ON_ANY_BIKE(PLAYER::PLAYER_PED_ID()))
					{
						...
						{
							func_41(1000);
							if ((!PED::IS_PED_INJURED(iLocal_68) && !PED::IS_PED_INJURED(iLocal_69[2])) && !ENTITY::IS_ENTITY_DEAD(iLocal_76, 0))
							{
								TASK::OPEN_SEQUENCE_TASK(&iLocal_84);
								...
								if ((!PED::IS_PED_INJURED(iLocal_68) && !ENTITY::IS_ENTITY_DEAD(iLocal_76, 0)) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_68, 0))
								{
									iLocal_48++;
								}
								else
		...
		case 7:
			if ((((!PED::IS_PED_INJURED(iLocal_68) && !ENTITY::IS_ENTITY_DEAD(iLocal_76, 0)) && !PED::IS_PED_IN_VEHICLE(iLocal_68, iLocal_76, 0)) && !PED::IS_PED_IN_COVER(iLocal_68, 0)) && !PED::IS_PED_GOING_INTO_COVER(iLocal_68))
			{
			}
			iVar0 = 0;
			while (iVar0 < iLocal_69)
...
void func_60()//Position - 0x335C
{
	Global_19671 = 0;
	func_61();
}

void func_61()//Position - 0x336C
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
void func_63(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x3867
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_65(int iParam0, char* sParam1, int iParam2)//Position - 0x39A6
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_66(iParam2), 1);
}

int func_66(int iParam0)//Position - 0x39BD
{
	int iVar0;
...
void func_69()//Position - 0x3FC7
{
	iLocal_47 = 3;
}

int func_70(int iParam0)//Position - 0x3FD2
{
	if (func_74())
	{
		Global_111550 = 1;
...
void func_71(int iParam0)//Position - 0x4026
{
	switch (iParam0)
	{
		case 0:
...
void func_72(char[4] cParam0, int iParam1)//Position - 0x4107
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

char* func_73(int iParam0)//Position - 0x411E
{
	char* sVar0;
...
int func_75(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x4198
{
	int iVar0;
...
void func_76(var uParam0, int iParam1)//Position - 0x42CF
{
	int iVar0;
...
bool func_77(int iParam0)//Position - 0x431E
{
	return func_78(iParam0, Global_41396);
}

int func_78(int iParam0, int iParam1)//Position - 0x432F
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_79(int iParam0)//Position - 0x4510
{
	if (Global_41396 == 15)
	{
		return 0;
...
int func_80(int iParam0, bool bParam1, int iParam2)//Position - 0x4532
{
	int iVar0;
...
int func_81(int iParam0, bool bParam1, bool bParam2)//Position - 0x457C
{
	int iVar0;
...
float func_82(bool bParam0, float fParam1, float fParam2)//Position - 0x4620
{
	if (bParam0)
	{
		return fParam1;
...
int func_83()//Position - 0x4637
{
	...
	if (!bLocal_55)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_69[0]))
		{
			...
			if (((MISC::IS_PROJECTILE_TYPE_IN_AREA(vVar3, vVar0, joaat("weapon_smokegrenade"), 1) || MISC::IS_PROJECTILE_TYPE_IN_AREA(vVar3, vVar0, joaat("weapon_grenade"), 1)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(vVar3, vVar0, joaat("weapon_grenadelauncher"), 1)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(vVar3, vVar0, joaat("weapon_stickybomb"), 1))
			{
				func_4();
				return 1;
			}
...
void func_84()//Position - 0x4B4E
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_76, 0))
	{
		if ((!ENTITY::IS_ENTITY_AT_COORD(iLocal_76, 915.7905f, 3603.449f, 31.9111f, 5f, 5f, 5f, false, true, 0) && !PED::IS_PED_IN_VEHICLE(iLocal_68, iLocal_76, 0)) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_76, 1))
		{
			func_64();
		}
	}
...
int func_85()//Position - 0x4BAA
{
	...
	if (((((!ENTITY::DOES_ENTITY_EXIST(iLocal_68) && !ENTITY::DOES_ENTITY_EXIST(iLocal_69[0])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_69[1])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_76)) && !ENTITY::DOES_ENTITY_EXIST(iLocal_77[0])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_77[1]))
	{
		...
		if (((((((STREAMING::HAS_MODEL_LOADED(joaat("a_m_m_skidrow_01")) && STREAMING::HAS_MODEL_LOADED(joaat("g_m_y_lost_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("g_m_y_lost_02"))) && STREAMING::HAS_MODEL_LOADED(joaat("picador"))) && STREAMING::HAS_MODEL_LOADED(joaat("hexer"))) && STREAMING::HAS_ANIM_DICT_LOADED("random@countryside_gang_fight")) && STREAMING::HAS_ANIM_DICT_LOADED("veh@drivebystd_ds_grenades")) && STREAMING::HAS_ANIM_SET_LOADED("move_m@gangster@var_i"))
		{
			...
			PED::ADD_SCENARIO_BLOCKING_AREA(vLocal_50 - Vector(20f, 50f, 80f), vLocal_50 + Vector(20f, 50f, 70f), 0, 1, 1, 1);
...
int func_87(float fParam0, bool bParam1)//Position - 0x50EB
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_88(int iParam0, var uParam1)//Position - 0x51A2
{
	switch (iParam0)
	{
		case 0:
...
int func_90(int iParam0)//Position - 0x647A
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_91(int iParam0)//Position - 0x67C0
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_92(int iParam0)//Position - 0x67F8
{
	struct<2> Var0;
...
bool func_94()//Position - 0x6C77
{
	return Global_111278 > 0;
}

int func_95()//Position - 0x6C85
{
	if (Global_95621 != -1)
	{
		return 1;
...
void func_100()//Position - 0x6D6A
{
}

void func_101(int iParam0)//Position - 0x6D72
{
	if (iParam0 == -1)
	{
		iParam0 = func_38();
...
void func_103(int iParam0)//Position - 0x6DE5
{
	Global_111549 = iParam0;
}

int func_104(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x6DF3
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
	...
	if (!bVar0)
	{
		...
		if (!func_140(Global_111560.f_24990.f_43[iParam3]))
		{
			return 0;
		}
...
bool func_105(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x718D
{
	if (bParam6)
	{
...
bool func_106(int iParam0)//Position - 0x71D4
{
	int iVar0;
...
int func_107(int iParam0)//Position - 0x71F5
{
	return func_108(iParam0, 1);
}

int func_108(int iParam0, int iParam1)//Position - 0x7204
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_109(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x7257
{
	func_110(func_121(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_110(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x7275
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_111(float fParam0, float fParam1, float fParam2)//Position - 0x7476
{
	float fVar0;
...
int func_112(int iParam0, int iParam1)//Position - 0x74B8
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_113(int iParam0)//Position - 0x755A
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_114(int iParam0)//Position - 0x756D
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_115(int iParam0)//Position - 0x7580
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_116(int iParam0)//Position - 0x7593
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_117(int iParam0)//Position - 0x75A5
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_118(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_118(bool bParam0, int iParam1, int iParam2)//Position - 0x75CA
{
	if (bParam0)
	{
		return iParam1;
...
int func_119(int iParam0)//Position - 0x75E1
{
	return iParam0 & 15;
}

int func_120(int iParam0, int iParam1)//Position - 0x75EE
{
	int iVar0;
	int iVar1;
...
void func_122(var uParam0, int iParam1)//Position - 0x7740
{
	if (iParam1 <= 0)
	{
		return;
...
void func_123(var uParam0, int iParam1)//Position - 0x77C6
{
...
void func_124(var uParam0, int iParam1)//Position - 0x77F9
{
	int iVar0;
	int iVar1;
...
void func_125(var uParam0, int iParam1)//Position - 0x784A
{
...
void func_126(var uParam0, int iParam1)//Position - 0x7884
{
...
void func_127(var uParam0, int iParam1)//Position - 0x78BF
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_128(int iParam0)//Position - 0x78FB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_129(int iParam0, int iParam1)//Position - 0x79D7
{
...
int func_130(int iParam0)//Position - 0x79FA
{
	int iVar0;
...
var func_131()//Position - 0x8118
{
	return Global_98708.f_1;
}

int func_132()//Position - 0x8126
{
	if (Global_95621 != -1)
	{
...
bool func_135()//Position - 0x8190
{
	return Global_98721.f_346 > 0;
}

bool func_136()//Position - 0x81A1
{
	return Global_98721.f_345 > 0;
}

var func_137()//Position - 0x81B2
{
	return Global_1312873;
}

int func_138()//Position - 0x81BE
{
...
bool func_140(int iParam0)//Position - 0x8202
{
	return func_120(func_121(), iParam0);
}

int func_141(int iParam0, int iParam1, int iParam2)//Position - 0x8214
{
	int iVar0;
	int iVar1;
...
int func_142(int iParam0)//Position - 0x82F8
{
	if (!func_31(iParam0))
	{
		return 7;
...
bool func_143(int iParam0)//Position - 0x831C
{
	int iVar0;
	bool bVar1;
...
void func_147(int iParam0)//Position - 0x863A
{
	char cVar0[64];
...
void func_148(var uParam0)//Position - 0x86EF
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_149(int iParam0, bool bParam1)//Position - 0x872C
{
	switch (iParam0)
	{
		case 0:
...
void func_150(int iParam0)//Position - 0x8975
{
	Global_41947 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_151(int iParam0)//Position - 0x8987
{
	func_152(iParam0, 0, func_157(iParam0));
}

void func_152(int iParam0, int iParam1, int iParam2)//Position - 0x899C
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_153(var uParam0)//Position - 0x89CB
{
	struct<16> Var0;
	int iVar16;
...
void func_154(int iParam0, var uParam1)//Position - 0x8A9C
{
	Global_111560.f_24990.f_43[iParam0] = *uParam1;
}

void func_155(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8AB4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_156(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8C36
{
...
int func_157(int iParam0)//Position - 0x8C6E
{
	int iVar0;
