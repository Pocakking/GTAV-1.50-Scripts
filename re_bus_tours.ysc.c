	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(11))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_306, 0))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_306, 2.5f, 1.5f, 0f), 1, false, 0, 1);
...
bool func_7(int iParam0)//Position - 0x779
{
	return func_8(iParam0, 20);
}

bool func_8(int iParam0, int iParam1)//Position - 0x789
{
...
int func_15()//Position - 0x9D5
{
	func_16();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_16()//Position - 0x9EE
{
	int iVar0;
...
bool func_17(int iParam0)//Position - 0xAEB
{
	return iParam0 < 3;
}

int func_18(int iParam0)//Position - 0xAF7
{
	int iVar0;
	int iVar1;
...
int func_19(int iParam0)//Position - 0xB34
{
	if (func_17(iParam0))
	{
...
var func_20(int iParam0)//Position - 0xB59
{
...
int func_26(int iParam0)//Position - 0xCB5
{
...
void func_27(bool bParam0)//Position - 0xCF9
{
	if (!bParam0)
	{
...
void func_28(vector3 vParam0, int iParam3)//Position - 0xDD6
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_306, 0))
	{
...
void func_29(vector3 vParam0)//Position - 0xE5A
{
	int iVar0;
	int iVar1;
...
void func_31(int iParam0, int iParam1, vector3 vParam2)//Position - 0x121F
{
	float fVar0;
	vector3 vVar1;
...
void func_35()//Position - 0x1445
{
	Global_19671 = 0;
	func_24();
}

void func_36(vector3 vParam0, float fParam3)//Position - 0x1455
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_306, 0))
	{
		...
		ENTITY::SET_ENTITY_COORDS(iLocal_306, vParam0.x, vParam0.y, vParam0.z, 1, false, 0, 1);
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_306, 0))
	{
		...
		VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_306, true, true, 0);
		if (iVar0 < 13)
		{
			if (!PED::IS_PED_INJURED(iLocal_285))
			{
...
void func_37()//Position - 0x1634
{
	Global_19671 = 0;
	func_38();
}

void func_38()//Position - 0x1644
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_39(vector3 vParam0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x1665
{
	int iVar0;
	int iVar1;
...
void func_40()//Position - 0x16D5
{
	Global_22211.f_6 = 1;
}

void func_41(int iParam0)//Position - 0x16E3
{
	if (func_46())
	{
		return;
...
void func_42(int iParam0)//Position - 0x1716
{
	if (func_46())
	{
		return;
...
void func_43(bool bParam0, bool bParam1)//Position - 0x17A0
{
	if (bParam0)
	{
		if (func_45(0))
...
bool func_44()//Position - 0x1814
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

int func_45(int iParam0)//Position - 0x1825
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
bool func_46()//Position - 0x187F
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

void func_47()//Position - 0x1891
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_48(vector3 vParam0)//Position - 0x1BB2
{
	int iVar0;
...
int func_49()//Position - 0x1C1B
{
	...
	switch (iLocal_333)
	{
		case 0:
			...
			PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
			GRAPHICS::_0xEF398BEEE4EF45F9(1);
			iLocal_329 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", 93.8459f, 251.8829f, 110.4535f, 23.0883f, 0.101f, -61.7699f, 40f, 1, 2);
			iLocal_330 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", 97.0995f, 249.7653f, 109.0195f, -3f, 0f, -91.5944f, 50f, 1, 2);
			...
			ENTITY::SET_ENTITY_COORDS(iLocal_306, Local_263.f_1, 1, false, 0, 1);
				...
				while (iLocal_335 < 5)
				{
					if (ENTITY::DOES_ENTITY_EXIST(uLocal_287[iLocal_335]))
					{
						if (!PED::IS_PED_INJURED(uLocal_287[iLocal_335]))
						{
							...
							ENTITY::SET_ENTITY_COORDS(uLocal_287[iLocal_335], vVar6[iLocal_335 /*3*/], 1, false, 0, 1);
...
void func_51()//Position - 0x200B
{
	func_52();
}

int func_52()//Position - 0x2018
{
	if (func_53(0))
	{
		return 0;
...
bool func_53(bool bParam0)//Position - 0x2063
{
...
void func_54(int iParam0, int iParam1)//Position - 0x208E
{
	if (iParam0 == -1)
	{
		iParam0 = func_72();
...
void func_55(int iParam0)//Position - 0x2191
{
	Global_111546 = iParam0;
}

void func_56(int iParam0, var uParam1, var uParam2)//Position - 0x219F
{
	bool bVar0;
...
int func_58()//Position - 0x2748
{
	return Global_30736;
}

int func_59(int iParam0, int iParam1)//Position - 0x2753
{
	int iVar0;
...
int func_60(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x27A4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_61()//Position - 0x2DF1
{
	return Global_1312745;
}

int func_62(int iParam0, int iParam1)//Position - 0x2DFD
{
	switch (iParam0)
	{
		case 0:
...
int func_63(int iParam0)//Position - 0x3171
{
	switch (iParam0)
	{
		case 29:
...
void func_64(int iParam0)//Position - 0x31A0
{
	int iVar0;
	int iVar1;
...
void func_65(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x31E2
{
	func_66(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_66(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x3203
{
	int iVar0;
...
int func_69(int iParam0)//Position - 0x353C
{
	int iVar0;
	int iVar1;
...
void func_70(int iParam0, int iParam1)//Position - 0x357F
{
	MISC::SET_BIT(&(Global_111560.f_24990.f_8[iParam0]), iParam1);
}

int func_71(int iParam0)//Position - 0x359A
{
	int iVar0;
...
int func_73(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x3668
{
...
void func_74(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x3842
{
	if (bParam0)
	{
...
bool func_75()//Position - 0x397B
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_76(int iParam0, int iParam1)//Position - 0x3998
{
	bool bVar0;
...
int func_77(int iParam0, bool bParam1)//Position - 0x39E3
{
	int iVar0;
	int iVar1;
...
int func_78(int iParam0)//Position - 0x3A24
{
...
bool func_79()//Position - 0x3A66
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_80(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x3A77
{
	int iVar0;
...
void func_81(int iParam0)//Position - 0x3AAA
{
	if (iParam0 == 1)
	{
...
int func_82(int iParam0)//Position - 0x3ACD
{
	if (CAM::IS_SCREEN_FADED_IN())
	{
...
bool func_84(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x3B49
{
...
void func_85(struct<2> Param0, float fParam2, struct<2> Param3, var uParam5, float fParam6, float fParam7, int iParam8)//Position - 0x3B97
{
	if (!iLocal_318)
	{
		if (Param3 <= Param0)
...
int func_87(int iParam0)//Position - 0x3F25
{
...
bool func_89(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x403A
{
	func_25(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
	...
	if (!PED::IS_PED_INJURED(iLocal_286) && !PED::IS_PED_INJURED(iLocal_285))
	{
		switch (iLocal_51)
		{
			case 0:
				...
				MISC::SET_MINIGAME_IN_PROGRESS(1);
				HUD::DISPLAY_RADAR(false);
				iLocal_329 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", 94.5693f, 246.0525f, 108.9809f, -11.5369f, 0f, -74.512f, 40f, 1, 2);
				iLocal_330 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", 95.7144f, 243.8854f, 111.291f, -26.2154f, 0f, -59.2407f, 50f, 1, 2);
				CAM::SET_CAM_ACTIVE(iLocal_329, true);
				CAM::RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
...
int func_93(int iParam0, int iParam1, int iParam2)//Position - 0x4479
{
...
int func_94(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x44AD
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_95(bool bParam0)//Position - 0x4AAC
{
	int iVar0;
	int iVar1;
...
void func_96(int iParam0)//Position - 0x4D2E
{
	int iVar0;
...
void func_97(int iParam0)//Position - 0x4D88
{
	bool bVar0;
	char cVar1[64];
...
char* func_98(int iParam0)//Position - 0x4F18
{
	switch (iParam0)
	{
		case 0:
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x5021
{
	int iVar0;
...
int func_101(var uParam0)//Position - 0x5051
{
	int iVar0;
	int iVar1;
...
void func_102(int iParam0)//Position - 0x5085
{
	func_123(93, iParam0);
	func_123(29, iParam0);
	func_123(30, iParam0);
...
bool func_103(int iParam0)//Position - 0x50A5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_104(int iParam0, int iParam1, int iParam2)//Position - 0x5255
{
	int iVar0;
	var uVar1;
...
int func_105(int iParam0, int iParam1, int iParam2)//Position - 0x5287
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_106(int iParam0)//Position - 0x52C4
{
	int iVar0;
...
int func_107(int iParam0, int iParam1)//Position - 0x5660
{
	int iVar0;
...
int func_108(bool bParam0)//Position - 0x59D4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_109(int iParam0, int iParam1)//Position - 0x5A8B
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_110(int iParam0, int iParam1)//Position - 0x5AA6
{
...
int func_111(var uParam0, int iParam1)//Position - 0x5B43
{
	int iVar0;
	var uVar1[78];
...
int func_112(var uParam0, int iParam1)//Position - 0x5BF4
{
	int iVar0;
...
bool func_113(var uParam0, int iParam1)//Position - 0x5C6F
{
	return (*uParam0)[iParam1] == 78;
}

void func_114(var uParam0)//Position - 0x5C80
{
	int iVar0;
...
void func_115(var uParam0, int iParam1)//Position - 0x5CB4
{
	(*uParam0)[iParam1] = 78;
}

void func_116(var uParam0, float fParam1)//Position - 0x5CC4
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_117(var uParam0)//Position - 0x5CE1
{
	return uParam0->f_80;
}

bool func_118(var uParam0, int iParam1)//Position - 0x5CED
{
	return func_119(uParam0, iParam1) != -1;
}

int func_119(var uParam0, int iParam1)//Position - 0x5CFF
{
	int iVar0;
...
bool func_120(var uParam0)//Position - 0x5D2C
{
	return uParam0->f_79 == 1;
}

int func_121(int iParam0)//Position - 0x5D3A
{
	switch (iParam0)
	{
		case 60:
...
void func_122(int iParam0, int iParam1)//Position - 0x5D8A
{
	int iVar0;
...
void func_123(int iParam0, int iParam1)//Position - 0x5DAD
{
	int iVar0;
...
int func_125(int iParam0)//Position - 0x5E7F
{
	return Global_1798[iParam0 /*29*/].f_17;
}

int func_126(char* sParam0)//Position - 0x5E90
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_127()//Position - 0x5EA3
{
			...
			if ((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_306, 5f, 5f, 5f, 0, 1, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && !func_126("TX_H02"))
			{
				if (func_157())
				{
					...
					if (!HUD::DOES_BLIP_EXIST(iLocal_310))
					{
						...
						HUD::SET_BLIP_SCALE(iLocal_310, Global_30782);
						if (!PED::IS_PED_INJURED(iLocal_286))
						{
...
int func_129(var uParam0)//Position - 0x603F
{
	char* sVar0;
	
	*uParam0 = 0;
	if (PED::GET_CLOSEST_PED(vLocal_279, 100f, 1, 0, uParam0, 0, 0, 28))
	{
...
char* func_130(bool bParam0)//Position - 0x6198
{
	int iVar0;
...
int func_131(int iParam0)//Position - 0x64D5
{
	int iVar0;
...
void func_132(int iParam0)//Position - 0x654E
{
	iLocal_51 = 0;
	iLocal_49 = iParam0;
}

int func_133()//Position - 0x655D
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_306, 0))
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
int func_134(int iParam0)//Position - 0x659A
{
	if (func_138())
	{
		Global_111550 = 1;
...
void func_135(int iParam0)//Position - 0x65ED
{
	switch (iParam0)
	{
		case 0:
...
void func_136(char[4] cParam0, int iParam1)//Position - 0x66CE
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

char* func_137(int iParam0)//Position - 0x66E5
{
	char* sVar0;
...
int func_139(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x675E
{
	int iVar0;
...
void func_140(var uParam0, int iParam1)//Position - 0x6895
{
	int iVar0;
...
bool func_141(int iParam0)//Position - 0x68E4
{
	return func_142(iParam0, Global_41396);
}

int func_142(int iParam0, int iParam1)//Position - 0x68F5
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_143(int iParam0)//Position - 0x6AD6
{
	if (Global_41396 == 15)
	{
		return 0;
...
int func_145(float fParam0, bool bParam1)//Position - 0x6B5A
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_146(int iParam0, var uParam1)//Position - 0x6C11
{
	switch (iParam0)
	{
		case 0:
...
int func_148(int iParam0)//Position - 0x7E57
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_149(int iParam0)//Position - 0x819D
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_150(int iParam0)//Position - 0x81D4
{
	struct<2> Var0;
...
bool func_153()//Position - 0x866F
{
	return Global_111278 > 0;
}

int func_154()//Position - 0x867D
{
	if (Global_95621 != -1)
	{
		return 1;
...
int func_158(int iParam0)//Position - 0x86FE
{
	var uVar0;
...
int func_159(int iParam0)//Position - 0x8756
{
	int iVar0;
...
var func_160()//Position - 0x8E73
{
	return Global_98708.f_1;
}

int func_161()//Position - 0x8E81
{
	if (Global_95621 != -1)
	{
...
bool func_164()//Position - 0x8EEB
{
	return Global_98721.f_346 > 0;
}

bool func_165()//Position - 0x8EFC
{
	return Global_98721.f_345 > 0;
}

var func_166()//Position - 0x8F0D
{
	return Global_1312873;
}

int func_167()//Position - 0x8F19
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_169(int iParam0)//Position - 0x907A
{
	if (func_181(iLocal_286))
	{
		if (!PED::IS_PED_INJURED(iLocal_286))
...
void func_171(int iParam0, char* sParam1, int iParam2)//Position - 0x911B
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_172(iParam2), 1);
}

int func_172(int iParam0)//Position - 0x9132
{
	int iVar0;
...
int func_173(int iParam0)//Position - 0x9327
{
...
int func_174(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5, int iParam6)//Position - 0x9361
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
void func_175(char* sParam0, int iParam1)//Position - 0x95BF
{
	func_177(sParam0);
	func_176(iParam1);
}

void func_176(int iParam0)//Position - 0x95D3
{
	if (iParam0 > 0)
	{
	}
...
void func_177(char* sParam0)//Position - 0x95E1
{
...
void func_178(int iParam0)//Position - 0x95F4
{
	AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(iParam0);
}

void func_179(char* sParam0)//Position - 0x9602
{
	func_177(sParam0);
}

int func_180(int iParam0, int iParam1)//Position - 0x9610
{
...
int func_181(int iParam0)//Position - 0x965D
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_186()//Position - 0x974C
{
	...
	else
	{
		...
		if ((((STREAMING::HAS_MODEL_LOADED(iVar0) && STREAMING::HAS_MODEL_LOADED(iVar1)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_509)) && STREAMING::HAS_MODEL_LOADED(joaat("tourbus"))) && HUD::HAS_ADDITIONAL_TEXT_LOADED(2))
		{
			...
			TASK::TASK_PLAY_ANIM(0, sLocal_509, "IDLE_A", 8f, -8f, -1, 0, 0, 0, 0, 0);
			TASK::TASK_PLAY_ANIM(0, sLocal_509, "IDLE_B", 8f, -8f, -1, 0, 0, 0, 0, 0);
			TASK::TASK_PLAY_ANIM(0, sLocal_509, "IDLE_C", 8f, -8f, -1, 0, 0, 0, 0, 0);
			TASK::SET_SEQUENCE_TO_REPEAT(iLocal_327, 1);
...
void func_188(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x9A0D
{
...
void func_190()//Position - 0x9B2E
{
}

void func_191()//Position - 0x9B36
{
}

void func_192()//Position - 0x9B3E
{
	struct<15> Var0;
	struct<15> Var15;
	struct<15> Var30;
...
void func_193(char[60] cParam0)//Position - 0xA10A
{
	Local_52[iLocal_278 /*15*/] = { cParam0 };
	iLocal_278++;
}

void func_194(int iParam0)//Position - 0xA129
{
	if (iParam0 == -1)
	{
		iParam0 = func_72();
...
void func_196(int iParam0)//Position - 0xA19C
{
	Global_111549 = iParam0;
}

int func_197(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA1AA
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
...
bool func_198(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0xA544
{
	if (bParam6)
	{
...
bool func_199(int iParam0)//Position - 0xA58B
{
	int iVar0;
...
int func_200(int iParam0)//Position - 0xA5AC
{
	return func_201(iParam0, 1);
}

int func_201(int iParam0, int iParam1)//Position - 0xA5BB
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_202(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0xA60E
{
	func_203(func_214(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_203(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0xA62C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_204(float fParam0, float fParam1, float fParam2)//Position - 0xA82D
{
	float fVar0;
...
int func_205(int iParam0, int iParam1)//Position - 0xA86F
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_206(int iParam0)//Position - 0xA911
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_207(int iParam0)//Position - 0xA924
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_208(int iParam0)//Position - 0xA937
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_209(int iParam0)//Position - 0xA94A
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_210(int iParam0)//Position - 0xA95C
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_211(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_211(bool bParam0, int iParam1, int iParam2)//Position - 0xA981
{
	if (bParam0)
	{
		return iParam1;
...
int func_212(int iParam0)//Position - 0xA998
{
	return iParam0 & 15;
}

int func_213(int iParam0, int iParam1)//Position - 0xA9A5
{
	int iVar0;
	int iVar1;
...
void func_215(var uParam0, int iParam1)//Position - 0xAAF7
{
	if (iParam1 <= 0)
	{
		return;
...
void func_216(var uParam0, int iParam1)//Position - 0xAB7D
{
...
void func_217(var uParam0, int iParam1)//Position - 0xABB0
{
	int iVar0;
	int iVar1;
...
void func_218(var uParam0, int iParam1)//Position - 0xAC01
{
...
void func_219(var uParam0, int iParam1)//Position - 0xAC3B
{
...
void func_220(var uParam0, int iParam1)//Position - 0xAC76
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_221(int iParam0)//Position - 0xACB2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_222(int iParam0, int iParam1)//Position - 0xAD8E
{
...
bool func_224(int iParam0)//Position - 0xADD9
{
	return func_213(func_214(), iParam0);
}

int func_225(int iParam0, int iParam1, int iParam2)//Position - 0xADEB
{
	int iVar0;
	int iVar1;
...
int func_226(int iParam0)//Position - 0xAECF
{
	if (!func_17(iParam0))
	{
		return 7;
...
bool func_227(int iParam0)//Position - 0xAEF3
{
	int iVar0;
	bool bVar1;
...
void func_232(int iParam0)//Position - 0xB204
{
	char cVar0[64];
...
char* func_233(int iParam0, bool bParam1)//Position - 0xB2B9
{
	switch (iParam0)
	{
		case 0:
...
void func_234(int iParam0)//Position - 0xB502
{
	Global_41947 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_235(int iParam0)//Position - 0xB514
{
	func_236(iParam0, 0, func_241(iParam0));
}

void func_236(int iParam0, int iParam1, int iParam2)//Position - 0xB529
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_237(var uParam0)//Position - 0xB558
{
	struct<16> Var0;
	int iVar16;
...
void func_238(int iParam0, var uParam1)//Position - 0xB628
{
	Global_111560.f_24990.f_43[iParam0] = *uParam1;
}

void func_239(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xB640
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_240(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xB7C2
{
...
int func_241(int iParam0)//Position - 0xB7FA
{
	int iVar0;
...
void func_242(var uParam0)//Position - 0xB99D
{
	if (*uParam0 == -1)
	{
		return;
