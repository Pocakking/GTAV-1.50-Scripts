...
void func_63()
{
	...
	if (SYSTEM::TIMERA() > 10000)
	{
		...
		while (MISC::GET_DISTANCE_BETWEEN_COORDS(func_95(PLAYER::PLAYER_ID()), vLocal_53, 1) < 209f && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			SYSTEM::WAIT(0);
		}
		func_64(18);
...
void func_116()
{
	...
	switch (iLocal_94)
	{
		case 0:
			...
			while ((((((!func_143() || !STREAMING::HAS_MODEL_LOADED(joaat("a_m_o_acult_02"))) || !STREAMING::HAS_MODEL_LOADED(joaat("a_m_y_acult_02"))) || !STREAMING::HAS_MODEL_LOADED(-2022916910)) || !STREAMING::HAS_MODEL_LOADED(-1322183878)) || !STREAMING::HAS_MODEL_LOADED(joaat("prop_box_wood05a"))) || !STREAMING::HAS_MODEL_LOADED(joaat("prop_security_case_01")))
			{
				SYSTEM::WAIT(0);
			}
...
void func_192()
{
	if (func_195())
	{
		...
		while (MISC::GET_DISTANCE_BETWEEN_COORDS(func_95(PLAYER::PLAYER_ID()), vLocal_53, 1) < 209f)
		{
			SYSTEM::WAIT(0);
		}
	}
	...
	if (func_194())
	{
		if (iLocal_83)
		{
			...
			{
				OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(Global_40519[9 /*31*/].f_5, Global_40519[9 /*31*/].f_2, 0, 0f, 0);
			}
			if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Global_40519[10 /*31*/].f_2, 6f, Global_40519[10 /*31*/].f_5, 0))
			{
				OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(Global_40519[10 /*31*/].f_5, Global_40519[10 /*31*/].f_2, 0, 0f, 0);
			}
			bLocal_84 = true;
			iLocal_83 = 0;
		}
