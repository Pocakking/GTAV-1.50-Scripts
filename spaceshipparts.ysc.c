...
var func_10(int iParam0)//Position - 0x5D3
{
	return Global_1798[iParam0 /*29*/];
}

int func_11(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x5E2
{
	struct<14> Var0;
...
void func_12(int iParam0)//Position - 0x6FD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_13(int iParam0)//Position - 0x7C1
{
	switch (iParam0)
	{
		case 0:
...
bool func_14(bool bParam0)//Position - 0x82B
{
...
int func_15(int iParam0)//Position - 0x856
{
...
int func_16(var uParam0, int iParam1)//Position - 0x883
{
	int iVar0;
	bool bVar1;
	vector3 vVar2;
...
void func_17(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, char* sParam6, char* sParam7)//Position - 0xA4C
{
	int iVar0;
...
int func_19(int iParam0)//Position - 0xBF9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_20(int iParam0, int iParam1, int iParam2)//Position - 0xCC1
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_21(int iParam0)//Position - 0xCFE
{
	int iVar0;
...
int func_22(int iParam0, int iParam1)//Position - 0x109A
{
	int iVar0;
...
int func_23()//Position - 0x140B
{
	return Global_1312745;
}

int func_24(int iParam0)//Position - 0x1417
{
	if (iParam0 == 3)
	{
		return 815;
...
int func_25(int iParam0, int iParam1)//Position - 0x145E
{
	if (iParam1 < 32)
	{
		return iParam1;
...
int func_26(int iParam0)//Position - 0x147A
{
	if (iParam0 == 3)
	{
		return 30;
...
void func_27(int iParam0)//Position - 0x14CA
{
...
int func_28(var uParam0, var uParam1, vector3 vParam2)//Position - 0x14E4
{
	int iVar0;
...
void func_29(var uParam0)//Position - 0x15A1
{
...
void func_30(var uParam0, var uParam1, int iParam2)//Position - 0x15BA
{
	int iVar0;
...
void func_32(int iParam0, int iParam1)//Position - 0x16B0
{
	Global_98708.f_7 = iParam0;
	Global_98708.f_8 = iParam1;
}

void func_33()//Position - 0x16C8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_34(int iParam0, int iParam1)//Position - 0x176B
{
	int iVar0;
...
int func_35(int iParam0)//Position - 0x17BC
{
	if (iParam0 == 3)
	{
...
void func_36(var uParam0)//Position - 0x180D
{
	int iVar0;
	int iVar1;
...
void func_37(int iParam0, int iParam1)//Position - 0x1890
{
...
int func_38(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x18CD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_39(var uParam0, int iParam1)//Position - 0x1F17
{
	if (uParam0->f_3 <= 0)
	{
	}
...
void func_40(int iParam0, int iParam1, bool bParam2)//Position - 0x1F8B
{
...
void func_41(int iParam0, int iParam1, bool bParam2)//Position - 0x2077
{
	if (iParam1 < 0 || iParam1 >= 64)
	{
		return;
...
void func_42(int iParam0)//Position - 0x20D8
{
...
int func_43(int iParam0)//Position - 0x20F8
{
	int iVar0;
	int iVar1;
...
int func_44(int iParam0)//Position - 0x2184
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_45(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5)//Position - 0x21A5
{
	int iVar0;
...
void func_46(vector3 vParam0)//Position - 0x22BE
{
	int iVar0;
...
bool func_47(var uParam0, int iParam1)//Position - 0x22FC
{
	if (iParam1 < 0 || iParam1 >= 64)
	{
		return 0;
...
bool func_48(int iParam0)//Position - 0x233A
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
void func_49(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2358
{
	uParam0->f_6 = iParam1;
	func_50(&(uParam0->f_1), iParam2, iParam3);
}

void func_50(int iParam0, var uParam1, var uParam2)//Position - 0x2372
{
	int iVar0;
	int iVar1;
...
void func_51(var uParam0, int iParam1, int iParam2, char* sParam3)//Position - 0x23DB
{
	*uParam0 = iParam1;
	uParam0->f_7 = iParam2;
	uParam0->f_8 = sParam3;
...
Vector3 func_53(int iParam0, int iParam1)//Position - 0x2706
{
	switch (iParam0)
	{
		case 0:
...
int func_54(int iParam0)//Position - 0x2F52
{
	int iVar0;
	int iVar1;
...
int func_56(int iParam0)//Position - 0x3022
{
	int iVar0;
	int iVar1;
...
void func_59(int iParam0, int iParam1)//Position - 0x30F5
{
	if (iParam0 == 146 || iParam0 == -1)
	{
		return;
...
bool func_60(var uParam0)//Position - 0x313A
{
	if (uParam0->f_3 <= 0)
	{
	}
