...
int func_2()//Position - 0x10E
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_90))
	{
		if (!GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(iLocal_87))
		{
			...
			iLocal_87 = GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD(&cLocal_90, vLocal_83 + vVar0, 0f, 0f, 0f, 1f, 0, 0, 0, false);
		}
	}
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			fVar3 = PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_96029);
			switch (iLocal_224)
			{
				case 0:
					if (fLocal_141 < 0f)
					...
					if (fVar3 > fLocal_141)
					{
						...
						else if (GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY(&cLocal_106, iLocal_72, 0f, 0f, -1f, 0f, 0f, 0f, 1f, 0, 0, 0))
						{
							if (MISC::ARE_STRINGS_EQUAL(&cLocal_106, "scr_meth_pipe_smoke"))
							{
								func_17(PLAYER::PLAYER_PED_ID(), 0, 1);
				...
				case 2:
					...
					{
						if (GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD(&cLocal_122, vLocal_83 + vLocal_138, 0f, 0f, 0f, 1f, 0, 0, 0))
						{
							iLocal_224++;
						}
					}
...
int func_3(int iParam0, int iParam1)//Position - 0x3DF
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
	...
	switch (iParam1)
	{
		...
		case 4:
			...
			switch (ENTITY::GET_ENTITY_MODEL(*iParam0))
			{
				...
				case joaat("prop_toiletfoot_static"):
					...
					vVar17 = { 0f, 0f, 53.6f };
					ENTITY::SET_ENTITY_COORDS(*iParam0, vVar14, 1, false, 0, 1);
		...
		case 5:
			FIRE::ADD_EXPLOSION(ENTITY::GET_ENTITY_COORDS(*iParam0, true), 0, 0.5f, 1, 0, 1065353216, 0);
			OBJECT::DELETE_OBJECT(iParam0);
			return 1;
			break;
		...
		case 8:
			...
			GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD(sVar26, vVar20, vVar23, 1f, 0, 0, 0);
			OBJECT::DELETE_OBJECT(iParam0);
			return 1;
			break;
		...
		case 9:
			...
			GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD(sVar33, vVar27, vVar30, 1f, 0, 0, 0);
			OBJECT::DELETE_OBJECT(iParam0);
			*iParam0 = OBJECT::CREATE_OBJECT(iVar34, vVar27, true, true, false);
			...
			if (func_6(iVar0, &sVar35, &cVar51, &iVar67))
			{
				if (func_4(iVar0, &sVar68, &cVar84, &cVar100, &uVar116, &uVar117))
				{
					...
					{
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(*iParam0, Global_96029, &sVar35, &sVar68, 1000f, -8f, iVar67, 1148846080);
					}
				}
			}
...
int func_4(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5)//Position - 0xABD
{
	*uParam4 = 9;
	*uParam5 = 0;
	switch (iParam0)
...
void func_5(int iParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0x21ED
{
...
int func_6(int iParam0, char* sParam1, char* sParam2, var uParam3)//Position - 0x220D
{
	*uParam3 = 0;
	StringCopy(sParam2, "", 64);
	switch (iParam0)
...
void func_7(bool bParam0)//Position - 0x2403
{
	if (bParam0)
	{
		func_14();
...
void func_8(int iParam0)//Position - 0x2466
{
	if (func_12())
	{
		return;
...
void func_10(bool bParam0, bool bParam1)//Position - 0x2517
{
	if (bParam0)
	{
		if (func_13(0))
...
bool func_11()//Position - 0x258B
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

bool func_12()//Position - 0x259C
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

int func_13(int iParam0)//Position - 0x25AE
{
	if (iParam0 == 1)
	{
...
void func_17(int iParam0, int iParam1, int iParam2)//Position - 0x2672
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_18(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x27CB
{
	func_19(iParam0, iParam1, iParam2, iParam3, 0, iParam4);
}

void func_19(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x27E2
{
	int iVar0;
...
int func_21(int iParam0, int iParam1, int iParam2)//Position - 0x2895
{
...
int func_22(int iParam0, int iParam1, int iParam2)//Position - 0x28B0
{
	int iVar0;
...
void func_23(int iParam0, int iParam1)//Position - 0x28FC
{
	int iVar0;
	int iVar1;
...
void func_24(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x297B
{
	func_19(iParam0, iParam1, iParam2, 0, iParam3, 1);
}

int func_25(int iParam0)//Position - 0x2991
{
	int iVar0;
...
int func_26(int iParam0)//Position - 0x29C2
{
	int iVar0;
...
int func_27(int iParam0)//Position - 0x29F2
{
	int iVar0;
...
void func_28(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4, bool bParam5)//Position - 0x2A33
{
	int iVar0;
...
int func_30(int iParam0)//Position - 0x2B6D
{
	int iVar0;
	int iVar1;
...
int func_31(int iParam0, int iParam1, bool bParam2)//Position - 0x2BB0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_33(int iParam0)//Position - 0x2C9B
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_34(int iParam0)//Position - 0x2CBC
{
	int iVar0;
...
int func_35(int iParam0)//Position - 0x2D05
{
	int iVar0;
	int iVar1;
	...
	if (!iLocal_73 == 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_72))
		{
			...
			else if (iLocal_80 != -1)
			{
				...
				ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_72, PLAYER::PLAYER_PED_ID(), PED::GET_PED_BONE_INDEX(PLAYER::PLAYER_PED_ID(), iLocal_80), vLocal_74, vLocal_77, 0, 0, 0, 0, 2, 1);
			}
			else
			{
				iLocal_72 = OBJECT::CREATE_OBJECT(iLocal_73, vLocal_83 + vLocal_74, true, true, false);
				ENTITY::SET_ENTITY_COORDS(iLocal_72, vLocal_83 + vLocal_74, 1, false, 0, 1);
				ENTITY::SET_ENTITY_ROTATION(iLocal_72, Vector(uLocal_86, 0f, 0f) + vLocal_77, 2, 1);
...
int func_38(int iParam0, int iParam1)//Position - 0x2E95
{
	vector3 vVar0;
	float fVar3;
...
int func_39(var uParam0)//Position - 0x2F79
{
	return uParam0;
}

bool func_40(var uParam0, var uParam1)//Position - 0x2F83
{
	return (uParam0 && uParam1) != 0;
}

int func_41()//Position - 0x2F92
{
	func_42();
...
bool func_43(int iParam0)//Position - 0x30D5
{
	return iParam0 < 3;
}

int func_44(int iParam0)//Position - 0x30E1
{
	int iVar0;
	int iVar1;
...
int func_45(int iParam0)//Position - 0x311E
{
	if (func_43(iParam0))
	{
...
var func_46(int iParam0)//Position - 0x3143
{
	return Global_1798[iParam0 /*29*/];
}

bool func_47(int iParam0)//Position - 0x3152
{
	return Global_41396 == iParam0;
}

void func_48()//Position - 0x3160
{
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
...
void func_49()//Position - 0x31A0
{
	func_50((Global_98392 - 1));
}

void func_50(int iParam0)//Position - 0x31B2
{
	Global_98392 = iParam0;
}

void func_51()//Position - 0x31C0
{
	func_50(0);
}

void func_52()//Position - 0x31CD
{
	int iVar0;
	bool bVar1;
...
void func_53()//Position - 0x331D
{
	...
	func_57(iLocal_70, &vLocal_83, &uLocal_86, &cVar0);
	switch (iLocal_70)
	{
		case 273:
		case 274:
...
int func_54(struct<109> Param0, var uParam109)//Position - 0x36B4
{
	uParam109->f_119 = 0;
	switch (Param0.f_2)
	{
...
void func_55(var uParam0, int iParam1, int iParam2, int iParam3, vector3 vParam4, float fParam7)//Position - 0x6A2E
{
...
void func_56(var uParam0)//Position - 0x6A58
{
	func_55(uParam0, 145, 1435919172, 1435919172, 0f, 0f, 0f, 0f);
}

int func_57(int iParam0, var uParam1, var uParam2, char* sParam3)//Position - 0x6A76
{
	int iVar0;
...
bool func_58(var uParam0)//Position - 0x6C69
{
	int iVar0;
	vector3 vVar1;
	float fVar4;
...
bool func_59(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x6D24
{
	if (bParam6)
	{
...
int func_60(int iParam0, var uParam1, char* sParam2)//Position - 0x6D6B
{
	vector3 vVar0;
	int iVar3;
	var uVar4;
...
int func_61(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0x9274
{
	switch (iParam1)
	{
		case 0:
...
int func_63(int iParam0, var uParam1, var uParam2)//Position - 0xB1E2
{
	switch (iParam0)
	{
		case 11:
...
char* func_64(int iParam0)//Position - 0xBB51
{
	switch (iParam0)
	{
		case 2014101067:
