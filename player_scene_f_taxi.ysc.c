...
int func_4()//Position - 0x1B6
{
	...
	if (!func_3(&uVar0))
	{
		...
		else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96029))
		{
			...
			if (!func_5(Global_98390, iLocal_74, 2))
			{
				if (fVar1 >= 0.9f)
				{
					PED::SET_PED_INTO_VEHICLE(Global_98390, iLocal_74, 2);
				}
			}
			if (!iLocal_180)
			{
		...
		else
		{
			...
			ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_74, -8f, 1);
			SYSTEM::WAIT(100);
			if (!func_3(&uVar0))
			{
...
void func_22()//Position - 0x6A5
{
	...
	iVar0 = 0;
	while ((!ENTITY::DOES_ENTITY_EXIST(Global_98390) || !ENTITY::DOES_ENTITY_EXIST(iLocal_74)) || (!STREAMING::HAS_MODEL_LOADED(iLocal_73) && iVar0 < 400))
	{
	...
	{
		VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_74, true, true, 0);
		VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_74, 2);
		VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_74, 1084227584);
		iLocal_72 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_74, 4, iLocal_73, -1, 1, true);
...
void func_27(var uParam0, int iParam1, int iParam2, int iParam3, vector3 vParam4, float fParam7)//Position - 0x4349
{
...
int func_36()//Position - 0xA3C6
{
	return 0;
}

int func_37()//Position - 0xA3CF
{
	return 1;
}

int func_38()//Position - 0xA3D8
{
	return 1;
}

int func_39()//Position - 0xA3E1
{
...
int func_41(int iParam0)//Position - 0xA4B5
{
...
int func_42(int iParam0, var uParam1, var uParam2, char* sParam3)//Position - 0xA735
{
	int iVar0;
...
bool func_43(var uParam0)//Position - 0xA930
{
	int iVar0;
	vector3 vVar1;
	float fVar4;
...
bool func_44(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0xA9EB
{
	if (bParam6)
	{
...
int func_45(int iParam0, var uParam1, char* sParam2)//Position - 0xAA32
{
	vector3 vVar0;
	int iVar3;
	var uVar4;
...
int func_46(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0xD039
{
	switch (iParam1)
	{
		case 0:
...
int func_48(int iParam0, var uParam1, var uParam2)//Position - 0xEFA7
{
	switch (iParam0)
	{
		case 11:
...
char* func_49(int iParam0)//Position - 0xF916
{
	switch (iParam0)
	{
		case 2014101067:
