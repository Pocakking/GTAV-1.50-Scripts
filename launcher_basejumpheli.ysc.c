				...
				case 3:
					...
					else
					{
						...
						if (!func_137(3) && !Global_98703)
						{
							...
							{
								if ((!func_159(uLocal_94, 1) || !ENTITY::DOES_ENTITY_EXIST(func_136())) && !Global_98703)
								{
									func_152(10);
									break;
								}
				...
				case 6:
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_52))
					{
						...
						if (iLocal_99 != -1)
						{
							if (func_159(Global_110211, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_20(iLocal_99), 0, Global_98706, 0);
								func_6(func_20(iLocal_99), 0, Global_98706, 1, 0);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_20(iLocal_99), 0, Global_98706, 0);
								func_6(func_20(iLocal_99), 0, Global_98706, 0, 0);
							}
						}
						func_5();
						func_166(&Global_110211, 0);
...
int func_27()//Position - 0xFC2
{
	...
	Global_111560.f_18962 = iLocal_121;
	switch (iLocal_121)
	{
		case 0:
		case 1:
...
void func_51()//Position - 0x57DB
{
	...
	if (func_107(Local_287.f_3, Local_287, 1, 1, 1, 1, 0) || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(Local_287.f_3) && !PED::IS_PED_INJURED(Local_287.f_3))
		{
			...
			{
				TASK::TASK_VEHICLE_MISSION_COORS_TARGET(Local_287.f_3, Local_287, ENTITY::GET_ENTITY_COORDS(Local_287, true) + Vector(100f, 100f, 100f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(Local_287) + Vector(500f, 0f, 0f), 4, VEHICLE::GET_VEHICLE_ESTIMATED_MAX_SPEED(Local_287), 262144, 50f, 50f, 1);
			}
			else
			{
	...
	if (fVar10 < 10000f)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(Local_287.f_3))
		{
			...
			{
				Local_287.f_3 = PED::CREATE_PED_INSIDE_VEHICLE(Local_287, 4, func_105(iLocal_121), -1, 1, true);
				...
				VEHICLE::SET_VEHICLE_ENGINE_ON(Local_287, true, true, 0);
				VEHICLE::SET_HELI_BLADES_SPEED(Local_287, fVar11);
			}
		}
		else
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Local_287.f_3, true, 0);
	...
	else if (fVar10 > 12100f)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_287.f_3))
		{
			...
			{
				ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iVar5, true, 0);
	...
	if ((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_287, 1) && !PED::IS_PED_JACKING(PLAYER::PLAYER_PED_ID())) && func_76(Local_287.f_3, Local_287))
	{
		...
		if (vVar7.x < 0f || vVar7.y < 1f)
		{
			...
			if (!CAM::DOES_CAM_EXIST(iLocal_461))
			{
				func_65(0, 0, 1);
				func_58(1);
				iLocal_461 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, func_57(iLocal_121), func_56(iLocal_121), func_55(iLocal_121), 0, 2);
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_287, 0))
			{
				...
				if (iVar0 != 0 && iVar0 != 1)
				{
					...
					func_22(&iLocal_462);
					while (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_287, 0) && func_53(&iLocal_462) < 2f)
					{
						SYSTEM::WAIT(0);
					}
					func_9(&iLocal_462);
					...
					if (!ENTITY::IS_ENTITY_DEAD(Local_287.f_3, 0) && !ENTITY::IS_ENTITY_DEAD(Local_287, 0))
					{
						...
						TASK::TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_287, ENTITY::GET_ENTITY_COORDS(Local_287, true) + Vector(100f, 100f, 100f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(Local_287) + Vector(500f, 0f, 0f), 4, VEHICLE::GET_VEHICLE_ESTIMATED_MAX_SPEED(Local_287), 262144, 50f, 50f, 1);
	...
	if (!bVar12)
	{
		if ((VEHICLE::IS_VEHICLE_DRIVEABLE(Local_287, 0) && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_287, true)) < 225f) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
		{
...
void func_52(char[4] cParam0)//Position - 0x601E
{
...
void func_61(bool bParam0, bool bParam1)//Position - 0x63D8
{
	if (bParam0)
	{
		if (func_118(0))
...
bool func_62()//Position - 0x644C
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

bool func_63()//Position - 0x645D
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

void func_64()//Position - 0x646F
{
...
void func_65(int iParam0, int iParam1, int iParam2)//Position - 0x6498
{
...
void func_66(int iParam0, bool bParam1)//Position - 0x64F0
{
	if (bParam1)
	{
...
void func_67(bool bParam0, bool bParam1, var uParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x6512
{
	if (bParam0)
	{
...
bool func_68()//Position - 0x664B
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_69(int iParam0, int iParam1)//Position - 0x6668
{
	bool bVar0;
...
int func_70(int iParam0, bool bParam1)//Position - 0x66B3
{
	int iVar0;
	int iVar1;
...
int func_71()//Position - 0x66F4
{
	return Global_1312745;
}

int func_72(int iParam0)//Position - 0x6700
{
...
bool func_73()//Position - 0x6742
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_74(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x6753
{
	int iVar0;
...
void func_75(int iParam0)//Position - 0x6786
{
	if (iParam0 == 1)
	{
...
int func_76(int iParam0, int iParam1)//Position - 0x67A9
{
...
int func_77(int iParam0, int iParam1)//Position - 0x6806
{
...
int func_78(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x6878
{
...
int func_79(char* sParam0, int iParam1, bool bParam2)//Position - 0x68C6
{
	Global_20806 = 0;
...
bool func_82(int iParam0)//Position - 0x6C33
{
	return func_83(iParam0, 20);
}

bool func_83(int iParam0, int iParam1)//Position - 0x6C43
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_84()//Position - 0x6C5E
{
	return -1;
}

void func_85()//Position - 0x6C67
{
	int iVar0;
...
var func_89()//Position - 0x6E68
{
	func_90();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_90()//Position - 0x6E81
{
	int iVar0;
...
bool func_91(int iParam0)//Position - 0x6F7E
{
	return iParam0 < 3;
}

int func_92(int iParam0)//Position - 0x6F8A
{
	int iVar0;
	int iVar1;
...
int func_93(int iParam0)//Position - 0x6FC7
{
	if (func_91(iParam0))
	{
...
var func_94(int iParam0)//Position - 0x6FEC
{
	return Global_1798[iParam0 /*29*/];
}

void func_95()//Position - 0x6FFB
{
	int iVar0;
...
void func_97(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x70A9
{
...
char* func_98(int iParam0)//Position - 0x70FF
{
	bool bVar0;
...
char* func_99(bool bParam0, char* sParam1, char* sParam2)//Position - 0x71C1
{
	if (bParam0)
	{
		return sParam1;
...
void func_100(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x71D8
{
...
char* func_101(int iParam0)//Position - 0x7273
{
	return "EXT1HELIPILOT";
}

char* func_102(int iParam0)//Position - 0x727F
{
	switch (iParam0)
	{
		case 0:
...
void func_103()//Position - 0x72FA
{
	iLocal_48++;
}

void func_104(int iParam0, int iParam1)//Position - 0x7308
{
...
int func_105(int iParam0)//Position - 0x73AF
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_106(int iParam0)//Position - 0x742F
{
	switch (iParam0)
	{
		case 0:
...
int func_107(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x7579
{
	int iVar0;
	vector3 vVar1;
...
float func_108(int iParam0, bool bParam1)//Position - 0x7768
{
	return func_109(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), iParam0, bParam1);
}

float func_109(int iParam0, int iParam1, bool bParam2)//Position - 0x7780
{
	vector3 vVar0;
	vector3 vVar3;
...
float func_110(bool bParam0, float fParam1, float fParam2)//Position - 0x77DE
{
	if (bParam0)
	{
		return fParam1;
...
int func_111(int iParam0)//Position - 0x77F5
{
	switch (iParam0)
	{
		case 0:
...
int func_112(int iParam0, bool bParam1)//Position - 0x784B
{
	int iVar0;
...
int func_113(int iParam0)//Position - 0x7903
{
	int iVar0;
...
void func_114(int iParam0)//Position - 0x793E
{
	int iVar0;
...
void func_115(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x7995
{
	int iVar0;
...
var func_117()//Position - 0x7ACD
{
	return Global_73784;
}

int func_118(int iParam0)//Position - 0x7AD9
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
bool func_119(int iParam0, int iParam1)//Position - 0x7B33
{
	switch (iParam0)
	{
		case 5:
...
bool func_120()//Position - 0x7B6E
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

int func_121()//Position - 0x7B83
{
...
bool func_122(bool bParam0)//Position - 0x7B9D
{
	if (bParam0)
	{
...
int func_123()//Position - 0x7BC6
{
	return 1;
}

void func_124(var uParam0, int iParam1)//Position - 0x7BCF
{
	func_125(uParam0, iParam1);
}

void func_125(var uParam0, var uParam1)//Position - 0x7BDF
{
	*uParam0 = (*uParam0 || uParam1);
}

bool func_126()//Position - 0x7BF0
{
	int iVar0;
	bool bVar1;
...
int func_127(int iParam0)//Position - 0x7CFA
{
	int iVar0;
...
var func_128()//Position - 0x8418
{
	return Global_98708.f_1;
}

int func_129()//Position - 0x8426
{
	if (Global_95621 != -1)
	{
...
bool func_131()//Position - 0x8476
{
	return Global_98721.f_346 > 0;
}

bool func_132()//Position - 0x8487
{
	return Global_98721.f_345 > 0;
}

var func_133()//Position - 0x8498
{
	return Global_1312873;
}

int func_134()//Position - 0x84A4
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
var func_136()//Position - 0x84DA
{
	return Global_94531;
}

int func_137(int iParam0)//Position - 0x84E6
{
	switch (iParam0)
	{
		case 0:
...
bool func_138(int iParam0)//Position - 0x8558
{
	int iVar0;
...
bool func_139(int iParam0)//Position - 0x8594
{
	return Global_41396 == iParam0;
}

void func_140(var uParam0, int iParam1)//Position - 0x85A2
{
	*uParam0 = (*uParam0 || iParam1);
}

void func_141()//Position - 0x85B3
{
	if (bLocal_457)
	{
		switch (iLocal_121)
...
void func_142(vector3 vParam0, float fParam3)//Position - 0x86D3
{
	var uVar0;
	bool bVar1;
...
bool func_143()//Position - 0x8803
{
	return func_144(&uLocal_119);
}

int func_144(var uParam0)//Position - 0x8811
{
	int iVar0;
...
void func_146(var uParam0)//Position - 0x88AD
{
	int iVar0;
...
int func_148(var uParam0, int iParam1)//Position - 0x8906
{
	int iVar0;
	int iVar1;
...
int func_149(var uParam0)//Position - 0x8963
{
	int iVar0;
...
void func_150(int iParam0)//Position - 0x898F
{
	if (iParam0 == 2)
	{
	}
...
void func_152(int iParam0)//Position - 0x8A23
{
	iLocal_95 = iParam0;
}

void func_153(int iParam0, bool bParam1, bool bParam2)//Position - 0x8A2F
{
	int iVar0;
	bool bVar1;
...
bool func_156(int iParam0, int iParam1)//Position - 0x8B7B
{
	bool bVar0;
...
bool func_157(int iParam0)//Position - 0x8BC8
{
	return func_158(iParam0, Global_41396);
}

int func_158(int iParam0, int iParam1)//Position - 0x8BD9
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_159(var uParam0, int iParam1)//Position - 0x8DBA
{
	return (uParam0 && iParam1) != 0;
}

void func_160()//Position - 0x8DC9
{
	iLocal_99 = 0;
	if (ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
...
int func_161(int iParam0)//Position - 0x8F5B
{
	switch (iParam0)
	{
		case 91:
...
int func_162(int iParam0)//Position - 0x9073
{
...
bool func_163(int iParam0)//Position - 0x909F
{
	return Global_110647[iParam0 /*10*/].f_1;
}

int func_164(vector3 vParam0, int iParam3)//Position - 0x90B1
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_165(int iParam0)//Position - 0x9100
{
	switch (iParam0)
	{
		case 0:
...
void func_166(var uParam0, int iParam1)//Position - 0x9147
{
	func_167(uParam0, iParam1);
}

void func_167(var uParam0, var uParam1)//Position - 0x9157
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

void func_168(bool bParam0)//Position - 0x916C
{
	if (bParam0)
	{
		if (iLocal_105 != 263)
