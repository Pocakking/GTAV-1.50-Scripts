			...
			switch (iLocal_95)
			{
				...
				case 3:
					...
					if (!func_86(iLocal_100))
					{
						...
						{
							bVar1 = true;
							if (MISC::ARE_STRINGS_EQUAL(&(Global_98669.f_3), &cLocal_69))
							{
								cLocal_69 = { Local_53 };
								bVar1 = false;
							}
					...
					else
					{
						...
						if (!func_74(3) && !Global_98703)
						{
							...
							{
								if ((!func_88(uLocal_94, 1) || !ENTITY::DOES_ENTITY_EXIST(func_73())) && !Global_98703)
								{
									func_81(10);
									break;
								}
						...
						if (bVar2)
						{
							...
							{
								if (!ENTITY::IS_ENTITY_AT_COORD(PED::GET_VEHICLE_PED_IS_IN(iLocal_85, 0), ScriptParam_0.f_1[0 /*3*/], fLocal_117, fLocal_117, 20f, false, false, iLocal_103))
								{
									bVar2 = false;
								}
							}
...
void func_42(char[4] cParam0, int iParam1)//Position - 0x16FC
{
...
void func_45(char[4] cParam0, int iParam1, int iParam2)//Position - 0x187F
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam1);
...
var func_52(int iParam0)//Position - 0x1A78
{
	return Global_1798[iParam0 /*29*/];
}

void func_53(char[4] cParam0, int iParam1, int iParam2)//Position - 0x1A87
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam1);
...
var func_54()//Position - 0x1AA9
{
	return Global_73784;
}

int func_55(int iParam0)//Position - 0x1AB5
{
	if (iParam0 == 1)
	{
...
bool func_57()//Position - 0x1B4A
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

int func_58()//Position - 0x1B5F
{
...
bool func_59(bool bParam0)//Position - 0x1B79
{
	if (bParam0)
	{
...
void func_60(var uParam0, int iParam1)//Position - 0x1BA2
{
	func_61(uParam0, iParam1);
}

void func_61(var uParam0, var uParam1)//Position - 0x1BB2
{
...
int func_64(int iParam0)//Position - 0x1CF2
{
	int iVar0;
...
var func_65()//Position - 0x240F
{
	return Global_98708.f_1;
}

int func_66()//Position - 0x241D
{
	if (Global_95621 != -1)
	{
...
bool func_68()//Position - 0x246D
{
	return Global_98721.f_346 > 0;
}

bool func_69()//Position - 0x247E
{
	return Global_98721.f_345 > 0;
}

var func_70()//Position - 0x248F
{
	return Global_1312873;
}

int func_71()//Position - 0x249B
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
var func_73()//Position - 0x24D1
{
	return Global_94531;
}

int func_74(int iParam0)//Position - 0x24DD
{
	switch (iParam0)
	{
		case 0:
...
bool func_75(int iParam0)//Position - 0x254F
{
	int iVar0;
...
bool func_76(int iParam0)//Position - 0x258B
{
	return Global_41396 == iParam0;
}

void func_77(var uParam0, int iParam1)//Position - 0x2599
{
	*uParam0 = (*uParam0 || iParam1);
}

void func_78()//Position - 0x25AA
{
}

int func_79()//Position - 0x25B2
{
	return 1;
}

void func_80()//Position - 0x25BB
{
}

void func_81(int iParam0)//Position - 0x25C3
{
	iLocal_95 = iParam0;
}

void func_82(int iParam0, bool bParam1, bool bParam2)//Position - 0x25CF
{
	int iVar0;
	bool bVar1;
...
bool func_85(int iParam0, int iParam1)//Position - 0x271B
{
	bool bVar0;
...
bool func_86(int iParam0)//Position - 0x2768
{
	return func_87(iParam0, Global_41396);
}

int func_87(int iParam0, int iParam1)//Position - 0x2779
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_88(var uParam0, int iParam1)//Position - 0x295A
{
	return (uParam0 && iParam1) != 0;
}

void func_89()//Position - 0x2969
{
...
int func_90(int iParam0)//Position - 0x29DD
{
	switch (iParam0)
	{
		case 91:
...
int func_91(bool bParam0)//Position - 0x2AF5
{
	if (bParam0)
	{
		return 200;
...
void func_92(var uParam0, int iParam1)//Position - 0x2B0C
{
	func_93(uParam0, iParam1);
}

void func_93(var uParam0, var uParam1)//Position - 0x2B1C
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

void func_94(bool bParam0)//Position - 0x2B31
{
	if (bParam0)
	{
		if (iLocal_105 != 263)
...
void func_96()//Position - 0x2BDC
{
}

int func_97(char* sParam0, int iParam1)//Position - 0x2BE4
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam1);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
