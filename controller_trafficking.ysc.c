...
int func_17(int iParam0)//Position - 0xDF9
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_18(var uParam0)//Position - 0xE19
{
	int iVar0;
...
int func_19(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0xEC9
{
	char* sVar0;
...
int func_20(int iParam0, int iParam1, bool bParam2)//Position - 0xFF5
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_21(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x1066
{
...
int func_22()//Position - 0x1137
{
	func_23();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_23()//Position - 0x1150
{
	int iVar0;
...
bool func_24(int iParam0)//Position - 0x124D
{
	return Global_41396 == iParam0;
}

int func_25(int iParam0)//Position - 0x125B
{
	if (func_13(iParam0))
	{
...
var func_26(int iParam0)//Position - 0x1280
{
	return Global_1798[iParam0 /*29*/];
}

int func_27(int iParam0)//Position - 0x128F
{
	int iVar0;
	int iVar1;
...
int func_28(int iParam0)//Position - 0x12CC
{
	if (Global_41396 == 15)
	{
		return 0;
...
bool func_29(int iParam0)//Position - 0x12EE
{
	return func_30(iParam0, Global_41396);
}

int func_30(int iParam0, int iParam1)//Position - 0x12FF
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_31(int iParam0)//Position - 0x14E0
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	switch (iLocal_53)
	{
		...
		case 3:
			...
			{
				MISC::CLEAR_AREA_OF_VEHICLES(vLocal_55, 4f, 0, 0, 0, 0, false, 0);
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_54))
				{
					VEHICLE::DELETE_VEHICLE(&iLocal_54);
				}
				iLocal_54 = VEHICLE::CREATE_VEHICLE(func_162(), vLocal_55, fLocal_58, 1, 1, 0);
		...
		case 6:
			if (SCRIPT::HAS_SCRIPT_LOADED("Traffick_Ground"))
			{
				...
				if (iVar3 == 1)
				{
					...
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_54, true, 0);
					ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_54);
		...
		case 7:
			if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_30))
			{
				...
				else
				{
					...
					Global_111560.f_19978.f_12 = iVar101;
					func_1(106, 0, 0);
					Global_111560.f_19978.f_13 = 0;
				}
				*iParam0 = 0;
...
int func_32(int iParam0)//Position - 0x1A40
{
	return func_33(func_53(), iParam0);
}

int func_33(int iParam0, int iParam1)//Position - 0x1A52
{
	int iVar0;
	int iVar1;
...
int func_34(int iParam0)//Position - 0x1B5E
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_35(int iParam0)//Position - 0x1B71
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_36(int iParam0)//Position - 0x1B84
{
...
int func_38(int iParam0)//Position - 0x1BA9
{
	return iParam0 & 15;
}

var func_39(int iParam0)//Position - 0x1BB6
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_40(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_40(bool bParam0, int iParam1, int iParam2)//Position - 0x1BDB
{
	if (bParam0)
	{
		return iParam1;
...
int func_41(int iParam0)//Position - 0x1BF2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_42(int iParam0, int iParam1)//Position - 0x1CCE
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
void func_43(var uParam0, int iParam1)//Position - 0x1D70
{
	func_44(uParam0, iParam1);
}

void func_44(var uParam0, var uParam1)//Position - 0x1D80
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

void func_45(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1D95
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_46(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1F17
{
...
void func_47(var uParam0, int iParam1)//Position - 0x1F4F
{
	if (iParam1 <= 0)
	{
		return;
...
void func_48(var uParam0, int iParam1)//Position - 0x1FD5
{
	int iVar0;
	int iVar1;
...
void func_49(var uParam0, int iParam1)//Position - 0x2026
{
...
void func_50(var uParam0, int iParam1)//Position - 0x2059
{
...
void func_51(var uParam0, int iParam1)//Position - 0x2093
{
...
void func_52(var uParam0, int iParam1)//Position - 0x20CE
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
void func_55(int iParam0)//Position - 0x21A9
{
	if (iParam0 == 1)
	{
...
void func_57()//Position - 0x21F0
{
	StringCopy(&Global_76809, "", 16);
	StringCopy(&Global_76813, "", 16);
}

void func_58()//Position - 0x220A
{
	int iVar0;
...
void func_62(int iParam0)//Position - 0x22DC
{
	if (iParam0 == 1)
	{
		Global_41945 = 1;
...
void func_63()//Position - 0x22F5
{
	func_64(&Global_105109);
}

void func_64(var uParam0)//Position - 0x2305
{
	int iVar0;
	int iVar1;
...
void func_65(var uParam0)//Position - 0x2895
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_66(var uParam0)//Position - 0x28B0
{
...
void func_67(var uParam0)//Position - 0x28DF
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_68(var uParam0)//Position - 0x28FD
{
	int iVar0;
...
void func_69(var uParam0)//Position - 0x29DD
{
	*uParam0 = -15;
}

void func_70()//Position - 0x29EB
{
	StringCopy(&Global_102117, "", 32);
	func_64(&Global_102125);
}

void func_71(int iParam0)//Position - 0x2A04
{
	if (*iParam0 == -1)
	{
		return;
...
void func_72(int iParam0)//Position - 0x2A41
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_73(int iParam0)//Position - 0x2A9A
{
...
int func_74(int iParam0)//Position - 0x2B1D
{
	int iVar0;
...
void func_75(int iParam0, int iParam1, int iParam2)//Position - 0x2B4E
{
	func_76(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_76(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2B63
{
	int iVar0;
...
int func_78(int iParam0, int iParam1, int iParam2)//Position - 0x2C16
{
...
int func_79(int iParam0, int iParam1, int iParam2)//Position - 0x2C31
{
	int iVar0;
...
int func_80(int iParam0)//Position - 0x2C7D
{
	int iVar0;
...
void func_81(int iParam0)//Position - 0x2CC6
{
	var uVar0;
	vector3 vVar1[24];
...
void func_82(char[4] cParam0, int iParam1)//Position - 0x2D1D
{
	MISC::CLEAR_BIT(&(Global_98669.f_20), 17);
	func_83(cParam0, iParam1, 0);
}

void func_83(char[4] cParam0, int iParam1, int iParam2)//Position - 0x2D3A
{
...
void func_85(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x3A12
{
	int iVar0;
	int iVar1;
...
int func_86(var uParam0)//Position - 0x489C
{
...
void func_87(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x48BE
{
	int iVar0;
	int iVar1;
...
int func_88(int iParam0, int iParam1, int iParam2)//Position - 0x4A5E
{
	int iVar0;
	var uVar1;
...
int func_89(var uParam0)//Position - 0x4A90
{
	int iVar0;
	int iVar1;
...
var func_90()//Position - 0x4AC4
{
	return Global_1312745;
}

int func_91(int iParam0, int iParam1)//Position - 0x4AD0
{
	var uVar0;
	var uVar1;
	
	uVar0 = Global_2576213[iParam0 /*3*/][func_89(iParam1)];
...
void func_92(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x4AFC
{
	int iVar0;
...
void func_93(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x5044
{
	int iVar0;
...
int func_94()//Position - 0x5285
{
	func_23();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_95(int iParam0, bool bParam1)//Position - 0x529E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_96(int iParam0, var uParam1)//Position - 0x5391
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_98(Var11.f_1)) && iVar72 < 51)
			{
...
int func_97(int iParam0)//Position - 0x5619
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_98(int iParam0)//Position - 0x56B4
{
...
int func_99(int iParam0, int iParam1)//Position - 0x5846
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_100(int iParam0, var uParam1)//Position - 0x63B7
{
	int iVar0;
	int iVar1;
...
int func_101(int iParam0)//Position - 0x63F2
{
	int iVar0;
...
void func_102(int iParam0)//Position - 0x6666
{
	int iVar0;
...
void func_103(var uParam0, int iParam1)//Position - 0x66A2
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_104(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x6BFB
{
	int iVar0;
	int iVar1;
...
bool func_105(int iParam0, var uParam1, var uParam2)//Position - 0x6C3F
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_106(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x735A
{
	if (bParam6)
	{
...
int func_107(var uParam0)//Position - 0x73A1
{
...
bool func_108(int iParam0)//Position - 0x73FC
{
	return func_109(iParam0, 0, 1);
}

int func_109(int iParam0, int iParam1, bool bParam2)//Position - 0x740C
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_110(int iParam0)//Position - 0x7476
{
	switch (iParam0)
	{
		case 0:
...
int func_111()//Position - 0x77A6
{
	return Global_30736;
}

int func_112(int iParam0)//Position - 0x77B1
{
	return func_109(iParam0, 5, 1);
}

int func_113(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x77C1
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_114(int iParam0, bool bParam1)//Position - 0x7863
{
	switch (iParam0)
	{
		case -1:
...
int func_115(int iParam0)//Position - 0x7E80
{
	if (iParam0 != func_124())
	{
...
Vector3 func_116(int iParam0, int iParam1)//Position - 0x7EDE
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_117(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7F8C
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_118(vector3 vParam0, float fParam3)//Position - 0x8022
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_119(int iParam0)//Position - 0x8066
{
	struct<6> Var0;
...
struct<6> func_120(int iParam0)//Position - 0x81EA
{
	return func_121(iParam0);
}

struct<6> func_121(int iParam0)//Position - 0x81F8
{
	struct<6> Var0;
...
int func_122(int iParam0, var uParam1)//Position - 0x8CBF
{
	switch (iParam0)
	{
		case 0:
...
int func_123(int iParam0)//Position - 0x8D41
{
	if (iParam0 != func_124())
	{
...
int func_124()//Position - 0x8D9F
{
	return -1;
}

Vector3 func_125(int iParam0)//Position - 0x8DA8
{
	switch (iParam0)
	{
		case 1:
...
int func_126()//Position - 0x8FB3
{
	return func_127(PLAYER::PLAYER_ID());
}

var func_127(int iParam0)//Position - 0x8FC3
{
	return MISC::GET_BITS_IN_RANGE(Global_2424073[iParam0 /*421*/].f_309.f_3, 28, 31);
}

int func_128(int iParam0)//Position - 0x8FE0
{
	return func_109(iParam0, 0, 0);
}

int func_129(int iParam0)//Position - 0x8FF0
{
	switch (iParam0)
	{
		case -1:
...
bool func_130()//Position - 0x92BE
{
	return Global_98721.f_345 > 0;
}

int func_131(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x92CF
{
	int iVar0;
...
void func_132(var uParam0, int iParam1)//Position - 0x9406
{
	int iVar0;
...
void func_133(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)//Position - 0x9455
{
	struct<60> Var0;
...
void func_134(int iParam0, int iParam1, int iParam2)//Position - 0x957E
{
	int iVar0;
...
void func_135(int iParam0, int iParam1)//Position - 0x969B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_136(int iParam0)//Position - 0x989D
{
...
int func_137(int iParam0)//Position - 0x997A
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_138(int iParam0, bool bParam1)//Position - 0x9B2B
{
	int iVar0;
	struct<2> Var1;
...
int func_139(int iParam0)//Position - 0x9CAB
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_141(int iParam0)//Position - 0x9D8E
{
	int iVar0;
	int iVar1;
...
int func_142()//Position - 0xC25A
{
	return 0;
}

int func_143()//Position - 0xC263
{
	return 1;
}

int func_144()//Position - 0xC26C
{
	return 1;
}

int func_145()//Position - 0xC275
{
...
int func_147(int iParam0)//Position - 0xC349
{
	int iVar0;
	char* sVar1;
...
int func_148(int iParam0)//Position - 0xC38F
{
	int iVar0;
...
int func_149(int iParam0)//Position - 0xC3CA
{
	int iVar0;
...
int func_150(int iParam0)//Position - 0xC446
{
	int iVar0;
...
int func_151(int iParam0)//Position - 0xC52E
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_152(var uParam0, int iParam1)//Position - 0xC54A
{
	int iVar0;
	int iVar1;
...
void func_153(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0xDC41
{
	if (func_152(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
...
void func_154(int iParam0, bool bParam1)//Position - 0xDD40
{
	if (iParam0 == -1)
	{
		return;
...
void func_155(int iParam0, int iParam1, bool bParam2)//Position - 0xDD9D
{
	if (iParam0 == -1)
	{
		return;
...
bool func_156(int iParam0, int iParam1)//Position - 0xDDD8
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_157(var uParam0, var uParam1)//Position - 0xDDFB
{
...
void func_158(int iParam0)//Position - 0xDEC7
{
	if (iParam0 == -1)
	{
		return;
...
void func_159(int iParam0)//Position - 0xDF41
{
...
void func_160()//Position - 0xDF68
{
	Global_22211.f_6 = 1;
}

void func_161()//Position - 0xDF76
{
	int iVar0;
...
int func_162()//Position - 0xDFD0
{
	return joaat("dune");
}

void func_163(bool bParam0)//Position - 0xDFDD
{
...
void func_165(var uParam0, int iParam1)//Position - 0xE0C4
{
	func_166(uParam0, iParam1);
}

void func_166(var uParam0, var uParam1)//Position - 0xE0D4
{
	*uParam0 = (*uParam0 || uParam1);
}

void func_167(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0xE0E5
{
	func_168(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_168(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0xE106
{
	int iVar0;
...
bool func_170(var uParam0, int iParam1)//Position - 0xE3F9
{
	return (uParam0 && iParam1) != 0;
}

void func_171(int iParam0)//Position - 0xE408
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	switch (iLocal_47)
	{
		...
		case 3:
			...
			if (STREAMING::HAS_MODEL_LOADED(joaat("cuban800")))
			{
				...
				{
					MISC::CLEAR_AREA_OF_VEHICLES(vLocal_50, 8f, 0, 0, 0, 0, false, 0);
					iLocal_48 = VEHICLE::CREATE_VEHICLE(joaat("cuban800"), vLocal_50, 25.29f, 1, 1, 0);
...
void func_172(bool bParam0)//Position - 0xE952
{
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("cuban800"));
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_48))
	{
...
bool func_175(int iParam0, int iParam1)//Position - 0xEB0C
{
	switch (iParam0)
	{
		case 5:
...
bool func_176()//Position - 0xEB47
{
	return Global_1312873;
}

int func_177(int iParam0)//Position - 0xEB53
{
	int iVar0;
...
var func_178()//Position - 0xF270
{
	return Global_98708.f_1;
}

int func_179()//Position - 0xF27E
{
	if (Global_95621 != -1)
	{
...
bool func_181()//Position - 0xF2BE
{
	return Global_98721.f_346 > 0;
}

int func_182()//Position - 0xF2CF
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_185(int iParam0, int iParam1)//Position - 0xF359
{
	bool bVar0;
...
int func_188(int iParam0)//Position - 0xF426
{
	int iVar0;
	int iVar1;
...
void func_191(int iParam0, bool bParam1)//Position - 0xF532
{
	if (bParam1)
	{
