	...
	switch (iLocal_169)
	{
		...
		case 4:
			...
			if (func_5(Local_749))
			{
				...
				ENTITY::SET_ENTITY_COORDS(Local_749, -1246.956f, -89.9753f, 42.904f, 1, false, 0, 1);
			...
			if (!func_32())
			{
				if (func_5(Local_694[4 /*6*/]))
				{
					...
					ENTITY::SET_ENTITY_COORDS(Local_694[4 /*6*/], -1273.736f, -75.3014f, 44.6289f, 1, false, 0, 1);
		...
		case 5:
			...
			if (func_511(iLocal_777))
			{
				...
				{
					ENTITY::DETACH_ENTITY(iLocal_777, 1, true);
				}
			}
			func_4(&Local_455);
			iLocal_354 = 0;
		...
		case 6:
			...
			if (!func_32())
			{
				if (func_511(PLAYER::PLAYER_PED_ID()))
				{
					ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_777, true) + Vector(0f, 1.5f, 0f), 1, false, 0, 1);
				}
			}
			iLocal_362 = 1;
			iLocal_171 = 2;
...
void func_20(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0xE61
{
	if (bParam0)
	{
...
bool func_21()//Position - 0xF9A
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_22(int iParam0, int iParam1)//Position - 0xFB7
{
	bool bVar0;
...
int func_23(int iParam0, bool bParam1)//Position - 0x1002
{
	int iVar0;
	int iVar1;
...
int func_24()//Position - 0x1043
{
	return Global_1312745;
}

int func_25(int iParam0)//Position - 0x104F
{
...
bool func_26()//Position - 0x1091
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_27(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x10A2
{
	int iVar0;
...
void func_29(int iParam0)//Position - 0x10FC
{
	if (iParam0 == 1)
	{
...
void func_30(int iParam0, int iParam1, int iParam2)//Position - 0x111F
{
	if (func_538() && func_32())
	{
...
void func_31(int iParam0)//Position - 0x11E3
{
	if (iParam0 == 1)
	{
...
bool func_32()//Position - 0x120C
{
	return MISC::IS_BIT_SET(Global_98669.f_20, 13);
}

void func_33(char* sParam0, int iParam1, int iParam2)//Position - 0x1220
{
	iParam2 = iParam2;
...
void func_34(int iParam0)//Position - 0x1239
{
	iLocal_377 = iParam0;
	func_35(8);
}

void func_35(int iParam0)//Position - 0x124C
{
	iLocal_169 = iParam0;
	iLocal_171 = 0;
}

void func_36()//Position - 0x125B
{
	int iVar0;
...
void func_38(int iParam0, bool bParam1)//Position - 0x13BB
{
	int iVar0;
	char* sVar1;
...
void func_40(int iParam0, int iParam1, int iParam2)//Position - 0x153D
{
	bool bVar0;
...
int func_42()//Position - 0x1AE6
{
	return Global_30736;
}

int func_43(int iParam0, int iParam1)//Position - 0x1AF1
{
	int iVar0;
...
int func_44(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1B42
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_47()//Position - 0x220B
{
	StringCopy(&Global_76809, "", 16);
	StringCopy(&Global_76813, "", 16);
}

void func_48()//Position - 0x2227
{
	int iVar0;
...
void func_52(int iParam0)//Position - 0x22F9
{
	if (iParam0 == 1)
	{
		Global_41945 = 1;
...
void func_54(var uParam0)//Position - 0x2322
{
	int iVar0;
	int iVar1;
...
void func_55(var uParam0)//Position - 0x28B2
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_56(var uParam0)//Position - 0x28CD
{
...
void func_57(var uParam0)//Position - 0x28FC
{
	int iVar0;
...
void func_58(var uParam0)//Position - 0x29AD
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_59(var uParam0)//Position - 0x29CB
{
	int iVar0;
...
void func_60(var uParam0)//Position - 0x2AAC
{
	*uParam0 = -15;
}

void func_61()//Position - 0x2ABA
{
	StringCopy(&Global_102117, "", 32);
	func_54(&Global_102125);
}

void func_62()//Position - 0x2AD4
{
...
int func_64(int iParam0, int iParam1, int iParam2)//Position - 0x2C12
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	else
	{
		...
		Global_76389[1 /*14*/] = { func_115(iVar0, iParam1, uVar31[iParam1], -1) };
...
int func_65(int iParam0, int iParam1, int iParam2)//Position - 0x2DD1
{
	int iVar0;
...
int func_66(int iParam0)//Position - 0x2E5D
{
	switch (iParam0)
	{
...
int func_67(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2E98
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76389[1 /*14*/] = { func_115(iVar10, 14, uVar28[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76389[1 /*14*/] = { func_115(iVar10, 14, uVar69[iVar1], -1) };
			func_83(iParam0, Global_76389[1 /*14*/].f_12, Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4);
			func_98(14);
			if (Global_76387 == 1)
			{
...
void func_68(int iParam0, int iParam1, int iParam2)//Position - 0x36AE
{
	int iVar0;
	int iVar1;
...
int func_69(int iParam0, int iParam1, int iParam2)//Position - 0x3738
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_70(int iParam0, int iParam1, int iParam2)//Position - 0x3816
{
	Global_76389[1 /*14*/] = { func_115(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 2);
}

int func_71(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x3841
{
	var uVar0;
	int iVar10;
...
int func_72(int iParam0, int iParam1, int iParam2)//Position - 0x3E45
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_73(int iParam0, int iParam1, int iParam2)//Position - 0x3EDE
{
	int iVar0;
	int iVar1;
...
int func_74(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3F7F
{
	int iVar0;
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x4287
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x4E3A
{
	int iVar0;
...
int func_77(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x511E
{
	int iVar0;
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x53E5
{
	int iVar0;
	int iVar1;
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x541C
{
	int iVar0;
...
int func_80(int iParam0, int iParam1, int iParam2)//Position - 0x5445
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x570F
{
	int iVar0;
...
int func_82(int iParam0, int iParam1, int iParam2)//Position - 0x5999
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5AF0
{
	int iVar0;
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5B88
{
	switch (iParam0)
	{
...
int func_85(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5C56
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar41 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_107(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_86(int iParam0, int iParam1)//Position - 0x5DB2
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_87(int iParam0)//Position - 0x6159
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x61BA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_89(int iParam0, int iParam1)//Position - 0x62B6
{
	int iVar0;
...
int func_90(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x63F4
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_107(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
int func_91(int iParam0)//Position - 0x64D4
{
	switch (iParam0)
	{
		case 0:
...
int func_92(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x655A
{
	switch (iParam0)
	{
		case joaat("player_zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_85(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_85(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_85(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_85(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_93(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x67D7
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_94(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6BFC
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_95(int iParam0, int iParam1)//Position - 0x6EEF
{
	int iVar0;
	int iVar1;
...
int func_96(int iParam0, int iParam1)//Position - 0x6F35
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_97(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6F95
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_98(int iParam0)//Position - 0x7019
{
...
void func_99(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x70D1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x711B
{
	int iVar0;
...
int func_101(var uParam0)//Position - 0x714B
{
	int iVar0;
	int iVar1;
...
int func_102(int iParam0, int iParam1, int iParam2)//Position - 0x717F
{
	int iVar0;
	var uVar1;
...
bool func_103(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x71B1
{
	int iVar0;
...
int func_104(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x9295
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_105(int iParam0)//Position - 0xA1B3
{
	if (!MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_106(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA204
{
	int iVar0;
...
int func_107(int iParam0)//Position - 0xA29A
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_108(int iParam0, int iParam1)//Position - 0xA34A
{
	int iVar0;
	struct<10> Var1;
...
void func_109(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAC79
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_110(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xADA3
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_111(int iParam0, int iParam1)//Position - 0xADEB
{
	int iVar0;
	struct<17> Var1;
...
void func_112(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCC34
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_113(int iParam0)//Position - 0xCE1E
{
	switch (iParam0)
	{
		case 0:
...
void func_114(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xCECE
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_115(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCF3F
{
	func_179();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_116(int iParam0, int iParam1)//Position - 0xCF91
{
	switch (iParam0)
	{
		case 0:
...
void func_117(int iParam0)//Position - 0xD081
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_118(&(Global_76389[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_118(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xE2F8
{
	int iVar0;
	int iVar1;
...
bool func_119(int iParam0, int iParam1, var uParam2)//Position - 0xE689
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_120(int iParam0, int iParam1)//Position - 0xEA8E
{
	switch (iParam1)
	{
		case 0:
...
int func_121(int iParam0, int iParam1)//Position - 0xEE89
{
	switch (iParam1)
	{
		case 0:
...
int func_122(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xF284
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_123(int iParam0)//Position - 0xF2C6
{
	return Global_41396 == iParam0;
}

int func_124(int iParam0)//Position - 0xF2D4
{
	switch (iParam0)
	{
		case -1:
...
void func_125(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xF3A8
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_118(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_118(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_107(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_126(int iParam0)//Position - 0xF681
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_127(int iParam0)//Position - 0xF7D8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0xFCE6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0xFD5B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0xFDCF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0xFEB6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x1021B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x1042C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x1065C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x1076C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x1110B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x11C7E
{
	if (iParam0 < 136)
	{
		func_139(iParam0);
...
void func_138(int iParam0)//Position - 0x11CB3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0)//Position - 0x128B7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x137C5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x138F2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0, int iParam1)//Position - 0x139F0
{
	switch (iParam0)
	{
		case 0:
...
void func_143(int iParam0)//Position - 0x13AE0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x14FD2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x15123
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x1562E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x15C9C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x15D10
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x15DE0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x16310
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x164A7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x16CA5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x16DB5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x17CE0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x1899F
{
	if (iParam0 < 107)
	{
		func_158(iParam0);
...
void func_156(int iParam0)//Position - 0x189E5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0x1948A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x1A279
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x1AEC2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x1B13B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0, int iParam1)//Position - 0x1B281
{
	switch (iParam0)
	{
		case 0:
...
void func_162(int iParam0)//Position - 0x1B371
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x1C0FC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x1C276
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x1C7ED
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x1CD17
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x1CD8B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x1CE5B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x1D333
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x1D59C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x1D872
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x1DA3B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x1E58F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x1F1D9
{
	if (iParam0 < 60)
	{
		func_176(iParam0);
...
void func_175(int iParam0)//Position - 0x1F20E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0)//Position - 0x1FFAE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_177(int iParam0)//Position - 0x20665
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x2074C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_179()//Position - 0x2084A
{
...
int func_180(int iParam0, int iParam1, int iParam2)//Position - 0x208C3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_181(int iParam0)//Position - 0x20B1E
{
	int iVar0;
	int iVar1;
...
void func_182(char* sParam0, int iParam1)//Position - 0x20B5B
{
...
void func_184()//Position - 0x20BFB
{
	int iVar0;
...
bool func_185(int iParam0)//Position - 0x20CF8
{
	return iParam0 < 3;
}

struct<2> func_186(int iParam0)//Position - 0x20D04
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_187(int iParam0)//Position - 0x20D3C
{
	struct<2> Var0;
...
void func_188(int iParam0, int iParam1)//Position - 0x21189
{
...
void func_189(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x211D3
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
void func_190(int iParam0, int iParam1, int iParam2)//Position - 0x21270
{
	struct<4> Var0;
	char* sVar32;
	...
	if (iParam0 != -1)
	{
		...
		func_191(&sVar32, Var0.f_3, Global_98706, iParam1, iParam2);
	}
}

void func_191(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x212AF
{
...
void func_192(int iParam0, var uParam1)//Position - 0x212F4
{
	switch (iParam0)
	{
		case 0:
...
int func_194(int iParam0)//Position - 0x225CC
{
	switch (iParam0)
	{
		case 0:
...
void func_195(int iParam0)//Position - 0x22912
{
	Global_41947 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_196()//Position - 0x22924
{
	if (Global_96011)
	{
		func_184();
...
char* func_197(var uParam0)//Position - 0x22957
{
	uParam0 = uParam0;
	return "";
}

void func_198()//Position - 0x22967
{
	vector3 vVar0[24];
...
void func_199(int iParam0, int iParam1)//Position - 0x229AA
{
	Global_96006 = iParam0;
	Global_96007 = iParam1;
}

void func_200()//Position - 0x229BE
{
	if (Global_76831 != 6)
	{
	}
...
void func_201(var uParam0)//Position - 0x229F6
{
	if (*uParam0 == -1)
	{
		return;
...
void func_202(int iParam0, bool bParam1)//Position - 0x22A33
{
	struct<26> Var0;
	int iVar32;
	bool bVar33;
...
int func_203(int iParam0)//Position - 0x22BBA
{
	switch (iParam0)
	{
		case 0:
...
void func_204(int iParam0)//Position - 0x22F41
{
	func_206(iParam0, 1);
...
int func_205()//Position - 0x22F77
{
	return (Global_111560.f_10011.f_21 + Global_111560.f_18569.f_380);
}

void func_206(var uParam0, bool bParam1)//Position - 0x22F93
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_207(int iParam0)//Position - 0x232B7
{
...
void func_208(int iParam0)//Position - 0x232EA
{
	switch (iParam0)
	{
		case 30:
...
void func_209(int iParam0, bool bParam1)//Position - 0x2331F
{
	if (iParam0 == -1)
	{
		return;
...
void func_210(int iParam0, int iParam1, bool bParam2)//Position - 0x2337C
{
	if (iParam0 == -1)
	{
		return;
...
bool func_211(int iParam0, int iParam1)//Position - 0x233B7
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_212(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x233DA
{
	if (iParam0 != 198)
	{
		if (Global_76577)
...
void func_213(int iParam0, int iParam1)//Position - 0x23435
{
	switch (iParam0)
	{
		case 12:
...
void func_214(int iParam0, bool bParam1)//Position - 0x2351E
{
	if (bParam1)
	{
...
bool func_215(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x23547
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_217()//Position - 0x23EDF
{
	return Global_30737;
}

int func_218(var uParam0, int iParam1)//Position - 0x23EEA
{
	int iVar0;
...
int func_219(int iParam0)//Position - 0x27777
{
	switch (iParam0)
	{
		case 46:
...
void func_220(int iParam0, bool bParam1)//Position - 0x27869
{
	switch (iParam0)
	{
		case 46:
...
void func_221(int iParam0, bool bParam1)//Position - 0x278BA
{
	int iVar0;
...
void func_222(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x27920
{
	func_223(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_223(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x27942
{
	int iVar0;
...
void func_224()//Position - 0x27B16
{
	int iVar0;
...
int func_225(int iParam0)//Position - 0x27C36
{
	int iVar0;
	int iVar1;
...
int func_228(int iParam0)//Position - 0x27E71
{
...
void func_229(int iParam0, int iParam1)//Position - 0x27E9E
{
...
int func_230(char* sParam0)//Position - 0x27EDB
{
	int iVar0;
...
int func_231()//Position - 0x27F3B
{
	return func_232(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_232(char* sParam0, int iParam1)//Position - 0x27F4C
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_233(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x27F95
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_234(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2837F
{
	Global_76389[1 /*14*/] = { func_115(iParam0, iParam1, iParam2, -1) };
	if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0) && !MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 6))
	{
...
int func_235(int iParam0)//Position - 0x2841B
{
	if (func_185(iParam0))
	{
...
var func_236(int iParam0)//Position - 0x28440
{
	return Global_1798[iParam0 /*29*/];
}

void func_237(int iParam0)//Position - 0x2844F
{
	if (iParam0 == 1)
	{
		HUD::CLEAR_PRINTS();
...
bool func_239(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x2847D
{
...
int func_240(char* sParam0, int iParam1, bool bParam2)//Position - 0x284DC
{
	Global_20806 = 0;
...
void func_241()//Position - 0x287AC
{
	if (!func_242())
	{
		return;
...
bool func_243(int iParam0)//Position - 0x28849
{
	return func_244(iParam0, 20);
}

bool func_244(int iParam0, int iParam1)//Position - 0x28859
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_245()//Position - 0x28874
{
	return -1;
}

void func_246()//Position - 0x2887D
{
	int iVar0;
...
void func_247()//Position - 0x288AF
{
...
void func_249()//Position - 0x289DD
{
	if (func_123(14))
	{
...
int func_250()//Position - 0x28A7F
{
	func_184();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_251()//Position - 0x28A98
{
	int iVar0;
...
bool func_252(int iParam0, int iParam1)//Position - 0x28AF0
{
	switch (iParam0)
	{
		case 5:
...
void func_253(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x28B2B
{
...
void func_254()//Position - 0x28B81
{
	int iVar0;
	int iVar1;
	...
	if (func_511(Local_455))
	{
		switch (iLocal_170)
		{
			case 0:
				func_291();
				if (func_272(Local_455, 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					if (!func_14())
					{
						if (func_14())
						...
						ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_782.f_1, Local_455, PED::GET_PED_BONE_INDEX(Local_455, 28422), 0.06f, 0.04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1);
						if (func_5(Local_749))
						{
							if (func_6(Local_455))
							{
								if (!PED::IS_PED_IN_VEHICLE(Local_455, Local_749, 0))
								{
									TASK::TASK_ENTER_VEHICLE(Local_455, Local_749, -1, -1, 1073741824, 1, 0);
								}
							}
						}
			...
			case 1:
				if (func_272(Local_455, 1, 1116471296, 1126825984, 0, 0, 0, 0) || iLocal_350 == 1)
				{
				...
				else
				{
					...
					{
						ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_782.f_1, Local_455, PED::GET_PED_BONE_INDEX(Local_455, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
						...
						TASK::SET_SEQUENCE_TO_REPEAT(iLocal_776, 1);
					...
					{
						if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_749, 0) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_694[5 /*6*/], 0))
						{
							if (func_14())
							{
								func_15();
			...
			case 3:
				if (((func_5(Local_749) && func_262(Local_455, Local_749, 1) < 10f) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_749, 0)) && !ENTITY::IS_ENTITY_UPSIDEDOWN(Local_749))
				{
					if (PED::IS_PED_SITTING_IN_VEHICLE(Local_455, Local_749))
					{
						...
						if (func_6(Local_455))
						{
							if (!func_260())
							{
								TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_455, Local_749, "NIGEL1DGOLF", 786468, 0, 12, -1, -1082130432, 0, 1073741824);
							}
							else
							{
								iLocal_363 = 1;
								TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_455, Local_749, "NIGEL1DGOLF2", 786468, 0, 12, -1, -1082130432, 0, 1073741824);
							}
						}
						iLocal_170 = 4;
					}
			...
			case 6:
				...
				if (func_5(Local_749))
				{
					if (!PED::IS_PED_IN_VEHICLE(Local_455, Local_749, 0) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_749, 1))
					{
						iLocal_170 = 7;
					}
				}
...
int func_255()//Position - 0x294FF
{
	if (ENTITY::GET_ENTITY_SPEED(Local_749) < 0.15f && PED::IS_PED_IN_VEHICLE(Local_455, Local_749, 0))
	{
		...
		if (iLocal_378 > 30)
		{
			...
			{
				VEHICLE::BRING_VEHICLE_TO_HALT(Local_749, 2f, 3, 0);
				if (PED::IS_PED_IN_VEHICLE(Local_455, Local_749, 0))
				{
...
void func_256()//Position - 0x295B8
{
	if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_455, true), 20f, 1))
	{
...
void func_257()//Position - 0x296CD
{
...
float func_258(int iParam0, int iParam1)//Position - 0x2986C
{
	return func_262(iParam0, iParam1, 1);
}

void func_259()//Position - 0x2987D
{
	int iVar0;
...
bool func_261(var uParam0, struct<2> Param1, float fParam3)//Position - 0x298E4
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
float func_262(int iParam0, int iParam1, bool bParam2)//Position - 0x299A0
{
	vector3 vVar0;
	vector3 vVar3;
...
bool func_263(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x299FE
{
...
void func_264()//Position - 0x29A4C
{
	int iVar0;
	...
	if (iLocal_357 == 0)
	{
			...
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_749, 0))
			{
				if (func_6(Local_455))
				{
					if (!PED::IS_PED_IN_VEHICLE(Local_455, Local_749, 0))
					{
						...
						TASK::TASK_ENTER_VEHICLE(0, Local_749, -1, -1, 1073741824, 1, 0);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_775);
		...
		if (iLocal_169 <= 3 && func_511(Local_455))
		{
			...
			if (func_511(Local_468))
			{
				ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_825, Local_468, PED::GET_PED_BONE_INDEX(Local_468, 28422), 0.06f, 0.04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1);
			}
		}
		else if (ENTITY::IS_ENTITY_ATTACHED(Local_782.f_1))
		{
			ENTITY::DETACH_ENTITY(Local_782.f_1, 1, true);
		}
		func_265(790, 0);
		iLocal_357 = 1;
	}
...
void func_265(int iParam0, bool bParam1)//Position - 0x29CA3
{
	int iVar0;
...
void func_266()//Position - 0x29CED
{
	int iVar0;
...
void func_267(int iParam0)//Position - 0x29D23
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_788[iParam0 /*6*/]))
	{
		if (ENTITY::IS_ENTITY_ATTACHED(Local_788[iParam0 /*6*/]))
		{
			ENTITY::DETACH_ENTITY(Local_788[iParam0 /*6*/], 1, true);
		}
	}
	func_296(Local_561[iParam0 /*13*/], 1);
}

int func_268(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x29D60
{
	int iVar0;
	bool bVar1;
...
bool func_269(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x29DB2
{
...
int func_271(int iParam0)//Position - 0x29E4C
{
	var uVar0;
...
int func_272(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x29E60
{
	vector3 vVar0;
...
int func_273(int iParam0, float fParam1)//Position - 0x29F1B
{
	float fVar0;
...
bool func_274(int iParam0, float fParam1)//Position - 0x29F91
{
	return func_275(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_275(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x29FA9
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_276(&(Local_49[iVar4 /*4*/]), vVar1, iParam1, &(Local_49[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_49[iVar4 /*4*/].f_3) < iParam4);
}

int func_276(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x2A06A
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_277(iParam4, iParam7) };
...
Vector3 func_277(int iParam0, int iParam1)//Position - 0x2A196
{
	int iVar0;
...
int func_279(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2A2A5
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	...
	{
		vVar3 = { func_281(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_280(vector3 vParam0, vector3 vParam3)//Position - 0x2A336
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_281(vector3 vParam0)//Position - 0x2A357
{
	float fVar0;
	float fVar1;
...
void func_282(var uParam0)//Position - 0x2A396
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_283(int iParam0, int iParam1)//Position - 0x2A3B1
{
	int iVar0;
...
int func_284(int iParam0)//Position - 0x2A3F0
{
...
bool func_285(int iParam0, int iParam1, float fParam2)//Position - 0x2A418
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_286(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x2A45F
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_287(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x2A55A
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_288(int iParam0, float fParam1)//Position - 0x2A666
{
	var uVar0;
	vector3 vVar1;
...
int func_289(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0x2A6FB
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_290(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x2A789
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_291()//Position - 0x2A7D1
{
	switch (iLocal_693)
	{
		case 0:
...
bool func_292(int iParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x2A8A5
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam3), ENTITY::GET_ENTITY_COORDS(iParam1, bParam3)) <= (fParam2 * fParam2);
}

void func_293(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2A8C7
{
...
void func_294(var uParam0, int iParam1)//Position - 0x2A962
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
void func_295(int iParam0)//Position - 0x2A97F
{
...
void func_296(int iParam0, int iParam1)//Position - 0x2A99F
{
	if (func_6(iParam0))
	{
		if (iParam1 == 0)
...
void func_297()//Position - 0x2AADF
{
	int iVar0;
...
void func_298()//Position - 0x2AB83
{
	if (iLocal_368)
	{
...
void func_299(int iParam0)//Position - 0x2ABB8
{
	bool bVar0;
	int iVar1;
...
void func_301()//Position - 0x2AC55
{
	int iVar0;
...
void func_302(int iParam0)//Position - 0x2ACFB
{
			...
			if (func_5(Local_749))
			{
				if (func_511(Local_455))
				{
					if (PED::IS_PED_IN_VEHICLE(Local_455, Local_749, 0))
					{
						...
						else if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_640[iParam0 /*13*/], true), 15f, 1))
						{
					...
					else if (func_272(Local_640[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0) || ENTITY::IS_ENTITY_AT_ENTITY(Local_455, Local_640[iParam0 /*13*/], 30f, 30f, 30f, 0, 1, 0))
					{
						func_296(Local_640[iParam0 /*13*/], 0);
						iLocal_678[iParam0] = 3;
					}
		...
		case 1:
			if (ENTITY::IS_ENTITY_AT_ENTITY(Local_455, Local_640[iParam0 /*13*/], 38f, 38f, 38f, 0, 1, 0))
			{
				if (func_6(Local_640[iParam0 /*13*/]))
				{
					...
					TASK::TASK_GO_STRAIGHT_TO_COORD(Local_640[iParam0 /*13*/], Local_640[iParam0 /*13*/].f_4, 3f, -1, 1193033728, 0.5f);
...
void func_303(int iParam0, char* sParam1, int iParam2)//Position - 0x2AF4A
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_304(iParam2), 1);
}

int func_304(int iParam0)//Position - 0x2AF61
{
	int iVar0;
...
void func_305(var uParam0, int iParam1)//Position - 0x2B177
{
...
void func_306(int iParam0, int iParam1)//Position - 0x2B1B0
{
...
int func_307(int iParam0)//Position - 0x2B1FC
{
	int iVar0;
	int iVar1;
...
void func_308()//Position - 0x2B2FA
{
	int iVar0;
...
void func_309()//Position - 0x2B3A2
{
	int iVar0;
...
void func_310(int iParam0)//Position - 0x2B490
{
	int iVar0;
	int iVar1;
	...
	switch (iLocal_667[iParam0])
	{
		case 0:
			...
			else if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 25f, 25f, 25f, 0, 1, 0))
				{
					if (!func_180(PLAYER::PLAYER_PED_ID(), 12, 4))
					{
						if (!func_314())
						{
							if (func_274(Local_481[iParam0 /*13*/], 1126825984) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 18f, 18f, 18f, 0, 1, 0))
							{
								if (func_14())
								{
									func_12();
						...
						else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 18f, 18f, 18f, 0, 1, 0))
						{
							if (iLocal_349 == 0)
							{
								func_293(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
			...
			else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 50f, 50f, 50f, 0, 1, 0))
			{
				...
				else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 25f, 25f, 25f, 0, 1, 0))
				{
		...
		case 1:
			...
			else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 9f, 9f, 9f, 0, 1, 0) && iLocal_351 == 1)
			{
				func_293(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
		...
		case 2:
			...
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 4f, 4f, 4f, 0, 1, 0) || (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_455, 8f, 8f, 8f, 0, 1, 0) && iLocal_351 == 1))
				{
					func_293(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
					if (func_269(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_3", 7, 0, 0))
					{
		...
		case 3:
			...
			{
				if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_481[iParam0 /*13*/], true), 20f, 0) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
				{
					if (func_14())
					{
						func_12();
				...
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 7f, 7f, 5f, 0, 1, 0) || (func_312(PLAYER::PLAYER_PED_ID(), -1097.28f, 68.05f, 52.99f, 10f) && iLocal_351 == 1))
				{
					if (func_14())
					{
						func_12();
				...
				else
				{
					...
					if ((MISC::GET_GAME_TIMER() - iLocal_387) >= 10000)
					{
						if (func_511(Local_455))
						{
							if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 25f, 25f, 25f, 0, 1, 0) && !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_455, 11f, 11f, 11f, 0, 1, 0))
							{
								if (func_6(Local_481[iParam0 /*13*/]))
								{
							...
							else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
							{
		...
		case 4:
			if (func_262(Local_481[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), 1) > 120f && (PED::IS_PED_IN_ANY_VEHICLE(Local_455, 0) || func_511(Local_455)))
			{
				if (HUD::DOES_BLIP_EXIST(Local_481[iParam0 /*13*/].f_11))
				{
...
int func_311(int iParam0, int iParam1)//Position - 0x2C833
{
	if (func_6(iParam0))
	{
...
bool func_312(int iParam0, vector3 vParam1, float fParam4)//Position - 0x2C866
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, true), vParam1) <= (fParam4 * fParam4);
}

void func_313(char* sParam0, float fParam1)//Position - 0x2C883
{
	sParam0 = sParam0;
	fParam1 = fParam1;
}

int func_314()//Position - 0x2C893
{
...
void func_315()//Position - 0x2C8F7
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_455))
	{
		if (iLocal_169 < 3 || func_262(PLAYER::PLAYER_PED_ID(), Local_455, 1) > 100f)
		{
				...
				if (func_6(Local_481[iVar0 /*13*/]))
				{
					...
					if (iVar0 == 1)
					{
						if (ENTITY::DOES_ENTITY_EXIST(Local_455))
						{
							...
							TASK::TASK_GO_TO_ENTITY(Local_481[iVar0 /*13*/], Local_455, 20000, 6f, 2f, 1073741824, 0);
						}
					}
					else
					{
			...
			if (func_511(Local_468))
			{
				...
				{
					ENTITY::DETACH_ENTITY(Local_825, 1, true);
				}
				TASK::TASK_SMART_FLEE_PED(Local_468, PLAYER::PLAYER_PED_ID(), 300f, -1, 1, 0);
...
void func_316(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x2CA66
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
float func_317(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x2CAB6
{
	vector3 vVar0;
...
int func_319(int iParam0, int iParam1, bool bParam2)//Position - 0x2CC91
{
...
void func_320()//Position - 0x2CCDC
{
	int iVar0;
...
void func_322()//Position - 0x2CE2C
{
	switch (iLocal_171)
	{
		case 0:
...
void func_323(bool bParam0, int iParam1)//Position - 0x2D080
{
	int iVar0;
...
void func_324()//Position - 0x2D11A
{
	if (iLocal_367 == 0)
	{
...
int func_325(int iParam0)//Position - 0x2D14D
{
...
void func_326()//Position - 0x2D16B
{
	if (iLocal_364 == 0)
	{
	...
	if (func_511(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (iLocal_169 < 6)
		{
			if (func_511(Local_455))
			{
				if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_455, 140f, 140f, 140f, 0, 1, 0) && !func_275(PLAYER::PLAYER_PED_ID(), Local_455, 1126825984, 1, 250, 7))
				{
					func_34(1);
				}
			}
...
void func_327(var uParam0, int iParam1, int iParam2)//Position - 0x2D2B7
{
	char* sVar0;
...
int func_328(char* sParam0)//Position - 0x2D39B
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_329()//Position - 0x2D3AE
{
	if (iLocal_344 == 1)
	{
		if (func_511(iLocal_777))
...
void func_330()//Position - 0x2D46B
{
	switch (iLocal_171)
	{
		case 0:
			...
			if (func_511(Local_782.f_1) && func_511(Local_455))
			{
				if (!ENTITY::IS_ENTITY_ATTACHED(Local_782.f_1))
				{
					...
					ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_782.f_1, iLocal_777, 0, 0.1f, 0f, -0.25f, -5f, 155f, 0f, 0, 0, 0, 0, 2, 1);
				}
		...
		case 1:
			func_254();
			func_326();
			func_363(iLocal_339, Local_749, 140f, 1061158912, 0);
			func_298();
			if (bLocal_369)
			{
...
int func_331()//Position - 0x2D6F0
{
	if (func_5(Local_749))
	{
		if (func_511(Local_455))
		{
			...
			if ((func_255() || VEHICLE::IS_VEHICLE_TYRE_BURST(Local_749, 0, 0)) || VEHICLE::IS_VEHICLE_TYRE_BURST(Local_749, 1, 0))
			{
...
void func_332()//Position - 0x2D7E2
{
	if (func_511(Local_455))
	{
...
void func_333(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x2D82C
{
	func_334(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_334(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2D849
{
	func_335(uParam0, iParam1, vParam2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

void func_335(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2D867
{
	...
	uParam0->f_6 = 2;
	func_336(uParam0, iParam1, vParam2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

void func_336(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2D89F
{
	int iVar0;
	int iVar1;
	...
	if (func_361(iParam1) && ENTITY::IS_ENTITY_VISIBLE(iParam1))
	{
		...
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			...
			{
				func_352(uParam0, iParam1, vParam2, iParam6);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
void func_337(var uParam0)//Position - 0x2DC10
{
...
int func_338(var uParam0)//Position - 0x2DC7E
{
	int iVar0;
...
int func_339(bool bParam0)//Position - 0x2DCA9
{
	switch (Global_41396)
	{
		case 0:
...
void func_340(char[4] cParam0, int iParam1)//Position - 0x2DD53
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_341(char* sParam0)//Position - 0x2DD6A
{
	if (!func_342(1, 1, 0))
	{
...
int func_342(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2DE04
{
	int iVar0;
	int iVar1;
	...
	if ((func_349() || func_348(Global_4456448.f_190930)) || func_347())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::IS_TURRET_SEAT(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_345(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_343(int iParam0)//Position - 0x2E05D
{
	if (iParam0 != func_245())
	{
...
int func_344(int iParam0, bool bParam1, bool bParam2)//Position - 0x2E0C3
{
	int iVar0;
...
int func_345(int iParam0, int iParam1)//Position - 0x2E10D
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
...
int func_346(int iParam0, int iParam1)//Position - 0x2E16F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_347()//Position - 0x2E1F4
{
	return Global_2448961.f_17;
}

bool func_348(int iParam0)//Position - 0x2E202
{
	return iParam0 == 51;
}

var func_349()//Position - 0x2E20F
{
	return Global_2448961.f_16;
}

bool func_350()//Position - 0x2E21D
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

int func_351(int iParam0)//Position - 0x2E232
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
void func_352(var uParam0, int iParam1, vector3 vParam2, int iParam5)//Position - 0x2E28C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_353()//Position - 0x2E3A0
{
	return func_354(PLAYER::PLAYER_ID());
}

int func_354(int iParam0)//Position - 0x2E3B0
{
...
bool func_355(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x2E3CF
{
	if (bParam6)
	{
...
int func_356(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x2E416
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_357(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2E782
{
...
int func_358(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2E7D4
{
	if (!func_342(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_359(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2E81D
{
	if (!func_342(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_360(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2E87C
{
	if (!func_342(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_361(int iParam0)//Position - 0x2E8D2
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_362()//Position - 0x2E92D
{
	MISC::SET_BIT(&Global_7357, 4);
}

void func_363(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)//Position - 0x2E93D
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_364(int iParam0, bool bParam1, int iParam2)//Position - 0x2EA96
{
	int iVar0;
...
void func_365()//Position - 0x2EACB
{
	switch (iLocal_171)
	{
		case 0:
			...
			if (func_511(iLocal_777) && func_5(Local_749))
			{
				if (!ENTITY::IS_ENTITY_ATTACHED(iLocal_777))
				{
					func_530("Reattaching bag to buggy!?");
		...
		case 1:
			...
			func_324();
			PLAYER::_0x4669B3ED80F24B4E(PLAYER::PLAYER_ID());
			func_363(iLocal_339, Local_455, 140f, 1061158912, 0);
			if (!func_511(Local_782.f_1))
			{
				HUD::CLEAR_PRINTS();
				if (func_14())
...
int func_366()//Position - 0x2EDC5
{
	if (func_5(Local_749))
	{
		if (func_511(Local_455))
		{
			...
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_749, PLAYER::PLAYER_PED_ID(), 1) && !WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(Local_749, 0, 2))
			{
				func_367();
...
void func_367()//Position - 0x2EF20
{
	if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || MISC::GET_PROFILE_SETTING(203) == 0)
	{
		if (!func_14())
...
void func_368()//Position - 0x2EF87
{
	if (iLocal_169 < 6)
	{
		if (func_6(Local_455))
			...
			if (func_5(Local_749))
			{
				if (PED::IS_PED_IN_VEHICLE(Local_455, Local_749, 0))
				{
					if (iLocal_363 == 0)
					{
						if (!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_749))
						{
							TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_455, Local_749, "NIGEL1DGOLF", 786468, 0, 8, -1, -1082130432, 0, 1073741824);
						}
					}
...
void func_369()//Position - 0x2EFFC
{
	int iVar0;
	...
	if (iLocal_347 == 0)
	{
		if (func_376(0))
		{
			...
			while (iVar0 <= 5)
			{
				...
				ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_788[iVar0 /*6*/], Local_561[iVar0 /*13*/], PED::GET_PED_BONE_INDEX(Local_561[iVar0 /*13*/], 28422), 0.06f, 0.04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1);
				iVar0++;
			}
			ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_788[0 /*6*/], Local_561[0 /*13*/], PED::GET_PED_BONE_INDEX(Local_561[0 /*13*/], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_788[1 /*6*/], Local_561[1 /*13*/], PED::GET_PED_BONE_INDEX(Local_561[1 /*13*/], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_788[2 /*6*/], Local_561[2 /*13*/], PED::GET_PED_BONE_INDEX(Local_561[2 /*13*/], 28422), 0f, 0f, 0.05f, 0f, -10f, -90f, 0, 0, 0, 0, 2, 1);
			ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_788[3 /*6*/], Local_561[3 /*13*/], PED::GET_PED_BONE_INDEX(Local_561[3 /*13*/], 28422), -0.01f, 0f, 0f, 10f, 0f, -90f, 0, 0, 0, 0, 2, 1);
			iVar0 = 0;
			while (iVar0 <= 1)
			{
...
void func_370(int iParam0)//Position - 0x2F249
{
	switch (iLocal_671[iParam0])
	{
		case 0:
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_561[iParam0 /*13*/], true), 50f, 0))
				{
					func_267(iParam0);
				...
				else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_561[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
				{
			...
			else if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_561[iParam0 /*13*/], true), 50f, 1))
			{
				func_296(Local_561[iParam0 /*13*/], 1);
				func_372(iParam0);
				if (!func_14() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
			...
			else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(Local_561[iParam0 /*13*/]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_561[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), 1))
			{
...
void func_371()//Position - 0x2F695
{
	int iVar0;
			...
			if (Local_561[iVar0 /*13*/].f_10 == 0)
			{
				if (ENTITY::IS_ENTITY_AT_COORD(Local_561[iVar0 /*13*/], vLocal_399, 20f, 20f, 20f, false, true, 0))
				{
					...
					if (ENTITY::DOES_ENTITY_EXIST(Local_788[iVar0 /*6*/]))
					{
						...
						{
							ENTITY::DETACH_ENTITY(Local_788[iVar0 /*6*/], 1, true);
						}
					}
					iLocal_671[iVar0] = 1;
				}
...
void func_372(int iParam0)//Position - 0x2F73E
{
	int iVar0;
...
void func_375(var uParam0, int iParam1)//Position - 0x2F81D
{
	if (STREAMING::HAS_MODEL_LOADED(uParam0->f_5))
	{
...
int func_376(int iParam0)//Position - 0x2F867
{
	int iVar0;
	int iVar1;
...
void func_377()//Position - 0x2F965
{
	if (iLocal_355 == 0)
	{
		if (func_511(Local_468))
		{
			if (func_272(Local_468, 1, 1116471296, 1126825984, 0, 0, 0, 0))
			{
				if (func_511(Local_468))
				{
					ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_468, true, 1);
...
void func_378()//Position - 0x2F9B6
{
	func_295(&iLocal_340);
	iLocal_690 = 6;
}

void func_379(int iParam0)//Position - 0x2F9C9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_380()//Position - 0x2FA01
{
	switch (iLocal_171)
	{
		case 0:
...
void func_381()//Position - 0x2FBA7
{
	switch (iLocal_690)
	{
		case 0:
		...
		case 1:
			...
			{
				iLocal_341 = CAM::CREATE_CAMERA_WITH_PARAMS(180543640, -1409.452f, 53.5135f, 78.0868f, -26.7543f, 0f, -85.6976f, 50f, 0, 2);
		...
		case 4:
			...
			{
				iLocal_342 = CAM::CREATE_CAMERA_WITH_PARAMS(180543640, -1373.681f, 57.0584f, 54.9717f, -10.6657f, 0f, 91.5916f, 50f, 0, 2);
...
void func_382(int iParam0)//Position - 0x2FF6D
{
	if (!func_185(iParam0))
	{
		return;
...
void func_384()//Position - 0x2FFB4
{
	int iVar0;
...
void func_385()//Position - 0x30070
{
	int iVar0;
...
void func_386(int iParam0)//Position - 0x3009E
{
	switch (iLocal_685[iParam0])
	{
		case 0:
			...
			else if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_402[iParam0 /*13*/], true), 30f, 1))
			{
				if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || MISC::GET_PROFILE_SETTING(203) == 0)
				{
					if (!func_14())
...
void func_387()//Position - 0x30220
{
	int iVar0;
...
void func_388()//Position - 0x30246
{
	if (func_511(PLAYER::PLAYER_PED_ID()))
	{
		if (!func_325(PLAYER::PLAYER_PED_ID()))
...
int func_389(int iParam0)//Position - 0x302B0
{
...
void func_390()//Position - 0x302CE
{
	switch (iLocal_171)
	{
		case 0:
...
void func_391(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x3042F
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar10 = func_460(&(Global_98669.f_3));
				if (iVar10 > -1)
				{
...
void func_392(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x305A8
{
	func_393(&Global_105109, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_393(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x305C4
{
	int iVar0;
	int iVar1;
...
int func_394(var uParam0)//Position - 0x3144D
{
...
void func_395(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x3146F
{
	int iVar0;
...
int func_396(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x314F7
{
...
int func_397(int iParam0)//Position - 0x31537
{
	int iVar0;
...
void func_398(var uParam0, int iParam1, int iParam2)//Position - 0x31565
{
...
int func_399(int iParam0)//Position - 0x31641
{
	int iVar0;
...
int func_400(int iParam0)//Position - 0x31683
{
	int iVar0;
...
int func_401(int iParam0, int iParam1, int iParam2)//Position - 0x316E6
{
	int iVar0;
...
int func_402(int iParam0, int iParam1)//Position - 0x31774
{
	struct<82> Var0;
...
void func_403(int iParam0, var uParam1, int iParam2)//Position - 0x317B6
{
	int iVar0;
...
void func_404(int iParam0, var uParam1)//Position - 0x31A17
{
	int iVar0;
...
int func_405(int iParam0)//Position - 0x31CC4
{
	switch (iParam0)
	{
		case 1:
...
int func_406(int iParam0, var uParam1, var uParam2)//Position - 0x31D74
{
	int iVar0;
	int iVar1;
...
int func_407(int iParam0)//Position - 0x31F67
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_408(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x31F87
{
	char* sVar0;
...
int func_409(int iParam0, int iParam1, bool bParam2)//Position - 0x320B9
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_410(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x3212A
{
...
void func_411(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3220A
{
	int iVar0;
	int iVar1;
...
int func_412(int iParam0, int iParam1)//Position - 0x323AA
{
	var uVar0;
	var uVar1;
...
void func_413(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x323D6
{
	int iVar0;
...
void func_414(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3291E
{
	int iVar0;
...
int func_415()//Position - 0x32B5F
{
	func_184();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_416(int iParam0, bool bParam1)//Position - 0x32B78
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_417(int iParam0, var uParam1)//Position - 0x32C6B
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_419(Var11.f_1)) && iVar72 < 51)
			{
...
int func_418(int iParam0)//Position - 0x32EF3
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_419(int iParam0)//Position - 0x32F8E
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
int func_420(int iParam0, int iParam1)//Position - 0x33120
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_421(int iParam0, var uParam1)//Position - 0x33C91
{
	int iVar0;
	int iVar1;
...
int func_422(int iParam0)//Position - 0x33CCC
{
	int iVar0;
...
void func_423(int iParam0)//Position - 0x33F40
{
	int iVar0;
...
void func_424(var uParam0, int iParam1)//Position - 0x33F7C
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_425(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x344D9
{
	int iVar0;
	int iVar1;
...
bool func_426(int iParam0, var uParam1, var uParam2)//Position - 0x3451D
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
int func_427(var uParam0)//Position - 0x34C38
{
...
bool func_428(int iParam0)//Position - 0x34C93
{
	return func_429(iParam0, 0, 1);
}

int func_429(int iParam0, int iParam1, bool bParam2)//Position - 0x34CA3
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_430(int iParam0)//Position - 0x34D0D
{
	switch (iParam0)
	{
		case 0:
...
int func_431(int iParam0)//Position - 0x3503D
{
	return func_429(iParam0, 5, 1);
}

int func_432(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x3504D
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_433(int iParam0, bool bParam1)//Position - 0x350EF
{
	switch (iParam0)
	{
		case -1:
...
int func_434(int iParam0)//Position - 0x3570C
{
	if (iParam0 != func_245())
	{
...
Vector3 func_435(int iParam0, int iParam1)//Position - 0x3576A
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_436(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x35818
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_437(vector3 vParam0, float fParam3)//Position - 0x358AD
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_438(int iParam0)//Position - 0x358F1
{
	struct<6> Var0;
...
struct<6> func_439(int iParam0)//Position - 0x35A75
{
	return func_440(iParam0);
}

struct<6> func_440(int iParam0)//Position - 0x35A83
{
	struct<6> Var0;
...
int func_441(int iParam0, var uParam1)//Position - 0x3654A
{
	switch (iParam0)
	{
		case 0:
...
int func_442(int iParam0)//Position - 0x365CC
{
	if (iParam0 != func_245())
	{
...
Vector3 func_443(int iParam0)//Position - 0x3662A
{
	switch (iParam0)
	{
		case 1:
...
int func_444()//Position - 0x36835
{
	return func_445(PLAYER::PLAYER_ID());
}

int func_445(int iParam0)//Position - 0x36845
{
	return MISC::GET_BITS_IN_RANGE(Global_2424073[iParam0 /*421*/].f_309.f_3, 28, 31);
}

int func_446(int iParam0)//Position - 0x36862
{
	return func_429(iParam0, 0, 0);
}

int func_447(int iParam0)//Position - 0x36872
{
	switch (iParam0)
	{
		case -1:
...
bool func_448()//Position - 0x36B40
{
	return Global_98721.f_345 > 0;
}

var func_449()//Position - 0x36B51
{
	var uVar0;
...
void func_450(var uParam0, int iParam1)//Position - 0x36B97
{
	if (iParam1 <= 0)
	{
		return;
...
void func_451(var uParam0, int iParam1)//Position - 0x36C1D
{
...
void func_452(var uParam0, int iParam1)//Position - 0x36C50
{
	int iVar0;
	int iVar1;
...
int func_453(int iParam0, int iParam1)//Position - 0x36CA1
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_454(int iParam0)//Position - 0x36D43
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_455(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_455(bool bParam0, int iParam1, int iParam2)//Position - 0x36D68
{
	if (bParam0)
	{
		return iParam1;
...
int func_456(var uParam0)//Position - 0x36D7F
{
	return uParam0 & 15;
}

void func_457(var uParam0, int iParam1)//Position - 0x36D8C
{
...
void func_458(var uParam0, int iParam1)//Position - 0x36DC6
{
...
void func_459(var uParam0, int iParam1)//Position - 0x36E01
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_460(char* sParam0)//Position - 0x36E3D
{
...
int func_461(int iParam0)//Position - 0x36E97
{
	switch (iParam0)
	{
		case 69:
...
int func_462(int iParam0)//Position - 0x36F53
{
	switch (iParam0)
	{
		case 1:
...
int func_463(char* sParam0, bool bParam1)//Position - 0x36FA7
{
	int iVar0;
	int iVar1;
...
int func_464(int iParam0, bool bParam1)//Position - 0x36FD1
{
	int iVar0;
...
void func_465(bool bParam0)//Position - 0x37007
{
	int iVar0;
	int iVar1;
...
void func_466()//Position - 0x37289
{
	switch (iLocal_171)
	{
		case 0:
...
void func_467(int iParam0)//Position - 0x373A5
{
...
int func_468(vector3 vParam0, bool bParam3)//Position - 0x373EE
{
	int iVar0;
...
float func_469(bool bParam0, float fParam1, float fParam2)//Position - 0x3741A
{
	if (bParam0)
	{
		return fParam1;
...
void func_470()//Position - 0x37431
{
	while (iLocal_354 == 0)
	{
		if (func_471(0))
		{
			...
			ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_825, Local_468, PED::GET_PED_BONE_INDEX(Local_468, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			TASK::TASK_PLAY_ANIM(Local_468, "rcmnigel1d", "idle_a", 8f, -8f, -1, 1, 0, 0, 0, 0);
			...
			if (AUDIO::IS_AUDIO_SCENE_ACTIVE("NIGEL_1D_SCENE"))
			{
				if (func_5(Local_749))
				{
					AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(Local_749, "NIGEL_1D_GOLF_CART_A", 0);
				}
			}
			VEHICLE::SET_VEHICLE_ENGINE_ON(Local_749, true, true, 0);
...
int func_471(int iParam0)//Position - 0x37674
{
	int iVar0;
...
void func_472()//Position - 0x3773C
{
	switch (iLocal_171)
	{
		case 0:
...
void func_474()//Position - 0x378A0
{
	char* sVar0;
...
void func_475()//Position - 0x3795B
{
	int iVar0;
...
void func_476(int iParam0, var uParam1)//Position - 0x37ABE
{
	if (!func_185(iParam0))
	{
		return;
...
void func_477(int iParam0)//Position - 0x37AE6
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_479(char* sParam0, bool bParam1)//Position - 0x37B3E
{
	func_480(sParam0);
	func_550(bParam1);
}

void func_480(char* sParam0)//Position - 0x37B52
{
...
void func_481(int iParam0, bool bParam1)//Position - 0x37B92
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_482(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x37C2D
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_76831 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_484(Global_76832, Global_76834, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
float func_483(char* sParam0)//Position - 0x37F12
{
	HUD::_BEGIN_TEXT_COMMAND_GET_WIDTH(sParam0);
	return HUD::_END_TEXT_COMMAND_GET_WIDTH(1);
}

struct<2> func_484(int iParam0, int iParam1, int iParam2)//Position - 0x37F25
{
	struct<2> Var0;
	int iVar2;
...
char* func_485(int iParam0)//Position - 0x37FFC
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_486(int iParam0)//Position - 0x38168
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_487(int iParam0)//Position - 0x3819D
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_488(int iParam0)//Position - 0x381D2
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_489(int iParam0)//Position - 0x38207
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_490(int iParam0)//Position - 0x3823C
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_491(int iParam0)//Position - 0x3827B
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_492(int iParam0)//Position - 0x382B0
{
	struct<2> Var0;
...
int func_493(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x3831D
{
...
bool func_494(bool bParam0)//Position - 0x38436
{
	if (bParam0)
	{
...
int func_495(int iParam0)//Position - 0x3845F
{
	if (Global_41396 == 15)
	{
		return 0;
...
bool func_496(int iParam0)//Position - 0x38481
{
	return func_497(iParam0, Global_41396);
}

int func_497(int iParam0, int iParam1)//Position - 0x38492
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_498(int iParam0, int iParam1)//Position - 0x38673
{
	func_501(1, 1);
	if (iParam1 == 1)
	{
...
void func_499()//Position - 0x386B9
{
	HUD::CLEAR_PRINTS();
	func_475();
	PLAYER::SET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID(), 0, 0);
...
void func_500()//Position - 0x3876B
{
	int iVar0;
...
void func_501(bool bParam0, bool bParam1)//Position - 0x38873
{
	if (bParam0)
	{
		func_505(0, 1, 1);
...
void func_502(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x388A6
{
	int iVar0;
...
Vector3 func_503(int iParam0)//Position - 0x38A64
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_504(bool bParam0)//Position - 0x38A77
{
	int iVar0;
...
void func_505(bool bParam0, int iParam1, int iParam2)//Position - 0x38AB5
{
	bool bVar0;
...
void func_506(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x38B14
{
	if (func_538())
	{
...
void func_507(char* sParam0, int iParam1)//Position - 0x38BA9
{
	sParam0 = sParam0;
	iParam1 = iParam1;
}

int func_508()//Position - 0x38BB9
{
...
int func_509(int iParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6)//Position - 0x38BE3
{
	bool bVar0;
	float fVar1;
...
bool func_510(bool bParam0)//Position - 0x38C3F
{
...
int func_511(int iParam0)//Position - 0x38C6A
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_512()//Position - 0x38C8B
{
	int iVar0;
	...
	iLocal_778 = PED::ADD_SCENARIO_BLOCKING_AREA(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, 0, 1, 1, 1);
...
void func_513(var uParam0, var uParam1, float fParam2)//Position - 0x390C3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_514(var uParam0)//Position - 0x391D0
{
	int iVar0;
	float fVar1;
...
void func_515(var uParam0, vector3 vParam1)//Position - 0x39270
{
	if (uParam0->f_51 == 0)
	{
	}
...
void func_516(var uParam0)//Position - 0x392A1
{
	if (uParam0->f_51)
	{
	}
...
void func_517(int iParam0)//Position - 0x392C8
{
	if (func_520())
	{
		return;
...
void func_518(bool bParam0, bool bParam1)//Position - 0x39352
{
	if (bParam0)
	{
		if (func_351(0))
...
bool func_519()//Position - 0x393C6
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

bool func_520()//Position - 0x393D7
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

void func_521(int iParam0, int iParam1, bool bParam2)//Position - 0x393E9
{
	int iVar0;
...
void func_522()//Position - 0x39519
{
	char cVar0[64];
	char cVar16[64];
	char* sVar32;
...
struct<4> func_523(int iParam0)//Position - 0x39598
{
	return Global_1798[iParam0 /*29*/].f_3;
}

int func_524(int iParam0, int iParam1)//Position - 0x395AB
{
...
int func_525(int iParam0, int iParam1)//Position - 0x395D5
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_526(int iParam0, int iParam1, int iParam2)//Position - 0x395FF
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_527(int iParam0, int iParam1, int iParam2)//Position - 0x39644
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
int func_528(int iParam0)//Position - 0x39689
{
	if (!func_185(iParam0))
	{
		return 0;
...
void func_529()//Position - 0x396B0
{
...
void func_530(char* sParam0)//Position - 0x39ED1
{
	sParam0 = sParam0;
}

void func_531(var uParam0, bool bParam1, bool bParam2)//Position - 0x39EDD
{
	int iVar0;
...
int func_532(var uParam0, var uParam1)//Position - 0x39FD2
{
	int iVar0[7];
	char* sVar8;
	int iVar9;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			TASK::SET_SEQUENCE_TO_REPEAT(iVar10, 1);
...
void func_533(int iParam0, bool bParam1)//Position - 0x3A5C2
{
	switch (iParam0)
	{
		case 37:
		...
		case 38:
			if (bParam1)
			{
				iLocal_107 = PED::ADD_SCENARIO_BLOCKING_AREA(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, 0, 1, 1, 1);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_GUARD_STAND", 0);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_CLIPBOARD", 0);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_DRIVE_SOLO", 0);
		...
		case 39:
			if (bParam1)
			{
				iLocal_107 = PED::ADD_SCENARIO_BLOCKING_AREA(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, 0, 1, 1, 1);
				PED::SET_PED_NON_CREATION_AREA(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f);
		...
		case 41:
			if (bParam1)
			{
				iLocal_107 = PED::ADD_SCENARIO_BLOCKING_AREA(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, 0, 1, 1, 1);
		...
		case 42:
			if (bParam1)
			{
				iLocal_107 = PED::ADD_SCENARIO_BLOCKING_AREA(-1319.566f, -650.077f, 23.53715f, -1301.789f, -634.0721f, 38.18122f, 0, 1, 1, 1);
...
void func_534(bool bParam0)//Position - 0x3A9E0
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	vVar6 = { vVar0 };
	vVar9 = { vVar3 };
	PATHFIND::SET_ROADS_IN_ANGLED_AREA(vVar6, vVar9, 25f, 0, bParam0, 1);
	VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vVar0, vVar3, bParam0, 1);
	if (!bParam0)
	{
...
void func_539(int iParam0)//Position - 0x3AB1E
{
	int iVar0;
...
void func_540(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x3ACBB
{
...
void func_541(var uParam0, bool bParam1)//Position - 0x3ACDB
{
	func_542(&(uParam0->f_41), bParam1);
}

void func_542(var uParam0, bool bParam1)//Position - 0x3ACED
{
	int iVar0;
...
void func_543(var uParam0, bool bParam1)//Position - 0x3AD2B
{
	func_544(&(uParam0->f_35), bParam1);
}

void func_544(var uParam0, bool bParam1)//Position - 0x3AD3D
{
	int iVar0;
...
void func_545(var uParam0, int iParam1)//Position - 0x3AD7A
{
	func_546(&(uParam0->f_28), iParam1);
}

void func_546(var uParam0, int iParam1)//Position - 0x3AD8C
{
	int iVar0;
...
void func_547(int iParam0, bool bParam1)//Position - 0x3ADCD
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_548()//Position - 0x3AE08
{
	int iVar0;
...
void func_550(bool bParam0)//Position - 0x3AED3
{
	int iVar0;
...
void func_551(char* sParam0, int iParam1)//Position - 0x3AFA3
{
	if (Global_98669 != 12)
	{
...
int func_552(char* sParam0, int iParam1, int iParam2)//Position - 0x3AFCB
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
void func_556(bool bParam0)//Position - 0x3B23D
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_557(int iParam0)//Position - 0x3B251
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_558(int iParam0)//Position - 0x3B28E
{
	if (iParam0 == 1)
	{
...
void func_559()//Position - 0x3B2CB
{
	Global_22211.f_5 = 1;
}

void func_560()//Position - 0x3B2D9
{
	Global_22211.f_5 = 0;
}

void func_561(bool bParam0)//Position - 0x3B2E7
{
	if (bParam0)
	{
		func_562();
...
void func_562()//Position - 0x3B34A
{
...
void func_563()//Position - 0x3B373
{
	Global_92875 = 0;
	Global_92876 = 0;
}

int func_564()//Position - 0x3B385
{
...
void func_565()//Position - 0x3B3C3
{
	Global_98704 = 1;
...
void func_566(int iParam0)//Position - 0x3B4B8
{
...
void func_567()//Position - 0x3B4CA
{
	int iVar0;
...
void func_568(var uParam0)//Position - 0x3B4EA
{
...
void func_569(var uParam0)//Position - 0x3B50A
{
	int iVar0;
...
int func_570(int iParam0)//Position - 0x3B544
{
	if (!func_185(iParam0))
	{
		return func_236(iParam0);
