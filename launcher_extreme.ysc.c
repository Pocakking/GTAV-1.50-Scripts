...
void __EntryFunction__()//Position - 0x0
{
	...
	if (Var0 == 17)
	{
		iLocal_97 = PED::ADD_SCENARIO_BLOCKING_AREA(vVar61 - Vector(40f, 40f, 40f), vVar61 + Vector(40f, 40f, 40f), 0, 1, 1, 1);
	...
	while (true)
	{
		...
		{
			func_196(&Var0);
			func_191(&Var0, vVar61, "EXT2AU", "EXT2_AMB", 3, "DOM", 5000, 1101004800);
		}
		else if (Var0 == 19)
		{
			func_196(&Var0);
			...
			{
				func_191(&Var0, vVar61, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
			}
...
int func_26(var uParam0)//Position - 0x29D9
{
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x29FB
{
	int iVar0;
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2A83
{
...
int func_29(int iParam0)//Position - 0x2AC3
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x2AF1
{
...
int func_31(int iParam0)//Position - 0x2BCD
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2C0F
{
	int iVar0;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x2C72
{
	int iVar0;
...
int func_34(int iParam0, int iParam1)//Position - 0x2D00
{
	struct<82> Var0;
...
void func_35(int iParam0, var uParam1, int iParam2)//Position - 0x2D42
{
	int iVar0;
...
bool func_36(int iParam0)//Position - 0x2F9E
{
	return iParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2FAA
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x3255
{
	switch (iParam0)
	{
		case 1:
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x3305
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x34F8
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0)//Position - 0x3518
{
	int iVar0;
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x35C9
{
	char* sVar0;
...
int func_43(int iParam0, int iParam1, bool bParam2)//Position - 0x36F8
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x3769
{
...
int func_45(int iParam0)//Position - 0x3842
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x387F
{
	if (func_36(iParam0))
	{
...
var func_47(int iParam0)//Position - 0x38A4
{
	return Global_1798[iParam0 /*29*/];
}

void func_48(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x38B3
{
	int iVar0;
	int iVar1;
...
int func_60(int iParam0)//Position - 0x471B
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_61(int iParam0)//Position - 0x47B6
{
...
int func_62(int iParam0, int iParam1)//Position - 0x4948
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var uParam1)//Position - 0x54B9
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x54F4
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x5768
{
	int iVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x57A4
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_67(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x5CFF
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5D43
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x645E
{
	if (bParam6)
	{
...
int func_70(var uParam0)//Position - 0x64A5
{
...
bool func_71(int iParam0)//Position - 0x6500
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x6510
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x657A
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x68AA
{
	return Global_30736;
}

int func_75(int iParam0)//Position - 0x68B5
{
	return func_72(iParam0, 5, 1);
}

int func_76(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x68C5
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x6967
{
	switch (iParam0)
	{
		case -1:
...
int func_78(int iParam0)//Position - 0x6F84
{
	if (iParam0 != func_87())
	{
...
Vector3 func_79(int iParam0, int iParam1)//Position - 0x6FE2
{
	vector3 vVar0;
	vector3 vVar6;
...
Vector3 func_81(vector3 vParam0, float fParam3)//Position - 0x7125
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
int func_87()//Position - 0x7EA2
{
	return -1;
}

Vector3 func_88(int iParam0)//Position - 0x7EAB
{
	switch (iParam0)
	{
		case 1:
...
int func_89()//Position - 0x80B8
{
	return func_90(PLAYER::PLAYER_ID());
}

int func_90(int iParam0)//Position - 0x80C8
{
	return MISC::GET_BITS_IN_RANGE(Global_2424073[iParam0 /*421*/].f_309.f_3, 28, 31);
}

int func_91(int iParam0)//Position - 0x80E5
{
	return func_72(iParam0, 0, 0);
}

int func_92(int iParam0)//Position - 0x80F5
{
	switch (iParam0)
	{
		case -1:
...
bool func_93()//Position - 0x83C3
{
	return Global_98721.f_345 > 0;
}

var func_94()//Position - 0x83D4
{
	var uVar0;
...
void func_95(var uParam0, int iParam1)//Position - 0x841A
{
	if (iParam1 <= 0)
	{
		return;
...
void func_96(var uParam0, int iParam1)//Position - 0x84A0
{
...
void func_97(var uParam0, int iParam1)//Position - 0x84D3
{
	int iVar0;
	int iVar1;
...
int func_98(int iParam0, int iParam1)//Position - 0x8524
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_99(int iParam0)//Position - 0x85C6
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_100(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_100(bool bParam0, int iParam1, int iParam2)//Position - 0x85EB
{
	if (bParam0)
	{
		return iParam1;
...
int func_101(var uParam0)//Position - 0x8602
{
	return uParam0 & 15;
}

void func_102(var uParam0, int iParam1)//Position - 0x860F
{
...
void func_103(var uParam0, int iParam1)//Position - 0x8649
{
...
void func_104(var uParam0, int iParam1)//Position - 0x8684
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_105()//Position - 0x86C0
{
	func_56();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_106(int iParam0)//Position - 0x86D9
{
	var uVar0;
	vector3 vVar1[24];
...
void func_107(char* sParam0, int iParam1, int iParam2)//Position - 0x8732
{
...
bool func_108(bool bParam0)//Position - 0x8774
{
...
struct<2> func_109(int iParam0)//Position - 0x879F
{
	struct<2> Var0;
...
void func_110(int iParam0, var uParam1)//Position - 0x8BEC
{
	switch (iParam0)
	{
		case 0:
...
int func_112(int iParam0)//Position - 0x9EC4
{
	switch (iParam0)
	{
		case 0:
...
int func_113(int iParam0)//Position - 0xA20A
{
	int iVar0;
...
void func_114(int iParam0)//Position - 0xA2AE
{
	struct<2> Var0;
...
void func_115(int iParam0)//Position - 0xA349
{
	if (iParam0 < 63)
	{
		func_116();
...
void func_117(int iParam0)//Position - 0xA3A7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_118(int iParam0)//Position - 0xA400
{
...
int func_119(int iParam0)//Position - 0xA483
{
	int iVar0;
...
void func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA4B4
{
	func_121(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_121(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA4C9
{
	int iVar0;
...
int func_123(int iParam0, int iParam1, int iParam2)//Position - 0xA57C
{
...
int func_124(int iParam0, int iParam1, int iParam2)//Position - 0xA597
{
	int iVar0;
...
int func_125(int iParam0)//Position - 0xA5E3
{
	int iVar0;
...
int func_126(int iParam0)//Position - 0xA62C
{
	if (func_189(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_127(int iParam0)//Position - 0xA64C
{
	switch (iParam0)
	{
		case 5:
...
int func_129(int iParam0)//Position - 0xA71C
{
	switch (iParam0)
	{
		case 5:
...
void func_130(var uParam0, bool bParam1, bool bParam2)//Position - 0xA76F
{
	int iVar0;
...
int func_131(int iParam0)//Position - 0xA864
{
	switch (iParam0)
	{
		case 5:
...
void func_132(bool bParam0)//Position - 0xA8CF
{
	int iVar0;
...
void func_133(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0xA90D
{
	if (bParam0)
	{
...
bool func_134()//Position - 0xAA46
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_135(int iParam0, int iParam1)//Position - 0xAA63
{
	bool bVar0;
...
int func_136(int iParam0, bool bParam1)//Position - 0xAAAE
{
	int iVar0;
	int iVar1;
...
int func_137(int iParam0)//Position - 0xAAEF
{
...
bool func_138()//Position - 0xAB31
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_139(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xAB42
{
	int iVar0;
...
void func_141(int iParam0)//Position - 0xAB9C
{
	if (iParam0 == 1)
	{
...
int func_142(int iParam0)//Position - 0xABBF
{
...
void func_143()//Position - 0xABFC
{
	Global_19671 = 0;
	func_144();
}

void func_144()//Position - 0xAC0C
{
...
int func_147(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xACD0
{
...
void func_148(int iParam0)//Position - 0xAE5F
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_150(int iParam0)//Position - 0xAEDC
{
	if (func_155())
	{
		return;
...
void func_151(int iParam0)//Position - 0xAF0F
{
	if (func_155())
	{
		return;
...
void func_152(bool bParam0, bool bParam1)//Position - 0xAF99
{
	if (bParam0)
	{
		if (func_154(0))
...
bool func_153()//Position - 0xB00D
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

int func_154(int iParam0)//Position - 0xB01E
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
bool func_155()//Position - 0xB078
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

int func_156(int iParam0)//Position - 0xB08A
{
...
int func_157(int iParam0)//Position - 0xB0CB
{
	int iVar0;
...
void func_158(int iParam0)//Position - 0xB110
{
...
int func_159(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB142
{
	int iVar0;
...
void func_160(var uParam0, int iParam1)//Position - 0xB279
{
	int iVar0;
...
bool func_161(int iParam0)//Position - 0xB2C8
{
	return func_162(iParam0, Global_41396);
}

int func_162(int iParam0, int iParam1)//Position - 0xB2D9
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_163(int iParam0)//Position - 0xB4BA
{
	if (Global_41396 == 15)
	{
		return 0;
...
int func_164()//Position - 0xB4DC
{
	return func_165(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_165(char* sParam0, int iParam1)//Position - 0xB4ED
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_167(int iParam0, int iParam1)//Position - 0xB55A
{
	switch (iParam0)
	{
		case 0:
...
int func_168(vector3 vParam0, bool bParam3)//Position - 0xB9E1
{
	int iVar0;
...
float func_169(bool bParam0, float fParam1, float fParam2)//Position - 0xBA0D
{
	if (bParam0)
	{
		return fParam1;
...
int func_170(int iParam0)//Position - 0xBA24
{
	switch (iParam0)
	{
		case 0:
...
int func_171(var uParam0)//Position - 0xBAB3
{
	if (*uParam0 == 18)
	{
...
int func_172(int iParam0, int iParam1)//Position - 0xBB5A
{
	if (func_126(iParam0))
	{
...
int func_173(var uParam0, int iParam1)//Position - 0xBB8D
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_174()//Position - 0xC373
{
	func_27(&(Global_102125.f_2890), &Global_102125, 0, 1, 1, 0);
}

int func_175(var uParam0)//Position - 0xC38E
{
	float fVar0;
...
void func_176(int iParam0, int iParam1)//Position - 0xC41C
{
	if (iParam0 == 1)
	{
		if (!func_129(iParam1))
...
int func_177(bool bParam0)//Position - 0xC480
{
	int iVar0;
...
int func_178(int iParam0)//Position - 0xC517
{
	if (func_189(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
int func_179(int iParam0)//Position - 0xC541
{
	int iVar0;
...
var func_180()//Position - 0xCC5E
{
	return Global_98708.f_1;
}

int func_181()//Position - 0xCC6C
{
	if (Global_95621 != -1)
	{
...
bool func_184()//Position - 0xCCD6
{
	return Global_98721.f_346 > 0;
}

bool func_185(int iParam0, int iParam1)//Position - 0xCCE7
{
	switch (iParam0)
	{
		case 5:
...
var func_186()//Position - 0xCD22
{
	return Global_1312873;
}

int func_187()//Position - 0xCD2E
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_188(char[4] cParam0, int iParam1)//Position - 0xCD4A
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_189(int iParam0)//Position - 0xCD61
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
int func_191(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xCDA4
{
	var uVar0;
...
void func_192(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCE2C
{
...
void func_193(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCE67
{
...
void func_194(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCEBD
{
...
float func_195(int iParam0, vector3 vParam1, bool bParam4)//Position - 0xCF58
{
	vector3 vVar0;
...
void func_196(int iParam0)//Position - 0xCF92
{
...
void func_197(int iParam0, int iParam1, vector3 vParam2)//Position - 0xCFBF
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_198(int iParam0, bool bParam1)//Position - 0xD0B0
{
	if (iParam0 == -1)
	{
		return;
...
int func_199(int iParam0)//Position - 0xD0EC
{
	if (Global_76573 == iParam0)
	{
		if (Global_76574 == -1)
...
void func_200(int iParam0, int iParam1)//Position - 0xD125
{
	bool bVar0;
	int iVar1;
...
bool func_201()//Position - 0xD1C3
{
	return Global_96008;
}

void func_202(int iParam0)//Position - 0xD1CF
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_203(iParam0);
...
void func_203(int iParam0)//Position - 0xD1E6
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_204(int iParam0)//Position - 0xD2CE
{
	if (iParam0 == -1)
	{
		iParam0 = func_164();
...
int func_205(var uParam0, bool bParam1)//Position - 0xD2F6
{
	struct<27> Var0;
...
void func_206(int iParam0, var uParam1, int iParam2)//Position - 0xD569
{
	int iVar0;
	int iVar1;
...
int func_207(int iParam0)//Position - 0xD8C1
{
...
int func_208(var uParam0)//Position - 0xD8E1
{
...
int func_209(var uParam0)//Position - 0xD8F9
{
...
void func_210(var uParam0)//Position - 0xD91E
{
	int iVar0;
	int iVar1;
...
void func_211(int iParam0)//Position - 0xDC22
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_212(var uParam0)//Position - 0xDC4D
{
	int iVar0;
...
int func_213(var uParam0, bool bParam1, bool bParam2)//Position - 0xDCCD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_214(int iParam0, int iParam1)//Position - 0xDE8B
{
	int iVar0;
...
int func_215(var uParam0, bool bParam1, int iParam2)//Position - 0xDEBB
{
	int iVar0;
	int iVar1;
...
int func_216(int iParam0)//Position - 0xE177
{
...
int func_217(int iParam0, float fParam1)//Position - 0xE1AB
{
	float fVar0;
...
bool func_218(int iParam0, float fParam1)//Position - 0xE221
{
	return func_219(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_219(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE239
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_220(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_220(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE2FA
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_221(int iParam0, int iParam1)//Position - 0xE426
{
	int iVar0;
...
int func_223(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE535
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_224(vector3 vParam0, vector3 vParam3)//Position - 0xE5C6
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_225(vector3 vParam0)//Position - 0xE5E7
{
	float fVar0;
	float fVar1;
...
void func_226(var uParam0)//Position - 0xE626
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_227(int iParam0, int iParam1)//Position - 0xE641
{
	int iVar0;
...
int func_228(int iParam0)//Position - 0xE680
{
...
int func_229(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE6A8
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_230(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE7A3
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_231(int iParam0, float fParam1)//Position - 0xE8AF
{
	var uVar0;
	vector3 vVar1;
...
int func_232(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0xE944
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_233(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE9D2
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_234(int iParam0)//Position - 0xEA1A
{
...
void func_235(int iParam0)//Position - 0xEA64
{
	int iVar0;
...
int func_236(int iParam0)//Position - 0xEB01
{
	if (iParam0 == -1)
	{
		iParam0 = func_164();
...
int func_237(int iParam0)//Position - 0xEB99
{
...
int func_240(int iParam0)//Position - 0xEC1B
{
...
int func_242(int iParam0)//Position - 0xEC8D
{
	if (func_108(0))
	{
...
int func_243(int iParam0)//Position - 0xECB5
{
	switch (*iParam0)
	{
		case 17:
...
int func_244(var uParam0)//Position - 0xED2A
{
	int iVar0[1];
	int iVar2;
...
void func_245(int iParam0, vector3 vParam1, float fParam4)//Position - 0xEE2E
{
...
void func_246(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0xEE60
{
	func_247(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, vParam2, fParam5, 0, false);
}

void func_247(int iParam0)//Position - 0xEE81
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_248(var uParam0)//Position - 0xEEC2
{
	if (func_209(uParam0))
	{
...
int func_249(int iParam0)//Position - 0xEEEC
{
	int iVar0;
...
void func_250(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0xEF1D
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_251(var uParam0)//Position - 0xEF59
{
	int iVar0[1];
	int iVar2;
	bool bVar3;
...
int func_252(int iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)//Position - 0xF0EC
{
...
int func_253(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0xF148
{
	int iVar0;
...
int func_254(var uParam0, int iParam1)//Position - 0xF1D6
{
	int iVar0;
...
int func_255(var uParam0)//Position - 0xF21C
{
	int iVar0[3];
	int iVar4;
	bool bVar5;
...
void func_256(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xF520
{
	func_257(iParam0);
...
void func_257(int iParam0)//Position - 0xF562
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_258(var uParam0)//Position - 0xF5FE
{
	int iVar0[1];
	int iVar2;
...
int func_259(int iParam0)//Position - 0xF6EA
{
	struct<27> Var0;
	int iVar32;
...
int func_260(int iParam0)//Position - 0xF73E
{
	char* sVar0;
...
int func_261(int iParam0)//Position - 0xF7F7
{
	var uVar0;
...
int func_262(int iParam0)//Position - 0xF8B8
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_263(int iParam0, char* sParam1)//Position - 0xF93D
{
...
bool func_264(int iParam0)//Position - 0xFA1F
{
...
bool func_265(int iParam0)//Position - 0xFA4D
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_266(int iParam0)//Position - 0xFA7B
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_267(int iParam0)//Position - 0xFAA9
{
	if (func_237(iParam0))
	{
		return 0;
...
void func_268()//Position - 0xFADE
{
	func_285("Running end routines.");
	Global_111278 = (Global_111278 - 1);
}

int func_269(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xFAF8
{
	int iVar0;
...
int func_270(int iParam0, vector3 vParam1, float fParam4, var uParam5)//Position - 0xFB5D
{
	int iVar0;
	struct<7> Var1;
...
int func_271(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0xFBDB
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_272(int iParam0, bool bParam1)//Position - 0xFC56
{
	if (*iParam0 == 18)
	{
...
int func_273(var uParam0)//Position - 0xFD37
{
	if (func_209(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_274(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xFD6D
{
...
void func_275(var uParam0, bool bParam1)//Position - 0xFD8D
{
	func_276(&(uParam0->f_41), bParam1);
}

void func_276(var uParam0, bool bParam1)//Position - 0xFD9F
{
	int iVar0;
...
void func_277(int iParam0, bool bParam1)//Position - 0xFDDD
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_278(var uParam0, bool bParam1)//Position - 0xFE18
{
	func_279(&(uParam0->f_35), bParam1);
}

void func_279(var uParam0, bool bParam1)//Position - 0xFE2A
{
	int iVar0;
...
void func_280(int iParam0)//Position - 0xFE67
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_281(var uParam0, int iParam1)//Position - 0xFE9F
{
	func_282(&(uParam0->f_28), iParam1);
}

void func_282(var uParam0, int iParam1)//Position - 0xFEB1
{
	int iVar0;
...
void func_283(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xFEF2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_284(var uParam0)//Position - 0xFF42
{
	if (*uParam0 == -1)
	{
		return;
...
void func_285(int iParam0)//Position - 0xFF7F
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(iParam0))
	{
	}
...
void func_286(var uParam0)//Position - 0xFF91
{
	*uParam0 = -1;
...
void func_287()//Position - 0xFFC4
{
	func_285("Running start routines.");
	Global_111278++;
}

int func_288(int iParam0)//Position - 0xFFDE
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
