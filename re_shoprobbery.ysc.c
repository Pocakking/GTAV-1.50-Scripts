								...
								switch (iLocal_47)
								{
									...
									case 2:
										...
										if (MISC::IS_PROJECTILE_IN_AREA(vLocal_194 - Vector(20f, 20f, 20f), vLocal_194 + Vector(20f, 20f, 20f), 0))
										{
											...
											{
												TASK::TASK_SMART_FLEE_COORD(iLocal_117[1], vLocal_103, 150f, -1, 0, 0);
											...
											{
												TASK::TASK_SMART_FLEE_COORD(iLocal_117[2], vLocal_103, 150f, -1, 0, 0);
											...
											while (iVar2 <= (iLocal_113 - 1))
											{
												if (!PED::IS_PED_INJURED(iLocal_121[iVar2]))
												{
													...
													TASK::TASK_SMART_FLEE_COORD(0, vLocal_103, 150f, -1, 0, 0);
										...
										if (iLocal_49 == 1)
										{
											if (!iLocal_160)
											{
												...
												else if (!PED::IS_PED_INJURED(iLocal_117[0]))
												{
													...
													TASK::TASK_PLAY_ANIM(iLocal_117[0], "random@robbery", "stand_worried_female", 8f, -8f, -1, 9, 0, 0, 0, 0);
													if (!PED::IS_PED_INJURED(iLocal_117[1]))
													{
														TASK::TASK_SMART_FLEE_COORD(iLocal_117[1], vLocal_103, 150f, -1, 0, 0);
														PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_117[1], false);
											...
											if (!iLocal_160)
											{
												...
												else if (!PED::IS_PED_INJURED(iLocal_117[0]))
												{
													...
													while (iVar5 <= (iLocal_113 - 1))
													{
														...
														{
															TASK::TASK_SMART_FLEE_COORD(iLocal_121[iVar5], vLocal_103, 150f, -1, 0, 0);
...
int func_9()//Position - 0x1AB9
{
	return Global_30736;
}

void func_10(int iParam0, int iParam1, bool bParam2)//Position - 0x1AC4
{
	int iVar0;
...
int func_11(int iParam0, int iParam1, bool bParam2)//Position - 0x1B36
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_12(int iParam0, int iParam1, int iParam2)//Position - 0x1BA0
{
...
int func_13(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x1BD4
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_14(bool bParam0)//Position - 0x21D3
{
	int iVar0;
	int iVar1;
...
void func_15(int iParam0)//Position - 0x2455
{
	int iVar0;
...
void func_16(int iParam0)//Position - 0x24AF
{
	bool bVar0;
	char cVar1[64];
...
char* func_17(int iParam0)//Position - 0x2640
{
	switch (iParam0)
	{
		case 0:
...
int func_19(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x274A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_20(int iParam0)//Position - 0x2D9C
{
	func_41(93, iParam0);
	func_41(29, iParam0);
	func_41(30, iParam0);
...
bool func_21(int iParam0)//Position - 0x2DBC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_22(int iParam0, int iParam1, int iParam2)//Position - 0x2F6C
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_23(int iParam0)//Position - 0x2FA9
{
	int iVar0;
...
int func_24(int iParam0, int iParam1)//Position - 0x3345
{
	int iVar0;
...
int func_25(bool bParam0)//Position - 0x36BE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_26(int iParam0, int iParam1)//Position - 0x3775
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_27(int iParam0, int iParam1)//Position - 0x3790
{
...
int func_28(var uParam0, int iParam1)//Position - 0x382D
{
	int iVar0;
	var uVar1[78];
...
int func_29(var uParam0, int iParam1)//Position - 0x38DE
{
	int iVar0;
...
bool func_30(var uParam0, int iParam1)//Position - 0x3959
{
	return (*uParam0)[iParam1] == 78;
}

void func_31(var uParam0)//Position - 0x396A
{
	int iVar0;
...
void func_32(var uParam0, int iParam1)//Position - 0x399E
{
	(*uParam0)[iParam1] = 78;
}

void func_33(var uParam0, float fParam1)//Position - 0x39AE
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_34(var uParam0)//Position - 0x39CB
{
	return uParam0->f_80;
}

bool func_35(var uParam0, int iParam1)//Position - 0x39D7
{
	return func_36(uParam0, iParam1) != -1;
}

int func_36(var uParam0, int iParam1)//Position - 0x39E9
{
	int iVar0;
...
bool func_37(var uParam0)//Position - 0x3A16
{
	return uParam0->f_79 == 1;
}

int func_38(int iParam0)//Position - 0x3A24
{
	switch (iParam0)
	{
		case 60:
...
bool func_39(int iParam0)//Position - 0x3A74
{
	return Global_41396 == iParam0;
}

int func_40(int iParam0, int iParam1)//Position - 0x3A82
{
	int iVar0;
...
void func_41(int iParam0, int iParam1)//Position - 0x3AD3
{
	int iVar0;
...
int func_43(int iParam0)//Position - 0x3BA5
{
	return Global_1798[iParam0 /*29*/].f_17;
}

int func_44()//Position - 0x3BB6
{
	func_45();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_45()//Position - 0x3BCF
{
	int iVar0;
...
bool func_46(int iParam0)//Position - 0x3CCC
{
	return iParam0 < 3;
}

int func_47(int iParam0)//Position - 0x3CD8
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0)//Position - 0x3D15
{
	if (func_46(iParam0))
	{
...
var func_49(int iParam0)//Position - 0x3D3A
{
	return Global_1798[iParam0 /*29*/];
}

void func_50(int iParam0, int iParam1)//Position - 0x3D49
{
	int iVar0;
...
void func_52()//Position - 0x3E80
{
	Global_19671 = 0;
	func_53();
}

void func_53()//Position - 0x3E90
{
...
void func_56()//Position - 0x4045
{
	func_57();
}

int func_57()//Position - 0x4052
{
	if (func_58(0))
	{
		return 0;
...
bool func_58(bool bParam0)//Position - 0x409D
{
...
void func_59(int iParam0, int iParam1)//Position - 0x40C8
{
	if (iParam0 == -1)
	{
		iParam0 = func_72();
...
void func_60(int iParam0, var uParam1, var uParam2)//Position - 0x41CC
{
	bool bVar0;
...
int func_62(int iParam0, int iParam1)//Position - 0x4775
{
	switch (iParam0)
	{
		case 0:
...
int func_63(int iParam0)//Position - 0x4AE9
{
	switch (iParam0)
	{
		case 29:
...
void func_64(int iParam0)//Position - 0x4B18
{
	int iVar0;
	int iVar1;
...
void func_65(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x4B5A
{
	func_66(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_66(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x4B7C
{
	int iVar0;
...
int func_69(int iParam0)//Position - 0x4EB6
{
	int iVar0;
	int iVar1;
...
void func_70(int iParam0, int iParam1)//Position - 0x4EF9
{
	MISC::SET_BIT(&(Global_111560.f_24990.f_8[iParam0]), iParam1);
}

int func_71(int iParam0)//Position - 0x4F14
{
	int iVar0;
...
int func_73(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x4FE2
{
...
int func_74()//Position - 0x51BC
{
	return 1;
}

void func_75(int iParam0)//Position - 0x51C5
{
	Global_111546 = iParam0;
}

void func_76(int iParam0, int iParam1)//Position - 0x51D3
{
	int iVar0;
...
void func_77(int iParam0)//Position - 0x52CC
{
...
void func_78(int iParam0)//Position - 0x531A
{
	struct<7> Var0;
	bool bVar7;
	bool bVar8;
...
int func_80(int iParam0)//Position - 0x587C
{
	int iVar0;
...
int func_81(int iParam0)//Position - 0x5AD1
{
	int iVar0;
...
int func_82(int iParam0)//Position - 0x5B3D
{
	return iParam0;
}

void func_83(int iParam0, var uParam1)//Position - 0x5B47
{
	int iVar0;
	int iVar1;
...
bool func_84(int iParam0)//Position - 0x64E2
{
	struct<7> Var0;
	int iVar7;
...
int func_85(int iParam0)//Position - 0x6516
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_86()//Position - 0x6529
{
	var uVar0;
...
void func_87(var uParam0, int iParam1)//Position - 0x656F
{
	if (iParam1 <= 0)
	{
		return;
...
void func_88(var uParam0, int iParam1)//Position - 0x65F5
{
...
void func_89(var uParam0, int iParam1)//Position - 0x6628
{
	int iVar0;
	int iVar1;
...
int func_90(int iParam0, int iParam1)//Position - 0x6679
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_91(int iParam0)//Position - 0x671B
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_92(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_92(bool bParam0, int iParam1, int iParam2)//Position - 0x6740
{
	if (bParam0)
	{
		return iParam1;
...
int func_93(int iParam0)//Position - 0x6757
{
	return iParam0 & 15;
}

void func_94(var uParam0, int iParam1)//Position - 0x6764
{
...
void func_95(var uParam0, int iParam1)//Position - 0x679E
{
...
void func_96(var uParam0, int iParam1)//Position - 0x67D9
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
struct<7> func_97(int iParam0)//Position - 0x6815
{
	struct<7> Var0;
...
int func_99()//Position - 0x9450
{
	return Global_30737;
}

void func_100(int iParam0, var uParam1)//Position - 0x945B
{
	int iVar0;
	int iVar1;
...
void func_101(int iParam0)//Position - 0x94FA
{
	switch (iParam0)
	{
		case 0:
...
void func_102(char[4] cParam0, int iParam1)//Position - 0x95DB
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

char* func_103(int iParam0)//Position - 0x95F2
{
	char* sVar0;
...
void func_105(var uParam0)//Position - 0x96B7
{
	*uParam0 = -99;
}

void func_106(var uParam0, int iParam1)//Position - 0x96C5
{
...
int func_108(int iParam0)//Position - 0x987F
{
	int iVar0;
...
float func_109(bool bParam0, float fParam1, float fParam2)//Position - 0x98B7
{
	if (bParam0)
	{
		return fParam1;
...
int func_113(int iParam0, bool bParam1, bool bParam2)//Position - 0x9B92
{
	return func_114(iParam0, !bParam1, bParam2);
}

int func_114(int iParam0, bool bParam1, bool bParam2)//Position - 0x9BA5
{
	int iVar0;
...
int func_117(int iParam0)//Position - 0x9D18
{
	int iVar0;
	int iVar1;
...
bool func_118(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x9D68
{
...
int func_119(char* sParam0, int iParam1, bool bParam2)//Position - 0x9DB6
{
	Global_20806 = 0;
...
bool func_122(int iParam0)//Position - 0xA123
{
	return func_123(iParam0, 20);
}

bool func_123(int iParam0, int iParam1)//Position - 0xA133
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_124()//Position - 0xA14E
{
	return -1;
}

void func_125()//Position - 0xA157
{
	int iVar0;
...
bool func_131(int iParam0, int iParam1)//Position - 0xA3D8
{
	switch (iParam0)
	{
		case 5:
...
void func_133(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA46A
{
...
void func_135(bool bParam0)//Position - 0xA4E2
{
	if (bParam0)
	{
		func_141();
...
void func_136(int iParam0)//Position - 0xA545
{
	if (func_139())
	{
		return;
...
void func_137(bool bParam0, bool bParam1)//Position - 0xA5CF
{
	if (bParam0)
	{
		if (func_140(0))
...
bool func_138()//Position - 0xA643
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

bool func_139()//Position - 0xA654
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

int func_140(int iParam0)//Position - 0xA666
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
void func_142(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0xA6E9
{
	if (bParam0)
	{
...
bool func_143()//Position - 0xA822
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_144(int iParam0, int iParam1)//Position - 0xA83F
{
	bool bVar0;
...
int func_145(int iParam0, bool bParam1)//Position - 0xA88A
{
	int iVar0;
	int iVar1;
...
int func_146(int iParam0)//Position - 0xA8CB
{
...
bool func_147()//Position - 0xA90D
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_148(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA91E
{
	int iVar0;
...
void func_149(int iParam0)//Position - 0xA951
{
	if (iParam0 == 1)
	{
...
Vector3 func_157(int iParam0)//Position - 0xB424
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_158()//Position - 0xB437
{
	int iVar0;
	...
	if (!iLocal_136 && func_161(1, 0, 1))
	{
		...
		else if (iLocal_49 == 2)
		{
			...
			{
				TASK::CLEAR_PED_TASKS(iLocal_117[0]);
				TASK::TASK_PLAY_ANIM(iLocal_117[0], "random@robbery", "robbery_main_female", 2f, -2f, -1, 0, 0, 0, 0, 0);
			}
...
void func_159()//Position - 0xB86F
{
	...
	else if (STREAMING::HAS_MODEL_LOADED(iVar0))
	{
		...
		ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_184, 1, 0f);
...
int func_161(bool bParam0, bool bParam1, bool bParam2)//Position - 0xBA0E
{
	int iVar0;
...
void func_162()//Position - 0xBAF3
{
	func_236();
}

int func_163(int iParam0)//Position - 0xBAFF
{
	if (func_164())
	{
		Global_111550 = 1;
...
int func_165(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xBB88
{
	int iVar0;
...
void func_166(var uParam0, int iParam1)//Position - 0xBCBF
{
	int iVar0;
...
bool func_167(int iParam0)//Position - 0xBD0E
{
	return func_168(iParam0, Global_41396);
}

int func_168(int iParam0, int iParam1)//Position - 0xBD1F
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_169(int iParam0)//Position - 0xBF00
{
	if (Global_41396 == 15)
	{
		return 0;
...
int func_171(int iParam0, bool bParam1, int iParam2)//Position - 0xC075
{
	int iVar0;
...
bool func_173(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0xC38D
{
...
void func_176(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xC4CD
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_177(iParam3), 0);
}

int func_177(int iParam0)//Position - 0xC4E6
{
	int iVar0;
...
void func_178()//Position - 0xC6DB
{
	...
	while (iVar0 <= (iLocal_111 - 1))
	{
		...
		ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_114[iVar0], 1, 0f);
	...
	else if (iLocal_49 == 2)
	{
		...
		TASK::TASK_PLAY_ANIM(iLocal_117[0], "random@shop_robbery", "robbery_intro_loop_f", 4f, -4f, -1, 9, 0, 0, 0, 0);
		PED::SET_PED_KEEP_TASK(iLocal_117[0], true);
		TASK::TASK_PLAY_ANIM(iLocal_117[1], "random@robbery", "f_cower_02", 4f, -4f, -1, 9, 0, 0, 0, 0);
		PED::SET_PED_KEEP_TASK(iLocal_117[1], true);
		TASK::TASK_COWER(iLocal_121[0], -1);
		PED::SET_PED_KEEP_TASK(iLocal_121[0], true);
		TASK::TASK_PLAY_ANIM(iLocal_121[1], "random@robbery", "f_cower_01", 4f, -4f, -1, 9, 0, 0, 0, 0);
		PED::SET_PED_KEEP_TASK(iLocal_121[1], true);
		...
		TASK::TASK_PLAY_ANIM(iLocal_114[1], "random@shop_robbery", "robbery_intro_loop_a", 16f, -4f, -1, 9, 0, 0, 0, 0);
		func_182(14, 1);
		func_181(14);
		SYSTEM::WAIT(500);
		func_179(14, 0, 0);
...
void func_179(int iParam0, bool bParam1, bool bParam2)//Position - 0xD12D
{
	int iVar0;
	int iVar1;
...
int func_180(int iParam0, int iParam1)//Position - 0xD190
{
	switch (iParam0)
	{
		case 0:
...
void func_181(int iParam0)//Position - 0xD611
{
	func_10(iParam0, 9, 1);
}

void func_182(int iParam0, bool bParam1)//Position - 0xD622
{
	if (bParam1)
	{
...
void func_183(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD660
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
int func_188(float fParam0, bool bParam1)//Position - 0xDBA9
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_189(int iParam0, var uParam1)//Position - 0xDC60
{
	switch (iParam0)
	{
		case 0:
...
int func_191(int iParam0)//Position - 0xEF38
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_192(int iParam0)//Position - 0xF27E
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_193(int iParam0)//Position - 0xF2B6
{
	struct<2> Var0;
...
bool func_195()//Position - 0xF735
{
	return Global_111278 > 0;
}

int func_196()//Position - 0xF743
{
	if (Global_95621 != -1)
	{
		return 1;
...
void func_201(int iParam0)//Position - 0xF828
{
	if (iParam0 == -1)
	{
		iParam0 = func_72();
...
void func_203(int iParam0)//Position - 0xF89B
{
	Global_111549 = iParam0;
}

int func_204(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xF8A9
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
...
bool func_205(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0xFC43
{
	if (bParam6)
	{
...
bool func_206(int iParam0)//Position - 0xFC8A
{
	int iVar0;
...
int func_207(int iParam0)//Position - 0xFCAB
{
	return func_208(iParam0, 1);
}

int func_208(int iParam0, int iParam1)//Position - 0xFCBA
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_209(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0xFD0D
{
	func_210(func_86(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_210(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0xFD2B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_211(float fParam0, float fParam1, float fParam2)//Position - 0xFF2C
{
	float fVar0;
...
int func_212(int iParam0)//Position - 0xFF6E
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_213(int iParam0)//Position - 0xFF81
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_214(int iParam0)//Position - 0xFF94
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_215(int iParam0, int iParam1)//Position - 0xFFA6
{
	int iVar0;
	int iVar1;
...
int func_216(int iParam0)//Position - 0x100B3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_217(int iParam0, int iParam1)//Position - 0x1018F
{
...
int func_218(int iParam0)//Position - 0x101B2
{
	int iVar0;
...
var func_219()//Position - 0x108CF
{
	return Global_98708.f_1;
}

int func_220()//Position - 0x108DD
{
	if (Global_95621 != -1)
	{
...
bool func_223()//Position - 0x10947
{
	return Global_98721.f_346 > 0;
}

bool func_224()//Position - 0x10958
{
	return Global_98721.f_345 > 0;
}

var func_225()//Position - 0x10969
{
	return Global_1312873;
}

int func_226()//Position - 0x10975
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_228(int iParam0)//Position - 0x109B9
{
	return func_215(func_86(), iParam0);
}

int func_229(int iParam0, int iParam1, int iParam2)//Position - 0x109CB
{
	int iVar0;
	int iVar1;
...
int func_230(int iParam0)//Position - 0x10AAF
{
	if (!func_46(iParam0))
	{
		return 7;
...
bool func_231(int iParam0)//Position - 0x10AD3
{
	int iVar0;
	bool bVar1;
...
bool func_234(int iParam0)//Position - 0x10C30
{
	return func_11(iParam0, 0, 0);
}

bool func_235(int iParam0)//Position - 0x10C40
{
	return func_11(iParam0, 7, 1);
}

void func_236()//Position - 0x10C50
{
	int iVar0;
	...
	if (iLocal_223)
	{
		...
		while (iVar0 <= (iLocal_111 - 1))
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_114[iVar0]))
			{
				...
				{
					TASK::TASK_SMART_FLEE_COORD(iLocal_114[iVar0], vLocal_103, 150f, -1, 0, 0);
					PED::SET_PED_KEEP_TASK(iLocal_114[iVar0], true);
				}
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_114[iVar0]));
			}
				...
				if (!PED::IS_PED_INJURED(iLocal_117[iVar0]))
				{
					...
					if (iVar0 == 0)
					{
						if (!iLocal_183)
						{
							...
							TASK::TASK_SMART_FLEE_COORD(iLocal_117[iVar0], vLocal_103, 150f, -1, 0, 0);
						}
						else
						{
...
void func_237(int iParam0)//Position - 0x10FA2
{
	char cVar0[64];
...
void func_238(var uParam0)//Position - 0x11057
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_239(int iParam0, bool bParam1)//Position - 0x11094
{
	switch (iParam0)
	{
		case 0:
...
void func_240(int iParam0)//Position - 0x112DD
{
	Global_41947 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_241(int iParam0)//Position - 0x112EF
{
	func_242(iParam0, 0, func_247(iParam0));
}

void func_242(int iParam0, int iParam1, int iParam2)//Position - 0x11304
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_243(var uParam0)//Position - 0x11333
{
	struct<16> Var0;
	int iVar16;
...
void func_244(int iParam0, var uParam1)//Position - 0x11404
{
	Global_111560.f_24990.f_43[iParam0] = *uParam1;
}

void func_245(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1141C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_246(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1159E
{
...
void func_248()//Position - 0x11779
{
	Global_19671 = 0;
	func_249();
}

void func_249()//Position - 0x11789
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
Vector3 func_250()//Position - 0x117AD
{
	float fVar0;
