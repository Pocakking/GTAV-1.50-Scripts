...
void func_4(int iParam0)//Position - 0x1E0
{
	...
	if (STREAMING::HAS_MODEL_LOADED(iParam0))
	{
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			...
			{
				iLocal_68 = VEHICLE::CREATE_VEHICLE(iParam0, vVar0, fVar3, 0, 1, 0);
...
var func_13(int iParam0)//Position - 0x54B
{
	return Global_1798[iParam0 /*29*/];
}

int func_14(char* sParam0)//Position - 0x55A
{
	if (iLocal_94 != 0)
	{
...
bool func_15(int iParam0)//Position - 0x5C4
{
	return Global_41396 == iParam0;
}

void func_16(char* sParam0)//Position - 0x5D2
{
	if (func_14(""))
	{
	}
...
void func_17(int iParam0)//Position - 0x604
{
...
int func_18(int iParam0, vector3 vParam1, float fParam4)//Position - 0x624
{
	vector3 vVar0[9];
	vector3 vVar28;
	vector3 vVar31;
	...
	vVar34.y = (MISC::ABSF((vVar31.y - vVar28.y)) / 2f);
	vVar34.z = (MISC::ABSF((vVar31.z - vVar28.z)) / 2f);
	vVar0[0 /*3*/] = { vParam1 };
...
Vector3 func_19(int iParam0)//Position - 0x8E0
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_20(int iParam0)//Position - 0x8F3
{
...
void func_21(char* sParam0)//Position - 0x916
{
	if (!func_15(14))
	{
...
void func_24(char* sParam0)//Position - 0xA0D
{
	if (func_14(sParam0))
	{
	}
...
int func_26(int iParam0)//Position - 0xA8F
{
	var uVar0;
...
int func_29(int iParam0)//Position - 0xB22
{
...
void func_31(int iParam0, bool bParam1)//Position - 0xBBF
{
	if (bParam1)
	{
...
bool func_33(bool bParam0)//Position - 0xCCE
{
	if (bParam0)
	{
...
int func_38(int iParam0, int iParam1)//Position - 0xFCB
{
	int iVar0;
	int iVar1;
...
void func_40(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17)//Position - 0x1167
{
	int iVar0;
	int iVar1;
...
void func_41(int iParam0, int iParam1)//Position - 0x12C4
{
	MISC::SET_BIT(&(Global_1375006.f_6184[iParam0]), iParam1);
}

bool func_42(int iParam0, int iParam1)//Position - 0x12DD
{
	return MISC::IS_BIT_SET(Global_1375006.f_6184[iParam0], iParam1);
}

void func_43()//Position - 0x12F6
{
	switch (iLocal_59)
	{
		case 1:
...
void func_46(bool bParam0)//Position - 0x151A
{
...
void func_48(int iParam0)//Position - 0x1628
{
	int iVar0;
...
void func_49(int iParam0)//Position - 0x164D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_50(int iParam0)//Position - 0x16A6
{
...
int func_51(int iParam0)//Position - 0x1729
{
	int iVar0;
...
void func_52(int iParam0, int iParam1, int iParam2)//Position - 0x175A
{
	func_53(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_53(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x176F
{
	int iVar0;
...
int func_55(int iParam0, int iParam1, int iParam2)//Position - 0x1822
{
...
int func_56(int iParam0, int iParam1, int iParam2)//Position - 0x183D
{
	int iVar0;
...
int func_57(int iParam0)//Position - 0x1889
{
	int iVar0;
...
void func_58(int iParam0, float fParam1, float fParam2, int iParam3)//Position - 0x18D2
{
	func_59(-1, iParam0, fParam1, fParam2, iParam3, 1);
}

void func_59(int iParam0, var uParam1, float fParam2, float fParam3, int iParam4, bool bParam5)//Position - 0x18E8
{
	int iVar0;
...
int func_60(int iParam0)//Position - 0x19A3
{
	return func_61(iParam0, -1, 1);
}

int func_61(int iParam0, int iParam1, bool bParam2)//Position - 0x19B3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0)//Position - 0x1A9E
{
	int iVar0;
...
int func_66(int iParam0)//Position - 0x1C51
{
...
int func_71(int iParam0)//Position - 0x1D74
{
	if (iParam0 == 1)
	{
...
int func_75()//Position - 0x1FC5
{
	return ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID());
}

void func_76()//Position - 0x1FD5
{
	int iVar0;
...
int func_82(int iParam0)//Position - 0x25C9
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		if (ENTITY::DOES_ENTITY_EXIST(iVar0))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
			{
				...
				if (iParam0 & 512 != 0)
				{
					...
					iVar4 = ENTITY::GET_ENTITY_SCRIPT(iVar0, &uVar3);
					if (!MISC::IS_STRING_NULL_OR_EMPTY(iVar4))
					{
						if (MISC::GET_HASH_KEY(iVar4) == MISC::GET_HASH_KEY("taxiService"))
						{
							return 0;
						}
					}
...
int func_83(int iParam0, int iParam1, bool bParam2)//Position - 0x27CA
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_84(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x283B
{
...
int func_85(int iParam0, int iParam1)//Position - 0x2913
{
	struct<82> Var0;
...
void func_86(int iParam0, var uParam1, int iParam2)//Position - 0x2955
{
	int iVar0;
...
void func_103(int iParam0, char* sParam1)//Position - 0x3AAB
{
	if (iLocal_46 == 1)
	{
...
int func_104(int iParam0)//Position - 0x3B45
{
	switch (iParam0)
	{
		case joaat("dodo"):
...
bool func_105(int iParam0, int iParam1)//Position - 0x3B9D
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_106(int iParam0, int iParam1)//Position - 0x3BC0
{
...
int func_107(int iParam0, int iParam1)//Position - 0x3C0D
{
	if (!func_15(14))
	{
