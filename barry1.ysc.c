...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_32 = 180f;
	iLocal_35 = 3;
	uLocal_83 = func_577(49);
	iLocal_87 = 1;
	iLocal_88 = 65;
	iLocal_89 = 49;
	iLocal_90 = 64;
	uLocal_94 = HUD::_GET_LEVEL_BLIP_SPRITE();
	iLocal_95 = HUD::_GET_WAYPOINT_BLIP_SPRITE();
	sLocal_159 = "";
	iLocal_160 = -1;
...
int func_5(vector3 vParam0, int iParam3, int iParam4)//Position - 0x698
{
	int iVar0;
...
float func_8(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x6FF
{
	vector3 vVar0;
	...
	switch (iLocal_161)
	{
		...
		case 1:
			if (iParam0 == 0)
			{
				...
				TASK::TASK_PLAY_ANIM(0, iLocal_338, sLocal_352, 8f, -8f, -1, 0, 0, 0, 0, 0);
				TASK::TASK_PLAY_ANIM(0, iLocal_338, sLocal_353, 8f, -8f, -1, 1, 0, 0, 0, 0);
				TASK::CLOSE_SEQUENCE_TASK(uVar4);
				TASK::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uVar4);
				TASK::CLEAR_SEQUENCE_TASK(&uVar4);
			}
			iVar5 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", CAM::GET_GAMEPLAY_CAM_COORD(), CAM::GET_GAMEPLAY_CAM_ROT(2), CAM::GET_GAMEPLAY_CAM_FOV(), 1, 2);
			vVar0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - CAM::GET_GAMEPLAY_CAM_COORD() };
			CAM::ATTACH_CAM_TO_ENTITY(iVar5, PLAYER::PLAYER_PED_ID(), -vVar0, 1);
			if (CAM::DOES_CAM_EXIST(iVar5))
			{
				CAM::SET_CAM_ACTIVE(iVar5, 1);
			}
		...
		case 5:
			if (MISC::GET_GAME_TIMER() > iLocal_158)
			{
				if (iParam0 == 1)
				{
					...
					MISC::CLEAR_AREA_OF_VEHICLES(vLocal_174, 200f, 0, 0, 0, 0, false, 0);
...
bool func_21(int iParam0)//Position - 0x10EF
{
	return func_22(iParam0, 20);
}

bool func_22(int iParam0, int iParam1)//Position - 0x10FF
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_23()//Position - 0x111A
{
	return -1;
}

void func_24()//Position - 0x1123
{
	int iVar0;
...
int func_29()//Position - 0x134A
{
	func_30();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_30()//Position - 0x1363
{
	int iVar0;
...
bool func_31(int iParam0)//Position - 0x1460
{
	return iParam0 < 3;
}

int func_32(int iParam0)//Position - 0x146C
{
	int iVar0;
	int iVar1;
...
int func_33(int iParam0)//Position - 0x14A9
{
	if (func_31(iParam0))
	{
...
var func_34(int iParam0)//Position - 0x14CE
{
	return Global_1798[iParam0 /*29*/];
}

bool func_35(int iParam0)//Position - 0x14DD
{
	return Global_41396 == iParam0;
}

void func_36()//Position - 0x14EB
{
	int iVar0;
...
bool func_37(int iParam0, int iParam1)//Position - 0x1541
{
	switch (iParam0)
	{
		case 5:
...
void func_39(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x15D3
{
...
bool func_40(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1629
{
...
void func_41(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1677
{
...
void func_42(char* sParam0, bool bParam1)//Position - 0x1712
{
	func_43(bParam1);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_43(bool bParam0)//Position - 0x1728
{
	int iVar0;
...
void func_44(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x1766
{
	if (bParam0)
	{
...
bool func_45()//Position - 0x189F
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_46(int iParam0, int iParam1)//Position - 0x18BC
{
	bool bVar0;
...
int func_47(int iParam0, bool bParam1)//Position - 0x1907
{
	int iVar0;
	int iVar1;
...
int func_48()//Position - 0x1948
{
	return Global_1312745;
}

int func_49(int iParam0)//Position - 0x1954
{
...
bool func_50()//Position - 0x1996
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_51(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x19A7
{
	int iVar0;
...
void func_52(int iParam0)//Position - 0x19DA
{
	if (iParam0 == 1)
	{
...
void func_53(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x19FD
{
	int iVar0;
...
int func_54(int iParam0)//Position - 0x1AA6
{
	if (func_574(iParam0))
	{
...
void func_55(vector3 vParam0, float fParam3)//Position - 0x1AC6
{
	func_56(&(Global_105109.f_2890), vParam0, fParam3);
}

void func_56(var uParam0, vector3 vParam1, var uParam4)//Position - 0x1ADF
{
	*uParam0 = { vParam1 };
	uParam0->f_6 = uParam4;
}

void func_57(vector3 vParam0, float fParam3)//Position - 0x1AF5
{
...
bool func_58(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x1B21
{
	if (bParam6)
	{
...
void func_60(int iParam0)//Position - 0x1B95
{
	int iVar0;
...
void func_61(var uParam0, int iParam1)//Position - 0x1BC1
{
	if (*uParam0 == 0)
	{
		return;
...
void func_62(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1BE9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_63(var uParam0)//Position - 0x1C39
{
	if (func_67(uParam0))
	{
		iLocal_558 = 0;
...
void func_64(var uParam0)//Position - 0x1C8A
{
...
void func_65(var uParam0)//Position - 0x1CBA
{
	if (*uParam0 != 0)
	{
...
void func_66(var uParam0)//Position - 0x1CEA
{
	if (*uParam0 != -1)
	{
...
bool func_67(var uParam0)//Position - 0x1D0B
{
	return (uParam0->f_1 == 10 || uParam0->f_1 == 11);
}

void func_68()//Position - 0x1D27
{
	int iVar0;
...
void func_70(int iParam0)//Position - 0x1DBC
{
	var uVar0;
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			TASK::TASK_PLAY_ANIM(0, iLocal_338, sLocal_348, 8f, -8f, -1, 0, 0, 0, 0, 0);
			TASK::TASK_PLAY_ANIM(0, iLocal_338, sLocal_351, 8f, -2f, -1, 0, 0, 0, 0, 0);
...
int func_71()//Position - 0x1F30
{
	...
	{
		case 0:
			iLocal_930 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", vLocal_967, vLocal_970, 50f, 0, 2);
		...
		case 3:
			if (MISC::GET_GAME_TIMER() > iLocal_966)
			{
				ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), vLocal_967, 1, 0, 0, 1);
				...
				if (CAM::_0xEE778F8C7E1142E2(0) != 4)
				{
					if (CAM::DOES_CAM_EXIST(iLocal_930))
					{
						...
						CAM::SET_CAM_ACTIVE(iLocal_930, 1);
						CAM::ATTACH_CAM_TO_ENTITY(iLocal_930, PLAYER::PLAYER_PED_ID(), 0f, 0f, 4f, 0);
					}
				}
				else
				{
		...
		case 6:
			if (CAM::IS_GAMEPLAY_CAM_RENDERING())
			{
				if (CAM::DOES_CAM_EXIST(iLocal_930))
				{
					CAM::SET_CAM_ACTIVE(iLocal_930, 0);
					CAM::DESTROY_CAM(iLocal_930, 0);
				}
				return 1;
			}
			break;
...
void func_73(var uParam0)//Position - 0x2125
{
	if (*uParam0 == 0)
	{
		return;
...
void func_74(int iParam0)//Position - 0x2149
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_75(var uParam0, float fParam1)//Position - 0x218A
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if (!uParam0->f_15)
	{
		if (CAM::DOES_CAM_EXIST(uParam0->f_11))
		{
			...
			{
				fVar2 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iVar11, 1), CAM::GET_CAM_COORD(uParam0->f_11), true);
			}
			else
			{
				fVar2 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iVar11, 0), CAM::GET_CAM_COORD(uParam0->f_11), true);
			}
			...
			if (bVar9)
			{
				...
				CAM::ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], iVar10, vVar6, 1);
			}
			else
			{
				vVar6 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iVar11, CAM::GET_FINAL_RENDERED_CAM_COORD()) };
				CAM::ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], iVar11, vVar6, 1);
			}
			...
			{
				vVar6 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iVar10, CAM::GET_FINAL_RENDERED_CAM_COORD()) };
				CAM::ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], iVar10, vVar6 + Vector(15f, 0f, 0f), 1);
			}
			else
			{
...
void func_76(int iParam0)//Position - 0x27C2
{
	Global_22209 = iParam0;
}

float func_77(int iParam0)//Position - 0x27CF
{
	vector3 vVar0;
...
float func_78(float fParam0, float fParam1, float fParam2)//Position - 0x27F2
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
int func_79()//Position - 0x2819
{
	return Global_2359302.f_2;
}

void func_80(int iParam0, int iParam1, int iParam2)//Position - 0x2827
{
	if (*iParam2 >= 8)
	{
		return;
...
void func_81(int iParam0)//Position - 0x284B
{
	if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
	{
		if (func_574(PLAYER::PLAYER_PED_ID()))
	...
	switch (*iParam0)
	{
		case 0:
			func_42("bar_2_rcm", 0);
			func_341(vLocal_174, 1112014848, 12, 5000, 0, 0);
		...
		case 1:
			if (func_333(1, 1093140480, 0) && SCRIPT::HAS_SCRIPT_LOADED("postRC_Barry1and2"))
			{
				...
				func_332();
				MISC::CLEAR_AREA_OF_VEHICLES(vLocal_174, 250f, 0, 0, 0, 0, false, 0);
				MISC::CLEAR_AREA_OF_PEDS(vLocal_174, 50f, 0);
				MISC::CLEAR_AREA_OF_OBJECTS(vLocal_174, 30f, 0);
				GRAPHICS::REMOVE_DECALS_IN_RANGE(vLocal_174, 500f);
				PLAYER::CLEAR_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID());
				func_283();
				CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(0, sLocal_328, 2, func_577(49), 0);
		...
		case 2:
			...
			else
			{
				...
				{
					if (func_574(Local_96.f_41[0]) && func_574(Local_96.f_41[2]))
					{
...
void func_83(int iParam0, bool bParam1)//Position - 0x2C7C
{
	int iVar0;
	var uVar1;
...
void func_85(int iParam0, int iParam1, int iParam2)//Position - 0x2DFE
{
	bool bVar0;
...
int func_87()//Position - 0x33A7
{
	return Global_30736;
}

int func_88(int iParam0, int iParam1)//Position - 0x33B2
{
	int iVar0;
...
int func_89(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x3403
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_91(int iParam0)//Position - 0x3AAE
{
	if (iParam0 == 1)
	{
...
void func_93()//Position - 0x3AF5
{
	StringCopy(&Global_76809, "", 16);
	StringCopy(&Global_76813, "", 16);
}

void func_94()//Position - 0x3B0D
{
	int iVar0;
...
void func_98(int iParam0)//Position - 0x3BDF
{
	if (iParam0 == 1)
	{
		Global_41945 = 1;
...
void func_99()//Position - 0x3BF8
{
	func_100(&Global_105109);
}

void func_100(var uParam0)//Position - 0x3C08
{
	int iVar0;
	int iVar1;
...
void func_101(var uParam0)//Position - 0x4199
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_102(var uParam0)//Position - 0x41B4
{
...
void func_103(var uParam0)//Position - 0x41E3
{
	int iVar0;
...
void func_104(var uParam0)//Position - 0x4292
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_105(var uParam0)//Position - 0x42B0
{
	int iVar0;
...
void func_106(var uParam0)//Position - 0x438F
{
	*uParam0 = -15;
}

void func_107()//Position - 0x439D
{
	StringCopy(&Global_102117, "", 32);
	func_100(&Global_102125);
}

void func_108()//Position - 0x43B5
{
...
int func_110(int iParam0, int iParam1, int iParam2)//Position - 0x44F3
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	else
	{
		...
		Global_76389[1 /*14*/] = { func_161(iVar0, iParam1, uVar31[iParam1], -1) };
...
int func_111(int iParam0, int iParam1, int iParam2)//Position - 0x46B2
{
	int iVar0;
...
int func_112(int iParam0)//Position - 0x473E
{
	switch (iParam0)
	{
...
int func_113(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x4779
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76389[1 /*14*/] = { func_161(iVar10, 14, uVar28[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76389[1 /*14*/] = { func_161(iVar10, 14, uVar69[iVar1], -1) };
			func_129(iParam0, Global_76389[1 /*14*/].f_12, Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4);
			func_144(14);
			if (Global_76387 == 1)
			{
...
void func_114(int iParam0, int iParam1, int iParam2)//Position - 0x4F8F
{
	int iVar0;
	int iVar1;
...
int func_115(int iParam0, int iParam1, int iParam2)//Position - 0x5019
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_116(int iParam0, int iParam1, int iParam2)//Position - 0x50F7
{
	Global_76389[1 /*14*/] = { func_161(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 2);
}

int func_117(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x5122
{
	var uVar0;
	int iVar10;
...
int func_118(int iParam0, int iParam1, int iParam2)//Position - 0x5726
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_119(int iParam0, int iParam1, int iParam2)//Position - 0x57BF
{
	int iVar0;
	int iVar1;
...
int func_120(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5860
{
	int iVar0;
...
int func_121(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x5B67
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_122(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x671A
{
	int iVar0;
...
int func_123(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x69FE
{
	int iVar0;
...
int func_124(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6CC5
{
	int iVar0;
	int iVar1;
...
int func_125(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6CFC
{
	int iVar0;
...
int func_126(int iParam0, int iParam1, int iParam2)//Position - 0x6D25
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_127(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6FEF
{
	int iVar0;
...
int func_128(int iParam0, int iParam1, int iParam2)//Position - 0x7279
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_129(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x73D0
{
	int iVar0;
...
int func_130(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7468
{
	switch (iParam0)
	{
...
int func_131(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7536
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_132(int iParam0, int iParam1)//Position - 0x7692
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_133(int iParam0)//Position - 0x7A39
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_134(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7A9A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_135(int iParam0, int iParam1)//Position - 0x7B96
{
	int iVar0;
...
int func_136(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7CD4
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_137(int iParam0)//Position - 0x7DB4
{
	switch (iParam0)
	{
		case 0:
...
int func_138(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7E3A
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_139(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x80B8
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_140(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x84DD
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_141(int iParam0, int iParam1)//Position - 0x87D0
{
	int iVar0;
	int iVar1;
...
int func_142(int iParam0, int iParam1)//Position - 0x8816
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_143(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8876
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_144(int iParam0)//Position - 0x88FA
{
...
void func_145(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x89B2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_146(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x89FC
{
	int iVar0;
...
int func_147(var uParam0)//Position - 0x8A2C
{
	int iVar0;
	int iVar1;
...
int func_148(int iParam0, int iParam1, int iParam2)//Position - 0x8A60
{
	int iVar0;
	var uVar1;
...
bool func_149(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x8A92
{
	int iVar0;
...
int func_150(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xA8F9
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_151(int iParam0)//Position - 0xB817
{
	if (!MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_152(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB868
{
	int iVar0;
...
int func_153(int iParam0)//Position - 0xB8FE
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_154(int iParam0, int iParam1)//Position - 0xB9AE
{
	int iVar0;
	struct<10> Var1;
...
void func_155(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC2DE
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_156(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xC408
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_157(int iParam0, int iParam1)//Position - 0xC450
{
	int iVar0;
	struct<17> Var1;
...
void func_158(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE298
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_159(int iParam0)//Position - 0xE482
{
	switch (iParam0)
	{
		case 0:
...
void func_160(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xE532
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_161(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE5A3
{
	func_224();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_162(int iParam0, int iParam1)//Position - 0xE5F5
{
	switch (iParam0)
	{
		case 0:
...
void func_163(int iParam0)//Position - 0xE6E5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_164(&(Global_76389[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_164(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xF95C
{
	int iVar0;
	int iVar1;
...
bool func_165(int iParam0, int iParam1, var uParam2)//Position - 0xFCED
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_166(int iParam0, int iParam1)//Position - 0x100FD
{
	switch (iParam1)
	{
		case 0:
...
int func_167(int iParam0, int iParam1)//Position - 0x104F8
{
	switch (iParam1)
	{
		case 0:
...
int func_168(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x108F3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_169(int iParam0)//Position - 0x10935
{
	switch (iParam0)
	{
		case -1:
...
void func_170(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10A09
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_164(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_164(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
void func_171(int iParam0)//Position - 0x10CE2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x10E39
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x11347
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x113BC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x11430
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0)//Position - 0x11517
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_177(int iParam0)//Position - 0x1187A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x11A8B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_179(int iParam0)//Position - 0x11CBB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180(int iParam0)//Position - 0x11DCB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_181(int iParam0)//Position - 0x1276A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_182(int iParam0)//Position - 0x132DD
{
	if (iParam0 < 136)
	{
		func_184(iParam0);
...
void func_183(int iParam0)//Position - 0x13312
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_184(int iParam0)//Position - 0x13F16
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_185(int iParam0)//Position - 0x14EE7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_186(int iParam0)//Position - 0x15014
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_187(int iParam0, int iParam1)//Position - 0x15112
{
	switch (iParam0)
	{
		case 0:
...
void func_188(int iParam0)//Position - 0x15202
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_189(int iParam0)//Position - 0x166F3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_190(int iParam0)//Position - 0x16844
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_191(int iParam0)//Position - 0x16D4F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_192(int iParam0)//Position - 0x173BD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_193(int iParam0)//Position - 0x17431
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_194(int iParam0)//Position - 0x17501
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_195(int iParam0)//Position - 0x17A31
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_196(int iParam0)//Position - 0x17BC8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_197(int iParam0)//Position - 0x183C8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_198(int iParam0)//Position - 0x184D8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_199(int iParam0)//Position - 0x19403
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_200(int iParam0)//Position - 0x1A0C0
{
	if (iParam0 < 107)
	{
		func_203(iParam0);
...
void func_201(int iParam0)//Position - 0x1A106
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_202(int iParam0)//Position - 0x1ABAB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_203(int iParam0)//Position - 0x1B99A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_204(int iParam0)//Position - 0x1C5E5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_205(int iParam0)//Position - 0x1C85E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_206(int iParam0, int iParam1)//Position - 0x1C9A4
{
	switch (iParam0)
	{
		case 0:
...
void func_207(int iParam0)//Position - 0x1CA94
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_208(int iParam0)//Position - 0x1D81E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_209(int iParam0)//Position - 0x1D998
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_210(int iParam0)//Position - 0x1DF0F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_211(int iParam0)//Position - 0x1E439
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_212(int iParam0)//Position - 0x1E4AD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_213(int iParam0)//Position - 0x1E57D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_214(int iParam0)//Position - 0x1EA55
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_215(int iParam0)//Position - 0x1ECBE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_216(int iParam0)//Position - 0x1EF94
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_217(int iParam0)//Position - 0x1F15D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_218(int iParam0)//Position - 0x1FCB1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_219(int iParam0)//Position - 0x208FD
{
	if (iParam0 < 60)
	{
		func_221(iParam0);
...
void func_220(int iParam0)//Position - 0x20932
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_221(int iParam0)//Position - 0x216D2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_222(int iParam0)//Position - 0x21D5E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_223(int iParam0)//Position - 0x21E45
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_224()//Position - 0x21F43
{
...
int func_225(int iParam0, int iParam1, int iParam2)//Position - 0x21FBC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_226(var uParam0, int iParam1)//Position - 0x22217
{
...
struct<2> func_228(int iParam0)//Position - 0x222B7
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_229(int iParam0)//Position - 0x222ED
{
	struct<2> Var0;
...
void func_230(int iParam0, int iParam1)//Position - 0x22738
{
...
void func_231(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x22782
{
...
void func_232(int iParam0, int iParam1, int iParam2)//Position - 0x2281F
{
	struct<4> Var0;
	char* sVar32;
	...
	if (iParam0 != -1)
	{
		...
		func_233(&sVar32, Var0.f_3, Global_98706, iParam1, iParam2);
	}
}

void func_233(char* sParam0, var uParam1, var uParam2, var uParam3, var uParam4)//Position - 0x2285E
{
...
void func_234(int iParam0, var uParam1)//Position - 0x228A1
{
	switch (iParam0)
	{
		case 0:
...
int func_236(int iParam0)//Position - 0x23AA7
{
	switch (iParam0)
	{
		case 0:
...
void func_237(int iParam0)//Position - 0x23DED
{
	Global_41947 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_238()//Position - 0x23DFF
{
	if (Global_96011)
	{
		func_30();
...
char* func_239(var uParam0)//Position - 0x23E30
{
	uParam0 = uParam0;
	return "";
}

void func_240()//Position - 0x23E3E
{
	vector3 vVar0[24];
...
void func_241(int iParam0, int iParam1)//Position - 0x23E81
{
	Global_96006 = iParam0;
	Global_96007 = iParam1;
}

void func_242()//Position - 0x23E95
{
	if (Global_76831 != 6)
	{
	}
...
void func_243(var uParam0)//Position - 0x23ECD
{
	if (*uParam0 == -1)
	{
		return;
...
void func_244(int iParam0, bool bParam1)//Position - 0x23F0A
{
	struct<26> Var0;
	int iVar32;
	bool bVar33;
...
int func_245(int iParam0)//Position - 0x24090
{
	switch (iParam0)
	{
		case 0:
...
void func_246(int iParam0)//Position - 0x24417
{
	func_248(iParam0, 1);
...
int func_247()//Position - 0x2444D
{
	return (Global_111560.f_10011.f_21 + Global_111560.f_18569.f_380);
}

void func_248(var uParam0, bool bParam1)//Position - 0x24469
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_249(int iParam0)//Position - 0x2478D
{
...
void func_250(int iParam0)//Position - 0x247C0
{
	switch (iParam0)
	{
		case 30:
...
void func_251(int iParam0, bool bParam1)//Position - 0x247F5
{
	if (iParam0 == -1)
	{
		return;
...
void func_252(int iParam0, int iParam1, bool bParam2)//Position - 0x24852
{
	if (iParam0 == -1)
	{
		return;
...
bool func_253(int iParam0, int iParam1)//Position - 0x2488D
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_254(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x248B0
{
	if (iParam0 != 198)
	{
		if (Global_76577)
...
void func_255(int iParam0, int iParam1)//Position - 0x2490B
{
	switch (iParam0)
	{
		case 12:
...
void func_256(int iParam0, bool bParam1)//Position - 0x249F4
{
	if (bParam1)
	{
...
bool func_257(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x24A1D
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		if (MISC::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()) != MISC::GET_HASH_KEY("standard_global_reg"))
		{
			if (iParam2 == 0)
			{
				if (Global_38363[iParam0] && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Var3, true) < 200f)
				{
					bVar99 = false;
					Global_1653163 = 1;
				}
...
int func_259()//Position - 0x25389
{
	return Global_30737;
}

int func_260(var uParam0, int iParam1)//Position - 0x25394
{
	int iVar0;
...
int func_261(int iParam0)//Position - 0x28A8E
{
	switch (iParam0)
	{
		case 46:
...
void func_262(int iParam0, bool bParam1)//Position - 0x28B80
{
	switch (iParam0)
	{
		case 46:
...
void func_263(int iParam0, bool bParam1)//Position - 0x28BD1
{
	int iVar0;
...
void func_264(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x28C37
{
	func_265(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_265(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x28C57
{
	int iVar0;
...
void func_266()//Position - 0x28E29
{
	int iVar0;
...
int func_267(int iParam0)//Position - 0x28F49
{
	int iVar0;
	int iVar1;
...
int func_270(int iParam0)//Position - 0x29182
{
...
void func_271(int iParam0, int iParam1)//Position - 0x291AF
{
...
int func_272(char* sParam0)//Position - 0x291EC
{
	int iVar0;
...
int func_273()//Position - 0x2924C
{
	return func_274(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_274(char* sParam0, int iParam1)//Position - 0x2925D
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
Vector3 func_275(int iParam0, vector3 vParam1)//Position - 0x292A6
{
	var uVar0;
...
void func_276(bool bParam0, int iParam1, int iParam2)//Position - 0x292EC
{
	bool bVar0;
...
void func_277(int iParam0, bool bParam1)//Position - 0x2934B
{
	if (CAM::IS_SCREEN_FADED_IN())
	{
...
void func_278(int iParam0, int iParam1)//Position - 0x2937D
{
	vector3 vVar0;
	float fVar3;
...
void func_279(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0x293AD
{
	func_14(iParam0);
...
void func_280(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x293D4
{
	int iVar0;
...
Vector3 func_281(int iParam0)//Position - 0x29592
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), 0);
}

void func_282(int iParam0, bool bParam1)//Position - 0x295A5
{
	if (CAM::IS_SCREEN_FADED_OUT() || CAM::IS_SCREEN_FADING_OUT())
	{
		if (!CAM::IS_SCREEN_FADING_IN())
...
void func_283()//Position - 0x295E1
{
	if (iLocal_929)
	{
		return;
	...
	{
		MISC::CLEAR_AREA(vLocal_925, 3f, 1, 0, 0, false);
		if (func_574(func_331()))
		{
			ENTITY::SET_ENTITY_COORDS(func_331(), vLocal_925, 1, 0, 0, 1);
...
void func_284(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)//Position - 0x29677
{
	struct<60> Var0;
...
void func_285(int iParam0, int iParam1, int iParam2)//Position - 0x297A0
{
	int iVar0;
...
void func_286(int iParam0, int iParam1)//Position - 0x298BD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_287(int iParam0)//Position - 0x29ABF
{
...
int func_288(int iParam0)//Position - 0x29B9C
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_289(int iParam0, bool bParam1)//Position - 0x29D4D
{
	int iVar0;
	struct<2> Var1;
...
int func_290(int iParam0)//Position - 0x29ECD
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_292(int iParam0)//Position - 0x29FB0
{
	int iVar0;
	int iVar1;
...
int func_293()//Position - 0x2C47C
{
	return 0;
}

int func_294()//Position - 0x2C485
{
	return 1;
}

int func_295()//Position - 0x2C48E
{
	return 1;
}

int func_296()//Position - 0x2C497
{
...
int func_298(int iParam0)//Position - 0x2C56B
{
	int iVar0;
	char* sVar1;
...
int func_299(int iParam0)//Position - 0x2C5B1
{
	int iVar0;
...
int func_300(int iParam0)//Position - 0x2C5EC
{
	int iVar0;
...
int func_301(int iParam0)//Position - 0x2C668
{
	int iVar0;
...
int func_302(int iParam0, int iParam1, bool bParam2)//Position - 0x2C750
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_303(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2C7C1
{
...
int func_304(int iParam0)//Position - 0x2C898
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_306(var uParam0, int iParam1)//Position - 0x2C8FA
{
	if (iParam1 <= 0)
	{
		return;
...
void func_307(var uParam0, int iParam1)//Position - 0x2C980
{
...
void func_308(var uParam0, int iParam1)//Position - 0x2C9B3
{
	int iVar0;
	int iVar1;
...
int func_309(int iParam0, int iParam1)//Position - 0x2CA04
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_310(int iParam0)//Position - 0x2CAA6
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_311(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_311(bool bParam0, int iParam1, int iParam2)//Position - 0x2CACB
{
	if (bParam0)
	{
		return iParam1;
...
int func_312(var uParam0)//Position - 0x2CAE2
{
	return uParam0 & 15;
}

void func_313(var uParam0, int iParam1)//Position - 0x2CAEF
{
...
void func_314(var uParam0, int iParam1)//Position - 0x2CB29
{
...
void func_315(var uParam0, int iParam1)//Position - 0x2CB64
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_316(var uParam0, int iParam1)//Position - 0x2CBA0
{
	int iVar0;
	int iVar1;
...
int func_317(int iParam0, int iParam1)//Position - 0x2E296
{
	struct<82> Var0;
...
void func_318(int iParam0, var uParam1, int iParam2)//Position - 0x2E2D8
{
	int iVar0;
...
void func_319(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0x2E534
{
	if (func_316(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
...
void func_320(var uParam0, var uParam1)//Position - 0x2E633
{
...
void func_321(int iParam0)//Position - 0x2E6FF
{
	if (iParam0 == -1)
	{
		return;
...
int func_322(int iParam0)//Position - 0x2E779
{
	int iVar0;
...
void func_323(int iParam0, var uParam1)//Position - 0x2E7DC
{
	int iVar0;
...
int func_324(int iParam0)//Position - 0x2EA87
{
	switch (iParam0)
	{
		case 1:
...
int func_325(int iParam0, var uParam1, var uParam2)//Position - 0x2EB37
{
	int iVar0;
	int iVar1;
...
int func_326(int iParam0)//Position - 0x2ED2A
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_327(int iParam0)//Position - 0x2ED4A
{
...
bool func_328(vector3 vParam0, int iParam3)//Position - 0x2ED71
{
	return func_329(Global_102125.f_2890.f_12.f_66, vParam0, iParam3);
}

int func_329(int iParam0, vector3 vParam1, int iParam4)//Position - 0x2ED8E
{
	vector3 vVar0;
	vector3 vVar3;
...
Vector3 func_330()//Position - 0x2EDF8
{
	return 2.55f, 5.665f, 2.55f;
}

int func_331()//Position - 0x2EE0F
{
	return Global_102125.f_4;
}

void func_332()//Position - 0x2EE1D
{
...
int func_333(int iParam0, float fParam1, int iParam2)//Position - 0x2EE8F
{
	int iVar0;
...
bool func_334()//Position - 0x2EF63
{
	bool bVar0;
...
void func_335()//Position - 0x2EF86
{
	Global_19671 = 0;
	func_38();
}

int func_336()//Position - 0x2EF96
{
...
void func_337()//Position - 0x2EFB8
{
...
int func_338(int iParam0, int iParam1)//Position - 0x2F009
{
	if (func_54(iParam0))
	{
...
int func_339(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x2F03C
{
...
void func_340(int iParam0)//Position - 0x2F1CB
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_341(vector3 vParam0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x2F1F7
{
	var uVar0;
	int iVar1;
...
void func_342()//Position - 0x2F267
{
	Global_22211.f_6 = 1;
}

void func_343(int iParam0)//Position - 0x2F275
{
	switch (*iParam0)
	{
		case 0:
...
void func_344(int iParam0)//Position - 0x2F2CE
{
	switch (*iParam0)
	{
		case 0:
...
void func_345()//Position - 0x2F3BE
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		return;
...
int func_347(var uParam0, int iParam1)//Position - 0x2F486
{
...
int func_349(var uParam0)//Position - 0x2F4F5
{
	int iVar0;
	int iVar1;
...
bool func_350(char* sParam0, int iParam1, char* sParam2)//Position - 0x2F518
{
...
void func_351()//Position - 0x2F536
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
int func_352(var uParam0)//Position - 0x2F65C
{
	if (iLocal_181 == 0)
	{
		return 0;
...
int func_353(var uParam0, bool bParam1)//Position - 0x2F6B6
{
	vector3 vVar0;
	float fVar3;
	...
	if (!OBJECT::IS_POINT_IN_ANGLED_AREA(vVar0, Local_200[0 /*3*/], Local_200[1 /*3*/], Local_200.f_7, 0, 1))
	{
		return 0;
	}
	if (bLocal_185)
...
bool func_354(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x2F77B
{
	return MISC::IS_POSITION_OCCUPIED(vParam0, fParam3, 0, 0, 1, 0, 0, iParam4, iParam5);
}

bool func_355(int iParam0, vector3 vParam1, float fParam4)//Position - 0x2F796
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, 1), vParam1) <= (fParam4 * fParam4);
}

Vector3 func_356(vector3 vParam0, float fParam3, float fParam4)//Position - 0x2F7B3
{
	vector3 vVar0;
	float fVar3;
...
Vector3 func_357(vector3 vParam0, float fParam3)//Position - 0x2F7FB
{
	float fVar0;
...
void func_358(var uParam0)//Position - 0x2F832
{
...
int func_359(var uParam0, vector3 vParam1, int iParam4, bool bParam5)//Position - 0x2F866
{
	if (bParam5)
	{
	...
	uParam0->f_2 = PED::CREATE_PED(26, iLocal_357, vParam1, 0f, 1, true);
	...
	uParam0->f_4 = OBJECT::CREATE_OBJECT_NO_OFFSET(iLocal_358, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_2, 0f, -5f, 0f), 1, true, 0);
	...
	uParam0->f_5 = OBJECT::CREATE_OBJECT_NO_OFFSET(iLocal_358, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_2, 0f, -5f, 0f), 1, true, 0);
	...
	uParam0->f_6 = OBJECT::CREATE_OBJECT_NO_OFFSET(iLocal_358, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_2, 0f, 5f, 0f), 1, true, 0);
	...
	*uParam0 = 1;
	...
	TASK::TASK_PLAY_ANIM(uParam0->f_2, iLocal_338, sLocal_350, 1000f, -8f, -1, 1, 0, 0, 0, 0);
	iLocal_876++;
	return 1;
}

float func_360(int iParam0, int iParam1, bool bParam2)//Position - 0x2FAD4
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_361(int iParam0)//Position - 0x2FB32
{
	float fVar0;
	
	fVar0 = func_362(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1);
	ENTITY::SET_ENTITY_HEADING(iParam0, fVar0);
}

float func_362(struct<2> Param0, float fParam2, struct<2> Param3, float fParam5, int iParam6)//Position - 0x2FB59
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_363(var uParam0, float fParam1)//Position - 0x2FBBE
{
	float fVar0;
	vector3 vVar1;
...
int func_364(var uParam0)//Position - 0x2FBFE
{
	int iVar0;
	int iVar1;
	vector3 vVar2[9];
...
void func_365(int iParam0, int iParam1, vector3 vParam2)//Position - 0x2FC9C
{
	*(iParam0[iParam1 /*3*/]) = { vParam2 };
}

void func_366(var uParam0)//Position - 0x2FCB0
{
	int iVar0;
...
int func_367(int iParam0)//Position - 0x2FCD7
{
	int iVar0;
...
void func_368(int iParam0)//Position - 0x2FD0F
{
	int iVar0;
...
int func_369(int iParam0)//Position - 0x2FDA0
{
	int iVar0;
...
int func_370(int iParam0)//Position - 0x2FDE4
{
	int iVar0;
...
int func_371(int iParam0)//Position - 0x2FE1C
{
	if (PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		return 0;
...
void func_372(int iParam0)//Position - 0x2FE59
{
	switch (*iParam0)
	{
		case 0:
...
int func_373(int iParam0, float fParam1)//Position - 0x2FF44
{
...
void func_374(var uParam0)//Position - 0x2FF62
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
int func_375(var uParam0, float fParam1)//Position - 0x2FF78
{
	if (func_379(uParam0))
	{
...
float func_376(var uParam0)//Position - 0x2FF9A
{
	if (func_379(uParam0))
	{
		if (func_378(uParam0))
...
float func_377(bool bParam0)//Position - 0x2FFD9
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_378(var uParam0)//Position - 0x30035
{
	return MISC::IS_BIT_SET(*uParam0, 2);
}

bool func_379(var uParam0)//Position - 0x30045
{
	return MISC::IS_BIT_SET(*uParam0, 1);
}

void func_380(int iParam0)//Position - 0x30055
{
	if (!func_379(iParam0))
	{
		func_381(iParam0);
...
void func_381(int iParam0)//Position - 0x3006D
{
	func_382(iParam0, 0f);
}

void func_382(int iParam0, float fParam1)//Position - 0x3007C
{
...
void func_383(int iParam0)//Position - 0x300AA
{
	int iVar0;
...
void func_384(vector3 vParam0, float fParam3, int iParam4, bool bParam5)//Position - 0x302EF
{
	int iVar0;
	vector3 vVar1;
...
int func_385(vector3 vParam0, float fParam3, var uParam4)//Position - 0x30371
{
	if (iLocal_181 == 0)
	{
		return 0;
	}
	*uParam4 = { func_356(vParam0, fParam3, 6f) };
	return func_353(uParam4, 1);
}

void func_386()//Position - 0x30399
{
	struct<2> Var0;
...
void func_387(int iParam0, int iParam1)//Position - 0x30402
{
	int iVar0;
...
void func_388(int iParam0)//Position - 0x3046D
{
	int iVar0;
...
void func_389()//Position - 0x30509
{
	iLocal_36 = MISC::GET_GAME_TIMER();
}

void func_390(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x30517
{
...
void func_391(var uParam0, bool bParam1)//Position - 0x30537
{
	func_392(&(uParam0->f_41), bParam1);
}

void func_392(var uParam0, bool bParam1)//Position - 0x30549
{
	int iVar0;
...
void func_393(int iParam0, bool bParam1)//Position - 0x30587
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_394(var uParam0, bool bParam1)//Position - 0x305C2
{
	func_395(&(uParam0->f_35), bParam1);
}

void func_395(var uParam0, bool bParam1)//Position - 0x305D4
{
	int iVar0;
...
void func_396(int iParam0)//Position - 0x30611
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_397(int iParam0)//Position - 0x30649
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_398(int iParam0)//Position - 0x306E5
{
	if (func_574(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_399(var uParam0, int iParam1)//Position - 0x3070F
{
	func_400(&(uParam0->f_28), iParam1);
}

void func_400(var uParam0, int iParam1)//Position - 0x30721
{
	int iVar0;
...
void func_401(var uParam0, bool bParam1, bool bParam2)//Position - 0x30762
{
	int iVar0;
...
void func_402()//Position - 0x30857
{
	func_41(&uLocal_390, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
...
void func_403()//Position - 0x308A9
{
	...
	func_408(&uLocal_210, 8, 2, iLocal_338, 0);
	func_407(&uLocal_210, 9, iLocal_359);
}

int func_404(var uParam0, int iParam1)//Position - 0x3092A
{
...
void func_405(var uParam0)//Position - 0x30971
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_406(var uParam0, int iParam1, char* sParam2, int iParam3)//Position - 0x30996
{
	if (MISC::IS_BIT_SET(uParam0->f_113, iParam1) || MISC::IS_BIT_SET(uParam0->f_114, iParam1))
	{
		return 1;
...
int func_407(var uParam0, int iParam1, int iParam2)//Position - 0x309E6
{
	if (MISC::IS_BIT_SET(uParam0->f_113, iParam1) || MISC::IS_BIT_SET(uParam0->f_114, iParam1))
	{
		return 1;
...
int func_408(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4)//Position - 0x30A35
{
	if (MISC::IS_BIT_SET(uParam0->f_113, iParam1) || MISC::IS_BIT_SET(uParam0->f_114, iParam1))
	{
		return 1;
	...
	switch (iParam2)
	{
		...
		case 11:
			TASK::REQUEST_WAYPOINT_RECORDING(iParam3);
			break;
...
int func_409(var uParam0, int iParam1, int iParam2)//Position - 0x30B0D
{
	if (MISC::IS_BIT_SET(uParam0->f_113, iParam1) || MISC::IS_BIT_SET(uParam0->f_114, iParam1))
	{
		return 1;
...
bool func_410(var uParam0)//Position - 0x30B53
{
	int iVar0;
	int iVar1;
...
int func_411(var uParam0, int iParam1)//Position - 0x30BC7
{
...
int func_412(var uParam0, int iParam1)//Position - 0x30DCD
{
	if (MISC::IS_BIT_SET(uParam0->f_113, iParam1) || MISC::IS_BIT_SET(uParam0->f_114, iParam1))
	{
		return 1;
...
void func_413(int iParam0)//Position - 0x30F6A
{
	int iVar0;
	char* sVar1;
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_333(1, 1093140480, 0))
			{
				...
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_96.f_28[0], sLocal_328, 2, func_577(49), 0);
				}
				if (func_574(Local_96.f_41[0]))
				{
...
int func_414(int iParam0)//Position - 0x31458
{
	if (CAM::IS_SCREEN_FADED_IN())
	{
...
void func_416(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4)//Position - 0x314D4
{
...
void func_417(int iParam0, int iParam1)//Position - 0x314F2
{
...
void func_418()//Position - 0x315C1
{
	if (func_328(func_330(), 1))
	{
		if (func_574(func_331()))
		{
			vLocal_925 = { ENTITY::GET_ENTITY_COORDS(func_331(), 1) };
...
void func_419(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x31671
{
	func_420(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_420(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x3169B
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_421(vector3 vParam0)//Position - 0x31A8F
{
...
int func_422(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x31AB9
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_423(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x31DAF
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_424(vector3 vParam0)//Position - 0x31E63
{
	float fVar0;
	float fVar1;
...
void func_425(int iParam0)//Position - 0x31EA2
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_426(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x31F07
{
	if (iParam0 == 1)
	{
...
void func_427()//Position - 0x31FA1
{
	int iVar0;
...
int func_428(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x31FC1
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	uVar1 = WEAPON::CREATE_WEAPON_OBJECT(iVar2, iVar3, vVar5, iVar0, 1065353216, iVar9, iParam7, iParam8);
	while (func_432(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
...
void func_429(var uParam0, int iParam1)//Position - 0x32135
{
	int iVar0;
...
int func_430(int iParam0)//Position - 0x32153
{
	switch (iParam0)
	{
		case 1550611612:
...
int func_431(int iParam0)//Position - 0x322D9
{
...
int func_432(int iParam0, int iParam1)//Position - 0x324B1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_433(int iParam0)//Position - 0x33022
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_434(int iParam0, var uParam1)//Position - 0x330BD
{
	int iVar0;
	int iVar1;
...
void func_435(int iParam0)//Position - 0x330F8
{
	int iVar0;
	int iVar1;
...
void func_436(int iParam0, var uParam1)//Position - 0x33155
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_437(Var11.f_1)) && iVar72 < 51)
			{
...
int func_437(int iParam0)//Position - 0x333DD
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
int func_438(int iParam0)//Position - 0x3356F
{
	int iVar0;
...
void func_439(int iParam0)//Position - 0x337E3
{
	var uVar0;
...
int func_440(char* sParam0, int iParam1)//Position - 0x3399E
{
	int iVar0;
...
void func_441()//Position - 0x339F9
{
	if (func_574(PLAYER::PLAYER_PED_ID()))
	{
...
void func_442()//Position - 0x33A72
{
	func_482(0);
	func_337();
	func_443();
...
void func_443()//Position - 0x33A87
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
...
void func_444()//Position - 0x33ADF
{
	int iVar0;
...
void func_445()//Position - 0x33B3B
{
	int iVar0;
	float fVar1;
...
void func_446(var uParam0)//Position - 0x33BC3
{
	vector3 vVar0;
	var uVar3;
	int iVar4;
	...
	if (func_475(uParam0) && bLocal_559 == 1)
	{
		...
		TASK::TASK_PLAY_ANIM(uParam0->f_2, iLocal_338, sLocal_349, 8f, -8f, -1, 1, 0, 0, 0, 0);
		func_64(uParam0);
		func_66(&(uParam0->f_17));
		uParam0->f_1 = 13;
		uParam0->f_26 = 0;
	...
	switch (uParam0->f_1)
	{
		...
		case 2:
			...
			PED::SET_PED_CAN_BE_TARGETTED(uParam0->f_2, false);
			func_361(uParam0->f_2);
			TASK::TASK_PLAY_ANIM(uParam0->f_2, iLocal_338, sLocal_350, 8f, -8f, -1, 1, 0, 0, 0, 0);
		...
		case 12:
			...
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), iLocal_338, sLocal_346, 3))
			{
			}
		...
		case 13:
			...
			if (bLocal_559 == 1)
			{
				...
				{
					TASK::TASK_PLAY_ANIM(uParam0->f_2, iLocal_338, sLocal_349, 4f, -4f, -1, 1, 0, 0, 0, 0);
				}
				return;
			}
			uParam0->f_1 = 14;
		...
		case 14:
			...
			if (MISC::GET_GAME_TIMER() > uParam0->f_7 && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), iLocal_338, sLocal_346, 3))
			{
				uParam0->f_1 = 9;
			}
			break;
		...
		case 18:
			if (!PED::IS_PED_RUNNING_RAGDOLL_TASK(uParam0->f_2))
			{
				...
				uParam0->f_23 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_alien_beam", uParam0->f_4, 0f, 0f, 0f, vLocal_867, fLocal_858, 0, 0, 0);
				GRAPHICS::SET_PARTICLE_FX_LOOPED_FAR_CLIP_DIST(uParam0->f_23, uParam0->f_12);
				TASK::TASK_PLAY_ANIM(uParam0->f_2, iLocal_338, "MIND_CONTROL_B_Loop", 4f, -8f, -1, 1, 0, 0, 0, 0);
				uParam0->f_1 = 19;
			}
			break;
		...
		case 20:
			...
			if (TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_2, -2017877118) != 1)
			{
				TASK::TASK_PLAY_ANIM(uParam0->f_2, iLocal_338, "MIND_CONTROL_B_LOOP", 2f, -8f, -1, 1, 0, 0, 0, 0);
			}
			if (TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_2, -2017877118) == 1)
			{
...
int func_447(var uParam0)//Position - 0x34627
{
	if (uParam0->f_1 != 7)
	{
		return 0;
...
int func_448(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x3468D
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_449(var uParam0)//Position - 0x34708
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
	...
	vVar5 = { ENTITY::GET_ENTITY_COORDS(uParam0->f_4, 1) };
	...
	else
	{
		...
		else if (iVar1 == 2)
		{
			if (iVar0 > 0)
			{
				...
				uParam0->f_27 = { MISC::_0x21C235BC64831E5A(vVar11, vVar5, vVar8, 0) };
				...
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(uParam0->f_27, vVar2, true) <= 0.7f)
				{
					...
					if (MISC::ABSF((uParam0->f_27.f_2 - vVar2.z)) < 1f)
					{
						...
						{
							MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(vVar5, vVar8, 0, 1, joaat("weapon_pistol"), 0, 0, 1, -1082130432);
						}
						if (iLocal_851 == 1)
						{
...
void func_450(vector3 vParam0, vector3 vParam3, int iParam6)//Position - 0x34B62
{
...
void func_451()//Position - 0x34BBE
{
...
void func_452(char[4] cParam0, int iParam1)//Position - 0x34C18
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

void func_453(var uParam0)//Position - 0x34C2F
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	if (func_456(&vVar9, ENTITY::GET_ENTITY_COORDS(uParam0->f_4, 1), ENTITY::GET_ENTITY_COORDS(uParam0->f_5, 1), vVar3, vVar6))
	{
		if (CAM::IS_SPHERE_VISIBLE(vVar9, 0.5f))
		{
			iVar14 = func_454(vVar3, vVar0, ENTITY::GET_ENTITY_COORDS(uParam0->f_4, 1));
			iVar15 = func_454(vVar3, vVar0, ENTITY::GET_ENTITY_COORDS(uParam0->f_5, 1));
			...
			{
				uParam0->f_25 = GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD("scr_alien_impact", vVar9, 0f, 0f, 0f, fVar13, 0, 0, 0, 0);
			}
...
int func_454(vector3 vParam0, vector3 vParam3, vector3 vParam6)//Position - 0x34D8C
{
	float fVar0;
...
float func_455(vector3 vParam0, vector3 vParam3)//Position - 0x34DC1
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

int func_456(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10)//Position - 0x34DE2
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
Vector3 func_457(vector3 vParam0)//Position - 0x34E62
{
	return (-SYSTEM::SIN(vParam0.z) * SYSTEM::COS(vParam0.x)), (SYSTEM::COS(vParam0.z) * SYSTEM::COS(vParam0.x)), SYSTEM::SIN(vParam0.x);
}

void func_458(int iParam0, vector3 vParam1)//Position - 0x34E8F
{
	float fVar0;
	float fVar1;
	
	func_459(ENTITY::GET_ENTITY_COORDS(iParam0, 1), vParam1, &fVar0, &fVar1, 1);
	ENTITY::SET_ENTITY_ROTATION(iParam0, fVar0, 0f, fVar1, 2, 1);
}

void func_459(vector3 vParam0, vector3 vParam3, var uParam6, var uParam7, int iParam8)//Position - 0x34EB8
{
	vector3 vVar0;
	
	vVar0 = { vParam3 - vParam0 };
	func_460(vVar0, uParam6, uParam7, iParam8);
}

void func_460(vector3 vParam0, var uParam3, var uParam4, int iParam5)//Position - 0x34EDB
{
	float fVar0;
...
void func_461(var uParam0)//Position - 0x34F80
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	else
	{
		...
		if (iVar1 == 2)
		{
			if (iVar0 == 0 && func_9())
			{
				...
				TASK::TASK_PLAY_ANIM(0, iLocal_338, "MIND_CONTROL_B_Enter", 8f, -8f, -1, 2, 0, 0, 0, 0);
...
void func_462(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x35194
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_463(iParam3), 0);
}

int func_463(int iParam0)//Position - 0x351AD
{
	int iVar0;
...
void func_464(var uParam0)//Position - 0x353C2
{
	int iVar0;
	float fVar1;
	...
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->f_2, iLocal_338, sLocal_343, 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->f_2, iLocal_338, sLocal_341, 3))
		{
			TASK::TASK_PLAY_ANIM(uParam0->f_2, iLocal_338, sLocal_345, 8f, -8f, -1, 0, 0, 0, 0, 0);
		}
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), iLocal_338, sLocal_344, 3))
		{
			TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
			TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), iLocal_338, sLocal_346, 8f, -4f, -1, 0, 0, 0, 0, 0);
			PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
		}
		else if (ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), iLocal_338, sLocal_342, 3))
		{
			TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
			TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), iLocal_338, sLocal_346, 8f, -4f, -1, 0, 0, 0, 0, 0);
			PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
	...
	if (MISC::GET_GAME_TIMER() > uParam0->f_7)
	{
		TASK::TASK_PLAY_ANIM(uParam0->f_2, iLocal_338, sLocal_347, 8f, -8f, -1, 0, 0, 0, 0, 0);
		func_66(&(uParam0->f_17));
		func_465();
	}
}

void func_465()//Position - 0x35626
{
...
int func_466(char* sParam0)//Position - 0x35644
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

int func_467(float fParam0)//Position - 0x35657
{
	if (fParam0 < 0f)
	{
		return -1;
...
void func_468(var uParam0)//Position - 0x3566E
{
	var uVar0;
	...
	func_361(uParam0->f_2);
	TASK::OPEN_SEQUENCE_TASK(&uVar0);
	TASK::TASK_PLAY_ANIM(0, iLocal_338, sLocal_341, 8f, -8f, -1, 0, 0, 0, 0, 0);
	TASK::TASK_PLAY_ANIM(0, iLocal_338, sLocal_343, 8f, -8f, -1, 1, 0, 0, 0, 0);
	TASK::CLOSE_SEQUENCE_TASK(uVar0);
	...
	TASK::OPEN_SEQUENCE_TASK(&uVar0);
	TASK::TASK_PLAY_ANIM(0, iLocal_338, sLocal_342, 8f, -8f, -1, 0, 0, 0, 0, 0);
	TASK::TASK_PLAY_ANIM(0, iLocal_338, sLocal_344, 8f, -8f, -1, 1, 0, 0, 0, 0);
	TASK::CLOSE_SEQUENCE_TASK(uVar0);
	TASK::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uVar0);
	TASK::CLEAR_SEQUENCE_TASK(&uVar0);
	PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
...
void func_469()//Position - 0x35910
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		return;
...
void func_470(int iParam0, int iParam1)//Position - 0x3595F
{
	float fVar0;
	
	fVar0 = func_362(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(iParam1, 1), 1);
	ENTITY::SET_ENTITY_HEADING(iParam0, fVar0);
}

int func_471(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x35984
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	
	vVar0 = { func_424(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
bool func_472(var uParam0)//Position - 0x35A15
{
	if (uParam0->f_32)
	{
		return 0;
...
int func_473(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x35A55
{
	int iVar0;
	bool bVar1;
...
bool func_474(var uParam0)//Position - 0x35AA7
{
	int iVar0;
...
bool func_475(var uParam0)//Position - 0x35ABA
{
	return ((((uParam0->f_1 == 20 || uParam0->f_1 == 19) || uParam0->f_1 == 18) || uParam0->f_1 == 17) || uParam0->f_1 == 15);
}

void func_476(var uParam0)//Position - 0x35AFD
{
...
int func_477(var uParam0)//Position - 0x35B70
{
	if (!func_481(uParam0))
	{
...
void func_478(int iParam0)//Position - 0x35D00
{
	bool bVar0;
	int iVar1;
...
void func_479()//Position - 0x35D71
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		return;
...
void func_480(int iParam0, char* sParam1, vector3 vParam2, int iParam5)//Position - 0x35DFF
{
	AUDIO::_PLAY_AMBIENT_SPEECH_AT_COORDS(iParam0, sParam1, vParam2, func_463(iParam5));
}

bool func_481(var uParam0)//Position - 0x35E19
{
	return (uParam0->f_1 == 7 || uParam0->f_1 == 8);
}

void func_482(int iParam0)//Position - 0x35E34
{
	if (func_487())
	{
		return;
...
void func_483(int iParam0)//Position - 0x35E67
{
	if (func_487())
	{
		return;
...
void func_484(bool bParam0, bool bParam1)//Position - 0x35EF1
{
	if (bParam0)
	{
		if (func_486(0))
...
bool func_485()//Position - 0x35F65
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

int func_486(int iParam0)//Position - 0x35F76
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
bool func_487()//Position - 0x35FD0
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

void func_488()//Position - 0x35FE2
{
	PED::SET_PED_DENSITY_MULTIPLIER_THIS_FRAME(0f);
...
void func_489(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x36004
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_76831 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_491(Global_76832, Global_76834, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
float func_490(char* sParam0)//Position - 0x362E9
{
	HUD::_BEGIN_TEXT_COMMAND_GET_WIDTH(sParam0);
	return HUD::_END_TEXT_COMMAND_GET_WIDTH(1);
}

struct<2> func_491(int iParam0, int iParam1, int iParam2)//Position - 0x362FC
{
	struct<2> Var0;
	int iVar2;
...
char* func_492(int iParam0)//Position - 0x363D1
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_493(int iParam0)//Position - 0x36539
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_494(int iParam0)//Position - 0x3656C
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_495(int iParam0)//Position - 0x3659F
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_496(int iParam0)//Position - 0x365D2
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_497(int iParam0)//Position - 0x36605
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_498(int iParam0)//Position - 0x36642
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_499(int iParam0)//Position - 0x36675
{
	struct<2> Var0;
...
int func_500(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x366E2
{
...
bool func_501(bool bParam0)//Position - 0x367FB
{
	if (bParam0)
	{
...
int func_502(int iParam0)//Position - 0x36824
{
	if (Global_41396 == 15)
	{
		return 0;
...
bool func_503(int iParam0)//Position - 0x36846
{
	return func_504(iParam0, Global_41396);
}

int func_504(int iParam0, int iParam1)//Position - 0x36857
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_505(bool bParam0)//Position - 0x36A38
{
...
void func_506(int iParam0)//Position - 0x36A63
{
	if (iParam0 > 0)
	{
	}
...
void func_507(vector3 vParam0, float fParam3, var uParam4, var uParam5)//Position - 0x36A71
{
	vector3 vVar0;
...
int func_508(int iParam0, int iParam1)//Position - 0x36A9D
{
	int iVar0;
...
void func_509()//Position - 0x36AFB
{
	...
	if (func_522() == 1)
	{
		...
		if (func_574(PLAYER::PLAYER_PED_ID()))
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), iLocal_338, sLocal_344, 3))
			{
				TASK::STOP_ANIM_TASK(PLAYER::PLAYER_PED_ID(), iLocal_338, sLocal_344, -8f);
			}
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), iLocal_338, sLocal_342, 3))
			{
				TASK::STOP_ANIM_TASK(PLAYER::PLAYER_PED_ID(), iLocal_338, sLocal_342, -8f);
			}
			ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), true, 0);
			func_435(PLAYER::PLAYER_PED_ID());
			WEAPON::REMOVE_ALL_PED_WEAPONS(PLAYER::PLAYER_PED_ID(), 1);
...
void func_510(int iParam0, int iParam1, int iParam2)//Position - 0x36CF6
{
...
bool func_511()//Position - 0x36DBA
{
	return MISC::IS_BIT_SET(Global_98669.f_20, 13);
}

void func_512(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x36DCE
{
	if (func_522())
	{
...
int func_513(var uParam0)//Position - 0x36E63
{
	int iVar0[7];
	vector3 vVar8;
	float fVar11;
	...
	switch (iLocal_82)
	{
		...
		case 3:
			if (func_574(uParam0->f_28[0]))
			{
				...
				ENTITY::SET_ENTITY_COORDS(uParam0->f_28[0], vVar8, 1, 0, 0, 1);
...
int func_514(int iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)//Position - 0x372C6
{
	if (func_515(iParam0, iParam1, vParam2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_515(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0x37322
{
	int iVar0;
...
int func_516(var uParam0, int iParam1)//Position - 0x373B0
{
	int iVar0;
...
int func_517(var uParam0)//Position - 0x373F6
{
	if (func_518(uParam0))
	{
...
int func_518(var uParam0)//Position - 0x37420
{
...
int func_519(int iParam0)//Position - 0x37445
{
	int iVar0;
...
void func_520(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0x37476
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
float func_521(float fParam0)//Position - 0x374B2
{
	return (fParam0 * 57.29578f);
}

int func_522()//Position - 0x374C2
{
...
void func_523(bool bParam0)//Position - 0x374E6
{
	if (bParam0)
	{
...
void func_524(int iParam0, bool bParam1)//Position - 0x37512
{
	if (bParam1)
	{
...
void func_525()//Position - 0x37534
{
...
void func_526()//Position - 0x3760C
{
	iLocal_209 = joaat("weapon_minigun");
	fLocal_570 = 7.5f;
	iLocal_565 = 10;
...
void func_527()//Position - 0x376C1
{
	int iVar0;
...
void func_528(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x376EB
{
	*(uParam0[0 /*3*/]) = { vParam1 };
	*(uParam0[1 /*3*/]) = { vParam4 };
	uParam0->f_7 = fParam7;
...
void func_529(bool bParam0)//Position - 0x3770F
{
	if (bParam0)
	{
		func_530();
...
void func_530()//Position - 0x37772
{
...
void func_531(int iParam0)//Position - 0x3779B
{
...
void func_532(bool bParam0)//Position - 0x377F5
{
	int iVar0;
...
void func_533(int iParam0, bool bParam1)//Position - 0x37818
{
	if (bParam1)
	{
...
void func_534(int iParam0, int iParam1, bool bParam2)//Position - 0x3784F
{
	int iVar0;
...
int func_535(int iParam0)//Position - 0x378C1
{
	switch (iParam0)
	{
		case 0:
...
void func_536(int iParam0, int iParam1, bool bParam2)//Position - 0x37BF1
{
	int iVar0;
...
int func_537(int iParam0, int iParam1, bool bParam2)//Position - 0x37C63
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_538()//Position - 0x37CCD
{
	func_427();
	if (func_542())
	{
...
void func_539(int iParam0)//Position - 0x37E27
{
...
void func_540(var uParam0)//Position - 0x37E8A
{
	int iVar0;
...
int func_541(var uParam0, int iParam1)//Position - 0x37EAF
{
...
void func_543(bool bParam0)//Position - 0x38145
{
	int iVar0;
...
void func_544(char* sParam0, int iParam1)//Position - 0x38215
{
	if (Global_98669 != 12)
	{
...
int func_545(char* sParam0, int iParam1, int iParam2)//Position - 0x3823D
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_546(char* sParam0)//Position - 0x383CF
{
...
int func_548(char* sParam0, bool bParam1)//Position - 0x3844D
{
	int iVar0;
	int iVar1;
...
int func_549(int iParam0, bool bParam1)//Position - 0x38477
{
	int iVar0;
...
void func_552(bool bParam0)//Position - 0x38569
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_553(int iParam0)//Position - 0x3857D
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_554(int iParam0)//Position - 0x385BA
{
	if (iParam0 == 1)
	{
...
void func_555()//Position - 0x385F7
{
	Global_22211.f_5 = 1;
}

void func_556()//Position - 0x38605
{
	Global_22211.f_5 = 0;
}

void func_557()//Position - 0x38613
{
	Global_92875 = 0;
	Global_92876 = 0;
}

int func_558()//Position - 0x38625
{
...
void func_559()//Position - 0x38663
{
	Global_98704 = 1;
...
void func_560(char* sParam0, bool bParam1)//Position - 0x38754
{
	func_561(sParam0);
	func_543(bParam1);
}

void func_561(char* sParam0)//Position - 0x38768
{
...
void func_562(int iParam0)//Position - 0x387A6
{
...
void func_563(int iParam0)//Position - 0x387B8
{
	if (func_31(iParam0))
	{
...
void func_564(int iParam0, bool bParam1)//Position - 0x387F0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_565(int iParam0, bool bParam1)//Position - 0x388E3
{
	int iVar0;
	int iVar1;
...
void func_566(int iParam0, var uParam1, bool bParam2)//Position - 0x38940
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar7 < 2)
		{
				...
				if (iVar1 != 0 && iVar1 != 1993361168)
				{
					...
					if (iVar2 != 0 && iVar2 != joaat("weapon_unarmed"))
					{
						if (func_571(iVar2))
						{
							if (iVar7 == 0)
							{
								iVar72[iVar5] = WEAPON::GET_AMMO_IN_PED_WEAPON(iParam0, iVar2);
							}
							else
							{
			...
			iVar178 = FILES::GET_NUM_DLC_WEAPONS();
			iVar8 = 0;
			while (iVar8 < iVar178)
			{
				if (FILES::GET_DLC_WEAPON_DATA(iVar8, &Var9))
				{
					if (!FILES::IS_CONTENT_ITEM_LOCKED(Var9) && !func_437(Var9.f_1))
					{
						if (iVar7 == 0)
						{
							iVar117[iVar8] = WEAPON::GET_AMMO_IN_PED_WEAPON(iParam0, Var9.f_1);
						}
						else
						{
		...
		while (iVar5 <= (44 - 1))
		{
			...
			if (iVar1 != 0 && iVar1 != 1993361168)
			{
				...
				if (!bParam2)
				{
					if (iVar2 != 0 && iVar2 != joaat("weapon_unarmed"))
					{
						if (WEAPON::GET_AMMO_IN_PED_WEAPON(iParam0, iVar2) < iVar72[iVar5])
						{
							WEAPON::SET_PED_AMMO(iParam0, iVar2, iVar72[iVar5], 0);
						}
					}
				}
			}
		...
		while (iVar70 < uParam1->f_221)
		{
			...
			if ((iVar8 != -1 && iVar8 < 60) && !func_437(Var9.f_1))
			{
							...
							if (FILES::GET_DLC_WEAPON_COMPONENT_DATA(iVar8, iVar6, &Var48))
							{
								if (!func_433(Var48.f_3))
								{
									...
									else if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar3, Var48.f_3))
									{
										...
										func_567(iParam0, iVar3, Var48.f_3);
									}
									iVar71++;
								}
							}
						...
						while (iVar6 < FILES::GET_NUM_DLC_WEAPON_COMPONENTS(iVar8))
						{
							if (FILES::GET_DLC_WEAPON_COMPONENT_DATA(iVar8, iVar6, &Var48))
							{
								if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, Var48.f_3))
								{
									...
									func_567(iParam0, iVar2, Var48.f_3);
								}
							}
							iVar6++;
						}
				...
				if (!bParam2)
				{
					...
					{
						if (WEAPON::GET_AMMO_IN_PED_WEAPON(iParam0, iVar3) < iVar117[iVar8])
						{
							WEAPON::SET_PED_AMMO(iParam0, iVar3, iVar117[iVar8], 0);
						}
					}
				}
			}
...
void func_567(int iParam0, int iParam1, int iParam2)//Position - 0x38F9E
{
	int iVar0;
...
void func_568(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x38FCB
{
	int iVar0;
...
int func_569(int iParam0)//Position - 0x38FED
{
	switch (iParam0)
	{
		case -1860492113:
...
void func_570(int iParam0, int iParam1, int iParam2)//Position - 0x3931C
{
	int iVar0;
...
bool func_571(int iParam0)//Position - 0x3933C
{
	int iVar0;
	struct<2> Var1;
...
int func_572(bool bParam0, bool bParam1)//Position - 0x39468
{
	if (bParam0)
	{
...
bool func_573()//Position - 0x394D4
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_574(int iParam0)//Position - 0x394E5
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_575(var uParam0)//Position - 0x39506
{
...
void func_576(var uParam0)//Position - 0x39526
{
	int iVar0;
...
int func_577(int iParam0)//Position - 0x39560
{
	if (!func_31(iParam0))
	{
		return func_34(iParam0);
