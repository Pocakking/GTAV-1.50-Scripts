				...
				case 3:
					...
					else
					{
						...
						if (!func_73(3) && !Global_98703)
						{
							...
							{
								if ((!func_87(uLocal_94, 1) || !ENTITY::DOES_ENTITY_EXIST(func_72())) && !Global_98703)
								{
									func_80(10);
									break;
								}
...
int func_1(char* sParam0)//Position - 0xB18
{
...
void func_8(int iParam0)//Position - 0xC26
{
	iParam0->f_1 = 0f;
	iParam0->f_2 = 0f;
	*iParam0 = 0;
...
float func_9(int iParam0)//Position - 0xC3C
{
	if (func_12(iParam0))
	{
		if (func_11(iParam0))
...
float func_10(bool bParam0)//Position - 0xC7B
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_11(var uParam0)//Position - 0xCD3
{
	return MISC::IS_BIT_SET(*uParam0, 2);
}

bool func_12(var uParam0)//Position - 0xCE3
{
	return MISC::IS_BIT_SET(*uParam0, 1);
}

int func_13()//Position - 0xCF3
{
	return 1;
}
...
void func_15(char* sParam0, int iParam1, int iParam2)//Position - 0xD04
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_95769))
	{
...
bool func_16(bool bParam0)//Position - 0xD45
{
...
char* func_17(int iParam0)//Position - 0xD70
{
	switch (iParam0)
	{
		case 0:
...
void func_18(int iParam0)//Position - 0xEAE
{
	var uVar0;
	vector3 vVar1[24];
...
void func_19(int iParam0)//Position - 0xF05
{
	if (!func_12(iParam0))
	{
		func_22(iParam0);
...
void func_20(int iParam0)//Position - 0xF26
{
	func_21(iParam0, 0f);
}

void func_21(int iParam0, float fParam1)//Position - 0xF35
{
...
void func_22(int iParam0)//Position - 0xF63
{
	if (!func_12(iParam0))
	{
		func_20(iParam0);
...
int func_24()//Position - 0xFAB
{
	...
	vVar0.y = iLocal_124;
	vVar0.z = iLocal_123;
	iVar3 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS(&Local_53, &vVar0, 3, iLocal_97);
	SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&Local_53);
	return iVar3;
}

void func_25(int iParam0)//Position - 0xFDB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_26(int iParam0)//Position - 0x1034
{
...
int func_27(int iParam0)//Position - 0x10B7
{
	int iVar0;
...
void func_28(int iParam0, int iParam1, int iParam2)//Position - 0x10E8
{
	func_29(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_29(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x10FD
{
	int iVar0;
...
int func_31(int iParam0, int iParam1, int iParam2)//Position - 0x11B0
{
...
int func_32(int iParam0, int iParam1, int iParam2)//Position - 0x11CB
{
	int iVar0;
...
int func_33(int iParam0)//Position - 0x1217
{
	int iVar0;
...
int func_35(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x12DD
{
	int iVar0;
...
void func_36(var uParam0, int iParam1)//Position - 0x1414
{
	int iVar0;
...
int func_37(int iParam0)//Position - 0x1463
{
	if (Global_41396 == 15)
	{
		return 0;
...
void func_39(int iParam0)//Position - 0x1638
{
	if (iParam0 == 2)
	{
	}
...
int func_40(int iParam0, bool bParam1)//Position - 0x1659
{
	int iVar0;
...
int func_41(int iParam0)//Position - 0x1711
{
	int iVar0;
...
void func_42(int iParam0)//Position - 0x174C
{
	int iVar0;
...
void func_43(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x17A3
{
	int iVar0;
...
int func_44(var uParam0)//Position - 0x18CE
{
	return 1;
}

void func_45(char[4] cParam0, int iParam1, int iParam2)//Position - 0x18D7
{
...
bool func_46(int iParam0)//Position - 0x18F9
{
	func_47();
...
bool func_48(int iParam0)//Position - 0x1A12
{
	return iParam0 < 3;
}
...
int func_50(int iParam0)//Position - 0x1A5B
{
	if (func_48(iParam0))
	{
...
var func_51(int iParam0)//Position - 0x1A80
{
	return Global_1798[iParam0 /*29*/];
}

var func_52()//Position - 0x1A8F
{
	return Global_73784;
}

int func_53(int iParam0)//Position - 0x1A9B
{
	if (iParam0 == 1)
	{
...
bool func_54(int iParam0, int iParam1)//Position - 0x1AF5
{
	switch (iParam0)
	{
		case 5:
...
bool func_55()//Position - 0x1B30
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

int func_56()//Position - 0x1B45
{
...
bool func_57(bool bParam0)//Position - 0x1B5F
{
	if (bParam0)
	{
...
int func_58()//Position - 0x1B88
{
	return 1;
}

void func_59(var uParam0, int iParam1)//Position - 0x1B91
{
	func_60(uParam0, iParam1);
}

void func_60(var uParam0, var uParam1)//Position - 0x1BA1
{
...
int func_62(int iParam0)//Position - 0x1CBC
{
	int iVar0;
...
var func_63()//Position - 0x23D9
{
	return Global_98708.f_1;
}

int func_64()//Position - 0x23E7
{
	if (Global_95621 != -1)
	{
...
bool func_66()//Position - 0x2437
{
	return Global_98721.f_346 > 0;
}

bool func_67()//Position - 0x2448
{
	return Global_98721.f_345 > 0;
}

var func_68()//Position - 0x2459
{
	return Global_1312873;
}

int func_69()//Position - 0x2465
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
var func_72()//Position - 0x24B4
{
	return Global_94531;
}

int func_73(int iParam0)//Position - 0x24C0
{
	switch (iParam0)
	{
		case 0:
...
bool func_74(int iParam0)//Position - 0x2532
{
	int iVar0;
...
bool func_75(int iParam0)//Position - 0x256E
{
	return Global_41396 == iParam0;
}

void func_76(var uParam0, int iParam1)//Position - 0x257C
{
	*uParam0 = (*uParam0 || iParam1);
}

void func_77()//Position - 0x258D
{
	if (bLocal_125)
	{
		bLocal_126 = true;
...
void func_80(int iParam0)//Position - 0x266A
{
	iLocal_95 = iParam0;
}

void func_81(int iParam0, bool bParam1, bool bParam2)//Position - 0x2676
{
	int iVar0;
	bool bVar1;
...
bool func_84(int iParam0, int iParam1)//Position - 0x27C2
{
	bool bVar0;
...
bool func_85(int iParam0)//Position - 0x280F
{
	return func_86(iParam0, Global_41396);
}

int func_86(int iParam0, int iParam1)//Position - 0x2820
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_87(var uParam0, int iParam1)//Position - 0x2A01
{
	return (uParam0 && iParam1) != 0;
}

void func_88()//Position - 0x2A10
{
...
void func_89(int iParam0)//Position - 0x2A5E
{
	if (iLocal_95 < 5)
	{
		if (iParam0 != 263)
...
int func_90(int iParam0)//Position - 0x2AA1
{
	switch (iParam0)
	{
		case 91:
...
void func_91(var uParam0, int iParam1)//Position - 0x2BB9
{
	func_92(uParam0, iParam1);
}

void func_92(var uParam0, var uParam1)//Position - 0x2BC9
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

void func_93(bool bParam0)//Position - 0x2BDE
{
	if (bParam0)
	{
		if (iLocal_105 != 263)
