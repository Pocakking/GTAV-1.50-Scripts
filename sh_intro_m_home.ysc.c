		...
		switch (iLocal_37)
		{
			...
			case 2:
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					...
					vVar0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
					if (func_219(vVar0, vVar3, 100f) || iLocal_40)
					{
...
int func_4(int iParam0)//Position - 0xE5A
{
...
void func_6(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0xED6
{
	int iVar0;
...
void func_9(char[4] cParam0, int iParam1)//Position - 0xFC0
{
...
void func_11(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)//Position - 0x10FE
{
	struct<60> Var0;
...
void func_13(int iParam0, int iParam1)//Position - 0x1344
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_14(int iParam0)//Position - 0x1546
{
...
int func_15(int iParam0)//Position - 0x1623
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_16(int iParam0, bool bParam1)//Position - 0x17D4
{
	int iVar0;
	struct<2> Var1;
...
int func_17(int iParam0)//Position - 0x1954
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_19(int iParam0)//Position - 0x1A34
{
	int iVar0;
	int iVar1;
...
int func_20()//Position - 0x3EFF
{
	return 0;
}

int func_21()//Position - 0x3F08
{
	return 1;
}

int func_22()//Position - 0x3F11
{
	return 1;
}

int func_23()//Position - 0x3F1A
{
...
int func_25(int iParam0)//Position - 0x3FEE
{
	int iVar0;
	char* sVar1;
...
int func_26(int iParam0)//Position - 0x4037
{
	int iVar0;
...
int func_27(int iParam0)//Position - 0x4072
{
	int iVar0;
...
int func_28(int iParam0)//Position - 0x40EE
{
	int iVar0;
...
int func_29(int iParam0, int iParam1, bool bParam2)//Position - 0x41D6
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_30(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x4247
{
...
int func_31(int iParam0)//Position - 0x4320
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_33(var uParam0, int iParam1)//Position - 0x4382
{
	if (iParam1 <= 0)
	{
		return;
...
void func_34(var uParam0, int iParam1)//Position - 0x4408
{
...
void func_35(var uParam0, int iParam1)//Position - 0x443B
{
	int iVar0;
	int iVar1;
...
int func_36(int iParam0, int iParam1)//Position - 0x448C
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_37(int iParam0)//Position - 0x452E
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_38(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_38(bool bParam0, int iParam1, int iParam2)//Position - 0x4553
{
	if (bParam0)
	{
		return iParam1;
...
int func_39(var uParam0)//Position - 0x456A
{
	return uParam0 & 15;
}

void func_40(var uParam0, int iParam1)//Position - 0x4577
{
...
void func_41(var uParam0, int iParam1)//Position - 0x45B1
{
...
void func_42(var uParam0, int iParam1)//Position - 0x45EC
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_43(var uParam0, int iParam1)//Position - 0x4628
{
	int iVar0;
	int iVar1;
...
int func_44(int iParam0, int iParam1)//Position - 0x5D20
{
	struct<82> Var0;
...
void func_45(int iParam0, var uParam1, int iParam2)//Position - 0x5D62
{
	int iVar0;
...
bool func_46(int iParam0)//Position - 0x5FBE
{
	return iParam0 < 3;
}

void func_47(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0x5FCA
{
	if (func_43(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
...
void func_48(int iParam0, bool bParam1)//Position - 0x60C9
{
	if (iParam0 == -1)
	{
		return;
...
void func_49(int iParam0, int iParam1, bool bParam2)//Position - 0x6126
{
	if (iParam0 == -1)
	{
		return;
...
bool func_50(int iParam0, int iParam1)//Position - 0x6161
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_51(var uParam0, var uParam1)//Position - 0x6184
{
...
void func_52(int iParam0)//Position - 0x6250
{
	if (iParam0 == -1)
	{
		return;
...
int func_53(int iParam0)//Position - 0x62CA
{
	int iVar0;
...
bool func_54(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x632D
{
	if (bParam6)
	{
...
void func_55(int iParam0, var uParam1)//Position - 0x6374
{
	int iVar0;
...
int func_56(int iParam0)//Position - 0x661F
{
	switch (iParam0)
	{
		case 1:
...
int func_57(int iParam0, var uParam1, var uParam2)//Position - 0x66CF
{
	int iVar0;
	int iVar1;
...
int func_58(int iParam0)//Position - 0x68C2
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_59(var uParam0)//Position - 0x68E2
{
	int iVar0;
...
void func_60(int iParam0)//Position - 0x6993
{
...
Vector3 func_61(vector3 vParam0)//Position - 0x69BA
{
	return (-SYSTEM::SIN(vParam0.z) * SYSTEM::COS(vParam0.x)), (SYSTEM::COS(vParam0.z) * SYSTEM::COS(vParam0.x)), SYSTEM::SIN(vParam0.x);
}

void func_62(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x69E7
{
	int iVar0;
...
void func_63(int iParam0, bool bParam1)//Position - 0x6BA5
{
	if (CAM::IS_SCREEN_FADED_OUT() || CAM::IS_SCREEN_FADING_OUT())
	{
...
Vector3 func_64(int iParam0)//Position - 0x6BE1
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_65(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x6BF4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_66(int iParam0, int iParam1, int iParam2)//Position - 0x740A
{
	int iVar0;
...
int func_67(int iParam0)//Position - 0x7496
{
	switch (iParam0)
	{
...
void func_68(int iParam0, int iParam1, int iParam2)//Position - 0x74D1
{
	int iVar0;
	int iVar1;
...
int func_69(int iParam0, int iParam1, int iParam2)//Position - 0x755B
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_70(int iParam0, int iParam1, int iParam2)//Position - 0x7639
{
	Global_76389[1 /*14*/] = { func_116(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 2);
}

int func_71(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x7664
{
	var uVar0;
	int iVar10;
...
int func_72(int iParam0, int iParam1, int iParam2)//Position - 0x7C68
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7D01
{
	int iVar0;
...
int func_74(int iParam0, int iParam1, int iParam2)//Position - 0x7D97
{
	int iVar0;
	int iVar1;
...
int func_75(int iParam0)//Position - 0x7E38
{
	switch (iParam0)
	{
		case 0:
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7EE8
{
	int iVar0;
...
int func_77(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x81FB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x8DAE
{
	int iVar0;
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9092
{
	int iVar0;
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9359
{
	int iVar0;
	int iVar1;
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9390
{
	int iVar0;
...
int func_82(int iParam0, int iParam1, int iParam2)//Position - 0x93B9
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9683
{
	int iVar0;
...
int func_84(int iParam0, int iParam1, int iParam2)//Position - 0x990D
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_85(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9A64
{
	int iVar0;
...
int func_86(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9AFC
{
	switch (iParam0)
	{
...
int func_87(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9BCA
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_88(int iParam0, int iParam1)//Position - 0x9D26
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_89(int iParam0)//Position - 0xA0CD
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_90(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA12E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_91(int iParam0, int iParam1)//Position - 0xA22A
{
	int iVar0;
...
int func_92(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA368
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_93(int iParam0)//Position - 0xA448
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_94(int iParam0, int iParam1)//Position - 0xA4CE
{
	int iVar0;
	struct<10> Var1;
...
void func_95(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xADFD
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_96(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xAF27
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_97(int iParam0, int iParam1)//Position - 0xAF6F
{
	int iVar0;
	struct<17> Var1;
...
void func_98(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCDB9
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_99(int iParam0)//Position - 0xCFA3
{
	switch (iParam0)
	{
		case 0:
...
void func_100(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xD053
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_101(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD0C4
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD341
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_103(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD766
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_104(int iParam0, int iParam1)//Position - 0xDA59
{
	int iVar0;
	int iVar1;
...
int func_105(int iParam0, int iParam1)//Position - 0xDA9F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_106(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDAFF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_107(int iParam0)//Position - 0xDB83
{
...
void func_108(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xDC3B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_109(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xDC85
{
	int iVar0;
...
int func_110(var uParam0)//Position - 0xDCB5
{
	int iVar0;
	int iVar1;
...
int func_111()//Position - 0xDCE9
{
	return Global_1312745;
}

int func_112(int iParam0, int iParam1, int iParam2)//Position - 0xDCF5
{
	int iVar0;
	var uVar1;
...
bool func_113(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xDD27
{
	int iVar0;
...
int func_114(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xFB8E
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_115(int iParam0)//Position - 0x10AAD
{
	if (!MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_116(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10AFE
{
	func_180();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_117(int iParam0, int iParam1)//Position - 0x10B50
{
	switch (iParam0)
	{
		case 0:
...
void func_118(int iParam0)//Position - 0x10C40
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_119(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x11EB7
{
	int iVar0;
	int iVar1;
...
bool func_120(int iParam0, int iParam1, var uParam2)//Position - 0x12248
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_121(int iParam0, int iParam1)//Position - 0x1264D
{
	switch (iParam1)
	{
		case 0:
...
int func_122(int iParam0, int iParam1)//Position - 0x12A48
{
	switch (iParam1)
	{
		case 0:
...
int func_123(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x12E43
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_124(int iParam0)//Position - 0x12E85
{
	return Global_41396 == iParam0;
}

int func_125(int iParam0)//Position - 0x12E93
{
	switch (iParam0)
	{
		case -1:
...
void func_126(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x12F67
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
...
void func_127(int iParam0)//Position - 0x13240
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0x13397
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0x138A5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0x1391A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x1398E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x13A75
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x13DD8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x13FE9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x1421A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x1432A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x14CC9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x1583C
{
	if (iParam0 < 136)
	{
		func_140(iParam0);
...
void func_139(int iParam0)//Position - 0x15871
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x16475
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x17383
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x174B0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0, int iParam1)//Position - 0x175AE
{
	switch (iParam0)
	{
		case 0:
...
void func_144(int iParam0)//Position - 0x1769E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x18B90
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x18CE1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x191EC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x1985A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x198CE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x1999E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x19ECE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x1A065
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x1A863
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x1A973
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x1B89E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x1C55C
{
	if (iParam0 < 107)
	{
		func_159(iParam0);
...
void func_157(int iParam0)//Position - 0x1C5A2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x1D047
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x1DE36
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x1EA7F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x1ECF8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0, int iParam1)//Position - 0x1EE3E
{
	switch (iParam0)
	{
		case 0:
...
void func_163(int iParam0)//Position - 0x1EF2E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x1FCB8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x1FE32
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x203AB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x208D5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x20949
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x20A19
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x20EF1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x2115A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x21430
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x215F9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x2214D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x22D97
{
	if (iParam0 < 60)
	{
		func_177(iParam0);
...
void func_176(int iParam0)//Position - 0x22DCC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_177(int iParam0)//Position - 0x23B6C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x241F9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_179(int iParam0)//Position - 0x242E0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180()//Position - 0x243DE
{
...
int func_181(int iParam0, int iParam1, int iParam2)//Position - 0x24457
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_182()//Position - 0x246B2
{
	func_183();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_183()//Position - 0x246CB
{
	int iVar0;
...
int func_184(int iParam0)//Position - 0x247C8
{
	int iVar0;
	int iVar1;
...
int func_185(int iParam0)//Position - 0x24805
{
	if (func_46(iParam0))
	{
...
var func_186(int iParam0)//Position - 0x2482A
{
	return Global_1798[iParam0 /*29*/];
}

void func_187(bool bParam0)//Position - 0x24839
{
	int iVar0;
...
void func_188(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x24877
{
	if (bParam0)
	{
...
bool func_189()//Position - 0x249B0
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_190(int iParam0, int iParam1)//Position - 0x249CD
{
	bool bVar0;
...
int func_191(int iParam0, bool bParam1)//Position - 0x24A18
{
	int iVar0;
	int iVar1;
...
int func_192(int iParam0)//Position - 0x24A59
{
...
bool func_193()//Position - 0x24A9B
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_194(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x24AAC
{
	int iVar0;
...
void func_196(int iParam0)//Position - 0x24B06
{
	if (iParam0 == 1)
	{
...
void func_197()//Position - 0x24B29
{
	Global_19671 = 0;
	func_198();
}

void func_198()//Position - 0x24B39
{
...
int func_199(int iParam0, float fParam1, int iParam2)//Position - 0x24B5A
{
	int iVar0;
...
bool func_200()//Position - 0x24C2E
{
	bool bVar0;
...
void func_201()//Position - 0x24C51
{
	Global_19671 = 0;
	func_202();
}

void func_202()//Position - 0x24C61
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
...
void func_204()//Position - 0x24CDA
{
...
int func_205(int iParam0, int iParam1)//Position - 0x24D2B
{
	if (func_7(iParam0))
	{
...
int func_206(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x24D5E
{
...
void func_207(int iParam0)//Position - 0x24EED
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_208()//Position - 0x24F19
{
	if (iLocal_41)
	{
		if (INTERIOR::IS_VALID_INTERIOR(iLocal_51))
...
void func_209(bool bParam0)//Position - 0x24F4F
{
	if (bParam0)
	{
		if (!iLocal_40)
...
int func_211(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x24FC9
{
	int iVar0;
...
void func_212(var uParam0, int iParam1)//Position - 0x25100
{
	int iVar0;
...
bool func_213(int iParam0)//Position - 0x2514F
{
	return func_214(iParam0, Global_41396);
}

int func_214(int iParam0, int iParam1)//Position - 0x25160
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_215(int iParam0)//Position - 0x25341
{
	if (Global_41396 == 15)
	{
		return 0;
...
bool func_219(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x2541F
{
	vector3 vVar0;
...
bool func_220(var uParam0, struct<2> Param1, var uParam3)//Position - 0x25449
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_221(var uParam0)//Position - 0x25505
{
	int iVar0;
	float fVar1;
...
void func_222(var uParam0, vector3 vParam1)//Position - 0x255A5
{
	if (uParam0->f_51 == 0)
	{
	}
...
void func_223(var uParam0)//Position - 0x255D6
{
	if (uParam0->f_51)
	{
	}
...
void func_224()//Position - 0x255FD
{
	if (iLocal_47 != -1)
	{
		if (iLocal_39)
...
void func_225(int iParam0)//Position - 0x25678
{
	if (*iParam0 == -1)
	{
		return;
...
int func_226(int iParam0)//Position - 0x256B5
{
	int iVar0;
	int iVar1;
