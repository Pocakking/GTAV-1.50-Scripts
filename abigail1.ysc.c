...
void func_94(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_87(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_87(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102125.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102125.f_4, 0))
		{
			if (func_281(24) != Global_102125.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_278(ENTITY::GET_ENTITY_COORDS(Global_102125.f_4, 1), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
...
void func_234(int iParam0, vector3 vParam1, var uParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_268(iParam3, &Var0, vParam1, uParam2, func_271(iParam0));
...
void func_268(int iParam0, var uParam1, vector3 vParam2, var uParam3, int iParam4)
{
	if (func_265(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
		if (MISC::IS_BIT_SET(Global_75396.f_555[0 /*21*/].f_9, 10))
		{
			...
			if (MISC::IS_BIT_SET(Global_75396.f_555[0 /*21*/].f_9, 11))
			{
				...
				Global_111560.f_32744.f_1934[Global_75396.f_555[0 /*21*/].f_14] = uParam3;
			}
			else
			{
...
void func_283(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, var uParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
