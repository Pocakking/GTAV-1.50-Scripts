...
void func_1(var uParam0)//Position - 0xB9
{
	...
	switch (uParam0->f_13)
	{
		...
		case 4:
			...
			vVar20 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar16, func_31(uParam0), func_30(uParam0), 0, 2) };
			vVar23 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar16, func_31(uParam0), func_30(uParam0), 0, 2) };
			iVar26 = vVar23.z;
			fVar27 = 0.05f;
			...
			TASK::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), vVar20, 1f, 500, iVar26, fVar27);
			func_29(uParam0->f_9);
			func_59(uParam0, 5);
			break;
		...
		case 5:
			...
			vVar29 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar16, func_31(uParam0), func_30(uParam0), 0, 2) };
			fVar32 = vVar29.z;
			if ((iVar28 != 1 && iVar28 != 0) || func_16(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), fVar32, 5f))
			{
				...
				PAD::DISABLE_CONTROL_ACTION(0, 0, 1);
				uParam0->f_8 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_31(uParam0), func_30(uParam0), 2, 1, false, 1065353216, 0, 1.12f);
...
void func_2(var uParam0, bool bParam1)//Position - 0x6E6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_3(var uParam0)//Position - 0x805
{
	int iVar0;
...
bool func_4()//Position - 0x88C
{
	return func_5(PLAYER::PLAYER_ID());
}

int func_5(int iParam0)//Position - 0x89C
{
...
int func_6(int iParam0)//Position - 0x8BB
{
	switch (iParam0)
	{
		case 0:
...
int func_7(bool bParam0, int iParam1, int iParam2)//Position - 0x8FC
{
	if (bParam0)
	{
		return iParam1;
...
void func_8(var uParam0)//Position - 0x913
{
	vector3 vVar0;
	float fVar3;
	int iVar4;
...
int func_9(bool bParam0)//Position - 0xB27
{
...
int func_10(int iParam0)//Position - 0xC12
{
	int iVar0;
...
bool func_12(var uParam0)//Position - 0xC89
{
	return func_33(&(uParam0->f_7), 9);
}

void func_13(var uParam0)//Position - 0xC9B
{
	char* sVar0;
	char* sVar16;
...
void func_14(var uParam0)//Position - 0xD4E
{
	char* sVar0;
...
bool func_15()//Position - 0xDB8
{
	return MISC::IS_BIT_SET(Global_1676879.f_3, 25);
}

int func_16(float fParam0, float fParam1, float fParam2)//Position - 0xDCC
{
	float fVar0;
	float fVar1;
...
void func_17(var uParam0)//Position - 0xE52
{
	int iVar0;
...
void func_18()//Position - 0xEE6
{
	Global_22211.f_6 = 1;
}

void func_19(bool bParam0)//Position - 0xEF4
{
	if (bParam0)
	{
		if (func_20())
...
void func_22(int iParam0)//Position - 0xF3D
{
	if (func_28())
	{
		return;
...
void func_23(int iParam0)//Position - 0xF70
{
	if (func_28())
	{
		return;
...
void func_25(bool bParam0, bool bParam1)//Position - 0x1021
{
	if (bParam0)
	{
		if (func_27(0))
...
bool func_26()//Position - 0x1095
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

int func_27(int iParam0)//Position - 0x10A6
{
	if (iParam0 == 1)
	{
...
bool func_28()//Position - 0x1100
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

void func_29(int iParam0)//Position - 0x1112
{
	Global_2459028 = iParam0;
	Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_865 = iParam0;
}

Vector3 func_30(var uParam0)//Position - 0x1130
{
	vector3 vVar0;
...
Vector3 func_31(var uParam0)//Position - 0x116C
{
	return uParam0->f_16[uParam0->f_9 /*14*/];
}

void func_32(int iParam0, int iParam1)//Position - 0x1180
{
	MISC::SET_BIT(iParam0, iParam1);
}

bool func_33(var uParam0, int iParam1)//Position - 0x1190
{
	return MISC::IS_BIT_SET(*uParam0, iParam1);
}

void func_34(var uParam0, char* sParam1)//Position - 0x11A1
{
	if (uParam0->f_1.f_1 == 1)
	{
		if (func_4())
...
void func_35(var uParam0, char* sParam1)//Position - 0x14D3
{
...
void func_36(int iParam0)//Position - 0x175D
{
	int iVar0;
...
void func_38(var uParam0)//Position - 0x17CD
{
...
int func_39(var uParam0)//Position - 0x1805
{
	int iVar0;
...
int func_40(int iParam0)//Position - 0x189D
{
	switch (iParam0)
	{
		case 1:
...
int func_41(int iParam0)//Position - 0x18D5
{
	switch (iParam0)
	{
		case 2:
...
void func_42(var uParam0)//Position - 0x1913
{
	if (uParam0->f_6 != -1)
	{
		func_43(&(uParam0->f_6));
...
void func_43(var uParam0)//Position - 0x1935
{
	int iVar0;
...
int func_44(int iParam0)//Position - 0x198C
{
	int iVar0;
...
void func_45(var uParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x19C7
{
	int iVar0;
...
int func_46(int iParam0)//Position - 0x1AF2
{
	if (iParam0 != 4)
	{
		return 0;
...
bool func_47(int iParam0)//Position - 0x1B0B
{
	return func_48(iParam0) == joaat("weapon_minigun");
}

int func_48(int iParam0)//Position - 0x1B1F
{
	return Global_1628955[iParam0 /*614*/].f_594;
}

bool func_49(var uParam0)//Position - 0x1B33
{
...
int func_50(var uParam0)//Position - 0x1B5D
{
	var uVar0[10];
	int iVar11;
...
int func_51(var uParam0)//Position - 0x1BD4
{
	int iVar0;
	int iVar1;
...
int func_52(int iParam0)//Position - 0x1C4E
{
	if (iParam0 != func_53())
	{
...
int func_53()//Position - 0x1C6F
{
	return -1;
}

int func_54(int iParam0, bool bParam1, bool bParam2)//Position - 0x1C78
{
	int iVar0;
...
bool func_55(var uParam0)//Position - 0x1CC2
{
	return uParam0->f_7 & 31 > 0;
}

int func_56(int iParam0, vector3 vParam1, int iParam4)//Position - 0x1CD3
{
...
void func_59(var uParam0, int iParam1)//Position - 0x1DC3
{
	uParam0->f_13 = iParam1;
}

void func_60(int iParam0, int iParam1)//Position - 0x1DD1
{
	MISC::CLEAR_BIT(iParam0, iParam1);
}

void func_61(var uParam0)//Position - 0x1DE1
{
	if (uParam0->f_13 == 6)
	{
	}
...
float func_62()//Position - 0x1E34
{
	return 0.13f;
}

void func_63(var uParam0)//Position - 0x1E41
{
...
void func_64(int iParam0, int iParam1, bool bParam2)//Position - 0x1E99
{
	int iVar0;
...
bool func_65()//Position - 0x1EBD
{
	return Global_73784;
}

int func_66()//Position - 0x1EC9
{
...
int func_68()//Position - 0x1F3D
{
	return Global_1312467.f_18;
}

int func_69()//Position - 0x1F4B
{
	var uVar0;
...
int func_72()//Position - 0x202C
{
	return Global_30736;
}

bool func_73()//Position - 0x2037
{
	return Global_2448961.f_598;
}

int func_74(int iParam0)//Position - 0x2046
{
...
bool func_75()//Position - 0x205D
{
	return Global_2458999;
}

bool func_76()//Position - 0x2069
{
	return Global_2448961.f_593;
}

void func_77(var uParam0)//Position - 0x2078
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_78(int iParam0)//Position - 0x20EB
{
	vector3 vVar0;
	int iVar3;
	int iVar4;
...
int func_79(int iParam0, var uParam1)//Position - 0x216C
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
var func_81(int iParam0)//Position - 0x21DB
{
	return MISC::GET_BITS_IN_RANGE(Global_2424073[iParam0 /*421*/].f_309.f_3, 28, 31);
}

int func_82(int iParam0)//Position - 0x21F8
{
...
int func_83(int iParam0)//Position - 0x2231
{
	if (iParam0 != func_53() && func_54(iParam0, 1, 1))
	{
...
int func_84(int iParam0)//Position - 0x2265
{
	if (iParam0 != func_53() && func_54(iParam0, 1, 1))
	{
...
int func_85(int iParam0)//Position - 0x2299
{
	if (iParam0 != func_53())
	{
...
int func_86(int iParam0)//Position - 0x22E0
{
	switch (iParam0)
	{
		case 0:
...
void func_87()//Position - 0x26A8
{
	func_89(&uLocal_197);
	func_88();
}

void func_88()//Position - 0x26BA
{
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_89(var uParam0)//Position - 0x26C6
{
	int iVar0;
...
void func_90(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x2725
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool func_91(int iParam0)//Position - 0x2B91
{
	return iParam0 == 17;
}

void func_92()//Position - 0x2B9E
{
	vector3 vVar0;
...
void func_95(int iParam0, int iParam1, int iParam2)//Position - 0x2C5A
{
	int iVar0;
	int iVar1;
...
void func_96(int iParam0, int iParam1)//Position - 0x2D30
{
	int iVar0;
...
bool func_98()//Position - 0x2DA7
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

bool func_99(int iParam0, int iParam1)//Position - 0x2DB8
{
	bool bVar0;
...
int func_100(int iParam0, bool bParam1)//Position - 0x2E03
{
	int iVar0;
	int iVar1;
...
void func_105(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2F83
{
	vector3 vVar0;
	float fVar3;
...
Vector3 func_106()//Position - 0x3014
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_107(vector3 vParam0, float fParam3)//Position - 0x3027
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
float func_108(int iParam0, float fParam1)//Position - 0x306B
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_109()//Position - 0x30A4
{
	return -0.5f, -0.5f, 0f;
}

void func_110(int iParam0, var uParam1, var uParam2)//Position - 0x30B7
{
	if (func_4())
	{
		switch (iParam0)
...
void func_111()//Position - 0x3677
{
}

int func_112(int iParam0, int iParam1, bool bParam2)//Position - 0x367F
{
	int iVar0;
...
bool func_113()//Position - 0x3794
{
	return Global_1312850;
}

var func_114()//Position - 0x37A0
{
	var uVar0;
