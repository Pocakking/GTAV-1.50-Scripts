...
void func_3(int iParam0, int iParam1, vector3 vParam2, bool bParam5, bool bParam6)//Position - 0x10B
{
	int iVar0;
	...
	iLocal_281[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(iParam1, func_4(iParam0), vParam2, iVar0, -1, 2, 1, 0);
...
void func_7(int iParam0, int iParam1, vector3 vParam2, bool bParam5, bool bParam6)//Position - 0x1E7
{
	int iVar0;
	...
	iLocal_278[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(iParam1, func_8(iParam0), vParam2, iVar0, -1, 2, 1, 0);
...
void func_11(int iParam0, int iParam1, vector3 vParam2, bool bParam5, bool bParam6)//Position - 0x3FC
{
	int iVar0;
	...
	iLocal_266[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(iParam1, func_12(iParam0), vParam2, iVar0, -1, 2, 1, 0);
	...
	switch (Global_30977)
	{
		...
		case 1:
			switch (Global_30978)
			{
				...
				case 1:
					if (OBJECT::DOES_PICKUP_EXIST(iLocal_86[Global_30979]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_86[Global_30979]))
					{
						Global_30980 = 0;
					}
					else
				...
				case 2:
					if (OBJECT::DOES_PICKUP_EXIST(iLocal_163[Global_30979]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_163[Global_30979]))
					{
						Global_30980 = 0;
					}
					else
...
void func_26(int iParam0, int iParam1, vector3 vParam2, bool bParam5, bool bParam6, bool bParam7)//Position - 0xFF8
{
	int iVar0;
	...
	iLocal_163[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(iParam1, func_28(iParam0, 0), vParam2, iVar0, -1, 2, 1, 0);
...
void func_30(int iParam0, vector3 vParam1, bool bParam4, bool bParam5)//Position - 0x243A
{
	int iVar0;
	...
	iLocal_86[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_health_standard"), func_32(iParam0, 0), vParam1, iVar0, -1, 2, 1, 0);
...
void func_34(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x3435
{
	int iVar0;
	...
	iLocal_66[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_weapon_petrolcan"), func_35(iParam0), vParam1, iVar0, -1, 2, 1, 0);
...
void func_37(int iParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6)//Position - 0x3935
{
	int iVar0;
