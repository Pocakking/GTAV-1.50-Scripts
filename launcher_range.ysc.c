				...
				case 3:
					...
					else
					{
						...
						if (!func_81(3) && !Global_98703)
						{
							...
							{
								if ((!func_98(uLocal_94, 1) || !ENTITY::DOES_ENTITY_EXIST(func_80())) && !Global_98703)
								{
									func_91(10);
									break;
								}
				...
				case 6:
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_52))
					{
						...
						if (iLocal_99 != -1)
						{
							if (func_98(Global_110211, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_17(iLocal_99), 0, Global_98706, 0);
...
int func_1(char* sParam0)//Position - 0xAF1
{
...
void func_5(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0xB69
{
...
void func_8(int iParam0)//Position - 0xC2C
{
	iParam0->f_1 = 0f;
	iParam0->f_2 = 0f;
	*iParam0 = 0;
...
float func_9(int iParam0)//Position - 0xC42
{
	if (func_12(iParam0))
	{
		if (func_11(iParam0))
...
float func_10(bool bParam0)//Position - 0xC81
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_11(var uParam0)//Position - 0xCD9
{
	return MISC::IS_BIT_SET(*uParam0, 2);
}

bool func_12(var uParam0)//Position - 0xCE9
{
	return MISC::IS_BIT_SET(*uParam0, 1);
}

int func_13()//Position - 0xCF9
{
	return 1;
}

void func_14()//Position - 0xD02
{
}

void func_15(char* sParam0, int iParam1, int iParam2)//Position - 0xD0A
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_95769))
	{
...
bool func_16(bool bParam0)//Position - 0xD4B
{
...
char* func_17(int iParam0)//Position - 0xD76
{
	switch (iParam0)
	{
		case 0:
...
void func_18(int iParam0)//Position - 0xEB4
{
	var uVar0;
	vector3 vVar1[24];
...
void func_19(int iParam0)//Position - 0xF0B
{
	if (!func_12(iParam0))
	{
		func_22(iParam0);
...
void func_20(int iParam0)//Position - 0xF2C
{
	func_21(iParam0, 0f);
}

void func_21(int iParam0, float fParam1)//Position - 0xF3B
{
...
void func_22(int iParam0)//Position - 0xF69
{
	if (!func_12(iParam0))
	{
		func_20(iParam0);
...
void func_25(int iParam0)//Position - 0x1131
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_26(int iParam0)//Position - 0x118A
{
...
void func_28(int iParam0, int iParam1, int iParam2)//Position - 0x123E
{
	func_29(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_29(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x1253
{
	int iVar0;
...
int func_31(int iParam0, int iParam1, int iParam2)//Position - 0x1306
{
...
int func_32(int iParam0, int iParam1, int iParam2)//Position - 0x1321
{
	int iVar0;
...
int func_33(int iParam0)//Position - 0x136D
{
	int iVar0;
...
int func_35(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x1433
{
	int iVar0;
...
void func_36(var uParam0, int iParam1)//Position - 0x156A
{
	int iVar0;
...
int func_37(int iParam0)//Position - 0x15B9
{
	if (Global_41396 == 15)
	{
		return 0;
		...
		if (fVar3 < 400f)
		{
			if (!iLocal_134)
			{
				if ((ENTITY::DOES_ENTITY_EXIST(Local_140[0 /*6*/].f_1) && ENTITY::DOES_ENTITY_EXIST(iLocal_123)) && !PED::IS_PED_DEAD_OR_DYING(iLocal_123, 1))
				{
					...
					TASK::TASK_AIM_GUN_AT_COORD(0, vVar5, 3000, 0, 0);
					TASK::TASK_SHOOT_AT_COORD(0, vVar5, 2000, -687903391);
			...
			if (!iLocal_135)
			{
				if ((ENTITY::DOES_ENTITY_EXIST(Local_140[1 /*6*/].f_1) && ENTITY::DOES_ENTITY_EXIST(iLocal_124)) && !PED::IS_PED_DEAD_OR_DYING(iLocal_124, 1))
				{
					...
					TASK::OPEN_SEQUENCE_TASK(&iVar4);
					TASK::TASK_AIM_GUN_AT_COORD(0, vVar5, 4000, 0, 0);
					TASK::TASK_SHOOT_AT_COORD(0, vVar5, 1000, -687903391);
					TASK::SET_SEQUENCE_TO_REPEAT(iVar4, 1);
					TASK::CLOSE_SEQUENCE_TASK(iVar4);
			...
			if (!iLocal_136)
			{
				if ((ENTITY::DOES_ENTITY_EXIST(Local_140[2 /*6*/].f_1) && ENTITY::DOES_ENTITY_EXIST(iLocal_125)) && !PED::IS_PED_DEAD_OR_DYING(iLocal_125, 1))
				{
					...
					TASK::OPEN_SEQUENCE_TASK(&iVar4);
					TASK::TASK_AIM_GUN_AT_COORD(0, vVar5, 2000, 0, 0);
					TASK::TASK_SHOOT_AT_COORD(0, vVar5, 1500, -687903391);
					TASK::SET_SEQUENCE_TO_REPEAT(iVar4, 1);
					TASK::CLOSE_SEQUENCE_TASK(iVar4);
...
int func_40(int iParam0)//Position - 0x1AFA
{
	return func_41(iParam0, 1, 1);
}

int func_41(int iParam0, int iParam1, bool bParam2)//Position - 0x1B0A
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_42(int iParam0, int iParam1, int iParam2)//Position - 0x1B74
{
	int iVar0;
	var uVar1;
...
int func_43(var uParam0)//Position - 0x1BA6
{
	int iVar0;
	int iVar1;
...
var func_44()//Position - 0x1BDA
{
	return Global_1312745;
}

int func_45(int iParam0)//Position - 0x1BE6
{
	switch (iParam0)
	{
		case 0:
...
int func_46()//Position - 0x1F16
{
	return Global_30736;
}

int func_47(int iParam0, bool bParam1)//Position - 0x1F21
{
	int iVar0;
...
int func_48(int iParam0)//Position - 0x1FD9
{
	int iVar0;
...
void func_49(int iParam0)//Position - 0x2014
{
	int iVar0;
...
void func_50(char[4] cParam0, int iParam1)//Position - 0x206B
{
...
void func_51(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x2087
{
	int iVar0;
...
int func_52(var uParam0)//Position - 0x21B2
{
	return 1;
}

void func_53(char[4] cParam0, int iParam1, int iParam2)//Position - 0x21BB
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam1);
...
int func_54(int iParam0)//Position - 0x21D8
{
	var uVar0;
...
int func_55()//Position - 0x2230
{
	func_56();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_56()//Position - 0x2249
{
	int iVar0;
...
bool func_57(int iParam0)//Position - 0x2346
{
	return iParam0 < 3;
}

int func_58(int iParam0)//Position - 0x2352
{
	int iVar0;
	int iVar1;
...
int func_59(int iParam0)//Position - 0x238F
{
	if (func_57(iParam0))
	{
...
var func_60(int iParam0)//Position - 0x23B4
{
	return Global_1798[iParam0 /*29*/];
}

var func_61()//Position - 0x23C3
{
	return Global_73784;
}

int func_62(int iParam0)//Position - 0x23CF
{
	if (iParam0 == 1)
	{
...
bool func_63(int iParam0, int iParam1)//Position - 0x2429
{
	switch (iParam0)
	{
		case 5:
...
bool func_64()//Position - 0x2464
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

int func_65()//Position - 0x2479
{
...
bool func_66(bool bParam0)//Position - 0x2493
{
	if (bParam0)
	{
...
int func_67()//Position - 0x24BC
{
	return 1;
}

void func_68(var uParam0, int iParam1)//Position - 0x24C5
{
	func_69(uParam0, iParam1);
}

void func_69(var uParam0, var uParam1)//Position - 0x24D5
{
	*uParam0 = (*uParam0 || uParam1);
}

bool func_70()//Position - 0x24E6
{
	int iVar0;
	bool bVar1;
...
int func_71(int iParam0)//Position - 0x25F0
{
	int iVar0;
...
var func_72()//Position - 0x2D0D
{
	return Global_98708.f_1;
}

int func_73()//Position - 0x2D1B
{
	if (Global_95621 != -1)
	{
...
bool func_75()//Position - 0x2D6B
{
	return Global_98721.f_346 > 0;
}

bool func_76()//Position - 0x2D7C
{
	return Global_98721.f_345 > 0;
}

var func_77()//Position - 0x2D8D
{
	return Global_1312873;
}

int func_78()//Position - 0x2D99
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
var func_80()//Position - 0x2DCF
{
	return Global_94531;
}

int func_81(int iParam0)//Position - 0x2DDB
{
	switch (iParam0)
	{
		case 0:
...
bool func_82(int iParam0)//Position - 0x2E4D
{
	int iVar0;
...
bool func_83(int iParam0)//Position - 0x2E89
{
	return Global_41396 == iParam0;
}

void func_84(var uParam0, int iParam1)//Position - 0x2E97
{
	*uParam0 = (*uParam0 || iParam1);
}

void func_85()//Position - 0x2EA8
{
	vector3 vVar0;
	float fVar3;
	int iVar4;
	...
	if (bLocal_133)
	{
		...
		if (fVar3 > 225f)
		{
			...
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_123, true, 0);
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_124, true, 0);
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_125, true, 0);
...
void func_86(int iParam0)//Position - 0x317C
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_140[iParam0 /*6*/].f_1, Local_140[iParam0 /*6*/], 0, 0f, -0.04f, -0.41f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	Local_140[iParam0 /*6*/].f_2 = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_target_inner1"), vVar9, true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_140[iParam0 /*6*/].f_2, Local_140[iParam0 /*6*/], 0, 0f, -0.04f, -0.41f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	Local_140[iParam0 /*6*/].f_3 = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_target_inner2_b"), vVar9, true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_140[iParam0 /*6*/].f_3, Local_140[iParam0 /*6*/], 0, 0f, -0.04f, -0.41f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	Local_140[iParam0 /*6*/].f_4 = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_target_inner3_b"), vVar9, true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_140[iParam0 /*6*/].f_4, Local_140[iParam0 /*6*/], 0, 0f, -0.04f, -0.41f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	Local_140[iParam0 /*6*/].f_5 = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_target_arm_b"), vVar9, true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_140[iParam0 /*6*/], Local_140[iParam0 /*6*/].f_5, 0, 0f, 0.007f, -0.76f, 0f, 0f, 180f, 0, 0, 0, 0, 2, 1);
	if (iLocal_138 == 0)
	{
...
void func_87(int iParam0, var uParam1, var uParam2)//Position - 0x353E
{
...
void func_91(int iParam0)//Position - 0x3717
{
	iLocal_95 = iParam0;
}

void func_92(int iParam0, bool bParam1, bool bParam2)//Position - 0x3723
{
	int iVar0;
	bool bVar1;
...
bool func_95(int iParam0, int iParam1)//Position - 0x386F
{
	bool bVar0;
...
bool func_96(int iParam0)//Position - 0x38BC
{
	return func_97(iParam0, Global_41396);
}

int func_97(int iParam0, int iParam1)//Position - 0x38CD
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_98(var uParam0, int iParam1)//Position - 0x3AAE
{
	return (uParam0 && iParam1) != 0;
}

void func_99()//Position - 0x3ABD
{
...
bool func_100(int iParam0)//Position - 0x3B5D
{
	return func_41(iParam0, 0, 1);
}

int func_101(int iParam0)//Position - 0x3B6D
{
	switch (iParam0)
	{
		case 91:
...
void func_102(var uParam0, int iParam1)//Position - 0x3C85
{
	func_103(uParam0, iParam1);
}

void func_103(var uParam0, var uParam1)//Position - 0x3C95
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

void func_104(bool bParam0)//Position - 0x3CAA
{
	if (bParam0)
	{
		if (iLocal_105 != 263)
...
void func_106()//Position - 0x3D55
{
}

int func_107(char* sParam0, int iParam1)//Position - 0x3D5D
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam1);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
