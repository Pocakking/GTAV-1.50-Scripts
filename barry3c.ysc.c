	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (func_415(iVar0))
		{
			...
			if ((((iVar1 == joaat("towtruck") || iVar1 == joaat("towtruck2")) || iVar1 == joaat("cargobob")) || iVar1 == joaat("cargobob2")) || iVar1 == joaat("cargobob3"))
			{
				...
				while (iLocal_250 <= 7)
				{
					if (func_415(Local_191[iLocal_250 /*7*/].f_4) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_191[iLocal_250 /*7*/].f_4, 0))
					{
						bVar2 = true;
...
bool func_9(int iParam0, vector3 vParam1, float fParam4)//Position - 0x7EC
{
...
void func_17()//Position - 0x942
{
	if (!iLocal_428)
	{
		...
		else if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_159.f_4, 1))
		{
			func_18();
		}
	}
		...
		else
		{
			...
			switch (iLocal_424)
			{
				...
				case 3:
					...
					{
						AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_426, "IGNITION_FAIL", Local_159.f_4, "BARRY_03_SOUNDSET", 0, 0);
...
void func_19()//Position - 0xBAE
{
	...
	switch (iLocal_157)
	{
		...
		case 1:
			...
			else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_159.f_4, Local_439[0 /*7*/][0 /*3*/], Local_439[0 /*7*/][1 /*3*/], fLocal_454[0], 0, 0, 0) && !ENTITY::IS_ENTITY_IN_AIR(Local_159.f_4))
			{
				vVar0 = { ENTITY::GET_ENTITY_COORDS(Local_159.f_4, 1) };
				if (vVar0.z < 6.7f)
				{
					iLocal_156 = 12;
					iLocal_157 = 0;
...
bool func_25(int iParam0)//Position - 0x1159
{
	return func_26(iParam0, 20);
}

bool func_26(int iParam0, int iParam1)//Position - 0x1169
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_27()//Position - 0x1184
{
	return -1;
}

void func_28()//Position - 0x118D
{
	int iVar0;
...
int func_33()//Position - 0x13B5
{
	func_34();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_34()//Position - 0x13CE
{
	int iVar0;
...
bool func_35(int iParam0)//Position - 0x14CB
{
	return iParam0 < 3;
}

int func_36(int iParam0)//Position - 0x14D7
{
	int iVar0;
	int iVar1;
...
int func_37(int iParam0)//Position - 0x1514
{
	if (func_35(iParam0))
	{
...
var func_38(int iParam0)//Position - 0x1539
{
	return Global_1798[iParam0 /*29*/];
}

bool func_39(int iParam0)//Position - 0x1548
{
	return Global_41396 == iParam0;
}

void func_40()//Position - 0x1556
{
	int iVar0;
...
bool func_41(int iParam0, int iParam1)//Position - 0x15AD
{
	switch (iParam0)
	{
		case 5:
...
void func_43(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x163F
{
...
bool func_45(char* sParam0, int iParam1, char* sParam2)//Position - 0x16C7
{
...
int func_46(int iParam0, bool bParam1, int iParam2)//Position - 0x16E5
{
	int iVar0;
...
void func_47(int iParam0)//Position - 0x171A
{
		...
		case 2:
			...
			if (func_4())
			{
				if (func_2())
				{
					...
					else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_159.f_4, Local_439[0 /*7*/][0 /*3*/], Local_439[0 /*7*/][1 /*3*/], fLocal_454[0], 0, 1, 0))
					{
						iLocal_156 = 6;
					}
					else
...
void func_50(int iParam0)//Position - 0x193B
{
	HUD::CLEAR_THIS_PRINT(vLocal_458[iParam0 /*3*/].f_2);
}

void func_51()//Position - 0x1950
{
	func_17();
	switch (iLocal_157)
	{
...
void func_52()//Position - 0x1A69
{
	func_53(71, 0);
	func_469();
}

void func_53(int iParam0, bool bParam1)//Position - 0x1A7C
{
	int iVar0;
	var uVar1;
...
void func_55(int iParam0, int iParam1, int iParam2)//Position - 0x1BFE
{
	bool bVar0;
...
int func_57()//Position - 0x21A7
{
	return Global_30736;
}

int func_58(int iParam0, int iParam1)//Position - 0x21B2
{
	int iVar0;
...
int func_59(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x2203
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_60()//Position - 0x2850
{
	return Global_1312745;
}

void func_61()//Position - 0x285C
{
	func_78();
	func_70();
	func_66();
...
void func_62(int iParam0)//Position - 0x28B5
{
	if (iParam0 == 1)
	{
...
void func_64()//Position - 0x28FC
{
	StringCopy(&Global_76809, "", 16);
	StringCopy(&Global_76813, "", 16);
}

void func_65()//Position - 0x2916
{
	int iVar0;
...
void func_69(int iParam0)//Position - 0x29E8
{
	if (iParam0 == 1)
	{
		Global_41945 = 1;
...
void func_70()//Position - 0x2A01
{
	func_71(&Global_105109);
}

void func_71(var uParam0)//Position - 0x2A11
{
	int iVar0;
	int iVar1;
...
void func_72(var uParam0)//Position - 0x2FA1
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_73(var uParam0)//Position - 0x2FBC
{
...
void func_74(var uParam0)//Position - 0x2FEB
{
	int iVar0;
...
void func_75(var uParam0)//Position - 0x309B
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_76(var uParam0)//Position - 0x30B9
{
	int iVar0;
...
void func_77(var uParam0)//Position - 0x3199
{
	*uParam0 = -15;
}

void func_78()//Position - 0x31A7
{
	StringCopy(&Global_102117, "", 32);
	func_71(&Global_102125);
}

void func_79()//Position - 0x31C0
{
...
int func_81(int iParam0, int iParam1, int iParam2)//Position - 0x32FE
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	else
	{
		...
		Global_76389[1 /*14*/] = { func_132(iVar0, iParam1, uVar31[iParam1], -1) };
...
int func_82(int iParam0, int iParam1, int iParam2)//Position - 0x34BD
{
	int iVar0;
...
int func_83(int iParam0)//Position - 0x3549
{
	switch (iParam0)
	{
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x3584
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76389[1 /*14*/] = { func_132(iVar10, 14, uVar28[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76389[1 /*14*/] = { func_132(iVar10, 14, uVar69[iVar1], -1) };
			func_100(iParam0, Global_76389[1 /*14*/].f_12, Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4);
			func_115(14);
			if (Global_76387 == 1)
			{
...
void func_85(int iParam0, int iParam1, int iParam2)//Position - 0x3D9A
{
	int iVar0;
	int iVar1;
...
int func_86(int iParam0, int iParam1, int iParam2)//Position - 0x3E24
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_87(int iParam0, int iParam1, int iParam2)//Position - 0x3F02
{
	Global_76389[1 /*14*/] = { func_132(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 2);
}

int func_88(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x3F2D
{
	var uVar0;
	int iVar10;
...
int func_89(int iParam0, int iParam1, int iParam2)//Position - 0x4533
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_90(int iParam0, int iParam1, int iParam2)//Position - 0x45CC
{
	int iVar0;
	int iVar1;
...
int func_91(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x466D
{
	int iVar0;
...
int func_92(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x4974
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_93(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x5527
{
	int iVar0;
...
int func_94(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x580B
{
	int iVar0;
...
int func_95(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5AD2
{
	int iVar0;
	int iVar1;
...
int func_96(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5B09
{
	int iVar0;
...
int func_97(int iParam0, int iParam1, int iParam2)//Position - 0x5B32
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_98(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5DFC
{
	int iVar0;
...
int func_99(int iParam0, int iParam1, int iParam2)//Position - 0x6086
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x61DD
{
	int iVar0;
...
int func_101(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6275
{
	switch (iParam0)
	{
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6343
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar41 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_124(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_103(int iParam0, int iParam1)//Position - 0x649F
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_104(int iParam0)//Position - 0x6846
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_105(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x68A7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_106(int iParam0, int iParam1)//Position - 0x69A3
{
	int iVar0;
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6AE1
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_124(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
int func_108(int iParam0)//Position - 0x6BC1
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6C47
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_110(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6EC4
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_111(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x72E9
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_112(int iParam0, int iParam1)//Position - 0x75DC
{
	int iVar0;
	int iVar1;
...
int func_113(int iParam0, int iParam1)//Position - 0x7622
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_114(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7682
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_115(int iParam0)//Position - 0x7706
{
...
void func_116(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x77BE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_117(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x7808
{
	int iVar0;
...
int func_118(var uParam0)//Position - 0x7838
{
	int iVar0;
	int iVar1;
...
int func_119(int iParam0, int iParam1, int iParam2)//Position - 0x786C
{
	int iVar0;
	var uVar1;
...
bool func_120(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x789E
{
	int iVar0;
...
int func_121(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x9886
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_122(int iParam0)//Position - 0xA7A4
{
	if (!MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_123(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA7F5
{
	int iVar0;
...
int func_124(int iParam0)//Position - 0xA88B
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_125(int iParam0, int iParam1)//Position - 0xA93B
{
	int iVar0;
	struct<10> Var1;
...
void func_126(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB26A
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_127(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xB394
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_128(int iParam0, int iParam1)//Position - 0xB3DC
{
	int iVar0;
	struct<17> Var1;
...
void func_129(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD225
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_130(int iParam0)//Position - 0xD40F
{
	switch (iParam0)
	{
		case 0:
...
void func_131(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xD4BF
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_132(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD530
{
	func_195();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_133(int iParam0, int iParam1)//Position - 0xD582
{
	switch (iParam0)
	{
		case 0:
...
void func_134(int iParam0)//Position - 0xD672
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_135(&(Global_76389[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_135(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xE8E9
{
	int iVar0;
	int iVar1;
...
bool func_136(int iParam0, int iParam1, var uParam2)//Position - 0xEC7A
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_137(int iParam0, int iParam1)//Position - 0xF07F
{
	switch (iParam1)
	{
		case 0:
...
int func_138(int iParam0, int iParam1)//Position - 0xF47A
{
	switch (iParam1)
	{
		case 0:
...
int func_139(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xF875
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_140(int iParam0)//Position - 0xF8B7
{
	switch (iParam0)
	{
		case -1:
...
void func_141(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xF98B
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_135(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_135(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_124(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_142(int iParam0)//Position - 0xFC64
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0xFDBB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x102CA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x1033F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x103B3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x1049A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x107FD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x10A0E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x10C3E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x10D4E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x116ED
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x12260
{
	if (iParam0 < 136)
	{
		func_155(iParam0);
...
void func_154(int iParam0)//Position - 0x12295
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x12E99
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x13DA7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0x13ED4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0, int iParam1)//Position - 0x13FD2
{
	switch (iParam0)
	{
		case 0:
...
void func_159(int iParam0)//Position - 0x140E9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x155DA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x1572B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0x15C36
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x162A4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x16318
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x163E8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x16918
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x16AAF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x172AD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x173BD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x182E9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x18FA6
{
	if (iParam0 < 107)
	{
		func_174(iParam0);
...
void func_172(int iParam0)//Position - 0x18FEC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x19A91
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x1A880
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x1B4C9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0)//Position - 0x1B742
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_177(int iParam0, int iParam1)//Position - 0x1B888
{
	switch (iParam0)
	{
		case 0:
...
void func_178(int iParam0)//Position - 0x1B978
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_179(int iParam0)//Position - 0x1C704
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180(int iParam0)//Position - 0x1C87E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_181(int iParam0)//Position - 0x1CDF5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_182(int iParam0)//Position - 0x1D31F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_183(int iParam0)//Position - 0x1D393
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_184(int iParam0)//Position - 0x1D463
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_185(int iParam0)//Position - 0x1D93B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_186(int iParam0)//Position - 0x1DBA4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_187(int iParam0)//Position - 0x1DE7A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_188(int iParam0)//Position - 0x1E043
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_189(int iParam0)//Position - 0x1EB97
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_190(int iParam0)//Position - 0x1F7E1
{
	if (iParam0 < 60)
	{
		func_192(iParam0);
...
void func_191(int iParam0)//Position - 0x1F816
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_192(int iParam0)//Position - 0x205B8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_193(int iParam0)//Position - 0x20C44
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_194(int iParam0)//Position - 0x20D2B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_195()//Position - 0x20E29
{
...
int func_196(int iParam0, int iParam1, int iParam2)//Position - 0x20EA2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_197(var uParam0, int iParam1)//Position - 0x210FD
{
...
struct<2> func_199(int iParam0)//Position - 0x2119D
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_200(int iParam0)//Position - 0x211D4
{
	struct<2> Var0;
...
void func_201(int iParam0, int iParam1)//Position - 0x21620
{
...
void func_202(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2166A
{
...
void func_203(int iParam0, int iParam1, int iParam2)//Position - 0x21707
{
	struct<4> Var0;
	char* sVar32;
	...
	if (iParam0 != -1)
	{
		...
		func_204(&sVar32, Var0.f_3, Global_98706, iParam1, iParam2);
	}
}

void func_204(char* sParam0, var uParam1, var uParam2, var uParam3, var uParam4)//Position - 0x21746
{
...
void func_205(int iParam0, var uParam1)//Position - 0x2178A
{
	switch (iParam0)
	{
		case 0:
...
int func_207(int iParam0)//Position - 0x229D0
{
	switch (iParam0)
	{
		case 0:
...
void func_208(int iParam0)//Position - 0x22D16
{
	Global_41947 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_209()//Position - 0x22D28
{
	if (Global_96011)
	{
		func_34();
...
char* func_210(var uParam0)//Position - 0x22D5A
{
	uParam0 = uParam0;
	return "";
}

void func_211()//Position - 0x22D69
{
	vector3 vVar0[24];
...
void func_212(int iParam0, int iParam1)//Position - 0x22DAC
{
	Global_96006 = iParam0;
	Global_96007 = iParam1;
}

void func_213()//Position - 0x22DC0
{
	if (Global_76831 != 6)
	{
	}
...
void func_214(var uParam0)//Position - 0x22DF8
{
	if (*uParam0 == -1)
	{
		return;
...
void func_215(int iParam0, bool bParam1)//Position - 0x22E35
{
	struct<26> Var0;
	int iVar32;
	bool bVar33;
...
int func_216(int iParam0)//Position - 0x22FBB
{
	switch (iParam0)
	{
		case 0:
...
void func_217(int iParam0)//Position - 0x23342
{
	func_219(iParam0, 1);
...
int func_218()//Position - 0x23378
{
	return (Global_111560.f_10011.f_21 + Global_111560.f_18569.f_380);
}

void func_219(var uParam0, bool bParam1)//Position - 0x23394
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_220(int iParam0)//Position - 0x236B8
{
...
void func_221(int iParam0)//Position - 0x236EB
{
	switch (iParam0)
	{
		case 30:
...
void func_222(int iParam0, bool bParam1)//Position - 0x23720
{
	if (iParam0 == -1)
	{
		return;
...
void func_223(int iParam0, int iParam1, bool bParam2)//Position - 0x2377D
{
	if (iParam0 == -1)
	{
		return;
...
bool func_224(int iParam0, int iParam1)//Position - 0x237B8
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_225(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x237DB
{
	if (iParam0 != 198)
	{
		if (Global_76577)
...
void func_226(int iParam0, int iParam1)//Position - 0x23836
{
	switch (iParam0)
	{
		case 12:
...
void func_227(int iParam0, bool bParam1)//Position - 0x2391F
{
	if (bParam1)
	{
...
bool func_228(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x23948
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_230()//Position - 0x242CC
{
	return Global_30737;
}

int func_231(var uParam0, int iParam1)//Position - 0x242D7
{
	int iVar0;
...
int func_232(int iParam0)//Position - 0x27A71
{
	switch (iParam0)
	{
		case 46:
...
void func_233(int iParam0, bool bParam1)//Position - 0x27B63
{
	switch (iParam0)
	{
		case 46:
...
void func_234(int iParam0, bool bParam1)//Position - 0x27BB4
{
	int iVar0;
...
void func_235(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x27C1A
{
	func_236(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_236(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x27C3B
{
	int iVar0;
...
void func_237()//Position - 0x27E0E
{
	int iVar0;
...
int func_238(int iParam0)//Position - 0x27F2E
{
	int iVar0;
	int iVar1;
...
int func_241(int iParam0)//Position - 0x281CC
{
...
void func_242(int iParam0, int iParam1)//Position - 0x281F9
{
...
int func_243(char* sParam0)//Position - 0x28236
{
	int iVar0;
...
int func_244()//Position - 0x28296
{
	return func_245(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_245(char* sParam0, int iParam1)//Position - 0x282A7
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_246(int iParam0)//Position - 0x282F0
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_247(bool bParam0)//Position - 0x2831B
{
	if (bParam0)
	{
...
void func_250(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x283B5
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar10 = func_320(&(Global_98669.f_3));
				if (iVar10 > -1)
				{
...
void func_251(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2852A
{
	func_252(&Global_105109, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_252(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x28546
{
	int iVar0;
	int iVar1;
...
int func_253(var uParam0)//Position - 0x293CF
{
...
void func_254(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x293F1
{
	int iVar0;
...
int func_255(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x29479
{
...
int func_256(int iParam0)//Position - 0x294B9
{
	int iVar0;
...
void func_257(var uParam0, int iParam1, int iParam2)//Position - 0x294E7
{
...
int func_258(int iParam0)//Position - 0x295C3
{
	int iVar0;
...
int func_259(int iParam0)//Position - 0x29605
{
	int iVar0;
...
int func_260(int iParam0, int iParam1, int iParam2)//Position - 0x29668
{
	int iVar0;
...
int func_261(int iParam0, int iParam1)//Position - 0x296F6
{
	struct<82> Var0;
...
void func_262(int iParam0, var uParam1, int iParam2)//Position - 0x29738
{
	int iVar0;
...
void func_263(int iParam0, var uParam1)//Position - 0x29994
{
	int iVar0;
...
int func_264(int iParam0)//Position - 0x29C3F
{
	switch (iParam0)
	{
		case 1:
...
int func_265(int iParam0, var uParam1, var uParam2)//Position - 0x29CEF
{
	int iVar0;
	int iVar1;
...
int func_266(int iParam0)//Position - 0x29EE2
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_267(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x29F02
{
	char* sVar0;
...
int func_268(int iParam0, int iParam1, bool bParam2)//Position - 0x2A031
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_269(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2A0A2
{
...
void func_270(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2A17A
{
	int iVar0;
	int iVar1;
...
int func_271(int iParam0, int iParam1)//Position - 0x2A31A
{
	var uVar0;
	var uVar1;
	
	uVar0 = Global_2576213[iParam0 /*3*/][func_118(iParam1)];
...
void func_272(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2A346
{
	int iVar0;
...
void func_273(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x2A88E
{
	int iVar0;
...
int func_274()//Position - 0x2AACF
{
	func_34();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_275(int iParam0, bool bParam1)//Position - 0x2AAE8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_276(int iParam0, var uParam1)//Position - 0x2ABDB
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_278(Var11.f_1)) && iVar72 < 51)
			{
...
int func_277(int iParam0)//Position - 0x2AE63
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_278(int iParam0)//Position - 0x2AEFE
{
...
int func_279(int iParam0, int iParam1)//Position - 0x2B090
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_280(int iParam0, var uParam1)//Position - 0x2BC01
{
	int iVar0;
	int iVar1;
...
int func_281(int iParam0)//Position - 0x2BC3C
{
	int iVar0;
...
void func_282(int iParam0)//Position - 0x2BEB0
{
	int iVar0;
...
void func_283(var uParam0, int iParam1)//Position - 0x2BEEC
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_284(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x2C44B
{
	int iVar0;
	int iVar1;
...
bool func_285(int iParam0, var uParam1, var uParam2)//Position - 0x2C48F
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_286(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x2CBAA
{
	if (bParam6)
	{
...
int func_287(var uParam0)//Position - 0x2CBF1
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_308())
		{
			*uParam0 = func_292(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
bool func_288(int iParam0)//Position - 0x2CC4C
{
	return func_289(iParam0, 0, 1);
}

int func_289(int iParam0, int iParam1, bool bParam2)//Position - 0x2CC5C
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_290(int iParam0)//Position - 0x2CCC6
{
	switch (iParam0)
	{
		case 0:
...
int func_291(int iParam0)//Position - 0x2CFF6
{
	return func_289(iParam0, 5, 1);
}

int func_292(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x2D006
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_293(int iParam0, bool bParam1)//Position - 0x2D0A8
{
	switch (iParam0)
	{
		case -1:
...
int func_294(int iParam0)//Position - 0x2D6C5
{
	if (iParam0 != func_27())
	{
...
Vector3 func_295(int iParam0, int iParam1)//Position - 0x2D723
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_296(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x2D7D1
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_297(vector3 vParam0, float fParam3)//Position - 0x2D866
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_298(int iParam0)//Position - 0x2D8AA
{
	struct<6> Var0;
...
struct<6> func_299(int iParam0)//Position - 0x2DA2E
{
	return func_300(iParam0);
}

struct<6> func_300(int iParam0)//Position - 0x2DA3C
{
	struct<6> Var0;
...
int func_301(int iParam0, var uParam1)//Position - 0x2E503
{
	switch (iParam0)
	{
		case 0:
...
int func_302(int iParam0)//Position - 0x2E585
{
	if (iParam0 != func_27())
	{
...
Vector3 func_303(int iParam0)//Position - 0x2E5E3
{
	switch (iParam0)
	{
		case 1:
...
int func_304()//Position - 0x2E7EE
{
	return func_305(PLAYER::PLAYER_ID());
}

var func_305(int iParam0)//Position - 0x2E7FE
{
	return MISC::GET_BITS_IN_RANGE(Global_2424073[iParam0 /*421*/].f_309.f_3, 28, 31);
}

int func_306(int iParam0)//Position - 0x2E81B
{
	return func_289(iParam0, 0, 0);
}

int func_307(int iParam0)//Position - 0x2E82B
{
	switch (iParam0)
	{
		case -1:
...
bool func_308()//Position - 0x2EAF9
{
	return Global_98721.f_345 > 0;
}

var func_309()//Position - 0x2EB0A
{
	var uVar0;
...
void func_310(var uParam0, int iParam1)//Position - 0x2EB50
{
	if (iParam1 <= 0)
	{
		return;
...
void func_311(var uParam0, int iParam1)//Position - 0x2EBD6
{
...
void func_312(var uParam0, int iParam1)//Position - 0x2EC09
{
	int iVar0;
	int iVar1;
...
int func_313(int iParam0, int iParam1)//Position - 0x2EC5A
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_314(int iParam0)//Position - 0x2ECFC
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_315(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_315(bool bParam0, int iParam1, int iParam2)//Position - 0x2ED21
{
	if (bParam0)
	{
		return iParam1;
...
int func_316(var uParam0)//Position - 0x2ED38
{
	return uParam0 & 15;
}
...
void func_318(var uParam0, int iParam1)//Position - 0x2ED7F
{
...
void func_319(var uParam0, int iParam1)//Position - 0x2EDBA
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_320(char* sParam0)//Position - 0x2EDF6
{
...
int func_321(int iParam0)//Position - 0x2EE4C
{
	switch (iParam0)
	{
		case 69:
...
int func_322(int iParam0)//Position - 0x2EF08
{
	switch (iParam0)
	{
		case 1:
...
int func_323(char* sParam0, bool bParam1)//Position - 0x2EF5C
{
	int iVar0;
	int iVar1;
...
int func_324(int iParam0, bool bParam1)//Position - 0x2EF86
{
	int iVar0;
...
void func_325(bool bParam0)//Position - 0x2EFBC
{
	int iVar0;
	int iVar1;
...
bool func_326(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x2F23E
{
...
void func_327()//Position - 0x2F29D
{
	func_17();
	switch (iLocal_157)
	{
		...
		case 1:
			...
			else if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_188, 0))
			{
				iLocal_157 = 2;
			}
			else if (func_2())
			{
				...
				else if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_159.f_4, Local_439[1 /*7*/][0 /*3*/], Local_439[1 /*7*/][1 /*3*/], fLocal_454[1], 0, 1, 0))
				{
					iLocal_156 = 10;
					iLocal_157 = 0;
				}
...
void func_328(int iParam0)//Position - 0x2F448
{
	bool bVar0;
	int iVar1;
...
void func_329(bool bParam0, int iParam1)//Position - 0x2F4B9
{
	int iVar0;
...
void func_330(char[4] cParam0, int iParam1)//Position - 0x2F553
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

void func_331()//Position - 0x2F56A
{
	vector3 vVar0;
	...
	switch (iLocal_157)
	{
		...
		case 1:
			...
			else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_159.f_4, Local_439[0 /*7*/][0 /*3*/], Local_439[0 /*7*/][1 /*3*/], fLocal_454[0], 1, 1, 0))
			{
				iLocal_157 = 2;
			}
			else if (iLocal_486)
...
int func_332(vector3 vParam0, int iParam3, int iParam4)//Position - 0x2F7A6
{
	int iVar0;
...
void func_333()//Position - 0x2F7D4
{
	func_17();
	switch (iLocal_157)
	{
...
void func_334(int iParam0, bool bParam1)//Position - 0x2F98F
{
	int iVar0;
...
void func_335(int iParam0)//Position - 0x2F9D9
{
...
void func_336()//Position - 0x2F9FF
{
	switch (iLocal_157)
	{
		case 0:
...
bool func_337(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7)//Position - 0x2FBFE
{
...
void func_339()//Position - 0x2FCCD
{
	if (!iLocal_249)
	{
...
void func_340(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x2FCE9
{
	vector3 vVar0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102125.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102125.f_4, 0))
		{
			if (func_367(24) != Global_102125.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_364(ENTITY::GET_ENTITY_COORDS(Global_102125.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
				}
				func_341(Global_102125.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_341(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)//Position - 0x2FD64
{
	struct<60> Var0;
...
void func_342(int iParam0, int iParam1, int iParam2)//Position - 0x2FE8D
{
	int iVar0;
...
void func_343(int iParam0, int iParam1)//Position - 0x2FFAA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_344(int iParam0)//Position - 0x301AE
{
...
int func_345(int iParam0)//Position - 0x3028B
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_346(int iParam0, bool bParam1)//Position - 0x3043C
{
	int iVar0;
	struct<2> Var1;
...
int func_347(int iParam0)//Position - 0x305BC
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_349(int iParam0)//Position - 0x3069F
{
	int iVar0;
	int iVar1;
...
int func_350()//Position - 0x32B6A
{
	return 0;
}

int func_351()//Position - 0x32B73
{
	return 1;
}

int func_352()//Position - 0x32B7C
{
	return 1;
}

int func_353()//Position - 0x32B85
{
...
int func_355(int iParam0)//Position - 0x32C59
{
	int iVar0;
	char* sVar1;
...
int func_356(int iParam0)//Position - 0x32C9F
{
	int iVar0;
...
int func_357(int iParam0)//Position - 0x32CDA
{
	int iVar0;
...
int func_358(int iParam0)//Position - 0x32D56
{
	int iVar0;
...
int func_359(var uParam0, int iParam1)//Position - 0x32E3E
{
	int iVar0;
	int iVar1;
...
void func_360(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0x34538
{
	if (func_359(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
...
void func_361(var uParam0, var uParam1)//Position - 0x34637
{
...
void func_362(int iParam0)//Position - 0x34703
{
	if (iParam0 == -1)
	{
		return;
...
void func_363(int iParam0)//Position - 0x3477D
{
...
int func_364(vector3 vParam0, int iParam3, var uParam4, var uParam5)//Position - 0x347A4
{
	int iVar0;
...
int func_365(vector3 vParam0, int iParam3, int iParam4)//Position - 0x348BA
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_366(int iParam0)//Position - 0x34949
{
	return MISC::IS_BIT_SET(Global_111560.f_7224[iParam0], 0);
}

int func_367(int iParam0)//Position - 0x34961
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_368()//Position - 0x3497D
{
	switch (iLocal_157)
	{
		case 0:
...
void func_369()//Position - 0x34A68
{
	switch (iLocal_157)
	{
		case 0:
...
void func_370(int iParam0, bool bParam1)//Position - 0x34F75
{
...
void func_371()//Position - 0x34FB1
{
	switch (iLocal_157)
	{
		case 0:
...
void func_372(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)//Position - 0x350C2
{
	switch (*uParam0)
	{
		case 0:
...
bool func_373(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x351D3
{
...
void func_374()//Position - 0x35227
{
	Global_19671 = 0;
	func_42();
}

struct<6> func_375()//Position - 0x35237
{
	struct<6> Var0;
	int iVar6;
	int iVar7;
...
struct<6> func_376()//Position - 0x352E3
{
	struct<6> Var0;
...
void func_377()//Position - 0x35307
{
}

int func_378()//Position - 0x3530F
{
	if (!func_415(PLAYER::PLAYER_PED_ID()))
	{
		return 1;
...
void func_379()//Position - 0x3543C
{
	switch (iLocal_157)
	{
		case 0:
...
void func_380()//Position - 0x354D2
{
...
void func_381(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x35515
{
...
void func_382(var uParam0, bool bParam1)//Position - 0x35535
{
	func_383(&(uParam0->f_41), bParam1);
}

void func_383(var uParam0, bool bParam1)//Position - 0x35547
{
	int iVar0;
...
void func_384(int iParam0, bool bParam1)//Position - 0x35585
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_385(var uParam0, bool bParam1)//Position - 0x355C0
{
	func_386(&(uParam0->f_35), bParam1);
}

void func_386(var uParam0, bool bParam1)//Position - 0x355D2
{
	int iVar0;
...
void func_387(var uParam0, int iParam1)//Position - 0x3560F
{
	func_388(&(uParam0->f_28), iParam1);
}

void func_388(var uParam0, int iParam1)//Position - 0x35621
{
	int iVar0;
...
void func_389(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x35662
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_390(int iParam0)//Position - 0x356B2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_391(bool bParam0)//Position - 0x356F3
{
	func_392(39, bParam0);
	func_392(40, bParam0);
	func_392(41, bParam0);
...
void func_392(int iParam0, bool bParam1)//Position - 0x3572B
{
	if (bParam1)
	{
...
void func_393(int iParam0, int iParam1, bool bParam2)//Position - 0x35762
{
	int iVar0;
...
void func_394(int iParam0, int iParam1, bool bParam2)//Position - 0x357D4
{
	int iVar0;
...
void func_396(char* sParam0, bool bParam1)//Position - 0x35873
{
	func_397(sParam0);
	func_471(bParam1);
}

void func_397(char* sParam0)//Position - 0x35887
{
...
void func_398(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x358C6
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_76831 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_400(Global_76832, Global_76834, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
float func_399(char* sParam0)//Position - 0x35BAB
{
	HUD::_BEGIN_TEXT_COMMAND_GET_WIDTH(sParam0);
	return HUD::_END_TEXT_COMMAND_GET_WIDTH(1);
}

struct<2> func_400(int iParam0, int iParam1, int iParam2)//Position - 0x35BBE
{
	struct<2> Var0;
	int iVar2;
...
char* func_401(int iParam0)//Position - 0x35C94
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_402(int iParam0)//Position - 0x35DE7
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_403(int iParam0)//Position - 0x35E1A
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_404(int iParam0)//Position - 0x35E4D
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_405(int iParam0)//Position - 0x35E80
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_406(int iParam0)//Position - 0x35EB3
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_407(int iParam0)//Position - 0x35EF0
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_408(int iParam0)//Position - 0x35F23
{
	struct<2> Var0;
...
int func_409(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x35F8C
{
...
bool func_410(bool bParam0)//Position - 0x360A4
{
	if (bParam0)
	{
...
int func_411(int iParam0)//Position - 0x360CD
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
int func_412(int iParam0)//Position - 0x36127
{
	if (Global_41396 == 15)
	{
		return 0;
...
bool func_413(int iParam0)//Position - 0x36149
{
	return func_414(iParam0, Global_41396);
}

int func_414(int iParam0, int iParam1)//Position - 0x3615A
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_415(int iParam0)//Position - 0x3633B
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
bool func_416(bool bParam0)//Position - 0x3635C
{
...
void func_417(bool bParam0)//Position - 0x36387
{
	if (bParam0)
	{
		if (func_434())
...
void func_418(int iParam0, int iParam1, int iParam2)//Position - 0x36558
{
...
bool func_419()//Position - 0x3661C
{
	return MISC::IS_BIT_SET(Global_98669.f_20, 13);
}

void func_420(vector3 vParam0, float fParam3, bool bParam4)//Position - 0x36630
{
	if (func_415(PLAYER::PLAYER_PED_ID()))
	{
		if (bParam4)
	...
	iLocal_188 = VEHICLE::CREATE_VEHICLE(iLocal_189, vParam0, fParam3, 1, 1, 0);
...
void func_421(int iParam0, int iParam1, int iParam2)//Position - 0x366F1
{
	if (func_422(iParam0))
	{
		if (func_415(iParam1))
...
int func_422(int iParam0)//Position - 0x36733
{
	if (func_415(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_423(vector3 vParam0, float fParam3)//Position - 0x36753
{
	...
	func_246(&iLocal_172);
	func_6(&(Local_159.f_4));
	Local_159.f_4 = VEHICLE::CREATE_VEHICLE(Local_159.f_5, vParam0, fParam3, 1, 1, 0);
	...
	iLocal_172 = OBJECT::CREATE_OBJECT(iLocal_179, vParam0 + vLocal_173, 1, true, 0);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_172, Local_159.f_4, 0, vLocal_173, vLocal_176, 0, 0, 0, 0, 2, 1);
}

void func_424()//Position - 0x36847
{
	if (func_415(PLAYER::PLAYER_PED_ID()))
	{
		if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
...
void func_425()//Position - 0x36879
{
	HUD::CLEAR_PRINTS();
	HUD::CLEAR_HELP(1);
	if (func_15())
...
void func_426(int iParam0)//Position - 0x3689A
{
	if (func_429())
	{
		return;
...
void func_427(bool bParam0, bool bParam1)//Position - 0x36924
{
	if (bParam0)
	{
		if (func_411(0))
...
bool func_428()//Position - 0x36998
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

bool func_429()//Position - 0x369A9
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

void func_430()//Position - 0x369BB
{
	Global_19671 = 0;
	func_431();
}

void func_431()//Position - 0x369CB
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_432(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x369EC
{
	if (func_451())
	{
...
int func_433()//Position - 0x36A81
{
	return Global_105109.f_2890.f_12.f_66;
}

bool func_434()//Position - 0x36A94
{
	return func_435(&(Global_105109.f_2890));
}

int func_435(var uParam0)//Position - 0x36AA7
{
...
int func_436(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x36B06
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_437(bool bParam0)//Position - 0x36B81
{
	if (bParam0)
	{
		if (func_434())
...
void func_438(bool bParam0)//Position - 0x36DC8
{
	if (bParam0)
	{
		if (func_434())
	...
	else if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_159.f_4, 0))
	{
...
void func_439(int iParam0, int iParam1, int iParam2)//Position - 0x37043
{
...
void func_440(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x37077
{
	int iVar0;
...
void func_441(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x37120
{
	if (bParam0)
	{
...
bool func_442()//Position - 0x37259
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_443(int iParam0, int iParam1)//Position - 0x37276
{
	bool bVar0;
...
int func_444(int iParam0, bool bParam1)//Position - 0x372C1
{
	int iVar0;
	int iVar1;
...
int func_445(int iParam0)//Position - 0x37302
{
...
bool func_446()//Position - 0x37344
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_447(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x37355
{
	int iVar0;
...
void func_448(int iParam0)//Position - 0x37388
{
	if (iParam0 == 1)
	{
...
void func_449(bool bParam0)//Position - 0x373AB
{
	if (bParam0)
	{
		func_432(Local_159, Local_159.f_3, 1, 0);
...
void func_452()//Position - 0x37536
{
	...
	iLocal_142 = func_465();
	iLocal_185[0] = PED::ADD_SCENARIO_BLOCKING_AREA(-1156.9f, -1274f, 0f, -1141.5f, -1239.6f, 8f, 0, 1, 1, 1);
	iLocal_185[1] = PED::ADD_SCENARIO_BLOCKING_AREA(-1177f, -1292f, 0f, -1160f, -1273.3f, 8f, 0, 1, 1, 1);
...
void func_453(int iParam0, int iParam1, bool bParam2)//Position - 0x37823
{
	int iVar0;
...
void func_454()//Position - 0x37953
{
	char cVar0[64];
	char cVar16[64];
	char* sVar32;
...
struct<4> func_455(int iParam0)//Position - 0x379CE
{
	return Global_1798[iParam0 /*29*/].f_3;
}

int func_456(int iParam0, int iParam1)//Position - 0x379E1
{
...
int func_457(int iParam0, int iParam1)//Position - 0x37A0B
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_458(int iParam0, int iParam1, int iParam2)//Position - 0x37A35
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_459(int iParam0, int iParam1, int iParam2)//Position - 0x37A7A
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_460()//Position - 0x37ABF
{
...
void func_461()//Position - 0x37AEF
{
...
Vector3 func_462(char* sParam0, int iParam1)//Position - 0x37B91
{
	vector3 vVar0;
...
void func_463(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x37BAC
{
...
struct<7> func_464(vector3 vParam0, float fParam3)//Position - 0x37C47
{
	struct<7> Var0;
...
int func_465()//Position - 0x37C6F
{
	return PED::ADD_SCENARIO_BLOCKING_AREA(-564f, -1758.1f, 16.5f, -419.31f, -1649f, 23f, 0, 1, 1, 1);
}

void func_466(var uParam0, var uParam1)//Position - 0x37C9D
{
	*uParam0 = *uParam1;
	*uParam1 = 0;
}

void func_467(var uParam0, int iParam1)//Position - 0x37CAF
{
	Global_98669.f_22[iParam1] = uParam0;
}

void func_468(int iParam0, var uParam1)//Position - 0x37CC3
{
	*iParam0 = *uParam1;
	*uParam1 = 0;
}

void func_469()//Position - 0x37CD5
{
	if (func_470())
	{
	}
	PLAYER::SET_WANTED_LEVEL_MULTIPLIER(1f);
	func_381(&Local_81, 1, 0, 0);
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_142, 0);
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_185[0], 0);
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_185[1], 0);
...
void func_471(bool bParam0)//Position - 0x37DC5
{
	int iVar0;
...
void func_472(char* sParam0, int iParam1)//Position - 0x37E95
{
	if (Global_98669 != 12)
	{
...
int func_473(char* sParam0, int iParam1, int iParam2)//Position - 0x37EBD
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
void func_477(bool bParam0)//Position - 0x38131
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_478(int iParam0)//Position - 0x38145
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_479(int iParam0)//Position - 0x38182
{
	if (iParam0 == 1)
	{
...
void func_480()//Position - 0x381BF
{
	Global_22211.f_5 = 1;
}

void func_481()//Position - 0x381CD
{
	Global_22211.f_5 = 0;
}

void func_482(bool bParam0)//Position - 0x381DB
{
	if (bParam0)
	{
		func_483();
...
void func_483()//Position - 0x3823E
{
...
void func_484()//Position - 0x38267
{
	Global_92875 = 0;
	Global_92876 = 0;
}

int func_485()//Position - 0x38279
{
...
void func_486()//Position - 0x382B7
{
	Global_98704 = 1;
...
void func_487(int iParam0)//Position - 0x383A4
{
...
void func_488()//Position - 0x383B6
{
	int iVar0;
...
void func_489(var uParam0)//Position - 0x383D6
{
...
void func_490(var uParam0)//Position - 0x383F6
{
	int iVar0;
...
int func_491(int iParam0)//Position - 0x38430
{
	if (!func_35(iParam0))
	{
		return func_38(iParam0);
