...
void __EntryFunction__()//Position - 0x0
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iScriptParam_0))
	{
		...
		iLocal_316 = Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_26;
		func_74(&Global_1297630, iLocal_316);
		vLocal_378 = { Global_1297630.f_146.f_82[5 /*102*/] };
		fLocal_381 = Global_1297630.f_146.f_82[5 /*102*/].f_3;
		if (fLocal_381 < 0f)
		{
			fLocal_381 = (fLocal_381 + 360f);
		}
		vLocal_388 = { Global_1297630.f_146.f_82[5 /*102*/].f_16 };
		fLocal_391 = Global_1297630.f_146.f_82[5 /*102*/].f_19.f_2;
		vLocal_382 = { Global_1297630.f_146.f_82[5 /*102*/].f_7 };
		vLocal_385 = { Global_1297630.f_146.f_82[5 /*102*/].f_10 };
	}
...
void func_1()//Position - 0x384
{
	...
	switch (iLocal_312)
	{
			...
			if (func_52(1, 0, 1))
			{
				if (((func_56(vLocal_378, vVar0) && !func_55()) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) > (fLocal_381 - 45f)) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) < (fLocal_381 + 45f))
				{
					if ((!PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID()) && !PLAYER::IS_PLAYER_TARGETTING_ANYTHING(PLAYER::PLAYER_ID())) && PAD::IS_CONTROL_JUST_PRESSED(2, 51))
					{
						...
						func_23(1, 1, 1, 0, 0, 0);
						TASK::TASK_PED_SLIDE_TO_COORD(PLAYER::PLAYER_PED_ID(), vLocal_378, fLocal_381, 1061158912);
						iLocal_312 = 2;
					}
				}
				else
		...
		case 2:
			...
			{
				func_15(104, 1, -1, 1);
				iLocal_317 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_382, vLocal_385, 2, false, false, 1065353216, 0, 1065353216);
		...
		case 6:
			...
			{
				iLocal_317 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_382, vLocal_385, 2, false, true, 1065353216, 0, 1065353216);
...
void func_3(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0xD6D
{
	struct<6> Var0;
...
int func_4(int iParam0)//Position - 0xDB1
{
	var uVar0;
...
int func_5(int iParam0, bool bParam1, bool bParam2)//Position - 0xDC9
{
	int iVar0;
...
void func_6(int iParam0)//Position - 0xE13
{
	switch (iParam0)
	{
		case 0:
...
int func_8()//Position - 0xF70
{
	return -1;
}

void func_9(int iParam0)//Position - 0xF79
{
	int iVar0;
...
bool func_11(int iParam0)//Position - 0xFBB
{
	return MISC::IS_BIT_SET(Global_1373500.f_241.f_136[func_13(9) /*33*/][iParam0], func_12(9));
}

int func_12(int iParam0)//Position - 0xFE1
{
	return (iParam0 % 32);
}

int func_13(int iParam0)//Position - 0xFEE
{
	return (iParam0 / 32);
}

int func_14(int iParam0)//Position - 0xFFB
{
...
void func_15(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x101A
{
	int iVar0;
...
int func_16(var uParam0)//Position - 0x104C
{
	int iVar0;
	int iVar1;
...
int func_17()//Position - 0x1080
{
	return Global_1312745;
}

int func_18()//Position - 0x108C
{
	return 1;
	return 0;
}

void func_19(bool bParam0)//Position - 0x1099
{
	if (bParam0)
	{
		func_21();
...
void func_20(int iParam0, int iParam1)//Position - 0x10EA
{
...
void func_21()//Position - 0x1120
{
	Global_2531497.f_4532 = 0;
}

void func_22()//Position - 0x1130
{
	Global_22211.f_6 = 1;
}

void func_23(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x113E
{
	if (bParam0)
	{
...
bool func_24()//Position - 0x1277
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_25(int iParam0, int iParam1)//Position - 0x1294
{
	bool bVar0;
...
int func_26(int iParam0, bool bParam1)//Position - 0x12DF
{
	int iVar0;
	int iVar1;
...
int func_27(int iParam0)//Position - 0x1320
{
...
bool func_28()//Position - 0x1362
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_29(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x1373
{
	int iVar0;
...
void func_31(int iParam0)//Position - 0x13CD
{
	if (iParam0 == 1)
	{
...
void func_32(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x13F0
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool func_33(int iParam0)//Position - 0x185C
{
	return iParam0 == 17;
}

void func_34()//Position - 0x1869
{
	vector3 vVar0;
...
int func_36(int iParam0)//Position - 0x18F4
{
	int iVar0;
...
void func_37(bool bParam0, int iParam1, int iParam2)//Position - 0x1925
{
	int iVar0;
	int iVar1;
...
void func_38(int iParam0, bool bParam1)//Position - 0x19FB
{
	int iVar0;
...
int func_41()//Position - 0x1A87
{
	return Global_1312467.f_18;
}

int func_42()//Position - 0x1A95
{
...
void func_43()//Position - 0x1AC3
{
	if (!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iLocal_322))
	{
		if (func_45(2, 0, 1))
		{
			...
			{
				if (func_44(&iLocal_322, 5, iLocal_320, vLocal_388, fLocal_391, 1, 1, 1) && func_44(&iLocal_323, 5, iLocal_321, vLocal_388, fLocal_391, 1, 1, 1))
				{
...
int func_44(int iParam0, int iParam1, int iParam2, vector3 vParam3, float fParam6, bool bParam7, int iParam8, bool bParam9)//Position - 0x1B2E
{
	int iVar0;
...
bool func_45(int iParam0, bool bParam1, bool bParam2)//Position - 0x1B8D
{
	return func_46(0, iParam0, 1, bParam1, bParam2);
}

int func_46(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x1BA1
{
	int iVar0;
	int iVar1;
...
int func_47(int iParam0)//Position - 0x1C6A
{
	switch (iParam0)
	{
		case 0:
...
int func_48(int iParam0)//Position - 0x1CA4
{
	switch (iParam0)
	{
		case 0:
...
int func_49(int iParam0, bool bParam1)//Position - 0x1CEA
{
	int iVar0;
...
int func_50(int iParam0)//Position - 0x1D87
{
	switch (iParam0)
	{
		case 0:
...
int func_52(bool bParam0, bool bParam1, bool bParam2)//Position - 0x1DEA
{
	int iVar0;
...
int func_56(vector3 vParam0, float fParam3, var uParam4, var uParam5)//Position - 0x1F14
{
		...
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID())) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (!FIRE::IS_EXPLOSION_IN_SPHERE(-1, vParam0, 2f))
			{
				if ((((CAM::IS_GAMEPLAY_CAM_RENDERING() && !CUTSCENE::IS_CUTSCENE_PLAYING()) && !CAM::IS_CINEMATIC_CAM_RENDERING()) && !func_60(0)) && !func_59())
				{
					...
					if (func_57(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vParam0, fParam3, 0))
					{
						return 1;
					}
				}
...
int func_57(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x1FC7
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_60(int iParam0)//Position - 0x211B
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
int func_64()//Position - 0x2256
{
	return Global_30736;
}

bool func_65()//Position - 0x2261
{
	return Global_2448961.f_598;
}

int func_66(int iParam0)//Position - 0x2270
{
...
bool func_67()//Position - 0x2287
{
	return Global_2458999;
}

bool func_68()//Position - 0x2293
{
	return Global_2448961.f_593;
}

void func_69(var uParam0)//Position - 0x22A2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_70(int iParam0)//Position - 0x2315
{
	vector3 vVar0;
	int iVar3;
	int iVar4;
...
int func_71(int iParam0, var uParam1)//Position - 0x2396
{
...
void func_74(var uParam0, int iParam1)//Position - 0x24EA
{
	vector3 vVar0;
	int iVar6;
...
void func_75(int iParam0, var uParam1, var uParam2, int iParam3)//Position - 0x4CCF
{
	struct<4> Var0;
...
void func_76(int iParam0, int iParam1, var uParam2, bool bParam3)//Position - 0x516A
{
	struct<6> Var0[2];
	vector3 vVar13;
...
Vector3 func_77(vector3 vParam0, float fParam3)//Position - 0x5AE7
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_78(var uParam0, int iParam1)//Position - 0x5B2B
{
	struct<6> Var0;
	var uVar6;
	int iVar23;
...
int func_79(int iParam0, var uParam1)//Position - 0x5B6D
{
	switch (iParam0)
	{
		case -1:
...
struct<6> func_80(int iParam0)//Position - 0x5C93
{
	struct<6> Var0;
...
void func_81(var uParam0, int iParam1)//Position - 0x6293
{
	vector3 vVar0;
...
int func_82(int iParam0)//Position - 0x698F
{
	switch (iParam0)
	{
		case 87:
...
int func_83(int iParam0, int iParam1)//Position - 0x69BE
{
	if (iParam1 == -1)
	{
		switch (iParam0)
...
int func_84(int iParam0, int iParam1)//Position - 0x6A9B
{
	if (iParam1 == -1)
	{
		switch (iParam0)
...
int func_85(int iParam0)//Position - 0x6B57
{
	switch (iParam0)
	{
		case 83:
...
void func_86(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6B80
{
	struct<6> Var0[2];
	vector3 vVar13;
...
struct<6> func_87(int iParam0, bool bParam1)//Position - 0x803B
{
	struct<6> Var0;
...
int func_88(int iParam0)//Position - 0x8BF1
{
	switch (iParam0)
	{
		case 1:
...
int func_89(int iParam0, int iParam1, bool bParam2)//Position - 0x8E2E
{
	int iVar0;
...
bool func_90()//Position - 0x8F43
{
	return Global_1312850;
}

void func_91()//Position - 0x8F4F
{
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_92()//Position - 0x8F5B
{
...
int func_95(int iParam0)//Position - 0x9040
{
	if (Global_41396 == 15)
	{
		return 0;
...
bool func_96(int iParam0)//Position - 0x9062
{
	return func_97(iParam0, Global_41396);
}

int func_97(int iParam0, int iParam1)//Position - 0x9073
{
	if (iParam1 == 15)
	{
		return 1;
