...
void __EntryFunction__()//Position - 0x0
{
	...
	while (iVar0 == 1)
	{
		...
		switch (iLocal_250)
		{
			...
			case 8:
				...
				else if (iLocal_440 == 1)
				{
					...
					{
						func_52(Global_111505[iLocal_251], iLocal_297, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_240, &Local_372, &Local_356));
					}
				}
				break;
			...
			case 9:
				...
				if (!bVar37 && (!bVar36 || bLocal_437))
				{
					if (bLocal_507)
					{
						Global_111505[iLocal_251] = uLocal_506;
					}
					else
					{
		...
		if (((((((((((((iLocal_250 == 0 || iLocal_250 == 1) || iLocal_250 == 3) || iLocal_250 == 8) || iLocal_250 == 9) || iLocal_250 == 7) && func_84(iLocal_240, PLAYER::PLAYER_PED_ID(), 1) < 5f) && bLocal_436 == 1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) && iVar30 == 0) && bLocal_439 == 1) && !Global_3) && func_7()) && bVar81)
		{
			if (iLocal_298 == -1)
			{
...
void func_1()//Position - 0x11FC
{
	...
	if ((ENTITY::DOES_ENTITY_EXIST(iLocal_448) && !ENTITY::IS_ENTITY_DEAD(iLocal_448, 0)) && !ENTITY::IS_ENTITY_DEAD(iLocal_240, 0))
	{
		if (!iLocal_449)
		{
...
void func_6(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x14BD
{
	int iVar0;
...
int func_7()//Position - 0x15E8
{
	return 1;
}

void func_8()//Position - 0x15F1
{
	func_9();
...
void func_9()//Position - 0x162D
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_240, 0))
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_240, 0);
	}
}

void func_10()//Position - 0x1647
{
	func_9();
	if (func_102(iLocal_240) && func_102(PLAYER::PLAYER_PED_ID()))
	{
...
void func_11()//Position - 0x168D
{
}

void func_12(var uParam0, int iParam1)//Position - 0x1695
{
...
void func_13()//Position - 0x16B2
{
	Global_19671 = 0;
	func_14();
}

void func_14()//Position - 0x16C2
{
...
int func_16()//Position - 0x1740
{
	func_17();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_17()//Position - 0x1759
{
	int iVar0;
...
bool func_18(int iParam0)//Position - 0x1856
{
	return Global_41396 == iParam0;
}

bool func_19(int iParam0)//Position - 0x1864
{
	return iParam0 < 3;
}

int func_20(int iParam0)//Position - 0x1870
{
	int iVar0;
	int iVar1;
...
int func_21(int iParam0)//Position - 0x18AD
{
	if (func_19(iParam0))
	{
...
var func_22(int iParam0)//Position - 0x18D2
{
	return Global_1798[iParam0 /*29*/];
}

void func_23(char* sParam0)//Position - 0x18E1
{
	struct<16> Var0;
...
void func_24(char* sParam0)//Position - 0x1907
{
	int iVar0;
...
void func_25(char* sParam0)//Position - 0x1945
{
	int iVar0;
...
void func_26(int iParam0, char* sParam1)//Position - 0x1989
{
	switch (iParam0)
	{
		case 0:
...
void func_27(char* sParam0)//Position - 0x1B52
{
	char cVar0[64];
...
void func_28(char* sParam0)//Position - 0x1B86
{
	struct<4> Var0;
...
void func_29(char* sParam0)//Position - 0x1BB1
{
...
void func_30()//Position - 0x1BD2
{
	iLocal_254 = MISC::GET_RANDOM_INT_IN_RANGE(0, iLocal_253);
}

void func_31(char* sParam0)//Position - 0x1BE3
{
	int iVar0;
...
bool func_33(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1C4F
{
...
int func_34(char* sParam0, int iParam1, bool bParam2)//Position - 0x1C9D
{
	Global_20806 = 0;
...
bool func_37(int iParam0)//Position - 0x200A
{
	return func_38(iParam0, 20);
}

bool func_38(int iParam0, int iParam1)//Position - 0x201A
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_39()//Position - 0x2035
{
	return -1;
}

void func_40()//Position - 0x203E
{
	int iVar0;
...
bool func_46(int iParam0, int iParam1)//Position - 0x22BB
{
	switch (iParam0)
	{
		case 5:
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x22F6
{
...
void func_48(char[4] cParam0)//Position - 0x234C
{
	int iVar0;
...
void func_49(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2387
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_50(char* sParam0)//Position - 0x2422
{
	int iVar0;
...
void func_51(var uParam0)//Position - 0x245A
{
}

void func_52(var uParam0, int iParam1, float fParam2)//Position - 0x2462
{
}

void func_53()//Position - 0x246A
{
	STREAMING::REMOVE_ANIM_DICT(&Local_388);
}

void func_54()//Position - 0x2479
{
	char* sVar0;
	struct<16> Var8;
...
void func_55(var uParam0)//Position - 0x24EF
{
}

void func_56(char* sParam0)//Position - 0x24F7
{
...
void func_57(int iParam0, char* sParam1, char* sParam2)//Position - 0x250A
{
...
bool func_59()//Position - 0x2663
{
	return Global_98721.f_345 > 0;
}

bool func_60()//Position - 0x2674
{
	bool bVar0;
...
void func_64(char* sParam0)//Position - 0x26F7
{
	struct<8> Var0;
...
void func_65(char* sParam0)//Position - 0x2737
{
	func_26(iLocal_297, sParam0);
}

void func_66(char* sParam0)//Position - 0x2748
{
	StringCopy(sParam0, "MONOLOGUE_", 16);
	StringIntConCat(sParam0, Global_111505[iLocal_251] + 1, 16);
}

void func_67(int iParam0, bool bParam1)//Position - 0x2766
{
	int iVar0;
...
void func_68(int iParam0, bool bParam1)//Position - 0x2787
{
	int iVar0;
...
void func_69(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x27F8
{
	func_70(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_70(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2818
{
	int iVar0;
...
int func_72(int iParam0)//Position - 0x2B0A
{
	int iVar0;
	int iVar1;
...
int func_75(int iParam0)//Position - 0x2C53
{
	if (func_77(iParam0))
	{
...
int func_76(int iParam0)//Position - 0x2C7A
{
	int iVar0;
...
int func_77(int iParam0)//Position - 0x2CAD
{
...
int func_78(int iParam0)//Position - 0x2CD7
{
	switch (iParam0)
	{
...
void func_79(int iParam0)//Position - 0x2D95
{
	if (iLocal_447 == 1)
	{
...
void func_80(int iParam0, int iParam1, bool bParam2)//Position - 0x2DB4
{
	if (iLocal_447 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
...
int func_81(int iParam0, bool bParam1, int iParam2)//Position - 0x2E07
{
	int iVar0;
...
int func_82(int iParam0, bool bParam1, bool bParam2)//Position - 0x2E51
{
	int iVar0;
...
float func_83(bool bParam0, float fParam1, float fParam2)//Position - 0x2EF5
{
	if (bParam0)
	{
		return fParam1;
...
float func_84(int iParam0, int iParam1, bool bParam2)//Position - 0x2F0C
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_85(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2F6A
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_86(vector3 vParam0, vector3 vParam3)//Position - 0x2FFB
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_87(vector3 vParam0)//Position - 0x301C
{
	float fVar0;
	float fVar1;
...
int func_88(int iParam0)//Position - 0x305B
{
	var uVar0;
...
void func_91()//Position - 0x30AF
{
	Global_19671 = 0;
	func_92();
}

void func_92()//Position - 0x30BF
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_93()//Position - 0x30E0
{
	return 0;
}

void func_94()//Position - 0x30E9
{
}

int func_95()//Position - 0x30F1
{
	return 1;
}

float func_96(int iParam0, int iParam1)//Position - 0x30FA
{
	return func_84(iParam0, iParam1, 1);
}

void func_97(int iParam0)//Position - 0x310B
{
	int iVar0;
...
int func_98(int iParam0)//Position - 0x313C
{
	int iVar0;
	int iVar1;
...
int func_99(int iParam0, bool bParam1)//Position - 0x316D
{
	if (!func_77(iParam0))
	{
		if (!bParam1)
...
void func_100(var uParam0, var uParam1)//Position - 0x3220
{
	*uParam0 = (*uParam0 || uParam1);
}

void func_101(int iParam0, bool bParam1)//Position - 0x3231
{
	if (iParam0 == 1)
	{
		TASK::TASK_PLAY_ANIM(iLocal_240, &cLocal_324, &Local_218, 2f, -2f, -1, 0, 0, 0, 0, 0);
...
int func_102(int iParam0)//Position - 0x32A3
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_103()//Position - 0x32C4
{
	func_104();
}

void func_104()//Position - 0x32D0
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_240, 0))
	{
		AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_240, "MAG_2_PAM_PED_GROUP", 0);
	}
}

void func_105()//Position - 0x3382
{
...
int func_109()//Position - 0x34AB
{
	return 1;
}

bool func_110(var uParam0)//Position - 0x34B4
{
	return func_111(Global_111560.f_20112, uParam0);
}

bool func_111(var uParam0, var uParam1)//Position - 0x34C9
{
	return (uParam0 && uParam1) != 0;
}

int func_112(int iParam0)//Position - 0x34D8
{
...
void func_113(int iParam0)//Position - 0x35FF
{
	var uVar0;
...
void func_114(int iParam0)//Position - 0x36CE
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
struct<6> func_115()//Position - 0x36EE
{
	struct<6> Var0;
...
void func_116()//Position - 0x3712
{
	func_117();
}

void func_117()//Position - 0x371E
{
	if (!Global_3)
	{
		return;
