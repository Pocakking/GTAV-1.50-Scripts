...
void func_11(var uParam0)//Position - 0x21C
{
	...
	switch (uParam0->f_57.f_4)
	{
		...
		case 5:
			...
			{
				uParam0->f_57.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_39(uParam0), func_38(uParam0), 2, 1, false, 1065353216, 0, 1065353216);
...
void func_75(int iParam0, var uParam1, int iParam2)//Position - 0x19CE
{
	vector3 vVar0;
	float fVar3;
	int iVar4;
...
Vector3 func_76(int iParam0)//Position - 0x1A89
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_77(int iParam0)//Position - 0x1AD7
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_78(vector3 vParam0, float fParam3)//Position - 0x1B19
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
Vector3 func_79(int iParam0)//Position - 0x1B5D
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_80()//Position - 0x1BA9
{
	return func_81() + Vector(0f, -8.946f, 47.215f);
}

Vector3 func_81()//Position - 0x1BC1
{
	return 345.0041f, 4842.001f, -59.9997f;
}

void func_82(int iParam0, var uParam1, var uParam2)//Position - 0x1BD8
{
	switch (iParam0)
	{
		case 0:
...
int func_83(int iParam0, int iParam1, bool bParam2)//Position - 0x1D76
{
	int iVar0;
