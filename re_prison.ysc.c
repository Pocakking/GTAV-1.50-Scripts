...
int func_7(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x992
{
...
int func_15(vector3 vParam0, int iParam3, int iParam4, bool bParam5)//Position - 0xB5E
{
	vector3 vVar0[15];
	vector3 vVar46[15];
	float fVar92[15];
...
void func_30()//Position - 0x257A
{
	...
	while (iVar0 < 3)
	{
		if (((ENTITY::DOES_ENTITY_EXIST(iLocal_408[iVar0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_408[iVar0], 0)) && ENTITY::DOES_ENTITY_EXIST(iLocal_404[iVar0])) && !ENTITY::IS_ENTITY_DEAD(iLocal_404[iVar0], 0))
		{
			...
			VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_404[iVar0], false, false, 0);
			if (iLocal_412[iVar0])
			{
				if (!func_28())
				{
					...
					{
						iLocal_412[iVar0] = 0;
						VEHICLE::SET_VEHICLE_SEARCHLIGHT(iLocal_404[iVar0], 0, 0);
					}
				}
			}
			else if (func_28())
			{
				...
				{
					iLocal_412[iVar0] = 1;
					VEHICLE::SET_VEHICLE_SEARCHLIGHT(iLocal_404[iVar0], 1, 0);
				}
			}
		}
		iVar0++;
...
void func_35()//Position - 0x2C90
{
	...
	if (!iLocal_102)
	{
		...
		while (iVar0 < 12)
		{
			iLocal_52[iVar0] = PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(vLocal_65[iVar0 /*3*/], 10f, 10f, 10f, 0f, 0, 7);
			iVar0++;
		}
		iLocal_102 = 1;
	}
...
bool func_41(int iParam0)//Position - 0x30B5
{
	return func_42(iParam0, 20);
}

bool func_42(int iParam0, int iParam1)//Position - 0x30C5
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_43()//Position - 0x30E0
{
	return -1;
}

void func_44()//Position - 0x30E9
{
	int iVar0;
...
var func_49()//Position - 0x3311
{
	func_50();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_50()//Position - 0x332A
{
	int iVar0;
...
bool func_51(int iParam0)//Position - 0x3427
{
	return iParam0 < 3;
}

int func_52(int iParam0)//Position - 0x3433
{
	int iVar0;
	int iVar1;
...
int func_53(int iParam0)//Position - 0x3470
{
	if (func_51(iParam0))
	{
...
var func_54(int iParam0)//Position - 0x3495
{
	return Global_1798[iParam0 /*29*/];
}

void func_55()//Position - 0x34A4
{
	int iVar0;
...
bool func_56(int iParam0, int iParam1)//Position - 0x34FB
{
	switch (iParam0)
	{
		case 5:
...
void func_58(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x358D
{
...
void func_59(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x35E3
{
...
void func_60(int iParam0, int iParam1)//Position - 0x367E
{
...
void func_61(var uParam0, int iParam1)//Position - 0x36A5
{
	func_62(uParam0, iParam1);
}

void func_62(var uParam0, var uParam1)//Position - 0x36B5
{
	*uParam0 = (*uParam0 || uParam1);
}

void func_63(var uParam0, int iParam1)//Position - 0x36C6
{
	func_64(uParam0, iParam1);
}

void func_64(var uParam0, var uParam1)//Position - 0x36D6
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

void func_65()//Position - 0x36EB
{
...
void func_66()//Position - 0x3705
{
	func_68();
	func_67();
}

void func_67()//Position - 0x3715
{
	int iVar0;
...
void func_69()//Position - 0x3995
{
	if (bLocal_574)
	{
		iLocal_569 = VEHICLE::CREATE_VEHICLE(joaat("polmav"), 10f, 10f, -30f, 0f, true, true, false);
		VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_569, true, true, 0);
...
void func_73()//Position - 0x4865
{
	...
	if (!CAM::IS_SPHERE_VISIBLE(1823.845f, 2621.267f, 57f, 0.5f))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_404[0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_404[0], 0))
		{
			...
			ENTITY::SET_ENTITY_COLLISION(iLocal_404[0], false, 0);
			ENTITY::SET_ENTITY_VISIBLE(iLocal_404[0], false, 0);
	...
	if (!CAM::IS_SPHERE_VISIBLE(1761.418f, 2410.378f, 61f, 0.5f))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_404[1]) && !ENTITY::IS_ENTITY_DEAD(iLocal_404[1], 0))
		{
			...
			ENTITY::SET_ENTITY_COLLISION(iLocal_404[1], false, 0);
			ENTITY::SET_ENTITY_VISIBLE(iLocal_404[1], false, 0);
	...
	if (!CAM::IS_SPHERE_VISIBLE(1534.635f, 2585.162f, 61f, 0.5f))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_404[2]) && !ENTITY::IS_ENTITY_DEAD(iLocal_404[2], 0))
		{
			...
			ENTITY::SET_ENTITY_COLLISION(iLocal_404[2], false, 0);
			ENTITY::SET_ENTITY_VISIBLE(iLocal_404[2], false, 0);
...
void func_89(bool bParam0)//Position - 0x5374
{
	int iVar0;
...
void func_96(int iParam0, var uParam1)//Position - 0x56ED
{
