...
char* func_14(int iParam0)//Position - 0x111F
{
	switch (iParam0)
	{
		case 0:
...
void func_16(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x121A
{
	int iVar0;
...
int func_17(var uParam0)//Position - 0x124A
{
	int iVar0;
	int iVar1;
...
int func_18()//Position - 0x127E
{
	return Global_1312745;
}

int func_19(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x128A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_20(int iParam0)//Position - 0x18DC
{
	func_43(93, iParam0);
	func_43(29, iParam0);
	func_43(30, iParam0);
...
bool func_21(int iParam0)//Position - 0x18FC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_22(int iParam0, int iParam1, int iParam2)//Position - 0x1AAC
{
	int iVar0;
	var uVar1;
...
int func_23(int iParam0, int iParam1, int iParam2)//Position - 0x1ADE
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_24(int iParam0)//Position - 0x1B1B
{
	int iVar0;
...
int func_25(int iParam0, int iParam1)//Position - 0x1EB7
{
	int iVar0;
...
int func_26(bool bParam0)//Position - 0x2230
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_27(int iParam0, int iParam1)//Position - 0x22E7
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_28(int iParam0, int iParam1)//Position - 0x2302
{
...
int func_29(var uParam0, int iParam1)//Position - 0x239F
{
	int iVar0;
	var uVar1[78];
...
int func_30(var uParam0, int iParam1)//Position - 0x2450
{
	int iVar0;
...
bool func_31(var uParam0, int iParam1)//Position - 0x24CB
{
	return (*uParam0)[iParam1] == 78;
}

void func_32(var uParam0)//Position - 0x24DC
{
	int iVar0;
...
void func_33(var uParam0, int iParam1)//Position - 0x2510
{
	(*uParam0)[iParam1] = 78;
}

void func_34(var uParam0, float fParam1)//Position - 0x2520
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_35(var uParam0)//Position - 0x253D
{
	return uParam0->f_80;
}

bool func_36(var uParam0, int iParam1)//Position - 0x2549
{
	return func_37(uParam0, iParam1) != -1;
}

int func_37(var uParam0, int iParam1)//Position - 0x255B
{
	int iVar0;
...
bool func_38(var uParam0)//Position - 0x2588
{
	return uParam0->f_79 == 1;
}

int func_39(int iParam0)//Position - 0x2596
{
	switch (iParam0)
	{
		case 60:
...
bool func_40(int iParam0)//Position - 0x25E6
{
	return Global_41396 == iParam0;
}

int func_41(int iParam0, int iParam1)//Position - 0x25F4
{
	int iVar0;
...
void func_42(int iParam0, int iParam1)//Position - 0x2645
{
	int iVar0;
...
void func_43(int iParam0, int iParam1)//Position - 0x2668
{
	int iVar0;
...
int func_45(int iParam0)//Position - 0x273A
{
	return Global_1798[iParam0 /*29*/].f_17;
}

void func_46(int iParam0, int iParam1)//Position - 0x274B
{
	bool bVar0;
...
Vector3 func_49(int iParam0)//Position - 0x356D
{
	vector3 vVar0;
	int iVar3;
	int iVar4;
...
void func_50(int iParam0, char* sParam1, int iParam2)//Position - 0x3648
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_51(iParam2), 1);
}

int func_51(int iParam0)//Position - 0x365F
{
	int iVar0;
...
int func_52(int iParam0, bool bParam1)//Position - 0x3854
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_54(char* sParam0)//Position - 0x3951
{
	func_55(sParam0);
}

void func_55(char* sParam0)//Position - 0x395F
{
...
int func_56(int iParam0)//Position - 0x3972
{
	var uVar0;
...
int func_57()//Position - 0x39CA
{
	func_58();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_58()//Position - 0x39E3
{
	int iVar0;
...
bool func_59(int iParam0)//Position - 0x3AE0
{
	return iParam0 < 3;
}

int func_60(int iParam0)//Position - 0x3AEC
{
	int iVar0;
	int iVar1;
...
int func_61(int iParam0)//Position - 0x3B29
{
	if (func_59(iParam0))
	{
...
var func_62(int iParam0)//Position - 0x3B4E
{
	return Global_1798[iParam0 /*29*/];
}

int func_63()//Position - 0x3B5D
{
...
int func_64(int iParam0)//Position - 0x3B76
{
	return Global_111560.f_24899[iParam0 /*4*/];
}

void func_65()//Position - 0x3B89
{
	if (func_227())
	{
		func_225();
		...
		switch (iLocal_938)
		{
			case 0:
				if (!PED::IS_PED_INJURED(Global_110592) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_110591, 0))
				{
					if (PED::IS_PED_SITTING_IN_VEHICLE(Global_110592, Global_110591))
					{
						if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_941, "leanover_enter", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_941, "leanover_idle", 3))
						{
	...
	if (!func_220())
	{
		if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_114))
		{
			if (iLocal_938 != 0)
			{
				...
				func_75(1);
				func_74(1);
				func_67(&iLocal_114, &Local_803, &uLocal_115, func_73(&uLocal_115));
			}
		}
		else
		{
...
void func_67(int iParam0, var uParam1, var uParam2, int iParam3)//Position - 0x3EF9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_69(int iParam0, var uParam1)//Position - 0x4297
{
	GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(iParam0, uParam1->f_4, uParam1->f_5, uParam1->f_6, uParam1->f_7, 0);
}

void func_70(char* sParam0)//Position - 0x42B6
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}

void func_71(char* sParam0)//Position - 0x42C8
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
}

void func_72(var uParam0)//Position - 0x42D6
{
	uParam0->f_679 = 0;
}

int func_73(var uParam0)//Position - 0x42E4
{
	return uParam0->f_679;
}

void func_74(int iParam0)//Position - 0x42F1
{
	Global_1315712 = iParam0;
}

void func_75(int iParam0)//Position - 0x42FF
{
	Global_1375006.f_1100 = iParam0;
}

int func_76()//Position - 0x4310
{
	if (iLocal_938 != 2)
	{
		return 0;
...
void func_77(int iParam0, int iParam1, char* sParam2, var uParam3, bool bParam4, int iParam5)//Position - 0x4352
{
	int iVar0;
...
void func_78(var uParam0)//Position - 0x43CF
{
	func_79(uParam0);
	uParam0->f_679 = 1;
}

void func_79(var uParam0)//Position - 0x43E3
{
	int iVar0;
...
struct<9> func_80()//Position - 0x44B7
{
	struct<9> Var0;
	...
	switch (iLocal_940)
	{
		...
		case 3:
			if (Global_76593 == -1)
			{
				...
				iLocal_812 = func_110(vLocal_43.x);
				if (iLocal_812 != -1)
				{
		...
		case 6:
			...
			if (iLocal_812 != -1)
			{
				...
				if (bVar1)
				{
					if (((func_57() == 0 && !MISC::IS_BIT_SET(Global_89487[iLocal_812 /*34*/].f_15, 8)) || (func_57() == 1 && !MISC::IS_BIT_SET(Global_89487[iLocal_812 /*34*/].f_15, 9))) || (func_57() == 2 && !MISC::IS_BIT_SET(Global_89487[iLocal_812 /*34*/].f_15, 10)))
					{
						bVar1 = false;
					}
				}
				...
				if (bVar1)
				{
					CLOCK::ADVANCE_CLOCK_TIME_TO(Global_89487[iLocal_812 /*34*/].f_13, 0, 0);
				}
			}
...
bool func_82()//Position - 0x4B6E
{
	return MISC::IS_BIT_SET(Global_98669.f_20, 13);
}

void func_83()//Position - 0x4B82
{
	vector3 vVar0;
	float fVar3;
	...
	switch (iLocal_813)
	{
		case 92:
			vVar0 = { func_85(229, 0) };
			fVar3 = MISC::GET_DISTANCE_BETWEEN_COORDS(Global_110598, vVar0, true);
			if (fVar3 < 100f)
			{
				vVar0 = { func_84(Global_110598 - vVar0) };
				vVar0 = { (Global_110598 + (vVar0.x * IntToFloat((100 - SYSTEM::ROUND(fVar3))))), (Global_110598.f_1 + (vVar0.y * IntToFloat((100 - SYSTEM::ROUND(fVar3))))), Global_110598.f_2 };
...
Vector3 func_84(vector3 vParam0)//Position - 0x4C3D
{
	float fVar0;
	float fVar1;
...
Vector3 func_85(int iParam0, int iParam1)//Position - 0x4C7C
{
	int iVar0;
...
bool func_86()//Position - 0x4CBA
{
	return !Global_75396.f_553;
}

int func_87(vector3 vParam0)//Position - 0x4CCA
{
	int iVar0;
...
void func_88(int iParam0)//Position - 0x4D18
{
	iParam0->f_1 = 0f;
	iParam0->f_2 = 0f;
	*iParam0 = 0;
...
float func_89(int iParam0)//Position - 0x4D2E
{
	if (func_94(iParam0))
	{
		if (func_91(iParam0))
...
float func_90(bool bParam0)//Position - 0x4D6D
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_91(var uParam0)//Position - 0x4DC5
{
	return MISC::IS_BIT_SET(*uParam0, 2);
}

void func_92(int iParam0, float fParam1)//Position - 0x4DD5
{
	if (!func_94(iParam0))
	{
...
void func_93(int iParam0, float fParam1)//Position - 0x4DEF
{
...
bool func_94(var uParam0)//Position - 0x4E1D
{
	return MISC::IS_BIT_SET(*uParam0, 1);
}

int func_95(vector3 vParam0)//Position - 0x4E2D
{
	int iVar0;
	int iVar1;
	float fVar2;
...
bool func_96(int iParam0, int iParam1)//Position - 0x4EE8
{
	bool bVar0;
...
int func_97(int iParam0)//Position - 0x4F35
{
	if (iParam0 != -1)
	{
...
int func_98(int iParam0, bool bParam1)//Position - 0x4F56
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_99(int iParam0, var uParam1)//Position - 0x500D
{
	switch (iParam0)
	{
		case 0:
...
int func_101(int iParam0)//Position - 0x6253
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_102(int iParam0)//Position - 0x6599
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_103(int iParam0)//Position - 0x65D0
{
	struct<2> Var0;
...
bool func_105(int iParam0, int iParam1)//Position - 0x6A62
{
	return func_106(CLOCK::GET_CLOCK_HOURS(), iParam0, iParam1);
}

int func_106(int iParam0, int iParam1, int iParam2)//Position - 0x6A76
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_107()//Position - 0x6B1F
{
	Global_75396.f_553 = 1;
	Global_75396.f_554 = 0;
}

void func_108(int iParam0)//Position - 0x6B37
{
	if (func_109(iParam0))
	{
...
int func_109(int iParam0)//Position - 0x6B56
{
	switch (iParam0)
	{
		case 67:
...
int func_110(int iParam0)//Position - 0x6BB5
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0x6C0F
{
	if (Global_95621 != -1)
	{
...
void func_112(int iParam0, bool bParam1)//Position - 0x6C33
{
	if (bParam1)
	{
...
void func_113(float fParam0)//Position - 0x6C71
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	while (!bVar1 && iVar2 < 10)
	{
		...
		{
			bVar1 = false;
			if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(Global_110598, iVar2, &vVar3, 1, 1077936128, 0))
			{
				iVar2++;
			}
		}
...
int func_114(int iParam0, vector3 vParam1, float fParam4)//Position - 0x6D59
{
	int iVar0[5];
	int iVar6;
...
int func_115()//Position - 0x6DCE
{
	return Global_76839;
}

int func_116(int iParam0)//Position - 0x6DDA
{
	int iVar0;
...
void func_119(float fParam0)//Position - 0x6F55
{
	int iVar0;
	int iVar1;
...
void func_120(int iParam0, float fParam1)//Position - 0x6FE6
{
	if (func_94(iParam0))
	{
...
float func_121(vector3 vParam0, vector3 vParam3)//Position - 0x7009
{
	return (SYSTEM::VMAG(vParam3 - vParam0) * 1.3f);
}

void func_122()//Position - 0x7024
{
	float fVar0;
	int iVar1;
	
	fVar0 = (((func_121(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), Global_110598) / 50f) * fLocal_75) * 2.4f);
...
void func_123()//Position - 0x708C
{
	...
	if (iLocal_103 != iLocal_104)
	{
		...
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		fLocal_85 = SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), Global_110598);
		iLocal_104 = iLocal_103;
	}
}

void func_124()//Position - 0x712A
{
	int iVar0;
	float fVar1;
...
int func_126(int iParam0, var uParam1, float fParam2)//Position - 0x71C0
{
	vector3 vVar0;
	...
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
		switch (iLocal_937)
		{
			case 0:
				...
				{
					if (func_144(vLocal_949, uParam1, fParam2))
					{
						vVar0 = { vLocal_949 - *uParam1 };
						vVar0.z = 0f;
						fLocal_74 = SYSTEM::VMAG(vVar0);
			...
			case 1:
				if (func_133(vLocal_949, uParam1, fParam2, 1))
				{
					vVar0 = { vLocal_949 - *uParam1 };
					vVar0.z = 0f;
					fLocal_74 = SYSTEM::VMAG(vVar0);
			...
			case 2:
				...
				{
					if (func_127(&Global_110591, ENTITY::GET_ENTITY_COORDS(Global_110591, false), vLocal_949, uParam1, fParam2, &iLocal_90, 1000))
					{
						iLocal_937 = 3;
						return 1;
					}
...
int func_127(var uParam0, vector3 vParam1, vector3 vParam4, var uParam7, float fParam8, int iParam9, int iParam10)//Position - 0x737B
{
	float fVar0;
	float fVar1;
	vector3 vVar2;
	...
	iVar24 = *iParam9 + 2;
	iVar25 = 50;
	func_130(vParam1, vParam4, &vLocal_952, &vLocal_955, iParam10);
	if (func_129(vLocal_952, vLocal_955))
	{
			...
			if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(vParam4, *iParam9, uParam7, fParam8, &iVar12, iVar20, fVar0, fVar1))
			{
				...
				if (PATHFIND::IS_VEHICLE_NODE_ID_VALID(iVar18))
				{
					if (PATHFIND::GET_CLOSEST_ROAD(*uParam7, 1f, 1, &uVar8, &uVar5, &iVar14, &iVar13, &fVar16, iVar21))
					{
						...
						if (func_128(vParam4, *uParam7) || fVar17 < 0.5f)
						{
...
int func_128(vector3 vParam0, vector3 vParam3)//Position - 0x76C8
{
	float fVar0;
	float fVar1;
...
int func_129(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)//Position - 0x772A
{
...
void func_130(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, var uParam6, var uParam7, int iParam8)//Position - 0x774A
{
	vector3 vVar0;
	vector3 vVar3;
	...
	if (!func_131(vVar0, *uParam6, 1056964608, 0) || !func_131(vVar0, *uParam6, 1056964608, 0))
	{
		*uParam6 = { vVar0 };
		*uParam7 = { vVar3 };
	}
...
int func_131(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x7815
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_132(vector3 vParam0)//Position - 0x7890
{
	char* sVar0;
...
int func_133(vector3 vParam0, var uParam3, float fParam4, int iParam5)//Position - 0x7B84
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4[6];
	...
	fVar30 = 232.0109f;
	fVar31 = func_135(vParam0, vVar27);
	vVar32 = { 2450.604f, 5129.224f, 45.9722f };
	fVar35 = 241.1957f;
	fVar36 = func_135(vParam0, vVar32);
	vVar1 = { vParam0 };
	bVar37 = false;
	if (vParam0.z == 1f)
	{
...
bool func_134(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x9CA7
{
	return SYSTEM::VDIST2(vParam0, vParam3) <= (fParam6 * fParam6);
}

float func_135(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)//Position - 0x9CC1
{
	return SYSTEM::VDIST2(Param0, Param0.f_1, 0f, Param3, Param3.f_1, 0f);
}

int func_136()//Position - 0x9CDB
{
	int iVar0;
...
int func_137(int iParam0)//Position - 0x9D3A
{
...
bool func_138(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x9D67
{
	vector3 vVar0;
...
int func_139(vector3 vParam0, int iParam3, int iParam4, bool bParam5)//Position - 0x9D91
{
	vector3 vVar0[15];
	vector3 vVar46[15];
	float fVar92[15];
...
bool func_140(int iParam0, vector3 vParam1)//Position - 0xAAE5
{
	return SYSTEM::VDIST2(vParam1, func_142(iParam0)) < func_141(iParam0);
}

float func_141(int iParam0)//Position - 0xAB02
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_142(int iParam0)//Position - 0xAB9A
{
	switch (iParam0)
	{
		case 1:
...
int func_143(vector3 vParam0, vector3 vParam3, vector3 vParam6)//Position - 0xAC84
{
...
int func_144(vector3 vParam0, var uParam3, float fParam4)//Position - 0xACDB
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	fVar1 = 1E+08f;
	fVar2 = 1E+08f;
	func_156(&vParam0, &iLocal_813, &fVar0);
	func_154(&vParam0, &iLocal_108, &fVar1);
	func_151(&vParam0, &iLocal_814, &fVar2);
	if (fVar0 < fVar1 && fVar0 < fVar2)
	{
		if (func_150(iLocal_813, vParam0))
		{
			if (func_149(iLocal_813, uParam3, fParam4))
			{
				return 1;
			}
		}
	...
	{
		if (func_148(iLocal_108, vParam0))
		{
	...
	{
		if (func_146(iLocal_814, vParam0))
		{
			if (func_145(iLocal_814, uParam3, fParam4))
			{
				return 1;
			}
		}
...
int func_145(int iParam0, var uParam1, var uParam2)//Position - 0xADC1
{
	switch (iParam0)
	{
		case 76:
...
int func_146(int iParam0, vector3 vParam1)//Position - 0xB0F7
{
	switch (iParam0)
	{
		case 76:
...
int func_147(int iParam0, var uParam1, var uParam2)//Position - 0xB71B
{
	int iVar0;
...
int func_148(int iParam0, vector3 vParam1)//Position - 0xBBED
{
	switch (iParam0)
	{
		case 9:
...
int func_149(int iParam0, var uParam1, var uParam2)//Position - 0xC2FC
{
	int iVar0;
...
int func_150(int iParam0, vector3 vParam1)//Position - 0xC6A1
{
	switch (iParam0)
	{
		case 3:
...
int func_151(var uParam0, int iParam1, float fParam2)//Position - 0xCAF9
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_152(int iParam0)//Position - 0xCC12
{
	int iVar0;
...
int func_153(var uParam0)//Position - 0xCC4E
{
...
int func_154(var uParam0, int iParam1, float fParam2)//Position - 0xCD54
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_156(var uParam0, int iParam1, float fParam2)//Position - 0xCEAA
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar6 < 8)
	{
		if (Global_95632[iVar6 /*17*/])
		{
			...
			{
				if (HUD::DOES_BLIP_EXIST(Global_31111[Global_95632[iVar6 /*17*/].f_9 /*23*/].f_19))
				{
					vVar3 = { HUD::GET_BLIP_COORDS(Global_31111[Global_95632[iVar6 /*17*/].f_9 /*23*/].f_19) };
					if (uParam0->f_2 == 1f)
					{
						vVar3.z = 1f;
					}
...
void func_158(int iParam0)//Position - 0xCF99
{
	int iVar0;
	var uVar1;
	int iVar2;
...
int func_159(var uParam0)//Position - 0xD0C1
{
...
bool func_160(int iParam0, int iParam1)//Position - 0xD112
{
	return (MISC::GET_GAME_TIMER() - iParam0) > iParam1;
}

void func_161(bool bParam0)//Position - 0xD124
{
	if (bParam0)
	{
		func_168();
...
void func_162(int iParam0)//Position - 0xD187
{
	if (func_166())
	{
		return;
...
void func_164(bool bParam0, bool bParam1)//Position - 0xD238
{
	if (bParam0)
	{
		if (func_167(0))
...
bool func_165()//Position - 0xD2AC
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

bool func_166()//Position - 0xD2BD
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

int func_167(int iParam0)//Position - 0xD2CF
{
	if (iParam0 == 1)
	{
	...
	if (!PED::IS_PED_INJURED(Global_110592) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_110591, 0))
	{
		if (PED::IS_PED_SITTING_IN_VEHICLE(Global_110592, Global_110591))
		{
			...
			else if (!func_2(Global_110592, -272084098))
			{
				...
				fVar3 = ENTITY::GET_ENTITY_HEADING(Global_110591);
				TASK::TASK_VEHICLE_PARK(Global_110592, Global_110591, vVar0, fVar3, 3, 60f, 0);
			}
		}
	}
}

void func_170()//Position - 0xD431
{
	int iVar0;
	float fVar1;
		...
		if (bLocal_63)
		{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_110591, 0))
			{
				if (!PED::IS_PED_INJURED(Global_110592))
				{
					...
					else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_941, "leanover_enter", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_941, "leanover_idle", 3))
					{
						if (PED::IS_PED_HEADTRACKING_PED(Global_110592, PLAYER::PLAYER_PED_ID()))
						{
							TASK::TASK_CLEAR_LOOK_AT(Global_110592);
						}
						TASK::TASK_PLAY_ANIM(Global_110592, &cLocal_941, "leanover_exit", 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
					else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_941, "leanover_exit", 3))
					{
						ENTITY::SET_ENTITY_ANIM_SPEED(Global_110592, &cLocal_941, "leanover_exit", 1.2f);
					...
					else if (!func_2(Global_110592, 242628503))
					{
						...
						else
						{
							...
							TASK::OPEN_SEQUENCE_TASK(&iLocal_802);
							TASK::TASK_VEHICLE_DRIVE_TO_COORD_LONGRANGE(0, Global_110591, Global_110598, fVar1, iVar0, 45f);
							TASK::TASK_VEHICLE_PARK(0, Global_110591, Global_110598, Global_110604, iLocal_112, 60f, 1);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_802);
							TASK::TASK_PERFORM_SEQUENCE(Global_110592, iLocal_802);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_802);
						}
					}
				}
			}
...
int func_171(int iParam0, int iParam1)//Position - 0xD629
{
	int iVar0;
	var uVar1;
	int iVar2;
...
int func_172()//Position - 0xD7AE
{
	if ((ENTITY::IS_ENTITY_AT_COORD(Global_110591, Global_110598, 45f, 45f, 20f, false, true, 0) || iLocal_58) || iLocal_938 == 4)
	{
		iLocal_58 = 1;
...
void func_174(var uParam0, int iParam1)//Position - 0xD85D
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(Global_110592) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_110591, 0))
	{
		if (PED::IS_PED_SITTING_IN_VEHICLE(Global_110592, Global_110591))
		{
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_941))
			{
				...
				TASK::OPEN_SEQUENCE_TASK(&iLocal_802);
				TASK::TASK_PLAY_ANIM(0, &cLocal_941, "leanover_enter", 4f, -8f, -1, 0, 0, 0, 0, 0);
				TASK::TASK_PLAY_ANIM(0, &cLocal_941, "leanover_idle", 4f, -8f, -1, 1, 0, 0, 0, 0);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_802);
				TASK::TASK_PERFORM_SEQUENCE(Global_110592, iLocal_802);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_802);
				return 1;
...
int func_176()//Position - 0xDA43
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_110591))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_110591, 0))
		{
			iLocal_111 = OBJECT::CREATE_OBJECT(iLocal_110, ENTITY::GET_ENTITY_COORDS(Global_110591, true), true, true, false);
			ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_111, Global_110591, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(Global_110591, "Chassis"), vLocal_973, vLocal_976, 0, 0, 0, 0, 2, 1);
...
void func_178()//Position - 0xDB36
{
	...
	if (!CAM::DOES_CAM_EXIST(iLocal_70))
	{
		if (!func_186() && !func_185(8, -1))
		{
			...
			CAM::ATTACH_CAM_TO_ENTITY(iLocal_70, Global_110591, vLocal_967, 1);
			func_182();
...
void func_181(int iParam0, bool bParam1, int iParam2)//Position - 0xDCE0
{
	switch (iParam0)
	{
		case 5:
...
void func_182()//Position - 0xDD2F
{
	if (CAM::DOES_CAM_EXIST(iLocal_70))
	{
		func_183(Global_110591, &iLocal_70, vLocal_970);
...
void func_183(int iParam0, int iParam1, vector3 vParam2)//Position - 0xDD6E
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
		if (CAM::DOES_CAM_EXIST(*iParam1))
		{
			...
			fVar5 = vVar0.y;
			vVar6 = { func_84(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_110591, vParam2) - ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_110591, vLocal_967)) };
			func_184(vVar6, &fVar3, &fVar4, 1);
			CAM::SET_CAM_ROT(*iParam1, fVar3, fVar5, fVar4, 2);
		}
	}
}

void func_184(vector3 vParam0, var uParam3, var uParam4, int iParam5)//Position - 0xDDD9
{
	float fVar0;
...
bool func_185(int iParam0, int iParam1)//Position - 0xDE7E
{
	switch (iParam0)
	{
		case 5:
...
bool func_186()//Position - 0xDEB9
{
	return Global_22209;
}

void func_187()//Position - 0xDEC4
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar0 < iLocal_93)
	{
		...
		else if (func_192(vLocal_816[iVar0 /*3*/]) == -1)
		{
		}
		else if (func_131(HUD::GET_BLIP_COORDS(vLocal_816[iVar0 /*3*/]), 0f, 0f, 0f, 1056964608, 0))
		{
		}
		else
		{
			...
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar0);
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(HUD::GET_BLIP_SPRITE(vLocal_816[iVar0 /*3*/]));
			HUD::GET_HUD_COLOUR(HUD::GET_BLIP_HUD_COLOUR(vLocal_816[iVar0 /*3*/]), &iVar1, &iVar2, &iVar3, &uVar4);
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar1);
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar2);
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar3);
			iVar8 = func_190(vLocal_816[iVar0 /*3*/]);
			if (iVar8 == -1)
			{
...
char* func_188(int iParam0)//Position - 0xE132
{
	switch (iParam0)
	{
		case 0:
...
char* func_189(int iParam0, int iParam1)//Position - 0xE4D7
{
	switch (iParam0)
	{
		case -1:
...
int func_190(int iParam0)//Position - 0xE8D8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_191(int iParam0)//Position - 0xE913
{
	switch (iParam0)
	{
		case -1:
...
int func_192(int iParam0)//Position - 0xEC1D
{
	int iVar0;
		...
		if (iLocal_96 == 0)
		{
			if (HUD::DOES_BLIP_EXIST(Global_110595))
			{
				...
				while (iVar0 < 40)
				{
					if (HUD::DOES_BLIP_EXIST(vLocal_816[iVar0 /*3*/]))
					{
						if (vLocal_816[iVar0 /*3*/] == Global_110595)
						{
							iLocal_94 = iVar0;
							iVar0 = 40;
						}
	...
	if (MISC::GET_MISSION_FLAG())
	{
		if (!Global_110597 == -1)
		{
			...
			while (iVar0 < 40)
			{
				if (HUD::DOES_BLIP_EXIST(vLocal_816[iVar0 /*3*/]))
				{
					if (func_192(vLocal_816[iVar0 /*3*/]) == Global_110597)
					{
						iLocal_94 = iVar0;
						iVar0 = 40;
					}
...
int func_195(int iParam0)//Position - 0xF16E
{
...
int func_196(int iParam0)//Position - 0xF1B4
{
	int iVar0;
...
void func_197(int iParam0, bool bParam1)//Position - 0xF1E4
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
...
void func_198(vector3 vParam0, bool bParam3)//Position - 0xF63A
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 40)
	{
		if (func_192(vLocal_816[iVar0 /*3*/]) == func_192(vParam0.x))
		{
			iVar1 = iVar0;
			iVar0 = 40;
		}
	...
	while (iVar0 < 40)
	{
		...
		if (iVar0 < iLocal_93)
		{
			if (func_192(vLocal_816[iVar0 /*3*/]) == func_192(vParam0.x))
			{
				if (func_202(vParam0, vLocal_816[iVar0 /*3*/]))
				{
					if (bParam3)
					{
...
void func_199(vector3 vParam0, int iParam3)//Position - 0xF759
{
	func_200(iParam3);
	vLocal_816[iParam3 /*3*/] = { vParam0 };
	if (func_192(vLocal_816[iParam3 /*3*/]) == HUD::_GET_WAYPOINT_BLIP_SPRITE())
	{
		iLocal_99 = iParam3;
...
void func_200(int iParam0)//Position - 0xF79A
{
	int iVar0;
	vector3 vVar1;
...
void func_201(vector3 vParam0, int iParam3)//Position - 0xF7DF
{
	vLocal_816[iParam3 /*3*/] = { vParam0 };
	if (func_192(vLocal_816[iParam3 /*3*/]) == HUD::_GET_WAYPOINT_BLIP_SPRITE())
	{
...
int func_202(int iParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5)//Position - 0xF81A
{
...
float func_203(int iParam0)//Position - 0xF837
{
	vector3 vVar0;
...
void func_204(int iParam0, var uParam1)//Position - 0xF87A
{
	vector3 vVar0;
...
int func_205(int iParam0)//Position - 0xF8C4
{
	int iVar0;
...
int func_206(int iParam0)//Position - 0xF932
{
	int iVar0;
...
int func_207(int iParam0)//Position - 0xF9A5
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
		return 1;
...
bool func_208(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0xFA00
{
	if (bParam6)
	{
...
int func_209(int iParam0)//Position - 0xFA47
{
	float fVar0;
	
	if (!func_192(iParam0) == iLocal_46)
	{
	...
	if (SYSTEM::TIMERB() > 250)
	{
		...
		if (!bVar0)
		{
			if (iLocal_99 != -1)
			{
				...
				{
					if (func_192(vLocal_816[iLocal_99 /*3*/]) == HUD::_GET_WAYPOINT_BLIP_SPRITE())
					{
						vVar1 = { HUD::GET_BLIP_COORDS(vLocal_816[iLocal_99 /*3*/]) };
						if (!func_131(vVar1, vLocal_964, 1056964608, 0))
						{
							bVar0 = true;
						}
					}
				...
				{
					iVar4 = HUD::GET_FIRST_BLIP_INFO_ID(HUD::_GET_WAYPOINT_BLIP_SPRITE());
			...
			if (iLocal_938 == 2)
			{
				...
				if (!bLocal_66)
				{
					if (PAD::IS_CONTROL_JUST_PRESSED(2, 179))
					{
						...
						if (!PED::IS_PED_INJURED(Global_110592))
						{
							if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_941, "leanover_enter", 3))
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_941, "leanover_idle", 3))
								{
									if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_941, "leanover_exit", 3))
									{
										TASK::CLEAR_PED_TASKS(Global_110592);
									}
								}
...
int func_217(vector3 vParam0)//Position - 0x10042
{
...
void func_218()//Position - 0x1006C
{
	vector3 vVar0;
...
void func_219(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)//Position - 0x100D1
{
...
bool func_221()//Position - 0x10220
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

bool func_222()//Position - 0x10235
{
	return Global_73784;
}

void func_223()//Position - 0x10241
{
	if (!Global_110596 == 0)
	{
...
void func_224()//Position - 0x10264
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_225()//Position - 0x102B5
{
...
void func_226()//Position - 0x10322
{
	MISC::SET_BIT(&Global_7357, 4);
}

int func_227()//Position - 0x10332
{
	int iVar0;
...
int func_228(int iParam0)//Position - 0x10441
{
...
int func_229(int iParam0)//Position - 0x1045C
{
	vector3 vVar0;
	float fVar3;
	vector3 vVar4;
...
int func_231()//Position - 0x105FD
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (func_235(&iVar0, func_237(), func_236()))
		{
			...
			{
				vLocal_958 = { ENTITY::GET_ENTITY_COORDS(Global_110591, true) - ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
				vLocal_958.z = 0f;
...
void func_232()//Position - 0x106E1
{
	int iVar0;
...
int func_233(int iParam0, int iParam1, bool bParam2)//Position - 0x10783
{
...
void func_234()//Position - 0x108C7
{
	int iVar0;
...
int func_235(int iParam0, int iParam1, int iParam2)//Position - 0x10B05
{
	int iVar0;
	int iVar1;
...
int func_236()//Position - 0x10B99
{
	return joaat("a_m_y_stlat_01");
}

int func_237()//Position - 0x10BA6
{
	return joaat("taxi");
}

void func_238(bool bParam0)//Position - 0x10BB3
{
	...
	if (func_239(Global_110592))
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_941, "leanover_enter", 3))
		{
			ENTITY::STOP_ENTITY_ANIM(Global_110592, "leanover_enter", &cLocal_941, -2f);
		}
		else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_941, "leanover_idle", 3))
		{
			ENTITY::STOP_ENTITY_ANIM(Global_110592, "leanover_idle", &cLocal_941, -2f);
		}
		else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_110592, &cLocal_941, "leanover_exit", 3))
		{
			ENTITY::STOP_ENTITY_ANIM(Global_110592, "leanover_exit", &cLocal_941, -2f);
		}
		if (PED::IS_PED_HEADTRACKING_PED(Global_110592, PLAYER::PLAYER_PED_ID()))
		{
			TASK::TASK_CLEAR_LOOK_AT(Global_110592);
...
int func_239(int iParam0)//Position - 0x10E11
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
