...
void func_20()//Position - 0x54F
{
	...
	while (iVar0 < iLocal_72)
	{
		if (iLocal_77[iVar0] != 0)
		{
			iLocal_72[iVar0] = PED::CREATE_PED(26, iLocal_77[iVar0], vLocal_82 + vLocal_86[iVar0 /*3*/], 0f, 1, true);
			ENTITY::SET_ENTITY_ROTATION(iLocal_72[iVar0], Vector(uLocal_85, 0f, 0f) + vLocal_99[iVar0 /*3*/], 2, 1);
			...
			TASK::TASK_PLAY_ANIM_ADVANCED(iLocal_72[iVar0], &cLocal_117, &(Local_125[iVar0 /*8*/]), vLocal_82 + vLocal_86[iVar0 /*3*/], Vector(uLocal_85, 0f, 0f) + vLocal_99[iVar0 /*3*/], 1000f, -8f, -1, iLocal_158, 0, 2, 0);
			PED::_0x2208438012482A1A(iLocal_72[iVar0], 0, 0);
	...
	while (iVar0 < iLocal_159)
	{
		if (iLocal_166[iVar0] > 0)
		{
			...
			fVar14 = 1f;
			fVar15 = -1f;
			iLocal_159[iVar0] = GRAPHICS::ADD_DECAL(iLocal_166[iVar0], vLocal_82 + vLocal_173[iVar0 /*3*/], vVar3, vVar6, fVar9, fVar10, fVar11, fVar12, fVar13, fVar14, fVar15, 0, 0, 0);
			SYSTEM::WAIT(0);
		}
		iVar0++;
	}
...
Vector3 func_21(vector3 vParam0)//Position - 0x8D7
{
	float fVar0;
	float fVar1;
...
void func_22()//Position - 0x916
{
	...
	func_26(iLocal_70, &vLocal_82, &uLocal_85, &cVar0);
	Var8.f_1 = -1;
	Var8.f_17 = 4;
	Var8.f_17.f_8 = 4;
	Var8.f_17.f_13 = 4;
...
void func_24(var uParam0, int iParam1, int iParam2, int iParam3, vector3 vParam4, float fParam7)//Position - 0x408A
{
...
bool func_28(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x4380
{
	if (bParam6)
	{
...
int func_29(int iParam0, var uParam1, char* sParam2)//Position - 0x43C7
{
	vector3 vVar0;
	int iVar3;
	var uVar4;
...
int func_30(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0x6897
{
	switch (iParam1)
	{
		case 0:
...
int func_32(int iParam0, var uParam1, var uParam2)//Position - 0x880A
{
	switch (iParam0)
	{
		case 11:
...
char* func_33(int iParam0)//Position - 0x9179
{
	switch (iParam0)
	{
		case 2014101067:
