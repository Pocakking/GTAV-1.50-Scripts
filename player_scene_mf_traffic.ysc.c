...
var func_28(int iParam0)//Position - 0x99B
{
	return Global_1798[iParam0 /*29*/];
}

void func_29()//Position - 0x9AA
{
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
...
void func_30()//Position - 0x9EA
{
	func_31((Global_98392 - 1));
}

void func_31(int iParam0)//Position - 0x9FC
{
	Global_98392 = iParam0;
}

void func_32()//Position - 0xA0A
{
	func_31(0);
}

void func_33()//Position - 0xA17
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < 12)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_77[iVar0]))
			{
				...
				{
					MISC::CLEAR_AREA(vLocal_237 + vLocal_103[iVar0 /*3*/], 10f, 1, 0, 0, false);
		...
		while (iVar0 < 4)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_153[iVar0]))
			{
				...
				{
					MISC::CLEAR_AREA(vLocal_237 + vLocal_163[iVar0 /*3*/], 10f, 1, 0, 0, false);
		...
		while (iVar0 < 4)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_181[iVar0]))
			{
				...
				{
					MISC::CLEAR_AREA(vLocal_237 + vLocal_191[iVar0 /*3*/], 10f, 1, 0, 0, false);
		...
		while (iVar0 < 4)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_209[iVar0]))
			{
				...
				{
					MISC::CLEAR_AREA(vLocal_237 + vLocal_219[iVar0 /*3*/], 10f, 1, 0, 0, false);
	...
	while (iVar0 < 12)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_77[iVar0], 0))
		{
			iVar3 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_77[iVar0], 4, iLocal_72[func_36()], -1, 1, true);
			func_34(iVar3);
			ENTITY::_SET_ENTITY_SOMETHING(iLocal_77[iVar0], true);
	...
	while (iVar0 < 4)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_153[iVar0], 0))
		{
			...
			{
				iVar4 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_153[iVar0], 4, iLocal_72[func_36()], -1, 1, true);
				func_34(iVar4);
				ENTITY::_SET_ENTITY_SOMETHING(iLocal_77[iVar0], true);
	...
	while (iVar0 < 4)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_181[iVar0], 0))
		{
			...
			{
				iVar5 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_181[iVar0], 4, iLocal_72[func_36()], -1, 1, true);
				func_34(iVar5);
				ENTITY::_SET_ENTITY_SOMETHING(iLocal_77[iVar0], true);
	...
	while (iVar0 < 4)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_209[iVar0], 0))
		{
			...
			{
				iVar6 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_209[iVar0], 4, iLocal_72[func_36()], -1, 1, true);
				func_34(iVar6);
				ENTITY::_SET_ENTITY_SOMETHING(iLocal_77[iVar0], true);
...
void func_34(int iParam0)//Position - 0xF96
{
...
void func_38(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5, var uParam6, var uParam7, int iParam8, var uParam9, var uParam10, int iParam11, var uParam12, var uParam13)//Position - 0x10DD
{
	vector3 vVar0;
	float fVar3;
	char[] cVar4[8];
...
void func_39(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)//Position - 0x16D9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_40(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5)//Position - 0x187B
{
...
void func_41(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)//Position - 0x1ABB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_42(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5)//Position - 0x1C5D
{
...
void func_43(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)//Position - 0x1E9D
{
	int iVar0;
...
void func_44(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5)//Position - 0x1FDB
{
...
Vector3 func_45(float fParam0, float fParam1)//Position - 0x221B
{
	return MISC::GET_RANDOM_FLOAT_IN_RANGE(fParam0, fParam1), MISC::GET_RANDOM_FLOAT_IN_RANGE(fParam0, fParam1), 0f;
}

void func_46(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5)//Position - 0x2234
{
...
void func_47(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)//Position - 0x2474
{
	int iVar0;
...
void func_48(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5)//Position - 0x25B2
{
	vector3 vVar0;
	int iVar3;
...
int func_49(int iParam0, var uParam1, var uParam2, char* sParam3)//Position - 0x287F
{
	int iVar0;
...
bool func_50(var uParam0)//Position - 0x2A6A
{
	int iVar0;
	vector3 vVar1;
	float fVar4;
...
bool func_51(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x2B25
{
	if (bParam6)
	{
...
int func_52(int iParam0, var uParam1, char* sParam2)//Position - 0x2B6C
{
	vector3 vVar0;
	int iVar3;
	var uVar4;
