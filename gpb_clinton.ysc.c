...
var func_16()//Position - 0x15FE
{
	return iLocal_276[iLocal_254];
}

void func_17(char* sParam0)//Position - 0x160D
{
	struct<16> Var0;
...
void func_18(char* sParam0)//Position - 0x1633
{
	switch (iLocal_254)
	{
		case 0:
...
void func_19(char* sParam0)//Position - 0x1697
{
	int iVar0;
...
void func_20(int iParam0, char* sParam1)//Position - 0x16DB
{
	switch (iParam0)
	{
		case 0:
...
void func_21(char* sParam0)//Position - 0x18A4
{
	char cVar0[64];
...
void func_22(char* sParam0)//Position - 0x18D8
{
	struct<4> Var0;
...
int func_23()//Position - 0x1903
{
	func_24();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_24()//Position - 0x191C
{
	int iVar0;
...
bool func_25(int iParam0)//Position - 0x1A19
{
	return Global_41396 == iParam0;
}

bool func_26(int iParam0)//Position - 0x1A27
{
	return iParam0 < 3;
}

int func_27(int iParam0)//Position - 0x1A33
{
	int iVar0;
	int iVar1;
...
int func_28(int iParam0)//Position - 0x1A70
{
	if (func_26(iParam0))
	{
...
var func_29(int iParam0)//Position - 0x1A95
{
	return Global_1798[iParam0 /*29*/];
}

void func_30(char* sParam0)//Position - 0x1AA4
{
...
void func_31()//Position - 0x1AC5
{
	iLocal_254 = MISC::GET_RANDOM_INT_IN_RANGE(0, iLocal_253);
}

void func_32(char* sParam0)//Position - 0x1AD6
{
	int iVar0;
...
bool func_34(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1B42
{
...
int func_35(char* sParam0, int iParam1, bool bParam2)//Position - 0x1B90
{
	Global_20806 = 0;
...
bool func_38(int iParam0)//Position - 0x1EFD
{
	return func_39(iParam0, 20);
}

bool func_39(int iParam0, int iParam1)//Position - 0x1F0D
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_40()//Position - 0x1F28
{
	return -1;
}

void func_41()//Position - 0x1F31
{
	int iVar0;
...
bool func_47(int iParam0, int iParam1)//Position - 0x21AE
{
	switch (iParam0)
	{
		case 5:
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x21E9
{
...
void func_49(char[4] cParam0)//Position - 0x223F
{
	int iVar0;
...
void func_50(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x227A
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_51(char* sParam0)//Position - 0x2315
{
	int iVar0;
...
void func_52(var uParam0)//Position - 0x234D
{
}

void func_53(var uParam0, int iParam1, float fParam2)//Position - 0x2355
{
}
...
void func_56(var uParam0)//Position - 0x23E2
{
}

void func_57(char* sParam0)//Position - 0x23EA
{
...
void func_58(int iParam0, char* sParam1, char* sParam2)//Position - 0x23FD
{
...
bool func_60()//Position - 0x2567
{
	return Global_98721.f_345 > 0;
}

bool func_61()//Position - 0x2578
{
	bool bVar0;
...
void func_65(char* sParam0)//Position - 0x25FB
{
	struct<8> Var0;
...
void func_66(char* sParam0)//Position - 0x263B
{
	func_20(iLocal_297, sParam0);
}

void func_67(char* sParam0)//Position - 0x264C
{
	StringCopy(sParam0, "MONOLOGUE_", 16);
	StringIntConCat(sParam0, Global_111505[iLocal_251] + 1, 16);
}

void func_68(int iParam0, bool bParam1)//Position - 0x266A
{
	int iVar0;
...
void func_69(int iParam0, bool bParam1)//Position - 0x268B
{
	int iVar0;
...
void func_70(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x26FC
{
	func_71(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_71(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x271C
{
	int iVar0;
...
int func_73(int iParam0)//Position - 0x2A0E
{
	int iVar0;
	int iVar1;
...
int func_76(int iParam0)//Position - 0x2B57
{
	if (func_78(iParam0))
	{
...
int func_77(int iParam0)//Position - 0x2B7E
{
	int iVar0;
...
int func_78(int iParam0)//Position - 0x2BB1
{
...
void func_80(int iParam0)//Position - 0x2C99
{
	if (iLocal_447 == 1)
	{
...
void func_81(int iParam0, int iParam1, bool bParam2)//Position - 0x2CB8
{
	if (iLocal_447 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
...
int func_82(int iParam0, bool bParam1, int iParam2)//Position - 0x2D0B
{
	int iVar0;
...
int func_83(int iParam0, bool bParam1, bool bParam2)//Position - 0x2D55
{
	int iVar0;
...
float func_84(bool bParam0, float fParam1, float fParam2)//Position - 0x2DF9
{
	if (bParam0)
	{
		return fParam1;
...
float func_85(int iParam0, int iParam1, bool bParam2)//Position - 0x2E10
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_86(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2E6E
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_87(vector3 vParam0, vector3 vParam3)//Position - 0x2EFF
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_88(vector3 vParam0)//Position - 0x2F20
{
	float fVar0;
	float fVar1;
...
int func_89(int iParam0)//Position - 0x2F5F
{
	var uVar0;
...
int func_96()//Position - 0x2FF5
{
	return 1;
}

float func_97(int iParam0, int iParam1)//Position - 0x2FFE
{
...
void func_101(var uParam0, var uParam1)//Position - 0x3124
{
...
int func_103(int iParam0)//Position - 0x31A7
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
int func_110()//Position - 0x3333
{
	return 1;
}

bool func_111(var uParam0)//Position - 0x333C
{
	return func_112(Global_111560.f_20112, uParam0);
}

bool func_112(var uParam0, var uParam1)//Position - 0x3351
{
	return (uParam0 && uParam1) != 0;
}

int func_113(int iParam0)//Position - 0x3360
{
...
void func_114(int iParam0)//Position - 0x3487
{
	var uVar0;
...
void func_115(int iParam0)//Position - 0x3556
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
struct<6> func_116()//Position - 0x3576
{
	struct<6> Var0;
...
void func_117()//Position - 0x359A
{
	func_118();
}

void func_118()//Position - 0x35A6
{
}

void func_119()//Position - 0x35AE
{
	if (iLocal_245 == -1)
	{
