...
int func_21(int iParam0, int iParam1)//Position - 0x10E0
{
...
void func_22(int iParam0)//Position - 0x110A
{
	if (func_26())
	{
		return;
...
void func_24(bool bParam0, bool bParam1)//Position - 0x11BB
{
	if (bParam0)
	{
		if (func_5(0))
...
bool func_25()//Position - 0x122F
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

bool func_26()//Position - 0x1240
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

int func_27()//Position - 0x1252
{
...
int func_29()//Position - 0x1288
{
	func_30();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_30()//Position - 0x12A1
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x13DB
{
	if (func_10(iParam0))
	{
...
var func_33(int iParam0)//Position - 0x1400
{
	return Global_1798[iParam0 /*29*/];
}

int func_34(int iParam0)//Position - 0x140F
{
	if (iParam0 == 146 || iParam0 == -1)
	{
		return 0;
...
int func_35(int iParam0)//Position - 0x143C
{
...
int func_36(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1468
{
	struct<15> Var0;
...
int func_37(int iParam0)//Position - 0x156E
{
	int iVar0;
...
void func_38()//Position - 0x166A
{
	Global_98708 = 1;
}

void func_39(int iParam0)//Position - 0x1677
{
...
void func_40()//Position - 0x16CC
{
	Global_41947 = MISC::GET_GAME_TIMER();
}

int func_41(int iParam0)//Position - 0x16DB
{
	int iVar0;
	int iVar1;
...
int func_43(int iParam0)//Position - 0x1781
{
	int iVar0;
	int iVar1;
...
void func_44(int iParam0)//Position - 0x18A8
{
	int iVar0;
	struct<10> Var1;
...
void func_45(int iParam0)//Position - 0x1961
{
	int iVar0;
	struct<14> Var1;
...
void func_46(int iParam0)//Position - 0x1A29
{
	struct<15> Var0;
	int iVar15;
	int iVar16;
...
void func_47(int iParam0)//Position - 0x1AD6
{
	struct<15> Var0;
	int iVar15;
	int iVar16;
	...
	while (iVar15 < Global_111560.f_7683.f_198)
	{
		...
		{
			func_48(Global_111560.f_7683.f_137[iVar15 /*15*/].f_6);
			iVar16 = iVar15;
...
int func_48(int iParam0)//Position - 0x1B92
{
	int iVar0;
...
void func_49(int iParam0, int iParam1)//Position - 0x1BE8
{
	int iVar0;
...
void func_50(int iParam0, int iParam1, int iParam2)//Position - 0x1C1D
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_51(int iParam0, int iParam1, int iParam2)//Position - 0x1C62
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
int func_52(int iParam0, int iParam1)//Position - 0x1CA7
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_53(int iParam0, int iParam1, int iParam2)//Position - 0x1CD1
{
...
void func_54(int iParam0)//Position - 0x1D02
{
	int iVar0;
	int iVar1;
	struct<15> Var2;
