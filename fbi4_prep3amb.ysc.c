...
void func_1(int iParam0, bool bParam1)//Position - 0x1B4
{
	...
	if (bParam1)
	{
		if (iParam0 != 46)
		{
			if ((!func_2(func_3(iParam0)) && !Global_110200) && !MISC::IS_BIT_SET(iLocal_105, 15))
			{
				MISC::SET_BIT(&iLocal_105, 15);
				HUD::CLEAR_HELP(1);
			}
		}
		else if ((HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && !Global_110200) && !MISC::IS_BIT_SET(iLocal_105, 15))
		{
			MISC::SET_BIT(&iLocal_105, 15);
			HUD::CLEAR_HELP(1);
		}
...
int func_12(int iParam0, int iParam1, int iParam2)//Position - 0x48E
{
...
int func_15(int iParam0)//Position - 0x53B
{
	if (iParam0 == 1)
	{
...
void func_16(int iParam0)//Position - 0x595
{
	func_109();
	if (iLocal_40 == 0)
	{
		...
		if (!func_77(0f, 0f, 0f, vLocal_110, 0))
		{
			if (func_76(PLAYER::PLAYER_PED_ID(), vLocal_110, 100f) && !func_75())
			{
				if (func_85(func_74(25)))
				{
					...
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_109, true, 1);
					if (func_85(iLocal_109))
					{
...
void func_21(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)//Position - 0x9B7
{
	struct<60> Var0;
...
void func_22(int iParam0, int iParam1, int iParam2)//Position - 0xAE0
{
	int iVar0;
...
void func_23(int iParam0, int iParam1)//Position - 0xBFD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_24(int iParam0)//Position - 0xDFF
{
...
int func_25(int iParam0)//Position - 0xEDC
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_26(int iParam0, bool bParam1)//Position - 0x108D
{
	int iVar0;
	struct<2> Var1;
...
int func_29(int iParam0)//Position - 0x12E9
{
	int iVar0;
	int iVar1;
...
int func_30()//Position - 0x37B4
{
	return 0;
}

int func_31()//Position - 0x37BD
{
	return 1;
}

int func_32()//Position - 0x37C6
{
	return 1;
}

int func_33()//Position - 0x37CF
{
...
int func_35(int iParam0)//Position - 0x38A3
{
	int iVar0;
	char* sVar1;
...
int func_36(int iParam0)//Position - 0x38E9
{
	int iVar0;
...
int func_37(int iParam0)//Position - 0x3924
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x39A0
{
	int iVar0;
...
int func_39(int iParam0, int iParam1, bool bParam2)//Position - 0x3A88
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_40(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x3AF9
{
...
void func_42(var uParam0, int iParam1)//Position - 0x3C16
{
	if (iParam1 <= 0)
	{
		return;
...
void func_43(var uParam0, int iParam1)//Position - 0x3C9C
{
...
void func_44(var uParam0, int iParam1)//Position - 0x3CCF
{
	int iVar0;
	int iVar1;
...
int func_45(int iParam0, int iParam1)//Position - 0x3D20
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_46(int iParam0)//Position - 0x3DC2
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_47(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_47(bool bParam0, int iParam1, int iParam2)//Position - 0x3DE7
{
	if (bParam0)
	{
		return iParam1;
...
int func_48(var uParam0)//Position - 0x3DFE
{
	return uParam0 & 15;
}

void func_49(var uParam0, int iParam1)//Position - 0x3E0B
{
...
void func_50(var uParam0, int iParam1)//Position - 0x3E45
{
...
void func_51(var uParam0, int iParam1)//Position - 0x3E80
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_52(var uParam0, int iParam1)//Position - 0x3EBC
{
	int iVar0;
	int iVar1;
...
void func_56(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0x594F
{
	if (func_52(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
...
bool func_76(int iParam0, vector3 vParam1, float fParam4)//Position - 0x64A6
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, true), vParam1) <= (fParam4 * fParam4);
}

bool func_77(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x64C3
{
	if (bParam6)
	{
...
int func_98(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x6F55
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_135()//Position - 0x804D
{
	return Global_76839;
}

void func_136()//Position - 0x8059
{
...
void func_138()//Position - 0x8104
{
	func_17();
	func_109();
}

void func_139()//Position - 0x8114
{
	int iVar0;
...
int func_140(var uParam0)//Position - 0x817F
{
	char* sVar0;
...
void func_142(int iParam0, vector3 vParam1)//Position - 0x81FC
{
	int iVar0;
...
bool func_143(var uParam0, var uParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x824B
{
...
int func_144(char* sParam0, int iParam1, bool bParam2)//Position - 0x82AA
{
	Global_20806 = 0;
...
bool func_147(int iParam0)//Position - 0x8617
{
	return func_148(iParam0, 20);
}

bool func_148(int iParam0, int iParam1)//Position - 0x8627
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_149()//Position - 0x8642
{
	return -1;
}

void func_150()//Position - 0x864B
{
	int iVar0;
...
bool func_156(int iParam0, int iParam1)//Position - 0x88C8
{
	switch (iParam0)
	{
		case 5:
...
void func_158(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x895A
{
...
void func_160(int iParam0, var uParam1)//Position - 0x89CA
{
	int iVar0;
...
void func_161(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x8B40
{
...
void func_162(int iParam0, int iParam1, bool bParam2)//Position - 0x8BDB
{
	int iVar0;
...
struct<4> func_164(int iParam0)//Position - 0x8D84
{
	return Global_1798[iParam0 /*29*/].f_3;
}

int func_165(int iParam0, int iParam1)//Position - 0x8D97
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
int func_166(int iParam0, int iParam1)//Position - 0x8DC1
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
char* func_169(int iParam0)//Position - 0xA699
{
	char* sVar0;
...
int func_172(int iParam0)//Position - 0xA85C
{
...
int func_173(int iParam0)//Position - 0xA88C
{
	if (Global_21920 == 0)
	{
		return 0;
...
void func_175()//Position - 0xA917
{
	if ((MISC::IS_BIT_SET(iLocal_105, 0) && Global_41396 == 15) && !func_207())
	{
		if (iLocal_38 == 0)
		{
			if (!MISC::IS_BIT_SET(iLocal_105, 1))
			{
				if (!func_76(PLAYER::PLAYER_PED_ID(), vLocal_106, 5f))
				{
					...
					{
						if ((PED::IS_PED_STOPPED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && !MISC::IS_BIT_SET(iLocal_105, 20))
						{
							if (iLocal_1438 != -1)
							{
...
void func_177(int iParam0)//Position - 0xAC1B
{
	if (func_180())
	{
		return;
...
void func_178(bool bParam0, bool bParam1)//Position - 0xACA5
{
	if (bParam0)
	{
		if (func_15(0))
...
bool func_179()//Position - 0xAD19
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

bool func_180()//Position - 0xAD2A
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

int func_181(int iParam0)//Position - 0xAD3C
{
	vector3 vVar0;
...
int func_182(int iParam0)//Position - 0xADF1
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
	...
	if (iParam0 != 0)
	{
		if (func_85(iParam0))
		{
			...
			if (!MISC::IS_AREA_OCCUPIED(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, vVar1), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, vVar4), 0, 1, 0, 0, 0, iParam0, 0))
			{
				iVar0++;
			}
			else if (func_13())
...
int func_183(vector3 vParam0)//Position - 0xAEA6
{
	float fVar0;
	float fVar1;
	vector3 vVar2;
...
int func_185(vector3 vParam0)//Position - 0xAF6B
{
...
int func_186(vector3 vParam0)//Position - 0xAFC4
{
...
int func_187(vector3 vParam0)//Position - 0xAFF7
{
	float fVar0;
...
int func_188(vector3 vParam0, bool bParam3)//Position - 0xB02C
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= (7 - 1))
	{
		...
		{
			if (!bParam3 || MISC::IS_BIT_SET(Global_111560.f_7224.f_17[iVar0], 0))
			{
...
int func_189(vector3 vParam0)//Position - 0xB0A9
{
	float fVar0;
...
int func_190(vector3 vParam0, bool bParam3)//Position - 0xB0DE
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_191(vector3 vParam0)//Position - 0xB15B
{
	vector3 vVar0;
	float fVar3;
...
int func_192(vector3 vParam0, vector3 vParam3)//Position - 0xB1E4
{
	float fVar0;
...
int func_193(vector3 vParam0)//Position - 0xB207
{
	if (!func_196(1))
	{
		if (!func_196(0))
...
int func_194(vector3 vParam0, int iParam3)//Position - 0xB87A
{
	float fVar0;
...
Vector3 func_195(int iParam0)//Position - 0xB8A2
{
	vector3 vVar0;
...
bool func_196(int iParam0)//Position - 0xBF7F
{
...
int func_198(var uParam0)//Position - 0xC108
{
...
int func_199(int iParam0)//Position - 0xC133
{
	int iVar0;
	...
	while (iVar0 <= 12)
	{
		...
		{
			if (MISC::ARE_STRINGS_EQUAL(sLocal_1249[iVar0], iParam0))
			{
				return 1;
			}
		}
...
int func_200(vector3 vParam0)//Position - 0xC17F
{
	if (vParam0.z < -90f)
	{
		return 1;
...
void func_202(int iParam0)//Position - 0xC25B
{
...
int func_203(vector3 vParam0, int iParam3, int iParam4)//Position - 0xC2B8
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_204(int iParam0)//Position - 0xC347
{
	return MISC::IS_BIT_SET(Global_111560.f_7224[iParam0], 0);
}

int func_205()//Position - 0xC35F
{
...
void func_206(int iParam0, int iParam1)//Position - 0xC3D7
{
	func_4(iParam0);
...
int func_209(int iParam0)//Position - 0xC732
{
...
int func_210(int iParam0)//Position - 0xC763
{
...
int func_212(int iParam0)//Position - 0xC7EB
{
...
int func_213(int iParam0)//Position - 0xC80A
{
...
int func_214(int iParam0)//Position - 0xC837
{
	int iVar0;
...
int func_215(int iParam0)//Position - 0xC88B
{
	int iVar0;
...
int func_216(int iParam0)//Position - 0xC8D0
{
	int iVar0;
...
int func_218(int iParam0)//Position - 0xC992
{
	if (DECORATOR::DECOR_EXIST_ON(iParam0, "GetawayVehicleValid"))
	{
		return 1;
...
int func_220(var uParam0)//Position - 0xC9F5
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	switch (iLocal_203)
	{
		case 0:
			if (MISC::IS_BIT_SET(iLocal_105, 0))
			{
				...
				{
					iLocal_1263 = ZONE::GET_NAME_OF_ZONE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true));
					iLocal_203 = 1;
				}
		...
		case 1:
			...
			{
				if (!MISC::IS_STRING_NULL_OR_EMPTY(iLocal_1263) && !MISC::IS_STRING_NULL_OR_EMPTY(Local_204[iLocal_1265 /*261*/][iLocal_1264 /*8*/]))
				{
					if (MISC::ARE_STRINGS_EQUAL(iLocal_1263, Local_204[iLocal_1265 /*261*/][iLocal_1264 /*8*/]))
					{
...
void func_222()//Position - 0xCBB7
{
	int iVar0;
	int iVar1;
	
	if (((((((Global_41396 == 15 && iLocal_37 != 3) && MISC::IS_BIT_SET(iLocal_105, 5)) && !func_207()) && Global_76574 == -1) && !func_232()) && !func_84(9)) || func_103(35))
	{
		func_231();
		func_229();
		switch (iLocal_39)
...
void func_223(int iParam0, bool bParam1)//Position - 0xCD48
{
	switch (iLocal_39)
	{
		case 1:
...
void func_224(char[4] cParam0, int iParam1)//Position - 0xCE58
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_225()//Position - 0xCE6F
{
...
int func_226(int iParam0)//Position - 0xCE89
{
	int iVar0;
...
int func_227(int iParam0)//Position - 0xCED3
{
	int iVar0;
...
void func_228(int iParam0, int iParam1)//Position - 0xCF8A
{
	int iVar0;
...
bool func_230(char* sParam0, int iParam1, char* sParam2)//Position - 0xD154
{
...
int func_241(float fParam0)//Position - 0xD540
{
	if (iLocal_42 == 1)
	{
...
int func_244(int iParam0)//Position - 0xD64C
{
	return func_245(iParam0, 6, 1);
}

int func_245(int iParam0, int iParam1, bool bParam2)//Position - 0xD65C
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_246(int iParam0, int iParam1, int iParam2)//Position - 0xD6C6
{
	int iVar0;
	var uVar1;
...
int func_247(var uParam0)//Position - 0xD6F8
{
	int iVar0;
	int iVar1;
...
int func_248(int iParam0)//Position - 0xD72C
{
	switch (iParam0)
	{
		case 0:
...
int func_249(int iParam0)//Position - 0xDA5C
{
	if (func_86(iParam0))
	{
...
int func_250(int iParam0)//Position - 0xDA7C
{
...
void func_251(int iParam0)//Position - 0xDAA8
{
	iLocal_42 = iParam0;
	if (iLocal_42 == 0)
	{
...
char* func_253(int iParam0)//Position - 0xDD4B
{
	char* sVar0;
...
struct<8> func_255(char* sParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0xF24B
{
	struct<8> Var0;
...
void func_256(int iParam0, bool bParam1)//Position - 0xF276
{
	if (func_85(iLocal_109))
	{
		func_20(&iLocal_109);
...
int func_257(int iParam0)//Position - 0xF29E
{
	int iVar0;
	int iVar1;
...
void func_258(bool bParam0)//Position - 0xF2F8
{
	char* sVar0;
...
float func_268(int iParam0)//Position - 0xF4B8
{
	if (iParam0 == -1)
	{
		return 0f;
...
Vector3 func_269(int iParam0)//Position - 0xF4EE
{
	if (iParam0 == -1)
	{
		return 0f, 0f, 0f;
...
int func_270(int iParam0)//Position - 0xF528
{
	int iVar0;
	int iVar1;
