		...
		switch (iLocal_294)
		{
			...
			case 1:
				...
				else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96029))
				{
					...
					if (!ENTITY::IS_ENTITY_PLAYING_ANIM(*iParam0, &cLocal_312, &cLocal_344, 2))
					{
						TASK::CLEAR_PED_TASKS(*iParam0);
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(*iParam0, -16f, 1);
						PED::SET_PED_MOVE_ANIMS_BLEND_OUT(*iParam0);
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, vLocal_304 + vLocal_308, 1f, -1, (fLocal_311 * 0.1f), 0, 1193033728);
					...
					else
					{
						...
						if (!ENTITY::FIND_ANIM_EVENT_PHASE(&cLocal_312, &cLocal_344, "WalkInterruptible", &fVar1, &uVar2))
						{
						}
						else
						{
				...
				else if (iLocal_103 != 151)
				{
					...
					{
						TASK::TASK_START_SCENARIO_AT_POSITION(*iParam0, &cLocal_360, vLocal_304 + vLocal_376, (fLocal_307 + fLocal_379), 0, 0, 1);
			...
			case 3:
				...
				{
					if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(*iParam0, true), vLocal_304 + vLocal_308) < (fLocal_311 * fLocal_311))
					{
						if (fLocal_311 == 0f)
						{
							fLocal_311 = (SYSTEM::VMAG(vLocal_308) * 0.75f);
						}
						TASK::TASK_WANDER_IN_AREA(*iParam0, vLocal_304 + vLocal_308, fLocal_311, 1077936128, 1086324736);
						func_135(4, 0);
						return 1;
					}
				}
			...
			case 4:
				...
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(*iParam0, true), vLocal_304 + vLocal_308) < (fLocal_311 * fLocal_311))
				{
					if (TASK::DOES_SCENARIO_EXIST_IN_AREA(vLocal_304 + vLocal_308, fLocal_311, 1))
					{
						TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD(*iParam0, vLocal_304 + vLocal_308, fLocal_311, 0);
						PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_381, 0);
						func_135(5, 0);
						return 1;
					}
				}
			...
			case 5:
				...
				else
				{
					...
					vVar6 = { func_4(vLocal_304 + vLocal_308, (fLocal_311 * 0.9f), 0f) };
					if (PATHFIND::GET_SAFE_COORD_FOR_PED(vVar6, 0, &vVar9, 14))
					{
						if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(*iParam0, true), vVar9) > 100f)
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, vVar9, 1f, -1, 1048576000, 0, 1193033728);
							vVar12 = { ENTITY::GET_ENTITY_COORDS(*iParam0, true) - Vector(2f, 2f, 2f) };
							vVar15 = { ENTITY::GET_ENTITY_COORDS(*iParam0, true) + Vector(2f, 2f, 2f) };
							iLocal_381 = PED::ADD_SCENARIO_BLOCKING_AREA(vVar12, vVar15, 0, 0, 1, 1);
			...
			case 7:
				...
				func_7(*iParam0);
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*iParam0, &cLocal_312, &cLocal_328, 2))
				{
				}
				else if (ENTITY::IS_ENTITY_PLAYING_ANIM(*iParam0, &cLocal_312, &cLocal_344, 2))
				{
				}
				break;
...
Vector3 func_4(vector3 vParam0, float fParam3, float fParam4)//Position - 0x872
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
Vector3 func_5(vector3 vParam0, float fParam3, float fParam4)//Position - 0x8EB
{
	vector3 vVar0;
	float fVar3;
...
Vector3 func_6(vector3 vParam0, float fParam3)//Position - 0x933
{
	float fVar0;
...
void func_7(int iParam0)//Position - 0x96A
{
	...
	if (PED::IS_PED_INJURED(iParam0))
	{
		if (!iLocal_384 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 1))
		{
	...
	func_10(iParam0, 138, &uLocal_104, "FMMAUD", &uLocal_269, &iLocal_290, 3);
	...
	else
	{
		...
		if (iLocal_382 > 0)
		{
			if (iLocal_383 == 0)
			{
				if (iLocal_382 + 15000 < MISC::GET_GAME_TIMER())
				{
			...
			else if (iLocal_382 + 10000 < MISC::GET_GAME_TIMER())
			{
...
int func_14(char* sParam0, char* sParam1, var uParam2, int iParam3, var uParam4, int iParam5)//Position - 0x1109
{
	char* sVar0;
	int iVar1;
	int iVar2;
...
bool func_20(int iParam0)//Position - 0x15E8
{
	return func_21(iParam0, 20);
}

bool func_21(int iParam0, int iParam1)//Position - 0x15F8
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_22()//Position - 0x1613
{
	return -1;
}

void func_23()//Position - 0x161C
{
	int iVar0;
...
bool func_28(int iParam0)//Position - 0x1843
{
	return Global_41396 == iParam0;
}

void func_29()//Position - 0x1851
{
	int iVar0;
...
bool func_30(int iParam0, int iParam1)//Position - 0x18A7
{
	switch (iParam0)
	{
		case 5:
...
void func_32(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x1939
{
...
int func_33(char* sParam0, int iParam1)//Position - 0x198F
{
...
void func_35(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x19F0
{
...
int func_36(char* sParam0, int iParam1, var uParam2)//Position - 0x1A8B
{
	char cVar0[16];
	char cVar4[16];
	int iVar8;
...
int func_37(int iParam0)//Position - 0x212F
{
...
int func_38(int iParam0)//Position - 0x215C
{
	int iVar0;
...
int func_39(int iParam0)//Position - 0x227D
{
	if (func_41(iParam0))
	{
...
var func_40(int iParam0)//Position - 0x22A2
{
	return Global_1798[iParam0 /*29*/];
}

bool func_41(int iParam0)//Position - 0x22B1
{
	return iParam0 < 3;
}

int func_42(int iParam0)//Position - 0x22BD
{
	if (!func_41(iParam0))
	{
		return func_40(iParam0);
...
int func_43()//Position - 0x22E3
{
	func_44();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_44()//Position - 0x22FC
{
	int iVar0;
...
int func_45(int iParam0)//Position - 0x23F9
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2436
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x2622
{
...
int func_49(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x2656
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_50(bool bParam0)//Position - 0x2C55
{
	int iVar0;
	int iVar1;
...
void func_51(int iParam0)//Position - 0x2ED7
{
	int iVar0;
...
void func_52(int iParam0)//Position - 0x2F31
{
	bool bVar0;
	char cVar1[64];
...
char* func_53(int iParam0)//Position - 0x30C0
{
	switch (iParam0)
	{
		case 0:
...
void func_55(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x31C8
{
	int iVar0;
...
int func_56(var uParam0)//Position - 0x31F8
{
	int iVar0;
	int iVar1;
...
int func_57()//Position - 0x322C
{
	return Global_1312745;
}

int func_58(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x3238
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_59(int iParam0)//Position - 0x388A
{
	func_81(93, iParam0);
	func_81(29, iParam0);
	func_81(30, iParam0);
...
bool func_60(int iParam0)//Position - 0x38AA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_61(int iParam0, int iParam1, int iParam2)//Position - 0x3A5A
{
	int iVar0;
	var uVar1;
...
int func_62(int iParam0, int iParam1, int iParam2)//Position - 0x3A8C
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_63(int iParam0)//Position - 0x3AC9
{
	int iVar0;
...
int func_64(int iParam0, int iParam1)//Position - 0x3E65
{
	int iVar0;
...
int func_65(bool bParam0)//Position - 0x41E0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_66(int iParam0, int iParam1)//Position - 0x4297
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_67(int iParam0, int iParam1)//Position - 0x42B2
{
...
int func_68(var uParam0, int iParam1)//Position - 0x434F
{
	int iVar0;
	var uVar1[78];
...
int func_69(var uParam0, int iParam1)//Position - 0x4400
{
	int iVar0;
...
bool func_70(var uParam0, int iParam1)//Position - 0x447B
{
	return (*uParam0)[iParam1] == 78;
}

void func_71(var uParam0)//Position - 0x448C
{
	int iVar0;
...
void func_72(var uParam0, int iParam1)//Position - 0x44C0
{
	(*uParam0)[iParam1] = 78;
}

void func_73(var uParam0, float fParam1)//Position - 0x44D0
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_74(var uParam0)//Position - 0x44ED
{
	return uParam0->f_80;
}

bool func_75(var uParam0, int iParam1)//Position - 0x44F9
{
	return func_76(uParam0, iParam1) != -1;
}

int func_76(var uParam0, int iParam1)//Position - 0x450B
{
	int iVar0;
...
bool func_77(var uParam0)//Position - 0x4538
{
	return uParam0->f_79 == 1;
}

int func_78(int iParam0)//Position - 0x4546
{
	switch (iParam0)
	{
		case 60:
...
int func_79(int iParam0, int iParam1)//Position - 0x4596
{
	int iVar0;
...
void func_80(int iParam0, int iParam1)//Position - 0x45E7
{
	int iVar0;
...
void func_81(int iParam0, int iParam1)//Position - 0x460A
{
	int iVar0;
...
int func_83(int iParam0)//Position - 0x46DC
{
	return Global_1798[iParam0 /*29*/].f_17;
}

int func_84(int iParam0)//Position - 0x46ED
{
	var uVar0;
...
int func_89(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9)//Position - 0x484D
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
struct<4> func_90(int iParam0)//Position - 0x48DC
{
	return Global_1798[iParam0 /*29*/].f_3;
}

int func_91(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)//Position - 0x48EF
{
	int iVar0;
...
void func_92(int iParam0, char* sParam1)//Position - 0x4DAE
{
	if (!func_19())
	{
		return;
...
void func_93(int iParam0)//Position - 0x4DD3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_94(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11)//Position - 0x5379
{
...
void func_95(char* sParam0)//Position - 0x542C
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}

void func_96(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6)//Position - 0x543E
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
	if (fParam3 != -1f)
...
bool func_97()//Position - 0x54A1
{
	return Global_1312873;
}

void func_98(int iParam0)//Position - 0x54AD
{
	var uVar0;
	var uVar1;
...
void func_99(int iParam0)//Position - 0x54CC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_101(struct<6> Param0, struct<6> Param6)//Position - 0x5629
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
...
int func_103(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x587C
{
	struct<4> Var0;
	struct<4> Var4[2];
	int iVar13;
...
int func_104(char* sParam0, int iParam1)//Position - 0x59B4
{
	int iVar0;
	int iVar1;
...
int func_105(int iParam0)//Position - 0x5A28
{
	switch (iParam0)
	{
		case 0:
...
char* func_106(int iParam0)//Position - 0x5A8A
{
	switch (iParam0)
	{
		case 0:
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)//Position - 0x5AFD
{
	struct<14> Var0;
...
void func_108(int iParam0)//Position - 0x5C3B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_110(bool bParam0)//Position - 0x5D69
{
...
int func_111(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4)//Position - 0x5D94
{
	struct<4> Var0[2];
	int iVar9;
...
int func_112(int iParam0, int iParam1)//Position - 0x5E96
{
...
int func_113(int iParam0)//Position - 0x5F44
{
	switch (iParam0)
	{
		case 0:
...
void func_114(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0x5F7B
{
	if (iParam0 == iParam5)
	{
		return;
...
int func_115(int iParam0)//Position - 0x5FC4
{
	int iVar0;
	int iVar1;
...
int func_116(int iParam0, int iParam1)//Position - 0x607A
{
	struct<10> Var0;
	bool bVar10;
...
int func_117()//Position - 0x6112
{
	func_44();
	return Global_111560.f_2358.f_539.f_4321;
}

struct<10> func_118(int iParam0)//Position - 0x612B
{
	int iVar0;
	struct<10> Var1;
...
int func_119(int iParam0, int iParam1)//Position - 0x617A
{
	struct<14> Var0;
	bool bVar14;
...
struct<14> func_120(int iParam0)//Position - 0x6209
{
	int iVar0;
	struct<14> Var1;
...
int func_121(int iParam0, int iParam1)//Position - 0x6258
{
	struct<15> Var0;
	bool bVar15;
...
struct<15> func_122(int iParam0)//Position - 0x6303
{
	int iVar0;
	struct<15> Var1;
...
int func_123(int iParam0)//Position - 0x634B
{
	int iVar0;
...
int func_124(int iParam0)//Position - 0x6447
{
	vector3 vVar0;
...
int func_125(vector3 vParam0, bool bParam3)//Position - 0x64DA
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_126(int iParam0)//Position - 0x6557
{
	if (iParam0 == 0)
	{
		return 2091854273;
...
int func_127(int iParam0)//Position - 0x65C3
{
	if (iParam0 == 145)
	{
		return 7;
...
var func_128(int iParam0)//Position - 0x661B
{
	return Global_1798[iParam0 /*29*/].f_11;
}

int func_129()//Position - 0x662C
{
...
int func_130(int iParam0)//Position - 0x664E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_131(int iParam0)//Position - 0x6694
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_132(int iParam0, bool bParam1)//Position - 0x66F2
{
...
bool func_133(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x6742
{
	if (bParam6)
	{
...
void func_134(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x6789
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_9(iParam3), 0);
}

void func_135(int iParam0, char* sParam1)//Position - 0x67A2
{
	sParam1 = sParam1;
	iLocal_294 = iParam0;
}

int func_136()//Position - 0x67B3
{
	if (!func_138())
	{
		func_35(&uLocal_104, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
		switch (func_38(Global_98390))
		{
			case 0:
				func_35(&uLocal_104, 1, Global_98390, func_137(0), 0, 1);
				break;
			
			case 1:
				func_35(&uLocal_104, 2, Global_98390, func_137(1), 0, 1);
				break;
			
			case 2:
				func_35(&uLocal_104, 3, Global_98390, func_137(2), 0, 1);
				break;
	...
	if (iLocal_297 != 0)
	{
		...
		{
			iLocal_296 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vLocal_304 + vLocal_298, 1f, iLocal_297, 1, 0, 1);
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_296))
			{
				ENTITY::SET_ENTITY_COORDS(iLocal_296, vLocal_304 + vLocal_298, 1, false, 0, 1);
				ENTITY::SET_ENTITY_ROTATION(iLocal_296, Vector(fLocal_307, 0f, 0f) + vLocal_301, 2, 1);
				ENTITY::FREEZE_ENTITY_POSITION(iLocal_296, true);
			}
		}
	}
	return 0;
...
char* func_137(int iParam0)//Position - 0x68B3
{
	switch (iParam0)
	{
		case 0:
...
int func_139(int iParam0, int iParam1)//Position - 0x6A09
{
	vector3 vVar0;
	float fVar3;
...
int func_140(var uParam0)//Position - 0x6AED
{
	return uParam0;
}

bool func_141(var uParam0, var uParam1)//Position - 0x6AF7
{
	return (uParam0 && uParam1) != 0;
}

int func_142()//Position - 0x6B06
{
	func_44();
...
void func_144()//Position - 0x6B8C
{
	func_145((Global_98392 - 1));
}

void func_145(int iParam0)//Position - 0x6B9E
{
	Global_98392 = iParam0;
}

void func_146()//Position - 0x6BAC
{
	func_145(0);
}

void func_147()//Position - 0x6BB9
{
	int iVar0;
	bool bVar1;
	...
	if (iLocal_295 != 0)
	{
		VEHICLE::REQUEST_VEHICLE_ASSET(iLocal_295, 3);
	}
	iVar0 = 0;
	bVar1 = false;
	while (!bVar1 && iVar0 < 400)
	{
		...
		if (iLocal_295 != 0)
		{
			if (!VEHICLE::HAS_VEHICLE_ASSET_LOADED(iLocal_295))
			{
				bVar1 = false;
			}
		}
...
void func_148(var uParam0, int iParam1)//Position - 0x6C4F
{
...
void func_149()//Position - 0x6C85
{
	...
	func_165(iLocal_103, &vLocal_304, &fLocal_307, &cVar0);
	switch (iLocal_103)
	{
		case 98:
			vLocal_308 = { -25f, -35f, 0f };
			fLocal_311 = 30f;
			fLocal_380 = 0.73f;
			break;
		
		case 99:
			vLocal_308 = { Vector(24.3224f, -700.7733f, -1306.836f) - vLocal_304 };
			fLocal_311 = 40f;
			iLocal_294 = 2;
			break;
		
		case 100:
			vLocal_308 = { Vector((82.0206f + 1f), 272.6104f, -566.2225f) - vLocal_304 };
			fLocal_311 = 30f;
			iLocal_294 = 2;
			break;
		
		case 101:
			vLocal_308 = { Vector((53.6418f + 1f), -217.321f, 77.2686f) - vLocal_304 };
			fLocal_311 = 25f;
			iLocal_294 = 2;
			break;
		
		case 102:
			vLocal_308 = { Vector((102.0191f + 1f), 313.2252f, 412.1519f) - vLocal_304 };
			fLocal_311 = 15f;
			iLocal_294 = 2;
			break;
		
		case 170:
			vLocal_308 = { Vector((37.8417f + 1f), -275.1926f, -616.7041f) - vLocal_304 };
			fLocal_311 = 30f;
			break;
		
		case 171:
			vLocal_308 = { Vector((56.8469f + 1f), -125.1416f, -106.3491f) - vLocal_304 };
			fLocal_311 = 25f;
			break;
		...
		case 94:
			vLocal_308 = { Vector((112.1615f + 1f), 328.301f, -16.8925f) - vLocal_304 };
			fLocal_311 = 25f;
			break;
		...
		case 152:
			vLocal_308 = { 0f, 0f, 0f };
			fLocal_311 = 0f;
			StringCopy(&cLocal_360, "PROP_HUMAN_SEAT_SUNLOUNGER", 64);
			vLocal_376 = { 1.358f, 2.385f, -0.608f };
			fLocal_379 = 160f;
			iLocal_297 = joaat("prop_patio_lounger1");
			vLocal_298 = { Vector(63.082f, 357.697f, -1352.644f) - Vector(64.08f, 355.1845f, -1353.791f) };
			vLocal_301 = { 0f, 0f, (54.35f - 72f) };
			break;
		
		case 151:
			vLocal_308 = { 0f, 0f, 0f };
			fLocal_311 = 0f;
			iLocal_297 = joaat("prop_chateau_chair_01");
			vLocal_298 = { 0.8706f, 2.0176f, -0.4948f };
			vLocal_301 = { 0f, 0f, 0f };
			break;
		
		default:
			vLocal_308 = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-50f, 50f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-50f, 50f), 0f };
			fLocal_311 = (SYSTEM::VMAG(vLocal_308) * 0.75f);
			break;
	}
	if ((iLocal_103 != 94 && iLocal_103 != 152) && iLocal_103 != 151)
	{
		Var8.f_11 = 12;
		Var8.f_31 = 49;
		Var8.f_81 = 2;
		if (func_152(0, iLocal_103, &Var8, &uVar106, &uVar109, &uVar110, &uVar113))
		{
			iLocal_295 = Var8;
		}
	}
	...
	if (iLocal_294 == 0)
	{
		func_150(iLocal_103, &cLocal_312, &cLocal_328, &cLocal_344, &uVar114, &uVar115);
		iLocal_294 = 0;
	}
	else
	{
		...
		StringCopy(&cLocal_344, "", 64);
		iLocal_294 = 2;
	}
}

int func_150(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5)//Position - 0x6FBE
{
	*uParam4 = 9;
	*uParam5 = 8;
	switch (iParam0)
...
void func_151(char* sParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5)//Position - 0x76D8
{
...
int func_152(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x76F2
{
	uParam2->f_3 = 1000;
	uParam2->f_1 = 0;
	uParam2->f_84 = 255;
...
void func_153(int iParam0, var uParam1, int iParam2)//Position - 0xAB65
{
	int iVar0;
...
int func_154(int iParam0, var uParam1, int iParam2)//Position - 0xADC1
{
...
int func_155(int iParam0, bool bParam1)//Position - 0xAFF8
{
	int iVar0;
	struct<2> Var1;
...
int func_156(int iParam0)//Position - 0xB178
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_158(int iParam0)//Position - 0xB25B
{
	int iVar0;
	int iVar1;
...
int func_159()//Position - 0xD727
{
	return 0;
}

int func_160()//Position - 0xD730
{
	return 1;
}

int func_161()//Position - 0xD739
{
	return 1;
}

int func_162()//Position - 0xD742
{
...
int func_164(int iParam0)//Position - 0xD816
{
...
int func_165(int iParam0, var uParam1, var uParam2, char* sParam3)//Position - 0xDA96
{
	int iVar0;
...
bool func_166(var uParam0)//Position - 0xDC81
{
	int iVar0;
	vector3 vVar1;
	float fVar4;
...
int func_167(int iParam0, var uParam1, char* sParam2)//Position - 0xDD3C
{
	vector3 vVar0;
	int iVar3;
	var uVar4;
...
int func_168(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0x10149
{
	switch (iParam1)
	{
		case 0:
...
int func_170(int iParam0, var uParam1, var uParam2)//Position - 0x120B7
{
	switch (iParam0)
	{
		case 11:
...
char* func_171(int iParam0)//Position - 0x12A26
{
	switch (iParam0)
	{
		case 2014101067:
...
void func_172()//Position - 0x12AB7
{
	if (iLocal_295 != 0)
	{
		VEHICLE::REMOVE_VEHICLE_ASSET(iLocal_295);
	}
