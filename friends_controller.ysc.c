...
void func_6(var uParam0)//Position - 0x724
{
	...
	PATHFIND::SET_ROADS_BACK_TO_ORIGINAL(vVar65, vVar68, true);
...
void func_11(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x95E
{
	if (bParam0)
	{
...
bool func_12()//Position - 0xA97
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_13(int iParam0, int iParam1)//Position - 0xAB4
{
	bool bVar0;
...
int func_14(int iParam0, bool bParam1)//Position - 0xAFF
{
	int iVar0;
	int iVar1;
...
int func_15()//Position - 0xB40
{
	return Global_1312745;
}

int func_16(int iParam0)//Position - 0xB4C
{
...
bool func_17()//Position - 0xB8E
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_18(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xB9F
{
	int iVar0;
...
void func_20(int iParam0)//Position - 0xBF9
{
	if (iParam0 == 1)
	{
...
void func_21(int iParam0, int iParam1, char* sParam2, char* sParam3)//Position - 0xC1C
{
	if (iParam0 == 0)
	{
		if (iParam1 == 1)
...
void func_22(int iParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5)//Position - 0xCC9
{
	switch (iParam0)
	{
		case 0:
...
void func_23(int iParam0, int iParam1, int iParam2)//Position - 0xD67
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_24(int iParam0)//Position - 0xDB4
{
	func_25(iParam0, 0f);
}

void func_25(int iParam0, float fParam1)//Position - 0xDC3
{
...
float func_26(bool bParam0)//Position - 0xDF1
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_27(int iParam0, int iParam1)//Position - 0xE49
{
	int iVar0;
...
int func_28(int iParam0)//Position - 0xFD3
{
	if (iParam0 == 145)
	{
		return 7;
...
var func_29(int iParam0)//Position - 0x102B
{
	return Global_1798[iParam0 /*29*/].f_11;
}

int func_30()//Position - 0x103C
{
...
void func_31(var uParam0, var uParam1)//Position - 0x105E
{
	int iVar0;
...
void func_32(int iParam0)//Position - 0x1862
{
	if (func_37())
	{
		return;
...
void func_33(int iParam0)//Position - 0x1895
{
	if (func_37())
	{
		return;
...
void func_34(bool bParam0, bool bParam1)//Position - 0x191F
{
	if (bParam0)
	{
		if (func_36(0))
...
bool func_35()//Position - 0x1993
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

int func_36(int iParam0)//Position - 0x19A4
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
void func_38()//Position - 0x1A10
{
	Global_22211.f_6 = 1;
}

void func_39(var uParam0)//Position - 0x1A1E
{
	int iVar0;
	int iVar1;
...
int func_40(var uParam0)//Position - 0x1AA0
{
	int iVar0;
...
int func_41(var uParam0)//Position - 0x1C41
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_42(int iParam0, int iParam1, var uParam2)//Position - 0x1D06
{
	int iVar0;
	int iVar1;
...
int func_43(int iParam0)//Position - 0x1E53
{
	switch (iParam0)
	{
		case 0:
...
int func_44(var uParam0)//Position - 0x1EB5
{
	int iVar0;
	int iVar1;
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		else if (iVar0 == 1)
		{
			if (func_46(5))
			{
				...
				if (ENTITY::IS_ENTITY_IN_AREA(PLAYER::PLAYER_PED_ID(), vVar1, vVar4, 0, 1, 0))
				{
					return 1;
				}
			}
			if (func_46(6))
			{
				...
				if (ENTITY::IS_ENTITY_IN_AREA(PLAYER::PLAYER_PED_ID(), vVar7, vVar10, 0, 1, 0))
				{
					return 1;
				}
			}
...
bool func_46(int iParam0)//Position - 0x2125
{
	return MISC::IS_BIT_SET(Global_111560.f_7224[iParam0], 0);
}

int func_47(int iParam0, int iParam1)//Position - 0x213D
{
...
bool func_48(int iParam0, int iParam1, int iParam2)//Position - 0x2194
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_49(int iParam0)//Position - 0x21D6
{
...
int func_50(int iParam0)//Position - 0x2203
{
...
void func_51(int iParam0, int iParam1)//Position - 0x222F
{
	if (iParam0 < 9)
	{
...
int func_52(int iParam0)//Position - 0x224D
{
	if (iParam0 < 9)
	{
...
int func_53(int iParam0, int iParam1, int iParam2)//Position - 0x226B
{
	int iVar0;
	int iVar1;
...
void func_54(var uParam0)//Position - 0x22B0
{
	int iVar0;
	int iVar1;
...
int func_55(int iParam0, int iParam1)//Position - 0x231C
{
	int iVar0;
	int iVar1;
...
int func_56(int iParam0)//Position - 0x23D1
{
	int iVar0;
...
int func_57(int iParam0, bool bParam1)//Position - 0x240C
{
	int iVar0;
...
void func_58(var uParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x24C4
{
	int iVar0;
...
void func_59(var uParam0)//Position - 0x25EF
{
	int iVar0;
...
int func_60(var uParam0, float fParam1)//Position - 0x2646
{
	if (func_62(uParam0))
	{
...
float func_61(var uParam0)//Position - 0x2668
{
	if (func_62(uParam0))
	{
		if (func_410(uParam0))
...
bool func_62(var uParam0)//Position - 0x26A7
{
	return MISC::IS_BIT_SET(*uParam0, 1);
}

int func_63(var uParam0)//Position - 0x26B7
{
	int iVar0;
	int iVar1;
...
int func_64(var uParam0)//Position - 0x26FB
{
	if (func_46(1))
	{
...
int func_65(var uParam0, bool bParam1)//Position - 0x273C
{
	if (bParam1)
	{
		return 31;
...
int func_66(var uParam0)//Position - 0x276A
{
	int iVar0;
...
void func_67(var uParam0)//Position - 0x27AD
{
	int iVar0;
	int iVar1;
...
void func_68(var uParam0)//Position - 0x282E
{
	int iVar0;
...
int func_69(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2884
{
	char* sVar0;
	char[] cVar4[8];
...
bool func_71(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2900
{
...
int func_72(char* sParam0, int iParam1, bool bParam2)//Position - 0x294E
{
	Global_20806 = 0;
...
bool func_75(int iParam0)//Position - 0x2CBB
{
	return func_76(iParam0, 20);
}

bool func_76(int iParam0, int iParam1)//Position - 0x2CCB
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_77()//Position - 0x2CE6
{
	return -1;
}

void func_78()//Position - 0x2CEF
{
	int iVar0;
...
bool func_83(int iParam0, int iParam1)//Position - 0x2F49
{
	switch (iParam0)
	{
		case 5:
...
void func_85(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2FDB
{
...
int func_86(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4)//Position - 0x3031
{
	int iVar0;
	int iVar1;
...
struct<4> func_87(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x308B
{
	struct<4> Var0;
	int iVar4;
	int iVar5;
...
char* func_88(int iParam0)//Position - 0x3183
{
	switch (iParam0)
	{
		case 0:
...
int func_89(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x31F6
{
	char* sVar0;
	char[] cVar4[8];
...
int func_90(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4)//Position - 0x3250
{
	int iVar0;
	int iVar1;
...
void func_91(var uParam0, int iParam1)//Position - 0x373D
{
...
int func_92(int iParam0, int iParam1)//Position - 0x376E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_93(int iParam0, int iParam1)//Position - 0x37AD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_94(var uParam0)//Position - 0x3806
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_96()//Position - 0x3905
{
	return Global_98721.f_346 > 0;
}

int func_97()//Position - 0x3916
{
	if (Global_76837)
	{
		return 1;
...
bool func_98()//Position - 0x3940
{
	return Global_1312873;
}

void func_99(var uParam0, bool bParam1, int iParam2)//Position - 0x394C
{
...
void func_100(var uParam0, int iParam1, bool bParam2, int iParam3)//Position - 0x3980
{
	uParam0->f_14 = 1;
...
void func_101(var uParam0, var uParam1, var uParam2)//Position - 0x39D7
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_102(var uParam0, var uParam1)//Position - 0x41D9
{
	char[] cVar0[8];
	char[] cVar16[8];
	char[] cVar24[8];
		...
		else
		{
			...
			if ((STREAMING::HAS_ANIM_DICT_LOADED(&cVar0) && STREAMING::HAS_ANIM_DICT_LOADED(&sVar40)) && STREAMING::HAS_ANIM_DICT_LOADED(&cVar64))
			{
				if (AUDIO::PREPARE_SYNCHRONIZED_AUDIO_EVENT(&cVar88, 0))
				{
					...
					MISC::GET_GROUND_Z_FOR_3D_COORD(vVar121, &(vVar121.f_2), 0, 0);
					...
					MISC::CLEAR_AREA_OF_VEHICLES(vVar121, 10f, 0, 0, 1, 1, false, 0);
					...
					PATHFIND::SET_ROADS_IN_AREA(vVar125, vVar128, false, 1);
...
void func_103(char* sParam0, int iParam1, int iParam2)//Position - 0x45A6
{
	iParam2 = iParam2;
...
int func_104(vector3 vParam0, float fParam3)//Position - 0x45BF
{
	vector3 vVar0;
...
void func_105(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x45F1
{
	int iVar0;
...
void func_106(int iParam0, bool bParam1)//Position - 0x47AF
{
...
Vector3 func_107(int iParam0)//Position - 0x47EB
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_108(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x47FE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_109(int iParam0, int iParam1, int iParam2)//Position - 0x5014
{
	int iVar0;
...
int func_110(int iParam0)//Position - 0x50A0
{
	switch (iParam0)
	{
...
void func_111(int iParam0, int iParam1, int iParam2)//Position - 0x50DB
{
	int iVar0;
	int iVar1;
...
int func_112(int iParam0, int iParam1, int iParam2)//Position - 0x5165
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_113(int iParam0, int iParam1, int iParam2)//Position - 0x5243
{
	Global_76389[1 /*14*/] = { func_158(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 2);
}

int func_114(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x526E
{
	var uVar0;
	int iVar10;
...
int func_115(int iParam0, int iParam1, int iParam2)//Position - 0x5872
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_116(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x590B
{
	int iVar0;
...
int func_117(int iParam0, int iParam1, int iParam2)//Position - 0x59A1
{
	int iVar0;
	int iVar1;
...
int func_118(int iParam0)//Position - 0x5A42
{
	switch (iParam0)
	{
		case 0:
...
int func_119(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5AF2
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x5DF9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_121(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x69AC
{
	int iVar0;
...
int func_122(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6C90
{
	int iVar0;
...
int func_123(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6F57
{
	int iVar0;
	int iVar1;
...
int func_124(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6F8E
{
	int iVar0;
...
int func_125(int iParam0, int iParam1, int iParam2)//Position - 0x6FB7
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_126(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7281
{
	int iVar0;
...
int func_127(int iParam0, int iParam1, int iParam2)//Position - 0x750B
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_128(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7662
{
	int iVar0;
...
int func_129(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x76FA
{
	switch (iParam0)
	{
...
int func_130(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x77C8
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_131(int iParam0, int iParam1)//Position - 0x7924
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_132(int iParam0)//Position - 0x7CCB
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_133(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7D2C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_134(int iParam0, int iParam1)//Position - 0x7E28
{
	int iVar0;
...
int func_135(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7F66
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_136(int iParam0)//Position - 0x8047
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_137(int iParam0, int iParam1)//Position - 0x80CD
{
	int iVar0;
	struct<10> Var1;
...
void func_138(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x89FC
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_139(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x8B26
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_140(int iParam0, int iParam1)//Position - 0x8B6E
{
	int iVar0;
	struct<17> Var1;
...
void func_141(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA9B6
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_142(int iParam0)//Position - 0xABA0
{
	switch (iParam0)
	{
		case 0:
...
void func_143(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xAC50
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_144(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xACC1
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_145(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAF3E
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_146(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB363
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_147(int iParam0, int iParam1)//Position - 0xB656
{
	int iVar0;
	int iVar1;
...
int func_148(int iParam0, int iParam1)//Position - 0xB69C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_149(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB6FC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_150(int iParam0)//Position - 0xB780
{
...
void func_151(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xB838
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_152(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xB882
{
	int iVar0;
...
int func_153(var uParam0)//Position - 0xB8B2
{
	int iVar0;
	int iVar1;
...
int func_154(int iParam0, int iParam1, int iParam2)//Position - 0xB8E6
{
	int iVar0;
	var uVar1;
...
bool func_155(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xB918
{
	int iVar0;
...
int func_156(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xD886
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_157(int iParam0)//Position - 0xE7A4
{
	if (!MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_158(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE7F5
{
	func_221();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_159(int iParam0, int iParam1)//Position - 0xE847
{
	switch (iParam0)
	{
		case 0:
...
void func_160(int iParam0)//Position - 0xE937
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xFBAE
{
	int iVar0;
	int iVar1;
...
bool func_162(int iParam0, int iParam1, var uParam2)//Position - 0xFF3F
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_163(int iParam0, int iParam1)//Position - 0x10347
{
	switch (iParam1)
	{
		case 0:
...
int func_164(int iParam0, int iParam1)//Position - 0x10742
{
	switch (iParam1)
	{
		case 0:
...
int func_165(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x10B3D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_166(int iParam0)//Position - 0x10B7F
{
	switch (iParam0)
	{
		case -1:
...
void func_167(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10C53
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_161(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_161(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
void func_168(int iParam0)//Position - 0x10F2C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x11083
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x11591
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x11606
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x1167A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x11761
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x11AC4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x11CD5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0)//Position - 0x11F05
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_177(int iParam0)//Position - 0x12015
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x129B4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_179(int iParam0)//Position - 0x13527
{
	if (iParam0 < 136)
	{
		func_181(iParam0);
...
void func_180(int iParam0)//Position - 0x1355C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_181(int iParam0)//Position - 0x14162
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_182(int iParam0)//Position - 0x15070
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_183(int iParam0)//Position - 0x1519D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_184(int iParam0, int iParam1)//Position - 0x1529B
{
	switch (iParam0)
	{
		case 0:
...
void func_185(int iParam0)//Position - 0x1538B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_186(int iParam0)//Position - 0x1687C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_187(int iParam0)//Position - 0x169CD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_188(int iParam0)//Position - 0x16ED8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_189(int iParam0)//Position - 0x17546
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_190(int iParam0)//Position - 0x175BA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_191(int iParam0)//Position - 0x1768A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_192(int iParam0)//Position - 0x17BBA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_193(int iParam0)//Position - 0x17D51
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_194(int iParam0)//Position - 0x18550
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_195(int iParam0)//Position - 0x18660
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_196(int iParam0)//Position - 0x1958B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_197(int iParam0)//Position - 0x1A248
{
	if (iParam0 < 107)
	{
		func_200(iParam0);
...
void func_198(int iParam0)//Position - 0x1A28E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_199(int iParam0)//Position - 0x1AD33
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_200(int iParam0)//Position - 0x1BB22
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_201(int iParam0)//Position - 0x1C76D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_202(int iParam0)//Position - 0x1C9E6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_203(int iParam0, int iParam1)//Position - 0x1CB2C
{
	switch (iParam0)
	{
		case 0:
...
void func_204(int iParam0)//Position - 0x1CC1C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_205(int iParam0)//Position - 0x1D9A6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_206(int iParam0)//Position - 0x1DB20
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_207(int iParam0)//Position - 0x1E097
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_208(int iParam0)//Position - 0x1E5C1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_209(int iParam0)//Position - 0x1E635
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_210(int iParam0)//Position - 0x1E705
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_211(int iParam0)//Position - 0x1EBDD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_212(int iParam0)//Position - 0x1EE46
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_213(int iParam0)//Position - 0x1F11C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_214(int iParam0)//Position - 0x1F2E5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_215(int iParam0)//Position - 0x1FE39
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_216(int iParam0)//Position - 0x20C23
{
	if (iParam0 < 60)
	{
		func_218(iParam0);
...
void func_217(int iParam0)//Position - 0x20C58
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_218(int iParam0)//Position - 0x219F8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_219(int iParam0)//Position - 0x22084
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_220(int iParam0)//Position - 0x2216B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_221()//Position - 0x22269
{
...
int func_222(int iParam0, int iParam1, int iParam2)//Position - 0x222E2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_223(bool bParam0)//Position - 0x2253D
{
	int iVar0;
...
void func_224(int iParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, var uParam6, var uParam7)//Position - 0x2257B
{
	bool bVar0;
...
int func_225(var uParam0, var uParam1)//Position - 0x227EB
{
	int iVar0;
...
int func_226(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x22824
{
	int iVar0;
...
void func_227(var uParam0, int iParam1)//Position - 0x2295B
{
	int iVar0;
...
bool func_228(int iParam0)//Position - 0x229AA
{
	return func_229(iParam0, Global_41396);
}

int func_229(int iParam0, int iParam1)//Position - 0x229BB
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_230(int iParam0)//Position - 0x22B9C
{
	if (Global_41396 == 15)
	{
		return 0;
...
int func_231(var uParam0, var uParam1, var uParam2, float fParam3)//Position - 0x22BBE
{
	int iVar0;
	int iVar1;
	char[] cVar2[8];
...
int func_232(var uParam0, var uParam1)//Position - 0x235F8
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	...
	while (iVar36 < 3)
	{
		if (uParam0->f_61[iVar36] == 0)
		{
			if ((vVar26[iVar36 /*3*/] != 0f && vVar26[iVar36 /*3*/].f_1 != 0f) && vVar26[iVar36 /*3*/].f_2 != 0f)
			{
				...
				uParam0->f_61[iVar36] = SHAPETEST::START_SHAPE_TEST_BOX(vVar37, vVar26[iVar36 /*3*/], 0f, 0f, fVar6, 2, iVar40, iVar7, 7);
			}
		}
		else
		{
...
void func_233(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x237C8
{
	switch (iParam0)
	{
		case 0:
...
void func_234(var uParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x238EC
{
	struct<2> Var0;
	int iVar4;
...
void func_235(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x23919
{
...
int func_236(int iParam0)//Position - 0x239B4
{
	switch (iParam0)
	{
		case 0:
...
char* func_237(int iParam0)//Position - 0x23A13
{
	switch (iParam0)
	{
		case 0:
...
int func_238(var uParam0)//Position - 0x23A86
{
...
void func_239(var uParam0, int iParam1)//Position - 0x23AB0
{
...
bool func_240(int iParam0, int iParam1, float fParam2)//Position - 0x23AE3
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_241(var uParam0)//Position - 0x23B41
{
	int iVar0;
...
int func_242(int iParam0, int iParam1)//Position - 0x23BD9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_243(var uParam0)//Position - 0x23C5E
{
	if (!func_252(uParam0->f_2, -1794415470))
	{
		TASK::CLEAR_PED_TASKS(uParam0->f_2);
...
void func_244(var uParam0)//Position - 0x23C93
{
...
int func_246(int iParam0)//Position - 0x23CDA
{
	int iVar0;
...
void func_247(var uParam0)//Position - 0x23D3D
{
...
void func_248(var uParam0, float fParam1, int iParam2)//Position - 0x23DC6
{
...
int func_249(var uParam0, int iParam1, int iParam2)//Position - 0x23E09
{
...
void func_250(int iParam0, char* sParam1, int iParam2)//Position - 0x23E9F
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_251(iParam2), 1);
}

int func_251(int iParam0)//Position - 0x23EB6
{
	int iVar0;
...
int func_252(int iParam0, int iParam1)//Position - 0x240AC
{
	if (func_9(iParam0))
	{
...
void func_253(var uParam0, bool bParam1)//Position - 0x240DF
{
	if (bParam1)
	{
...
int func_254(var uParam0, var uParam1)//Position - 0x24233
{
...
int func_255(var uParam0, var uParam1)//Position - 0x242A9
{
...
int func_256(int iParam0, float fParam1)//Position - 0x24311
{
	float fVar0;
...
bool func_257(int iParam0, float fParam1)//Position - 0x24387
{
	return func_258(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_258(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2439F
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_259(&(Local_49[iVar4 /*4*/]), vVar1, iParam1, &(Local_49[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_49[iVar4 /*4*/].f_3) < iParam4);
}

int func_259(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x24460
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_260(int iParam0, int iParam1)//Position - 0x2458C
{
	int iVar0;
...
int func_262(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2469B
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_263(vector3 vParam0, vector3 vParam3)//Position - 0x2472C
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_264(vector3 vParam0)//Position - 0x2474D
{
	float fVar0;
	float fVar1;
...
void func_265(var uParam0)//Position - 0x2478C
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_266(int iParam0, int iParam1)//Position - 0x247A7
{
	int iVar0;
...
int func_267(int iParam0)//Position - 0x247E6
{
...
void func_268(var uParam0, var uParam1)//Position - 0x2480E
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	if (!PED::IS_PED_IN_ANY_VEHICLE(uParam1->f_2, 0))
	{
		...
		else if (uParam1->f_4 < 60)
		{
			...
			iVar9 = 1 | 2 | 4 | 8;
			if (PATHFIND::GET_SAFE_COORD_FOR_PED(vVar3, 1, &vVar6, iVar9))
			{
				iVar10 = 0;
				iVar11 = 0;
				while (iVar11 < 3)
				...
				if (iVar10 == 0)
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(uParam1->f_2, vVar6, 1f, -1, 1048576000, 0, 1193033728);
					uParam1->f_4 = 60;
				}
			}
		}
...
bool func_269(int iParam0, vector3 vParam1, float fParam4)//Position - 0x24A55
{
	vector3 vVar0;
...
int func_270(var uParam0, int iParam1, int iParam2)//Position - 0x24AA8
{
	var uVar0[12];
	int iVar13;
	int iVar14;
...
int func_271(var uParam0)//Position - 0x24B6E
{
	int iVar0;
	vector3 vVar1;
...
int func_272(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x24C71
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_273(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x24D6C
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_274(int iParam0, float fParam1)//Position - 0x24E78
{
	var uVar0;
	vector3 vVar1;
...
int func_275(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0x24F0D
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_276(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x24F9B
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_277(var uParam0)//Position - 0x24FE3
{
	int iVar0;
...
int func_278(var uParam0)//Position - 0x2501B
{
	int iVar0;
...
int func_279(var uParam0, var uParam1)//Position - 0x25066
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
...
int func_280(int iParam0)//Position - 0x25273
{
	return iParam0;
}

void func_281(var uParam0, var uParam1, bool bParam2)//Position - 0x2527D
{
	if (bParam2)
	{
...
int func_282(int iParam0)//Position - 0x25324
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_283(int iParam0)//Position - 0x2535F
{
	int iVar0;
...
int func_284(var uParam0, var uParam1, var uParam2)//Position - 0x2538E
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
int func_285(var uParam0, int iParam1, float fParam2)//Position - 0x255EF
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_286(var uParam0, var uParam1, var uParam2)//Position - 0x2564F
{
	int iVar0;
...
int func_287(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x25749
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_288()//Position - 0x258F3
{
	int iVar0;
	int iVar1;
...
int func_289(int iParam0, int iParam1, int iParam2)//Position - 0x25935
{
...
int func_290(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x25969
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_291(bool bParam0)//Position - 0x25F68
{
	int iVar0;
	int iVar1;
...
void func_292(int iParam0)//Position - 0x261EA
{
	int iVar0;
...
void func_293(int iParam0)//Position - 0x26244
{
	bool bVar0;
	char cVar1[64];
...
char* func_294(int iParam0)//Position - 0x263D5
{
	switch (iParam0)
	{
		case 0:
...
int func_296(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x264DF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_297(int iParam0)//Position - 0x26B31
{
	func_318(93, iParam0);
	func_318(29, iParam0);
	func_318(30, iParam0);
...
bool func_298(int iParam0)//Position - 0x26B51
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_299(int iParam0, int iParam1, int iParam2)//Position - 0x26D01
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_300(int iParam0)//Position - 0x26D3E
{
	int iVar0;
...
int func_301(int iParam0, int iParam1)//Position - 0x270DA
{
	int iVar0;
...
int func_302(bool bParam0)//Position - 0x27453
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_303(int iParam0, int iParam1)//Position - 0x2750A
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_304(int iParam0, int iParam1)//Position - 0x27525
{
...
int func_305(var uParam0, int iParam1)//Position - 0x275C2
{
	int iVar0;
	var uVar1[78];
...
int func_306(var uParam0, int iParam1)//Position - 0x27673
{
	int iVar0;
...
bool func_307(var uParam0, int iParam1)//Position - 0x276EE
{
	return (*uParam0)[iParam1] == 78;
}

void func_308(var uParam0)//Position - 0x276FF
{
	int iVar0;
...
void func_309(var uParam0, int iParam1)//Position - 0x27733
{
	(*uParam0)[iParam1] = 78;
}

void func_310(var uParam0, float fParam1)//Position - 0x27743
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_311(var uParam0)//Position - 0x27760
{
	return uParam0->f_80;
}

bool func_312(var uParam0, int iParam1)//Position - 0x2776C
{
	return func_313(uParam0, iParam1) != -1;
}

int func_313(var uParam0, int iParam1)//Position - 0x2777E
{
	int iVar0;
...
bool func_314(var uParam0)//Position - 0x277AB
{
	return uParam0->f_79 == 1;
}

int func_315(int iParam0)//Position - 0x277B9
{
	switch (iParam0)
	{
		case 60:
...
int func_316(int iParam0, int iParam1)//Position - 0x27809
{
	int iVar0;
...
void func_317(int iParam0, int iParam1)//Position - 0x2785A
{
	int iVar0;
...
void func_318(int iParam0, int iParam1)//Position - 0x2787D
{
	int iVar0;
...
void func_319()//Position - 0x278DA
{
	int iVar0;
...
int func_320(int iParam0)//Position - 0x2794F
{
	return Global_1798[iParam0 /*29*/].f_17;
}

int func_321(int iParam0)//Position - 0x27960
{
	var uVar0;
...
void func_322()//Position - 0x279B8
{
	int iVar0;
	int iVar1;
...
void func_323()//Position - 0x279FA
{
	int iVar0;
	int iVar1;
...
void func_324()//Position - 0x27A3C
{
	int iVar0;
	int iVar1;
...
void func_325()//Position - 0x27A7E
{
	int iVar0;
	int iVar1;
...
int func_326(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9)//Position - 0x27AC0
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
struct<4> func_327(int iParam0)//Position - 0x27B4F
{
	return Global_1798[iParam0 /*29*/].f_3;
}

int func_328(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)//Position - 0x27B62
{
	int iVar0;
...
void func_329(int iParam0, char* sParam1)//Position - 0x28023
{
	if (!func_74())
	{
		return;
...
void func_330(int iParam0)//Position - 0x28048
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_331(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11)//Position - 0x285EE
{
...
void func_332(char* sParam0)//Position - 0x286A1
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}

void func_333(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6)//Position - 0x286B3
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
	if (fParam3 != -1f)
...
void func_334(int iParam0)//Position - 0x28716
{
	var uVar0;
	var uVar1;
...
void func_335(int iParam0)//Position - 0x28735
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_336()//Position - 0x287C7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_337(struct<6> Param0, struct<6> Param6)//Position - 0x28892
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
...
int func_339(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x28AE5
{
	struct<4> Var0;
	struct<4> Var4[2];
	int iVar13;
...
int func_340(char* sParam0, int iParam1)//Position - 0x28C1D
{
	int iVar0;
	int iVar1;
...
int func_341(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)//Position - 0x28C91
{
	struct<14> Var0;
...
void func_342(int iParam0)//Position - 0x28DCF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_343(int iParam0)//Position - 0x28E93
{
	switch (iParam0)
	{
		case 0:
...
bool func_344(bool bParam0)//Position - 0x28EFD
{
...
int func_345(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4)//Position - 0x28F28
{
	struct<4> Var0[2];
	int iVar9;
...
int func_346(int iParam0, int iParam1)//Position - 0x2902A
{
...
int func_347(int iParam0)//Position - 0x290D8
{
	switch (iParam0)
	{
		case 0:
...
int func_348(int iParam0)//Position - 0x2910F
{
	int iVar0;
	int iVar1;
...
int func_349(int iParam0, int iParam1)//Position - 0x291C5
{
	struct<10> Var0;
	bool bVar10;
...
int func_350()//Position - 0x2925D
{
	func_351();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_351()//Position - 0x29276
{
	int iVar0;
...
int func_352(int iParam0)//Position - 0x29373
{
	int iVar0;
	int iVar1;
...
int func_353(int iParam0)//Position - 0x293B0
{
	if (func_404(iParam0))
	{
...
var func_354(int iParam0)//Position - 0x293D5
{
	return Global_1798[iParam0 /*29*/];
}

struct<10> func_355(int iParam0)//Position - 0x293E4
{
	int iVar0;
	struct<10> Var1;
...
int func_356(int iParam0, int iParam1)//Position - 0x29433
{
	struct<14> Var0;
	bool bVar14;
...
struct<14> func_357(int iParam0)//Position - 0x294C2
{
	int iVar0;
	struct<14> Var1;
...
int func_358(int iParam0, int iParam1)//Position - 0x29511
{
	struct<15> Var0;
	bool bVar15;
...
struct<15> func_359(int iParam0)//Position - 0x295BC
{
	int iVar0;
	struct<15> Var1;
...
int func_360(int iParam0)//Position - 0x29604
{
	int iVar0;
...
int func_361(int iParam0)//Position - 0x29700
{
	vector3 vVar0;
...
int func_362(vector3 vParam0, bool bParam3)//Position - 0x29793
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= (5 - 1))
	{
		...
		{
			if (!bParam3 || MISC::IS_BIT_SET(Global_111560.f_7224.f_11[iVar0], 0))
			{
...
int func_363(var uParam0, bool bParam1)//Position - 0x29810
{
...
void func_364(int iParam0, int iParam1)//Position - 0x2989A
{
	if (iParam0 < 6)
	{
...
void func_365(int iParam0)//Position - 0x298E5
{
	if (func_62(iParam0))
	{
		if (!func_410(iParam0))
...
int func_366(int iParam0)//Position - 0x2991F
{
	if (iParam0 == 0)
	{
		return 2091854273;
...
void func_367(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x2998B
{
	func_368(sParam0, sParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8, iParam9);
}

void func_368(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x299AB
{
	int iVar0;
...
void func_369()//Position - 0x29B7F
{
	int iVar0;
...
void func_370(var uParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x29C9F
{
	if (*uParam1 != 0)
	{
...
void func_371(var uParam0)//Position - 0x29D5A
{
	int iVar0;
	int iVar1;
...
void func_372(var uParam0, var uParam1)//Position - 0x29DB5
{
	if (!PED::IS_PED_INJURED(uParam1->f_2))
	{
...
void func_374(var uParam0, int iParam1)//Position - 0x29E33
{
	if (iParam1 <= 0)
	{
		return;
...
void func_375(var uParam0, int iParam1)//Position - 0x29EB9
{
...
void func_376(var uParam0, int iParam1)//Position - 0x29EEC
{
	int iVar0;
	int iVar1;
...
int func_377(int iParam0, int iParam1)//Position - 0x29F3D
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_378(int iParam0)//Position - 0x29FDF
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_379(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_379(bool bParam0, int iParam1, int iParam2)//Position - 0x2A004
{
	if (bParam0)
	{
		return iParam1;
...
int func_380(var uParam0)//Position - 0x2A01B
{
	return uParam0 & 15;
}

void func_381(var uParam0, int iParam1)//Position - 0x2A028
{
...
void func_382(var uParam0, int iParam1)//Position - 0x2A062
{
...
void func_383(var uParam0, int iParam1)//Position - 0x2A09D
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
void func_384(int iParam0)//Position - 0x2A0D9
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
	...
	vVar6 = { Global_111560.f_2358.f_539.f_2318[iVar0 /*3*/] };
	func_386(iParam0, 0);
	if (!func_385(vVar1, 0f, 0f, 0f, 0))
	{
		fVar9 = MISC::ABSF((Global_111560.f_2358.f_539.f_2300[iVar0 /*3*/].f_2 - vVar1.z));
		fVar10 = SYSTEM::VDIST2(vVar1, Global_111560.f_2358.f_539.f_2300[iVar0 /*3*/]);
		fVar11 = SYSTEM::VMAG(Global_111560.f_2358.f_539.f_2318[iVar0 /*3*/]);
		bVar12 = false;
		if (fVar11 > 25f)
		{
			if (fVar9 > 25f)
		...
		if (bVar12)
		{
			...
			Global_111560.f_2358.f_539.f_2318[iVar0 /*3*/] = { vVar6 };
		}
	}
}

bool func_385(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x2A258
{
	if (bParam6)
	{
...
void func_386(int iParam0, bool bParam1)//Position - 0x2A29F
{
	func_399(iParam0);
...
void func_387(int iParam0)//Position - 0x2A2D3
{
	int iVar0;
...
void func_388(int iParam0)//Position - 0x2A31A
{
	int iVar0;
...
void func_389(int iParam0)//Position - 0x2A358
{
	int iVar0;
...
void func_390(int iParam0)//Position - 0x2A4E5
{
	int iVar0;
...
void func_391(int iParam0)//Position - 0x2A521
{
	int iVar0;
...
void func_392(int iParam0, bool bParam1)//Position - 0x2A57E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_393(int iParam0, var uParam1)//Position - 0x2A671
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_395(Var11.f_1)) && iVar72 < 51)
			{
...
int func_394(int iParam0)//Position - 0x2A8F9
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_395(int iParam0)//Position - 0x2A994
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
int func_396(int iParam0, int iParam1)//Position - 0x2AB26
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_397(int iParam0, var uParam1)//Position - 0x2B697
{
	int iVar0;
	int iVar1;
...
int func_398(int iParam0)//Position - 0x2B6D2
{
	int iVar0;
...
void func_399(int iParam0)//Position - 0x2B946
{
	int iVar0;
...
void func_400(var uParam0, bool bParam1)//Position - 0x2B980
{
	int iVar0;
...
void func_401(var uParam0)//Position - 0x2B9CD
{
	int iVar0;
...
void func_402(var uParam0, bool bParam1)//Position - 0x2BA4A
{
	if (uParam0->f_50 != 0)
	{
...
void func_403(var uParam0)//Position - 0x2BA68
{
	int iVar0;
...
bool func_404(int iParam0)//Position - 0x2BAB5
{
	return iParam0 < 3;
}

int func_405()//Position - 0x2BAC1
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_406(int iParam0)//Position - 0x2BADD
{
	if (iParam0 < 6)
	{
...
void func_407(int iParam0)//Position - 0x2BB3B
{
	if (func_62(iParam0))
	{
		if (func_410(iParam0))
...
int func_408(int iParam0)//Position - 0x2BB79
{
	int iVar0;
	int iVar1;
...
int func_409(int iParam0)//Position - 0x2BBC1
{
	int iVar0;
...
bool func_410(var uParam0)//Position - 0x2BBFC
{
	return MISC::IS_BIT_SET(*uParam0, 2);
}

void func_411(int iParam0)//Position - 0x2BC0C
{
	if (iParam0 >= 94)
	{
		return;
...
void func_413(int iParam0, int iParam1, int iParam2)//Position - 0x2BC56
{
	if (Global_94545 == 5)
	{
		if (!func_412())
...
bool func_414(int iParam0)//Position - 0x2BCC5
{
	return Global_41396 == iParam0;
}

void func_415(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x2BCD3
{
	func_368(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

int func_416(char* sParam0)//Position - 0x2BCF5
{
...
int func_417(char* sParam0)//Position - 0x2BD1C
{
	int iVar0;
...
void func_418(int iParam0, int iParam1)//Position - 0x2BD57
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void func_419(int iParam0, int iParam1, int iParam2)//Position - 0x2BFD7
{
	switch (iParam2)
	{
		case 0:
...
void func_420(int iParam0, int iParam1, int iParam2)//Position - 0x2C0A3
{
	func_421(iParam0, iParam1, (func_422(iParam0, iParam1) + iParam2));
}

void func_421(int iParam0, int iParam1, int iParam2)//Position - 0x2C0BE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_422(int iParam0, int iParam1)//Position - 0x2C139
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_426(int iParam0, int iParam1)//Position - 0x2C1C9
{
	if (iParam0 < 9)
	{
...
void func_427(int iParam0, int iParam1, bool bParam2)//Position - 0x2C1F4
{
	if (iParam0 < 9)
	{
		if (bParam2)
...
int func_428(int iParam0, var uParam1, var uParam2, var uParam3)//Position - 0x2C238
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_234(&uLocal_213, iVar0, PLAYER::PLAYER_PED_ID(), 1);
...
int func_429(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0x2C465
{
	int iVar0;
	var uVar1;
...
bool func_430(int iParam0, int iParam1)//Position - 0x2C4DC
{
	return !func_48(func_43(iParam0), func_43(iParam1), 0);
}

int func_431(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0x2C4F6
{
	int iVar0;
	int iVar1;
...
bool func_432(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x2C537
{
...
int func_433(int iParam0)//Position - 0x2C596
{
	int iVar0;
...
bool func_434(var uParam0, int iParam1, char* sParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15)//Position - 0x2C5DC
{
	var uVar0;
	var uVar11;
...
int func_435(var uParam0, var uParam1, int iParam2, bool bParam3)//Position - 0x2C63F
{
	int iVar0;
...
void func_436(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16)//Position - 0x2C9A9
{
	func_437(iParam0);
	(*uParam1)[0] = uParam3;
	(*uParam2)[0] = uParam4;
...
void func_437(var uParam0)//Position - 0x2CA19
{
...
void func_438()//Position - 0x2CA3F
{
	Global_20853 = 0;
	Global_20812 = 1;
	Global_20819 = 0;
...
int func_439(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4)//Position - 0x2CA78
{
	int iVar0;
	int iVar1;
...
int func_440(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4)//Position - 0x2CD60
{
	int iVar0;
...
int func_441(vector3 vParam0)//Position - 0x2CE7C
{
	vector3 vVar0;
	float fVar3;
	var uVar4;
	...
	if (!func_443())
	{
		if (Global_95627 == 0)
		{
			if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(vParam0, 1, &vVar0, &fVar3, &uVar4, 4, 3f, 0f))
			{
				...
				if ((PATHFIND::GET_SAFE_COORD_FOR_PED(vVar5 + vVar11 * Vector(1f, 1f, 1f), 1, &vVar26, 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(vVar5, vVar26, true) < 10f) && MISC::GET_DISTANCE_BETWEEN_COORDS(vVar23, vVar26, true) > 2f)
				{
					vVar26 = { vVar26 };
				}
				else
				...
				if ((PATHFIND::GET_SAFE_COORD_FOR_PED(vVar5 + vVar11 * Vector(1f, 1f, 1f), 1, &vVar29, 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(vVar5, vVar29, true) < 10f) && MISC::GET_DISTANCE_BETWEEN_COORDS(vVar23, vVar29, true) > 2f)
				{
					vVar29 = { vVar29 };
				}
				else
				...
				Global_94000[0 /*18*/] = { vVar5 };
				Global_94000[0 /*18*/].f_3 = { vVar26 - vVar5 };
				Global_94000[0 /*18*/].f_6 = { vVar29 - vVar5 };
				Global_94000[0 /*18*/].f_9 = { 0f, 0f, 0f };
				Global_94000[0 /*18*/].f_12 = 0f;
				Global_94000[0 /*18*/].f_13 = { vVar23 };
...
float func_442(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)//Position - 0x2D139
{
	return ((Param0 * Param3) + (Param0.f_1 * Param3.f_1));
}

bool func_443()//Position - 0x2D150
{
	return Global_94000[0 /*18*/].f_17 != 0;
}

void func_444()//Position - 0x2D163
{
	Global_94000[0 /*18*/].f_17 = 0;
}

bool func_445()//Position - 0x2D175
{
	return Global_94000[0 /*18*/].f_17 & 1024 != 0;
}

int func_446(var uParam0)//Position - 0x2D18C
{
...
int func_447(var uParam0)//Position - 0x2D1AD
{
...
int func_448(int iParam0, var uParam1, var uParam2)//Position - 0x2D1CE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_449(int iParam0, int iParam1)//Position - 0x2D270
{
	var uVar0;
	var uVar1;
...
int func_450(int iParam0, int iParam1)//Position - 0x2D2D7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_451(int iParam0, int iParam1)//Position - 0x2D33C
{
	int iVar0;
	int iVar1;
...
bool func_452(int iParam0, int iParam1)//Position - 0x2D36B
{
	return !func_48(func_43(iParam0), func_43(iParam1), 2);
}

int func_453(var uParam0, int iParam1)//Position - 0x2D385
{
	int iVar0;
	char* sVar1;
	char[] cVar5[8];
...
int func_454(int iParam0, char* sParam1, char* sParam2)//Position - 0x2D3C9
{
...
int func_455(int iParam0, int iParam1)//Position - 0x2D456
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int func_456(int iParam0, var uParam1, var uParam2, var uParam3)//Position - 0x2D4EC
{
...
int func_457(int iParam0, var uParam1, var uParam2)//Position - 0x2D552
{
	switch (iParam0)
	{
		case 0:
...
int func_458(int iParam0, int iParam1)//Position - 0x2D5EB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_459(int iParam0, int iParam1)//Position - 0x2D677
{
	int iVar0;
...
bool func_460(int iParam0, int iParam1)//Position - 0x2D6BD
{
	return !func_48(func_43(iParam0), func_43(iParam1), 1);
}

int func_461(int iParam0)//Position - 0x2D6D7
{
	if (func_462(iParam0))
	{
		return 0;
...
int func_462(int iParam0)//Position - 0x2D6ED
{
	if (iParam0 < 6)
	{
...
void func_463(var uParam0)//Position - 0x2D74E
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
int func_464(int iParam0)//Position - 0x2D764
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_465(int iParam0)//Position - 0x2D7CF
{
	func_351();
	return iParam0 == Global_111560.f_2358.f_539.f_4321;
}

int func_466(int iParam0)//Position - 0x2D7EB
{
	if (Global_21919 == 0)
	{
		return 0;
...
int func_467(int iParam0, var uParam1)//Position - 0x2D83F
{
	int iVar0;
...
int func_468()//Position - 0x2D8A6
{
	func_351();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_469(int iParam0, int iParam1)//Position - 0x2D8BF
{
	if (iParam0 < 9)
	{
...
void func_470()//Position - 0x2D8EC
{
}

void func_471()//Position - 0x2D8F4
{
	func_474(1);
	func_472();
	func_401(&uLocal_131);
...
void func_472()//Position - 0x2D90B
{
	func_473(11, 0, 68);
	func_473(13, 1, 96);
	func_473(16, 1, 97);
...
void func_473(int iParam0, int iParam1, int iParam2)//Position - 0x2D9D1
{
	Global_94435[iParam0 /*2*/].f_1 = iParam1;
	Global_94435[iParam0 /*2*/] = iParam2;
}

void func_474(bool bParam0)//Position - 0x2D9EF
{
	if (bParam0)
	{
...
void func_475(int iParam0)//Position - 0x2E355
{
	Global_94000[iLocal_126 /*18*/].f_17 = (Global_94000[iLocal_126 /*18*/].f_17 || iParam0);
}

void func_476(int iParam0)//Position - 0x2E374
{
	Global_94000[iLocal_126 /*18*/].f_17 = (Global_94000[iLocal_126 /*18*/].f_17 || iParam0);
}

void func_477(vector3 vParam0, float fParam3, vector3 vParam4)//Position - 0x2E393
{
	Global_94000[iLocal_126 /*18*/].f_9 = { vParam0 };
	Global_94000[iLocal_126 /*18*/].f_12 = fParam3;
	Global_94000[iLocal_126 /*18*/].f_13 = { vParam4 };
}

void func_478(int iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, int iParam10)//Position - 0x2E3C7
{
	iLocal_126 = iParam0;
	Global_94000[iLocal_126 /*18*/] = { vParam1 };
	Global_94000[iLocal_126 /*18*/].f_3 = { vParam4 };
	Global_94000[iLocal_126 /*18*/].f_6 = { vParam7 };
	Global_94000[iLocal_126 /*18*/].f_17 = 0;
	Global_94000[iLocal_126 /*18*/].f_16 = iParam10;
}

void func_479()//Position - 0x2E418
{
	int iVar0;
	int iVar1;
