...
int func_14()//Position - 0x111E
{
	return Global_1312745;
}

int func_15(int iParam0, int iParam1)//Position - 0x112A
{
	switch (iParam0)
	{
		case 0:
...
int func_16(int iParam0)//Position - 0x149E
{
	switch (iParam0)
	{
		case 29:
...
void func_17(int iParam0)//Position - 0x14CD
{
	int iVar0;
	int iVar1;
...
void func_18(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x150F
{
	func_19(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_19(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x1531
{
	int iVar0;
...
bool func_23(int iParam0)//Position - 0x1968
{
...
int func_25(int iParam0)//Position - 0x1982
{
	int iVar0;
	int iVar1;
...
int func_26(int iParam0)//Position - 0x19BF
{
	if (func_24(iParam0))
	{
...
var func_27(int iParam0)//Position - 0x19E4
{
	return Global_1798[iParam0 /*29*/];
}

int func_28(int iParam0)//Position - 0x19F3
{
	int iVar0;
	int iVar1;
...
void func_29(int iParam0, int iParam1)//Position - 0x1A36
{
	MISC::SET_BIT(&(Global_111560.f_24990.f_8[iParam0]), iParam1);
}

int func_30(int iParam0)//Position - 0x1A51
{
	int iVar0;
...
int func_32(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x1B1F
{
...
int func_33()//Position - 0x1CF9
{
	return 1;
}

int func_34()//Position - 0x1D02
{
...
void func_35()//Position - 0x1D24
{
}

void func_36()//Position - 0x1D2C
{
	if (!bLocal_243)
	{
		if (func_56())
...
bool func_37(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1EAB
{
...
int func_38(char* sParam0, int iParam1, bool bParam2)//Position - 0x1EF9
{
	Global_20806 = 0;
...
bool func_41(int iParam0)//Position - 0x2266
{
	return func_42(iParam0, 20);
}

bool func_42(int iParam0, int iParam1)//Position - 0x2276
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_43()//Position - 0x2291
{
	return -1;
}

void func_44()//Position - 0x229A
{
	int iVar0;
...
int func_49()//Position - 0x24C3
{
	func_22();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_50()//Position - 0x24DC
{
	int iVar0;
...
bool func_51(int iParam0, int iParam1)//Position - 0x2534
{
	switch (iParam0)
	{
		case 5:
...
void func_53(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x25C6
{
...
void func_54()//Position - 0x261C
{
	Global_19671 = 0;
	func_55();
}

void func_55()//Position - 0x262C
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_58()//Position - 0x2A9E
{
	if (!bLocal_244)
	{
		if (!PED::IS_PED_INJURED(iLocal_70))
		{
			if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_70, 242628503) == 7 && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_70, PLAYER::PLAYER_PED_ID(), 2.8f, 2.8f, 2.8f, 0, 1, 0))
			{
				if (!iLocal_245)
				{
					iLocal_250 = 500;
...
int func_59(int iParam0, int iParam1, int iParam2)//Position - 0x2C28
{
...
int func_60(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x2C5C
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_61(bool bParam0)//Position - 0x325B
{
	int iVar0;
	int iVar1;
...
void func_62(int iParam0)//Position - 0x34DD
{
	int iVar0;
...
void func_63(int iParam0)//Position - 0x3537
{
	bool bVar0;
	char cVar1[64];
...
char* func_64(int iParam0)//Position - 0x36C8
{
	switch (iParam0)
	{
		case 0:
...
void func_66(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x37D2
{
	int iVar0;
...
int func_67(var uParam0)//Position - 0x3802
{
	int iVar0;
	int iVar1;
...
void func_68(int iParam0)//Position - 0x3836
{
	func_89(93, iParam0);
	func_89(29, iParam0);
	func_89(30, iParam0);
...
bool func_69(int iParam0)//Position - 0x3856
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_70(int iParam0, int iParam1, int iParam2)//Position - 0x3A06
{
	int iVar0;
	var uVar1;
...
int func_71(int iParam0, int iParam1, int iParam2)//Position - 0x3A38
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_72(int iParam0)//Position - 0x3A75
{
	int iVar0;
...
int func_73(int iParam0, int iParam1)//Position - 0x3E11
{
	int iVar0;
...
int func_74(bool bParam0)//Position - 0x417C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_75(int iParam0, int iParam1)//Position - 0x4233
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_76(int iParam0, int iParam1)//Position - 0x424E
{
...
int func_77(var uParam0, int iParam1)//Position - 0x42EB
{
	int iVar0;
	var uVar1[78];
...
int func_78(var uParam0, int iParam1)//Position - 0x439C
{
	int iVar0;
...
bool func_79(var uParam0, int iParam1)//Position - 0x4417
{
	return (*uParam0)[iParam1] == 78;
}

void func_80(var uParam0)//Position - 0x4428
{
	int iVar0;
...
void func_81(var uParam0, int iParam1)//Position - 0x445C
{
	(*uParam0)[iParam1] = 78;
}

void func_82(var uParam0, float fParam1)//Position - 0x446C
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_83(var uParam0)//Position - 0x4489
{
	return uParam0->f_80;
}

bool func_84(var uParam0, int iParam1)//Position - 0x4495
{
	return func_85(uParam0, iParam1) != -1;
}

int func_85(var uParam0, int iParam1)//Position - 0x44A7
{
	int iVar0;
...
bool func_86(var uParam0)//Position - 0x44D4
{
	return uParam0->f_79 == 1;
}

int func_87(int iParam0)//Position - 0x44E2
{
	switch (iParam0)
	{
		case 60:
...
void func_88(int iParam0, int iParam1)//Position - 0x4532
{
	int iVar0;
...
void func_89(int iParam0, int iParam1)//Position - 0x4555
{
	int iVar0;
...
int func_91(int iParam0)//Position - 0x4627
{
	return Global_1798[iParam0 /*29*/].f_17;
}

int func_92(int iParam0)//Position - 0x4638
{
	var uVar0;
		...
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 873.9561f, -1050.806f, 33.0066f, 4.75f, 1.9f, 1f, false, true, 0))
		{
			if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_69))
				{
					...
					TASK::OPEN_SEQUENCE_TASK(&iLocal_75);
					TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_64, PLAYER::PLAYER_PED_ID(), 2f, false, 0f, 4f, true, 512, 0, -957453492, 20000);
...
void func_94(bool bParam0)//Position - 0x4934
{
	if (bParam0)
	{
		func_100();
...
void func_95(int iParam0)//Position - 0x4997
{
	if (func_98())
	{
		return;
...
void func_96(bool bParam0, bool bParam1)//Position - 0x4A21
{
	if (bParam0)
	{
		if (func_99(0))
...
bool func_97()//Position - 0x4A95
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

bool func_98()//Position - 0x4AA6
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

int func_99(int iParam0)//Position - 0x4AB8
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
int func_101(int iParam0, bool bParam1, int iParam2)//Position - 0x4B3B
{
	int iVar0;
...
int func_102(int iParam0, bool bParam1, bool bParam2)//Position - 0x4B85
{
	int iVar0;
...
float func_103(bool bParam0, float fParam1, float fParam2)//Position - 0x4C29
{
	if (bParam0)
	{
		return fParam1;
...
void func_106()//Position - 0x4E6D
{
	if (!func_135())
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_69, 0))
		{
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_49, 65f, 60f, 60f, false, true, 0) || Global_111555)
			{
...
void func_107()//Position - 0x510F
{
	Global_19671 = 0;
	func_108();
}

void func_108()//Position - 0x511F
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
int func_109(int iParam0)//Position - 0x5143
{
	if (func_113())
	{
		Global_111550 = 1;
...
void func_110(int iParam0)//Position - 0x5196
{
	switch (iParam0)
	{
		case 0:
...
void func_111(char[4] cParam0, int iParam1)//Position - 0x5277
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

char* func_112(int iParam0)//Position - 0x528E
{
	char* sVar0;
...
int func_114(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x5308
{
	int iVar0;
...
void func_115(var uParam0, int iParam1)//Position - 0x543F
{
	int iVar0;
...
bool func_116(int iParam0)//Position - 0x548E
{
	return func_117(iParam0, Global_41396);
}

int func_117(int iParam0, int iParam1)//Position - 0x549F
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_118(int iParam0)//Position - 0x5680
{
	if (Global_41396 == 15)
	{
		return 0;
...
void func_119()//Position - 0x56A2
{
	...
	ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_70, 1, 0f);
...
void func_120(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x588E
{
...
int func_123(float fParam0, bool bParam1)//Position - 0x5A1D
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_124(int iParam0, var uParam1)//Position - 0x5AD4
{
	switch (iParam0)
	{
		case 0:
...
int func_126(int iParam0)//Position - 0x6DAC
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_127(int iParam0)//Position - 0x70F2
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_128(int iParam0)//Position - 0x712A
{
	struct<2> Var0;
...
bool func_130()//Position - 0x75A9
{
	return Global_111278 > 0;
}

int func_131()//Position - 0x75B7
{
	if (Global_95621 != -1)
	{
		return 1;
...
void func_136(int iParam0)//Position - 0x769C
{
	if (iParam0 == -1)
	{
		iParam0 = func_31();
...
void func_138(int iParam0)//Position - 0x770F
{
	Global_111549 = iParam0;
}

int func_139(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x771D
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
...
bool func_140(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x7AB7
{
	if (bParam6)
	{
...
bool func_141(int iParam0)//Position - 0x7AFE
{
	int iVar0;
...
int func_142(int iParam0)//Position - 0x7B1F
{
	return func_143(iParam0, 1);
}

int func_143(int iParam0, int iParam1)//Position - 0x7B2E
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_144(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x7B81
{
	func_145(func_156(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_145(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x7B9F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_146(float fParam0, float fParam1, float fParam2)//Position - 0x7DA0
{
	float fVar0;
...
int func_147(int iParam0, int iParam1)//Position - 0x7DE2
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_148(int iParam0)//Position - 0x7E84
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_149(int iParam0)//Position - 0x7E97
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_150(int iParam0)//Position - 0x7EAA
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_151(int iParam0)//Position - 0x7EBD
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_152(int iParam0)//Position - 0x7ECF
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_153(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_153(bool bParam0, int iParam1, int iParam2)//Position - 0x7EF4
{
	if (bParam0)
	{
		return iParam1;
...
int func_154(int iParam0)//Position - 0x7F0B
{
	return iParam0 & 15;
}

int func_155(int iParam0, int iParam1)//Position - 0x7F18
{
	int iVar0;
	int iVar1;
...
void func_157(var uParam0, int iParam1)//Position - 0x806C
{
	if (iParam1 <= 0)
	{
		return;
...
void func_158(var uParam0, int iParam1)//Position - 0x80F2
{
...
void func_159(var uParam0, int iParam1)//Position - 0x8125
{
	int iVar0;
	int iVar1;
...
void func_160(var uParam0, int iParam1)//Position - 0x8176
{
...
void func_161(var uParam0, int iParam1)//Position - 0x81B0
{
...
void func_162(var uParam0, int iParam1)//Position - 0x81EB
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_163(int iParam0)//Position - 0x8227
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_164(int iParam0, int iParam1)//Position - 0x8303
{
...
int func_165(int iParam0)//Position - 0x8326
{
	int iVar0;
...
var func_166()//Position - 0x8A43
{
	return Global_98708.f_1;
}

int func_167()//Position - 0x8A51
{
	if (Global_95621 != -1)
	{
...
bool func_170()//Position - 0x8ABB
{
	return Global_98721.f_346 > 0;
}

bool func_171()//Position - 0x8ACC
{
	return Global_98721.f_345 > 0;
}

var func_172()//Position - 0x8ADD
{
	return Global_1312873;
}

int func_173()//Position - 0x8AE9
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_175(int iParam0)//Position - 0x8B2D
{
	return func_155(func_156(), iParam0);
}

int func_176(int iParam0, int iParam1, int iParam2)//Position - 0x8B3F
{
	int iVar0;
	int iVar1;
...
int func_177(int iParam0)//Position - 0x8C23
{
	if (!func_24(iParam0))
	{
		return 7;
...
bool func_178(int iParam0)//Position - 0x8C47
{
	int iVar0;
	bool bVar1;
...
void func_182(int iParam0)//Position - 0x8E64
{
	char cVar0[64];
...
void func_183(var uParam0)//Position - 0x8F19
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_184(int iParam0, bool bParam1)//Position - 0x8F56
{
	switch (iParam0)
	{
		case 0:
...
void func_185(int iParam0)//Position - 0x919F
{
	Global_41947 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_186(int iParam0)//Position - 0x91B1
{
	func_187(iParam0, 0, func_192(iParam0));
}

void func_187(int iParam0, int iParam1, int iParam2)//Position - 0x91C6
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_188(var uParam0)//Position - 0x91F5
{
	struct<16> Var0;
	int iVar16;
...
void func_189(int iParam0, var uParam1)//Position - 0x92C6
{
	Global_111560.f_24990.f_43[iParam0] = *uParam1;
}

void func_190(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x92DE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_191(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x9460
{
...
int func_192(int iParam0)//Position - 0x9498
{
	int iVar0;
