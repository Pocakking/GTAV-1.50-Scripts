...
void func_25(char* sParam0)//Position - 0x1810
{
	int iVar0;
...
void func_26(int iParam0, char* sParam1)//Position - 0x1854
{
	switch (iParam0)
	{
		case 0:
...
void func_27(char* sParam0)//Position - 0x1A1D
{
	char cVar0[64];
...
void func_28(char* sParam0)//Position - 0x1A51
{
	struct<4> Var0;
...
void func_29(char* sParam0)//Position - 0x1A7C
{
...
void func_30()//Position - 0x1A9D
{
	iLocal_254 = MISC::GET_RANDOM_INT_IN_RANGE(0, iLocal_253);
}

void func_31(char* sParam0)//Position - 0x1AAE
{
	int iVar0;
...
bool func_33(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1B1A
{
...
int func_34(char* sParam0, int iParam1, bool bParam2)//Position - 0x1B68
{
	Global_20806 = 0;
...
bool func_37(int iParam0)//Position - 0x1ED5
{
	return func_38(iParam0, 20);
}

bool func_38(int iParam0, int iParam1)//Position - 0x1EE5
{
...
bool func_46(int iParam0, int iParam1)//Position - 0x2186
{
	switch (iParam0)
	{
		case 5:
...
bool func_59()//Position - 0x24A6
{
	return Global_98721.f_345 > 0;
}

bool func_60()//Position - 0x24B7
{
	bool bVar0;
...
void func_64(char* sParam0)//Position - 0x253A
{
	struct<8> Var0;
...
void func_65(char* sParam0)//Position - 0x257A
{
	func_26(iLocal_297, sParam0);
}

void func_66(char* sParam0)//Position - 0x258B
{
	StringCopy(sParam0, "MONOLOGUE_", 16);
	StringIntConCat(sParam0, Global_111505[iLocal_251] + 1, 16);
}

void func_67(int iParam0, bool bParam1)//Position - 0x25A9
{
	int iVar0;
...
void func_68(int iParam0, bool bParam1)//Position - 0x25CA
{
	int iVar0;
...
void func_69(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x263B
{
	func_70(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_70(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x265B
{
	int iVar0;
...
int func_72(int iParam0)//Position - 0x294D
{
	int iVar0;
	int iVar1;
...
int func_75(int iParam0)//Position - 0x2A96
{
	if (func_77(iParam0))
	{
...
int func_76(int iParam0)//Position - 0x2ABD
{
	int iVar0;
...
int func_77(int iParam0)//Position - 0x2AF0
{
...
int func_78(int iParam0)//Position - 0x2B1A
{
	switch (iParam0)
	{
...
void func_79(int iParam0)//Position - 0x2BD8
{
	if (iLocal_447 == 1)
	{
...
void func_80(int iParam0, int iParam1, bool bParam2)//Position - 0x2BF7
{
	if (iLocal_447 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
...
int func_81(int iParam0, bool bParam1, int iParam2)//Position - 0x2C4A
{
	int iVar0;
...
int func_82(int iParam0, bool bParam1, bool bParam2)//Position - 0x2C94
{
	int iVar0;
...
float func_83(bool bParam0, float fParam1, float fParam2)//Position - 0x2D38
{
	if (bParam0)
	{
		return fParam1;
...
float func_84(int iParam0, int iParam1, bool bParam2)//Position - 0x2D4F
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_85(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2DAD
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_86(vector3 vParam0, vector3 vParam3)//Position - 0x2E3E
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_87(vector3 vParam0)//Position - 0x2E5F
{
	float fVar0;
	float fVar1;
...
int func_88(int iParam0)//Position - 0x2E9E
{
	var uVar0;
...
void func_91()//Position - 0x2EF2
{
	Global_19671 = 0;
	func_92();
}

void func_92()//Position - 0x2F02
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_93()//Position - 0x2F23
{
	return 0;
}

void func_94()//Position - 0x2F2C
{
}

int func_95()//Position - 0x2F34
{
	return 1;
}

float func_96(int iParam0, int iParam1)//Position - 0x2F3D
{
	return func_84(iParam0, iParam1, 1);
}

void func_97(int iParam0)//Position - 0x2F4E
{
	int iVar0;
...
int func_98(int iParam0)//Position - 0x2F7F
{
	int iVar0;
	int iVar1;
...
int func_99(int iParam0, bool bParam1)//Position - 0x2FB0
{
	if (!func_77(iParam0))
	{
		if (!bParam1)
...
void func_100(var uParam0, var uParam1)//Position - 0x3063
{
	*uParam0 = (*uParam0 || uParam1);
}

void func_101(int iParam0, bool bParam1)//Position - 0x3074
{
	if (iParam0 == 1)
	{
		TASK::TASK_PLAY_ANIM(iLocal_240, &cLocal_324, &Local_218, 2f, -2f, -1, 0, 0, 0, 0, 0);
...
int func_102(int iParam0)//Position - 0x30E6
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_103()//Position - 0x3107
{
	func_104();
}

void func_104()//Position - 0x3113
{
}

void func_105()//Position - 0x311B
{
...
bool func_112(var uParam0)//Position - 0x332E
{
	return func_113(Global_111560.f_20112, uParam0);
}

bool func_113(var uParam0, var uParam1)//Position - 0x3343
{
	return (uParam0 && uParam1) != 0;
}

int func_114(int iParam0)//Position - 0x3352
{
...
void func_115(int iParam0)//Position - 0x3479
{
	var uVar0;
...
void func_116(int iParam0)//Position - 0x3548
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
struct<6> func_117()//Position - 0x3568
{
	struct<6> Var0;
...
void func_118()//Position - 0x358C
{
	func_119();
}

void func_119()//Position - 0x3598
{
}

void func_120()//Position - 0x35A0
{
	if (iLocal_245 == -1)
	{
