...
bool func_7(int iParam0)//Position - 0x586
{
	return func_8(iParam0, 20);
}

bool func_8(int iParam0, int iParam1)//Position - 0x596
{
...
bool func_15(int iParam0)//Position - 0x7E2
{
	return Global_41396 == iParam0;
}

void func_16()//Position - 0x7F0
{
	int iVar0;
...
bool func_17(int iParam0, int iParam1)//Position - 0x847
{
	switch (iParam0)
	{
		case 5:
...
void func_19(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x8D9
{
...
void func_21(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x95E
{
...
void func_23(int iParam0, int iParam1)//Position - 0xA36
{
...
int func_25()//Position - 0xA9B
{
	func_26();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_26()//Position - 0xAB4
{
	int iVar0;
...
bool func_27(int iParam0)//Position - 0xBB1
{
	return iParam0 < 3;
}

int func_28(int iParam0)//Position - 0xBBD
{
	int iVar0;
	int iVar1;
...
int func_29(int iParam0)//Position - 0xBFA
{
	if (func_27(iParam0))
	{
...
var func_30(int iParam0)//Position - 0xC1F
{
	return Global_1798[iParam0 /*29*/];
}

int func_31()//Position - 0xC2E
{
	var uVar0[16];
	int iVar17;
	int iVar18;
...
void func_33(var uParam0, int iParam1)//Position - 0xCDE
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
