#region Local Var
	...
	vector3 vLocal_236[32] = {{ 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f } };
#endregion
...
void __EntryFunction__()//Position - 0x0
{
	...
	if (iLocal_203 == 126)
	{
		...
		AUDIO::SET_AUDIO_SCENE_VARIABLE("dlc_ch_arcade_music_volume", "ArcadeRadioVolumeDucking", Local_231.f_1);
	}
	...
	while (true)
	{
		...
		if (iLocal_198 != 0 && !func_169(vLocal_228, 0f, 0f, 0f, 0))
		{
			if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
			{
				func_168();
		...
		else if (iLocal_203 != -1 && iLocal_203 <= 126)
		{
			...
			if (iLocal_203 == 126)
			{
				iLocal_198 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vLocal_222, 2f, 1150719273, 1, 0, 0);
			}
			else
			{
				iLocal_198 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vLocal_222, 2f, 598033448, 1, 0, 0);
			}
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_198))
			{
				vLocal_225 = { ENTITY::GET_ENTITY_COORDS(iLocal_198, true) - ENTITY::GET_ENTITY_FORWARD_VECTOR(iLocal_198) * Vector(0.6f, 0.6f, 0.6f) };
				vLocal_225.z = (vLocal_225.z + 0.5f);
				vLocal_228 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_198, 0f, -0.12f, -0.0315f) };
			}
		}
		else
		{
...
Vector3 func_2()//Position - 0x34C
{
	return 2720.626f, -381.4199f, -50f;
}

Vector3 func_3(int iParam0)//Position - 0x363
{
...
int func_5(int iParam0, int iParam1)//Position - 0x5E8
{
	if (iParam1 == -1)
	{
		switch (iParam0)
...
void func_7(var uParam0, bool bParam1, bool bParam2)//Position - 0x711
{
...
void func_8(int iParam0)//Position - 0x74E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_10(int iParam0)//Position - 0x81F
{
	switch (iParam0)
	{
		case 0:
...
void func_11(var uParam0)//Position - 0x861
{
	Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_273.f_345 = uParam0;
}

int func_12()//Position - 0x87C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_13(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x8B6
{
	int iVar0;
...
int func_14(var uParam0)//Position - 0x8E6
{
	int iVar0;
	int iVar1;
...
int func_15()//Position - 0x91A
{
	return Global_1312745;
}

int func_16(int iParam0, int iParam1, int iParam2)//Position - 0x926
{
	int iVar0;
	var uVar1;
...
int func_17(int iParam0)//Position - 0x958
{
	switch (iParam0)
	{
		case 0:
...
int func_18(var uParam0, int iParam1, bool bParam2)//Position - 0x9D6
{
	if (iParam1 == -1)
	{
		return 1;
...
void func_19(var uParam0, bool bParam1, bool bParam2)//Position - 0xA34
{
	if (uParam0->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1)
...
void func_21()//Position - 0xA85
{
	...
	{
		func_175(Local_231.f_3);
		if (iLocal_199 == PLAYER::PLAYER_ID() && Local_231.f_4)
		{
			if (iLocal_203 == 126)
			{
	...
	{
		func_172(bVar0);
		if ((iLocal_199 == PLAYER::PLAYER_ID() && Local_231.f_4) && !bVar0)
		{
			if (iLocal_203 == 126)
			{
...
var func_22(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB6C
{
	int iVar0;
	int iVar1;
	var uVar2;
...
void func_23()//Position - 0x1123
{
	...
	switch (iLocal_215)
	{
		case 0:
			if (func_159() && func_158())
			{
				...
				else if ((iLocal_205 != -1 && func_154(iLocal_205, 1)) && !TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()))
				{
					func_153(2);
					func_151(&iLocal_205);
					MISC::SET_BIT(&(vLocal_236[PLAYER::PLAYER_ID() /*3*/]), 0);
		...
		case 2:
			if (Local_231.f_2 == PLAYER::PLAYER_ID() && func_148())
			{
				iLocal_206 = 0;
				func_153(1);
				MISC::CLEAR_BIT(&(vLocal_236[PLAYER::PLAYER_ID() /*3*/]), 0);
				MISC::SET_BIT(&(vLocal_236[PLAYER::PLAYER_ID() /*3*/]), 1);
		...
		case 4:
			...
			else if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar0) >= 0.96f)
			{
				...
				MISC::CLEAR_BIT(&iLocal_208, 4);
				MISC::CLEAR_BIT(&(vLocal_236[PLAYER::PLAYER_ID() /*3*/]), 1);
				MISC::CLEAR_BIT(&(vLocal_236[PLAYER::PLAYER_ID() /*3*/]), 2);
				MISC::CLEAR_BIT(&(vLocal_236[PLAYER::PLAYER_ID() /*3*/]), 3);
...
int func_26(int iParam0)//Position - 0x1444
{
	if (iParam0 == func_181())
	{
		return -1;
...
int func_27(int iParam0)//Position - 0x1469
{
	if (iParam0 == func_181())
	{
		return -1;
...
{
	vLocal_236[PLAYER::PLAYER_ID() /*3*/].f_1 = iParam0;
	MISC::SET_BIT(&(vLocal_236[PLAYER::PLAYER_ID() /*3*/]), 2);
}

int func_30(bool bParam0)//Position - 0x14C4
{
	if (!bParam0)
	{
		iLocal_206 = 1;
...
void func_31(int iParam0)//Position - 0x1530
{
	if (func_37())
	{
		return;
...
void func_32(int iParam0)//Position - 0x1563
{
	if (func_37())
	{
		return;
...
void func_34(bool bParam0, bool bParam1)//Position - 0x1614
{
	if (bParam0)
	{
		if (func_36(0))
...
bool func_35()//Position - 0x1688
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

int func_36(int iParam0)//Position - 0x1699
{
	if (iParam0 == 1)
	{
...
bool func_37()//Position - 0x16F3
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

int func_38(char* sParam0, bool bParam1, bool bParam2)//Position - 0x1705
{
	int iVar0;
	...
	if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_213))
	{
		if ((!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar0) || PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar0) >= 0.96f) || bParam1)
		{
			...
			iLocal_207 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_228, ENTITY::GET_ENTITY_ROTATION(iLocal_198, 2), 2, false, bParam2, 1065353216, 0, 1065353216);
...
void func_39(bool bParam0, int iParam1)//Position - 0x179D
{
	int iVar0;
...
void func_40(int iParam0)//Position - 0x185B
{
	if (iParam0->f_9 != 0)
	{
...
int func_41(var uParam0, bool bParam1, int iParam2)//Position - 0x1884
{
	char cVar0[64];
	int iVar16;
	int iVar17;
...
void func_43()//Position - 0x1982
{
	HUD::HIDE_HUD_AND_RADAR_THIS_FRAME();
	HUD::HIDE_SCRIPTED_HUD_COMPONENT_THIS_FRAME(19);
}

void func_44(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7, int iParam8)//Position - 0x1994
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		if (iVar5 == 1 && Global_22350.f_5728)
		{
			...
			if (MISC::GET_HASH_KEY(&(Global_22350.f_4690)) != 0 && Global_22350.f_4766 != -1)
			{
				...
				if (Global_22350.f_4768 != 0)
				{
					...
					GRAPHICS::DRAW_SPRITE(func_69(Global_22350.f_4768), func_66(Global_22350.f_4768, 1), ((Global_22347 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
				}
			...
			if (MISC::GET_HASH_KEY(&(Global_4268271.f_21)) != 0 && Global_4268271.f_65 != -1)
			{
				...
				if (Global_4268271.f_67 != 0)
				{
					...
					GRAPHICS::DRAW_SPRITE(func_69(Global_4268271.f_67), func_66(Global_4268271.f_67, 1), ((Global_22347 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
				}
				fVar51 = (fVar51 + (((HUD::_GET_TEXT_SCALE_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
									...
									if (bVar54)
									{
										if (func_75(26, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_75(26, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													GRAPHICS::DRAW_SPRITE(func_69(26), func_66(26, 1), ((fVar34 + fVar42) + fVar45), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
												}
											}
										}
										if (func_75(27, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_75(27, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													GRAPHICS::DRAW_SPRITE(func_69(27), func_66(27, 1), (((fVar34 + fVar42) + fVar45) + (fVar43 + fVar44)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
												}
											}
										}
									}
												...
												if (func_75(Global_22350.f_4433[(iVar22 + iVar28)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (func_75(Global_22350.f_4433[(iVar22 + iVar28)], bVar32, 1, &fVar36, &fVar37, bParam7))
													{
														...
														if (iVar5 == 1)
														{
															if (Global_22350.f_5083[iVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_69(Global_22350.f_4433[(iVar22 + iVar28)]), func_66(Global_22350.f_4433[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar42) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_69(Global_22350.f_4433[(iVar22 + iVar28)]), func_66(Global_22350.f_4433[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar42) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
															}
														}
												...
												if (func_75(Global_22350.f_4433[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (iVar5 == 1)
													{
														if (func_75(Global_22350.f_4433[(iVar22 + iVar14)], bVar32, 1, &fVar36, &fVar37, bParam7))
														{
															...
															{
																GRAPHICS::DRAW_SPRITE(func_69(Global_22350.f_4433[(iVar22 + iVar14)]), func_66(Global_22350.f_4433[(iVar22 + iVar14)], bVar32), (Global_22347 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
															}
															else if (Global_22350.f_5083[iVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_69(Global_22350.f_4433[(iVar22 + iVar14)]), func_66(Global_22350.f_4433[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar42) + fVar43) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_69(Global_22350.f_4433[(iVar22 + iVar14)]), func_66(Global_22350.f_4433[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar42) + fVar43) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
															}
														}
													}
									...
									if (func_75(Global_22350.f_4433[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
									{
										...
										if (iVar5 == 1)
										{
											if (func_75(Global_22350.f_4433[iVar22], bVar32, 1, &fVar36, &fVar37, bParam7))
											{
												...
												GRAPHICS::DRAW_SPRITE(func_69(Global_22350.f_4433[iVar22]), func_66(Global_22350.f_4433[iVar22], bVar32), ((fVar34 + fVar42) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), (fVar36 * func_46(Global_22350.f_4433[iVar22])), (fVar37 * func_46(Global_22350.f_4433[iVar22])), 0f, iVar47, iVar48, iVar49, iVar50, 0);
											}
										}
									}
								}
...
void func_45(int iParam0)//Position - 0x4735
{
	Global_1375006.f_1100 = iParam0;
}

float func_46(int iParam0)//Position - 0x4746
{
	switch (iParam0)
	{
		case 35:
...
void func_47(float fParam0, float fParam1, char* sParam2, float fParam3, int iParam4)//Position - 0x47B5
{
...
void func_48(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4)//Position - 0x47D4
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
bool func_49()//Position - 0x47F2
{
	return DLC::IS_DLC_PRESENT(-1762644250);
}

void func_50(bool bParam0)//Position - 0x4803
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_51(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x4849
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_52(int iParam0, var uParam1, var uParam2, var uParam3)//Position - 0x49F7
{
	switch (iParam0)
	{
		case 0:
...
void func_53(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)//Position - 0x4C81
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_54(char* sParam0)//Position - 0x5189
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}

void func_55(char* sParam0)//Position - 0x519B
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
}

bool func_56(int iParam0, int iParam1)//Position - 0x51A9
{
	bool bVar0;
...
int func_57(int iParam0, bool bParam1)//Position - 0x51F4
{
	int iVar0;
	int iVar1;
...
void func_60(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x52BD
{
...
void func_61(float fParam0)//Position - 0x53D2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_62(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4)//Position - 0x5431
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam3);
...
float func_63(char* sParam0, int iParam1, int iParam2)//Position - 0x5454
{
...
void func_65(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x5520
{
	GRAPHICS::DRAW_RECT((fParam0 + (fParam2 * 0.5f)), (fParam1 + (fParam3 * 0.5f)), fParam2, fParam3, iParam4, iParam5, iParam6, iParam7, 0);
}

var func_66(int iParam0, bool bParam1)//Position - 0x554F
{
	char* sVar0[2];
	var uVar3;
	struct<13> Var19;
...
var func_67(var uParam0)//Position - 0x5A79
{
	return uParam0;
}

struct<13> func_68(int iParam0)//Position - 0x5A83
{
	struct<13> Var0;
...
char* func_69(int iParam0)//Position - 0x5A9A
{
	var uVar0;
	struct<13> Var16;
...
void func_70(int iParam0, char* sParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)//Position - 0x5B0F
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float func_71(char* sParam0)//Position - 0x5D1B
{
...
float func_72(char* sParam0)//Position - 0x5D37
{
	if (!MISC::IS_STRING_NULL(sParam0))
	{
		if (MISC::GET_HASH_KEY(sParam0) == 0)
...
void func_73(int iParam0, bool bParam1)//Position - 0x5D74
{
	int iVar0;
...
int func_75(int iParam0, bool bParam1, bool bParam2, float fParam3, float fParam4, bool bParam5)//Position - 0x5DF2
{
	char cVar0[64];
	char cVar16[64];
	int iVar32;
	...
	if (MISC::GET_HASH_KEY(&cVar16) != 0)
	{
		...
		vVar37.y = (vVar37.y * (func_76(iParam0) / fVar34));
		if (!bParam2)
		{
...
float func_76(int iParam0)//Position - 0x5FA3
{
	switch (iParam0)
	{
		case 33:
...
int func_77(bool bParam0, bool bParam1)//Position - 0x6077
{
...
int func_78()//Position - 0x6114
{
	return Global_1312808;
}

bool func_79(int iParam0, int iParam1)//Position - 0x6120
{
	switch (iParam0)
	{
		case 5:
...
void func_82(char* sParam0, int iParam1, int iParam2)//Position - 0x6205
{
	int iVar0;
...
void func_84()//Position - 0x62BC
{
	func_82("JBOX_TOFF_NM", 0, 0);
}

void func_85(int iParam0, bool bParam1, int iParam2)//Position - 0x62CE
{
	int iVar0;
	int iVar1;
...
void func_88(int iParam0, char* sParam1, int iParam2, bool bParam3)//Position - 0x64A0
{
	char* sVar0;
...
void func_89(char* sParam0)//Position - 0x6555
{
	func_93(0, 0);
	func_92(sParam0);
	func_91(1, 2, 1, 1, 1);
...
void func_90(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x657B
{
...
void func_91(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x6625
{
...
void func_92(char* sParam0)//Position - 0x6664
{
	int iVar0;
...
void func_93(bool bParam0, bool bParam1)//Position - 0x66AF
{
	int iVar0;
	int iVar1;
	float fVar2;
...
void func_95(int iParam0, char* sParam1, int iParam2)//Position - 0x6C69
{
	char* sVar0;
...
bool func_97(char* sParam0, int iParam1, bool bParam2)//Position - 0x6D56
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool func_98(var uParam0)//Position - 0x6E4C
{
	switch (uParam0->f_9)
	{
		case 0:
...
void func_100(int iParam0)//Position - 0x71BD
{
	int iVar0;
	int iVar1;
...
void func_101(int iParam0, int iParam1, var uParam2, bool bParam3, bool bParam4, bool bParam5)//Position - 0x722A
{
	int iVar0;
...
int func_102(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x7897
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_103(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x7A42
{
	switch (iParam1)
	{
		case 1704445500:
...
void func_104(int iParam0)//Position - 0x7A7A
{
	bool bVar0;
...
void func_105(var uParam0)//Position - 0x7ACE
{
	uParam0->f_65 = 0;
...
void func_106(var uParam0)//Position - 0x7BD9
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_107(int iParam0)//Position - 0x7C21
{
...
void func_108(int iParam0, int iParam1)//Position - 0x7C4B
{
	Global_2461338 = iParam1;
	Global_2461337 = iParam0;
}

int func_109(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7, var uParam8, int iParam9, int iParam10)//Position - 0x7C5F
{
	int iVar0;
...
void func_110(struct<66> Param0, var uParam66, var uParam67, var uParam68, var uParam69, var uParam70, var uParam71, var uParam72, var uParam73, var uParam74, var uParam75, var uParam76, var uParam77, var uParam78, var uParam79, var uParam80, var uParam81, var uParam82, var uParam83, int iParam84)//Position - 0x7D9B
{
	vector3 vVar0;
	int iVar35;
...
void func_111()//Position - 0x7E2D
{
	SCRIPT::REQUEST_SCRIPT("AM_ARENA_SHP");
}

var func_112(int iParam0)//Position - 0x7E3D
{
	var uVar0;
...
char* func_114(int iParam0)//Position - 0x7E6C
{
	switch (iParam0)
	{
		case 0:
...
char* func_115(int iParam0)//Position - 0x7EF4
{
	switch (iParam0)
	{
		case 0:
...
void func_116(float fParam0)//Position - 0x7F3B
{
	vLocal_236[PLAYER::PLAYER_ID() /*3*/].f_2 = fParam0;
	MISC::SET_BIT(&(vLocal_236[PLAYER::PLAYER_ID() /*3*/]), 3);
}

int func_117()//Position - 0x7F5C
{
	int iVar0;
...
void func_118(var uParam0, var uParam1, bool bParam2, bool bParam3, var uParam4, var uParam5)//Position - 0x7FAD
{
...
int func_119(int iParam0, int iParam1, int iParam2)//Position - 0x80DD
{
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0x8142
{
	if (PAD::_IS_INPUT_DISABLED(2))
	{
		if (Global_4268347 == -2)
...
int func_123(int iParam0, int iParam1, bool bParam2)//Position - 0x81ED
{
	if (!PAD::_IS_INPUT_DISABLED(2))
	{
		return 0;
...
void func_124(bool bParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x82CD
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_125(bool bParam0)//Position - 0x8579
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_128(bool bParam0)//Position - 0x8680
{
	if (bParam0)
	{
		if (func_129())
...
bool func_129()//Position - 0x86A5
{
	return MISC::IS_BIT_SET(Global_2448961.f_2, 11);
}

bool func_130()//Position - 0x86B9
{
	return HUD::GET_PAUSE_MENU_STATE() != 0;
}

int func_131()//Position - 0x86C7
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		switch (iLocal_206)
...
int func_133(int iParam0, int iParam1)//Position - 0x880B
{
	if (func_134(iParam0))
	{
...
int func_134(int iParam0)//Position - 0x883E
{
	if (func_135(iParam0))
	{
...
int func_135(int iParam0)//Position - 0x885E
{
...
int func_136(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x887F
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_137(var uParam0)//Position - 0x88FA
{
	uParam0->f_1 = 0;
}

void func_138(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x8907
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool func_139(int iParam0)//Position - 0x8D73
{
	return iParam0 == 17;
}

void func_140()//Position - 0x8D80
{
	vector3 vVar0;
...
int func_142(int iParam0)//Position - 0x8E0B
{
	int iVar0;
...
void func_143(bool bParam0, int iParam1, int iParam2)//Position - 0x8E3C
{
	int iVar0;
	int iVar1;
...
void func_144(int iParam0, bool bParam1)//Position - 0x8F12
{
	int iVar0;
...
bool func_146()//Position - 0x8F89
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_147()//Position - 0x8F9A
{
...
int func_149()//Position - 0x8FDD
{
	return Global_1312467.f_18;
}

void func_150(char[4] cParam0)//Position - 0x8FEB
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 1, true, -1);
}

void func_151(int iParam0)//Position - 0x9001
{
	int iVar0;
...
int func_152(int iParam0)//Position - 0x9058
{
	int iVar0;
...
void func_153(int iParam0)//Position - 0x9093
{
	iLocal_215 = iParam0;
}

int func_154(int iParam0, bool bParam1)//Position - 0x909F
{
	int iVar0;
...
void func_155(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x9157
{
	int iVar0;
...
int func_157(char* sParam0)//Position - 0x92A3
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

int func_158()//Position - 0x92B6
{
...
int func_159()//Position - 0x92DA
{
	...
	if ((((((((((((((!MISC::IS_BIT_SET(Global_2507867, 5) && !func_166()) && !func_36(0)) && !func_165()) && !PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), 0)) && INTERIOR::GET_ROOM_KEY_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_ROOM_KEY_FROM_ENTITY(iLocal_198)) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_225, 0.55f, 0.8f, 1.5f, false, true, 1)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_213, "EXIT", 3)) && !func_164(PLAYER::PLAYER_ID())) && !func_163()) && iVar0) && !MISC::IS_BIT_SET(Global_1676879.f_4, 2)) && func_160(PLAYER::PLAYER_PED_ID()) <= 9) && !Global_2405071.f_2670) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
	{
		return 1;
	}
	return 0;
...
int func_160(int iParam0)//Position - 0x93E6
{
	int iVar0;
	int iVar1;
...
int func_161(int iParam0)//Position - 0x9429
{
	int iVar0;
...
int func_162(int iParam0)//Position - 0x9459
{
	int iVar0;
...
int func_164(int iParam0)//Position - 0x94AF
{
...
bool func_165()//Position - 0x94EE
{
	return Global_73784;
}

int func_166()//Position - 0x94FA
{
	if (func_167() != -1)
	{
		return 1;
...
int func_167()//Position - 0x9516
{
	return Global_2459028;
}

void func_168()//Position - 0x9522
{
	if (func_163())
	{
		if (MISC::IS_BIT_SET(vLocal_236[Local_231.f_2 /*3*/], 2))
		{
			if (vLocal_236[Local_231.f_2 /*3*/].f_1 == iLocal_212)
			{
				if (func_170())
				{
					Local_231 = 0;
			...
			else if (Local_231.f_3 != vLocal_236[Local_231.f_2 /*3*/].f_1)
			{
				Local_231.f_3 = vLocal_236[Local_231.f_2 /*3*/].f_1;
				if (iLocal_199 == Local_231.f_2)
				{
					Local_231.f_4 = 1;
				}
		...
		if (MISC::IS_BIT_SET(vLocal_236[Local_231.f_2 /*3*/], 3))
		{
			if (Local_231.f_1 != vLocal_236[Local_231.f_2 /*3*/].f_2)
			{
				Local_231.f_1 = vLocal_236[Local_231.f_2 /*3*/].f_2;
			}
		}
		if (!MISC::IS_BIT_SET(vLocal_236[Local_231.f_2 /*3*/], 1) && !MISC::IS_BIT_SET(vLocal_236[Local_231.f_2 /*3*/], 0))
		{
			Local_231.f_2 = -1;
		}
	}
	else if (MISC::IS_BIT_SET(vLocal_236[iLocal_204 /*3*/], 0))
	{
		if (!func_163())
		{
...
bool func_169(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x96B5
{
	if (bParam6)
	{
...
bool func_170()//Position - 0x96FC
{
	return Local_231 == 1;
}

void func_171()//Position - 0x9708
{
	int iVar0;
	int iVar1;
...
void func_172(bool bParam0)//Position - 0x974E
{
	if (bParam0)
	{
...
void func_173(bool bParam0)//Position - 0x9791
{
...
void func_174(int iParam0, bool bParam1)//Position - 0x97AD
{
	if (func_4(iParam0) == 97)
	{
...
void func_175(int iParam0)//Position - 0x9806
{
	if (func_5(iLocal_203, -1))
	{
...
void func_176(int iParam0)//Position - 0x989B
{
	char* sVar0;
...
void func_177(int iParam0, int iParam1)//Position - 0x98BF
{
	char* sVar0;
...
bool func_178(int iParam0)//Position - 0x9920
{
	return (func_180(iParam0) && func_179(iParam0));
}

int func_179(int iParam0)//Position - 0x9939
{
	if (iParam0 != -1)
	{
...
int func_180(int iParam0)//Position - 0x995A
{
	if (iParam0 != func_181())
	{
...
int func_181()//Position - 0x9985
{
	return -1;
}

int func_182(int iParam0)//Position - 0x998E
{
	int iVar0;
...
int func_183(int iParam0)//Position - 0x9A12
{
	if (iParam0 != func_181())
	{
...
bool func_184(int iParam0, bool bParam1)//Position - 0x9A35
{
	if (!bParam1)
	{
		if (func_185(iParam0))
...
int func_185(int iParam0)//Position - 0x9A60
{
	if (iParam0 != func_181())
	{
...
int func_186(int iParam0)//Position - 0x9A95
{
	switch (iParam0)
	{
		case 0:
...
int func_187(int iParam0)//Position - 0x9E5D
{
	if (iParam0 != func_181())
	{
...
int func_188(int iParam0, bool bParam1, bool bParam2)//Position - 0x9ECC
{
	int iVar0;
...
bool func_189(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12)//Position - 0x9F16
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

void func_190(int iParam0, var uParam1)//Position - 0x9F26
{
	*uParam1 = { Global_1590446[iParam0 /*871*/].f_273.f_63 };
}

void func_191()//Position - 0x9F44
{
	int iVar0;
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !MISC::IS_BIT_SET(iLocal_208, 2))
	{
		...
		NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&Local_231, 5);
		NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&vLocal_236, 97);
		if (!func_192())
		{
			func_206(0);
		}
...
int func_193(int iParam0)//Position - 0xA012
{
...
bool func_194()//Position - 0xA029
{
	return Global_2448961.f_593;
}

int func_195(int iParam0, int iParam1, bool bParam2)//Position - 0xA038
{
	int iVar0;
...
bool func_196()//Position - 0xA14D
{
	return Global_1312850;
}

void func_197()//Position - 0xA159
{
	SCRIPT::TERMINATE_THIS_THREAD();
}

int func_198()//Position - 0xA165
{
	var uVar0;
...
int func_199(int iParam0)//Position - 0xA181
{
	if (iParam0 != func_181())
	{
		if (func_188(iParam0, 1, 1))
...
bool func_201()//Position - 0xA3D6
{
	return Global_3934113;
}

int func_202(int iParam0)//Position - 0xA3E2
{
...
int func_203(int iParam0)//Position - 0xA41B
{
	if (iParam0 != func_181() && func_188(iParam0, 1, 1))
	{
...
int func_204(int iParam0)//Position - 0xA44F
{
	if (iParam0 != func_181() && func_188(iParam0, 1, 1))
	{
...
int func_205(int iParam0)//Position - 0xA483
{
	if (iParam0 != func_181())
	{
		if (func_188(iParam0, 1, 1))
...
void func_206(bool bParam0)//Position - 0xA4CA
{
	func_208(0);
	if (MISC::IS_BIT_SET(iLocal_208, 3))
	{
...
void func_208(bool bParam0)//Position - 0xA5C9
{
	if (bParam0)
	{
		func_209();
