										...
										if (!PED::IS_PED_INJURED(iLocal_54[0]))
										{
											...
											if (VEHICLE::_0x639431E895B9AA57(iLocal_54[0], iLocal_58, -1, 0, false) || VEHICLE::_0x639431E895B9AA57(iLocal_54[0], iLocal_58, 0, 0, false))
											{
												if (!iLocal_164)
												{
													...
													TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_58, -0.5f, 0.5f, 0f), PLAYER::PLAYER_PED_ID(), 3f, true, 0.5f, 1082130432, true, 0, 0, -957453492, 20000);
							...
							if (!PED::IS_PED_INJURED(iLocal_53))
							{
								if (!bLocal_130)
								{
									if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_53, 1785177548) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_53, 1785177548) != 0)
									{
										...
										TASK::TASK_SYNCHRONIZED_SCENE(iLocal_53, iLocal_343, "random@burial", "b_burial", 1000f, -4f, 1, 24592, 1148846080, 0);
...
int func_23()//Position - 0x208A
{
	return Global_1312745;
}

int func_24(int iParam0, int iParam1)//Position - 0x2096
{
	switch (iParam0)
	{
		case 0:
...
int func_25(int iParam0)//Position - 0x240A
{
	switch (iParam0)
	{
		case 29:
...
void func_26(int iParam0)//Position - 0x2439
{
	int iVar0;
	int iVar1;
...
void func_27(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x247B
{
	func_28(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_28(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x249B
{
	int iVar0;
...
bool func_32(int iParam0)//Position - 0x28D0
{
	return Global_41396 == iParam0;
}

bool func_33(int iParam0)//Position - 0x28DE
{
	return iParam0 < 3;
}

int func_34(int iParam0)//Position - 0x28EA
{
	int iVar0;
	int iVar1;
...
int func_35(int iParam0)//Position - 0x2927
{
	if (func_33(iParam0))
	{
...
var func_36(int iParam0)//Position - 0x294C
{
	return Global_1798[iParam0 /*29*/];
}

int func_37(int iParam0)//Position - 0x295B
{
	int iVar0;
	int iVar1;
...
void func_38(int iParam0, int iParam1)//Position - 0x299E
{
	MISC::SET_BIT(&(Global_111560.f_24990.f_8[iParam0]), iParam1);
}

int func_39(int iParam0)//Position - 0x29B9
{
	int iVar0;
...
int func_41(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x2A87
{
...
int func_42(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x2C61
{
	struct<15> Var0;
	int iVar15;
...
void func_43(int iParam0)//Position - 0x2DE1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_44(int iParam0)//Position - 0x2EA5
{
	switch (iParam0)
	{
		case 0:
...
int func_45()//Position - 0x2F0F
{
	func_31();
	return Global_111560.f_2358.f_539.f_4321;
}

int func_46()//Position - 0x2F28
{
	return 1;
}

void func_47()//Position - 0x2F31
{
	switch (iLocal_136)
	{
		case 0:
...
int func_49(bool bParam0, bool bParam1, bool bParam2)//Position - 0x326A
{
	int iVar0;
...
int func_51(vector3 vParam0)//Position - 0x33CA
{
	if (func_45() == 2)
	{
...
int func_54(char* sParam0)//Position - 0x3A70
{
	var uVar0;
...
struct<6> func_55()//Position - 0x3A98
{
	struct<6> Var0;
...
int func_56(char* sParam0)//Position - 0x3ABC
{
	var uVar0;
...
struct<6> func_57()//Position - 0x3AE4
{
	struct<6> Var0;
	int iVar6;
...
int func_60()//Position - 0x3DD1
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

int func_61()//Position - 0x3DE1
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
	{
	...
	if ((iLocal_175 - iLocal_174) > 120000)
	{
		if (!PED::IS_PED_INJURED(iLocal_53))
		{
			if (PED::IS_PED_IN_GROUP(iLocal_53))
			{
				...
				if (ENTITY::IS_ENTITY_AT_COORD(iLocal_53, vLocal_139, 100f, 100f, 100f, false, true, 0))
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_53, vLocal_139, 1f, -1, 1048576000, 0, 1193033728);
					PED::SET_PED_KEEP_TASK(iLocal_53, true);
				}
				else
				{
...
int func_66(vector3 vParam0, bool bParam3)//Position - 0x426C
{
	int iVar0;
...
float func_67(bool bParam0, float fParam1, float fParam2)//Position - 0x4298
{
	if (bParam0)
	{
		return fParam1;
...
int func_68(int iParam0, bool bParam1, int iParam2)//Position - 0x42AF
{
	int iVar0;
...
int func_69(int iParam0, bool bParam1, bool bParam2)//Position - 0x42F9
{
	int iVar0;
...
bool func_71(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x43E0
{
...
int func_72(char* sParam0, int iParam1, bool bParam2)//Position - 0x442E
{
	Global_20806 = 0;
...
bool func_75(int iParam0)//Position - 0x479B
{
	return func_76(iParam0, 20);
}

bool func_76(int iParam0, int iParam1)//Position - 0x47AB
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_77()//Position - 0x47C6
{
	return -1;
}

void func_78()//Position - 0x47CF
{
	int iVar0;
...
bool func_84(int iParam0, int iParam1)//Position - 0x4A4C
{
	switch (iParam0)
	{
		case 5:
...
void func_86(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x4ADE
{
...
void func_87(bool bParam0)//Position - 0x4B34
{
	if (bParam0)
	{
		if (iLocal_149)
...
void func_88()//Position - 0x4BA0
{
	Global_19671 = 0;
	func_89();
}

void func_89()//Position - 0x4BB0
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
bool func_90(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x4BD4
{
			...
			if (func_49(1, 0, 1))
			{
				...
				if (!iLocal_115)
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_53))
					{
						...
						TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_53);
						TASK::TASK_SYNCHRONIZED_SCENE(iLocal_53, iLocal_343, "random@burial", "untie_ped", 1000f, -1000f, 4, 0, 1148846080, 0);
...
void func_95(char[4] cParam0, int iParam1)//Position - 0x55CC
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_96(int iParam0)//Position - 0x55E3
{
...
void func_98(int iParam0)//Position - 0x565F
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_99(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x56DD
{
	if (bParam0)
	{
...
bool func_100()//Position - 0x5816
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_101(int iParam0, int iParam1)//Position - 0x5833
{
	bool bVar0;
...
int func_102(int iParam0, bool bParam1)//Position - 0x587E
{
	int iVar0;
	int iVar1;
...
int func_103(int iParam0)//Position - 0x58BF
{
...
bool func_104()//Position - 0x5901
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_105(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x5912
{
	int iVar0;
...
void func_106(int iParam0)//Position - 0x5945
{
	if (iParam0 == 1)
	{
...
void func_108(int iParam0, char* sParam1, int iParam2)//Position - 0x5A6F
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_109(iParam2), 1);
}

int func_109(int iParam0)//Position - 0x5A86
{
	int iVar0;
...
void func_110()//Position - 0x5C7B
{
	Global_19671 = 0;
	func_111();
}

void func_111()//Position - 0x5C8B
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
float func_116(int iParam0, int iParam1, bool bParam2)//Position - 0x6448
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_119(int iParam0)//Position - 0x6766
{
	if (func_122())
	{
		Global_111550 = 1;
...
void func_120(int iParam0)//Position - 0x67B9
{
	switch (iParam0)
	{
		case 0:
...
char* func_121(int iParam0)//Position - 0x689A
{
	char* sVar0;
...
int func_123(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x6912
{
	int iVar0;
...
void func_124(var uParam0, int iParam1)//Position - 0x6A49
{
	int iVar0;
...
bool func_125(int iParam0)//Position - 0x6A98
{
	return func_126(iParam0, Global_41396);
}

int func_126(int iParam0, int iParam1)//Position - 0x6AA9
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_127(int iParam0)//Position - 0x6C8A
{
	if (Global_41396 == 15)
	{
		return 0;
		...
		if (ENTITY::IS_ENTITY_ATTACHED(iLocal_60))
		{
			if (!PED::IS_PED_INJURED(iLocal_54[0]))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_54[0], "random@burial", "a_burial_stop", 3))
				{
					...
					{
						GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_burial_dirt", iLocal_60, 0f, 0f, -0.95f, 0f, 180f, 0f, 1f, 0, 0, 0);
					}
				}
...
int func_133(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5, int iParam6)//Position - 0x7575
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
void func_134(char* sParam0, int iParam1)//Position - 0x77D3
{
	func_136(sParam0);
	func_135(iParam1);
}

void func_135(int iParam0)//Position - 0x77E7
{
	if (iParam0 > 0)
	{
	}
...
void func_136(char* sParam0)//Position - 0x77F5
{
...
void func_137(int iParam0)//Position - 0x7808
{
	AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(iParam0);
}

void func_138(char* sParam0)//Position - 0x7816
{
	func_136(sParam0);
}

int func_139(int iParam0, int iParam1)//Position - 0x7824
{
	if (PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()))
	{
...
void func_140()//Position - 0x7871
{
	...
	VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_58, 5, 0, false);
	...
	TASK::TASK_SYNCHRONIZED_SCENE(iLocal_53, iLocal_343, "random@burial", "b_burial", 4f, -4f, 1, 0, 1148846080, 0);
	ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_61[0], iLocal_343, "b_burial_legstie", "random@burial", 4f, -4f, 0, 1148846080);
	ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_61[1], iLocal_343, "b_burial_wristtie", "random@burial", 4f, -4f, 0, 1148846080);
	PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_343, true);
	PED::SET_PED_KEEP_TASK(iLocal_53, true);
...
void func_141(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x7D81
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_142(int iParam0, bool bParam1)//Position - 0x7E1C
{
	if (bParam1)
	{
...
void func_143(int iParam0, int iParam1, bool bParam2)//Position - 0x7E53
{
	int iVar0;
...
void func_144(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x7EC5
{
	int iVar0;
...
int func_145(var uParam0)//Position - 0x7EF5
{
	int iVar0;
	int iVar1;
...
int func_146(int iParam0, int iParam1, int iParam2)//Position - 0x7F29
{
	int iVar0;
	var uVar1;
...
int func_147(int iParam0)//Position - 0x7F5B
{
	switch (iParam0)
	{
		case 0:
...
void func_148(int iParam0, int iParam1, bool bParam2)//Position - 0x8329
{
	int iVar0;
...
int func_149(int iParam0, int iParam1, bool bParam2)//Position - 0x839B
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_154(float fParam0, bool bParam1)//Position - 0x86CC
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_155(int iParam0, var uParam1)//Position - 0x8783
{
	switch (iParam0)
	{
		case 0:
...
int func_157(int iParam0)//Position - 0x9989
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_158(int iParam0)//Position - 0x9CCF
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_159(int iParam0)//Position - 0x9D05
{
	struct<2> Var0;
...
bool func_161()//Position - 0xA182
{
	return Global_111278 > 0;
}

int func_162()//Position - 0xA190
{
	if (Global_95621 != -1)
	{
		return 1;
...
void func_167(int iParam0)//Position - 0xA275
{
	if (iParam0 == -1)
	{
		iParam0 = func_40();
...
void func_169(int iParam0)//Position - 0xA2E8
{
	Global_111549 = iParam0;
}

int func_170(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA2F6
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
...
bool func_171(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0xA690
{
	if (bParam6)
	{
...
bool func_172(int iParam0)//Position - 0xA6D7
{
	int iVar0;
...
int func_173(int iParam0)//Position - 0xA6F8
{
	return func_174(iParam0, 1);
}

int func_174(int iParam0, int iParam1)//Position - 0xA707
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_175(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0xA75A
{
	func_176(func_187(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_176(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0xA778
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_177(float fParam0, float fParam1, float fParam2)//Position - 0xA979
{
	float fVar0;
...
int func_178(int iParam0, int iParam1)//Position - 0xA9BB
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_179(int iParam0)//Position - 0xAA5D
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_180(int iParam0)//Position - 0xAA70
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_181(int iParam0)//Position - 0xAA83
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_182(int iParam0)//Position - 0xAA96
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_183(int iParam0)//Position - 0xAAA8
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_184(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_184(bool bParam0, int iParam1, int iParam2)//Position - 0xAACD
{
	if (bParam0)
	{
		return iParam1;
...
int func_185(int iParam0)//Position - 0xAAE4
{
	return iParam0 & 15;
}

int func_186(int iParam0, int iParam1)//Position - 0xAAF1
{
	int iVar0;
	int iVar1;
...
void func_188(var uParam0, int iParam1)//Position - 0xAC43
{
	if (iParam1 <= 0)
	{
		return;
...
void func_189(var uParam0, int iParam1)//Position - 0xACC9
{
...
void func_190(var uParam0, int iParam1)//Position - 0xACFC
{
	int iVar0;
	int iVar1;
...
void func_191(var uParam0, int iParam1)//Position - 0xAD4D
{
...
void func_192(var uParam0, int iParam1)//Position - 0xAD87
{
...
void func_193(var uParam0, int iParam1)//Position - 0xADC2
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_194(int iParam0)//Position - 0xADFE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_195(int iParam0, int iParam1)//Position - 0xAEDA
{
...
int func_196(int iParam0)//Position - 0xAEFD
{
	int iVar0;
...
var func_197()//Position - 0xB61A
{
	return Global_98708.f_1;
}

int func_198()//Position - 0xB628
{
	if (Global_95621 != -1)
	{
...
bool func_201()//Position - 0xB692
{
	return Global_98721.f_346 > 0;
}

bool func_202()//Position - 0xB6A3
{
	return Global_98721.f_345 > 0;
}

var func_203()//Position - 0xB6B4
{
	return Global_1312873;
}

int func_204()//Position - 0xB6C0
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_206(int iParam0)//Position - 0xB704
{
	return func_186(func_187(), iParam0);
}

int func_207(int iParam0, int iParam1, int iParam2)//Position - 0xB716
{
	int iVar0;
	int iVar1;
...
int func_208(int iParam0)//Position - 0xB7FA
{
	if (!func_33(iParam0))
	{
		return 7;
...
bool func_209(int iParam0)//Position - 0xB81E
{
	int iVar0;
	bool bVar1;
...
void func_213(int iParam0)//Position - 0xBB9E
{
	char cVar0[64];
...
void func_214(var uParam0)//Position - 0xBC53
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_215(int iParam0, bool bParam1)//Position - 0xBC90
{
	switch (iParam0)
	{
		case 0:
...
void func_216(int iParam0)//Position - 0xBED9
{
	Global_41947 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_217(int iParam0)//Position - 0xBEEB
{
	func_218(iParam0, 0, func_223(iParam0));
}

void func_218(int iParam0, int iParam1, int iParam2)//Position - 0xBF00
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_219(var uParam0)//Position - 0xBF2F
{
	struct<16> Var0;
	int iVar16;
...
void func_220(int iParam0, var uParam1)//Position - 0xBFFE
{
	Global_111560.f_24990.f_43[iParam0] = *uParam1;
}

void func_221(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xC018
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_222(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xC19A
{
...
int func_223(int iParam0)//Position - 0xC1D2
{
	int iVar0;
...
void func_225(bool bParam0)//Position - 0xC391
{
	int iVar0;
