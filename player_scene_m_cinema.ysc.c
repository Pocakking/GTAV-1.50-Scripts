...
void func_21()//Position - 0x769
{
	...
	while (iVar0 < iLocal_72)
	{
		if (iLocal_77[iVar0] != 0)
		{
			iLocal_72[iVar0] = PED::CREATE_PED(4, iLocal_77[iVar0], vLocal_104 + vLocal_108[iVar0 /*3*/], 0f, 1, true);
...
void func_24(var uParam0, int iParam1, int iParam2, int iParam3, vector3 vParam4, float fParam7)//Position - 0x3F60
{
...
bool func_28(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x4257
{
	if (bParam6)
	{
...
int func_29(int iParam0, var uParam1, char* sParam2)//Position - 0x429E
{
	vector3 vVar0;
	int iVar3;
	var uVar4;
...
int func_30(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0x676E
{
	switch (iParam1)
	{
		case 0:
...
int func_32(int iParam0, var uParam1, var uParam2)//Position - 0x86E3
{
	switch (iParam0)
	{
		case 11:
...
char* func_33(int iParam0)//Position - 0x9052
{
	switch (iParam0)
	{
		case 2014101067:
