...
void func_1()//Position - 0x121
{
	...
	while (iVar2 < 63)
	{
		...
		{
			func_3(iLocal_74[Global_110647[iVar0 /*10*/].f_8], 0, 0);
				...
				if (!func_43(74))
				{
					...
					else if (func_23(iLocal_96))
					{
						...
						while (iVar1 <= 262)
						{
							...
							{
								if (HUD::DOES_BLIP_EXIST(Global_31111[iVar34 /*23*/].f_19))
								{
									HUD::SET_BLIP_FLASHES(Global_31111[iVar34 /*23*/].f_19, 1);
									HUD::SET_BLIP_FLASH_TIMER(Global_31111[iVar34 /*23*/].f_19, 10000);
									switch (func_9())
									{
										case 1:
...
var func_15(int iParam0)//Position - 0x8F0
{
	return Global_1798[iParam0 /*29*/];
}

bool func_16(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x8FF
{
	if (bParam6)
	{
...
Vector3 func_17(int iParam0, int iParam1)//Position - 0x946
{
	int iVar0;
...
void func_18(int iParam0, var uParam1)//Position - 0x984
{
	switch (iParam0)
	{
		case 0:
...
int func_20(int iParam0)//Position - 0x1BAB
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_21(int iParam0)//Position - 0x1EF1
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_22(int iParam0)//Position - 0x1F28
{
	struct<2> Var0;
...
bool func_23(int iParam0)//Position - 0x2374
{
	return func_24(func_42(), iParam0);
}

int func_24(int iParam0, int iParam1)//Position - 0x2386
{
	int iVar0;
	int iVar1;
...
int func_25(int iParam0)//Position - 0x2492
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_26(int iParam0)//Position - 0x24A5
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_27(int iParam0)//Position - 0x24B8
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_28(int iParam0)//Position - 0x24CB
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_29(int iParam0)//Position - 0x24DD
{
	return iParam0 & 15;
}

int func_30(int iParam0)//Position - 0x24EA
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_31(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_31(bool bParam0, int iParam1, int iParam2)//Position - 0x250F
{
	if (bParam0)
	{
		return iParam1;
...
int func_32(int iParam0)//Position - 0x2526
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_33(int iParam0, int iParam1)//Position - 0x2602
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
void func_34(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x26A4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_35(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2826
{
...
void func_36(var uParam0, int iParam1)//Position - 0x285E
{
	if (iParam1 <= 0)
	{
		return;
...
void func_37(var uParam0, int iParam1)//Position - 0x28E4
{
	int iVar0;
	int iVar1;
...
void func_38(var uParam0, int iParam1)//Position - 0x2935
{
...
void func_39(var uParam0, int iParam1)//Position - 0x2968
{
...
void func_40(var uParam0, int iParam1)//Position - 0x29A2
{
...
void func_41(var uParam0, int iParam1)//Position - 0x29DD
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_43(int iParam0)//Position - 0x2A5F
{
...
int func_45(int iParam0)//Position - 0x2AB8
{
	int iVar0;
	int iVar1;
...
int func_47(char* sParam0)//Position - 0x2B55
{
...
int func_48(char* sParam0)//Position - 0x2B7C
{
	int iVar0;
...
float func_50(int iParam0)//Position - 0x2C4E
{
...
float func_51(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x2CDA
{
	vector3 vVar0;
...
Vector3 func_52(int iParam0)//Position - 0x2D14
{
	if (iParam0 == 5)
	{
...
var func_53(int iParam0)//Position - 0x2DFA
{
	return Global_110647[iParam0 /*10*/].f_1;
}

void func_54()//Position - 0x2E0C
{
	if (func_75())
	{
		if (!func_43(114))
...
void func_55(int iParam0, int iParam1)//Position - 0x2E97
{
...
int func_56(int iParam0)//Position - 0x2ED4
{
	int iVar0;
	int iVar1;
...
void func_57(int iParam0)//Position - 0x2FFB
{
	int iVar0;
	struct<10> Var1;
...
void func_58(int iParam0)//Position - 0x30B4
{
	int iVar0;
	struct<14> Var1;
...
void func_59(int iParam0)//Position - 0x317C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_60(int iParam0)//Position - 0x3240
{
	struct<15> Var0;
	int iVar15;
	int iVar16;
...
void func_61(int iParam0)//Position - 0x32ED
{
	struct<15> Var0;
	int iVar15;
	int iVar16;
	...
	while (iVar15 < Global_111560.f_7683.f_198)
	{
		...
		{
			func_62(Global_111560.f_7683.f_137[iVar15 /*15*/].f_6);
			iVar16 = iVar15;
...
int func_62(int iParam0)//Position - 0x33A9
{
	int iVar0;
...
void func_63(int iParam0, int iParam1)//Position - 0x33FF
{
	int iVar0;
...
void func_64(int iParam0, int iParam1, int iParam2)//Position - 0x3434
{
...
void func_65(int iParam0, int iParam1, int iParam2)//Position - 0x3479
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
int func_66(int iParam0, int iParam1)//Position - 0x34BE
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_67(int iParam0, int iParam1, int iParam2)//Position - 0x34E8
{
...
int func_68(int iParam0, int iParam1)//Position - 0x3519
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_69(int iParam0)//Position - 0x3543
{
	int iVar0;
	int iVar1;
	struct<15> Var2;
...
int func_70(int iParam0)//Position - 0x361E
{
	int iVar0;
...
void func_71(int iParam0, int iParam1)//Position - 0x371A
{
	if (iParam0 == 146 || iParam0 == -1)
	{
		return;
...
int func_72(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x375F
{
	struct<14> Var0;
...
int func_73(int iParam0)//Position - 0x387A
{
	switch (iParam0)
	{
		case 0:
...
bool func_74(bool bParam0)//Position - 0x38E4
{
	...
	if (!func_82(iVar0) || iVar0 == 52)
	{
		if (!MISC::IS_BIT_SET(Global_111560.f_18569.f_390[iLocal_52], iLocal_51))
		{
			...
			else if (Global_110647[iVar0 /*10*/].f_8 != -1)
			{
				...
				{
					if (MISC::IS_BIT_SET(Global_31111[iLocal_74[Global_110647[iVar0 /*10*/].f_8] /*23*/].f_11, 6))
					{
						func_81(iLocal_74[Global_110647[iVar0 /*10*/].f_8]);
					}
				}
			}
		}
		else if (Global_110647[iVar0 /*10*/].f_8 != -1)
		{
			if (iLocal_53[Global_110647[iVar0 /*10*/].f_8])
			{
				if (!MISC::IS_BIT_SET(Global_31111[iLocal_74[Global_110647[iVar0 /*10*/].f_8] /*23*/].f_11, 6))
				{
					func_77(iLocal_74[Global_110647[iVar0 /*10*/].f_8]);
				}
			}
		}
	}
...
void func_77(int iParam0)//Position - 0x3B1C
{
	func_80(iParam0, 1, 0);
	func_79(iParam0, 1);
	func_78(iParam0, 1);
...
void func_78(int iParam0, bool bParam1)//Position - 0x3B3A
{
	int iVar0;
...
void func_79(int iParam0, bool bParam1)//Position - 0x3BC0
{
	int iVar0;
...
void func_80(int iParam0, bool bParam1, bool bParam2)//Position - 0x3C46
{
	int iVar0;
...
void func_81(int iParam0)//Position - 0x3CF2
{
	func_80(iParam0, 0, 0);
	func_79(iParam0, 1);
	func_78(iParam0, 1);
...
int func_82(int iParam0)//Position - 0x3D10
{
...
void func_83(int iParam0)//Position - 0x3D51
{
	struct<31> Var0;
	var uVar32;
	int iVar33;
	...
	if (MISC::IS_BIT_SET(Global_111560.f_18569[iParam0 /*6*/], 0) && !MISC::IS_BIT_SET(Global_111560.f_18569[iParam0 /*6*/], 3))
	{
		if (!Global_111560.f_18569[iParam0 /*6*/].f_1)
		{
			...
			Global_111560.f_18569[iParam0 /*6*/].f_2 = uVar32;
		...
		if (MISC::IS_BIT_SET(Global_111560.f_18569[iParam0 /*6*/], 1))
		{
			if (!MISC::IS_BIT_SET(Global_111560.f_18569[iParam0 /*6*/], 2))
			{
				...
				if (Var0.f_15 > 0 && bVar34)
				{
					...
					{
						func_122(Global_111560.f_18569[iParam0 /*6*/].f_2, &uVar35, &uVar36, &uVar37, &iVar38, &iVar39, &iVar40);
	...
	iVar62 = 0;
	if ((((iVar60 && !MISC::IS_BIT_SET(Global_111560.f_18569[iParam0 /*6*/], 3)) && MISC::IS_BIT_SET(Global_111560.f_18569[iParam0 /*6*/], 0)) && MISC::IS_BIT_SET(Global_111560.f_18569[iParam0 /*6*/], 1)) && MISC::IS_BIT_SET(Global_111560.f_18569[iParam0 /*6*/], 2))
	{
	...
	if (Global_110647[iParam0 /*10*/].f_7 != iVar62)
	{
		if (func_105(&(Global_110647[iParam0 /*10*/].f_8)))
		{
			...
			{
				iVar63 = iLocal_74[Global_110647[iParam0 /*10*/].f_8];
				if (iVar62 == 0)
				{
					func_3(iVar63, 0, 0);
					func_104(iVar63, 0);
			...
			Global_110647[iParam0 /*10*/].f_7 = iVar62;
		}
	}
...
int func_85(int iParam0)//Position - 0x4593
{
	if (iParam0 == 2)
	{
...
int func_86(int iParam0)//Position - 0x45F7
{
...
bool func_87(int iParam0)//Position - 0x4663
{
	int iVar0;
...
int func_88(int iParam0)//Position - 0x469F
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void func_90(int iParam0, int iParam1)//Position - 0x471A
{
	int iVar0;
...
int func_91(int iParam0)//Position - 0x47B7
{
	int iVar0;
	int iVar1;
...
int func_92(int iParam0, int iParam1)//Position - 0x481A
{
...
void func_93(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x4841
{
	int iVar0;
...
int func_94(int iParam0, int iParam1)//Position - 0x490F
{
	switch (iParam1)
	{
		case 0:
...
void func_95(int iParam0)//Position - 0x493C
{
	int iVar0;
...
void func_96(int iParam0, int iParam1)//Position - 0x49CD
{
	func_98(iParam0, 0);
	if (iParam1 == 1)
	{
...
void func_97(int iParam0, char* sParam1)//Position - 0x4D43
{
	int iVar0;
...
void func_98(int iParam0, int iParam1)//Position - 0x4D9D
{
	int iVar0;
...
void func_99(int iParam0, int iParam1)//Position - 0x4DFB
{
	int iVar0;
...
void func_100(int iParam0, var uParam1)//Position - 0x4E69
{
	int iVar0;
...
void func_101(int iParam0, vector3 vParam1)//Position - 0x4EB9
{
	int iVar0;
...
void func_102(int iParam0, bool bParam1)//Position - 0x4F4D
{
	int iVar0;
...
int func_103(int iParam0)//Position - 0x4FBF
{
...
void func_104(int iParam0, bool bParam1)//Position - 0x501F
{
	int iVar0;
...
int func_105(var uParam0)//Position - 0x50A8
{
	int iVar0;
...
void func_107(int iParam0, int iParam1)//Position - 0x5113
{
	int iVar0;
...
void func_108(int iParam0)//Position - 0x520C
{
...
void func_109(int iParam0)//Position - 0x525A
{
	struct<7> Var0;
	bool bVar7;
	bool bVar8;
...
int func_111(int iParam0)//Position - 0x57BC
{
	int iVar0;
...
int func_112(int iParam0)//Position - 0x5A11
{
	int iVar0;
...
int func_113(int iParam0)//Position - 0x5A7D
{
	return iParam0;
}

void func_114(int iParam0, var uParam1)//Position - 0x5A87
{
	int iVar0;
	int iVar1;
...
bool func_115(int iParam0)//Position - 0x6422
{
	struct<7> Var0;
	int iVar7;
...
struct<7> func_116(int iParam0)//Position - 0x6456
{
	struct<7> Var0;
...
int func_118()//Position - 0x9091
{
	return Global_30737;
}

int func_119()//Position - 0x909C
{
	return Global_30736;
}

int func_120()//Position - 0x90A7
{
...
int func_121(int iParam0, int iParam1)//Position - 0x90E5
{
	int iVar0;
...
void func_122(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x913A
{
	func_123(func_42(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_123(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x9158
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_124(float fParam0, float fParam1, float fParam2)//Position - 0x9359
{
	float fVar0;
...
int func_125(bool bParam0)//Position - 0x939B
{
	if (bParam0)
	{
...
int func_126(int iParam0)//Position - 0x93C2
{
	if (func_127(iParam0))
	{
		return 0;
...
int func_127(int iParam0)//Position - 0x93F7
{
...
int func_128(int iParam0)//Position - 0x9436
{
...
int func_129(int iParam0)//Position - 0x94A2
{
	int iVar0;
...
int func_130()//Position - 0x950A
{
	return 1;
}

int func_131(int iParam0)//Position - 0x9513
{
	if (Global_41396 == 15)
	{
		return 0;
...
bool func_132(int iParam0)//Position - 0x9535
{
	return func_133(iParam0, Global_41396);
}

int func_133(int iParam0, int iParam1)//Position - 0x9546
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_135(int iParam0, int iParam1)//Position - 0x9831
{
	int iVar0;
