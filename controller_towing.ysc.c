...
void func_2(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x19A
{
	...
	*iParam3 = 500;
	if (!ENTITY::IS_ENTITY_DEAD(iParam1, 0))
	{
		...
		func_149(Global_111560.f_19968.f_3, &vVar3, &fVar7, &uVar0, &uVar6);
		if (Global_111560.f_19968.f_3 >= 5 || uLocal_263)
		{
			func_148(iParam1, vVar3, fVar7, iParam0);
...
int func_28(var uParam0)//Position - 0x2BB6
{
...
void func_29(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2BD8
{
	int iVar0;
...
int func_30(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2C60
{
...
int func_31(int iParam0)//Position - 0x2CA0
{
	int iVar0;
...
void func_32(var uParam0, int iParam1, int iParam2)//Position - 0x2CCE
{
...
int func_33(int iParam0)//Position - 0x2DAA
{
	int iVar0;
...
int func_34(int iParam0)//Position - 0x2DEC
{
	int iVar0;
...
int func_35(int iParam0, int iParam1, int iParam2)//Position - 0x2E4F
{
	int iVar0;
...
int func_36(int iParam0, int iParam1)//Position - 0x2EDD
{
	struct<82> Var0;
...
void func_37(int iParam0, var uParam1, int iParam2)//Position - 0x2F1F
{
	int iVar0;
...
bool func_38(int iParam0)//Position - 0x3176
{
	return iParam0 < 3;
}

void func_39(int iParam0, var uParam1)//Position - 0x3182
{
	int iVar0;
...
int func_40(int iParam0)//Position - 0x342B
{
	switch (iParam0)
	{
		case 1:
...
int func_41(int iParam0, var uParam1, var uParam2)//Position - 0x34DB
{
	int iVar0;
	int iVar1;
...
int func_42(int iParam0)//Position - 0x36CE
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_43(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x36EE
{
	char* sVar0;
...
int func_44(int iParam0, int iParam1, bool bParam2)//Position - 0x381A
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_45(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x388B
{
...
int func_46(int iParam0)//Position - 0x395C
{
	int iVar0;
	int iVar1;
...
int func_47(int iParam0)//Position - 0x3999
{
	if (func_38(iParam0))
	{
...
var func_48(int iParam0)//Position - 0x39BE
{
	return Global_1798[iParam0 /*29*/];
}

void func_49(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x39CD
{
	int iVar0;
	int iVar1;
...
int func_50(int iParam0, int iParam1, int iParam2)//Position - 0x3B6D
{
	int iVar0;
	var uVar1;
...
int func_51(var uParam0)//Position - 0x3B9F
{
	int iVar0;
	int iVar1;
...
var func_52()//Position - 0x3BD3
{
	return Global_1312745;
}

int func_53(int iParam0, int iParam1)//Position - 0x3BDF
{
	var uVar0;
	var uVar1;
...
void func_54(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3C0B
{
	int iVar0;
...
void func_55(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x4155
{
	int iVar0;
...
int func_56()//Position - 0x4396
{
	func_57();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_57()//Position - 0x43AF
{
	int iVar0;
...
bool func_58(int iParam0)//Position - 0x44AC
{
	return Global_41396 == iParam0;
}

void func_59(int iParam0, bool bParam1)//Position - 0x44BA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_60(int iParam0, var uParam1)//Position - 0x45AD
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_62(Var11.f_1)) && iVar72 < 51)
			{
...
int func_61(int iParam0)//Position - 0x4835
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_62(int iParam0)//Position - 0x48D0
{
...
int func_63(int iParam0, int iParam1)//Position - 0x4A62
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_64(int iParam0, var uParam1)//Position - 0x55D3
{
	int iVar0;
	int iVar1;
...
int func_65(int iParam0)//Position - 0x560E
{
	int iVar0;
...
void func_66(int iParam0)//Position - 0x5882
{
	int iVar0;
...
void func_67(var uParam0, int iParam1)//Position - 0x58BE
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_68(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x5E19
{
	int iVar0;
	int iVar1;
...
bool func_69(int iParam0, var uParam1, var uParam2)//Position - 0x5E5D
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_70(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x6578
{
	if (bParam6)
	{
...
int func_71(var uParam0)//Position - 0x65BF
{
...
bool func_72(int iParam0)//Position - 0x661A
{
	return func_73(iParam0, 0, 1);
}

int func_73(int iParam0, int iParam1, bool bParam2)//Position - 0x662A
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_74(int iParam0)//Position - 0x6694
{
	switch (iParam0)
	{
		case 0:
...
int func_75()//Position - 0x69C4
{
	return Global_30736;
}

int func_76(int iParam0)//Position - 0x69CF
{
	return func_73(iParam0, 5, 1);
}

int func_77(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x69DF
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_78(int iParam0, bool bParam1)//Position - 0x6A81
{
	switch (iParam0)
	{
		case -1:
...
int func_79(int iParam0)//Position - 0x709E
{
	if (iParam0 != func_88())
	{
...
Vector3 func_80(int iParam0, int iParam1)//Position - 0x70FC
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_81(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x71AA
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_82(vector3 vParam0, float fParam3)//Position - 0x723F
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_83(int iParam0)//Position - 0x7283
{
	struct<6> Var0;
...
struct<6> func_84(int iParam0)//Position - 0x7407
{
	return func_85(iParam0);
}

struct<6> func_85(int iParam0)//Position - 0x7415
{
	struct<6> Var0;
...
int func_86(int iParam0, var uParam1)//Position - 0x7EDC
{
	switch (iParam0)
	{
		case 0:
...
int func_87(int iParam0)//Position - 0x7F5E
{
	if (iParam0 != func_88())
	{
...
int func_88()//Position - 0x7FBC
{
	return -1;
}

Vector3 func_89(int iParam0)//Position - 0x7FC5
{
	switch (iParam0)
	{
		case 1:
...
var func_91(int iParam0)//Position - 0x8214
{
...
bool func_94()//Position - 0x850F
{
	return Global_98721.f_345 > 0;
}

var func_95()//Position - 0x8520
{
	var uVar0;
...
void func_96(var uParam0, int iParam1)//Position - 0x8566
{
	if (iParam1 <= 0)
	{
		return;
...
void func_97(var uParam0, int iParam1)//Position - 0x85EC
{
...
void func_98(var uParam0, int iParam1)//Position - 0x861F
{
	int iVar0;
	int iVar1;
...
int func_99(int iParam0, int iParam1)//Position - 0x8670
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_100(int iParam0)//Position - 0x8712
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_101(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_101(bool bParam0, int iParam1, int iParam2)//Position - 0x8737
{
	if (bParam0)
	{
		return iParam1;
...
int func_102(var uParam0)//Position - 0x874E
{
	return uParam0 & 15;
}

void func_103(var uParam0, int iParam1)//Position - 0x875B
{
...
void func_104(var uParam0, int iParam1)//Position - 0x8795
{
...
void func_105(var uParam0, int iParam1)//Position - 0x87D0
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_106()//Position - 0x880C
{
	func_57();
	return Global_111560.f_2358.f_539.f_4321;
}

int func_107()//Position - 0x8825
{
	int iVar0;
	...
	if (SCRIPT::HAS_SCRIPT_LOADED("Towing"))
	{
		...
		if (iVar0 == 1)
		{
			...
			vLocal_53.z = 1;
			iLocal_249 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS("Towing", &vLocal_53, 9, 29500);
			SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED("Towing");
...
void func_108(var uParam0, int iParam1)//Position - 0x88C1
{
	func_109(uParam0, iParam1);
}

void func_109(var uParam0, var uParam1)//Position - 0x88D1
{
	*uParam0 = (*uParam0 || uParam1);
}

int func_110(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x88E2
{
	int iVar0;
...
void func_111(var uParam0, int iParam1)//Position - 0x8A19
{
	int iVar0;
...
bool func_112(int iParam0)//Position - 0x8A68
{
	return func_113(iParam0, Global_41396);
}

int func_113(int iParam0, int iParam1)//Position - 0x8A79
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_114(int iParam0)//Position - 0x8C5A
{
	if (Global_41396 == 15)
	{
		return 0;
...
void func_116(int iParam0)//Position - 0x8C9B
{
	iParam0->f_1 = 0f;
	iParam0->f_2 = 0f;
	*iParam0 = 0;
...
void func_117()//Position - 0x8CB1
{
	Global_22211.f_6 = 1;
}

void func_118()//Position - 0x8CBF
{
	switch (iLocal_74)
	{
		case 1:
...
void func_119(char[4] cParam0, int iParam1)//Position - 0x8E0E
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

bool func_120(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8E25
{
...
int func_121(char* sParam0, int iParam1, bool bParam2)//Position - 0x8E73
{
	Global_20806 = 0;
...
bool func_124(int iParam0)//Position - 0x91E0
{
	return func_125(iParam0, 20);
}

bool func_125(int iParam0, int iParam1)//Position - 0x91F0
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

void func_126()//Position - 0x920B
{
	int iVar0;
...
bool func_132(int iParam0, int iParam1)//Position - 0x948A
{
	switch (iParam0)
	{
		case 5:
...
void func_134(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x951C
{
...
void func_135(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x9572
{
...
float func_136(int iParam0)//Position - 0x960D
{
	if (func_141(iParam0))
	{
		if (func_138(iParam0))
...
float func_137(bool bParam0)//Position - 0x964C
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_138(int iParam0)//Position - 0x96A4
{
	return MISC::IS_BIT_SET(*iParam0, 2);
}

void func_139(int iParam0)//Position - 0x96B4
{
	func_140(iParam0, 0f);
}

void func_140(int iParam0, float fParam1)//Position - 0x96C3
{
...
bool func_141(int iParam0)//Position - 0x96F1
{
	return MISC::IS_BIT_SET(*iParam0, 1);
}

int func_142()//Position - 0x9701
{
...
int func_143(int iParam0)//Position - 0x9723
{
	int iVar0;
	int iVar1;
...
void func_144(var uParam0, int iParam1)//Position - 0x97A3
{
	func_145(uParam0, iParam1);
}

void func_145(var uParam0, var uParam1)//Position - 0x97B3
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

void func_146(var uParam0, int iParam1)//Position - 0x97C8
{
...
void func_147(int iParam0)//Position - 0x98CE
{
	if (!func_141(iParam0))
	{
		func_139(iParam0);
...
void func_148(int iParam0, vector3 vParam1, float fParam4, var uParam5)//Position - 0x98E6
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	switch (iLocal_75)
	{
		...
		case 2:
			...
			{
				if (!CAM::IS_SPHERE_VISIBLE(vLocal_258, fLocal_261) || func_22(Global_111560.f_19968.f_1, 1073741824))
				{
					if (!ENTITY::DOES_ENTITY_EXIST(iLocal_275))
					{
						iLocal_275 = VEHICLE::CREATE_VEHICLE(joaat("towtruck"), vParam1, fParam4, 1, 1, 0);
						STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("towtruck"));
						iLocal_75 = 3;
					}
				}
...
void func_149(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4)//Position - 0x9A80
{
	switch (iParam0)
	{
		case 0:
...
int func_150(var uParam0, bool bParam1, bool bParam2)//Position - 0x9B4C
{
	if (!bParam1)
	{
		if (func_114(9))
...
int func_151(int iParam0)//Position - 0x9BEB
{
	int iVar0;
...
int func_153(int iParam0)//Position - 0x9C97
{
	return Global_111560.f_24899[iParam0 /*4*/];
}

bool func_154(int iParam0, int iParam1)//Position - 0x9CAA
{
	bool bVar0;
...
int func_155(int iParam0)//Position - 0x9CF7
{
	int iVar0;
	int iVar1;
