...
int func_6(char* sParam0)//Position - 0x224
{
...
void func_9(var uParam0)//Position - 0x2C9
{
	...
	switch (uParam0->f_43.f_4)
	{
		...
		case 5:
			...
			{
				uParam0->f_43.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_48(uParam0), func_47(uParam0), 2, 1, false, 1065353216, 0, 1.12f);
...
bool func_18(int iParam0, int iParam1)//Position - 0xE56
{
	int iVar0;
...
int func_19()//Position - 0xE93
{
	return -1;
}

int func_20(bool bParam0)//Position - 0xE9C
{
...
int func_21(int iParam0)//Position - 0xF87
{
	int iVar0;
...
bool func_23(int iParam0)//Position - 0xFFE
{
	if (iParam0 == func_19())
	{
		return 0;
...
int func_24(int iParam0, int iParam1)//Position - 0x1029
{
	if (iParam0 == func_19())
	{
		return 0;
...
int func_26(int iParam0)//Position - 0x1150
{
...
int func_27()//Position - 0x1190
{
	return Global_2459028;
}

bool func_28(var uParam0)//Position - 0x119C
{
	return func_32(&(uParam0->f_43), 9);
}

void func_29(var uParam0)//Position - 0x11AE
{
	char* sVar0;
	char* sVar16;
...
void func_30(var uParam0)//Position - 0x126F
{
	char* sVar0;
...
bool func_31()//Position - 0x12E1
{
	return MISC::IS_BIT_SET(Global_1676879.f_3, 25);
}

bool func_32(var uParam0, int iParam1)//Position - 0x12F5
{
	return MISC::IS_BIT_SET(*uParam0, iParam1);
}

void func_33(int iParam0, int iParam1)//Position - 0x1306
{
	MISC::SET_BIT(iParam0, iParam1);
}

int func_34(float fParam0, float fParam1, float fParam2)//Position - 0x1316
{
	float fVar0;
	float fVar1;
...
void func_36()//Position - 0x1424
{
	Global_22211.f_6 = 1;
}

void func_37(bool bParam0)//Position - 0x1432
{
	if (bParam0)
	{
		if (func_38())
...
bool func_38()//Position - 0x1457
{
	return MISC::IS_BIT_SET(Global_2448961.f_2, 11);
}

void func_39()//Position - 0x146B
{
	MISC::SET_BIT(&Global_7357, 4);
}

void func_40(int iParam0)//Position - 0x147B
{
	if (func_46())
	{
		return;
...
void func_41(int iParam0)//Position - 0x14AE
{
	if (func_46())
	{
		return;
...
void func_43(bool bParam0, bool bParam1)//Position - 0x155F
{
	if (bParam0)
	{
		if (func_45(0))
...
bool func_44()//Position - 0x15D3
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

int func_45(int iParam0)//Position - 0x15E4
{
	if (iParam0 == 1)
	{
...
bool func_46()//Position - 0x163E
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

Vector3 func_47(var uParam0)//Position - 0x1650
{
	vector3 vVar0;
...
Vector3 func_48(var uParam0)//Position - 0x168E
{
	return (uParam0[uParam0->f_43.f_2 /*14*/])->f_8;
}

void func_49(var uParam0, char* sParam1)//Position - 0x16A4
{
	if (uParam0->f_43.f_8 == 1)
	{
		if (func_12())
...
void func_50(var uParam0, char* sParam1)//Position - 0x19C6
{
...
void func_51(var uParam0)//Position - 0x1BDE
{
...
int func_52(var uParam0)//Position - 0x1C1A
{
	int iVar0;
...
int func_53(int iParam0)//Position - 0x1C99
{
	switch (iParam0)
	{
		case 1:
...
void func_54(var uParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x1CC7
{
	int iVar0;
...
bool func_55(var uParam0)//Position - 0x1DF2
{
...
int func_56(var uParam0)//Position - 0x1E21
{
	int iVar0;
	int iVar1;
...
int func_57(var uParam0)//Position - 0x1EAA
{
	var uVar0[10];
	int iVar11;
...
int func_58(int iParam0)//Position - 0x1F5A
{
	if (iParam0 != func_19())
	{
...
int func_59(int iParam0, bool bParam1, bool bParam2)//Position - 0x1F7B
{
	int iVar0;
...
bool func_60(var uParam0)//Position - 0x1FC5
{
...
bool func_61(int iParam0)//Position - 0x1FE5
{
	return MISC::IS_BIT_SET(Global_2424073[iParam0 /*421*/].f_309.f_3, 13);
}

int func_62(int iParam0, vector3 vParam1, int iParam4)//Position - 0x2001
{
...
void func_65(var uParam0, int iParam1)//Position - 0x20E9
{
	uParam0->f_43.f_4 = iParam1;
}

void func_66(int iParam0, int iParam1)//Position - 0x20F9
{
	MISC::CLEAR_BIT(iParam0, iParam1);
}

void func_67(var uParam0)//Position - 0x2109
{
	if (uParam0->f_43.f_4 == 6)
	{
	}
...
float func_68()//Position - 0x2164
{
	return 0.13f;
}

void func_69(var uParam0)//Position - 0x2171
{
...
void func_70(int iParam0, int iParam1, bool bParam2)//Position - 0x21C9
{
	int iVar0;
...
bool func_71()//Position - 0x21ED
{
	return Global_73784;
}

int func_72()//Position - 0x21F9
{
...
int func_76()//Position - 0x2334
{
	return Global_30736;
}

bool func_77()//Position - 0x233F
{
	return Global_2448961.f_598;
}

int func_78(int iParam0)//Position - 0x234E
{
...
bool func_79()//Position - 0x2365
{
	return Global_2458999;
}

bool func_80()//Position - 0x2371
{
	return Global_2448961.f_593;
}

void func_81(var uParam0)//Position - 0x2380
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_82(int iParam0)//Position - 0x23F3
{
	vector3 vVar0;
	int iVar3;
	int iVar4;
...
int func_83(int iParam0, var uParam1)//Position - 0x2474
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
bool func_85()//Position - 0x2511
{
	return MISC::IS_BIT_SET(Global_1676879.f_4, 10);
}

int func_86()//Position - 0x2525
{
	if (Global_2424073[PLAYER::PLAYER_ID() /*421*/].f_309.f_8 != func_19())
	{
...
void func_88(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x25BC
{
	vector3 vVar0;
	float fVar3;
...
Vector3 func_89()//Position - 0x2643
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_90(vector3 vParam0, float fParam3)//Position - 0x2656
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
float func_91(int iParam0, float fParam1)//Position - 0x269A
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_92()//Position - 0x26CD
{
	return -0.5f, -0.5f, 0f;
}

void func_93(int iParam0, var uParam1, var uParam2)//Position - 0x26E0
{
	if (func_12())
	{
		switch (iParam0)
...
void func_94()//Position - 0x27C0
{
}

int func_95(int iParam0, int iParam1, bool bParam2)//Position - 0x27C8
{
	int iVar0;
