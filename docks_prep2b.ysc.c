...
void func_5(vector3 vParam0, float fParam3)//Position - 0x362
{
	func_6(&(Global_105109.f_2890), vParam0, fParam3);
}

void func_6(var uParam0, vector3 vParam1, var uParam4)//Position - 0x37B
{
	*uParam0 = { vParam1 };
	uParam0->f_6 = uParam4;
}

void func_7(vector3 vParam0, float fParam3)//Position - 0x391
{
...
bool func_8(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x3BD
{
	if (bParam6)
	{
...
void func_15(var uParam0, int iParam1)//Position - 0x5F4
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_17(Global_111560.f_18528[iVar0], &vVar2, &fVar5))
			{
...
var func_26(int iParam0)//Position - 0x13F1
{
	return Global_1798[iParam0 /*29*/];
}

int func_27()//Position - 0x1400
{
	int iVar0;
...
bool func_28(bool bParam0)//Position - 0x1435
{
...
void func_31(int iParam0, int iParam1)//Position - 0x1571
{
...
void func_32(bool bParam0, int iParam1)//Position - 0x15BB
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_33(int iParam0)//Position - 0x1691
{
	switch (iParam0)
	{
		case 71:
...
bool func_36()//Position - 0x1846
{
	return MISC::IS_BIT_SET(Global_98669.f_20, 13);
}

void func_37()//Position - 0x185A
{
	switch (iLocal_28)
	{
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_48))
			{
				MISC::CLEAR_AREA(vLocal_311, 10f, 1, 0, 0, false);
				iLocal_48 = VEHICLE::CREATE_VEHICLE(joaat("cargobob"), vLocal_311, fLocal_323, 1, 1, 0);
		...
		case 3:
			...
			else if (!PED::IS_PED_IN_VEHICLE(iLocal_31[0], iLocal_49[0], 0))
			{
		...
		case 4:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_48))
			{
				...
				VEHICLE::SET_VEHICLE_ENGINE_CAN_DEGRADE(iLocal_48, 0);
				VEHICLE::SET_VEHICLE_STRONG(iLocal_48, 1);
				VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_48, true, 1, 0);
				VEHICLE::SET_HELI_BLADES_FULL_SPEED(iLocal_48);
...
int func_38(vector3 vParam0, float fParam3)//Position - 0x1F38
{
	return func_39(&(Global_105109.f_2890), vParam0, fParam3, 0);
}

int func_39(var uParam0, vector3 vParam1, float fParam4, bool bParam5)//Position - 0x1F52
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
void func_40(int iParam0, int iParam1)//Position - 0x2203
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_41(int iParam0, var uParam1)//Position - 0x2405
{
	int iVar0;
...
int func_42(int iParam0)//Position - 0x26AE
{
	switch (iParam0)
	{
		case 1:
...
int func_43(int iParam0, var uParam1, var uParam2)//Position - 0x275E
{
	int iVar0;
	int iVar1;
...
int func_44(int iParam0)//Position - 0x2951
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_45(var uParam0)//Position - 0x2971
{
	int iVar0;
...
int func_46(int iParam0)//Position - 0x2A21
{
...
int func_47(int iParam0)//Position - 0x2AFE
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_48(int iParam0, bool bParam1)//Position - 0x2CAF
{
	int iVar0;
	struct<2> Var1;
...
int func_49(int iParam0)//Position - 0x2E2F
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_51(int iParam0)//Position - 0x2F11
{
	int iVar0;
	int iVar1;
...
int func_52()//Position - 0x53DE
{
	return 0;
}

int func_53()//Position - 0x53E7
{
	return 1;
}

int func_54()//Position - 0x53F0
{
	return 1;
}

int func_55()//Position - 0x53F9
{
...
int func_57(int iParam0)//Position - 0x54CD
{
	int iVar0;
	char* sVar1;
...
int func_58(int iParam0)//Position - 0x5513
{
	int iVar0;
...
int func_59(int iParam0)//Position - 0x554E
{
	int iVar0;
...
int func_60(int iParam0)//Position - 0x55CA
{
	int iVar0;
...
int func_61(int iParam0)//Position - 0x56B2
{
	int iVar0;
...
int func_62(int iParam0, int iParam1, bool bParam2)//Position - 0x5715
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_63(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x5786
{
...
void func_64(int iParam0, bool bParam1)//Position - 0x585E
{
	if (iParam0 == -1)
	{
		return;
...
void func_65(int iParam0, int iParam1, bool bParam2)//Position - 0x58BB
{
	if (iParam0 == -1)
	{
		return;
...
bool func_66(int iParam0, int iParam1)//Position - 0x58F6
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_67(int iParam0)//Position - 0x5919
{
	bool bVar0;
...
void func_68(var uParam0, var uParam1)//Position - 0x5A8B
{
...
int func_69(int iParam0, int iParam1)//Position - 0x5B57
{
	int iVar0;
...
int func_70(var uParam0)//Position - 0x5BC9
{
	return *uParam0;
}

int func_71(var uParam0, int iParam1)//Position - 0x5BD4
{
	int iVar0;
	int iVar1;
...
int func_72(int iParam0, int iParam1)//Position - 0x72CB
{
	struct<82> Var0;
...
void func_73(int iParam0, var uParam1, int iParam2)//Position - 0x730D
{
	int iVar0;
...
int func_74(int iParam0)//Position - 0x7569
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_75(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x762C
{
	int iVar0;
	var uVar1[3];
	int iVar5;
...
int func_76(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x7834
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_77(int iParam0, int iParam1, bool bParam2)//Position - 0x78AF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_78(int iParam0, int iParam1)//Position - 0x7910
{
	int iVar0;
...
void func_79(int iParam0, int iParam1)//Position - 0x7992
{
	int iVar0;
...
void func_80(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x7A30
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_81(int iParam0, var uParam1, var uParam2)//Position - 0x7FF0
{
	int iVar0;
	int iVar1;
...
int func_82(int iParam0)//Position - 0x81B5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_83(var uParam0)//Position - 0x8291
{
...
int func_84(int iParam0, int iParam1)//Position - 0x82D1
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_85(int iParam0, int iParam1)//Position - 0x83B6
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
void func_86(int iParam0, int iParam1)//Position - 0x872C
{
	int iVar0;
	int iVar1;
...
bool func_87()//Position - 0x87A4
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_88(int iParam0)//Position - 0x87B5
{
	int iVar0;
...
int func_89(int iParam0)//Position - 0x8800
{
...
int func_90(int iParam0)//Position - 0x8887
{
...
int func_91(int iParam0)//Position - 0x88B6
{
...
int func_92(int iParam0)//Position - 0x88D3
{
...
int func_93(int iParam0, int iParam1)//Position - 0x88F6
{
...
int func_94(int iParam0)//Position - 0x8931
{
	if (func_93(iParam0, 0))
	{
...
int func_95(int iParam0, int iParam1)//Position - 0x8954
{
	int iVar0;
...
int func_96(int iParam0, bool bParam1, bool bParam2)//Position - 0x89A1
{
	int iVar0;
...
void func_97(vector3 vParam0, float fParam3, bool bParam4)//Position - 0x89EB
{
	int iVar0;
...
int func_98(var uParam0)//Position - 0x8A3B
{
	if (func_99(uParam0))
	{
...
int func_99(var uParam0)//Position - 0x8A70
{
		...
		if (STREAMING::HAS_MODEL_LOADED(joaat("s_m_y_marine_01")) && STREAMING::HAS_MODEL_LOADED(joaat("s_m_m_pilot_02")))
		{
			...
			while (iLocal_176 <= 12)
			{
				if (iLocal_275[iLocal_176] == 0)
				{
					...
					{
						ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_33[iLocal_176], 1, 1);
						...
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_33[iLocal_176], 1);
...
void func_101(int iParam0, bool bParam1)//Position - 0x8EE6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_102(var uParam0, int iParam1)//Position - 0x8F81
{
	int iVar0;
...
void func_103(int iParam0, int iParam1)//Position - 0x8FD7
{
	Global_98669.f_22[iParam1] = iParam0;
}

bool func_104()//Position - 0x8FEB
{
	return func_98(&(Global_105109.f_2890));
}

void func_105()//Position - 0x8FFE
{
	func_106(&(Global_105109.f_2890));
}

void func_106(var uParam0)//Position - 0x9011
{
	if (func_99(uParam0))
	{
...
var func_107()//Position - 0x902F
{
	return Global_105109.f_2890.f_12.f_66;
}

bool func_108()//Position - 0x9042
{
	return func_99(&(Global_105109.f_2890));
}

void func_109(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x9055
{
	func_110(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_110(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x907E
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_111(vector3 vParam0)//Position - 0x9472
{
...
int func_112(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x949C
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_113(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x9792
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_114(vector3 vParam0)//Position - 0x9846
{
	float fVar0;
	float fVar1;
...
void func_115(int iParam0)//Position - 0x9885
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_116()//Position - 0x98EA
{
	...
	if (CAM::DOES_CAM_EXIST(iLocal_56))
	{
		...
		CAM::DESTROY_CAM(iLocal_56, 0);
	}
}

void func_117()//Position - 0x9B34
{
...
void func_118(int iParam0)//Position - 0x9B8A
{
	bool bVar0;
	struct<8> Var1;
...
int func_120(int iParam0, bool bParam1, bool bParam2)//Position - 0x9DAF
{
	return func_121(iParam0, !bParam1, bParam2);
}

int func_121(int iParam0, bool bParam1, bool bParam2)//Position - 0x9DC2
{
	int iVar0;
...
float func_122(bool bParam0, float fParam1, float fParam2)//Position - 0x9E66
{
	if (bParam0)
	{
		return fParam1;
...
int func_123(int iParam0, bool bParam1, bool bParam2)//Position - 0x9E7D
{
	return func_121(iParam0, !bParam1, bParam2);
}

void func_124(char* sParam0, int iParam1, int iParam2)//Position - 0x9E90
{
	iParam2 = iParam2;
...
int func_126(vector3 vParam0, bool bParam3)//Position - 0x9ECB
{
	int iVar0;
	...
	if (iLocal_175 == 1)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_48))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_48, 0))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_48, 0))
				{
					if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_314, 2f, 2f, 2f, 1, true, 0))
					{
					}
...
void func_128(bool bParam0, int iParam1)//Position - 0xA29D
{
	int iVar0;
...
void func_129(char[4] cParam0, int iParam1)//Position - 0xA337
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_130(int iParam0)//Position - 0xA34E
{
...
bool func_131(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0xA37B
{
...
int func_132(char* sParam0, int iParam1, bool bParam2)//Position - 0xA3DA
{
	Global_20806 = 0;
...
bool func_135(int iParam0)//Position - 0xA747
{
	return func_136(iParam0, 20);
}

bool func_136(int iParam0, int iParam1)//Position - 0xA757
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_137()//Position - 0xA772
{
	return -1;
}

void func_138()//Position - 0xA77B
{
	int iVar0;
...
bool func_144(int iParam0, int iParam1)//Position - 0xA9FA
{
	switch (iParam0)
	{
		case 5:
...
void func_146(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAA8C
{
...
int func_147(int iParam0)//Position - 0xAAE2
{
...
bool func_148(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xAB0E
{
...
void func_149(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xAB5C
{
...
void func_150(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xABF7
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar10 = func_214(&(Global_98669.f_3));
				if (iVar10 > -1)
				{
...
void func_151(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0xAD6C
{
	func_152(&Global_105109, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_152(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0xAD88
{
	int iVar0;
	int iVar1;
...
int func_153(var uParam0)//Position - 0xBC11
{
...
void func_154(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xBC33
{
	int iVar0;
...
int func_155(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0xBCBB
{
...
int func_156(int iParam0)//Position - 0xBCFB
{
	int iVar0;
...
void func_157(var uParam0, int iParam1, int iParam2)//Position - 0xBD29
{
...
int func_158(int iParam0)//Position - 0xBE05
{
	int iVar0;
...
int func_159(int iParam0, int iParam1, int iParam2)//Position - 0xBE47
{
	int iVar0;
...
int func_160(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0xBED5
{
	char* sVar0;
...
void func_161(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0xC003
{
	int iVar0;
	int iVar1;
...
int func_162(int iParam0, int iParam1, int iParam2)//Position - 0xC1A3
{
	int iVar0;
	var uVar1;
...
int func_163(var uParam0)//Position - 0xC1D5
{
	int iVar0;
	int iVar1;
...
var func_164()//Position - 0xC209
{
	return Global_1312745;
}

int func_165(int iParam0, int iParam1)//Position - 0xC215
{
	var uVar0;
	var uVar1;
...
void func_166(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0xC241
{
	int iVar0;
...
void func_167(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0xC789
{
	int iVar0;
...
int func_168()//Position - 0xC9CA
{
	func_21();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_169(int iParam0, bool bParam1)//Position - 0xC9E3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_170(int iParam0, var uParam1)//Position - 0xCAD6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_171(int iParam0)//Position - 0xCD5E
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_172(int iParam0)//Position - 0xCDF9
{
...
int func_173(int iParam0, int iParam1)//Position - 0xCF8B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_174(int iParam0, var uParam1)//Position - 0xDAFC
{
	int iVar0;
	int iVar1;
...
int func_175(int iParam0)//Position - 0xDB37
{
	int iVar0;
...
void func_176(int iParam0)//Position - 0xDDAB
{
	int iVar0;
...
void func_177(var uParam0, int iParam1)//Position - 0xDDE7
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_178(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0xE342
{
	int iVar0;
	int iVar1;
...
bool func_179(int iParam0, var uParam1, var uParam2)//Position - 0xE386
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
int func_180(var uParam0)//Position - 0xEAA1
{
...
bool func_181(int iParam0)//Position - 0xEAFC
{
	return func_182(iParam0, 0, 1);
}

int func_182(int iParam0, int iParam1, bool bParam2)//Position - 0xEB0C
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_183(int iParam0)//Position - 0xEB76
{
	switch (iParam0)
	{
		case 0:
...
int func_184()//Position - 0xEEA6
{
	return Global_30736;
}

int func_185(int iParam0)//Position - 0xEEB1
{
	return func_182(iParam0, 5, 1);
}

int func_186(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0xEEC1
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_187(int iParam0, bool bParam1)//Position - 0xEF63
{
	switch (iParam0)
	{
		case -1:
...
int func_188(int iParam0)//Position - 0xF580
{
	if (iParam0 != func_137())
	{
...
Vector3 func_189(int iParam0, int iParam1)//Position - 0xF5DE
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_190(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0xF68C
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_191(vector3 vParam0, float fParam3)//Position - 0xF721
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_192(int iParam0)//Position - 0xF765
{
	struct<6> Var0;
...
struct<6> func_193(int iParam0)//Position - 0xF8E9
{
	return func_194(iParam0);
}

struct<6> func_194(int iParam0)//Position - 0xF8F7
{
	struct<6> Var0;
...
int func_195(int iParam0, var uParam1)//Position - 0x103C2
{
	switch (iParam0)
	{
		case 0:
...
int func_196(int iParam0)//Position - 0x10444
{
	if (iParam0 != func_137())
	{
...
Vector3 func_197(int iParam0)//Position - 0x104A2
{
	switch (iParam0)
	{
		case 1:
...
int func_198()//Position - 0x106AD
{
	return func_199(PLAYER::PLAYER_ID());
}

var func_199(int iParam0)//Position - 0x106BD
{
	return MISC::GET_BITS_IN_RANGE(Global_2424073[iParam0 /*421*/].f_309.f_3, 28, 31);
}

int func_200(int iParam0)//Position - 0x106DA
{
	return func_182(iParam0, 0, 0);
}

int func_201(int iParam0)//Position - 0x106EA
{
	switch (iParam0)
	{
		case -1:
...
bool func_202()//Position - 0x109B8
{
	return Global_98721.f_345 > 0;
}

var func_203()//Position - 0x109C9
{
	var uVar0;
...
void func_204(var uParam0, int iParam1)//Position - 0x10A0F
{
	if (iParam1 <= 0)
	{
		return;
...
void func_205(var uParam0, int iParam1)//Position - 0x10A95
{
...
void func_206(var uParam0, int iParam1)//Position - 0x10AC8
{
	int iVar0;
	int iVar1;
...
int func_207(int iParam0, int iParam1)//Position - 0x10B19
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_208(int iParam0)//Position - 0x10BBB
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_209(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_209(bool bParam0, int iParam1, int iParam2)//Position - 0x10BE0
{
	if (bParam0)
	{
		return iParam1;
...
int func_210(var uParam0)//Position - 0x10BF7
{
	return uParam0 & 15;
}

void func_211(var uParam0, int iParam1)//Position - 0x10C04
{
...
void func_212(var uParam0, int iParam1)//Position - 0x10C3E
{
...
void func_213(var uParam0, int iParam1)//Position - 0x10C79
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_214(char* sParam0)//Position - 0x10CB5
{
...
struct<2> func_215(int iParam0)//Position - 0x10D0B
{
	struct<2> Var0;
...
int func_216(char* sParam0, int iParam1)//Position - 0x11157
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_217(int iParam0, var uParam1)//Position - 0x111A0
{
	switch (iParam0)
	{
		case 0:
...
void func_218(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, var uParam22, int iParam23, int iParam24)//Position - 0x12355
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_219(int iParam0)//Position - 0x123E6
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_220(int iParam0)//Position - 0x1272C
{
	struct<2> Var0;
	char[] cVar2[8];
...
int func_221(int iParam0)//Position - 0x12763
{
	switch (iParam0)
	{
		case 69:
...
int func_222(int iParam0)//Position - 0x1281F
{
	switch (iParam0)
	{
		case 1:
...
int func_223(char* sParam0, bool bParam1)//Position - 0x12873
{
	int iVar0;
	int iVar1;
...
int func_224(int iParam0, bool bParam1)//Position - 0x1289D
{
	int iVar0;
...
void func_225(bool bParam0)//Position - 0x128D3
{
	int iVar0;
	int iVar1;
...
void func_226(int iParam0, int iParam1, int iParam2)//Position - 0x12B55
{
	if (func_272() && func_36())
	{
...
void func_227(int iParam0)//Position - 0x12C19
{
	if (iParam0 == 1)
	{
...
void func_228()//Position - 0x12C42
{
...
void func_229()//Position - 0x12D12
{
	if (iLocal_175 > 0)
	{
		func_119();
	...
	if (iLocal_175 == 1)
	{
		if (iLocal_206[0] == 1)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_48))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_48, 0))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_48, 1721.001f, 3264.248f, 38.40064f, 1765.509f, 3276.518f, 46.05385f, 48.25f, 0, true, 0))
					{
						if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_48, 0))
						{
							PLAYER::SET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID(), 0, 0);
...
void func_230(int iParam0, int iParam1)//Position - 0x12FF4
{
	Global_61482 = iParam0;
	Global_61483 = iParam1;
}

void func_231(int iParam0, bool bParam1)//Position - 0x13006
{
	int iVar0;
...
int func_232(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x13050
{
	if (iParam3 == 0)
	{
...
void func_233()//Position - 0x13227
{
...
void func_234()//Position - 0x132BF
{
	if (iLocal_28 == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_48))
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
					{
						if (!PED::IS_PED_INJURED(iLocal_31[0]))
						{
							if (func_2(PLAYER::PLAYER_PED_ID(), iLocal_31[0], 1) < 200f)
							{
								...
								PED::SET_PED_SPHERE_DEFENSIVE_AREA(iLocal_31[0], vLocal_317, 10f, 0, 0);
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_49[0], 0))
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
					{
						if (!PED::IS_PED_INJURED(iLocal_31[0]))
						{
							...
							if (!PED::IS_PED_IN_VEHICLE(iLocal_31[0], iLocal_49[0], 0))
							{
								TASK::TASK_ENTER_VEHICLE(0, iLocal_49[0], 20000, -1, 1073741824, 1, 0);
							}
							TASK::TASK_HELI_MISSION(0, iLocal_49[0], 0, 0, vLocal_317.x, vLocal_317.y, (vLocal_317.z + 20f), 4, 30f, 10f, -1f, 170, 40, -1f, 0);
							...
							TASK::TASK_PERFORM_SEQUENCE(iLocal_31[0], uLocal_572);
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_49[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_49[0], 0))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(iLocal_31[0]))
								{
									TASK::TASK_HELI_MISSION(iLocal_31[0], iLocal_49[0], 0, 0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_49[0], 20f, 0f, 0f), 4, 10f, 10f, ENTITY::GET_ENTITY_HEADING(iLocal_49[0]), SYSTEM::ROUND(ENTITY::GET_ENTITY_HEIGHT(iLocal_49[0], ENTITY::GET_ENTITY_COORDS(iLocal_49[0], true), 1, 1)), 100, -1f, 0);
									iLocal_215[0] = 0;
								}
							}
						}
...
void func_235()//Position - 0x13DCB
{
	if (iLocal_210 == 0)
	{
								...
								if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_48, 0) || iLocal_212 == 1)
								{
									if (func_2(PLAYER::PLAYER_PED_ID(), iLocal_33[iLocal_176], 1) < 39f)
									{
										if (iLocal_217[iLocal_176] == 0)
										{
											...
											PED::SET_PED_SPHERE_DEFENSIVE_AREA(iLocal_33[iLocal_176], ENTITY::GET_ENTITY_COORDS(iLocal_33[iLocal_176], true), 50f, 0, 0);
									...
									else if (iLocal_231[iLocal_176] == 0)
									{
										TASK::CLEAR_PED_TASKS(iLocal_33[iLocal_176]);
										TASK::OPEN_SEQUENCE_TASK(&uLocal_572);
										TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_48, true), 2f, -1, 20f, 0, 1193033728);
										TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
										TASK::CLOSE_SEQUENCE_TASK(uLocal_572);
										TASK::TASK_PERFORM_SEQUENCE(iLocal_33[iLocal_176], uLocal_572);
										TASK::CLEAR_SEQUENCE_TASK(&uLocal_572);
										iLocal_245[iLocal_176] = 0;
										iLocal_259[iLocal_176] = 0;
					...
					if (!PED::IS_PED_INJURED(iLocal_33[iLocal_193]))
					{
						if (func_2(iLocal_33[iLocal_193], PLAYER::PLAYER_PED_ID(), 1) < 25f)
						{
							if (iLocal_292[iLocal_193] == 0)
							{
								...
								TASK::TASK_AIM_GUN_AT_ENTITY(iLocal_33[iLocal_193], PLAYER::PLAYER_PED_ID(), -1, 0);
...
int func_236(vector3 vParam0, int iParam3, int iParam4, bool bParam5)//Position - 0x14456
{
	vector3 vVar0[15];
	vector3 vVar46[15];
	float fVar92[15];
...
void func_237()//Position - 0x151AA
{
	if (iLocal_175 > 0)
	{
		func_119();
...
void func_238(int iParam0)//Position - 0x15710
{
	MISC::CLEAR_BIT(&Global_94554, iParam0);
}

void func_239(int iParam0)//Position - 0x15722
{
	MISC::SET_BIT(&Global_94554, iParam0);
}

bool func_240(int iParam0)//Position - 0x15734
{
	return MISC::IS_BIT_SET(Global_94554, iParam0);
}

int func_241(int iParam0)//Position - 0x15746
{
	var uVar0;
...
int func_242(int iParam0)//Position - 0x1575A
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
void func_243(int iParam0)//Position - 0x157B4
{
	if (Global_95621 != -1)
	{
...
void func_244(int iParam0, int iParam1)//Position - 0x157D8
{
	int iVar0;
...
void func_245(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x15843
{
	vector3 vVar0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102125.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102125.f_4, 0))
		{
			if (func_254(24) != Global_102125.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_251(ENTITY::GET_ENTITY_COORDS(Global_102125.f_4, true), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
				}
				func_246(Global_102125.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_246(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)//Position - 0x158BE
{
	struct<60> Var0;
...
void func_247(int iParam0, int iParam1, int iParam2)//Position - 0x159E7
{
	int iVar0;
...
void func_248(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0x15B04
{
	if (func_71(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
...
void func_249(int iParam0)//Position - 0x15C03
{
	if (iParam0 == -1)
	{
		return;
...
void func_250(int iParam0)//Position - 0x15C7D
{
...
int func_251(vector3 vParam0, int iParam3, var uParam4, var uParam5)//Position - 0x15CA4
{
	int iVar0;
...
int func_252(vector3 vParam0, int iParam3, int iParam4)//Position - 0x15DBA
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_253(int iParam0)//Position - 0x15E49
{
	return MISC::IS_BIT_SET(Global_111560.f_7224[iParam0], 0);
}

int func_254(int iParam0)//Position - 0x15E61
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_255()//Position - 0x15E7D
{
	if (iLocal_175 == 0)
	{
		func_259(1, 0);
...
void func_256()//Position - 0x16047
{
	iLocal_197 = 0;
	if (!CAM::IS_SCREEN_FADED_OUT())
	{
...
void func_257(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x16156
{
	if (func_272())
	{
...
void func_261()//Position - 0x16250
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_48))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_48, 0))
...
int func_262(int iParam0, int iParam1)//Position - 0x162A8
{
...
void func_263()//Position - 0x1631A
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
void func_264()//Position - 0x163B1
{
}

void func_265()//Position - 0x163B9
{
	if (iLocal_289 == 0)
	{
		iLocal_185 = 0;
...
void func_266(int iParam0, char* sParam1, int iParam2)//Position - 0x16A86
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_267(iParam2), 1);
}

int func_267(int iParam0)//Position - 0x16A9D
{
	int iVar0;
...
int func_270(int iParam0, int iParam1)//Position - 0x16D56
{
...
void func_271()//Position - 0x16DA2
{
...
void func_273()//Position - 0x16DED
{
	func_274(73);
	...
	iLocal_67 = PED::ADD_SCENARIO_BLOCKING_AREA(-1884.6f, 2827.7f, 41.8f, -1843.1f, 2772.1f, 29.9f, 0, 1, 1, 1);
	iLocal_69 = PED::ADD_SCENARIO_BLOCKING_AREA(-2168.3f, 3223.6f, 52.8f, -2156.2f, 3205f, 29f, 0, 1, 1, 1);
...
void func_274(int iParam0)//Position - 0x16FD3
{
	Global_94554 = 0;
	switch (iParam0)
	{
...
void func_275()//Position - 0x17061
{
	func_276();
	...
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_68, 0);
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_69, 0);
	func_259(1, 1);
	func_259(2, 1);
	func_259(7, 1);
	func_259(8, 1);
...
void func_276()//Position - 0x171A9
{
	Global_94554 = 0;
}

void func_277()//Position - 0x171B6
{
	int iVar0;
