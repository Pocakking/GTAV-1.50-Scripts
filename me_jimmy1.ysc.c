...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_99 = 49;
	iLocal_100 = 64;
	iLocal_105 = HUD::_GET_LEVEL_BLIP_SPRITE();
	iLocal_106 = HUD::_GET_WAYPOINT_BLIP_SPRITE();
...
void func_3()//Position - 0x39F
{
	...
	else if (func_42(iLocal_392) && func_42(PLAYER::PLAYER_PED_ID()))
	{
		if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(iLocal_392, true), 2f) && !FIRE::IS_EXPLOSION_IN_SPHERE(13, ENTITY::GET_ENTITY_COORDS(iLocal_392, true), 2f))
		{
			...
			ENTITY::SET_ENTITY_COLLISION(iLocal_392, true, 0);
			func_2(2);
		}
...
bool func_8(int iParam0)//Position - 0x9D4
{
	return func_9(iParam0, 20);
}

bool func_9(int iParam0, int iParam1)//Position - 0x9E4
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_10()//Position - 0x9FF
{
	return -1;
}

void func_11()//Position - 0xA08
{
	int iVar0;
...
int func_16()//Position - 0xC30
{
	func_17();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_17()//Position - 0xC49
{
	int iVar0;
...
bool func_18(int iParam0)//Position - 0xD46
{
	return iParam0 < 3;
}

int func_19(int iParam0)//Position - 0xD52
{
	int iVar0;
	int iVar1;
...
int func_20(int iParam0)//Position - 0xD8F
{
	if (func_18(iParam0))
	{
...
var func_21(int iParam0)//Position - 0xDB4
{
	return Global_1798[iParam0 /*29*/];
}

bool func_22(int iParam0)//Position - 0xDC3
{
	return Global_41396 == iParam0;
}

void func_23()//Position - 0xDD1
{
	int iVar0;
...
bool func_24(int iParam0, int iParam1)//Position - 0xE28
{
	switch (iParam0)
	{
		case 5:
...
void func_26(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEBA
{
...
void func_28()//Position - 0xF32
{
	Global_19671 = 0;
	func_29();
}

void func_29()//Position - 0xF42
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
bool func_30(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xF63
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_31(&(Local_52[iVar4 /*4*/]), vVar1, iParam1, &(Local_52[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_52[iVar4 /*4*/].f_3) < iParam4);
}

int func_31(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x1024
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_32(int iParam0, int iParam1)//Position - 0x1150
{
	int iVar0;
...
int func_34(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x125F
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_35(vector3 vParam0, vector3 vParam3)//Position - 0x12F0
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_36(vector3 vParam0)//Position - 0x1311
{
	float fVar0;
	float fVar1;
...
void func_37(var uParam0)//Position - 0x1350
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_38(int iParam0, int iParam1)//Position - 0x136B
{
	int iVar0;
...
int func_42(int iParam0)//Position - 0x1405
{
	if (func_41(iParam0))
	{
...
int func_44(int iParam0, int iParam1)//Position - 0x152E
{
	if (*iParam0 < 0)
	{
...
bool func_45(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1559
{
...
void func_46(bool bParam0, bool bParam1)//Position - 0x15A7
{
	int iVar0;
...
void func_47(int iParam0)//Position - 0x16AA
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_48(int iParam0)//Position - 0x16E2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_49(int iParam0)//Position - 0x177E
{
	if (func_41(iParam0))
	{
...
int func_50(int iParam0)//Position - 0x17A8
{
	int iVar0;
...
int func_51(int iParam0)//Position - 0x180B
{
	int iVar0;
...
int func_52(int iParam0)//Position - 0x192C
{
	if (!func_18(iParam0))
	{
		return func_21(iParam0);
...
void func_53(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1952
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_54(int iParam0)//Position - 0x19A2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_56(char* sParam0)//Position - 0x1A10
{
	func_57(sParam0);
	func_58(0);
}

void func_57(char* sParam0)//Position - 0x1A23
{
...
void func_58(int iParam0)//Position - 0x1A62
{
	int iVar0;
...
int func_59(int iParam0)//Position - 0x1AA7
{
	int iVar0;
	int iVar1;
...
void func_60(var uParam0, int iParam1)//Position - 0x1BBE
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_62(Global_111560.f_18528[iVar0], &vVar2, &fVar5))
			{
...
void func_61(var uParam0)//Position - 0x1D87
{
	*uParam0 = -15;
}

int func_62(int iParam0, var uParam1, float fParam2)//Position - 0x1D95
{
	switch (iParam0)
	{
		case 11:
...
void func_63(int iParam0, bool bParam1)//Position - 0x2704
{
	if (bParam1)
	{
...
bool func_66(bool bParam0)//Position - 0x285E
{
...
void func_67(int iParam0)//Position - 0x2889
{
		...
		switch (iLocal_389)
		{
			case 0:
				...
				else
				{
					...
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_296, 1f, 20000, 1048576000, 0, 1193033728);
...
void func_69()//Position - 0x2D2B
{
	func_70(0, 0);
	func_515(0);
}

void func_70(bool bParam0, int iParam1)//Position - 0x2D3E
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_71(int iParam0)//Position - 0x2E14
{
	switch (iParam0)
	{
		case 71:
...
void func_72(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2E52
{
	int iVar0;
...
void func_73(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x2EFB
{
	if (bParam0)
	{
...
bool func_74()//Position - 0x3034
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_75(int iParam0, int iParam1)//Position - 0x3051
{
	bool bVar0;
...
int func_78(int iParam0)//Position - 0x30E9
{
...
bool func_79()//Position - 0x312B
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_80(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x313C
{
	int iVar0;
...
void func_81(int iParam0)//Position - 0x316F
{
	if (iParam0 == 1)
	{
...
bool func_82(int iParam0, vector3 vParam1, float fParam4)//Position - 0x3192
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_83(int iParam0)//Position - 0x31C7
{
...
void func_85(int iParam0, bool bParam1)//Position - 0x3243
{
...
void func_86(int iParam0, bool bParam1)//Position - 0x327F
{
	if (CAM::IS_SCREEN_FADED_IN())
	{
...
int func_87(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x32B1
{
...
void func_88(int iParam0)//Position - 0x3440
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_89(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x346C
{
	int iVar0;
...
Vector3 func_90(int iParam0)//Position - 0x362A
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_91(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x363D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_92(int iParam0, int iParam1, int iParam2)//Position - 0x3E53
{
	int iVar0;
...
int func_93(int iParam0)//Position - 0x3EDF
{
	switch (iParam0)
	{
...
void func_94(int iParam0, int iParam1, int iParam2)//Position - 0x3F1A
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1, int iParam2)//Position - 0x3FA4
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_96(int iParam0, int iParam1, int iParam2)//Position - 0x4084
{
	Global_76389[1 /*14*/] = { func_141(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 2);
}

int func_97(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x40AF
{
	var uVar0;
	int iVar10;
...
int func_98(int iParam0, int iParam1, int iParam2)//Position - 0x46B3
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_99(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x474C
{
	int iVar0;
...
int func_100(int iParam0, int iParam1, int iParam2)//Position - 0x47E2
{
	int iVar0;
	int iVar1;
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4933
{
	int iVar0;
...
int func_103(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x4C3A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_104(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x57ED
{
	int iVar0;
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5DCF
{
	int iVar0;
...
int func_108(int iParam0, int iParam1, int iParam2)//Position - 0x5DF8
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_109(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x60C2
{
	int iVar0;
...
void func_111(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x64A3
{
	int iVar0;
...
int func_112(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x653B
{
	switch (iParam0)
	{
...
int func_113(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6609
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_114(int iParam0, int iParam1)//Position - 0x6765
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_115(int iParam0)//Position - 0x6B0C
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_116(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6B6D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_117(int iParam0, int iParam1)//Position - 0x6C69
{
	int iVar0;
...
int func_118(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6DA7
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_119(int iParam0)//Position - 0x6E87
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_120(int iParam0, int iParam1)//Position - 0x6F0D
{
	int iVar0;
	struct<10> Var1;
...
void func_121(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x783C
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_122(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x7966
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_123(int iParam0, int iParam1)//Position - 0x79AE
{
	int iVar0;
	struct<17> Var1;
...
void func_124(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x97F7
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_125(int iParam0)//Position - 0x99E1
{
	switch (iParam0)
	{
		case 0:
...
void func_126(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x9A91
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_127(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9B02
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_128(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9D7F
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_129(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA1A4
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_130(int iParam0, int iParam1)//Position - 0xA497
{
	int iVar0;
	int iVar1;
...
int func_131(int iParam0, int iParam1)//Position - 0xA4DD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_132(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA53D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_133(int iParam0)//Position - 0xA5C1
{
...
void func_134(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xA679
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_135(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xA6C3
{
	int iVar0;
...
int func_136(var uParam0)//Position - 0xA6F3
{
	int iVar0;
	int iVar1;
...
int func_137(int iParam0, int iParam1, int iParam2)//Position - 0xA727
{
	int iVar0;
	var uVar1;
...
bool func_138(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xA759
{
	int iVar0;
...
int func_139(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xC653
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_140(int iParam0)//Position - 0xD571
{
	if (!MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_141(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD5C2
{
	func_204();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_142(int iParam0, int iParam1)//Position - 0xD614
{
	switch (iParam0)
	{
		case 0:
...
void func_143(int iParam0)//Position - 0xD704
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xE97B
{
	int iVar0;
	int iVar1;
...
bool func_145(int iParam0, int iParam1, var uParam2)//Position - 0xED0C
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_146(int iParam0, int iParam1)//Position - 0xF111
{
	switch (iParam1)
	{
		case 0:
...
int func_147(int iParam0, int iParam1)//Position - 0xF50C
{
	switch (iParam1)
	{
		case 0:
...
int func_148(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xF907
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_149(int iParam0)//Position - 0xF949
{
	switch (iParam0)
	{
		case -1:
...
void func_150(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xFA1D
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_144(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_144(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
void func_151(int iParam0)//Position - 0xFCF6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0xFE4D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x1035D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x103D2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x10446
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x1052D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0x10890
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x10AA1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x10CD1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x10DE1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x11780
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0x122F3
{
	if (iParam0 < 136)
	{
		func_164(iParam0);
...
void func_163(int iParam0)//Position - 0x12328
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x12F2C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x13E3A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x13F67
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0, int iParam1)//Position - 0x14067
{
	switch (iParam0)
	{
		case 0:
...
void func_168(int iParam0)//Position - 0x14157
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x15648
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x15799
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x15CA4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x16312
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x16386
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x16456
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x16986
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0)//Position - 0x16B1D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_177(int iParam0)//Position - 0x1731B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x1742B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_179(int iParam0)//Position - 0x18357
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180(int iParam0)//Position - 0x19014
{
	if (iParam0 < 107)
	{
		func_183(iParam0);
...
void func_181(int iParam0)//Position - 0x1905A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_182(int iParam0)//Position - 0x19AFF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_183(int iParam0)//Position - 0x1A8EE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_184(int iParam0)//Position - 0x1B537
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_185(int iParam0)//Position - 0x1B7B0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_186(int iParam0, int iParam1)//Position - 0x1B8F6
{
	switch (iParam0)
	{
		case 0:
...
void func_187(int iParam0)//Position - 0x1B9E6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_188(int iParam0)//Position - 0x1C772
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_189(int iParam0)//Position - 0x1C8EC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_190(int iParam0)//Position - 0x1CE63
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_191(int iParam0)//Position - 0x1D38D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_192(int iParam0)//Position - 0x1D401
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_193(int iParam0)//Position - 0x1D4D1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_194(int iParam0)//Position - 0x1D9A9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_195(int iParam0)//Position - 0x1DC12
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_196(int iParam0)//Position - 0x1DEE8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_197(int iParam0)//Position - 0x1E0B1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_198(int iParam0)//Position - 0x1EC05
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_199(int iParam0)//Position - 0x1F84F
{
	if (iParam0 < 60)
	{
		func_201(iParam0);
...
void func_200(int iParam0)//Position - 0x1F884
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_201(int iParam0)//Position - 0x20626
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_202(int iParam0)//Position - 0x20CB2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_203(int iParam0)//Position - 0x20D99
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_204()//Position - 0x20E97
{
...
int func_205(int iParam0, int iParam1, int iParam2)//Position - 0x20F10
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_206(bool bParam0)//Position - 0x2116B
{
	int iVar0;
...
void func_207()//Position - 0x211A9
{
	Global_19671 = 0;
	func_208();
}

void func_208()//Position - 0x211B9
{
...
void func_209()//Position - 0x211F0
{
	Global_19671 = 0;
	func_210();
}

void func_210()//Position - 0x21200
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
void func_211()//Position - 0x21224
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		switch (iLocal_389)
		{
			case 0:
				...
				else
				{
					...
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 2f, 20000, 1048576000, 0, 1193033728);
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 10000);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_293, 1f, 20000, 1048576000, 0, 1193033728);
					TASK::CLOSE_SEQUENCE_TASK(iVar1);
					TASK::TASK_PERFORM_SEQUENCE(iLocal_392, iVar1);
					TASK::CLEAR_SEQUENCE_TASK(&iVar1);
				}
			...
			case 3:
				...
				if (((!func_27() && (func_82(iLocal_392, vLocal_287, 2f) || func_82(iLocal_392, vLocal_290, 2f))) || bLocal_300) || MISC::GET_GAME_TIMER() > iLocal_299)
				{
					if (bLocal_300)
					{
						...
						{
							TASK::CLEAR_PED_TASKS(iLocal_392);
							ENTITY::SET_ENTITY_COORDS(iLocal_392, vLocal_293, 1, false, 0, 1);
...
void func_212(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x215F0
{
	func_213(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_213(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2161A
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_214(vector3 vParam0)//Position - 0x21A0E
{
...
int func_215(int iParam0, int iParam1, bool bParam2)//Position - 0x21A38
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_216(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x21AA9
{
...
int func_217(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x21B81
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_218(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x21E77
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_219(int iParam0)//Position - 0x21F2B
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
Vector3 func_220()//Position - 0x21F90
{
	return 2.55f, 5.665f, 2.55f;
}

void func_221()//Position - 0x21FA7
{
	func_241();
...
void func_222()//Position - 0x220AA
{
	if (func_42(iLocal_392) && func_49(iLocal_403))
	{
		switch (iLocal_274)
		{
			...
			case 2:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_273, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, iLocal_273, sLocal_272, "enter_back", 8f, -8f, 4, iLocal_276, 1148846080, 0);
				iLocal_322 = 0;
				iLocal_323 = -1;
				iLocal_274 = 12;
				break;
			...
			case 4:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_273, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, iLocal_273, sLocal_272, "enter_left", 8f, -8f, 4, iLocal_276, 1148846080, 0);
				iLocal_274 = 5;
				break;
			...
			case 5:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_273))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_273) >= 0.9f)
					{
						...
						PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_273, false);
						PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
						TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, iLocal_273, sLocal_272, "left", 8f, -8f, 4, iLocal_276, 1148846080, 0);
						iLocal_274 = 6;
					}
				}
				break;
			...
			case 7:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_273, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, iLocal_273, sLocal_272, "exit_left", 8f, -8f, 4, iLocal_276, 1148846080, 0);
			...
			case 8:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_273, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, iLocal_273, sLocal_272, "enter_right", 8f, -8f, 4, iLocal_276, 1148846080, 0);
				iLocal_274 = 9;
				break;
			...
			case 9:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_273))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_273) >= 0.9f)
					{
						...
						PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_273, false);
						PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
						TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, iLocal_273, sLocal_272, "right", 8f, -8f, 4, iLocal_276, 1148846080, 0);
						iLocal_274 = 10;
					}
				}
				break;
			...
			case 11:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_273, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, iLocal_273, sLocal_272, "exit_right", 8f, -8f, 4, iLocal_276, 1148846080, 0);
				if (iLocal_277 || !VEHICLE::IS_VEHICLE_WINDOW_INTACT(iLocal_403, 7))
				{
					iLocal_274 = 13;
				}
			...
			case 12:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_273))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_273) >= 0.9f)
					{
						...
						PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_273, false);
						PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
						TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, iLocal_273, sLocal_272, "back", 8f, -8f, 4, iLocal_276, 1148846080, 0);
						iLocal_274 = 3;
					}
				}
				break;
			...
			case 14:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_273, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, iLocal_273, sLocal_272, "exit_back", 4f, -8f, 4, iLocal_276, 1148846080, 0);
				iLocal_274 = 15;
				break;
			...
			case 15:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_273))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_273) >= 0.95f)
					{
						...
						TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, iLocal_273, sLocal_272, "enter_backseat", 8f, -8f, 4, iLocal_276, 1148846080, 0);
						iLocal_274 = 16;
					}
				}
				else
...
void func_223(int iParam0, int iParam1, int iParam2)//Position - 0x22806
{
	if (func_42(iParam0))
	{
		if (func_41(iParam1))
...
float func_225(int iParam0, int iParam1)//Position - 0x228B5
{
	return func_226(iParam0, iParam1, 1);
}

float func_226(int iParam0, int iParam1, bool bParam2)//Position - 0x228C6
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_227()//Position - 0x22924
{
	int iVar0;
...
void func_228()//Position - 0x22975
{
...
void func_232()//Position - 0x22A8F
{
	int iVar0;
	bool bVar1;
...
int func_233()//Position - 0x22B44
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

void func_234(var uParam0)//Position - 0x22B54
{
...
void func_235(char* sParam0, int iParam1, int iParam2)//Position - 0x22B7E
{
	iParam2 = iParam2;
...
void func_236(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)//Position - 0x22B97
{
	switch (*uParam0)
	{
		case 0:
...
bool func_237(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x22CA8
{
	func_26(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
void func_238()//Position - 0x22CFC
{
	Global_19671 = 0;
	func_25();
}

struct<6> func_239()//Position - 0x22D0C
{
	struct<6> Var0;
	int iVar6;
	int iVar7;
...
struct<6> func_240()//Position - 0x22DB8
{
	struct<6> Var0;
...
void func_241()//Position - 0x22DDC
{
	int iVar0;
	int iVar1;
...
void func_242()//Position - 0x22E49
{
	func_241();
	func_236(&uLocal_459, &uLocal_107, "MEJ1AUD", &sLocal_460, &cLocal_466);
	switch (iLocal_389)
...
void func_243()//Position - 0x22F08
{
	if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_392))
	{
...
int func_244(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x22F58
{
	int iVar0;
	bool bVar1;
...
void func_245()//Position - 0x22FAA
{
	func_241();
	func_236(&uLocal_459, &uLocal_107, "MEJ1AUD", &sLocal_460, &cLocal_466);
	switch (iLocal_389)
	{
		case 0:
			...
			if (func_336() == 1)
			{
				...
				VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_383 - Vector(10f, 10f, 10f), vLocal_383 + Vector(10f, 10f, 10f), false, 1);
				MISC::CLEAR_AREA_OF_VEHICLES(vLocal_383, 10f, 0, 0, 0, 0, false, 0);
			}
			else
			{
			...
			if (func_42(iLocal_392) && !PED::IS_PED_GROUP_MEMBER(iLocal_392, func_233()))
			{
				...
				PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_392, 1);
				PED::SET_PED_DIES_INSTANTLY_IN_WATER(iLocal_392, 0);
				ENTITY::SET_ENTITY_PROOFS(iLocal_392, true, false, false, false, true, false, 0, false);
				PED::SET_PED_CAN_RAGDOLL(iLocal_392, 1);
			}
...
void func_246()//Position - 0x2318A
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
...
void func_247()//Position - 0x2323F
{
	int iVar0;
...
void func_248()//Position - 0x2329E
{
...
void func_249()//Position - 0x232EC
{
...
void func_250()//Position - 0x2336E
{
	bool bVar0;
...
void func_251()//Position - 0x23457
{
	if (iLocal_278 == 0)
	{
...
void func_252()//Position - 0x2351B
{
...
void func_253(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2358C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_254(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x23701
{
	func_255(&Global_105109, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_255(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2371D
{
	int iVar0;
	int iVar1;
...
int func_256(var uParam0)//Position - 0x245A7
{
...
void func_257(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x245C9
{
	int iVar0;
...
int func_258(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x24651
{
...
int func_259(int iParam0)//Position - 0x24691
{
	int iVar0;
...
void func_260(var uParam0, int iParam1, int iParam2)//Position - 0x246BF
{
...
int func_261(int iParam0)//Position - 0x2479B
{
	int iVar0;
...
int func_262(int iParam0)//Position - 0x247DD
{
	int iVar0;
...
int func_263(int iParam0, int iParam1, int iParam2)//Position - 0x24840
{
	int iVar0;
...
int func_264(int iParam0, int iParam1)//Position - 0x248CE
{
	struct<82> Var0;
...
void func_265(int iParam0, var uParam1, int iParam2)//Position - 0x24910
{
	int iVar0;
...
void func_266(int iParam0, var uParam1)//Position - 0x24B6C
{
	int iVar0;
...
int func_267(int iParam0)//Position - 0x24E17
{
	switch (iParam0)
	{
		case 1:
...
int func_268(int iParam0, var uParam1, var uParam2)//Position - 0x24EC7
{
	int iVar0;
	int iVar1;
...
int func_269(int iParam0)//Position - 0x250BA
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_270(var uParam0)//Position - 0x250DA
{
	int iVar0;
...
int func_271(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2518A
{
	char* sVar0;
...
void func_272(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x252B9
{
	int iVar0;
	int iVar1;
...
int func_273(int iParam0, int iParam1)//Position - 0x25459
{
	var uVar0;
	var uVar1;
...
void func_274(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x25485
{
	int iVar0;
...
void func_275(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x259CD
{
	int iVar0;
...
int func_276()//Position - 0x25C0E
{
	func_17();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_277(int iParam0, bool bParam1)//Position - 0x25C27
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_278(int iParam0, var uParam1)//Position - 0x25D1A
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_280(Var11.f_1)) && iVar72 < 51)
			{
...
int func_279(int iParam0)//Position - 0x25FA2
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_280(int iParam0)//Position - 0x2603D
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
int func_281(int iParam0, int iParam1)//Position - 0x261CF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_282(int iParam0, var uParam1)//Position - 0x26D40
{
	int iVar0;
	int iVar1;
...
int func_283(int iParam0)//Position - 0x26D7B
{
	int iVar0;
...
void func_284(int iParam0)//Position - 0x26FEF
{
	int iVar0;
...
void func_285(var uParam0, int iParam1)//Position - 0x2702B
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_286(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x27586
{
	int iVar0;
	int iVar1;
...
bool func_287(int iParam0, var uParam1, var uParam2)//Position - 0x275CA
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_288(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x27CE5
{
	if (bParam6)
	{
...
int func_289(var uParam0)//Position - 0x27D2C
{
...
bool func_290(int iParam0)//Position - 0x27D87
{
	return func_291(iParam0, 0, 1);
}

int func_291(int iParam0, int iParam1, bool bParam2)//Position - 0x27D97
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_292(int iParam0)//Position - 0x27E01
{
	switch (iParam0)
	{
		case 0:
...
int func_293()//Position - 0x28132
{
	return Global_30736;
}

int func_294(int iParam0)//Position - 0x2813D
{
	return func_291(iParam0, 5, 1);
}

int func_295(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x2814D
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_296(int iParam0, bool bParam1)//Position - 0x281EF
{
	switch (iParam0)
	{
		case -1:
...
int func_297(int iParam0)//Position - 0x2880C
{
	if (iParam0 != func_10())
	{
...
Vector3 func_298(int iParam0, int iParam1)//Position - 0x2886A
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_299(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x28918
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_300(vector3 vParam0, float fParam3)//Position - 0x289AD
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_301(int iParam0)//Position - 0x289F1
{
	struct<6> Var0;
...
struct<6> func_302(int iParam0)//Position - 0x28B75
{
	return func_303(iParam0);
}

struct<6> func_303(int iParam0)//Position - 0x28B83
{
	struct<6> Var0;
...
int func_304(int iParam0, var uParam1)//Position - 0x2964A
{
	switch (iParam0)
	{
		case 0:
...
int func_305(int iParam0)//Position - 0x296CC
{
	if (iParam0 != func_10())
	{
...
Vector3 func_306(int iParam0)//Position - 0x2972A
{
	switch (iParam0)
	{
		case 1:
...
int func_307()//Position - 0x29935
{
	return func_308(PLAYER::PLAYER_ID());
}

int func_308(int iParam0)//Position - 0x29945
{
	return MISC::GET_BITS_IN_RANGE(Global_2424073[iParam0 /*421*/].f_309.f_3, 28, 31);
}

int func_309(int iParam0)//Position - 0x29962
{
	return func_291(iParam0, 0, 0);
}

int func_310(int iParam0)//Position - 0x29972
{
	switch (iParam0)
	{
		case -1:
...
bool func_311()//Position - 0x29C40
{
	return Global_98721.f_345 > 0;
}

var func_312()//Position - 0x29C51
{
	var uVar0;
...
void func_313(var uParam0, int iParam1)//Position - 0x29C97
{
	if (iParam1 <= 0)
	{
		return;
...
void func_314(var uParam0, int iParam1)//Position - 0x29D1D
{
...
void func_315(var uParam0, int iParam1)//Position - 0x29D50
{
	int iVar0;
	int iVar1;
...
int func_316(int iParam0, int iParam1)//Position - 0x29DA1
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_317(int iParam0)//Position - 0x29E43
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_318(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_318(bool bParam0, int iParam1, int iParam2)//Position - 0x29E68
{
	if (bParam0)
	{
		return iParam1;
...
int func_319(var uParam0)//Position - 0x29E7F
{
	return uParam0 & 15;
}

void func_320(var uParam0, int iParam1)//Position - 0x29E8C
{
...
void func_321(var uParam0, int iParam1)//Position - 0x29EC6
{
...
void func_322(var uParam0, int iParam1)//Position - 0x29F01
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_323(char* sParam0)//Position - 0x29F3D
{
...
struct<2> func_324(int iParam0)//Position - 0x29F93
{
	struct<2> Var0;
...
int func_325(char* sParam0, int iParam1)//Position - 0x2A3DF
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_326(int iParam0, var uParam1)//Position - 0x2A428
{
	switch (iParam0)
	{
		case 0:
...
void func_327(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, var uParam22, int iParam23, int iParam24)//Position - 0x2B5DD
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_328(int iParam0)//Position - 0x2B66E
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_329(int iParam0)//Position - 0x2B9B4
{
	struct<2> Var0;
	char[] cVar2[8];
...
int func_330(int iParam0)//Position - 0x2B9EB
{
	switch (iParam0)
	{
		case 69:
...
int func_331(int iParam0)//Position - 0x2BAA7
{
	switch (iParam0)
	{
		case 1:
...
int func_332(char* sParam0, bool bParam1)//Position - 0x2BAFB
{
	int iVar0;
	int iVar1;
...
int func_333(int iParam0, bool bParam1)//Position - 0x2BB25
{
	int iVar0;
...
void func_334(bool bParam0)//Position - 0x2BB5B
{
	int iVar0;
	int iVar1;
...
int func_335(vector3 vParam0, int iParam3, bool bParam4)//Position - 0x2BDDD
{
	int iVar0;
...
int func_337(int iParam0)//Position - 0x2BE89
{
...
int func_338(int iParam0)//Position - 0x2BEB6
{
...
void func_339()//Position - 0x2BEE2
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	switch (iLocal_389)
	{
		case 0:
			...
			{
				ENTITY::SET_ENTITY_VISIBLE(iLocal_403, true, 0);
				VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(iLocal_403, true);
				iVar0 = 0;
				iVar0 = 0;
				while (iVar0 < 3)
				{
					ENTITY::SET_ENTITY_VISIBLE(iLocal_394[iVar0], true, 0);
					iVar0++;
				}
				ENTITY::SET_ENTITY_VISIBLE(iLocal_392, true, 0);
				...
				if (VEHICLE::IS_VEHICLE_STOPPED(iLocal_403))
				{
					...
					while (iVar2 < 3)
					{
						if (func_42(iLocal_394[iVar2]))
						{
							...
							if (PED::IS_PED_IN_VEHICLE(iLocal_394[iVar2], iLocal_403, 0))
							{
...
void func_340()//Position - 0x2C6AC
{
	if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_392))
	{
...
void func_341()//Position - 0x2C705
{
	if (!func_27())
	{
		if (HUD::IS_MESSAGE_BEING_DISPLAYED())
...
void func_342()//Position - 0x2C74D
{
	iLocal_358 = MISC::GET_GAME_TIMER() + 9000;
	iLocal_389 = 0;
	if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
...
void func_343(var uParam0, int iParam1, int iParam2)//Position - 0x2C77A
{
	char* sVar0;
...
int func_344(char* sParam0)//Position - 0x2C857
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_345(int iParam0, bool bParam1)//Position - 0x2C86A
{
	char* sVar0;
	int iVar1;
	int iVar2;
...
void func_346(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x2C8DB
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_347(iParam3), 0);
}

int func_347(int iParam0)//Position - 0x2C8F4
{
	int iVar0;
...
void func_348(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2CAE9
{
...
int func_349(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, float fParam6)//Position - 0x2CB84
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
...
int func_351(int iParam0)//Position - 0x2CCD4
{
	switch (iParam0)
	{
		case joaat("police"):
...
void func_353(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x2CDAC
{
	func_354(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_354(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x2CDC6
{
	uParam0->f_6 = 0;
	func_355(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_355(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2CDE8
{
	int iVar0;
	int iVar1;
...
void func_356(var uParam0)//Position - 0x2D155
{
...
int func_357(var uParam0)//Position - 0x2D1BE
{
	int iVar0;
...
int func_358(bool bParam0)//Position - 0x2D1E9
{
	switch (Global_41396)
	{
		case 0:
...
int func_359(char* sParam0)//Position - 0x2D293
{
	if (!func_360(1, 1, 0))
	{
...
int func_360(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2D32C
{
	int iVar0;
	int iVar1;
...
int func_361(int iParam0)//Position - 0x2D585
{
	if (iParam0 != func_10())
	{
...
int func_362(int iParam0, bool bParam1, bool bParam2)//Position - 0x2D5EB
{
	int iVar0;
...
int func_363(int iParam0, int iParam1)//Position - 0x2D635
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		if (VEHICLE::GET_NUM_MOD_KITS(iParam0) > 0)
...
int func_364(int iParam0, int iParam1)//Position - 0x2D697
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_365()//Position - 0x2D71C
{
	return Global_2448961.f_17;
}

bool func_366(int iParam0)//Position - 0x2D72A
{
	return iParam0 == 51;
}

var func_367()//Position - 0x2D737
{
	return Global_2448961.f_16;
}

bool func_368()//Position - 0x2D745
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

int func_369(int iParam0)//Position - 0x2D75A
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
void func_370(var uParam0, int iParam1, vector3 vParam2, int iParam5)//Position - 0x2D7B4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_371()//Position - 0x2D8C4
{
	return func_372(PLAYER::PLAYER_ID());
}

int func_372(int iParam0)//Position - 0x2D8D4
{
...
int func_373(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x2D8F3
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_374(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2DC5F
{
...
int func_375(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2DCB1
{
	if (!func_360(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_376(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2DCFA
{
	if (!func_360(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_377(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2DD59
{
	if (!func_360(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_378(int iParam0)//Position - 0x2DDAF
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_379()//Position - 0x2DE0A
{
	MISC::SET_BIT(&Global_7357, 4);
}

void func_380(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)//Position - 0x2DE1A
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_381()//Position - 0x2DF73
{
...
bool func_382(char* sParam0, int iParam1, char* sParam2)//Position - 0x2E01E
{
...
void func_383()//Position - 0x2E03C
{
	bool bVar0;
		...
		if (iLocal_310 == -1 && iLocal_311 == -1)
		{
			...
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_403, PLAYER::PLAYER_PED_ID(), 1) || bLocal_313)
			{
				...
				if (func_4(&uLocal_107, "MEJ1AUD", "MEJ1_RAM", "MEJ1_RAM_3", 7, 0, 0))
				{
					...
					TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_394[0], iLocal_403, PLAYER::PLAYER_PED_ID(), 8, 25f, 786468, 100f, 1f, 1);
					RECORDING::_0x293220DA1B46CEBC(3f, 0f, 3);
					iLocal_274 = 2;
					fLocal_386 = 200f;
					fLocal_387 = 500f;
...
bool func_384(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7)//Position - 0x2E287
{
...
void func_385()//Position - 0x2E2D5
{
	vector3 vVar0;
	int iVar3;
	int iVar4;
...
void func_386(int iParam0, int iParam1, int iParam2)//Position - 0x2E349
{
	char* sVar0;
	char* sVar1;
	char* sVar2;
...
int func_387(int iParam0, int iParam1)//Position - 0x2E44F
{
...
bool func_388(int iParam0, vector3 vParam1, float fParam4)//Position - 0x2E4C1
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, true), vParam1) <= (fParam4 * fParam4);
}

void func_389(var uParam0, var uParam1, var uParam2, float fParam3)//Position - 0x2E4DE
{
	*uParam0 = 0;
	*uParam1 = 0;
	*uParam2 = 0;
...
void func_390(char[4] cParam0, int iParam1)//Position - 0x2E4F6
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_391(int iParam0, bool bParam1, int iParam2)//Position - 0x2E50D
{
	int iVar0;
...
void func_392()//Position - 0x2E542
{
	func_236(&uLocal_459, &uLocal_107, "MEJ1AUD", &sLocal_460, &cLocal_466);
	switch (iLocal_389)
	{
...
int func_393()//Position - 0x2E6E9
{
	if (((func_49(iLocal_403) && func_42(PLAYER::PLAYER_PED_ID())) && func_42(iLocal_394[0])) && func_42(iLocal_392))
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_409, vLocal_412, fLocal_433, 0, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_415, vLocal_418, fLocal_434, 0, true, 0))
		{
			ENTITY::SET_ENTITY_COORDS(iLocal_403, vLocal_405, 1, false, 0, 1);
			ENTITY::SET_ENTITY_HEADING(iLocal_403, fLocal_408);
			return 1;
		}
		else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_421, vLocal_424, fLocal_433, 0, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_427, vLocal_430, fLocal_434, 0, true, 0))
		{
			ENTITY::SET_ENTITY_COORDS(iLocal_403, vLocal_405, 1, false, 0, 1);
			ENTITY::SET_ENTITY_HEADING(iLocal_403, fLocal_408);
			return 1;
...
void func_394()//Position - 0x2E7D5
{
	int iVar0;
	...
	if (func_49(iLocal_403))
	{
		...
		while (iVar0 < 3)
		{
			if (!func_42(iLocal_394[iVar0]))
			{
				if (STREAMING::HAS_MODEL_LOADED(iLocal_402))
				{
					...
					ENTITY::SET_ENTITY_VISIBLE(iLocal_394[iVar0], false, 0);
		...
		if (!func_42(iLocal_392))
		{
			if (STREAMING::HAS_MODEL_LOADED(func_52(14)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_272))
			{
				...
				ENTITY::SET_ENTITY_VISIBLE(iLocal_392, false, 0);
				...
				ENTITY::SET_ENTITY_PROOFS(iLocal_392, true, false, false, true, true, false, 0, false);
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_273, false);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, iLocal_273, sLocal_272, "base", 8f, -8f, 4, iLocal_276, 1148846080, 0);
				iLocal_274 = 0;
			}
		}
	}
	else if (STREAMING::HAS_MODEL_LOADED(iLocal_404))
	{
		...
		ENTITY::SET_ENTITY_VISIBLE(iLocal_403, false, 0);
...
int func_395(int iParam0, vector3 vParam1, float fParam4, bool bParam5)//Position - 0x2EAB8
{
	int iVar0;
...
void func_397()//Position - 0x2EB50
{
	func_398(iLocal_402);
	func_398(func_52(14));
	func_398(iLocal_404);
...
bool func_398(int iParam0)//Position - 0x2EB73
{
	if (iParam0 == 0)
	{
		return 1;
...
void func_399(int iParam0, vector3 vParam1, float fParam4)//Position - 0x2EB91
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
void func_400()//Position - 0x2EBBA
{
	int iVar0;
	vector3 vVar1;
	float fVar4;
	...
	if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
	{
		...
		if (func_66(0) && func_42(PLAYER::PLAYER_PED_ID()))
		{
			...
			func_436(&iVar0, vVar1, fVar4, 1, 0, 1, 1, 1, joaat("asterope"), 0, 145, 1);
		}
		if (func_396())
		{
			iVar5 = func_435();
...
void func_401(vector3 vParam0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x2EF38
{
	int iVar0;
	int iVar1;
...
void func_402()//Position - 0x2EFA8
{
	Global_22211.f_6 = 1;
}

void func_403(int iParam0)//Position - 0x2EFB6
{
	if (func_407())
	{
		return;
...
void func_404(int iParam0)//Position - 0x2EFE9
{
	if (func_407())
	{
		return;
...
void func_405(bool bParam0, bool bParam1)//Position - 0x2F073
{
	if (bParam0)
	{
		if (func_369(0))
...
bool func_406()//Position - 0x2F0E7
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

bool func_407()//Position - 0x2F0F8
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

void func_408(int iParam0, int iParam1, int iParam2)//Position - 0x2F10A
{
...
void func_409(bool bParam0)//Position - 0x2F13E
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
	...
	if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_392))
	{
		...
		if (bParam0)
		{
			if ((func_49(iLocal_403) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_403, -1, 0)) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_403, 0, 0))
			{
				...
				VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_403, true, true, 0);
			}
		}
		else
		{
...
void func_410(var uParam0, var uParam1)//Position - 0x2F2BE
{
	vector3 vVar0[5];
	float fVar16[5];
	int iVar22;
...
Vector3 func_411()//Position - 0x2F3C2
{
	return Global_105109.f_2884;
}

void func_412()//Position - 0x2F3D3
{
	int iVar0;
...
int func_413(int iParam0)//Position - 0x2F411
{
	if (*iParam0 < 0)
	{
...
int func_414(int iParam0)//Position - 0x2F490
{
	if (*iParam0 < 0)
	{
		*iParam0 = MISC::GET_GAME_TIMER() + 1000;
...
void func_415(bool bParam0, bool bParam1)//Position - 0x2F4EB
{
	if (bParam0)
	{
		func_416(0, 1, 1);
...
void func_416(bool bParam0, int iParam1, int iParam2)//Position - 0x2F51E
{
	bool bVar0;
...
void func_417()//Position - 0x2F57D
{
	int iVar0;
...
void func_418()//Position - 0x2F67D
{
	int iVar0;
	int iVar1;
...
void func_419(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x2F6B4
{
	vector3 vVar0;
	float fVar3;
...
int func_420(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2F745
{
...
bool func_422()//Position - 0x2F848
{
	return func_423(&(Global_105109.f_2890));
}

int func_423(var uParam0)//Position - 0x2F85B
{
...
int func_424(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x2F8BA
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_425(int iParam0, bool bParam1)//Position - 0x2F935
{
	int iVar0;
	struct<2> Var1;
...
int func_426(int iParam0)//Position - 0x2FAB5
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_428(int iParam0)//Position - 0x2FB98
{
	int iVar0;
	int iVar1;
...
int func_429()//Position - 0x32065
{
	return 0;
}

int func_430()//Position - 0x3206E
{
	return 1;
}

int func_431()//Position - 0x32077
{
	return 1;
}

int func_432()//Position - 0x32080
{
...
var func_434()//Position - 0x32154
{
	return Global_102125.f_2890.f_8;
}

int func_435()//Position - 0x32165
{
	if (!Global_98669 == 10 && !Global_98669 == 9)
	{
		return 0;
...
void func_436(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x3218F
{
	int iVar0;
...
int func_437(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)//Position - 0x32323
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
void func_438(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x33167
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_439(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x33D7B
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_440(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x33DEE
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_441(int iParam0)//Position - 0x354DF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_442(int iParam0, bool bParam1, var uParam2)//Position - 0x3558F
{
	int iVar0;
	bool bVar1;
...
int func_443(int iParam0)//Position - 0x356FD
{
	int iVar0;
...
int func_444(int iParam0)//Position - 0x35738
{
	if (iParam0 != func_10())
	{
		if (func_362(iParam0, 1, 1))
...
int func_445(int iParam0)//Position - 0x3577F
{
	switch (iParam0)
	{
		case 0:
...
int func_446(int iParam0)//Position - 0x35B47
{
...
int func_447(int iParam0)//Position - 0x35B89
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case -32236122:
...
int func_448(int iParam0)//Position - 0x35C2C
{
	if (iParam0 != func_10())
	{
		if (func_362(iParam0, 1, 1))
...
int func_449(int iParam0)//Position - 0x35C73
{
	if (iParam0 != func_10())
	{
		if (func_362(iParam0, 1, 1))
...
int func_450(int iParam0)//Position - 0x35CB9
{
	switch (iParam0)
	{
		case -2118308144:
...
int func_451(int iParam0)//Position - 0x35CEE
{
...
int func_452(int iParam0)//Position - 0x35D1D
{
...
int func_453(int iParam0)//Position - 0x35DDA
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		return 0;
...
int func_454(int iParam0)//Position - 0x35E10
{
	switch (iParam0)
	{
		case 562680400:
...
int func_455(int iParam0, bool bParam1)//Position - 0x35E69
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_456(int iParam0)//Position - 0x35EC4
{
	int iVar0;
...
int func_457(int iParam0, int iParam1)//Position - 0x35EFE
{
	if (iParam1 == 0)
	{
...
bool func_458()//Position - 0x36272
{
	return DLC::IS_DLC_PRESENT(1927191088);
}

bool func_459()//Position - 0x36283
{
	return DLC::IS_DLC_PRESENT(2067165443);
}

bool func_460()//Position - 0x36294
{
	return DLC::IS_DLC_PRESENT(-957277403);
}

bool func_461()//Position - 0x362A5
{
	return DLC::IS_DLC_PRESENT(210122941);
}

bool func_462()//Position - 0x362B6
{
	return DLC::IS_DLC_PRESENT(-1894522408);
}

bool func_463()//Position - 0x362C7
{
	return DLC::IS_DLC_PRESENT(1630677557);
}

int func_464(int iParam0, int iParam1)//Position - 0x362D8
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_465(int iParam0)//Position - 0x3664E
{
	if (iParam0 != func_10())
	{
		if (func_362(iParam0, 1, 1))
...
int func_466(int iParam0)//Position - 0x366AD
{
	if (iParam0 != func_10())
	{
		if (func_362(iParam0, 1, 1))
...
int func_467(int iParam0)//Position - 0x3670D
{
	if (iParam0 != func_10())
	{
		if (func_362(iParam0, 1, 1))
...
int func_468(int iParam0, bool bParam1, var uParam2)//Position - 0x36754
{
	bool bVar0;
...
int func_469(int iParam0)//Position - 0x36B93
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_470(int iParam0, int iParam1)//Position - 0x36BBC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_471(int iParam0)//Position - 0x36DBE
{
...
int func_472(int iParam0)//Position - 0x36E9B
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_473(int iParam0)//Position - 0x3704C
{
	int iVar0;
	char* sVar1;
...
int func_474(int iParam0)//Position - 0x37092
{
	int iVar0;
...
int func_475(int iParam0)//Position - 0x3710E
{
	int iVar0;
...
void func_476(int iParam0, int iParam1)//Position - 0x371F6
{
	int iVar0;
...
void func_477(int iParam0)//Position - 0x37278
{
	if (!func_478(*iParam0))
	{
...
bool func_478(int iParam0)//Position - 0x372A3
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_479(int iParam0, var uParam1, var uParam2)//Position - 0x372B2
{
	int iVar0;
	int iVar1;
...
int func_480(int iParam0)//Position - 0x37475
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_481(var uParam0)//Position - 0x37551
{
...
int func_482(int iParam0, int iParam1)//Position - 0x37591
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_483(var uParam0, int iParam1)//Position - 0x37676
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_484(int iParam0, int iParam1)//Position - 0x376B7
{
	int iVar0;
...
void func_485(vector3 vParam0, float fParam3, bool bParam4)//Position - 0x37755
{
	int iVar0;
...
void func_486(int iParam0)//Position - 0x377A5
{
	bool bVar0;
...
void func_487(int iParam0, bool bParam1)//Position - 0x37917
{
	if (iParam0 == -1)
	{
		return;
...
void func_488(int iParam0, int iParam1, bool bParam2)//Position - 0x37974
{
	if (iParam0 == -1)
	{
		return;
...
void func_489(var uParam0, var uParam1)//Position - 0x379AF
{
...
int func_490(int iParam0, int iParam1)//Position - 0x37A7B
{
	int iVar0;
...
int func_491(var uParam0)//Position - 0x37AED
{
	return *uParam0;
}

bool func_492(int iParam0, int iParam1)//Position - 0x37AF8
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_493(var uParam0, int iParam1)//Position - 0x37B1B
{
	int iVar0;
	int iVar1;
...
int func_494(vector3 vParam0, float fParam3)//Position - 0x39214
{
	return func_495(&(Global_105109.f_2890), vParam0, fParam3, 0);
}

int func_495(var uParam0, vector3 vParam1, float fParam4, bool bParam5)//Position - 0x3922E
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
int func_496(int iParam0)//Position - 0x394E0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_497(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x395A3
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_498(iParam0, uVar1[iVar6], 1) && func_424(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
int func_498(int iParam0, int iParam1, bool bParam2)//Position - 0x397AB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_499(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x3980C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_500(int iParam0, int iParam1)//Position - 0x39DCE
{
	int iVar0;
	int iVar1;
...
bool func_501()//Position - 0x39E46
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_502(int iParam0)//Position - 0x39E57
{
	int iVar0;
...
int func_503(int iParam0)//Position - 0x39EA2
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
int func_504(int iParam0)//Position - 0x39F29
{
...
int func_505(int iParam0)//Position - 0x39F58
{
...
int func_506(int iParam0)//Position - 0x39F75
{
...
int func_507(int iParam0, int iParam1)//Position - 0x39F98
{
...
int func_508(int iParam0)//Position - 0x39FD3
{
	if (func_507(iParam0, 0))
	{
...
int func_509(int iParam0, int iParam1)//Position - 0x39FF6
{
	int iVar0;
...
int func_510(var uParam0)//Position - 0x3A043
{
	if (func_423(uParam0))
	{
...
bool func_511()//Position - 0x3A078
{
	return func_510(&(Global_105109.f_2890));
}

void func_512()//Position - 0x3A08B
{
	func_513(&(Global_105109.f_2890));
}

void func_513(var uParam0)//Position - 0x3A09E
{
	if (func_423(uParam0))
	{
...
void func_514(bool bParam0)//Position - 0x3A0BC
{
	if (bParam0)
	{
...
void func_515(bool bParam0)//Position - 0x3A0E8
{
	func_46(0, bParam0);
	...
	CAM::SET_WIDESCREEN_BORDERS(false, 0);
	VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_383 - Vector(10f, 10f, 10f), vLocal_383 + Vector(10f, 10f, 10f), true, 1);
	func_514(0);
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_516()//Position - 0x3A14F
{
	int iVar0;
