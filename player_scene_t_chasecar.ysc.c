...
int func_3(int iParam0, int iParam1, int iParam2)//Position - 0x317
{
	struct<2> Var0;
	float fVar4;
	float fVar5;
...
bool func_11(int iParam0)//Position - 0x89F
{
	return func_12(iParam0, 20);
}

bool func_12(int iParam0, int iParam1)//Position - 0x8AF
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_13()//Position - 0x8CA
{
	return -1;
}

void func_14()//Position - 0x8D3
{
	int iVar0;
...
var func_19()//Position - 0xAFB
{
	func_20();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_20()//Position - 0xB14
{
	int iVar0;
...
bool func_21(int iParam0)//Position - 0xC11
{
	return iParam0 < 3;
}

int func_22(int iParam0)//Position - 0xC1D
{
	int iVar0;
	int iVar1;
...
int func_23(int iParam0)//Position - 0xC5A
{
	if (func_21(iParam0))
	{
...
var func_24(int iParam0)//Position - 0xC7F
{
	return Global_1798[iParam0 /*29*/];
}

bool func_25(int iParam0)//Position - 0xC8E
{
	return Global_41396 == iParam0;
}

void func_26()//Position - 0xC9C
{
	int iVar0;
...
bool func_27(int iParam0, int iParam1)//Position - 0xCF3
{
	switch (iParam0)
	{
		case 5:
...
void func_29(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0xD85
{
...
void func_30(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xDDB
{
...
int func_31(int iParam0, float fParam1)//Position - 0xE76
{
	if (func_35(iParam0))
	{
...
float func_32(var uParam0)//Position - 0xE98
{
	if (func_35(uParam0))
	{
		if (func_33(uParam0))
...
bool func_33(var uParam0)//Position - 0xED7
{
	return MISC::IS_BIT_SET(*uParam0, 2);
}

void func_34(int iParam0)//Position - 0xEE7
{
	if (!func_35(iParam0))
	{
		func_4(iParam0);
...
bool func_35(var uParam0)//Position - 0xEFF
{
	return MISC::IS_BIT_SET(*uParam0, 1);
}

int func_36()//Position - 0xF0F
{
...
void func_37(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0xF64
{
	func_38(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_38(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0xF7E
{
	func_39(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_39(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0xF9B
{
...
void func_40(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0xFD3
{
	int iVar0;
	int iVar1;
...
void func_41(var uParam0)//Position - 0x133C
{
...
int func_42(var uParam0)//Position - 0x13A0
{
	int iVar0;
...
int func_43(bool bParam0)//Position - 0x13CB
{
	switch (Global_41396)
	{
		case 0:
...
void func_44(char[4] cParam0, int iParam1)//Position - 0x1475
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_45(char* sParam0)//Position - 0x148C
{
	if (!func_46(1, 1, 0))
	{
...
int func_46(bool bParam0, bool bParam1, bool bParam2)//Position - 0x1524
{
	int iVar0;
	int iVar1;
	...
	if ((func_53() || func_52(Global_4456448.f_190930)) || func_51())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::IS_TURRET_SEAT(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_49(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_47(int iParam0)//Position - 0x177D
{
	if (iParam0 != func_13())
	{
...
int func_48(int iParam0, bool bParam1, bool bParam2)//Position - 0x17E3
{
	int iVar0;
...
int func_49(int iParam0, int iParam1)//Position - 0x182D
{
...
int func_50(int iParam0, int iParam1)//Position - 0x188F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_51()//Position - 0x1914
{
	return Global_2448961.f_17;
}

bool func_52(int iParam0)//Position - 0x1922
{
	return iParam0 == 51;
}

var func_53()//Position - 0x192F
{
	return Global_2448961.f_16;
}

bool func_54()//Position - 0x193D
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

int func_55(int iParam0)//Position - 0x1952
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
void func_56(var uParam0, int iParam1, vector3 vParam2, int iParam5)//Position - 0x19AC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_57()//Position - 0x1AB8
{
	return func_58(PLAYER::PLAYER_ID());
}

int func_58(int iParam0)//Position - 0x1AC8
{
...
bool func_59(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x1AE7
{
	if (bParam6)
	{
...
int func_60(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x1B2E
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_61(bool bParam0, bool bParam1, bool bParam2)//Position - 0x1E9A
{
...
int func_62(bool bParam0, bool bParam1, bool bParam2)//Position - 0x1EEC
{
	if (!func_46(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_63(bool bParam0, bool bParam1, bool bParam2)//Position - 0x1F35
{
	if (!func_46(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_64(bool bParam0, bool bParam1, bool bParam2)//Position - 0x1F94
{
	if (!func_46(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_65(int iParam0)//Position - 0x1FEA
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_66()//Position - 0x2045
{
	MISC::SET_BIT(&Global_7357, 4);
}

int func_67(char* sParam0)//Position - 0x2055
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_68(var uParam0, int iParam1, int iParam2)//Position - 0x2068
{
	char* sVar0;
...
int func_69(int iParam0, int iParam1)//Position - 0x213E
{
	int iVar0;
	bool bVar1;
	float fVar2;
	...
	switch (iLocal_529[iParam0])
	{
		case 0:
			...
			if (fLocal_506 >= 0f)
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_462[iParam0], 0))
				{
					if (!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_462[iParam0]))
					{
						VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(iLocal_462[iParam0], iLocal_500[iParam0], &Local_496, 1);
					}
		...
		case 1:
			...
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_462[iParam0]))
			{
				...
				if (!VEHICLE::IS_PLAYBACK_USING_AI_GOING_ON_FOR_VEHICLE(iLocal_462[iParam0]))
				{
					if (!PED::GET_PED_TYPE(iLocal_451[iParam0]) == 6)
					{
						if (MISC::IS_AREA_OCCUPIED(ENTITY::GET_ENTITY_COORDS(iLocal_462[iParam0], true) - Vector(1f, 1f, 1f), ENTITY::GET_ENTITY_COORDS(iLocal_462[iParam0], true) + Vector(1f, 1f, 1f), 0, 1, 0, 0, 0, 0, 0))
						{
				...
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_451[iParam0], PLAYER::PLAYER_PED_ID(), 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_462[iParam0], PLAYER::PLAYER_PED_ID(), 1))
				{
					VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(iLocal_462[iParam0]);
					return 0;
				}
		...
		case 4:
			...
			if (!PED::IS_PED_SITTING_IN_VEHICLE(iLocal_451[iParam0], iLocal_462[iParam0]))
			{
				...
				{
					TASK::TASK_ENTER_VEHICLE(iLocal_451[iParam0], iLocal_462[iParam0], 20000, -1, 1073741824, 1, 0);
				}
			}
			else
			{
		...
		case -2:
			if (!PED::IS_PED_INJURED(iLocal_451[iParam0]))
			{
				if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_451[iParam0], 1805844857) != 1)
				{
					...
					TASK::TASK_SMART_FLEE_PED(iLocal_451[iParam0], PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
				}
			}
			else
			{
...
void func_70(int iParam0, int iParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, bool bParam9)//Position - 0x2774
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_71(int iParam0, int iParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, bool bParam10)//Position - 0x27D4
{
	float fVar0;
	float fVar1;
	float fVar2;
...
float func_72(int iParam0, int iParam1)//Position - 0x2A7B
{
	struct<2> Var0;
	vector3 vVar3;
	vector3 vVar6;
...
float func_73(int iParam0, int iParam1)//Position - 0x2B0C
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_74(int iParam0, int iParam1)//Position - 0x2B5E
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
float func_75(vector3 vParam0, vector3 vParam3)//Position - 0x2C01
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

float func_76(int iParam0, int iParam1)//Position - 0x2C22
{
	struct<2> Var0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_77(int iParam0, var uParam1)//Position - 0x2CB1
{
	if (*uParam1 < 0)
	{
		*uParam1 = iParam0;
...
int func_78(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4)//Position - 0x2CCA
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		*uParam2 = iParam3;
...
int func_80()//Position - 0x2D7B
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iVar0, 0))
	{
		...
		else
		{
			...
			while (iVar1 < 4)
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_462[iVar1], 0) && !PED::IS_PED_INJURED(iLocal_451[iVar1]))
				{
					if (!MISC::IS_STRING_NULL_OR_EMPTY(&Local_496) && iLocal_500[iVar1] > 0)
					{
						VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(iLocal_462[iVar1], iLocal_500[iVar1], &Local_496, 1);
						VEHICLE::SKIP_TIME_IN_PLAYBACK_RECORDED_VEHICLE(iLocal_462[iVar1], fLocal_505);
						TASK::TASK_VEHICLE_MISSION(iLocal_451[iVar1], iLocal_462[iVar1], 0, 15, 20f, iLocal_270, 0.5f, 2f, 1);
						if (PED::GET_PED_TYPE(iLocal_451[iVar1]) == 6)
						{
							VEHICLE::SET_VEHICLE_SIREN(iLocal_462[iVar1], 1);
						}
					}
				}
				iVar1++;
...
int func_81(int iParam0, int iParam1)//Position - 0x2E58
{
	vector3 vVar0;
	float fVar3;
...
int func_82(var uParam0)//Position - 0x2F3C
{
	return uParam0;
}

bool func_83(var uParam0, var uParam1)//Position - 0x2F46
{
	return (uParam0 && uParam1) != 0;
}

int func_84()//Position - 0x2F55
{
	func_20();
...
void func_86()//Position - 0x2FDB
{
	func_87((Global_98392 - 1));
}

void func_87(int iParam0)//Position - 0x2FED
{
	Global_98392 = iParam0;
}

void func_88()//Position - 0x2FFB
{
	func_87(0);
}

void func_89()//Position - 0x3008
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(3, iLocal_491, 1862763509);
	iVar0 = 0;
	while (iVar0 < 4)
	{
		if (iLocal_467[iVar0] != 0)
		{
			MISC::CLEAR_AREA(vLocal_492 + vLocal_472[iVar0 /*3*/], 20f, 1, 0, 0, false);
		...
		if (iLocal_456[iVar0] != 0)
		{
			iLocal_451[iVar0] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_462[iVar0], iLocal_461, iLocal_456[iVar0], -1, 1, true);
			...
			{
				PED::SET_PED_HELMET(iLocal_451[iVar0], 1);
			}
			if (iLocal_461 != 6)
			{
...
int func_91(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x3A6E
{
	switch (iParam0)
	{
		case 231:
...
int func_92(int iParam0, var uParam1, var uParam2, char* sParam3)//Position - 0x3D45
{
	int iVar0;
...
bool func_93(var uParam0)//Position - 0x3F38
{
	int iVar0;
	vector3 vVar1;
	float fVar4;
...
int func_94(int iParam0, var uParam1, char* sParam2)//Position - 0x3FF3
{
	vector3 vVar0;
	int iVar3;
	var uVar4;
...
int func_97(int iParam0, var uParam1, var uParam2)//Position - 0x8470
{
	switch (iParam0)
	{
		case 11:
...
char* func_98(int iParam0)//Position - 0x8DDF
{
	switch (iParam0)
	{
		case 2014101067:
