			...
			switch (iLocal_510)
			{
				...
				case 2:
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_54) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						...
						else if (((!ENTITY::IS_ENTITY_OCCLUDED(iLocal_54) && iLocal_48 == 4) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_96, vLocal_99, fLocal_102, 0, true, 0)) || func_158())
						{
							func_139(1);
						}
		...
		else
		{
			...
			if (!HUD::DOES_BLIP_EXIST(iLocal_63))
			{
				...
				else if (iLocal_511 == 2)
				{
					...
					{
						func_104(&uLocal_305, OBJECT::GET_PICKUP_COORDS(iLocal_137), 0, 0, 1, 1, 1);
						if (SYSTEM::VDIST2(OBJECT::GET_PICKUP_COORDS(iLocal_137), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) > SYSTEM::POW(50f, 2f))
						{
							iLocal_511 = -1;
							func_135(&uLocal_305, 0, 0);
...
bool func_8(int iParam0)//Position - 0x1783
{
	return func_9(iParam0, 20);
}

bool func_9(int iParam0, int iParam1)//Position - 0x1793
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_10()//Position - 0x17AE
{
	return -1;
}

void func_11()//Position - 0x17B7
{
	int iVar0;
...
int func_16()//Position - 0x19E0
{
	func_17();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_17()//Position - 0x19F9
{
	int iVar0;
...
bool func_18(int iParam0)//Position - 0x1AF6
{
	return iParam0 < 3;
}

int func_19(int iParam0)//Position - 0x1B02
{
	int iVar0;
	int iVar1;
...
int func_20(int iParam0)//Position - 0x1B3F
{
	if (func_18(iParam0))
	{
...
var func_21(int iParam0)//Position - 0x1B64
{
	return Global_1798[iParam0 /*29*/];
}

bool func_22(int iParam0)//Position - 0x1B73
{
	return Global_41396 == iParam0;
}

void func_23()//Position - 0x1B81
{
	int iVar0;
...
bool func_24(int iParam0, int iParam1)//Position - 0x1BD9
{
	switch (iParam0)
	{
		case 5:
...
void func_26(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x1C6B
{
...
void func_30(vector3 vParam0, bool bParam3)//Position - 0x1EDD
{
...
int func_31(int iParam0)//Position - 0x1FAF
{
	return func_32(iParam0);
}

int func_32(int iParam0)//Position - 0x1FBD
{
	int iVar0;
...
float func_33(bool bParam0, float fParam1, float fParam2)//Position - 0x1FF5
{
	if (bParam0)
	{
		return fParam1;
...
void func_34()//Position - 0x200C
{
	if (func_36())
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_57))
		{
			VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_54, 2, 0, false);
			VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_54, 3, 0, false);
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_57))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_54, 0))
				{
					if (((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, 0) && VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(iLocal_54, 2) > 0.25f) && VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(iLocal_54, 3) > 0.25f) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, 0))
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_56))
						{
							if (ENTITY::IS_ENTITY_ATTACHED(iLocal_56))
							{
								AUDIO::PLAY_SOUND_FROM_COORD(AUDIO::GET_SOUND_ID(), "DOORS_BLOWN", ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(iLocal_54, 13), "RE_SECURITY_VAN_SOUNDSET", false, 0, 0);
...
Vector3 func_35(vector3 vParam0)//Position - 0x22BC
{
	float fVar0;
	float fVar1;
...
int func_36()//Position - 0x22FB
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_57) && ENTITY::IS_ENTITY_ATTACHED(iLocal_57))
	{
		if (!iLocal_466)
		{
			if (MISC::_IS_PROJECTILE_TYPE_IN_RADIUS(ENTITY::GET_ENTITY_COORDS(iLocal_57, true), joaat("weapon_stickybomb"), 0.25f, 0) || OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_57, true), 0.3f, WEAPON::GET_WEAPONTYPE_MODEL(joaat("weapon_stickybomb")), 0))
			{
				iLocal_466 = 1;
			}
		}
...
int func_37(vector3 vParam0, vector3 vParam3, vector3 vParam6, float fParam9, bool bParam10)//Position - 0x2464
{
	int iVar0;
...
int func_38(vector3 vParam0)//Position - 0x286F
{
...
int func_40(int iParam0, bool bParam1, bool bParam2)//Position - 0x2D39
{
	return func_41(iParam0, !bParam1, bParam2);
}

int func_41(int iParam0, bool bParam1, bool bParam2)//Position - 0x2D4C
{
	int iVar0;
...
int func_42(int iParam0, bool bParam1, int iParam2)//Position - 0x2DF0
{
	int iVar0;
...
int func_44()//Position - 0x2E5E
{
	return 1;
}

void func_45(int iParam0, int iParam1)//Position - 0x2E67
{
	if (iParam0 == -1)
	{
		iParam0 = func_65();
...
void func_46(int iParam0)//Position - 0x2F6B
{
	Global_111546 = iParam0;
}

void func_47(int iParam0, var uParam1, var uParam2)//Position - 0x2F79
{
	bool bVar0;
...
bool func_50(bool bParam0)//Position - 0x356D
{
...
int func_51()//Position - 0x3598
{
	return Global_30736;
}

int func_52(int iParam0, int iParam1)//Position - 0x35A3
{
	int iVar0;
...
int func_53(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x35F4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_54()//Position - 0x3C46
{
	return Global_1312745;
}

int func_55(int iParam0, int iParam1)//Position - 0x3C52
{
	switch (iParam0)
	{
		case 0:
...
int func_56(int iParam0)//Position - 0x3FC6
{
	switch (iParam0)
	{
		case 29:
...
void func_57(int iParam0)//Position - 0x3FF5
{
	int iVar0;
	int iVar1;
...
void func_58(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x4038
{
	func_59(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_59(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x405A
{
	int iVar0;
...
int func_62(int iParam0)//Position - 0x4394
{
	int iVar0;
	int iVar1;
...
void func_63(int iParam0, int iParam1)//Position - 0x43D7
{
	MISC::SET_BIT(&(Global_111560.f_24990.f_8[iParam0]), iParam1);
}

int func_64(int iParam0)//Position - 0x43F2
{
	int iVar0;
...
int func_66(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x44C0
{
...
void func_68(int iParam0)//Position - 0x46B5
{
	iLocal_48 = iParam0;
	iLocal_50 = 0;
}

int func_69()//Position - 0x46C4
{
	if (!OBJECT::DOES_PICKUP_EXIST(iLocal_137))
	{
		if (bLocal_109)
...
int func_70(int iParam0)//Position - 0x47CE
{
				...
				if (!PED::IS_PED_INJURED(iLocal_51[0]) || !PED::IS_PED_INJURED(iLocal_51[1]))
				{
					...
					while (iVar0 < iLocal_51)
					{
						if (!PED::IS_PED_INJURED(iLocal_51[iVar0]))
						{
							...
							{
								PED::SET_PED_DEFENSIVE_SPHERE_ATTACHED_TO_VEHICLE(iLocal_51[iVar0], iLocal_54, OBJECT::GET_PICKUP_COORDS(iLocal_137), 5f, 0);
								iLocal_123[iVar0] = 1;
							}
							if (bLocal_121)
							{
...
void func_74(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x4DBE
{
...
void func_75(var uParam0, int iParam1)//Position - 0x4E59
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
bool func_76(int iParam0)//Position - 0x4E76
{
	bool bVar0;
...
void func_77(int iParam0, bool bParam1)//Position - 0x4F5A
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
			...
			while (iVar12 < iLocal_51)
			{
				if ((((((!PED::IS_PED_INJURED(iLocal_51[iVar12]) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(iLocal_51[iVar12], true), vVar5[iVar12 /*3*/]) > 2f) && (MISC::GET_GAME_TIMER() - iLocal_504[iVar12]) > 1000) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_51[iVar12], 0)) && !iLocal_481[iVar12]) && (iParam0 == -1 || iParam0 == iVar12))
				{
					if (bParam1)
					{
						...
						{
							TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vVar5[iVar12 /*3*/], PLAYER::PLAYER_PED_ID(), 2f, false, 0.5f, 1082130432, true, 0, 0, -957453492, 20000);
							TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1);
						}
						else
						{
							TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, vVar5[iVar12 /*3*/], vLocal_501, 2f, false, 1056964608, 1082130432, 1, 0, 0, -957453492);
							TASK::TASK_AIM_GUN_AT_COORD(0, vLocal_501, -1, 1, 0);
						}
...
void func_78(float fParam0)//Position - 0x51BF
{
	if (*fParam0 > 180f)
	{
...
void func_79(int iParam0)//Position - 0x51FA
{
	float fVar0;
				...
				if (!bLocal_109)
				{
					...
					if (((!PED::IS_PED_INJURED(iLocal_51[1]) && !ENTITY::IS_ENTITY_DEAD(iLocal_51[1], 0)) && !PED::IS_PED_INJURED(iLocal_51[0])) && !ENTITY::IS_ENTITY_DEAD(iLocal_51[0], 0))
					{
						...
						if (OBJECT::DOES_PICKUP_EXIST(iLocal_137))
						{
							if (bLocal_110)
							{
								TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, OBJECT::GET_PICKUP_COORDS(iLocal_137), 2f, -1, 1048576000, 0, 1193033728);
							}
							else
							{
								TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, OBJECT::GET_PICKUP_COORDS(iLocal_137), 1f, -1, 1048576000, 0, 1193033728);
							}
							iLocal_50++;
						}
						else
...
int func_80(int iParam0)//Position - 0x58E0
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var4;
...
int func_81(var uParam0, var uParam1, var uParam2)//Position - 0x5B2C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_82(vector3 vParam0, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11, var uParam12)//Position - 0x5BB0
{
	float fVar0;
	float fVar1;
	float fVar2;
...
float func_83(float fParam0, float fParam1)//Position - 0x5CE8
{
	if (fParam0 > fParam1)
	{
		return fParam0;
...
float func_84(float fParam0, float fParam1)//Position - 0x5D02
{
	if (fParam0 < fParam1)
	{
		return fParam0;
...
void func_85(int iParam0)//Position - 0x5D1C
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_56))
...
int func_91(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8)//Position - 0x6362
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_92(int iParam0, int iParam1, bool bParam2, int iParam3)//Position - 0x6427
{
	int iVar0;
...
void func_94(int iParam0)//Position - 0x67B7
{
...
void func_95()//Position - 0x6854
{
	...
	switch (iLocal_50)
	{
		...
		case 2:
			if (!func_99())
			{
				if (!func_98(iLocal_54, 1000) && SYSTEM::TIMERA() > 10000)
				{
					bVar0 = true;
				}
				...
				while (iVar1 < iLocal_51)
				{
					if (!func_98(iLocal_51[iVar1], 1000) && (func_27() < 2f && WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6)))
					{
						bVar0 = true;
					}
...
void func_96()//Position - 0x6C4C
{
	Global_19671 = 0;
	func_97();
}

void func_97()//Position - 0x6C5C
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_98(int iParam0, int iParam1)//Position - 0x6C7D
{
	int iVar0;
...
int func_103(char* sParam0)//Position - 0x6EFB
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_104(var uParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, int iParam7, bool bParam8)//Position - 0x6F0E
{
	...
	uParam0->f_6 = 2;
	func_105(uParam0, vParam1, iParam4, iParam5, bParam6, iParam7, bParam8);
}

void func_105(var uParam0, vector3 vParam1, var uParam4, int iParam5, bool bParam6, var uParam7, bool bParam8)//Position - 0x6F44
{
	int iVar0;
...
void func_106(var uParam0)//Position - 0x721E
{
...
int func_107(int iParam0)//Position - 0x7287
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (ENTITY::IS_ENTITY_A_VEHICLE(iParam0))
...
int func_108(var uParam0)//Position - 0x72E2
{
	int iVar0;
...
int func_109(bool bParam0)//Position - 0x730D
{
	switch (Global_41396)
	{
		case 0:
...
int func_110(char* sParam0)//Position - 0x73B7
{
	if (!func_111(1, 1, 0))
	{
...
int func_111(bool bParam0, bool bParam1, bool bParam2)//Position - 0x7450
{
	int iVar0;
	int iVar1;
	...
	if ((func_118() || func_117(Global_4456448.f_190930)) || func_116())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::IS_TURRET_SEAT(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_114(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_112(int iParam0)//Position - 0x76A9
{
	if (iParam0 != func_10())
	{
...
int func_113(int iParam0, bool bParam1, bool bParam2)//Position - 0x770F
{
	int iVar0;
...
int func_114(int iParam0, int iParam1)//Position - 0x7759
{
...
int func_115(int iParam0, int iParam1)//Position - 0x77BB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_116()//Position - 0x7840
{
	return Global_2448961.f_17;
}

bool func_117(int iParam0)//Position - 0x784E
{
	return iParam0 == 51;
}

var func_118()//Position - 0x785B
{
	return Global_2448961.f_16;
}

bool func_119()//Position - 0x7869
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

int func_120(int iParam0)//Position - 0x787E
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
void func_121(var uParam0, vector3 vParam1, int iParam4)//Position - 0x78D8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_122(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x7974
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_123(bool bParam0, bool bParam1, bool bParam2)//Position - 0x7CE0
{
...
int func_124(bool bParam0, bool bParam1, bool bParam2)//Position - 0x7D32
{
	if (!func_111(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_125(bool bParam0, bool bParam1, bool bParam2)//Position - 0x7D7B
{
	if (!func_111(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_126(bool bParam0, bool bParam1, bool bParam2)//Position - 0x7DDA
{
	if (!func_111(bParam0, bParam1, bParam2))
	{
		return 0;
...
void func_127()//Position - 0x7E30
{
	MISC::SET_BIT(&Global_7357, 4);
}

void func_128(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x7E40
{
	func_129(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_129(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x7E5D
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
	{
		func_135(uParam0, 0, 0);
...
void func_130(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x7E95
{
	int iVar0;
	int iVar1;
...
void func_131(var uParam0, int iParam1, vector3 vParam2, int iParam5)//Position - 0x8204
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_132()//Position - 0x8314
{
	return func_133(PLAYER::PLAYER_ID());
}

int func_133(int iParam0)//Position - 0x8324
{
...
bool func_134(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x8343
{
	if (bParam6)
	{
...
void func_135(var uParam0, int iParam1, int iParam2)//Position - 0x838A
{
	char* sVar0;
...
void func_136(int iParam0)//Position - 0x8467
{
	MISC::SET_BIT(&(Global_111560.f_24990.f_6), iParam0);
}

void func_137(char[4] cParam0, int iParam1)//Position - 0x847E
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

bool func_138(int iParam0)//Position - 0x8495
{
	return MISC::IS_BIT_SET(Global_111560.f_24990.f_6, iParam0);
}

int func_139(int iParam0)//Position - 0x84AC
{
	if (func_142())
	{
		Global_111550 = 1;
...
void func_140(int iParam0)//Position - 0x84FF
{
	switch (iParam0)
	{
		case 0:
...
char* func_141(int iParam0)//Position - 0x85E0
{
	char* sVar0;
...
int func_143(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x865A
{
	int iVar0;
...
void func_144(var uParam0, int iParam1)//Position - 0x8791
{
	int iVar0;
...
bool func_145(int iParam0)//Position - 0x87E0
{
	return func_146(iParam0, Global_41396);
}

int func_146(int iParam0, int iParam1)//Position - 0x87F1
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_147(int iParam0)//Position - 0x89D2
{
	if (Global_41396 == 15)
	{
		return 0;
...
void func_148()//Position - 0x89F4
{
		...
		case 0:
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, 0))
			{
				if (!PED::IS_PED_INJURED(iLocal_51[0]) && !PED::IS_PED_INJURED(iLocal_51[1]))
				{
					...
					{
						if (!PED::IS_PED_IN_VEHICLE(iLocal_51[0], iLocal_54, 0) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_51[0], -1794415470) != 1)
						{
							TASK::TASK_ENTER_VEHICLE(iLocal_51[0], iLocal_54, -1, -1, 1f, 8388608, 0);
						}
						if (!PED::IS_PED_IN_VEHICLE(iLocal_51[1], iLocal_54, 0) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_51[1], -1794415470) != 1)
						{
	...
	if (iLocal_48 == 4)
	{
		...
		if (((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, 0) && func_37(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(iLocal_54, true), 25f, 0)) || (!PED::IS_PED_INJURED(iLocal_51[0]) && func_37(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(iLocal_51[0], true), 20f, 0))) || (!PED::IS_PED_INJURED(iLocal_51[1]) && func_37(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(iLocal_51[1], true), 20f, 0)))
		{
			func_68(6);
		}
		if (iLocal_48 != 4)
...
int func_158()//Position - 0x9E00
{
	...
	while (iVar0 < iLocal_51)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_51[iVar0]))
		{
			...
			{
				if ((MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_51[iVar0], true), 5f, 1) || func_37(ENTITY::GET_ENTITY_COORDS(iLocal_51[iVar0], true) + Vector(5f, 10f, 10f), ENTITY::GET_ENTITY_COORDS(iLocal_51[iVar0], true) - Vector(5f, 5f, 5f), 0f, 0f, 0f, 0, 0)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_51[iVar0], PLAYER::PLAYER_PED_ID(), 1))
				{
					bLocal_110 = true;
					return 1;
				}
...
void func_159()//Position - 0x9EC5
{
	...
	while (iVar0 < iLocal_51)
	{
		...
		ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_51[iVar0], 1, 0f);
...
float func_160(int iParam0, vector3 vParam1, bool bParam4)//Position - 0xA238
{
	vector3 vVar0;
...
int func_162(var uParam0)//Position - 0xA2C4
{
	int iVar0;
...
bool func_163(var uParam0)//Position - 0xA326
{
	return func_164(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

int func_164(int iParam0, char* sParam1, int iParam2)//Position - 0xA33D
{
...
int func_165(int iParam0)//Position - 0xA431
{
	int iVar0;
...
void func_166(var uParam0, int iParam1)//Position - 0xA45D
{
	if (iParam1 > 0)
	{
...
void func_167(var uParam0, char* sParam1)//Position - 0xA474
{
	func_168(uParam0, 1, -1, sParam1, 0);
}

void func_168(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4)//Position - 0xA487
{
	int iVar0;
...
void func_169(var uParam0, int iParam1)//Position - 0xA56F
{
	func_168(uParam0, 0, iParam1, "NULL", 0);
}

int func_170()//Position - 0xA583
{
...
int func_171(float fParam0, bool bParam1)//Position - 0xA609
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_172(int iParam0, var uParam1)//Position - 0xA6C0
{
	switch (iParam0)
	{
		case 0:
...
int func_174(int iParam0)//Position - 0xB998
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_175(int iParam0)//Position - 0xBCDE
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_176(int iParam0)//Position - 0xBD16
{
	struct<2> Var0;
...
bool func_178()//Position - 0xC196
{
	return Global_111278 > 0;
}

int func_179()//Position - 0xC1A4
{
	if (Global_95621 != -1)
	{
		return 1;
...
void func_184(var uParam0)//Position - 0xC289
{
	int iVar0;
...
void func_185(int iParam0)//Position - 0xC313
{
	func_186(iParam0, &(iParam0->f_2), iParam0->f_1);
}

void func_186(int iParam0, char* sParam1, int iParam2)//Position - 0xC329
{
	if (MISC::IS_BIT_SET(*iParam0, 30))
	{
		switch (func_165(*iParam0))
...
void func_188(int iParam0)//Position - 0xC766
{
	if (iParam0 == -1)
	{
		iParam0 = func_65();
...
void func_190(int iParam0)//Position - 0xC7D9
{
	Global_111549 = iParam0;
}

int func_191(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xC7E7
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
...
bool func_192(int iParam0)//Position - 0xCB81
{
	int iVar0;
...
int func_193(int iParam0)//Position - 0xCBA2
{
	return func_194(iParam0, 1);
}

int func_194(int iParam0, int iParam1)//Position - 0xCBB1
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_195(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0xCC04
{
	func_196(func_207(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_196(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0xCC22
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_197(float fParam0, float fParam1, float fParam2)//Position - 0xCE23
{
	float fVar0;
...
int func_198(int iParam0, int iParam1)//Position - 0xCE65
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_199(int iParam0)//Position - 0xCF07
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_200(int iParam0)//Position - 0xCF1A
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_201(int iParam0)//Position - 0xCF2D
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_202(int iParam0)//Position - 0xCF40
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_203(int iParam0)//Position - 0xCF52
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_204(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_204(bool bParam0, int iParam1, int iParam2)//Position - 0xCF77
{
	if (bParam0)
	{
		return iParam1;
...
int func_205(int iParam0)//Position - 0xCF8E
{
	return iParam0 & 15;
}

int func_206(int iParam0, int iParam1)//Position - 0xCF9B
{
	int iVar0;
	int iVar1;
...
void func_208(var uParam0, int iParam1)//Position - 0xD0ED
{
	if (iParam1 <= 0)
	{
		return;
...
void func_209(var uParam0, int iParam1)//Position - 0xD173
{
...
void func_210(var uParam0, int iParam1)//Position - 0xD1A6
{
	int iVar0;
	int iVar1;
...
void func_211(var uParam0, int iParam1)//Position - 0xD1F7
{
...
void func_212(var uParam0, int iParam1)//Position - 0xD231
{
...
void func_213(var uParam0, int iParam1)//Position - 0xD26C
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_214(int iParam0)//Position - 0xD2A8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_215(int iParam0, int iParam1)//Position - 0xD384
{
...
int func_216(int iParam0)//Position - 0xD3A7
{
	int iVar0;
...
var func_217()//Position - 0xDAC4
{
	return Global_98708.f_1;
}

int func_218()//Position - 0xDAD2
{
	if (Global_95621 != -1)
	{
...
bool func_221()//Position - 0xDB3C
{
	return Global_98721.f_346 > 0;
}

bool func_222()//Position - 0xDB4D
{
	return Global_98721.f_345 > 0;
}

var func_223()//Position - 0xDB5E
{
	return Global_1312873;
}

int func_224()//Position - 0xDB6A
{
	func_15();
	if (Global_8161[Global_19486 /*2811*/][0 /*281*/].f_259 == 2)
	{
...
bool func_225(int iParam0)//Position - 0xDB92
{
	return func_206(func_207(), iParam0);
}

int func_226(int iParam0, int iParam1, int iParam2)//Position - 0xDBA4
{
	int iVar0;
	int iVar1;
...
int func_227(int iParam0)//Position - 0xDC88
{
	if (!func_18(iParam0))
	{
		return 7;
...
bool func_228(int iParam0)//Position - 0xDCAC
{
	int iVar0;
	bool bVar1;
...
void func_232(var uParam0, bool bParam1)//Position - 0xDEB7
{
	int iVar0;
...
void func_233(var uParam0)//Position - 0xDEF2
{
	*uParam0 = 0;
	uParam0->f_1 = -1;
...
void func_234(var uParam0)//Position - 0xDF0B
{
	int iVar0;
...
void func_235(var uParam0)//Position - 0xDF44
{
	func_236(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

void func_236(int iParam0, char* sParam1, int iParam2)//Position - 0xDF5B
{
	if (MISC::IS_BIT_SET(iParam0, 30))
	{
		switch (func_165(iParam0))
...
void func_237(int iParam0)//Position - 0xE01B
{
	char cVar0[64];
...
void func_238(var uParam0)//Position - 0xE0D0
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_239(int iParam0, bool bParam1)//Position - 0xE10D
{
	switch (iParam0)
	{
		case 0:
...
void func_240(int iParam0)//Position - 0xE356
{
	Global_41947 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_241(int iParam0)//Position - 0xE368
{
	func_242(iParam0, 0, func_247(iParam0));
}

void func_242(int iParam0, int iParam1, int iParam2)//Position - 0xE37D
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_243(var uParam0)//Position - 0xE3AC
{
	struct<16> Var0;
	int iVar16;
...
void func_244(int iParam0, var uParam1)//Position - 0xE47D
{
	Global_111560.f_24990.f_43[iParam0] = *uParam1;
}

void func_245(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xE495
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_246(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xE617
{
...
int func_247(int iParam0)//Position - 0xE64F
{
	int iVar0;
...
int func_248(int iParam0)//Position - 0xE7F2
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
