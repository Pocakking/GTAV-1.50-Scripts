...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		if (Global_1663011)
		{
			if (!Global_1663013)
			{
				Global_1663010 = unk_0x67D02A194A2FC2BD("OPENING_CREDITS");
				Global_1663013 = 1;
			}
		...
		if (func_1(&iLocal_106, &(Local_95[0 /*5*/].f_4)))
		{
		}
	}
}
...
void func_2(int iParam0)//Position - 0x38EA
{
	int iVar0;
...
void func_3(bool bParam0)//Position - 0x3943
{
	if (bParam0)
	{
...
void func_5(int iParam0)//Position - 0x39E5
{
	vector3 vVar0;
...
void func_6(var uParam0, int iParam1)//Position - 0x3A52
{
	vector3 vVar0;
	float fVar3;
...
void func_7(int iParam0, var uParam1, var uParam2)//Position - 0x3B07
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
float func_8(int iParam0)//Position - 0x3D3D
{
	float fVar0;
	float fVar1;
...
void func_9(int iParam0)//Position - 0x3DBA
{
	if (MISC::IS_BIT_SET(*iParam0, 29))
	{
...
void func_10(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3E3C
{
	int iVar0;
...
int func_11(var uParam0)//Position - 0x3E6E
{
	int iVar0;
	int iVar1;
...
int func_12()//Position - 0x3EA2
{
	return Global_1312745;
}

int func_13()//Position - 0x3EAE
{
	return 1;
	return 0;
}

void func_14(int iParam0, bool bParam1, bool bParam2)//Position - 0x3EBB
{
...
void func_15(int iParam0)//Position - 0x4121
{
	Global_2541154.f_1072 = iParam0;
}

void func_16()//Position - 0x4132
{
	func_17(0);
}

void func_17(bool bParam0)//Position - 0x413F
{
	if (bParam0)
	{
		func_24();
...
void func_18(int iParam0)//Position - 0x41A2
{
	if (func_22())
	{
		return;
...
void func_20(bool bParam0, bool bParam1)//Position - 0x4253
{
	if (bParam0)
	{
		if (func_23(0))
...
bool func_21()//Position - 0x42C7
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

bool func_22()//Position - 0x42D8
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

int func_23(int iParam0)//Position - 0x42EA
{
	if (iParam0 == 1)
	{
...
void func_27(int iParam0)//Position - 0x43A4
{
	int iVar0;
...
int func_29(int iParam0, int iParam1, bool bParam2)//Position - 0x441F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_30(int iParam0)//Position - 0x44A2
{
	switch (iParam0)
	{
		case 6:
...
int func_31(int iParam0)//Position - 0x4681
{
	switch (iParam0)
	{
		case 6:
...
int func_32(int iParam0)//Position - 0x4860
{
	int iVar0;
	int iVar1;
...
void func_33(int iParam0, int iParam1)//Position - 0x4986
{
...
void func_34(bool bParam0)//Position - 0x49C4
{
	if (bParam0)
	{
...
bool func_35(int iParam0)//Position - 0x49FA
{
	return MISC::IS_BIT_SET(Global_1590446[iParam0 /*871*/].f_146, 22);
}

void func_36(bool bParam0)//Position - 0x4A13
{
	if (bParam0)
	{
...
int func_37(int iParam0)//Position - 0x4A47
{
	if (iParam0->f_6 < 31)
	{
...
void func_38(int iParam0, float fParam1)//Position - 0x4A83
{
	func_39(iParam0->f_34, 7, "FMINTRO", fParam1, 1);
}

void func_39(int iParam0, int iParam1, char* sParam2, float fParam3, bool bParam4)//Position - 0x4A9B
{
	int iVar0;
...
void func_40(int iParam0, float fParam1)//Position - 0x4B1B
{
	func_39(iParam0->f_34, 6, "FMINTRO", fParam1, 1);
}

void func_41(int iParam0)//Position - 0x4B33
{
	int iVar0;
	int iVar1;
...
bool func_42(int iParam0)//Position - 0x4B68
{
	if (iParam0 == 0)
	{
		return 1;
...
void func_43(int iParam0)//Position - 0x4B86
{
	int iVar0;
...
int func_44(int iParam0)//Position - 0x4BD5
{
	int iVar0;
...
bool func_45(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x4FAD
{
...
int func_46(char* sParam0, int iParam1, bool bParam2)//Position - 0x5001
{
	Global_20806 = 0;
...
bool func_49(int iParam0)//Position - 0x536E
{
	return func_50(iParam0, 20);
}

bool func_50(int iParam0, int iParam1)//Position - 0x537E
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_51()//Position - 0x5399
{
	return -1;
}

void func_52()//Position - 0x53A2
{
	int iVar0;
...
var func_56()//Position - 0x55A4
{
	func_57();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_57()//Position - 0x55BD
{
	int iVar0;
...
bool func_58(int iParam0)//Position - 0x56BA
{
	return iParam0 < 3;
}

int func_59(int iParam0)//Position - 0x56C6
{
	int iVar0;
	int iVar1;
...
int func_60(int iParam0)//Position - 0x5703
{
	if (func_58(iParam0))
	{
...
var func_61(int iParam0)//Position - 0x5728
{
	return Global_1798[iParam0 /*29*/];
}

bool func_62(int iParam0)//Position - 0x5737
{
	return Global_41396 == iParam0;
}

void func_63()//Position - 0x5745
{
	int iVar0;
...
bool func_64(int iParam0, int iParam1)//Position - 0x579D
{
	switch (iParam0)
	{
		case 5:
...
void func_66(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x582F
{
...
void func_67(int iParam0)//Position - 0x5885
{
	int iVar0;
	vector3 vVar1;
...
int func_68(int iParam0)//Position - 0x5963
{
	int iVar0;
	vector3 vVar1;
	float fVar4;
...
int func_69()//Position - 0x5B12
{
	return ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID());
}

void func_70(int iParam0)//Position - 0x5B22
{
	int iVar0;
...
void func_71(int iParam0)//Position - 0x5B83
{
	int iVar0;
...
int func_72(int iParam0)//Position - 0x5C24
{
	if (func_87(iParam0))
	{
...
int func_73(int iParam0)//Position - 0x5C91
{
	int iVar0;
...
void func_74(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x5D5B
{
...
void func_75(int iParam0, float fParam1)//Position - 0x5DF6
{
	func_39(iParam0->f_34, 5, "FMINTRO", fParam1, 0);
}

void func_76(int iParam0)//Position - 0x5E0E
{
	int iVar0;
...
void func_77(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x5E4C
{
	if (bParam0)
	{
...
bool func_78()//Position - 0x5F85
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_79(int iParam0, int iParam1)//Position - 0x5FA2
{
	bool bVar0;
...
int func_80(int iParam0, bool bParam1)//Position - 0x5FED
{
	int iVar0;
	int iVar1;
...
int func_81(int iParam0)//Position - 0x602E
{
...
bool func_82()//Position - 0x6070
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_83(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x6081
{
	int iVar0;
...
void func_84(int iParam0)//Position - 0x60B4
{
	if (iParam0 == 1)
	{
...
void func_85(int iParam0)//Position - 0x60D7
{
	int iVar0;
...
char* func_86(int iParam0)//Position - 0x6124
{
	switch (iParam0)
	{
		case 0:
...
int func_87(int iParam0)//Position - 0x61A7
{
	if (iParam0->f_295)
	{
		return func_88();
...
int func_88()//Position - 0x61C6
{
	return func_89(PLAYER::PLAYER_ID());
}

int func_89(int iParam0)//Position - 0x61D6
{
...
int func_90()//Position - 0x61F5
{
	return joaat("s_m_y_xmech_02");
}

void func_91(int iParam0, int iParam1)//Position - 0x6202
{
...
int func_92(int iParam0)//Position - 0x624B
{
	switch (iParam0)
	{
		case 0:
...
void func_94(int iParam0)//Position - 0x6322
{
	var uVar0;
	int iVar1;
...
void func_95(int iParam0)//Position - 0x63CD
{
...
void func_96(int iParam0)//Position - 0x6425
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_49[2]))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0->f_49[2], 0))
...
void func_98(int iParam0, char* sParam1, char* sParam2, int iParam3, vector3 vParam4, vector3 vParam7)//Position - 0x6488
{
...
void func_99(int iParam0)//Position - 0x6503
{
...
int func_101(int iParam0)//Position - 0x65AB
{
	int iVar0;
	vector3 vVar1;
...
void func_102(var uParam0, int iParam1)//Position - 0x67AE
{
	switch (iParam1)
	{
		case 0:
...
int func_103(var uParam0, int iParam1)//Position - 0x70A9
{
...
int func_104(int iParam0, bool bParam1, bool bParam2)//Position - 0x70E4
{
	int iVar0;
...
int func_105(var uParam0, int iParam1)//Position - 0x712E
{
...
void func_106(var uParam0)//Position - 0x7181
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_107(int iParam0)//Position - 0x71F0
{
	switch (iParam0)
	{
		case 0:
...
int func_108(int iParam0)//Position - 0x725B
{
	int iVar0;
	int iVar1;
...
void func_109(int iParam0)//Position - 0x7428
{
	int iVar0;
...
int func_110(var uParam0)//Position - 0x74CC
{
	int iVar0;
...
int func_111(var uParam0)//Position - 0x76B1
{
	int iVar0;
	vector3 vVar1;
	float fVar4;
...
int func_112(var uParam0, int iParam1)//Position - 0x781A
{
	switch (iParam1)
	{
		case 0:
...
void func_113(var uParam0, int iParam1)//Position - 0x7CCF
{
	switch (iParam1)
	{
		case 0:
...
void func_114(var uParam0, int iParam1)//Position - 0x7F16
{
	switch (iParam1)
	{
		case 0:
...
bool func_115(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x8034
{
	if (bParam6)
	{
...
void func_116(int iParam0, var uParam1, var uParam2)//Position - 0x807B
{
	switch (iParam0)
	{
		case 0:
...
void func_117()//Position - 0x81AA
{
	STREAMING::REQUEST_MODEL(func_90());
	STREAMING::REQUEST_ANIM_DICT(func_118());
}

char* func_118()//Position - 0x81C2
{
	return "MP_INTRO_SEQ@";
}

void func_119()//Position - 0x81CE
{
	int iVar0;
...
void func_120(int iParam0, float fParam1, float fParam2)//Position - 0x81F3
{
...
void func_121(int iParam0, int iParam1)//Position - 0x8258
{
	int iVar0;
	int iVar1;
...
void func_122(var uParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, bool bParam7)//Position - 0x8C27
{
...
void func_123(int iParam0, char* sParam1, char* sParam2, vector3 vParam3, vector3 vParam6, float fParam9, float fParam10)//Position - 0x8D4B
{
	if (!CAM::DOES_CAM_EXIST(iParam0->f_8))
	{
		iParam0->f_8 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", false);
...
void func_124(int iParam0)//Position - 0x8DBC
{
...
int func_125(int iParam0)//Position - 0x8DEA
{
	bool bVar0;
	int iVar1;
...
int func_128(int iParam0)//Position - 0x92B1
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
void func_129(char[4] cParam0, int iParam1)//Position - 0x944C
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, false, iParam1);
}

int func_130(int iParam0, int iParam1, int iParam2)//Position - 0x9463
{
	int iVar0;
...
int func_131(int iParam0)//Position - 0x94A9
{
	int iVar0;
...
void func_132(int iParam0, int iParam1)//Position - 0x9568
{
...
void func_133(int iParam0)//Position - 0x959F
{
	iParam0->f_13 = MISC::GET_GAME_TIMER();
}

int func_134(var uParam0, int iParam1, bool bParam2)//Position - 0x95AF
{
	if (iParam1 == -1)
	{
		return 1;
...
void func_135(var uParam0)//Position - 0x960D
{
	uParam0->f_1 = 0;
}

Vector3 func_136(vector3 vParam0)//Position - 0x961A
{
	return (-SYSTEM::SIN(vParam0.z) * SYSTEM::COS(vParam0.x)), (SYSTEM::COS(vParam0.z) * SYSTEM::COS(vParam0.x)), SYSTEM::SIN(vParam0.x);
}

int func_137()//Position - 0x9647
{
	return Global_1312808;
}

void func_138()//Position - 0x9653
{
...
void func_139(int iParam0)//Position - 0x96AF
{
	Global_2531497.f_4531 = iParam0;
}

void func_140()//Position - 0x96C0
{
	func_18(0);
	func_17(1);
}

bool func_141()//Position - 0x96D2
{
	return func_142();
}

int func_142()//Position - 0x96DE
{
	return func_19();
}

void func_143(bool bParam0, int iParam1)//Position - 0x96EA
{
	func_148();
	func_146(1);
	HUD::CLEAR_HELP(1);
...
void func_144(int iParam0, bool bParam1, int iParam2)//Position - 0x9755
{
	switch (iParam0)
	{
		case 5:
...
void func_146(int iParam0)//Position - 0x97FB
{
	int iVar0;
...
void func_147(int iParam0)//Position - 0x9829
{
...
int func_150()//Position - 0x992D
{
	return Global_1312467.f_19;
}

void func_151(int iParam0)//Position - 0x993B
{
...
void func_152(int iParam0, bool bParam1)//Position - 0x9956
{
	char* sVar0;
	int iVar1;
...
int func_153(int iParam0)//Position - 0x99E1
{
	struct<2> Var0;
...
struct<2> func_154(var uParam0)//Position - 0x9A15
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_155(int iParam0, bool bParam1)//Position - 0x9A67
{
	struct<2> Var0;
...
var func_156(int iParam0, int iParam1)//Position - 0x9AAA
{
	struct<5> Var0;
...
struct<5> func_157(int iParam0)//Position - 0x9ACF
{
	struct<5> Var0;
	vector3 vVar5;
...
struct<6> func_158(int iParam0, bool bParam1)//Position - 0xC107
{
	struct<6> Var0;
...
int func_159()//Position - 0xCCBD
{
	return Global_2460160;
}

bool func_160()//Position - 0xCCC9
{
	return Global_2458997;
}

void func_161(bool bParam0, bool bParam1)//Position - 0xCCD5
{
	if (bParam1)
	{
		func_179(bParam0, 0);
...
void func_162(int iParam0)//Position - 0xCCF4
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_167()//Position - 0xCE62
{
	return Global_1312467.f_18;
}

int func_168(int iParam0)//Position - 0xCE70
{
...
int func_174(int iParam0)//Position - 0xD012
{
	switch (iParam0)
	{
		case 0:
...
void func_175(var uParam0, bool bParam1, bool bParam2)//Position - 0xD3DA
{
...
char* func_176(int iParam0)//Position - 0xD417
{
	switch (iParam0)
	{
		case 0:
...
void func_177(int iParam0)//Position - 0xD7AB
{
	var uVar0;
...
var func_178()//Position - 0xD7BF
{
	return Global_1312807;
}

void func_179(bool bParam0, bool bParam1)//Position - 0xD7CB
{
	int iVar0;
...
void func_180(int iParam0)//Position - 0xD830
{
	if (iParam0 == 0)
	{
		Global_2461237 = 0;
...
void func_181(var uParam0, bool bParam1)//Position - 0xD84B
{
	uParam0->f_15 = 0;
	uParam0->f_16 = 0;
	uParam0->f_17 = 0;
...
void func_182(int iParam0)//Position - 0xD8C3
{
	Global_22209 = iParam0;
}

void func_183(bool bParam0, int iParam1)//Position - 0xD8D0
{
	if (bParam0)
	{
		func_188(1, 0, 1);
...
void func_184(int iParam0)//Position - 0xD8ED
{
	func_187();
	if (iParam0 == 0)
	{
...
void func_185(int iParam0)//Position - 0xD92E
{
...
int func_186()//Position - 0xD949
{
	return Global_1312467.f_20;
}

void func_187()//Position - 0xD957
{
	Global_2460545 = 1;
}

void func_188(int iParam0, bool bParam1, bool bParam2)//Position - 0xD964
{
	if (func_189())
	{
		return;
...
void func_191(bool bParam0)//Position - 0xD9DD
{
	if (bParam0)
	{
...
void func_192(bool bParam0)//Position - 0xDA51
{
	int iVar0;
...
void func_193(int iParam0)//Position - 0xDA88
{
	Global_98721.f_181[iParam0] = 1;
	Global_98721.f_180 = 1;
}

void func_194(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6)//Position - 0xDAA2
{
	int iVar0;
...
void func_195(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xDB31
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool func_196(int iParam0)//Position - 0xDF9D
{
	return iParam0 == 17;
}

void func_197()//Position - 0xDFAA
{
	vector3 vVar0;
...
int func_199(int iParam0)//Position - 0xE035
{
	int iVar0;
...
void func_200(int iParam0, int iParam1, int iParam2)//Position - 0xE066
{
	int iVar0;
	int iVar1;
	...
	if (iVar0 == 0)
	{
		...
		func_201(joaat("mpply_is_char_spectating"), iParam0);
	}
}

void func_201(int iParam0, int iParam1)//Position - 0xE13C
{
	int iVar0;
...
void func_204()//Position - 0xE1E1
{
	Global_22211.f_5 = 1;
}

void func_205(var uParam0, bool bParam1, bool bParam2)//Position - 0xE1EF
{
	if (uParam0->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1)
...
bool func_206(var uParam0)//Position - 0xE234
{
	return uParam0->f_1;
}

void func_207(bool bParam0)//Position - 0xE240
{
	if (bParam0)
	{
...
void func_210(int iParam0)//Position - 0xE2E2
{
	PED::SET_PED_RESET_FLAG(PLAYER::GET_PLAYER_PED(iParam0), 346, true);
}

void func_211(int iParam0)//Position - 0xE2F8
{
...
void func_212(char* sParam0, float fParam1)//Position - 0xF752
{
...
void func_213(char* sParam0, float fParam1)//Position - 0xF783
{
...
void func_214(char* sParam0, char* sParam1, float fParam2, char* sParam3, bool bParam4)//Position - 0xF7B4
{
...
void func_215(char* sParam0, char* sParam1, float fParam2, char* sParam3, bool bParam4)//Position - 0xF80F
{
...
void func_216(char* sParam0, float fParam1, float fParam2, char* sParam3, float fParam4, float fParam5)//Position - 0xF86A
{
...
void func_217(int iParam0)//Position - 0xF8BF
{
