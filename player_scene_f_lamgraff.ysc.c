...
int func_2()//Position - 0x12E
{
	...
	if (!PED::IS_PED_INJURED(Global_98390))
	{
		...
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_98390, &sLocal_277, &cLocal_309, 3))
			{
				...
				fVar0 = PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_325);
				if (!iLocal_270)
				{
					if (func_3(&uLocal_104, "PRSAUD", "FRAS_IG_7x", 3, 0, 0, 0))
					{
						iLocal_270 = 1;
					}
				}
				if (fVar0 < 0.2812f)
				{
					if (iLocal_326 != 0)
					{
						GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_326, 0);
						iLocal_326 = 0;
					}
				}
				else if (fVar0 < 0.4778f)
				{
					if (iLocal_326 == 0)
					{
						iLocal_326 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_lamgraff_paint_spray", iLocal_271, 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
						GRAPHICS::SET_PARTICLE_FX_LOOPED_COLOUR(iLocal_326, fLocal_327, fLocal_328, fLocal_329, false);
					}
				}
...
bool func_7(int iParam0)//Position - 0x659
{
	return func_8(iParam0, 20);
}

bool func_8(int iParam0, int iParam1)//Position - 0x669
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_9()//Position - 0x684
{
	return -1;
}

void func_10()//Position - 0x68D
{
	int iVar0;
...
var func_15()//Position - 0x8B5
{
	func_16();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_16()//Position - 0x8CE
{
	int iVar0;
...
bool func_17(int iParam0)//Position - 0x9CB
{
	return iParam0 < 3;
}
...
int func_19(int iParam0)//Position - 0xA14
{
	if (func_17(iParam0))
	{
...
var func_20(int iParam0)//Position - 0xA39
{
	return Global_1798[iParam0 /*29*/];
}

bool func_21(int iParam0)//Position - 0xA48
{
	return Global_41396 == iParam0;
}

void func_22()//Position - 0xA56
{
	int iVar0;
...
bool func_23(int iParam0, int iParam1)//Position - 0xAAD
{
	switch (iParam0)
	{
		case 5:
...
void func_25(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0xB3F
{
...
int func_26()//Position - 0xB95
{
	...
	if (!PED::IS_PED_INJURED(Global_98390))
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_271))
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_98390, &sLocal_277, &cLocal_293, 3))
			{
				if (FIRE::IS_ENTITY_ON_FIRE(Global_98390))
				{
					TASK::STOP_ANIM_PLAYBACK(Global_98390, 0, 0);
				...
				else
				{
					...
					{
						iLocal_325 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_273, 0f, 0f, fLocal_276, 2);
						PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_325, true);
					}
					TASK::TASK_SYNCHRONIZED_SCENE(Global_98390, iLocal_325, &sLocal_277, &cLocal_309, 8f, -8f, 257, 0, 8f, 0);
					return 1;
				}
			}
			else
...
int func_29(int iParam0, int iParam1)//Position - 0xE25
{
	vector3 vVar0;
	float fVar3;
...
int func_30(var uParam0)//Position - 0xF09
{
	return uParam0;
}

bool func_31(var uParam0, var uParam1)//Position - 0xF13
{
	return (uParam0 && uParam1) != 0;
}

int func_32()//Position - 0xF22
{
	func_16();
...
void func_34()//Position - 0xFA8
{
	func_35((Global_98392 - 1));
}

void func_35(int iParam0)//Position - 0xFBA
{
	Global_98392 = iParam0;
}

void func_36()//Position - 0xFC8
{
	func_35(0);
}

void func_37()//Position - 0xFD5
{
	STREAMING::REQUEST_MODEL(iLocal_272);
	STREAMING::REQUEST_PTFX_ASSET();
	while (!ENTITY::DOES_ENTITY_EXIST(Global_98390) || !STREAMING::HAS_MODEL_LOADED(iLocal_272))
	{
		SYSTEM::WAIT(0);
	}
	...
	func_38(&uLocal_104, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	iLocal_271 = OBJECT::CREATE_OBJECT(iLocal_272, ENTITY::GET_ENTITY_COORDS(Global_98390, true), true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_271, Global_98390, PED::GET_PED_BONE_INDEX(Global_98390, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
}

void func_38(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x10B4
{
...
void func_39(var uParam0, int iParam1)//Position - 0x114F
{
...
void func_40()//Position - 0x1185
{
	...
	func_46(iLocal_103, &vLocal_273, &fLocal_276, &cVar0);
	iLocal_272 = joaat("prop_cs_spray_can");
	Var8.f_1 = -1;
	Var8.f_17 = 4;
	Var8.f_17.f_8 = 4;
	Var8.f_17.f_13 = 4;
	...
	func_43(Var8, &Var117);
	func_41(iLocal_103, &sLocal_277, &cVar237, &cLocal_293, &uVar253, &uVar254);
	StringCopy(&cLocal_309, "Lamar_tagging_EXIT_LOOP_LAMAR", 64);
}

int func_41(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5)//Position - 0x1285
{
	*uParam4 = 9;
	*uParam5 = 8;
	switch (iParam0)
...
void func_42(char* sParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5)//Position - 0x1996
{
...
int func_43(struct<109> Param0, var uParam109)//Position - 0x19B0
{
	uParam109->f_119 = 0;
	switch (Param0.f_2)
	{
...
void func_44(var uParam0, int iParam1, int iParam2, int iParam3, vector3 vParam4, float fParam7)//Position - 0x4D2C
{
...
void func_45(var uParam0)//Position - 0x4D56
{
	func_44(uParam0, 145, 1435919172, 1435919172, 0f, 0f, 0f, 0f);
}

int func_46(int iParam0, var uParam1, var uParam2, char* sParam3)//Position - 0x4D74
{
	int iVar0;
...
bool func_47(var uParam0)//Position - 0x4F67
{
	int iVar0;
	vector3 vVar1;
	float fVar4;
...
bool func_48(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x5022
{
	if (bParam6)
	{
...
int func_49(int iParam0, var uParam1, char* sParam2)//Position - 0x5069
{
	vector3 vVar0;
	int iVar3;
	var uVar4;
...
int func_50(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0x7570
{
	switch (iParam1)
	{
		case 0:
...
int func_52(int iParam0, var uParam1, var uParam2)//Position - 0x94E0
{
	switch (iParam0)
	{
		case 11:
...
char* func_53(int iParam0)//Position - 0x9E4F
{
	switch (iParam0)
	{
		case 2014101067:
