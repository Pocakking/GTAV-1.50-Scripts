...
void func_6(vector3 vParam0, vector3 vParam3, var uParam6, var uParam7, int iParam8)//Position - 0xAC0
{
	vector3 vVar0;
...
void func_7(vector3 vParam0, var uParam3, var uParam4, int iParam5)//Position - 0xAE3
{
	float fVar0;
...
void func_15(bool bParam0)//Position - 0xE40
{
	...
	if (func_30(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (bLocal_292)
		{
			...
			func_18(&Local_294, vVar0, ENTITY::GET_ENTITY_ROTATION(PLAYER::PLAYER_PED_ID(), 2), 50f, Local_294.f_20, Local_294.f_21, 3, 1101004800, 0, 0, -1082130432, 0);
...
void func_18(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7, var uParam8, var uParam9, int iParam10, int iParam11, int iParam12, int iParam13, float fParam14, bool bParam15)//Position - 0x1020
{
	uParam0->f_1 = { vParam1 };
	uParam0->f_4 = { vParam4 };
	uParam0->f_7 = fParam7;
...
void func_19(var uParam0, float fParam1)//Position - 0x1116
{
	...
	if (func_30(PLAYER::PLAYER_PED_ID()))
	{
		...
		iVar0 = func_21(iLocal_286);
		if (!MISC::IS_STRING_NULL_OR_EMPTY(iVar0))
		{
			TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_1, iLocal_160, iVar0, 1000f, -8f, 0, 0, 1148846080, 0);
	...
	TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), iLocal_160, func_21(iLocal_286), 1000f, -8f, -1, 1, 0, 0, 0, 0);
	PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
}
...
Vector3 func_20(float fParam0)//Position - 0x1261
{
	...
	vVar0.y = (SYSTEM::COS(fParam0) * vLocal_281.y);
	vVar0.z = vLocal_281.z;
	return vVar0;
}
...
void func_24()//Position - 0x131D
{
	...
	{
		ENTITY::SET_ENTITY_COORDS(iLocal_161, vLocal_278, 1, 0, 0, 1);
...
void func_31()//Position - 0x14FB
{
	...
	func_200(&uLocal_40, 2, 2, iLocal_160, 0);
	...
	{
		iLocal_293 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -1659.446f, -1120.833f, 12.9255f, -3.6667f, 0f, 56.0716f, 50.1098f, 1, 2);
...
void func_32(char[4] cParam0, int iParam1)//Position - 0x1866
{
	...
	while (iVar0 < 2)
	{
		...
		if (iVar2 != 0)
		{
			...
			if (func_30(uParam0->f_4[iVar0]))
			{
				...
				iVar3 = func_21(iVar1);
				if (!MISC::IS_STRING_NULL_OR_EMPTY(iVar3))
				{
					TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_4[iVar0], uParam0->f_1, iLocal_160, iVar3, 1000f, -8f, 0, 0, 1148846080, 0);
...
void func_41(var uParam0, vector3 vParam1, vector3 vParam4, int iParam7, int iParam8)//Position - 0x1D33
{
	func_42(uParam0);
...
void func_52(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x616A
{
	func_53(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_53(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x6193
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
var func_62(int iParam0)//Position - 0x6863
{
	return Global_1798[iParam0 /*29*/];
}

int func_63(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x6872
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_64(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x6B68
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_65(vector3 vParam0)//Position - 0x6C1C
{
	float fVar0;
	float fVar1;
...
void func_66(int iParam0)//Position - 0x6C5B
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
int func_67(int iParam0, int iParam1)//Position - 0x6CC0
{
	struct<2> Var0;
	struct<2> Var3;
	struct<2> Var6;
...
void func_68(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x6D1D
{
	int iVar0;
...
void func_69(int iParam0, bool bParam1)//Position - 0x6EDB
{
...
Vector3 func_70(int iParam0)//Position - 0x6F17
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), 0);
}

int func_71(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x6F2A
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76389[1 /*14*/] = { func_122(iVar10, 14, uVar28[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76389[1 /*14*/] = { func_122(iVar10, 14, uVar69[iVar1], -1) };
			func_91(iParam0, Global_76389[1 /*14*/].f_12, Global_76389[1 /*14*/].f_3, Global_76389[1 /*14*/].f_4);
			func_113(14);
			if (Global_76387 == 1)
			{
...
int func_72(int iParam0, int iParam1, int iParam2)//Position - 0x7740
{
	int iVar0;
...
int func_73(int iParam0)//Position - 0x77CC
{
	switch (iParam0)
	{
...
void func_74(int iParam0, int iParam1, int iParam2)//Position - 0x7807
{
	int iVar0;
	int iVar1;
...
int func_75(int iParam0, int iParam1, int iParam2)//Position - 0x7891
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_76(int iParam0, int iParam1, int iParam2)//Position - 0x796F
{
	Global_76389[1 /*14*/] = { func_122(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 2);
}

int func_77(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x799A
{
	var uVar0;
	int iVar10;
...
int func_78(int iParam0, int iParam1, int iParam2)//Position - 0x7F9E
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8038
{
	int iVar0;
...
int func_80(int iParam0, int iParam1, int iParam2)//Position - 0x80CE
{
	int iVar0;
	int iVar1;
...
int func_81(int iParam0)//Position - 0x816F
{
	switch (iParam0)
	{
		case 0:
...
int func_82(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x821F
{
	int iVar0;
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x8526
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x90D9
{
	int iVar0;
...
int func_85(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x93BD
{
	int iVar0;
...
int func_86(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9684
{
	int iVar0;
	int iVar1;
...
int func_87(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x96BB
{
	int iVar0;
...
int func_88(int iParam0, int iParam1, int iParam2)//Position - 0x96E4
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_89(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x99AE
{
	int iVar0;
...
int func_90(int iParam0, int iParam1, int iParam2)//Position - 0x9C38
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_91(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9D8F
{
	int iVar0;
...
int func_92(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9E27
{
	switch (iParam0)
	{
...
int func_93(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9EF5
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_94(int iParam0, int iParam1)//Position - 0xA051
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_95(int iParam0)//Position - 0xA3F8
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_96(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA459
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_97(int iParam0, int iParam1)//Position - 0xA555
{
	int iVar0;
...
int func_98(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA693
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_99(int iParam0)//Position - 0xA773
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_100(int iParam0, int iParam1)//Position - 0xA7F9
{
	int iVar0;
	struct<10> Var1;
...
void func_101(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB128
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_102(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xB252
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_103(int iParam0, int iParam1)//Position - 0xB29A
{
	int iVar0;
	struct<17> Var1;
...
void func_104(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD0E3
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_105(int iParam0)//Position - 0xD2CD
{
	switch (iParam0)
	{
		case 0:
...
void func_106(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xD37D
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD3EE
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_108(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD66B
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_109(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDA90
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_110(int iParam0, int iParam1)//Position - 0xDD83
{
	int iVar0;
	int iVar1;
...
int func_111(int iParam0, int iParam1)//Position - 0xDDC9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_112(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDE29
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_113(int iParam0)//Position - 0xDEAD
{
...
void func_114(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xDF65
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_115(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xDFAF
{
	int iVar0;
...
int func_116(var uParam0)//Position - 0xDFDF
{
	int iVar0;
	int iVar1;
...
int func_117()//Position - 0xE013
{
	return Global_1312745;
}

int func_118(int iParam0, int iParam1, int iParam2)//Position - 0xE01F
{
	int iVar0;
	var uVar1;
...
bool func_119(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xE051
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xFEB8
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_121(int iParam0)//Position - 0x10DD7
{
	if (!MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_122(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10E28
{
	func_185();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_123(int iParam0, int iParam1)//Position - 0x10E7A
{
	switch (iParam0)
	{
		case 0:
...
void func_124(int iParam0)//Position - 0x10F6A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_125(&(Global_76389[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_125(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x121E1
{
	int iVar0;
	int iVar1;
...
bool func_126(int iParam0, int iParam1, var uParam2)//Position - 0x12572
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_127(int iParam0, int iParam1)//Position - 0x12977
{
	switch (iParam1)
	{
		case 0:
...
int func_128(int iParam0, int iParam1)//Position - 0x12D72
{
	switch (iParam1)
	{
		case 0:
...
int func_129(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x1316D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_130(int iParam0)//Position - 0x131AF
{
	switch (iParam0)
	{
		case -1:
...
void func_131(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x13283
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_125(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_125(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
void func_132(int iParam0)//Position - 0x1355C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x136B3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x13BC1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x13C36
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x13CAA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x13D91
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x140F5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0)//Position - 0x14306
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x14536
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x14646
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x14FE5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x15B58
{
	if (iParam0 < 136)
	{
		func_145(iParam0);
...
void func_144(int iParam0)//Position - 0x15B8D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x16791
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x1769F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x177CC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0, int iParam1)//Position - 0x178CA
{
	switch (iParam0)
	{
		case 0:
...
void func_149(int iParam0)//Position - 0x179BA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x18EAD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x18FFE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x19509
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x19B77
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x19BEB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x19CBB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x1A1EB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0x1A382
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x1AB80
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x1AC90
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x1BBBB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x1C87A
{
	if (iParam0 < 107)
	{
		func_164(iParam0);
...
void func_162(int iParam0)//Position - 0x1C8C0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x1D365
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x1E154
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x1ED9D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x1F016
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0, int iParam1)//Position - 0x1F15C
{
	switch (iParam0)
	{
		case 0:
...
void func_168(int iParam0)//Position - 0x1F24C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x1FFD6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x20152
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x206C9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x20BF3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x20C67
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x20D37
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x2120F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0)//Position - 0x21478
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_177(int iParam0)//Position - 0x2174E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x21917
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_179(int iParam0)//Position - 0x2246B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180(int iParam0)//Position - 0x230B5
{
	if (iParam0 < 60)
	{
		func_182(iParam0);
...
void func_181(int iParam0)//Position - 0x230EA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_182(int iParam0)//Position - 0x23E8A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_183(int iParam0)//Position - 0x24665
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_184(int iParam0)//Position - 0x2474C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_185()//Position - 0x2484A
{
...
int func_186(int iParam0, int iParam1, int iParam2)//Position - 0x248C3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_187(bool bParam0)//Position - 0x24B1E
{
	int iVar0;
...
void func_188(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x24B5C
{
	if (bParam0)
	{
...
bool func_189()//Position - 0x24C95
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_190(int iParam0, int iParam1)//Position - 0x24CB2
{
	bool bVar0;
...
int func_191(int iParam0, bool bParam1)//Position - 0x24CFD
{
	int iVar0;
	int iVar1;
...
int func_192(int iParam0)//Position - 0x24D3E
{
...
bool func_193()//Position - 0x24D80
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_194(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x24D91
{
	int iVar0;
...
void func_196(int iParam0)//Position - 0x24DEB
{
	if (iParam0 == 1)
	{
...
bool func_197(var uParam0)//Position - 0x24E0E
{
	int iVar0;
	int iVar1;
...
int func_198(var uParam0, int iParam1)//Position - 0x24E82
{
...
int func_199(var uParam0, int iParam1)//Position - 0x25088
{
...
int func_200(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4)//Position - 0x25225
{
	if (MISC::IS_BIT_SET(uParam0->f_113, iParam1) || MISC::IS_BIT_SET(uParam0->f_114, iParam1))
	{
		return 1;
...
void func_201(var uParam0)//Position - 0x252FD
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_202(var uParam0, int iParam1, int iParam2)//Position - 0x25322
{
	if (MISC::IS_BIT_SET(uParam0->f_113, iParam1) || MISC::IS_BIT_SET(uParam0->f_114, iParam1))
	{
		return 1;
...
void func_203(bool bParam0)//Position - 0x25371
{
	if (bParam0)
	{
		func_209();
...
void func_204(int iParam0)//Position - 0x253D4
{
	if (func_207())
	{
		return;
...
void func_205(bool bParam0, bool bParam1)//Position - 0x2545E
{
	if (bParam0)
	{
		if (func_208(0))
...
bool func_206()//Position - 0x254D2
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

bool func_207()//Position - 0x254E3
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

int func_208(int iParam0)//Position - 0x254F5
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
void func_209()//Position - 0x2554F
{
...
void func_210(bool bParam0)//Position - 0x25578
{
	if (bParam0)
	{
		HUD::CLEAR_HELP(1);
...
void func_211(int iParam0, int iParam1, int iParam2)//Position - 0x25699
{
	bool bVar0;
...
void func_212()//Position - 0x25781
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_214(bool bParam0)//Position - 0x25C8D
{
...
int func_215(int iParam0, int iParam1)//Position - 0x25CB8
{
	int iVar0;
...
int func_216(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x25D09
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_217(var uParam0)//Position - 0x2635B
{
	int iVar0;
...
int func_218(var uParam0, int iParam1)//Position - 0x26380
{
...
void func_219(int iParam0, int iParam1)//Position - 0x26573
{
	int iVar0;
...
int func_220(int iParam0, int iParam1, int iParam2)//Position - 0x265C0
{
...
int func_221(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x265F4
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_222(bool bParam0)//Position - 0x26BF3
{
	int iVar0;
	int iVar1;
...
void func_223(int iParam0)//Position - 0x26E75
{
	int iVar0;
...
void func_224(int iParam0)//Position - 0x26ECF
{
	bool bVar0;
	char cVar1[64];
...
char* func_225(int iParam0)//Position - 0x27060
{
	switch (iParam0)
	{
		case 0:
...
void func_227(int iParam0)//Position - 0x2716A
{
	func_247(93, iParam0);
	func_247(29, iParam0);
	func_247(30, iParam0);
...
bool func_228(int iParam0)//Position - 0x2718A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_229(int iParam0, int iParam1, int iParam2)//Position - 0x2733A
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_230(int iParam0)//Position - 0x27377
{
	int iVar0;
...
int func_231(int iParam0, int iParam1)//Position - 0x27713
{
	int iVar0;
...
int func_232(bool bParam0)//Position - 0x27A8C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_233(int iParam0, int iParam1)//Position - 0x27B43
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_234(int iParam0, int iParam1)//Position - 0x27B5E
{
...
int func_235(var uParam0, int iParam1)//Position - 0x27BFB
{
	int iVar0;
	var uVar1[78];
...
int func_236(var uParam0, int iParam1)//Position - 0x27CAC
{
	int iVar0;
...
bool func_237(var uParam0, int iParam1)//Position - 0x27D27
{
	return (*uParam0)[iParam1] == 78;
}

void func_238(var uParam0)//Position - 0x27D38
{
	int iVar0;
...
void func_239(var uParam0, int iParam1)//Position - 0x27D6C
{
	(*uParam0)[iParam1] = 78;
}

void func_240(var uParam0, float fParam1)//Position - 0x27D7C
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_241(var uParam0)//Position - 0x27D99
{
	return uParam0->f_80;
}

bool func_242(var uParam0, int iParam1)//Position - 0x27DA5
{
	return func_243(uParam0, iParam1) != -1;
}

int func_243(var uParam0, int iParam1)//Position - 0x27DB7
{
	int iVar0;
...
bool func_244(var uParam0)//Position - 0x27DE4
{
	return uParam0->f_79 == 1;
}

int func_245(int iParam0)//Position - 0x27DF2
{
	switch (iParam0)
	{
		case 60:
...
void func_246(int iParam0, int iParam1)//Position - 0x27E42
{
	int iVar0;
...
void func_247(int iParam0, int iParam1)//Position - 0x27E65
{
	int iVar0;
...
void func_248()//Position - 0x27EC2
{
	int iVar0;
...
int func_249(int iParam0)//Position - 0x27F37
{
	return Global_1798[iParam0 /*29*/].f_17;
}

void func_250(int iParam0, int iParam1, int iParam2, float fParam3)//Position - 0x27F48
{
	int iVar0;
	int iVar1;
	float fVar2;
...
void func_251(int iParam0, bool bParam1)//Position - 0x27FCB
{
	if (bParam1)
	{
	}
...
var func_252(int iParam0)//Position - 0x27FDC
{
	var uVar0;
...
int func_253(int iParam0)//Position - 0x27FEE
{
	if (iParam0 > -1)
	{
		if (iParam0 == PLAYER::PLAYER_ID())
...
int func_254(int iParam0)//Position - 0x28032
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_255(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x28057
{
	int iVar0;
...
int func_256(int iParam0)//Position - 0x28100
{
	if (func_26(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_257()//Position - 0x28120
{
	int iVar0;
...
void func_258(int iParam0)//Position - 0x281CB
{
	if (*iParam0 != -1)
	{
