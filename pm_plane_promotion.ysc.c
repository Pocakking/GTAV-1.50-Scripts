...
void func_1()//Position - 0xC8
{
	...
	if ((((ENTITY::DOES_ENTITY_EXIST(iLocal_241) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_241, 0)) && ENTITY::IS_ENTITY_IN_AIR(iLocal_241)) && iLocal_325) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("PLANES", false, -1))
	{
		if (!bLocal_326)
		{
			if (PAD::IS_CONTROL_JUST_PRESSED(0, 114))
			{
				if (iLocal_324 == -1 || (MISC::GET_GAME_TIMER() - iLocal_324) > 2000)
				{
					...
					{
						iLocal_332 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_property_leaflet_drop", iLocal_241, 0f, -2f, -0.65f, 0f, 0f, 0f, 1f, 0, 0, 0);
						fLocal_330 = 0f;
					}
					if (func_137("LEAFLET"))
					{
	...
	if (GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(iLocal_332))
	{
		...
		GRAPHICS::SET_PARTICLE_FX_LOOPED_EVOLUTION(iLocal_332, "spawn", fLocal_330, 0);
	}
	switch (iLocal_47)
	{
		case 0:
			...
			{
				iLocal_241 = Global_110270.f_222[0];
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_241))
				{
					iLocal_241 = VEHICLE::CREATE_VEHICLE(joaat("stunt"), vVar0, 121.2244f, true, true, false);
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_241, 1084227584);
				}
				else
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_241, true, 1);
				}
		...
		case 3:
			if (func_30(&iLocal_51, vLocal_36, -1067.083f, -2922.601f, 12.82418f, -1091.854f, -2965.403f, 23.94564f, 31.5625f, 1, iLocal_241, "LAND", "", "BK_PLANE", 1, 0, 1, -1) && !ENTITY::IS_ENTITY_IN_AIR(iLocal_241))
			{
				func_133(&iLocal_51, 1, 0);
				iLocal_47++;
			}
...
bool func_6(int iParam0)//Position - 0x923
{
	return func_7(iParam0, 20);
}

bool func_7(int iParam0, int iParam1)//Position - 0x933
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_8()//Position - 0x94E
{
	return -1;
}

void func_9()//Position - 0x957
{
	int iVar0;
...
var func_14()//Position - 0xB7F
{
	func_15();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_15()//Position - 0xB98
{
	int iVar0;
...
bool func_16(int iParam0)//Position - 0xC95
{
	return iParam0 < 3;
}

int func_17(int iParam0)//Position - 0xCA1
{
	int iVar0;
	int iVar1;
...
int func_18(int iParam0)//Position - 0xCDE
{
	if (func_16(iParam0))
	{
...
var func_19(int iParam0)//Position - 0xD03
{
	return Global_1798[iParam0 /*29*/];
}

bool func_20(int iParam0)//Position - 0xD12
{
	return Global_41396 == iParam0;
}

void func_21()//Position - 0xD20
{
	int iVar0;
...
bool func_22(int iParam0, int iParam1)//Position - 0xD77
{
	switch (iParam0)
	{
		case 5:
...
void func_24(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0xE09
{
...
int func_25(int iParam0)//Position - 0xE5F
{
...
void func_27()//Position - 0xEB1
{
	func_149(1);
	func_148();
}

int func_28(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xEC2
{
...
void func_29(int iParam0)//Position - 0x1051
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
int func_30(int iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, float fParam10, bool bParam11, int iParam12, char* sParam13, char* sParam14, char* sParam15, bool bParam16, int iParam17, bool bParam18, int iParam19)//Position - 0x107D
{
	return func_31(iParam0, vParam1, func_75(), vParam4, vParam7, bParam11, 5, 0, 0, 0, iParam12, sParam13, func_74(), func_74(), func_74(), func_74(), sParam14, 0, bParam16, sParam15, 1, iParam17, bParam18, iParam19, func_74(), func_74(), func_74(), 1, fParam10);
}

int func_31(int iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10, bool bParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, char* sParam19, char* sParam20, char* sParam21, char* sParam22, char* sParam23, char* sParam24, bool bParam25, bool bParam26, char* sParam27, bool bParam28, int iParam29, bool bParam30, int iParam31, var uParam32, var uParam33, var uParam34, bool bParam35, float fParam36)//Position - 0x10D2
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
int func_32(int iParam0, bool bParam1, bool bParam2)//Position - 0x1A2B
{
	return func_33(iParam0, !bParam1, bParam2);
}

int func_33(int iParam0, bool bParam1, bool bParam2)//Position - 0x1A3E
{
	int iVar0;
...
float func_34(bool bParam0, float fParam1, float fParam2)//Position - 0x1AE2
{
	if (bParam0)
	{
		return fParam1;
...
int func_35(int iParam0)//Position - 0x1AF9
{
...
int func_36(bool bParam0, bool bParam1, bool bParam2)//Position - 0x1B57
{
	int iVar0;
...
int func_37(int iParam0)//Position - 0x1C3C
{
	float fVar0;
...
int func_38(int iParam0, int iParam1)//Position - 0x1C73
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
int func_39(int iParam0, int iParam1)//Position - 0x1CDE
{
	int iVar0;
...
int func_40()//Position - 0x1D26
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

int func_41(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x1D36
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_42(int iParam0, int iParam1)//Position - 0x1DB1
{
	if (HUD::DOES_BLIP_EXIST(iParam0))
	{
...
int func_43(vector3 vParam0, bool bParam3)//Position - 0x1DEC
{
	int iVar0;
...
void func_44(int iParam0, char* sParam1, int iParam2)//Position - 0x1E18
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_45(iParam2), 1);
}

int func_45(int iParam0)//Position - 0x1E2F
{
	int iVar0;
...
void func_46(int iParam0, char* sParam1, bool bParam2)//Position - 0x2023
{
	if (!bParam2)
	{
...
int func_47(int iParam0)//Position - 0x205A
{
...
int func_48(int iParam0, int iParam1)//Position - 0x207E
{
...
int func_50(var uParam0)//Position - 0x20ED
{
	int iVar0;
	int iVar1;
...
int func_51(var uParam0, int iParam1)//Position - 0x2110
{
	int iVar0;
...
int func_52(int iParam0, var uParam1, int iParam2)//Position - 0x2141
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_53(char* sParam0)//Position - 0x21D5
{
...
int func_54(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, char* sParam7, float fParam8, bool bParam9, int iParam10, bool bParam11, int iParam12, var uParam13, var uParam14, var uParam15, int iParam16, bool bParam17)//Position - 0x21ED
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_55(int iParam0, var uParam1)//Position - 0x325D
{
	switch (iParam0)
	{
		case 0:
...
void func_56(var uParam0, char* sParam1, char* sParam2, bool bParam3)//Position - 0x32A5
{
	if (!bParam3)
	{
		if (!MISC::IS_STRING_NULL(sParam1))
...
void func_57(char* sParam0, char* sParam1, int iParam2, int iParam3)//Position - 0x32DE
{
	iParam3 = iParam3;
...
int func_58(int iParam0, var uParam1)//Position - 0x32FD
{
	switch (iParam0)
	{
		case 0:
...
int func_59(int iParam0, float fParam1)//Position - 0x3346
{
	int iVar0;
...
int func_60(int iParam0, int iParam1)//Position - 0x337D
{
	int iVar0;
...
int func_61(int iParam0, int iParam1)//Position - 0x33E4
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
void func_62(int iParam0, var uParam1)//Position - 0x3419
{
	switch (iParam0)
	{
		case 0:
...
void func_63(int iParam0, var uParam1)//Position - 0x3461
{
	switch (iParam0)
	{
		case 0:
...
int func_64(int iParam0, var uParam1)//Position - 0x34A9
{
	switch (iParam0)
	{
		case 0:
...
int func_65(int iParam0)//Position - 0x34F2
{
	int iVar0;
	int iVar1;
...
int func_66(int iParam0, var uParam1)//Position - 0x357F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_67(var uParam0)//Position - 0x36DF
{
	int iVar0;
...
int func_68(var uParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x370E
{
	int iVar0;
...
int func_69(int iParam0)//Position - 0x37EC
{
	float fVar0;
...
int func_70(int iParam0, int iParam1)//Position - 0x3824
{
	int iVar0;
...
void func_72(var uParam0)//Position - 0x38C1
{
	int iVar0;
...
void func_73(var uParam0)//Position - 0x3964
{
	int iVar0;
...
Vector3 func_75()//Position - 0x3A04
{
	return 0f, 0f, 2f;
}

int func_76(var uParam0)//Position - 0x3A0F
{
	float fVar0;
...
int func_77(vector3 vParam0, float fParam3, bool bParam4)//Position - 0x3B4D
{
	int iVar0;
...
void func_78(char[4] cParam0, int iParam1)//Position - 0x3B87
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

float func_79(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x3B9E
{
	vector3 vVar0;
...
void func_80(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x3BD8
{
	vector3 vVar0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102125.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102125.f_4, 0))
		{
			if (func_132(24) != Global_102125.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_129(ENTITY::GET_ENTITY_COORDS(Global_102125.f_4, true), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
				}
				func_81(Global_102125.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_81(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)//Position - 0x3C53
{
	struct<60> Var0;
...
void func_82(int iParam0, int iParam1, int iParam2)//Position - 0x3D7C
{
	int iVar0;
...
void func_83(int iParam0, int iParam1)//Position - 0x3E99
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_84(int iParam0)//Position - 0x409C
{
...
int func_85(int iParam0)//Position - 0x4179
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_86(int iParam0, bool bParam1)//Position - 0x432A
{
	int iVar0;
	struct<2> Var1;
...
int func_87(int iParam0)//Position - 0x44AA
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_89(int iParam0)//Position - 0x458D
{
	int iVar0;
	int iVar1;
...
int func_90()//Position - 0x6A58
{
	return 0;
}

int func_91()//Position - 0x6A61
{
	return 1;
}

int func_92()//Position - 0x6A6A
{
	return 1;
}

int func_93()//Position - 0x6A73
{
...
int func_95(int iParam0)//Position - 0x6B47
{
	int iVar0;
	char* sVar1;
...
int func_96(int iParam0)//Position - 0x6B8D
{
	int iVar0;
...
int func_97(int iParam0)//Position - 0x6BC8
{
	int iVar0;
...
int func_98(int iParam0)//Position - 0x6C44
{
	int iVar0;
...
int func_99(int iParam0, int iParam1, bool bParam2)//Position - 0x6D2C
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_100(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x6D9D
{
...
void func_102(var uParam0, int iParam1)//Position - 0x6EBB
{
	if (iParam1 <= 0)
	{
		return;
...
void func_103(var uParam0, int iParam1)//Position - 0x6F41
{
...
void func_104(var uParam0, int iParam1)//Position - 0x6F74
{
	int iVar0;
	int iVar1;
...
int func_105(int iParam0, int iParam1)//Position - 0x6FC5
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_106(int iParam0)//Position - 0x7067
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_107(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_107(bool bParam0, int iParam1, int iParam2)//Position - 0x708C
{
	if (bParam0)
	{
		return iParam1;
...
void func_109(var uParam0, int iParam1)//Position - 0x70B0
{
...
void func_110(var uParam0, int iParam1)//Position - 0x70EA
{
...
void func_111(var uParam0, int iParam1)//Position - 0x7125
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_112(var uParam0, int iParam1)//Position - 0x7161
{
	int iVar0;
	int iVar1;
...
int func_113(int iParam0, int iParam1)//Position - 0x885C
{
	struct<82> Var0;
...
void func_114(int iParam0, var uParam1, int iParam2)//Position - 0x889E
{
	int iVar0;
...
void func_115(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0x8AFA
{
	if (func_112(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
...
void func_116(int iParam0, bool bParam1)//Position - 0x8BF9
{
	if (iParam0 == -1)
	{
		return;
...
void func_117(int iParam0, int iParam1, bool bParam2)//Position - 0x8C56
{
	if (iParam0 == -1)
	{
		return;
...
bool func_118(int iParam0, int iParam1)//Position - 0x8C91
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_119(var uParam0, var uParam1)//Position - 0x8CB4
{
...
void func_120(int iParam0)//Position - 0x8D80
{
	if (iParam0 == -1)
	{
		return;
...
int func_121(int iParam0)//Position - 0x8DFA
{
	int iVar0;
...
bool func_122(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x8E5D
{
	if (bParam6)
	{
...
void func_123(int iParam0, var uParam1)//Position - 0x8EA4
{
	int iVar0;
...
int func_124(int iParam0)//Position - 0x914F
{
	switch (iParam0)
	{
		case 1:
...
int func_125(int iParam0, var uParam1, var uParam2)//Position - 0x91FF
{
	int iVar0;
	int iVar1;
...
int func_126(int iParam0)//Position - 0x93F2
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_127(var uParam0)//Position - 0x9412
{
	int iVar0;
...
void func_128(int iParam0)//Position - 0x94C2
{
...
int func_129(vector3 vParam0, int iParam3, var uParam4, var uParam5)//Position - 0x94E9
{
	int iVar0;
...
int func_130(vector3 vParam0, int iParam3, int iParam4)//Position - 0x95FF
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_131(int iParam0)//Position - 0x968E
{
	return MISC::IS_BIT_SET(Global_111560.f_7224[iParam0], 0);
}

int func_132(int iParam0)//Position - 0x96A6
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_133(int iParam0, bool bParam1, bool bParam2)//Position - 0x96C2
{
	int iVar0;
...
void func_134(int iParam0, var uParam1)//Position - 0x9873
{
	switch (iParam0)
	{
		case 0:
...
void func_135(var uParam0)//Position - 0x98BB
{
	if (HUD::DOES_BLIP_EXIST(uParam0->f_5))
	{
		HUD::REMOVE_BLIP(&(uParam0->f_5));
...
float func_136(float fParam0, float fParam1, float fParam2)//Position - 0x98D6
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
int func_137(char* sParam0)//Position - 0x98FD
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

float func_138(int iParam0, int iParam1, bool bParam2)//Position - 0x9910
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_139(int iParam0, bool bParam1, bool bParam2)//Position - 0x996E
{
	return func_33(iParam0, !bParam1, bParam2);
}

void func_140(char* sParam0, int iParam1, int iParam2)//Position - 0x9981
{
	iParam2 = iParam2;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
void func_141()//Position - 0x999A
{
	func_149(2);
	func_148();
}

int func_142()//Position - 0x99AB
{
...
int func_144()//Position - 0x9BE5
{
	return Global_110270.f_20;
}

int func_145(vector3 vParam0)//Position - 0x9BF3
{
...
void func_146(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x9C1D
{
...
void func_147(int iParam0, int iParam1)//Position - 0x9CB8
{
...
void func_149(int iParam0)//Position - 0x9D68
{
