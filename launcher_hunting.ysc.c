...
void __EntryFunction__()//Position - 0x0
{
	...
	MISC::CLEAR_AREA(vVar61, 3f, 1, 0, 0, false);
	while (true)
	{
		SYSTEM::WAIT(0);
		if (!func_197(&Var0, 1))
		...
		if (Var0 == 25)
		{
			func_184(&Var0, vVar61, "HUNT1AU", "HUNT1_AMB", 3, "CLETUS", 5000, 1101004800);
		}
...
int func_26(var uParam0)//Position - 0x28BD
{
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x28DF
{
	int iVar0;
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2967
{
...
int func_29(int iParam0)//Position - 0x29A7
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x29D5
{
...
int func_31(int iParam0)//Position - 0x2AB1
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2AF3
{
	int iVar0;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x2B56
{
	int iVar0;
...
int func_34(int iParam0, int iParam1)//Position - 0x2BE4
{
	struct<82> Var0;
...
void func_35(int iParam0, var uParam1, int iParam2)//Position - 0x2C26
{
	int iVar0;
...
bool func_36(int iParam0)//Position - 0x2E82
{
	return iParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2E8E
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x3139
{
	switch (iParam0)
	{
		case 1:
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x31E9
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x33DC
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0)//Position - 0x33FC
{
	int iVar0;
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x34AD
{
	char* sVar0;
...
int func_43(int iParam0, int iParam1, bool bParam2)//Position - 0x35DC
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x364D
{
...
int func_45(int iParam0)//Position - 0x3726
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x3763
{
	if (func_36(iParam0))
	{
...
var func_47(int iParam0)//Position - 0x3788
{
	return Global_1798[iParam0 /*29*/];
}

void func_48(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3797
{
	int iVar0;
	int iVar1;
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x3937
{
	int iVar0;
	var uVar1;
...
int func_62(int iParam0, int iParam1)//Position - 0x482B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, var uParam1)//Position - 0x539C
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x53D7
{
	int iVar0;
...
void func_65(int iParam0)//Position - 0x564B
{
	int iVar0;
...
void func_66(var uParam0, int iParam1)//Position - 0x5687
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_67(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x5BE2
{
	int iVar0;
	int iVar1;
...
bool func_68(int iParam0, var uParam1, var uParam2)//Position - 0x5C26
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_69(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x6341
{
	if (bParam6)
	{
...
int func_70(var uParam0)//Position - 0x6388
{
...
bool func_71(int iParam0)//Position - 0x63E3
{
	return func_72(iParam0, 0, 1);
}

int func_72(int iParam0, int iParam1, bool bParam2)//Position - 0x63F3
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x645D
{
	switch (iParam0)
	{
		case 0:
...
int func_74()//Position - 0x678D
{
	return Global_30736;
}

int func_75(int iParam0)//Position - 0x6798
{
	return func_72(iParam0, 5, 1);
}

int func_76(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x67A8
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_77(int iParam0, bool bParam1)//Position - 0x684A
{
	switch (iParam0)
	{
		case -1:
...
int func_78(int iParam0)//Position - 0x6E67
{
	if (iParam0 != func_87())
	{
...
Vector3 func_79(int iParam0, int iParam1)//Position - 0x6EC5
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_80(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6F73
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_81(vector3 vParam0, float fParam3)//Position - 0x7008
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_82(int iParam0)//Position - 0x704C
{
	struct<6> Var0;
...
struct<6> func_83(int iParam0)//Position - 0x71D0
{
	return func_84(iParam0);
}

struct<6> func_84(int iParam0)//Position - 0x71DE
{
	struct<6> Var0;
...
int func_85(int iParam0, var uParam1)//Position - 0x7CA5
{
	switch (iParam0)
	{
		case 0:
...
int func_86(int iParam0)//Position - 0x7D27
{
	if (iParam0 != func_87())
	{
...
int func_87()//Position - 0x7D85
{
	return -1;
}

Vector3 func_88(int iParam0)//Position - 0x7D8E
{
	switch (iParam0)
	{
		case 1:
...
int func_89()//Position - 0x7F99
{
	return func_90(PLAYER::PLAYER_ID());
}

int func_90(int iParam0)//Position - 0x7FA9
{
	return MISC::GET_BITS_IN_RANGE(Global_2424073[iParam0 /*421*/].f_309.f_3, 28, 31);
}

int func_91(int iParam0)//Position - 0x7FC6
{
	return func_72(iParam0, 0, 0);
}

int func_92(int iParam0)//Position - 0x7FD6
{
	switch (iParam0)
	{
		case -1:
...
int func_184(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xC65C
{
	var uVar0;
...
void func_185(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC6E4
{
...
void func_186(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC71F
{
...
void func_187(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xC775
{
...
float func_188(int iParam0, vector3 vParam1, bool bParam4)//Position - 0xC810
{
	vector3 vVar0;
...
void func_189(int iParam0, int iParam1, vector3 vParam2)//Position - 0xC84A
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_190(int iParam0, bool bParam1)//Position - 0xC93B
{
	if (iParam0 == -1)
	{
		return;
...
int func_191(int iParam0)//Position - 0xC977
{
	if (Global_76573 == iParam0)
	{
		if (Global_76574 == -1)
...
void func_192(int iParam0, int iParam1)//Position - 0xC9B0
{
	bool bVar0;
	int iVar1;
...
bool func_193()//Position - 0xCA4E
{
	return Global_96008;
}

void func_194(int iParam0)//Position - 0xCA5A
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_195(iParam0);
...
void func_195(int iParam0)//Position - 0xCA71
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_196(int iParam0)//Position - 0xCB59
{
	if (iParam0 == -1)
	{
		iParam0 = func_166();
...
int func_197(int iParam0, bool bParam1)//Position - 0xCB81
{
	struct<27> Var0;
...
void func_198(int iParam0, var uParam1, int iParam2)//Position - 0xCDF4
{
	int iVar0;
	int iVar1;
...
int func_199(int iParam0)//Position - 0xD14C
{
...
int func_200(var uParam0)//Position - 0xD16C
{
...
int func_201(var uParam0)//Position - 0xD184
{
...
void func_202(var uParam0)//Position - 0xD1A9
{
	int iVar0;
	int iVar1;
...
void func_203(int iParam0)//Position - 0xD4AD
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_204(var uParam0)//Position - 0xD4D8
{
	int iVar0;
...
int func_205(var uParam0, bool bParam1, bool bParam2)//Position - 0xD558
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_206(int iParam0, int iParam1)//Position - 0xD716
{
	int iVar0;
...
int func_207(var uParam0, bool bParam1, int iParam2)//Position - 0xD746
{
	int iVar0;
	int iVar1;
...
int func_208(int iParam0)//Position - 0xDA02
{
...
int func_209(int iParam0, float fParam1)//Position - 0xDA36
{
	float fVar0;
...
bool func_210(int iParam0, float fParam1)//Position - 0xDAAC
{
	return func_211(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_211(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDAC4
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_212(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_212(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xDB85
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_213(int iParam0, int iParam1)//Position - 0xDCB1
{
	int iVar0;
...
int func_215(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xDDC0
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_216(vector3 vParam0, vector3 vParam3)//Position - 0xDE51
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_217(vector3 vParam0)//Position - 0xDE72
{
	float fVar0;
	float fVar1;
...
void func_218(var uParam0)//Position - 0xDEB1
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_219(int iParam0, int iParam1)//Position - 0xDECC
{
	int iVar0;
...
int func_220(int iParam0)//Position - 0xDF0B
{
...
int func_221(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xDF33
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_222(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE02E
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_223(int iParam0, float fParam1)//Position - 0xE13A
{
	var uVar0;
	vector3 vVar1;
...
int func_224(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0xE1CF
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_225(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE25D
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_226(int iParam0)//Position - 0xE2A5
{
...
void func_227(int iParam0)//Position - 0xE2EF
{
	int iVar0;
...
int func_228(int iParam0)//Position - 0xE38C
{
	if (iParam0 == -1)
	{
		iParam0 = func_166();
...
int func_229(int iParam0)//Position - 0xE424
{
...
int func_232(int iParam0)//Position - 0xE4A6
{
...
int func_234(int iParam0)//Position - 0xE518
{
	if (func_108(0))
	{
...
int func_235(int iParam0)//Position - 0xE540
{
	switch (*iParam0)
	{
		case 25:
...
int func_236(var uParam0)//Position - 0xE587
{
	int iVar0[5];
	int iVar6;
	bool bVar7;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			{
				iLocal_100 = WEAPON::CREATE_WEAPON_OBJECT(joaat("weapon_sniperrifle"), 0, vLocal_97, 0, 1065353216, 0, 0, 1);
		...
		case 3:
			...
			if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(vLocal_97, 1f, iLocal_94, 0))
			{
...
void func_237(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0xE7BC
{
...
void func_238(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xE822
{
	func_239(iParam0);
...
void func_239(int iParam0)//Position - 0xE864
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_240(int iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)//Position - 0xE900
{
...
int func_241(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0xE95C
{
	int iVar0;
...
int func_242(var uParam0, int iParam1)//Position - 0xE9EA
{
	int iVar0;
...
int func_243(int iParam0)//Position - 0xEA30
{
	int iVar0;
...
int func_244(var uParam0)//Position - 0xEA61
{
	int iVar0[2];
	int iVar3;
	bool bVar4;
...
int func_245(var uParam0)//Position - 0xED16
{
	if (func_201(uParam0))
	{
...
void func_246(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xED40
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_247(int iParam0)//Position - 0xED7C
{
	struct<27> Var0;
	int iVar32;
...
int func_248(int iParam0)//Position - 0xEDD0
{
	char* sVar0;
...
int func_249(int iParam0)//Position - 0xEE89
{
	var uVar0;
...
int func_250(int iParam0)//Position - 0xEF4A
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_251(int iParam0, char* sParam1)//Position - 0xEFCF
{
...
bool func_252(int iParam0)//Position - 0xF0B1
{
...
bool func_253(int iParam0)//Position - 0xF0DF
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_254(int iParam0)//Position - 0xF10D
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_255(int iParam0)//Position - 0xF13B
{
	if (func_229(iParam0))
	{
		return 0;
...
void func_256()//Position - 0xF170
{
	func_273("Running end routines.");
	Global_111278 = (Global_111278 - 1);
}

int func_257(int iParam0, int iParam1, vector3 vParam2, float fParam5)//Position - 0xF18A
{
	int iVar0;
...
int func_258(int iParam0, vector3 vParam1, float fParam4, var uParam5)//Position - 0xF1EF
{
	int iVar0;
	struct<7> Var1;
...
int func_259(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0xF26D
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_260(int iParam0, bool bParam1)//Position - 0xF2E8
{
	if (bParam1)
	{
...
void func_261(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xF335
{
...
void func_262(var uParam0, bool bParam1)//Position - 0xF355
{
	func_263(&(uParam0->f_41), bParam1);
}

void func_263(var uParam0, bool bParam1)//Position - 0xF367
{
	int iVar0;
...
void func_264(int iParam0, bool bParam1)//Position - 0xF3A5
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_265(var uParam0, bool bParam1)//Position - 0xF3E0
{
	func_266(&(uParam0->f_35), bParam1);
}

void func_266(var uParam0, bool bParam1)//Position - 0xF3F2
{
	int iVar0;
...
void func_267(int iParam0)//Position - 0xF42F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_268(var uParam0, int iParam1)//Position - 0xF467
{
	func_269(&(uParam0->f_28), iParam1);
}

void func_269(var uParam0, int iParam1)//Position - 0xF479
{
	int iVar0;
...
void func_270(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xF4BA
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_271(int iParam0)//Position - 0xF50A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_272(var uParam0)//Position - 0xF54B
{
	if (*uParam0 == -1)
	{
		return;
...
void func_273(int iParam0)//Position - 0xF588
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(iParam0))
	{
	}
...
void func_274(var uParam0)//Position - 0xF59A
{
	*uParam0 = -1;
...
void func_275()//Position - 0xF5CD
{
	func_273("Running start routines.");
	Global_111278++;
}

int func_276(int iParam0)//Position - 0xF5E7
{
	if (!func_36(iParam0))
	{
		return func_47(iParam0);
