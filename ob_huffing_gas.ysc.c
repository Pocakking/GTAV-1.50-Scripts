...
void func_4()//Position - 0x2B1
{
	...
	switch (iLocal_293)
	{
		...
		case 2:
			...
			ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_41, iLocal_297, func_44(0), func_75(), 1000f, -8f, 0, 1148846080);
			if (!PED::_0x7F2F4F13AC5257EF(iLocal_297))
			{
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_297, true);
			}
			if (CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() != 4)
			{
		...
		case 4:
			...
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), vLocal_302, 1, false, 0, 1);
		...
		case 5:
			...
			if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_297))
			{
				...
				if (PED::_0x7F2F4F13AC5257EF(iLocal_297))
				{
					PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_297, false);
				}
				if (CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() != 4)
				{
					iLocal_296 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", true);
...
int func_6(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xD03
{
...
int func_7(char* sParam0, int iParam1, bool bParam2)//Position - 0xD51
{
	Global_20806 = 0;
...
bool func_10(int iParam0)//Position - 0x10BE
{
	return func_11(iParam0, 20);
}

bool func_11(int iParam0, int iParam1)//Position - 0x10CE
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_12()//Position - 0x10E9
{
	return -1;
}

void func_13()//Position - 0x10F2
{
	int iVar0;
...
bool func_18(int iParam0)//Position - 0x131B
{
	return Global_41396 == iParam0;
}

void func_19()//Position - 0x1329
{
	int iVar0;
...
bool func_20(int iParam0, int iParam1)//Position - 0x1381
{
	switch (iParam0)
	{
		case 5:
...
void func_22(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x1413
{
...
void func_23(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1469
{
...
int func_24()//Position - 0x1504
{
	func_25();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_25()//Position - 0x151D
{
	int iVar0;
...
bool func_26(int iParam0)//Position - 0x161A
{
	return iParam0 < 3;
}

int func_27(int iParam0)//Position - 0x1626
{
	int iVar0;
	int iVar1;
...
int func_28(int iParam0)//Position - 0x1663
{
	if (func_26(iParam0))
	{
...
var func_29(int iParam0)//Position - 0x1688
{
	return Global_1798[iParam0 /*29*/];
}

void func_30(int iParam0, bool bParam1)//Position - 0x1697
{
...
void func_32(vector3 vParam0, float fParam3, int iParam4)//Position - 0x16F8
{
	int iVar0;
	int iVar1;
...
void func_33(float fParam0)//Position - 0x1755
{
	int iVar0;
	int iVar1;
...
void func_34(int iParam0, float fParam1)//Position - 0x17E6
{
	if (func_39(iParam0))
	{
...
void func_35(int iParam0, float fParam1)//Position - 0x1809
{
...
float func_36(bool bParam0)//Position - 0x1837
{
	float fVar0;
	float fVar1;
	int iVar2;
...
float func_37(var uParam0)//Position - 0x188F
{
	if (func_39(uParam0))
	{
		if (func_38(uParam0))
...
bool func_38(var uParam0)//Position - 0x18CE
{
	return MISC::IS_BIT_SET(*uParam0, 2);
}

bool func_39(var uParam0)//Position - 0x18DE
{
	return MISC::IS_BIT_SET(*uParam0, 1);
}

void func_40(int iParam0, bool bParam1)//Position - 0x18EE
{
...
char* func_41(int iParam0)//Position - 0x1924
{
	char* sVar0;
...
char* func_44(int iParam0)//Position - 0x1AED
{
	char* sVar0;
...
char* func_45(int iParam0)//Position - 0x1BE9
{
	char* sVar0;
...
Vector3 func_46()//Position - 0x1CEE
{
	vector3 vVar0;
...
Vector3 func_47()//Position - 0x1E03
{
	vector3 vVar0;
...
void func_48()//Position - 0x1F78
{
	Global_22211.f_6 = 1;
}

void func_49(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x1F86
{
	if (bParam0)
	{
...
bool func_50()//Position - 0x20BF
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_51(int iParam0, int iParam1)//Position - 0x20DC
{
	bool bVar0;
...
int func_52(int iParam0, bool bParam1)//Position - 0x2127
{
	int iVar0;
	int iVar1;
...
int func_53()//Position - 0x2168
{
	return Global_1312745;
}

int func_54(int iParam0)//Position - 0x2174
{
...
bool func_55()//Position - 0x21B6
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_56(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x21C7
{
	int iVar0;
...
void func_57(int iParam0)//Position - 0x21FA
{
	if (iParam0 == 1)
	{
...
int func_58(char* sParam0)//Position - 0x221D
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

int func_59(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2230
{
	int iVar0;
...
int func_64(vector3 vParam0, float fParam3, var uParam4, var uParam5)//Position - 0x255C
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
int func_65(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x260F
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_68(int iParam0)//Position - 0x2763
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
Vector3 func_69()//Position - 0x27BD
{
	vector3 vVar0;
...
int func_77(int iParam0)//Position - 0x2C16
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_78(int iParam0, int iParam1)//Position - 0x2CFB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2D5B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_80(int iParam0)//Position - 0x2DDF
{
	switch (iParam0)
	{
		case 0:
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2E8F
{
...
int func_82(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x32B4
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_83(int iParam0, int iParam1)//Position - 0x3410
{
	switch (iParam0)
	{
...
int func_84(int iParam0)//Position - 0x37B7
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_85(int iParam0, int iParam1)//Position - 0x3818
{
	int iVar0;
	int iVar1;
...
int func_86(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x385E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_87(int iParam0, int iParam1)//Position - 0x395A
{
	int iVar0;
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3A98
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_89(int iParam0)//Position - 0x3B78
{
	switch (iParam0)
	{
		case 0:
...
int func_90(int iParam0)//Position - 0x3BFE
{
	if (Global_76577)
	{
		return 1;
...
int func_92(int iParam0)//Position - 0x3FD6
{
...
int func_94(int iParam0)//Position - 0x401F
{
...
int func_98(int iParam0)//Position - 0x40AA
{
	if (Global_41396 == 15)
	{
		return 0;
...
bool func_99(int iParam0)//Position - 0x40CC
{
	return func_100(iParam0, Global_41396);
}

int func_100(int iParam0, int iParam1)//Position - 0x40DD
{
	if (iParam1 == 15)
	{
		return 1;
