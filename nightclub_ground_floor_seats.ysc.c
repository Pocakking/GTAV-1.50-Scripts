...
int func_76()//Position - 0x2330
{
	return Global_30736;
}

bool func_77()//Position - 0x233B
{
	return Global_2448961.f_598;
}

int func_78(int iParam0)//Position - 0x234A
{
...
bool func_79()//Position - 0x2361
{
	return Global_2458999;
}

bool func_80()//Position - 0x236D
{
	return Global_2448961.f_593;
}

void func_81(var uParam0)//Position - 0x237C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_82(int iParam0)//Position - 0x23EF
{
	vector3 vVar0;
	int iVar3;
	int iVar4;
...
int func_83(int iParam0, var uParam1)//Position - 0x2470
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
bool func_85()//Position - 0x250D
{
	return MISC::IS_BIT_SET(Global_1676879.f_3, 6);
}

int func_86()//Position - 0x2520
{
	if (Global_2424073[PLAYER::PLAYER_ID() /*421*/].f_309.f_8 != func_19())
	{
...
void func_88(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x25F1
{
	vector3 vVar0;
	float fVar3;
	...
	(uParam1[iParam2 /*14*/])->f_1 = { func_90(func_91(), fVar3) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_3 = { func_90(func_89(), fVar3) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_6 = 1.25f;
}

Vector3 func_89()//Position - 0x266C
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_90(vector3 vParam0, float fParam3)//Position - 0x267F
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
Vector3 func_91()//Position - 0x26C3
{
	return -0.5f, -0.5f, 0f;
}

void func_92(int iParam0, var uParam1, var uParam2)//Position - 0x26D6
{
	if (func_12())
	{
		switch (iParam0)
...
void func_93()//Position - 0x2976
{
}

int func_94(int iParam0, int iParam1, bool bParam2)//Position - 0x297E
{
	int iVar0;
