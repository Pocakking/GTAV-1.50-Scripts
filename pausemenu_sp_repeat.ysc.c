...
int func_13(int iParam0, int iParam1, int iParam2)//Position - 0x669
{
	int iVar0;
	var uVar1;
...
int func_14(var uParam0)//Position - 0x69B
{
	int iVar0;
	int iVar1;
...
var func_15()//Position - 0x6CF
{
	return Global_1312745;
}

int func_16(int iParam0)//Position - 0x6DB
{
	switch (iParam0)
	{
		case 0:
...
int func_17()//Position - 0xA0B
{
	return Global_30736;
}

bool func_18()//Position - 0xA16
{
	return Global_98721.f_345 > 0;
}

bool func_19()//Position - 0xA27
{
	return Global_98721.f_346 > 0;
}

bool func_20()//Position - 0xA38
{
	return MISC::IS_BIT_SET(Global_76825, 9);
}

bool func_21()//Position - 0xA4A
{
	return MISC::IS_BIT_SET(Global_76825, 8);
}

int func_22()//Position - 0xA5C
{
...
bool func_23(var uParam0, int iParam1)//Position - 0xBD1
{
	return (uParam0 && iParam1) != 0;
}

bool func_24(bool bParam0)//Position - 0xBE0
{
...
bool func_25(int iParam0)//Position - 0xC0B
{
	return Global_41396 == iParam0;
}

int func_26()//Position - 0xC19
{
	if (Global_41396 == 15)
	{
		return 0;
...
void func_27(int iParam0)//Position - 0xC2E
{
	Global_76843 = iParam0;
}

void func_28(int iParam0, bool bParam1)//Position - 0xC3C
{
	if (bParam1 == 1)
	{
		func_29(0, 1);
...
void func_29(bool bParam0, int iParam1)//Position - 0xC6B
{
	char* sVar0;
	char* sVar1;
	int iVar2;
...
void func_30(char* sParam0)//Position - 0xDEC
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}

void func_31(int iParam0)//Position - 0xDFE
{
	if (iParam0 == 1)
	{
...
void func_32(int iParam0, int iParam1)//Position - 0xE26
{
	if (func_8() == -1)
	{
...
void func_33(int iParam0, int iParam1)//Position - 0xE74
{
...
int func_34(int iParam0)//Position - 0xE9F
{
	int iVar0;
...
int func_36(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xF0D
{
	int iVar0;
...
void func_37(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0xF65
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_38(int iParam0, int iParam1, int iParam2)//Position - 0x1053
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_39(int iParam0, int iParam1)//Position - 0x10CF
{
	switch (iParam1)
	{
		case 1:
...
int func_40(int iParam0)//Position - 0x1110
{
	switch (iParam0)
	{
		case 0:
...
int func_41(int iParam0, int iParam1)//Position - 0x1456
{
	switch (iParam1)
	{
		case 1:
...
int func_42(int iParam0, int iParam1)//Position - 0x149E
{
	switch (iParam1)
	{
		case 1:
...
int func_44(var uParam0)//Position - 0x155C
{
	int iVar0;
...
int func_45(int iParam0)//Position - 0x1596
{
	switch (iParam0)
	{
		case 1:
...
void func_46(int iParam0)//Position - 0x15C5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_47(int iParam0)//Position - 0x1709
{
...
float func_48(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4)//Position - 0x1726
{
	float fVar0;
	int iVar1;
...
int func_49(int iParam0)//Position - 0x17F8
{
	int iVar0;
...
int func_50(float fParam0)//Position - 0x1834
{
	if (fParam0 == 0f)
	{
		return 0;
...
float func_51(int iParam0, int iParam1, bool bParam2)//Position - 0x1869
{
	float fVar0;
	float fVar1;
...
void func_52(int iParam0, int iParam1)//Position - 0x18C8
{
	int iVar0;
...
int func_53(int iParam0, int iParam1, int iParam2)//Position - 0x1988
{
	struct<13> Var0;
	int iVar13;
	int iVar14;
...
void func_54(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1BEE
{
	if (iParam5 != 0)
	{
...
char* func_55(int iParam0)//Position - 0x1C5E
{
	switch (iParam0)
	{
		case 0:
...
void func_56(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2E39
{
	if (iParam5 != 0)
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam5, "SET_DATA_SLOT");
...
void func_57(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x2EA9
{
	int iVar0;
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x2F2E
{
	float fVar0;
...
void func_59(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4)//Position - 0x2FB7
{
	if (iParam4 != 0)
	{
...
void func_60(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x301C
{
	int iVar0;
	int iVar1;
...
void func_61(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x30BB
{
	if (iParam5 != 0)
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam5, "SET_DATA_SLOT");
...
char* func_62(int iParam0)//Position - 0x312B
{
	switch (iParam0)
	{
		case 0:
...
int func_63(int iParam0)//Position - 0x434D
{
...
int func_64(int iParam0, int iParam1)//Position - 0x4370
{
	if (iParam1 < 0)
	{
		return 0;
...
int func_65()//Position - 0x443A
{
	func_66();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_66()//Position - 0x4453
{
	int iVar0;
...
bool func_67(int iParam0)//Position - 0x4550
{
	return iParam0 < 3;
}

int func_68(int iParam0)//Position - 0x455C
{
	int iVar0;
	int iVar1;
...
int func_69(int iParam0)//Position - 0x4599
{
	if (func_67(iParam0))
	{
...
var func_70(int iParam0)//Position - 0x45BE
{
	return Global_1798[iParam0 /*29*/];
}

int func_71(int iParam0)//Position - 0x45CD
{
	int iVar0;
...
int func_72(int iParam0)//Position - 0x45F6
{
	int iVar0;
...
int func_73(int iParam0, int iParam1, int iParam2)//Position - 0x461B
{
	switch (iParam1)
	{
		case 1:
...
int func_74(int iParam0, int iParam1)//Position - 0x465E
{
	switch (iParam0)
	{
		case 2:
...
int func_75(int iParam0, int iParam1)//Position - 0x4D42
{
	switch (iParam1)
	{
		case 1:
...
int func_76(int iParam0)//Position - 0x4D7D
{
	switch (iParam0)
	{
		case 2:
...
void func_77(int iParam0)//Position - 0x4F2E
{
...
struct<2> func_78(int iParam0, int iParam1)//Position - 0x4F53
{
	struct<2> Var0;
...
struct<2> func_79(int iParam0)//Position - 0x4FE9
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_80(int iParam0)//Position - 0x5021
{
	struct<2> Var0;
...
void func_82(int iParam0, int iParam1, int iParam2)//Position - 0x54A4
{
	int iVar0;
...
void func_84(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, char* sParam5, int iParam6)//Position - 0x565C
{
