...
void func_9()//Position - 0x1518
{
	...
	{
		PED::SET_PED_MOVEMENT_CLIPSET(iLocal_240, sLocal_448, 1048576000);
	}
}

void func_10()//Position - 0x1539
{
	func_9();
	if (func_102(iLocal_240) && func_102(PLAYER::PLAYER_PED_ID()))
	{
...
void func_11()//Position - 0x157F
{
}

void func_12(var uParam0, int iParam1)//Position - 0x1587
{
...
void func_13()//Position - 0x15A4
{
	Global_19671 = 0;
	func_14();
}

void func_14()//Position - 0x15B4
{
...
int func_16()//Position - 0x1632
{
	func_17();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_17()//Position - 0x164B
{
	int iVar0;
...
bool func_18(int iParam0)//Position - 0x1748
{
	return Global_41396 == iParam0;
}

bool func_19(int iParam0)//Position - 0x1756
{
	return iParam0 < 3;
}

int func_20(int iParam0)//Position - 0x1762
{
	int iVar0;
	int iVar1;
...
int func_21(int iParam0)//Position - 0x179F
{
	if (func_19(iParam0))
	{
...
var func_22(int iParam0)//Position - 0x17C4
{
	return Global_1798[iParam0 /*29*/];
}

void func_23(char* sParam0)//Position - 0x17D3
{
	struct<16> Var0;
...
void func_24(char* sParam0)//Position - 0x17F9
{
	int iVar0;
...
void func_25(char* sParam0)//Position - 0x1837
{
	int iVar0;
...
void func_26(int iParam0, char* sParam1)//Position - 0x187B
{
	switch (iParam0)
	{
		case 0:
...
void func_27(char* sParam0)//Position - 0x1A44
{
	char cVar0[64];
...
void func_28(char* sParam0)//Position - 0x1A78
{
	struct<4> Var0;
...
void func_29(char* sParam0)//Position - 0x1AA3
{
...
void func_30()//Position - 0x1AC4
{
	iLocal_254 = MISC::GET_RANDOM_INT_IN_RANGE(0, iLocal_253);
}

void func_31(char* sParam0)//Position - 0x1AD5
{
	int iVar0;
...
bool func_33(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1B41
{
...
int func_34(char* sParam0, int iParam1, bool bParam2)//Position - 0x1B8F
{
	Global_20806 = 0;
...
bool func_37(int iParam0)//Position - 0x1EFC
{
	return func_38(iParam0, 20);
}

bool func_38(int iParam0, int iParam1)//Position - 0x1F0C
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_39()//Position - 0x1F27
{
	return -1;
}

void func_40()//Position - 0x1F30
{
	int iVar0;
...
bool func_46(int iParam0, int iParam1)//Position - 0x21AD
{
	switch (iParam0)
	{
		case 5:
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x21E8
{
...
void func_48(char[4] cParam0)//Position - 0x223E
{
	int iVar0;
...
void func_49(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2279
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_50(char* sParam0)//Position - 0x2314
{
	int iVar0;
...
void func_51(var uParam0)//Position - 0x234C
{
}

void func_52(var uParam0, int iParam1, float fParam2)//Position - 0x2354
{
}

void func_53()//Position - 0x235C
{
	STREAMING::REMOVE_ANIM_DICT(&Local_388);
}

void func_54()//Position - 0x236B
{
	char* sVar0;
	struct<16> Var8;
...
void func_55(var uParam0)//Position - 0x23E1
{
}

void func_56(char* sParam0)//Position - 0x23E9
{
...
void func_57(int iParam0, char* sParam1, char* sParam2)//Position - 0x23FC
{
...
bool func_59()//Position - 0x24DE
{
	return Global_98721.f_345 > 0;
}

bool func_60()//Position - 0x24EF
{
	bool bVar0;
...
void func_64(char* sParam0)//Position - 0x2572
{
	struct<8> Var0;
...
void func_65(char* sParam0)//Position - 0x25B2
{
	func_26(iLocal_297, sParam0);
}

void func_66(char* sParam0)//Position - 0x25C3
{
	StringCopy(sParam0, "MONOLOGUE_", 16);
	StringIntConCat(sParam0, Global_111505[iLocal_251] + 1, 16);
}

void func_67(int iParam0, bool bParam1)//Position - 0x25E1
{
	int iVar0;
...
void func_68(int iParam0, bool bParam1)//Position - 0x2602
{
	int iVar0;
...
void func_69(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x2673
{
	func_70(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_70(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2693
{
	int iVar0;
...
int func_72(int iParam0)//Position - 0x2985
{
	int iVar0;
	int iVar1;
...
int func_75(int iParam0)//Position - 0x2ACE
{
	if (func_77(iParam0))
	{
...
int func_76(int iParam0)//Position - 0x2AF5
{
	int iVar0;
...
int func_77(int iParam0)//Position - 0x2B28
{
...
int func_78(int iParam0)//Position - 0x2B52
{
	switch (iParam0)
	{
...
void func_79(int iParam0)//Position - 0x2C10
{
	if (iLocal_447 == 1)
	{
...
void func_80(int iParam0, int iParam1, bool bParam2)//Position - 0x2C2F
{
	if (iLocal_447 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
...
int func_81(int iParam0, bool bParam1, int iParam2)//Position - 0x2C82
{
	int iVar0;
...
int func_82(int iParam0, bool bParam1, bool bParam2)//Position - 0x2CCC
{
	int iVar0;
...
float func_83(bool bParam0, float fParam1, float fParam2)//Position - 0x2D70
{
	if (bParam0)
	{
		return fParam1;
...
float func_84(int iParam0, int iParam1, bool bParam2)//Position - 0x2D87
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_85(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2DE5
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_86(vector3 vParam0, vector3 vParam3)//Position - 0x2E76
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_87(vector3 vParam0)//Position - 0x2E97
{
	float fVar0;
	float fVar1;
...
int func_88(int iParam0)//Position - 0x2ED6
{
	var uVar0;
...
void func_91()//Position - 0x2F2A
{
	Global_19671 = 0;
	func_92();
}

void func_92()//Position - 0x2F3A
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_93()//Position - 0x2F5B
{
	return 1;
}

void func_94()//Position - 0x2F64
{
}

int func_95()//Position - 0x2F6C
{
	return 1;
}

float func_96(int iParam0, int iParam1)//Position - 0x2F75
{
	return func_84(iParam0, iParam1, 1);
}

void func_97(int iParam0)//Position - 0x2F86
{
	int iVar0;
...
int func_98(int iParam0)//Position - 0x2FB7
{
	int iVar0;
	int iVar1;
...
int func_99(int iParam0, bool bParam1)//Position - 0x2FE8
{
	if (!func_77(iParam0))
	{
		if (!bParam1)
...
void func_100(var uParam0, var uParam1)//Position - 0x309B
{
	*uParam0 = (*uParam0 || uParam1);
}

void func_101(int iParam0, bool bParam1)//Position - 0x30AC
{
	if (iParam0 == 1)
	{
		TASK::TASK_PLAY_ANIM(iLocal_240, &cLocal_324, &Local_218, 2f, -2f, -1, 0, 0, 0, 0, 0);
...
int func_102(int iParam0)//Position - 0x311E
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_103()//Position - 0x313F
{
	func_104();
}

void func_104()//Position - 0x314B
{
...
int func_110(int iParam0)//Position - 0x3295
{
...
bool func_111(var uParam0)//Position - 0x32C1
{
	return func_112(Global_111560.f_20112, uParam0);
}

bool func_112(var uParam0, var uParam1)//Position - 0x32D6
{
	return (uParam0 && uParam1) != 0;
}

int func_113(int iParam0)//Position - 0x32E5
{
...
void func_114(int iParam0)//Position - 0x340C
{
	var uVar0;
...
void func_115(int iParam0)//Position - 0x34DB
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
struct<6> func_116()//Position - 0x34FB
{
	struct<6> Var0;
...
void func_117()//Position - 0x351F
{
	func_118();
}

void func_118()//Position - 0x352B
{
	if (iLocal_449 == 1)
	{
