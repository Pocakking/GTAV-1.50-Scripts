...
void __EntryFunction__()//Position - 0x0
{
	...
	sLocal_89 = "idle";
	cLocal_90 = "MM_LETREAD";
	cLocal_91 = "MM_LETCANC";
...
void func_2(char[4] cParam0, int iParam1)//Position - 0x449
{
...
struct<4> func_9(int iParam0)//Position - 0x70B
{
	return Global_1798[iParam0 /*29*/].f_3;
}

int func_10(int iParam0, int iParam1)//Position - 0x71E
{
...
int func_11(int iParam0, int iParam1)//Position - 0x748
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_12(int iParam0, int iParam1, int iParam2)//Position - 0x772
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_13(int iParam0, int iParam1, int iParam2)//Position - 0x7B7
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
int func_15()//Position - 0x89E
{
	func_16();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_16()//Position - 0x8B7
{
	int iVar0;
...
bool func_17(int iParam0)//Position - 0x9B4
{
	return iParam0 < 3;
}

int func_18(int iParam0)//Position - 0x9C0
{
	int iVar0;
	int iVar1;
...
int func_19(int iParam0)//Position - 0x9FD
{
	if (func_17(iParam0))
	{
...
var func_20(int iParam0)//Position - 0xA22
{
	return Global_1798[iParam0 /*29*/];
}

bool func_21(int iParam0)//Position - 0xA31
{
	return Global_41396 == iParam0;
}

bool func_22(int iParam0)//Position - 0xA3F
{
	int iVar0;
	int iVar1;
...
int func_23(int iParam0, int iParam1)//Position - 0xA78
{
	if (iParam1 == 0)
	{
		return 1;
...
void func_24(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0xA9A
{
	func_25(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_25(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0xAC4
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_26(vector3 vParam0)//Position - 0xEB8
{
...
int func_27(int iParam0, int iParam1, bool bParam2)//Position - 0xEE2
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_28(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0xF53
{
...
int func_29(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x1024
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_30(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x131A
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_31(vector3 vParam0)//Position - 0x13CE
{
	float fVar0;
	float fVar1;
...
void func_32(int iParam0)//Position - 0x140D
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_33(int iParam0, bool bParam1)//Position - 0x1472
{
	if (bParam1)
	{
...
bool func_34(int iParam0)//Position - 0x1492
{
	return MISC::IS_BIT_SET(iLocal_92, iParam0);
}

void func_35()//Position - 0x14A2
{
	int iVar0;
...
void func_36(vector3 vParam0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x1751
{
	int iVar0;
	int iVar1;
...
var func_39(int iParam0, int iParam1)//Position - 0x1809
{
	struct<5> Var0;
...
struct<5> func_40(int iParam0)//Position - 0x182E
{
	struct<5> Var0;
	vector3 vVar5;
...
struct<6> func_41(int iParam0, bool bParam1)//Position - 0x3E64
{
	struct<6> Var0;
...
Vector3 func_42()//Position - 0x4BAF
{
	return 2.55f, 5.665f, 2.55f;
}

void func_43(bool bParam0)//Position - 0x4BC6
{
	func_33(5, bParam0);
	CLOCK::PAUSE_CLOCK(bParam0);
}

void func_44(int iParam0, vector3 vParam1, float fParam4)//Position - 0x4BDB
{
	ENTITY::SET_ENTITY_COORDS(iParam0, vParam1, 1, false, 0, 1);
	ENTITY::SET_ENTITY_HEADING(iParam0, fParam4);
}

void func_45(int iParam0, bool bParam1)//Position - 0x4BF9
{
	char* sVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x4C84
{
	struct<2> Var0;
...
struct<2> func_47(var uParam0)//Position - 0x4CB8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_48(int iParam0, bool bParam1)//Position - 0x4D0A
{
	struct<2> Var0;
...
void func_49()//Position - 0x4D4D
{
	...
	{
		case 0:
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vVar0, vVar3, fVar6, 0, true, 0) && !func_5(0))
			{
				func_53(cLocal_90);
				iLocal_73++;
			}
...
int func_50(char* sParam0)//Position - 0x4F4A
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_51(bool bParam0)//Position - 0x4F5D
{
	func_33(6, !bParam0);
	PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), bParam0, 0);
}

bool func_52(int iParam0, int iParam1)//Position - 0x4F78
{
	int iVar0;
...
void func_53(char[4] cParam0)//Position - 0x4F98
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 1, true, -1);
}

void func_54(int iParam0)//Position - 0x4FAE
{
	if (func_59())
	{
		return;
...
void func_55(int iParam0)//Position - 0x4FE1
{
	if (func_59())
	{
		return;
...
void func_57(bool bParam0, bool bParam1)//Position - 0x5092
{
	if (bParam0)
	{
		if (func_5(0))
...
bool func_58()//Position - 0x5106
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

bool func_59()//Position - 0x5117
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

void func_60()//Position - 0x5129
{
	Global_22211.f_6 = 1;
}

void func_61(bool bParam0, int iParam1)//Position - 0x5137
{
	func_33(4, !bParam0);
	if (bParam0)
	{
...
int func_64(int iParam0)//Position - 0x522D
{
	if (!func_17(iParam0))
	{
		return 7;
...
int func_66(int iParam0)//Position - 0x5295
{
...
int func_67(int iParam0)//Position - 0x52C1
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_68(int iParam0, bool bParam1, bool bParam2)//Position - 0x52E2
{
	if (bParam1)
	{
...
bool func_70(bool bParam0)//Position - 0x5371
{
...
bool func_73()//Position - 0x53D2
{
	return SYSTEM::VDIST2(func_75(iLocal_85), vLocal_82) < func_74(iLocal_85);
}

float func_74(int iParam0)//Position - 0x53EF
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_75(int iParam0)//Position - 0x5460
{
	switch (iParam0)
	{
		case 0:
...
bool func_76(int iParam0)//Position - 0x552F
{
	return MISC::IS_BIT_SET(Global_111560.f_10044.f_133, iParam0);
}

int func_77()//Position - 0x5546
{
	switch (iLocal_85)
	{
		case 0:
...
bool func_78(vector3 vParam0)//Position - 0x55E9
{
	var uVar0;
	var uVar1;
...
bool func_79()//Position - 0x55FD
{
	return SYSTEM::VDIST2(func_81(iLocal_85), vLocal_82) < func_80(iLocal_85);
}

float func_80(int iParam0)//Position - 0x561A
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_81(int iParam0)//Position - 0x568C
{
	switch (iParam0)
	{
		case 0:
...
void func_83(vector3 vParam0)//Position - 0x577B
{
	int iVar0;
	int iVar1;
...
void func_84()//Position - 0x57DE
{
	switch (iLocal_85)
	{
		...
		case 4:
			func_86(-671910391);
			func_85(sLocal_88);
			iLocal_78 = PED::CREATE_PED(26, -671910391, func_75(4), 184.5548f, 1, true);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-671910391);
			TASK::TASK_PLAY_ANIM(iLocal_78, sLocal_88, sLocal_89, 1000f, -1000f, -1, 9, 0, 0, 0, 0);
		...
		case 5:
			iLocal_75 = 731806707;
			OBJECT::ADD_DOOR_TO_SYSTEM(iLocal_75, joaat("v_ilev_sol_off_door01"), -1002.147f, -478.064f, 50.117f, 1, true, 0);
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(iLocal_75, 1, true, false);
			iLocal_74 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, -1008.056f, -476.7573f, 50.2493f, -89.5003f, 0f, 38.7952f, 50f, 0, 2);
			break;
		
		case 6:
			func_86(732742363);
			iLocal_76 = PED::CREATE_PED(26, 732742363, func_75(6), 22.9631f, 1, true);
			...
			iLocal_77 = OBJECT::CREATE_OBJECT_NO_OFFSET(130556722, -543.71f, 1986.2f, 126.05f, true, true, false);
			break;
	}
}

void func_85(char* sParam0)//Position - 0x5996
{
...
void func_86(int iParam0)//Position - 0x59B6
{
...
void func_87(int iParam0, vector3 vParam1, float fParam4)//Position - 0x59D6
{
...
bool func_88(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x59FC
{
	return SYSTEM::VDIST(vParam0, vParam3) <= fParam6;
}

int func_89()//Position - 0x5A13
{
	int iVar0;
...
void func_91()//Position - 0x5AE2
{
	switch (iLocal_85)
	{
		...
		case 5:
			...
			if (func_50(cLocal_90) || func_50(cLocal_91))
			{
				HUD::CLEAR_HELP(1);
			}
			break;
		...
		case 6:
			...
			if (func_34(2))
			{
				ENTITY::REMOVE_MODEL_HIDE(vLocal_68, 200f, -1241212535, false);
			}
			break;
	}
}
