				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
				{
					...
					else
					{
						switch (iLocal_1035)
						{
							...
							case 2:
								TASK::TASK_VEHICLE_DRIVE_TO_COORD(func_92(iLocal_1015), iVar0, vLocal_1003, 15f, 0, 1938952078, 786484, 5f, 5f);
	...
	if (iLocal_1036 < 8)
	{
		if (iLocal_1036 < 4)
		{
			if (ENTITY::DOES_ENTITY_EXIST(Global_95196.f_9[iLocal_1036]))
			{
				...
				{
					if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(Global_95196.f_9[iLocal_1036], 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < 900f)
					{
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95196.f_9[iLocal_1036], 1, 1);
						iLocal_834[iLocal_1036] = Global_95196.f_9[iLocal_1036];
						bVar0 = true;
						Global_95196.f_9[iLocal_1036] = 0;
					}
					else if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(Global_95196.f_9[iLocal_1036], 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > 2500f && ENTITY::IS_ENTITY_OCCLUDED(Global_95196.f_9[iLocal_1036]))
					{
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95196.f_9[iLocal_1036], 1, 1);
...
void func_99()
{
	...
	{
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95196[0], 1, 1);
	...
	if ((ENTITY::DOES_ENTITY_EXIST(Global_95196[1]) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_95196[1], 0)) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_95196[1], 0))
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95196[1], 1, 1);
