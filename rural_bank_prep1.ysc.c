...
void func_8()//Position - 0x4A3
{
	...
	switch (iLocal_1481)
	{
		...
		case 1:
			if (func_46(&Local_403, vLocal_49, 0.1f, 0.1f, 2f, 1, Local_94[0 /*2*/], "RHP_RTN", "", "RHP_BK", 1, 0, 1, -1) || (HUD::DOES_BLIP_EXIST(Local_403.f_5) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_94[0 /*2*/], 1359.476f, 3614.326f, 36.87141f, 1356.748f, 3621.605f, 33.72731f, 5f, 0, true, 0)))
			{
...
bool func_16(int iParam0)//Position - 0xC17
{
	return func_17(iParam0, 20);
}

bool func_17(int iParam0, int iParam1)//Position - 0xC27
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_18()//Position - 0xC42
{
	return -1;
}

void func_19()//Position - 0xC4B
{
	int iVar0;
...
int func_24()//Position - 0xE73
{
	func_25();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_25()//Position - 0xE8C
{
	int iVar0;
...
bool func_26(int iParam0)//Position - 0xF89
{
	return iParam0 < 3;
}

int func_27(int iParam0)//Position - 0xF95
{
	if (func_26(iParam0))
	{
...
var func_28(int iParam0)//Position - 0xFBA
{
	return Global_1798[iParam0 /*29*/];
}

bool func_29(int iParam0)//Position - 0xFC9
{
	return Global_41396 == iParam0;
}

void func_30()//Position - 0xFD7
{
	int iVar0;
...
bool func_31(int iParam0, int iParam1)//Position - 0x102E
{
	switch (iParam0)
	{
		case 5:
...
void func_33(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x10C0
{
...
void func_34(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1116
{
...
int func_35(int iParam0)//Position - 0x11B1
{
	int iVar0;
	int iVar1;
...
void func_36(char* sParam0, int iParam1, int iParam2)//Position - 0x11EE
{
	iParam2 = iParam2;
...
int func_37(int iParam0)//Position - 0x1207
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_38(bool bParam0, int iParam1)//Position - 0x1252
{
	int iVar0;
...
void func_39(int iParam0, bool bParam1, bool bParam2)//Position - 0x12EC
{
	int iVar0;
...
int func_40()//Position - 0x149D
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

void func_41(int iParam0, var uParam1)//Position - 0x14AD
{
	switch (iParam0)
	{
		case 0:
...
void func_42(int iParam0, var uParam1)//Position - 0x14F5
{
	switch (iParam0)
	{
		case 0:
...
void func_43(var uParam0)//Position - 0x153D
{
...
int func_44(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x1558
{
...
void func_45(int iParam0)//Position - 0x16E7
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
int func_46(int iParam0, vector3 vParam1, vector3 vParam4, bool bParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11, bool bParam12, int iParam13, bool bParam14, int iParam15)//Position - 0x1713
{
...
int func_47(int iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10, bool bParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, char* sParam19, char* sParam20, char* sParam21, char* sParam22, char* sParam23, char* sParam24, bool bParam25, bool bParam26, char* sParam27, bool bParam28, int iParam29, bool bParam30, int iParam31, int iParam32, int iParam33, int iParam34, bool bParam35, float fParam36)//Position - 0x1762
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
int func_48(int iParam0, bool bParam1, bool bParam2)//Position - 0x20BC
{
	return func_49(iParam0, !bParam1, bParam2);
}

int func_49(int iParam0, bool bParam1, bool bParam2)//Position - 0x20CF
{
	int iVar0;
...
float func_50(bool bParam0, float fParam1, float fParam2)//Position - 0x2173
{
	if (bParam0)
	{
		return fParam1;
...
int func_51(int iParam0)//Position - 0x218A
{
...
int func_52(bool bParam0, bool bParam1, bool bParam2)//Position - 0x21E8
{
	int iVar0;
...
int func_53(int iParam0)//Position - 0x22CD
{
	float fVar0;
...
int func_54(int iParam0, int iParam1)//Position - 0x2304
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
int func_55(int iParam0, int iParam1)//Position - 0x236F
{
	int iVar0;
...
int func_56(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x23B7
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_57(int iParam0, int iParam1)//Position - 0x2432
{
	if (HUD::DOES_BLIP_EXIST(iParam0))
	{
...
int func_58(vector3 vParam0, bool bParam3)//Position - 0x246D
{
	int iVar0;
...
void func_59(int iParam0, char* sParam1, int iParam2)//Position - 0x2499
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_60(iParam2), 1);
}

int func_60(int iParam0)//Position - 0x24B0
{
	int iVar0;
...
void func_61(int iParam0, char* sParam1, bool bParam2)//Position - 0x26A5
{
	if (!bParam2)
	{
...
int func_62(int iParam0)//Position - 0x26DC
{
...
int func_63(int iParam0, int iParam1)//Position - 0x2700
{
...
int func_64(var uParam0)//Position - 0x2758
{
	int iVar0;
	int iVar1;
...
int func_65(var uParam0, int iParam1)//Position - 0x277B
{
	int iVar0;
...
int func_66(int iParam0, var uParam1, int iParam2)//Position - 0x27AC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_67(char* sParam0)//Position - 0x2840
{
...
int func_68(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, char* sParam7, float fParam8, bool bParam9, int iParam10, bool bParam11, int iParam12, var uParam13, var uParam14, var uParam15, int iParam16, bool bParam17)//Position - 0x2858
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_69(int iParam0, var uParam1)//Position - 0x38C9
{
	switch (iParam0)
	{
		case 0:
...
void func_70(var uParam0, char* sParam1, char* sParam2, bool bParam3)//Position - 0x3911
{
	if (!bParam3)
	{
		if (!MISC::IS_STRING_NULL(sParam1))
...
void func_71(char* sParam0, char* sParam1, int iParam2, int iParam3)//Position - 0x394A
{
	iParam3 = iParam3;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
int func_72(int iParam0, var uParam1)//Position - 0x3969
{
	switch (iParam0)
	{
		case 0:
...
int func_73(int iParam0, float fParam1)//Position - 0x39B2
{
	int iVar0;
...
int func_74(int iParam0, int iParam1)//Position - 0x39E9
{
	int iVar0;
...
int func_75(int iParam0, int iParam1)//Position - 0x3A50
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
void func_76(int iParam0, var uParam1)//Position - 0x3A85
{
	switch (iParam0)
	{
		case 0:
...
int func_77(int iParam0, var uParam1)//Position - 0x3ACD
{
	switch (iParam0)
	{
		case 0:
...
int func_78(int iParam0)//Position - 0x3B16
{
	int iVar0;
	int iVar1;
...
int func_79(int iParam0, var uParam1)//Position - 0x3BA3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_80(var uParam0)//Position - 0x3D03
{
	int iVar0;
...
int func_81(var uParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x3D32
{
	int iVar0;
...
int func_82(int iParam0)//Position - 0x3E10
{
	float fVar0;
...
int func_83(int iParam0, int iParam1)//Position - 0x3E48
{
	int iVar0;
...
void func_85(var uParam0)//Position - 0x3EE5
{
	int iVar0;
...
void func_86(var uParam0)//Position - 0x3F88
{
	int iVar0;
...
Vector3 func_88()//Position - 0x402A
{
	vector3 vVar0;
...
void func_89(int iParam0, bool bParam1)//Position - 0x4036
{
	int iVar0;
...
int func_90(int iParam0, int iParam1, int iParam2)//Position - 0x4080
{
	var uVar0;
	int iVar1;
...
void func_91(int iParam0, int iParam1)//Position - 0x40C0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_92(int iParam0, var uParam1)//Position - 0x42C2
{
	int iVar0;
...
int func_93(int iParam0)//Position - 0x456B
{
	switch (iParam0)
	{
		case 1:
...
int func_94(int iParam0, var uParam1, var uParam2)//Position - 0x461B
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0)//Position - 0x480E
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_96(var uParam0)//Position - 0x482E
{
	int iVar0;
...
int func_97(int iParam0)//Position - 0x48DE
{
...
int func_98(int iParam0)//Position - 0x49BB
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_99(int iParam0, bool bParam1)//Position - 0x4B6C
{
	int iVar0;
	struct<2> Var1;
...
int func_100(int iParam0)//Position - 0x4CEC
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_102(int iParam0)//Position - 0x4DCF
{
	int iVar0;
	int iVar1;
...
int func_103()//Position - 0x729A
{
	return 0;
}

int func_104()//Position - 0x72A3
{
	return 1;
}

int func_105()//Position - 0x72AC
{
	return 1;
}

int func_106()//Position - 0x72B5
{
...
int func_108(int iParam0)//Position - 0x7389
{
	int iVar0;
	char* sVar1;
...
int func_109(int iParam0)//Position - 0x73CF
{
	int iVar0;
...
int func_111(int iParam0)//Position - 0x7486
{
	int iVar0;
...
int func_112(int iParam0)//Position - 0x756E
{
	int iVar0;
...
int func_113(int iParam0, int iParam1, bool bParam2)//Position - 0x75D1
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_114(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x7642
{
...
int func_116(int iParam0, bool bParam1, bool bParam2)//Position - 0x7834
{
	return func_49(iParam0, !bParam1, bParam2);
}

int func_117(int iParam0)//Position - 0x7847
{
	if (iLocal_1479 == 0)
	{
		iLocal_1482 = iParam0;
...
void func_118(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x7867
{
	vector3 vVar0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102125.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102125.f_4, 0))
		{
			if (func_146(24) != Global_102125.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_143(ENTITY::GET_ENTITY_COORDS(Global_102125.f_4, true), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
				}
				func_119(Global_102125.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_119(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)//Position - 0x78E2
{
	struct<60> Var0;
...
void func_120(int iParam0, int iParam1, int iParam2)//Position - 0x7A0B
{
	int iVar0;
...
void func_122(var uParam0, int iParam1)//Position - 0x7B6E
{
	if (iParam1 <= 0)
	{
		return;
...
void func_123(var uParam0, int iParam1)//Position - 0x7BF4
{
...
void func_124(var uParam0, int iParam1)//Position - 0x7C27
{
	int iVar0;
	int iVar1;
...
int func_125(int iParam0, int iParam1)//Position - 0x7C78
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_126(int iParam0)//Position - 0x7D1A
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_127(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_127(bool bParam0, int iParam1, int iParam2)//Position - 0x7D3F
{
	if (bParam0)
	{
		return iParam1;
...
int func_128(var uParam0)//Position - 0x7D56
{
	return uParam0 & 15;
}

void func_129(var uParam0, int iParam1)//Position - 0x7D63
{
...
void func_130(var uParam0, int iParam1)//Position - 0x7D9D
{
...
void func_131(var uParam0, int iParam1)//Position - 0x7DD8
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_132(var uParam0, int iParam1)//Position - 0x7E14
{
	int iVar0;
	int iVar1;
...
int func_133(int iParam0, int iParam1)//Position - 0x950B
{
	struct<82> Var0;
...
void func_134(int iParam0, var uParam1, int iParam2)//Position - 0x954D
{
	int iVar0;
...
void func_135(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0x97A9
{
	if (func_132(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
...
void func_136(int iParam0, bool bParam1)//Position - 0x98A8
{
	if (iParam0 == -1)
	{
		return;
...
void func_137(int iParam0, int iParam1, bool bParam2)//Position - 0x9905
{
	if (iParam0 == -1)
	{
		return;
...
bool func_138(int iParam0, int iParam1)//Position - 0x9940
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_139(var uParam0, var uParam1)//Position - 0x9963
{
...
void func_140(int iParam0)//Position - 0x9A2F
{
	if (iParam0 == -1)
	{
		return;
...
bool func_141(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x9AA9
{
	if (bParam6)
	{
...
void func_142(int iParam0)//Position - 0x9AF0
{
...
int func_143(vector3 vParam0, int iParam3, var uParam4, var uParam5)//Position - 0x9B17
{
	int iVar0;
...
int func_144(vector3 vParam0, int iParam3, int iParam4)//Position - 0x9C2D
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_145(int iParam0)//Position - 0x9CBC
{
	return MISC::IS_BIT_SET(Global_111560.f_7224[iParam0], 0);
}

int func_146(int iParam0)//Position - 0x9CD4
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_147()//Position - 0x9CF0
{
	Global_19671 = 0;
	func_148();
}

void func_148()//Position - 0x9D00
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_150(char[4] cParam0, int iParam1)//Position - 0x9DF6
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

void func_151()//Position - 0x9E0D
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_94[0 /*2*/], -1521.829f, 2725.003f, 16.64367f, -1600.763f, 2794.875f, 21.45629f, 30f, 0, true, 0) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_94[0 /*2*/], 0))
		{
...
void func_152(int iParam0, int iParam1)//Position - 0xA607
{
	Global_61482 = iParam0;
	Global_61483 = iParam1;
}

void func_153(int iParam0, int iParam1)//Position - 0xA619
{
	int iVar0;
...
int func_154(vector3 vParam0, int iParam3, int iParam4, bool bParam5)//Position - 0xA684
{
	vector3 vVar0[15];
	vector3 vVar46[15];
	float fVar92[15];
...
void func_156()//Position - 0xB4E1
{
	...
	if (iLocal_437 == 3 || iLocal_437 == 1)
	{
		...
		OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(Global_40519[20 /*31*/], fLocal_439, false, true);
		OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_40519[20 /*31*/], 4, false, true);
	}
}

float func_157(float fParam0, float fParam1, float fParam2)//Position - 0xB5DF
{
	float fVar0;
...
float func_158(float fParam0)//Position - 0xB60E
{
	return (fParam0 * 57.29578f);
}

int func_159()//Position - 0xB61E
{
	int iVar0;
	...
	while (iVar0 < 3)
	{
		if ((ENTITY::DOES_ENTITY_EXIST(Local_94[iVar0 /*2*/]) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_94[iVar0 /*2*/], 0)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_94[iVar0 /*2*/], -1591.019f, 2803.731f, 15.41812f, -1569.92f, 2777.878f, 22.14856f, 8.25f, 0, true, 0))
		{
			return 1;
		}
		iVar0++;
	...
	while (iVar0 < 3)
	{
		...
		if (!PED::IS_PED_INJURED(iVar1))
		{
			...
			else if (func_165(iVar1) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar1, 1))
			{
				...
				bLocal_1490 = ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar1, 1365.772f, 3625.582f, 33.69244f, 1374.662f, 3598.951f, 36.8947f, 34f, 0, true, 0);
				if (!bLocal_1490)
				{
...
int func_161(int iParam0)//Position - 0xB851
{
	int iVar0;
...
int func_162(int iParam0, int iParam1)//Position - 0xB8A9
{
	int iVar0;
...
int func_163(int iParam0)//Position - 0xB930
{
	if (!func_164())
	{
...
int func_165(int iParam0)//Position - 0xB9BA
{
	if (!func_164())
	{
		if (func_37(Local_94[0 /*2*/]) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_94[0 /*2*/], 1364.248f, 3620.511f, 33.89069f, 1350.9f, 3616.225f, 37.12358f, 6.5f, 0, true, 0))
		{
...
int func_166(int iParam0, int iParam1)//Position - 0xBA50
{
	int iVar0;
...
int func_167(int iParam0)//Position - 0xBAAC
{
	int iVar0;
...
int func_168(int iParam0)//Position - 0xBAF5
{
	if (iParam0 > 3)
	{
		return 0;
...
int func_169(int iParam0)//Position - 0xBB26
{
	if (iParam0 == 0)
	{
		return 0;
	...
	switch (iLocal_434)
	{
		case 0:
			if (!bLocal_456)
			{
				...
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_94[0 /*2*/], -1521.829f, 2725.003f, 16.64367f, -1600.763f, 2794.875f, 21.45629f, 30f, 0, true, 0) && PED::IS_PED_IN_VEHICLE(Local_111[4 /*14*/], Local_94[0 /*2*/], 0))
					{
						iLocal_434 = 2;
						iLocal_471 = 0;
					}
			...
			switch (iLocal_435)
			{
				...
				case 4:
					...
					while (iVar0 <= (9 - 1))
					{
						...
						{
							if (iVar7 && func_175(Local_111[iVar0 /*14*/], vLocal_49, 1) < 30f)
							{
							...
							else if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_94[0 /*2*/], 0) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_94[0 /*2*/], false), ENTITY::GET_ENTITY_COORDS(Local_111[iVar0 /*14*/], false), true) > (120f / 2f))
							{
								PED::SET_PED_COMBAT_ATTRIBUTES(Local_111[iVar0 /*14*/], 1, true);
								...
								else if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(Local_111[iVar0 /*14*/]))
								{
									...
									{
										if (func_171(Local_111[iVar0 /*14*/], PED::GET_VEHICLE_PED_IS_IN(Local_111[iVar0 /*14*/], 0)) == -1)
										{
...
int func_171(int iParam0, int iParam1)//Position - 0xCDAD
{
...
float func_172(int iParam0, int iParam1, bool bParam2)//Position - 0xCE1F
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_173(int iParam0)//Position - 0xCE7D
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
var func_174(int iParam0)//Position - 0xCECD
{
	var uVar0;
	float fVar1;
...
float func_175(int iParam0, vector3 vParam1, bool bParam4)//Position - 0xCF77
{
	vector3 vVar0;
...
int func_176()//Position - 0xCFB1
{
	if (func_37(PLAYER::PLAYER_PED_ID()) && func_37(Local_94[0 /*2*/]))
	{
		...
		else if (func_175(PLAYER::PLAYER_PED_ID(), vLocal_460, 1) > 120f && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_94[0 /*2*/], 0))
		{
			return 3;
		}
	}
...
void func_177(int iParam0)//Position - 0xD03F
{
	int iVar0;
	vector3 vVar1;
	float fVar4;
	...
	if (func_37(Local_111[iParam0 /*14*/]))
	{
		...
		if (!Local_111[iParam0 /*14*/].f_12)
		{
			if (func_37(iVar0))
			{
				PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_111[iParam0 /*14*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iVar0, vVar1), fVar4, 0, 0);
			}
			else if (func_37(Local_94[0 /*2*/]))
			{
				if (func_178(Local_94[0 /*2*/]) == 1)
				{
					PED::SET_PED_DEFENSIVE_SPHERE_ATTACHED_TO_VEHICLE(Local_111[iParam0 /*14*/], Local_94[0 /*2*/], vLocal_61, 3.8f, 0);
				}
				...
				{
					PED::SET_PED_DEFENSIVE_SPHERE_ATTACHED_TO_VEHICLE(Local_111[iParam0 /*14*/], Local_94[0 /*2*/], vLocal_52, 3.8f, 0);
				}
...
int func_178(int iParam0)//Position - 0xD603
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_179(float fParam0, float fParam1, float fParam2)//Position - 0xD6D5
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
void func_180()//Position - 0xD6FC
{
	...
	while (iVar0 <= (9 - 1))
	{
		if (func_37(Local_111[iVar0 /*14*/]))
		{
			...
			if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(Local_111[iVar0 /*14*/], PLAYER::PLAYER_PED_ID()) && (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Local_111[iVar0 /*14*/]) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_111[iVar0 /*14*/])))
			{
				if (iLocal_459 != 0)
				{
					if (WEAPON::GET_WEAPONTYPE_GROUP(iLocal_459) != -728555052 && iLocal_459 != joaat("weapon_unarmed"))
					{
	...
	if (func_37(Local_94[1 /*2*/]))
	{
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			vVar1 = { func_183(ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), false) - ENTITY::GET_ENTITY_COORDS(Local_94[1 /*2*/], false)) };
			vVar4 = { ENTITY::GET_ENTITY_VELOCITY(Local_94[1 /*2*/]) - ENTITY::GET_ENTITY_VELOCITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)) };
	...
	if (func_37(Local_94[2 /*2*/]))
	{
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			vVar7 = { func_183(ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), false) - ENTITY::GET_ENTITY_COORDS(Local_94[2 /*2*/], false)) };
			vVar10 = { ENTITY::GET_ENTITY_VELOCITY(Local_94[2 /*2*/]) - ENTITY::GET_ENTITY_VELOCITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)) };
	...
	if (func_37(Local_94[0 /*2*/]))
	{
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			vVar13 = { func_183(ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), false) - ENTITY::GET_ENTITY_COORDS(Local_94[0 /*2*/], false)) };
			vVar16 = { ENTITY::GET_ENTITY_VELOCITY(Local_94[0 /*2*/]) - ENTITY::GET_ENTITY_VELOCITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)) };
		...
		if (func_181())
		{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar19, 0))
			{
				...
				vVar20 = { func_183(ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), false) - ENTITY::GET_ENTITY_COORDS(Local_94[0 /*2*/], false)) };
				vVar23 = { ENTITY::GET_ENTITY_VELOCITY(Local_94[0 /*2*/]) - ENTITY::GET_ENTITY_VELOCITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)) };
...
bool func_181()//Position - 0xDCC9
{
	return MISC::IS_BIT_SET(Global_2531497.f_795, 2);
}

float func_182(vector3 vParam0, vector3 vParam3)//Position - 0xDCDD
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_183(vector3 vParam0)//Position - 0xDCFE
{
	float fVar0;
	float fVar1;
...
int func_184(vector3 vParam0, vector3 vParam3, vector3 vParam6, float fParam9, bool bParam10)//Position - 0xDD3D
{
	int iVar0;
...
int func_185(vector3 vParam0)//Position - 0xE148
{
...
void func_186()//Position - 0xE172
{
	...
	if (((((func_37(Local_94[0 /*2*/]) && func_37(Local_94[1 /*2*/])) && func_37(Local_94[2 /*2*/])) && func_37(Local_111[4 /*14*/])) && func_37(Local_111[0 /*14*/])) && func_37(Local_111[5 /*14*/]))
	{
		...
		{
			case 0:
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vVar6, vVar9, 9f, 0, true, 0))
				{
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vVar0, vVar3, 9f, 0, true, 0))
				{
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vVar12, vVar15, 9f, 0, true, 0))
				{
			...
			case 1:
				...
				if ((!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vVar0, vVar3, 9f, 0, true, 0) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vVar6, vVar9, 9f, 0, true, 0)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vVar12, vVar15, 9f, 0, true, 0))
				{
...
void func_187(int iParam0)//Position - 0xEB34
{
	bool bVar0;
	int iVar1;
...
int func_188(int iParam0, int iParam1, bool bParam2)//Position - 0xEBA5
{
	int iVar0;
...
void func_189(int iParam0, int iParam1, bool bParam2)//Position - 0xEBEB
{
	int iVar0;
...
int func_190(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xEC95
{
	if (iParam3 == 0)
	{
...
int func_191(var uParam0)//Position - 0xEE6C
{
...
void func_192(int iParam0)//Position - 0xEEC6
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_193(int iParam0)//Position - 0xEEFE
{
	char* sVar0;
...
void func_195(char* sParam0)//Position - 0xEFE9
{
	func_203(sParam0);
	func_196(0);
}

void func_196(int iParam0)//Position - 0xEFFC
{
	int iVar0;
...
int func_197(int iParam0)//Position - 0xF041
{
	int iVar0;
	int iVar1;
...
void func_198(var uParam0, int iParam1)//Position - 0xF158
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_200(Global_111560.f_18528[iVar0], &vVar2, &fVar5))
			{
...
void func_199(var uParam0)//Position - 0xF321
{
	*uParam0 = -15;
}

int func_200(int iParam0, var uParam1, float fParam2)//Position - 0xF32F
{
	switch (iParam0)
	{
		case 11:
...
void func_201(int iParam0, bool bParam1)//Position - 0xFC9E
{
	if (bParam1)
	{
...
void func_203(char* sParam0)//Position - 0xFDC9
{
...
void func_204(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xFE08
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_207(int iParam0, int iParam1, int iParam2)//Position - 0xFFA7
{
...
void func_208(int iParam0)//Position - 0x1006C
{
	if (iParam0 == 1)
	{
...
void func_210(vector3 vParam0, float fParam3)//Position - 0x100B9
{
	...
	ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_108[0], Local_94[0 /*2*/], 0, 0f, -0.5f, 1.5f, 0f, 0f, -90f, 0, 0, 0, 0, 2, 1);
	iLocal_108[1] = OBJECT::CREATE_OBJECT(joaat("prop_mil_crate_01"), 1006.765f, 2128.32f, 48.0929f, true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_108[1], Local_94[0 /*2*/], 0, 0f, -2.85f, 1.5f, 0f, 0f, -90f, 0, 0, 0, 0, 2, 1);
	AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(Local_94[0 /*2*/], "PS_PREP_VEHICLES_GROUP", 0);
}

void func_211(var uParam0, int iParam1)//Position - 0x101F9
{
	Global_98669.f_22[iParam1] = uParam0;
}

void func_212()//Position - 0x1020D
{
...
void func_213()//Position - 0x1024B
{
	int iVar0;
...
void func_214(vector3 vParam0, float fParam3)//Position - 0x1030A
{
...
void func_215(int iParam0, bool bParam1)//Position - 0x10337
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_216(int iParam0, int iParam1)//Position - 0x103D2
{
	int iVar0;
	int iVar1;
...
void func_217(vector3 vParam0, float fParam3)//Position - 0x10584
{
...
void func_218()//Position - 0x105B1
{
	int iVar0;
...
int func_219(var uParam0)//Position - 0x10742
{
	if (func_220(uParam0))
	{
		return 1;
...
int func_220(var uParam0)//Position - 0x1075B
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_221(var uParam0)//Position - 0x1112B
{
...
void func_222(var uParam0)//Position - 0x11147
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_223(int iParam0)//Position - 0x11162
{
	switch (iParam0)
	{
		case 0:
...
int func_224(var uParam0, int iParam1)//Position - 0x11239
{
	int iVar0;
	int iVar1;
...
int func_225(var uParam0, int iParam1)//Position - 0x11300
{
	int iVar0;
	int iVar1;
...
int func_226(var uParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0x113A9
{
...
void func_227(int iParam0, var uParam1, var uParam2)//Position - 0x11461
{
	switch (iParam0)
	{
		case 0:
...
bool func_228()//Position - 0x114FC
{
	return MISC::IS_BIT_SET(Global_98669.f_20, 13);
}

void func_229(var uParam0)//Position - 0x11510
{
	int iVar0;
...
void func_230()//Position - 0x11768
{
	iLocal_447 = 0;
	while (iLocal_447 <= (3 - 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_101[iLocal_447 /*2*/]) && !PED::IS_PED_INJURED(Local_101[iLocal_447 /*2*/]))
		{
			...
			{
				PED::SET_PED_COORDS_NO_GANG(Local_101[iLocal_447 /*2*/], ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(Local_101[iLocal_447 /*2*/], 0), true) + Vector(0f, -2f, 0f));
			}
	...
	while (iLocal_447 <= (9 - 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_111[iLocal_447 /*14*/]))
		{
			...
			if (!PED::IS_PED_INJURED(Local_111[iLocal_447 /*14*/]))
			{
				...
				{
					PED::SET_PED_COORDS_NO_GANG(Local_111[iLocal_447 /*14*/], ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(Local_111[iLocal_447 /*14*/], 0), true) + Vector(0f, -2f, 0f));
				}
...
void func_231(int iParam0)//Position - 0x11952
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_232(int iParam0)//Position - 0x119EE
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
int func_233(int iParam0)//Position - 0x11A0F
{
	if (func_232(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_234(int iParam0)//Position - 0x11A39
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_235(int iParam0)//Position - 0x11AD5
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_236(int iParam0)//Position - 0x11B00
{
	bool bVar0;
	struct<8> Var1;
...
void func_237(int iParam0)//Position - 0x11B72
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_238()//Position - 0x11BB3
{
	switch (iLocal_1479)
	{
		case 1:
...
void func_239(var uParam0, int iParam1, int iParam2)//Position - 0x11C1A
{
	char* sVar0;
...
int func_240(char* sParam0)//Position - 0x11CF7
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_241(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x11D0A
{
	func_242(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_242(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x11D24
{
	uParam0->f_6 = 0;
	func_243(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_243(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x11D46
{
	int iVar0;
	int iVar1;
...
void func_244(var uParam0)//Position - 0x120B3
{
...
int func_245(var uParam0)//Position - 0x1211C
{
	int iVar0;
...
int func_246(bool bParam0)//Position - 0x12147
{
	switch (Global_41396)
	{
		case 0:
...
int func_247(char* sParam0)//Position - 0x121F1
{
	if (!func_248(1, 1, 0))
	{
...
int func_248(bool bParam0, bool bParam1, bool bParam2)//Position - 0x1228A
{
	int iVar0;
	int iVar1;
...
int func_249(int iParam0)//Position - 0x124E3
{
	if (iParam0 != func_18())
	{
...
int func_250(int iParam0, bool bParam1, bool bParam2)//Position - 0x12549
{
	int iVar0;
...
int func_251(int iParam0, int iParam1)//Position - 0x12593
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		if (VEHICLE::GET_NUM_MOD_KITS(iParam0) > 0)
...
int func_252(int iParam0, int iParam1)//Position - 0x125F5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_253()//Position - 0x1267A
{
	return Global_2448961.f_17;
}

bool func_254(int iParam0)//Position - 0x12688
{
	return iParam0 == 51;
}

var func_255()//Position - 0x12695
{
	return Global_2448961.f_16;
}

bool func_256()//Position - 0x126A3
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

int func_257(int iParam0)//Position - 0x126B8
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
void func_258(var uParam0, int iParam1, vector3 vParam2, int iParam5)//Position - 0x12712
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_259()//Position - 0x12822
{
	return func_260(PLAYER::PLAYER_ID());
}

int func_260(int iParam0)//Position - 0x12832
{
...
int func_261(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x12851
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_262(bool bParam0, bool bParam1, bool bParam2)//Position - 0x12BBD
{
...
int func_263(bool bParam0, bool bParam1, bool bParam2)//Position - 0x12C0F
{
	if (!func_248(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_264(bool bParam0, bool bParam1, bool bParam2)//Position - 0x12C58
{
	if (!func_248(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_265(bool bParam0, bool bParam1, bool bParam2)//Position - 0x12CB7
{
	if (!func_248(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_266(int iParam0)//Position - 0x12D0D
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (ENTITY::IS_ENTITY_A_VEHICLE(iParam0))
...
void func_267()//Position - 0x12D68
{
	MISC::SET_BIT(&Global_7357, 4);
}

void func_268(var uParam0)//Position - 0x12D78
{
	func_220(uParam0);
}

void func_269()//Position - 0x12D87
{
	vector3 vVar0;
	var uVar3;
	...
	iLocal_445 = PED::ADD_SCENARIO_BLOCKING_AREA(Vector(35.39456f, 3600.538f, 1375.234f) - Vector(0f, 7f, 14.25f), Vector(35.39456f, 3600.538f, 1375.234f) + Vector(3f, 7f, 14.25f), 0, 1, 1, 1);
...
void func_270(int iParam0)//Position - 0x12F96
{
	Global_94554 = 0;
	switch (iParam0)
	{
...
void func_271(int iParam0)//Position - 0x13024
{
	MISC::SET_BIT(&Global_94554, iParam0);
}

void func_272(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x13036
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_273(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x131AB
{
	func_274(&Global_105109, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_274(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x131C7
{
	int iVar0;
	int iVar1;
...
int func_275(var uParam0)//Position - 0x14051
{
...
void func_276(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x14073
{
	int iVar0;
...
int func_277(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x140FB
{
...
int func_278(int iParam0)//Position - 0x1413B
{
	int iVar0;
...
void func_279(var uParam0, int iParam1, int iParam2)//Position - 0x14169
{
...
int func_280(int iParam0)//Position - 0x14245
{
	int iVar0;
...
int func_281(int iParam0, int iParam1, int iParam2)//Position - 0x14287
{
	int iVar0;
...
int func_282(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x14315
{
	char* sVar0;
...
void func_283(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x14442
{
	int iVar0;
	int iVar1;
...
int func_284(int iParam0, int iParam1, int iParam2)//Position - 0x145E2
{
	int iVar0;
	var uVar1;
...
int func_285(var uParam0)//Position - 0x14614
{
	int iVar0;
	int iVar1;
...
var func_286()//Position - 0x14648
{
	return Global_1312745;
}

int func_287(int iParam0, int iParam1)//Position - 0x14654
{
	var uVar0;
	var uVar1;
...
void func_288(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x14680
{
	int iVar0;
...
void func_289(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x14BC8
{
	int iVar0;
...
int func_290()//Position - 0x14E09
{
	func_25();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_291(int iParam0, bool bParam1)//Position - 0x14E22
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_292(int iParam0, var uParam1)//Position - 0x14F15
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_294(Var11.f_1)) && iVar72 < 51)
			{
...
int func_293(int iParam0)//Position - 0x1519D
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_294(int iParam0)//Position - 0x15238
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
int func_295(int iParam0, int iParam1)//Position - 0x153CA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_296(int iParam0, var uParam1)//Position - 0x15F3B
{
	int iVar0;
	int iVar1;
...
int func_297(int iParam0)//Position - 0x15F76
{
	int iVar0;
...
void func_298(int iParam0)//Position - 0x161EA
{
	int iVar0;
...
void func_299(var uParam0, int iParam1)//Position - 0x16226
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_300(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x16781
{
	int iVar0;
	int iVar1;
...
bool func_301(int iParam0, var uParam1, var uParam2)//Position - 0x167C5
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
int func_302(var uParam0)//Position - 0x16EE0
{
...
bool func_303(int iParam0)//Position - 0x16F3B
{
	return func_304(iParam0, 0, 1);
}

int func_304(int iParam0, int iParam1, bool bParam2)//Position - 0x16F4B
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_305(int iParam0)//Position - 0x16FB5
{
	switch (iParam0)
	{
		case 0:
...
int func_306()//Position - 0x172E5
{
	return Global_30736;
}

int func_307(int iParam0)//Position - 0x172F0
{
	return func_304(iParam0, 5, 1);
}

int func_308(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x17300
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_309(int iParam0, bool bParam1)//Position - 0x173A2
{
	switch (iParam0)
	{
		case -1:
...
int func_310(int iParam0)//Position - 0x179BF
{
	if (iParam0 != func_18())
	{
...
Vector3 func_311(int iParam0, int iParam1)//Position - 0x17A1D
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_312(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x17ACB
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_313(vector3 vParam0, float fParam3)//Position - 0x17B60
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_314(int iParam0)//Position - 0x17BA4
{
	struct<6> Var0;
...
struct<6> func_315(int iParam0)//Position - 0x17D28
{
	return func_316(iParam0);
}

struct<6> func_316(int iParam0)//Position - 0x17D36
{
	struct<6> Var0;
...
int func_317(int iParam0, var uParam1)//Position - 0x187FD
{
	switch (iParam0)
	{
		case 0:
...
int func_318(int iParam0)//Position - 0x1887F
{
	if (iParam0 != func_18())
	{
...
Vector3 func_319(int iParam0)//Position - 0x188DD
{
	switch (iParam0)
	{
		case 1:
...
int func_320()//Position - 0x18AE8
{
	return func_321(PLAYER::PLAYER_ID());
}

int func_321(int iParam0)//Position - 0x18AF8
{
	return MISC::GET_BITS_IN_RANGE(Global_2424073[iParam0 /*421*/].f_309.f_3, 28, 31);
}

int func_322(int iParam0)//Position - 0x18B15
{
	return func_304(iParam0, 0, 0);
}

int func_323(int iParam0)//Position - 0x18B25
{
	switch (iParam0)
	{
		case -1:
...
bool func_324()//Position - 0x18DF3
{
	return Global_98721.f_345 > 0;
}

int func_325(char* sParam0)//Position - 0x18E04
{
...
struct<2> func_326(int iParam0)//Position - 0x18E5A
{
	struct<2> Var0;
...
int func_327(char* sParam0, int iParam1)//Position - 0x192A6
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_328(int iParam0, var uParam1)//Position - 0x192EF
{
	switch (iParam0)
	{
		case 0:
...
int func_330(int iParam0)//Position - 0x1A535
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_331(int iParam0)//Position - 0x1A87B
{
	struct<2> Var0;
	char[] cVar2[8];
...
int func_332(int iParam0)//Position - 0x1A8B2
{
	switch (iParam0)
	{
		case 69:
...
int func_333(int iParam0)//Position - 0x1A96E
{
	switch (iParam0)
	{
		case 1:
...
int func_334(char* sParam0, bool bParam1)//Position - 0x1A9C2
{
	int iVar0;
	int iVar1;
...
int func_335(int iParam0, bool bParam1)//Position - 0x1A9EC
{
	int iVar0;
...
void func_336(bool bParam0)//Position - 0x1AA22
{
	int iVar0;
	int iVar1;
...
int func_337()//Position - 0x1ACA4
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_108[0]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_95196.f_28[0]))
		{
			...
			iLocal_108[0] = Global_95196.f_28[0];
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_108[1]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_95196.f_28[1]))
		{
			...
			iLocal_108[1] = Global_95196.f_28[1];
		}
	}
	iVar0 = 0;
	while (iVar0 <= (9 - 1))
...
void func_338(int iParam0, vector3 vParam1)//Position - 0x1B1C0
{
	int iVar0;
...
void func_339(vector3 vParam0, var uParam3, int iParam4, int iParam5)//Position - 0x1B20F
{
	if (func_209())
	{
...
void func_341()//Position - 0x1B2CE
{
	func_39(&Local_403, 1, 0);
	iLocal_447 = 0;
	while (iLocal_447 <= (3 - 1))
...
void func_342()//Position - 0x1B4F1
{
	Global_94554 = 0;
}

void func_343(bool bParam0)//Position - 0x1B4FE
{
	if (bParam0)
	{
...
void func_344(int iParam0, bool bParam1)//Position - 0x1B52A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_345()//Position - 0x1B565
{
	int iVar0;
