	...
	while (true)
	{
		...
		switch (iLocal_99)
		{
			...
			case 1:
				...
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_95, iLocal_101, sLocal_98, "MTN_DNC_if_you_want_to_get_to_heaven", 2f, -2f, 1, 0, 1148846080, 0);
			...
			case 3:
				...
				if (((((PED::IS_PED_INJURED(iLocal_95) || MISC::IS_BULLET_IN_AREA(vVar0, 50f, 1)) || MISC::IS_BULLET_IN_AREA(vVar0, 50f, 0)) || MISC::IS_PROJECTILE_IN_AREA(vVar0, 20f, 20f, 20f, 0)) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, vVar0, 50f)) || (((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_95) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_95)) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vVar0, true) < 25f) && func_1(iLocal_95, PLAYER::PLAYER_PED_ID(), 1126825984, 0)))
				{
					AUDIO::STOP_SYNCHRONIZED_AUDIO_EVENT(iLocal_101);
					iLocal_99 = 4;
					iLocal_97 = 1;
			...
			case 4:
				...
				if (!PED::IS_PED_RAGDOLL(iLocal_95))
				{
					if (iLocal_97 == 1)
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_95, 723.1315f, 4171.957f, 39.7091f, 2f, -1, 1f, 1024, 1193033728);
					}
					else
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_95, 723.1315f, 4171.957f, 39.7091f, 1f, -1, 1f, 1024, 1193033728);
					}
			...
			case 6:
				if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_95, 713668775) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_95, 713668775) != 0)
				{
					...
					if (iLocal_97 == 1)
					{
						TASK::TASK_SMART_FLEE_PED(iLocal_95, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
					}
					else
					{
...
float func_2(vector3 vParam0, vector3 vParam3)//Position - 0x524
{
...
void func_14(int iParam0, var uParam1)//Position - 0x89A
{
	switch (iParam0)
	{
		case 0:
...
int func_16(int iParam0)//Position - 0x1ACD
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_17(int iParam0)//Position - 0x1E13
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_18(int iParam0)//Position - 0x1E4A
{
	struct<2> Var0;
...
bool func_21(int iParam0)//Position - 0x23D9
{
	return Global_41396 == iParam0;
}

int func_22(int iParam0)//Position - 0x23E7
{
	int iVar0;
	int iVar1;
...
int func_23(int iParam0)//Position - 0x2424
{
	if (func_25(iParam0))
	{
...
var func_24(int iParam0)//Position - 0x2449
{
	return Global_1798[iParam0 /*29*/];
}

bool func_25(int iParam0)//Position - 0x2458
{
	return iParam0 < 3;
}

int func_26()//Position - 0x2464
{
	func_20();
	return Global_111560.f_2358.f_539.f_4321;
}

int func_27()//Position - 0x247D
{
...
bool func_29()//Position - 0x24CC
{
	return Global_111278 > 0;
}

int func_30()//Position - 0x24DA
{
	if (Global_95621 != -1)
	{
		return 1;
...
bool func_32(int iParam0)//Position - 0x2515
{
	return func_33(iParam0, Global_41396);
}

int func_33(int iParam0, int iParam1)//Position - 0x2526
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_35(var uParam0, int iParam1)//Position - 0x278D
{
	*uParam0 = (*uParam0 || iParam1);
}

bool func_36(var uParam0, int iParam1)//Position - 0x279E
{
	return (uParam0 && iParam1) != 0;
}

void func_37(bool bParam0)//Position - 0x27AD
{
