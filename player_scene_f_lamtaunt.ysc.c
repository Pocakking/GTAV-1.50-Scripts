#region Local Var
	...
	float fLocal_312 = 0f;
	vector3 vLocal_313[3] = {{ 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f } };
	vector3 vLocal_323[4] = {{ 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f }, { 0f, 0f, 0f } };
	float fLocal_336[3] = { 0f, 0f, 0f };
	float fLocal_340[4] = { 0f, 0f, 0f, 0f };
	...
	var uLocal_407 = 0;
	var uLocal_408 = 0;
	struct<16> Local_409[4];
	struct<16> Local_474[4];
...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_543 = 0f;
	sLocal_545 = "WORLD_HUMAN_PROSTITUTE_LOW_CLASS";
	fLocal_546 = 0.94f;
	iLocal_547 = -1;
	...
	while (iLocal_293 && func_138(2, 0))
	{
		...
		switch (iLocal_102)
		{
			...
			case 2:
				if (func_134())
				{
					func_133(&uLocal_104, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
					func_133(&uLocal_104, 2, Global_98390, "LAMAR", 0, 1);
					iLocal_102 = 3;
				}
				break;
...
int func_2()//Position - 0x171
{
	...
	{
		func_126(&(iLocal_294[iVar0]), iVar0);
		iVar0++;
	}
	func_126(&Global_98390, iLocal_294);
	func_3(Global_98390);
	return 0;
}
...
void func_3(int iParam0)//Position - 0x1B0
{
	...
	{
		if (!iLocal_549 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 1))
		{
	...
	func_6(iParam0, 138, &uLocal_104, "FMFAUD", &uLocal_269, &iLocal_290, 3);
	...
	else
	{
		...
		if (iLocal_547 > 0)
		{
			if (iLocal_548 == 0)
			{
				if (iLocal_547 + 15000 < MISC::GET_GAME_TIMER())
				{
			...
			else if (iLocal_547 + 10000 < MISC::GET_GAME_TIMER())
			{
...
int func_10(char* sParam0, char* sParam1, var uParam2, int iParam3, var uParam4, int iParam5)//Position - 0x952
{
	char* sVar0;
	int iVar1;
	int iVar2;
...
bool func_16(int iParam0)//Position - 0xE30
{
	return func_17(iParam0, 20);
}

bool func_17(int iParam0, int iParam1)//Position - 0xE40
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_18()//Position - 0xE5B
{
	return -1;
}

void func_19()//Position - 0xE64
{
	int iVar0;
...
bool func_24(int iParam0)//Position - 0x108B
{
	return Global_41396 == iParam0;
}

void func_25()//Position - 0x1099
{
	int iVar0;
...
bool func_26(int iParam0, int iParam1)//Position - 0x10EF
{
	switch (iParam0)
	{
		case 5:
...
void func_28(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x1181
{
...
int func_29(char* sParam0, int iParam1)//Position - 0x11D7
{
...
int func_31(char* sParam0, int iParam1, var uParam2)//Position - 0x1238
{
	char cVar0[16];
	char cVar4[16];
	int iVar8;
...
int func_32(int iParam0)//Position - 0x18DC
{
...
int func_33(int iParam0)//Position - 0x1909
{
	int iVar0;
...
int func_34(int iParam0)//Position - 0x1A2A
{
	if (func_36(iParam0))
	{
...
var func_35(int iParam0)//Position - 0x1A4F
{
	return Global_1798[iParam0 /*29*/];
}

bool func_36(int iParam0)//Position - 0x1A5E
{
	return iParam0 < 3;
}

int func_37(int iParam0)//Position - 0x1A6A
{
	if (!func_36(iParam0))
	{
		return func_35(iParam0);
...
int func_38()//Position - 0x1A90
{
	func_39();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_39()//Position - 0x1AA9
{
	int iVar0;
...
int func_40(int iParam0)//Position - 0x1BA6
{
	int iVar0;
	int iVar1;
...
int func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1BE3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_43(int iParam0, int iParam1, int iParam2)//Position - 0x1DCF
{
...
int func_44(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x1E03
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_45(bool bParam0)//Position - 0x2402
{
	int iVar0;
	int iVar1;
...
void func_46(int iParam0)//Position - 0x2684
{
	int iVar0;
...
void func_47(int iParam0)//Position - 0x26DE
{
	bool bVar0;
	char cVar1[64];
...
char* func_48(int iParam0)//Position - 0x286D
{
	switch (iParam0)
	{
		case 0:
...
void func_50(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x2975
{
	int iVar0;
...
int func_51(var uParam0)//Position - 0x29A5
{
	int iVar0;
	int iVar1;
...
int func_52()//Position - 0x29D9
{
	return Global_1312745;
}

int func_53(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x29E5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_54(int iParam0)//Position - 0x3037
{
	func_76(93, iParam0);
	func_76(29, iParam0);
	func_76(30, iParam0);
...
bool func_55(int iParam0)//Position - 0x3057
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_56(int iParam0, int iParam1, int iParam2)//Position - 0x3207
{
	int iVar0;
	var uVar1;
...
int func_57(int iParam0, int iParam1, int iParam2)//Position - 0x3239
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_58(int iParam0)//Position - 0x3276
{
	int iVar0;
...
int func_59(int iParam0, int iParam1)//Position - 0x3612
{
	int iVar0;
...
int func_60(bool bParam0)//Position - 0x398B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_61(int iParam0, int iParam1)//Position - 0x3A42
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_62(int iParam0, int iParam1)//Position - 0x3A5D
{
...
int func_63(var uParam0, int iParam1)//Position - 0x3AFA
{
	int iVar0;
	var uVar1[78];
...
int func_64(var uParam0, int iParam1)//Position - 0x3BAB
{
	int iVar0;
...
bool func_65(var uParam0, int iParam1)//Position - 0x3C26
{
	return (*uParam0)[iParam1] == 78;
}

void func_66(var uParam0)//Position - 0x3C37
{
	int iVar0;
...
void func_67(var uParam0, int iParam1)//Position - 0x3C6B
{
	(*uParam0)[iParam1] = 78;
}

void func_68(var uParam0, float fParam1)//Position - 0x3C7B
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_69(var uParam0)//Position - 0x3C98
{
	return uParam0->f_80;
}

bool func_70(var uParam0, int iParam1)//Position - 0x3CA4
{
	return func_71(uParam0, iParam1) != -1;
}

int func_71(var uParam0, int iParam1)//Position - 0x3CB6
{
	int iVar0;
...
bool func_72(var uParam0)//Position - 0x3CE3
{
	return uParam0->f_79 == 1;
}

int func_73(int iParam0)//Position - 0x3CF1
{
	switch (iParam0)
	{
		case 60:
...
int func_74(int iParam0, int iParam1)//Position - 0x3D41
{
	int iVar0;
...
void func_75(int iParam0, int iParam1)//Position - 0x3D92
{
	int iVar0;
...
void func_76(int iParam0, int iParam1)//Position - 0x3DB5
{
	int iVar0;
...
int func_78(int iParam0)//Position - 0x3E87
{
	return Global_1798[iParam0 /*29*/].f_17;
}

int func_79(int iParam0)//Position - 0x3E98
{
	var uVar0;
...
int func_84(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9)//Position - 0x3FF8
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
struct<4> func_85(int iParam0)//Position - 0x408A
{
	return Global_1798[iParam0 /*29*/].f_3;
}

int func_86(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)//Position - 0x409D
{
	int iVar0;
...
void func_87(int iParam0, char* sParam1)//Position - 0x455C
{
	if (!func_15())
	{
		return;
...
void func_88(int iParam0)//Position - 0x4581
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_89(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11)//Position - 0x4B27
{
...
void func_90(char* sParam0)//Position - 0x4BDA
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}

void func_91(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6)//Position - 0x4BEC
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
	if (fParam3 != -1f)
...
bool func_92()//Position - 0x4C4F
{
	return Global_1312873;
}

void func_93(int iParam0)//Position - 0x4C5B
{
	var uVar0;
	var uVar1;
...
void func_94(int iParam0)//Position - 0x4C7A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_96(struct<6> Param0, struct<6> Param6)//Position - 0x4DD7
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
...
int func_98(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x502A
{
	struct<4> Var0;
	struct<4> Var4[2];
	int iVar13;
...
int func_99(char* sParam0, int iParam1)//Position - 0x5162
{
	int iVar0;
	int iVar1;
...
int func_100(int iParam0)//Position - 0x51D6
{
	switch (iParam0)
	{
		case 0:
...
char* func_101(int iParam0)//Position - 0x5238
{
	switch (iParam0)
	{
		case 0:
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)//Position - 0x52AB
{
	struct<14> Var0;
...
void func_103(int iParam0)//Position - 0x53E9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_104(int iParam0)//Position - 0x54AD
{
	switch (iParam0)
	{
		case 0:
...
bool func_105(bool bParam0)//Position - 0x5517
{
...
int func_106(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4)//Position - 0x5542
{
	struct<4> Var0[2];
	int iVar9;
...
int func_107(int iParam0, int iParam1)//Position - 0x5644
{
...
int func_108(int iParam0)//Position - 0x56F2
{
	switch (iParam0)
	{
		case 0:
...
void func_109(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0x5729
{
	if (iParam0 == iParam5)
	{
		return;
	...
	Global_41397[iParam0 /*5*/].f_3 = fParam4;
	Global_41397[iParam0 /*5*/].f_4 = iParam5;
}

int func_110(int iParam0)//Position - 0x5772
{
	int iVar0;
	int iVar1;
...
int func_111(int iParam0, int iParam1)//Position - 0x5828
{
	struct<10> Var0;
	bool bVar10;
...
int func_112()//Position - 0x58C0
{
	func_39();
	return Global_111560.f_2358.f_539.f_4321;
}

struct<10> func_113(int iParam0)//Position - 0x58D9
{
	int iVar0;
	struct<10> Var1;
...
int func_114(int iParam0, int iParam1)//Position - 0x5928
{
	struct<14> Var0;
	bool bVar14;
...
struct<14> func_115(int iParam0)//Position - 0x59B7
{
	int iVar0;
	struct<14> Var1;
...
int func_116(int iParam0, int iParam1)//Position - 0x5A06
{
	struct<15> Var0;
	bool bVar15;
...
struct<15> func_117(int iParam0)//Position - 0x5AB1
{
	int iVar0;
	struct<15> Var1;
...
int func_118(int iParam0)//Position - 0x5AF9
{
	int iVar0;
...
int func_119(int iParam0)//Position - 0x5BF5
{
	vector3 vVar0;
...
int func_120(vector3 vParam0, bool bParam3)//Position - 0x5C88
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_121(int iParam0)//Position - 0x5D05
{
	if (iParam0 == 0)
	{
		return 2091854273;
...
int func_122(int iParam0)//Position - 0x5D71
{
	if (iParam0 == 145)
	{
		return 7;
...
var func_123(int iParam0)//Position - 0x5DC9
{
	return Global_1798[iParam0 /*29*/].f_11;
}

int func_124()//Position - 0x5DDA
{
...
int func_125(int iParam0)//Position - 0x5DFC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_126(int iParam0, int iParam1)//Position - 0x5E42
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		...
		switch (iLocal_302[iParam1])
		{
			case 0:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*iParam0, &cLocal_393, &(Local_474[iParam1 /*16*/]), 2))
				{
					fVar1 = fLocal_546;
					fVar2 = -1f;
					fVar3 = -1f;
					if (ENTITY::FIND_ANIM_EVENT_PHASE(&cLocal_393, &(Local_474[iParam1 /*16*/]), "WalkInterruptible", &fVar2, &fVar3))
					{
						fVar1 = fVar2;
					}
					else
					...
					{
						if (func_132(vLocal_323[iParam1 /*3*/], 0f, 0f, 0f, 0))
						{
							vVar4 = { ENTITY::GET_ENTITY_COORDS(*iParam0, true) };
							vLocal_323[iParam1 /*3*/] = { vVar4 - vLocal_309 * Vector(4f, 4f, 4f) };
							vLocal_323[iParam1 /*3*/].f_2 = 0f;
						}
						SYSTEM::WAIT(0);
						if (PED::IS_PED_INJURED(*iParam0))
						{
							TASK::CLEAR_PED_TASKS(*iParam0);
							TASK::TASK_GO_STRAIGHT_TO_COORD(*iParam0, vLocal_309 + vLocal_323[iParam1 /*3*/] * Vector(0.1f, 0.1f, 0.1f), 1f, -1, 1193033728, 0.5f);
			...
			case 1:
				...
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, vLocal_309 + vLocal_323[iParam1 /*3*/], 1f, -1, 0.25f, iVar0, 1193033728);
					iLocal_302[iParam1] = 2;
					return 1;
				}
				fVar7 = SYSTEM::VMAG(vLocal_323[iParam1 /*3*/] * Vector(0.05f, 0.05f, 0.05f));
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(*iParam0, true), vLocal_309) >= fVar7)
				{
			...
			case 2:
				...
				{
					if (fLocal_340[iParam1] == 0f)
					{
						fLocal_340[iParam1] = (SYSTEM::VMAG(vLocal_323[iParam1 /*3*/]) * 0.75f);
					}
					TASK::TASK_WANDER_IN_AREA(*iParam0, vLocal_309 + vLocal_323[iParam1 /*3*/], fLocal_340[iParam1], 1077936128, 1086324736);
					iLocal_302[iParam1] = 3;
					return 1;
				}
				if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), *iParam0) || PED::IS_PED_IN_COMBAT(*iParam0, 0))
				{
			...
			case 3:
				...
				if (TASK::IS_SCENARIO_TYPE_ENABLED(sLocal_545))
				{
					TASK::SET_SCENARIO_TYPE_ENABLED(sLocal_545, false);
				}
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(*iParam0, true), vLocal_309 + vLocal_323[iParam1 /*3*/]) < (fLocal_340[iParam1] * fLocal_340[iParam1]))
				{
					if (TASK::DOES_SCENARIO_EXIST_IN_AREA(vLocal_309 + vLocal_323[iParam1 /*3*/], fLocal_340[iParam1], 1))
					{
						TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD(*iParam0, vLocal_309 + vLocal_323[iParam1 /*3*/], fLocal_340[iParam1], 0);
						iLocal_302[iParam1] = 4;
						return 1;
					}
				}
				break;
			...
			case 4:
				...
				else
				{
					...
					vVar8 = { func_127(vLocal_309 + vLocal_323[iParam1 /*3*/], func_130((fLocal_340[iParam1] * 0.9f), 10f, 100f), 0f) };
					if (TASK::GET_SCRIPT_TASK_STATUS(*iParam0, 1647992574) == 1)
					{
					}
					else if (PATHFIND::GET_SAFE_COORD_FOR_PED(vVar8, 0, &vVar11, 14))
					{
						if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(*iParam0, true), vVar11) > 100f)
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, vVar11, 1f, -1, 0.25f, iVar0, 1193033728);
							iLocal_302[iParam1] = 1;
							return 1;
						}
					}
			...
			case 10:
				...
				while (iVar14 < 3)
				{
					if (iVar14 != iParam1)
					{
						if (iLocal_302[iVar14] == 2 || iLocal_302[iVar14] == 3)
						{
							iLocal_302[iVar14] = 10;
						}
					}
					iVar14++;
				}
				...
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_307, Global_93703);
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, Global_93703, iLocal_307);
				TASK::TASK_COMBAT_HATED_TARGETS_AROUND_PED(*iParam0, 15f, 0);
				iLocal_302[iParam1] = 11;
				return 1;
				break;
...
Vector3 func_127(vector3 vParam0, float fParam3, float fParam4)//Position - 0x643C
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
	...
	while (iVar5 < 10)
	{
		...
		{
			fVar4 = (fParam4 / 2f);
			vVar0.z = MISC::GET_RANDOM_FLOAT_IN_RANGE(-fVar4, fVar4);
...
Vector3 func_128(vector3 vParam0, float fParam3, float fParam4)//Position - 0x64B5
{
	vector3 vVar0;
	float fVar3;
...
Vector3 func_129(vector3 vParam0, float fParam3)//Position - 0x64FD
{
	float fVar0;
...
float func_130(float fParam0, float fParam1, float fParam2)//Position - 0x6534
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
bool func_132(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x6575
{
	if (bParam6)
	{
...
void func_133(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x65BC
{
...
int func_134()//Position - 0x6657
{
	...
	if (!func_135())
	{
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96029))
		{
			...
			if (!iLocal_544)
			{
				...
				else if (func_12(&uLocal_104, "PRSAUD", &Local_539, 3, 0, 0, 0))
				{
					iLocal_544 = 1;
				}
			}
	...
	iVar1 = 0;
	while (iVar1 < iLocal_294)
	{
		func_126(&(iLocal_294[iVar1]), iVar1);
		iVar1++;
	}
	func_126(&Global_98390, iLocal_294);
	return 0;
...
int func_136()//Position - 0x6732
{
	...
	if (!func_135())
	{
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96029))
		{
			...
			while (iVar0 < iLocal_294)
			{
				if (!PED::IS_PED_INJURED(iLocal_294[iVar0]))
				{
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_294[iVar0], Global_96029, &cLocal_393, &(Local_474[iVar0 /*16*/]), 8f, -4f, 3, 0, 1148846080, 0);
					iLocal_302[iVar0] = 0;
				}
				else
				{
...
int func_137()//Position - 0x67BB
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_96028))
	{
		...
		while (iVar0 < iLocal_294)
		{
			if (!PED::IS_PED_INJURED(iLocal_294[iVar0]))
			{
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_294[iVar0], Global_96028, &cLocal_393, &(Local_409[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
			}
			iVar0++;
		}
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			func_133(&uLocal_104, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
		}
		if (!PED::IS_PED_INJURED(Global_98390))
		{
			func_133(&uLocal_104, 4, Global_98390, "LAMAR", 0, 1);
		}
		if (!PED::IS_PED_INJURED(iLocal_294[0]))
		{
			func_133(&uLocal_104, 5, iLocal_294[0], "GangMember1", 0, 1);
		}
		if (!PED::IS_PED_INJURED(iLocal_294[1]))
		{
			func_133(&uLocal_104, 6, iLocal_294[1], "GangMember2", 0, 1);
		}
		return 1;
	}
	return 0;
...
int func_138(int iParam0, int iParam1)//Position - 0x689B
{
	vector3 vVar0;
	float fVar3;
...
int func_139(var uParam0)//Position - 0x697F
{
	return uParam0;
}

bool func_140(var uParam0, var uParam1)//Position - 0x6989
{
	return (uParam0 && uParam1) != 0;
}

int func_141()//Position - 0x6998
{
	func_39();
...
void func_143()//Position - 0x6A1E
{
	func_144((Global_98392 - 1));
}

void func_144(int iParam0)//Position - 0x6A30
{
	Global_98392 = iParam0;
}

void func_145()//Position - 0x6A3E
{
	func_144(0);
}

void func_146()//Position - 0x6A4B
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_294)
		{
			if (iLocal_298[iVar0] != 0)
			{
				STREAMING::REQUEST_MODEL(iLocal_298[iVar0]);
				if (!STREAMING::HAS_MODEL_LOADED(iLocal_298[iVar0]))
				{
					bVar2 = false;
					STREAMING::REQUEST_MODEL(iLocal_298[iVar0]);
				}
		...
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_393))
		{
			STREAMING::REQUEST_ANIM_DICT(&cLocal_393);
			if (!STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_393))
			{
				bVar2 = false;
				STREAMING::REQUEST_ANIM_DICT(&cLocal_393);
			}
	...
	PED::ADD_RELATIONSHIP_GROUP("TAUNTERS", &iLocal_307);
	iVar0 = 0;
	while (iVar0 < iLocal_294)
	{
		if (iLocal_298[iVar0] != 0)
		{
			iLocal_294[iVar0] = PED::CREATE_PED(iLocal_308, iLocal_298[iVar0], vLocal_309 + vLocal_313[iVar0 /*3*/], 0f, 1, true);
			ENTITY::SET_ENTITY_HEADING(iLocal_294[iVar0], (fLocal_312 + fLocal_336[iVar0]));
			PED::SET_PED_RANDOM_COMPONENT_VARIATION(iLocal_294[iVar0], 0);
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_294[iVar0], iLocal_307);
			TASK::TASK_PLAY_ANIM(iLocal_294[iVar0], &cLocal_393, &(Local_409[iVar0 /*16*/]), 8f, -8f, -1, 9, 0, 0, 0, 0);
			PED::SET_PED_CONFIG_FLAG(iLocal_294[iVar0], 317, true);
			if (iLocal_308 == 6)
			{
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_294[iVar0], joaat("weapon_stungun"), 1000, false, true);
			}
		}
		iVar0++;
	}
...
void func_147(var uParam0, int iParam1)//Position - 0x6C29
{
...
void func_148()//Position - 0x6C5F
{
	char[] cVar0[8];
	var uVar8;
	var uVar9;
	
	iLocal_103 = Global_98072;
	func_152(iLocal_103, &vLocal_309, &fLocal_312, &cVar0);
	func_150(iLocal_103, &sLocal_345, &cLocal_361, &cLocal_377, &uVar8, &uVar9);
	switch (iLocal_103)
	{
		case 218:
			vLocal_313[0 /*3*/] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			vLocal_313[1 /*3*/] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			vLocal_323[0 /*3*/] = { -77.3f, -4.1f, 1f };
			vLocal_323[1 /*3*/] = { vLocal_323[0 /*3*/] };
			vLocal_323[iLocal_294 /*3*/] = { 66.7f, -7.299f, 1f };
			fLocal_336[0] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			fLocal_336[1] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			fLocal_340[0] = 30f;
			fLocal_340[1] = fLocal_340[0];
			fLocal_340[iLocal_294] = 20f;
			fLocal_546 = 0.94f;
			iLocal_298[0] = joaat("g_m_y_strpunk_01");
			iLocal_298[1] = joaat("g_m_y_strpunk_02");
			iLocal_308 = 7;
			StringCopy(&cLocal_393, "SWITCH@FRANKLIN@GANG_TAUNT_P1", 64);
			StringCopy(&(Local_409[0 /*16*/]), "gang_taunt_loop_thug_01", 64);
			StringCopy(&(Local_409[1 /*16*/]), "gang_taunt_loop_thug_02", 64);
			StringCopy(&(Local_474[0 /*16*/]), "gang_taunt_exit_thug_01", 64);
			StringCopy(&(Local_474[1 /*16*/]), "gang_taunt_exit_thug_02", 64);
			StringCopy(&Local_539, "FRAS_IG_6_P1", 16);
			fLocal_543 = 0f;
			break;
		
		case 219:
			vLocal_313[0 /*3*/] = { -0.2331f, 0.0497f, 0.0041f };
			vLocal_313[1 /*3*/] = { 0.6908f, -0.4534f, 0.0042f };
			vLocal_323[0 /*3*/] = { -0.6f, -144.3f, 0f };
			vLocal_323[1 /*3*/] = { vLocal_323[0 /*3*/] };
			vLocal_323[iLocal_294 /*3*/] = { 112.2308f, 43.129f, 3.188f };
			fLocal_336[0] = 180f;
			fLocal_336[1] = 180f;
			fLocal_340[0] = 40f;
			fLocal_340[1] = fLocal_340[0];
			fLocal_340[iLocal_294] = 40f;
			fLocal_546 = 0.94f;
			iLocal_298[0] = joaat("g_m_y_strpunk_01");
			iLocal_298[1] = joaat("g_m_y_strpunk_02");
			iLocal_308 = 7;
			StringCopy(&cLocal_393, "SWITCH@FRANKLIN@GANG_TAUNT_P3", 64);
			StringCopy(&(Local_409[0 /*16*/]), "gang_taunt_with_lamar_loop_g1", 64);
			StringCopy(&(Local_409[1 /*16*/]), "gang_taunt_with_lamar_loop_g2", 64);
			StringCopy(&(Local_474[0 /*16*/]), "gang_taunt_with_lamar_exit_g1", 64);
			StringCopy(&(Local_474[1 /*16*/]), "gang_taunt_with_lamar_exit_g2", 64);
			StringCopy(&Local_539, "FRAS_IG_6_P3", 16);
			fLocal_543 = 0f;
			break;
		
		case 220:
			vLocal_313[0 /*3*/] = { 1.7097f, -1.8585f, -0.052f };
			vLocal_313[1 /*3*/] = { 2.7011f, -1.5f, -0.052f };
			vLocal_323[0 /*3*/] = { Vector(21.5656f, -1890.595f, 59.4395f) - vLocal_309 };
			vLocal_323[1 /*3*/] = { vLocal_323[0 /*3*/] };
			vLocal_323[iLocal_294 /*3*/] = { Vector(-4.6336f, -54.7307f, 67.5391f) * Vector(-1f, -1f, -1f) };
			fLocal_336[0] = -0.7167f;
			fLocal_336[1] = -0.7167f;
			fLocal_340[0] = 40f;
			fLocal_340[1] = fLocal_340[0];
			fLocal_340[iLocal_294] = 40f;
			fLocal_546 = 0.99f;
			iLocal_298[0] = joaat("s_m_y_cop_01");
			iLocal_298[1] = joaat("s_m_y_cop_01");
			iLocal_308 = 6;
			StringCopy(&cLocal_393, "SWITCH@FRANKLIN@GANG_TAUNT_P5", 64);
			StringCopy(&(Local_409[0 /*16*/]), "fras_ig_6_p5_loop_g1", 64);
			StringCopy(&(Local_409[1 /*16*/]), "fras_ig_6_p5_loop_g2", 64);
			StringCopy(&(Local_474[0 /*16*/]), "fras_ig_6_p5_exit_g1", 64);
			StringCopy(&(Local_474[1 /*16*/]), "fras_ig_6_p5_exit_g2", 64);
			StringCopy(&Local_539, "FRAS_IG_6_P4", 16);
			fLocal_543 = 0.625f;
			break;
		
		case 225:
			vLocal_313[0 /*3*/] = { 3.8209f, 1.0394f, 0f };
			vLocal_313[1 /*3*/] = { 4.0994f, -0.0922f, 0f };
			vLocal_323[0 /*3*/] = { Vector(27.9565f, -1650.517f, 278.2831f) - vLocal_309 };
			vLocal_323[1 /*3*/] = { vLocal_323[0 /*3*/] };
			vLocal_323[iLocal_294 /*3*/] = { -Vector(0f, 62.7f, 54.673f) };
			fLocal_336[0] = -23.9383f;
			fLocal_336[1] = 5.0908f;
			fLocal_340[0] = 40f;
			fLocal_340[1] = fLocal_340[0];
			fLocal_340[iLocal_294] = 40f;
			fLocal_546 = 0.94f;
			...
			iLocal_308 = 7;
			StringCopy(&cLocal_393, "SWITCH@FRANKLIN@GANG_TAUNT_P3", 64);
			StringCopy(&(Local_409[0 /*16*/]), "fras_ig_10_p3_loop_g1", 64);
			StringCopy(&(Local_409[1 /*16*/]), "fras_ig_10_p3_loop_g2", 64);
			StringCopy(&(Local_474[0 /*16*/]), "fras_ig_10_p3_exit_g1", 64);
			StringCopy(&(Local_474[1 /*16*/]), "fras_ig_10_p3_exit_g2", 64);
			Local_539 = { func_149("FRAS_IG_10", 3) };
			fLocal_543 = 0f;
			break;
		...
		default:
			vLocal_313[0 /*3*/] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			vLocal_313[1 /*3*/] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			vLocal_323[0 /*3*/] = { 0f, 0f, 0f };
			vLocal_323[1 /*3*/] = { 0f, 0f, 0f };
			vLocal_323[iLocal_294 /*3*/] = { 0f, 0f, 0f };
			fLocal_336[0] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			fLocal_336[1] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			fLocal_340[0] = 0f;
			fLocal_340[1] = 0f;
			fLocal_340[iLocal_294] = 0f;
			fLocal_546 = -1f;
			iLocal_298[0] = joaat("g_m_y_strpunk_01");
			iLocal_298[1] = joaat("g_m_y_strpunk_02");
			iLocal_308 = -1;
	...
	StringCopy(&(Local_409[iLocal_294 /*16*/]), "", 64);
	StringCopy(&(Local_409[iLocal_294 /*16*/]), "", 64);
}

struct<4> func_149(char* sParam0, int iParam1)//Position - 0x721A
{
	struct<4> Var0;
...
int func_150(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5)//Position - 0x7276
{
	*uParam4 = 9;
	*uParam5 = 0;
	switch (iParam0)
...
void func_151(int iParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0x89B5
{
...
int func_152(int iParam0, var uParam1, var uParam2, char* sParam3)//Position - 0x89D5
{
	int iVar0;
...
bool func_153(var uParam0)//Position - 0x8BC0
{
	int iVar0;
	vector3 vVar1;
	float fVar4;
	...
	*uParam0 = 5;
	...
	while (iVar5 < 5)
	{
		if (MISC::IS_BIT_SET(Global_111560.f_7224.f_11[iVar5], 0))
		{
			vVar6 = { Global_93902[iVar5 /*9*/].f_3 };
...
int func_154(int iParam0, var uParam1, char* sParam2)//Position - 0x8C7B
{
	vector3 vVar0;
	int iVar3;
	var uVar4;
...
int func_155(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0xB087
{
	switch (iParam1)
	{
		case 0:
...
int func_157(int iParam0, var uParam1, var uParam2)//Position - 0xCFF6
{
	switch (iParam0)
	{
		case 11:
...
char* func_158(int iParam0)//Position - 0xD965
{
	switch (iParam0)
	{
		case 2014101067:
...
void func_159()//Position - 0xD9F6
{
	int iVar0;
	
	iVar0 = 0;
	while (iVar0 < iLocal_298)
	{
		if (iLocal_298[iVar0] != 0)
		{
			ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_294[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_298)
	{
		if (iLocal_298[iVar0] != 0)
		{
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_298[iVar0]);
		}
		iVar0++;
	}
	...
	if (!TASK::IS_SCENARIO_TYPE_ENABLED(sLocal_545))
	{
		TASK::SET_SCENARIO_TYPE_ENABLED(sLocal_545, true);
	}
