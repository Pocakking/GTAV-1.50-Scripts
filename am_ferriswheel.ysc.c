	...
	if (MISC::IS_BIT_SET(Local_1073[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 0))
	{
		if (MISC::IS_BIT_SET(iLocal_369, 4))
		{
			if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_380))
			{
				...
				func_101(1);
				func_100(1);
				func_93(&uLocal_380, &Local_1068, &uLocal_381, func_99(&uLocal_381));
			}
		}
		else
		{
...
void func_106(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, float fParam7, bool bParam8)
{
	...
	{
		uParam0->f_14 = (uParam0->f_14 + func_107(((((vVar6.x - uParam0->f_14) * 0.05f) * fVar5) * fParam7), -3f, 3f));
		uParam0->f_14.f_1 = (uParam0->f_14.f_1 + func_107(((((vVar6.y - uParam0->f_14.f_1) * 0.05f) * fVar5) * fParam7), -3f, 3f));
		uParam0->f_14.f_2 = (uParam0->f_14.f_2 + func_107(((((vVar6.z - uParam0->f_14.f_2) * 0.05f) * fVar5) * fParam7), -3f, 3f));
	}
	if (uParam0->f_26)
	{
...
void func_117()
{
	...
	if (func_135(1) >= Global_262145.f_7789 || MONEY::NETWORK_CAN_SPEND_MONEY(Global_262145.f_7789, 0, 0, 1, -1, 0))
	{
		...
		{
			MONEY::NETWORK_BUY_FAIRGROUND_RIDE(Global_262145.f_7789, 2, false, 1);
		}
