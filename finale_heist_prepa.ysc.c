#region Local Var
	...
	int iLocal_664 = 0;
	int iLocal_665 = 0;
	vector3 vLocal_666[24] = "";
	var uLocal_669 = 0;
	var uLocal_670 = 0;
	var uLocal_671 = 0;
	vector3 vLocal_672[24] = "";
	var uLocal_675 = 0;
	var uLocal_676 = 0;
	var uLocal_677 = 0;
	int iLocal_678 = 0;
...
void __EntryFunction__()//Position - 0x0
{
	...
	func_395();
	func_381();
	iLocal_360 = PED::ADD_SCENARIO_BLOCKING_AREA(402.9022f, -1633.604f, 25.0472f, 315.6288f, -1558.814f, 38.7931f, 0, 1, 1, 1);
	func_380(27, 0);
	if (func_379())
	{
...
void func_8(vector3 vParam0, float fParam3)//Position - 0x431
{
	func_9(&(Global_105109.f_2890), vParam0, fParam3);
}

void func_9(var uParam0, vector3 vParam1, var uParam4)//Position - 0x44A
{
	*uParam0 = { vParam1 };
	uParam0->f_6 = uParam4;
}

void func_10(vector3 vParam0, float fParam3)//Position - 0x460
{
...
bool func_11(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x48C
{
	if (bParam6)
	{
...
bool func_12(var uParam0, struct<2> Param1, float fParam3)//Position - 0x4D3
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_17(var uParam0, int iParam1)//Position - 0x72D
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_19(Global_111560.f_18528[iVar0], &vVar2, &fVar5))
			{
...
var func_28(int iParam0)//Position - 0x152A
{
	return Global_1798[iParam0 /*29*/];
}

int func_29()//Position - 0x1539
{
	int iVar0;
...
bool func_30(bool bParam0)//Position - 0x156E
{
...
void func_31(char* sParam0)//Position - 0x1599
{
	func_32(sParam0);
	func_15(0);
}

void func_32(char* sParam0)//Position - 0x15AC
{
...
void func_33()//Position - 0x15EB
{
	func_34(&iLocal_356);
	func_34(&iLocal_357);
}

void func_34(int iParam0)//Position - 0x1601
{
...
void func_35()//Position - 0x1621
{
	var uVar0;
	
	func_91(&Local_456, &uVar0, &iLocal_82, &iLocal_357, &iLocal_356, vLocal_364, 0, 0, 1090519040);
	switch (iLocal_81)
	{
		case 0:
		...
		case 1:
			...
			if (func_58(Local_456, vLocal_364, &iLocal_356, iLocal_82, iLocal_91, &iLocal_663, &iLocal_385, &iLocal_379, &iLocal_380, &iLocal_355, 1090519040))
			{
		...
		case 3:
			if (func_7(Local_456))
			{
				if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_456, 0))
				{
...
void func_36(int iParam0, int iParam1, int iParam2)//Position - 0x1746
{
...
void func_37(int iParam0, bool bParam1)//Position - 0x177A
{
...
void func_38(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x17B6
{
	int iVar0;
...
void func_39(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x185F
{
	if (bParam0)
	{
...
bool func_40()//Position - 0x1998
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_41(int iParam0, int iParam1)//Position - 0x19B5
{
	bool bVar0;
...
int func_42(int iParam0, bool bParam1)//Position - 0x1A00
{
	int iVar0;
	int iVar1;
...
int func_44(int iParam0)//Position - 0x1A4D
{
...
bool func_45()//Position - 0x1A8F
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_46(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x1AA0
{
	int iVar0;
...
void func_48(int iParam0)//Position - 0x1AFA
{
	if (iParam0 == 1)
	{
...
int func_49(int iParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6)//Position - 0x1B1D
{
	bool bVar0;
	float fVar1;
...
void func_51(bool bParam0, int iParam1)//Position - 0x1B93
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_52(int iParam0)//Position - 0x1C69
{
	switch (iParam0)
	{
		case 71:
...
void func_53()//Position - 0x1CA7
{
	Global_19671 = 0;
	func_54();
}

void func_54()//Position - 0x1CB7
{
...
void func_55()//Position - 0x1D0E
{
	func_57(1, 649);
	func_56(0, -1);
}

void func_56(int iParam0, int iParam1)//Position - 0x1D24
{
	int iVar0;
...
void func_57(bool bParam0, int iParam1)//Position - 0x1D8F
{
	int iVar0;
...
int func_58(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)//Position - 0x1E29
{
	float fVar0;
...
void func_59(char* sParam0, int iParam1, int iParam2)//Position - 0x1FD3
{
	iParam2 = iParam2;
...
char* func_60(int iParam0)//Position - 0x1FEC
{
	char* sVar0;
...
char* func_61(int iParam0, bool bParam1)//Position - 0x2041
{
	char* sVar0;
...
int func_62(float fParam0, int iParam1)//Position - 0x20A4
{
	int iVar0;
...
bool func_63(int iParam0, vector3 vParam1, float fParam4)//Position - 0x2128
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, true), vParam1) <= (fParam4 * fParam4);
}

void func_64(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x2145
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
		*iParam0 = func_65(vParam1, 5, bParam4);
	}
}

int func_65(vector3 vParam0, int iParam3, bool bParam4)//Position - 0x2166
{
	int iVar0;
...
bool func_66(char* sParam0, int iParam1, char* sParam2)//Position - 0x2194
{
...
void func_67(char* sParam0, int iParam1)//Position - 0x21B2
{
	if (!*iParam1)
	{
...
char* func_68(int iParam0)//Position - 0x21CF
{
	char* sVar0;
...
int func_69()//Position - 0x2224
{
	return Global_76839;
}

void func_70(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x2230
{
	switch (*iParam4)
	{
		case 0:
...
int func_71(int iParam0, bool bParam1)//Position - 0x2310
{
	int iVar0;
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_82(1, vLocal_361, 0))
			{
				...
				{
					iLocal_371 = PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(400.8628f, -1609.739f, 28.29278f, 7.5f, 2f, 9.5f, func_81(229.3746f), 0, 7);
...
void func_74(int iParam0, vector3 vParam1, float fParam4)//Position - 0x269B
{
	if (func_377(iParam0))
	{
...
void func_76(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x274F
{
...
int func_78(int iParam0, int iParam1)//Position - 0x28AB
{
	if (func_377(iParam0))
	{
...
void func_79(int iParam0, int iParam1, bool bParam2)//Position - 0x28DE
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
int func_80(int iParam0, bool bParam1, int iParam2)//Position - 0x28FD
{
	int iVar0;
...
float func_81(float fParam0)//Position - 0x2932
{
	return (fParam0 * 0.01745329f);
}

int func_82(int iParam0, vector3 vParam1, float fParam4)//Position - 0x2942
{
	int iVar0;
	int iVar1;
	char cVar2[16];
	...
	{
		case 0:
			if (func_90(vParam1, vLocal_361, 1056964608, 0) && fParam4 == 0f)
			{
				return 1;
			}
			break;
		...
		case 4:
			...
			while (iVar6 <= 3)
			{
				...
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_95196[iVar6], true, 1);
		...
		case 5:
			if (func_83(&iLocal_358, joaat("prop_box_guncase_03a"), 354.6938f, -1634.783f, 22.7849f, 299.1508f, 1))
			{
				if (func_7(Local_456))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_358, Local_456, 0, 0f, -1.85f, 0.05f, ENTITY::GET_ENTITY_ROTATION(Local_456, 2), 0, 0, 0, 0, 2, 1);
...
int func_83(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0x2CAF
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_84(int iParam0, bool bParam1)//Position - 0x2D12
{
	if (bParam1)
	{
...
int func_85(int iParam0, int iParam1, int iParam2)//Position - 0x2D37
{
...
int func_86(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x2D66
{
...
void func_87(int iParam0)//Position - 0x2DE6
{
...
int func_88(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0x2EBF
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (func_85(iParam1, "Loading", 0))
...
void func_89(int iParam0, int iParam1)//Position - 0x2F72
{
	Global_98669.f_22[iParam1] = iParam0;
}

int func_90(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x2F86
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_91(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, vector3 vParam5, int iParam8, bool bParam9, float fParam10)//Position - 0x3001
{
	if (func_7(*iParam0))
	{
		switch (*iParam2)
...
void func_92(int iParam0, var uParam1)//Position - 0x31B5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_93(int iParam0)//Position - 0x32A2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_95(int iParam0)//Position - 0x3337
{
	int iVar0;
...
int func_96(int iParam0)//Position - 0x3390
{
	int iVar0;
	int iVar1;
...
int func_97(int iParam0)//Position - 0x3413
{
	int iVar0;
	int iVar1;
...
void func_98()//Position - 0x347F
{
	...
	switch (iLocal_81)
	{
		...
		case 1:
			...
			if (func_101(Local_456, vLocal_364, &iLocal_356, iLocal_91, iLocal_82, &iLocal_355, &iLocal_385, 0, 0, 1086324736))
			{
				RECORDING::_0x293220DA1B46CEBC(5f, 6f, 4);
				iLocal_81 = 2;
			}
...
void func_99(bool bParam0)//Position - 0x361A
{
	func_100(iLocal_80);
...
void func_100(int iParam0)//Position - 0x3652
{
	switch (iParam0)
	{
		case 0:
...
int func_101(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, float fParam11)//Position - 0x366A
{
...
bool func_102()//Position - 0x375D
{
	return Global_98721.f_345 > 0;
}

int func_103()//Position - 0x376E
{
...
int func_107(int iParam0, int iParam1)//Position - 0x38AC
{
	switch (iLocal_83[iParam0])
	{
		case 0:
			TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iParam1, PED::GET_VEHICLE_PED_IS_IN(iParam1, 0), vLocal_364, 4, 20f, 786469, 3.5f, 5f, 1);
			iLocal_83[iParam0] = 3;
			break;
...
int func_108(int iParam0)//Position - 0x3937
{
	int iVar0;
...
int func_109(int iParam0, int iParam1)//Position - 0x398F
{
	float fVar0;
...
int func_110(int iParam0, int iParam1)//Position - 0x3A6D
{
	int iVar0;
...
int func_111(int iParam0, int iParam1)//Position - 0x3AF4
{
	if (!func_112())
	{
		if ((ENTITY::DOES_ENTITY_EXIST(Local_456) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_456, 0)) && !ENTITY::IS_ENTITY_AT_COORD(Local_456, vLocal_364, 2f, 2f, 2f, false, true, 0))
		{
			if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_456, 0)) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
			{
				if (PED::IS_PED_IN_VEHICLE(iParam1, Local_456, 0) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_456, -1, 0) == iParam1)
				{
					iLocal_87[iParam0] = 2;
					return 1;
				}
...
int func_113(int iParam0, int iParam1)//Position - 0x3BA5
{
	if (!func_112())
	{
...
int func_114(int iParam0, int iParam1)//Position - 0x3C9B
{
	int iVar0;
...
int func_115(int iParam0)//Position - 0x3CF7
{
	int iVar0;
...
int func_116(int iParam0)//Position - 0x3D40
{
	if (iParam0 > 3)
	{
		return 0;
...
int func_117(int iParam0)//Position - 0x3D71
{
	if (iParam0 == 0)
	{
		return 0;
...
void func_120(int iParam0)//Position - 0x3FB5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_121(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x43D7
{
...
void func_122(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x4412
{
...
void func_123(int iParam0)//Position - 0x4468
{
...
int func_124(int iParam0, int iParam1)//Position - 0x44E0
{
	int iVar0;
...
void func_127(int iParam0)//Position - 0x45C5
{
...
void func_128(int iParam0)//Position - 0x46A9
{
	char* sVar0;
	...
	if ((iLocal_80 != 2 && !iLocal_659) && !ENTITY::IS_ENTITY_DEAD(Local_389[iParam0 /*22*/], 0))
	{
		if (func_133(iParam0) && func_131(Local_389[iParam0 /*22*/], 30f))
		{
			...
			else if (!func_124(iParam0, 15) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 362.6359f, -1581.256f, 31.54774f, 358.1074f, -1586.615f, 34.29774f, 2f, 0, true, 0))
			{
				...
				{
					AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(Local_389[iParam0 /*22*/], "ARREST_PLAYER", sVar0, "SPEECH_PARAMS_FORCE", 0);
				}
				iLocal_659 = 1;
			}
		}
...
void func_129()//Position - 0x47A9
{
	Global_19671 = 0;
	func_130();
}

void func_130()//Position - 0x47B9
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_131(int iParam0, float fParam1)//Position - 0x47DA
{
	if (iParam0 == 0)
	{
		return 1;
...
float func_132(int iParam0, int iParam1, bool bParam2)//Position - 0x4818
{
	vector3 vVar0;
	vector3 vVar3;
...
bool func_133(int iParam0)//Position - 0x4876
{
	return Local_389[iParam0 /*22*/].f_18 > 1;
}

void func_134(int iParam0)//Position - 0x4889
{
	var uVar0;
...
bool func_136(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x4B36
{
...
int func_137(char* sParam0, int iParam1, bool bParam2)//Position - 0x4B8A
{
	Global_20806 = 0;
...
bool func_140(int iParam0)//Position - 0x4EF7
{
	return func_141(iParam0, 20);
}

bool func_141(int iParam0, int iParam1)//Position - 0x4F07
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_142()//Position - 0x4F22
{
	return -1;
}

void func_143()//Position - 0x4F2B
{
	int iVar0;
...
bool func_148(int iParam0, int iParam1)//Position - 0x5183
{
	switch (iParam0)
	{
		case 5:
...
int func_149(int iParam0)//Position - 0x51BE
{
...
int func_150(int iParam0)//Position - 0x51F1
{
	int iVar0;
...
void func_151(int iParam0)//Position - 0x520D
{
...
void func_152(int iParam0)//Position - 0x528D
{
	func_174(iParam0);
	if (!func_173(iParam0))
	{
...
bool func_153(int iParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x5380
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam3), ENTITY::GET_ENTITY_COORDS(iParam1, bParam3)) <= (fParam2 * fParam2);
}

int func_154(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x53A2
{
	vector3 vVar0;
...
int func_155(int iParam0, float fParam1)//Position - 0x545D
{
	float fVar0;
...
bool func_156(int iParam0, float fParam1)//Position - 0x54D3
{
	return func_157(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_157(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x54EB
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_158(&(Local_38[iVar4 /*4*/]), vVar1, iParam1, &(Local_38[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_38[iVar4 /*4*/].f_3) < iParam4);
}

int func_158(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x55AC
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_159(int iParam0, int iParam1)//Position - 0x56D8
{
	int iVar0;
...
int func_161(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x57E7
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_162(vector3 vParam0, vector3 vParam3)//Position - 0x5878
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_163(vector3 vParam0)//Position - 0x5899
{
	float fVar0;
	float fVar1;
...
void func_164(var uParam0)//Position - 0x58D8
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_165(int iParam0, int iParam1)//Position - 0x58F3
{
	int iVar0;
...
int func_166(int iParam0)//Position - 0x5932
{
...
bool func_167(int iParam0, int iParam1, float fParam2)//Position - 0x595A
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_168(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x59A1
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_169(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x5A9C
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_170(int iParam0, float fParam1)//Position - 0x5BA8
{
	var uVar0;
	vector3 vVar1;
...
int func_171(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0x5C3D
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_172(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x5CCB
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_173(int iParam0)//Position - 0x5D13
{
...
void func_174(int iParam0)//Position - 0x5D52
{
	func_194(iParam0);
	func_190(iParam0);
	func_187(iParam0);
...
void func_175(int iParam0)//Position - 0x5DD1
{
	int iVar0;
...
void func_176(int iParam0, int iParam1)//Position - 0x5E54
{
	switch (iParam1)
	{
		case 0:
...
void func_177(int iParam0, int iParam1, int iParam2)//Position - 0x5F4B
{
	char* sVar0;
	char* sVar1;
		...
		else if (iParam1 == 5)
		{
			if (Local_389[func_150(iParam0) /*22*/].f_20 != 5)
			{
				if (iParam0 == 0)
				{
					...
					AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(Local_389[iParam0 /*22*/], "CHALLENGE_THREATEN", sVar1, "SPEECH_PARAMS_FORCE", 0);
				}
				else if (iParam0 == 1)
				{
...
void func_178(int iParam0, char* sParam1, bool bParam2, bool bParam3)//Position - 0x61DE
{
	struct<6> Var0;
...
struct<6> func_180()//Position - 0x62E0
{
	struct<6> Var0;
	int iVar6;
...
struct<6> func_181()//Position - 0x6326
{
	struct<6> Var0;
...
void func_182(int iParam0, int iParam1, int iParam2)//Position - 0x634A
{
	char* sVar0;
	char* sVar1;
	...
	if (!func_149(iParam0) || iParam2)
	{
		...
		else if (iParam1 == 5)
		{
			if (Local_389[iParam0 /*22*/].f_19 != 5)
			{
				...
				AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(Local_389[iParam0 /*22*/], "BUMP", sVar1, "SPEECH_PARAMS_FORCE", 0);
				func_183(iParam0, iParam1, 0);
			}
		}
		else if (iParam1 == 7)
...
void func_183(int iParam0, int iParam1, bool bParam2)//Position - 0x65A9
{
	if (bParam2)
	{
		if (MISC::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 12))
...
void func_184(int iParam0)//Position - 0x6649
{
	float fVar0;
	...
	if ((!func_149(iParam0) && Local_389[iParam0 /*22*/].f_20 != 6) && Local_389[iParam0 /*22*/].f_20 != 7)
	{
		...
		if (iParam0 == 0 || iParam0 == 1)
		{
			if (!iLocal_382)
			{
				...
				if (((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_309[1 /*7*/], Local_309[1 /*7*/].f_3, Local_309[1 /*7*/].f_6, 0, true, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_389[iParam0 /*22*/], Local_309[1 /*7*/], Local_309[1 /*7*/].f_3, Local_309[1 /*7*/].f_6, 0, true, 0)) && !MISC::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 10)) && !MISC::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 11))
				{
					if ((fVar0 > 12f && !Local_389[iParam0 /*22*/].f_16) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 344.4482f, -1603.473f, 28.29278f, 345.6222f, -1604.478f, 32.29278f, 3.46f, 0, true, 0))
					{
						func_186(iParam0, 11);
					}
				}
		...
		else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_309[5 /*7*/], Local_309[5 /*7*/].f_3, Local_309[5 /*7*/].f_6, 0, true, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_389[iParam0 /*22*/], Local_309[5 /*7*/], Local_309[5 /*7*/].f_3, Local_309[5 /*7*/].f_6, 0, true, 0))
		{
...
void func_185(int iParam0, int iParam1)//Position - 0x6915
{
...
void func_186(int iParam0, int iParam1)//Position - 0x6948
{
	if (!MISC::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, iParam1))
	{
...
void func_187(int iParam0)//Position - 0x697C
{
	bool bVar0;
...
int func_188(int iParam0)//Position - 0x6A7A
{
	if (iParam0 == 2)
	{
		return 0;
...
int func_189(int iParam0, int iParam1)//Position - 0x6ABD
{
...
void func_190(int iParam0)//Position - 0x6AF5
{
	int iVar0;
	...
	if (Local_389[iParam0 /*22*/].f_20 != 6 && Local_389[iParam0 /*22*/].f_20 != 7)
	{
		...
		while (iVar0 <= 5)
		{
			if (Local_389[iParam0 /*22*/].f_16)
			{
				if (!MISC::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 12))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_309[iVar0 /*7*/], Local_309[iVar0 /*7*/].f_3, Local_309[iVar0 /*7*/].f_6, 0, true, 0))
					{
						iLocal_382 = 1;
						iLocal_381 = MISC::GET_GAME_TIMER();
						if (iVar0 == 4)
			...
			else if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_309[iVar0 /*7*/], Local_309[iVar0 /*7*/].f_3, Local_309[iVar0 /*7*/].f_6, 0, true, 0) || MISC::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 12))
			{
				func_191(iParam0, iVar0);
			}
			iVar0++;
	...
	else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_309[3 /*7*/], Local_309[3 /*7*/].f_3, Local_309[3 /*7*/].f_6, 0, true, 0))
	{
		func_193(iParam0, 3);
	}
	else
...
void func_191(int iParam0, int iParam1)//Position - 0x6C43
{
	int iVar0;
		...
		case 4:
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				if (func_7(iVar0))
				{
					...
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar0, Local_309[4 /*7*/], Local_309[4 /*7*/].f_3, Local_309[4 /*7*/].f_6, 0, true, 0))
					{
						func_185(iParam0, 8);
						func_185(iParam0, 7);
					}
...
int func_192(int iParam0)//Position - 0x6D4C
{
	switch (iParam0)
	{
		case joaat("police"):
...
void func_193(int iParam0, int iParam1)//Position - 0x6DA5
{
	switch (iParam1)
	{
		case 1:
...
void func_194(int iParam0)//Position - 0x6F38
{
...
void func_195(int iParam0)//Position - 0x6F8A
{
	bool bVar0;
	struct<8> Var1;
...
int func_196(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x6FFC
{
	if (iParam3 == 0)
	{
...
void func_198(int iParam0)//Position - 0x7328
{
	char* sVar0;
	float fVar1;
...
void func_199(int iParam0)//Position - 0x761E
{
	func_200(iParam0);
	func_184(iParam0);
	func_175(iParam0);
...
void func_200(int iParam0)//Position - 0x7638
{
	func_194(iParam0);
	func_203(iParam0);
	func_190(iParam0);
...
void func_201(int iParam0)//Position - 0x76C0
{
	bool bVar0;
...
void func_202(int iParam0)//Position - 0x778D
{
	bool bVar0;
...
void func_203(int iParam0)//Position - 0x7851
{
	if (!func_173(iParam0))
	{
		if (bLocal_374)
...
int func_204(int iParam0)//Position - 0x78C1
{
	float fVar0;
...
bool func_206(int iParam0, var uParam1, char* sParam2, float fParam3, int iParam4)//Position - 0x7ACB
{
	if (!*uParam1)
	{
...
int func_207(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x7B2F
{
...
void func_208(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x7B7D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_211(vector3 vParam0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x7EA7
{
	int iVar0;
	int iVar1;
...
void func_212()//Position - 0x7F17
{
	Global_22211.f_6 = 1;
}

void func_213(int iParam0)//Position - 0x7F25
{
	if (func_218())
	{
		return;
...
void func_214(int iParam0)//Position - 0x7F58
{
	if (func_218())
	{
		return;
...
void func_215(bool bParam0, bool bParam1)//Position - 0x7FE2
{
	if (bParam0)
	{
		if (func_217(0))
...
bool func_216()//Position - 0x8059
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

int func_217(int iParam0)//Position - 0x806A
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
bool func_218()//Position - 0x80C4
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

void func_219(int iParam0, int iParam1, int iParam2)//Position - 0x80D6
{
...
void func_220(int iParam0)//Position - 0x819A
{
	if (iParam0 == 1)
	{
...
bool func_221()//Position - 0x81C3
{
	return MISC::IS_BIT_SET(Global_98669.f_20, 13);
}

void func_222(int iParam0)//Position - 0x81D7
{
	Global_94554 = 0;
	switch (iParam0)
	{
...
void func_223(int iParam0)//Position - 0x8265
{
	MISC::SET_BIT(&Global_94554, iParam0);
}

void func_224()//Position - 0x8277
{
	int iVar0;
...
void func_225(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)//Position - 0x82B4
{
	struct<60> Var0;
...
void func_226(int iParam0, int iParam1, int iParam2)//Position - 0x83DD
{
	int iVar0;
...
void func_227(int iParam0, int iParam1)//Position - 0x84FA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_228(int iParam0)//Position - 0x86FC
{
...
int func_229(int iParam0)//Position - 0x87D9
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_230(int iParam0, bool bParam1)//Position - 0x898A
{
	int iVar0;
	struct<2> Var1;
...
int func_231(int iParam0)//Position - 0x8B0A
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_233(int iParam0)//Position - 0x8BED
{
	int iVar0;
	int iVar1;
...
int func_234()//Position - 0xB0B8
{
	return 0;
}

int func_235()//Position - 0xB0C1
{
	return 1;
}

int func_236()//Position - 0xB0CA
{
	return 1;
}

int func_237()//Position - 0xB0D3
{
...
int func_239(int iParam0)//Position - 0xB1A7
{
	int iVar0;
	char* sVar1;
...
int func_240(int iParam0)//Position - 0xB1ED
{
	int iVar0;
...
int func_241(int iParam0)//Position - 0xB228
{
	int iVar0;
...
int func_242(int iParam0)//Position - 0xB2A4
{
	int iVar0;
...
int func_243(int iParam0, int iParam1, bool bParam2)//Position - 0xB38C
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_244(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0xB3FD
{
...
int func_245(int iParam0)//Position - 0xB4D5
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_247(var uParam0, int iParam1)//Position - 0xB537
{
	if (iParam1 <= 0)
	{
		return;
...
void func_248(var uParam0, int iParam1)//Position - 0xB5BD
{
...
void func_249(var uParam0, int iParam1)//Position - 0xB5F0
{
	int iVar0;
	int iVar1;
...
int func_250(int iParam0, int iParam1)//Position - 0xB641
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_251(int iParam0)//Position - 0xB6E3
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_252(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_252(bool bParam0, int iParam1, int iParam2)//Position - 0xB708
{
	if (bParam0)
	{
		return iParam1;
...
int func_253(var uParam0)//Position - 0xB71F
{
	return uParam0 & 15;
}

void func_254(var uParam0, int iParam1)//Position - 0xB72C
{
...
void func_255(var uParam0, int iParam1)//Position - 0xB766
{
...
void func_256(var uParam0, int iParam1)//Position - 0xB7A1
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_257(var uParam0, int iParam1)//Position - 0xB7DD
{
	int iVar0;
	int iVar1;
...
int func_258(int iParam0, int iParam1)//Position - 0xCED5
{
	struct<82> Var0;
...
void func_259(int iParam0, var uParam1, int iParam2)//Position - 0xCF17
{
	int iVar0;
...
void func_260(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0xD173
{
	if (func_257(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
...
void func_261(int iParam0, bool bParam1)//Position - 0xD272
{
	if (iParam0 == -1)
	{
		return;
...
void func_262(int iParam0, int iParam1, bool bParam2)//Position - 0xD2CF
{
	if (iParam0 == -1)
	{
		return;
...
bool func_263(int iParam0, int iParam1)//Position - 0xD30A
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_264(var uParam0, var uParam1)//Position - 0xD32D
{
...
void func_265(int iParam0)//Position - 0xD3F9
{
	if (iParam0 == -1)
	{
		return;
...
int func_266(int iParam0)//Position - 0xD473
{
	int iVar0;
...
void func_267(int iParam0, var uParam1)//Position - 0xD4D6
{
	int iVar0;
...
int func_268(int iParam0)//Position - 0xD781
{
	switch (iParam0)
	{
		case 1:
...
int func_269(int iParam0, var uParam1, var uParam2)//Position - 0xD831
{
	int iVar0;
	int iVar1;
...
int func_270(int iParam0)//Position - 0xDA24
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_271(var uParam0)//Position - 0xDA44
{
	int iVar0;
...
void func_272(int iParam0)//Position - 0xDAF4
{
...
int func_273(int iParam0, int iParam1, int iParam2)//Position - 0xDB1B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_274(int iParam0)//Position - 0xDD76
{
	switch (iParam0)
	{
		case 0:
...
int func_275(int iParam0, int iParam1)//Position - 0xDE26
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_276(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDE86
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_277(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0xDF0A
{
	var uVar0;
	int iVar10;
...
int func_278(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE50E
{
	switch (iParam0)
	{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_279(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_279(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_279(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_279(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_279(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE78B
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar41 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_274(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_280(int iParam0, int iParam1)//Position - 0xE8E7
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_281(int iParam0)//Position - 0xEC8E
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_282(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xECEF
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_283(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xF114
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_284(int iParam0, int iParam1, int iParam2)//Position - 0xF407
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
struct<10> func_285(int iParam0, int iParam1)//Position - 0xF4A0
{
	int iVar0;
	struct<10> Var1;
...
void func_286(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xFDCF
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
int func_287(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xFEF9
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_274(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
void func_288(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xFFD9
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_289(int iParam0, int iParam1)//Position - 0x10022
{
	int iVar0;
	struct<17> Var1;
...
void func_290(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11E6A
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_291(int iParam0)//Position - 0x12054
{
	switch (iParam0)
	{
		case 0:
...
void func_292(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x12104
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_293(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x12175
{
	func_360();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_294(int iParam0, int iParam1)//Position - 0x121C7
{
	switch (iParam0)
	{
		case 0:
...
void func_295(int iParam0)//Position - 0x122B7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_296(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x1352E
{
	int iVar0;
	int iVar1;
...
bool func_297(int iParam0, int iParam1, var uParam2)//Position - 0x138BF
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_298(int iParam0, int iParam1)//Position - 0x13CC4
{
	switch (iParam1)
	{
		case 0:
...
int func_299(int iParam0, int iParam1, int iParam2)//Position - 0x140C1
{
	int iVar0;
	var uVar1;
...
int func_300(var uParam0)//Position - 0x140F3
{
	int iVar0;
	int iVar1;
...
int func_301(int iParam0, int iParam1)//Position - 0x14127
{
	switch (iParam1)
	{
		case 0:
...
int func_302(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x14522
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_303(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x15440
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_304(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x15482
{
	int iVar0;
...
int func_305(int iParam0)//Position - 0x172E9
{
	switch (iParam0)
	{
		case -1:
...
void func_306(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x173BD
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_296(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_296(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_274(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_307(int iParam0)//Position - 0x17696
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_308(int iParam0)//Position - 0x177ED
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_309(int iParam0)//Position - 0x17CFB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_310(int iParam0)//Position - 0x17D70
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_311(int iParam0)//Position - 0x17DE4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_312(int iParam0)//Position - 0x17ECB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_313(int iParam0)//Position - 0x1822F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_314(int iParam0)//Position - 0x18440
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_315(int iParam0)//Position - 0x18670
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_316(int iParam0)//Position - 0x18780
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_317(int iParam0)//Position - 0x1911F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_318(int iParam0)//Position - 0x19C92
{
	if (iParam0 < 136)
	{
		func_320(iParam0);
...
void func_319(int iParam0)//Position - 0x19CC7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_320(int iParam0)//Position - 0x1A8CB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_321(int iParam0)//Position - 0x1B7D9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_322(int iParam0)//Position - 0x1B906
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_323(int iParam0, int iParam1)//Position - 0x1BA04
{
	switch (iParam0)
	{
		case 0:
...
void func_324(int iParam0)//Position - 0x1BAF4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_325(int iParam0)//Position - 0x1CFE7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_326(int iParam0)//Position - 0x1D138
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_327(int iParam0)//Position - 0x1D643
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_328(int iParam0)//Position - 0x1DCB1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_329(int iParam0)//Position - 0x1DD25
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_330(int iParam0)//Position - 0x1DDF5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_331(int iParam0)//Position - 0x1E325
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_332(int iParam0)//Position - 0x1E4BC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_333(int iParam0)//Position - 0x1ECBA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_334(int iParam0)//Position - 0x1EDCA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_335(int iParam0)//Position - 0x1FCF5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_336(int iParam0)//Position - 0x209B4
{
	if (iParam0 < 107)
	{
		func_339(iParam0);
...
void func_337(int iParam0)//Position - 0x209FA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_338(int iParam0)//Position - 0x2149F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_339(int iParam0)//Position - 0x2228E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_340(int iParam0)//Position - 0x22ED7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_341(int iParam0)//Position - 0x23150
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_342(int iParam0, int iParam1)//Position - 0x23296
{
	switch (iParam0)
	{
		case 0:
...
void func_343(int iParam0)//Position - 0x23386
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_344(int iParam0)//Position - 0x24111
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_345(int iParam0)//Position - 0x2428B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_346(int iParam0)//Position - 0x24802
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_347(int iParam0)//Position - 0x24D2C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_348(int iParam0)//Position - 0x24DA0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_349(int iParam0)//Position - 0x24E70
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_350(int iParam0)//Position - 0x25348
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_351(int iParam0)//Position - 0x255B1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_352(int iParam0)//Position - 0x25887
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_353(int iParam0)//Position - 0x25A50
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_354(int iParam0)//Position - 0x265A4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_355(int iParam0)//Position - 0x271EE
{
	if (iParam0 < 60)
	{
		func_357(iParam0);
...
void func_356(int iParam0)//Position - 0x27223
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_357(int iParam0)//Position - 0x27FC3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_358(int iParam0)//Position - 0x28665
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_359(int iParam0)//Position - 0x2874C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_360()//Position - 0x2884A
{
...
void func_361(int iParam0)//Position - 0x288C3
{
	if (Global_95621 != -1)
	{
...
void func_362()//Position - 0x288E7
{
	func_364();
	func_363();
}

void func_363()//Position - 0x288F7
{
...
void func_364()//Position - 0x2893B
{
	if (bLocal_374)
	{
...
void func_365(int iParam0, float fParam1)//Position - 0x28AAE
{
...
void func_366(int iParam0, float fParam1)//Position - 0x28B39
{
	if (*fParam1 != 1f)
	{
		OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(iParam0, *fParam1, 1, 1);
...
void func_367()//Position - 0x28B82
{
	func_368();
	if (iLocal_662)
	{
...
void func_368()//Position - 0x28BAB
{
	if (!iLocal_383)
	{
		if (iLocal_82 == 1 || iLocal_82 == 2)
...
void func_369(int iParam0, bool bParam1)//Position - 0x28BE1
{
	int iVar0;
...
void func_370()//Position - 0x28C2B
{
...
void func_371()//Position - 0x28C50
{
...
void func_372(int iParam0)//Position - 0x28CCC
{
	HUD::CLEAR_PRINTS();
	func_53();
	AUDIO::TRIGGER_MUSIC_EVENT("FHPRA_FAIL");
...
void func_373(char* sParam0, bool bParam1)//Position - 0x28D3A
{
	if (!*bParam1)
	{
		func_59(sParam0, 7500, 0);
...
void func_374()//Position - 0x28D57
{
	if (!func_7(Local_456))
	{
		func_372(1);
...
void func_375()//Position - 0x28DD5
{
...
int func_376(int iParam0)//Position - 0x28E27
{
	if (func_7(iParam0))
	{
...
int func_377(int iParam0)//Position - 0x28E82
{
	if (func_6(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_378(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x28EA2
{
	if (func_379())
	{
...
void func_380(int iParam0, int iParam1)//Position - 0x28F5B
{
...
void func_381()//Position - 0x28FA0
{
	func_393();
	func_391();
	func_386();
...
void func_382()//Position - 0x28FC0
{
...
struct<7> func_383(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x290E2
{
	struct<7> Var0;
...
void func_384()//Position - 0x29106
{
	int iVar0;
...
void func_385()//Position - 0x29176
{
...
void func_386()//Position - 0x291C7
{
	vector3 vVar0[8];
...
void func_387(var uParam0)//Position - 0x2939A
{
	int iVar0;
	float fVar1;
...
void func_388(var uParam0, vector3 vParam1)//Position - 0x2943A
{
	if (uParam0->f_51 == 0)
	{
	}
...
void func_389(var uParam0)//Position - 0x2946B
{
	if (uParam0->f_51)
	{
	}
...
void func_390(var uParam0, var uParam1, int iParam2)//Position - 0x29492
{
	int iVar0;
...
void func_391()//Position - 0x294C9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
struct<22> func_392(vector3 vParam0, float fParam3, int iParam4)//Position - 0x295C5
{
	struct<22> Var0;
...
void func_393()//Position - 0x295F1
{
...
struct<6> func_394(vector3 vParam0, float fParam3, int iParam4)//Position - 0x2968A
{
	struct<6> Var0;
...
void func_395()//Position - 0x296AC
{
	PED::ADD_RELATIONSHIP_GROUP("COPS", &iLocal_481);
}

void func_396()//Position - 0x296C0
{
	...
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_360, 0);
	func_55();
	PLAYER::SET_MAX_WANTED_LEVEL(5);
	PLAYER::SET_WANTED_LEVEL_MULTIPLIER(1f);
	func_406();
...
void func_397(bool bParam0)//Position - 0x29742
{
	vector3 vVar0;
	...
	if (CAM::DOES_CAM_EXIST(iLocal_359))
	{
		...
		CAM::DESTROY_CAM(iLocal_359, 0);
	}
}

void func_398()//Position - 0x2981C
{
	int iVar0;
...
void func_399(int iParam0, bool bParam1)//Position - 0x29877
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_400()//Position - 0x298B2
{
}

void func_401()//Position - 0x298BA
{
}

void func_402()//Position - 0x298C2
{
}

void func_403()//Position - 0x298CA
{
	int iVar0;
...
void func_404()//Position - 0x298FA
{
	int iVar0;
	int iVar1;
...
void func_405(bool bParam0, int iParam1, int iParam2)//Position - 0x29936
{
	bool bVar0;
...
void func_406()//Position - 0x29995
{
	Global_94554 = 0;
}

void func_407(int iParam0)//Position - 0x299A2
{
	Global_96005 = iParam0;
}

void func_408()//Position - 0x299B0
{
	int iVar0;
...
void func_410()//Position - 0x29A5F
{
