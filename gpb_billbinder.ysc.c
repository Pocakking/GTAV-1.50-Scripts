...
int func_16()//Position - 0x162A
{
	func_17();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_17()//Position - 0x1643
{
	int iVar0;
...
bool func_18(int iParam0)//Position - 0x1740
{
	return Global_41396 == iParam0;
}

bool func_19(int iParam0)//Position - 0x174E
{
	return iParam0 < 3;
}

int func_20(int iParam0)//Position - 0x175A
{
	int iVar0;
	int iVar1;
...
int func_21(int iParam0)//Position - 0x1797
{
	if (func_19(iParam0))
	{
...
var func_22(int iParam0)//Position - 0x17BC
{
	return Global_1798[iParam0 /*29*/];
}

void func_23(char* sParam0)//Position - 0x17CB
{
	struct<16> Var0;
...
void func_25(char* sParam0)//Position - 0x1844
{
	int iVar0;
...
void func_26(int iParam0, char* sParam1)//Position - 0x1888
{
	switch (iParam0)
	{
		case 0:
...
void func_27(char* sParam0)//Position - 0x1A51
{
	char cVar0[64];
...
void func_28(char* sParam0)//Position - 0x1A85
{
	struct<4> Var0;
...
void func_29(char* sParam0)//Position - 0x1AB0
{
...
void func_31(char* sParam0)//Position - 0x1AE2
{
	int iVar0;
...
bool func_33(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1B4E
{
...
int func_34(char* sParam0, int iParam1, bool bParam2)//Position - 0x1B9C
{
	Global_20806 = 0;
...
bool func_37(int iParam0)//Position - 0x1F09
{
	return func_38(iParam0, 20);
}

bool func_38(int iParam0, int iParam1)//Position - 0x1F19
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_39()//Position - 0x1F34
{
	return -1;
}

void func_40()//Position - 0x1F3D
{
	int iVar0;
...
bool func_46(int iParam0, int iParam1)//Position - 0x21BA
{
	switch (iParam0)
	{
		case 5:
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x21F5
{
...
void func_48(char[4] cParam0)//Position - 0x224B
{
	int iVar0;
...
void func_49(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2286
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_50(char* sParam0)//Position - 0x2321
{
	int iVar0;
...
void func_51(var uParam0)//Position - 0x2359
{
}

void func_52(var uParam0, int iParam1, float fParam2)//Position - 0x2361
{
}

void func_53()//Position - 0x2369
{
	STREAMING::REMOVE_ANIM_DICT(&Local_388);
}

void func_54()//Position - 0x2378
{
	char* sVar0;
	struct<16> Var8;
...
void func_55(var uParam0)//Position - 0x23EE
{
}

void func_56(char* sParam0)//Position - 0x23F6
{
...
void func_57(int iParam0, char* sParam1, char* sParam2)//Position - 0x2409
{
...
bool func_59()//Position - 0x24FC
{
	return Global_98721.f_345 > 0;
}

bool func_60()//Position - 0x250D
{
	bool bVar0;
...
void func_64(char* sParam0)//Position - 0x2590
{
	struct<8> Var0;
...
void func_65(char* sParam0)//Position - 0x25D0
{
	func_26(iLocal_297, sParam0);
}

void func_66(char* sParam0)//Position - 0x25E1
{
	StringCopy(sParam0, "MONOLOGUE_", 16);
	StringIntConCat(sParam0, Global_111505[iLocal_251] + 1, 16);
}

void func_67(int iParam0, bool bParam1)//Position - 0x25FF
{
	int iVar0;
...
void func_68(int iParam0, bool bParam1)//Position - 0x2620
{
	int iVar0;
...
void func_69(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x2691
{
	func_70(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_70(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x26B1
{
	int iVar0;
...
int func_72(int iParam0)//Position - 0x29A3
{
	int iVar0;
	int iVar1;
...
int func_75(int iParam0)//Position - 0x2AEC
{
	if (func_77(iParam0))
	{
...
int func_76(int iParam0)//Position - 0x2B13
{
	int iVar0;
...
int func_78(int iParam0)//Position - 0x2B70
{
	switch (iParam0)
	{
...
void func_79(int iParam0)//Position - 0x2C2E
{
	if (iLocal_447 == 1)
	{
...
void func_80(int iParam0, int iParam1, bool bParam2)//Position - 0x2C4D
{
	if (iLocal_447 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
...
int func_81(int iParam0, bool bParam1, int iParam2)//Position - 0x2CA0
{
	int iVar0;
...
int func_82(int iParam0, bool bParam1, bool bParam2)//Position - 0x2CEA
{
	int iVar0;
...
float func_83(bool bParam0, float fParam1, float fParam2)//Position - 0x2D8E
{
	if (bParam0)
	{
		return fParam1;
...
float func_84(int iParam0, int iParam1, bool bParam2)//Position - 0x2DA5
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_85(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2E03
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_86(vector3 vParam0, vector3 vParam3)//Position - 0x2E94
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_87(vector3 vParam0)//Position - 0x2EB5
{
	float fVar0;
	float fVar1;
...
int func_88(int iParam0)//Position - 0x2EF4
{
	var uVar0;
...
void func_91()//Position - 0x2F48
{
	Global_19671 = 0;
	func_92();
}

void func_92()//Position - 0x2F58
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_93()//Position - 0x2F79
{
	return 0;
}

void func_94()//Position - 0x2F82
{
}

int func_95()//Position - 0x2F8A
{
	return 1;
}

float func_96(int iParam0, int iParam1)//Position - 0x2F93
{
	return func_84(iParam0, iParam1, 1);
}

void func_97(int iParam0)//Position - 0x2FA4
{
	int iVar0;
...
int func_98(int iParam0)//Position - 0x2FD5
{
	int iVar0;
	int iVar1;
...
int func_99(int iParam0, bool bParam1)//Position - 0x3006
{
	if (!func_77(iParam0))
	{
		if (!bParam1)
...
void func_100(var uParam0, var uParam1)//Position - 0x30B9
{
	*uParam0 = (*uParam0 || uParam1);
}

void func_101(int iParam0, bool bParam1)//Position - 0x30CA
{
	if (iParam0 == 1)
	{
		TASK::TASK_PLAY_ANIM(iLocal_240, &cLocal_324, &Local_218, 2f, -2f, -1, 0, 0, 0, 0, 0);
...
int func_102(int iParam0)//Position - 0x313C
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_103()//Position - 0x315D
{
	func_104();
}

void func_104()//Position - 0x3169
{
}

void func_105()//Position - 0x3171
{
...
int func_106(int iParam0)//Position - 0x3249
{
...
int func_110()//Position - 0x32CE
{
	return 1;
}

bool func_111(var uParam0)//Position - 0x32D7
{
	return func_112(Global_111560.f_20112, uParam0);
}

bool func_112(var uParam0, var uParam1)//Position - 0x32EC
{
	return (uParam0 && uParam1) != 0;
}

int func_113(int iParam0)//Position - 0x32FB
{
...
void func_114(int iParam0)//Position - 0x3422
{
	var uVar0;
...
void func_115(int iParam0)//Position - 0x34F1
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
struct<6> func_116()//Position - 0x3511
{
	struct<6> Var0;
...
void func_118()//Position - 0x3541
{
}

void func_119()//Position - 0x3549
{
	if (iLocal_245 == -1)
	{
