...
var func_54(int iParam0)//Position - 0x17BF
{
	return Global_1798[iParam0 /*29*/];
}

bool func_55(int iParam0)//Position - 0x17CE
{
	return iParam0 < 3;
}

void func_56()//Position - 0x17DA
{
	func_48(0, &uLocal_88);
	if (func_8(iLocal_81))
	{
...
void func_57(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x18BF
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_58(int iParam0, bool bParam1)//Position - 0x190F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
