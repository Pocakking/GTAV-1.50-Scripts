...
void __EntryFunction__()//Position - 0x0
{
	...
	uLocal_54 = HUD::_GET_LEVEL_BLIP_SPRITE();
	iLocal_55 = HUD::_GET_WAYPOINT_BLIP_SPRITE();
	iLocal_268 = -1;
	fLocal_270 = 1f;
	iLocal_383 = 100;
	iLocal_384 = 3;
							...
							if (!PED::IS_PED_INJURED(iLocal_1057))
							{
								...
								if (iLocal_1044 == 1)
								{
									if (ENTITY::DOES_ENTITY_EXIST(iLocal_1314))
									{
										...
										{
											TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_1057, iLocal_1314, iLocal_1314, 2f, 0, 1056964608, 1082130432, 1, 0, -957453492);
										}
									}
								...
								else if (iLocal_1044 == 8)
								{
									...
									{
										TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_1057, iLocal_1312, iLocal_1312, 2f, 0, 1056964608, 1082130432, 1, 0, -957453492);
									}
...
bool func_10(int iParam0)//Position - 0xCA0
{
	return func_11(iParam0, 20);
}

bool func_11(int iParam0, int iParam1)//Position - 0xCB0
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_12()//Position - 0xCCB
{
	return -1;
}

void func_13()//Position - 0xCD4
{
	int iVar0;
...
int func_18()//Position - 0xEFC
{
	func_19();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_19()//Position - 0xF15
{
	int iVar0;
...
bool func_20(int iParam0)//Position - 0x1012
{
	return iParam0 < 3;
}
...
int func_22(int iParam0)//Position - 0x105B
{
	if (func_20(iParam0))
	{
...
var func_23(int iParam0)//Position - 0x1080
{
	return Global_1798[iParam0 /*29*/];
}

bool func_24(int iParam0)//Position - 0x108F
{
	return Global_41396 == iParam0;
}

void func_25()//Position - 0x109D
{
	int iVar0;
...
bool func_26(int iParam0, int iParam1)//Position - 0x10F4
{
	switch (iParam0)
	{
		case 5:
...
void func_27(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x112F
{
...
float func_29(int iParam0, bool bParam1)//Position - 0x11A7
{
	return func_30(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), iParam0, bParam1);
}

float func_30(int iParam0, int iParam1, bool bParam2)//Position - 0x11BF
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_31(float fParam0)//Position - 0x121D
{
	int iVar0;
...
float func_32(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x12AA
{
	if (ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
		return -1f;
...
int func_33(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x12D4
{
...
void func_34(int iParam0, int iParam1, char* sParam2)//Position - 0x1328
{
...
void func_35(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1349
{
...
int func_36(int iParam0, bool bParam1)//Position - 0x13E4
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 2)
	{
		if (!PED::IS_PED_INJURED(iLocal_1050[iVar0]))
		{
			if (bParam1 || (!bParam1 && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_1050[iVar0], 0)))
			{
	...
	while (iVar0 <= 1)
	{
		if (!PED::IS_PED_INJURED(iLocal_1054[iVar0]))
		{
			if (bParam1 || (!bParam1 && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_1054[iVar0], 0)))
			{
...
void func_37(int iParam0)//Position - 0x151E
{
	char* sVar0;
...
void func_38(int iParam0)//Position - 0x1610
{
	int iVar0;
...
int func_39(int iParam0)//Position - 0x1655
{
	int iVar0;
	int iVar1;
...
void func_40(var uParam0, int iParam1)//Position - 0x176C
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_42(Global_111560.f_18528[iVar0], &vVar2, &fVar5))
			{
...
void func_41(var uParam0)//Position - 0x1935
{
	*uParam0 = -15;
}

int func_42(int iParam0, var uParam1, float fParam2)//Position - 0x1943
{
	switch (iParam0)
	{
		case 11:
...
void func_43(int iParam0, bool bParam1)//Position - 0x22B2
{
	if (bParam1)
	{
...
bool func_46(bool bParam0)//Position - 0x2410
{
...
void func_47(char* sParam0)//Position - 0x243B
{
	func_533(&(Global_111560.f_19958.f_1), 1024);
...
void func_48(char* sParam0)//Position - 0x2463
{
...
void func_49(vector3 vParam0, float fParam3)//Position - 0x24A2
{
...
bool func_50(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x24CE
{
	if (bParam6)
	{
...
float func_52(int iParam0)//Position - 0x2548
{
	if (func_58(iParam0))
	{
		if (func_54(iParam0))
...
float func_53(bool bParam0)//Position - 0x2587
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_54(var uParam0)//Position - 0x25DF
{
	return MISC::IS_BIT_SET(*uParam0, 2);
}

void func_55(int iParam0)//Position - 0x25EF
{
	if (!func_58(iParam0))
	{
		func_56(iParam0);
...
void func_56(int iParam0)//Position - 0x2607
{
	func_57(iParam0, 0f);
}

void func_57(int iParam0, float fParam1)//Position - 0x2616
{
...
bool func_58(int iParam0)//Position - 0x2644
{
	return MISC::IS_BIT_SET(*iParam0, 1);
}

void func_59()//Position - 0x2654
{
...
int func_60(int iParam0)//Position - 0x266B
{
	float fVar0;
	bool bVar1;
			...
			if (!PED::IS_PED_INJURED(iLocal_1046))
			{
				...
				else if (HUD::DOES_BLIP_EXIST(iLocal_1120))
				{
					if (func_30(iLocal_1045, iLocal_1046, 1) >= (fVar0 * 0.5f))
					{
						...
						{
							HUD::SET_BLIP_FLASHES(iLocal_1120, 1);
						}
					}
					else if (HUD::IS_BLIP_FLASHING(iLocal_1120))
					{
						HUD::SET_BLIP_FLASHES(iLocal_1120, 0);
					}
				}
			}
		}
...
void func_62(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x279D
{
	func_63(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_63(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x27B7
{
	func_64(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_64(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x27D4
{
	...
	uParam0->f_6 = 2;
	func_65(uParam0, iParam1, vParam2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

void func_65(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x280C
{
	int iVar0;
	int iVar1;
...
void func_66(var uParam0)//Position - 0x2B79
{
...
int func_67(var uParam0)//Position - 0x2BE2
{
	int iVar0;
...
int func_68(bool bParam0)//Position - 0x2C0D
{
	switch (Global_41396)
	{
		case 0:
...
void func_69(char[4] cParam0, int iParam1)//Position - 0x2CB7
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_70(char* sParam0)//Position - 0x2CCE
{
	if (!func_71(1, 1, 0))
	{
...
int func_71(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2D67
{
	int iVar0;
	int iVar1;
...
int func_72(int iParam0)//Position - 0x2FC0
{
	if (iParam0 != func_12())
	{
...
int func_73(int iParam0, bool bParam1, bool bParam2)//Position - 0x3026
{
	int iVar0;
...
int func_74(int iParam0, int iParam1)//Position - 0x3070
{
...
int func_75(int iParam0, int iParam1)//Position - 0x30D2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_76()//Position - 0x3157
{
	return Global_2448961.f_17;
}

bool func_77(int iParam0)//Position - 0x3165
{
	return iParam0 == 51;
}

var func_78()//Position - 0x3172
{
	return Global_2448961.f_16;
}

bool func_79()//Position - 0x3180
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

int func_80(int iParam0)//Position - 0x3195
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
void func_81(var uParam0, int iParam1, vector3 vParam2, int iParam5)//Position - 0x31EF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_82()//Position - 0x32FF
{
	return func_83(PLAYER::PLAYER_ID());
}

int func_83(int iParam0)//Position - 0x330F
{
...
int func_84(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x332E
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_85(bool bParam0, bool bParam1, bool bParam2)//Position - 0x369A
{
...
int func_86(bool bParam0, bool bParam1, bool bParam2)//Position - 0x36EC
{
	if (!func_71(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_87(bool bParam0, bool bParam1, bool bParam2)//Position - 0x3735
{
	if (!func_71(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_88(bool bParam0, bool bParam1, bool bParam2)//Position - 0x3794
{
	if (!func_71(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_89(int iParam0)//Position - 0x37EA
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_90()//Position - 0x3845
{
	MISC::SET_BIT(&Global_7357, 4);
}

int func_91(char* sParam0)//Position - 0x3855
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_92(var uParam0, int iParam1, int iParam2)//Position - 0x3868
{
	char* sVar0;
...
void func_93(var uParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x3945
{
	float fVar0;
...
void func_94(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17)//Position - 0x3A84
{
	int iVar0;
	int iVar1;
...
void func_95(int iParam0, int iParam1)//Position - 0x3BE1
{
	MISC::SET_BIT(&(Global_1375006.f_6184[iParam0]), iParam1);
}

bool func_96(int iParam0, int iParam1)//Position - 0x3BFA
{
	return MISC::IS_BIT_SET(Global_1375006.f_6184[iParam0], iParam1);
}

void func_97()//Position - 0x3C13
{
	int iVar0;
	...
	switch (iLocal_1207)
	{
		case 0:
			if (!func_28())
			{
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_1050[0], 0))
				{
					TASK::TASK_CLEAR_LOOK_AT(iLocal_1050[0]);
				}
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_1050[1], 0))
				{
...
int func_98()//Position - 0x3E5D
{
	...
	while (iVar0 < 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_1050[iVar0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_1050[iVar0], 0))
		{
			PED::SET_PED_RESET_FLAG(iLocal_1050[iVar0], 85, 1);
	...
	while (iVar0 < 2)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_1054[iVar0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_1054[iVar0], 0))
		{
			PED::SET_PED_RESET_FLAG(iLocal_1054[iVar0], 85, 1);
...
int func_99(int iParam0)//Position - 0x3F68
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_100(int iParam0)//Position - 0x3FE0
{
	if (!bLocal_1181)
	{
...
int func_103(int iParam0)//Position - 0x4142
{
	int iVar0;
	float fVar1;
	int iVar2;
...
int func_106(int iParam0)//Position - 0x4477
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
int func_107(int iParam0)//Position - 0x44B1
{
	int iVar0;
	int iVar1;
...
int func_108(int iParam0)//Position - 0x457F
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1312, 0))
	{
...
void func_110(int iParam0)//Position - 0x484A
{
	int iVar0;
	vector3 vVar1;
	float fVar4;
	...
	switch (iLocal_1037[iParam0])
	{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1313, 0))
			{
				if (func_134())
				{
					if (!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_1313))
					{
						...
						{
							TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iLocal_1054[iParam0], iLocal_1313, "OJASva_104", 948, 0, 16, 18, 6f, 0, 1073741824);
						}
					}
		...
		case 2:
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1313, 0))
			{
				if (!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_1313))
				{
					vVar1 = { ENTITY::GET_ENTITY_COORDS(iLocal_1313, 1) };
		...
		case 3:
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1313, 0))
			{
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_1054[iParam0], 0))
				{
					if (PED::IS_PED_IN_VEHICLE(iLocal_1054[iParam0], iLocal_1313, 0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1312, 0))
					{
						if (!iLocal_1134)
						{
							if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1313, -1, 0) == iLocal_1054[iParam0])
		...
		case 6:
			if (bLocal_1159)
			{
				...
				{
					TASK::TASK_PERFORM_SEQUENCE(iLocal_1054[iParam0], uLocal_1324);
				}
		...
		case 7:
			if (!PED::IS_PED_INJURED(iLocal_1054[iParam0]))
			{
				...
				{
					TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_1054[iParam0], iLocal_1045, iLocal_1045, 1f, 0, -1f, 1082130432, 1, 0, -957453492);
				}
			}
			break;
...
void func_111(int iParam0, int iParam1)//Position - 0x4F02
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (PED::IS_PED_INJURED(iParam0))
...
void func_112(var uParam0, int iParam1)//Position - 0x4F2B
{
	func_113(uParam0, iParam1);
}

void func_113(var uParam0, var uParam1)//Position - 0x4F3B
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

int func_114(int iParam0, float fParam1)//Position - 0x4F50
{
	if (!iLocal_1134)
	{
		if (!func_99(iLocal_1045))
...
void func_116(vector3 vParam0, float fParam3, float fParam4)//Position - 0x5081
{
	int iVar0;
	float fVar1;
...
int func_117(int iParam0)//Position - 0x5188
{
	int iVar0;
	float fVar1;
...
int func_118(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)//Position - 0x520A
{
	int iVar0;
	bool bVar1;
...
int func_119(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)//Position - 0x5334
{
	int iVar0;
	int iVar1;
...
int func_120(int iParam0, int iParam1)//Position - 0x5506
{
	int iVar0;
...
int func_121(int iParam0, int iParam1, var uParam2)//Position - 0x555B
{
...
int func_122(int iParam0, int iParam1, var uParam2, bool bParam3)//Position - 0x55A9
{
	vector3 vVar0;
	int iVar3;
...
int func_123(int iParam0, var uParam1)//Position - 0x5722
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
bool func_124(var uParam0, int iParam1)//Position - 0x57A7
{
	return (uParam0 && iParam1) != 0;
}

void func_125(int iParam0, int iParam1, float fParam2, float fParam3, float fParam4)//Position - 0x57B6
{
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (func_30(iParam1, iParam0, 0) > fParam2 && func_29(iParam1, 1) < fParam3)
				{
					if (!PED::IS_PED_IN_VEHICLE(iParam1, iParam0, 0))
					{
						...
						{
							TASK::TASK_ENTER_VEHICLE(iParam1, iParam0, 20000, -1, 1073741824, 1, 0);
						}
					}
...
void func_126(int iParam0)//Position - 0x591D
{
	var uVar0;
...
void func_127(int iParam0)//Position - 0x5982
{
...
Vector3 func_128()//Position - 0x5A27
{
	vector3 vVar0;
	int iVar3;
...
void func_129(int iParam0, vector3 vParam1)//Position - 0x5A9B
{
	if (!iLocal_1134)
	{
		if (!PED::IS_PED_INJURED(iParam0))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_1045, iParam0, vParam1, 0, 1, 0))
			{
...
void func_130(int iParam0)//Position - 0x5B41
{
	var uVar0;
	vector3 vVar1;
...
int func_132()//Position - 0x5C99
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			vVar3 = { ENTITY::GET_ENTITY_COORDS(iLocal_1312, 1) };
		}
...
void func_133(int iParam0)//Position - 0x5CF0
{
	int iVar0;
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_1054[iParam0], 0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1313, 0))
		{
			if (!PED::IS_PED_IN_VEHICLE(iLocal_1054[iParam0], iLocal_1313, 0))
			{
				if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_1054[iParam0], -1794415470) != 1)
				{
					TASK::TASK_ENTER_VEHICLE(iLocal_1054[iParam0], iLocal_1313, 20000, iVar0, 1073741824, 1, 0);
				}
			}
		}
	}
...
int func_134()//Position - 0x5D6D
{
	if (!PED::IS_PED_INJURED(iLocal_1054[0]) && !PED::IS_PED_INJURED(iLocal_1054[1]))
	{
		if (PED::IS_PED_IN_VEHICLE(iLocal_1054[0], iLocal_1313, 0) && PED::IS_PED_IN_VEHICLE(iLocal_1054[1], iLocal_1313, 0))
		{
			return 1;
		}
	}
...
void func_135(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x5DBC
{
	if (!iLocal_1134)
	{
		if (MISC::IS_PROJECTILE_TYPE_IN_ANGLED_AREA(vParam0, vParam3, fParam6, joaat("weapon_stickybomb"), 0))
		{
			iLocal_1134 = 1;
		}
	}
...
void func_136(int iParam0)//Position - 0x5DE6
{
	int iVar0;
	float fVar1;
	int iVar2;
	...
	switch (iLocal_1033[iParam0])
	{
		case 0:
			if (!PED::IS_PED_INJURED(iVar0))
			{
				TASK::CLEAR_SEQUENCE_TASK(&uLocal_1324);
				TASK::OPEN_SEQUENCE_TASK(&uLocal_1324);
				TASK::TASK_GO_TO_COORD_ANY_MEANS(0, vLocal_1268[iParam0 /*3*/], 1f, 0, 0, 786603, -1082130432);
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				if (!ENTITY::IS_ENTITY_DEAD(iVar0, 0))
				{
					if (!bLocal_1169)
					{
						...
						{
							if (ENTITY::IS_ENTITY_AT_COORD(iVar0, vLocal_1268[iParam0 /*3*/], 3f, 3f, 3f, 0, 1, 0))
							{
			...
			if (!iLocal_1134)
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1312, 0))
				{
					if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1312, -1, 0) == iVar0)
					{
						if (!PED::IS_PED_INJURED(iVar0))
						{
							VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_1312, true, 1, 0);
							if (func_138())
							{
							...
							{
								TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iVar0, iLocal_1312, "OJASva_101", 181, 0, 0, -1, -1082130432, 0, 1073741824);
							}
						}
					}
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1312, 0))
				{
					if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1312, -1, 0) == iVar0)
					{
						if (!ENTITY::IS_ENTITY_DEAD(iVar0, 0))
						{
							if (TASK::GET_SCRIPT_TASK_STATUS(iVar0, -1273030092) != 1)
							{
								TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iVar0, iLocal_1312, vLocal_1290, 8, 25f, 786603, -1f, -1f, 1);
							}
						}
					}
				}
		...
		case 8:
			if (bLocal_1159)
			{
				...
				TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_COORD(0, PLAYER::PLAYER_PED_ID(), func_128(), 1f, 0, 1056964608, 1082130432, 1, 0, -957453492);
				TASK::CLOSE_SEQUENCE_TASK(uLocal_1324);
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_1050[iParam0], 0))
				{
					TASK::TASK_PERFORM_SEQUENCE(iLocal_1050[iParam0], uLocal_1324);
				}
				TASK::CLEAR_SEQUENCE_TASK(&uLocal_1324);
			}
			else
		...
		case 9:
			if (!PED::IS_PED_INJURED(iLocal_1050[iParam0]))
			{
				...
				{
					TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_1050[iParam0], iLocal_1045, iLocal_1045, 1f, 0, -1f, 1082130432, 1, 0, -957453492);
				}
			}
			break;
...
int func_137(int iParam0)//Position - 0x6722
{
	int iVar0;
...
int func_139(int iParam0)//Position - 0x683B
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_142(int iParam0)//Position - 0x68F3
{
	switch (iLocal_1208)
	{
		case 0:
...
void func_143(int iParam0)//Position - 0x6967
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
void func_144(int iParam0, var uParam1, bool bParam2)//Position - 0x6A04
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
		if (bParam2)
...
void func_145(int iParam0, var uParam1)//Position - 0x6A23
{
	int iVar0;
...
int func_146(int iParam0, int iParam1, int iParam2)//Position - 0x6AF8
{
	int iVar0;
	int iVar1;
...
void func_147(int iParam0)//Position - 0x6B40
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	switch (iLocal_1041[iParam0])
	{
		...
		case 3:
			...
			{
				PED::SET_PED_SPHERE_DEFENSIVE_AREA(iLocal_1047[iParam0], vLocal_1305, 15f, 0, 0);
				...
				else
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_1312) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1312, 0))
					{
						...
						vVar7 = { ENTITY::GET_ENTITY_COORDS(iLocal_1312, 1) };
						vVar7 = { vVar4 - vVar7 };
						PED::SET_PED_DEFENSIVE_SPHERE_ATTACHED_TO_VEHICLE(iLocal_1047[iParam0], iLocal_1312, vVar7, 1.5f, 0);
					}
					TASK::OPEN_SEQUENCE_TASK(&uLocal_1324);
					TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
					if (PED::IS_PED_INJURED(iLocal_1046) && !func_50(func_148(), vVar4, 0))
					{
						TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, vVar4, func_128(), 2f, 0, 1056964608, 1082130432, 1, 0, 0, -957453492);
...
Vector3 func_148()//Position - 0x72C6
{
	vector3 vVar0;
...
int func_149(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x72D2
{
	if (iParam3 == 0)
	{
...
void func_150()//Position - 0x74A9
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_1046))
	{
		vLocal_1305 = { ENTITY::GET_ENTITY_COORDS(iLocal_1046, 0) };
	}
	switch (iLocal_1040)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_1046, 0))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1312, 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_1050[0], 0))
				{
					if (!PED::IS_PED_IN_VEHICLE(iLocal_1046, iLocal_1312, 0))
					{
...
int func_153(int iParam0)//Position - 0x7928
{
	var uVar0;
	...
	switch (iLocal_1031)
	{
		...
		case 6:
			...
			if (bLocal_1142)
			{
				...
				{
					func_57(&iLocal_1336, Global_111560.f_19958.f_5);
				}
				iLocal_1209 = func_519();
				if (Global_92876)
				{
...
void func_155()//Position - 0x7BF9
{
	PLAYER::CLEAR_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID());
	func_156();
}

void func_156()//Position - 0x7C0D
{
	func_252();
	switch (iLocal_1215)
	{
		case 0:
			if (!iLocal_377)
			{
				...
				Global_111560.f_19958.f_5 = func_52(&iLocal_1336);
				fLocal_372 = Global_111560.f_19958.f_5;
				func_244();
				iLocal_377 = 1;
				iLocal_1215 = 1;
			}
...
void func_157()//Position - 0x7D80
{
	func_158();
}

int func_158()//Position - 0x7D8D
{
	if (func_46(0))
	{
		return 0;
...
void func_159(bool bParam0, int iParam1)//Position - 0x7DD8
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_160(int iParam0)//Position - 0x7EAE
{
	switch (iParam0)
	{
		case 71:
...
void func_161(struct<25> Param0, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38)//Position - 0x7EEC
{
	float fVar0;
...
void func_162(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x7F37
{
	int iVar0;
	int iVar1;
...
int func_163(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x800B
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_164(bool bParam0)//Position - 0x860A
{
	int iVar0;
	int iVar1;
...
void func_165(int iParam0)//Position - 0x888C
{
	int iVar0;
...
void func_166(int iParam0)//Position - 0x88E6
{
	bool bVar0;
	char cVar1[64];
...
char* func_167(int iParam0)//Position - 0x8A76
{
	switch (iParam0)
	{
		case 0:
...
void func_169(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x8B7F
{
	int iVar0;
...
int func_170(var uParam0)//Position - 0x8BAF
{
	int iVar0;
	int iVar1;
...
int func_171()//Position - 0x8BE3
{
	return Global_1312745;
}

int func_172(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x8BEF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_173(int iParam0)//Position - 0x9241
{
	func_195(93, iParam0);
	func_195(29, iParam0);
	func_195(30, iParam0);
...
bool func_174(int iParam0)//Position - 0x9261
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_175(int iParam0, int iParam1, int iParam2)//Position - 0x9411
{
	int iVar0;
	var uVar1;
...
int func_176(int iParam0, int iParam1, int iParam2)//Position - 0x9443
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_177(int iParam0)//Position - 0x9480
{
	int iVar0;
...
int func_178(int iParam0, int iParam1)//Position - 0x981C
{
	int iVar0;
...
int func_179(bool bParam0)//Position - 0x9B95
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_180(int iParam0, int iParam1)//Position - 0x9C4C
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_181(int iParam0, int iParam1)//Position - 0x9C67
{
...
int func_182(var uParam0, int iParam1)//Position - 0x9D04
{
	int iVar0;
	var uVar1[78];
...
int func_183(var uParam0, int iParam1)//Position - 0x9DB5
{
	int iVar0;
...
bool func_184(var uParam0, int iParam1)//Position - 0x9E30
{
	return (*uParam0)[iParam1] == 78;
}

void func_185(var uParam0)//Position - 0x9E41
{
	int iVar0;
...
void func_186(var uParam0, int iParam1)//Position - 0x9E75
{
	(*uParam0)[iParam1] = 78;
}

void func_187(var uParam0, float fParam1)//Position - 0x9E85
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_188(var uParam0)//Position - 0x9EA2
{
	return uParam0->f_80;
}

bool func_189(var uParam0, int iParam1)//Position - 0x9EAE
{
	return func_190(uParam0, iParam1) != -1;
}

int func_190(var uParam0, int iParam1)//Position - 0x9EC0
{
	int iVar0;
...
bool func_191(var uParam0)//Position - 0x9EED
{
	return uParam0->f_79 == 1;
}

int func_192(int iParam0)//Position - 0x9EFB
{
	switch (iParam0)
	{
		case 60:
...
int func_193(int iParam0, int iParam1)//Position - 0x9F4B
{
	int iVar0;
...
void func_194(int iParam0, int iParam1)//Position - 0x9F9C
{
	int iVar0;
...
void func_195(int iParam0, int iParam1)//Position - 0x9FBF
{
	int iVar0;
...
int func_197(int iParam0)//Position - 0xA091
{
	return Global_1798[iParam0 /*29*/].f_17;
}

float func_198()//Position - 0xA0A2
{
	float fVar0;
...
void func_199()//Position - 0xA1BB
{
	func_533(&(Global_111560.f_19958.f_1), 2048);
}

void func_200(var uParam0)//Position - 0xA1D3
{
	if (uParam0->f_1 != 0)
	{
...
void func_201(int iParam0)//Position - 0xA27A
{
	Global_76837 = iParam0;
	Global_76838 = iParam0;
}

void func_202(var uParam0)//Position - 0xA28E
{
...
void func_203(var uParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)//Position - 0xA2C1
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void func_204(var uParam0, int iParam1)//Position - 0xA581
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
}

void func_205(var uParam0, int iParam1)//Position - 0xA596
{
	*uParam0 = (*uParam0 || iParam1);
}

float func_206(bool bParam0, float fParam1, float fParam2)//Position - 0xA5A7
{
	if (bParam0)
	{
		return fParam1;
...
void func_207(char* sParam0)//Position - 0xA5BE
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}

void func_208(char* sParam0)//Position - 0xA5D0
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
}

bool func_209(var uParam0, int iParam1)//Position - 0xA5DE
{
	return (uParam0 && iParam1) != 0;
}

int func_210(var uParam0)//Position - 0xA5ED
{
	if (*uParam0 != 0)
	{
...
int func_211(var uParam0, bool bParam1, float fParam2, bool bParam3, int iParam4, bool bParam5)//Position - 0xA614
{
	bool bVar0;
...
void func_212(var uParam0, bool bParam1)//Position - 0xAC6D
{
...
float func_213(float fParam0, float fParam1, float fParam2)//Position - 0xAD31
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
void func_214(var uParam0, float fParam1, bool bParam2)//Position - 0xAD58
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float func_215(float fParam0)//Position - 0xB9E9
{
	return (fParam0 * 0.00078125f);
}

void func_216(char* sParam0, float fParam1, float fParam2, int iParam3, bool bParam4, int iParam5)//Position - 0xB9F9
{
...
int func_217(int iParam0, bool bParam1, bool bParam2, float fParam3, float fParam4, bool bParam5)//Position - 0xBA36
{
	char cVar0[64];
	char cVar16[64];
	int iVar32;
	...
	if (MISC::GET_HASH_KEY(&cVar16) != 0)
	{
		...
		vVar37.y = (vVar37.y * (func_218(iParam0) / fVar34));
		if (!bParam2)
		{
...
float func_218(int iParam0)//Position - 0xBBE7
{
	switch (iParam0)
	{
		case 33:
...
var func_220(int iParam0, bool bParam1)//Position - 0xBCED
{
	char* sVar0[2];
	var uVar3;
	struct<13> Var19;
...
var func_221(var uParam0)//Position - 0xC216
{
	return uParam0;
}

struct<13> func_222(int iParam0)//Position - 0xC220
{
	struct<13> Var0;
...
char* func_223(int iParam0)//Position - 0xC237
{
	var uVar0;
	struct<13> Var16;
...
void func_224(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5)//Position - 0xC2AC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_225(int iParam0, int iParam1, float fParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xC537
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float func_226(float fParam0)//Position - 0xC8BF
{
	return (fParam0 * 0.025f);
}

float func_227(float fParam0)//Position - 0xC8CF
{
	return (fParam0 * 0.0009259259f);
}

float func_228(char* sParam0)//Position - 0xC8DF
{
	HUD::_BEGIN_TEXT_COMMAND_GET_WIDTH(sParam0);
	return (HUD::_END_TEXT_COMMAND_GET_WIDTH(1) / 2f);
}

void func_229()//Position - 0xC8F4
{
...
void func_230(char* sParam0)//Position - 0xC91C
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
}

float func_231()//Position - 0xC92A
{
	float fVar0;
...
float func_232(float fParam0)//Position - 0xC93E
{
	return (fParam0 * 0.001388889f);
}

void func_233(int iParam0)//Position - 0xC94E
{
	if (func_237())
	{
		return;
...
void func_234(int iParam0)//Position - 0xC981
{
	if (func_237())
	{
		return;
...
void func_235(bool bParam0, bool bParam1)//Position - 0xCA0B
{
	if (bParam0)
	{
		if (func_80(0))
...
bool func_236()//Position - 0xCA7F
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

bool func_237()//Position - 0xCA90
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

int func_238(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xCAA2
{
	int iVar0;
	int iVar1;
...
void func_239(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xCB6B
{
	if (*uParam0 == 0)
	{
...
int func_240(var uParam0, bool bParam1, int iParam2)//Position - 0xCBE5
{
...
void func_241(var uParam0)//Position - 0xCD84
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "CLEAR_ALL");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	if (MISC::IS_PC_VERSION())
...
void func_242(var uParam0)//Position - 0xCE49
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_243(var uParam0)//Position - 0xCF51
{
	uParam0->f_547 = 1f;
	uParam0->f_546 = 0;
	uParam0->f_568 = 0f;
...
void func_244()//Position - 0xCFD0
{
	...
	if (!iLocal_377)
	{
		func_250(&uLocal_388, &Local_965, &Global_61486, 0);
...
void func_246(int iParam0, int iParam1, bool bParam2)//Position - 0xD48D
{
	int iVar0;
...
void func_247(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0xD537
{
...
void func_248()//Position - 0xD572
{
	Global_92875 = 0;
	Global_92876 = 0;
}

void func_249(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0xD584
{
	int iVar0;
...
void func_250(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xD5F7
{
...
void func_251()//Position - 0xD61A
{
	func_533(&(Global_111560.f_19958.f_1), 4194304);
}

void func_252()//Position - 0xD633
{
	int iVar0;
...
void func_256(int iParam0)//Position - 0xD914
{
	bool bVar0;
	struct<8> Var1;
...
int func_257(int iParam0, var uParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0xD986
{
	if (!*iParam0)
	{
...
void func_258(char* sParam0, int iParam1, int iParam2)//Position - 0xD9B3
{
	iParam2 = iParam2;
...
void func_260()//Position - 0xDAF2
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_1313))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_1313, 0))
		{
			...
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_1054[0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_1054[0], 0))
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_1313, 0))
					{
						if (PED::IS_PED_IN_VEHICLE(iLocal_1054[0], iLocal_1313, 0))
						{
							TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_1054[0]);
						}
					}
				}
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_1054[1]) && !ENTITY::IS_ENTITY_DEAD(iLocal_1054[1], 0))
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_1313, 0))
					{
						if (PED::IS_PED_IN_VEHICLE(iLocal_1054[1], iLocal_1313, 0))
						{
...
void func_261(bool bParam0)//Position - 0xDC78
{
	int iVar0;
...
void func_262()//Position - 0xDD17
{
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_1293, vLocal_1296, fLocal_1243, 1, 0, 0))
	{
		bLocal_1152 = true;
	}
	else
...
void func_263()//Position - 0xDD83
{
	iLocal_1193 = 0;
}

void func_264()//Position - 0xDD8F
{
	if (!bLocal_1149)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_1312))
...
int func_265(int iParam0, int iParam1)//Position - 0xDDE2
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
...
int func_266(int iParam0, float fParam1)//Position - 0xDE32
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
float func_267(int iParam0, vector3 vParam1, bool bParam4)//Position - 0xDE64
{
	vector3 vVar0;
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1312, 0))
			{
				if (func_140())
				{
					if (!PED::IS_PED_INJURED(iLocal_1050[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1312, 0))
						{
							if (PED::IS_PED_IN_VEHICLE(iLocal_1050[0], iLocal_1312, 0))
							{
								bLocal_1145 = true;
								func_263();
								iLocal_1031 = 13;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_1046))
	{
		if (PED::IS_PED_INJURED(iLocal_1046))
		{
			if (ENTITY::IS_ENTITY_DEAD(iLocal_1046, 0))
			{
				...
				func_116(vLocal_1305, 1097859072, 1116471296);
			}
...
void func_273(int iParam0)//Position - 0xE012
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_274(int iParam0)//Position - 0xE03D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_OCCLUDED(*iParam0))
...
void func_275()//Position - 0xE05F
{
	...
	{
		vVar7 = { ENTITY::GET_ENTITY_COORDS(iLocal_1046, 1) };
	...
	while (iVar11 < 2)
	{
		if (iVar11 == 0)
		{
			iLocal_1047[iVar11] = PED::CREATE_PED(26, iLocal_1327, vVar0[0 /*3*/], vVar0[0 /*3*/].f_1, 38.3253f, uLocal_1239[iLocal_1202], 1, true);
		}
		else
		{
			iLocal_1047[iVar11] = PED::CREATE_PED(26, iLocal_1328, vVar0[1 /*3*/], vVar0[1 /*3*/].f_1, 38.3253f, uLocal_1239[iLocal_1202], 1, true);
		}
...
void func_276(int iParam0, bool bParam1)//Position - 0xE1B4
{
...
void func_277()//Position - 0xE220
{
	func_279();
	iLocal_1202 = MISC::GET_RANDOM_INT_IN_RANGE(0, iLocal_1195);
	iLocal_1046 = PED::CREATE_PED(26, iLocal_1325, vLocal_1258[iLocal_1202 /*3*/], uLocal_1239[iLocal_1202], 1, true);
...
int func_278(int iParam0, bool bParam1, bool bParam2)//Position - 0xE295
{
	int iVar0;
...
float func_281(vector3 vParam0, bool bParam3)//Position - 0xE4EB
{
	return func_32(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), vParam0, bParam3);
}

int func_282()//Position - 0xE505
{
...
int func_283(int iParam0, float fParam1)//Position - 0xE533
{
...
int func_286()//Position - 0xE5E2
{
	...
	{
		if (PED::IS_PED_IN_VEHICLE(iLocal_1050[0], iLocal_1312, 0) && PED::IS_PED_IN_VEHICLE(iLocal_1050[1], iLocal_1312, 0))
		{
			return 1;
		}
	}
...
void func_288()//Position - 0xE67B
{
	switch (iLocal_1193)
	{
		case 0:
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1312, 0))
			{
				VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_1312, false, 1, 0);
			}
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
...
void func_289()//Position - 0xE78C
{
	iLocal_1044 = 1;
	bLocal_1139 = true;
}

int func_290(var uParam0, int iParam1)//Position - 0xE79C
{
...
int func_291(var uParam0)//Position - 0xE7E1
{
	vector3 vVar0;
	...
	*uParam0 = VEHICLE::GET_CLOSEST_VEHICLE(-1221.954f, -210.746f, 38.638f, 27f, 0, 4);
	...
	if (iLocal_1319 != 0)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_1319) && !ENTITY::IS_ENTITY_DEAD(iLocal_1319, 0))
		{
			...
			{
				vVar0 = { ENTITY::GET_ENTITY_COORDS(iLocal_1319, 1) };
				return 1;
			}
		}
	}
...
void func_292()//Position - 0xE8AC
{
	...
	while (iVar1 < 3)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_1050[iVar1]))
		{
			...
			iLocal_1050[iVar1] = PED::CREATE_PED(26, iVar0, vLocal_1268[iVar1 /*3*/], fLocal_1221[iVar1], 1, true);
			if (iVar1 == 0)
			{
		...
		if (!PED::IS_PED_INJURED(iLocal_1050[iVar1]))
		{
			...
			PED::SET_PED_KEEP_TASK(iLocal_1050[iVar1], 1);
			PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_1050[iVar1], 23, 1);
			PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_1050[iVar1], 30, 0);
...
void func_294()//Position - 0xEA88
{
	...
	while (iVar0 < 2)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_1054[iVar0]))
		{
			if (iVar0 == 0)
			{
				iLocal_1054[iVar0] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_1313, 26, iLocal_1327, -1, 1, true);
			}
			else if (iVar0 == 1)
			{
				iLocal_1054[iVar0] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_1313, 26, iLocal_1328, 0, 1, true);
			}
			func_276(iLocal_1054[iVar0], 1);
			PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_1054[iVar0], 3, 0);
			PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_1054[iVar0], 23, 1);
			PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_1054[iVar0], 30, 0);
			PED::SET_PED_TARGET_LOSS_RESPONSE(iLocal_1054[iVar0], 2);
			PED::SET_PED_KEEP_TASK(iLocal_1054[iVar0], 1);
		}
		iVar0++;
	}
}

void func_295()//Position - 0xEB3C
{
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_1313))
	{
		iLocal_1313 = VEHICLE::CREATE_VEHICLE(iLocal_1329, vLocal_1284, fLocal_1233, 1, 1, 0);
		VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(iLocal_1313, 0);
	}
}

void func_296(int iParam0)//Position - 0xEB6C
{
	func_297(&(Global_105109.f_2890), &Global_105109, iParam0, 1);
}

int func_297(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0xEB87
{
...
int func_298(int iParam0)//Position - 0xEBC7
{
	int iVar0;
...
void func_299(var uParam0, int iParam1, int iParam2)//Position - 0xEBF5
{
...
int func_300(int iParam0)//Position - 0xECD1
{
	int iVar0;
...
int func_301(int iParam0)//Position - 0xED13
{
	int iVar0;
...
int func_302(int iParam0, int iParam1, int iParam2)//Position - 0xED76
{
	int iVar0;
...
int func_303(int iParam0, int iParam1)//Position - 0xEE04
{
	struct<82> Var0;
...
void func_304(int iParam0, var uParam1, int iParam2)//Position - 0xEE46
{
	int iVar0;
...
void func_305(int iParam0, var uParam1)//Position - 0xF0A2
{
	int iVar0;
...
int func_306(int iParam0)//Position - 0xF34D
{
	switch (iParam0)
	{
		case 1:
...
int func_307(int iParam0, var uParam1, var uParam2)//Position - 0xF3FD
{
	int iVar0;
	int iVar1;
...
int func_308(int iParam0)//Position - 0xF5F0
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_309(var uParam0)//Position - 0xF610
{
	int iVar0;
...
void func_310(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xF6C0
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar10 = func_368(&(Global_98669.f_3));
				if (iVar10 > -1)
				{
...
void func_311(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0xF835
{
	func_312(&Global_105109, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_312(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0xF851
{
	int iVar0;
	int iVar1;
...
int func_313(var uParam0)//Position - 0x106DD
{
...
void func_314(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x106FF
{
	int iVar0;
...
int func_315(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x10787
{
	char* sVar0;
...
int func_316(int iParam0, int iParam1, bool bParam2)//Position - 0x108B6
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_317(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x10927
{
...
void func_318(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x109FF
{
	int iVar0;
	int iVar1;
...
int func_319(int iParam0, int iParam1)//Position - 0x10B9F
{
	var uVar0;
	var uVar1;
	
	uVar0 = Global_2576213[iParam0 /*3*/][func_170(iParam1)];
...
void func_320(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x10BCB
{
	int iVar0;
...
void func_321(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x11113
{
	int iVar0;
...
int func_322()//Position - 0x11354
{
	func_19();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_323(int iParam0, bool bParam1)//Position - 0x1136D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_324(int iParam0, var uParam1)//Position - 0x11460
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_326(Var11.f_1)) && iVar72 < 51)
			{
...
int func_325(int iParam0)//Position - 0x116E8
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_326(int iParam0)//Position - 0x11783
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
int func_327(int iParam0, int iParam1)//Position - 0x11915
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_328(int iParam0, var uParam1)//Position - 0x12486
{
	int iVar0;
	int iVar1;
...
int func_329(int iParam0)//Position - 0x124C1
{
	int iVar0;
...
void func_330(int iParam0)//Position - 0x12735
{
	int iVar0;
...
void func_331(var uParam0, int iParam1)//Position - 0x12771
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
...
int func_332(vector3 vParam0, char* sParam3, vector3 vParam4)//Position - 0x12CCC
{
	int iVar0;
	int iVar1;
...
bool func_333(int iParam0, var uParam1, var uParam2)//Position - 0x12D10
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
int func_334(var uParam0)//Position - 0x1342B
{
...
bool func_335(int iParam0)//Position - 0x13486
{
	return func_336(iParam0, 0, 1);
}

int func_336(int iParam0, int iParam1, bool bParam2)//Position - 0x13496
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_337(int iParam0)//Position - 0x13500
{
	switch (iParam0)
	{
		case 0:
...
int func_338()//Position - 0x13830
{
	return Global_30736;
}

int func_339(int iParam0)//Position - 0x1383B
{
	return func_336(iParam0, 5, 1);
}

int func_340(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x1384B
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_341(int iParam0, bool bParam1)//Position - 0x138ED
{
	switch (iParam0)
	{
		case -1:
...
int func_342(int iParam0)//Position - 0x13F0A
{
	if (iParam0 != func_12())
	{
...
Vector3 func_343(int iParam0, int iParam1)//Position - 0x13F68
{
	vector3 vVar0;
	vector3 vVar6;
...
int func_344(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x14017
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
Vector3 func_345(vector3 vParam0, float fParam3)//Position - 0x140AC
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
struct<6> func_346(int iParam0)//Position - 0x140F0
{
	struct<6> Var0;
...
struct<6> func_347(int iParam0)//Position - 0x14274
{
	return func_348(iParam0);
}

struct<6> func_348(int iParam0)//Position - 0x14282
{
	struct<6> Var0;
...
int func_349(int iParam0, var uParam1)//Position - 0x14D49
{
	switch (iParam0)
	{
		case 0:
...
int func_350(int iParam0)//Position - 0x14DCB
{
	if (iParam0 != func_12())
	{
...
Vector3 func_351(int iParam0)//Position - 0x14E29
{
	switch (iParam0)
	{
		case 1:
...
int func_352()//Position - 0x15034
{
	return func_353(PLAYER::PLAYER_ID());
}

var func_353(int iParam0)//Position - 0x15044
{
	return MISC::GET_BITS_IN_RANGE(Global_2424073[iParam0 /*421*/].f_309.f_3, 28, 31);
}

int func_354(int iParam0)//Position - 0x15061
{
	return func_336(iParam0, 0, 0);
}

int func_355(int iParam0)//Position - 0x15071
{
	switch (iParam0)
	{
		case -1:
...
bool func_356()//Position - 0x1533F
{
	return Global_98721.f_345 > 0;
}

var func_357()//Position - 0x15350
{
	var uVar0;
...
void func_358(var uParam0, int iParam1)//Position - 0x15396
{
	if (iParam1 <= 0)
	{
		return;
...
void func_359(var uParam0, int iParam1)//Position - 0x1541C
{
...
void func_360(var uParam0, int iParam1)//Position - 0x1544F
{
	int iVar0;
	int iVar1;
...
int func_361(int iParam0, int iParam1)//Position - 0x154A0
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_362(int iParam0)//Position - 0x15542
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_363(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_363(bool bParam0, int iParam1, int iParam2)//Position - 0x15567
{
	if (bParam0)
	{
		return iParam1;
...
int func_364(var uParam0)//Position - 0x1557E
{
	return uParam0 & 15;
}

void func_365(var uParam0, int iParam1)//Position - 0x1558B
{
...
void func_366(var uParam0, int iParam1)//Position - 0x155C5
{
...
void func_367(var uParam0, int iParam1)//Position - 0x15600
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_368(char* sParam0)//Position - 0x1563C
{
...
struct<2> func_369(int iParam0)//Position - 0x15692
{
	struct<2> Var0;
...
int func_370(char* sParam0, int iParam1)//Position - 0x15ADE
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
void func_371(int iParam0, var uParam1)//Position - 0x15B27
{
	switch (iParam0)
	{
		case 0:
...
void func_372(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, var uParam22, int iParam23, int iParam24)//Position - 0x16CDC
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_373(int iParam0)//Position - 0x16D6D
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_374(int iParam0)//Position - 0x170B3
{
	struct<2> Var0;
	char[] cVar2[8];
...
int func_375(int iParam0)//Position - 0x170EA
{
	switch (iParam0)
	{
		case 69:
...
int func_376(int iParam0)//Position - 0x171A6
{
	switch (iParam0)
	{
		case 1:
...
int func_377(char* sParam0, bool bParam1)//Position - 0x171FA
{
	int iVar0;
	int iVar1;
...
int func_378(int iParam0, bool bParam1)//Position - 0x17224
{
	int iVar0;
...
void func_379()//Position - 0x1725A
{
	int iVar0;
...
void func_380()//Position - 0x17336
{
	switch (iLocal_1193)
	{
		case 0:
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_1312, 0))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1312, 0))
				{
					if (VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_1312) >= 7000f)
					{
						...
						while (iLocal_1192 < 3)
						{
							if (!ENTITY::IS_ENTITY_DEAD(iLocal_1050[iLocal_1192], 0))
							{
								if (iLocal_1192 == 0)
								{
									iVar0 = 1250;
								...
								if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_1050[iLocal_1192], 242628503) != 1)
								{
									...
									TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_1248[iLocal_1192 /*3*/], 1f, 20000, 1048576000, 0, 1193033728);
									TASK::CLOSE_SEQUENCE_TASK(uLocal_1324);
									TASK::TASK_PERFORM_SEQUENCE(iLocal_1050[iLocal_1192], uLocal_1324);
									TASK::CLEAR_SEQUENCE_TASK(&uLocal_1324);
								}
							}
							iLocal_1192++;
...
void func_382(bool bParam0)//Position - 0x1796A
{
	CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0);
	CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0, 1065353216);
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1312, 0))
	{
		...
		VEHICLE::REMOVE_VEHICLE_RECORDING(102, "ASSOJva");
		VEHICLE::REMOVE_VEHICLE_RECORDING(107, "ASSOJva");
		ENTITY::SET_ENTITY_COORDS(iLocal_1312, vLocal_1290, 1, 0, 0, 1);
...
void func_383()//Position - 0x17A13
{
...
int func_384(int iParam0)//Position - 0x17A32
{
...
void func_386(bool bParam0, bool bParam1, int iParam2)//Position - 0x17AA7
{
	if (bParam0)
	{
...
void func_387(int iParam0, bool bParam1)//Position - 0x17AE4
{
	if (bParam1)
	{
...
void func_388(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x17B06
{
	if (bParam0)
	{
...
bool func_389()//Position - 0x17C3F
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_390(int iParam0, int iParam1)//Position - 0x17C5C
{
	bool bVar0;
...
int func_391(int iParam0, bool bParam1)//Position - 0x17CA7
{
	int iVar0;
	int iVar1;
...
int func_392(int iParam0)//Position - 0x17CE8
{
...
bool func_393()//Position - 0x17D2A
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_394(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x17D3B
{
	int iVar0;
...
void func_395(int iParam0)//Position - 0x17D6E
{
	if (iParam0 == 1)
	{
...
void func_396()//Position - 0x17D91
{
...
void func_397(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x17E19
{
	func_398(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_398(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x17E43
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_399(vector3 vParam0)//Position - 0x18239
{
...
int func_400(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0x18263
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_401(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x18559
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_402(vector3 vParam0)//Position - 0x1860D
{
	float fVar0;
	float fVar1;
...
void func_403(int iParam0)//Position - 0x1864C
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
Vector3 func_404()//Position - 0x186B1
{
	return 2.55f, 5.665f, 2.55f;
}

void func_405()//Position - 0x186C8
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
		ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), vLocal_1302, 1, 0, 0, 1);
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_1315))
	{
		...
		{
			VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_1315, false, 1, 0);
...
int func_406()//Position - 0x18754
{
	iLocal_382 = MISC::GET_GAME_TIMER();
	return iLocal_382;
}

void func_407(int iParam0, int iParam1, int iParam2)//Position - 0x18766
{
...
void func_408()//Position - 0x187BE
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_1312))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1312, 0))
		{
			...
			while (iLocal_1192 < 3)
			{
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_1050[iLocal_1192]))
				{
					if (iLocal_1192 == 0)
					{
						iLocal_1050[iLocal_1192] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_1312, 26, iLocal_1327, -1, 1, true);
					...
					{
						iLocal_1050[iLocal_1192] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_1312, 26, iLocal_1327, 0, 1, true);
					...
					{
						iLocal_1050[iLocal_1192] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_1312, 26, iLocal_1328, 1, 1, true);
						PED::SET_PED_COMPONENT_VARIATION(iLocal_1050[iLocal_1192], 0, 1, 2, 0);
...
void func_409()//Position - 0x18957
{
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_1312))
	{
		iLocal_1312 = VEHICLE::CREATE_VEHICLE(iLocal_1326, vLocal_1287, fLocal_1219, 1, 1, 0);
...
void func_410(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x1899F
{
	func_398(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

int func_411(float fParam0, int iParam1)//Position - 0x189C8
{
	int iVar0;
...
int func_412(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x18A73
{
...
void func_413(int iParam0)//Position - 0x18C02
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_414()//Position - 0x18C2E
{
	int iVar0;
...
void func_415()//Position - 0x18DD2
{
	if (!iLocal_1132)
	{
...
void func_417()//Position - 0x18EB6
{
	STREAMING::REQUEST_MODEL(iLocal_1327);
	STREAMING::REQUEST_MODEL(iLocal_1328);
}

void func_418(int iParam0, char* sParam1)//Position - 0x18ECC
{
	if (PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
	{
		if (HUD::DOES_BLIP_EXIST(iParam0))
...
void func_419()//Position - 0x18EFD
{
	if (HUD::DOES_BLIP_EXIST(iLocal_1119))
	{
...
bool func_421(char* sParam0, int iParam1, char* sParam2)//Position - 0x18F43
{
...
void func_422(int iParam0, vector3 vParam1, float fParam4)//Position - 0x18F61
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
int func_423(vector3 vParam0, int iParam3)//Position - 0x18F8A
{
	int iVar0;
...
int func_424()//Position - 0x18FB6
{
	...
	if (func_425())
	{
		if (ENTITY::IS_ENTITY_AT_COORD(iLocal_1045, vLocal_1302, 25f, 25f, 90f, 1, 1, 0))
		{
			iVar1 = 1;
		}
	}
	if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
	{
		if ((fVar0 < 2f || ENTITY::IS_ENTITY_AT_COORD(iLocal_1045, vLocal_1302, 2f, 2f, 2f, 1, 1, 0)) || iVar1)
		{
...
void func_426()//Position - 0x1910C
{
	var uVar0;
	...
	switch (iLocal_1205)
	{
		...
		case 1:
			Local_1691[0] = PED::CREATE_PED(4, joaat("a_f_m_bevhills_01"), -1220.679f, -203.2689f, 38.3251f, 321.2841f, 1, true);
			Local_1691[1] = PED::CREATE_PED(4, joaat("a_f_m_bevhills_02"), -1219.596f, -201.3663f, 38.3251f, 110.7199f, 1, true);
			...
			TASK::CLEAR_SEQUENCE_TASK(&uVar0);
			Local_1691.f_4 = VEHICLE::CREATE_VEHICLE(joaat("taxi"), -1221.73f, -199.0665f, 38.1751f, 152.5038f, 1, 1, 0);
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_1691.f_4, 1084227584);
			Local_1691.f_3 = PED::CREATE_PED_INSIDE_VEHICLE(Local_1691.f_4, 4, joaat("a_m_y_hipster_01"), -1, 1, true);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1691.f_3, 1);
			TASK::TASK_LOOK_AT_ENTITY(Local_1691.f_3, Local_1691[0], -1, 0, 2);
			Local_1691.f_8[0] = PED::CREATE_PED(4, joaat("a_m_m_bevhills_01"), -1211.597f, -184.5331f, 38.3255f, 4.5193f, 1, true);
			Local_1691.f_8[1] = PED::CREATE_PED(4, joaat("a_m_y_hipster_01"), -1211.654f, -182.7625f, 38.3255f, 166.2532f, 1, true);
			...
			Local_1691.f_5[0] = PED::CREATE_PED(4, joaat("a_m_m_bevhills_01"), -1229.099f, -176.3197f, 38.3255f, 231.8036f, 1, true);
			Local_1691.f_5[1] = PED::CREATE_PED(4, joaat("a_f_m_bevhills_02"), -1249.779f, -162.4767f, 39.4131f, 220.1651f, 1, true);
...
void func_427()//Position - 0x194FB
{
	vector3 vVar0;
	...
	if (iLocal_1186)
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		{
			fLocal_1245 = SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_1302);
			iLocal_1186 = 0;
		}
	}
...
void func_428(int iParam0)//Position - 0x195D5
{
...
void func_429()//Position - 0x195FB
{
	var uVar0;
	float fVar1;
...
void func_430()//Position - 0x1981B
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_1058))
	{
...
int func_431(int iParam0, float fParam1)//Position - 0x19834
{
...
void func_432(int iParam0)//Position - 0x19852
{
	iParam0->f_1 = 0f;
	iParam0->f_2 = 0f;
	*iParam0 = 0;
...
int func_433(int iParam0, float fParam1)//Position - 0x19868
{
	if (func_58(iParam0))
	{
...
void func_434()//Position - 0x1988A
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_1058))
	{
...
void func_435()//Position - 0x198B4
{
...
void func_436(int iParam0, int iParam1, int iParam2)//Position - 0x198FB
{
...
void func_437(int iParam0)//Position - 0x199BF
{
	if (iParam0 == 1)
	{
...
bool func_438()//Position - 0x199E8
{
	return MISC::IS_BIT_SET(Global_98669.f_20, 13);
}

void func_439()//Position - 0x199FC
{
	while (iLocal_1205 < 2)
	{
		func_426();
...
void func_440()//Position - 0x19AA8
{
	func_436(0, -1, 1);
	CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0);
	CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0, 1065353216);
...
void func_441()//Position - 0x19AD1
{
	iLocal_1316[0] = VEHICLE::CREATE_VEHICLE(iLocal_1329, -1270.045f, -251.4953f, 41.4459f, 214.63f, 1, 1, 0);
	iLocal_1316[1] = VEHICLE::CREATE_VEHICLE(iLocal_1329, -1265.199f, -218.4823f, 45.9981f, 127.85f, 1, 1, 0);
}

void func_442()//Position - 0x19B21
{
	iLocal_1330 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, -1244.344f, -251.566f, 50.3194f, -9.2001f, 0.0498f, 6.3064f, 38f, 0, 2);
	iLocal_1331 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, -1243.588f, -251.4826f, 50.3187f, -9.2001f, 0.0498f, 6.3064f, 38f, 0, 2);
}

int func_443()//Position - 0x19B8B
{
	int iVar0;
...
void func_444()//Position - 0x19C1D
{
...
void func_445(bool bParam0)//Position - 0x19C78
{
	if (bParam0)
	{
...
void func_446()//Position - 0x19D37
{
	vector3 vVar0;
	vector3 vVar3;
	...
	iLocal_1128 = PED::ADD_SCENARIO_BLOCKING_AREA(vVar0 - Vector(15f, 15f, 15f), vVar0 + Vector(15f, 15f, 15f), 0, 1, 1, 1);
	iLocal_1129 = PED::ADD_SCENARIO_BLOCKING_AREA(vVar3 - Vector(45f, 35f, 35f), vVar3 + Vector(45f, 35f, 35f), 0, 1, 1, 1);
}

void func_447()//Position - 0x19E63
{
	StringCopy(&Local_965, "ASS_VA_PASSED", 24);
	MemCopy(&(Local_965.f_6), {Global_61486}, 6);
...
void func_448()//Position - 0x19ED9
{
...
void func_449()//Position - 0x1A0A3
{
	switch (iLocal_1193)
	{
		case 0:
		...
		case 1:
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), vLocal_1669, 1, 0, 0, 1);
				...
				{
					iLocal_1673 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, vLocal_1675, vLocal_1678, 42.2032f, 1, 2);
					CAM::SHAKE_CAM(iLocal_1673, "HAND_SHAKE", 0.3f);
				}
				if (!CAM::DOES_CAM_EXIST(iLocal_1674))
				{
					iLocal_1674 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, vLocal_1681, vLocal_1684, 42.2032f, 0, 2);
...
bool func_450()//Position - 0x1A5B8
{
	bool bVar0;
...
void func_451()//Position - 0x1A5DB
{
...
void func_452()//Position - 0x1A60D
{
	int iVar0;
				...
				if (ENTITY::DOES_ENTITY_EXIST(iVar0))
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
					{
						if ((iVar0 != iLocal_1320[0] && iVar0 != iLocal_1320[1]) && iVar0 != iLocal_1320[2])
						{
							...
							ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_1320[iLocal_1216 + 1], true, 0);
...
void func_453()//Position - 0x1A6B4
{
	int iVar0;
...
void func_454()//Position - 0x1A6F6
{
	int iVar0;
	vector3 vVar1;
...
void func_455()//Position - 0x1A7AA
{
	if (bLocal_1140)
	{
...
void func_456(int iParam0, int iParam1)//Position - 0x1A885
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
void func_457(int iParam0, bool bParam1)//Position - 0x1A8C1
{
	var uVar0;
...
void func_458()//Position - 0x1A938
{
	int iVar0;
...
void func_459()//Position - 0x1ACA5
{
...
void func_461()//Position - 0x1AFFE
{
	func_526();
}

int func_462()//Position - 0x1B00A
{
	if (Global_3)
	{
		return 1;
...
void func_463(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x1B037
{
	if (func_525())
	{
...
int func_464(vector3 vParam0, float fParam3)//Position - 0x1B0CC
{
	return func_465(&(Global_105109.f_2890), vParam0, fParam3, 0);
}

int func_465(var uParam0, vector3 vParam1, float fParam4, bool bParam5)//Position - 0x1B0E6
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
void func_466(int iParam0, int iParam1)//Position - 0x1B398
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_467(int iParam0)//Position - 0x1B59A
{
...
int func_468(int iParam0)//Position - 0x1B677
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_469(int iParam0, bool bParam1)//Position - 0x1B828
{
	int iVar0;
	struct<2> Var1;
...
int func_470(int iParam0)//Position - 0x1B9A8
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_472(int iParam0)//Position - 0x1BA8B
{
	int iVar0;
	int iVar1;
...
int func_473()//Position - 0x1DF59
{
	return 0;
}

int func_474()//Position - 0x1DF62
{
	return 1;
}

int func_475()//Position - 0x1DF6B
{
	return 1;
}

int func_476()//Position - 0x1DF74
{
...
int func_478(int iParam0)//Position - 0x1E048
{
	int iVar0;
	char* sVar1;
...
int func_479(int iParam0)//Position - 0x1E08E
{
	int iVar0;
...
int func_480(int iParam0)//Position - 0x1E0C9
{
	int iVar0;
...
int func_481(int iParam0)//Position - 0x1E145
{
	int iVar0;
...
void func_482(int iParam0, bool bParam1)//Position - 0x1E22D
{
	if (iParam0 == -1)
	{
		return;
...
void func_483(int iParam0, int iParam1, bool bParam2)//Position - 0x1E28A
{
	if (iParam0 == -1)
	{
		return;
...
bool func_484(int iParam0, int iParam1)//Position - 0x1E2C5
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_485(int iParam0)//Position - 0x1E2E8
{
	bool bVar0;
...
void func_486(var uParam0, var uParam1)//Position - 0x1E45A
{
...
int func_487(int iParam0, int iParam1)//Position - 0x1E526
{
	int iVar0;
...
int func_488(var uParam0)//Position - 0x1E598
{
	return *uParam0;
}

int func_489(var uParam0, int iParam1)//Position - 0x1E5A3
{
	int iVar0;
	int iVar1;
...
int func_490(int iParam0)//Position - 0x1FC9A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_491(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x1FD5D
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_50(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), true) < 10f)
					{
...
int func_492(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x1FF65
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_493(int iParam0, int iParam1, bool bParam2)//Position - 0x1FFE0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_494(int iParam0, int iParam1)//Position - 0x20042
{
	int iVar0;
...
void func_495(int iParam0, int iParam1)//Position - 0x200C4
{
	int iVar0;
...
void func_496(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x20162
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_497(int iParam0, var uParam1, var uParam2)//Position - 0x20724
{
	int iVar0;
	int iVar1;
...
int func_498(int iParam0)//Position - 0x208E7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_499(var uParam0)//Position - 0x209C3
{
...
int func_500(int iParam0, int iParam1)//Position - 0x20A03
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_501(int iParam0, int iParam1)//Position - 0x20AE8
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
void func_502(int iParam0, int iParam1)//Position - 0x20E5E
{
	int iVar0;
	int iVar1;
...
bool func_503()//Position - 0x20ED6
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_504(int iParam0)//Position - 0x20EE7
{
	int iVar0;
...
int func_505(int iParam0)//Position - 0x20F32
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
int func_506(int iParam0)//Position - 0x20FB9
{
...
int func_507(int iParam0)//Position - 0x20FE8
{
...
int func_508(int iParam0)//Position - 0x21005
{
...
int func_509(int iParam0, int iParam1)//Position - 0x21028
{
...
int func_510(int iParam0)//Position - 0x21063
{
	if (func_509(iParam0, 0))
	{
...
int func_511(int iParam0, int iParam1)//Position - 0x21086
{
	int iVar0;
...
void func_512(vector3 vParam0, float fParam3, bool bParam4)//Position - 0x210D3
{
	int iVar0;
...
int func_513(var uParam0)//Position - 0x21123
{
	if (func_514(uParam0))
	{
...
int func_514(var uParam0)//Position - 0x21158
{
...
bool func_515()//Position - 0x211B7
{
	return func_513(&(Global_105109.f_2890));
}

void func_516()//Position - 0x211CA
{
	func_517(&(Global_105109.f_2890));
}

void func_517(var uParam0)//Position - 0x211DD
{
	if (func_514(uParam0))
	{
...
void func_518()//Position - 0x211FB
{
	if (STREAMING::_0x07C313F94746702C(uLocal_1130))
	{
		STREAMING::_0x1EE7D8DF4425F053(uLocal_1130);
...
struct<39> func_520(int iParam0)//Position - 0x2123E
{
	struct<39> Var0;
...
Vector3 func_521(int iParam0)//Position - 0x216F6
{
	switch (iParam0)
	{
		case 0:
...
void func_522()//Position - 0x21780
{
	bool bVar0;
...
void func_523()//Position - 0x217B9
{
}

bool func_524()//Position - 0x217C1
{
	return func_514(&(Global_105109.f_2890));
}

int func_525()//Position - 0x217D4
{
	if (Global_98669 == 10 || Global_98669 == 9)
	{
		return 1;
...
void func_526()//Position - 0x217F8
{
	if (func_58(&iLocal_1336))
	{
		Global_111560.f_19958.f_5 = func_52(&iLocal_1336);
	...
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_1129, 0);
	func_518();
	func_92(&uLocal_1529, 0, 0);
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
...
void func_527()//Position - 0x218E2
{
	int iVar0;
...
void func_528(int iParam0, int iParam1)//Position - 0x21952
{
	int iVar0;
...
int func_529(int iParam0, int iParam1)//Position - 0x219B8
{
	int iVar0;
...
void func_530()//Position - 0x21AEB
{
	VEHICLE::REMOVE_VEHICLE_RECORDING(102, "ASSOJva");
	VEHICLE::REMOVE_VEHICLE_RECORDING(107, "ASSOJva");
...
void func_531()//Position - 0x21B1F
{
	int iVar0;
...
void func_533(var uParam0, int iParam1)//Position - 0x21BCE
{
	func_534(uParam0, iParam1);
}

void func_534(var uParam0, var uParam1)//Position - 0x21BDE
{
