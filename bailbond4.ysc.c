...
void __EntryFunction__()//Position - 0x0
{
	...
	StringCopy(&vLocal_604, "MAUDE_MCS_5", 24);
...
bool func_4(vector3 vParam0, var uParam3, float fParam4, int iParam5)//Position - 0x6A7
{
	var uVar0;
	vector3 vVar1;
...
void func_10(vector3 vParam0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x7A7
{
	var uVar0;
	int iVar1;
...
int func_17(int iParam0)//Position - 0x98E
{
	if (iParam0 == 1)
	{
...
bool func_18()//Position - 0x9E8
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

void func_19(int iParam0, struct<2> Param1, float fParam3)//Position - 0x9FA
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
int func_20(int iParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6)//Position - 0xA59
{
	bool bVar0;
	float fVar1;
...
int func_23(int iParam0)//Position - 0xB1C
{
	if (func_434(iParam0))
	{
...
void func_24(int iParam0, bool bParam1)//Position - 0xB3C
{
...
void func_25(int iParam0, int iParam1, int iParam2)//Position - 0xB78
{
...
void func_26(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0xBAC
{
	int iVar0;
...
void func_27(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0xC55
{
	if (bParam0)
	{
...
bool func_28()//Position - 0xD8E
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_29(int iParam0, int iParam1)//Position - 0xDAB
{
	bool bVar0;
...
int func_30(int iParam0, bool bParam1)//Position - 0xDF6
{
	int iVar0;
	int iVar1;
...
int func_31()//Position - 0xE37
{
	return Global_1312745;
}

int func_32(int iParam0)//Position - 0xE43
{
...
bool func_33()//Position - 0xE85
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_34(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xE96
{
	int iVar0;
...
void func_35(int iParam0)//Position - 0xEC9
{
	if (iParam0 == 1)
	{
...
void func_36(int iParam0)//Position - 0xEEC
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		switch (iParam0)
	...
	if (func_59(vLocal_619, Local_322.f_1, 210f))
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(Local_342))
		{
			if (func_59(vLocal_619, Local_342.f_1, 150f))
			{
				...
				{
					Local_342 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_342.f_1, 10f, func_48(), 1, 0, 1);
					if (func_434(Local_342))
					{
						ENTITY::SET_ENTITY_COORDS(Local_342, func_47(), 1, 0, 0, 1);
		...
		if (!ENTITY::DOES_ENTITY_EXIST(Local_348))
		{
			if (func_59(vLocal_619, Local_348.f_1, 150f))
			{
				...
				{
					Local_348 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_348.f_1, 10f, func_45(), 1, 0, 1);
				}
			}
		}
	}
...
void func_38(int iParam0, bool bParam1)//Position - 0x10FD
{
	if (bParam1)
	{
		func_40(iParam0);
...
void func_39(int iParam0, bool bParam1)//Position - 0x111A
{
...
void func_40(int iParam0)//Position - 0x1155
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
char* func_41()//Position - 0x1180
{
	return "special_ped@maude@base";
}

void func_42(int iParam0, bool bParam1)//Position - 0x118B
{
	if (bParam1)
	{
		func_44(iParam0);
...
void func_43(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11AA
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_44(int iParam0)//Position - 0x11FA
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_45()//Position - 0x123B
{
	return 2057223314;
}

float func_46()//Position - 0x1248
{
	return -92.17f;
}

Vector3 func_47()//Position - 0x1255
{
	return 2727.4f, 4145.56f, 43.68f;
}

int func_48()//Position - 0x126C
{
	return -380698483;
}

void func_49()//Position - 0x1279
{
	int iVar0;
	int iVar1;
	...
	if (func_23(Local_322))
	{
		if (func_434(Local_330))
		{
			if (func_58(2))
			{
				...
				TASK::TASK_SYNCHRONIZED_SCENE(Local_322, iVar0, func_41(), func_51(), 1000f, -8f, 4688, 0, 1148846080, 0);
				iVar1 = 0;
				iVar1 += 16;
				iVar1 += 64;
				iVar1 += 512;
				iVar1 += 4096;
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(Local_330, iVar0, func_50(), func_41(), 1000f, -8f, iVar1, 1148846080);
				...
				TASK::SET_PED_PATH_CAN_USE_CLIMBOVERS(Local_322, 0);
				TASK::SET_PED_PATH_CAN_DROP_FROM_HEIGHT(Local_322, 0);
...
char* func_50()//Position - 0x1365
{
	return "base_chair";
}

char* func_51()//Position - 0x1370
{
	return "base";
}

Vector3 func_52()//Position - 0x137B
{
	return 0f, 0f, -92.17f;
}

Vector3 func_53()//Position - 0x138A
{
	return 2727.4f, 4145.56f, 43.68f;
}

int func_54(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, bool bParam7, bool bParam8)//Position - 0x13A1
{
...
void func_55(int iParam0, bool bParam1)//Position - 0x1423
{
	if (iParam0 != 0)
	{
		if (bParam1)
...
int func_56(int iParam0)//Position - 0x144E
{
	if (iParam0 == 0)
	{
		return 1;
...
int func_57(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0x1474
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_56(iParam1))
...
int func_58(int iParam0)//Position - 0x14DF
{
	switch (iParam0)
	{
		case 0:
...
bool func_59(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x1583
{
	return SYSTEM::VDIST2(vParam0, vParam3) <= (fParam6 * fParam6);
}

int func_60(int iParam0, float fParam1, int iParam2)//Position - 0x159D
{
	int iVar0;
...
int func_64(int iParam0, int iParam1)//Position - 0x1707
{
	if (func_23(iParam0))
	{
...
int func_65(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x173A
{
...
void func_66(int iParam0)//Position - 0x18C9
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_68(char* sParam0)//Position - 0x1937
{
	func_27(1, 1, 0, 0, 0, 0);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_69(int iParam0, int iParam1, int iParam2)//Position - 0x1951
{
	if (func_521() && func_71())
	{
...
void func_70(int iParam0)//Position - 0x1A15
{
	if (iParam0 == 1)
	{
	...
	switch (iLocal_100)
	{
		case 0:
			...
			if (iLocal_102 == 4)
			{
				if (func_23(Local_322))
				{
					...
					{
						if (func_112(Local_322, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 35f))
						{
		...
		case 1:
			...
			else if (!iLocal_375)
			{
				...
				if (iLocal_102 == 4)
				{
					if (func_23(Local_322))
					{
						if (func_112(Local_322, vLocal_619, 35f))
						{
							...
							if (func_75(&uLocal_432, cLocal_426, &vLocal_598, 4, 0, 0, 0))
							{
								iLocal_375 = 1;
							}
						}
				...
				else if (func_75(&uLocal_432, cLocal_426, &vLocal_598, 4, 0, 0, 0))
				{
					iLocal_375 = 1;
				}
				if (iLocal_102 == 4)
					...
					else if (func_23(Local_322))
					{
						if (!func_64(Local_322, 1805844857))
						{
							if (!PED::IS_PED_FLEEING(Local_322))
							{
								...
								{
									func_73(&Local_322);
									TASK::TASK_SMART_FLEE_PED(Local_322, PLAYER::PLAYER_PED_ID(), 50f, -1, 0, 0);
									PED::SET_PED_KEEP_TASK(Local_322, 1);
								}
							}
						}
...
void func_73(int iParam0)//Position - 0x1CFD
{
	if (func_23(*iParam0))
	{
...
char* func_74()//Position - 0x1D66
{
	return "female_Flee_Table_Left_Maude";
}

int func_75(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1D72
{
	if (iParam4 == 0)
	{
...
bool func_76(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1DAF
{
...
int func_77(char* sParam0, int iParam1, bool bParam2)//Position - 0x1DFD
{
	Global_20806 = 0;
...
bool func_80(int iParam0)//Position - 0x216A
{
	return func_81(iParam0, 20);
}

bool func_81(int iParam0, int iParam1)//Position - 0x217A
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_82()//Position - 0x2195
{
	return -1;
}

void func_83()//Position - 0x219E
{
	int iVar0;
...
int func_87()//Position - 0x239F
{
	func_88();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_88()//Position - 0x23B8
{
	int iVar0;
...
bool func_89(int iParam0)//Position - 0x24B5
{
	return iParam0 < 3;
}

int func_90(int iParam0)//Position - 0x24C1
{
	int iVar0;
	int iVar1;
...
int func_91(int iParam0)//Position - 0x24FE
{
	if (func_89(iParam0))
	{
...
var func_92(int iParam0)//Position - 0x2523
{
	return Global_1798[iParam0 /*29*/];
}

bool func_93(int iParam0)//Position - 0x2532
{
	return Global_41396 == iParam0;
}

void func_94()//Position - 0x2540
{
	int iVar0;
...
bool func_95(int iParam0, int iParam1)//Position - 0x2597
{
	switch (iParam0)
	{
		case 5:
...
void func_96(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x25D2
{
...
void func_97(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2628
{
...
void func_98(bool bParam0)//Position - 0x26C3
{
	int iVar0;
...
void func_99(int iParam0, bool bParam1)//Position - 0x2896
{
	if (bParam1)
	{
		func_101(iParam0);
...
void func_100(int iParam0)//Position - 0x28B2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_101(int iParam0)//Position - 0x28EA
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_102(int iParam0)//Position - 0x2986
{
	if (func_434(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_103(var uParam0)//Position - 0x29B0
{
...
void func_105(char* sParam0)//Position - 0x29F6
{
...
void func_106(int iParam0, bool bParam1)//Position - 0x2A35
{
	if (func_23(iParam0))
	{
		PED::SET_PED_COMBAT_ATTRIBUTES(iParam0, 5, 0);
...
int func_107(int iParam0, int iParam1, int iParam2)//Position - 0x2AB0
{
	int iVar0;
...
char* func_108()//Position - 0x2BFC
{
	return "Female_Flee_Table_Left_Maude_Chair";
}

char* func_109()//Position - 0x2C08
{
	return "special_ped@maude@exit_flee";
}

void func_110(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x2C14
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_111(iParam3), 0);
}

int func_111(int iParam0)//Position - 0x2C2D
{
	int iVar0;
...
bool func_112(int iParam0, vector3 vParam1, float fParam4)//Position - 0x2E22
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, 1), vParam1) <= (fParam4 * fParam4);
}

void func_113(int iParam0, bool bParam1)//Position - 0x2E3F
{
	char* sVar0;
	int iVar1;
	int iVar2;
...
void func_114(var uParam0, int iParam1)//Position - 0x2EB0
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
void func_116(int iParam0)//Position - 0x2EF1
{
	bool bVar0;
	struct<8> Var1;
...
void func_117(int iParam0)//Position - 0x2F63
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
void func_118(int iParam0)//Position - 0x2F83
{
	int iVar0;
...
bool func_120(int iParam0, int iParam1)//Position - 0x306F
{
	return (MISC::GET_GAME_TIMER() - iParam0) > iParam1;
}

void func_121(int iParam0)//Position - 0x3081
{
...
void func_122(int iParam0)//Position - 0x31C4
{
	func_24(500, 1);
...
void func_123(int iParam0, int iParam1, int iParam2)//Position - 0x31F9
{
	bool bVar0;
...
int func_126()//Position - 0x37ED
{
	return Global_30736;
}

int func_127(int iParam0, int iParam1)//Position - 0x37F8
{
	int iVar0;
...
int func_128(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x3849
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_129(int iParam0)//Position - 0x3E9B
{
	int iVar0;
		...
		case 0:
			...
			if (func_37())
			{
				if (func_60(1, 10.5f, 1))
				{
					...
					func_196(&vVar0, &vVar3, &fVar9);
					vVar6 = { func_195() };
					if (func_192(vVar6, 0))
					{
						func_185(vVar0, vVar3, fVar9, 2719.87f, 4143.46f, 43.46f, 261.91f, 1, 1, 1, 0, 0);
						func_132(2719.87f, 4143.46f, 43.46f, 261.91f, 0, 145);
					}
					else
					{
						func_185(vVar0, vVar3, fVar9, 2710.665f, 4149.075f, 42.7026f, 180.9488f, 1, 1, 1, 0, 0);
...
void func_131(int iParam0)//Position - 0x41D6
{
	iLocal_98 = iParam0;
	iLocal_100 = 0;
}

void func_132(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x41E5
{
	vector3 vVar0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102125.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_102125.f_4, 0))
		{
			if (func_184(24) != Global_102125.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_181(ENTITY::GET_ENTITY_COORDS(Global_102125.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
				}
				func_133(Global_102125.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_133(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)//Position - 0x4260
{
	struct<60> Var0;
...
void func_134(int iParam0, int iParam1, int iParam2)//Position - 0x4389
{
	int iVar0;
...
void func_135(int iParam0, int iParam1)//Position - 0x44A6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_136(int iParam0)//Position - 0x46A8
{
...
int func_137(int iParam0)//Position - 0x4785
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_138(int iParam0, bool bParam1)//Position - 0x4936
{
	int iVar0;
	struct<2> Var1;
...
int func_139(int iParam0)//Position - 0x4AB6
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_141(int iParam0)//Position - 0x4B99
{
	int iVar0;
	int iVar1;
...
int func_142()//Position - 0x7064
{
	return 0;
}

int func_143()//Position - 0x706D
{
	return 1;
}

int func_144()//Position - 0x7076
{
	return 1;
}

int func_145()//Position - 0x707F
{
...
int func_147(int iParam0)//Position - 0x7153
{
	int iVar0;
	char* sVar1;
...
int func_148(int iParam0)//Position - 0x7199
{
	int iVar0;
...
int func_149(int iParam0)//Position - 0x71D4
{
	int iVar0;
...
int func_150(int iParam0)//Position - 0x7250
{
	int iVar0;
...
int func_151(int iParam0, int iParam1, bool bParam2)//Position - 0x7338
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_152(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x73A9
{
...
void func_154(var uParam0, int iParam1)//Position - 0x74C7
{
	if (iParam1 <= 0)
	{
		return;
...
void func_155(var uParam0, int iParam1)//Position - 0x754D
{
...
void func_156(var uParam0, int iParam1)//Position - 0x7580
{
	int iVar0;
	int iVar1;
...
int func_157(int iParam0, int iParam1)//Position - 0x75D1
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_158(int iParam0)//Position - 0x7673
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_159(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_159(bool bParam0, int iParam1, int iParam2)//Position - 0x7698
{
	if (bParam0)
	{
		return iParam1;
...
int func_160(var uParam0)//Position - 0x76AF
{
	return uParam0 & 15;
}

void func_161(var uParam0, int iParam1)//Position - 0x76BC
{
...
void func_162(var uParam0, int iParam1)//Position - 0x76F6
{
...
void func_163(var uParam0, int iParam1)//Position - 0x7731
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_164(var uParam0, int iParam1)//Position - 0x776D
{
	int iVar0;
	int iVar1;
...
int func_165(int iParam0, int iParam1)//Position - 0x8E66
{
	struct<82> Var0;
...
void func_166(int iParam0, var uParam1, int iParam2)//Position - 0x8EA8
{
	int iVar0;
...
void func_167(int iParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)//Position - 0x9104
{
	if (func_164(&(Global_75396.f_555[0 /*21*/]), iParam0))
	{
...
void func_168(int iParam0, bool bParam1)//Position - 0x9203
{
	if (iParam0 == -1)
	{
		return;
...
void func_169(int iParam0, int iParam1, bool bParam2)//Position - 0x9260
{
	if (iParam0 == -1)
	{
		return;
...
bool func_170(int iParam0, int iParam1)//Position - 0x929B
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_171(var uParam0, var uParam1)//Position - 0x92BE
{
...
void func_172(int iParam0)//Position - 0x938A
{
	if (iParam0 == -1)
	{
		return;
...
int func_173(int iParam0)//Position - 0x9404
{
	int iVar0;
...
bool func_174(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x9467
{
	if (bParam6)
	{
...
void func_175(int iParam0, var uParam1)//Position - 0x94AE
{
	int iVar0;
...
int func_176(int iParam0)//Position - 0x9759
{
	switch (iParam0)
	{
		case 1:
...
int func_177(int iParam0, var uParam1, var uParam2)//Position - 0x9809
{
	int iVar0;
	int iVar1;
...
int func_178(int iParam0)//Position - 0x99FC
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_179(var uParam0)//Position - 0x9A1C
{
	int iVar0;
...
void func_180(int iParam0)//Position - 0x9ACC
{
...
int func_181(vector3 vParam0, int iParam3, var uParam4, var uParam5)//Position - 0x9AF3
{
	int iVar0;
...
int func_182(vector3 vParam0, int iParam3, int iParam4)//Position - 0x9C09
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_183(int iParam0)//Position - 0x9C98
{
	return MISC::IS_BIT_SET(Global_111560.f_7224[iParam0], 0);
}

int func_184(int iParam0)//Position - 0x9CB0
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_185(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x9CCC
{
	func_186(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_186(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x9CF5
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_187(vector3 vParam0)//Position - 0xA0E9
{
...
int func_188(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)//Position - 0xA113
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_189(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0xA409
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_190(vector3 vParam0)//Position - 0xA4BD
{
	float fVar0;
	float fVar1;
...
void func_191(int iParam0)//Position - 0xA4FC
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
bool func_192(vector3 vParam0, int iParam3)//Position - 0xA561
{
	return func_193(Global_102125.f_2890.f_12.f_66, vParam0, iParam3);
}

int func_193(int iParam0, vector3 vParam1, int iParam4)//Position - 0xA57E
{
	vector3 vVar0;
	vector3 vVar3;
...
Vector3 func_194()//Position - 0xA5E8
{
	return 2.55f, 5.665f, 2.55f;
}

Vector3 func_195()//Position - 0xA5FF
{
	return 3.01f, 11.01f, 6.01f;
}

int func_196(var uParam0, var uParam1, var uParam2)//Position - 0xA616
{
...
void func_197(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0xA64D
{
	int iVar0;
...
Vector3 func_198(int iParam0)//Position - 0xA80B
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), 0);
}

int func_199(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xA81E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_200(int iParam0, int iParam1, int iParam2)//Position - 0xB034
{
	int iVar0;
...
int func_201(int iParam0)//Position - 0xB0C0
{
	switch (iParam0)
	{
...
void func_202(int iParam0, int iParam1, int iParam2)//Position - 0xB0FB
{
	int iVar0;
	int iVar1;
...
int func_203(int iParam0, int iParam1, int iParam2)//Position - 0xB185
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_204(int iParam0, int iParam1, int iParam2)//Position - 0xB263
{
	Global_76389[1 /*14*/] = { func_249(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 2);
}

int func_205(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0xB28E
{
	var uVar0;
	int iVar10;
...
int func_206(int iParam0, int iParam1, int iParam2)//Position - 0xB892
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_207(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB92B
{
	int iVar0;
...
int func_208(int iParam0, int iParam1, int iParam2)//Position - 0xB9C1
{
	int iVar0;
	int iVar1;
...
int func_209(int iParam0)//Position - 0xBA62
{
	switch (iParam0)
	{
		case 0:
...
int func_210(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBB12
{
	int iVar0;
...
int func_211(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xBE19
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_212(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0xC9CD
{
	int iVar0;
...
int func_213(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCCB1
{
	int iVar0;
...
int func_214(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCF78
{
	int iVar0;
	int iVar1;
...
int func_215(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCFAF
{
	int iVar0;
...
int func_216(int iParam0, int iParam1, int iParam2)//Position - 0xCFD8
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_217(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD2A2
{
	int iVar0;
...
int func_218(int iParam0, int iParam1, int iParam2)//Position - 0xD52C
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_219(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD683
{
	int iVar0;
...
int func_220(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD71B
{
	switch (iParam0)
	{
...
int func_221(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD7E9
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_222(int iParam0, int iParam1)//Position - 0xD945
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_223(int iParam0)//Position - 0xDCEC
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_224(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDD4D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_225(int iParam0, int iParam1)//Position - 0xDE49
{
	int iVar0;
...
int func_226(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDF87
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_227(int iParam0)//Position - 0xE067
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_228(int iParam0, int iParam1)//Position - 0xE0ED
{
	int iVar0;
	struct<10> Var1;
...
void func_229(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xEA1C
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_230(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xEB46
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_231(int iParam0, int iParam1)//Position - 0xEB8E
{
	int iVar0;
	struct<17> Var1;
...
void func_232(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x109D7
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_233(int iParam0)//Position - 0x10BC1
{
	switch (iParam0)
	{
		case 0:
...
void func_234(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x10C71
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_235(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10CE2
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_236(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10F5F
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_237(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11384
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_238(int iParam0, int iParam1)//Position - 0x11677
{
	int iVar0;
	int iVar1;
...
int func_239(int iParam0, int iParam1)//Position - 0x116BD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_240(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1171D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_241(int iParam0)//Position - 0x117A1
{
...
void func_242(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x11859
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_243(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x118A3
{
	int iVar0;
...
int func_244(var uParam0)//Position - 0x118D3
{
	int iVar0;
	int iVar1;
...
int func_245(int iParam0, int iParam1, int iParam2)//Position - 0x11907
{
	int iVar0;
	var uVar1;
...
bool func_246(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x11939
{
	int iVar0;
...
int func_247(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x137A0
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_248(int iParam0)//Position - 0x146C0
{
	if (!MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_249(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x14711
{
	func_312();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_250(int iParam0, int iParam1)//Position - 0x14763
{
	switch (iParam0)
	{
		case 0:
...
void func_251(int iParam0)//Position - 0x14853
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_252(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x15ACA
{
	int iVar0;
	int iVar1;
...
bool func_253(int iParam0, int iParam1, var uParam2)//Position - 0x15E5B
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_254(int iParam0, int iParam1)//Position - 0x16260
{
	switch (iParam1)
	{
		case 0:
...
int func_255(int iParam0, int iParam1)//Position - 0x1665B
{
	switch (iParam1)
	{
		case 0:
...
int func_256(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x16A56
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_257(int iParam0)//Position - 0x16A98
{
	switch (iParam0)
	{
		case -1:
...
void func_258(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x16B6C
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_252(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_252(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
void func_259(int iParam0)//Position - 0x16E45
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_260(int iParam0)//Position - 0x16F9C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_261(int iParam0)//Position - 0x174AA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_262(int iParam0)//Position - 0x1751F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_263(int iParam0)//Position - 0x17593
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_264(int iParam0)//Position - 0x1767A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_265(int iParam0)//Position - 0x179DD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_266(int iParam0)//Position - 0x17BEE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_267(int iParam0)//Position - 0x17E1E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_268(int iParam0)//Position - 0x17F2E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_269(int iParam0)//Position - 0x18978
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_270(int iParam0)//Position - 0x194EB
{
	if (iParam0 < 136)
	{
		func_272(iParam0);
...
void func_271(int iParam0)//Position - 0x19520
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_272(int iParam0)//Position - 0x1A124
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_273(int iParam0)//Position - 0x1B032
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_274(int iParam0)//Position - 0x1B15F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_275(int iParam0, int iParam1)//Position - 0x1B25D
{
	switch (iParam0)
	{
		case 0:
...
void func_276(int iParam0)//Position - 0x1B34D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_277(int iParam0)//Position - 0x1C83F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_278(int iParam0)//Position - 0x1C990
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_279(int iParam0)//Position - 0x1CE9B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_280(int iParam0)//Position - 0x1D509
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_281(int iParam0)//Position - 0x1D57D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_282(int iParam0)//Position - 0x1D64D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_283(int iParam0)//Position - 0x1DB7D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_284(int iParam0)//Position - 0x1DD14
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_285(int iParam0)//Position - 0x1E512
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_286(int iParam0)//Position - 0x1E622
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_287(int iParam0)//Position - 0x1F54D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_288(int iParam0)//Position - 0x2020C
{
	if (iParam0 < 107)
	{
		func_291(iParam0);
...
void func_289(int iParam0)//Position - 0x20252
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_290(int iParam0)//Position - 0x20CF7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_291(int iParam0)//Position - 0x21AE6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_292(int iParam0)//Position - 0x2272F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_293(int iParam0)//Position - 0x229A8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_294(int iParam0, int iParam1)//Position - 0x22AEE
{
	switch (iParam0)
	{
		case 0:
...
void func_295(int iParam0)//Position - 0x22BDE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_296(int iParam0)//Position - 0x23968
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_297(int iParam0)//Position - 0x23AE2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_298(int iParam0)//Position - 0x2405A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_299(int iParam0)//Position - 0x24584
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_300(int iParam0)//Position - 0x245F8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_301(int iParam0)//Position - 0x246C8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_302(int iParam0)//Position - 0x24BA0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_303(int iParam0)//Position - 0x24E09
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_304(int iParam0)//Position - 0x250DF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_305(int iParam0)//Position - 0x252A8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_306(int iParam0)//Position - 0x25DFC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_307(int iParam0)//Position - 0x26A46
{
	if (iParam0 < 60)
	{
		func_309(iParam0);
...
void func_308(int iParam0)//Position - 0x26A7B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_309(int iParam0)//Position - 0x2781B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_310(int iParam0)//Position - 0x27EA7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_311(int iParam0)//Position - 0x27F8E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_312()//Position - 0x2808E
{
...
int func_313(int iParam0, int iParam1, int iParam2)//Position - 0x28107
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_314(bool bParam0)//Position - 0x28362
{
	int iVar0;
...
void func_315()//Position - 0x283A0
{
	bool bVar0;
	vector3 vVar1;
			...
			case 1:
				if (!iLocal_382)
				{
					...
					if (Local_112.f_10 == 13 || Local_112.f_10 == 14)
					{
						...
						if (func_327(Local_112.f_9, vLocal_619, bVar0, 0, 1, iLocal_412))
						{
...
int func_316(var uParam0)//Position - 0x2887B
{
	vector3 vVar0;
...
int func_317(var uParam0)//Position - 0x288C0
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
bool func_318(char* sParam0, int iParam1, char* sParam2)//Position - 0x288F8
{
...
void func_319(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x28916
{
...
void func_320(char* sParam0, int iParam1, int iParam2)//Position - 0x289C2
{
	iParam2 = iParam2;
...
int func_321(char* sParam0, bool bParam1)//Position - 0x289DB
{
	struct<6> Var0;
...
struct<6> func_322()//Position - 0x28A16
{
	struct<6> Var0;
...
void func_323(int iParam0, vector3 vParam1, int iParam4, float fParam5)//Position - 0x28A3A
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_324(var uParam0, int iParam1, int iParam2)//Position - 0x28B1F
{
	char* sVar0;
...
int func_325(char* sParam0)//Position - 0x28BFC
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_326()//Position - 0x28C0F
{
	if (func_23(Local_112.f_9))
	{
...
int func_327(int iParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6, int iParam7)//Position - 0x28D0A
{
	int iVar0;
...
int func_328(int iParam0, vector3 vParam1, float fParam4, float fParam5)//Position - 0x28E80
{
...
int func_329(int iParam0, vector3 vParam1)//Position - 0x28EB8
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
void func_330(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x28F16
{
	func_331(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_331(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x28F30
{
	func_332(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_332(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x28F4D
{
	...
	uParam0->f_6 = 2;
	func_333(uParam0, iParam1, vParam2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

void func_333(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x28F85
{
	int iVar0;
	int iVar1;
...
void func_334(var uParam0)//Position - 0x292F2
{
...
int func_335(var uParam0)//Position - 0x2935B
{
	int iVar0;
...
int func_336(bool bParam0)//Position - 0x29386
{
	switch (Global_41396)
	{
		case 0:
...
void func_337(char[4] cParam0, int iParam1)//Position - 0x29430
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_338(char* sParam0)//Position - 0x29447
{
	if (!func_339(1, 1, 0))
	{
...
int func_339(bool bParam0, bool bParam1, bool bParam2)//Position - 0x294E0
{
	int iVar0;
	int iVar1;
...
int func_340(int iParam0)//Position - 0x29739
{
	if (iParam0 != func_82())
	{
...
int func_341(int iParam0, bool bParam1, bool bParam2)//Position - 0x2979F
{
	int iVar0;
...
int func_342(int iParam0, int iParam1)//Position - 0x297E9
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		if (VEHICLE::GET_NUM_MOD_KITS(iParam0) > 0)
...
int func_343(int iParam0, int iParam1)//Position - 0x2984B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_344()//Position - 0x298D0
{
	return Global_2448961.f_17;
}

bool func_345(int iParam0)//Position - 0x298DE
{
	return iParam0 == 51;
}

var func_346()//Position - 0x298EB
{
	return Global_2448961.f_16;
}

bool func_347()//Position - 0x298F9
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

void func_348(var uParam0, int iParam1, vector3 vParam2, int iParam5)//Position - 0x2990E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_349()//Position - 0x29A1E
{
	return func_350(PLAYER::PLAYER_ID());
}

int func_350(int iParam0)//Position - 0x29A2E
{
...
int func_351(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x29A4D
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_352(bool bParam0, bool bParam1, bool bParam2)//Position - 0x29DB9
{
...
int func_353(bool bParam0, bool bParam1, bool bParam2)//Position - 0x29E0B
{
	if (!func_339(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_354(bool bParam0, bool bParam1, bool bParam2)//Position - 0x29E54
{
	if (!func_339(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_355(bool bParam0, bool bParam1, bool bParam2)//Position - 0x29EB3
{
	if (!func_339(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_356(int iParam0)//Position - 0x29F09
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_357()//Position - 0x29F64
{
	MISC::SET_BIT(&Global_7357, 4);
}

void func_358(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x29F74
{
	if (HUD::DOES_BLIP_EXIST(*uParam0))
	{
...
int func_359(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x2A06F
{
	int iVar0;
	bool bVar1;
...
void func_360(int iParam0)//Position - 0x2A0C1
{
...
void func_361(var uParam0, vector3 vParam1)//Position - 0x2A107
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_362()//Position - 0x2A1E4
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			switch (Local_112.f_10)
			{
				...
				case 31:
					if (func_120(Local_112.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_622, PLAYER::PLAYER_PED_ID(), 1f, 1, 0.5f, 1082130432, 1, 0, 0, -957453492, 20000);
				...
				case 33:
					if (func_120(Local_112.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_622, PLAYER::PLAYER_PED_ID(), 2f, 1, 0.5f, 4f, 1, 0, 0, -687903391, 20000);
				...
				case 35:
					if (func_120(Local_112.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						TASK::OPEN_SEQUENCE_TASK(&uLocal_418);
						TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 750, 0);
						TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_622, PLAYER::PLAYER_PED_ID(), 2f, 1, 0.75f, 4f, 1, 0, 0, -687903391, 20000);
						TASK::CLOSE_SEQUENCE_TASK(uLocal_418);
						TASK::TASK_PERFORM_SEQUENCE(Local_112.f_9, uLocal_418);
						TASK::CLEAR_SEQUENCE_TASK(&uLocal_418);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, 1);
				...
				case 15:
					...
					{
						if ((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_191[0 /*6*/], 0) && func_112(Local_191[0 /*6*/], Local_191[0 /*6*/].f_1, 3f)) && func_369(ENTITY::GET_ENTITY_HEADING(Local_191[0 /*6*/]), Local_191[0 /*6*/].f_4, 20f))
						{
				...
				case 16:
					...
					else if (((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_191[0 /*6*/], 0) || PED::IS_PED_BEING_JACKED(Local_112.f_9)) || !func_112(Local_191[0 /*6*/], Local_191[0 /*6*/].f_1, 3f)) || !func_369(ENTITY::GET_ENTITY_HEADING(Local_191[0 /*6*/]), Local_191[0 /*6*/].f_4, 20f))
					{
						Local_112.f_10 = 13;
					}
...
bool func_363(int iParam0, int iParam1)//Position - 0x2B68E
{
	return (MISC::GET_FRAME_COUNT() - iParam0) > iParam1;
}

int func_364()//Position - 0x2B6A0
{
	int iVar0;
	int iVar1;
...
var func_365()//Position - 0x2B726
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

int func_366()//Position - 0x2B736
{
	if (!iLocal_355)
	{
		return 1;
...
int func_367(int iParam0, int iParam1, float fParam2, bool bParam3, float fParam4, float fParam5, bool bParam6)//Position - 0x2B7A3
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_368(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2B959
{
	int iVar0;
...
int func_369(float fParam0, float fParam1, float fParam2)//Position - 0x2BA50
{
...
char* func_370()//Position - 0x2BA6C
{
	return "move_m@bail_bond_not_tazered";
}

char* func_371()//Position - 0x2BA78
{
	return "move_m@bail_bond_tazered";
}

int func_372()//Position - 0x2BA84
{
...
void func_373(var uParam0, bool bParam1)//Position - 0x2BAB9
{
...
void func_374(int iParam0, var uParam1, float fParam2, int iParam3)//Position - 0x2BAD0
{
	if (func_434(iParam0))
	{
...
bool func_375(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2BAFC
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_376(&(Local_56[iVar4 /*4*/]), vVar1, iParam1, &(Local_56[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_56[iVar4 /*4*/].f_3) < iParam4);
}

int func_376(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x2BBBD
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_377(int iParam0, int iParam1)//Position - 0x2BCE9
{
	int iVar0;
...
int func_379(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2BDF8
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	
	vVar0 = { func_190(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
float func_380(vector3 vParam0, vector3 vParam3)//Position - 0x2BE89
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

int func_381(int iParam0, int iParam1)//Position - 0x2BEAA
{
	int iVar0;
...
void func_382(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2BEE9
{
	if (func_434(iParam0))
	{
...
void func_383()//Position - 0x2BF15
{
	if (func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_616, 100f))
	{
		if (!func_384())
		{
			CUTSCENE::REQUEST_CUTSCENE(&vLocal_604, 8);
			func_67();
			iLocal_386 = 1;
		}
	}
	...
	{
		if (!func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_616, 120f))
		{
			if (CUTSCENE::HAS_CUTSCENE_LOADED())
			{
				CUTSCENE::REMOVE_CUTSCENE();
...
bool func_384()//Position - 0x2BF9F
{
	return Global_96008;
}

void func_385()//Position - 0x2BFAB
{
	func_37();
	func_383();
	if (func_23(Local_112.f_9))
		...
		switch (iLocal_100)
		{
			...
			case 1:
				if (!iLocal_383)
				{
					...
					{
						func_388();
						func_386(&Local_322, vLocal_619, &iLocal_399, 5000, 1101004800);
					}
				}
...
int func_386(int iParam0, vector3 vParam1, int iParam4, int iParam5, float fParam6)//Position - 0x2C2D2
{
	vector3 vVar0;
	var uVar3;
	char[] cVar168[8];
...
void func_387(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2C35F
{
...
void func_388()//Position - 0x2C39A
{
	int iVar0;
	int iVar1;
...
int func_389(int iParam0)//Position - 0x2C7F6
{
	int iVar0;
...
void func_390(char* sParam0, int iParam1)//Position - 0x2C82F
{
	if (func_325(sParam0))
	{
...
void func_391(int iParam0)//Position - 0x2C846
{
...
void func_392()//Position - 0x2C881
{
	func_37();
	func_383();
	if (func_23(Local_112.f_9))
	{
		...
		switch (iLocal_100)
		{
			...
			case 1:
				...
				if (!bLocal_380)
				{
					bLocal_380 = func_393(vLocal_619, Local_103, 180f);
				}
				if (func_316(&(Local_112.f_9)))
				{
					iLocal_387 = 1;
			...
			case 2:
				...
				else
				{
					...
					if (!bLocal_380)
					{
						bLocal_380 = func_393(vLocal_619, Local_103, 0f);
					}
					func_131(4);
				}
				break;
...
int func_393(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x2CC56
{
	int iVar0;
...
bool func_394(vector3 vParam0, vector3 vParam3, float fParam6)//Position - 0x2CD47
{
	vector3 vVar0;
...
int func_395(vector3 vParam0, int iParam3, int iParam4)//Position - 0x2CD71
{
	int iVar0;
...
void func_396()//Position - 0x2CD9F
{
	bool bVar0;
			...
			case 1:
				...
				if (!iLocal_382)
				{
					...
					if (Local_112.f_10 == 13 || Local_112.f_10 == 14)
					{
						...
						if (func_327(Local_112.f_9, vLocal_619, bVar0, 0, 1, 170))
						{
							func_326();
							func_398(iLocal_407);
							Local_112.f_17 = MISC::GET_GAME_TIMER();
...
void func_397(bool bParam0, var uParam1)//Position - 0x2D1BE
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_398(int iParam0)//Position - 0x2D2AB
{
	int iVar0;
...
void func_399(int iParam0)//Position - 0x2D2F4
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			switch (Local_132[iVar0 /*19*/].f_14)
			{
				...
				case 2:
					...
					else
					{
						...
						func_400(Local_132[iVar0 /*19*/], &(Local_132[iVar0 /*19*/].f_6), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1);
					}
					break;
...
int func_400(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x2D648
{
	if (iParam3 == 0)
	{
...
int func_401(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, float fParam6)//Position - 0x2D81F
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
void func_402(int iParam0)//Position - 0x2D9B8
{
	int iVar0;
...
void func_403()//Position - 0x2D9F7
{
	if (func_23(Local_112.f_9))
	{
...
void func_404(bool bParam0)//Position - 0x2DEBB
{
...
void func_405()//Position - 0x2DEDF
{
	Global_19671 = 0;
	func_406();
}

void func_406()//Position - 0x2DEEF
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
void func_407()//Position - 0x2DF13
{
	if (!iLocal_367)
	{
		if (!func_62())
...
struct<6> func_408()//Position - 0x2E038
{
	struct<6> Var0;
	int iVar6;
	int iVar7;
...
int func_409(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2E0E4
{
	if (iParam5 == 0)
	{
		if (HUD::IS_MESSAGE_BEING_DISPLAYED())
...
bool func_410(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2E121
{
...
int func_411(int iParam0, int iParam1, bool bParam2, float fParam3, float fParam4)//Position - 0x2E175
{
	if (func_434(iParam0))
	{
		if (!func_363(iParam1, 10))
...
int func_412(var uParam0)//Position - 0x2E1DB
{
...
int func_413(int iParam0, vector3 vParam1, float fParam4)//Position - 0x2E1F5
{
	vector3 vVar0;
	float fVar3;
...
void func_414()//Position - 0x2E224
{
	switch (iLocal_100)
	{
		case 0:
...
void func_415(var uParam0, var uParam1)//Position - 0x2E451
{
	if (!uParam0->f_7)
	{
...
char* func_416(int iParam0)//Position - 0x2E4E2
{
	switch (iParam0)
	{
		case 0:
...
char* func_417(int iParam0)//Position - 0x2E527
{
	switch (iParam0)
	{
		case 0:
...
int func_418(int iParam0, int iParam1, int iParam2)//Position - 0x2E56A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_419(int iParam0)//Position - 0x2E654
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_420(int iParam0)//Position - 0x2E6B8
{
	switch (iParam0)
	{
		case 0:
...
void func_421()//Position - 0x2E6F5
{
	if (bLocal_378)
	{
...
void func_422()//Position - 0x2E752
{
	if (bLocal_378)
	{
...
void func_423()//Position - 0x2E79C
{
...
int func_424(bool bParam0)//Position - 0x2E8DB
{
	if (func_23(Local_322))
	{
		...
		if (func_430(Local_322, 1126825984))
		{
			return 1;
		}
...
int func_425(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x2EA33
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_426(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x2EB2E
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_427(int iParam0, float fParam1)//Position - 0x2EC3A
{
	var uVar0;
	vector3 vVar1;
...
int func_428(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0x2ECCF
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	
	vVar0 = { func_190(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
int func_429(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x2ED5D
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_430(int iParam0, float fParam1)//Position - 0x2EDA5
{
	float fVar0;
...
bool func_431(int iParam0, float fParam1)//Position - 0x2EE1B
{
	return func_375(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

int func_432(int iParam0)//Position - 0x2EE33
{
...
void func_433(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)//Position - 0x2EE5B
{
	func_20(iParam0, vParam1, fParam4, bParam5, 1);
	if (bParam6)
	{
		if (func_434(iParam0))
		{
...
int func_434(int iParam0)//Position - 0x2EE89
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
bool func_435(bool bParam0)//Position - 0x2EEAA
{
...
void func_436(int iParam0, bool bParam1)//Position - 0x2EED5
{
	func_446(bParam1, 1);
	if (bParam1)
	{
...
void func_437()//Position - 0x2EF64
{
	func_438(1, 0);
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
void func_438(bool bParam0, bool bParam1)//Position - 0x2EFD6
{
	HUD::CLEAR_PRINTS();
	if (HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
	{
	...
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_416, 0);
	PED::CLEAR_PED_NON_CREATION_AREA();
...
void func_439(bool bParam0)//Position - 0x2F0ED
{
	if (bParam0)
	{
...
void func_440()//Position - 0x2F128
{
	STREAMING::REMOVE_ANIM_SET(func_370());
	STREAMING::REMOVE_ANIM_SET(func_371());
}

void func_441(bool bParam0, int iParam1, int iParam2)//Position - 0x2F140
{
	bool bVar0;
...
void func_442(int iParam0)//Position - 0x2F19F
{
	Global_96005 = iParam0;
}

void func_443(bool bParam0)//Position - 0x2F1AD
{
	if (bParam0)
	{
...
void func_444(bool bParam0)//Position - 0x2F289
{
	if (bParam0)
	{
		func_445();
...
void func_445()//Position - 0x2F2EC
{
...
void func_446(bool bParam0, bool bParam1)//Position - 0x2F315
{
	if (bParam0)
	{
		func_441(0, 1, 1);
...
void func_447(vector3 vParam0, float fParam3, int iParam4, int iParam5)//Position - 0x2F348
{
	if (func_521())
	{
...
void func_448(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2F3DD
{
	int iVar0;
...
int func_449(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)//Position - 0x2F571
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
void func_450(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x303B7
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_451(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x30FCB
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_452(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x3103E
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_453(int iParam0)//Position - 0x32530
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_454(int iParam0, bool bParam1, var uParam2)//Position - 0x325E0
{
	int iVar0;
	bool bVar1;
...
int func_455(int iParam0)//Position - 0x3274E
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
...
int func_456(int iParam0)//Position - 0x32795
{
	switch (iParam0)
	{
		case 0:
...
int func_457(int iParam0)//Position - 0x32B5D
{
...
int func_458(int iParam0)//Position - 0x32B9F
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		case -32236122:
...
int func_459(int iParam0)//Position - 0x32C42
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
...
int func_460(int iParam0)//Position - 0x32C89
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
...
int func_461(int iParam0)//Position - 0x32CCF
{
	switch (iParam0)
	{
		case -2118308144:
...
int func_462(int iParam0)//Position - 0x32D04
{
...
int func_463(int iParam0)//Position - 0x32D33
{
...
int func_464(int iParam0)//Position - 0x32DF0
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		return 0;
...
int func_465(int iParam0)//Position - 0x32E26
{
	switch (iParam0)
	{
		case 562680400:
...
int func_466(int iParam0, bool bParam1)//Position - 0x32E7F
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_467(int iParam0)//Position - 0x32EDA
{
	int iVar0;
...
int func_468(int iParam0, int iParam1)//Position - 0x32F14
{
	if (iParam1 == 0)
	{
...
bool func_469()//Position - 0x33288
{
	return DLC::IS_DLC_PRESENT(1927191088);
}

bool func_470()//Position - 0x33299
{
	return DLC::IS_DLC_PRESENT(2067165443);
}

bool func_471()//Position - 0x332AA
{
	return DLC::IS_DLC_PRESENT(-957277403);
}

bool func_472()//Position - 0x332BB
{
	return DLC::IS_DLC_PRESENT(210122941);
}

bool func_473()//Position - 0x332CC
{
	return DLC::IS_DLC_PRESENT(-1894522408);
}

bool func_474()//Position - 0x332DD
{
	return DLC::IS_DLC_PRESENT(1630677557);
}

int func_475(int iParam0, int iParam1)//Position - 0x332EE
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_476(int iParam0)//Position - 0x33664
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
...
int func_477(int iParam0)//Position - 0x336C3
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
...
int func_478(int iParam0)//Position - 0x33723
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
...
int func_479(int iParam0, bool bParam1, var uParam2)//Position - 0x3376A
{
	bool bVar0;
...
int func_480(int iParam0)//Position - 0x33BA9
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_481(int iParam0, int iParam1)//Position - 0x33BD2
{
	int iVar0;
...
void func_482(int iParam0)//Position - 0x33C54
{
	if (!func_483(*iParam0))
	{
...
bool func_483(int iParam0)//Position - 0x33C7F
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_484(int iParam0, var uParam1, var uParam2)//Position - 0x33C8E
{
	int iVar0;
	int iVar1;
...
int func_485(int iParam0)//Position - 0x33E51
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_486(var uParam0)//Position - 0x33F2D
{
...
int func_487(int iParam0, int iParam1)//Position - 0x33F6D
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_488(var uParam0, int iParam1)//Position - 0x34053
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_489(int iParam0, int iParam1)//Position - 0x34094
{
	int iVar0;
...
void func_490(vector3 vParam0, float fParam3, bool bParam4)//Position - 0x34132
{
	int iVar0;
...
void func_491(int iParam0)//Position - 0x34182
{
	bool bVar0;
...
int func_492(int iParam0, int iParam1)//Position - 0x342F4
{
	int iVar0;
...
int func_493(var uParam0)//Position - 0x34366
{
	return *uParam0;
}

int func_494(vector3 vParam0, float fParam3)//Position - 0x34371
{
	return func_495(&(Global_105109.f_2890), vParam0, fParam3, 0);
}

int func_495(var uParam0, vector3 vParam1, float fParam4, bool bParam5)//Position - 0x3438B
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
int func_496(int iParam0)//Position - 0x3463D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_497(int iParam0, vector3 vParam1, bool bParam4)//Position - 0x34700
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_174(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
int func_498(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x34908
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_499(int iParam0, int iParam1, bool bParam2)//Position - 0x34983
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_500(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x349E4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_501(int iParam0, int iParam1)//Position - 0x34FA6
{
	int iVar0;
	int iVar1;
...
bool func_502()//Position - 0x3501E
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_503(int iParam0)//Position - 0x3502F
{
	int iVar0;
...
int func_504(int iParam0)//Position - 0x3507A
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
int func_505(int iParam0)//Position - 0x35101
{
...
int func_506(int iParam0)//Position - 0x35130
{
...
int func_507(int iParam0)//Position - 0x3514D
{
...
int func_508(int iParam0, int iParam1)//Position - 0x35170
{
...
int func_509(int iParam0)//Position - 0x351AB
{
	if (func_508(iParam0, 0))
	{
...
int func_510(int iParam0, int iParam1)//Position - 0x351CE
{
	int iVar0;
...
int func_511(var uParam0)//Position - 0x3521B
{
	if (func_512(uParam0))
	{
...
int func_512(var uParam0)//Position - 0x35250
{
...
bool func_513()//Position - 0x352AF
{
	return func_511(&(Global_105109.f_2890));
}

void func_514()//Position - 0x352C2
{
	func_515(&(Global_105109.f_2890));
}

void func_515(var uParam0)//Position - 0x352D5
{
	if (func_512(uParam0))
	{
...
int func_516(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x352F3
{
...
int func_518(int iParam0)//Position - 0x353F6
{
	switch (iParam0)
	{
		case joaat("police"):
...
bool func_519()//Position - 0x3544F
{
	return func_512(&(Global_105109.f_2890));
}

int func_520()//Position - 0x35462
{
...
void func_522()//Position - 0x354B0
{
	vector3 vVar0;
	vector3 vVar3;
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, iLocal_597);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_597, 1862763509);
	vVar0 = { func_529(Local_103) };
	vVar3 = { func_528(Local_103) };
	PED::SET_PED_NON_CREATION_AREA(vVar0, vVar3);
	iLocal_416 = PED::ADD_SCENARIO_BLOCKING_AREA(vVar0, vVar3, 0, 1, 1, 1);
...
void func_523()//Position - 0x355F5
{
	int iVar0;
	...
	while (iVar0 <= 2)
	{
		if (func_23(Local_132[iVar0 /*19*/]))
		{
			...
			func_524(Local_132[iVar0 /*19*/], "BACKUP_", iVar0);
			switch (iVar0)
			{
				case 0:
					TASK::OPEN_SEQUENCE_TASK(&uLocal_418);
...
void func_524(var uParam0, char* sParam1, int iParam2)//Position - 0x35AEC
{
	char cVar0[16];
...
int func_525()//Position - 0x35B08
{
	...
	if (iLocal_404 > 0)
	{
		...
		{
			if (func_527(&(Local_191[iVar2 /*6*/]), Local_191[iVar2 /*6*/].f_5, Local_191[iVar2 /*6*/].f_1, Local_191[iVar2 /*6*/].f_4, 1))
			{
				iVar0++;
			}
			iVar2++;
	...
	if (iLocal_406 > 0)
	{
		...
		{
			if (func_526(&(Local_314[iVar2 /*7*/]), Local_314[iVar2 /*7*/].f_5, Local_314[iVar2 /*7*/].f_2, Local_314[iVar2 /*7*/].f_6, Local_314[iVar2 /*7*/].f_1, 1))
			{
				iVar0++;
			}
			iVar2++;
...
int func_526(var uParam0, int iParam1, vector3 vParam2, int iParam5, int iParam6, bool bParam7)//Position - 0x35D3E
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_56(iParam6))
...
int func_527(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)//Position - 0x35DAF
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_56(iParam1))
...
Vector3 func_528(struct<5> Param0, var uParam5, var uParam6, var uParam7)//Position - 0x35E4E
{
	switch (Param0.f_4)
	{
		case 0:
...
Vector3 func_529(struct<5> Param0, var uParam5, var uParam6, var uParam7)//Position - 0x35EC2
{
	switch (Param0.f_4)
	{
		case 0:
...
void func_530()//Position - 0x35F36
{
	int iVar0;
	...
	StringCopy(&vLocal_598, "", 24);
	StringCopy(&Local_610, "", 24);
	Local_322.f_6 = func_541(62);
	Local_322.f_1 = { func_540() };
	Local_322.f_4 = func_539();
	Local_330.f_5 = func_538();
	Local_330.f_1 = { func_537() };
	Local_330.f_4 = func_536();
	Local_336.f_5 = func_535();
	...
	Local_348.f_1 = { func_532() };
	Local_348.f_4 = func_531();
...
float func_531()//Position - 0x363F7
{
	return 75.15f;
}

Vector3 func_532()//Position - 0x36404
{
	return 2727.29f, 4145.9f, 44.16f;
}

float func_533()//Position - 0x3641B
{
	return 71f;
}

Vector3 func_534()//Position - 0x36428
{
	return 2727.686f, 4145.715f, 44.08f;
}

int func_535()//Position - 0x3643F
{
	return 1385417869;
}

float func_536()//Position - 0x3644C
{
	return -91.28f;
}

Vector3 func_537()//Position - 0x36459
{
	return 2728.35f, 4145.59f, 43.3f;
}

int func_538()//Position - 0x36470
{
	return -741944541;
}

float func_539()//Position - 0x3647D
{
	return 89.19f;
}

Vector3 func_540()//Position - 0x3648A
{
	return 2728.33f, 4145.6f, 43.89f;
}

int func_541(int iParam0)//Position - 0x364A1
{
	if (!func_89(iParam0))
	{
		return func_92(iParam0);
...
int func_542(bool bParam0)//Position - 0x364C7
{
...
int func_546(int iParam0)//Position - 0x365FF
{
	int iVar0;
...
var func_547()//Position - 0x36D1C
{
	return Global_98708.f_1;
}

int func_548()//Position - 0x36D2A
{
	if (Global_95621 != -1)
	{
...
bool func_549()//Position - 0x36D50
{
	return Global_98721.f_346 > 0;
}

bool func_550()//Position - 0x36D61
{
	return Global_98721.f_345 > 0;
}

var func_551()//Position - 0x36D72
{
	return Global_1312873;
}

bool func_552(int iParam0)//Position - 0x36D7E
{
	return func_553(iParam0, Global_41396);
}

int func_553(int iParam0, int iParam1)//Position - 0x36D8F
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_554(int iParam0)//Position - 0x36F70
{
	func_579();
	if (!func_578())
	{
...
void func_555(char* sParam0)//Position - 0x36FBB
{
	if (Global_98669 != 12)
	{
...
int func_556(char* sParam0, int iParam1, int iParam2)//Position - 0x36FD8
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
int func_557(char* sParam0)//Position - 0x3716A
{
...
void func_558(int iParam0, var uParam1)//Position - 0x371C0
{
	switch (iParam0)
	{
		case 0:
...
int func_560(int iParam0)//Position - 0x3840B
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_561(int iParam0)//Position - 0x38751
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_562(int iParam0)//Position - 0x38788
{
	struct<2> Var0;
...
int func_564(char* sParam0, bool bParam1)//Position - 0x38BF8
{
	int iVar0;
	int iVar1;
...
int func_565(int iParam0, bool bParam1)//Position - 0x38C22
{
	int iVar0;
...
void func_568(int iParam0)//Position - 0x38D14
{
	if (iParam0 == 1)
	{
		Global_41945 = 1;
...
void func_569(bool bParam0)//Position - 0x38D2D
{
	HUD::DISPLAY_HUD(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_570(int iParam0)//Position - 0x38D41
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_571(int iParam0)//Position - 0x38D7E
{
	if (iParam0 == 1)
	{
...
void func_572()//Position - 0x38DBB
{
	Global_22211.f_5 = 1;
}

void func_573()//Position - 0x38DC9
{
	Global_22211.f_5 = 0;
}

void func_574()//Position - 0x38DD7
{
	Global_92875 = 0;
	Global_92876 = 0;
}

void func_575()//Position - 0x38DE9
{
	Global_98669 = 13;
	Global_98669.f_1 = -1;
	Global_98669.f_2 = 0;
...
void func_579()//Position - 0x38ED4
{
	Global_98704 = 1;
...
void func_580()//Position - 0x38FC1
{
	if (iLocal_384)
	{
		func_438(0, 1);
