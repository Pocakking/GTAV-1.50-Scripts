							...
							if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), vLocal_39[iLocal_31 /*3*/]) < fLocal_250)
							{
								if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
								{
									...
									if (VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0))
									{
										if (func_15())
										{
											if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_251, vLocal_254, fLocal_263, 0, true, 0))
											{
												bLocal_33 = true;
												iLocal_27 = 1;
											}
											if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_257, vLocal_260, fLocal_263, 0, true, 0))
											{
												bLocal_34 = true;
												iLocal_27 = 1;
											}
						...
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
						{
							...
							if (bLocal_33)
							{
								if (iLocal_37)
								{
									if (iLocal_36)
									{
										if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_251, vLocal_254, fLocal_263, 0, true, 0) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_257, vLocal_260, fLocal_263, 0, true, 0))
										{
											func_14();
											func_1();
									...
									else if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_251, vLocal_254, fLocal_263, 0, true, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_257, vLocal_260, fLocal_263, 0, true, 0))
									{
										iLocal_36 = 1;
									}
									else if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_251, vLocal_254, fLocal_263, 0, true, 0) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_257, vLocal_260, fLocal_263, 0, true, 0))
...
var func_13(int iParam0)//Position - 0x97E
{
	return Global_1798[iParam0 /*29*/];
}

void func_14()//Position - 0x98D
{
	bLocal_33 = false;
	bLocal_34 = false;
	iLocal_35 = 0;
...
void func_22(char* sParam0)//Position - 0xCBD
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}

int func_23()//Position - 0xCCF
{
	if (Global_76837)
	{
		return 1;
...
void func_24()//Position - 0xCF9
{
}

void func_25()//Position - 0xD01
{
}

void func_26()//Position - 0xD09
{
	int iVar0;
	...
	while (iVar0 < 70)
	{
		if (func_28(vLocal_264, vLocal_39[iVar0 /*3*/], 1056964608, 0))
		{
...
void func_27(int iParam0)//Position - 0xDCE
{
	switch (iParam0)
	{
		case 0:
...
int func_28(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0x26E1
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_31(int iParam0, int iParam1)//Position - 0x2E60
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_32(int iParam0, int iParam1)//Position - 0x2E7B
{
...
int func_33(var uParam0, int iParam1)//Position - 0x2F18
{
	int iVar0;
	var uVar1[78];
...
int func_34(var uParam0, int iParam1)//Position - 0x2FC9
{
	int iVar0;
...
bool func_35(var uParam0, int iParam1)//Position - 0x3044
{
	return (*uParam0)[iParam1] == 78;
}

void func_36(var uParam0)//Position - 0x3055
{
	int iVar0;
...
void func_37(var uParam0, int iParam1)//Position - 0x3089
{
	(*uParam0)[iParam1] = 78;
}

void func_38(var uParam0, float fParam1)//Position - 0x3099
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_39(var uParam0)//Position - 0x30B6
{
	return uParam0->f_80;
}

bool func_40(var uParam0, int iParam1)//Position - 0x30C2
{
	return func_41(uParam0, iParam1) != -1;
}

int func_41(var uParam0, int iParam1)//Position - 0x30D4
{
	int iVar0;
...
bool func_42(var uParam0)//Position - 0x3101
{
	return uParam0->f_79 == 1;
}

int func_43(int iParam0)//Position - 0x310F
{
	switch (iParam0)
	{
		case 60:
...
void func_44(int iParam0, int iParam1, int iParam2)//Position - 0x315F
{
	bool bVar0;
...
int func_46()//Position - 0x3708
{
	return Global_30736;
}

int func_47(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x3713
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_48(int iParam0, int iParam1)//Position - 0x3D5C
{
	int iVar0;
...
int func_50(int iParam0)//Position - 0x3E31
{
	switch (iParam0)
	{
		case 33:
...
bool func_52(bool bParam0)//Position - 0x3F29
{
...
bool func_53(int iParam0)//Position - 0x3F54
{
