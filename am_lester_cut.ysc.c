		...
		switch (func_211(NETWORK::PARTICIPANT_ID_TO_INT()))
		{
			...
			case 2:
				if (func_210() == 2)
				{
					...
					{
						func_12();
						HUD::SET_BLIP_ROUTE(Global_1662509, 0);
							...
							if ((bLocal_351 && CUTSCENE::HAS_CUTSCENE_LOADED()) || !bLocal_351)
							{
								...
								if (MISC::IS_BIT_SET(vLocal_180[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1))
								{
									if (Local_103.f_2 == NETWORK::PARTICIPANT_ID_TO_INT())
									{
										...
										{
											func_190();
											uLocal_361 = unk_0x67D02A194A2FC2BD("SECURITY_CAM");
										}
							...
							if (func_184(0, 1, 1, 1))
							{
								if (!func_198())
								{
									...
									if (!HUD::DOES_BLIP_EXIST(Global_1662509))
									{
										...
										HUD::SET_BLIP_FLASHES(Global_1662509, 1);
...
int func_39(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2576213[iParam0 /*3*/][func_81(iParam1)];
...
int func_138()
{
	switch (iLocal_360)
	{
		case 0:
			...
			if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_361) && func_190())
			{
				func_171();
				func_170();
		...
		case 3:
			if (!PED::IS_PED_INJURED(iLocal_183))
			{
				if (func_180(&uLocal_363, 5000, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_183, 1275.138f, -1718.426f, 53.72994f, 1272.451f, -1719.627f, 55.45897f, 1.5625f, 0, 1, 0))
				{
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
