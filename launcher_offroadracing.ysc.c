				...
				case 3:
					...
					else
					{
						...
						if (!func_114(3) && !Global_98703)
						{
							...
							{
								if ((!func_142(uLocal_94, 1) || !ENTITY::DOES_ENTITY_EXIST(func_113())) && !Global_98703)
								{
									func_135(10);
									break;
								}
				...
				case 6:
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_52))
					{
						...
						if (iLocal_99 != -1)
						{
							if (func_142(Global_110211, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_30(iLocal_99), 0, Global_98706, 0);
...
bool func_59(int iParam0)//Position - 0x2571
{
	return func_60(iParam0, 20);
}

bool func_60(int iParam0, int iParam1)//Position - 0x2581
{
...
var func_67()//Position - 0x27CE
{
	func_68();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_68()//Position - 0x27E7
{
	int iVar0;
...
bool func_69(int iParam0)//Position - 0x28E4
{
	return iParam0 < 3;
}

int func_70(int iParam0)//Position - 0x28F0
{
	int iVar0;
	int iVar1;
...
int func_71(int iParam0)//Position - 0x292D
{
	if (func_69(iParam0))
	{
...
var func_72(int iParam0)//Position - 0x2952
{
	return Global_1798[iParam0 /*29*/];
}

void func_73()//Position - 0x2961
{
	int iVar0;
...
void func_75(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x2A10
{
...
void func_78(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x2CED
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_79(iParam3), 0);
}

int func_79(int iParam0)//Position - 0x2D06
{
	int iVar0;
...
void func_80()//Position - 0x2EFB
{
	...
	while (iVar2 < 5)
	{
		...
		{
			if (func_85(Local_329[iVar2 /*14*/], 1, 0, 0, 0) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_329[iVar2 /*14*/].f_1, 1))
			{
				func_83();
				func_82(iLocal_105);
...
void func_82(int iParam0)//Position - 0x34D5
{
	if (iLocal_95 < 5)
	{
		if (iParam0 != 263)
...
void func_84(int iParam0)//Position - 0x3628
{
	if (iParam0 == 2)
	{
	}
...
int func_85(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x3649
{
	int iVar0;
	vector3 vVar1;
...
float func_86(int iParam0, bool bParam1)//Position - 0x3803
{
	return func_87(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), iParam0, bParam1);
}

float func_87(int iParam0, int iParam1, bool bParam2)//Position - 0x381B
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_88(int iParam0, bool bParam1)//Position - 0x3879
{
	int iVar0;
...
int func_89(int iParam0)//Position - 0x3931
{
	int iVar0;
...
void func_90(int iParam0)//Position - 0x396C
{
	int iVar0;
...
void func_91(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x39C3
{
	int iVar0;
...
int func_92(int iParam0)//Position - 0x3AEE
{
...
void func_93(char[4] cParam0, int iParam1, int iParam2)//Position - 0x3B1B
{
...
var func_94()//Position - 0x3B3D
{
	return Global_73784;
}

int func_95(int iParam0)//Position - 0x3B49
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
bool func_96(int iParam0, int iParam1)//Position - 0x3BA3
{
	switch (iParam0)
	{
		case 5:
...
bool func_97()//Position - 0x3BDE
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

int func_98()//Position - 0x3BF3
{
...
bool func_99(bool bParam0)//Position - 0x3C0D
{
	if (bParam0)
	{
...
int func_100()//Position - 0x3C36
{
	return 1;
}

void func_101(var uParam0, int iParam1)//Position - 0x3C3F
{
	func_102(uParam0, iParam1);
}

void func_102(var uParam0, var uParam1)//Position - 0x3C4F
{
	*uParam0 = (*uParam0 || uParam1);
}

bool func_103()//Position - 0x3C60
{
	int iVar0;
	bool bVar1;
...
int func_104(int iParam0)//Position - 0x3D6A
{
	int iVar0;
...
var func_105()//Position - 0x4487
{
	return Global_98708.f_1;
}

int func_106()//Position - 0x4495
{
	if (Global_95621 != -1)
	{
...
bool func_108()//Position - 0x44E5
{
	return Global_98721.f_346 > 0;
}

bool func_109()//Position - 0x44F6
{
	return Global_98721.f_345 > 0;
}

var func_110()//Position - 0x4507
{
	return Global_1312873;
}

int func_111()//Position - 0x4513
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
var func_113()//Position - 0x4549
{
	return Global_94531;
}

int func_114(int iParam0)//Position - 0x4555
{
	switch (iParam0)
	{
		case 0:
...
bool func_115(int iParam0)//Position - 0x45C7
{
	int iVar0;
...
bool func_116(int iParam0)//Position - 0x4603
{
	return Global_41396 == iParam0;
}

void func_117()//Position - 0x4611
{
	int iVar0;
	char* sVar1;
	...
	if (fLocal_110 > 9f)
	{
		...
		while (iVar5 < Local_329)
		{
			if (!func_123(Local_329[iVar5 /*14*/].f_2))
			{
				...
				{
					Local_329[iVar5 /*14*/] = PED::CREATE_PED_INSIDE_VEHICLE(Local_329[iVar5 /*14*/].f_1, 4, func_121(), -1, 1, true);
					VEHICLE::SET_VEHICLE_ENGINE_ON(Local_329[iVar5 /*14*/].f_1, true, false, 0);
				}
				else
				{
					Local_329[iVar5 /*14*/] = PED::CREATE_PED(4, func_121(), Local_329[iVar5 /*14*/].f_6, Local_329[iVar5 /*14*/].f_9, 1, true);
					iVar1 = iVar5;
					switch (iVar1)
					{
						case 0:
		...
		{
			Local_329.f_83 = PED::CREATE_PED_INSIDE_VEHICLE(Local_329.f_83.f_1, 4, func_121(), -1, 1, true);
			VEHICLE::SET_VEHICLE_ENGINE_ON(Local_329.f_83.f_1, true, false, 0);
		}
		else
		{
			Local_329.f_83 = PED::CREATE_PED(4, func_121(), Local_329.f_83.f_6, Local_329.f_83.f_9, 1, true);
...
void func_119(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x50C5
{
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0x5160
{
	if (iParam0 > iParam2)
	{
		return iParam2;
...
int func_121()//Position - 0x5185
{
	return joaat("a_m_y_motox_01");
}

int func_122(bool bParam0)//Position - 0x5192
{
	int iVar0;
	int iVar1;
...
int func_123(vector3 vParam0)//Position - 0x5284
{
...
void func_124(vector3 vParam0, float fParam3, vector3 vParam4, float fParam7)//Position - 0x52AE
{
...
void func_125(vector3 vParam0, float fParam3, vector3 vParam4, float fParam7)//Position - 0x52F2
{
	int iVar0;
	bool bVar1;
...
int func_129(var uParam0)//Position - 0x5665
{
	int iVar0;
...
void func_131(var uParam0)//Position - 0x58EC
{
	int iVar0;
...
int func_132(var uParam0, int iParam1)//Position - 0x591C
{
	int iVar0;
	int iVar1;
...
int func_133(var uParam0)//Position - 0x5979
{
	int iVar0;
...
void func_134(var uParam0, int iParam1)//Position - 0x59A5
{
	*uParam0 = (*uParam0 || iParam1);
}

void func_135(int iParam0)//Position - 0x59B6
{
	iLocal_95 = iParam0;
}

void func_136(int iParam0, bool bParam1, bool bParam2)//Position - 0x59C2
{
	int iVar0;
	bool bVar1;
...
bool func_139(int iParam0, int iParam1)//Position - 0x5B0E
{
	bool bVar0;
...
bool func_140(int iParam0)//Position - 0x5B5B
{
	return func_141(iParam0, Global_41396);
}

int func_141(int iParam0, int iParam1)//Position - 0x5B6C
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_142(var uParam0, int iParam1)//Position - 0x5D4D
{
	return (uParam0 && iParam1) != 0;
}

void func_143()//Position - 0x5D5C
{
...
bool func_144(int iParam0, bool bParam1)//Position - 0x5E57
{
	int iVar0;
...
int func_145(int iParam0)//Position - 0x5EAB
{
	switch (iParam0)
	{
		case 91:
...
int func_146(int iParam0)//Position - 0x5FC3
{
	switch (iParam0)
	{
		case 0:
...
int func_147(vector3 vParam0, var uParam3)//Position - 0x6017
{
	int iVar0;
	vector3 vVar1[7];
	float fVar23;
...
Vector3 func_148(int iParam0)//Position - 0x60D6
{
...
void func_149(var uParam0, int iParam1)//Position - 0x618F
{
	func_150(uParam0, iParam1);
}

void func_150(var uParam0, var uParam1)//Position - 0x619F
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

void func_151(bool bParam0)//Position - 0x61B4
{
	if (bParam0)
	{
		if (iLocal_105 != 263)
