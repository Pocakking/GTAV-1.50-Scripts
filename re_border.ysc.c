...
int func_12()//Position - 0xFE6
{
	return Global_1312745;
}

int func_13(int iParam0, int iParam1)//Position - 0xFF2
{
	switch (iParam0)
	{
		case 0:
...
int func_14(int iParam0)//Position - 0x1366
{
	switch (iParam0)
	{
		case 29:
...
void func_15(int iParam0)//Position - 0x1395
{
	int iVar0;
	int iVar1;
...
void func_16(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x13D7
{
	func_17(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_17(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x13F9
{
	int iVar0;
...
bool func_21(int iParam0)//Position - 0x1830
{
...
int func_23(int iParam0)//Position - 0x184A
{
	int iVar0;
	int iVar1;
...
int func_24(int iParam0)//Position - 0x1887
{
	if (func_22(iParam0))
	{
...
var func_25(int iParam0)//Position - 0x18AC
{
	return Global_1798[iParam0 /*29*/];
}

int func_26(int iParam0)//Position - 0x18BB
{
	int iVar0;
	int iVar1;
...
void func_27(int iParam0, int iParam1)//Position - 0x18FE
{
	MISC::SET_BIT(&(Global_111560.f_24990.f_8[iParam0]), iParam1);
}

int func_28(int iParam0)//Position - 0x1919
{
	int iVar0;
...
int func_30(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x19E7
{
...
void func_31()//Position - 0x1BC1
{
	func_7();
}

int func_32()//Position - 0x1BCE
{
	return 1;
}

int func_33()//Position - 0x1BD7
{
	int iVar0;
	int iVar1;
...
int func_35()//Position - 0x1FA9
{
	func_20();
	return Global_111560.f_2358.f_539.f_4321;
}

int func_36(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1FC2
{
...
int func_37(char* sParam0, int iParam1, bool bParam2)//Position - 0x2010
{
	Global_20806 = 0;
...
bool func_40(int iParam0)//Position - 0x237D
{
	return func_41(iParam0, 20);
}

bool func_41(int iParam0, int iParam1)//Position - 0x238D
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_42()//Position - 0x23A8
{
	return -1;
}

void func_43()//Position - 0x23B1
{
	int iVar0;
...
bool func_49(int iParam0, int iParam1)//Position - 0x2632
{
	switch (iParam0)
	{
		case 5:
...
void func_51(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x26C4
{
...
void func_53(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x273B
{
...
void func_54(var uParam0, int iParam1)//Position - 0x27D6
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
void func_57()//Position - 0x286F
{
	...
	while (iVar0 < 3)
	{
		if (!PED::IS_PED_INJURED(iLocal_85[iVar0]))
		{
			...
			if (iLocal_64 || iLocal_65)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_85[iVar0], 0))
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !iLocal_67[iVar0])
					{
						...
						{
							TASK::TASK_VEHICLE_MISSION(iLocal_85[iVar0], iLocal_89[iVar0], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iVar0 + 10, 30f, 786469, 10f, 5f, 1);
						}
						if (!iLocal_65)
						{
						...
						if (!PED::IS_PED_INJURED(iLocal_85[iVar0]))
						{
							if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_85[iVar0], 0))
							{
								TASK::TASK_DRIVE_BY(iLocal_85[iVar0], PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 1000f, 60, 1, -753768974);
					...
					else if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !iLocal_71[iVar0])
					{
						...
						{
							TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_85[iVar0], iLocal_89[iVar0], PLAYER::PLAYER_PED_ID(), iVar0 + 10, 30f, 786469, 10f, 5f, 1);
							if (!iLocal_65)
							{
								SYSTEM::WAIT(MISC::GET_RANDOM_INT_IN_RANGE(400, 800));
							}
			...
			{
				TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(iLocal_85[iVar0], PLAYER::PLAYER_PED_ID(), 1f, 0f, 0f, 2f, -1, 1036831949, 1);
			}
			if (!PED::IS_PED_INJURED(iLocal_85[iVar0]))
			{
...
int func_59(int iParam0, bool bParam1, int iParam2)//Position - 0x2DB9
{
	int iVar0;
...
int func_60(int iParam0, bool bParam1, bool bParam2)//Position - 0x2E03
{
	int iVar0;
...
float func_61(bool bParam0, float fParam1, float fParam2)//Position - 0x2EA7
{
	if (bParam0)
	{
		return fParam1;
...
int func_62(int iParam0)//Position - 0x2EBE
{
	if (func_66())
	{
		Global_111550 = 1;
...
void func_63(int iParam0)//Position - 0x2F11
{
	switch (iParam0)
	{
		case 0:
...
void func_64(char[4] cParam0, int iParam1)//Position - 0x2FF2
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

char* func_65(int iParam0)//Position - 0x3009
{
	char* sVar0;
...
int func_67(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x3083
{
	int iVar0;
...
void func_68(var uParam0, int iParam1)//Position - 0x31BA
{
	int iVar0;
...
bool func_69(int iParam0)//Position - 0x3209
{
	return func_70(iParam0, Global_41396);
}

int func_70(int iParam0, int iParam1)//Position - 0x321A
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_71(int iParam0)//Position - 0x33FB
{
	if (Global_41396 == 15)
	{
		return 0;
...
int func_74(float fParam0, bool bParam1)//Position - 0x375A
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_75(int iParam0, var uParam1)//Position - 0x3811
{
	switch (iParam0)
	{
		case 0:
...
int func_77(int iParam0)//Position - 0x4AEA
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_78(int iParam0)//Position - 0x4E30
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_79(int iParam0)//Position - 0x4E68
{
	struct<2> Var0;
...
bool func_82()//Position - 0x5304
{
	return Global_111278 > 0;
}

int func_83()//Position - 0x5312
{
	if (Global_95621 != -1)
	{
		return 1;
...
Vector3 func_86(int iParam0)//Position - 0x5378
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_87()//Position - 0x538B
{
}

void func_88(int iParam0)//Position - 0x5393
{
	if (iParam0 == -1)
	{
		iParam0 = func_29();
...
void func_90(int iParam0)//Position - 0x5406
{
	Global_111549 = iParam0;
}

int func_91(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x5414
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
	...
	if (!bVar0)
	{
		...
		if (!func_127(Global_111560.f_24990.f_43[iParam3]))
		{
			return 0;
		}
...
bool func_92(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x57AE
{
	if (bParam6)
	{
...
bool func_93(int iParam0)//Position - 0x57F5
{
	int iVar0;
...
int func_94(int iParam0)//Position - 0x5816
{
	return func_95(iParam0, 1);
}

int func_95(int iParam0, int iParam1)//Position - 0x5825
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_96(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x5878
{
	func_97(func_108(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_97(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x5896
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_98(float fParam0, float fParam1, float fParam2)//Position - 0x5A97
{
	float fVar0;
...
int func_99(int iParam0, int iParam1)//Position - 0x5AD9
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_100(int iParam0)//Position - 0x5B7B
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_101(int iParam0)//Position - 0x5B8E
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_102(int iParam0)//Position - 0x5BA1
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_103(int iParam0)//Position - 0x5BB4
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_104(int iParam0)//Position - 0x5BC6
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_105(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_105(bool bParam0, int iParam1, int iParam2)//Position - 0x5BEB
{
	if (bParam0)
	{
		return iParam1;
...
int func_106(int iParam0)//Position - 0x5C02
{
	return iParam0 & 15;
}

int func_107(int iParam0, int iParam1)//Position - 0x5C0F
{
	int iVar0;
	int iVar1;
...
void func_109(var uParam0, int iParam1)//Position - 0x5D61
{
	if (iParam1 <= 0)
	{
		return;
...
void func_110(var uParam0, int iParam1)//Position - 0x5DE7
{
...
void func_111(var uParam0, int iParam1)//Position - 0x5E1A
{
	int iVar0;
	int iVar1;
...
void func_112(var uParam0, int iParam1)//Position - 0x5E6B
{
...
void func_113(var uParam0, int iParam1)//Position - 0x5EA5
{
...
void func_114(var uParam0, int iParam1)//Position - 0x5EE0
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_115(int iParam0)//Position - 0x5F1C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_116(int iParam0, int iParam1)//Position - 0x5FF8
{
...
int func_117(int iParam0)//Position - 0x601B
{
	int iVar0;
...
var func_118()//Position - 0x6738
{
	return Global_98708.f_1;
}

int func_119()//Position - 0x6746
{
	if (Global_95621 != -1)
	{
...
bool func_122()//Position - 0x67B0
{
	return Global_98721.f_346 > 0;
}

bool func_123()//Position - 0x67C1
{
	return Global_98721.f_345 > 0;
}

var func_124()//Position - 0x67D2
{
	return Global_1312873;
}

int func_125()//Position - 0x67DE
{
...
bool func_127(int iParam0)//Position - 0x6822
{
	return func_107(func_108(), iParam0);
}

int func_128(int iParam0, int iParam1, int iParam2)//Position - 0x6834
{
	int iVar0;
	int iVar1;
...
int func_129(int iParam0)//Position - 0x6918
{
	if (!func_22(iParam0))
	{
		return 7;
...
bool func_130(int iParam0)//Position - 0x693C
{
	int iVar0;
	bool bVar1;
...
int func_133()//Position - 0x6A99
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			{
				if (((((PED::IS_PED_IN_MODEL(PLAYER::PLAYER_PED_ID(), joaat("rhino")) || PED::IS_PED_IN_MODEL(PLAYER::PLAYER_PED_ID(), joaat("ambulance"))) || PED::IS_PED_IN_MODEL(PLAYER::PLAYER_PED_ID(), 1938952078)) || PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_FLYING_VEHICLE(PLAYER::PLAYER_PED_ID())) || Global_110607 == 1)
				{
					return 1;
				}
			}
...
void func_135(int iParam0)//Position - 0x6BAA
{
	char cVar0[64];
...
void func_136(var uParam0)//Position - 0x6C5F
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_137(int iParam0, bool bParam1)//Position - 0x6C9C
{
	switch (iParam0)
	{
		case 0:
...
void func_138(int iParam0)//Position - 0x6EE5
{
	Global_41947 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_139(int iParam0)//Position - 0x6EF7
{
	func_140(iParam0, 0, func_145(iParam0));
}

void func_140(int iParam0, int iParam1, int iParam2)//Position - 0x6F0C
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_141(var uParam0)//Position - 0x6F3B
{
	struct<16> Var0;
	int iVar16;
...
void func_142(int iParam0, var uParam1)//Position - 0x700C
{
	Global_111560.f_24990.f_43[iParam0] = *uParam1;
}

void func_143(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x7024
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_144(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x71A6
{
...
int func_145(int iParam0)//Position - 0x71DE
{
	int iVar0;
...
Vector3 func_146()//Position - 0x7381
{
	float fVar0;
