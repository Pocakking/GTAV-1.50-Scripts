...
void func_11()//Position - 0x1580
{
}

void func_12(var uParam0, int iParam1)//Position - 0x1588
{
...
void func_13()//Position - 0x15A5
{
	Global_19671 = 0;
	func_14();
}

void func_14()//Position - 0x15B5
{
...
int func_16()//Position - 0x1633
{
	func_17();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_17()//Position - 0x164C
{
	int iVar0;
...
bool func_18(int iParam0)//Position - 0x1749
{
	return Global_41396 == iParam0;
}

bool func_19(int iParam0)//Position - 0x1757
{
	return iParam0 < 3;
}

int func_20(int iParam0)//Position - 0x1763
{
	int iVar0;
	int iVar1;
...
int func_21(int iParam0)//Position - 0x17A0
{
	if (func_19(iParam0))
	{
...
var func_22(int iParam0)//Position - 0x17C5
{
	return Global_1798[iParam0 /*29*/];
}

void func_23(char* sParam0)//Position - 0x17D4
{
	struct<16> Var0;
...
void func_24(char* sParam0)//Position - 0x17FA
{
	int iVar0;
...
void func_25(char* sParam0)//Position - 0x1838
{
	int iVar0;
...
void func_26(int iParam0, char* sParam1)//Position - 0x187C
{
	switch (iParam0)
	{
		case 0:
...
void func_27(char* sParam0)//Position - 0x1A45
{
	char cVar0[64];
...
void func_28(char* sParam0)//Position - 0x1A79
{
	struct<4> Var0;
...
void func_29(char* sParam0)//Position - 0x1AA4
{
...
void func_30()//Position - 0x1AC5
{
	iLocal_254 = MISC::GET_RANDOM_INT_IN_RANGE(0, iLocal_253);
}

void func_31(char* sParam0)//Position - 0x1AD6
{
	int iVar0;
...
bool func_33(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1B42
{
...
int func_34(char* sParam0, int iParam1, bool bParam2)//Position - 0x1B90
{
	Global_20806 = 0;
...
bool func_37(int iParam0)//Position - 0x1EFD
{
	return func_38(iParam0, 20);
}

bool func_38(int iParam0, int iParam1)//Position - 0x1F0D
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_39()//Position - 0x1F28
{
	return -1;
}

void func_40()//Position - 0x1F31
{
	int iVar0;
...
bool func_46(int iParam0, int iParam1)//Position - 0x21AE
{
	switch (iParam0)
	{
		case 5:
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x21E9
{
...
void func_48(char[4] cParam0)//Position - 0x223F
{
	int iVar0;
...
void func_49(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x227A
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_50(char* sParam0)//Position - 0x2315
{
	int iVar0;
...
void func_51(var uParam0)//Position - 0x234D
{
}

void func_52(var uParam0, int iParam1, float fParam2)//Position - 0x2355
{
}

void func_53()//Position - 0x235D
{
	STREAMING::REMOVE_ANIM_DICT(&Local_388);
}

void func_54()//Position - 0x236C
{
	char* sVar0;
	struct<16> Var8;
...
void func_55(var uParam0)//Position - 0x23E2
{
}

void func_56(char* sParam0)//Position - 0x23EA
{
...
void func_57(int iParam0, char* sParam1, char* sParam2)//Position - 0x23FD
{
...
void func_64(char* sParam0)//Position - 0x2584
{
	struct<8> Var0;
...
void func_65(char* sParam0)//Position - 0x25C4
{
...
void func_67(int iParam0, bool bParam1)//Position - 0x25F3
{
	int iVar0;
...
void func_68(int iParam0, bool bParam1)//Position - 0x2614
{
	int iVar0;
...
void func_69(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x2685
{
	func_70(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_70(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x26A5
{
	int iVar0;
...
int func_72(int iParam0)//Position - 0x2997
{
	int iVar0;
	int iVar1;
...
int func_75(int iParam0)//Position - 0x2AE0
{
	if (func_77(iParam0))
	{
...
int func_76(int iParam0)//Position - 0x2B07
{
	int iVar0;
...
int func_77(int iParam0)//Position - 0x2B3A
{
...
int func_78(int iParam0)//Position - 0x2B64
{
	switch (iParam0)
	{
...
void func_79(int iParam0)//Position - 0x2C22
{
	if (iLocal_447 == 1)
	{
...
void func_80(int iParam0, int iParam1, bool bParam2)//Position - 0x2C41
{
	if (iLocal_447 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
...
int func_81(int iParam0, bool bParam1, int iParam2)//Position - 0x2C94
{
	int iVar0;
...
int func_82(int iParam0, bool bParam1, bool bParam2)//Position - 0x2CDE
{
	int iVar0;
...
float func_83(bool bParam0, float fParam1, float fParam2)//Position - 0x2D82
{
	if (bParam0)
	{
		return fParam1;
...
float func_84(int iParam0, int iParam1, bool bParam2)//Position - 0x2D99
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_85(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2DF7
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_86(vector3 vParam0, vector3 vParam3)//Position - 0x2E88
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_87(vector3 vParam0)//Position - 0x2EA9
{
	float fVar0;
	float fVar1;
...
int func_88(int iParam0)//Position - 0x2EE8
{
	var uVar0;
...
void func_91()//Position - 0x2F3C
{
	Global_19671 = 0;
	func_92();
}

void func_92()//Position - 0x2F4C
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_93()//Position - 0x2F6D
{
	return 1;
}

void func_94()//Position - 0x2F76
{
}

int func_95()//Position - 0x2F7E
{
	return 1;
}

float func_96(int iParam0, int iParam1)//Position - 0x2F87
{
	return func_84(iParam0, iParam1, 1);
}

void func_97(int iParam0)//Position - 0x2F98
{
	int iVar0;
...
int func_98(int iParam0)//Position - 0x2FC9
{
	int iVar0;
	int iVar1;
...
int func_99(int iParam0, bool bParam1)//Position - 0x2FFA
{
	if (!func_77(iParam0))
	{
		if (!bParam1)
...
void func_100(var uParam0, var uParam1)//Position - 0x30AD
{
	*uParam0 = (*uParam0 || uParam1);
}

void func_101(int iParam0, bool bParam1)//Position - 0x30BE
{
	if (iParam0 == 1)
	{
		TASK::TASK_PLAY_ANIM(iLocal_240, &cLocal_324, &Local_218, 2f, -2f, -1, 0, 0, 0, 0, 0);
...
int func_102(int iParam0)//Position - 0x3130
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_103()//Position - 0x3151
{
	func_104();
}

void func_104()//Position - 0x315D
{
...
int func_109()//Position - 0x32C2
{
	return 1;
}

bool func_110(var uParam0)//Position - 0x32CB
{
	return func_111(Global_111560.f_20112, uParam0);
}

bool func_111(var uParam0, var uParam1)//Position - 0x32E0
{
	return (uParam0 && uParam1) != 0;
}

int func_112(int iParam0)//Position - 0x32EF
{
...
void func_113(int iParam0)//Position - 0x3416
{
	var uVar0;
...
void func_114(int iParam0)//Position - 0x34E5
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
struct<6> func_115()//Position - 0x3505
{
	struct<6> Var0;
...
void func_116()//Position - 0x3529
{
	func_117();
}

void func_117()//Position - 0x3535
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_448))
	{
