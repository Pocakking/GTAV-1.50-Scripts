		...
		if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || iLocal_60 > 1)
		{
			...
			if (iLocal_60 > 0)
			{
				...
				if (ENTITY::IS_ENTITY_DEAD(iLocal_87, 0))
				{
					...
					{
						PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, iLocal_578, 1862763509);
						if (func_1(iLocal_82))
						{
...
bool func_9(int iParam0)//Position - 0x7B5
{
	return func_10(iParam0, 20);
}

bool func_10(int iParam0, int iParam1)//Position - 0x7C5
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_11()//Position - 0x7E0
{
	return -1;
}

void func_12()//Position - 0x7E9
{
	int iVar0;
...
bool func_19(int iParam0)//Position - 0xB27
{
	return iParam0 < 3;
}

int func_20(int iParam0)//Position - 0xB33
{
	int iVar0;
	int iVar1;
...
int func_21(int iParam0)//Position - 0xB70
{
	if (func_19(iParam0))
	{
...
var func_22(int iParam0)//Position - 0xB95
{
	return Global_1798[iParam0 /*29*/];
}

bool func_23(int iParam0)//Position - 0xBA4
{
	return Global_41396 == iParam0;
}

void func_24()//Position - 0xBB2
{
	int iVar0;
...
bool func_25(int iParam0, int iParam1)//Position - 0xC09
{
	switch (iParam0)
	{
		case 5:
...
void func_27(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC9B
{
...
void func_28(int iParam0)//Position - 0xCF1
{
...
void func_29(var uParam0)//Position - 0xD11
{
	*uParam0 = (MISC::GET_GAME_TIMER() - 5000);
}

int func_30(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5, int iParam6)//Position - 0xD24
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
void func_31(char* sParam0, int iParam1)//Position - 0xF7A
{
	func_33(sParam0);
	func_32(iParam1);
}

void func_32(int iParam0)//Position - 0xF8E
{
	if (iParam0 > 0)
	{
	}
...
void func_33(char* sParam0)//Position - 0xF9C
{
...
void func_34(int iParam0)//Position - 0xFAF
{
	AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(iParam0);
}

void func_35(char* sParam0)//Position - 0xFBD
{
	func_33(sParam0);
}

int func_36(int iParam0, int iParam1)//Position - 0xFCB
{
...
int func_38(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x10EE
{
	if (iParam3 == 0)
	{
	...
	if (func_1(PLAYER::PLAYER_PED_ID()) && func_1(iLocal_87))
	{
		switch (iLocal_202)
		{
			...
			case 1:
				...
				func_218(0);
				func_217();
				if (((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) && !func_216()) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_227)) && STREAMING::HAS_MODEL_LOADED(joaat("prop_ld_wallet_01")))
				{
					if (iLocal_591 == -1)
					{
					...
					if (!PED::IS_PED_RUNNING_MOBILE_PHONE_TASK(iLocal_87) || (MISC::GET_GAME_TIMER() - iLocal_591) > 2000)
					{
						...
						ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_173, PLAYER::PLAYER_PED_ID(), PED::GET_PED_BONE_INDEX(PLAYER::PLAYER_PED_ID(), 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
						...
						PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_200, false);
						...
						TASK::TASK_SYNCHRONIZED_SCENE(iLocal_87, iLocal_200, sLocal_227, sLocal_229, 1000f, -1000f, 1, 0, 1148846080, 0);
						PED::_0x2208438012482A1A(iLocal_87, 0, 0);
						WEAPON::HIDE_PED_WEAPON_FOR_SCRIPTED_CUTSCENE(PLAYER::PLAYER_PED_ID(), true);
						iVar8 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(335.98f, -839.47f, 28.31f, 10f, 1948359883, 1, 0, 1);
						if (ENTITY::DOES_ENTITY_EXIST(iVar8))
						{
							ENTITY::SET_ENTITY_COORDS(iVar8, 317.94f, -824.33f, 28.27f, 1, false, 0, 1);
						}
						func_100(&iVar8, 0);
						iVar8 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(336.86f, -840.08f, 28.27f, 10f, 1388308576, 1, 0, 1);
						if (ENTITY::DOES_ENTITY_EXIST(iVar8))
						{
							ENTITY::SET_ENTITY_COORDS(iVar8, 315.63f, -826.01f, 28.27f, 1, false, 0, 1);
						}
						func_100(&iVar8, 0);
						...
						MISC::CLEAR_AREA(PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_227, sLocal_229, vVar0, vVar3, 0, 2), 2f, 1, 0, 0, false);
			...
			case 2:
				...
				else
				{
					...
					if (ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), -3856156))
					{
						...
						{
							ENTITY::DETACH_ENTITY(iLocal_173, 0, true);
							ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_173, iLocal_87, PED::GET_PED_BONE_INDEX(iLocal_87, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
							iLocal_247 = 1;
						}
					}
					else
...
void func_40(int iParam0, int iParam1)//Position - 0x193C
{
	int iVar0;
...
int func_41(int iParam0, int iParam1, int iParam2)//Position - 0x195F
{
...
int func_42(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x1993
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_43(bool bParam0)//Position - 0x1F92
{
	int iVar0;
	int iVar1;
...
void func_44(int iParam0)//Position - 0x2214
{
	int iVar0;
...
void func_45(int iParam0)//Position - 0x226E
{
	bool bVar0;
	char cVar1[64];
...
char* func_46(int iParam0)//Position - 0x23FE
{
	switch (iParam0)
	{
		case 0:
...
void func_48(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x2507
{
	int iVar0;
...
int func_49(var uParam0)//Position - 0x2537
{
	int iVar0;
	int iVar1;
...
int func_50()//Position - 0x256B
{
	return Global_1312745;
}

int func_51(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x2577
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_52(int iParam0)//Position - 0x2BC9
{
	func_73(93, iParam0);
	func_73(29, iParam0);
	func_73(30, iParam0);
...
bool func_53(int iParam0)//Position - 0x2BE9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_54(int iParam0, int iParam1, int iParam2)//Position - 0x2D99
{
	int iVar0;
	var uVar1;
...
int func_55(int iParam0, int iParam1, int iParam2)//Position - 0x2DCB
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_56(int iParam0)//Position - 0x2E08
{
	int iVar0;
...
int func_57(int iParam0, int iParam1)//Position - 0x31A4
{
	int iVar0;
...
int func_58(bool bParam0)//Position - 0x351D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_59(int iParam0, int iParam1)//Position - 0x35D4
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_60(int iParam0, int iParam1)//Position - 0x35EF
{
...
int func_61(var uParam0, int iParam1)//Position - 0x368C
{
	int iVar0;
	var uVar1[78];
...
int func_62(var uParam0, int iParam1)//Position - 0x373D
{
	int iVar0;
...
bool func_63(var uParam0, int iParam1)//Position - 0x37B8
{
	return (*uParam0)[iParam1] == 78;
}

void func_64(var uParam0)//Position - 0x37C9
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x37FD
{
	(*uParam0)[iParam1] = 78;
}

void func_66(var uParam0, float fParam1)//Position - 0x380D
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_67(var uParam0)//Position - 0x382A
{
	return uParam0->f_80;
}

bool func_68(var uParam0, int iParam1)//Position - 0x3836
{
	return func_69(uParam0, iParam1) != -1;
}

int func_69(var uParam0, int iParam1)//Position - 0x3848
{
	int iVar0;
...
bool func_70(var uParam0)//Position - 0x3875
{
	return uParam0->f_79 == 1;
}

int func_71(int iParam0)//Position - 0x3883
{
	switch (iParam0)
	{
		case 60:
...
int func_72(int iParam0, int iParam1)//Position - 0x38D3
{
	int iVar0;
...
void func_73(int iParam0, int iParam1)//Position - 0x3924
{
	int iVar0;
...
int func_75(int iParam0)//Position - 0x39F6
{
	return Global_1798[iParam0 /*29*/].f_17;
}

void func_76(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x3A07
{
	int iVar0;
...
int func_77(int iParam0)//Position - 0x3AB0
{
	if (func_1(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_78(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x3AD0
{
	if (bParam0)
	{
...
bool func_79()//Position - 0x3C09
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_80(int iParam0, int iParam1)//Position - 0x3C26
{
	bool bVar0;
...
int func_81(int iParam0, bool bParam1)//Position - 0x3C71
{
	int iVar0;
	int iVar1;
...
int func_82(int iParam0)//Position - 0x3CB2
{
...
bool func_83()//Position - 0x3CF4
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_84(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x3D05
{
	int iVar0;
...
void func_85(int iParam0)//Position - 0x3D38
{
	if (iParam0 == 1)
	{
...
void func_86(int iParam0, bool bParam1)//Position - 0x3D5B
{
...
void func_87()//Position - 0x3D97
{
	Global_19671 = 0;
	func_88();
}

void func_88()//Position - 0x3DA7
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_89(int iParam0)//Position - 0x3DC8
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_91(vector3 vParam0)//Position - 0x3E91
{
...
int func_92(int iParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6)//Position - 0x3EBB
{
	bool bVar0;
	float fVar1;
...
int func_93(int iParam0, int iParam1)//Position - 0x3F17
{
	if (func_77(iParam0))
	{
...
void func_95(int iParam0, bool bParam1)//Position - 0x3F69
{
...
int func_96(int iParam0)//Position - 0x3F9B
{
	if (CAM::IS_SCREEN_FADED_IN())
	{
...
int func_98(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x4019
{
...
void func_99(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x406D
{
...
void func_100(int iParam0, bool bParam1)//Position - 0x4108
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_101(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x4143
{
	int iVar0;
...
Vector3 func_102(int iParam0)//Position - 0x4301
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_103(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x4314
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_104(int iParam0, int iParam1, int iParam2)//Position - 0x4B2A
{
	int iVar0;
...
int func_105(int iParam0)//Position - 0x4BB6
{
	switch (iParam0)
	{
...
void func_106(int iParam0, int iParam1, int iParam2)//Position - 0x4BF1
{
	int iVar0;
	int iVar1;
...
int func_107(int iParam0, int iParam1, int iParam2)//Position - 0x4C7B
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_108(int iParam0, int iParam1, int iParam2)//Position - 0x4D59
{
	Global_76389[1 /*14*/] = { func_150(iParam0, iParam1, iParam2, -1) };
	return MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 2);
}

int func_109(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x4D84
{
	var uVar0;
	int iVar10;
...
int func_110(int iParam0, int iParam1, int iParam2)//Position - 0x5388
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_111(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5421
{
	int iVar0;
...
int func_112(int iParam0, int iParam1, int iParam2)//Position - 0x54B7
{
	int iVar0;
	int iVar1;
...
int func_113(int iParam0)//Position - 0x5558
{
	switch (iParam0)
	{
		case 0:
...
int func_114(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5608
{
	int iVar0;
...
int func_115(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x590F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_116(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x64C2
{
	int iVar0;
...
int func_117(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x67A6
{
	int iVar0;
...
int func_118(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6A6D
{
	int iVar0;
	int iVar1;
...
int func_119(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6AA4
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0x6ACD
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_121(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6D97
{
	int iVar0;
...
int func_122(int iParam0, int iParam1, int iParam2)//Position - 0x7021
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_123(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7178
{
	int iVar0;
...
int func_124(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7210
{
	switch (iParam0)
	{
...
int func_125(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x72DE
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar41 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_113(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_126(int iParam0, int iParam1)//Position - 0x743A
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_127(int iParam0)//Position - 0x77E1
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_128(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7842
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_129(int iParam0, int iParam1)//Position - 0x793E
{
	int iVar0;
...
int func_130(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7A7C
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_113(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
int func_131(int iParam0)//Position - 0x7B5C
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_132(int iParam0, int iParam1)//Position - 0x7BE2
{
	int iVar0;
	struct<10> Var1;
...
void func_133(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8571
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
void func_134(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x869B
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_135(int iParam0, int iParam1)//Position - 0x86E3
{
	int iVar0;
	struct<17> Var1;
...
void func_136(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA52B
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
int func_137(int iParam0)//Position - 0xA715
{
	switch (iParam0)
	{
		case 0:
...
void func_138(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xA7C5
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_139(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA836
{
	switch (iParam0)
	{
		case joaat("player_zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_125(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_125(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_125(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, -1757550583, 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_125(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_140(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAAB3
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_141(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAED8
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_142(int iParam0, int iParam1)//Position - 0xB1CB
{
	int iVar0;
	int iVar1;
...
int func_143(int iParam0, int iParam1)//Position - 0xB211
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_144(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB271
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_145(int iParam0)//Position - 0xB2F5
{
...
void func_146(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xB3AD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_147(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xB3F7
{
	int iVar0;
...
int func_148(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xD295
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_149(int iParam0)//Position - 0xE1B3
{
	if (!MISC::IS_BIT_SET(Global_76389[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_150(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE204
{
	func_213();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_151(int iParam0, int iParam1)//Position - 0xE256
{
	switch (iParam0)
	{
		case 0:
...
void func_152(int iParam0)//Position - 0xE346
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xF5BD
{
	int iVar0;
	int iVar1;
...
bool func_154(int iParam0, int iParam1, var uParam2)//Position - 0xF94E
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_155(int iParam0, int iParam1)//Position - 0xFD53
{
	switch (iParam1)
	{
		case 0:
...
int func_156(int iParam0, int iParam1)//Position - 0x10150
{
	switch (iParam1)
	{
		case 0:
...
int func_157(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x1054B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_158(int iParam0)//Position - 0x1058D
{
	switch (iParam0)
	{
		case -1:
...
void func_159(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10661
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_153(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76558)
		{
			...
			func_153(&(Global_76389[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 7, -1, 0, -1, func_113(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_160(int iParam0)//Position - 0x1093A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x10A91
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0x10F9F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x11014
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x11088
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x1116F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x114D2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x116E3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x11913
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x11A23
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x123C2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x12F35
{
	if (iParam0 < 136)
	{
		func_173(iParam0);
...
void func_172(int iParam0)//Position - 0x12F6A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x13B6E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x14A7D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x14BAA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0, int iParam1)//Position - 0x14CA8
{
	switch (iParam0)
	{
		case 0:
...
void func_177(int iParam0)//Position - 0x14D98
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x16289
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_179(int iParam0)//Position - 0x163DA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180(int iParam0)//Position - 0x168E5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_181(int iParam0)//Position - 0x16F53
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_182(int iParam0)//Position - 0x16FC7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_184(int iParam0)//Position - 0x175C7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_185(int iParam0)//Position - 0x1775E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_186(int iParam0)//Position - 0x17F5C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_187(int iParam0)//Position - 0x1806D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_188(int iParam0)//Position - 0x18F98
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_189(int iParam0)//Position - 0x19C55
{
	if (iParam0 < 107)
	{
		func_192(iParam0);
...
void func_190(int iParam0)//Position - 0x19C9B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_191(int iParam0)//Position - 0x1A740
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_192(int iParam0)//Position - 0x1B52F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_193(int iParam0)//Position - 0x1C17A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_194(int iParam0)//Position - 0x1C3F3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_195(int iParam0, int iParam1)//Position - 0x1C539
{
	switch (iParam0)
	{
		case 0:
...
void func_196(int iParam0)//Position - 0x1C629
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_197(int iParam0)//Position - 0x1D3B3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_198(int iParam0)//Position - 0x1D52D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_199(int iParam0)//Position - 0x1DAA4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_200(int iParam0)//Position - 0x1DFCE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_201(int iParam0)//Position - 0x1E042
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_202(int iParam0)//Position - 0x1E112
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_203(int iParam0)//Position - 0x1E5EA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_204(int iParam0)//Position - 0x1E853
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_205(int iParam0)//Position - 0x1EB29
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_206(int iParam0)//Position - 0x1ECF2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_207(int iParam0)//Position - 0x1F846
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_208(int iParam0)//Position - 0x20491
{
	if (iParam0 < 60)
	{
		func_210(iParam0);
...
void func_209(int iParam0)//Position - 0x204C6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_210(int iParam0)//Position - 0x21266
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_211(int iParam0)//Position - 0x218F2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_212(int iParam0)//Position - 0x219D9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_213()//Position - 0x21AD7
{
...
int func_214(int iParam0, int iParam1, int iParam2)//Position - 0x21B50
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_215(bool bParam0)//Position - 0x21DAB
{
	int iVar0;
...
void func_217()//Position - 0x21E0B
{
...
void func_218(int iParam0)//Position - 0x21E5C
{
	if (func_223())
	{
		return;
...
void func_219(int iParam0)//Position - 0x21E8F
{
	if (func_223())
	{
		return;
...
void func_220(bool bParam0, bool bParam1)//Position - 0x21F19
{
	if (bParam0)
	{
		if (func_222(0))
...
bool func_221()//Position - 0x21F8D
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

int func_222(int iParam0)//Position - 0x21F9E
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
bool func_223()//Position - 0x21FF8
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

void func_224(int iParam0)//Position - 0x2200A
{
	if (func_1(iLocal_87))
	{
		if (iParam0 == 1)
...
int func_225(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x22047
{
...
void func_226(int iParam0)//Position - 0x221D6
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
bool func_227(int iParam0)//Position - 0x22202
{
	return func_228(func_229(iParam0));
}

int func_228(char* sParam0)//Position - 0x22214
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

char* func_229(int iParam0)//Position - 0x22227
{
	char* sVar0;
...
void func_230()//Position - 0x2226A
{
	if (func_1(iLocal_87))
	{
		...
		else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 20f, 20f, 20f, 0, 1, 0))
		{
			func_231();
			iLocal_60 = 6;
		}
		...
		else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 30f, 30f, 20f, 0, 1, 0))
		{
			iLocal_194 = 1;
		}
...
void func_231()//Position - 0x2234E
{
	func_232(iLocal_82);
	func_232(iLocal_83);
	func_232(iLocal_84);
...
void func_232(int iParam0)//Position - 0x22392
{
	if (func_1(iParam0))
	{
...
void func_233(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x223E4
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_234(int iParam0)//Position - 0x22434
{
	if (func_1(iParam0))
	{
		if (func_1(PLAYER::PLAYER_PED_ID()))
...
int func_235(int iParam0)//Position - 0x224D2
{
	var uVar0;
...
void func_236()//Position - 0x2252A
{
	if (func_1(iLocal_87))
	{
		func_237();
		switch (iLocal_79)
		{
			case 0:
				if (!PED::IS_PED_RUNNING_MOBILE_PHONE_TASK(iLocal_87))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 30f, 30f, 30f, 0, 0, 0) && func_98(&uLocal_248, "RECHAAU", "RECHA_TK", "RECHA_TK_1", 4, 0, 0))
					{
						iLocal_79++;
					}
				}
				else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 40f, 40f, 40f, 0, 0, 0) && func_5(&uLocal_248, "RECHAAU", "RECHA_WT", 4, 0, 0, 0))
				{
					iLocal_79++;
				}
				break;
...
void func_237()//Position - 0x225F4
{
...
void func_238(int iParam0, var uParam1)//Position - 0x22638
{
	int iVar0;
	int iVar1;
...
void func_239()//Position - 0x226D7
{
	if (iLocal_71 == 0 && func_1(iLocal_87))
	{
		if (iLocal_68 == 1)
		{
			if ((!func_216() && SYSTEM::TIMERA() > 8000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 12f, 12f, 5f, 0, 0, 0))
			{
				TASK::OPEN_SEQUENCE_TASK(&iLocal_186);
...
void func_240(int iParam0, char* sParam1, int iParam2)//Position - 0x22832
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_241(iParam2), 1);
}

int func_241(int iParam0)//Position - 0x22849
{
	int iVar0;
...
void func_242()//Position - 0x22A3E
{
...
void func_243()//Position - 0x22AF9
{
...
void func_244(int iParam0)//Position - 0x22B44
{
	switch (iParam0)
	{
		case 0:
...
void func_245(char[4] cParam0, int iParam1)//Position - 0x22C25
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

void func_246(var uParam0)//Position - 0x22C3C
{
	*uParam0 = -99;
}

void func_247()//Position - 0x22C4A
{
	func_28(&iLocal_174);
	func_29(&uLocal_592);
	func_28(&iLocal_175);
...
void func_248()//Position - 0x22C6B
{
	vector3 vVar0;
	vector3 vVar3;
	...
	if (iLocal_72 == 1)
	{
		...
		if (func_1(iLocal_87) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_87, sLocal_589, "pickup_low", 3))
		{
			...
			{
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_177, 1f, 20000, 1048576000, 0, 1193033728);
			}
			TASK::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_STAND_MOBILE", 0, 1);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_186);
			TASK::TASK_PERFORM_SEQUENCE(iLocal_87, iLocal_186);
	...
	else if ((((bLocal_69 == 0 && OBJECT::DOES_PICKUP_EXIST(iLocal_588)) && func_1(iLocal_87)) && ENTITY::IS_ENTITY_AT_COORD(iLocal_87, OBJECT::GET_PICKUP_COORDS(iLocal_588), 15f, 15f, 2f, false, true, 0)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_87, sLocal_583, sLocal_584, 3))
	{
		...
		if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_589) && !PED::IS_ANY_PED_SHOOTING_IN_AREA(vVar0, vVar3, 0, 1))
		{
			iLocal_71 = 1;
			if (!func_93(iLocal_87, 242628503))
			{
				...
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, OBJECT::GET_PICKUP_COORDS(iLocal_588), 2f, 20000, 1048576000, 0, 1193033728);
				}
...
void func_249(int iParam0)//Position - 0x22E93
{
...
void func_250()//Position - 0x22EAC
{
	if (!func_303())
	{
		func_302(&iLocal_82);
	...
	else if (func_299())
	{
		...
		iLocal_588 = OBJECT::CREATE_PICKUP(joaat("pickup_money_wallet"), vLocal_240, iLocal_221, iLocal_199, 1, iLocal_226);
		func_247();
	...
	else
	{
		...
		{
			func_256(iLocal_174, iLocal_82, fLocal_590, 1061158912, 0);
...
void func_251()//Position - 0x22FF7
{
	...
	{
		if (MISC::IS_BULLET_IN_AREA(vLocal_62, 50f, 0))
		{
			func_224(0);
...
void func_252()//Position - 0x23051
{
	if (func_1(iLocal_87))
	{
		...
		{
			case 0:
				if (((iLocal_197 == 0 && !func_216()) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 40f, 40f, 40f, 0, 0, 0)) && func_5(&uLocal_248, "RECHAAU", "RECHA_GET", 4, 0, 0, 0))
				{
					iLocal_197 = 1;
				}
			...
			case 1:
				if (((!func_216() && (MISC::GET_GAME_TIMER() - iLocal_78) > 1000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 20f, 20f, 20f, 0, 0, 0)) && func_5(&uLocal_248, "RECHAAU", "RECHA_PCA", 4, 0, 0, 0))
				{
					iLocal_78 = MISC::GET_GAME_TIMER();
					iLocal_220 = 2;
					iLocal_77++;
			...
			case 2:
				if (((!func_216() && (MISC::GET_GAME_TIMER() - iLocal_78) > 5000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 20f, 20f, 20f, 0, 0, 0)) && func_5(&uLocal_248, "RECHAAU", "RECHA_PCB", 4, 0, 0, 0))
				{
					iLocal_78 = MISC::GET_GAME_TIMER();
					iLocal_220 = 3;
					iLocal_77++;
			...
			case 3:
				if (((!func_216() && (MISC::GET_GAME_TIMER() - iLocal_78) > 6000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 20f, 20f, 20f, 0, 0, 0)) && func_5(&uLocal_248, "RECHAAU", "RECHA_PCC", 4, 0, 0, 0))
				{
					iLocal_78 = MISC::GET_GAME_TIMER();
					iLocal_220 = 4;
					iLocal_77++;
			...
			case 4:
				if (((!func_216() && (MISC::GET_GAME_TIMER() - iLocal_78) > 6000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 15f, 15f, 15f, 0, 0, 0)) && func_5(&uLocal_248, "RECHAAU", "RECHA_PCD", 4, 0, 0, 0))
				{
					iLocal_220 = 5;
					iLocal_77++;
				}
...
int func_253()//Position - 0x233E9
{
	if (func_1(iLocal_87))
	{
		if (func_254())
		{
			...
			else if (((ENTITY::DOES_ENTITY_EXIST(iLocal_82) && ENTITY::IS_ENTITY_DEAD(iLocal_82, 0)) && ENTITY::IS_ENTITY_AT_COORD(iLocal_87, ENTITY::GET_ENTITY_COORDS(iLocal_82, false), 20f, 20f, 10f, false, true, 0)) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iLocal_87, iLocal_82, 17))
			{
				return 1;
			}
		}
...
float func_255(int iParam0, int iParam1, bool bParam2)//Position - 0x234DA
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_256(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)//Position - 0x23538
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_257()//Position - 0x23691
{
	switch (iLocal_61)
	{
		case 0:
			if ((func_1(iLocal_82) && func_1(iLocal_83)) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_92, 0))
			{
				...
				VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_92, true, true, 0);
				PED::FORCE_PED_MOTION_STATE(iLocal_82, -1115154469, false, 0, 0);
				iLocal_61 = 1;
			}
			else
			{
		...
		case 2:
			if (iLocal_65 == 0)
			{
				if (!PED::IS_PED_INJURED(iLocal_82) && !PED::IS_PED_INJURED(iLocal_83))
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_92, 0))
					{
						if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_92, vLocal_93, 30f, 30f, 5f, false, true, 0) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_83, 0))
						{
		...
		case 3:
			...
			if (((((((iLocal_75 < 4 && (MISC::GET_GAME_TIMER() - iLocal_76) > 10000) && func_1(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && !func_216()) && !PED::IS_PED_INJURED(iLocal_82)) && func_255(PLAYER::PLAYER_PED_ID(), iLocal_82, 1) < 40f) && func_5(&uLocal_248, "RECHAAU", "RECHA_YELL", 4, 0, 0, 0))
			{
				iLocal_75++;
				iLocal_76 = MISC::GET_GAME_TIMER();
			}
...
void func_258()//Position - 0x238B5
{
	if (((((((iLocal_191 == 1 && (MISC::GET_GAME_TIMER() - iLocal_80) > 8000) && !func_216()) && func_1(iLocal_82)) && func_1(iLocal_87)) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_82, 20f, 20f, 20f, 0, 1, 0)) && !ENTITY::IS_ENTITY_AT_ENTITY(iLocal_82, iLocal_87, 30f, 30f, 30f, 0, 1, 0)) && func_5(&uLocal_248, "RECHAAU", "RECHA_taunt", 4, 0, 0, 0))
	{
		iLocal_80 = MISC::GET_GAME_TIMER();
	}
}

void func_259()//Position - 0x23951
{
	if (iLocal_66 == 0)
	{
		iLocal_66 = 1;
...
void func_260()//Position - 0x23A9A
{
	char* sVar0;
...
void func_261(int iParam0)//Position - 0x23AFE
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_262()//Position - 0x23B36
{
	...
	iLocal_188 = 0;
	iVar9 = 10;
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_97[0], 0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_97[1], 0))
	{
			...
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (VEHICLE::_0xA4822F1CF23F4810(&vVar6, &vVar0, &vVar3, 0f, 180f, 75f, false, 1, 1))
				{
					...
					while (iLocal_188 < 2)
					{
						...
						iLocal_100[iLocal_188] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_97[iLocal_188], 22, iLocal_222, -1, 1, true);
						iLocal_103[iLocal_188] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_97[iLocal_188], 22, iLocal_222, 0, 1, true);
						...
						{
							TASK::TASK_VEHICLE_MISSION(iLocal_100[iLocal_188], iLocal_97[iLocal_188], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iVar9, 40f, 786469, 5f, 10f, 1);
						}
						else
						{
							TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_100[iLocal_188], iLocal_97[iLocal_188], PLAYER::PLAYER_PED_ID(), iVar9, 40f, 786469, 5f, 10f, 1);
						}
...
int func_264()//Position - 0x23DDE
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_92, 0))
	{
		...
		if (func_1(iLocal_82))
		{
			...
			else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_82, PLAYER::PLAYER_PED_ID(), 1))
			{
				return 1;
			}
			...
			if ((iLocal_61 == 1 && !PED::IS_PED_IN_VEHICLE(iLocal_82, iLocal_92, 1)) && !VEHICLE::_0x639431E895B9AA57(iLocal_82, iLocal_92, 0, 0, false))
			{
				return 1;
			}
		}
...
void func_266()//Position - 0x23F73
{
	if (iLocal_66 == 0)
	{
		...
		if ((((func_1(iLocal_83) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_83, 0)) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_83, -1273030092) == 1) && !TASK::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(iLocal_83)) && !PED::IS_PED_IN_COMBAT(iLocal_83, 0))
		{
		...
		if ((func_1(iLocal_85) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_85, 0)) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_85, 242628503) == 7)
		{
...
void func_268(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x240F7
{
	func_269(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_269(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x24114
{
	...
	uParam0->f_6 = 2;
	func_270(uParam0, iParam1, vParam2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

void func_270(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2414C
{
	int iVar0;
	int iVar1;
...
void func_271(var uParam0)//Position - 0x244B9
{
...
int func_272(var uParam0)//Position - 0x24522
{
	int iVar0;
...
int func_273(bool bParam0)//Position - 0x2454D
{
	switch (Global_41396)
	{
		case 0:
...
int func_274(char* sParam0)//Position - 0x245F7
{
	if (!func_275(1, 1, 0))
	{
...
int func_275(bool bParam0, bool bParam1, bool bParam2)//Position - 0x24690
{
	int iVar0;
	int iVar1;
	...
	if ((func_282() || func_281(Global_4456448.f_190930)) || func_280())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::IS_TURRET_SEAT(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 562680400 && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == 1181327175 && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == -1693015116 && iVar1 == 0) && func_278(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_276(int iParam0)//Position - 0x248E9
{
	if (iParam0 != func_11())
	{
...
int func_277(int iParam0, bool bParam1, bool bParam2)//Position - 0x2494F
{
	int iVar0;
...
int func_278(int iParam0, int iParam1)//Position - 0x24999
{
...
int func_279(int iParam0, int iParam1)//Position - 0x249FB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_280()//Position - 0x24A80
{
	return Global_2448961.f_17;
}

bool func_281(int iParam0)//Position - 0x24A8E
{
	return iParam0 == 51;
}

var func_282()//Position - 0x24A9B
{
	return Global_2448961.f_16;
}

bool func_283()//Position - 0x24AA9
{
	return MISC::GET_GAME_TIMER() <= Global_22350.f_5878 + 100;
}

void func_284(var uParam0, int iParam1, vector3 vParam2, int iParam5)//Position - 0x24ABE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_285()//Position - 0x24BCE
{
	return func_286(PLAYER::PLAYER_ID());
}

int func_286(int iParam0)//Position - 0x24BDE
{
...
bool func_287(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x24BFD
{
	if (bParam6)
	{
...
int func_288(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x24C44
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_289(bool bParam0, bool bParam1, bool bParam2)//Position - 0x24FB0
{
...
int func_290(bool bParam0, bool bParam1, bool bParam2)//Position - 0x25002
{
	if (!func_275(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_291(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2504B
{
	if (!func_275(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_292(bool bParam0, bool bParam1, bool bParam2)//Position - 0x250AA
{
	if (!func_275(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_293(int iParam0)//Position - 0x25100
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_294()//Position - 0x2515B
{
	MISC::SET_BIT(&Global_7357, 4);
}

void func_295(var uParam0, int iParam1, int iParam2)//Position - 0x2516B
{
	char* sVar0;
...
int func_296(int iParam0)//Position - 0x25248
{
	return func_297(iParam0);
}

int func_297(int iParam0)//Position - 0x25256
{
	int iVar0;
...
float func_298(bool bParam0, float fParam1, float fParam2)//Position - 0x2528E
{
	if (bParam0)
	{
		return fParam1;
...
void func_300(int iParam0)//Position - 0x252C9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_301(int iParam0)//Position - 0x25365
{
	if (func_1(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_302(int iParam0)//Position - 0x2538F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_304()//Position - 0x2544A
{
	if (iLocal_195 == 1)
	{
		...
		if (func_1(iLocal_82))
		{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_92, 0) && !func_264())
			{
		...
		if (func_1(iLocal_87))
		{
			if ((!func_216() && func_5(&uLocal_248, "RECHAAU", "RECHA_STO", 4, 0, 0, 0)) || func_255(PLAYER::PLAYER_PED_ID(), iLocal_87, 1) < 20f)
			{
				...
				if (func_1(iLocal_82))
				{
					...
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_177, 2f, 20000, 2f, 8192, 1193033728);
...
void func_305()//Position - 0x25623
{
	Global_19671 = 0;
	func_26();
}

void func_306()//Position - 0x25633
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_307()//Position - 0x25725
{
...
void func_308(int iParam0, var uParam1)//Position - 0x257DC
{
	if (HUD::DOES_BLIP_EXIST(iParam0))
	{
...
bool func_309(int iParam0)//Position - 0x2583A
{
	return MISC::IS_BIT_SET(Global_111556, iParam0);
}

void func_310(int iParam0)//Position - 0x2584C
{
	if (iParam0 == 1)
	{
...
int func_311(int iParam0, bool bParam1, int iParam2)//Position - 0x258B7
{
	iParam2 = iParam2;
	return func_312(iParam0, bParam1, 145);
}

int func_312(int iParam0, bool bParam1, int iParam2)//Position - 0x258CD
{
	int iVar0;
...
int func_313(int iParam0, bool bParam1, bool bParam2)//Position - 0x25917
{
	int iVar0;
...
int func_314(int iParam0)//Position - 0x259BB
{
	if (func_316())
	{
		Global_111550 = 1;
...
int func_315(int iParam0)//Position - 0x25A0E
{
	switch (iParam0)
	{
		case 29:
...
int func_317(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x25A73
{
	int iVar0;
...
void func_318(var uParam0, int iParam1)//Position - 0x25BAA
{
	int iVar0;
...
bool func_319(int iParam0)//Position - 0x25BF9
{
	return func_320(iParam0, Global_41396);
}

int func_320(int iParam0, int iParam1)//Position - 0x25C0A
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_321(int iParam0)//Position - 0x25DEB
{
	if (Global_41396 == 15)
	{
		return 0;
...
int func_322()//Position - 0x25E0D
{
	...
	if (iLocal_203 == 1)
	{
		...
		fVar6 = 167.5f;
		if ((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vVar0, vVar3, fVar6, 0, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_204, 20f, 20f, 20f, false, true, 0)) || MISC::IS_BULLET_IN_ANGLED_AREA(vVar0, vVar3, fVar6, 1)) || MISC::IS_PROJECTILE_TYPE_IN_ANGLED_AREA(vVar0, vVar3, fVar6, joaat("weapon_rpg"), 0)) || PED::IS_PED_INJURED(iLocal_82))
		{
			return 1;
		}
	}
	else if (iLocal_203 == 2)
	{
		...
		fVar6 = 100f;
		if ((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vVar0, vVar3, fVar6, 0, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_207, 20f, 20f, 20f, false, true, 0)) || MISC::IS_BULLET_IN_ANGLED_AREA(vVar0, vVar3, fVar6, 1)) || MISC::IS_PROJECTILE_TYPE_IN_ANGLED_AREA(vVar0, vVar3, fVar6, joaat("weapon_rpg"), 0)) || PED::IS_PED_INJURED(iLocal_82))
		{
			return 1;
		}
	}
	else if (iLocal_203 == 3)
	{
		...
		fVar6 = 96.75f;
		if ((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vVar0, vVar3, fVar6, 0, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_177, 20f, 20f, 20f, false, true, 0)) || MISC::IS_BULLET_IN_ANGLED_AREA(vVar0, vVar3, fVar6, 1)) || MISC::IS_PROJECTILE_TYPE_IN_ANGLED_AREA(vVar0, vVar3, fVar6, joaat("weapon_rpg"), 0)) || PED::IS_PED_INJURED(iLocal_82))
		{
			return 1;
		}
	}
...
int func_324(float fParam0, bool bParam1)//Position - 0x26139
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_325(int iParam0, var uParam1)//Position - 0x261F0
{
	switch (iParam0)
	{
		case 0:
...
int func_327(int iParam0)//Position - 0x27436
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_328(int iParam0)//Position - 0x2777C
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_329(int iParam0)//Position - 0x277B3
{
	struct<2> Var0;
...
bool func_333()//Position - 0x27C94
{
	return Global_111278 > 0;
}

int func_334()//Position - 0x27CA2
{
	if (Global_95621 != -1)
	{
		return 1;
...
void func_336()//Position - 0x27CDD
{
	int iVar0[2];
	vector3 vVar3[2];
	float fVar10[2];
	
	MISC::CLEAR_AREA(vLocal_88, 20f, 1, 0, 0, false);
	iLocal_87 = PED::CREATE_PED(26, iLocal_223, vLocal_88, fLocal_91, 1, true);
	...
	iLocal_82 = PED::CREATE_PED(26, iLocal_222, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_87, vLocal_243), fLocal_86, 1, true);
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_578, 1862763509);
	switch (iLocal_203)
	{
		case 1:
			iLocal_83 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_92, 22, iLocal_222, -1, 1, true);
		...
		case 3:
			...
			{
				iLocal_84 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_92, 22, iLocal_222, 1, 1, true);
				iLocal_85 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_92, 22, iLocal_222, 2, 1, true);
	...
	{
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_92, 1, 0, false);
	}
	ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iLocal_82, PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_580, sLocal_582, vLocal_231, vLocal_234, 0, 2), 0, 0, 1);
	vLocal_237 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_580, sLocal_582, vLocal_231, vLocal_234, 0, 2) };
	ENTITY::SET_ENTITY_HEADING(iLocal_82, vLocal_237.z);
	ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iLocal_87, PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_580, sLocal_581, vLocal_231, vLocal_234, 0, 2), 0, 0, 1);
	vLocal_237 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_580, sLocal_581, vLocal_231, vLocal_234, 0, 2) };
	...
	if (iLocal_203 == 2)
	{
		...
		while (iLocal_188 <= 1)
		{
			...
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iVar0[iLocal_188], 1084227584);
			iLocal_188++;
		}
	}
	if (iLocal_203 == 3)
	{
		iLocal_187 = PED::ADD_SCENARIO_BLOCKING_AREA(1608.8f, 4824.81f, 0f, 1730.9f, 4856.1f, 51.1f, 0, 1, 1, 1);
...
void func_337(int iParam0)//Position - 0x2821F
{
	if (func_1(iParam0))
	{
...
int func_339(var uParam0)//Position - 0x2838A
{
	int iVar0;
...
bool func_340(var uParam0)//Position - 0x283EC
{
	return func_341(*uParam0, "NULL", uParam0->f_1);
}

int func_341(int iParam0, char* sParam1, int iParam2)//Position - 0x28401
{
...
int func_342(int iParam0)//Position - 0x284F5
{
	int iVar0;
...
void func_343(var uParam0, int iParam1)//Position - 0x28521
{
	if (iParam1 > 0)
	{
...
void func_344(var uParam0, int iParam1)//Position - 0x28538
{
	func_345(uParam0, 0, iParam1, 0);
}

void func_345(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2854A
{
	int iVar0;
...
int func_346(int iParam0)//Position - 0x2860D
{
	switch (iParam0)
	{
		case -1:
...
void func_348(var uParam0)//Position - 0x28732
{
	int iVar0;
...
void func_349(int iParam0)//Position - 0x287BC
{
	func_350(iParam0, "NULL", iParam0->f_1);
}

void func_350(int iParam0, char* sParam1, int iParam2)//Position - 0x287D0
{
	if (MISC::IS_BIT_SET(*iParam0, 30))
	{
		switch (func_342(*iParam0))
...
void func_351()//Position - 0x288AA
{
}

void func_352()//Position - 0x288B2
{
...
int func_354(int iParam0, int iParam1)//Position - 0x28C3E
{
...
void func_355(int iParam0)//Position - 0x28C61
{
	if (iParam0 == -1)
	{
		iParam0 = func_358();
...
void func_356()//Position - 0x28C97
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
...
void func_357(int iParam0)//Position - 0x28CD4
{
	Global_111549 = iParam0;
}

int func_358()//Position - 0x28CE2
{
	struct<16> Var0;
	var uVar16;
...
int func_359(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x28CFF
{
...
int func_360(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x28ED9
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
...
bool func_361(int iParam0)//Position - 0x29273
{
	int iVar0;
...
int func_362(int iParam0)//Position - 0x29294
{
	return func_363(iParam0, 1);
}

int func_363(int iParam0, int iParam1)//Position - 0x292A3
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_364(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x292F6
{
	func_365(func_376(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_365(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x29314
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_366(float fParam0, float fParam1, float fParam2)//Position - 0x29515
{
	float fVar0;
...
int func_367(int iParam0, int iParam1)//Position - 0x29557
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_368(int iParam0)//Position - 0x295F9
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_369(int iParam0)//Position - 0x2960C
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_370(int iParam0)//Position - 0x2961F
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_371(int iParam0)//Position - 0x29632
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_372(int iParam0)//Position - 0x29644
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_373(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_373(bool bParam0, int iParam1, int iParam2)//Position - 0x29669
{
	if (bParam0)
	{
		return iParam1;
...
int func_374(int iParam0)//Position - 0x29680
{
	return iParam0 & 15;
}

int func_375(int iParam0, int iParam1)//Position - 0x2968D
{
	int iVar0;
	int iVar1;
...
void func_377(var uParam0, int iParam1)//Position - 0x297DF
{
	if (iParam1 <= 0)
	{
		return;
...
void func_378(var uParam0, int iParam1)//Position - 0x29865
{
...
void func_379(var uParam0, int iParam1)//Position - 0x29898
{
	int iVar0;
	int iVar1;
...
void func_380(var uParam0, int iParam1)//Position - 0x298E9
{
...
void func_381(var uParam0, int iParam1)//Position - 0x29923
{
...
void func_382(var uParam0, int iParam1)//Position - 0x2995E
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_383(int iParam0)//Position - 0x2999A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_384(int iParam0)//Position - 0x29A76
{
	int iVar0;
...
var func_385()//Position - 0x2A193
{
	return Global_98708.f_1;
}

int func_386()//Position - 0x2A1A1
{
	if (Global_95621 != -1)
	{
...
bool func_389()//Position - 0x2A20B
{
	return Global_98721.f_346 > 0;
}

bool func_390()//Position - 0x2A21C
{
	return Global_98721.f_345 > 0;
}

var func_391()//Position - 0x2A22D
{
	return Global_1312873;
}

int func_392()//Position - 0x2A239
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_394(int iParam0)//Position - 0x2A27D
{
	return func_375(func_376(), iParam0);
}

int func_395(int iParam0, int iParam1, int iParam2)//Position - 0x2A28F
{
	int iVar0;
	int iVar1;
...
int func_396(int iParam0)//Position - 0x2A373
{
	if (!func_19(iParam0))
	{
		return 7;
...
bool func_397(int iParam0)//Position - 0x2A397
{
	int iVar0;
	bool bVar1;
...
bool func_399(bool bParam0)//Position - 0x2A439
{
...
Vector3 func_401()//Position - 0x2A51F
{
	float fVar0;
...
void func_402()//Position - 0x2A60D
{
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_187, 0);
...
void func_403(int iParam0)//Position - 0x2A779
{
	char cVar0[64];
...
void func_404(var uParam0)//Position - 0x2A82E
{
	if (*uParam0 == -1)
	{
		return;
...
int func_405(int iParam0)//Position - 0x2A86B
{
	int iVar0;
...
char* func_406(int iParam0, bool bParam1)//Position - 0x2A91C
{
	switch (iParam0)
	{
		case 0:
...
void func_407(int iParam0)//Position - 0x2AB65
{
	Global_41947 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_408(int iParam0)//Position - 0x2AB77
{
	func_409(iParam0, 0, func_414(iParam0));
}

void func_409(int iParam0, int iParam1, int iParam2)//Position - 0x2AB8C
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_410(var uParam0)//Position - 0x2ABBB
{
	struct<16> Var0;
	int iVar16;
...
void func_411(int iParam0, var uParam1)//Position - 0x2AC8B
{
	Global_111560.f_24990.f_43[iParam0] = *uParam1;
}

void func_412(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2ACA3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_413(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2AE25
{
...
int func_414(int iParam0)//Position - 0x2AE5D
{
	int iVar0;
...
void func_416(var uParam0, bool bParam1)//Position - 0x2B02B
{
	int iVar0;
...
void func_417(var uParam0)//Position - 0x2B06B
{
	*uParam0 = 0;
	uParam0->f_1 = -1;
}

void func_418(var uParam0)//Position - 0x2B07C
{
	int iVar0;
...
void func_419(var uParam0)//Position - 0x2B0B5
{
	func_420(*uParam0, "NULL", uParam0->f_1);
}

void func_420(int iParam0, char* sParam1, int iParam2)//Position - 0x2B0CA
{
	if (MISC::IS_BIT_SET(iParam0, 30))
	{
		switch (func_342(iParam0))
...
void func_421(var uParam0, int iParam1)//Position - 0x2B18A
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
void func_422()//Position - 0x2B1A7
{
	if (!bLocal_70)
	{
		func_436();
...
void func_423(int iParam0, int iParam1)//Position - 0x2B1E6
{
	if (iParam0 == -1)
	{
		iParam0 = func_358();
...
void func_424(int iParam0, var uParam1, var uParam2)//Position - 0x2B2EA
{
	bool bVar0;
...
void func_425()//Position - 0x2B3D2
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_427()//Position - 0x2B8DE
{
	return Global_30736;
}

int func_428(int iParam0, int iParam1)//Position - 0x2B8E9
{
	switch (iParam0)
	{
		case 0:
...
void func_429(int iParam0)//Position - 0x2BC5D
{
	int iVar0;
	int iVar1;
...
void func_430(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x2BC9F
{
	func_431(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_431(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2BCC0
{
	int iVar0;
...
void func_432()//Position - 0x2BE93
{
	int iVar0;
...
int func_433(int iParam0)//Position - 0x2BFB3
{
	int iVar0;
	int iVar1;
...
void func_434(int iParam0, int iParam1)//Position - 0x2BFF6
{
	MISC::SET_BIT(&(Global_111560.f_24990.f_8[iParam0]), iParam1);
}

void func_435()//Position - 0x2C014
{
	func_426();
}

int func_436()//Position - 0x2C021
{
	return 1;
}
