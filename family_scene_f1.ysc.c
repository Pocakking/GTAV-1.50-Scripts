...
void __EntryFunction__()//Position - 0x0
{
	...
	while (iLocal_85)
	{
		...
		{
			func_36(&uLocal_145, &iLocal_146, &uLocal_149, &uLocal_150, vLocal_114, "v_franklinshouse");
			if (func_35(126))
			{
...
int func_1(int iParam0, var uParam1, vector3 vParam2, vector3 vParam5, var uParam8)//Position - 0xF3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_2(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x5C6
{
	struct<15> Var0;
	int iVar15;
...
void func_3(int iParam0)//Position - 0x746
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_4(int iParam0)//Position - 0x80A
{
	switch (iParam0)
	{
		case 0:
...
bool func_5(bool bParam0)//Position - 0x874
{
...
int func_6(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)//Position - 0x89F
{
	struct<14> Var0;
...
void func_8(vector3 vParam0, vector3 vParam3, var uParam6)//Position - 0x9FE
{
	if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
	{
		if (MISC::HAS_BULLET_IMPACTED_IN_BOX(vParam0, vParam3, 1, 1))
		{
			*uParam6++;
			if (*uParam6 > 6)
			{
		...
		else if ((FIRE::IS_EXPLOSION_IN_AREA(0, vParam0, vParam3) || FIRE::IS_EXPLOSION_IN_AREA(2, vParam0, vParam3)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(vParam0, vParam3, joaat("weapon_grenadelauncher"), 1))
		{
			Global_93722 = 5;
		}
	}
...
void func_9(vector3 vParam0, vector3 vParam3)//Position - 0xA79
{
	int iVar0;
...
void func_10(var uParam0, var uParam1)//Position - 0xABD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_11(int iParam0)//Position - 0xB74
{
	int iVar0;
...
void func_12(vector3 vParam0, vector3 vParam3, var uParam6)//Position - 0xBD7
{
...
void func_13(vector3 vParam0, vector3 vParam3)//Position - 0xC4E
{
	int iVar0;
	...
	if (WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &iVar0, 1))
	{
		...
		{
			if (MISC::IS_PROJECTILE_TYPE_IN_AREA(vParam0, vParam3, iVar0, 1))
			{
				Global_93722 = 0;
			}
		}
...
bool func_14(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0xC85
{
	if (bParam6)
	{
...
int func_15(int iParam0, int iParam1)//Position - 0xCCC
{
...
int func_16(int iParam0, int iParam1)//Position - 0xCF6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_17(int iParam0)//Position - 0xD66
{
	if (iParam0 < 9)
	{
...
int func_18(int iParam0, int iParam1)//Position - 0xD84
{
	int iVar0;
...
int func_19(int iParam0)//Position - 0xF0E
{
	if (iParam0 == 145)
	{
		return 7;
...
var func_20(int iParam0)//Position - 0xF66
{
	return Global_1798[iParam0 /*29*/].f_11;
}

int func_21()//Position - 0xF77
{
...
bool func_24(int iParam0)//Position - 0x10AF
{
	return Global_41396 == iParam0;
}

int func_25(int iParam0)//Position - 0x10BD
{
	int iVar0;
	int iVar1;
...
int func_26(int iParam0)//Position - 0x10FA
{
	if (func_29(iParam0))
	{
...
var func_27(int iParam0)//Position - 0x111F
{
	return Global_1798[iParam0 /*29*/];
}

int func_28(int iParam0)//Position - 0x112E
{
	if (func_29(iParam0))
	{
...
bool func_29(int iParam0)//Position - 0x117C
{
	return iParam0 < 3;
}

int func_30(int iParam0)//Position - 0x1188
{
	switch (iParam0)
	{
		case 0:
...
bool func_31(int iParam0)//Position - 0x11BF
{
	func_23();
...
bool func_33(var uParam0, var uParam1)//Position - 0x1209
{
	return (uParam0 && uParam1) != 0;
}

int func_34()//Position - 0x1218
{
	func_23();
...
int func_35(int iParam0)//Position - 0x125E
{
...
void func_36(var uParam0, int iParam1, var uParam2, var uParam3, vector3 vParam4, int iParam7)//Position - 0x128B
{
	int iVar0;
	vector3 vVar1;
	...
	else if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		*uParam2 = INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID());
		if (!MISC::IS_STRING_NULL_OR_EMPTY(iParam7))
		{
			...
			{
				*uParam3 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vParam4, iParam7);
			}
		}
		func_38(iParam1);
		*uParam0 = 0;
	...
	if (INTERIOR::IS_VALID_INTERIOR(*uParam2) && INTERIOR::IS_INTERIOR_READY(*uParam2))
	{
		...
		else if (!MISC::IS_STRING_NULL_OR_EMPTY(iParam7))
		{
...
void func_37(char[4] cParam0, int iParam1)//Position - 0x14E8
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

void func_38(int iParam0)//Position - 0x14FF
{
	func_39(iParam0, 0f);
}

void func_39(int iParam0, float fParam1)//Position - 0x150E
{
...
float func_40(bool bParam0)//Position - 0x153C
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_41(var uParam0, float fParam1)//Position - 0x1594
{
	if (func_44(uParam0))
	{
...
float func_42(var uParam0)//Position - 0x15B6
{
	if (func_44(uParam0))
	{
		if (func_43(uParam0))
...
bool func_43(var uParam0)//Position - 0x15F5
{
	return MISC::IS_BIT_SET(*uParam0, 2);
}

bool func_44(var uParam0)//Position - 0x1605
{
	return MISC::IS_BIT_SET(*uParam0, 1);
}

int func_45(int iParam0, vector3 vParam1, float fParam4)//Position - 0x1615
{
	if (!func_46(iParam0))
	{
		return 0;
...
int func_48(int iParam0)//Position - 0x172F
{
	if (Global_41396 == 15)
	{
		return 0;
...
bool func_49(int iParam0)//Position - 0x1751
{
	return func_50(iParam0, Global_41396);
}

int func_50(int iParam0, int iParam1)//Position - 0x1762
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_51()//Position - 0x1943
{
	...
	func_52(&uLocal_156, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
}

void func_52(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1974
{
...
void func_53(struct<4> Param0)//Position - 0x1A0F
{
	vLocal_114 = { Param0 };
	uLocal_117 = Param0.f_3;
}

void func_54()//Position - 0x1A25
{
	int iVar0;
	int iVar1;
...
void func_55(int iParam0)//Position - 0x1A93
{
	int iVar0;
	int iVar1;
...
int func_56(int iParam0)//Position - 0x1AD1
{
	if (!func_29(iParam0))
	{
		return func_27(iParam0);
...
int func_57(int iParam0, int iParam1)//Position - 0x1AF7
{
	*iParam1 = 0;
	switch (iParam0)
	{
...
void func_58(int iParam0)//Position - 0x1C04
{
...
int func_59(int iParam0)//Position - 0x1C50
{
	switch (iParam0)
	{
		case 0:
...
void func_60(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9)//Position - 0x1C7D
{
	int iVar0;
	struct<8> Var1;
	int iVar17;
...
int func_61(int iParam0)//Position - 0x1F39
{
	int iVar0;
	int iVar1;
...
void func_62(int iParam0)//Position - 0x2060
{
	int iVar0;
	struct<10> Var1;
...
void func_63(int iParam0)//Position - 0x2119
{
	int iVar0;
	struct<14> Var1;
...
void func_64(int iParam0)//Position - 0x21E1
{
	struct<15> Var0;
	int iVar15;
	int iVar16;
...
void func_65(int iParam0)//Position - 0x228E
{
	struct<15> Var0;
	int iVar15;
	int iVar16;
...
int func_66(int iParam0)//Position - 0x234A
{
	int iVar0;
...
void func_67(int iParam0, int iParam1)//Position - 0x23A0
{
	int iVar0;
...
void func_68(int iParam0, int iParam1, int iParam2)//Position - 0x23D5
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
void func_69(int iParam0, int iParam1, int iParam2)//Position - 0x241A
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return;
...
int func_70(int iParam0, int iParam1)//Position - 0x245F
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_71(int iParam0, int iParam1, int iParam2)//Position - 0x2489
{
...
int func_72(int iParam0, int iParam1)//Position - 0x24BA
{
	if (iParam1 < 0 || iParam1 > 4)
	{
		return 0;
...
void func_73(int iParam0)//Position - 0x24E4
{
	int iVar0;
	int iVar1;
	struct<15> Var2;
...
void func_75(int iParam0)//Position - 0x2600
{
	if (iParam0 != -1)
	{
...
void func_76(int iParam0, int iParam1)//Position - 0x2618
{
	Global_30796[iParam0 /*11*/].f_10 = iParam1;
}

int func_77(int iParam0)//Position - 0x262B
{
	if (iParam0 != -1)
	{
...
void func_79(int iParam0, bool bParam1)//Position - 0x2738
{
	if (bParam1)
	{
...
void func_80(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, char* sParam5, int iParam6)//Position - 0x2764
{
	switch (iParam0)
	{
		case 0:
...
int func_81(int iParam0, char* sParam1)//Position - 0x2A2C
{
	switch (iParam0)
	{
		case 0:
...
int func_82(var uParam0, var uParam1, char* sParam2)//Position - 0x334A
{
	AUDIO::STOP_STREAM();
...
void func_83(int iParam0)//Position - 0x33C6
{
...
void func_84(int iParam0, int iParam1, bool bParam2)//Position - 0x3415
{
	int iVar0;
	bool bVar1;
...
int func_85(int iParam0, int iParam1)//Position - 0x34D1
{
	int iVar0;
...
int func_86(int iParam0, char* sParam1, int iParam2)//Position - 0x350A
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
