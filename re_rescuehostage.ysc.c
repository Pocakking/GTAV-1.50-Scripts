...
void func_3()//Position - 0x662
{
	if (func_4())
	{
		if (!PED::IS_PED_INJURED(iLocal_53))
		{
			...
			TASK::TASK_SMART_FLEE_COORD(iLocal_53, vLocal_48, 50f, -1, 0, 0);
			PED::SET_PED_KEEP_TASK(iLocal_53, true);
		...
		if (!PED::IS_PED_INJURED(iLocal_54))
		{
			...
			TASK::TASK_SMART_FLEE_COORD(iLocal_54, vLocal_48, 50f, -1, 0, 0);
...
int func_11()//Position - 0xDAB
{
	return -1;
}

void func_12()//Position - 0xDB4
{
	int iVar0;
...
int func_17()//Position - 0xFDD
{
	func_18();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_18()//Position - 0xFF6
{
	int iVar0;
...
bool func_19(int iParam0)//Position - 0x10F3
{
	return iParam0 < 3;
}

int func_20(int iParam0)//Position - 0x10FF
{
	int iVar0;
	int iVar1;
...
int func_21(int iParam0)//Position - 0x113C
{
	if (func_19(iParam0))
	{
...
var func_22(int iParam0)//Position - 0x1161
{
	return Global_1798[iParam0 /*29*/];
}

bool func_23(int iParam0)//Position - 0x1170
{
	return Global_41396 == iParam0;
}

void func_24()//Position - 0x117E
{
	int iVar0;
...
bool func_25(int iParam0, int iParam1)//Position - 0x11D6
{
	switch (iParam0)
	{
		case 5:
...
void func_27(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x1268
{
...
void func_29()//Position - 0x12E1
{
	func_30();
}

int func_30()//Position - 0x12EE
{
	if (func_31(0))
	{
		return 0;
...
bool func_31(bool bParam0)//Position - 0x1339
{
...
void func_32(int iParam0, int iParam1)//Position - 0x1364
{
	if (iParam0 == -1)
	{
		iParam0 = func_50();
...
void func_33(int iParam0)//Position - 0x1468
{
	Global_111546 = iParam0;
}

void func_34(int iParam0, var uParam1, var uParam2)//Position - 0x1476
{
	bool bVar0;
...
int func_36()//Position - 0x1A1F
{
	return Global_30736;
}

int func_37(int iParam0, int iParam1)//Position - 0x1A2A
{
	int iVar0;
...
int func_38(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1A7B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_39()//Position - 0x20CD
{
	return Global_1312745;
}

int func_40(int iParam0, int iParam1)//Position - 0x20D9
{
	switch (iParam0)
	{
		case 0:
...
int func_41(int iParam0)//Position - 0x244D
{
	switch (iParam0)
	{
		case 29:
...
void func_42(int iParam0)//Position - 0x247C
{
	int iVar0;
	int iVar1;
...
void func_43(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x24BE
{
	func_44(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_44(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x24E0
{
	int iVar0;
...
int func_47(int iParam0)//Position - 0x281A
{
	int iVar0;
	int iVar1;
...
void func_48(int iParam0, int iParam1)//Position - 0x285D
{
	MISC::SET_BIT(&(Global_111560.f_24990.f_8[iParam0]), iParam1);
}

int func_49(int iParam0)//Position - 0x2878
{
	int iVar0;
...
int func_51(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x2946
{
...
int func_52()//Position - 0x2B20
{
	return 1;
}

int func_53()//Position - 0x2B29
{
	if (!iLocal_81)
	{
		SYSTEM::WAIT(0);
...
void func_54()//Position - 0x2D85
{
	Global_19671 = 0;
	func_55();
}

void func_55()//Position - 0x2D95
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_56(var uParam0, int iParam1)//Position - 0x2DB6
{
...
int func_58(int iParam0)//Position - 0x30AC
{
	int iVar0;
	bool bVar1;
...
Vector3 func_59(int iParam0)//Position - 0x3172
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_60()//Position - 0x3185
{
	if (func_101())
	{
...
bool func_64()//Position - 0x3388
{
	...
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar13, -91.56341f, 6391.747f, 30.6397f, -101.2611f, 6401.7f, 32.45449f, 7.5f, 0, true, 0))
		{
			bVar0 = true;
		}
	}
...
int func_65(int iParam0, float fParam1, float fParam2)//Position - 0x355A
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_66(int iParam0)//Position - 0x35E1
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
int func_67(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, float fParam5, int iParam6)//Position - 0x363B
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
void func_68(char* sParam0, int iParam1)//Position - 0x3899
{
	func_70(sParam0);
	func_69(iParam1);
}

void func_69(int iParam0)//Position - 0x38AD
{
	if (iParam0 > 0)
	{
	}
...
void func_70(char* sParam0)//Position - 0x38BB
{
...
void func_71(int iParam0)//Position - 0x38CE
{
	AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(iParam0);
}

void func_72(char* sParam0)//Position - 0x38DC
{
	func_70(sParam0);
}

int func_73(int iParam0, int iParam1)//Position - 0x38EA
{
...
void func_74()//Position - 0x3937
{
	if (((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -62.6571f, 6447.08f, 40.49928f, -153.6411f, 6354.579f, 23.99063f, 144.25f, 0, true, 0) || CAM::IS_SPHERE_VISIBLE(vLocal_48, 15f)) || bLocal_76) || func_4())
	{
...
int func_75(int iParam0)//Position - 0x39C7
{
	if (func_79())
	{
		Global_111550 = 1;
...
void func_76(int iParam0)//Position - 0x3A1A
{
	switch (iParam0)
	{
		case 0:
...
void func_77(char[4] cParam0, int iParam1)//Position - 0x3AFB
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

char* func_78(int iParam0)//Position - 0x3B12
{
	char* sVar0;
...
int func_80(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x3B8C
{
	int iVar0;
...
void func_81(var uParam0, int iParam1)//Position - 0x3CC3
{
	int iVar0;
...
bool func_82(int iParam0)//Position - 0x3D12
{
	return func_83(iParam0, Global_41396);
}

int func_83(int iParam0, int iParam1)//Position - 0x3D23
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_84(int iParam0)//Position - 0x3F04
{
	if (Global_41396 == 15)
	{
		return 0;
...
int func_85(int iParam0, bool bParam1, int iParam2)//Position - 0x3F26
{
	iParam2 = iParam2;
	return func_86(iParam0, bParam1, 145);
}

int func_86(int iParam0, bool bParam1, int iParam2)//Position - 0x3F3C
{
	int iVar0;
...
int func_87(int iParam0, bool bParam1, bool bParam2)//Position - 0x3F86
{
	int iVar0;
...
float func_88(bool bParam0, float fParam1, float fParam2)//Position - 0x402C
{
	if (bParam0)
	{
		return fParam1;
...
int func_90(float fParam0, bool bParam1)//Position - 0x40A5
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_91(int iParam0, var uParam1)//Position - 0x415C
{
	switch (iParam0)
	{
		case 0:
...
int func_93(int iParam0)//Position - 0x5434
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_94(int iParam0)//Position - 0x577A
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_95(int iParam0)//Position - 0x57B2
{
	struct<2> Var0;
...
bool func_98()//Position - 0x5C4E
{
	return Global_111278 > 0;
}

int func_99()//Position - 0x5C5C
{
	if (Global_95621 != -1)
	{
		return 1;
...
void func_105()//Position - 0x5EBD
{
	...
	func_108();
	PATHFIND::GET_CLOSEST_VEHICLE_NODE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), &vLocal_48, 1, 1077936128, 0);
...
void func_106(int iParam0, char* sParam1, int iParam2)//Position - 0x6002
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_2(iParam2), 1);
}

bool func_107(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x6019
{
...
void func_108()//Position - 0x606D
{
	...
	if (bLocal_98 == 0)
	{
		if (!PED::IS_PED_INJURED(iLocal_54) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				TASK::OPEN_SEQUENCE_TASK(&iLocal_79);
				TASK::TASK_GO_STRAIGHT_TO_COORD(0, vLocal_48, 1f, 20000, 1193033728, 0.5f);
				TASK::TASK_LOOK_AT_COORD(0, vLocal_48, -1, 2048, 2);
				TASK::TASK_PLAY_ANIM(0, sLocal_267, "bystander_bystander_angry", 8f, -8f, 1500, 0, 0, 0, 0, 0);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_79);
				TASK::TASK_PERFORM_SEQUENCE(iLocal_54, iLocal_79);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_79);
...
int func_112()//Position - 0x629E
{
	...
	{
		MISC::CLEAR_AREA(vLocal_48, 5f, 1, 1, 0, false);
		...
		iLocal_65 = PED::ADD_SCENARIO_BLOCKING_AREA(Vector(31.64024f, 6405.058f, -98.41389f) - Vector(40f, 40f, 40f), Vector(31.64024f, 6405.058f, -98.41389f) + Vector(40f, 40f, 40f), 0, 1, 1, 1);
...
void func_113(bool bParam0)//Position - 0x6648
{
	if (bParam0)
	{
		Global_30967 = 1;
...
void func_114(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x6660
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_115()//Position - 0x66FB
{
}

void func_116()//Position - 0x6703
{
}

void func_117()//Position - 0x670B
{
	switch (func_17())
	{
		case 0:
...
void func_118(int iParam0)//Position - 0x675B
{
	if (iParam0 == -1)
	{
		iParam0 = func_50();
...
void func_120(int iParam0)//Position - 0x67CE
{
	Global_111549 = iParam0;
}

int func_121(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x67DC
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
...
bool func_122(vector3 vParam0, vector3 vParam3, bool bParam6)//Position - 0x6B76
{
	if (bParam6)
	{
...
bool func_123(int iParam0)//Position - 0x6BBD
{
	int iVar0;
...
int func_124(int iParam0)//Position - 0x6BDE
{
	return func_125(iParam0, 1);
}

int func_125(int iParam0, int iParam1)//Position - 0x6BED
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_126(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x6C40
{
	func_127(func_138(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_127(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x6C5E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_128(float fParam0, float fParam1, float fParam2)//Position - 0x6E5F
{
	float fVar0;
...
int func_129(int iParam0, int iParam1)//Position - 0x6EA1
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_130(int iParam0)//Position - 0x6F43
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_131(int iParam0)//Position - 0x6F56
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_132(int iParam0)//Position - 0x6F69
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_133(int iParam0)//Position - 0x6F7C
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_134(int iParam0)//Position - 0x6F8E
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_135(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_135(bool bParam0, int iParam1, int iParam2)//Position - 0x6FB3
{
	if (bParam0)
	{
		return iParam1;
...
int func_136(int iParam0)//Position - 0x6FCA
{
	return iParam0 & 15;
}

int func_137(int iParam0, int iParam1)//Position - 0x6FD7
{
	int iVar0;
	int iVar1;
...
void func_139(var uParam0, int iParam1)//Position - 0x7129
{
	if (iParam1 <= 0)
	{
		return;
...
void func_140(var uParam0, int iParam1)//Position - 0x71AF
{
...
void func_141(var uParam0, int iParam1)//Position - 0x71E2
{
	int iVar0;
	int iVar1;
...
void func_142(var uParam0, int iParam1)//Position - 0x7233
{
...
void func_143(var uParam0, int iParam1)//Position - 0x726D
{
...
void func_144(var uParam0, int iParam1)//Position - 0x72A8
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_145(int iParam0)//Position - 0x72E4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_146(int iParam0, int iParam1)//Position - 0x73C0
{
...
int func_147(int iParam0)//Position - 0x73E3
{
	int iVar0;
...
var func_148()//Position - 0x7B00
{
	return Global_98708.f_1;
}

int func_149()//Position - 0x7B0E
{
	if (Global_95621 != -1)
	{
...
bool func_152()//Position - 0x7B78
{
	return Global_98721.f_346 > 0;
}

bool func_153()//Position - 0x7B89
{
	return Global_98721.f_345 > 0;
}

var func_154()//Position - 0x7B9A
{
	return Global_1312873;
}

int func_155()//Position - 0x7BA6
{
...
bool func_157(int iParam0)//Position - 0x7BEA
{
	return func_137(func_138(), iParam0);
}

int func_158(int iParam0, int iParam1, int iParam2)//Position - 0x7BFC
{
	int iVar0;
	int iVar1;
...
int func_159(int iParam0)//Position - 0x7CE0
{
	if (!func_19(iParam0))
	{
		return 7;
...
bool func_160(int iParam0)//Position - 0x7D04
{
	int iVar0;
	bool bVar1;
...
void func_164(int iParam0)//Position - 0x7EE5
{
	char cVar0[64];
...
void func_165(var uParam0)//Position - 0x7F9A
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_166(int iParam0, bool bParam1)//Position - 0x7FD7
{
	switch (iParam0)
	{
		case 0:
...
void func_167(int iParam0)//Position - 0x8242
{
	Global_41947 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_168(int iParam0)//Position - 0x8254
{
	func_169(iParam0, 0, func_174(iParam0));
}

void func_169(int iParam0, int iParam1, int iParam2)//Position - 0x8269
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_170(var uParam0)//Position - 0x8298
{
	struct<16> Var0;
	int iVar16;
...
void func_171(int iParam0, var uParam1)//Position - 0x8369
{
	Global_111560.f_24990.f_43[iParam0] = *uParam1;
}

void func_172(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8381
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_173(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8503
{
...
int func_174(int iParam0)//Position - 0x853B
{
	int iVar0;
