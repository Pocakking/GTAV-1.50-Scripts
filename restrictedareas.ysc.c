...
bool func_5(int iParam0)//Position - 0x7F2
{
	return func_6(iParam0, 20);
}

bool func_6(int iParam0, int iParam1)//Position - 0x802
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_7()//Position - 0x81D
{
	return -1;
}

void func_8()//Position - 0x826
{
	int iVar0;
...
int func_13()//Position - 0xA4E
{
	func_14();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_14()//Position - 0xA67
{
	int iVar0;
...
bool func_15(int iParam0)//Position - 0xB64
{
	return iParam0 < 3;
}

int func_16(int iParam0)//Position - 0xB70
{
	int iVar0;
	int iVar1;
...
int func_17(int iParam0)//Position - 0xBAD
{
	if (func_15(iParam0))
	{
...
var func_18(int iParam0)//Position - 0xBD2
{
	return Global_1798[iParam0 /*29*/];
}

bool func_19(int iParam0)//Position - 0xBE1
{
	return Global_41396 == iParam0;
}

void func_20()//Position - 0xBEF
{
	int iVar0;
...
bool func_21(int iParam0, int iParam1)//Position - 0xC46
{
	switch (iParam0)
	{
		case 5:
...
void func_23(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0xCD8
{
...
int func_26(int iParam0)//Position - 0xF2F
{
...
bool func_28(int iParam0, int iParam1)//Position - 0xF9C
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_31(int iParam0)//Position - 0x103E
{
	return Global_111560.f_24899[iParam0 /*4*/];
}

void func_32(int iParam0, bool bParam1)//Position - 0x1051
{
...
struct<6> func_33(int iParam0)//Position - 0x1088
{
	return Global_30895[iParam0 /*6*/];
}

int func_34(int iParam0)//Position - 0x1099
{
	if (MISC::IS_BIT_SET(Global_30894, iParam0))
	{
		return 1;
...
bool func_35(int iParam0, vector3 vParam1)//Position - 0x10B2
{
	return SYSTEM::VDIST2(vParam1, func_37(iParam0)) < func_36(iParam0);
}

float func_36(int iParam0)//Position - 0x10CF
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_37(int iParam0)//Position - 0x1167
{
	switch (iParam0)
	{
		case 1:
...
int func_38(vector3 vParam0, int iParam3, int iParam4, bool bParam5)//Position - 0x1251
{
	vector3 vVar0[15];
	vector3 vVar46[15];
	float fVar92[15];
...
void func_40()//Position - 0x1FE3
{
}

void func_41(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1FEB
{
