...
void func_12(var uParam0, int iParam1)//Position - 0x1580
{
...
void func_13()//Position - 0x159D
{
	Global_19671 = 0;
	func_14();
}

void func_14()//Position - 0x15AD
{
...
int func_15()//Position - 0x1604
{
	return 0;
}

void func_16(char* sParam0)//Position - 0x160D
{
	struct<16> Var0;
...
void func_17(char* sParam0)//Position - 0x1633
{
	switch (iLocal_254)
	{
		case 0:
...
void func_18(char* sParam0)//Position - 0x16A8
{
	int iVar0;
...
void func_19(int iParam0, char* sParam1)//Position - 0x16EC
{
	switch (iParam0)
	{
		case 0:
...
void func_20(char* sParam0)//Position - 0x18B5
{
	char cVar0[64];
...
void func_21(char* sParam0)//Position - 0x18E9
{
	struct<4> Var0;
...
int func_22()//Position - 0x1914
{
	func_23();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_23()//Position - 0x192D
{
	int iVar0;
...
bool func_24(int iParam0)//Position - 0x1A2A
{
	return Global_41396 == iParam0;
}

bool func_25(int iParam0)//Position - 0x1A38
{
	return iParam0 < 3;
}

int func_26(int iParam0)//Position - 0x1A44
{
	int iVar0;
	int iVar1;
...
int func_27(int iParam0)//Position - 0x1A81
{
	if (func_25(iParam0))
	{
...
var func_28(int iParam0)//Position - 0x1AA6
{
	return Global_1798[iParam0 /*29*/];
}

void func_29(char* sParam0)//Position - 0x1AB5
{
...
void func_30()//Position - 0x1AD6
{
	iLocal_254 = MISC::GET_RANDOM_INT_IN_RANGE(0, iLocal_253);
}

void func_31(char* sParam0)//Position - 0x1AE7
{
	int iVar0;
...
bool func_33(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1B53
{
...
int func_34(char* sParam0, int iParam1, bool bParam2)//Position - 0x1BA1
{
	Global_20806 = 0;
...
bool func_37(int iParam0)//Position - 0x1F0E
{
	return func_38(iParam0, 20);
}

bool func_38(int iParam0, int iParam1)//Position - 0x1F1E
{
	return MISC::IS_BIT_SET(Global_1628955[iParam0 /*614*/].f_11.f_4, iParam1);
}

int func_39()//Position - 0x1F39
{
	return -1;
}

void func_40()//Position - 0x1F42
{
	int iVar0;
...
bool func_46(int iParam0, int iParam1)//Position - 0x21BF
{
	switch (iParam0)
	{
		case 5:
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x21FA
{
...
void func_48(char[4] cParam0)//Position - 0x2250
{
	int iVar0;
...
void func_49(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x228B
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_50(char* sParam0)//Position - 0x2326
{
	int iVar0;
...
void func_51(var uParam0)//Position - 0x235E
{
}

void func_52(var uParam0, int iParam1, float fParam2)//Position - 0x2366
{
}

void func_53()//Position - 0x236E
{
	STREAMING::REMOVE_ANIM_DICT(&Local_388);
}

void func_54()//Position - 0x237D
{
	char* sVar0;
	struct<16> Var8;
...
void func_55(var uParam0)//Position - 0x23F3
{
}

void func_56(char* sParam0)//Position - 0x23FB
{
...
void func_57(int iParam0, char* sParam1, char* sParam2)//Position - 0x240E
{
...
bool func_59()//Position - 0x2578
{
	return Global_98721.f_345 > 0;
}

bool func_60()//Position - 0x2589
{
	bool bVar0;
...
void func_64(char* sParam0)//Position - 0x260C
{
	struct<8> Var0;
...
void func_65(char* sParam0)//Position - 0x264C
{
	func_19(iLocal_297, sParam0);
}

void func_66(char* sParam0)//Position - 0x265D
{
	StringCopy(sParam0, "MONOLOGUE_", 16);
	StringIntConCat(sParam0, Global_111505[iLocal_251] + 1, 16);
}

void func_67(int iParam0, bool bParam1)//Position - 0x267B
{
	int iVar0;
...
void func_68(int iParam0, bool bParam1)//Position - 0x269C
{
	int iVar0;
...
void func_69(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x270D
{
	func_70(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_70(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x272D
{
	int iVar0;
...
int func_72(int iParam0)//Position - 0x2A1F
{
	int iVar0;
	int iVar1;
...
int func_75(int iParam0)//Position - 0x2B68
{
	if (func_77(iParam0))
	{
...
int func_76(int iParam0)//Position - 0x2B8F
{
	int iVar0;
...
int func_77(int iParam0)//Position - 0x2BC2
{
...
int func_78(int iParam0)//Position - 0x2BEC
{
	switch (iParam0)
	{
...
void func_79(int iParam0)//Position - 0x2CAA
{
	if (iLocal_447 == 1)
	{
...
void func_80(int iParam0, int iParam1, bool bParam2)//Position - 0x2CC9
{
	if (iLocal_447 == 1)
	{
		if (!HUD::DOES_BLIP_EXIST(*iParam0))
...
int func_81(int iParam0, bool bParam1, int iParam2)//Position - 0x2D1C
{
	int iVar0;
...
int func_82(int iParam0, bool bParam1, bool bParam2)//Position - 0x2D66
{
	int iVar0;
...
float func_83(bool bParam0, float fParam1, float fParam2)//Position - 0x2E0A
{
	if (bParam0)
	{
		return fParam1;
...
float func_84(int iParam0, int iParam1, bool bParam2)//Position - 0x2E21
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_85(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2E7F
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_86(vector3 vParam0, vector3 vParam3)//Position - 0x2F10
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_87(vector3 vParam0)//Position - 0x2F31
{
	float fVar0;
	float fVar1;
...
int func_88(int iParam0)//Position - 0x2F70
{
	var uVar0;
...
void func_91()//Position - 0x2FC4
{
	Global_19671 = 0;
	func_92();
}

void func_92()//Position - 0x2FD4
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_21816 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_93()//Position - 0x2FF5
{
	return 0;
}

void func_94()//Position - 0x2FFE
{
}

int func_95()//Position - 0x3006
{
	return 1;
}

float func_96(int iParam0, int iParam1)//Position - 0x300F
{
	return func_84(iParam0, iParam1, 1);
}

void func_97(int iParam0)//Position - 0x3020
{
	int iVar0;
...
int func_98(int iParam0)//Position - 0x3051
{
	int iVar0;
	int iVar1;
...
int func_99(int iParam0, bool bParam1)//Position - 0x3082
{
	if (!func_77(iParam0))
	{
		if (!bParam1)
...
void func_100(var uParam0, var uParam1)//Position - 0x3135
{
	*uParam0 = (*uParam0 || uParam1);
}

void func_101(int iParam0, bool bParam1)//Position - 0x3146
{
	if (iParam0 == 1)
	{
		TASK::TASK_PLAY_ANIM(iLocal_240, &cLocal_324, &Local_218, 2f, -2f, -1, 0, 0, 0, 0, 0);
...
int func_102(int iParam0)//Position - 0x31B8
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_103()//Position - 0x31D9
{
	func_104();
}

void func_104()//Position - 0x31E5
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_240, 0))
	{
		AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_240, "MAG_2_RAGE_PED_GROUP", 0);
	}
}

void func_105()//Position - 0x3203
{
...
int func_109()//Position - 0x335F
{
	return 1;
}

bool func_110(var uParam0)//Position - 0x3368
{
	return func_111(Global_111560.f_20112, uParam0);
}

bool func_111(var uParam0, var uParam1)//Position - 0x337D
{
	return (uParam0 && uParam1) != 0;
}

int func_112(int iParam0)//Position - 0x338C
{
...
void func_113(int iParam0)//Position - 0x34B3
{
	var uVar0;
...
void func_114(int iParam0)//Position - 0x3582
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
struct<6> func_115()//Position - 0x35A2
{
	struct<6> Var0;
...
void func_116()//Position - 0x35C6
{
	func_117();
}

void func_117()//Position - 0x35D2
{
}

void func_118()//Position - 0x35DA
{
	if (iLocal_245 == -1)
	{
