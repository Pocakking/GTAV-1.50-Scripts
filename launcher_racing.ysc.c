...
void func_10()//Position - 0x643
{
	if (!func_11(0))
	{
		...
		SYSTEM::START_NEW_SCRIPT_WITH_ARGS("mission_Race", &Local_83, 6, 29500);
	}
...
int func_17(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x8FC
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_18(bool bParam0)//Position - 0xEFB
{
	int iVar0;
	int iVar1;
...
void func_19(int iParam0)//Position - 0x117D
{
	int iVar0;
...
void func_20(int iParam0)//Position - 0x11D7
{
	bool bVar0;
	char cVar1[64];
...
char* func_21(int iParam0)//Position - 0x1368
{
	switch (iParam0)
	{
		case 0:
...
void func_23(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x1472
{
	int iVar0;
...
int func_24(var uParam0)//Position - 0x14A2
{
	int iVar0;
	int iVar1;
...
int func_25()//Position - 0x14D6
{
	return Global_1312745;
}

int func_26(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x14E2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_27(int iParam0)//Position - 0x1B34
{
	func_50(93, iParam0);
	func_50(29, iParam0);
	func_50(30, iParam0);
...
bool func_28(int iParam0)//Position - 0x1B54
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_29(int iParam0, int iParam1, int iParam2)//Position - 0x1D04
{
	int iVar0;
	var uVar1;
...
int func_30(int iParam0, int iParam1, int iParam2)//Position - 0x1D36
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_31(int iParam0)//Position - 0x1D73
{
	int iVar0;
...
int func_32(int iParam0, int iParam1)//Position - 0x210F
{
	int iVar0;
...
int func_33(bool bParam0)//Position - 0x2488
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_34(int iParam0, int iParam1)//Position - 0x253F
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_35(int iParam0, int iParam1)//Position - 0x255A
{
...
int func_36(var uParam0, int iParam1)//Position - 0x25F7
{
	int iVar0;
	var uVar1[78];
...
int func_37(var uParam0, int iParam1)//Position - 0x26A8
{
	int iVar0;
...
bool func_38(var uParam0, int iParam1)//Position - 0x2723
{
	return (*uParam0)[iParam1] == 78;
}

void func_39(var uParam0)//Position - 0x2734
{
	int iVar0;
...
void func_40(var uParam0, int iParam1)//Position - 0x2768
{
	(*uParam0)[iParam1] = 78;
}

void func_41(var uParam0, float fParam1)//Position - 0x2778
{
	if (fParam1 == 0f)
	{
		uParam0->f_80 = 0f;
...
float func_42(var uParam0)//Position - 0x2795
{
	return uParam0->f_80;
}

bool func_43(var uParam0, int iParam1)//Position - 0x27A1
{
	return func_44(uParam0, iParam1) != -1;
}

int func_44(var uParam0, int iParam1)//Position - 0x27B3
{
	int iVar0;
...
bool func_45(var uParam0)//Position - 0x27E0
{
	return uParam0->f_79 == 1;
}

int func_46(int iParam0)//Position - 0x27EE
{
	switch (iParam0)
	{
		case 60:
...
bool func_47(int iParam0)//Position - 0x283E
{
	return Global_41396 == iParam0;
}

int func_48(int iParam0, int iParam1)//Position - 0x284C
{
	int iVar0;
...
void func_49(int iParam0, int iParam1)//Position - 0x289D
{
	int iVar0;
...
void func_50(int iParam0, int iParam1)//Position - 0x28C0
{
	int iVar0;
...
int func_52(int iParam0)//Position - 0x2992
{
	return Global_1798[iParam0 /*29*/].f_17;
}

int func_53()//Position - 0x29A3
{
	func_54();
	return Global_111560.f_2358.f_539.f_4321;
}

void func_54()//Position - 0x29BC
{
	int iVar0;
...
bool func_55(int iParam0)//Position - 0x2AB9
{
	return iParam0 < 3;
}

int func_56(int iParam0)//Position - 0x2AC5
{
	int iVar0;
	int iVar1;
...
int func_57(int iParam0)//Position - 0x2B02
{
	if (func_55(iParam0))
	{
...
var func_58(int iParam0)//Position - 0x2B27
{
	return Global_1798[iParam0 /*29*/];
}

int func_59()//Position - 0x2B36
{
	int iVar0;
...
int func_60(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x2B5A
{
	int iVar0;
...
void func_61(var uParam0, int iParam1)//Position - 0x2C91
{
	int iVar0;
...
bool func_62(int iParam0)//Position - 0x2CE0
{
	return func_63(iParam0, Global_41396);
}

int func_63(int iParam0, int iParam1)//Position - 0x2CF1
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_64(int iParam0)//Position - 0x2ED2
{
	if (Global_41396 == 15)
	{
		return 0;
...
int func_65(int iParam0)//Position - 0x2EF4
{
	if (func_15(iParam0))
	{
...
void func_67(bool bParam0, int iParam1)//Position - 0x2FA7
{
	int iVar0;
...
void func_68(int iParam0)//Position - 0x3065
{
	if (iParam0->f_9 != 0)
	{
...
int func_69(var uParam0, bool bParam1, int iParam2)//Position - 0x308E
{
	char cVar0[64];
	int iVar16;
	int iVar17;
...
void func_70(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x312B
{
	if (bParam0)
	{
...
bool func_71()//Position - 0x3264
{
	return MISC::IS_BIT_SET(Global_1590446[PLAYER::PLAYER_ID() /*871*/].f_39.f_18, 14);
}

bool func_72(int iParam0, int iParam1)//Position - 0x3281
{
	bool bVar0;
...
int func_73(int iParam0, bool bParam1)//Position - 0x32CC
{
	int iVar0;
	int iVar1;
...
int func_74(int iParam0)//Position - 0x330D
{
...
bool func_75()//Position - 0x334F
{
	return MISC::IS_BIT_SET(Global_2359302, 3);
}

int func_76(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x3360
{
	int iVar0;
...
void func_78(int iParam0)//Position - 0x33BA
{
	if (iParam0 == 1)
	{
...
void func_80(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7, int iParam8)//Position - 0x3539
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		if (iVar5 == 1 && Global_22350.f_5728)
		{
			...
			if (MISC::GET_HASH_KEY(&(Global_22350.f_4690)) != 0 && Global_22350.f_4766 != -1)
			{
				...
				if (Global_22350.f_4768 != 0)
				{
					...
					GRAPHICS::DRAW_SPRITE(func_109(Global_22350.f_4768), func_106(Global_22350.f_4768, 1), ((Global_22347 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
				}
			...
			if (MISC::GET_HASH_KEY(&(Global_4268271.f_21)) != 0 && Global_4268271.f_65 != -1)
			{
				...
				if (Global_4268271.f_67 != 0)
				{
					...
					GRAPHICS::DRAW_SPRITE(func_109(Global_4268271.f_67), func_106(Global_4268271.f_67, 1), ((Global_22347 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
				}
				fVar51 = (fVar51 + (((HUD::_GET_TEXT_SCALE_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
									...
									if (bVar54)
									{
										if (func_115(26, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_115(26, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													GRAPHICS::DRAW_SPRITE(func_109(26), func_106(26, 1), ((fVar34 + fVar42) + fVar45), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
												}
											}
										}
										if (func_115(27, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_115(27, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													GRAPHICS::DRAW_SPRITE(func_109(27), func_106(27, 1), (((fVar34 + fVar42) + fVar45) + (fVar43 + fVar44)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
												}
											}
										}
									}
												...
												if (func_115(Global_22350.f_4433[(iVar22 + iVar28)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (func_115(Global_22350.f_4433[(iVar22 + iVar28)], bVar32, 1, &fVar36, &fVar37, bParam7))
													{
														...
														if (iVar5 == 1)
														{
															if (Global_22350.f_5083[iVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_109(Global_22350.f_4433[(iVar22 + iVar28)]), func_106(Global_22350.f_4433[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar42) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_109(Global_22350.f_4433[(iVar22 + iVar28)]), func_106(Global_22350.f_4433[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar42) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
															}
														}
												...
												if (func_115(Global_22350.f_4433[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (iVar5 == 1)
													{
														if (func_115(Global_22350.f_4433[(iVar22 + iVar14)], bVar32, 1, &fVar36, &fVar37, bParam7))
														{
															...
															{
																GRAPHICS::DRAW_SPRITE(func_109(Global_22350.f_4433[(iVar22 + iVar14)]), func_106(Global_22350.f_4433[(iVar22 + iVar14)], bVar32), (Global_22347 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
															}
															else if (Global_22350.f_5083[iVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_109(Global_22350.f_4433[(iVar22 + iVar14)]), func_106(Global_22350.f_4433[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar42) + fVar43) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_109(Global_22350.f_4433[(iVar22 + iVar14)]), func_106(Global_22350.f_4433[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar42) + fVar43) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0);
															}
														}
													}
									...
									if (func_115(Global_22350.f_4433[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
									{
										...
										if (iVar5 == 1)
										{
											if (func_115(Global_22350.f_4433[iVar22], bVar32, 1, &fVar36, &fVar37, bParam7))
											{
												...
												GRAPHICS::DRAW_SPRITE(func_109(Global_22350.f_4433[iVar22]), func_106(Global_22350.f_4433[iVar22], bVar32), ((fVar34 + fVar42) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), (fVar36 * func_88(Global_22350.f_4433[iVar22])), (fVar37 * func_88(Global_22350.f_4433[iVar22])), 0f, iVar47, iVar48, iVar49, iVar50, 0);
											}
										}
									}
								}
...
void func_81(int iParam0)//Position - 0x62DC
{
	Global_1375006.f_1100 = iParam0;
}

void func_82(int iParam0)//Position - 0x62ED
{
	if (func_87())
	{
		return;
...
void func_83(int iParam0)//Position - 0x6320
{
	if (func_87())
	{
		return;
...
void func_84(bool bParam0, bool bParam1)//Position - 0x63AA
{
	if (bParam0)
	{
		if (func_86(0))
...
bool func_85()//Position - 0x641E
{
	return MISC::IS_BIT_SET(Global_1687880, 5);
}

int func_86(int iParam0)//Position - 0x642F
{
	if (iParam0 == 1)
	{
		if (Global_19486.f_1 > 3)
...
bool func_87()//Position - 0x6489
{
	return MISC::IS_BIT_SET(Global_1687880, 19);
}

float func_88(int iParam0)//Position - 0x649B
{
	switch (iParam0)
	{
		case 35:
...
void func_89(float fParam0, float fParam1, char* sParam2, float fParam3, int iParam4)//Position - 0x650A
{
...
void func_90(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4)//Position - 0x6529
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
bool func_91()//Position - 0x6547
{
	return DLC::IS_DLC_PRESENT(-1762644250);
}

void func_92(bool bParam0)//Position - 0x6558
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_93(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x659E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_94(int iParam0, var uParam1, var uParam2, var uParam3)//Position - 0x674C
{
	switch (iParam0)
	{
		case 0:
...
void func_95(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)//Position - 0x69D6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_96(char* sParam0)//Position - 0x6EDE
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}

void func_97(char* sParam0)//Position - 0x6EF0
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
}

int func_98()//Position - 0x6EFE
{
	vector3 vVar0;
...
void func_100(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x6F86
{
...
void func_101(float fParam0)//Position - 0x709B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_102(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4)//Position - 0x70FA
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam3);
...
float func_103(char* sParam0, int iParam1, int iParam2)//Position - 0x711D
{
...
void func_105(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x71E9
{
	GRAPHICS::DRAW_RECT((fParam0 + (fParam2 * 0.5f)), (fParam1 + (fParam3 * 0.5f)), fParam2, fParam3, iParam4, iParam5, iParam6, iParam7, 0);
}

var func_106(int iParam0, bool bParam1)//Position - 0x7218
{
	char* sVar0[2];
	var uVar3;
	struct<13> Var19;
...
var func_107(var uParam0)//Position - 0x7742
{
	return uParam0;
}

struct<13> func_108(int iParam0)//Position - 0x774C
{
	struct<13> Var0;
...
char* func_109(int iParam0)//Position - 0x7763
{
	var uVar0;
	struct<13> Var16;
...
void func_110(int iParam0, char* sParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)//Position - 0x77D8
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float func_111(char* sParam0)//Position - 0x79E4
{
...
float func_112(char* sParam0)//Position - 0x7A00
{
	if (!MISC::IS_STRING_NULL(sParam0))
	{
		if (MISC::GET_HASH_KEY(sParam0) == 0)
...
void func_113(int iParam0, bool bParam1)//Position - 0x7A3D
{
	int iVar0;
...
int func_115(int iParam0, bool bParam1, bool bParam2, float fParam3, float fParam4, bool bParam5)//Position - 0x7ABB
{
	char cVar0[64];
	char cVar16[64];
	int iVar32;
...
float func_116(int iParam0)//Position - 0x7C6C
{
	switch (iParam0)
	{
		case 33:
...
int func_117(bool bParam0, bool bParam1)//Position - 0x7D40
{
...
int func_118()//Position - 0x7DDD
{
	return Global_1312808;
}

bool func_119(int iParam0, int iParam1)//Position - 0x7DE9
{
	switch (iParam0)
	{
		case 5:
...
void func_120(int iParam0, bool bParam1, int iParam2)//Position - 0x7E24
{
	int iVar0;
	int iVar1;
...
void func_121(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)//Position - 0x7F76
{
...
void func_123(int iParam0)//Position - 0x80D1
{
	Global_22350.f_5738 = iParam0;
}

void func_124(int iParam0, char* sParam1, int iParam2)//Position - 0x80E1
{
	char* sVar0;
...
void func_125(int iParam0, char* sParam1, int iParam2)//Position - 0x8191
{
	char* sVar0;
...
void func_126(char* sParam0)//Position - 0x8240
{
	int iVar0;
...
void func_127(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x828B
{
...
void func_128(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x82CA
{
...
void func_129(bool bParam0, bool bParam1)//Position - 0x8374
{
	int iVar0;
	int iVar1;
	float fVar2;
...
bool func_130(char* sParam0, int iParam1, bool bParam2)//Position - 0x8873
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool func_131(var uParam0)//Position - 0x8969
{
	switch (uParam0->f_9)
	{
		case 0:
...
void func_134(int iParam0)//Position - 0x8ADD
{
	int iVar0;
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_103[iParam0], 0) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		switch (iLocal_195)
		{
			...
			case 3:
				...
				{
					func_139(&iLocal_198);
					TASK::TASK_PLAY_ANIM(iLocal_103[iParam0], "random@street_race", "_streetracer_wait_loop", 4f, -4f, -1, 9, 0, 0, 0, 0);
					iLocal_195 = 4;
				}
				break;
...
float func_135(int iParam0)//Position - 0x8CA4
{
	if (func_138(iParam0))
	{
		if (func_137(iParam0))
...
float func_136(bool bParam0)//Position - 0x8CE3
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_137(var uParam0)//Position - 0x8D3B
{
	return MISC::IS_BIT_SET(*uParam0, 2);
}

bool func_138(var uParam0)//Position - 0x8D4B
{
	return MISC::IS_BIT_SET(*uParam0, 1);
}

void func_139(int iParam0)//Position - 0x8D5B
{
	func_140(iParam0, 0f);
}

void func_140(int iParam0, float fParam1)//Position - 0x8D6A
{
...
void func_141(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x8D98
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_142(iParam3), 0);
}

int func_142(int iParam0)//Position - 0x8DB1
{
	int iVar0;
...
void func_143(int iParam0)//Position - 0x8FA6
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && !func_144())
	{
		if (func_65(iLocal_103[iParam0]))
		{
			...
			{
				CAM::SET_GAMEPLAY_ENTITY_HINT(iLocal_103[iParam0], 0f, 0f, 0f, 1, 2000, 2000, 2000, 0);
				iLocal_93 = 0;
			}
		}
	}
...
void func_147(char[4] cParam0)//Position - 0x9220
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 1, true, -1);
}

int func_148(char* sParam0)//Position - 0x9236
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_149(char[4] cParam0)//Position - 0x9249
{
	if (!func_148(cParam0))
	{
		func_147(cParam0);
...
int func_154(int iParam0)//Position - 0x9873
{
	switch (iParam0)
	{
		case joaat("police"):
...
void func_156(int iParam0)//Position - 0x9918
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_157(char[4] cParam0, int iParam1)//Position - 0x9950
{
	if (!func_159(cParam0, iParam1))
	{
		func_158(cParam0, iParam1);
	}
}

void func_158(char[4] cParam0, int iParam1)//Position - 0x996C
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(cParam0);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam1);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 1, true, -1);
...
int func_159(char* sParam0, int iParam1)//Position - 0x9988
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam1);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
...
int func_160(int iParam0)//Position - 0x99A1
{
	var uVar0;
			...
			if (func_165())
			{
				...
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_117))
				{
					if (STREAMING::HAS_MODEL_LOADED(iLocal_183))
					{
						...
						VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_117, false, true, 0);
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(cLocal_184))
				{
					if (iLocal_193)
					{
						...
						while (iVar0 <= (iLocal_174 - 1))
						{
							...
							{
								if (!ENTITY::IS_ENTITY_DEAD(iLocal_103[iVar0], 0) && !func_164(iLocal_103[iVar0], -2017877118))
								{
									TASK::TASK_PLAY_ANIM(iLocal_103[iVar0], cLocal_184, sLocal_185[iVar0], 1000f, -1000f, -1, 1, 0, 0, 0, 0);
							...
							else if (STREAMING::HAS_MODEL_LOADED(iLocal_174[iVar0]))
							{
								...
								ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iLocal_103[iVar0], vLocal_136[iVar0 /*3*/], 0, 0, 1);
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(cLocal_184))
				{
					if (iLocal_193)
					{
						...
						while (iVar1 <= (iLocal_174 - 3))
						{
							...
							{
								if (!ENTITY::IS_ENTITY_DEAD(iLocal_103[iVar1], 0) && !func_164(iLocal_103[iVar1], -2017877118))
								{
									ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iLocal_103[iVar1], vLocal_136[iVar1 /*3*/], 0, 0, 1);
									if (iVar1 != 2 && iVar1 != 3)
									{
										TASK::TASK_PLAY_ANIM(iLocal_103[iVar1], cLocal_184, sLocal_185[iVar1], 1000f, -1000f, -1, 1, 0, 0, 0, 0);
									}
									else
									{
										TASK::TASK_PLAY_ANIM(iLocal_103[iVar1], cLocal_184, sLocal_185[iVar1], 1000f, -1000f, -1, 1, 0.5f, 0, 0, 0);
									}
			...
			if (func_165())
			{
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_111))
				{
					if (STREAMING::HAS_MODEL_LOADED(iLocal_182))
					{
						...
						VEHICLE::_SET_BOAT_FROZEN_WHEN_ANCHORED(iLocal_111, 0);
						...
						VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_111, false, true, 0);
					}
				}
				iVar2 = 0;
				iVar2 = 0;
				while (iVar2 < 3)
				{
					...
					else if (STREAMING::HAS_MODEL_LOADED(iLocal_182))
					{
						...
						VEHICLE::_SET_BOAT_FROZEN_WHEN_ANCHORED(iLocal_166[iVar2], 1);
						VEHICLE::_0xB28B1FE5BFADD7F5(iLocal_166[iVar2], 1);
						if (VEHICLE::CAN_ANCHOR_BOAT_HERE(iLocal_166[iVar2]))
						{
							VEHICLE::SET_BOAT_ANCHOR(iLocal_166[iVar2], true);
						}
						VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_166[iVar2], false, true, 0);
					}
					iVar2++;
				}
...
int func_164(int iParam0, int iParam1)//Position - 0xA1CD
{
	if (func_65(iParam0))
	{
...
bool func_166(int iParam0, vector3 vParam1, float fParam4)//Position - 0xA243
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, true), vParam1) <= (fParam4 * fParam4);
}

int func_167()//Position - 0xA260
{
	if (Local_83.f_1 == 3)
	{
		return 1;
...
int func_168(var uParam0)//Position - 0xA2AE
{
	int iVar0;
...
bool func_169(var uParam0)//Position - 0xA310
{
	return func_170(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

int func_170(int iParam0, char* sParam1, int iParam2)//Position - 0xA327
{
...
int func_171(int iParam0)//Position - 0xA41B
{
	int iVar0;
...
void func_172(var uParam0)//Position - 0xA447
{
	int iVar0;
...
void func_173(int iParam0)//Position - 0xA4D1
{
	func_174(iParam0, &(iParam0->f_2), iParam0->f_1);
}

void func_174(int iParam0, char* sParam1, int iParam2)//Position - 0xA4E7
{
	if (MISC::IS_BIT_SET(*iParam0, 30))
	{
		switch (func_171(*iParam0))
...
void func_175()//Position - 0xA5C1
{
	...
	if (Local_83.f_1 == 1 || Local_83.f_1 == 2)
	{
		...
		PATHFIND::SET_ROADS_IN_ANGLED_AREA(vLocal_207, vLocal_210, fLocal_213, 0, false, 1);
		iLocal_94 = 1;
	}
	else if (Local_83.f_1 == 3)
	{
...
void func_176(var uParam0, char* sParam1)//Position - 0xAF4C
{
	func_177(uParam0, 1, -1, sParam1, 0);
}

void func_177(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4)//Position - 0xAF5F
{
	int iVar0;
...
int func_178(int iParam0)//Position - 0xB047
{
	int iVar0;
...
void func_179(var uParam0, int iParam1)//Position - 0xB088
{
	func_177(uParam0, 0, iParam1, "NULL", 0);
}

void func_180(int iParam0, var uParam1, var uParam2, float fParam3)//Position - 0xB09C
{
	switch (iParam0)
	{
		case 0:
	...
	if (!func_167())
	{
		...
		while (iVar1 <= (iLocal_170 - 1))
		{
			if (func_65(iLocal_170[iVar1]))
			{
				...
				if (func_14(iLocal_166[iVar1]) && PED::IS_PED_IN_VEHICLE(iLocal_170[iVar1], iLocal_166[iVar1], 0))
				{
	...
	if (func_183())
	{
		...
		while (iVar4 <= (iLocal_170 - 1))
		{
			...
			if (func_65(iLocal_170[iVar4]))
			{
				...
				if (func_14(iLocal_166[iVar4]) && PED::IS_PED_IN_VEHICLE(iLocal_170[iVar4], iLocal_166[iVar4], 0))
				{
...
void func_182(int iParam0, bool bParam1)//Position - 0xB712
{
	char* sVar0;
	int iVar1;
	int iVar2;
...
int func_183()//Position - 0xB783
{
	...
	if (Local_83.f_1 == 3)
	{
		...
		while (iVar0 <= (iLocal_170 - 1))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_166[iVar0]))
			{
				...
				else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_166[iVar0], PLAYER::PLAYER_PED_ID(), 1) && ENTITY::GET_ENTITY_HEALTH(iLocal_166[iVar0]) < 900)
				{
					return 1;
				}
			}
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_111))
		{
			...
			else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_111, PLAYER::PLAYER_PED_ID(), 1) && ENTITY::GET_ENTITY_HEALTH(iLocal_111) < 900)
			{
				return 1;
			}
		}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_111))
	{
		...
		else if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_111, 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_111, PLAYER::PLAYER_PED_ID(), 1))
		{
			return 1;
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_117))
	{
		...
		else if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_117, 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_117, PLAYER::PLAYER_PED_ID(), 1))
		{
			return 1;
		}
	}
...
int func_184(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0xB9D5
{
	vector3 vVar0;
...
int func_185(int iParam0, float fParam1)//Position - 0xBA90
{
	float fVar0;
...
bool func_186(int iParam0, float fParam1)//Position - 0xBB06
{
	return func_187(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_187(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xBB1E
{
	var uVar0;
	vector3 vVar1;
	int iVar4;
	...
	uVar0 = func_188(&(Local_40[iVar4 /*4*/]), vVar1, iParam1, &(Local_40[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_40[iVar4 /*4*/].f_3) < iParam4);
}

int func_188(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xBBDF
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
Vector3 func_189(int iParam0, int iParam1)//Position - 0xBD0B
{
	int iVar0;
...
int func_191(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xBE1A
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
float func_192(vector3 vParam0, vector3 vParam3)//Position - 0xBEAB
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}

Vector3 func_193(vector3 vParam0)//Position - 0xBECC
{
	float fVar0;
	float fVar1;
...
void func_194(var uParam0)//Position - 0xBF0B
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_195(int iParam0, int iParam1)//Position - 0xBF26
{
	int iVar0;
...
int func_196(int iParam0)//Position - 0xBF65
{
...
bool func_197(int iParam0, int iParam1, float fParam2)//Position - 0xBF8D
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_198(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xBFD4
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_199(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xC0CF
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_200(int iParam0, float fParam1)//Position - 0xC1DB
{
	var uVar0;
	vector3 vVar1;
...
int func_201(int iParam0, vector3 vParam1, float fParam4, int iParam5)//Position - 0xC270
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
int func_202(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xC2FE
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_203(int iParam0, int iParam1, int iParam2)//Position - 0xC346
{
...
int func_206(vector3 vParam0, float fParam3)//Position - 0xC514
{
	vector3 vVar0;
...
void func_207(bool bParam0)//Position - 0xC546
{
	if (bParam0)
	{
		switch (Local_83)
...
void func_208(var uParam0)//Position - 0xC5E4
{
	int iVar0;
...
void func_209(var uParam0)//Position - 0xC61D
{
	func_210(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

void func_210(int iParam0, char* sParam1, int iParam2)//Position - 0xC634
{
	if (MISC::IS_BIT_SET(iParam0, 30))
	{
		switch (func_171(iParam0))
...
int func_211(int iParam0)//Position - 0xC6F4
{
	switch (iParam0)
	{
		case 0:
...
bool func_212(int iParam0, int iParam1)//Position - 0xC786
{
	bool bVar0;
...
int func_214(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)//Position - 0xC96B
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
Vector3 func_215(int iParam0, int iParam1)//Position - 0xC9E6
{
	int iVar0;
...
void func_216(bool bParam0)//Position - 0xCA24
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 7)
	{
		if (func_15(iLocal_103[iVar0]))
		{
			...
			TASK::TASK_WANDER_STANDARD(iLocal_103[iVar0], 1193033728, 0);
	...
	if (Local_83 == 1)
	{
		PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_215, 0);
	}
	if (Local_83.f_1 == 1 || Local_83.f_1 == 2)
	{
		PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_214, 0);
	}
	else
	{
...
void func_217(var uParam0, bool bParam1)//Position - 0xCD6B
{
	int iVar0;
...
void func_218(var uParam0)//Position - 0xCDA6
{
	*uParam0 = 0;
	uParam0->f_1 = -1;
...
void func_219(int iParam0, bool bParam1, bool bParam2)//Position - 0xCDBF
{
	int iVar0;
	bool bVar1;
